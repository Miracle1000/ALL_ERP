...
'If font.color & "" <> "" Then cssText = cssText & "color:" & font.color & ";"
	...
	Response.write " " & vbcrlf & "<HTML>" & vbcrlf & "<HEAD>" & vbcrlf & "<TITLE>待建立付款计划</TITLE>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8""" & vbcrlf & "</HEAD>" & vbcrlf & "<body>" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td class=""place"">待建立付款计划导出</td>" & vbcrlf & "    <td>&nbsp;</td>" & vbcrlf & "    <td align=""right"">&nbsp;</td>" & vbcrlf & "    <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>  " & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr class=""top"">" & vbcrlf & "  <td colspan=2 class=tablebody1>&nbsp;</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr>" & vbcrlf & "  <td colspan=2 class=tablebody1>" & vbcrlf & "<span id=""CountTXTok"" name=""CountTXTok"" style=""font-size:10pt; color:#008040"">" & vbcrlf & "<B>正在导出待建立付款计划列表,请稍后...</B></span>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""1"" cellpadding=""1"">" & vbcrlf & "<tr> " & vbcrlf & "<td bgcolor=000000>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""1"">" & vbcrlf & "<tr> " & vbcrlf & "<td bgcolor=ffffff height=9><img src=""../images/tiao.jpg"" width=""0"" height=""16"" id=""CountImage"" name=""CountImage"" align=""absmiddle""></td></tr></table>" & vbcrlf & "</td></tr></table> <span id=""CountTXT"" name=""CountTXT"" style=""font-size:9pt; color:#008040"">0</span><span style=""font-size:9pt; color:#008040"">%</span></td></tr>" & vbcrlf & "<tr class=""top"">" & vbcrlf & "  <td colspan=2 class=tablebody1 height=""40"">" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf &""
	dotstr=""
		for i=1 to num_dot_xs
			...
			xlApplication.ActiveSheet.Columns(1).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1+1).ColumnWidth=25
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1+1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(2+1).ColumnWidth=25
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(2+1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(3+1).ColumnWidth=8
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(3+1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(4+1).ColumnWidth=8
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(4+1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(5+1).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(5+1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(5+1).NumberFormatLocal = "#,##0."&dotstr&"_ "
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(6+1).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(6+1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(6+1).NumberFormatLocal = "#,##0."&dotstr&"_ "
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(7+1).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(7+1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(7+1).NumberFormatLocal = "#,##0."&dotstr&"_ "
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(7+2).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(7+2).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(7+2).NumberFormatLocal = "#,##0."&dotstr&"_ "
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(8+2).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(8+2).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(9+2).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(9+2).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
			xlWorksheet.Cells(1,1).Value = "单据日期"
			xlWorksheet.Cells(1,1).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,1+1).Value = "供应商名称"
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,1+1).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,1+1).font.bold=true
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,2+1).Value = "单据主题"
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,2+1).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,2+1).font.bold=True
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,3+1).Value = "来源"
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,3+1).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,3+1).font.bold=True
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,4+1).Value = "币种"
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,4+1).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,4+1).font.bold=True
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,5+1).Value = "优惠后总额"
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,5+1).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,5+1).font.bold=true
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,6+1).Value = "付款计划总额"
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,6+1).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,6+1).font.bold=true
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,7+1).Value = "付款总额"
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,7+1).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,7+1).font.bold=true
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,7+2).Value = "付款计划余额"
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,7+2).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,7+2).font.bold=true
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,8+2).Value = "付款计划进展"
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,8+2).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,8+2).font.bold=true
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,9+2).Value = "单据人员"
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,9+2).font.Size=10
			xlWorksheet.Cells(1,1).font.bold=true
			xlWorksheet.Cells(1,9+2).font.bold=true
			xlWorksheet.Cells(1,1).font.bold=true
...
'if Cls > 0 then
			...
			if C<>"" then
				if B="khmc" then
					Str_Result=Str_Result+" and company in (select ord from tel where del=1 and name like '%"& replace(C,"","") &"%') "
'if B="khmc" then
				elseif B="khid" then
...
'elseif B="cgid" then
				elseif B="cguser" then
					Str_Result=Str_Result+" and cateid in (select  ord from gate where   name like '%"&replace(C,"'","")&"%')  "
'elseif B="cguser" then
				end if
			end if
			If A="1" Then
...
'ElseIf A="2" Then
			...
			If A="1" Then
				Str_Result=Str_Result+" and (select isnull(sum(money1),0) as money1 from payout where cls=a.cls and contract=a.ord and del=1)=0 "
'If A="1" Then
			ElseIf A="2" Then
				Str_Result=Str_Result+" and (select isnull(sum(money1),0) as money1 from payout where cls=a.cls and contract=a.ord and del=1)>0 "
'ElseIf A="2" Then
			...
			if MC<>"" THEN
				Str_Result=Str_Result+" and cls not in ("&MC&") "
'if MC<>"" THEN
			end if
			...
			set rs=server.CreateObject("adodb.recordset")
			sql = " select * from ( "&_
			"          SELECT  PayAlsoMoney,cls,ord,cateid,title,cgid,company,money1, "&_
			"       bz,del,date7,CONVERT(varchar(10) ,date3, 120)as date3 "&_
			"       from [erp_finace_willpayoutList] ("&ovqt&")  "&Str_Result&" "&_
			"  ) t   "&_
			"  order by date7 desc "
			rs.open sql,conn,1,1
			C1=rs.recordcount
			xlApplication.Init "待建立付款计划_"&session("name2006chen")&".xls",C1
			dim i
			i=1
			if rs.RecordCount<=0  then
				...
				do until rs.eof
					...
					clsname="采购"
					End Select
					cateid=rs("cateid") : cls=rs("cls") : ord=rs("ord") : gys = rs("company") : title = rs("title")
					bz = rs("bz") : date3 = rs("date3")
					if gys&""<>"" then
						set rs7=server.CreateObject("adodb.recordset")
						rs7.open "select name,cateid,del from tel WITH(NOLOCK) where ord="& gys &" ",conn,1,1
						if rs7.eof then
							cateid_kh=-1
'if rs7.eof then
							companyname="关联供应商已被删除"
						else
							cateid_kh=rs7("cateid")
							if rs7("del")&""="1" then
								companyname=rs7("name")
							else
								companyname=rs7("name")&"(已删除)"
							end if
						end if
						rs7.close
						set rs7=nothing
					...
					open_lb = open_5025_1 : intro_lb = intro_5025_1
					End Select
					if Not (open_lb=3 or (open_lb=1 and CheckPurview(intro_lb,trim(cateid))=True)) Then title = ""
					set rs7=server.CreateObject("adodb.recordset")
					rs7.open "select sort1 from sortbz WITH(NOLOCK) where id="&rs("bz")&" ",conn,1,1
					if not rs7.eof then
						sortbz=rs7(0)
					end if
					rs7.close
					...
					sql7="select isnull((select isnull(sum(money1),0) as moneyjh from payout WITH(NOLOCK) where del=1 and contract="& ord &" and isnull(cls,0)="& cls &"),0) moneyjh, isnull((select isnull(sum(money1),0) as moneyjh from payout WITH(NOLOCK) where del=1 and complete=3 and contract="& ord &" and isnull(cls,0)="& cls &"),0) moneyyh"
					rs7.open sql7,conn,1,1
					if not rs7.eof then
						moneyjh=rs7("moneyjh") : moneyyh=rs7("moneyyh")
					end if
					rs7.close
					hl = sdk.getSqlValue("select dbo.gethl("& bz &",'"& date3 &"',getdate())" , 1)
					If cgmoney1&"" = "" Then cgmoney1 = 0 Else cgmoney1 = CDBL(cgmoney1)
					If moneyjh&"" = "" Then moneyjh = 0 Else moneyjh = CDBL(moneyjh)
					If moneyyh&"" = "" Then moneyyh = 0 Else moneyyh = CDBL(moneyyh)
					If PayAlsoMoney&"" = "" Then PayAlsoMoney = 0 Else PayAlsoMoney = CDBL(PayAlsoMoney)
					cnCgmoney1 = cgmoney1 * hl
					cnMoneyjh= moneyjh * hl
					cnMoneyyh = moneyyh * hl
					cnPayAlsoMoney = PayAlsoMoney * hl
					sumCgMoney1 = sumCgMoney1 + cdbl(Formatnumber(cgmoney1,num_dot_xs,true,0,0))
					cnPayAlsoMoney = PayAlsoMoney * hl
					sumMoneyjh = sumMoneyjh + cdbl(Formatnumber(moneyjh,num_dot_xs,true,0,0))
					cnPayAlsoMoney = PayAlsoMoney * hl
					sumMoneyyh = sumMoneyyh + cdbl(Formatnumber(moneyyh,num_dot_xs,true,0,0))
					cnPayAlsoMoney = PayAlsoMoney * hl
					sumPayAlsoMoney = sumPayAlsoMoney + cdbl(Formatnumber(PayAlsoMoney,num_dot_xs,true,0,0))
					cnPayAlsoMoney = PayAlsoMoney * hl
					cnSumCgMoney1 = cnSumCgMoney1 + cdbl(Formatnumber(cnCgmoney1,num_dot_xs,true,0,0))
					cnPayAlsoMoney = PayAlsoMoney * hl
					cnSumMoneyjh = cnSumMoneyjh + cdbl(Formatnumber(cnMoneyjh,num_dot_xs,true,0,0))
					cnPayAlsoMoney = PayAlsoMoney * hl
					cnSumMoneyyh = cnSumMoneyyh + cdbl(Formatnumber(cnMoneyyh,num_dot_xs,true,0,0))
					cnPayAlsoMoney = PayAlsoMoney * hl
					cnSumPayAlsoMoney = cnSumPayAlsoMoney + cdbl(Formatnumber(cnPayAlsoMoney,num_dot_xs,true,0,0))
					cnPayAlsoMoney = PayAlsoMoney * hl
					if cateid&""<>"" then
						set rs7=server.CreateObject("adodb.recordset")
						...
						if rs7.eof then
							...
							if cls&""="0" then
								cateidname = "采购人员："&rs7("name")
							else
								cateidname = "我方代表："&rs7("name")
							end if
						end if
						rs7.close
						set rs7=nothing
					...
					if moneyjh=0 then
						str="未生成"
					elseif moneyjh<CDbl(rs("money1")) then
						str="部分生成"
					end if
					xlWorksheet.Cells(1+i,1).Value = date3
					str="部分生成"
					xlWorksheet.Cells(1+i,1).font.Size=10
					str="部分生成"
					xlWorksheet.Cells(1+i,1).HorizontalAlignment=1
					str="部分生成"
					xlWorksheet.Cells(1+i,1+1).Value = companyname
					str="部分生成"
					xlWorksheet.Cells(1+i,1+1).font.Size=10
					str="部分生成"
					xlWorksheet.Cells(1+i,1+1).HorizontalAlignment=1
					str="部分生成"
					xlWorksheet.Cells(1+i,2+1).Value = rs("title")
					str="部分生成"
					xlWorksheet.Cells(1+i,2+1).HorizontalAlignment=1
					str="部分生成"
					xlWorksheet.Cells(1+i,2+1).font.Size=10
					str="部分生成"
					xlWorksheet.Cells(1+i,3+1).Value = clsname
					str="部分生成"
					xlWorksheet.Cells(1+i,3+1).font.Size=10
					str="部分生成"
					xlWorksheet.Cells(1+i,4+1).Value = sortbz
					str="部分生成"
					xlWorksheet.Cells(1+i,4+1).font.Size=10
					str="部分生成"
					xlWorksheet.Cells(1+i,5+1).Value = Formatnumber(cgmoney1,num_dot_xs,-1)
					str="部分生成"
					xlWorksheet.Cells(1+i,5+1).font.Size=10
					str="部分生成"
					xlWorksheet.Cells(1+i,6+1).Value = Formatnumber(moneyjh,num_dot_xs,-1)
					str="部分生成"
					xlWorksheet.Cells(1+i,6+1).font.Size=10
					str="部分生成"
					xlWorksheet.Cells(1+i,7+1).Value = Formatnumber(moneyyh,num_dot_xs,-1)
					str="部分生成"
					xlWorksheet.Cells(1+i,7+1).font.Size=10
					str="部分生成"
					xlWorksheet.Cells(1+i,7+2).Value = Formatnumber(PayAlsoMoney,num_dot_xs,-1)
					str="部分生成"
					xlWorksheet.Cells(1+i,7+2).font.Size=10
					str="部分生成"
					xlWorksheet.Cells(1+i,8+2).Value = str
					str="部分生成"
					xlWorksheet.Cells(1+i,8+2).font.Size=10
					str="部分生成"
					xlWorksheet.Cells(1+i,9+2).Value = cateidname
					str="部分生成"
					xlWorksheet.Cells(1+i,9+2).font.Size=10
					str="部分生成"
			...
			rs.close
			set rs=Nothing
			xlWorksheet.Cells(1+i,3+2).Value = "合计"
			set rs=Nothing
			xlWorksheet.Cells(1+i,3+2).font.Size=10
			set rs=Nothing
			xlWorksheet.Cells(1+i,4+2).Value = Formatnumber(sumCgMoney1,num_dot_xs,-1)
			set rs=Nothing
			xlWorksheet.Cells(1+i,4+2).font.Size=10
			set rs=Nothing
			xlWorksheet.Cells(1+i,5+2).Value = Formatnumber(sumMoneyjh,num_dot_xs,-1)
			set rs=Nothing
			xlWorksheet.Cells(1+i,5+2).font.Size=10
			set rs=Nothing
			xlWorksheet.Cells(1+i,6+2).Value = Formatnumber(sumMoneyyh,num_dot_xs,-1)
			set rs=Nothing
			xlWorksheet.Cells(1+i,7+2).Value = Formatnumber(sumPayAlsoMoney,num_dot_xs,-1)
			set rs=Nothing
			xlWorksheet.Cells(2+i,3+2).Value = "人民币合计"
			set rs=Nothing
			xlWorksheet.Cells(2+i,3+2).font.Size=10
			set rs=Nothing
			xlWorksheet.Cells(2+i,4+2).Value = Formatnumber(cnSumCgMoney1,num_dot_xs,-1)
			set rs=Nothing
			xlWorksheet.Cells(2+i,4+2).font.Size=10
			set rs=Nothing
			xlWorksheet.Cells(2+i,5+2).Value = Formatnumber(cnSumMoneyjh,num_dot_xs,-1)
			set rs=Nothing
			xlWorksheet.Cells(2+i,5+2).font.Size=10
			set rs=Nothing
			xlWorksheet.Cells(2+i,6+2).Value = Formatnumber(cnSumMoneyyh,num_dot_xs,-1)
			set rs=Nothing
			xlWorksheet.Cells(2+i,7+2).Value = Formatnumber(cnSumPayAlsoMoney,num_dot_xs,-1)
			set rs=Nothing
			Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>待建立回款计划列表导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!待建立付款计划列表导出成功,共有"&(i-1)&"条记录!</B>"";</script>"
			set rs=Nothing
			Response.write "" & vbcrlf & "</BODY>" & vbcrlf & "</HTML>" & vbcrlf & ""
			Set fs = CreateObject("Scripting.FileSystemObject")
			tfile=Server.MapPath("待建立付款计划的采购单_"&session("name2006chen")&".xls")
			...
			Response.write """><font class=""red""><strong><u>下载导出的待建立付款计划</u></strong></font></a></p> " & vbcrlf & ""
