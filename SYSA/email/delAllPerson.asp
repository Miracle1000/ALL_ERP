...
'bigsystemtype = ".mozi"
	...
	sql="Delete  email_Person where 1=1  "&Str_Result&" "&str_sql_checkid&""
	conn.Execute(sql)
	action1="邮件地址删除"
	call close_list(2)
	Response.write"<script language=javascript>window.location.href='EmailList.asp?page_count="&page_count&"&currpage="&currpage&"&takeName="&strid&"';window.parent.location.reload();</script>"
