...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/cr_Add_carDriver.js?ver="
	Response.write Application("sys.info.jsver")
	...
	if ord<>0 then
		sql7="select * from O_cardriver where id="&ord
		set rs7=conn.execute(sql7)
		if not rs7.eof then
			drivername=rs7("drivername")
			phone=rs7("phone")
			mobile=rs7("mobile")
			mobile2=rs7("mobile2")
			addr=rs7("addr")
	...
	Response.write "" & vbcrlf & "</span>" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">     " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">司机"
	Response.write types
	Response.write "</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "     <form action=""Save_carDriver.asp?ord="
	Response.write ord
	Response.write "&tp1="
	Response.write tp1
	Response.write """ method=""POST"" name=""demo""id=""demo"" onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" colspan=""6"" ><div align=""left"">基本信息</div></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr name=""table_tr1"">" & vbcrlf & "            <td width=""15%"" height=""27""><div align=""right"">姓名：</div></td>" & vbcrlf & "      <td colspan=""5"" class=""gray""><input name=""name1"" type=""text"" id=""name1"" maxlength=""200"" value="""
	Response.write drivername
	Response.write """ dataType=""Limit""  min=""1"" max=""100"" msg=""必填""><span class=""red"">&nbsp;*</span></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr name=""table_tr1"">" & vbcrlf & "       <td width=""15%"" height=""27""><div align=""right"">固定电话：</div></td>" & vbcrlf & "          <td colspan=""5"" class=""gray""><input name=""car_phone"" type=""text"" id=""car_phone"" size=""15"" value="""
	Response.write phone
	Response.write """ maxlength=""200"" dataType=""PhoneNull"" max=""200"" msg=""格式不正确""></td>" & vbcrlf & "      </tr>" & vbcrlf & "   <tr name=""table_tr1"">" & vbcrlf & "       <td width=""15%"" height=""27""><div align=""right"">移动电话：</div></td>" & vbcrlf & "          <td colspan=""5"" class=""gray""><input name=""car_mobile"" type=""text"" id=""car_mobile"" size=""15"" value="""
	Response.write mobile
	Response.write """ maxlength=""200"" dataType=""MobileNull"" max=""200"" msg=""格式不正确""></td>" & vbcrlf & "      </tr>" & vbcrlf & "          <tr name=""table_tr1"">" & vbcrlf & "       <td width=""15%"" height=""27""><div align=""right"">移动电话2：</div></td>" & vbcrlf & "         <td colspan=""5"" class=""gray""><input name=""car_mobile2"" type=""text"" id=""car_mobile2"" size=""15"" value="""
	Response.write mobile2
	Response.write """ maxlength=""200"" dataType=""MobileNull"" max=""200"" msg=""格式不正确""></td>" & vbcrlf & "      </tr>" & vbcrlf & "          <tr name=""table_tr1"">" & vbcrlf & "       <td width=""15%"" height=""27""><div align=""right"">地址：</div></td>" & vbcrlf & "      <td colspan=""5"" class=""gray""><input name=""car_dirveradd"" type=""text"" id=""car_dirveradd"" value="""
	Response.write addr
	Response.write """ maxlength=""200"" max=""200""></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray"">" & vbcrlf & "                        <div align=""center""><input type=""hidden"" name=""tp"" id=""tp"" value=""1"">" & vbcrlf & "                       <input name=""Submit22"" type=""submit"" class=""anybutton2"" value="""
	if ord<>0 then
		Response.write "修改"
	else
		Response.write "保存"
	end if
	Response.write """ onClick=""return ask1('2')"">" & vbcrlf & "                          "
	if ord=0 then
		Response.write "" & vbcrlf & "                        <input name=""Submit222"" type=""submit"" class=""anybutton2"" value="""
		if ord<>0 then
			Response.write "修改"
		else
			Response.write "保存"
		end if
		Response.write "并添加"" onClick=""return ask1('1')"">" & vbcrlf & "                     "
	end if
	Response.write "" & vbcrlf & "                        <input type=""reset"" value=""重填"" class=""anybutton2"" name=""B2"">" & vbcrlf & "                 </div></td>" & vbcrlf & "      </tr></form>" & vbcrlf & "    </table>      </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="车辆司机"&types
	call close_list(1)
	Response.write "" & vbcrlf & "<script src= ""../Script/cr_Add_carDriver_2.js?ver="
	Response.write Application("sys.info.jsver")
