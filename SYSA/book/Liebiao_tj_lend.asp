...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	next
	Response.write "              </td>" & vbcrlf & "     </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">归还状态：</div></td>" & vbcrlf & "              <td colspan=""3"">" & vbcrlf & "                  <input name=""D10"" type=""checkbox"" id=""D10"" value=""1"">未归还" & vbcrlf & "                 <input name=""D10"" type=""checkbox"" id=""D10"" value=""2"">归还部分" & vbcrlf & "                   <input name=""D10"" type=""checkbox"" id=""D10"" value=""3"">归还完毕" & vbcrlf & "           </td>" & vbcrlf & "     </tr>" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">书名：</div></td>" & vbcrlf & "          <td colspan=""3""><input name=""D3"" type=""text"" id=""D3"" size=""30"" /></td>" & vbcrlf & "               </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">编号：</div></td>" & vbcrlf & "          <td colspan=""3""><input name=""D17"" type=""text"" id=""D17"" size=""15"" /></td>" & vbcrlf & "             </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "          <td><div align=""right"">作者：</div></td>" & vbcrlf & "                      <td width=""33%""><input name=""D4"" type=""text"" id=""D4"" size=""15""></td>" & vbcrlf & "             <td width=""15%""><div align=""right"">" & vbcrlf & "             <div align=""right"">出版社：</div></td>" & vbcrlf & "             <td width=""42%""><input name=""D5"" type=""text"" id=""D5"" size=""15"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "<td><div align=""right"">版次：</div></td>" & vbcrlf & "         <td><input name=""D6"" type=""text"" id=""D6"" size=""15"" /></td>" & vbcrlf & "         <td><div align=""right"">页数：</div></td>" & vbcrlf & "         <td><input name=""D7"" type=""text"" id=""D7"" onkeyup=""value=value.replace(/[^\d]/g,'')"" size=""6"" maxlength=""12""/>" & vbcrlf & "           -" & vbcrlf & "           <input name=""D71"" type=""text"" id=""D71"" onkeyup=""value=value.replace(/[^\d]/g,'')"" size=""6"" maxlength=""12""/></td>" & vbcrlf & "       </tr>" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">字数：</div></td>" & vbcrlf & "          <td><input name=""D8"" type=""text"" id=""D8"" onkeyup=""value=value.replace(/[^\d]/g,'')"" size=""12"" maxlength=""12"">" & vbcrlf & "         -" & vbcrlf & "<input name=""D81"" type=""text"" id=""D81"" onkeyup=""value=value.replace(/[^\d]/g,'')"" size=""12"" maxlength=""12""/></td>" & vbcrlf & "         <td><div align=""right"">开本：</div></td>" & vbcrlf & "         <td><input name=""D9"" type=""text"" id=""D9"" size=""15"" /></td>" & vbcrlf & "</tr> "& vbcrlf &  "      <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf &           "   <td><div align=""right"">纸张：</div></td> "& vbcrlf &    "       <td><input name=""D13"" type=""text"" id=""D13"" size=""15"" /></td> "& vbcrlf &         "    <td><div align=""right"">印次：</div></td>" & vbcrlf & "         <td><input name=""D18"" type=""text"" id=""D18"" size=""15"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">ISBN：</div></td>" & vbcrlf & "    <td><input name=""D16"" type=""text"" id=""D16"" size=""15"" /></td>" & vbcrlf & "          <td><div align=""right"">装帧：</div></td>" & vbcrlf & "         <td><input name=""D19"" type=""text"" id=""D19"" size=""15"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">单价：</div></td>" & vbcrlf & "    <td><input name=""D11"" type=""text"" id=""D11"" onKeyUp=""value=value.replace(/[^\d*|\.]/g,'')"" size=""12"" maxlength=""12"" />"& vbcrlf & "-" & vbcrlf & "<input name=""D12"" type=""text"" id=""D12"" onKeyUp=""value=value.replace(/[^\d*|\.]/g,'')"" size=""12"" maxlength=""12"" /></td>" & vbcrlf & "         <td><div align=""right"">数量：</div></td>" & vbcrlf & "         <td><input name=""D14"" type=""text"" id=""D14"" onkeyup=""value=value.replace(/[^\d]/g,'')"" size=""12"" maxlength=""12""/>" & vbcrlf & "-" & vbcrlf & "  <input name=""D15"" type=""text"" id=""D15"" onkeyup=""value=value.replace(/[^\d]/g,'')"" size=""12"" maxlength=""12""/></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">存放位置：</div></td>" & vbcrlf & "    <td colspan=""3""><input name=""D21"" type=""text"" id=""D21"" size=""30"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColorf & ""      <input name=""D201"" type=""text"" id=""D201"" onkeyup=""value=value.replace(/[^\d]/g,'')"" size=""12"" maxlength=""12""/></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td><divalign=""right"">借阅备注：</div></td>" & vbcrlf & "    <td colspan=""3""><input name=""D22"" type=""text"" id=""D22"" size=""30""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "          <td><div align=""right"">借阅时间：</div></td>" & vbcrlf & "             <td colspan=""3"">&nbsp;自：<input name=""M"" type=""text"" size=""9"" value="""" id=""daysOfMonthmPos"" onmouseup=toggleDatePicker(""daysOfMonthm"",""date.M"") readonly=""true""><DIV id=daysOfMonthm style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<input name=""K"" type=""text"" size=""9"" value="""" id=""daysOfMonthkPos"" onmouseup=toggleDatePicker(""daysOfMonthk"",""date.k"") readonly=""true""><DIV id=daysOfMonthk style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "  </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "  <td><div align=""right"">归还时间：</div></td>" & vbcrlf & "      <td colspan=""3"">&nbsp;自：<input name=""L1"" type=""text"" size=""9"" value="""" id=""daysOfMonthPosL1"" onmouseup=toggleDatePicker(""daysOfMonthL1"",""date.L1"") readonly=""true""><DIV id=daysOfMonthL1 style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<input name=""L2"" type=""text"" size=""9"" value="""" id=""daysOfMonthPosL2"" onmouseup=toggleDatePicker(""daysOfMonthL2"",""date.L2"") readonly=""true""><DIV id=daysOfMonthL2 style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "  <td><div align=""right"">添加时间：</div></td>" & vbcrlf & "      <td colspan=""3"">&nbsp;自：<input name=""L3"" type=""text"" size=""9""value="""" id=""daysOfMonthPosL3"" onmouseup=toggleDatePicker(""daysOfMonthL3"",""date.L3"") readonly=""true""><DIV id=daysOfMonthL3 style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<input name=""L4"" type=""text"" size=""9"" value="""" id=""daysOfMonthPosL4"" onmouseup=toggleDatePicker(""daysOfMonthL4"",""date.L4"") readonly=""true""><DIV id=daysOfMonthL4 style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "  </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td width=""10%"">&nbsp;</td>" & vbcrlf & "     <td colspan=""3""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "        </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
