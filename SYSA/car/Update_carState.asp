...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	ord=request("ord")
	car_state=trim(request("car_state"))
	r=request("r")
	if ord="" then
	...
	if ord="0" then
		Response.write "<script>alert('您没有选择任何车辆档案，请选择后再修改车辆状态！');history.back();</script>"
		call db_close : Response.end()
	end if
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">车辆状态</td>" & vbcrlf & "            <td></td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "       <form action=""Save_State.asp?ord="
	Response.write ord
	Response.write "&r="
	Response.write r
	Response.write """ method=""POST"" name=""data""id=""demo"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "            <td height=""30"" colspan=""6""><div align=""left"">选择状态</div></td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td height=""30"" colspan=""6"">" & vbcrlf & "            <input type=""radio"" value=""1"" name=""car_state"" id=""car_state"" "
	if car_state="1" or car_state=""  then
		Response.write " checked=""checked"" "
	end if
	Response.write " >正常" & vbcrlf & "                <input type=""radio"" value=""2"" name=""car_state"" id=""car_state"" "
	if car_state="2" then
		Response.write " checked=""checked"" "
	end if
	Response.write " >维护" & vbcrlf & "                <input type=""radio"" value=""3"" name=""car_state"" id=""car_state"" "
	if car_state="3" then
		Response.write " checked=""checked"" "
	end if
	Response.write " >报废" & vbcrlf & "                <input type=""radio"" value=""4"" name=""car_state"" id=""car_state"" "
	if car_state="4" then
		Response.write " checked=""checked"" "
	end if
	Response.write " >停用</td>" & vbcrlf & "     </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray"">" & vbcrlf & "                      <div align=""center"">" & vbcrlf & "                        <input type=""submit"" name=""Submit42"" value=""保存"" class=""page""/>" & vbcrlf & "                        <input type=""button"" value=""返回"" onClick=""javascript:window.history.back()"" class=""page"" name=""B2"">" & vbcrlf & "           </div></td>" & vbcrlf & "      </tr></form>" & vbcrlf & "    </table>" & vbcrlf & "      </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""30"">" & vbcrlf & "   <table width=""100%""border=""0"" align=""left"" >" & vbcrlf & "               <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
