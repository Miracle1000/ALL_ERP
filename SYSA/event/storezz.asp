...
'Public Function AddFormValue(name,  value)
	...
	Response.write "" & vbcrlf & "<html>" & vbcrlf & "<head>" & vbcrlf & "<meta name=""GENERATOR"" content=""Microsoft FrontPage 5.0"">" & vbcrlf & "<meta name=""ProgId"" content=""FrontPage.Editor.Document"">" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"">" & vbcrlf & "<title>"
	Response.write title_xtjm
	Response.write "</title>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & " function window.onload(){" & vbcrlf & " try" & vbcrlf & " {" & vbcrlf & " parent.document.getElementById(""mxlist"").style.height=document.body.scrollHeight;" & vbcrlf & " parent.document.getElementById(""mxlist"").style.width=document.body.scrollWidth;" & vbcrlf & " parent.parent.document.getElementById(""I1"").style.height=parent.document.body.scrollHeight;" & vbcrlf & " parent.parent.document.getElementById(""I1"").style.width=parent.document.body.offsetWidth;" & vbcrlf & "  }" & vbcrlf & "      catch(e)" & vbcrlf & "        {}" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-left: 0px;" & vbcrlf & "       margin-top: 0px;" & vbcrlf & "        margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "     background-color: #FFFFFF;" & vbcrlf & "   border:0!important;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style></head>" & vbcrlf & "" & vbcrlf & "<body >" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
	dim ProductList,ord
	ord=clng(session("storezz_idzbintel"))
	...
	CBField = ""
	if IsOpenRKPrice=false then CBField = ",6,7"
	sql="select * from zdymx where sort1=1004 and sorce not in (9,10,11,12"& CBField &") and set_open=1 order by gate1 asc "
	set rs = server.CreateObject("adodb.recordset")
	rs.open sql,conn,1,1
	Response.write "" & vbcrlf & "" & vbcrlf & "<table class=""detailTable noMargin"" width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "    <tr class=""top"">" & vbcrlf & "       <td height=""27"" colspan="""
	Response.write rs.recordcount+5
	Response.write """ class=""name"" style=""background:#FFF!important"">父件明细</td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "        "
	num1_ls=0
	adressNum1=0
	If Not rs.eof Then
		do until rs.eof
			kd=rs("kd")
			Response.write "<td class='name nonamepadding' width="&kd&"><div align='center'>"&rs("title")&"</div></td>"
			If rs("sorce")=5 Then
				adressNum1=num1_ls
				if isOpenAssUnit then
					Response.write "<td class='name nonamepadding' width="&kd&"><div align='center'>辅助单位</div></td>"
					Response.write "<td class='name nonamepadding' width="&kd&"><div align='center'>辅助数量</div></td>"
				end if
			end if
			If rs("sorce")=4 Then
				if isOpenProductAttrV then
					Response.write "<td class='name nonamepadding' width='90'><div align='center'>产品属性1</div></td>"
					Response.write "<td class='name nonamepadding' width='90'><div align='center'>产品属性2</div></td>"
				end if
			end if
			num1_ls=num1_ls+1
			Response.write "<td class='name nonamepadding' width='90'><div align='center'>产品属性2</div></td>"
	...
	rs.close
	Response.write "" & vbcrlf & "       <!-- <td height=""27"" class=""name""><div align=""center"">产品名称</div></td>" & vbcrlf & "        <td height=""20"" class=""name""><div align=""center"">产品编号</div></td>" & vbcrlf & "        <td class=""name""><div align=""center"">产品型号</div></td>" & vbcrlf & "        <td class=""name""><div align=""center"">单位</div></td>" & vbcrlf & "        <td width=""6%"" height=""20"" class=""name""><div align=""center"">数量</div></td>" & vbcrlf & "        <td width=""9%"" class=""name""><div align=""center"">单价</div></td>" & vbcrlf & "        <td width=""8%"" class=""name""><div align=""center"">总价</div></td>" & vbcrlf & "        <td width=""10%"" class=""name""><div align=""center"">仓库</div></td>" & vbcrlf & "        <td width=""8%"" class=""name""><div align=""center"">包装</div></td>" & vbcrlf & "        <td width=""6%"" class=""name""><div align=""center"">件数</div></td>" &vbcrlf & "        <td width=""12%"" class=""name""><div align=""center"">备注</div></td>-->" & vbcrlf & "    </tr>" & vbcrlf & ""
'Loop
	sql = "select * from kuinlist where  caigou="&ord&" and sort1=9 and addcate="&session("personzbintel2007")&" and del=7 order by id asc"
	set rss = server.CreateObject("adodb.recordset")
	rss.open sql,conn,1,1
	if rss.eof then
		Response.write "" & vbcrlf & "    <tr>" & vbcrlf & "      <td height=""27"" colspan="""
		Response.write num1_ls+5
		Response.write "" & vbcrlf & "    <tr>" & vbcrlf & "      <td height=""27"" colspan="""
		...
		zk=0
		do until rss.eof
			num=num+cdbl(rss("num1"))
'do until rss.eof
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select title,order1,type1 from product where ord="&rss("ord")&""
			rs7.open sql7,conn,1,1
			if rs7.eof then
				k=""
				order1=""
			...
			rs7.close
			set rs7=nothing
			if Isnull(rss("unit")) or rss("unit")="" then
				unitname=""
			else
				set rs7=server.CreateObject("adodb.recordset")
				sql7="select sort1 from sortonehy where id="&rss("unit")&""
				rs7.open sql7,conn,1,1
				if rs7.eof then
					unitname=""
				else
			...
			if isOpenAssUnit then
				if Isnull(rss("AssistUnit")) or rss("AssistUnit")="" then
					AssistUnitName=""
				else
					set rs7=server.CreateObject("adodb.recordset")
					sql7="select sort1 from sortonehy where id="&rss("AssistUnit")&""
					rs7.open sql7,conn,1,1
					if rs7.eof then
						AssistUnitName=""
					else
			...
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select sort1,sort from sortck where ord="&rss("ku")&""
			rs7.open sql7,conn,1,1
			if rs7.eof then
				ckname=""
			else
			...
			if rss("bz")<>"" then
				set rs7=server.CreateObject("adodb.recordset")
				sql7="select sort1 from sortonehy where id="&rss("bz")&""
				rs7.open sql7,conn,1,1
				if rs7.eof then
					bzname=""
				else
			...
			set rs=server.CreateObject("adodb.recordset")
			sql="select id,title,name,sort,kd,set_open,sorce,gate1 from zdymx where sort1=1004 and sorce not in (9,10,11,12"& CBField &") and set_open=1  order by gate1 asc "
			rs.open sql,conn,1,1
			do until rs.eof
				sorce=rs("sorce")
				kd=rs("kd")
				...
				Response.write kd
				Response.write """ height=""27""><div align=""left""><span class=""name"">&nbsp;" & vbcrlf & "                        "
				If qxOpen > 0 Then
					...
					Response.write "','newdfwin','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');return false;"" title=""点击可查看此产品详情"">" & vbcrlf & "                        "
					Response.write pwurl(rss("ord"))
				end if
				Response.write""&k&""
				Response.write "" & vbcrlf & "                        </a></span></div></td>" & vbcrlf & "" & vbcrlf & "                        "
				Case 2:
				Response.write "" & vbcrlf & "                                             <td width="""
				Response.write kd
				Response.write """ height=""20""><div align=""center"">"
				...
				Response.write "</div></td>" & vbcrlf & "                                          "
				if isOpenProductAttrV then
					Response.write "" & vbcrlf & "                                             <td width=""90"" height=""20""><div align=""center"">"
					Response.write GetProductAttrNameById(rss("ProductAttr1"))
					Response.write "</div></td>" & vbcrlf & "                                                  <td width=""90"" height=""20""><div align=""center"">"
					Response.write GetProductAttrNameById(rss("ProductAttr2"))
					Response.write "</div></td> " & vbcrlf & "                    "
				end if
				Case 5:
				Response.write "" & vbcrlf & "                                             <td width="""
				Response.write kd
				Response.write """ height=""20""><div align=""center"">"
				Response.write Formatnumber(zbcdbl(rss("num1")),num1_dot,-1)
				Response.write """ height=""20""><div align=""center"">"
				Response.write "</div></td>" & vbcrlf & "                                          "
				if isOpenAssUnit then
					AssistNumT=""
					if not (rss("AssistNum")&""="" or rss("AssistNum")&""="0") then AssistNumT=Formatnumber(zbcdbl(rss("AssistNum")),num1_dot,-1)
					AssistNumT=""
					Response.write "" & vbcrlf & "                                                     <td width="""
					Response.write kd
					Response.write """ height=""20""><div align=""right"">"
					Response.write AssistUnitName
					Response.write "</div></td>" & vbcrlf & "                                                  <td width="""
					Response.write kd
					Response.write """ height=""20""><div align=""right"">"
					Response.write AssistNumT
					Response.write "</div></td> " & vbcrlf & "                    "
				end if
				Case 6:
				Response.write "" & vbcrlf & "                                             <td width="""
				Response.write kd
				Response.write """ height=""20""><div align=""right"">"
				Response.write Formatnumber(zbcdbl(rss("price1")),StorePrice_dot_num,-1)
				Response.write """ height=""20""><div align=""right"">"
				Response.write "</div></td>" & vbcrlf & "                        "
				Case 7:
				Response.write "" & vbcrlf & "                                             <td width="""
		...
		Response.write adressNum1+ProductAttrColNum
		Response.write """><div align=""center"">合计</div></td>" & vbcrlf & "        <td height=""27"" class=""red""><div align=""center"">"
		Response.write Formatnumber(num,num1_dot,-1)
		Response.write "</div></td>" & vbcrlf & "          "
		If num1_ls>adressNum1+1 Then
			Response.write "</div></td>" & vbcrlf & "          "
			Response.write "" & vbcrlf & "                     <td colspan="""
			Response.write num1_ls-adressNum1-1
			Response.write "" & vbcrlf & "                     <td colspan="""
			Response.write """ height=""27""></td>" & vbcrlf & "         "
		end if
		if isOpenAssUnit then
			Response.write "" & vbcrlf & "                     <td height=""27"" class=""red""><div align=""center""></div></td>" & vbcrlf & "                     <td height=""27"" class=""red""><div align=""center""></div></td>" & vbcrlf & "        "
		end if
		Response.write "" & vbcrlf & "    </tr>" & vbcrlf & ""
	end if
	rss.close
	set Rss = nothing
	Response.write "" & vbcrlf & "</table>" & vbcrlf & "<table class=""detailTable noMargin"" width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" style='margin-top:-1px;' id=""content"">" & vbcrlf & ""
	set Rss = nothing
	sql="select * from zdymx where sort1=1005 and sorce not in (9,10"& CBField &") and set_open=1 order by gate1 asc "
	set rs = server.CreateObject("adodb.recordset")
	rs.open sql,conn,1,1
	Response.write "" & vbcrlf & "    <tr class=""top"">" & vbcrlf & "           <td height=""27"" colspan="""
	Response.write rs.recordcount+5
	Response.write """ class=""name""  style=""background:#FFF!important"">子件明细</td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      "
	num1_ls=0
	adressNum1=0
	If Not rs.eof Then
		do until rs.eof
			...
			If rs("sorce")=4 and isOpenProductAttrV Then
				Response.write "<td width='90'><div align='center'>产品属性1</div></td>"
				Response.write "<td width='90'><div align='center'>产品属性2</div></td>"
			end if
			num1_ls=num1_ls+1
			Response.write "<td width='90'><div align='center'>产品属性2</div></td>"
			rs.movenext
	...
	Response.write "" & vbcrlf & "    </tr>" & vbcrlf & ""
	dim k2
	sql = "select * from kuoutlist2 where contract="&ord&" and sort1=9 and addcate="&session("personzbintel2007")&" and del=7 order by id asc"
	set rss = server.CreateObject("adodb.recordset")
	rss.open sql,conn,1,1
	if rss.eof then
		Response.write "" & vbcrlf & "    <tr>" & vbcrlf & "        <td height=""27"" colspan="""
		Response.write num1_ls+5
		Response.write "" & vbcrlf & "    <tr>" & vbcrlf & "        <td height=""27"" colspan="""
		Response.write """ ><div align=""center"">没有信息<img src=""../images/jiantou.gif""><a href=""javascript:;"" onClick=""javascript:window.open('../store/top6.asp?top="
		Response.write pwurl(ord)
		Response.write "&f=101','plancor5','width=' + 1440 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=0,top=100');return false;"" title=""点击添加明细""><font class=""blue2"">添加组装明细</font></a></div></td>" & vbcrlf & "    </tr>" & vbcrlf & ""
		'Response.write pwurl(ord)
	else
		sum=0
		num=0
...
'do until rss.eof
			...
			set rs7=nothing
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select sort1,sort from sortck where ord="&rss("ck")&""
			rs7.open sql7,conn,1,1
			if rs7.eof then
				ckname=""
			else
			...
			Response.write "" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    "
			set rs=server.CreateObject("adodb.recordset")
			sql="select id,title,name,sort,kd,set_open,sorce,gate1 from zdymx where sort1=1005 and sorce not in (9,10"& CBField &") and set_open=1 order by gate1 asc "
			rs.open sql,conn,1,1
			do until rs.eof
				sorce=rs("sorce")
				kd=rs("kd")
				...
				Response.write""&k&""
				Response.write "" & vbcrlf & "                        </a></span></div></td>" & vbcrlf & "                        "
				Case 2:
				Response.write "" & vbcrlf & "                                             <td width="""
				Response.write kd
				Response.write """ height=""20""><div align=""center"">"
				...
				Response.write "</div></td>" & vbcrlf & "                        "
				if isOpenProductAttrV then
					Response.write "" & vbcrlf & "                                 <td width=""90"" class=""name""><div align=""center"">"
					Response.write  GetProductAttrNameById(rss("ProductAttr1"))
					Response.write "</div></td>" & vbcrlf & "                              <td width=""90"" class=""name""><div align=""center"">"
					Response.write  GetProductAttrNameById(rss("ProductAttr2"))
					Response.write "</div></td>" & vbcrlf & "                        "
				end if
				Case 5:
			...
			rs.close
			Response.write "" & vbcrlf & "    </tr> " & vbcrlf & ""
			mmm = mmm + Formatnumber(zbcdbl(rss("money1")),num_dot_xs,-1)
			'Response.write "" & vbcrlf & "    </tr> " & vbcrlf & ""
			k2=k2+1
			'Response.write "" & vbcrlf & "    </tr> " & vbcrlf & ""
			rss.movenext
		Loop
		mmm = Formatnumber( mmm ,num_dot_xs,-1)
'Loop
		Response.write "" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td height=""27"" colspan="""
		Response.write adressNum1+ProductAttrColNum
		Response.write """><div align=""center"">合计<img src=""../images/jiantou.gif""><a href=""javascript:;"" onClick=""javascript:window.open('../store/top6.asp?top="
		Response.write pwurl(ord)
		Response.write "','newwin22','width=' + 1440 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=0,top=100');return false;""  title=""点击编辑明细"">重新编辑</a></div></td>" & vbcrlf & "        <td height=""27"" class=""red""><div align=""center"">"
		'Response.write pwurl(ord)
		Response.write Formatnumber(num,num1_dot,-1)
		'Response.write pwurl(ord)
		Response.write "</div></td>" & vbcrlf & "        "
		if IsOpenRKPrice then
			Response.write "" & vbcrlf & "                  <td height=""20"" colspan=""1"">&nbsp;</td>" & vbcrlf & "             <td height=""20"" colspan=""1""><div align=""right"">"
			Response.write mmm
			Response.write "</div></td>" & vbcrlf & "            "
		else
			num1_ls = num1_ls +2
		...
		If num1_ls>adressNum1+3 Then
			Response.write "</div></td>" & vbcrlf & "            "
			Response.write "" & vbcrlf & "                      <td colspan="""
			Response.write num1_ls-adressNum1-3
			'Response.write "" & vbcrlf & "                      <td colspan="""
			Response.write """ height=""20""></td>" & vbcrlf & "          "
		end if
		Response.write "" & vbcrlf & "    </tr>" & vbcrlf & ""
	end if
	rss.close
	...
	conn.close
	set conn=nothing
	Response.write "" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>"
