...
function lx() {
    for (var i = 1; i < 1000; i++) {
        if (document.getElementById("lx_" + i)) {
            document.getElementById("lx_" + i).value = document.getElementById("lxall").value;
        }
    }
    xmlHttp.abort();
}
...
function invrateall() {
	for (var i = 1; i < 1000; i++) {
		if (document.getElementById("invrate_" + i)) {
			document.getElementById("invrate_" + i).value = document.getElementById("invrate_all").value;
		}
	}
	xmlHttp.abort();
}
