...
'imgurl = "../code2/viewCode.asp?codeType=128&data=HTID:"& v &"&height=60"
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<link href=""../inc/datePicker.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script language=""javascript"" src=""../Inc/DelUnusedFiles.js?ver="
	Response.write Application("sys.info.jsver")
...
'set rs=nothing
	...
	Response.write Format_Time(dateStr,2)
	Response.write "'})" & vbcrlf & "});" & vbcrlf & "</script>" & vbcrlf & "<script src= ""../Script/pn_addhome.js?ver="
	Response.write Application("sys.info.jsver")
	...
	rs1.close
	set rs1=nothing
	If Len(intro_71_6&"")=0 Then intro_71_6=0
	Str_power=""
	Str_power22=""
	Str_power33=""
	sorce=0
	...
	if time1="" then
		...
		time1=(CInt(time1)+1)&""
		time1="09"
		If Len(time1)=1 Then time1="0"&time1
	end if
	time2=request("time2")
	if time2="" then
		time2="00"
	...
	If time11="" Or isnull(time11) Then
		time11=(CInt(time1)-1)&""
'If time11="" Or isnull(time11) Then
		If Len(time11)=1 Then time11="0"&time11
	end if
	If time22="" Or isnull(time22) Then
		time22=time2
	end if
	sort_zjjg = 4
	Response.write "" & vbcrlf & "     <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">日程添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "       <form method=""post"" action=""savehome.asp?date1="
	...
	Response.write date2
	Response.write "&sxw="
	Response.write request("time1")
	Response.write """ id=""demo"" onsubmit=""return Validator.Validate(this,2)&&DelUnusedFilesBeforeSubmit()"" name=""date"">" & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "            <tr class=""top"">" & vbcrlf & "            <td colspan=""4""><div align=""left"">特别提示：如果要添加多项日程，只需要点击报表界面的“上午”或“下午”所在单元格即可</div></td>" & vbcrlf & "            </tr>" & vbcrlf & "           "
	if session("cateidzbintel")<"5" then
		Response.write "" & vbcrlf & "             <tr>" & vbcrlf & "              <td width=""118""><div align=""right"">执行人： </div></td>" & vbcrlf & "             <td colspan=""3""><div align=""left"">"
...
'If Len(exists_Pics) = 0 Then
	...
	Call regExistsFiles(sdk,intro3)
	Response.write "" & vbcrlf & "             <tr>" & vbcrlf & "        <td  width=""118""><div align=""right"">日程内容： " & vbcrlf & "          </div>" & vbcrlf & "          <div align=""right""></div></td>" & vbcrlf & "        <td colspan=""3""><textarea name=""intro3"" style=""display:none"" cols=""1"" rows=""1"">"
	if intro3<>"" then Response.write intro3
	Response.write "</textarea>" & vbcrlf & "                    <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=intro3&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME>" & vbcrlf & "          <span class=""gray""><span class=""red"">*</span></span></td> "& vbcrlf &      "</tr>" & vbcrlf &     " <tr>" & vbcrlf &       "  <td width=""148"" align=""right""> "& vbcrlf &       "  开始时间： "& vbcrlf & "</td> "& vbcrlf &         "<td  colspan=""3""><input name=ret2 class=""date-pick"" value="
'if intro3<>"" then Response.write intro3
	Response.write Format_Time(date1,2)
	Response.write """ id=""ret2"" size=10 readonly=""readonly"">" & vbcrlf & "          <span class=""gray""><span class=""red"">*</span></span>" & vbcrlf & "          <select name=""time11"">" & vbcrlf & "                      <option value="""
	Response.write time11
	Response.write """>"
	Response.write time11
	Response.write "</option>" & vbcrlf & "            <option value=""00"">00</option>" & vbcrlf & "            <option value=""01"">01</option>" & vbcrlf & "            <option value=""02"">02</option>" & vbcrlf & "            <option value=""03"">03</option>" & vbcrlf & "            <option value=""04"">04</option>" & vbcrlf & "            <option value=""05"">05</option>" & vbcrlf & "            <option value=""06"">06</option>" & vbcrlf & "            <option value=""07"">07</option>" & vbcrlf & "            <option value=""08"">08</option>" & vbcrlf & "            <option value=""09"">09</option>" & vbcrlf & "            <option value=""10"">10</option>" & vbcrlf & "            <option value=""11"">11</option>" & vbcrlf & "            <option value=""12"">12</option>" & vbcrlf & "            <option value=""13"">13</option>" & vbcrlf & "            <option value=""14"">14</option>" & vbcrlf & " <option value=""15"">15</option>" & vbcrlf & "            <option value=""16"">16</option>" & vbcrlf & "            <option value=""17"">17</option>" & vbcrlf & "            <option value=""18"">18</option>" & vbcrlf & "            <option value=""19"">19</option>" & vbcrlf & "           <option value=""20"">20</option>" & vbcrlf & "            <option value=""21"">21</option>" & vbcrlf & "            <option value=""22"">22</option>" & vbcrlf & "            <option value=""23"">23</option>" & vbcrlf & "          </select>" & vbcrlf & "            时" & vbcrlf & "              <select name=""time22"">" &vbcrlf & "                  <option value="""
	Response.write time22
	Response.write """>"
	Response.write time22
	Response.write "</option>" & vbcrlf & "              <option value=""00"">00</option>" & vbcrlf & "            <option value=""05"">05</option>" & vbcrlf & "            <option value=""10"">10</option>" & vbcrlf & "            <option value=""15"">15</option>" & vbcrlf & "            <option value=""20"">20</option>" & vbcrlf & "            <option value=""25"">25</option>" & vbcrlf & "             <option value=""30"">30</option>" & vbcrlf & "            <option value=""35"">35</option>" & vbcrlf & "            <option value=""40"">40</option>" & vbcrlf & "            <option value=""45"">45</option>" & vbcrlf & "            <option value=""50"">50</option>" & vbcrlf & "            <option value=""55"">55</option>" & vbcrlf & "           </select>" & vbcrlf & "               分 " & vbcrlf & "" & vbcrlf & "             <SCRIPT language=JavaScript1.2>" & vbcrlf & "                 function Cancel() {hideElement(""daysOfMonth"");}" & vbcrlf & "           </SCRIPT></td>" & vbcrlf & "       " & vbcrlf & "      </tr>" & vbcrlf & "          <tr> <td width=""148""><div  align=""right"">截止时间： </div></td>" & vbcrlf & "        <td  colspan=""3""><input name=ret class=""date-pick"" value="""
	Response.write time22
	Response.write Format_Time(date2,2)
	Response.write """ id=""ret"" size=10 readonly=""readonly"">" & vbcrlf & "          <span class=""gray""><span class=""red"">*</span></span>" & vbcrlf & "          <select name=""time1"">" & vbcrlf & "                        <option value="""
	Response.write time1
	Response.write """>"
	Response.write time1
	Response.write "</option>" & vbcrlf & "            <option value=""00"">00</option>" & vbcrlf & "            <option value=""01"">01</option>" & vbcrlf & "            <option value=""02"">02</option>" & vbcrlf & "            <option value=""03"">03</option>" & vbcrlf & "            <option value=""04"">04</option>" & vbcrlf & "            <option value=""05"">05</option>" & vbcrlf & "            <option value=""06"">06</option>" & vbcrlf & "            <option value=""07"">07</option>" & vbcrlf & "            <option value=""08"">08</option>" & vbcrlf & "            <option value=""09"">09</option>" & vbcrlf & "            <option value=""10"">10</option>" & vbcrlf & "            <option value=""11"">11</option>" & vbcrlf & "            <option value=""12"">12</option>" & vbcrlf & "            <option value=""13"">13</option>" & vbcrlf & "            <option value=""14"">14</option>" & vbcrlf & " <option value=""15"">15</option>" & vbcrlf & "            <option value=""16"">16</option>" & vbcrlf & "            <option value=""17"">17</option>" & vbcrlf & "            <option value=""18"">18</option>" & vbcrlf & "            <option value=""19"">19</option>" & vbcrlf & "           <option value=""20"">20</option>" & vbcrlf & "            <option value=""21"">21</option>" & vbcrlf & "            <option value=""22"">22</option>" & vbcrlf & "            <option value=""23"">23</option>" & vbcrlf & "          </select>" & vbcrlf & "            时" & vbcrlf & "              <select name=""time2"">" & vbcrlf & "           <option value="""
	Response.write time2
	Response.write """>"
	Response.write time2
	Response.write "</option>" & vbcrlf & "              <option value=""00"">00</option>" & vbcrlf & "            <option value=""05"">05</option>" & vbcrlf & "            <option value=""10"">10</option>" & vbcrlf & "            <option value=""15"">15</option>" & vbcrlf & "            <option value=""20"">20</option>" & vbcrlf & "            <option value=""25"">25</option>" & vbcrlf & "             <option value=""30"">30</option>" & vbcrlf & "            <option value=""35"">35</option>" & vbcrlf & "            <option value=""40"">40</option>" & vbcrlf & "            <option value=""45"">45</option>" & vbcrlf & "            <option value=""50"">50</option>" & vbcrlf & "            <option value=""55"">55</option>" & vbcrlf & "           </select>" & vbcrlf & "               分 " & vbcrlf & "" & vbcrlf & "             <SCRIPT language=JavaScript1.2>" & vbcrlf & "                 function Cancel() {hideElement(""daysOfMonth"");}" & vbcrlf & "           </SCRIPT>" & vbcrlf & "               </td></tr>" & vbcrlf & "                      <tr>" & vbcrlf & "          <td width=""148""><div align=""right"">是否提醒： </div></td>" & vbcrlf & "          <td colspan=""3""><input name=""option1"" type=""radio"" value=""0"" checked>" & vbcrlf & "            提醒" & vbcrlf & "              <input type=""radio"" name=""option1"" value=""1"">" & vbcrlf & "            不提醒</td>" & vbcrlf & "</tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td><div align=""right"">重要级别：" & vbcrlf & "          " & vbcrlf & "        </div></td>" & vbcrlf & "        <td colspan=""3""><input name=""gate"" type=""radio"" value=""4"" checked>" & vbcrlf & "          重要且紧急　" & vbcrlf & "            <input type=""radio"" name=""gate"" value=""3"">" & vbcrlf & "            重要不紧急　" & vbcrlf & "            <input type=""radio"" name=""gate"" value=""2"">" & vbcrlf & "            紧急不重要　" & vbcrlf & "            <input type=""radio"" name=""gate"" value=""1"">" & vbcrlf & "            不紧急不重要</td>" & vbcrlf & "        </tr>" & vbcrlf & "     "
	If ZBRuntime.MC(1001) Then
		session("companyzbintel") = ""
		Response.write "" & vbcrlf & "             <tr>" & vbcrlf & "            <td><div align=""right"">关联客户：</div></td>" & vbcrlf & "              <td colspan=""3""><span id=""khmc"">" & vbcrlf & "            <input name=""company"" type=""text""  style=""color: #999999;"" size=""25"" onClick=""javascript:window.open('../search/result4.asp?cc=2','eventcom','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=100,top=100');return false;"" readonly=""true"" dataType=""Limit"" min=""0"" max="""
'session("companyzbintel") = ""
	...
	If ZBRuntime.MC(3000) Then
		...
		session("chancezbintel") = chance
		if chance&""<>"" then
			chancename = sdk.getSqlvalue("select title from chance where ord = " & chance , "")
		end if
		Response.write "" & vbcrlf & "             <tr><td  width=""148""><div align=""right"">关联项目：</div></td>" & vbcrlf & "               <td colspan=""3""><span id=""xmmc"">" & vbcrlf & "            <input name=""chancename"" type=""text"" style=""color: #999999;"" value="""
		Response.write chancename
		Response.write """""  size=""25"" onClick=""javascript:window.open('../search/result3.asp?cc=2','eventcom','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=100,top=100');return false;"" readonly=""true""  value=""点击选择项目"" >" & vbcrlf & "            <input name=""chance"" type=""hidden"" value="""
		Response.write session("chancezbintel")
		Response.write """"" size=""5"">" & vbcrlf & "             </span></td>" & vbcrlf & "            </tr>" & vbcrlf & "   "
	end if
	Response.write "" & vbcrlf & "     <tr><td  width=""148""><div align=""right"">是否循环：</div></td>" & vbcrlf & "               <td colspan=""3""><input name=""isXunhuan"" type=""radio"" value=""0"" checked>不循环　<input name=""isXunhuan"" type=""radio"" value=""1"" >日循环　　<input name=""isXunhuan"" type=""radio"" value=""2"" >周循环　<input name=""isXunhuan"" type=""radio"" value=""3"" >月循环" & vbcrlf & "         </span></td>" & vbcrlf & "          </tr>" & vbcrlf & "      <tr> " & vbcrlf & "        <td height=""50"" colspan=""4"">  " & vbcrlf & "            <div align=""center"">" & vbcrlf & "                        <input type=""submit"" name=""Submit42"" value=""增加""  class=""page""/>" & vbcrlf & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & vbcrlf & "              <input type=""submit"" name=""Submit42"" value=""保存""  class=""page""/>" & vbcrlf & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & vbcrlf & "              <input type=""reset"" value=""重填"" class=""page"" name=""B2"">　　　　　　　" & vbcrlf & "              </div></td>" & vbcrlf & "        </tr>    " & vbcrlf & "    </table>" & vbcrlf & "  </form> " & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""60"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "       </td>  " & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="日程添加"
	call close_list(1)
	Response.write "" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & "<script src= ""../Script/pn_addhome_1.js?ver="
	Response.write Application("sys.info.jsver")
