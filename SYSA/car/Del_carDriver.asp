...
'bigsystemtype = ".mozi"
	...
	sql="delete from O_CarDriver where id in ("&ord&")"
	conn.execute(sql)
	action1="车辆司机删除"
	call close_list(2)
	Response.write "<script>window.location='List_carDriver.asp?CurrPage="&CurrPage&"&A="&ml.Dep(A)&"&B="&ml.Dep(B)&"&C="&ml.Dep(C)&"&page_count="&page_count&"'</script>"
