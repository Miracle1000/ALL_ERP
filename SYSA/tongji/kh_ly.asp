...
'bigsystemtype = ".mozi"
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "      margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "" & vbcrlf & "</style>" & vbcrlf & "    <style>" & vbcrlf & "        body{" & vbcrlf & "            background:#fff!important;" & vbcrlf & "        }" & vbcrlf & "        #user{" & vbcrlf & "            padding:0 10px;" & vbcrlf & "        }" & vbcrlf & "        .canvas-sort{" & vbcrlf & "            margin-top:20px;" & vbcrlf & "        }" & vbcrlf & "    </style>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"">" & vbcrlf & "<!--" & vbcrlf & "function MM_jumpMenu(targ,selObj,restore){ //v3.0" & vbcrlf & "eval(targ+"".location=\'""+selObj.options[selObj.selectedIndex].value+""\'"");" & vbcrlf & "if (restore) selObj.selectedIndex=0;" & vbcrlf & "}" & vbcrlf & "//-->" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "" & vbcrlf & "<body  oncontextmenu=self.event.returnValue=false  onMouseOver=""window.status='none';return true;""  scroll=AUTO>" & vbcrlf & ""
	...
	Str_Result2=Str_Result2+"and sort3="&sort3&""
	sort3=1
	gate_result=""
	if m1<>"" then
...
'if F<>"" then
	...
	Response.write "" & vbcrlf & "      <div id=""user"" name=""user""  style=""position:absolute;left:0; top:0;width:100%; height:10;"">" & vbcrlf & "   <table class=""resetTableBg"" width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">客户批量领用统计</td>" & vbcrlf & "            <td  align=""left"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img class=""resetElementHidden"" src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""table-layout:fixed"">" & vbcrlf & "<tr class=""top"">" & vbcrlf & "<form method=""POST"" action=""kh_ly.asp?width_tj="
	width_tj=550
	Response.write width_tj
	Response.write "&sort3="
	Response.write sort3
	Response.write """ id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "<td class=""resetHeadBg"" valign=""middle"" style=""height:55px;line-height:20px;background:#f4fafe;overflow:visible""><span>选择统计条件：</span>" & vbcrlf & ""
	'Response.write sort3
	Dim arrShow()
	Dim arrName()
	...
	Response.write "" & vbcrlf & "<input type=""submit"" name=""Submit422"" value=""统计""  class=""anybutton2""/></td></form>" & vbcrlf & "  </tr></table>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" class=""canvas-sort"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30""align=""right"">" & vbcrlf &  "        <input type=""button"" name=""pillar"" value=""柱状图分析"" onClick=""window.location.href='kh_ly.asp?type_tj=1&sort="
	Response.write E
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "          <input type=""button"" name=""zxt"" value=""折线图分析"" onClick=""window.location.href='kh_ly.asp?type_tj=2&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&sort3="
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "        <input type=""button"" name=""line"" value=""饼图分析"" onClick=""window.location.href='kh_ly.asp?type_tj=3&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&sort3="
	...
	Response.write ">图宽=550</option>" & vbcrlf & "              <option value=""kh_ly.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=700</option>" & vbcrlf & "              <option value=""kh_ly.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=1000</option>" & vbcrlf & "              <option value=""kh_ly.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=1500</option>" & vbcrlf & "              <option value=""kh_ly.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=2000</option>" & vbcrlf & "              <option value=""kh_ly.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	if open_1_10=1 or open_1_10=3  then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认将统计结果导出为EXCEL文档？')){window.location.href='kh_ly.asp?type_tj=4&sort="
		Response.write E
		Response.write "&sort1="
		Response.write F
		Response.write "&sort3="
	...
	dim numcg1,zs1
	set rs1=server.CreateObject("adodb.recordset")
	sql1 = " select ord,name, isnull(c,0) as c from gate left join (select cateid as xx, count(1) as c from tel where sort3=1 and cateorder1=cateid "&Str_Result2&" group by cateid) b on b.xx=ord " &Str_power33&" order by sorce asc,cateid asc,sorce2 asc"
	rs1.open sql1,conn,1,1
	...
	if counts<=0 then
		...
		do until rs1.eof
			numcg1=rs1("c").value
			title=rs1("name")
			lburl="../work/telhy.asp?W3="&rs1("ord")&"&H=21&E="&E&"&F="&F&"&D="&khhy&"&A1="&khjz&"&A3="&khly&"&ret="&m1&"&ret2="&m2&""
			total1(j,1)=numcg1
			total1(j,2)=title
			total1(j,0)=lburl
			total2(j,0)=title
...
'Response.write i
	...
	Dim broFirefox
    'response.write "asdf" : response.end
	broFirefox = "firefox"
