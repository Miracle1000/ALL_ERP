...
'bigsystemtype = ".mozi"
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""5"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td colspan=""2""><a href=""product.asp"" class=""AfterQuickSearch""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u  style='color:red'><font class=""advanSearch"">正常状态</font></u></a>         </td> "& vbcrlf &         "   </tr> "& vbcrlf &  "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'""> "& vbcrlf &         "     <td><div align=""right"">产品分类：</div></td> "& vbcrlf &" <td>" & vbcrlf & ""
	dim MODULES
	MODULES=session("zbintel2010ms")
	execute sdk.vbs("../manager/search_product.asp")
	Response.write "" & vbcrlf & "       </td>" & vbcrlf & "  </tr>" & vbcrlf & " <script type=""text/javascript"">" & vbcrlf & "    function checkAll(str){" & vbcrlf & "        var a=document.getElementById(""d""+str).getElementsByTagName(""input"");" & vbcrlf & "        var b=document.getElementById(""t""+str);& vbcrlf &         for(var i=0;i<a.length;i++){ & vbcrlf &             a[i].checked=b.checked; & vbcrlf &         } & vbcrlf &     } & vbcrlf & vbcrlf &     function fixChk(str){ & vbcrlf &         var a=document.getElementById(""t1"").getElementsByTagName(""input""); & vbcrlf & var b=document.getElementById(""d1"");" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf & "            if(a[i].checked==false){" & vbcrlf & "                b.checked=false;" & vbcrlf & "                return ;" & vbcrlf & "            }" & vbcrlf & "        }" & vbcrlf & "      b.checked=true;" & vbcrlf & "    }" & vbcrlf & "  </script>" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & "    function checkAll2(str){" & vbcrlf & "        var a=document.getElementById(""u""+str).getElementsByTagName(""input"");" & vbcrlf & "        var b=document.getElementById(""e""+str);" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf &       "      a[i].checked=b.checked;" & vbcrlf &   "      } "& vbcrlf &  "   } "& vbcrlf & vbcrlf &   "  function fixChk2(str){ "& vbcrlf &      "   var a=document.getElementById(""u1"").getElementsByTagName(""input""); "& vbcrlf & "        var b=document.getElementById(""e1"");" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf & "            if(a[i].checked==false){" & vbcrlf & "                b.checked=false;" & vbcrlf & "                return ;" & vbcrlf & "            }" & vbcrlf & "        }" & vbcrlf & "        b.checked=true;" & vbcrlf & "    }" & vbcrlf & "  </script>" & vbcrlf & "  <script type=""text/javascript"">" & vbcrlf & "    function checkAll3(str){" & vbcrlf & "        var a=document.getElementById(""h""+str).getElementsByTagName(""input"");" & vbcrlf & "        var b=document.getElementById(""i""+str);" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf & "            a[i].checked=b.checked;" & vbcrlf & "        }" & vbcrlf & "    }" & vbcrlf & "" & vbcrlf & "    function fixChk3(str){" & vbcrlf & "        var a=document.getElementById(""h1"").getElementsByTagName(""input"");" & vbcrlf & "        var b=document.getElementById(""i1"");" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf & "            if(a[i].checked==false){" & vbcrlf & "                b.checked=false;" & vbcrlf & "                return ;" & vbcrlf & "            }" & vbcrlf & "        }"& vbcrlf &       "  b.checked=true;" & vbcrlf &    " } "& vbcrlf &  " </script>" & vbcrlf &  " <script type=""text/javascript"">" & vbcrlf &    " function checkAll7(str){" & vbcrlf &   "      var a=document.getElementById(""Wd""+str).getElementsByTagName(""input"");" & vbcrlf &    "     var b=document.getElementById(""Wt""+str);" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf & "            a[i].checked=b.checked;" & vbcrlf & "        }" & vbcrlf & "    }" & vbcrlf & "" & vbcrlf & "    function fixChk7(str){" & vbcrlf & "        var a=document.getElementById(""Wd1"").getElementsByTagName(""input"");" & vbcrlf & "        var b=document.getElementById(""Wt1"");" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf & "            if(a[i].checked==false){" & vbcrlf & "                b.checked=false;" & vbcrlf & "                return ;" & vbcrlf & "            }" & vbcrlf & "        }" & vbcrlf & "        b.checked=true;" & vbcrlf & "    }" & vbcrlf & "  </script>" & vbcrlf & "  <script type=""text/javascript"">" & vbcrlf & "    function checkAll4(str){" & vbcrlf & "        var a=document.getElementById(""j""+str).getElementsByTagName(""input"");" & vbcrlf & "    var b=document.getElementById(""k""+str);" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf & "            a[i].checked=b.checked;" & vbcrlf & "        }" & vbcrlf & "    }" & vbcrlf & "" & vbcrlf & "    function fixChk4(str){" & vbcrlf & "        var a=document.getElementById(""j1"").getElementsByTagName(""input"");" & vbcrlf & "        var b=document.getElementById(""k1"");" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf & "            if(a[i].checked==false){" & vbcrlf & "                b.checked=false;" & vbcrlf & "                return ;" & vbcrlf & "          }" & vbcrlf & "        }" & vbcrlf & "        b.checked=true;" & vbcrlf & "    }" & vbcrlf & "  </script>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "<td><div align=""right"">产品名称：</div></td>" & vbcrlf & "   <td><select name=""F1"">" & vbcrlf & " <option value=""1"">包含</option>" & vbcrlf & "   <option value=""2"">不包含</option>" & vbcrlf & " <option value=""3"">等于</option>" & vbcrlf & "   <option value=""4"">不等于</option>" & vbcrlf & " <option value=""5"">以..开始</option>" & vbcrlf & "       <option value=""6"">以..结束</option>"& vbcrlf &    "  </select>" & vbcrlf &    "    <input name=""F2"" type=""text"" size=""15""></td>" & vbcrlf &" </tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColorelect"" name=""G1"">" & vbcrlf & " <input name=""G2"" type=""text"" size=""15""></td> "& vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColord"">" & vbcrlf & "   <td><select name=""P1"">" & vbcrlf & "    <option value=""1"">包含</option>" & vbcrlf & "    <option value=""2"">不包含</option>" & vbcrlf & "    <option value=""3"">等于</option>" & vbcrlf & "    <option value=""4"">不等于</option>" & vbcrlf & "    <option value=""5"">以..开始</option>" & vbcrlf & "    <option value=""6"">以..结束</option>" & vbcrlf & "    </select>" & vbcrlf & "     <input name=""P2"" type=""text"" size=""15""></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">删除人：</div></td> "& vbcrlf &     "  <td><input name=""D2"" type=""text"" size=""15""></td>" & vbcrlf & "</tr>" & vbcrlf &" <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf &     "<td><div align=""right"">删除日期：</div></td> "& vbcrlf & "<td>&nbsp;自：<INPUT readonly=""true"" name=""ret3"" size=9 onmousedown=""datedlg.show()"" value="""
	Response.write m1
	Response.write """>&nbsp;至：<INPUT name=""ret4"" readonly=""true"" size=9 onmousedown=""datedlg.show()"" value="""
	Response.write m2
	Response.write """></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "<td width=""10%"">&nbsp;</td>" & vbcrlf & "<td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""><input type=""HIDDEN"" value=""2"" class=""page"" name=""searchtype""></td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
