...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	if not rs7.eof then
		do while not rs7.eof
			if rs7("name")="书名" then
				Response.write "" & vbcrlf & "                      var td1 = document.createElement('td');" & vbcrlf & "                 tr.appendChild(td1);" & vbcrlf & "                    var Href = ""<div align=\""left\""><pre><input type=\""text\"" readonly='true' style='color:#CCCCCC;' name=\""bookname\"" id=\""bookname""+b+""\"" size=\""15\"" value=\""点击选择图书\"" maxlength=\""2000\""><input type=\""hidden\"" id=\""Ld_bkid""+b+""\"" name=\""Ld_bkid\"">&nbsp;<a href=\""###\"" onclick=\""del_TR('""+tr.id+""')\""><img src=\""../images/del2.gif\""/></a>&nbsp;<span id='sortlist'>""+a+""</span></div>"";" & vbcrlf & "                  td1.innerHTML=Href;" & vbcrlf & "             "
'if rs7("name")="书名" then
			end if
			if rs7("name")="编号" then
...
'if rs7("name")="添加时间" then
			...
			if rs7("name")="借阅数量" then
				Response.write "" & vbcrlf & "     var td23 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td23);" & vbcrlf & "   var Href = ""<div align=\""center\""><pre><input name=\""Ld_num\"" type=\""text\"" id=\""Ld_num\"" value=\""1\"" size=\""10\"" maxlength=\""20\"" onkeyup=\""value=value.replace(/[^\\d]/g,'')\"" onFocus=\""this.select()\"" onpropertychange=\""allsum()\""><img src='../images/116.png' title='借阅数量明细' onmouseover='extdiv(this,""+b+"")' onmouseout='disdiv()'><input type=\""hidden\"" name=\""nums\"" id=\""nums""+b+""\""></div>"";" & vbcrlf & "        td23.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="借阅数量" then
			end if
			if rs7("name")="借阅时间" then
				Response.write "" & vbcrlf & "     var td24 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td24);" & vbcrlf & "   var Href = ""<div align=\""center\""><input name=\""Ld_time""+b+""\"" type=\""text\"" size=\""9\"" value=\"""
'if rs7("name")="借阅时间" then
				Response.write date
				Response.write "\"" id=\""daysOfMonthPosy""+b+""\"" onmouseup=toggleDatePicker(\""daysOfMonthy""+b+""\"",\""date.Ld_time""+b+""\"") onpropertychange=\""setdate('""+b+""')\"" readonly=\""true\""><DIV id=daysOfMonthy""+b+"" style=\""POSITION: absolute;z-index:10\""></DIV><input type=\""hidden\"" name=\""timenum\"" id=\""timenum""+b+""\""></div>"";" & vbcrlf & "   td24.innerHTML=Href;" & vbcrlf & "    "
			end if
			if rs7("name")="归还时间" then
				Response.write "" & vbcrlf & "     var td25 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td25);" & vbcrlf & "   var Href = ""<div align=\""center\""><input name=\""Ld_rettime""+b+""\"" type=\""text\"" size=\""9\"" value=\"""
'if rs7("name")="归还时间" then
				Response.write date
				Response.write "\"" id=\""daysOfMonthPosx""+b+""\"" onmouseup=toggleDatePicker(\""daysOfMonthx""+b+""\"",\""date.Ld_rettime""+b+""\"") readonly=\""true\""><DIV id=daysOfMonthx""+b+"" style=\""POSITION: absolute;z-index:10\""></DIV></div>"";" & vbcrlf & "     td25.innerHTML=Href;" & vbcrlf & "    "
				Response.write date
			end if
			if rs7("name")="图书备注" then
				Response.write "" & vbcrlf & "     var td26 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td26);" & vbcrlf & "   var Href = ""<div align=\""center\""><input type=\""\"" name=\""Ld_note\"" id=\""Ld_note\"" size=\""15\"" maxlength=\""2000\""></div>"";" & vbcrlf & "    td26.innerHTML=Href;" & vbcrlf & "    "
			end if
			rs7.movenext
		loop
	end if
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "     allsum();" & vbcrlf & "       a=a+1;" & vbcrlf & "  b=b+1;" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body { margin-top: 0px;}" & vbcrlf & "img{border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "#adddiv{" & vbcrlf & "     width:1000px;height:500px;OVERFLOW:auto;" & vbcrlf & "        padding-left:30px;" & vbcrlf & "SCROLLBAR-FACE-COLOR:#F0F4FD;SCROLLBAR-HIGHLIGHT-COLOR:#ffffff;SCROLLBAR-SHADOW-COLOR:#919192;SCROLLBAR-3DLIGHT-COLOR:#ffffff;SCROLLBAR-ARROW-COLOR:#919192;SCROLLBAR-TRACK-COLOR:#ffffff;SCROLLBAR-DARKSHADOW-COLOR:#ffffff;}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"" scroll=""auto"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" &vbcrlf & "    <td width=""100%"" valign=""top"">   " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">借阅添加</td>" & vbcrlf & "            <td>&nbsp;</td>" &vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "     <form action=""Save_Lend.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)&&ask1()"">" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td width=""13%"" height=""27"" ><div align=""left""><strong>基本信息</strong></div></td>" & vbcrlf & "        <td width=""87%"" height=""27"">" & vbcrlf & "                 <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "              <input type=""button"" value=""重填"" class=""page"" name=""B22"" onclick=""window.location.reload()"">" & vbcrlf & "                 </div></td>" & vbcrlf & "        </tr>      " & vbcrlf & "        <tr>" & vbcrlf & "            <td colspan=""2"" >" & vbcrlf & "                 <div id=""adddiv"" style=""width:101%"">" & vbcrlf & "                      <table border=""0"" width=""100%"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                              <tr class=""top"">" & vbcrlf & "                          "
	sql7="select name from O_BookField where setopen in(2,3) order by sort1 asc"
	set rs7=server.CreateObject("adodb.recordset")
	rs7.open sql7,conn,3,1
	if rs7.eof Then
		Response.write("<script>alert('系统缺少图书字段信息，请先设置图书字段！\n\n或者升级系统获取默认字段！');history.back();</script>")
		action1="图书借阅添加":call close_list(1)
		Response.end()
	else
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "                             </tr>" & vbcrlf & "                           <tbody id=""add_tr"">" & vbcrlf & "                               "
	if ord<>"" then
		h=1
		sql8="select a.*,b.set_name,e.name from O_regbook a "&_
		"left join gate e on a.bk_addcateid=e.ord "&_
		"left join O_bookset b on a.bk_type=b.id where a.id in("&ord&")"
		set rs8=conn.execute(sql8)
		if not rs8.eof then
			do while not rs8.eof
				bk_returnnum=rs8("bk_returnnum")
				if bk_returnnum="" or isnull(bk_returnnum) then bk_returnnum=0
				returntime=dateadd("m",bk_returnnum,date)
				returntime=dateadd("d",-1,returntime)
				returntime=dateadd("m",bk_returnnum,date)
				...
				if not rs7.eof then
					...
					do while not rs7.eof
						if rs7("name")="书名" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><div align=""left""><pre><input type=""text"" readonly='true' name=""bookname"" id=""bookname"
							Response.write h
							Response.write """ size=""15"" value="""
							Response.write rs8("bk_name")
							Response.write """ maxlength=""2000""><input type=""hidden"" id=""Ld_bkid"
							Response.write h
							Response.write """ name=""Ld_bkid"" value="""
						...
						if rs7("name")="借阅周期" then
							...
							Response.write "个月</div></td>" & vbcrlf & "                                              "
						end if
						if rs7("name")="作者" then
...
'if bk_allmoney="" or isnull(bk_allmoney) then bk_allmoney=0
						...
						if rs7("name")="借阅数量" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><div align=""center""><pre><input name=""Ld_num"" type=""text"" id=""Ld_num"" value=""1"" size=""10"" maxlength=""20"" onkeyup=""value=value.replace(/[^\d]/g,'')"" onFocus=""this.select()"" onpropertychange=""allsum()""><img src='../images/116.png' title='借阅数量明细' onmouseover='extdiv(this,"
							Response.write h
							Response.write ")' onmouseout='disdiv()'><input type=""hidden"" name=""nums"" value="""
							Response.write rs8("bk_num")
							Response.write """ id=""nums"
							Response.write h
							Response.write """></div></td>" & vbcrlf & "                                             "
						end if
						if rs7("name")="借阅时间" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><div align=""center""><input name=""Ld_time"
							Response.write h
							...
							Response.write h
							Response.write "','date.Ld_time"
							Response.write h
							Response.write "')"" onpropertychange=""setdate('"
							Response.write h
							Response.write "')"" readonly=""true""><DIV id=""daysOfMonthy"
							Response.write h
							Response.write """ style=""POSITION: absolute;z-index:10""></DIV><input type=""hidden"" name=""timenum"" value="""
							Response.write h
							Response.write rs8("bk_returnnum")
							Response.write """ id=""timenum"
							Response.write h
							Response.write """></div></td>" & vbcrlf & "                                             "
						end if
						if rs7("name")="归还时间" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><div align=""center""><input name=""Ld_rettime"
							Response.write h
							Response.write """ type=""text"" size=""9"" value="""
							...
							Response.write h
							Response.write """ style=""POSITION: absolute;z-index:10""></DIV></div></td>" & vbcrlf & "                                           "
							Response.write h
						end if
						if rs7("name")="图书备注" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><div align=""center""><input type="""" name=""Ld_note"" id=""Ld_note"" size=""15"" value="""" maxlength=""2000""></div></td>" & vbcrlf & "                                          "
						end if
						rs7.movenext
					loop
				end if
	...
	Response.write ColumnNum-4
	Response.write """ align=""right""><pre><a href=""javascript:void(0)"" onclick=""selectBook(b,'','',1);""><img src=""../images/jiantou.gif"" title=""添加明细""/>添加明细</a>&nbsp;合计：</td>" & vbcrlf & "                                 <td align=""center""><div id=""allnums"">"
	Response.write allnums
	Response.write "</div></td>" & vbcrlf & "                                  <td colspan=""6""></td>" & vbcrlf & "                             </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                  </div>" & vbcrlf & "                  </td>" & vbcrlf & "         </tr> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""2"" class=""gray"">" & vbcrlf & "                       <div align=""center"">" & vbcrlf & "                     <input type=""submit"" name=""Submit42"" value=""保存"" class=""page""/>" & vbcrlf & "                        <input type=""button"" value=""重填"" class=""page"" name=""B2"" onclick=""window.location.reload()"">" & vbcrlf & "             </div></td>" & vbcrlf & "      </tr> " & vbcrlf & "    </table>" & vbcrlf & "     </form>" & vbcrlf & "  </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"">" & vbcrlf & "     <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" &vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""adsDiv"" style=""position:absolute;z-index:2001;display:none;"">" & vbcrlf & "<iframe src="""" name=""adsIF"" id=""adsIF"" width=""300px"" frameborder=""0"" border=""0"" scrolling=""no""></iframe>" & vbcrlf & "</div>"& vbcrlf & "<form target=""ssIF"" action=""../book/ShowMessage.asp"" id=""ssIFForm"" style=""display:none"" method=""post"">" & vbcrlf & "</form>" & vbcrlf & "<div id=""ddd"" class=""easyui-dialog"" icon=""icon-search"" title=""选择图书""  style=""width:900px;height:500px;padding:5px;background:#fafafa;top:0px"" closed=""true"" >" & vbcrlf & "  <div region=""center"" border=""false"" style=""padding:5px;background:#fff;border:1px solid #ccc;width:100%"">" & vbcrlf & "             <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""  style=""word-break:break-all;word-wrap:break-word;""> " & vbcrlf & "                   <tr>" & vbcrlf & "                            <td height=""27""><div id=""resultbook""></div></td>" & vbcrlf & "                    </tr>" & vbcrlf & "           </table>" & vbcrlf & "        </div>" & vbcrlf & "  <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:20px; padding:8px;"">" & vbcrlf & "             <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$('#ddd').window('close');"">关闭</a>" & vbcrlf & " </div>" & vbcrlf & "</div>" & vbcrlf & ""
	Response.write allnums
	action1="图书借阅添加"
	call close_list(1)
