...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td colspan=""4""><a href=""javascript:void(0)"" class='AfterQuickSearch' onClick=""document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';return false;""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u  style='color:red'><font class=""advanSearch"">正常状态</font></u></a></td>" & vbcrlf & "    </tr>" & vbcrlf & "           <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">添加人员：</div></td>" & vbcrlf & "<td colspan=""3"">"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td></tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">卡片类别：</div></td>" & vbcrlf & "      <td colspan=""3"">" & vbcrlf & "          "
	...
	set rs7=nothing
	Response.write "       </td>" & vbcrlf & "       </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">计提周期：</div></td>" & vbcrlf & "      <td colspan=""3"">" & vbcrlf & "                     "
	for i=0 to 12
		...
		Response.write i
	next
	Response.write "<br />" & vbcrlf & "                        <input name=""D9"" type=""checkbox"" id=""D9"" value=""1"">年" & vbcrlf & "                   <input name=""D9"" type=""checkbox"" id=""D9"" value=""2"">月" & vbcrlf & "                   <input name=""D9"" type=""checkbox"" id=""D9"" value=""3"">台班         </td>" & vbcrlf & "     </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "       <td><div align=""right"">已提周期：</div></td>" & vbcrlf & "        <td colspan=""3"">" & vbcrlf & "                   "
	for i=0 to 12
		Response.write "" & vbcrlf & "                      <input name=""D18"" type=""checkbox"" id=""D18"" value="""
		Response.write i
		Response.write """>"
		Response.write i
	next
	Response.write "</td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">折旧方法：</div></td>" & vbcrlf & "      <td colspan=""3"">" & vbcrlf & "                     "
	sql7="select * from O_assSetMethod order by id desc"
	set rs7=conn.execute(sql7)
	if not rs7.eof then
		do while not rs7.eof
			Response.write "" & vbcrlf & "                      <input name=""D10"" type=""checkbox"" id=""D10"" value="""
			Response.write rs7("id")
			Response.write """>"
	...
	set rs7=nothing
	Response.write "              </td>" & vbcrlf & "     </tr>" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">资产名称：</div></td>" & vbcrlf & "      <td colspan=""3""><input name=""D3"" type=""text"" id=""D3"" size=""30"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">资产分类：</div></td>" & vbcrlf & "      <td colspan=""3""><input name=""D171"" type=""text"" id=""D171"" size=""30"" onclick=""adSearch(this,'1');""/><input name=""D17"" type=""hidden"" id=""D17"" size=""30"" /></td>" & vbcrlf & "               </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td><div align=""right"">资产编号：</div></td>" & vbcrlf & "                     <td width=""33%""><input name=""D4"" type=""text"" id=""D4"" size=""30""></td>" & vbcrlf & "             <td width=""15%""><div align=""right"">" & vbcrlf & "             <div align=""right"">资产型号：</div></td>" & vbcrlf & "             <td width=""42%""><input name=""D5"" type=""text"" id=""D5"" size=""30"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">存放地址：</div></td>" & vbcrlf & "         <td><input name=""D6"" type=""text"" id=""D6"" size=""30"" /></td>" & vbcrlf & "         <td><div align=""right"">资产状态：</div></td>" & vbcrlf & "         <td><input name=""D71"" type=""text"" id=""D71"" size=""30"" onclick=""adSearch(this,'2');"" /><input name=""D7"" type=""hidden"" id=""D7"" size=""30""/></td>" & vbcrlf &"       </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">净残值率：</div></td>" & vbcrlf & "      <td><input name=""D8"" type=""text"" id=""D8"" size=""12"" onpropertychange=""formatData(this,'money');"">" & vbcrlf & "              -" & vbcrlf & "           <input name=""D81"" type=""text"" id=""D81"" size=""12"" onpropertychange=""formatData(this,'money');""/></td>" & vbcrlf & "         <td><div align=""right"">资产购价：</div></td>" & vbcrlf & "         <td><input name=""D14"" type=""text"" id=""D14"" size=""12"" onpropertychange=""formatData(thisbackgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">已提金额：</div></td>" & vbcrlf & "    <td colspan=""3"">" & vbcrlf & "      <input name=""D20"" type=""text"" id=""D20"" size=""12"" onpropertychange=""formatData(this,'money');""/>" & vbcrlf & "      -" & vbcrlf & "      " & vbcrlf & "      <input name=""D201"" type=""text"" id=""D201"" size=""12"" onpropertychange=""formatData(this,'money');""/></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">资产配件：</div></td>" & vbcrlf & "    <td colspan=""3""><input name=""D21"" type=""text"" id=""D21"" size=""30"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td><div align=""right"">资产备注：</div></td>" & vbcrlf & "      <td colspan=""3""><input name=""D22"" type=""text"" id=""D22"" size=""30""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">启用日期：</div></td>" & vbcrlf & "      <td colspan=""3"">&nbsp;自：<input type=""text"" name=""D11"" id=""D11"" Class=""DatePick""  onclick=""datedlg.show();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""D12"" id=""D12"" Class=""DatePick""  onclick=""datedlg.show();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td><div align=""right"">领用时间：</div></td>" & vbcrlf & "      <td colspan=""3"">&nbsp;自：<input type=""text"" name=""M"" id=""M"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""K"" id=""K"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td><div align=""right"">购置时间：</div></td>" & vbcrlf & "      <td colspan=""3"">&nbsp;自：<input type=""text"" name=""L1"" id=""L1"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""L2"" id=""L2"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td><div align=""right"">添加时间：</div></td>" & vbcrlf & "       <td colspan=""3"">&nbsp;自：<input type=""text"" name=""L3"" id=""L3"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""L4"" id=""L4"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "          <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td width=""10%"">&nbsp;</td>" & vbcrlf & "       <td colspan=""3""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "        </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
