...
'if strW3<>"" Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "}" & vbcrlf & ".style17 {color: #FF8040}" & vbcrlf & "#loading {" & vbcrlf & "    width:200px;" & vbcrlf & "    height:20px;" & vbcrlf & "padding:5px;" & vbcrlf & "    position:fixed;" & vbcrlf & " _position:absolute;" & vbcrlf & "     left:80px;" & vbcrlf & "      top:120px;" & vbcrlf & "      background-color: #E3EAFA;" & vbcrlf & "      filter:Alpha(opacity=60);" & vbcrlf & "       background-repeat: repeat-x;" & vbcrlf & "    background-position: left top;" & vbcrlf & "  border: 1px solid #C0CCDD;" & vbcrlf & "}" & vbcrlf & "#loading div {" & vbcrlf & "       width:1px;" & vbcrlf & "      height:20px;" & vbcrlf & "    background-color: #ffffff;" & vbcrlf & "      background-repeat: repeat-x;" & vbcrlf & "    background-position: left top;/*background:#F1FF4D;*/" & vbcrlf & "}"& vbcrlf & "" & vbcrlf & "" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script src=""../inc/system.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	...
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "  <script language=""javascript"" type=""text/javascript"">" & vbcrlf & "<!--" & vbcrlf & "function submit1()" & vbcrlf & "{" & vbcrlf & "document.all.date.action = ""delallRecv1.asp?complete=1&type=1&page_count="
	'Response.write Application("sys.info.jsver")
	...
	Response.write "&ret2="
	Response.write m2
	Response.write """;" & vbcrlf & "}" & vbcrlf & "function submit3()" & vbcrlf & "{" & vbcrlf & "document.all.date.action = ""delallRecv1.asp?type=1&currPage="
	Response.write currPage
	Response.write "&page_count="
	Response.write page_count
	Response.write """;" & vbcrlf & "}" & vbcrlf & "function submit4()" & vbcrlf & "{" & vbcrlf & "document.all.date.action = ""recvDelList.asp?page_count="
	Response.write page_count
	Response.write """;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"" "
	Response.write page_count
	if open_77_8=0 then
...
'elseif G1=6 then
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" >" & vbcrlf & "  <form name=""date"" method=""post"" action=""recvDelList.asp?page_count="
	Response.write page_count
	Response.write """>" & vbcrlf & "    <tr>" & vbcrlf & "      <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">邮件删除记录</td>" & vbcrlf & "         <td height=""32"">&nbsp;</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td ></td>" & vbcrlf & "          </tr>" & vbcrlf & "                                         <tr>" & vbcrlf & "            <td  background=""../images/112.gif""  height=""30"" align=""right"" colspan=""4""><div align=""right""  id=""kh"">邮件标题：" & vbcrlf &  "               <input name=""G1""  value=""1"" id=""Kjs1"" type=""hidden"" size=""15"" /> "& vbcrlf &        "         <input  name=""G2"" id=""Kjs1"" type=""text"" size=""15"" /> "& vbcrlf &           "      <input type=""submit"" name=""Submit45"" value=""检索"" onClick=""submit4();""  class=""page""/>" & vbcrlf & "                "
	if open_77_10=1 or open_77_10=3 then
		Response.write "" & vbcrlf & "                <input type=""button"" name=""Submitdel2"" value=""记录导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){window.location.href='../out/xls_emaidell.asp?page_count="
		Response.write page_count
		Response.write "&currPage="
		Response.write  currpage
		Response.write "&A2="
	...
	if open_77_3=3 or open_77_3=1  then
		Response.write "&nbsp;<input  name=submit22332 type=""button"" onClick=""if(confirm('确认清除全部？')){window.location.href='delallRecv1.asp?complete=1&page_count="
		Response.write page_count
		Response.write "&currPage="
		Response.write  currpage
		Response.write "&A2="
	...
	if open_77_7=1 or open_77_7=3 then
		Response.write "<input type=""button"" name=""Submit43"" value=""打印""  onClick=""window.print();return  false;""   class=""anybutton""/>"
	end if
	Response.write "<a href=""###"" class=""AfterQuickSearch"" onclick=""callServer2();document.getElementById('kh').disabled='disabled';document.getElementById('kh').style.display='none';document.getElementById('kh').style.display='none';document.getElementById('ht1').style.display='';document.getElementById('ht1').disabled='';""><img src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a> </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "        <span id=""ht1""></span>" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "          <tr class=""top"">" & vbcrlf & "            <td align=""center""><div align=""center"">选择</div></td>" & vbcrlf & "            <td width=""16%"" height=""27"" ><div align=""center"">发送人邮箱</div></td>" & vbcrlf & "            <td width=""25%"" ><div align=""center"">邮件标题</div></td>" & vbcrlf & "            <td ><div align=""center"">发送时间</div></td>" & vbcrlf & "            <td ><div align=""center"">收件人</div></td>" & vbcrlf & "            <td ><div align=""center"">" & vbcrlf & "    <select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){window.open(this.value,'_self');}this.selectedIndex=0;"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px   solid   #FFFFFF; overflow:hidden"">" & vbcrlf& "                  <option>-请选择-</option>" & vbcrlf & "                  <option value=""recvDelList.asp?page_count=10&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	Response.write ">每页显示10条</option>" & vbcrlf & "                  <option value=""recvDelList.asp?page_count=20&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	Response.write ">每页显示20条</option>" & vbcrlf & "                  <option value=""recvDelList.asp?page_count=30&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	Response.write ">每页显示30条</option>" & vbcrlf & "                  <option value=""recvDelList.asp?page_count=50&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	Response.write ">每页显示50条</option>" & vbcrlf & "                  <option value=""recvDelList.asp?page_count=100&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	Response.write ">每页显示100条</option>" & vbcrlf & "                  <option value=""recvDelList.asp?page_count=200&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from email_recv_list  where del=2  "&Str_Result2&" order by ord desc "
	rs.open sql,conn,1,1
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			...
			Response.write "" & vbcrlf & "          <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td width=""12%"" align=""center""><input name=""selectid"" type=""checkbox"" id=""selectid"" value="""
			Response.write rs("ord")
			Response.write """></td>" & vbcrlf & "            <td height=""28"" ><div align=""center"">"
			Response.write sendMail
			Response.write "</div></td>" & vbcrlf & "            <td height=""28""><div align=""center"" id=""Access""><a href=""javascript:void(0)"" onClick=""javascript:window.open('email_content.asp?action=recv&ord="
			...
			Response.write pwurl(ord)
			if isRead=0 then Response.write("<strong>")end if
			Response.write (title)
			if isRead=0 then Response.write("</strong>")end if
			Response.write "" & vbcrlf & "                </a>" & vbcrlf & "                "
			if rs("isAccess")="1" then
				set rs1=server.CreateObject("adodb.recordset")
				sql1="select * from email_recv_Access where del=1 and mailType=2 and email_ord="&ord&""
				rs1.open sql1,conn,1,1
				if not rs1.eof then
					...
					Response.write("<a href=""javascript:void(0)""  onClick=""getAccess("&recvord&","&ord&",'"&email_Id&"')"" title='点击下载'><img src='img/attachment.gif' style='border: none;' alt='此邮件存在附件'/>附件未下载</a>")
				end if
				rs1.close
			end if
			...
			Response.write "</div></td>" & vbcrlf & "            <td width=""17%"" class=""func""><div align=""center"">"
			...
			Response.write "" & vbcrlf & "                                             <input  name=submit2 type=""button""  onClick=""javascript:window.open('../email/RecoveryEmail.asp?ord="
			Response.write trim(pwurl(ord))
			Response.write "','newsSendemail','width=' + 900 + ',height=' + 800 + ',fullscreen =no,scrollbars=0,toolbar=0, status=no,resizable=1,location=no,menubar=no,menubar=no,left=210,top=100')""   value=""恢复"">" & vbcrlf & "                                          "
			Response.write trim(pwurl(ord))
			if open_77_3=3 or CheckPurview(intro_77_3,trim(addcate))=True then
				Response.write "<input  name=submit2 type=""button""   onClick=""if(!confirm('确认删除吗？')){return false;}else{window.location.href='delRecvDel.asp?ord="
				Response.write pwurl(ord)
				Response.write "&CurrPage="
				Response.write CurrPage
				Response.write "&page_count="
			...
			rs.movenext
		loop
		Response.write "" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td  class=""page""><table width=""100%"" border=""0"" align=""center"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""8%"" height=""1480"" valign=""top""><div align=""center"">全选 "& vbcrlf &             "    <input name=""chkall"" type=""checkbox"" id=""chkall"" value=""all"" onclick=""mm(this.form)"" /> "& vbcrlf &        "       </div></td> "& vbcrlf &          "   <td width=""17%"" valign=""top""> "& vbcrlf &    "           "
		if open_77_3=3 or open_77_3=1  then
		...
		Response.write "</td>" & vbcrlf & "            <td width=""75%"" valign=""top""><div align=""right""> <span class=""black"">"
		...
		if currpage=1 then
			...
			Response.write "" & vbcrlf & "                <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='recvDelList.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
			Response.write  1
			Response.write "&A2="
			...
			Response.write "&ret2="
			Response.write m2
			Response.write "'""/>" & vbcrlf & "                <input type=""button"" name=""Submit42"" value=""上一页""  onClick=""window.location.href='recvDelList.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
		...
		if currpage=rs.pagecount then
			...
			Response.write "" & vbcrlf & "                <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='recvDelList.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
			Response.write  currpage + 1
			Response.write "&currPage="
			...
			Response.write "&ret2="
			Response.write m2
			Response.write "'"" class=""page""/>" & vbcrlf & "                <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href='recvDelList.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
			Response.write  rs.PageCount
			Response.write "&A2="
		...
		Response.write "" & vbcrlf & "              </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "        <script language=javascript>" & vbcrlf & "                         function submit5()" & vbcrlf & "{" & vbcrlf & "document.all.date.action = ""recvDelList.asp?page_count="
		Response.write page_count
		Response.write "&A2="
		Response.write A2
		Response.write "&A1="
		...
		Response.write "&ret2="
		Response.write m2
		Response.write """;" & vbcrlf & "}" & vbcrlf & "function test()" & vbcrlf & "{" & vbcrlf & "  if(!confirm('确认删除吗？')) return false;" & vbcrlf & "}" & vbcrlf & " " & vbcrlf & "function mm(form) " & vbcrlf & "{ ///定义函数checkall,参数为form " & vbcrlf & "" & vbcrlf & "for (var i=0;i<form.elements.length;i++)" & vbcrlf& "" & vbcrlf & "///循环,form.elements.length得到表单里的控件个数" & vbcrlf & "{" & vbcrlf & "" & vbcrlf & "///把表单里的内容依依付给e这个变量 " & vbcrlf & "var e = form.elements[i]; " & vbcrlf & "if (e.name != 'chkall') " & vbcrlf & "e.checked = form.chkall.checked; " & vbcrlf & "} " & vbcrlf & "} " & vbcrlf & "</script>" &vbcrlf & "      " & vbcrlf & "      </td>" & vbcrlf & "    </tr>" & vbcrlf & "  </form>" & vbcrlf & "</table>" & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	action1="邮件删除记录"
