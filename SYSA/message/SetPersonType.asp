...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	if request.QueryString("action")="setAll" then
		...
		elseif open_67_1= 1 then
			Str_Result=" and (addcate in("&intro_67_1&")) "
		else
			Str_Result=" and 1=2 "
		end if
		if strid<>"" then
		...
		if typeid="1" then
			if checkid="" or classType="" then
				Response.write"<script language=javascript>alert('没有指定分类或没有选择任何联系人，请返回！'); window.location.href('all.asp?CurrPage="&CurrPage&"&page_count="&page_count&"');</script>"
				call db_close : Response.end
			else
				sql="update  MessagePerson set sort="&classType&" where del=1  and ord in("&checkid&") "&Str_Result&" "&str_sql_checkid
				conn.Execute(sql)
				Response.redirect "all.asp?CurrPage="&CurrPage&"&page_count="&page_count&""
			end if
		elseif typeid="2" and classType<>""   then
			sql="update  MessagePerson set sort="&classType&" where del=1  "&Str_Result&" "&str_sql_checkid
			conn.Execute(sql)
			Response.redirect "all.asp?CurrPage="&CurrPage&"&page_count="&page_count&""
		else
			Response.redirect "all.asp?CurrPage="&CurrPage&"&page_count="&page_count&""
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td class=""place"">批量指定分类</td>" & vbcrlf & "    <td>&nbsp;</td>" & vbcrlf & "    <td align=""right"">&nbsp;</td>" & vbcrlf & "    <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & " <form name=""form1"" method=""post"" action=""SetPersonType.asp?action=setAll&page_count="
	Response.write page_count
	Response.write "&CurrPage="
	Response.write CurrPage
	Response.write "&type="
	Response.write typeid
	Response.write """ style=""margin:0"">" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "     <tr>" & vbcrlf & "            <td width=""20%""  align=""right"">分类：</td>" & vbcrlf & "            <td width=""80%""  align=""left""><div  style=""color:#FF0000"" id=""mecon"">" & vbcrlf & "              <IFRAME name=""I2"" SRC=""../sortsms/correct.asp?isNode=yes"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""95%"" HEIGHT=""27"" marginwidth=""1"" marginheight=""1""></IFRAME>            " & vbcrlf & "           </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "     <tr  class=""gray"">" & vbcrlf & "            <td width=""20%""  align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""80%""  align=""left""><div  style=""color:#FF0000"" id=""mecon""><span style=""padding:12px"">" & vbcrlf & "              <input type=""hidden"" name=""checkid"" value="""
	Response.write selectid
	Response.write """>" & vbcrlf & "              <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>&nbsp;&nbsp;" & vbcrlf & "                       <input type=""reset"" value=""返回"" class=""page"" name=""B2"" onclick=""history.go(-1)""></span>" & vbcrlf & "           </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "            " & vbcrlf & "  </table>" & vbcrlf & "  </form>" & vbcrlf & "</td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "    " & vbcrlf & "      " & vbcrlf & "      </td>" & vbcrlf & "    </tr>" & vbcrlf & "  </table>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
	conn.close
	set conn=nothing
