function CheckData(NT120Client,inputjmg,tishi)
{
	try{
		...
		inputjmg.innerHTML="<a href='#' onclick='OnlineSetup(inputjmg)'>在线安装NT插件</a>&nbsp;<a href='ocx/NT120Client.exe'>下载插件安装</a>"//
		return false ;
	}
	return true ;
}
...
function CheckJMGLogin(NT120Client,pwdstr){
	if (NT120Client)
	{
		try{
			...
			{	
				alert("没有找到加密锁！");
				top.window.location.href="../index2.asp";
			}
			else{
