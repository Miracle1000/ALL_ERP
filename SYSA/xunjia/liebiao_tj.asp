...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	Response.write "               " & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td colspan=""2""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=document.getElementById""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td rowspan=""2""><div align=""right"">人员选择：</div></td>" & vbcrlf & "<td><label><input type=""checkbox"" name=""wtype"" value=""1"" checked>询价人员</label>" & vbcrlf & "       <label><input type=""checkbox"" name=""wtype"" value=""2"">定价人员</label></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "  <td><div align=""right"">询价状态：</div></td>" & vbcrlf & "  <td><label><input type=""checkbox"" name=""xjzt"" value=""0"" />暂存</label>" & vbcrlf & "             <label><input type=""checkbox"" name=""xjzt"" value=""1"" />询价中，待定价</label>" & vbcrlf & "      <label><input type=""checkbox"" name=""xjzt"" value=""2"" />询价中，部分定价</label>" & vbcrlf & "      <label><input type=""checkbox"" name=""xjzt"" value=""3"" />询价完毕</label>" & vbcrlf & "      <label><input type=""checkbox"" name=""xjzt"" value=""4"" />已终止</label></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "  <td><div align=""right"">询价主题：</div></td>" & vbcrlf & "  <td><input type=""input"" name=""xjTitle"" size=""20"" maxlength=""200"" /></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf &   "<td><div align=""right"">询价编号：</div></td>" & vbcrlf &   "<td><input type=""input"" name=""xjbh"" size=""20"" maxlength=""200"" /></td>" & vbcrlf & "</tr>" & vbcrlf & ""
	if ZBRuntime.MC(14000) Then
		Set rs1 = conn.execute("select isnull(qx_open,0) qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=25 and sort2=19")
		if rs1.eof then
			open_25_19=0
		else
		...
		rs1.close
		Set rs1 = Nothing
		If open_25_19=0 Then
			Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "  <td><div align=""right"">预购状态：</div></td>" & vbcrlf & "  <td><label><input type=""checkbox"" name=""ygzt"" value=""0"" />未预购</label>" & vbcrlf & "             <label><input type=""checkbox"" name=""ygzt"" value=""2"" />部分预购</label>" & vbcrlf &       "<label><input type=""checkbox"" name=""ygzt"" value=""1"" />预购完毕</label></td>" & vbcrlf & "</tr>" & vbcrlf
		end if
	end if
	if ZBRuntime.MC(15000) Then
		Set rs1 = conn.execute("select isnull(qx_open,0) qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=22 and sort2=19")
		if rs1.eof then
			open_22_19=0
		else
			open_22_19=rs1("qx_open")
		end if
		rs1.close
		Set rs1 = Nothing
		If open_22_19=0 Then
			Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "  <td><div align=""right"">采购状态：</div></td>" & vbcrlf & "  <td><label><input type=""checkbox"" name=""cgzt"" value=""0"" />未采购</label>" & vbcrlf & "             <label><input type=""checkbox"" name=""cgzt"" value=""2"" />部分采购</label>" & vbcrlf &       "<label><input type=""checkbox"" name=""cgzt"" value=""1"" />采购完毕</label>" & vbcrlf & "</tr>" & vbcrlf
		end if
	end if
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=24 and set_open=1 and js=1 and sort=2 order by gate1 asc "
	rs.open sql,conn,1,1
	if rs.eof then
	else
		do until rs.eof
			...
			Response.write "：</div></td>" & vbcrlf & "    <td><input type=""text"" name="""
			Response.write rs("name")
			Response.write """ id="""
			Response.write rs("name")
			Response.write """ size=""20"" maxlength=""200""/></td>" & vbcrlf & "</tr>" & vbcrlf & ""
			rs.movenext
		loop
	end if
	rs.close
	set rs=nothing
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=24 and set_open=1 and js=1 and sort=1 order by gate1 asc "
	rs.open sql,conn,1,1
	if not rs.eof then
		do until rs.eof
			Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "  <td><div align=""right"">询价概要：</div></td>" & vbcrlf & "  <td><input type=""input"" name=""remark"" size=""20"" maxlength=""200""/></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf &   "<td><div align=""right"">产品名称：</div></td>" & vbcrlf &   "<td><input type=""input"" name=""cpTitle"" size=""20"" maxlength=""200""/></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "  <td><div align=""right"">产品编号：</div></td>" & vbcrlf & "  <td><input type=""input"" name=""cpbh"" size=""20"" maxlength=""200"" /></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "  <td><div align=""right"">产品型号：</div></td>" & vbcrlf & "  <td><input type=""input"" name=""cptype1"" size=""20"" maxlength=""200"" /></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">询价日期：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=""ret"" size=""11"" readonly  id=""ret1"" onclick=""datedlg.show();"">" & vbcrlf & "&nbsp;至：" & vbcrlf & "<INPUT name=""ret2"" size=""11"" id=""ret2"" readonly  onclick=""datedlg.show();""></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">添加时间：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=""ret3"" size=""11"" readonly id=""ret3"" onclick=""datedlg.show();"">" & vbcrlf & "&nbsp;至：" & vbcrlf & "<INPUT name=""ret4"" size=""11"" id=""ret4"" readonly onclick=""datedlg.show();""></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td width=""10%"">&nbsp;</td>" & vbcrlf & "<td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr></table>" & vbcrlf & ""
	conn.close
	set conn=Nothing
%>
