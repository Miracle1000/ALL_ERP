...
'If font.color & "" <> "" Then cssText = cssText & "color:" & font.color & ";"
	...
	j=1
	k=1
	sql="select * from O_kuCheck "&Str_Result&" "&Ptr_Result
	set rs = server.CreateObject("adodb.recordset")
	...
	if not rs.eof then
		do until rs.eof
			...
			che_note=rs("che_note")
			sql8="select a.*,b.che_title,b.che_bh,b.che_cateid,b.che_cateid,b.che_addcateid,b.che_addtime,b.che_bh,b.che_time,g.prod_ph,g.prod_xlh,g.prod_sctime,g.prod_ystime,c.pro_name,d.sort1,e.name,f.prod_name,f.prod_bh,f.prod_xh,k.sto_name from O_kuCheList a "&_
			...
			" left join gate e on b.che_cateid=e.ord where che_fid="&rs("id")
	...
	rs.close
	set rs=nothing
	Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>盘点列表导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!盘点列表导出成功,共有"&(i-1)&"条记录!"&(j-1)&"条记录"&(k-1)&"条明细!</B>"";</script>"
	set rs=nothing
