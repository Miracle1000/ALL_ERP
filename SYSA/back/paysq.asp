...
'bigsystemtype = ".mozi"
	...
	Response.write Application("sys.info.jsver")
	Response.write "' defer='defer'></script>" & vbcrlf & "</head>" & vbcrlf & "<body  oncontextmenu=self.event.returnValue=false >" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "   <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf &  "   <tr> "& vbcrlf &   "    <td class=""place"">费用申请回收站</td>" & vbcrlf &     "  <td>&nbsp;</td>" & vbcrlf &   "    <td align=""right""><input type=""button"" name=""Submitdel"" class=""anybutton"" value=""全部清空"" onClick=""if(confirm('确认清空本回收站里的所有内容？')){window.location.href='delall.asp?ord=paysq&url=paysq.asp'}""/></td>" & vbcrlf & "      <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "    </tr>" & vbcrlf & "  </table> " & vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td align=""center""><div align=""center"">选择</div></td>" & vbcrlf & "        <td height=""26"" align=""center"" ><div align=""center""><strong>序号</strong></div></td>" & vbcrlf & "        <td height=""23""><div align=""center"">标题</div></td>" & vbcrlf & "        <td><div align=""center"" ><strong>金额</strong></div></td>" & vbcrlf & "        <td width=""10%""><div align=""center"" ><strong>申请人</strong></div></td>        " & vbcrlf & "     <td><div align=""center""><strong>删除人</strong></div></td>       " & vbcrlf & "        <td><div align=""center""><strong>删除日期</strong></div></td>" & vbcrlf & "        <td><div align=""center""><strong>操作</strong></div></td>" & vbcrlf & "      </tr>" & vbcrlf & ""
	dim n
	n=0
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from paysq where del=2 order by deldate desc"
	...
	if rs.RecordCount<=0 then
		...
		Response.write "" & vbcrlf & "   <form name=""form1"" method=""post"" action=""deletepaysqall.asp?ord="
		...
		do until rs.eof
			...
			Response.write rs("id")
			Response.write """>" & vbcrlf & "        </span></td>" & vbcrlf & "        <td width=""7%"" align=""center"" height=""26"">"
			...
			if open_6_14=3 or CheckPurview(intro_6_14,trim(cateid))=True then
				Response.write "" & vbcrlf & "              <a href=""javascript:void(0);"" onClick=""javascript:window.open('../pay/paysqdetail.asp?ord="
				Response.write rs("id")
			...
			Response.write "</td>" & vbcrlf & "        <td><div align=""right"">"
			Response.write Formatnumber(zbcdbl(rs("sqmoney")),num_dot_xs,-1)
			Response.write "</td>" & vbcrlf & "        <td><div align=""right"">"
			...
			Response.write "</div></td>" & vbcrlf & "                   "
			dim trade6
			if rs("delcateid")<>"" then
				set rs1=server.CreateObject("adodb.recordset")
				sql1="select * from gate where ord="&rs("delcateid")&" "
				rs1.open sql1,conn,1,1
				if rs1.eof then
				else
					trade6=rs1("name")
			...
			Response.write "</div></td>" & vbcrlf & "         <td width=""15%""><div align=""center""><input type=""button"" name=""Submit3c""  class=""anybutton""  value=""恢复""  onClick=""if(confirm('确认恢复？')){window.location.href='setpaysq.asp?ord="
			Response.write rs("id")
			Response.write "&CurrPage="
			Response.write CurrPage
			Response.write "'}""/>" & vbcrlf & "        <input type=""button"" name=""Submitdel"" class=""anybutton"" value=""彻底删除"" onClick=""if(confirm('您选择的是彻底删除，删除后不能再恢复，确认删除？')){window.location.href='deletepaysq.asp?ord="
			Response.write rs("id")
			Response.write "&CurrPage="
			Response.write CurrPage
		...
		if currpage=1 then
			...
			Response.write "" & vbcrlf & "    <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='paysq.asp?currPage="
			Response.write  1
			Response.write "&a="
			Response.write a
			Response.write "&b="
			...
			Response.write "&c="
			Response.write c
			Response.write "'""/> <input type=""button"" name=""Submit42"" value=""上一页""  onClick=""window.location.href='paysq.asp?currPage="
		...
		if currpage=rs.pagecount then
			...
			Response.write "" & vbcrlf & "   <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='paysq.asp?currPage="
			Response.write  currpage + 1
			Response.write "&a="
			Response.write a
			Response.write "&b="
			...
			Response.write "&c="
			Response.write c
			Response.write "'"" class=""page""/> <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href='paysq.asp?currPage="
			Response.write  rs.PageCount
			Response.write "&a="
			Response.write a
			Response.write "&b="
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "<script type=""text/Javascript"">window.currask2Url=""setpaysqall.asp?currPage="
		Response.write currPage
