...
if ($.fn.validatebox){
	$.fn.validatebox.defaults.missingMessage = 'Questo campo 猫 richiesto.';
...
if ($.fn.numberbox){
	$.fn.numberbox.defaults.missingMessage = 'Questo campo 猫 richiesto.';
}
if ($.fn.combobox){
	$.fn.combobox.defaults.missingMessage = 'Questo campo 猫 richiesto.';
}
if ($.fn.combotree){
	$.fn.combotree.defaults.missingMessage = 'Questo campo 猫 richiesto.';
}
if ($.fn.combogrid){
	$.fn.combogrid.defaults.missingMessage = 'Questo campo 猫 richiesto.';
}
if ($.fn.calendar){
...
if ($.fn.datebox){
	...
	$.fn.datebox.defaults.missingMessage = 'Questo campo 猫 richiesto.';
}
