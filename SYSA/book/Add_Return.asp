...
'If Not rs.Eof Then
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_2=0
		intro_103_2=""
	else
		open_103_2=rs1("qx_open")
		intro_103_2=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=3"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_3=0
		intro_103_3=""
	else
		open_103_3=rs1("qx_open")
		intro_103_3=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=5"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_5=0
		intro_103_5=""
	else
		open_103_5=rs1("qx_open")
		intro_103_5=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=7"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_7=0
		intro_103_7=""
	else
		open_103_7=rs1("qx_open")
		intro_103_7=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_8=0
		intro_103_8=""
	else
		open_103_8=rs1("qx_open")
		intro_103_8=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=9"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_9=0
		intro_103_9=""
	else
		open_103_9=rs1("qx_open")
		intro_103_9=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=10"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_10=0
		intro_103_10=""
	else
		open_103_10=rs1("qx_open")
		intro_103_10=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=11"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_11=0
		intro_103_11=""
	else
		open_103_11=rs1("qx_open")
		intro_103_11=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=12"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_12=0
		intro_103_12=""
	else
		open_103_12=rs1("qx_open")
		intro_103_12=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_13=0
		intro_103_13=""
	else
		open_103_13=rs1("qx_open")
		intro_103_13=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=131"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_131=0
		intro_103_131=""
	else
		open_103_131=rs1("qx_open")
		intro_103_131=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=132"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_132=0
		intro_103_132=""
	else
		open_103_132=rs1("qx_open")
		intro_103_132=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=133"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_133=0
		intro_103_133=""
	else
		open_103_133=rs1("qx_open")
		intro_103_133=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_16=0
		intro_103_16=""
	else
		open_103_16=rs1("qx_open")
		intro_103_16=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=103 and sort2=19"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_103_19=0
		intro_103_19=""
	else
		open_103_19=rs1("qx_open")
		intro_103_19=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	if open_103_1=3 then
		list=""
	elseif open_103_1=1 then
		list=" and bk_addcateid in ("&intro_103_1&")"
	else
		list=" and bk_addcateid=0"
	end if
...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Class myClass
		function addBookLog(bookname,bookid,booktype,auther,ISBN,publishingtime,djtytpe,djtime,sjnum,dbnum,xynum,djid)
			sqlx="select * from O_bookLog where 1=2 "
			set rsx=server.CreateObject("adodb.recordset")
			rsx.open sqlx,conn,1,3
			rsx.addnew
			rsx("bookname")=bookname
			rsx("bookid")=IsNum(bookid)
			rsx("booktype")=booktype
			rsx("auther")=auther
			rsx("ISBN")=ISBN
			rsx("publishingtime")=IsTime(publishingtime)
			rsx("djtytpe")=djtytpe
			rsx("djtime")=IsTime(djtime)
			rsx("sjnum")=IsNum(sjnum)
			rsx("dbnum")=IsNum(dbnum)
			rsx("xynum")=IsNum(xynum)
			rsx("djid")=IsNum(djid)
			rsx("addcateid")=session("personzbintel2007")
			rsx.update
			rsx.close
			set rsx=nothing
			addBookLog=true
		end function
		function addBookUpdate(bk_fid,bk_name,bk_type,bk_bh,bk_auther,bk_publishing,bk_ISBN,bk_pubtime,bk_pagesize,bk_pagenum,bk_pubnum,bk_printtime,bk_returnnum,bk_paper,bk_printnum,bk_binding,bk_format,bk_num,bk_price,bk_allnum,bk_allmoney,bk_postion,bk_note,bk_addcateid,bk_addtime,bk_del,bk_updateid,bk_updatetime,bk_updateIP,sign)
			sqlx="select * from O_RegBook_his where 1=2 "
			set rsx=server.CreateObject("adodb.recordset")
			rsx.open sqlx,conn,1,3
			rsx.addnew
			rsx("bk_fid")=bk_fid
			rsx("bk_name")=bk_name
			rsx("bk_type")=ml.IsNum(bk_type)
			rsx("bk_bh")=bk_bh
			rsx("bk_auther")=bk_auther
			rsx("bk_publishing")=bk_publishing
			rsx("bk_ISBN")=bk_ISBN
			rsx("bk_pubtime")=ml.IsTime(bk_pubtime)
			rsx("bk_pagesize")=ml.IsNum(bk_pagesize)
			rsx("bk_pagenum")=ml.IsNum(bk_pagenum)
			rsx("bk_pubnum")=bk_pubnum
			rsx("bk_printtime")=ml.IsTime(bk_printtime)
			rsx("bk_returnnum")=ml.IsNum(bk_returnnum)
			rsx("bk_paper")=bk_paper
			rsx("bk_printnum")=bk_printnum
			rsx("bk_binding")=bk_binding
			rsx("bk_format")=bk_format
			rsx("bk_num")=ml.IsNum(bk_num)
			rsx("bk_allnum")=ml.IsNum(bk_num)
			rsx("bk_price")=ml.IsNum(bk_price)
			rsx("bk_allmoney")=ml.IsNum(bk_allmoney)
			rsx("bk_postion")=bk_postion
			rsx("bk_note")=bk_note
			rsx("bk_addcateid")=bk_addcateid
			rsx("bk_addtime")=bk_addtime
			rsx("bk_del")=bk_del
			rsx("bk_updateid")=bk_updateid
			rsx("bk_updatetime")=bk_updatetime
			rsx("bk_updateIP")=bk_updateIP
			rsx("sign")=sign
			rsx.update
			rsx.close
			set rsx=nothing
...
'if isnull(values) then IsTime = null : exit function
	...
	if ord="" or isnull(ord) then
		ord=replace(request("selectid")," ","")
	end if
	if ord="" or isnull(ord) then
		ord=replace(request("selid")," ","")
	else
		if replace(request("selid")," ","")="" or isnull(replace(request("selid")," ","")) then
		else
			ord=ord&","&replace(request("selid")," ","")
		end if
	end if
	ordarr=split(ord,",")
	ordnum=Ubound(ordarr)+2
	ordarr=split(ord,",")
	set ml=new myClass
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/Javascript"" src=""jsClass.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "var a="
	Response.write ordnum
	Response.write "" & vbcrlf & "var b="
	Response.write ordnum
	Response.write "" & vbcrlf & "function addtr()" & vbcrlf & "{" & vbcrlf & "     $('#ddd').dialog('close');" & vbcrlf & "      var Table=document.getElementById('add_tr');" & vbcrlf & "    var tr=document.createElement(""tr"");" & vbcrlf & "      tr.id=""tr_""+b;" & vbcrlf & "    tr.name=""table_tr"";" & vbcrlf & "       Table.appendChild(tr);" & vbcrlf & "     tr.onmouseover=function(){this.style.backgroundColor='efefef';}" & vbcrlf & " tr.onmouseout=function(){this.style.backgroundColor='';}" & vbcrlf & "        " & vbcrlf & "        "
	sql7="select name from O_BookField where setopen in(2,3) order by sort1 asc"
	set rs7=server.CreateObject("adodb.recordset")
	rs7.open sql7,conn,3,1
	if not rs7.eof then
		do while not rs7.eof
			if rs7("name")="书名" then
				Response.write "" & vbcrlf & "      var td1 = document.createElement('td');" & vbcrlf & " tr.appendChild(td1);" & vbcrlf & "    var Href = ""<div align=\""center\""><input type=\""text\"" readonly='true' style='color:#CCCCCC;' name=\""bookname\"" id=\""bookname""+b+""\"" size=\""15\"" value=\""点击选择图书\"" maxlength=\""2000\""><input type=\""hidden\"" id=\""Ret_bkid""+b+""\"" name=\""Ret_bkid\"">&nbsp;<a href=\""###\"" onclick=\""del_TR('""+tr.id+""')\""><img src=\""../images/del2.gif\""/></a>&nbsp;<span id='sortlist'>""+a+""</span></div>"";" & vbcrlf & "   td1.innerHTML=Href;" & vbcrlf & "     "
'if rs7("name")="书名" then
			end if
			if rs7("name")="编号" then
				Response.write "" & vbcrlf & "      var td2 = document.createElement('td');" & vbcrlf & " tr.appendChild(td2);" & vbcrlf & "    var Href = ""<pre><div align=\""center\"" id=\""bk_bh""+b+""\""></div>"";" & vbcrlf & "       td2.innerHTML=Href;" & vbcrlf & "     "
'if rs7("name")="编号" then
			end if
			if rs7("name")="分类" then
				Response.write "" & vbcrlf & "      var td3 = document.createElement('td');" & vbcrlf & " tr.appendChild(td3);" & vbcrlf & "    var Href = ""<pre><div align=\""center\"" id=\""bk_type""+b+""\""></div>"";" & vbcrlf & "     td3.innerHTML=Href;" & vbcrlf & "     "
'if rs7("name")="分类" then
			end if
			if rs7("name")="借阅周期" then
				Response.write "" & vbcrlf & "      var td4 = document.createElement('td');" & vbcrlf & " tr.appendChild(td4);" & vbcrlf & "    var Href = ""<pre><div align=\""center\""  id=\""bk_returnnum""+b+""\""></div>"";" & vbcrlf & "       td4.innerHTML=Href;" & vbcrlf & "     "
'if rs7("name")="借阅周期" then
			end if
			if rs7("name")="作者" then
				Response.write "" & vbcrlf & "      var td5 = document.createElement('td');" & vbcrlf & " tr.appendChild(td5);" & vbcrlf & "    var Href = ""<pre><div align=\""center\"" id=\""bk_auther""+b+""\""></div>"";" & vbcrlf & "   td5.innerHTML=Href;" & vbcrlf & "     "
'if rs7("name")="作者" then
			end if
			if rs7("name")="出版时间" then
				Response.write "" & vbcrlf & "      var td6 = document.createElement('td');" & vbcrlf & " tr.appendChild(td6);" & vbcrlf & "    var Href = ""<pre><div align=\""center\"" id=\""bk_pubtime""+b+""\""></div>"";" & vbcrlf & "  td6.innerHTML=Href;" & vbcrlf & "     "
'if rs7("name")="出版时间" then
			end if
			if rs7("name")="出版社" then
				Response.write "" & vbcrlf & "      var td7 = document.createElement('td');" & vbcrlf & " tr.appendChild(td7);" & vbcrlf & "    var Href = ""<pre><div align=\""center\"" id=\""bk_publishing""+b+""\""></div>"";" & vbcrlf & "       td7.innerHTML=Href;" & vbcrlf & "     "
'if rs7("name")="出版社" then
			end if
			if rs7("name")="版次" then
				Response.write "" & vbcrlf & "      var td8 = document.createElement('td');" & vbcrlf & " tr.appendChild(td8);" & vbcrlf & "    var Href = ""<pre><div align=\""center\"" id=\""bk_pubnum""+b+""\""></div>"";" & vbcrlf & "   td8.innerHTML=Href;" & vbcrlf & "     "
'if rs7("name")="版次" then
			end if
			if rs7("name")="页数" then
				Response.write "" & vbcrlf & "      var td9 = document.createElement('td');" & vbcrlf & " tr.appendChild(td9);" & vbcrlf & "    var Href = ""<pre><div align=\""center\"" id=\""bk_pagenum""+b+""\""></div>"";" & vbcrlf & "  td9.innerHTML=Href;" & vbcrlf & "     "
'if rs7("name")="页数" then
			end if
			if rs7("name")="字数" then
				Response.write "" & vbcrlf & "      var td10 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td10);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_pagesize""+b+""\""></div>"";" & vbcrlf & " td10.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="字数" then
			end if
			if rs7("name")="印刷时间" then
				Response.write "" & vbcrlf & "      var td11 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td11);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_printtime""+b+""\""></div>"";" & vbcrlf & "        td11.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="印刷时间" then
			end if
			if rs7("name")="开本" then
				Response.write "" & vbcrlf & "      var td12 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td12);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_format""+b+""\""></div>"";" & vbcrlf & "   td12.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="开本" then
			end if
			if rs7("name")="纸张" then
				Response.write "" & vbcrlf & "      var td13 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td13);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_paper""+b+""\""></div>"";" & vbcrlf & "    td13.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="纸张" then
			end if
			if rs7("name")="印次" then
				Response.write "" & vbcrlf & "      var td14 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td14);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_printnum""+b+""\""></div>"";" & vbcrlf & " td14.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="印次" then
			end if
			if rs7("name")="ISBN" then
				Response.write "" & vbcrlf & "      var td15 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td15);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_ISBN""+b+""\""></div>"";" & vbcrlf & "     td15.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="ISBN" then
			end if
			if rs7("name")="装帧" then
				Response.write "" & vbcrlf & "      var td16 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td16);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_binding""+b+""\""></div>"";" & vbcrlf & "  td16.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="装帧" then
			end if
			if rs7("name")="单价" then
				Response.write "" & vbcrlf & "      var td17 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td17);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_price""+b+""\""></div>"";" & vbcrlf & "    td17.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="单价" then
			end if
			if rs7("name")="可借阅数量" then
				Response.write "" & vbcrlf & "     var td18 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td18);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_num""+b+""\""></div>"";" & vbcrlf & "      td18.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="可借阅数量" then
			end if
			if rs7("name")="总价" then
				Response.write "" & vbcrlf & "     var td19 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td19);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_allmoney""+b+""\""></div>"";" & vbcrlf & " td19.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="总价" then
			end if
			if rs7("name")="存放位置" then
				Response.write "" & vbcrlf & "     var td20 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td20);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_postion""+b+""\""></div>"";" & vbcrlf & "  td20.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="存放位置" then
			end if
			if rs7("name")="添加人员" then
				Response.write "" & vbcrlf & "     var td21 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td21);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_addcateid""+b+""\""></div>"";" & vbcrlf & "        td21.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="添加人员" then
			end if
			if rs7("name")="添加时间" then
				Response.write "" & vbcrlf & "     var td22 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td22);" & vbcrlf & "   var Href = ""<pre><div align=\""center\"" id=\""bk_addtime""+b+""\""></div>"";" & vbcrlf & "  td22.innerHTML=Href;" & vbcrlf & "    "
'if rs7("name")="添加时间" then
			end if
			rs7.movenext
		loop
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "     var td23 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td23);" & vbcrlf & "   var Href = ""<div align=\""center\"" id='Ld_num1""+b+""'>0</div><input name=\""Ld_num\"" type=\""hidden\"" id=\""Ld_num""+b+""\"" value=\""0\"">"";" & vbcrlf & "     td23.innerHTML=Href;" & vbcrlf & "   var td28 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td28);" & vbcrlf & "   var Href = ""<div align=\""center\""><input name=\""Ret_num\"" type=\""text\"" id=\""Ret_num\"" value=\""1\"" size=\""10\"" maxlength=\""20\"" onkeyup=\""value=value.replace(/[^\\d]/g,'')\"" onpropertychange=\""allsum()\""><input type=\""hidden\"" name=\""Ret_nums\"" id=\""Ret_nums""+b+""\""></div>"";" & vbcrlf & "        td28.innerHTML=Href;" & vbcrlf & "    var td24 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td24);" & vbcrlf & "   var Href = ""<div align=\""center\""><input name=\""Ret_time""+b+""\"" type=\""text\"" size=\""9\"" value=\"""
	set rs7=nothing
	Response.write date
	Response.write "\"" id=\""daysOfMonthPosy""+b+""\"" onmouseup=toggleDatePicker(\""daysOfMonthy""+b+""\"",\""date.Ret_time""+b+""\"") readonly=\""true\""><DIV id=daysOfMonthy""+b+"" style=\""POSITION: absolute;z-index:10\""></DIV><input name=\""time1\"" type=\""hidden\"" id=\""time1""+b+""\""></div>"";" & vbcrlf & "     td24.innerHTML=Href;" & vbcrlf & "    var td25 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td25);" & vbcrlf & "   var Href = ""<div align=\""center\""><input name=\""Ld_rettime""+b+""\"" type=\""text\"" size=\""9\"" id=\""daysOfMonthPosx""+b+""\"" onmouseup=toggleDatePicker(\""daysOfMonthx""+b+""\"",\""date.Ld_rettime""+b+""\"") readonly=\""true\""><DIV id=daysOfMonthx""+b+"" style=\""POSITION: absolute;z-index:10\""></DIV></div>"";" & vbcrlf & "     td25.innerHTML=Href;" & vbcrlf & "    var td26 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td26);" & vbcrlf & "   var Href = ""<div align=\""center\""><select name='Ret_isBreak'>"";" & vbcrlf & "     Href=Href+""<option value='1'>否</option>"";" & vbcrlf & "        Href=Href+""<option value='2'>是</option>"";" & vbcrlf & "        Href=Href+""</select></div>"";" & vbcrlf & "      td26.innerHTML=Href;" & vbcrlf & "    var td29 = document.createElement('td');" & vbcrlf & "      tr.appendChild(td29);" & vbcrlf & "   var Href = ""<div align=\""center\""><select name='Ld_stop'>"";" & vbcrlf & " Href=Href+""<option value='1'>否</option>"";" & vbcrlf & "        Href=Href+""<option value='2'>是</option>"";" & vbcrlf & "        Href=Href+""</select></div>"";" & vbcrlf & "        td29.innerHTML=Href;" & vbcrlf & "    var td27 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td27);" & vbcrlf & "   var Href = ""<div align=\""center\""><input type=\""\"" name=\""Ret_note\"" id=\""Ret_note\"" size=\""15\"" maxlength=\""2000\""></div>"";" & vbcrlf & "  td27.innerHTML=Href;" & vbcrlf & " " & vbcrlf & "        allsum();" & vbcrlf & "       a=a+1;" & vbcrlf & "  b=b+1;" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body { margin-top: 0px;}" & vbcrlf & "img{border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "#adddiv{width:1000px;height:500px;OVERFLOW:auto;" & vbcrlf & "SCROLLBAR-FACE-COLOR:#F0F4FD;SCROLLBAR-HIGHLIGHT-COLOR:#ffffff;SCROLLBAR-SHADOW-COLOR:#919192;SCROLLBAR-3DLIGHT-COLOR:#ffffff;SCROLLBAR-ARROW-COLOR:#919192;SCROLLBAR-TRACK-COLOR:#ffffff;SCROLLBAR-DARKSHADOW-COLOR:#ffffff;}" & vbcrlf & "-->" &vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"" scroll=""auto"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">归还添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "    <form action=""Save_Return.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)&&ask1()"">" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td width=""13%"" height=""27"" ><div align=""left""><strong>基本信息</strong></div></td>" & vbcrlf & "        <td width=""87%"" height=""27"">" & vbcrlf & "                 <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "              <input type=""button"" value=""重填"" class=""page"" name=""B22"" onclick=""window.location.reload()"">" & vbcrlf & "                 </div></td>" & vbcrlf & "        </tr>      " & vbcrlf & "        <tr>" & vbcrlf & "            <td colspan=""2"">" & vbcrlf & "                  <div id=""adddiv"" style=""width:100%"">" & vbcrlf & "                      <table class=""detailTable"" border=""0"" width=""100%"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                           <tr class=""top"">" & vbcrlf & "                          "
	sql7="select name from O_BookField where setopen in(2,3) and sort1<23 order by sort1 asc"
	set rs7=server.CreateObject("adodb.recordset")
	rs7.open sql7,conn,3,1
	if rs7.eof Then
		Response.write("<script>alert('系统缺少图书字段信息，请先设置图书字段！\n\n或者升级系统获取默认字段！');history.back();</script>")
		action1="图书归还添加":call close_list(1)
		Response.end()
	else
		ColumnNum=rs7.RecordCount
		do while not rs7.eof
			Response.write "" & vbcrlf & "                                     <td height=""27"" align=""center""><pre><b>"
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "                                     <td height=""27"" width=""100"" align=""center""><pre><b>已借数量</b></td>" & vbcrlf & "                                  <td height=""27"" width=""100"" align=""center""><pre><b>归还数量</b></td>" & vbcrlf & "                                  <td height=""27"" width=""100"" align=""center""><pre><b>归还时间</b></td>" & vbcrlf & "                                  <td height=""27"" width=""100"" align=""center""><pre><b>应还时间</b></td>" & vbcrlf & "                                      <td height=""27"" width=""100"" align=""center""><pre><b>是否损坏</b></td>" & vbcrlf & "                                  <td height=""27"" width=""100"" align=""center""><pre><b>归还进度</b></td>" & vbcrlf & "                                  <td height=""27"" align=""center""><pre><b>备注</b></td>" & vbcrlf & "                             </tr>" & vbcrlf & "                           <tbody id=""add_tr"">" & vbcrlf & "                               "
	if ord<>"" then
		h=1
		sql8="select a.id as pid,a.Ld_num, isnull((select SUM(Ret_num) from O_RetBookmx x inner join O_RetBook y on x.Ret_fid  = y.id and y.del =1 and x.Ret_bkid = a.id),0) as returnednum, a.Ld_time,a.Ld_rettime,c.*,b.set_name,e.name from O_lendbookmx a "&_
		"left join O_regbook c on a.Ld_bkid=c.id "&_
		"left join gate e on c.bk_addcateid=e.ord "&_
		"left join O_bookset b on c.bk_type=b.id where a.Ld_state=1 and a.id in ("&ord&")"
		set rs8=conn.execute(sql8)
		if not rs8.eof then
			do while not rs8.eof
				sql7="select isnull(sum(Ret_num),0) as Ret_num from O_RetBookmx where Ret_bkid="&rs8("pid")
				...
				rs7.close
				set rs7=nothing
				Response.write "" & vbcrlf & "                                     <tr id=""tr_"
				Response.write h
				Response.write """>" & vbcrlf & "                                                "
				sql7="select name from O_BookField where setopen in(2,3) and sort1<23 order by sort1 asc"
				set rs7=server.CreateObject("adodb.recordset")
				...
				if not rs7.eof then
					...
					do while not rs7.eof
						if rs7("name")="书名" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><div align=""center""><input type=""text"" readonly='true' name=""bookname"" id=""bookname"
							Response.write h
							Response.write """ size=""15"" value="""
							Response.write rs8("bk_name")
							Response.write """ maxlength=""2000""><input type=""hidden"" id=""Ret_bkid"
							Response.write h
							Response.write """ name=""Ret_bkid"" value="""
							Response.write rs8("pid")
							Response.write """>&nbsp;<a href=""###"" onclick=""del_TR('tr_"
							Response.write h
							Response.write "')""><img src=""../images/del2.gif""/></a>&nbsp;<span id='sortlist'>"
							Response.write h
							Response.write "</span></div></td>" & vbcrlf & "                                           "
						end if
						if rs7("name")="编号" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_bh"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_bh")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="分类" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_type"
							Response.write h
							Response.write """>"
							Response.write rs8("set_name")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="借阅周期" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center""  id=""bk_returnnum"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_returnnum")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="作者" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_auther"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_auther")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="出版时间" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_pubtime"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_pubtime")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="出版社" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_publishing"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_publishing")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="版次" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_pubnum"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_pubnum")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="页数" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_pagenum"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_pagenum")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="字数" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_pagesize"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_pagesize")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="印刷时间" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_printtime"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_printtime")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="开本" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_format"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_format")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="纸张" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_paper"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_paper")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="印次" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_printnum"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_printnum")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="ISBN" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_ISBN"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_ISBN")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="装帧" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_binding"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_binding")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="单价" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_price"
							Response.write h
							Response.write """>"
							bk_price=zbcdbl(rs8("bk_price"))
							if bk_price="" or isnull(bk_price) then bk_price=0
							Response.write Formatnumber(bk_price,num_dot_xs,-1)
'if bk_price="" or isnull(bk_price) then bk_price=0
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="可借阅数量" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_num"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_num")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="总价" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_allmoney"
							Response.write h
							Response.write """>"
							bk_allmoney=zbcdbl(rs8("bk_allmoney"))
							if bk_allmoney="" or isnull(bk_allmoney) then bk_allmoney=0
							Response.write Formatnumber(bk_allmoney,num_dot_xs,-1)
'if bk_allmoney="" or isnull(bk_allmoney) then bk_allmoney=0
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="存放位置" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_postion"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_postion")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="添加人员" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_addcateid"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_addcateid")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						if rs7("name")="添加时间" then
							Response.write "" & vbcrlf & "                                                     <td height=""27""><pre><div align=""center"" id=""bk_addtime"
							Response.write h
							Response.write """>"
							Response.write rs8("bk_addtime")
							Response.write "</div></td>" & vbcrlf & "                                          "
						end if
						rs7.movenext
					loop
				...
				rs7.close
				set rs7=nothing
				Response.write "" & vbcrlf & "                                             <td height=""27""><div align=""center"" id=""Ld_num1"
				Response.write h
				Response.write """>"
				Response.write rs8("Ld_num")
				returnednum = rs8("returnednum").value
				Response.write " <span style='color:#9999bb;font-size:10px'>(已还:" & returnednum & ")</span>"
				returnednum = rs8("returnednum").value
				Response.write "</div><input name=""Ld_num"" type=""hidden"" id=""Ld_num"
				Response.write h
				Response.write """ value="""
				Response.write rs8("Ld_num")
				Response.write """></td>" & vbcrlf & "                                           <td height=""27""><div align=""center""><pre><input name=""Ret_num"" type=""text"" id=""Ret_num"" size=""10"" maxlength=""20"" onkeyup=""value=value.replace(/[^\d]/g,'')"" onpropertychange=""allsum()"" value=""1""><input type=""hidden"" name=""Ret_nums"" value="""
				Response.write ret_num
				Response.write """ id=""Ret_nums"
				Response.write h
				Response.write """></div></td>" & vbcrlf & "                                             <td height=""27""><div align=""center""><input name=""Ret_time"
				Response.write h
				Response.write """ type=""text"" size=""9"" value="""
				Response.write date
				Response.write """ id=""daysOfMonthPosy"
				Response.write h
				Response.write """ onmouseup=toggleDatePicker(""daysOfMonthy"
				Response.write h
				Response.write """,""date.Ret_time"
				Response.write h
				Response.write """) readonly=""true""><DIV id=""daysOfMonthy"
				Response.write h
				Response.write """ style=""POSITION: absolute;z-index:10""></DIV><input name=""time1"" type=""hidden"" id=""time1"
				Response.write h
				Response.write h
				Response.write """ value="""
				Response.write rs8("Ld_time")
				Response.write """></div></td>" & vbcrlf & "                                             <td height=""27""><div align=""center""><input name=""Ld_rettime"
				Response.write h
				Response.write """ type=""text"" size=""9"" value="""
				Response.write rs8("Ld_rettime")
				Response.write """ id=""daysOfMonthPosx"
				Response.write h
				Response.write """ onmouseup=toggleDatePicker(""daysOfMonthx"
				Response.write h
				Response.write """,""date.Ld_rettime"
				Response.write h
				Response.write """) readonly=""true""><DIV id=""daysOfMonthx"
				Response.write h
				Response.write """ style=""POSITION: absolute;z-index:10""></DIV></div></td>" & vbcrlf & "                                           <td height=""27""><div align=""center"">" & vbcrlf & "                                                <select name=""Ret_isBreak"">" & vbcrlf & "                                                       <option value=""1"">否</option>" & vbcrlf & "                                                     <option value=""2"">是</option>" & vbcrlf & "                                             </select>" & vbcrlf & "                                              </div>" & vbcrlf & "                                          </td>" & vbcrlf & "                                           <td height=""27""><div align=""center"">" & vbcrlf & "                                                <select name=""Ld_stop"">" & vbcrlf & "                                                   <option value=""1"">否</option>" & vbcrlf & "                                                     <option value=""2"">是</option>" & vbcrlf & "                                             </select>" & vbcrlf & "                                            </div>" & vbcrlf & "                                          </td>" & vbcrlf & "                                           <td height=""27""><div align=""center""><input type=""text"" name=""Ret_note"" id=""Ret_note"" size=""15"" value="""" maxlength=""2000""></div></td>" & vbcrlf & "                                    </tr>" & vbcrlf & "                                   "
				h=h+1
				allnums1=ml.IsNum(allnums1)+rs8("Ld_num")
				allnums=ml.IsNum(allnums)+1
				rs8.movenext
			loop
		end if
		rs8.close
	...
	Response.write "" & vbcrlf & "                             </tbody>" & vbcrlf & "                                <tr>" & vbcrlf & "                                    <td colspan="""
	Response.write ColumnNum
	Response.write """ align=""right""><pre><a href=""javascript:void(0)"" onclick=""selectBook(b,'','',1);""><img src=""../images/jiantou.gif"" title=""添加明细""/>添加明细</a>&nbsp;合计：</td>" & vbcrlf & "                                 <td align=""center""><div id=""allnums1"">"
	Response.write allnums1
	Response.write "</div></td>" & vbcrlf & "                                  <td align=""center""><div id=""allnums"">"
	Response.write allnums
	Response.write "</div></td>" & vbcrlf & "                                  <td colspan=""6""></td>" & vbcrlf & "                             </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                  </div>" & vbcrlf & "                  </td>" & vbcrlf & "         </tr> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""2"" class=""gray"">" & vbcrlf & "                       <div align=""center"">" & vbcrlf & "                     <input type=""submit"" name=""Submit42"" value=""保存"" class=""page""/>" & vbcrlf & "                        <input type=""button"" value=""重填"" class=""page"" name=""B2"" onclick=""window.location.reload()"">" & vbcrlf & "             </div></td>" & vbcrlf & "      </tr> " & vbcrlf & "    </table>" & vbcrlf & "     </form>" & vbcrlf & "  </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"">" & vbcrlf & "     <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" &vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""ddd"" class=""easyui-dialog"" icon=""icon-search"" title=""选择图书""  style=""width:900px;height:500px;padding:5px;background:#fafafa;top:0px"" closed=""true"" >" & vbcrlf & "        <div region=""center"" border=""false"" style=""padding:10px;background:#fff;border:1px solid #ccc;width:100%"">" & vbcrlf & "            <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""  style=""word-break:break-all;word-wrap:break-word;""> " & vbcrlf & "                   <tr>" & vbcrlf & "                            <td height=""27""void(0)"" onClick=""$('#ddd').window('close');"">关闭</a>" & vbcrlf & "     </div>" & vbcrlf & "</div>" & vbcrlf & "" & vbcrlf & ""
	action1="图书返还添加"
	call close_list(1)
