...
'formatNumB = "0"& round(numf,num1)
	...
	Function HTMLEncode(fString)
		if not isnull(fString) Then
			...
			fString = Replace(fString, vbcrlf & CHR(10), "<br>")
	...
	Function HTMLDecode(fString)
		if not isnull(fString) Then
			...
			fString = Replace(fString, "&quot;",CHR(34) )
			fString = Replace(fString, "&#39;",CHR(39) )
			fString = Replace(fString, "<br>",vbcrlf & CHR(10))
...
'set rss=nothing
	...
	dim sort4,sort5,sort6
	sort4 = getrsval("select intro from setopen  where sort1=41 ")
	sort5 = getrsval("select intro from setopen  where sort1=42 ")
	sort6 = getrsval("select intro from setopen  where sort1=43 ")
	sort7 = getrsval("select intro from setopen  where sort1=44 ")
	sort10 = getrsval("select intro from setopen  where sort1=10 ")
	sort_jg = getrsval("select intro from setopen  where sort1=1202 ")
	sort_jg_cg=getrsval("select intro from setopen  where sort1=320173106 ")
	Response.write "" & vbcrlf & "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top""> " & vbcrlf & "   <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "      <tr>" & vbcrlf & "        <td class=""place"">采购价格控制</td>" & vbcrlf & "        <td>&nbsp;</td>" & vbcrlf & "        <td align=""right"">&nbsp;</td>" & vbcrlf & "        <td width=""3""><img src=""../images/m_mpr.gif""width=""3"" height=""32"" /></td>" & vbcrlf & "      </tr>" & vbcrlf & "    </table> " & vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "     <form method=""post"" action=""contract_cgjgsave.asp"" id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date""> "& vbcrlf & "   <tr class=""top""> "& vbcrlf &"         <td height=""30"" colspan=""6"" >采购价格控制</td>" & vbcrlf &"         </tr><tr> "& vbcrlf & "        <td  height=""26"" colspan=""6"" class=""name""><input name=""sort4"" type=""checkbox"" value=""1"" "
	if sort4="1" then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "高于限价不能录入 " & vbcrlf & "  <input name=""sort5"" type=""checkbox"" value=""1"" "
	if sort5="1" then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "高于限价需要审批 " & vbcrlf & "  <input name=""sort6"" type=""checkbox"" value=""1"" "
	if sort6="1" then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "任何采购（不含金额0）都需要审批 " & vbcrlf & "  <input name=""sort10"" type=""checkbox"" value=""1"" "
	if sort10="1" then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "采购金额为0需要审批 </td>" & vbcrlf & "      </tr>" & vbcrlf & "        <tr class=""top"">" & vbcrlf & "        <td height=""30"" >询价价格控制</td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td  height=""26"" class=""name""><input name=""sort7"" type=""checkbox""value=""1"" "
	if sort7="1" then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "高于限价不能录入  </td>" & vbcrlf & "      </tr>" & vbcrlf & "     <tr class=""top"">" & vbcrlf & "        <td height=""30"" colspan=""6"" >采购价格显示控制</td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "            <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "<input name=""sort_jg"" type=""radio"" value=""1"" onpropertychange=""chgSortJg(1);"" "
	if sort_jg="1" then
		Response.write "checked"
	end if
	Response.write ">默认显示历史价&nbsp;" & vbcrlf & "                <label id=""sort_jg_cg"" "
	if sort_jg<>"1" then Response.write("style='display:none;'")
	Response.write ">" & vbcrlf & "                    <input name=""sort_jg_cg"" type=""checkbox"" value=""1"" "
	if sort_jg_cg="1" then
		Response.write "checked"
	end if
	Response.write ">历史价格区分采购人员" & vbcrlf & "                </label>" & vbcrlf & "            </td>" & vbcrlf & "      </tr>" & vbcrlf & "        <tr>" & vbcrlf & "            <td height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "                <input name=""sort_jg"" type=""radio"" value=""2"" onpropertychange=""chgSortJg(2);"" "
	if sort_jg="2" then
		Response.write "checked"
	end if
	Response.write ">默认显示建议价" & vbcrlf & "            </td>" & vbcrlf & "        </tr>" & vbcrlf & "    <tr>" & vbcrlf & "        <td height=""40""><div align=""center"">" & vbcrlf & "          <input type=""submit"" name=""Submit42"" value=""保存""  class=""page""/>　　 " & vbcrlf & "          <input type=""reset"" value=""重填"" class=""page"" name=""B2"">         " & vbcrlf & "          </div></td>" & vbcrlf & "   </tr>" & vbcrlf & "   </form> " & vbcrlf & "    </table>  " & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "          </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
