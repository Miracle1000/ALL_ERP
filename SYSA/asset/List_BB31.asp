...
'if x=1 then
	...
	if ret<>"" then Str_Result1=Str_Result1+" and  datediff(s,'"&ret&"',D_time)>=0 "
	ret=ChangeDate(ret,1)
	ret2=ChangeDate(ret2,2)
	if ret2<>"" then Str_Result1=Str_Result1+" and  datediff(s,D_time,'"&ret2&"')>=0 "
	ret2=ChangeDate(ret2,2)
	Str_Result2 = ""
	qjret = request("qjret")
	if qjret<>"" then
		Str_Result2=Str_Result2+" and  datediff(m,'"& qjret & "-01" &"',ass_jttime)>=0 "
'if qjret<>"" then
	end if
	qjret2 = request("qjret2")
	if qjret2<>"" then
		Str_Result2=Str_Result2+" and datediff(m,ass_jttime,'"& qjret2 &"-01" &"')>=0 "
'if qjret2<>"" then
	end if
	Str_Result1=Str_Result1+Str_Result2
'if qjret2<>"" then
	if C<>"" then
		if B="name" then
		...
		elseif B="sort" then
			Str_Result=Str_Result&" and ass_type in (select ID from O_assSetname where sort1 like '%"&ml.De(C)&"%') "
		end if
	end if''
	...
	Response.write "" & vbcrlf & "<form name=""data"" id=""data"" action=""List_BB31.asp"" method=""get"" style=""padding:0; margin:0"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "           <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">已提折旧明细</td>" & vbcrlf & "                      <td><!--<A onclick=""Myopen(User);return false;"" href=""javascript:;"" class=""sortRule"">排序规则<IMG src=""../images/i10.gif"" alt=""排序规则"" width=""9"" height=""5"" border=""0""></A>--></td>" & vbcrlf & "           <td width=""2""><img src=""../images/m_mpr.gif"" width=""1"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table><span id=""ht1""></span>" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">      " & vbcrlf & "                <tr>" & vbcrlf & "              <td colspan=""10"" class=""top_btns"" background=""../images/112.gif""  height=""30"" align=""right"" style=""border-bottom:0px;border-top:#C0CCDD 0px solid;border-left:#C0CCDD 0px solid;border-right:#C0CCDD 1px;"">" & vbcrlf & "           <span id=""kh""><input type=""radio"" name=""hz"" checked=""checked"" onClick=""gotouri(2)"">明细表<input type=""radio"" name=""hz"" onClick=""gotouri(1)"">汇总表" & vbcrlf & "              计提期间：<input type=""text"" name=""qjret""id=""qjret"" Class=""DatePick"" style=""width:70px"" value="""
	Response.write qjret
	Response.write """ onclick=""setmonth(this)"" readonly=""readonly"">&nbsp;-&nbsp;<input style=""width:70px"" type=""text"" name=""qjret2"" id=""qjret2"" Class=""DatePick"" value="""
	Response.write qjret
	Response.write qjret2
	Response.write """ onclick=""setmonth(this)"" readonly=""readonly"">" & vbcrlf & "               <select name=""B"" id=""B"" style=""color:#000000"">" & vbcrlf & "                                <option value=""name"" "
	if B="name" then Response.write "selected"
	Response.write ">资产名称</option>" & vbcrlf & "                <option value=""sort"" "
	if B="sort" then Response.write "selected"
	Response.write ">资产分类</option>" & vbcrlf & "                           <option value=""bh"" "
	...
	if open_105_10=3 or (open_105_10=1 and CheckPurview(intro_105_10,trim(session("personzbintel2007"))))=True then
		Response.write "" & vbcrlf & "                     <input name=""submit2"" type=""button""  class=""anybutton2"" value=""导出"" onClick=""if (confirm('确认导出为EXCEL文档？')) { exportExcel({ from: 'form_with_page_action', page: '../out/xls_List_BB31.asp?px="
		Response.write px
	...
	Response.write "</span></td>" & vbcrlf & "         </tr>" & vbcrlf & "            <tr valign=""center"" class=""top resetGroupTableBg"">" & vbcrlf & "            <td width=""14%"" height=""30"" align=""left"" valign=""middle""><div align=""center"">资产名称</div></td>" & vbcrlf & "                  <td width=""12%"" align=""left"" valign=""middle""><div align=""center"">资产分类</div></td>" & vbcrlf & "                 <td width=""9%"" align=""left"" valign=""middle""><div align=""center"">计提周期</div></td>" & vbcrlf & "             <td width=""9%"" align=""left"" valign=""middle""><div align=""center"">资产购价</div></td>" & vbcrlf & "             <td width=""12%"" align=""left""valign=""middle""><div align=""center"">已提金额</div></td>" & vbcrlf & "                 <td width=""8%"" align=""left"" valign=""middle""><div align=""center"">已提周期</div></td>" & vbcrlf &"            <td width=""8%"" align=""left"" valign=""middle""><div align=""center"">计提期间</div></td>" & vbcrlf & "           <tdwidth=""15%"" align=""left"" valign=""middle""><div align=""center"">计提时间</div></td>" & vbcrlf & "          <td width=""9%"" align=""left"" valign=""middle""><div align=""center"">计提人员</div></td>" & vbcrlf & "                 <td width=""12%"" align=""left"" valign=""middle""><div align=""center"">操作</div></td>"& vbcrlf & "               </tr>          " & vbcrlf & "                  "
	currpage=Request("currpage")
	...
	currpage=clng(currpage)
	set rs7=server.CreateObject("adodb.recordset")
	sql7="SELECT a.D_assID,b.ass_money2 as allmoney,b.ass_name,b.ass_cycle,b.ass_ycycle ass_ycycle,b.ass_addcateid,b.ass_money,c.sort1 "&_
	"FROM "&_
	"(SELECT d_assid,d_money from O_assdeprect WHERE D_del=2 "&Str_Result1&") a "&_
	"LEFT JOIN O_asset b ON b.ass_id=a.d_assid "&_
	"left join O_assSetname c on b.ass_type=c.id "&Str_Result&" "&_
	"GROUP BY D_assID,b.ass_name,b.ass_cycle,b.ass_ycycle,ass_addcateid,b.ass_money,c.sort1,b.ass_money2   "
	hasData = false
	rs7.open sql7,conn,1,1
	if rs7.RecordCount<=0 then
		Response.write "<tr><td colspan=10 height=30><table align='center'><tr><td>没有信息!</td></tr></table></td></tr>"
		currpage=0
	else
		...
		do while not rs7.eof
			...
			Response.write "" & vbcrlf & "             <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "              <td width=""14%"" height=""30"" align=""left"" valign=""middle"">" & vbcrlf & "               "
			...
			Response.write "&nbsp;<img src=""../images/jiantou.gif""><a href=""javascript:void(0);"" onClick=""setHidden('tr','table_tr"
			Response.write rs7("D_assID")
			Response.write "');setSpan('"
			Response.write rs7("D_assID")
			Response.write "');""><span id=""textspan"
			Response.write rs7("D_assID")
			Response.write """>"
			if o>0 then
				Response.write "展开"
			...
			Response.write "明细</span></a></td>" & vbcrlf & "            <td width=""12%"" align=""left"" valign=""middle""><div align=""center"">"
			Response.write rs7("sort1")
			Response.write "</div></td>" & vbcrlf & "             <td width=""9%"" align=""left"" valign=""middle""><div align=""center"">"
			Response.write rs7("ass_cycle")
			Response.write "</div></td>" & vbcrlf & "             <td width=""9%"" align=""left"" valign=""middle""><div align=""center"">"
			Response.write Formatnumber(ml.IsNum(rs7("ass_money")),num_dot_xs,-1)
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""><div align=""center"">"
			Response.write Formatnumber(ml.IsNum(rs7("allmoney")),num_dot_xs,-1)
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""><div align=""center"">"
			Response.write rs7("ass_ycycle")
			Response.write "</div></td>" & vbcrlf & "         <td colspan=""4"" align=""left"" valign=""middle"">&nbsp;</td>" & vbcrlf & "          </tr>" & vbcrlf & "                        "
			sql8="select ROW_NUMBER() over(order by ass_jttime) ROWD_num,a.*,convert(varchar(7),a.ass_jttime,120) as jttime,b.name "&_
			" from O_assDeprect a left join gate b on a.D_cateid=b.ord "&_
			" where D_del=2 and D_assID="&rs7("D_assID")&" " & Str_Result2 &_
			" order by ROWD_num desc"
			set rs8=conn.execute(sql8)
			if not rs8.eof then
				do while not rs8.eof
					Response.write "" & vbcrlf & "                     <tr name=""table_tr"
					Response.write rs7("D_assID")
					Response.write """ onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"" "
					if o>0 then
						Response.write "style=""display:none"""
					end if
					Response.write ">" & vbcrlf & "                       <td height=""30"" colspan=""4"" align=""left"" valign=""middle""><div align=""right"">" & vbcrlf & "                   "
					if open_105_14=3 or CheckPurview(intro_105_14,trim(addcateid))=True then
						Response.write "" & vbcrlf & "                     <a href=""javascript:void(0);"" onClick=""javascript:window.open('Detail_assetBB2.asp?ord="
						Response.write rs8("id")
						Response.write "&del=1','neww34win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"">"
						Response.write rs8("id")
						Response.write rs7("ass_name")
						Response.write "</a>" & vbcrlf & "                 "
					else
					...
					Response.write "&nbsp;</div></td>" & vbcrlf & "                       <td align=""left"" valign=""middle""><div align=""center"">"
					Response.write Formatnumber(ml.IsNum(rs8("D_money")),num_dot_xs,-1)
					Response.write "</div></td>" & vbcrlf & "                     <td align=""left"" valign=""middle""><div align=""center"">"
					Response.write rs8("ROWD_num")
					Response.write "</div></td>" & vbcrlf & "               <td align=""left"" valign=""middle""><div align=""center"">"
					Response.write rs8("jttime")
					Response.write "</div></td>" & vbcrlf & "                     <td align=""left"" valign=""middle""><div align=""center"">"
					Response.write rs8("D_time")
					Response.write "</div></td>" & vbcrlf & "                     <td align=""left"" valign=""middle""><div align=""center"">"
					Response.write rs8("name")
					Response.write "</div></td>" & vbcrlf & "                     <td align=""left"" valign=""middle""><div align=""center"">" & vbcrlf & "                         "
					if open_105_14=3 or CheckPurview(intro_105_14,trim(addcateid))=True then
						Response.write "" & vbcrlf & "                        <input name=""button5"" type=""button""  class=""anybutton2"" id=""submit5"" onClick=""javascript:window.open('Detail_assetBB2.asp?ord="
						Response.write rs8("id")
						Response.write "&del=1','neww34win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" value=""详情""/>" & vbcrlf & "                        "
						Response.write rs8("id")
					end if
					if (open_105_3=3 or CheckPurview(intro_105_3,trim(addcateid))=True) then
						Response.write "" & vbcrlf & "                     <!--<input name=""button5"" type=""button""  class=""anybutton2"" id=""submit5"" onClick=""if(confirm('确认删除吗？')){window.location=('Del_assetBB2.asp?ord=&r=1')}"" value=""删除""/>-->"
'if (open_105_3=3 or CheckPurview(intro_105_3,trim(addcateid))=True) then
					end if
			...
			rs8.close
			set rs8=nothing
			allmoney1=allmoney1+CDbl(Formatnumber(ml.IsNum(rs7("ass_money")),num_dot_xs,-1))
			set rs8=nothing
			allmoney2=allmoney2+CDbl(Formatnumber(ml.IsNum(rs7("allmoney")),num_dot_xs,-1))
			set rs8=nothing
			o=o+1
			set rs8=nothing
			...
			rs7.movenext
		loop
		Response.write "" & vbcrlf & "              <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td height=""30"" colspan=""3"" align=""left"" valign=""middle""><div align=""right"">合计：</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""><div align=""center"">"
		Response.write Formatnumber(ml.IsNum(allmoney1),num_dot_xs,-1)
		Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""><div align=""center"">"
		Response.write Formatnumber(ml.IsNum(allmoney2),num_dot_xs,-1)
		Response.write "</div></td>" & vbcrlf & "         <td colspan=""5"" align=""left"" valign=""middle"">&nbsp;</td>" & vbcrlf & "        </tr>" & vbcrlf & "          "
	end if
	Response.write "" & vbcrlf & "     </table>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "  </form>" & vbcrlf & "  "
	if hasData then
		Response.write "" & vbcrlf & "  <tr>" & vbcrlf & "       <td class=""page"">" & vbcrlf & " <form name=""oneself"" action=""List_BB31.asp?px="
		Response.write px
		Response.write "&A="
		Response.write A
		Response.write "&B="
		...
		Response.write "&zdy9="
		Response.write zdy9
		Response.write """ method=""post"" id=""oneself"" style=""padding:0;margin:0"">" & vbcrlf & "        <table width=""100%"" border=""0"" align=""left"">" & vbcrlf & "    <tr>" & vbcrlf & "          <td width=""60"" height=""30""></td>" & vbcrlf & "            <td></td>               " & vbcrlf & "                <td>" & vbcrlf & "            <div align=""right"">" & vbcrlf & "            "
		...
		Response.write "             " & vbcrlf & "                </div>" & vbcrlf & "          </td>           " & vbcrlf & "          </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td colspan=""3"" height=""1000""></td>" & vbcrlf & "         </tr>" & vbcrlf & " </table>" & vbcrlf & "        </form>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  "
	end if
	Response.write "" & vbcrlf & "</table>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:100%; height:200;display:none;"">" & vbcrlf & "<table width=""150"" height=""200""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""192"">" & vbcrlf & "   <table width=""150"" height=""192"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=1')""><font color=""#2F496E"">按添加时间排序(降)</font></a></td>" & vbcrlf & " </tr>" & vbcrlf & "                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=2')""><font color=""#2F496E"">按添加时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=3')""><font color=""#2F496E"">按折旧时间排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<ahref=""###"" onClick=""gotourl('px=4')""><font color=""#2F496E"">按折旧时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=5')""><font color=""#2F496E"">按领用时间排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf &   "                <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=6')""><font color=""#2F496E"">按领用时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & ""
	rs7.close
	set rs7=nothing
	action1="已提折旧明细"
	call close_list(1)
	Response.write "" & vbcrlf & "<div id=""adsDiv"" style=""position:absolute;z-index:2001;display:none;padding:2px 2px 2px 2px;background-color:lightblue"">" & vbcrlf & "<iframe src="""" name=""adsIF"" id=""adsIF"" width=""195px"" frameborder=""0"" border=""0"" scrolling=""no""></iframe>" & vbcrlf & "</div>" & vbcrlf & "<form target=""ssIF"" action=""../asset/Search_All_Search.asp"" id=""ssIFForm"" style=""display:none"" method=""post"">" & vbcrlf & "</form>" & vbcrlf & "<script language=javascript>" & vbcrlf & "function gotouri(args)" & vbcrlf & "{" & vbcrlf & "      if(args==1)" & vbcrlf & "     {" & vbcrlf & "       window.location = '../../SYSN/view/finan/assets/AssetsSummary.ashx';" & vbcrlf & "      }" & vbcrlf & "       else if(args==2)" & vbcrlf & "        {" & vbcrlf & "               window.location='List_BB31.asp';" & vbcrlf & "        }" & vbcrlf & "}" & vbcrlf & "function setSpan(args)" & vbcrlf & "{" & vbcrlf & "       if(document.getElementById('textspan'+args).innerHTML==""展开明细"")" & vbcrlf & "  {" & vbcrlf & "               document.getElementById('textspan'+args).innerHTML=""隐藏明细"";" & vbcrlf & "    }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               document.getElementById('textspan'+args).innerHTML=""展开明细"";" & vbcrlf & "    }" & vbcrlf & "}" & vbcrlf & "function adSearch(obj,sel_type)" & vbcrlf & "{" & vbcrlf & "     " & vbcrlf & "        var tleft=obj.offsetLeft;" & vbcrlf & "       var ttop=obj.offsetTop;" & vbcrlf & " var theight=obj.clientHeight;" & vbcrlf & "   while (obj = obj.offsetParent){ttop+=obj.offsetTop; tleft+=obj.offsetLeft;}" & vbcrlf & "     var sdivobj=document.getElementById(""adsDiv"");" & vbcrlf & "      sdivobj.style.display=""none"";" & vbcrlf & "     sdivobj.style.left=tleft+""px"";" & vbcrlf & "    sdivobj.style.top=ttop+theight+""px"";" & vbcrlf & "      document.getElementById(""ssIFForm"").action=""../asset/Search_All_Search.asp?sel_type=""+sel_type;" & vbcrlf & "  document.getElementById(""ssIFForm"").target=""adsIF"";" & vbcrlf & " document.getElementById(""ssIFForm"").submit();" & vbcrlf & "     sdivobj.style.display=""inline"";" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function Myopen(divID){ //根据传递的参数确定显示的层" & vbcrlf & "      if(divID.style.display==""""){" & vbcrlf & "              divID.style.display=""none""" & vbcrlf & "        }else{" & vbcrlf & "          divID.style.display=""""" & vbcrlf & "    }" & vbcrlf & "       divID.style.left=300;" & vbcrlf & "   divID.style.top=20;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function testall()" & vbcrlf & "{" & vbcrlf & " if(!confirm('确认删除吗？'))" & vbcrlf & "        {" & vbcrlf & "                window.location=""List_BB31.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
	...
	Response.write "&CurrPage="
	Response.write CurrPage
	Response.write """;" & vbcrlf & "        }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               document.getElementById('data').action=""Del_assetBB2.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
	...
	Response.write "&CurrPage="
	Response.write CurrPage
	Response.write """;" & vbcrlf & "                document.getElementById('data').submit();" & vbcrlf & "       }" & vbcrlf & "}" & vbcrlf & "function testall1()" & vbcrlf & "{" & vbcrlf & "  if(!confirm('确认折旧吗？'))" & vbcrlf & "    {" & vbcrlf & "                window.location=""List_BB31.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
	...
	Response.write "&CurrPage="
	Response.write CurrPage
	Response.write """;" & vbcrlf & "        }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               document.getElementById('data').action=""Dep_assetBB2.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
	...
	Response.write "&CurrPage="
	Response.write CurrPage
	Response.write """;" & vbcrlf & "                document.getElementById('data').submit();" & vbcrlf & "       }" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function mm(form)" & vbcrlf & "{" & vbcrlf & "for (var i=0;i<form.elements.length;i++)" & vbcrlf & "///循环,form.elements.length得到表单里的控件个数" & vbcrlf & "{" & vbcrlf & "///把表单里的内容依付给e这个变量 " & vbcrlf & "var e = form.elements[i]; " & vbcrlf & "if (e.name != 'chkall') " & vbcrlf & "e.checked = form.chkall.checked; " & vbcrlf & "}" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
