...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script type=""text/vbscript"" src=""../work/pym.js?ver="
	Response.write Application("sys.info.jsver")
	...
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript""></script>" & vbcrlf & "<script src= ""../Script/tl_tongxllist_1.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  type=""text/javascript""></script>" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & "   $(function(){" & vbcrlf & "        $('#w').window({   " & vbcrlf & "                          maximizable:false ," & vbcrlf & "                             minimizable: false," & vbcrlf & "                             collapsible:false                               " & vbcrlf & "                                });" & vbcrlf & "});" & vbcrlf & "</script>" & vbcrlf & "" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "   margin-top: 0px;" & vbcrlf & "}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "-->" & vbcrlf & "#w{height:180px!important}" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	dim ord
	ord=request.QueryString("ord")
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "  <td width=""100%"" valign=""top"">      " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td class=""place"">通讯录添加</td>" & vbcrlf & "      <td>&nbsp;</td>" & vbcrlf & "      <td align=""right"">&nbsp;</td>" & vbcrlf & "      <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "    </tr>" & vbcrlf & "       </table>  " & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "       <form action=""save.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""date"" id=""demo"" onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" ><div align=""left""><strong>基本情况</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"" align=""right"" >"& vbcrlf & "          <div align=""right"">" & vbcrlf &             "<input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>"                 & vbcrlf &             "<input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf &           "</div></td>" & vbcrlf & "</tr> " & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""15%"" height=""33""><div align=""right"">姓　　名：</div></td>" & vbcrlf & "                          <td width=""23%""><div align=""left"" class=""gray""><input name=""name"" type=""text""  id=""name"" size=""15"" dataType=""Limit"" min=""1"" max=""50""  msg=""必须在1至50个字之间""> <span class=""red"">*</span></div></td>" & vbcrlf &                              "<td width=""15%""><div align=""right"">性　　别：</div></td>" & vbcrlf &                             "<td width=""19%"">" & vbcrlf &                                     "<div align=""left"" class=""gray"">" & vbcrlf &                                        "<input name=""sex"" type=""radio"" value=""男"" checked>"& vbcrlf & "                                               男" & vbcrlf & "                                              <input type=""radio"" name=""sex"" value=""女"">" & vbcrlf & "                                            女</div>                        </td>" & vbcrlf & "                           <td width=""15%"" height=""100"" rowspan=""3"">" & vbcrlf & "          <div align=""right"">照　　片： </div></td>" & vbcrlf & "                            <td height=""100"" rowspan=""3"">"& vbcrlf &                                "<img id=""imageField"" src=""../person/img/noneperson.jpg"" width=""90"" height=""100"" alt=""头像"">" & vbcrlf &                                "<input type=""hidden"" id=""imgurl1"" name=""imgurl1"" value=""></td>" & vbcrlf &       "</tr>" & vbcrlf &       "<tr>" & vbcrlf &         "<td width=""15%""><div align=""right"">家庭电话：</div></td>" & vbcrlf & "        <td width=""23%"" height=""33"" class=""gray"">" & vbcrlf & "          <div align=""left"">" & vbcrlf & "            <input name=""phone1"" type=""text""  id=""phone1"" size=""15"" datatype=""Limit"" max=""30""  msg=""家庭电话不能超过30个字"">" & vbcrlf & "                       "
	If tp=1 Then
		If ZBRuntime.MC(32000) Then
			Response.write "<img src='../images/15.gif' border='0' align='absbottom' style=' cursor:hand' onClick='phoneCall(phone1.value)'>"
		end if
	end if
	Response.write "" & vbcrlf & "          </div></td>" & vbcrlf & "        <td width=""15%""><div align=""right"">办公电话：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray"">" & vbcrlf & "              <div align=""left"">" & vbcrlf & "                      <input name=""phone2"" type=""text""  id=""phone2"" size=""15"" dataType=""Limit"" max=""30""  msg=""办公电话不能超过30个字"">" & vbcrlf & "                   "
	If tp=1 Then
		If ZBRuntime.MC(32000) Then
			Response.write "<img src='../images/15.gif' border='0' align='absbottom' style=' cursor:hand' onClick='phoneCall(phone2.value)'>"
		end if
	end if
	Response.write "" & vbcrlf & "                </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "       <tr>" & vbcrlf & "         <td width=""15%""><div align=""right"">家庭地址：</div></td>" & vbcrlf & "         <td height=""33""  class=""gray""><div align=""left"">" & vbcrlf & "             <input name=""familyadd"" type=""text"" id=""familyadd"" size=""30"" dataType=""Limit"" max=""200""  msg=""地址不能超过200个字"">" & vbcrlf &          "</div></td>" & vbcrlf &          "<td width=""15%""><div align=""right"">传　　真：</div></td>" & vbcrlf &         "<td class=""gray""><input name=""fax"" type=""text"" id=""fax"" size=""15"" dataType=""Limit"" max=""30""  msg=""传真不能超过30个字"">" & vbcrlf & "                       "
	If tp=1 Then
		If ZBRuntime.MC(32000) Then
			Response.write "<img src='../images/15.gif' border='0' align='absbottom' style=' cursor:hand' onClick='phoneCall(fax.value)'>"
		end if
	end if
	Response.write "" & vbcrlf & "              </td>" & vbcrlf & "        </tr>" & vbcrlf & "<tr>" & vbcrlf & "        <td width=""15%""><div align=""right"">手　　机：</div></td>" & vbcrlf & "        <td height=""33"" class=""gray"">" & vbcrlf & "          <div align=""left"">" & vbcrlf & "            <input name=""mobile1"" type=""text"" id=""mobile1"" size=""15"" dataType=""Limit"" max=""30""  msg=""手机不能超过30个字"">" & vbcrlf & ""
	If tp=1 Then
		If ZBRuntime.MC(32000) Then
			Response.write "<img src='../images/sj.gif' border='0' align='absbottom' style=' cursor:hand' onClick='phoneCall(mobile1.value)'>"
		end if
	end if
	if open_67_13=1  and open_67_19<>1  then
		Response.write "" & vbcrlf & "            <img src=""../images/message.gif"" onClick=""sendSms(mobile1.value);function sendSms(phone){if (phone.length==11){" & vbcrlf & "window.open('../message/topadd.asp?phone='+phone+'','newsSendSMS','width=900,height=800,fullscreen=no,scrollbars=0,toolbar=0,status=no,resizable=1,location=no,menubar=no,menubar=no,left=20,top=100');} else{ alert('请填写正确的号码！');}}""  style=""cursor:hand"" border=""0"" alt=""发送短信"" align=""absbottom"">" & vbcrlf & "            "
	end if
	Response.write "</div></td>" & vbcrlf & "        <td width=""15%""><div align=""right"">移动电话：</div></td>" & vbcrlf & "        <td class=""gray"">" & vbcrlf & "          <div align=""left"">" & vbcrlf & "            <input name=""mobile2"" type=""text"" id=""mobile2"" size=""15"" dataType=""Limit"" max=""30"" msg=""移动电话不能超过30个字"">" & vbcrlf & "            "
	If tp=1 Then
		If ZBRuntime.MC(32000) Then
			Response.write "<img src='../images/sj.gif' border='0' align='absbottom' style=' cursor:hand' onClick='phoneCall(mobile2.value)'>"
		end if
	end if
	if open_67_13=1  and open_67_19<>1  then
		Response.write "" & vbcrlf & "            <img src=""../images/message.gif"" onClick=""sendSms(mobile2.value);function sendSms(phone){if (phone.length==11){" & vbcrlf & "window.open('../message/topadd.asp?phone='+phone+'','newsSendSMS','width=900,height=800,fullscreen=no,scrollbars=0,toolbar=0,status=no,resizable=1,location=no,menubar=no,menubar=no,left=20,top=100');} else{ alert('请填写正确的号码！');}}""  style=""cursor:hand"" border=""0"" alt=""发送短信"" align=""absbottom"">" & vbcrlf & "            "
	end if
	Response.write "</div></td>" & vbcrlf & "        <td width=""15%""><div align=""right"">上　　传：</div></td>" & vbcrlf & "        <td class=""gray"">" & vbcrlf & "          <div align=""left"">" & vbcrlf & "                "
	Response.write "" & vbcrlf & "                <input type=""button"" name=""openbn"" id=""openbn"" value=""上传头像""  class=""anybutton"" onclick=""$('#w').window('open');""/>            </div>            </td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td width=""15%""><div align=""right"">电子邮件：</div></td>" & vbcrlf & "        <td class=""gray""><div align=""left"">" & vbcrlf & "            <input name=""email"" id=""email"" type=""text"" size=""15"" dataType=""Limit"" max=""50""  msg=""电子邮件不能超过50个字"">" & vbcrlf & "                                            "
	if open_77_13=1  and open_77_19<>1  then
		Response.write "<img satyle='height:20px;widht:30px;' src=""../images/email.gif"" onClick=""sendEmail(email.value);function sendEmail(email){if (email.indexOf('@')>0){" & vbcrlf & "window.open('../email/index.asp?email='+email+'','newsSendEmail','width=900,height=800,fullscreen=no,scrollbars=0,toolbar=0,status=no,resizable=1,location=no,menubar=no,menubar=no,left=20,top=100');} else{ alert('请输入正确的邮箱！');}}""  style=""cursor:hand"" border=""0"" alt=""发送邮件"" align=""absbottom"">"
	end if
	Response.write "" & vbcrlf & "        </div></td>" & vbcrlf & "        <td width=""15%""><div align=""right"">QQ：</div></td>" & vbcrlf & "        <td class=""gray"">" & vbcrlf & "          <div align=""left"">" & vbcrlf & "            <input name=""qq"" type=""text"" id=""qq"" size=""15"" onKeyUp=""value=value.replace(/[^\d]/g,'')"" dataType=""Limit"" max=""30""  msg=""QQ不能超过30个字"">" & vbcrlf & "          </div></td>" & vbcrlf & "        <td width=""15%""><div align=""right"">MSN：</div></td>" & vbcrlf & "        <td class=""gray"">" & vbcrlf & "          <div align=""left"">" & vbcrlf & "            <input name=""msn"" type=""text"" id=""msn"" size=""15"" dataType=""Limit"" max=""50""  msg=""MSN不能超过50个字"" >" & vbcrlf & "</div></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td width=""15%""><div align=""right"">生　　日：</div></td>" & vbcrlf & "        <td height=""33"" class=""gray""><INPUT type=""text"" name=birthday id=""birthday"" size=15 onclick=""toggleDatePicker('daysOfMonth','date.birthday')"" readonly=""true"">" & vbcrlf & "            <DIV id=daysOfMonth style=""POSITION: absolute""></DIV>          </td>" & vbcrlf & "        <td width=""15%"" height=""33""><div align=""right"">是否提示：</div></td>" & vbcrlf & "        <td height=""33"" class=""gray""><div align=""left"">" & vbcrlf & "          <input name=""wran"" type=""radio"" value=""0"" checked>" & vbcrlf & "          提示" & vbcrlf & "          <input type=""radio"" name=""wran"" value=""1"">" & vbcrlf & "不提示</div></td>" & vbcrlf & "                <td width=""15%"" height=""33""><div align=""right"">年　　龄：</div></td>" & vbcrlf & "          <td height=""33"" class=""gray""><div align=""left"">" & vbcrlf & "            <input name=""age"" type=""text"" id=""age"" size=""15"" onKeyUp=""value=value.replace(/[^\d]/g,'')"" dataType=""number"" min=""0"" max=""999""  msg=""年龄不能超过3个字"" cannull=1 >" & vbcrlf & "        </div></td>" & vbcrlf & "      </tr>" & vbcrlf & "           " & vbcrlf & "       <tr>" & vbcrlf & "      <td width=""15%""><div align=""right"">分类选择：</div></td>" & vbcrlf & "            <td class=""gray""><div align=""left"">"& vbcrlf & ""
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select *  from txltype where ord="&session("personzbintel2007")&" order by gate1 asc"
	rs7.open sql7,conn,1,1
	Response.write "" & vbcrlf & "            <select name=""sort"" id=""sort"">" & vbcrlf & "                               <option value=""""></option>" & vbcrlf & "                                "
	if not rs7.eof then
	...
	Response.write "" & vbcrlf & "                     </select>" & vbcrlf & "        </div></td>" & vbcrlf & "        <td width=""15%""><div align=""right"">邮　　编：</div></td>" & vbcrlf & "        <td class=""gray""><div align=""left"">" & vbcrlf & "            <input name=""postcode"" type=""text"" id=""postcode"" onKeyUp=""value=value.replace(/[^\d]/g,'')"" size=""15"" datatype=""Limit"" max=""6""  msg=""邮编不能超过6个字"">" & vbcrlf & "        </div></td>" & vbcrlf & "        <td width=""15%"">" & vbcrlf & "          <div align=""right"">单位电话：</div></td>" & vbcrlf & "                  <td class=""gray"">" & vbcrlf & "          <div align=""left"">" & vbcrlf & "            <input name=""comtel"" type=""text""  id=""comtel"" size=""15"" dataType=""Limit"" max=""60"" msg=""单位电话不能超过60个字"">" & vbcrlf & "                 "
	If tp=1 Then
		If ZBRuntime.MC(32000) Then
			Response.write "<img src='../images/15.gif' border='0' align='absbottom' style=' cursor:hand' onClick='phoneCall(comtel.value)'>"
		end if
	end if
	Response.write "" & vbcrlf & "          </div></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td width=""15%""><div align=""right"">单位邮编：</div></td>" & vbcrlf & "        <td height=""33"" class=""gray""><input name=""zip"" type=""text"" id=""zip"" size=""15"" onKeyUp=""value=value.replace(/[^\d]/g,'')"" dataType=""Limit"" max=""6""  msg=""单位邮编不能超过6个字""></td>" & vbcrlf & "        <td width=""15%""><div align=""right"">所在单位：</div></td>" & vbcrlf & "        <td class=""gray""><div align=""left"">" & vbcrlf & "            <input name=""company"" type=""text"" id=""company"" size=""30"" dataType=""Limit"" max=""200""  msg=""所在单位地址不能超过200个字"">" & vbcrlf & "        </div></td>" & vbcrlf & "        <td width=""15%""><div align=""right"">担当职务：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""position"" type=""text""  id=""position"" size=""15"" dataType=""Limit"" max=""20"" msg=""担当职务不能超过20个字""></td>" & vbcrlf &       "</tr>" & vbcrlf &          "<tr>" & vbcrlf &       "<td width=""15%""><div align=""right"">单位传真：</div></td>" & vbcrlf &             "<td height=""33"" class=""gray""><input name=""comfax"" type=""text"" id=""comfax"" size=""15"" dataType=""Limit"" max=""30""  msg=""单位传真不能超过30个字"">" & vbcrlf & "                  "
	If tp=1 Then
		If ZBRuntime.MC(32000) Then
			Response.write "<img src='../images/15.gif' border='0' align='absbottom' style=' cursor:hand' onClick='phoneCall(comfax.value)'>"
		end if
	end if
	Response.write "" & vbcrlf & "</td>" & vbcrlf & "<td width=""15%""><div align=""right"">单位地址：</div></td>" & vbcrlf & "        <td class=""gray""><div align=""left"">" & vbcrlf & "          <input name=""comadd"" type=""text"" id=""comadd"" size=""30"" dataType=""Limit"" max=""200""  msg=""单位地址不能超过200个字"">" & vbcrlf & "        </div></td>" & vbcrlf & "        <td width=""15%""><div align=""right"">公司地址：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""comadd1"" type=""text"" id=""comadd1"" size=""30"" dataType=""Limit"" max=""200""  msg=""公司地址不能超过200个字""></td>" & vbcrlf & "     </tr>" & vbcrlf & "         <tr class=""top"">" & vbcrlf & "        <td height=""27"" colspan=""6"" ><div align=""left""><strong>详细信息</strong></div></td>" & vbcrlf & "        </tr> " & vbcrlf & "          <tr>" & vbcrlf & "          <td width=""15%""><div align=""right"">学　　历：</div></td>" & vbcrlf & "           <td height=""33"" class=""gray""><input name=""xl"" type=""text"" size=""15"" dataType=""Limit"" min=""0"" max=""100""  msg=""学历不能超过100个字""></td>" & vbcrlf & "            <td width=""15%"" height=""33""><div align=""right"">学　　位：</div></td>" & vbcrlf & "          <td height=""33"" class=""gray""><input name=""xw"" type=""text"" size=""15"" dataType=""Limit"" min=""0"" max=""200""  msg=""学位不能超过200个字""></td>" & vbcrlf & "        <td width=""15%""><div align=""right"">专　　业：</div></td>" & vbcrlf & "            <td class=""gray""><input name=""zy"" type=""text"" size=""15"" dataType=""Limit"" min=""0"" max=""200""  msg=""专业不能超过200个字""></td>" & vbcrlf & "        </tr>" & vbcrlf & "       <tr>" & vbcrlf & "         <td width=""15%""><div align=""right"">毕业院校：</div></td>" & vbcrlf & "         <td height=""33"" class=""gray""><input name=""shool"" type=""text"" id=""shool"" size=""15"" dataType=""Limit"" min=""0"" max=""200""  msg=""毕业院校不能超过200个字""></td>" & vbcrlf &          "<td width=""15%""><div align=""right"">籍　　贯：</div></td>" & vbcrlf &          "<td class=""gray""><input name=""jg"" type=""text"" size=""15""  dataType=""Limit"" max=""100""  msg=""籍贯不能超过100个字""></td>" & vbcrlf &          "<td width=""15%""><div align=""right"">民　　族：</div></td>" & vbcrlf & "         <td class=""gray""><input name=""mz"" type=""text"" size=""15"" dataType=""Limit"" min=""0"" max=""50""  msg=""民族不能超过50个字""></td>" & vbcrlf & "       </tr>" & vbcrlf & "        <tr>" & vbcrlf & "          <td width=""15%""><div align=""right"">身　　高：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""high"" type=""text"" id=""high"" size=""15"" dataType=""Limit"" min=""0"" max=""20""  msg=""身高不能超过20个字""></td>" & vbcrlf & "          <td width=""15%""><div align=""right"">体　　重：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""weigh"" type=""text"" id=""weigh"" size=""15"" dataType=""Limit"" min=""0"" max=""20""  msg=""体重不能超过20个字""></td>" & vbcrlf & "          <td width=""15%""><div align=""right"">体　　型：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""tx"" type=""text"" size=""15"" dataType=""Limit"" min=""0"" max=""30""  msg=""体型不能超过30个字""></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "          <td width=""15%""><div align=""right"">鞋　　码：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""xm"" type=""text"" size=""15"" dataType=""Limit"" min=""0"" max=""10""  msg=""鞋码不能超过10个字""></td>" & vbcrlf & "          <td width=""15%""><div align=""right"">是否吸烟：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""smoke"" type=""radio"" value=""吸烟"" checked>" & vbcrlf & "吸烟" & vbcrlf & "  <input type=""radio"" name=""smoke"" value=""不吸烟"">" & vbcrlf & "不吸烟 </td>" & vbcrlf & "          <td width=""15%""><div align=""right"">喜欢烟牌：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""smoketype"" type=""text"" id=""smoketype"" size=""15"" dataType=""Limit"" min=""0"" max=""30""  msg=""喜欢烟牌不能超过30个字""></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "          <td width=""15%""><div align=""right"">是否饮酒：</div></td>" & vbcrlf & "          <td class=""gray"">" & vbcrlf & "<div align=""left"">" & vbcrlf & "              <input name=""wine"" type=""radio"" value=""饮酒"" checked>" & vbcrlf & "饮酒" & vbcrlf & "              <input type=""radio"" name=""wine"" value=""不饮酒"">" & vbcrlf & "            不饮酒</div></td>" & vbcrlf & "          <td width=""15%""><div align=""right"">喜欢酒类：</div></td>" & vbcrlf & "          <td class=""gray""><div align=""left"">" & vbcrlf &             "<input name=""winetype"" type=""text"" id=""winetype"" size=""15"" dataType=""Limit"" min=""0"" max=""30""  msg=""喜欢酒类不能超过30个字"">" & vbcrlf &           "</div></td>" & vbcrlf &           "<td width=""15%""><div align=""right"">喜欢酒牌：</div></td>" & vbcrlf &           "<td class=""gray""><input name=""winesign"" type=""text"" id=""winesign"" size=""8"" style=""width:70px;"" dataType=""Limit"" min=""0"" max=""30""  msg=""喜欢酒牌不能超过30个字"">" & vbcrlf & "            酒量：" & vbcrlf & "            <input name=""winel"" type=""text"" id=""winel"" size=""8"" style=""width:70px;""dataType=""Limit"" min=""0"" max=""30""  msg=""酒量不能超过30个字""></td>" & vbcrlf & "        </tr>" & vbcrlf & "<tr>" & vbcrlf & "          <td width=""15%""><div align=""right"">是否喝茶：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""tea"" type=""radio"" value=""喝茶"" checked>" & vbcrlf & "喝茶" & vbcrlf & "  <input type=""radio"" name=""tea"" value=""不喝茶"">" & vbcrlf & "不喝茶</td>" & vbcrlf & "<td width=""15%""><div align=""right"">喜欢茶类：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""teatype"" type=""text"" id=""teatype"" size=""15"" dataType=""Limit"" min=""0"" max=""30""  msg=""喜欢茶类不能超过30个字""></td>" & vbcrlf & "          <td width=""15%""><div align=""right"">饮食忌口：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""food"" type=""text"" id=""food"" size=""15"" dataType=""Limit"" min=""0"" max=""50""  msg=""饮食忌口不能超过50个字""></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "          <td width=""15%""><div align=""right"">疾病情况：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""health"" type=""text"" id=""health"" size=""15"" dataType=""Limit"" min=""0"" max=""50""  msg=""疾病情况不能超过50个字""></td>" & vbcrlf & "<td width=""15%""><div align=""right"">驾　　照：</div></td>" & vbcrlf &           "<td class=""gray""><div align=""left"">" & vbcrlf & "<input name=""drive"" type=""radio"" value=""有"" checked>"  & vbcrlf &             "有" & vbcrlf &             "<input type=""radio"" name=""drive"" value=""没有"">" & vbcrlf & "没有</div></td>" & vbcrlf & "          <td width=""15%""><div align=""right"">私　　车：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""car"" type=""radio"" value=""有"" checked>" & vbcrlf & "            有" & vbcrlf & "<input type=""radio"" name=""car"" value=""无"">" & vbcrlf & "              无            </td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "          <td width=""15%""><div align=""right"">私车车型：</div></td>" & vbcrlf & "          <td class=""gray""><div align=""left"">" & vbcrlf & "   <input name=""cartype"" type=""text"" id=""cartype"" size=""15"" dataType=""Limit"" min=""0"" max=""50""  msg=""私车车型不能超过50个字"">" & vbcrlf & "          </div></td>" & vbcrlf & "          <td width=""15%""><div align=""right"">私车颜色：</div></td>" & vbcrlf & "          <td class=""gray""><div align=""left"">" & vbcrlf & "            <input name=""carcolor"" type=""text"" id=""carcolor"" size=""15"" dataType=""Limit"" min=""0"" max=""30""  msg=""私车颜色不能超过30个字"">" & vbcrlf & "          </div></td>" & vbcrlf & "          <td width=""15%""><div align=""right"">私车牌照：</div></td>" & vbcrlf & "    <td class=""gray""><input name=""cardrive"" type=""text"" id=""cardrive"" size=""15"" dataType=""Limit"" min=""0"" max=""30""  msg=""私车牌照不能超过30个字""></td>" & vbcrlf & "        </tr>          " & vbcrlf & "                "
	set rs8=server.CreateObject("adodb.recordset")
	sql8="select * from zdy where sort1=94 and set_open=1 order by gate1 asc "
	...
	if rs8.eof then
		...
		do until rs8.eof
			...
			if rs8("sort")=2 then
				...
				Response.write """ type=""text"" size=""15"" datatype=""Limit"" max=""50"" msg="""
				Response.write rs8("title")
				Response.write "不能超过50个字"">" & vbcrlf & "          "
			...
			elseif rs8("sort")=3 then
				...
				Response.write """ id="""
				Response.write rs8("name")
				Response.write """ value="""" size=15 onclick=""toggleDatePicker('daysOfMonth1','date."
				Response.write rs8("name")
				Response.write "')"" readonly=""true"">" & vbcrlf & "                <DIV id=daysOfMonth1 style=""POSITION: absolute""></DIV> " & vbcrlf & "           "
			end if
	...
	rs8.close
	set rs8=nothing
	Response.write "" & vbcrlf & "        <tr>" & vbcrlf & "          <td width=""15%""><div align=""right"">明显特征：</div></td>" & vbcrlf & "          <td colspan=""5"" class=""gray""><input name=""tz"" type=""text"" id=""tz"" size=""60"" dataType=""Limit"" min=""0"" max=""300""  msg=""明显特征不能超过300个字""></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "        <td width=""15%""><div align=""right"">爱好特长：</div></td>" & vbcrlf & "        <td colspan=""5"" class=""gray"">" & vbcrlf & "          <div align=""left"">" & vbcrlf & "            <textarea name=""tc"" cols=""80"" rows=""4"" id=""tc""dataType=""Limit"" max=""2000""  msg=""爱好特长不能超过2000个字""></textarea>" & vbcrlf &           "</div></td>" & vbcrlf &         "</tr>" & vbcrlf &          "<tr>" & vbcrlf &       "<td width=""15%""><div align=""right"">备　　注：</div></td>" & vbcrlf &             "<td colspan=""5"" class=""gray"">" & vbcrlf & "<div align=""left"">" & vbcrlf & "                  <textarea name=""note"" cols=""80"" rows=""4"" id=""note"" dataType=""Limit"" max=""2000""  msg=""备注不能超过2000个字""></textarea>" & vbcrlf & "              </div></td></tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td  colspan=""6"" class=""gray"">   <p align=""center"">" & vbcrlf &                 "<input type=""submit"" name=""Submit42"" value=""保存""  class=""page""/>　　"           & vbcrlf &        ""          & vbcrlf &                 "<input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf &        ""          & vbcrlf & "        </td></tr> " & vbcrlf & "            </form>" & vbcrlf & "    </table>" & vbcrlf & "     </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30""><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "" & vbcrlf & "   </td>" & vbcrlf & "</tr>" & vbcrlf & "<IFRAME style=""display:none"" name=""I5"" id=""I5"" FRAMEBORDER=""0"" SCROLLING=""no"" marginwidth=""1"" marginheight=""1""></IFRAME>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="通讯录添加"
	call close_list(1)
	Response.write "" & vbcrlf & "<!--8888888888888888888888888888888888888888888888-->" & vbcrlf & "<div id=""w"" class=""easyui-window"" title=""上传头像""  style=""width:500px;height:190px;padding:5px;background: #fafafa;top:200px;""  closed=""true"" >" & vbcrlf & "<div region=""center"" border=""false"" style=""padding:10px;background:#fff;border:1px solid #ccc; width:450px"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <form action=""saveimg.asp"" method=""post"" enctype=""multipart/form-data"" name=""updata"" id=""updata"" target=""I5"">" & vbcrlf & "        <tr>" & vbcrlf & "          <td width=""28%"" height=""45"" valign=""middle""><div align=""right"">路径：</div></td>" & vbcrlf & "          <td width=""72%"" align=""left"" valign=""middle""><div align=""left"">" & vbcrlf & "              <input name=""imgurl"" class=""anybutton"" type=""file"" id=""imgurl"" style=""background-color:#FFFFFF;"">" & vbcrlf & "              <input name=""t""  id=""t"" type=""hidden"" value=""2"">" & vbcrlf & "          </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "                               <tr><td colspan=""2"" align=""center"">最佳尺寸：90*100(px)  &nbsp;格式要求：JPG/GIF/PNG </td></tr>" & vbcrlf & "      </form>" & vbcrlf & "    </table>" & vbcrlf & "</div><br />" & vbcrlf & "<div region=""south"" border=""false"" style=""text-align:center;height:30px;line-height:30px;"">" & vbcrlf & " <a class=""easyui-linkbutton""  href=""###"" onClick=""document.getElementById('updata').submit()"">确认</a>" & vbcrlf & "       <a class=""easyui-linkbutton"" href=""###"" onClick=""$('#w').window('close');"">取消</a>" & vbcrlf & "</div>" & vbcrlf & "</div>" & vbcrlf & "<!--888888888888888888888888888888888888888888888-->" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
