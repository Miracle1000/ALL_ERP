...
'bigsystemtype = ".mozi"
	...
	Response.write "" & vbcrlf & "<!DOCTYPE html>" & vbcrlf & "<html>" & vbcrlf & "<head>" & vbcrlf & "<meta http-equiv=""Content-Language"" content=""zh-cn"">" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"">" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<title>"
	Response.write session("name2006chen")
	Response.write "销售管理系统</title>" & vbcrlf & "<STYLE type=""text/css""> " & vbcrlf & "<!-- a:link { text-decoration: none; font-family: AdobeSm; color: #000000 }" & vbcrlf & "a:visited { text-decoration: none; color: #000000 }" & vbcrlf & "A:hover {COLOR: green; FONT-FAMILY: ""宋体""; TEXT-DECORATION: underline;}"& vbcrlf &" body { font-size: 9pt; font-family: 宋体, Arial;color: #000000} "& vbcrlf & "TD {FONT-SIZE: 9pt; FONT-FAMILY: ""宋体"", ""Arial"";color: #000000}" & vbcrlf & "p {FONT-SIZE: 9pt; FONT-FAMILY: ""宋体"", ""Arial"";color: #000000} "& vbcrlf & "input {FONT-SIZE: 9pt; FONT-FAMILY: ""宋体"", ""Arial"";color: #000000}" & vbcrlf &" #table2 tr.top_tr td{padding-top:0;padding-bottom:0}" & vbcrlf & "#table2{margin-top:0}" & vbcrlf & "body {     margin-top: 0;  margin-bottom: 0;       color: #000000; background-color: #FFFFFF;      margin-left: 0px;       margin-right: 0px;}" & vbcrlf &" --></STYLE>" & vbcrlf & "<script language=""javascript"" src=""../Inc/DelUnusedFiles.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "</head>" & vbcrlf & "<body onUnload=""if(window.opener) window.opener.location.reload();"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">添加工作互动</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>  " & vbcrlf & "<table border=""0"" width=""100%"" id=""table1"" cellspacing=""0"" cellpadding=""0"" bgcolor=""#FFFFFF"" height=""600"">" & vbcrlf & "      <tr>" & vbcrlf & "            <td valign=""top"">" & vbcrlf & "<form method=""POST"" action=""admin_news_add_save.asp"
	if title<>"" then Response.write "?edit=1&id="&request("id")
	Response.write """ onSubmit=""return checkSelect()&&DelUnusedFilesBeforeSubmit()"" language=""JavaScript"" name=""FrontPage_Form1"">" & vbcrlf & "                    <table border=""0"" width=""100%"" id=""table2"" cellspacing=""0"" cellpadding=""5"" style=""border-collapse: collapse"" bordercolor=""#c0ccdd"">" & vbcrlf & "           <tr class=""top_tr"">" & vbcrlf & "                                       <td class=""top_td"" width=""14%"" align=""center""><strong class=""gray2"">分类选择</strong></td>" & vbcrlf & "                                <td class=""top_td"" width=""86%"">   " & vbcrlf & "                                  "
	set rs=server.CreateObject("adodb.recordset")
	sql="select ord, sort1 from sortonehy where gate2=93 order by gate1 desc "
	rs.open sql,conn,1,1
	Response.write "                               " & vbcrlf & "                                       <select name=""sorttype"" id=""sorttype"" class=""gray"">" & vbcrlf & "                                   <option value=""0"">选择分类</option>" & vbcrlf & "                                       "
	if not rs.eof then
		do until rs.eof
	...
	Response.write "" & vbcrlf & "                                      </select>" & vbcrlf & "                                       <font color=""#FF0000"">* </font><span id=""sorttype_Msg"" style=""color:red""></span>" & vbcrlf & "                                      "
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "                                      </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                    <td width=""14%"" align=""center"" valign=""middle"" class=""gray""><strong class=""gray2"">共享设置</strong></td>" & vbcrlf & "                            <td width=""86%"">                                        " & vbcrlf & "                                <table width=""98%""  border=""0"" align=""left""  bgcolor=""#FFFFFF"" >" & vbcrlf & "    <tr>" & vbcrlf & "              <td height=""37"" colspan=""3"" class=""gray""> " & vbcrlf & "              <table width=""80%""  border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "                   <tr>" & vbcrlf & "                     <td colspan=""4""><input name=""member1"" type=""radio"" value=""1"" onClick=""document.getElementById('sort_member').style.display=''""; checked>" & vbcrlf & "                 <strong>共享给以下用户</strong>（在需要共享用户前面的方框打勾）<span id=""lbmsg"" style=""color:red""></span></td>" & vbcrlf & "                   </tr>" & vbcrlf & "                 <tr id=""sort_member"" style="""
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & "              </tr>" & vbcrlf & "                  <tr>" & vbcrlf & "                      <td colspan=""4"" height=""16""><strong>" & vbcrlf & "                  <input type=""radio"" name=""member1"" value=""0""  onclick=""document.getElementById('sort_member').style.display='none';document.getElementById('lbmsg').innerHTML='';"">" & vbcrlf & "                  对所有用户公开</strong></td>" & vbcrlf & "              </tr>  " & vbcrlf & "              <tr class=""gray"">" & vbcrlf & "                         <td colspan=""4"" height=""16"">&nbsp;</td>" & vbcrlf & "                  </tr>" & vbcrlf & "       </table></td>" & vbcrlf & "</table>                  </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                              <td class=""gray""><div align=""center"" class=""gray2""><strong>标　　题</strong></div></td>" & vbcrlf & "                           <td height=""50""><input name=""title"" id=""title"" type=""text"" size=""60"" maxlength=""50"">" & vbcrlf & "                     <font color=""#FF0000"">* </font><span id=""title_Msg"" style=""color:red""></span></td>" & vbcrlf & "                </tr>" & vbcrlf & "                             <tr>" & vbcrlf & "                                    <td class=""gray""><div align=""center"" class=""gray2""><strong>详细信息</strong></div></td><td><span class=""gray""><textarea name=""content"" id=""content"" style=""display:none"" cols=""1"" rows=""1"">"
	if content<>"" then Response.write content
	Response.write "</textarea>" & vbcrlf & "                                   <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=content&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></span><span id=""intro"" style=""color:red""></span></td>" & vbcrlf & "                            </tr>" & vbcrlf & "<tr class=""top_tr"">" & vbcrlf & "    <td colspan=""2"">  <div align=""center"">" & vbcrlf & "      <input type=""submit"" name=""Submit42"" value=""保存""  class=""page""/>　　　       " & vbcrlf & "      <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "    </div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr>" & vbcrlf & "    <td height=""38"" colspan=""2"">&nbsp;</td>" & vbcrlf & "</tr>" & vbcrlf & "                      </table>" & vbcrlf & "                        " & vbcrlf & "</form>" & vbcrlf & "" & vbcrlf & " </td>" & vbcrlf & "   </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="添加工作互动"
	call close_list(1)
	Response.write "" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & "<script src= ""../Script/ld_admin_news_add.js?ver="
	Response.write Application("sys.info.jsver")
