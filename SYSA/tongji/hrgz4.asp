...
'if strW3<>"" Then
	...
	if W3="" then W3=0
	W3=getW3(W1,W2,W3)
	W3=getLimitedW3(W3,2,3,0,session("personzbintel2007"))
	W4=replace(W3,"0","")
	W4=replace(W4,",","")
	if W4<>"" Then
		...
		W1=tmp(0)
		W2=tmp(1)
		Str_Result2=Str_Result2+" and l.cateid in("& W3 &") and l.cateid<>0 "
		W2=tmp(1)
	end if
	m1=request("ret")
	m2=request("ret2")
	If m1="" Then m1=year(Date())&"-1"
	m2=request("ret2")
	If m2="" Then m2=year(Date())&"-"&month(Date())
	m2=request("ret2")
	m1name="  起始："&m1
	m2name="  截止："&m2
	if open_10_11=3 then
	elseif open_10_11=1 then
		Str_Result2=Str_Result2+" and  l.cateid in("&intro_10_11&")"
'elseif open_10_11=1 then
	else
		Str_Result2=Str_Result2+" and  l.cateid=0"
'elseif open_10_11=1 then
	end if
	...
	if W2&""="0" then W2=""
	if W3&""="0" then W3=""
	Response.write "" & vbcrlf & "  <div id=""user"" name=""user"" style=""position:absolute;left:0; top:0;width:100%; height:10;"">" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">工资统计</td>" & vbcrlf & "" & vbcrlf & "            <td  align=""left""><strong>"
	Response.write W1name
	Response.write W2name
	Response.write W3name
	Response.write "工资每月走势"
	Response.write m1name
	Response.write m2name
	Response.write "</strong>" & vbcrlf & "                     </td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "    </table>" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr class=""top"">" & vbcrlf & "<form method=""get"" action=""hrgz4.asp"" id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "<td class=""top_btns""><input type=""hidden"" name=""width_tj"" value="""
	Response.write width_tj
	Response.write """>" & vbcrlf & "选择统计条件：" & vbcrlf & ""
	ww111 = request("w1")
	ww222= request("w2")
	ww333 = request("w3")
	on error resume next
	...
	If InStr(person_type,"0") Then strcheck0=" checked "
	If InStr(person_type,"2") Then strcheck2=" checked "
	If InStr(person_type,"4") Then strcheck4=" checked "
	Response.write "<input type='checkbox' name='person_type'"&strcheck0&" value='0'>在职&nbsp;&nbsp;<input type='checkbox' name='person_type' "&strcheck2&" value='2'>退休&nbsp;&nbsp;<input type='checkbox' name='person_type' "&strcheck4&" value='4'>离职&nbsp;&nbsp;"
	If InStr(person_type,"0")=0 Then  Str_Result2=Str_Result2 &" and nowstatus in (2,4) "
	If InStr(person_type,"2")=0 Then  Str_Result2=Str_Result2 &" and nowstatus<>2 "
	If InStr(person_type,"4")=0 Then  Str_Result2=Str_Result2 &" and nowstatus<>4 "
...
'if CDate(m1)>CDate(m2) then m1=m2
	...
	Response.write person_type
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "          <input type=""button"" name=""zxt"" value=""折线图分析"" onClick=""window.location.href='hrgz4.asp?type_tj=2&W1="
	Response.write W1
	Response.write "&W2="
	Response.write W2
	Response.write "&W3="
	...
	Response.write "&person_type="
	Response.write person_type
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "        <input type=""button"" name=""line"" value=""饼图分析"" onClick=""window.location.href='hrgz4.asp?type_tj=3&W1="
	Response.write W1
	Response.write "&W2="
	Response.write W2
	Response.write "&W3="
	...
	Response.write "&ret2="
	Response.write m2
	Response.write "&width_tj=550&person_type="
	Response.write person_type
	Response.write """ "
	if width_tj=550 then
		Response.write "selected"
	end if
	Response.write ">图宽=550</option>" & vbcrlf & "              <option value=""hrgz4.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write "&ret2="
	Response.write m2
	Response.write "&width_tj=700&person_type="
	Response.write person_type
	Response.write """ "
	if width_tj=700 then
		Response.write "selected"
	end if
	Response.write ">图宽=700</option>" & vbcrlf & "              <option value=""hrgz4.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write "&ret2="
	Response.write m2
	Response.write "&width_tj=1000&person_type="
	Response.write person_type
	Response.write """ "
	if width_tj=1000 then
		Response.write "selected"
	end if
	Response.write ">图宽=1000</option>" & vbcrlf & "              <option value=""hrgz4.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write "&ret2="
	Response.write m2
	Response.write "&width_tj=1500&person_type="
	Response.write person_type
	Response.write """ "
	if width_tj=1500 then
		Response.write "selected"
	end if
	Response.write ">图宽=1500</option>" & vbcrlf & "              <option value=""hrgz4.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write "&ret2="
	Response.write m2
	Response.write "&width_tj=2000&person_type="
	Response.write person_type
	Response.write """ "
	if width_tj=2000 then
		Response.write "selected"
	end if
	Response.write ">图宽=2000</option>" & vbcrlf & "              <option value=""hrgz4.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write "&ret2="
	Response.write m2
	Response.write "&width_tj=3000&person_type="
	Response.write person_type
	Response.write """ "
	...
	if open_10_7=1 or open_10_7=3 then
		Response.write "<input type=""button"" name=""Submit43"" value=""打印""  onClick=""window.print()"" class=""anybutton2"">"
	end if
	Response.write "&nbsp;"
	if open_10_10=1 or open_10_10=3  then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认将统计结果导出为EXCEL文档？')){window.location.href='hrgz4.asp?type_tj=4&W1="
		Response.write W1
		Response.write "&W2="
		Response.write W2
		Response.write "&W3="
	...
	for j=1 to m
		...
		money2=0
		set rs=server.CreateObject("adodb.recordset")
		sql="select l.money1,sort1,wages from wageslist l inner join wages w on w.id=l.wages left join (select b.userid , b.nowstatus from gate_person a inner join hr_person b on a.ord=b.userid where b.del=0) c on c.userid =l.cateid where isnull(w.salaryClass,0)>0 and l.del=1 and w.del=1 and complete1=1 and isnull(salaryClass,0)>0 and datediff(d,'"&cdate(tdw)&"',date2)>=0 and datediff(d,'"&dateadd("m",1,tdw)&"',date2)<0 and l.money1<>0 "&Str_Result2&""
		rs.open sql,conn,1,1
		if rs.eof then
		else
			do until rs.eof
				set rs3=server.CreateObject("adodb.recordset")
				sql3="select intro from sortwages where id="&rs("sort1")&" "
...
'if sort1=1 then
		...
		rs.close
		set rs=nothing
		numcg1=cdbl(money1)-cdbl(money2)
		'set rs=nothing
		title=year1&"年"&month1&"月"
		lburl="../hrwages/planallall.asp?W1="&W1&"&W2="&W2&"&W3="&W3&"&E="&E&"&F="&F&"&ret="&tdw&"&ret2="&dateadd("m",1,tdw)-1&"&person_type="& person_type &""
		'title=year1&"年"&month1&"月"
		total1(j,1)=numcg1
		total1(j,2)=title
		total1(j,0)=lburl
		total2(j,0)=title
		total2(j,1)=numcg1
		total2(0,1)="#FF0000,1.5,1,3,每月走势"
		total2(j,2)=lburl
		total3(j,0)=title
		total3(j,1)=numcg1
		total3(j,2)=lburl
