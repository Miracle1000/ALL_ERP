...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	If ly = "alt" Then
		...
		sql1="select qx_open,qx_intro,sort1,sort2 from power  where ord="&session("personzbintel2007")&" and sort1=1 and sort2=5"
	...
	elseif open_26_1=1 then
		list_gys=" (isnull(cateid,0) in ("&intro_26_1&") or share='1') "
	else
		list_gys=" isnull(cateid,0)=0"
	end if
	A=request("A")
	if A="1" then
		Str_Result=" where del=1 and (" & vbcrlf &_
		"(" & vbcrlf &_
		"sort3=1 and (" & vbcrlf &_
		"(" & list & ") " & vbcrlf &_
		"or charindex(',"&session("personzbintel2007")&",',','+replace(share,' ','')+',')>0 " & vbcrlf &_
		"(" & list & ") " & vbcrlf &_
		"or share='1'" & vbcrlf &_
		")" & vbcrlf &_
		")" & vbcrlf &_
		"or (sort3=2 and " & list_gys & ")" & vbcrlf &_
		") and isnull(sp,0)=0 "
	else
		If ly="alt" Then
			if open_1_5=3 then
			...
			elseif open_1_5=1 then
				list=" isnull(cateid,0) in ("&intro_1_5&") and isnull(cateid,0)>0 "
			else
				list=" 1=2 "
			end if
			Str_Result=" where del=1 and (("&list&") ) and sort3=1 and isnull(sp,0)=0 "
		else
			Str_Result=" where sort3=1 and del=1 and isnull(sp,0)=0 and (( "&list&") or share like '%"&session("personzbintel2007")&"%' or share='1') "
		end if
	end if
	dim company
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & ".style17 {color: #FF8040}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "" & vbcrlf & "</head>" & vbcrlf & "<body oncontextmenu=self.event.returnValue=false >" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
	dim clo
	clo=request("clo")
	if clo<>"" then
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" height=""500"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & ""
	...
	elseif B = "yw" then
		if Str_Result="" then
			str_Result="where  product like '%"& C &"%'"
		else
			Str_Result=Str_Result+"and  product like '%"& C &"%'"
			str_Result="where  product like '%"& C &"%'"
		end if
	end if
	Dim arrShow()
	...
	wend
	rs.close
	Response.write "" & vbcrlf & "     <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">客户检索</td>" & vbcrlf & "            <td><div align=""left""> <table width=""98%"" border=""0"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "    <tr>" & vbcrlf & "      <form name=""form"" method=""get"" action=""result4_onlykh.asp""> " & vbcrlf & "        <td  align=""center""  class=""top"">  " & vbcrlf & "          <div align=""right"">" & vbcrlf & "            <span class=""gray"">" & vbcrlf & "            <select name=""E""  datatype=""Limit"" min=""1"" max=""50"" style=""width:100px;word-wrap: normal;""  msg=""请选择"
	'arrName(intgate1)=rs("name")
    'response.write 123 : response.end
	...
	sql7="select ord,sort1 from sort4  order by gate1 desc,ord "
	rs7.open sql7,conn,1,1
	do until rs7.eof
		Response.write "" & vbcrlf & "             <option value="""
		Response.write rs7("ord")
		Response.write """ "
		if clng(E)=rs7("ord") then
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "            </select>" & vbcrlf & "            </span>" & vbcrlf & "                     <select name=""B"">" & vbcrlf & "              <option value=""mc"" "
	if B="mc" then
		Response.write "selected"
	end if
	Response.write ">---"
	...
	Response.write "---</option>" & vbcrlf & "                                 <option value=""pym"" "
	Response.write arrName(1)
	if B="pym" then
		Response.write "selected"
	end if
	...
	If arrShow(19)=1 Then
		Response.write "<option value=""dh"" "
		if B="dh" then
			Response.write "selected"
		end if
		Response.write ">---"
	...
	If arrShow(21)=1 Then
		Response.write "<option value=""cz"" "
		if B="cz" then
			Response.write "selected"
		end if
		Response.write ">---"
	...
	If arrShow(22)=1 Then
		Response.write "<option value=""yj"" "
		if B="yj" then
			Response.write "selected"
		end if
		Response.write ">---"
		'Response.write "selected"
		Response.write arrName(22)
		Response.write "---</option>"
		Response.write arrName(22)
	end if
	If arrShow(12)=1 Then
		Response.write "<option value=""dz"" "
		if B="dz" then
			Response.write "selected"
		end if
		Response.write ">---"
	...
	If arrShow(13)=1 Then
		Response.write "<option value=""yb"" "
		if B="yb" then
			Response.write "selected"
		end if
		Response.write ">---"
		'Response.write "selected"
		Response.write arrName(13)
		Response.write "---</option>"
		Response.write arrName(13)
	end if
	If arrShow(33)=1 Then
		Response.write "<option value=""yw"" "
		if B="yw" then
			Response.write "selected"
		end if
		Response.write ">---"
		'Response.write "selected"
		Response.write arrName(33)
		Response.write "---</option>"
		Response.write arrName(33)
	end if
	Response.write "" & vbcrlf & "          </select>" & vbcrlf & "            <input name=""C"" value="""
	Response.write C
	Response.write """ type=""text"" size=""12"" />" & vbcrlf & "                    "
	If ly&"" = "" And ZBRuntime.Mc("1002") Then
		Response.write "" & vbcrlf & "                     <input type=""checkbox"" name=""A"" value=""1"" "
		if A="1" then
			Response.write "checked"
		end if
		Response.write ">含供应商" & vbcrlf & "                    "
	end if
	Response.write "" & vbcrlf & "            <input type=""submit"" name=""Submit45"" value=""检索"" class=""page""/>" & vbcrlf & "            "
	if open_1_13=1 then
		Response.write "<input type=""button"" name=""Submit42"" value=""添加客户""  onClick=""javascript:window.open('../work/add.asp','newwin77','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')"" class=""anniu""/>"
'if open_1_13=1 then
	end if
	Response.write "" & vbcrlf & "            </div></td>" & vbcrlf & "              " & vbcrlf & "        <td width=""4"" >&nbsp;</td>" & vbcrlf & "      </form>" & vbcrlf & "    </tr>" & vbcrlf & "  </table>" & vbcrlf & "            </div></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & " " & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "    <td align=""center""><div align=""center""><strong>"
	Response.write arrName(3)
	Response.write "</strong></div></td>" & vbcrlf & "   <td height=""27"" class=""gray""><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "     <td class=""gray""><div align=""center""><strong>"
	Response.write arrName(1)
	Response.write "</strong></div></td>" & vbcrlf & "   <td class=""gray""><div align=""center"">销售人员</div></td>" & vbcrlf & "    <td width=""16%"" class=""gray""><div align=""center""><strong>操作</strong></div></td>" & vbcrlf & "     </tr>" & vbcrlf & "   "
	set rs=server.CreateObject("adodb.recordset")
	sql="select ord ,khid,name,cateid,sort3,isnull(person,0)person from tel  "&Str_Result&"  order by date1 desc,ord asc "
	...
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			...
			if rs("person")>0 then
				set rs7=server.CreateObject("adodb.recordset")
				sql7="select name,mobile,phone from person where ord="&rs("person")&""
				rs7.open sql7,conn,1,1
				if not rs7.eof then
					personname=rs7("name")
					mobile=rs7("mobile")
			...
			Response.write "" & vbcrlf & "     <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "                <td width=""13%"" align=""center"">"
			Response.write rs("khid")
			Response.write "</td>" & vbcrlf & "          <td width=""16%"" height=""28""><div align=""center""><a  href=""result4_onlykh.asp?company="
			Response.write rs("ord")
			Response.write "&clo=35"" target=""_self"" onClick=""if(opener.setPerspon){opener.setPerspon("
			Response.write person
			Response.write ",'"
			Response.write server.htmlencode(personname)
			Response.write "','"
			Response.write mobile
			Response.write "','"
			Response.write phone
			Response.write "')};opener.check_kh("
			Response.write rs("ord")
			Response.write ")"">点击选择此"
			Response.write iif(sort3=2,"供应商","客户")
			Response.write "</a></div></td>" & vbcrlf & "          <td width=""41%""><div align=""left"">　"
			...
			Response.write "" & vbcrlf & "                </div></td>" & vbcrlf & "                <td class=""name"">                 " & vbcrlf & "                  <div align=""center"">" & vbcrlf & "                                "
			If sort3="2" then
				if open_26_14=3 or CheckPurview(intro_26_14,trim(cateid))=True then
					Response.write " " & vbcrlf & "                                        <a  href=""#"" onclick=""javascript:window.open('../work2/content.asp?page="
					Response.write  CurrPage
					Response.write "&ord="
					Response.write pwurl(rs("ord"))
					Response.write " ','newwin2','width=' + 900 + ',height=' + 500 + ',scrollbars=1,toolbar=0,resizable=1,left=0,top=0,left=150,top=150')"" >查看此供应商详情</a>" & vbcrlf & "                  "
					Response.write pwurl(rs("ord"))
				end if
			else
				if open_1_14=3 or CheckPurview(intro_1_14,trim(cateid))=True then
					Response.write "" & vbcrlf & "                        <a  href=""#"" onclick=""javascript:window.open('../work/content.asp?page="
					Response.write  CurrPage
					Response.write "&ord="
					Response.write pwurl(rs("ord"))
					Response.write " ','newwin2','width=' + 900 + ',height=' + 500 + ',scrollbars=1,toolbar=0,resizable=1,left=0,top=0,left=150,top=150')"" >查看此客户详情</a>" & vbcrlf & "                  "
					Response.write pwurl(rs("ord"))
				end if
			end if
			...
			rs.movenext
		loop
		Response.write " " & vbcrlf & "      </table>" & vbcrlf & "      <table width=""80%"" border=""0"" align=""right"" style=""margin-right:20px;"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td><div align=""right""><span class=""black"">"
'loop
		...
		Response.write "条信息/页</span>&nbsp;&nbsp;" & vbcrlf & "         <input id=""curp1"" name=""currpage""  type=text   onkeyup=""value=value.replace(/[^\d\.]/g,'')"" maxlength=10 size=3 />" & vbcrlf & "          <input type=""submit"" name=""Submit422"" value=""跳转"" onclick=""gotourl('currPage='+document.getElementById('curp1').value);""  class=""anybutton2""/>" & vbcrlf & "          "
		if currpage=1 then
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "" & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	conn.close
