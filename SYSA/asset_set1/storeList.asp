...
'If sc>0 Then v = v & ";"
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"" />" & vbcrlf & "<style>" & vbcrlf & "pre{display:inline;}" & vbcrlf & "html{" & vbcrlf & "scrollbar-3dlight-color:#d0d0e8;" & vbcrlf & "scrollbar-highlight-color:#fff;" & vbcrlf & "scrollbar-face-color:#f0f0ff;" & vbcrlf & "scrollbar-arrow-color:#c0c0e8;"& vbcrlf & "scrollbar-shadow-color:#d0d0e8;" & vbcrlf & "scrollbar-darkshadow-color:#fff;" & vbcrlf & "scrollbar-base-color:#ffffff;" & vbcrlf & "scrollbar-track-color:#fff;" & vbcrlf & "height:100%;" & vbcrlf & "}" & vbcrlf & "body{height:100%;margin:0px;}" & vbcrlf & "</style>" & vbcrlf & "<script type=""text/JavaScript"" src=""../inc/menu.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" src=""../sortcp/function.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script>" & vbcrlf & "function frameResize()" & vbcrlf & "{" & vbcrlf & " document.getElementById(""cFF2"").style.height=I2.document.body.scrollHeight+0+""px"";" & vbcrlf & "  document.getElementById(""allStore"").style.height=(I2.document.body.scrollHeight>650?(I2.document.body.scrollHeight-110):550)+""px"";" & vbcrlf & "        parent.document.getElementById(""cFF"").style.height=document.body.scrollHeight+0+""px"";" & vbcrlf & "}" & vbcrlf & "function $(name){" & vbcrlf & "     return document.getElementById(name);" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "var xmlHttp = GetIE10SafeXmlHttp();" & vbcrlf & "" & vbcrlf & "function shDiv(divid,pdivid)" & vbcrlf & "{" & vbcrlf & "   document.getElementById(pdivid).className=document.getElementById(pdivid).className==""menu3""?""menu4"":""menu3""" & vbcrlf & "  document.getElementById(divid).style.display=document.getElement"& "}" & vbcrlf & "" & vbcrlf & "var expaned=true;" & vbcrlf & "function ExpandAll(obj)" & vbcrlf & "{" & vbcrlf & "      obj.innerHTML=expaned?""全部展开"":""全部收缩"";" & vbcrlf & "        var divobjs=document.getElementById(""leftmenuall"").getElementsByTagName(""div"");" & vbcrlf & "     for(var i=0;i<divobjs.length;i++)" & vbcrlf & "  {" & vbcrlf & "               if(divobjs[i].onclick&&divobjs[i].onclick.toString().indexOf('shDiv')>0&&((expaned&&divobjs[i+1].style.display!='none')||(!expaned&&divobjs[i+1].style.display=='none')))" & vbcrlf & "               {" & vbcrlf & "                       divobjs[i].click();" & vbcrlf & "                     //divobjs[i].fireEvent('onclick');" & vbcrlf & "             }" & vbcrlf & "       }" & vbcrlf & "       expaned=!expaned;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function searchSort(kvalue)" & vbcrlf & "{" & vbcrlf & "  var url=""search_store.asp?kv=""+escape(kvalue)+""&s=""+new Date().getTime() + ""&date1=""+ Math.round(Math.random()*100);" & vbcrlf & "  xmlHttp.open(""GET"", url, false);" & vbcrlf & "  xmlHttp.onreadystatechange = function()" & vbcrlf & "  {" & vbcrlf & "               if (xmlHttp.readyState == 4)" & vbcrlf & "            {" & vbcrlf & "                       document.getElementById(""allStore"").innerHTML=xmlHttp.responseText;" & vbcrlf & "               }" & vbcrlf & "  };"& vbcrlf & "  xmlHttp.send(null);  " & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""1"">" & vbcrlf & "  <tr>" & vbcrlf & "            <td width=""195"" valign=""center"" id='leftmenuall'>" & vbcrlf &"                  <table border=""0"" cellpadding=""0"" cellspacing=""0"" id=""placeInfo"" style=""margin:0"">" & vbcrlf & "                                <tr>" & vbcrlf & "                                    <td id=""placeInfo"">&nbsp;状态管理<a href=""../asset/111.asp""></a></td>" & vbcrlf & "                               </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                        <table width=""195"" border=""0"" align=""center"" cellpadding=""0"" cellspacing=""0"" style=""border-right:1px solid #ccc;margin:0"">   "  & vbcrlf &                    "       <tr> "& vbcrlf &                 "                    <td height=""27"" colspan=""2"" background=""../images/topb1g.gif""> "& vbcrlf &                              "                   <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">" & vbcrlf & "                                                       <tr>" & vbcrlf & "                                                            <td class=""resetHeadBg"" height=""55"" valign=""middle"" style=""background:#f4fafe;"" colspan=""2"" >" & vbcrlf & "                                                                     状态检索:" & vbcrlf & "                                                                         <input name=""C"" id=""txtKeywords"" type=""text"" value=""输入状态名检索"" style=""height: 19px;width:100px; solid;font-size: 9pt;color: #999999;text-align:center;"" onFocus=""if(value==defaultValue){value='';this.style.color='#000'}"" onBlur=""if(value=='')value=defaultValue;"" onpropertychange=""if(value.indexOf('\'')>=0){value=value.replace('\'','');}else{if(value!=defaultValue) searchSort(this.value);}"" onKeyPress=""if(event.keyCode==13) {searchSort(this.value);return false;}""/>" & vbcrlf & "                                                         </td>" & vbcrlf & "                                                 </tr>" & vbcrlf & "                                           </table>" & vbcrlf & "                                        </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                    <td class=""menutab"" style=""height:38px;padding:0 2px;"">" & vbcrlf & "                                          <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "                                                 <tr>" & vbcrlf & "                                                            <td width=""31%""  height=""27""><a href=""#"" onClick=""return false;"" class=""m_l"">状态名称</a></td>" & vbcrlf & "                                                            <td width=""69%"" align=""right"">" & vbcrlf &                                          "                           <a href=""javascript:void(0);"" onClick=""searchSort</td>"" "& vbcrlf & "                                                   </tr>" & vbcrlf & "                                           </table>" & vbcrlf & "                                        </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                        <div id=""allStore"" style=""width:195px;height:550px;overflow:auto"">" & vbcrlf & ""
	set doc= New htmlfile
	doc.open()
    set divobj=doc.createelement("div")
    doc.appendChild(divobj)
    sql="select isnull(max(depth),0) from O_assStateType "
    set rs=conn.execute(sql)
    Depth=rs(0)
    rs.close
    set rs=nothing
    for i=0 to Depth
        sql="select id,sort1,gate1,parentid,depth,storecode,isLeef,isnull((select count(*) from O_assStateType where depth=a.depth and parentid=a.parentid and id>a.id),0) as f from O_assStateType a where Depth="&i&" order by gate1 desc"
        set rs=server.CreateObject("adodb.recordset")
        j=1
           ...
           ' sobj.className="menu4"
            ...
            if i=0 then
                ...
                if rs("isLeef").value=true then
                    sql="select * from O_assStatename where sort="&rs("id")&" order by gate1 desc"
