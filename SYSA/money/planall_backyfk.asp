...
'Call GetCode128(Mid(Data, i, 2), ID, CodinBin, EAN128)
	...
	m1=request("ret")
	m2=request("ret2")
	bankin2 = deurl(request("bankin2"))
	If bankin2&""<>"" And bankin2<>"0" Then
		Str_Result = Str_Result &" and bankin2="& bankin2 &" "
	else
		bankin2 = 0
	end if
	...
	if D<>"0" then
		Str_Result=Str_Result+" and bank="&D&" "
'if D<>"0" then
	end if
	if C<>"" then
		if B="khmc" then
...
'if B="khmc" then
		elseif B="yfkgy" then
			Str_Result=Str_Result+ " and dbo.TrimHTML(intro2) like '%"&C&"%' "
'elseif B="yfkgy" then
		elseif B="jsr" then
...
'if m2<>"" then
	...
	if px=1 then
		px_Result="order by date3 desc,datediff(mi,'1970-01-01 00:00:00',date7) desc"
'if px=1 then
	elseif px=2 then
		px_Result="order by date3 asc,datediff(mi,'1970-01-01 00:00:00',date7) asc"
'elseif px=2 then
	elseif px=3 then
	...
	elseif px=5 then
		px_Result="order by companyname desc,datediff(mi,'1970-01-01 00:00:00',date7) desc"
'elseif px=5 then
	elseif px=6 then
		px_Result="order by companyname asc,datediff(mi,'1970-01-01 00:00:00',date7) asc"
'elseif px=6 then
	elseif px=7 then
		px_Result="order by money1 desc,datediff(mi,'1970-01-01 00:00:00',date7) desc"
'elseif px=7 then
	elseif px=8 then
		px_Result="order by money1 asc,datediff(mi,'1970-01-01 00:00:00',date7) asc"
'elseif px=8 then
	elseif px=9 then
		px_Result="order by cateidname desc,datediff(mi,'1970-01-01 00:00:00',date7) desc"
'elseif px=9 then
	elseif px=10 then
		px_Result="order by cateidname asc,datediff(mi,'1970-01-01 00:00:00',date7) asc"
'elseif px=10 then
	end if
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "        <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "              <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "      <form method=""get"" action=""planall_backyfk.asp?bankin2="
	Response.write pwurl(bankin2)
	Response.write """ id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "      <tr>" & vbcrlf & "        <td class=""place"">客户退预收款列表</td>" & vbcrlf & "        <td align=""left"">&nbsp;<a class='px_btn' href=""#"" onClick=""Myopen(User);return false;"" class=""sortRule"">排序规则<img src=""../images/i10.gif"" width=""9"" height=""5"" border=""0""></a></td>" & vbcrlf & "        <td width=""50%""><div align=""right"">" & vbcrlf & "          <select name=""select2""  onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" >" & vbcrlf & "            <option>-请选择-</option>" & vbcrlf & "            <option value=""page_count=10"" "
	Response.write pwurl(bankin2)
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "          </select>" & vbcrlf & "        </div></td>" & vbcrlf & "        <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "      </tr>" & vbcrlf & "             <tr height=""50"">" & vbcrlf & "                        <td class='ser_btn2 resetHeadBg' colspan=""3"" height=""50"" valign=""middle"" align=""right"">" & vbcrlf & "                       "
	...
	Response.write "" & vbcrlf & "                     <select name=""D"">" & vbcrlf & "                         <option value=""0"">银行账户</option>" & vbcrlf & ""
	set rs88=server.CreateObject("adodb.recordset")
	if open_bz=1 then
		rs88.open "select * from sortbank where del=1 and (person like '"&session("personzbintel2007")&",%' or person like '%,"&session("personzbintel2007")&",%' or person like '%, "&session("personzbintel2007")&",%'  or person like '%,"&session("personzbintel2007")&"' or person like '%, "&session("personzbintel2007")&"'  or person like '"&session("personzbintel2007")&"' or person like '0')",conn,1,1
	else
		rs88.open "select * from sortbank where del=1 and bz=14",conn,1,1
	end if
	...
	Response.write "</option>" & vbcrlf & "                            <option value=""jsr"" "
	if B="jsr" then
		Response.write "selected"
	end if
	Response.write ">经手人</option>" & vbcrlf & "                             <option value=""yfkgy"" "
	if B="yfkgy" then
		Response.write "selected"
	end if
	Response.write ">退款概要</option>" & vbcrlf & "                   </select>" & vbcrlf & "                       <input type=""text"" name=""C"" value="""
	Response.write C
	Response.write """ size=""8"" />" & vbcrlf & "                       <input type=""submit"" name=""Submit422"" class=""anybutton"" value=""检索"" />" & vbcrlf & "                 "
	if open_7_10=1 or open_7_10=3 then
		Response.write "" & vbcrlf & "                     <input type=""button"" name=""Submitdel2"" value=""EXCEL导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({debug:false,page:'../out/xls_khtyfk.asp'})}"" class=""anybutton""/>" & vbcrlf & "      "
	end if
	...
	Response.write "" & vbcrlf & "                     </td>" & vbcrlf & "             </tr>" & vbcrlf & "      </table> " & vbcrlf & "   <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""margin-top:-3px;"">" & vbcrlf & "      </form>" & vbcrlf & " <tr class=""top"">" & vbcrlf & "   <td width=""5%"" align=""center""><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "         <td width=""20%""><div align=""center"">"
	Response.write khname
	Response.write "</div></td>" & vbcrlf & "    <td width=""10%""><div align=""center""><strong>退款日期</strong></div></td>" & vbcrlf & "    <td width=""15%""><div align=""center""><strong>退款金额</strong></div></td>" & vbcrlf & "    <td width=""12%""><div align=""center""><strong>出账账户</strong></div></td>" & vbcrlf & "   <td width=""8%""><div align=""center""><strong>经手人</strong></div></td>" & vbcrlf & "    <td width=""15%""><div align=""center""><strong>概要</strong></div></td>" & vbcrlf & "        <td width=""15%"" ><div align=""center""><strong>操作</strong></div></td>" & vbcrlf & "     </tr>" & vbcrlf & ""
	dim n
	n=0
	summoney1=0
	money1_all=0
	set rs88=conn.execute("select isnull(sum(money1),0) as money1 from bankin3 "&Str_Result&" ")
	money1_all=cdbl(rs88(0).value)
	set rs88=nothing
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from (select id,money1,company,cateid,date3,bank,dbo.TrimHTML(intro2) as intro2,date7,(select isnull(name,'') from tel where ord=bankin3.company) as companyname,"&_
	"(select isnull(name,'') from gate where ord=bankin3.cateid) as cateidname "&_
	" from bankin3 "&Str_Result&" ) as a "&px_Result&" "
	rs.open sql,conn,1,1
	if rs.RecordCount<=0 then
		...
		Response.write "" & vbcrlf & "      <form name=""form1"" method=""post"" action=""deleteallbackyf.asp?bankin2="
		Response.write pwurl(bankin2)
		Response.write "&ord="
		...
		do until rs.eof
			...
			sql7="select name,isnull(cateid,0) as cateid, ISNULL(share,'-222') share ,sort3, del from tel where ord="&company&""
			set rs7=server.CreateObject("adodb.recordset")
			...
			set rs7=nothing
			cateid=rs("cateid")
			Response.write "" & vbcrlf & "     <tr height=""27"" onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & " <td align=""center""><span class=""red""><input name=""selectid"" type=""checkbox"" id=""selectid"" value="""
			Response.write rs("id")
			Response.write """></span></td> " & vbcrlf & "   <td class=""name"">" & vbcrlf & "    "
			If sort3="2" Then
				If del=1 Then
					...
					Response.write "<span class='red'>&nbsp;关联供应商已被删除，请查证</span>"
				end if
			else
				If del=1 Then
					...
					Response.write "<span class='red'>&nbsp;关联客户已被删除，请查证</span>"
				end if
			end if
			Response.write GetPrintInfo(conn, 43002 , id ,1)
			...
			Response.write  getbzflag(rs("bank"),"bankid")
			Response.write Formatnumber(zbcdbl(rs("money1")),num_dot_xs,-1)
			Response.write  getbzflag(rs("bank"),"bankid")
			Response.write "</div></td>" & vbcrlf & ""
			bank=rs("bank")
			if bank="" or Isnull(bank) then
				bank=0
			end if
			if bank<>0 then
				set rs88=server.CreateObject("adodb.recordset")
				rs88.open "select sort1 from sortbank where id="&bank&" and del=1 and (person like '"&session("personzbintel2007")&",%' or person like '%,"&session("personzbintel2007")&",%' or person like '%, "&session("personzbintel2007")&",%'  or person like '%,"&session("personzbintel2007")&"' or person like '%, "&session("personzbintel2007")&"'  or person like '"&session("personzbintel2007")&"' or person like '0')",conn,1,1
				if rs88.eof then
					bankname=""
				else
					bankname=rs88("sort1")
			...
			if open_7_14=3 or (open_7_14=1 and CheckPurview(intro_7_14,trim(cateid))=True) then
				Response.write "" & vbcrlf & "                     <input type=""button"" name=""Submit3"" value=""详情""  onClick=""javascript:window.open('contentbackyfk.asp?ord="
			...
			if open_7_3=3 or (open_7_3=1 and CheckPurview(intro_7_3,trim(cateid))=True) then
				Response.write "" & vbcrlf & "                <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='Deletebackyf.asp?bankin2="
				Response.write pwurl(bankin2)
				Response.write "&ord="
				Response.write rs("id")
				Response.write "&CurrPage="
		...
		loop
		m=n
		Response.write "" & vbcrlf & "     <tr height=""27"">" & vbcrlf & "          <td colspan=""3"" align=""right"">本页合计：</td>" & vbcrlf & "               <td align=""right"" class=""red"">"
		Response.write Formatnumber(summoney1,num_dot_xs,-1)
		Response.write "</td>" & vbcrlf & "                <td colspan=""4"">&nbsp;</td>" & vbcrlf & "       </tr>" & vbcrlf & "   <tr height=""27"">" & vbcrlf & "          <td colspan=""3"" align=""right"">所有合计：</td>" & vbcrlf & "               <td align=""right"" class=""red"">"
		Response.write Formatnumber(money1_all,num_dot_xs,-1)
		Response.write "</td>" & vbcrlf & "                <td colspan=""4"">&nbsp;</td>" & vbcrlf & "       </tr>     " & vbcrlf & "      </table>" & vbcrlf & "   </td>" & vbcrlf & "          </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""10%"" height=""30""><div align=""center"">" & vbcrlf & "      <input name=""chkall"" type=""checkbox"" id=""chkall"" value=""all"" onclick=""mm(this.form)"" />全选" & vbcrlf & "    </div></td>" & vbcrlf & "    <td>" & vbcrlf & "     "
		if open_7_3=1 or open_7_3=3 then
			Response.write "" & vbcrlf & "     <input class=""resetElementHidden"" type=image src=""../images/m_an_del.gif"" onClick=""return test();""  name=submit>" & vbcrlf & "    <input class=""resetElementShowNoAlign anybutton"" style=""display:none;"" type=""submit"" onClick=""return test();"" value=""批量删除"" name=submit"">" & vbcrlf & "      "
		end if
		...
		Response.write "条信息/页&nbsp;&nbsp;" & vbcrlf & "    <input name=""currpage"" id=""currpage"" type=""text"" onkeyup=""value=value.replace(/[^\d]/g,'')"" size=""3"" >" & vbcrlf & "          <input type=""button"" name=""Submit422"" value=""跳转"" onClick=""gotourl('currPage='+document.getElementById('currpage').value);""class=""anybutton2""/>" & vbcrlf & "    "
		if currpage=1 then
	...
	action1="客户退预收款列表"
	call close_list(1)
	Response.write "   " & vbcrlf & "    <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "           <tr> " & vbcrlf & "             <td height=""10"" colspan=""2""><img src=""../image/pixel.gif"" width=""1"" height=""1""></td>" & vbcrlf & "            </tr> " & vbcrlf & "                <tr>" & vbcrlf & "           <td width=""16%"" height=""10""><div align=""right""></div></td>" & vbcrlf & "           <td width=""84%"">&nbsp;</td>" & vbcrlf & "         </tr>" & vbcrlf & "             <tr>" & vbcrlf & "              <td height=""10"" colspan=""2"">&nbsp;</td>" & vbcrlf & "         </tr>" & vbcrlf & "             <tr>" & vbcrlf & "              <td height=""10"" colspan=""2"">&nbsp;</td>" & vbcrlf & "           </tr>" & vbcrlf & "     </table>" & vbcrlf & "      </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<script language=""javascript"">" & vbcrlf & "function Myopen(divID){" & vbcrlf & " if(divID.style.display==""""){" & vbcrlf & "              divID.style.display=""none""" & vbcrlf & "        }else{" & vbcrlf & "          divID.style.display=""""" & vbcrlf & "    }" & vbcrlf & "       divID.style.left=300;" & vbcrlf & "   divID.style.top=0;" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:150; height:400;display:none;"">" & vbcrlf & "<table width=""150"" height="""
	if D<>"0" then
		Response.write "300"
	else
		Response.write "250"
	end if
	Response.write """  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""139"">" & vbcrlf & "        <table width=""150"" height=""115"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=1');""><font color=""#2F496E"">按退款日期排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=2');""><font color=""#2F496E"">按退款日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=3');""><font color=""#2F496E"">按添加日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=4');""><font color=""#2F496E"">按添加日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf &           "  <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourlbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=6');""><font color=""#2F496E"">按客户名称排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & ""
	if D<>"0" then
		Response.write "" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=7');""><font color=""#2F496E"">按退款金额排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=8');""><font color=""#2F496E"">按退款金额排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=9');""><font color=""#2F496E"">按经手人排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & " <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=10');""><font color=""#2F496E"">按经手人排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & "</body>" & vbcrlf & "</html>"
