...
'bigsystemtype = ".mozi"
	...
	'Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write "' defer='defer'></script>" & vbcrlf & "</head>" & vbcrlf & "<body oncontextmenu=self.event.returnValue=false>" & vbcrlf & "<form name=""form1"" method=""post"" action=""../car/Del_Insure.asp?realDel=1&CurrPage="
	Response.write CurrPage
	Response.write """>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "            <td width=""100%"" valign=""top"">" & vbcrlf & "                      <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "<tr>" & vbcrlf &                    "                 <td class=""place"">车辆保险回收站</td>" & vbcrlf &                              "        <td>&nbsp;</td>" & vbcrlf &                           "       <td align=""right""><input type=""button"" name=""Submitdel"" class=""anybutton"" value=""全部清空"" onClick=""if(confirm('确认清空本回收站里的所有内容？')){window.location.href='../car/Del_insure.asp?ord=-634&realDel=1&CurrPage="
	Response.write CurrPage
	Response.write "'}""/></td>" & vbcrlf & "                                 <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "                              </tr>" & vbcrlf & "                   </table> " & vbcrlf & "                       <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf& "                                <tr class=""top"">" & vbcrlf & "                                  <td align=""center""><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "                                     <td align=""center"" height=""24""><div align=""center""><strong>序号</strong></div></td>" & vbcrlf & "                                   <td height=""27"" ><div align=""center""><strong>车牌号</strong></div></td>" & vbcrlf & "                                      <td ><div align=""center""><strong>险种</strong></div></td>" & vbcrlf & "                                 <td ><div align=""center""><strong>添加人</strong></div></td>" & vbcrlf & "                                       <td width=""14%"" ><div align=""center""><strong>删除人</strong></div></td>" & vbcrlf & "                                     <td ><div align=""center"">删除时间</div></td>" & vbcrlf & "                                   <td width=""20%"" ><div align=""center""><strong>操作</strong></div></td>" & vbcrlf & "                               </tr>" & vbcrlf & ""
	dim n
	n=0
	set rs=server.CreateObject("adodb.recordset")
	sql="select a.*,c.setName,b.car_code,isnull(g1.name,'') addName,isnull(g2.name,'') delName,iss_addcateid " & vbcrlf &_
	"from O_insure a "&_
	"left join O_carData b on a.iss_carid=b.car_id " & vbcrlf &_
	"left join gate g1 on g1.ord=a.iss_addcateid " & vbcrlf &_
	"left join gate g2 on g2.ord=a.delcate " & vbcrlf &_
	"Left Join O_carSet c on c.setType=3 and c.id = a.iss_type " & vbcrlf &_
	...
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			...
			if open_102_14=3 or CheckPurview(intro_102_14,trim(iss_addcateid))=True Then
				Response.write "" & vbcrlf & "                                                      <a href=""javascript:void(0)"" onclick=""window.open('../car/Detail_insure.asp?ord="
				Response.write id
			...
			Response.write "</div></td>" & vbcrlf & "                                   <td> " & vbcrlf & "                                           <div align=""center"">" & vbcrlf & "                                                      <input type=""button"" name=""Submit3c""  class=""anybutton"" value=""恢复"" onClick=""if(confirm('确认恢复？')){window.location.href='setInsure.asp?ord="
			Response.write id
			Response.write "&CurrPage="
			Response.write CurrPage
			Response.write "'}""/>" & vbcrlf & "                                                      <input type=""button"" name=""Submitdel"" class=""anybutton"" value=""彻底删除"" onClick=""if(confirm('您选择的是彻底删除，删除后不能再恢复，确认删除？')){window.location.href='../car/Del_Insure.asp?realDel=1&ord="
			Response.write id
			Response.write "&CurrPage="
			Response.write CurrPage
		...
		Response.write "" & vbcrlf & "                                             </div>" & vbcrlf & "                                  </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                           <script type=""text/Javascript"">window.currask2Url=""setInsure.asp?currPage="
		Response.write currPage
