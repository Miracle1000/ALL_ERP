...
'If Not rs.Eof Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin: 0px;" & vbcrlf & "    height:100%;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "" & vbcrlf & "<body bgcolor=""#ebebeb""  "
	if open_77_8=0 then
	...
	if open_77_17<>1 then
		Response.write"<script language=javascript>alert('您还没有邮件模板分类权限!');history.back();</script>"
		call db_close : Response.end
	end if
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">邮件模板分类设置</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right""><input type=""button"" name=""Submit32"" value=""添加分类""  class=""anybutton"" onClick=""window.location.href='correctSort.asp'""/></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table> " & vbcrlf & "   " & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""> " & vbcrlf & " <tr border=1 valign=""center"" class=""top""> " & vbcrlf & "   " & vbcrlf & "    <td align=""center"" valign=""middle""><div align=""center""><font style=""font-size: 9pt"">分类名</font></div></td>" & vbcrlf & "    <td  align=""center"" valign=""middle""><div align=""center"">添加人</font></div></td>" & vbcrlf & "              <td  align=""center"" valign=""middle""><div align=""center"">重要指数</font></div></td>" & vbcrlf & "    <td width=""393""  align=""center"" valign=""middle""><div align=""center""><font style=""font-size: 9pt"">操作</font>　</div></td>" & vbcrlf & "    </tr>" & vbcrlf & "  "
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from email_maoban_sort order by order1 asc ,ord desc"
	...
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			if rs("addcate")<>"" then
				set rs1=server.CreateObject("adodb.recordset")
				sql1="select name from gate where del=1 and ord="&rs("addcate")&""
				rs1.open sql1,conn,1,1
				if not rs1.eof then
					addName=rs1(0)
				end if
			...
			Response.write " " & vbcrlf & "  <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        " & vbcrlf & "    <td width=""379"" class=""name""><div align=""center"">"
			Response.write rs("sortName")
			Response.write "</div></td>" & vbcrlf & "" & vbcrlf & "    <td width=""312"" class=""name""><div align=""center"">"
			Response.write addName
			Response.write "</div></td>" & vbcrlf & "             <td width=""274"" class=""name""><div align=""center"">"
			Response.write rs("order1")
			Response.write "</div></td>" & vbcrlf & "    <td height=""25"" align=""center"" valign=""middle""  class=""func"">" & vbcrlf & "    <input type=""button"" name=""Submit3c"" value=""修改""  onClick=""javascript:window.open('correctSort.asp?ord="
			Response.write pwurl(rs("ord"))
			Response.write "&currPage="
			Response.write  currpage
			Response.write "','editMessageSort','width=' + 600 + ',height=' + 400 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=200,top=150')""/>&nbsp;&nbsp;" & vbcrlf & "      <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='moban_sort_del.asp?ord="
			Response.write  currpage
			Response.write pwurl(rs("ord"))
			Response.write "&currPage="
			Response.write  currpage
		...
		if currpage=1 then
			...
			Response.write "" & vbcrlf & "          <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='moban_Sort_list.asp?ord="
			Response.write ord
			Response.write "&currPage="
			Response.write  1
			Response.write "'""/> <input type=""button"" name=""Submit42"" value=""上一页""  onClick=""window.location.href='moban_Sort_list.asp?ord="
			Response.write ord
			Response.write "&currPage="
		...
		if currpage=rs.pagecount then
			...
			Response.write "" & vbcrlf & "         <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='moban_Sort_list.asp?ord="
			Response.write ord
			Response.write "&currPage="
			Response.write  currpage + 1
			Response.write "&currPage="
			Response.write "'"" class=""page""/> <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href='moban_Sort_list.asp?ord="
			Response.write ord
			Response.write "&currPage="
			Response.write  rs.PageCount
			Response.write "'"" class=""page""/>" & vbcrlf & "          "
