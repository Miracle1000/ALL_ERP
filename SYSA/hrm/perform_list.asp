...
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=15"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_15=0
intro_81_15=0
else
open_81_15=rs1("qx_open")
intro_81_15=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
...
if open_81_1=3 then
list_tj=""
elseif open_81_1=1 then
list_tj="and creator in ("&intro_81_1&")"
else
...
Hr_str_power=" "
elseif open_81_1=1 then
Hr_str_power=" and ord in ("&intro_81_1&") "
list_gate="and ord in ("&intro_81_1&")"
else
list_gate="and ord=0"
Hr_str_power=" and 1=2 "
end if
...
if open_81_1="1"  then
set rs1=server.CreateObject("adodb.recordset")
sql1="select ord,name,sorce,sorce2 from gate  where ord in ("&intro_81_1&") and del=1 order by sorce asc,sorce2 asc ,cateid asc ,ord asc"
rs1.open sql1,conn,1,1
if rs1.eof then
else
do until rs1.eof
...
rs1.close
set rs1=nothing
Str_power="where id in ("&sorce&")"
Str_power11="and id in ("&sorce&")"
Str_power2="and id in ("&sorce2&")"
Str_power22="where id in ("&sorce2&")"
Str_power3="and id in ("&sorce3&")  and del=0"
Str_power33="where id in ("&sorce3&") and del=0"
elseif open_81_1="3" then
Str_power="where id>0"
Str_power11="and id>0"
Str_power2="and id>0"
Str_power22="where id>0"
Str_power3="and id>0  and del=0"
Str_power33="where id>0 and del=0"
else
Str_power="where id<0"
Str_power2="id<0 and "
Str_power22="where id<0"
Str_power3="and id<0"
Str_power33="where id<0"
end if
TdYear=year(date())
Tdmonth=month(date())
TdDay=day(date())
...
ord=deurl(trim(Request.querystring("ord")))
remind = Request("remind")
If action="close" Then
conn.execute("update hr_perform_sort set khzt=1 where id="&ord&"")
end if
Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <form name=""form1"" method=""post"" action=""perform_list.asp"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr> "& vbcrlf & "            <td width=""208"" height=""32"" class=""place"">绩效列表</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf &  "           <td align=""right""><div>" & vbcrlf & "              "
if open_81_7<>0 then
Response.write " <INPUT onclick=""window.print()"" value=""打印"" type=""button"" class=""anybutton2"" name=""Submit43"">"
end if
Response.write "" & vbcrlf & "              </div></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf &  "         <tr class=""top"">" & vbcrlf & "            <td width=""6%"" align=""center""><div align=""center"">选择</div></td>" & vbcrlf &  "           <td width=""15%"" align=""center""><div align=""center"">考核主题</div></td>" & vbcrlf & "<td width=""15%"" align=""center""><div align=""center"">考核期</div></td>" & vbcrlf & "            <td width=""15%"" align=""center""><div align=""center"">审批期</div></td>" & vbcrlf & "                    <td width=""15%"" align=""center""><div align=""center"">申诉期</div></td>" & vbcrlf & "                  <td width=""10%"" align=""	center""><div align=""center"">考核状态</div></td>" & vbcrlf & "            <td width=""24%"" align=""center""><div align=""center"">操作</div></td>" & vbcrlf & "          </tr>" & vbcrlf & "          "
...
Str_Result_remind = " and a.id in (" & helper.listSQL("ids") & ")"
end if
list = " or 1=1 "
If open_81_1 = 1 Then
list = " or a.creator in("& intro_81_1 &")"
ElseIf open_81_1 = 0 Then
list = " or 1=0"
end if
If currPage&"" = "" Or isnumeric(currPage&"") = False Then
currPage = 1
end if
dim rs1,sql1
sql1 = "select count(id) count from hr_perform_sort a  where del=0 "& Str_Result_remind &" and (((isall=1 and dbo.HrIsShowGate(a.startTime,"&session("personzbintel2007")&")=1) or (isall=0 and charindex(','+'"&session("personzbintel2007")&"'+',',','+cast(user_list as varchar(max))+',')>0)) "&	list &" or "&session("personzbintel2007")&" in (select sp_id from hr_perform_sp_list b where b.sortID=a.sortid ))"
set rs1=server.CreateObject("adodb.recordset")
rs1.open sql1,conn,1,1
bookNum = clng(rs1("count"))
if clng(bookNum) < clng(page_count) then
allPageNum = 1
else
allPageNum = int(clng(bookNum)/clng(page_count)) + 1
allPageNum = 1
end if
if clng(currPage) < 1 then
currPage = 1
end if
if clng(currPage) > clng(allPageNum) then
currPage = allPageNum
end if
set rs=server.CreateObject("adodb.recordset")
sql = "select top (select "& clng(page_count) &") rownumber,id,title,startTime,endTime,sp_Time1,sp_Time2,ss_Time1,ss_Time2,user_list,isall,sortid,creator,khzt,isHrPerson from (select row_number() over(order by id desc) as rownumber,id,title,startTime,endTime,sp_Time1,sp_Time2,ss_Time1,ss_Time2,user_list,isall,sortid,creator,khzt,dbo.HrIsShowGate(a.startTime,"&session("personzbintel2007")&") isHrPerson from hr_perform_sort a  where del=0 "& Str_Result_remind &" and (((isall=1 and dbo.HrIsShowGate(a.startTime,"&session("personzbintel2007")&")=1) or (isall=0 and charindex(','+'"&session("	personzbintel2007")&"'+',',','+cast(user_list as varchar(max))+',')>0)) "& list &" or "&session("personzbintel2007")&" in (select sp_id from hr_perform_sp_list b where b.sortID=a.sortid ))) temp_row  where rownumber>("& clng(CurrPage) &"-1)*"& clng(page_count) &""       
set rs=server.CreateObject("adodb.recordset")
...
endTime=rs("endTime")
sp_Time1=rs("sp_Time1")
sp_Time2=rs("sp_Time2")
ss_Time1=rs("ss_Time1")
ss_Time2=rs("ss_Time2")
ss_user_list=rs("user_list")
ss_isall=rs("isall")
ss_sortID=rs("sortID") : isHrPerson = rs("isHrPerson")
isShowThis=conn.execute("select count(id) from hr_perform_sp_list  where sortID="&ss_sortID&" and sp_id="&session("personzbintel2007")&"")(0)
Response.write "" & vbcrlf & "          <tr>" & vbcrlf & "            <td align=""center"">"
if open_81_3=3 or CheckPurview(intro_81_3,trim(cateid))=True then
Response.write "<input name=""selectid"" type=""checkbox"" id=""selectid"" value="""
Response.write rs("id")
Response.write """>"
end if
Response.write "</td>" & vbcrlf & "            <td align=""center"">"
if ((ss_isall=1 And isHrPerson) or instr(","&ss_user_list&",",","&session("personzbintel2007")&",")>0 or isShowThis>0 or open_81_14=3 or CheckPurview(intro_81_14,trim(rs("creator")))) then
Response.write "" & vbcrlf & "<a href=""perform_content.asp?ord="
...
Response.write "</td>" & vbcrlf & "            <td align=""center"">"
Response.write sp_Time1
Response.write "--"
Response.write sp_Time1
Response.write sp_Time2
Response.write "</td>" & vbcrlf & "                        <td align=""center"">"
Response.write ss_Time1
Response.write "--"
Response.write ss_Time1
Response.write ss_Time2
Response.write "</td>" & vbcrlf & ""
khzt="考核中"
If datediff("d",sp_Time1,date())>=0 And datediff("d",sp_Time2,date())<=0 Then
khzt="待评分"
ElseIf datediff("d",sp_Time2,date())>=0 Then
khzt="评分完毕"
end if
If  datediff("d",ss_Time1,date())>=0 And datediff("d",ss_Time2,date())<=0 Then
khzt="申诉中"
ElseIf datediff("d",ss_Time2,date())>=0 Then
khzt="申诉完毕"
end if
If rs("khzt")=1 Then
khzt="考核完毕"
...
Response.write khzt
Response.write "</td>" & vbcrlf & "            <td align=""center"" class=""func"">  <div align=""center"">" & vbcrlf & ""
if ((ss_isall=1 And isHrPerson) or instr(","&ss_user_list&",",","&session("personzbintel2007")&",")>0 or isShowThis>0 or open_81_14=3 or CheckPurview(intro_81_14,trim(rs("creator")))) then
Response.write "<input type=""button"" name=""Submit3"" value=""详情""  onClick=""javascript:window.open('perform_content.asp?ord="
Response.write pwurl(rs("id"))
Response.write "','newHrss','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>"
Response.write pwurl(rs("id"))
end if
If rs("khzt")<>1 Then
if datediff("d",sp_Time1,date())>=0 and datediff("d",sp_Time2,date())<=0 and isShowThis>0 then
Response.write "" & vbcrlf & "     <input type=""button"" name=""Submit3c"" value=""审批""  onClick=""javascript:window.open('perform_edit.asp?ord="
Response.write pwurl(rs("id"))
Response.write "','newHrss','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>" & vbcrlf & " "
Response.write pwurl(rs("id"))
end if
if datediff("d",ss_Time1,date())>=0 and datediff("d",ss_Time2,date())<=0 then
Response.write "" & vbcrlf & "     <input type=""button"" name=""Submit3c"" value=""申诉""  onClick=""javascript:window.open('../manufacture/inc/Bill.asp?orderid=1015&ord="
Response.write pwurl(rs("id"))
Response.write "','newHrss','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>" & vbcrlf & " "
Response.write pwurl(rs("id"))
end if
if (open_81_2=3 or CheckPurview(intro_81_2,trim(rs("creator")))=True) then
Response.write "" & vbcrlf & "     <input type=""button"" name=""Submit3c"" value=""修改""  onClick=""javascript:window.open('perform_add.asp?action=edit&ord="
Response.write pwurl(rs("id"))
Response.write "','newHrss','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>" & vbcrlf & " "
Response.write pwurl(rs("id"))
end if
if open_81_15=1 And datediff("d",sp_Time1,date())>0 and datediff("d",ss_Time2,date())>0  Then
Response.write "" & vbcrlf & "     <input type=""button"" name=""Submit3c"" value=""结束""  onClick=""window.location.href='"
Response.write sdk.clearURL("perform_list.asp?"& sdk.ReturnURL("action=close&ord=" & pwurl(rs("id")) ))
Response.write "'""/>" & vbcrlf & ""
end if
end if
if open_81_3=3 or CheckPurview(intro_81_3,trim(rs("creator")))=True then
Response.write "" & vbcrlf & " <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除该数据？')){window.location.href='"
Response.write sdk.clearURL("perform_add.asp?"& sdk.ReturnURL("action=del&ord=" & pwurl(rs("id")) &"&remind="&remind))
Response.write "'}""/>" & vbcrlf & ""
end if
Response.write "" & vbcrlf & "                 </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "          "
if k>=bookNum then exit do
k=k+1
'if k>=bookNum then exit do
rs.movenext
loop
else
Response.write "" & vbcrlf & "          <tr>" & vbcrlf & "            <td align=""center"" colspan=""7"">暂无内容</td>" & vbcrlf & "          </tr>" & vbcrlf & "          "
end if
Response.write "" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "          <tr>" & vbcrlf & "            <td height=""100"" valign=""center"" ><div align=""right""> <span cla	ss=""black"">"
Response.write bookNum
Response.write "个 | "
Response.write currPage
Response.write "/"
Response.write allPageNum
Response.write "页 | &nbsp;"
Response.write page_count
Response.write "条信息/页</span>&nbsp;" & vbcrlf & "                <input   name=""currpage""  type=text   onkeyup=""value=value.replace(/[^\d\.]/g,'')""  size=3  >" & vbcrlf & "                &nbsp;" & vbcrlf & "                <input type=""submit"" name=""Submit422"" value=""跳转""  class=""anybutton2""/>" & vbcrlf & "                &nbsp;" & vbcrlf & "                <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='perform_list.asp?page_count="
Response.write page_count
Response.write "&currPage="
Response.write  1
Response.write "&A2="
...
Response.write remind
Response.write "'""/>" & vbcrlf & "                <input type=""button"" name=""Submit42"" value=""上一页""  onClick=""window.location.href='perform_list.asp?page_count="
Response.write page_count
Response.write "&currPage="
...
Response.write "&remind="
Response.write remind
Response.write "'"" class=""page""/>" & vbcrlf & "                <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='perform_list.asp?page_count="
Response.write page_count
Response.write "&currPage="
Response.write  currpage + 1
Response.write "&currPage="
...
Response.write "&remind="
Response.write remind
Response.write "'"" class=""page""/>" & vbcrlf & "                <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href = 'perform_list.asp?page_count="
Response.write page_count
Response.write "&currPage="
Response.write  allPageNum
Response.write "&A2="
...
Response.write "&remind="
Response.write remind
Response.write "'"" class=""page""/>" & vbcrlf & "              </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "  </form>" & vbcrlf & "</table>" & vbcrlf & ""
rs.close
action1="绩效列表"
call close_list(1)
