...
function webViewerInitialized() {
  ...
  var params = PDFViewerApplication.parseQueryString(queryString.replace(/%/g, '%25'));
  FLSTR=decode64(decodeURIComponent(FLSTR));
  var file = 'file' in params ? params.file : FLSTR;
...
function UnicodeToAnsi(chrCode)
{
    ...
    var i=UnicodeChr().indexOf(chrHex);//ÓÃjavascriptÊµÏÖBase64±àÂë¡ª½â¾öÖÐÎÄÎÊÌâ
    if(i!=-1)
    {
