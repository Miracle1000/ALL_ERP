...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write Application("sys.info.jsver")
	Response.write """ language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<script type=""text/JavaScript"" src=""../inc/CommSPAjax.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/py_addgr.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "</head>" & vbcrlf & "<body  onunload=""if(window.opener) window.opener.location.reload();"">" & vbcrlf & ""
	jkord=session("personzbintel2007")
	ty=request("ty")
	conn.execute "delete from payjk where del=7 and addcate=" & session("personzbintel2007")
	set rsbh = conn.execute("EXEC erp_getdjbh 81,"&session("personzbintel2007"))
	khid=rsbh(0).value
	rsbh.close
	set rsbh=Nothing
	if request("payjkid")="" then
		conn.execute "insert into payjk(title,bh,bz,addcate,del,date7,ModifyStamp,spstate,payid) values(null,'"&khid&"',null,"&session("personzbintel2007")&",7,getdate(),getdate(),5,4)"
		payjkid=GetIdentity("payjk","id","addcate","")
	else
		payjkid=getInt(request("payjkid"))
	end if
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "     <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "   <tr>" & vbcrlf & "            <td class=""place"">费用借款添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right""><div align=""center""></div>" & vbcrlf & "                </a></div></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & "    <form method=""POST"" action=""savegr.asp?ty="
	Response.write ty
	Response.write """ id=""demo"" onsubmit=""return false"" name=""date"" style=""margin:0"">" & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "              <tr class=""top"">" & vbcrlf & "            <td colspan=""3"">基本信息</td>" & vbcrlf & "             <td><div align=""right"">" & vbcrlf & "              <input name=""Submit2"" type=""button"" class=""anniu"" value=""保存"" onclick=""ask()"">" & vbcrlf & "                   <input name=""Submit4"" type=""reset"" class=""anniu"" value=""重置"">" & vbcrlf & "                  </div></td>" & vbcrlf & "     </tr>" & vbcrlf & "               <tr>" & vbcrlf & "               <td width=""10%""><div align=""right"">借款主题：</div></td>" & vbcrlf & "            <td width=""28%"" ><div align=""left"">" & vbcrlf & "                   <input name=""title""  type=""text"" id=""title"">&nbsp;<font id=""tit"" style=""color:red"">*</font>" & vbcrlf & "             </div></td>" & vbcrlf & "           <td width=""15%"" height=""37""><div align=""right"">借款编号：</div></td>" & vbcrlf & "           <td width=""35%"" height=""37"" ><div align=""left"">" & vbcrlf & "               <input name=""bh""  type=""text"" id=""bh"" value="""
	Response.write khid
	Response.write """ size=""30""" & vbcrlf & "                  class='jquery-auto-bh' autobh-options='cfgId:81,recId:"
	Response.write khid
	Response.write payjkid
	Response.write ",autoCreate:false,autoCheck:false'" & vbcrlf & "            >" & vbcrlf & "               </div></td>" & vbcrlf & "             </tr>" & vbcrlf & "             <tr>" & vbcrlf & "             <td width=""10%""><div align=""right"">借款日期：</div></td>" & vbcrlf & "                 <td width=""47%"" style=""padding-top:0!important;padding-bottom:0!important"">" &vbcrlf & "                   <div align=""left"">" & vbcrlf & "                          <TABLE border=0 align=""left"" >" & vbcrlf & "                                <TBODY>" & vbcrlf & "                           <TR>" & vbcrlf & "                                  <TD><INPUT name=""ret"" readonly onmouseup=""toggleDatePicker('daysOfMonth','date.ret')"" value="""
	Response.write date
	Response.write """ size=""10"">" & vbcrlf & "                                 <input type=""button"" class=""anybutton"" value=""选择日期"" style=""margin-bottom:-0.5px;"" align=""absMiddle""  border=""0""  id=""daysOfMonthPos"" name=""daysOfMonthPos""  onmouseup=""toggleDatePicker('daysOfMonth','date.ret')"" />" & vbcrlf & "                                 <span class=""red"">*</span>" & vbcrlf & "                                       <DIV id=daysOfMonth style=""POSITION: absolute""></DIV></TD>" & vbcrlf & "                                  </TR>" & vbcrlf & "                         </TBODY>" & vbcrlf & "                                </TABLE>" & vbcrlf & "                     </div>" & vbcrlf & "               </td>" & vbcrlf & "           <td width=""10%""><div align=""right"">总金额：</div></td>" & vbcrlf & "                  <td width=""47%""><div align=""left"">" & vbcrlf & "                    <input name=""allpay""  type=""text"" id=""allpay""  onpropertychange=""formatData(this,'money');"" onKeyUp=""checkDot('allpay','"
	Response.write num_dot_xs
	Response.write "')""  size=""15"" maxlength=""12"">" & vbcrlf & "                 <font id=""mone"" style=""color:red"">*</font></div></td>" & vbcrlf & "                 </tr>" & vbcrlf & "            "
	sql8="select bz from setbz"
	set rs8=conn.execute(sql8)
	bz=rs8("bz")
	set rs8=nothing
	if bz<>0 then
		Response.write "" & vbcrlf & "                <tr>" & vbcrlf & "                  <td width=""10%""><div align=""right"">币种：</div></td>" & vbcrlf & "                  <td colspan=""3""><div align=""left""><input name=""jktype"" type=""hidden"" value=""1"">" & vbcrlf & "            <select name=""bz"" id=""bz"">" & vbcrlf & "                       "
		...
		loop
		set rs8=nothing
		Response.write "" & vbcrlf & "             </select>" & vbcrlf & "                  </div></td>" & vbcrlf & "             </tr>" & vbcrlf & "           "
	end if
	Response.write getExtended(1001,0)
...
'if replace(w3_list,",","")="" then w3_list="-1"
	...
	Response.write "" & vbcrlf & "                <td width=""15%"" colspan=""4""><div align=""left""><font class=""left""><a href=""###"" style=""text-decoration:none"" onClick=""" & vbcrlf & "                                                         if(document.getElementById('tdr').style.display=='none')" & vbcrlf & "                                                                {document.getElementById('tdr').style.display='';" & vbcrlf & "                                                                document.getElementById('nodsr').src='../images/12.gif'}" & vbcrlf & "                                                                else" & vbcrlf & "                                                            {" & vbcrlf & "                                                               document.getElementById('tdr').style.display='none';" & vbcrlf & "                                                            document.getElementById('nodsr').src='../images/11.gif';" & vbcrlf & "                        }""><img border=""0"" id=""nodsr"" src=""../images/11.gif"">&nbsp;<strong>借款人员</strong></a></font>&nbsp;&nbsp;<font id=""sqr"">" & vbcrlf & "                                                           </font>&nbsp;<font id=""ry"" color=""red"">*</font></div></td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr id=""tdr"" style=""display:none"">" & vbcrlf & "               <td width=""15%"" colspan=""4"">" & vbcrlf & "                <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                      <tr>" & vbcrlf & "                <td colspan=""4""> " & vbcrlf & "                          "
	basesql="select ord, orgsid from gate where 1=1 "&str_w3
	Response.write CBaseUserTreeHtmlRadioCE(basesql,"", "","","member2",  "", "", "", jkord,"Tiggerfirst:if(node.value){chanceR(node.text)}")
	Response.write "" & vbcrlf & "                             </td></tr>" & vbcrlf & "      </table>" & vbcrlf & "                   </td>" & vbcrlf & "                 </tr>" & vbcrlf & "          <tr>" & vbcrlf & "             <td><div align=""right"">借款说明：</div></td>" & vbcrlf & "                <td  colspan=""3""><textarea name=""note"" style=""display:none"" cols=""1"" rows=""1"">"
	if note<>"" then Response.write note
	Response.write "</textarea>" & vbcrlf & "             <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME>                </td>" & vbcrlf & "                 </tr>" & vbcrlf & "           "
	Response.write getExtended1(1001,0)
	Response.write "" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""50"" colspan=""6"">" & vbcrlf & "                     <input type=""hidden"" id=""payjkid"" name=""payjkid"" value="""
	Response.write payjkid
	Response.write """>" & vbcrlf & "              <div align=""center""><input name=""Submit2"" type=""button"" class=""anniu"" value=""保存"" onclick=""ask()"">" & vbcrlf & "              <input name=""Submit4"" type=""reset"" class=""anniu"" value=""重置"">" & vbcrlf & "              </div></td>" & vbcrlf & "     </tr>" & vbcrlf & "    </table>" & vbcrlf & "        </form>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""1000"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "     </td>" & vbcrlf
	action1="费用借款添加"
	call close_list(1)
	Response.write "" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<script language='javascript'>" & vbcrlf & "var slbl=document.getElementById(""member2_"
	Response.write session("personzbintel2007")
	Response.write """);" & vbcrlf & "if(slbl) slbl.fireEvent(""onclick"");" & vbcrlf & "</script>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & "" & vbcrlf & ""
