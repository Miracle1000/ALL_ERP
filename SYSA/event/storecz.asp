...
'Public Function AddFormValue(name,  value)
	...
	Response.write "" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "<table class=""detailTable noMargin"" width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & ""
	...
	if rss.eof then
		...
		Response.write "" & vbcrlf & "    <tr>" & vbcrlf & "        <td height=""27"" colspan="""
		Response.write """ ><div align=""center"">没有信息 <img src=""../images/jiantou.gif""><a href=""../store/top7.asp?top="
		Response.write pwurl(ord)
		Response.write "&f=101"" onClick=""javascript:window.open('../store/top7.asp?top="
		Response.write pwurl(ord)
		Response.write "&f=101','plancor5','width=' + 1440 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=0,top=100');return false;"" title=""点击添加明细""><font class=""blue2"">添加拆装明细</font></a></div></td>" & vbcrlf & "    </tr>" & vbcrlf & ""
		'Response.write pwurl(ord)
	else
		sum=0
		num=0
		...
		do until rss.eof
			...
			do until rss.eof
				...
				Response.write "" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "" & vbcrlf & ""
				Dim qxOpen,qxIntro
				...
				do until rs.eof
					...
					Select Case sorce
					Case 1:
					Response.write "" & vbcrlf & "" & vbcrlf & "                        <td width="""
					Response.write kd
		...
		Response.write """><div align=""center"">合计<img src=""../images/jiantou.gif""><a href=""javascript:;"" onClick=""javascript:window.open('../store/top7.asp?top="
		Response.write pwurl(ord)
		...
		'Response.write pwurl(ord)
		Response.write "</div></td>" & vbcrlf & "          <td height=""20"" colspan=""1"">&nbsp;</td>" & vbcrlf & "             <td height=""20"" colspan=""1""><div align=""right"">"
		Response.write Formatnumber(mmm,num_dot_xs,-1)
		Response.write "</div></td>" & vbcrlf & "       "
	...
	rss.close
	set Rss = nothing
	Response.write "" & vbcrlf & "</table>" & vbcrlf & "<table class=""detailTable noMargin"" width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" style='margin-top:-1px;' bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & ""
	'set Rss = nothing
	...
	rs.close
	Response.write "" & vbcrlf & "    </tr>" & vbcrlf & ""
	sql = "select *,isnull(AssistNum,0)AssistNumV from kuinlist where  caigou="&ord&" and sort1=9 and addcate="&session("personzbintel2007")&" and del=7 order by id asc"
	set rss = server.CreateObject("adodb.recordset")
	rss.open sql,conn,1,1
	if rss.eof then
		Response.write "" & vbcrlf & "    <tr>" & vbcrlf & "     <td height=""27"" colspan="""
		...
		do until rss.eof
			num=num+cdbl(rss("num1"))
'do until rss.eof
			sumAssistNum=sumAssistNum+cdbl(rss("AssistNumV"))
'do until rss.eof
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select title,order1,type1 from product where ord="&rss("ord")&""
			rs7.open sql7,conn,1,1
			...
			do until rs.eof
				...
				Response.write "</div></td>" & vbcrlf & "                        "
				if isOpenProductAttrV then
					Response.write "" & vbcrlf & "                                 <td width=""90"" class=""name nonamepadding""><div align=""center"">"
					Response.write  GetProductAttrNameById(rss("ProductAttr1"))
					Response.write "</div></td>" & vbcrlf & "                              <td width=""90"" class=""name nonamepadding""><div align=""center"">"
					Response.write  GetProductAttrNameById(rss("ProductAttr2"))
					Response.write "</div></td>" & vbcrlf & "                        "
				end if
				Case 5:
		...
		Response.write "" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td height=""27"" colspan="""
		Response.write adressNum1+ProductAttrColNum
		Response.write """><div align=""center"">合计&nbsp;"
		if Formatnumber(cdbl(sum),num_dot_xs,-1)=Formatnumber(cdbl(mmm),num_dot_xs,-1) then
			Response.write """><div align=""center"">合计&nbsp;"
		else
			Response.write "<font color=red>父件总成本与子件总成本不一致!</font>"
		end if
		Response.write "</div></td>" & vbcrlf & "        <td height=""27"" class=""red""><div align=""center"">"
		Response.write Formatnumber(num,num1_dot,-1)
		'Response.write "</div></td>" & vbcrlf & "        <td height=""27"" class=""red""><div align=""center"">"
		Response.write "</div></td>" & vbcrlf & "        "
		if isOpenAssUnit then
			Response.write "" & vbcrlf & "                     <td height=""27"" class=""red""><div align=""center""></div></td>" & vbcrlf & "                     <td height=""27"" class=""red""><div align=""center"">"
			Response.write iif(sumAssistNum>0,Formatnumber(sumAssistNum,num1_dot,-1),"")
			Response.write "</div></td>" & vbcrlf & "        "
		end if
		if IsOpenRKPrice then
			Response.write "" & vbcrlf & "              <td height=""20"" colspan=""1"">&nbsp;</td>" & vbcrlf & "             <td height=""20"" colspan=""1""><div align=""right"">"
			Response.write Formatnumber(sum,num_dot_xs,-1)
			Response.write "</div></td>       " & vbcrlf & "        "
		else
			num1_ls = num1_ls + 2
			Response.write "</div></td>       " & vbcrlf & "        "
