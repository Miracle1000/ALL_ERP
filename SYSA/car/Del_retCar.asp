...
'bigsystemtype = ".mozi"
	...
	sqltext="update O_CarUsemx set use_complete=1,use_rettime=Null,use_retcateid=0,use_retnote='' where use_id in ("&ord&")"
	conn.execute(sqltext)
	action1="车辆返还删除"
	call close_list(2)
	Response.write "<script>window.location='List_retCar.asp?CurrPage="&CurrPage&"&px="&px&"&A="&ml.Dep(A)&"&B="&ml.Dep(B)&"&C="&ml.Dep(C)&"&ret="&ret&"&ret2="&ret2&"&page_count="&page_count&"'</script>"
