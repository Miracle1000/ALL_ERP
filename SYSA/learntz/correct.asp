...
'bigsystemtype = ".mozi"
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<STYLE type=""text/css""> <!-- a:link { text-decoration: none; font-family: AdobeSm; color: #000000 }" & vbcrlf & "a:visited { text-decoration: none; color: #000000 }" & vbcrlf & "A:hover {COLOR: green; FONT-FAMILY: ""宋体""; TEXT-DECORATION:underline;}" & vbcrlf & "body { font-size: 9pt; font-family: 宋体, Arial;color: #000000}" & vbcrlf & "TD {FONT-SIZE: 9pt; FONT-FAMILY: ""宋体"", ""Arial"";color: #000000}" & vbcrlf & "p {FONT-SIZE: 9pt; FONT-FAMILY: ""宋体"", ""Arial"";color: #000000}" & vbcrlf & "input {FONT-SIZE: 9pt; FONT-FAMILY: ""宋体"", ""Arial"";color: #000000}" & vbcrlf & "body { "& vbcrlf & "     margin-top: 0; "& vbcrlf &"   margin-bottom: 0;" & vbcrlf &  "      color: #000000;" & vbcrlf & " background-color: #FFFFFF;" & vbcrlf &    "   margin-left: 0px;" & vbcrlf &   "     margin-right: 0px;" & vbcrlf & "} "& vbcrlf &" -->" & vbcrlf & "#table2{margin:0}" & vbcrlf & "#table2 td{padding:9px 4px}" & vbcrlf & "</STYLE>" & vbcrlf & "" & vbcrlf & "<script language=""javascript"" src=""../Inc/DelUnusedFiles.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"">" & vbcrlf & "<!--" & vbcrlf & "function MM_jumpMenu(targ,selObj,restore){ //v3.0" & vbcrlf & "eval(targ+"".location=\'""+selObj.options[selObj.selectedIndex].value+""\'"");" & vbcrlf & "if (restore) selObj.selectedIndex=0;" & vbcrlf & "}" & vbcrlf & "//-->" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
	dim clo
	clo=request("clo")
	if clo<>"" then
		Response.write "" & vbcrlf & "<script>window.alert('操作成功！');</script>" & vbcrlf & "<script language='javascript'>if(window.opener){window.opener.location.reload();}window.close();</script>" & vbcrlf & ""
	end if
	if request("id")<>"" then
		id=deurl(request("id"))
		sql1 = "select * from learntz where ord="&id
		...
		Response.write "" & vbcrlf & "<table width=""100%"" height=""500"" border=""0"" align=""center"" cellpadding=""0"" cellspacing=""0"" bgcolor=""#FFFFFF"" id=""table1"" >" & vbcrlf & "    <tr>" & vbcrlf & "            <td valign=""top"">" & vbcrlf & "<form method=""POST"" action=""updatecp.asp"
		if title<>"" then Response.write "?edit=1&id="&id
		Response.write """  id=""demo""  name=""date""  onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf & " <table border=""1"" width=""98%"" id=""table2"" cellspacing=""0"" cellpadding=""5"" style=""border-collapse: collapse"" bordercolor=""#c0ccdd"">" & vbcrlf & "            <tr>" & vbcrlf & "                    <td width=""14%"" align=""center"">分类选择</td>" & vbcrlf & "                    <td width=""86%"">" & vbcrlf & "                  <select name=""sort"" class=""gray"" dataType=""Limit"" min=1 msg=""分类不能为空"">                                      " & vbcrlf & ""
		set rs=server.CreateObject("adodb.recordset")
		sql="select * from sortonehy where gate2=91 order by gate2 desc "
		rs.open sql,conn,1,1
		do until rs.eof
			Response.write "" & vbcrlf & "         <option value="""
			Response.write rs("ord")
			Response.write """ "
			if cdbl(sort1)=rs("ord") then
...
'If Len(exists_Pics) = 0 Then
	...
	Response.write "" & vbcrlf & "                                      <textarea name=""content"" style=""display:none"" cols=""1"" rows=""1"">"
	if content<>"" then Response.write content
	Response.write "</textarea> <span class=""red"">*</span></td>" & vbcrlf & "                             </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                              <td>　　" & vbcrlf & "                            <div align=""center"">标　　题</div></td>" & vbcrlf & "                           <td><input type=""text"" name=""title"" value="""
	Response.write title
	Response.write """ size=""60"" class=""text"" dataType=""Limit"" min=""1"" max=""50"" msg=""必填，长度不超过50个字""> <span class=""red"">*</span></td>" & vbcrlf & "               </tr>" & vbcrlf & "                             <tr>" & vbcrlf & "                                    <td colspan=""2"">" & vbcrlf & "                                  <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=content&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""98%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "                            </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                        <p align=""center"" >" & vbcrlf & "                         <input type=""submit"" name=""Submit42"" value=""保存""  class=""page""/>　　　      "  & vbcrlf &  "                         <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf &     "                  </p>" & vbcrlf &" </form>" & vbcrlf &"              <p>　" & vbcrlf &  "  </td> "& vbcrlf &  "  </tr> "& vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf
	end if
	action1="公告修改"
	call close_list(1)
%>
