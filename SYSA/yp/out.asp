...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/yp_out.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "       margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "img{" & vbcrlf & "border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "-->" & vbcrlf & "#prod_type{" & vbcrlf & "width:150px;" & vbcrlf & "height:auto;" & vbcrlf & "margin-bottom:20px;" & vbcrlf & "border:1px solid #CAE3FF;" & vbcrlf & "background-color: #F4F9FF;" & vbcrlf & "position:absolute;" & vbcrlf & "padding:5px;" & vbcrlf & "display:none;" & vbcrlf & "filter:alpha(Opacity=80);-moz-opacity:0.5;opacity: 0.5;" & vbcrlf & "}" & vbcrlf & "#ddd input[type=text]{" & vbcrlf & "        width:72px;" & vbcrlf & "}" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
	set rs88 = conn.execute("EXEC erp_getdjbh 802,"&session("personzbintel2007"))
	khid=rs88(0).value
	rs88.close
	set rs88=nothing
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">领用添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "        <form action=""save_out.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)&&ask1()"">" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" ><div align=""left""><strong>基本情况</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "            <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "              <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "                </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "      <td width=""14%"" height=""37""><div align=""right"">领用主题：</div></td>" & vbcrlf & "          <td width=""22%"" class=""gray""><input name=""get_title"" type=""text"" id=""get_title""dataType=""Limit"" min=""1"" max=""200""  msg=""长度必须在1至200个字之间"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">领用编号：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input name=""get_bh"" type=""text"" id=""get_bh"" " & vbcrlf &"                          dataType=""Limit"" value="""
	Response.write khid
	Response.write """ min=""1"" max=""200""  msg=""长度必须在1至200个字之间""" & vbcrlf & "                              class='jquery-auto-bh' autobh-options='cfgId:802,autoCreate:false'" & vbcrlf & "                      ></td>" & vbcrlf & "        <td width=""12%""><div align=""right"">领用时间：</div></td>" & vbcrlf & "                <td width=""22%"" class=""gray""><input name=""get_time"" type=""text"" size=""9"" value="""
	Response.write date
	Response.write """ id=""daysOfMonthPosx"" onmouseup=toggleDatePicker(""daysOfMonthx"",""date.get_time"") readonly>" & vbcrlf & "                <DIV id=daysOfMonthx style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "      </tr>" & vbcrlf & "         <tr>" & vbcrlf & "      <td width=""14%"" height=""37""><div align=""right"">领用/申请人员：</div></td>" & vbcrlf & "       <td width=""22%"" class=""gray"">" & vbcrlf & "           "
	sql7="select * from gate where ord="&session("personzbintel2007")
	set rs7=conn.execute(sql7)
	if not rs7.eof then
		get_lycateName=rs7("name")
	end if
	rs7.close
	set rs7=nothing
	Response.write "<input type=""text"" readonly id=""get_lycateName"" name=""get_lycateName"" value="""
	Response.write get_lycateName
	Response.write """ onclick=""check_person()""/>" & vbcrlf & "         <input type=""hidden"" id=""get_lycateid"" name=""get_lycateid"" value="""
	Response.write session("personzbintel2007")
	Response.write """/></td>" & vbcrlf & "        <td height=""37""><div align=""right"">领用类型：</div></td>" & vbcrlf & "        <td class=""gray""><select name=""get_type"" id=""get_type"" onChange=""setType(this.value)"">" & vbcrlf & "           <option value=""2"">用品申请</option>" & vbcrlf & "          "
	If open_101_17 = 1 Then
		Response.write "" & vbcrlf & "          <option value=""1"">用品发放</option>" & vbcrlf & "          "
	end if
	Response.write "" & vbcrlf & "        </select></td>" & vbcrlf & "        <td><div id=""type1"" align=""right"">库管人员：</div></td>" & vbcrlf & "        <td class=""gray"">" & vbcrlf & "              <select name=""get_storecateid"" id=""get_storecateid"" >" & vbcrlf & "               "
	sql="select * from gate where del=1 and ord in (select ord from power where sort1=101 AND sort2=17 and qx_open=1)"
	set rs=conn.execute(sql)
	if not rs.eof then
		do while not rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "        </select>" & vbcrlf & "             </td>" & vbcrlf & "     </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" align=""center"" class=""nopadding"">" & vbcrlf & "            <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">" & vbcrlf & "         <tr>" & vbcrlf &"                  <td valign=""center"" class=""nopadding"">" & vbcrlf & "                      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                              <tr class=""top"">" & vbcrlf & "                                  <td style=""height:68px!important"" colspan=""13""><div align=""left""><a href=""###"" onClick=""setMe('',1)"">添加明细<img src=""../images/add.gif"" border=""0"" style=""border:0px;""/></a></div></td>" & vbcrlf & "                           </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                    <td width=""9%"" height=""27""><div align=""center""><strong>名称</strong></div></td>" & vbcrlf & "                                       <td width=""9%"" height=""27""><div align=""center""><strong>编号</strong></div></td>" & vbcrlf & "                                  <td width=""8%"" height=""27""><div align=""center""><strong>型号</strong></div></td>" & vbcrlf & "                                       <td width=""6%"" height=""27""><div align=""center""><strong>单位</strong></div></td>" & vbcrlf & "                                       <td width=""6%"" height=""27""><div align=""center""><strong>领用数量</strong></div></td>" & vbcrlf & "                                      <td width=""8%"" height=""27""><div align=""center""><strong>出库仓库</strong></div></td>" & vbcrlf & "                                   <td width=""6%"" height=""27""><div align=""center""><strong>库存信息</strong></div></td>" & vbcrlf & "<td width=""8%"" height=""27""><div align=""center""><strong>用品分类</strong></div></td>" & vbcrlf & "                                   <td width=""8%"" height=""27""><div align=""center""><strong>批号</strong></div></td>" & vbcrlf &  "                                      <td width=""8%"" height=""27""><div align=""center""><strong>序列号</strong></div></td>" & vbcrlf & "                                  <td width=""6%"" height=""27""><div align=""center""><strong>生产日期</strong></div></td>" & vbcrlf & "                                   <td width=""6%"" height=""27""><div align=""center""><strong>有效日期</strong></div></td>" & vbcrlf & "                                   <td height=""27""><div align=""center""><strong>备注</strong></div></td>" & vbcrlf & "                             </tr>" & vbcrlf & "                           <tbody id=""prod_mx"">" & vbcrlf & "                              </tbody>" & vbcrlf & "                        </table>" & vbcrlf & "                        </td>" & vbcrlf & "           </tr>" & vbcrlf & "           </table></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "            <td><p align=""right"">领用备注：</td>" & vbcrlf & "             <td colspan=""5"" class=""gray""><textarea name=""get_note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "                    <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=get_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "            </tr> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray""><p align=""center"">" & vbcrlf & "           <input type=""submit"" name=""Submit42"" value=""保存"" class=""page""/>" & vbcrlf & "                <input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr> " & vbcrlf & "    </table>" & vbcrlf & "       </form>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"" height=""2000"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "" & vbcrlf & "   </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""ddd"" class=""easyui-dialog"" icon=""icon-search"" title=""选择明细""  style=""width:900px;height:500px;padding:5px;background:#fafafa;top:0px"" closed=""true"">" & vbcrlf & "       <div region=""south"" border=""false"" style=""font-size:14px;text-align:right;height:34px;line-height:27px; "">" & vbcrlf & "    <select name=""u_type"" id=""u_type"" onchange=""searchMe(this.value,1);"" style=""width:80px;"">" & vbcrlf & "      <option value="">用品分类</option>" & vbcrlf & ""
	Set rs = conn.execute("select id, pro_name from O_officeType order by pro_gate2 desc")
	While rs.eof = False
		Response.write "" & vbcrlf & "      <option value="""
	...
	rs.close
	set rs = nothing
	Response.write "" & vbcrlf & "      </select>" & vbcrlf & "       用品名称：<input  id=""u_name"" name=""u_name"" type=""text"" size=""12"" onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & "     用品编号：<input  id=""u_bh"" name=""u_bh"" type=""text"" size=""10"" onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & " 用品型号：<input  id=""u_xh"" name=""u_xh"" type=""text"" size=""10"" onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & "        用品批号：<input  id=""u_ph"" name=""u_ph"" type=""text"" size=""10"" onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & " 序列号：<input  id=""u_xlh"" name=""u_xlh"" type=""text"" size=""10"" onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & "      </div>" & vbcrlf & "  <div id=""selectiddiv"" region=""center"" border=""false"" style=""padding:5px;background:#fff;border:1px solid #ccc;width:99%;*width:100%"">"            & vbcrlf & "        </div>" & vbcrlf & "  <div region=""south"" border=""false"" style=""text-align:right;height:27px;line-height:27px;"">" & vbcrlf & "     <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$('#ddd').window('close');"">关闭</a>         " & vbcrlf & "        </div>" & vbcrlf & "</div>" & vbcrlf & "<div id=""d_person"" class=""easyui-dialog"" icon=""icon-search"" title=""选择领用/申请人员""  style=""width:950px;height:500px;padding:5px;background:#fafafa;top:0px"" closed=""true"">" & vbcrlf & " <div region=""center"" border=""false"" style=""padding:10px;background:#fff;border:1px solid #ccc;width:100%"">" & vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""5"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""> "       & vbcrlf & "  <tr class=""top"">" & vbcrlf & ""
	set rs1=server.CreateObject("adodb.recordset")
	...
	Response.write "" & vbcrlf & "                <td colspan=""4"" height=""30"">" & vbcrlf & "                <div align=""left""><font class=""left""><a href=""#"" onClick=""" & vbcrlf & "                      if(document.getElementById('tdr').style.display=='none')" & vbcrlf & "                        {document.getElementById('tdr').style.display='block';" & vbcrlf & "  document.getElementById('nodsr').src='../images/12.gif'}" & vbcrlf & "                        else" & vbcrlf & "                    {" & vbcrlf & "                       document.getElementById('tdr').style.display='none';" & vbcrlf & "                    document.getElementById('nodsr').src='../images/11.gif';" & vbcrlf & "                        }""><img border=""0"" id=""nodsr"" src=""../images/12.gif""><strong>选择人员</strong></a></font></div></td>" & vbcrlf & "  </tr>" & vbcrlf & "              <tr id=""tdr"">" & vbcrlf & "              <td colspan=""4"">" & vbcrlf & "                  <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                      <tr>"& vbcrlf & "                <td colspan=""4"">        " & vbcrlf & "                                "
	Response.write CBaseUserTreeHtmlRadioCE("select ord,orgsid from gate where del=1 "&str_w3, "","","","member2","","","",gateord,"if(node.value){chanceR(node.text, node.value)}")
	Response.write "</td></tr>" & vbcrlf & "                     </table>" & vbcrlf & "                      </td>" & vbcrlf & "            </tr>" & vbcrlf & "</table>" & vbcrlf & "  </div>" & vbcrlf & "  <div region=""south"" border=""false"" style=""text-align:right;height:27px;line-height:27px;"">" & vbcrlf & "    <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$('#d_person').window('close');"">关闭</a>                " & vbcrlf & "        </div>" & vbcrlf & "</div>" & vbcrlf & ""
	action1="用品领用添加"
	call close_list(1)
