...
$(document).ready(
    function () {
        var meghtml = "<span style=\"float:right;margin-top: 12px;margin-right: 48px;position:absolute;\"><span class=\"help_explan_ico\" onmouseover=\"Bill.showHelpExplan(this)\" text=\"<p>报表说明：</p>";
        meghtml += "<p>1.检索时间指的是入库确认时间和出库确认时间，先进先出法、个别计价法、移动加权平均法支持按天选择，全月平均法支持按月选择。</p>";
        meghtml += "<p>2.期初结存为：检索开始时间前库存剩余数量以及成本。</p>";
        ...
        meghtml += "<p>&nbsp;期末结存为：检索结束时间后库存剩余数量以及成本。</p>";
