...
'If sc>0 Then v = v & ";"
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"" />" & vbcrlf & "<style>" & vbcrlf & "pre{display:inline;}" & vbcrlf & "html{" & vbcrlf & "scrollbar-3dlight-color:#d0d0e8;" & vbcrlf & "scrollbar-highlight-color:#fff;" & vbcrlf & "scrollbar-face-color:#f0f0ff;" & vbcrlf & "scrollbar-arrow-color:#c0c0e8;"& vbcrlf & "scrollbar-shadow-color:#d0d0e8; "& vbcrlf & "scrollbar-darkshadow-color:#fff; "& vbcrlf & "scrollbar-base-color:#ffffff; "& vbcrlf & "scrollbar-track-color:#fff;" & vbcrlf &" }" & vbcrlf & "</style>" & vbcrlf & "<script type=""text/JavaScript"" src=""../inc/menu.js?ver="
	'Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" src=""../sortcp/function.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script>" & vbcrlf & "function frameResize()" & vbcrlf & "{" & vbcrlf & " document.getElementById(""cFF2"").style.height=I2.document.documentElement.scrollHeight+0+""px"";" & vbcrlf & "       document.getElementById(""allStore"").style.height=(I2.document.documentElement.scrollHeight>650?(I2.document.documentElement.scrollHeight-110):550)+""px"";" & vbcrlf & "       parent.document.getElementById(""cFF"").style.height=document.documentElement.scrollHeight+0+""px"";" & vbcrlf & "}" & vbcrlf & "function $(name){" & vbcrlf & "  return document.getElementById(name);" & vbcrlf &" } "& vbcrlf & vbcrlf &" var xmlHttp = GetIE10SafeXmlHttp(); "& vbcrlf & vbcrlf & "function shDiv(divid,pdivid) "& vbcrlf & "{" & vbcrlf &  " document.getElementById(pdivid).className=document.getElementById(pdivid).className==""menu3""?""menu4"":""menu3""" & vbcrlf &  " document.getElementById(divid).style.display=document.getElementById(divid).style.display=='none'?'block':'none';" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function showCK(sortid,tp)" & vbcrlf & "{" & vbcrlf & "    var p=tp?""ord=""+sortid:""sort=""+sortid;" & vbcrlf & "      document.getElementById(""cFF2"").contentWindow.document.location=""edit_ck.asp?""+p;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "var expaned=true;" & vbcrlf & "function ExpandAll(obj)" & vbcrlf & "{" & vbcrlf & "     obj.innerHTML=expaned?""全部展开"":""全部收缩"";" & vbcrlf & "        var divobjs=document.getElementById(""leftmenuall"").getElementsByTagName(""div"");"& vbcrlf & "       for(var i=0;i<divobjs.length;i++)" & vbcrlf & "       {" & vbcrlf & "               if(divobjs[i].onclick&&divobjs[i].onclick.toString().indexOf('shDiv')>0&&((expaned&&divobjs[i+1].style.display!='none')||(!expaned&&divobjs[i+1].style.display=='none')))" & vbcrlf & "               {" & vbcrlf & "                       divobjs[i].click();" & vbcrlf & "                    //divobjs[i].fireEvent('onclick');" & vbcrlf & "              }" & vbcrlf & "       }" & vbcrlf & "       expaned=!expaned;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function searchSort(kvalue)" & vbcrlf & "{" & vbcrlf & "  var url=""search_store.asp?kv=""+escape(kvalue)+""&s=""+new Date().getTime() + ""&date1=""+ Math.round(Math.random()*100);" & vbcrlf & "  xmlHttp.open(""GET"", url, false);" & vbcrlf & "  xmlHttp.onreadystatechange = function()" & vbcrlf & "  {" & vbcrlf & "                if (xmlHttp.readyState == 4)" & vbcrlf & "            {" & vbcrlf & "                       document.getElementById(""allStore"").innerHTML=xmlHttp.responseText;" & vbcrlf & "             }" & vbcrlf & "  };" & vbcrlf & "  xmlHttp.send(null);  " & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""1"">" & vbcrlf & "      <tr>" & vbcrlf & "            <td width=""195"" valign=""center"" id='leftmenuall'>" & vbcrlf & "                 <table border=""0"" cellpadding=""0"" cellspacing=""0"" id=""placeInfo"" style=""margin:0"">" & vbcrlf & "                                <tr>" & vbcrlf & "                                    <td id=""placeInfo"" style=""border-right:1px solid #95d2ff;"">&nbsp;分类管理<!--<a href=""../asset/111.asp"">111</a>--></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                        <table width=""195"" border=""0"" align=""center"" cellpadding=""0"" cellspacing=""0"" style=""border-right:1px solid #ccc;margin:0"">   " & vbcrlf & "                               <tr>" & vbcrlf & "                                    <td class=""resetHeadBg"" height=""55"" valign=""middle"" style=""background:#f4fafe;"" colspan=""2"" >" & vbcrlf & "                                          <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">" & vbcrlf & "                                                 <tr>" & vbcrlf & "                                                            <td height=""27"" align=""left"" style=""padding-left:5px"" valign=""middle"">" & vbcrlf & "                                                                  分类检索:" & vbcrlf & "                                                                       <input name=""C"" id=""txtKeywords"" type=""text"" value=""输入分类名检索"" style=""height: 19px;width:100px; solid;font-size: 9pt;color: #999999;text-align:center;"" onFocus=""if(value==defaultValue){value='';this.style.color='#000'}"" onBlur=""if(value=='')value=defaultValue;"" onpropertychange=""if(value.indexOf('\'')>=0){value=value.replace('\'','');}else{if(value!=defaultValue) searchSort(this.value);}"" onKeyPress=""if(event.keyCode==13) {searchSort(this.value);return false;}""/>" & vbcrlf & "                                                      </td>" & vbcrlf & "                                                 </tr>" & vbcrlf & "                                           </table>" & vbcrlf & "                        </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                    <td class=""menutab"" style=""height:38px;padding:0 2px;"">" & vbcrlf & "                                             <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "                                                 <tr>" & vbcrlf & "                                                            <td width=""31%""  height=""27""><a href=""#"" onClick=""return false;"" class=""m_l"">分类名称</a></td>" & vbcrlf & "                                                         <td width=""69%"" align=""right"">" & vbcrlf & "                                                                      <a href=""javascript:void(0);"" onClick=""searchSort('');document.getElementById('cFF2').contentWindow.document.location='edit_ck.asp';"">所有分类</a>" & vbcrlf & "                                                                     <a href=""javascript:void(0);"" onClick=""ExpandAll(this);"">全部收缩</a>" & vbcrlf & "                                                               </td>" & vbcrlf & "                                                   </tr>" & vbcrlf & "                                           </table>" & vbcrlf & "                                        </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                        <div id=""allStore"" style=""width:195px;height:550px;overflow:auto"">" & vbcrlf & ""
    ...
    set rs=nothing
    for i=0 to Depth
        sql="select id,sort1,gate1,parentid,depth,storecode,isLeef,isnull((select count(*) from O_assSetType where depth=a.depth and parentid=a.parentid and id>a.id),0) as f from O_assSetType a where del=1 and Depth="&i&" order by gate1 desc"
        set rs=server.CreateObject("adodb.recordset")
        j=1
        ...
        while not rs.eof
            ...
            if i=0 then
                ...
                sobj.setAttribute "pid","ckid_"&rs(0)
                sobj.setAttribute "ischged","0"
                sobj.style.paddingleft="20px"
                if (j=1 and rs.RecordCount=1) or j=rs.RecordCount then
                    sobj.className="list1"
                else
                    if rs("f")>0 then
                        sobj.className="list"
                    else
                ...
                if rs("isLeef").value=true then
                    sql="select * from O_assSetname where sort="&rs("id")&" order by gate1 desc"
                    set rsck=server.CreateObject("adodb.recordset")
                    rsck.open sql,conn,1,1
                    m=1
                    while not rsck.eof
                        if (m=1 and rsck.RecordCount=1) or m=rsck.RecordCount then
                            csName="file1"
                        else
                            csName="file"
                        end if
                        sobj.innerHTML=sobj.innerHTML&"<div class='"&csName&"' onclick='showCK("&rsck("id")&",true);'>"&rsck("sort1")&"</div>"
                        m=m+1
                        rsck.movenext
                    wend
                    rsck.close
...
'else '
    ...
    set divobj=nothing
    set doc=nothing
    Response.write "" & vbcrlf & "                     </div>" & vbcrlf & "          </td>" & vbcrlf & "    <td valign=""top"">" & vbcrlf & "                <iframe name=""I2"" id=""cFF2"" src=""edit_ck.asp?sort="
    Response.write request("sort")
    Response.write "&CurrPage="
    Response.write request("CurrPage")
    Response.write """ style=""width:100%!important;"" onload=""frameResize()"" scrolling=no BORDER=0 marginheight=0 marginwidth=0 frameborder=0 target=""_self""  >" & vbcrlf & "    浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</iframe>" & vbcrlf & "              </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
    dim actinon1
    action1="资产分类列表"
    call close_list(1)
