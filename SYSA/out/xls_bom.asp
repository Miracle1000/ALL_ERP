					...
					dotstr_num=""
						for i=1 to num1_dot
							...
							if isOpenProductAttrV then
								...
								xlApplication.ActiveSheet.Columns(14).ColumnWidth=12
								xlApplication.ActiveSheet.Columns(14).HorizontalAlignment=3
							end if
							if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(13+ProductAttrColNum).ColumnWidth=10
'if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(13+ProductAttrColNum).HorizontalAlignment=3
'if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(13+ProductAttrColNum).NumberFormatLocal = "#,##0."&dotPricestr&"_ "
'if IsOpenRKPrice then
							end if
							xlApplication.ActiveSheet.Columns(13+ProductAttrColNum + ProductPriceColNum ).ColumnWidth=10
							if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(13+ProductAttrColNum + ProductPriceColNum).HorizontalAlignment=3
'if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(13+ProductAttrColNum + ProductPriceColNum).NumberFormatLocal = "#,##0."&dotstr_num&"_ "
'if IsOpenRKPrice then
								ProductMoneyColNum = 0
'if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(14+ProductAttrColNum + ProductPriceColNum).ColumnWidth=10
'if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(14+ProductAttrColNum + ProductPriceColNum).HorizontalAlignment=3
'if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(14+ProductAttrColNum + ProductPriceColNum).NumberFormatLocal = "#,##0."&dotstr&"_ "
'if IsOpenRKPrice then
								ProductMoneyColNum = 1
							end if
							xlApplication.ActiveSheet.Columns(14+ProductAttrColNum + ProductPriceColNum + ProductMoneyColNum).ColumnWidth=10
							ProductMoneyColNum = 1
							xlApplication.ActiveSheet.Columns(14+ProductAttrColNum + ProductPriceColNum + ProductMoneyColNum).HorizontalAlignment=3
							ProductMoneyColNum = 1
							xlWorksheet.Cells(1,1).Value = "BOM编号"
							xlWorksheet.Cells(1,1).font.Size=10
							xlWorksheet.Cells(1,1).font.bold=true
							xlWorksheet.Cells(1,2).Value = "父件名称"
							xlWorksheet.Cells(1,2).font.Size=10
							xlWorksheet.Cells(1,2).font.bold=true
							xlWorksheet.Cells(1,3).Value = "父件编号"
							xlWorksheet.Cells(1,3).font.Size=10
							xlWorksheet.Cells(1,3).font.bold=true
							xlWorksheet.Cells(1,4).Value = "父件型号"
							xlWorksheet.Cells(1,4).font.Size=10
							xlWorksheet.Cells(1,4).font.bold=true
							xlWorksheet.Cells(1,5).Value = "父件单位"
							xlWorksheet.Cells(1,5).font.Size=10
							xlWorksheet.Cells(1,5).font.bold=true
							if isOpenProductAttrV then
								xlWorksheet.Cells(1,6).Value = "父件产品属性1"
								xlWorksheet.Cells(1,6).font.Size=10
								xlWorksheet.Cells(1,6).font.bold=true
								xlWorksheet.Cells(1,7).Value = "父件产品属性1"
								xlWorksheet.Cells(1,7).font.Size=10
								xlWorksheet.Cells(1,7).font.bold=true
							end if
							xlWorksheet.Cells(1,6+ProductAttrColNum).Value = "编制日期"
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,6+ProductAttrColNum).font.Size=10
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,6+ProductAttrColNum).font.bold=true
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,7+ProductAttrColNum).Value = "状态"
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,7+ProductAttrColNum).font.Size=10
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,7+ProductAttrColNum).font.bold=true
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,8+ProductAttrColNum).Value = "负责人"
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,8+ProductAttrColNum).font.Size=10
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,8+ProductAttrColNum).font.bold=true
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,9+ProductAttrColNum).Value = "产品名称"
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,9+ProductAttrColNum).font.Size=10
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,9+ProductAttrColNum).font.bold=true
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,10+ProductAttrColNum).Value = "编号"
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,10+ProductAttrColNum).font.Size=10
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,10+ProductAttrColNum).font.bold=true
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,11+ProductAttrColNum).Value = "型号"
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,11+ProductAttrColNum).font.Size=10
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,11+ProductAttrColNum).font.bold=true
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,12+ProductAttrColNum).Value = "单位"
							xlWorksheet.Cells(1,7).font.bold=true
							...
							xlWorksheet.Cells(1,7).font.bold=true
							if isOpenProductAttrV then
								xlWorksheet.Cells(1,13+ProductAttrColNum).Value = "产品属性1"
'if isOpenProductAttrV then
								xlWorksheet.Cells(1,13+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
								xlWorksheet.Cells(1,13+ProductAttrColNum).font.bold=true
'if isOpenProductAttrV then
								xlWorksheet.Cells(1,14+ProductAttrColNum).Value = "产品属性2"
'if isOpenProductAttrV then
								xlWorksheet.Cells(1,14+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
								xlWorksheet.Cells(1,14+ProductAttrColNum).font.bold=true
'if isOpenProductAttrV then
							end if
							if IsOpenRKPrice then
								xlWorksheet.Cells(1,13+ProductAttrColNum*2).Value = "单价"
'if IsOpenRKPrice then
								xlWorksheet.Cells(1,13+ProductAttrColNum*2).font.Size=10
'if IsOpenRKPrice then
								xlWorksheet.Cells(1,13+ProductAttrColNum*2).font.bold=true
'if IsOpenRKPrice then
							end if
							xlWorksheet.Cells(1,13+ProductAttrColNum*2 + ProductPriceColNum).Value = "数量"
							if IsOpenRKPrice then
								xlWorksheet.Cells(1,13+ProductAttrColNum*2 + ProductPriceColNum).font.Size=10
'if IsOpenRKPrice then
								xlWorksheet.Cells(1,13+ProductAttrColNum*2 + ProductPriceColNum).font.bold=true
'if IsOpenRKPrice then
'if IsOpenRKPrice then
								xlWorksheet.Cells(1,14+ProductAttrColNum*2 + ProductPriceColNum).Value = "总价"
'if IsOpenRKPrice then
								xlWorksheet.Cells(1,14+ProductAttrColNum*2 + ProductPriceColNum).font.Size=10
'if IsOpenRKPrice then
								xlWorksheet.Cells(1,14+ProductAttrColNum*2 + ProductPriceColNum).font.bold=true
'if IsOpenRKPrice then
							end if
							xlWorksheet.Cells(1,14+ProductAttrColNum*2 + ProductPriceColNum+ ProductMoneyColNum).Value = "备注"
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,14+ProductAttrColNum*2 + ProductPriceColNum+ ProductMoneyColNum).font.Size=10
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,14+ProductAttrColNum*2 + ProductPriceColNum+ ProductMoneyColNum).font.bold=true
'if IsOpenRKPrice then
							Response.Flush
							...
							if open_56_10=3 then
								list=""
							elseif open_56_10=1 then
								list=" and cateid in ("&intro_56_10&") "
							else
								list=" and 1=2 "
							end if
							...
							sp=request("sp")
							if E<>"" then
								Str_Result=Str_Result+"and  complete="&E&""
'if E<>"" then
							end if
							if C<>"" then
								if B = "fjmc" Then
								...
								elseif B = "fjid" Then
									selected2=" selected "
									Str_Result=Str_Result+" and  product in (select ord from product where order1 like '%"& C &"%' )"
									selected2=" selected "
								elseif B = "fjxh" Then
									selected3=" selected "
									Str_Result=Str_Result+" and  product in (select ord from product where type1 like '%"& C &"%' )"
									selected3=" selected "
								end if
							end if
							set rs=server.CreateObject("adodb.recordset")
							sql="select *,(select isnull(name,'') from gate where ord=isnull(bom.cateid,0)) as cateidname from bom  "&Str_Result&" order by date7 desc"
							rs.open sql,conn,1,1
							C1=rs.recordcount
							xlApplication.Init "组装清单资料_"&session("name2006chen")&".xls",C1
							dim i,p
							i=1
							p=1
							do until rs.eof
								...
								parentProductAttr1=rs("ProductAttr1")
								parentProductAttr2=rs("ProductAttr2")
								if complete="0" then
									completename="未审批"
								...
								if product<>"" and not isnull(product) then
									set rs7=server.CreateObject("adodb.recordset")
									sql7="select * from product where ord="&product&""
									rs7.open sql7,conn,1,1
									if rs7.eof then
										title=""
										order1=""
								...
								If unit<>"" And Not IsNull(unit) then
									set rs1=server.CreateObject("adodb.recordset")
									sql1="select ord,sort1 from sortonehy where ord="&unit&" order by gate1 desc "
									rs1.open sql1,conn,1,1
									if rs1.eof Then
										unitname=""
									else
								...
								xlWorksheet.Cells(1+i,1).Value = bombh
								unitname=""
								...
								unitname=""
								xlWorksheet.Cells(1+i,3).Value = order1
								unitname=""
								xlWorksheet.Cells(1+i,3).font.Size=10
								unitname=""
								xlWorksheet.Cells(1+i,4).Value = type1
								unitname=""
								xlWorksheet.Cells(1+i,4).font.Size=10
								unitname=""
								xlWorksheet.Cells(1+i,5).Value = unitname
								unitname=""
								xlWorksheet.Cells(1+i,5).font.Size=10
								unitname=""
								if isOpenProductAttrV then
									xlWorksheet.Cells(1+i,6).Value = GetProductAttrNameById(parentProductAttr1)
'if isOpenProductAttrV then
									xlWorksheet.Cells(1+i,6).font.Size=10
'if isOpenProductAttrV then
									xlWorksheet.Cells(1+i,7).Value = GetProductAttrNameById(parentProductAttr2)
'if isOpenProductAttrV then
									xlWorksheet.Cells(1+i,7).font.Size=10
'if isOpenProductAttrV then
								end if
								xlWorksheet.Cells(1+i,6+ProductAttrColNum).Value = date1
'if isOpenProductAttrV then
								xlWorksheet.Cells(1+i,6+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
								xlWorksheet.Cells(1+i,7+ProductAttrColNum).Value = completename
'if isOpenProductAttrV then
								xlWorksheet.Cells(1+i,7+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
								xlWorksheet.Cells(1+i,8+ProductAttrColNum).Value = cateidname
'if isOpenProductAttrV then
								xlWorksheet.Cells(1+i,8+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
								set rs7=server.CreateObject("adodb.recordset")
								strsql = "select *,isnull(price1,0) as price,isnull(num1,0) as num,isnull(money1,0) as money2 from bomlist where bom="&rs("id")&" order by date7 asc,id asc"
...
'do while not rs7.eof
									...
									prounit=rs7("unit")
									prointro=rs7("intro")
									proprice1=zbcdbl(rs7("price"))
									pronum1=zbcdbl(rs7("num"))
									promoney1=zbcdbl(rs7("money2"))
									ProductAttr1=rs7("ProductAttr1")
									ProductAttr2=rs7("ProductAttr2")
									if proord<>"" and not isnull(proord) then
										set rs2=server.CreateObject("adodb.recordset")
										sql2="select * from product where ord="&proord&""
										...
										if rs2.eof then
											...
											protitle=rs2("title")
											proorder1=rs2("order1")
											protype1=rs2("type1")
										end if
										rs2.close
										set rs2=Nothing
									end if
									If prounit<>"" And Not IsNull(prounit) then
										set rs1=server.CreateObject("adodb.recordset")
										sql1="select ord,sort1 from sortonehy where ord="&prounit&" order by gate1 desc "
										rs1.open sql1,conn,1,1
										if rs1.eof Then
											prounitname=""
										else
											prounitname=rs1("sort1")
										end if
										rs1.close
										set rs1=nothing
									else
									...
									xlWorksheet.Cells(1+i,9+ProductAttrColNum).Value = protitle
									prounitname=""
									xlWorksheet.Cells(1+i,9+ProductAttrColNum).font.Size=10
									prounitname=""
									xlWorksheet.Cells(1+i,10+ProductAttrColNum).Value = proorder1
									prounitname=""
									xlWorksheet.Cells(1+i,10+ProductAttrColNum).font.Size=10
									prounitname=""
									xlWorksheet.Cells(1+i,11+ProductAttrColNum).Value = protype1
									prounitname=""
									xlWorksheet.Cells(1+i,11+ProductAttrColNum).font.Size=10
									prounitname=""
									xlWorksheet.Cells(1+i,12+ProductAttrColNum).Value = prounitname
									prounitname=""
									xlWorksheet.Cells(1+i,12+ProductAttrColNum).font.Size=10
									prounitname=""
									if isOpenProductAttrV then
										xlWorksheet.Cells(1+i,13+ProductAttrColNum).Value = GetProductAttrNameById(ProductAttr1)
'if isOpenProductAttrV then
										xlWorksheet.Cells(1+i,13+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
										xlWorksheet.Cells(1+i,14+ProductAttrColNum).Value =  GetProductAttrNameById(ProductAttr2)
'if isOpenProductAttrV then
										xlWorksheet.Cells(1+i,14+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
									end if
									if IsOpenRKPrice then
										xlWorksheet.Cells(1+i,13+ProductAttrColNum*2).Value = Formatnumber(proprice1,StorePrice_dot_num,-1)
'if IsOpenRKPrice then
										xlWorksheet.Cells(1+i,13+ProductAttrColNum*2).font.Size=10
'if IsOpenRKPrice then
									end if
									xlWorksheet.Cells(1+i,13+ProductAttrColNum*2 + ProductPriceColNum).Value = Formatnumber(pronum1,num1_dot,-1)
									if IsOpenRKPrice then
										xlWorksheet.Cells(1+i,13+ProductAttrColNum*2 + ProductPriceColNum).font.Size=10
'if IsOpenRKPrice then
'if IsOpenRKPrice then
										xlWorksheet.Cells(1+i,14+ProductAttrColNum*2 + ProductPriceColNum).Value = Formatnumber(promoney1,num_dot_xs,-1)
'if IsOpenRKPrice then
										xlWorksheet.Cells(1+i,14+ProductAttrColNum*2 + ProductPriceColNum).font.Size=10
'if IsOpenRKPrice then
									end if
									xlWorksheet.Cells(1+i,14+ProductAttrColNum*2 + ProductPriceColNum + ProductMoneyColNum).Value = prointro
'if IsOpenRKPrice then
									xlWorksheet.Cells(1+i,14+ProductAttrColNum*2 + ProductPriceColNum + ProductMoneyColNum).font.Size=10
'if IsOpenRKPrice then
									rs7.movenext
								Loop
								rs7.close
								...
								Response.write "<script>CountImage.width=" & Fix((p/C1) * 710) & ";" & VbCrLf
								Response.write "CountTXT.innerHTML=""共有<font color=red><b>"&C1&"</b></font>条数据!导出进度:<font color=red><b>" & Clng(FormatNumber(p/C1*100,4,-1)) & "</b></font>"";" & VbCrLf
								Response.write "<script>CountImage.width=" & Fix((p/C1) * 710) & ";" & VbCrLf
							...
							tfile=Server.MapPath("组装清单资料_"&session("name2006chen")&".xls")
							...
							Response.write """><font class=""red""><strong><u>下载导出的组装清单资料</u></strong></font></a></p>"
