...
'If font.color & "" <> "" Then cssText = cssText & "color:" & font.color & ";"
	...
	Response.write " " & vbcrlf & "<HTML>" & vbcrlf & "<HEAD>" & vbcrlf & "<TITLE>费用申请导出</TITLE>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8""><style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "      background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-top: 0px;" & vbcrlf & "        margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style></HEAD>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "  <tr>" & vbcrlf & "<td class=""place"">费用申请导出</td>" & vbcrlf & "       <td>&nbsp;</td>" & vbcrlf & " <td align=""right"">&nbsp;</td>" & vbcrlf & "     <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table> "  & vbcrlf & " <table width=""100%"" border=""0""cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr class=""top"">" & vbcrlf & "  <td colspan=2 class=tablebody1>&nbsp;</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr>" & vbcrlf & "  <td colspan=2 class=tablebody1>" & vbcrlf & "<span id=""CountTXTok"" name=""CountTXTok"" style=""font-size:10pt; color:#008040"">" & vbcrlf & "<B>正在导出费用申请,请稍后...</B></span>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""1"" cellpadding=""1"">" & vbcrlf & "<tr> " & vbcrlf & "<td bgcolor=000000>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""1"">" & vbcrlf & "<tr> " & vbcrlf & "<td bgcolor=ffffff height=9><img src=""../images/tiao.jpg"" width=""0"" height=""16"" id=""CountImage"" name=""CountImage"" align=""absmiddle""></td></tr></table>" & vbcrlf & "</td></tr></table> <span id=""CountTXT"" name=""CountTXT"" style=""font-size:9pt; color:#008040"">0</span><span style=""font-size:9pt; color:#008040"">%</span></td></tr>" & vbcrlf & "<tr class=""top"">" & vbcrlf & "  <td colspan=2 class=tablebody1 height=""40"">" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	Response.write Application("sys.info.jsver")
	dotstr=""
		If num_dot_xs > 0 Then dotstr = "."
		for i=1 to num_dot_xs
			dotstr=dotstr&"0"
			next
			dim MODULES
			MODULES=session("zbintel2010ms")
			scVer = sdk.getSqlValue("select num1 from setjm3 where ord=2017112116" , 1)
			Set xlApplication = New ExcelApp
			xlApplication.isMainDetailMode = True
			...
			xlApplication.ActiveSheet.Columns(3).ColumnWidth=15
			...
			xlApplication.ActiveSheet.Columns(4).ColumnWidth=8
			...
			xlApplication.ActiveSheet.Columns(7).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(7).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(8).ColumnWidth=15
			...
			xlApplication.ActiveSheet.Columns(10).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(10).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(11).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(11).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(13).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(13).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(14).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(14).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(15).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(15).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(16).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(16).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(17).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(17).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(17).NumberFormatLocal = "#,##0"&dotstr&"_ "
			xlApplication.ActiveSheet.Columns(18).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(18).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(19).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(19).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(20).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(20).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(21).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(21).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(22).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(22).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(23).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(23).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(24).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(24).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(25).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(25).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(26).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(26).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(27).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(27).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(28).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(28).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(29).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(29).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(30).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(30).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(31).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(31).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(32).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(32).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(33).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(33).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(34).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(34).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(35).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(35).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(36).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(36).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(37).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(37).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(38).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(38).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(39).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(39).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(40).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(40).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(41).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(41).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(42).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(42).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(43).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(43).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(44).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(44).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(45).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(45).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(46).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(46).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(47).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(47).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(48).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(48).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(49).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(49).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(50).ColumnWidth=15
			xlApplication.ActiveSheet.Columns(50).HorizontalAlignment=3
			xlWorksheet.Cells(1,1).Value = "申请主题"
			...
			xlWorksheet.Cells(1,3).Value = "申请总额"
			xlWorksheet.Cells(1,3).font.Size=10
			xlWorksheet.Cells(1,3).font.bold=True
			xlWorksheet.Cells(1,4).Value = "审批总额"
			xlWorksheet.Cells(1,4).font.Size=10
			xlWorksheet.Cells(1,4).font.bold=True
			xlWorksheet.Cells(1,5).Value = "申请人员"
			xlWorksheet.Cells(1,5).font.Size=10
			xlWorksheet.Cells(1,5).font.bold=true
			xlWorksheet.Cells(1,6).Value = "申请日期"
			xlWorksheet.Cells(1,6).font.Size=10
			xlWorksheet.Cells(1,6).font.bold=true
			xlWorksheet.Cells(1,7).Value = "添加人员"
			xlWorksheet.Cells(1,7).font.Size=10
			xlWorksheet.Cells(1,7).font.bold=true
			xlWorksheet.Cells(1,8).Value = "添加时间"
			xlWorksheet.Cells(1,8).font.Size=10
			xlWorksheet.Cells(1,8).font.bold=true
			xlWorksheet.Cells(1,9).Value = "审批人员"
			xlWorksheet.Cells(1,9).font.Size=10
			xlWorksheet.Cells(1,9).font.bold=true
			xlWorksheet.Cells(1,10).Value = "审批时间"
			xlWorksheet.Cells(1,10).font.Size=10
			xlWorksheet.Cells(1,10).font.bold=true
			xlWorksheet.Cells(1,11).Value = "总张数"
			xlWorksheet.Cells(1,11).font.Size=10
			xlWorksheet.Cells(1,11).font.bold=true
			xlWorksheet.Cells(1,12).Value = "天数"
			xlWorksheet.Cells(1,12).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,13).Value = "申请概要"
			xlWorksheet.Cells(1,13).font.Size=10
			xlWorksheet.Cells(1,13).font.bold=true
			xlWorksheet.Cells(1,14).Value = "费用分类"
			xlWorksheet.Cells(1,14).font.Size=10
			xlWorksheet.Cells(1,14).font.bold=true
			xlWorksheet.Cells(1,15).Value = "编号"
			xlWorksheet.Cells(1,15).font.Size=10
			xlWorksheet.Cells(1,15).font.bold=true
			xlWorksheet.Cells(1,16).Value = "张数"
			xlWorksheet.Cells(1,16).font.Size=10
			xlWorksheet.Cells(1,16).font.bold=True
			xlWorksheet.Cells(1,17).Value = "金额"
			xlWorksheet.Cells(1,17).font.Size=10
			xlWorksheet.Cells(1,17).font.bold=true
			xlWorksheet.Cells(1,18).Value = "备注"
			xlWorksheet.Cells(1,18).font.Size=10
			xlWorksheet.Cells(1,18).font.bold=true
			xlWorksheet.Cells(1,19).Value = "出发时间"
			xlWorksheet.Cells(1,19).font.Size=10
			xlWorksheet.Cells(1,19).font.bold=true
			xlWorksheet.Cells(1,20).Value = "出发地点"
			xlWorksheet.Cells(1,20).font.Size=10
			xlWorksheet.Cells(1,20).font.bold=true
			xlWorksheet.Cells(1,21).Value = "到达时间"
			xlWorksheet.Cells(1,21).font.Size=10
			xlWorksheet.Cells(1,21).font.bold=true
			xlWorksheet.Cells(1,22).Value = "到达地点"
			xlWorksheet.Cells(1,22).font.Size=10
			xlWorksheet.Cells(1,22).font.bold=true
			xlWorksheet.Cells(1,23).Value = "里程"
			xlWorksheet.Cells(1,23).font.Size=10
			xlWorksheet.Cells(1,23).font.bold=true
			xlWorksheet.Cells(1,24).Value = "交通工具"
			xlWorksheet.Cells(1,24).font.Size=10
			xlWorksheet.Cells(1,24).font.bold=true
			xlWorksheet.Cells(1,25).Value = "返回时间"
			xlWorksheet.Cells(1,25).font.Size=10
			xlWorksheet.Cells(1,25).font.bold=true
			xlWorksheet.Cells(1,26).Value = "开始日期"
			xlWorksheet.Cells(1,26).font.Size=10
			xlWorksheet.Cells(1,26).font.bold=true
			xlWorksheet.Cells(1,27).Value = "结束日期"
			xlWorksheet.Cells(1,27).font.Size=10
			xlWorksheet.Cells(1,27).font.bold=true
			xlWorksheet.Cells(1,28).Value = "所在城市"
			xlWorksheet.Cells(1,28).font.Size=10
			xlWorksheet.Cells(1,28).font.bold=true
			xlWorksheet.Cells(1,29).Value = "宾馆名称"
			xlWorksheet.Cells(1,29).font.Size=10
			xlWorksheet.Cells(1,29).font.bold=true
			xlWorksheet.Cells(1,30).Value = "公关日期"
			xlWorksheet.Cells(1,30).font.Size=10
			xlWorksheet.Cells(1,30).font.bold=true
			xlWorksheet.Cells(1,31).Value = "公关对象"
			xlWorksheet.Cells(1,31).font.Size=10
			xlWorksheet.Cells(1,31).font.bold=true
			xlWorksheet.Cells(1,32).Value = "公关事由"
			xlWorksheet.Cells(1,32).font.Size=10
			xlWorksheet.Cells(1,32).font.bold=true
			xlWorksheet.Cells(1,33).Value = "赠送礼品"
			xlWorksheet.Cells(1,33).font.Size=10
			xlWorksheet.Cells(1,33).font.bold=true
			xlWorksheet.Cells(1,34).Value = "需要时间"
			xlWorksheet.Cells(1,34).font.Size=10
			xlWorksheet.Cells(1,34).font.bold=true
			xlWorksheet.Cells(1,35).Value = "用途"
			xlWorksheet.Cells(1,35).font.Size=10
			xlWorksheet.Cells(1,35).font.bold=true
			j=36
			if ZBRuntime.MC(1001) then
				xlWorksheet.Cells(1,j).Value = "关联客户"
			...
			if ZBRuntime.MC(2000) then
				xlWorksheet.Cells(1,j).Value = "关联联系人"
				xlWorksheet.Cells(1,j).font.Size=10
				xlWorksheet.Cells(1,j).font.bold=true
				j=j+1
				xlWorksheet.Cells(1,j).font.bold=true
			...
			if ZBRuntime.MC(3000) then
				xlWorksheet.Cells(1,j).Value = "关联项目"
				xlWorksheet.Cells(1,j).font.Size=10
				xlWorksheet.Cells(1,j).font.bold=true
				j=j+1
				xlWorksheet.Cells(1,j).font.bold=true
			...
			if ZBRuntime.MC(8000) then
				xlWorksheet.Cells(1,j).Value = "关联销售退货"
				xlWorksheet.Cells(1,j).font.Size=10
				xlWorksheet.Cells(1,j).font.bold=true
				j=j+1
				xlWorksheet.Cells(1,j).font.bold=true
			...
			if ZBRuntime.MC(9000) then
				xlWorksheet.Cells(1,j).Value = "关联售后"
				xlWorksheet.Cells(1,j).font.Size=10
				xlWorksheet.Cells(1,j).font.bold=true
				j=j+1
				xlWorksheet.Cells(1,j).font.bold=true
			end if
			if ZBRuntime.MC(31000) then
				xlWorksheet.Cells(1,j).Value = "关联日程"
				xlWorksheet.Cells(1,j).font.Size=10
				xlWorksheet.Cells(1,j).font.bold=true
				j=j+1
				xlWorksheet.Cells(1,j).font.bold=true
			end if
			if ZBRuntime.MC(17008) then
				xlWorksheet.Cells(1,j).Value = "关联发货"
				xlWorksheet.Cells(1,j).font.Size=10
				xlWorksheet.Cells(1,j).font.bold=true
				j=j+1
				xlWorksheet.Cells(1,j).font.bold=true
			...
			if ZBRuntime.MC(16000) then
				xlWorksheet.Cells(1,j).Value = "关联采购退货"
				xlWorksheet.Cells(1,j).font.Size=10
				xlWorksheet.Cells(1,j).font.bold=true
				j=j+1
				xlWorksheet.Cells(1,j).font.bold=true
			...
			if ZBRuntime.MC(1002) then
				xlWorksheet.Cells(1,j).Value = "关联供应商"
				xlWorksheet.Cells(1,j).font.Size=10
				xlWorksheet.Cells(1,j).font.bold=true
				j=j+1
				xlWorksheet.Cells(1,j).font.bold=true
			end if
			if ZBRuntime.MC(51000) then
				if ZBRuntime.MC(51001) then
					xlWorksheet.Cells(1,j).Value = "关联办公用品"
					xlWorksheet.Cells(1,j).font.Size=10
					xlWorksheet.Cells(1,j).font.bold=true
					j=j+1
					xlWorksheet.Cells(1,j).font.bold=true
				end if
				if ZBRuntime.MC(51002) then
					xlWorksheet.Cells(1,j).Value = "关联车辆保险"
					xlWorksheet.Cells(1,j).font.Size=10
					xlWorksheet.Cells(1,j).font.bold=true
					j=j+1
					xlWorksheet.Cells(1,j).font.bold=true
					xlWorksheet.Cells(1,j).Value = "关联车辆维护"
					xlWorksheet.Cells(1,j).font.Size=10
					xlWorksheet.Cells(1,j).font.bold=true
					j=j+1
					xlWorksheet.Cells(1,j).font.bold=true
				end if
				if ZBRuntime.MC(51003) then
					xlWorksheet.Cells(1,j).Value = "关联图书"
					xlWorksheet.Cells(1,j).font.Size=10
					xlWorksheet.Cells(1,j).font.bold=true
					j=j+1
					xlWorksheet.Cells(1,j).font.bold=true
			...
			if ZBRuntime.MC(18500) And scVer&""="0" then
				xlWorksheet.Cells(1,j).Value = "关联生产订单"
				xlWorksheet.Cells(1,j).font.Size=10
				xlWorksheet.Cells(1,j).font.bold=true
				j=j+1
				xlWorksheet.Cells(1,j).font.bold=true
			...
			If 1=0 Then
				if ZBRuntime.MC(18700       ) then
					xlWorksheet.Cells(1,j).Value = "关联整单委外"
					xlWorksheet.Cells(1,j).font.Size=10
					xlWorksheet.Cells(1,j).font.bold=true
					j=j+1
					xlWorksheet.Cells(1,j).font.bold=true
				end if
				if ZBRuntime.MC(18610) then
					xlWorksheet.Cells(1,j).Value = "关联工序委外"
					xlWorksheet.Cells(1,j).font.Size=10
					xlWorksheet.Cells(1,j).font.bold=true
					j=j+1
					xlWorksheet.Cells(1,j).font.bold=true
				end if
				if ZBRuntime.MC(18900) then
					xlWorksheet.Cells(1,j).Value = "关联生产设备"
					xlWorksheet.Cells(1,j).font.Size=10
					xlWorksheet.Cells(1,j).font.bold=true
					j=j+1
					xlWorksheet.Cells(1,j).font.bold=true
			...
			elseif open_6_1=1 then
				Str_Result=" and cateid in ("&intro_6_1&")"
			else
				Str_Result="and cateid=0"
			end if
			set rs1=server.CreateObject("adodb.recordset")
			...
			set rs1=nothing
			if open_6_10=1 then
				Str_Result=" and cateid in ("&intro_6_10&")"
			elseif open_6_10=0 then
				Str_Result="and cateid=0"
			end if
			if request("ret")<>"" then
				m1=request("ret")
			...
			if T="3333333" or T="5555555" then
				new_list="<span class='alt_tx'></span>"
				timelg=session("timezbintel2007")
				if T="3333333" and timelg<>"" then
					noalt1=" and adddate>'"&timelg&"'"
				end if
				Str_Result=" and (cateid_sp="&session("personzbintel2007")&" and sp>0 and complete in (0,2) "&Str_Result&") "&noalt1&""
			end if
...
'if W4<>"" and not isnull(W4) then
			...
			if listbz<>"" then
				listbz=cdbl(listbz)
				Str_Result=Str_Result+" and bz="&listbz&" "
				listbz=cdbl(listbz)
			end if
			if e<>"" then
				Str_Result=Str_Result+" and cateid_sp="&e&" and complete in (2,0) "
'if e<>"" then
			end if
			if e1<>"" then
				Str_Result=Str_Result+" and complete in ("&e1&") "
'if e1<>"" then
			end if
			if title<>"" then
				Str_Result=Str_Result&" and  title like '%"&title&"%' "
			end if
			if intro<>"" then
				Str_Result=Str_Result+"and  intro like '%"&intro&"%' "
'if intro<>"" then
			end if
			if remark<>"" then
				Str_Result=Str_Result+"and  remark like '%"&remark&"%' "
'if remark<>"" then
			end if
			if money1<>"" then
				if isnumeric(money1)=false then
					Response.write("<script>alert('请输入合法金额');window.location=('paysq.asp');</script>")
					call db_close : Response.end
				else
					Str_Result=Str_Result+"and sqmoney >="&money1&" "
					call db_close : Response.end
				end if
			end if
			if money12<>"" then
				if isnumeric(money12)=false then
					...
					Str_Result=Str_Result+"and  sqmoney <="&money12&" "
					call db_close : Response.end
				end if
			end if
			if T="1" then
				Str_Result=Str_Result+" and complete in ("&T&") "
'if T="1" then
			end if
			if T="2" then'
			Str_Result=Str_Result+" and complete in ("&T&") "
...
'if T="3" then''
	...
	if C<>"" then
		...
		elseif B="2" then
			perid=selname("gate","name",C,"ord")
			if trim(perid)="" or isnull(perid) then     perid=0
			if trim(perid)<>"" then
				Str_Result=Str_Result+" and cateid in ("&perid&") "
'if trim(perid)<>"" then
			end if
		elseif B="3" then
			perid=selname("gate","name",C,"ord")
			if trim(perid)="" or isnull(perid) then     perid=0
			if trim(perid)<>"" then
				Str_Result=Str_Result+" and addcateid in ("&perid&") "
'if trim(perid)<>"" then
			end if
		elseif B="4" then
			if isnumeric(C)=False Or InStr(C,",")>0 Or InStr(1,C,"e",1)>0 Then C=0
			Str_Result=Str_Result+" and  sqmoney="&C
			if isnumeric(C)=False Or InStr(C,",")>0 Or InStr(1,C,"e",1)>0 Then C=0
		elseif B="5" then
			if isnumeric(C)=False Or InStr(C,",")>0 Or InStr(1,C,"e",1)>0 Then C=0
			Str_Result=Str_Result+" and  days="&C
			if isnumeric(C)=False Or InStr(C,",")>0 Or InStr(1,C,"e",1)>0 Then C=0
		elseif B="6" then
			Str_Result=Str_Result+" and  intro like '%"&C&"%'"
'elseif B="6" then
		elseif B="20" then
			Str_Result=Str_Result+" and  remark like '%"&C&"%'"
'elseif B="20" then
		end if
	end if
	if m1<>"" then
		Str_Result=Str_Result+" and  sp_date>='"&m1&"' "
'if m1<>"" then'
	end if
	if m2<>"" then
		Str_Result=Str_Result+" and  sp_date<='"&m2&"' "
'if m2<>"" then
	end if
	If remind <> "" Then
	...
	if currpage<="0" or currpage="" or isnull(currpage) or isnumeric(currpage)=false then
		currpage=1
	end if
	...
	elseif px=3 then
		pxResult=" order by adddate desc"
	elseif px=4 then
		pxResult=" order by adddate asc"
	elseif px=5 then
		pxResult=" order by sp_date desc"
	elseif px=6 then
		pxResult=" order by sp_date asc"
	end if
	i=1
	k=1
	sql="select *,isnull((select top 1 sort1 from sortbz where id=paysq.bz),'人民币') bzname from paysq where del=1 "&Str_Result&" "&pxResult
	set rs = server.CreateObject("adodb.recordset")
	rs.open sql,conn,1,1
	C1=rs.recordcount
	xlApplication.Init "费用申请_"&session("name2006chen")&".xls",C1
	C2=0
	if rs.eof then
	else
		do until rs.eof
			title=rs("title")
			date1=rs("sp_date")
			money1=zbcdbl(rs("sqmoney"))
			money1_1=zbcdbl(rs("spmoney"))
			perid=rs("cateid")
			addcate=rs("addcateid")
			adddate=rs("adddate")
			note=rs("intro")
			days=rs("days")
			bz=rs("bz")
			...
			bzname=rs("bzname")
			num=getrsval("select sum(num) as num from paysqlist where fid="&rs("id"))
			member2=setname("gate","ord",perid,"name")
			member2_1=setname("gate","ord",addcate,"name")
			Set rsSP = conn.execute("" &_
			"select top 1 a.date1,isnull(b.name,'审批人被删除') from sp_intro a " &_
			"left join gate b on a.cateid=b.ord " &_
			"where a.ord=" & rs("id") & " and a.sort1=7 order by a.id desc")
			If rsSP.eof Then
				date_sp = ""
				gate_sp = ""
			else
			...
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,2).Value = bzname
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,2).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,2).HorizontalAlignment=3
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,3).Value = Formatnumber(money1,num_dot_xs,-1)
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,3).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,3).HorizontalAlignment=1
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,4).Value = Formatnumber(money1_1,num_dot_xs,-1)
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,4).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,4).HorizontalAlignment=1
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,5).Value = member2
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,5).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,5).HorizontalAlignment=3
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,6).Value = date1
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,6).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,6).HorizontalAlignment=1
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,7).Value = member2_1
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,7).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,7).HorizontalAlignment=3
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,8).Value = adddate
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,8).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,8).HorizontalAlignment=1
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,9).Value = gate_sp
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,9).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,9).HorizontalAlignment=3
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,10).Value = date_sp
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,10).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,10).HorizontalAlignment=1
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,11).Value =num
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,11).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,11).HorizontalAlignment=1
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,12).Value = days
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,12).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,12).HorizontalAlignment=1
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,13).Value = note
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,13).font.Size=10
			gate_sp = rsSP(1)
			xlWorksheet.Cells(1+i,13).HorizontalAlignment=1
			gate_sp = rsSP(1)
			sql5="select *,(select gate2 from paytype where id=paysqlist.sort1) as gate2 from paysqlist where del=1 and fid="&rs("id") &" order by gate2 desc, id asc"
			set rs5 = server.CreateObject("adodb.recordset")
			rs5.open sql5,conn,1,1
			if rs5.eof then
			else
				do until rs5.eof
					money2=zbcdbl(rs5("money1"))
					money2_1=zbcdbl(rs5("spmoney"))
					note1=rs5("note")
					num1=zbcdbl(rs5("num"))
					bh=rs5("bh")
					sort1=rs5("sort1")
					ggcate=rs5("ggcate")
					tel=rs5("company"):person=rs5("person"):chance=rs5("chance"):contract=rs5("contract"):contractth=rs5("contractth"):shouhou=rs5("shouhou"):richeng=rs5("richeng"):fahuo=rs5("fahuo"):caigou=rs5("caigou"):caigouth=rs5("caigouth"):work=rs5("iwork"):jkid=rs5("jkid"):office=rs5("office"):insure=rs5("insure"):repair=rs5("repair"):book=rs5("book") : scdd=rs5("scdd") : zdww=rs5("zdww") : gxww=rs5("gxww") : scsb=rs5("scsb")
					if sort1="" or isnull(sort1) then sort1=0
					fytype=setname("paytype","id",sort1,"sort1")
					if tel="" or isnull(tel) then tel=0
					if person="" or isnull(person) then person=0
					if chance="" or isnull(chance) then chance=0
					if contract="" or isnull(contract) then contract=0
					if contractth="" or isnull(contractth) then contractth=0
					if shouhou="" or isnull(shouhou) then shouhou=0
					if richeng="" or isnull(richeng) then richeng=0
					if fahuo="" or isnull(fahuo) then fahuo=0
					if caigou="" or isnull(caigou) then caigou=0
					if caigouth="" or isnull(caigouth) then caigouth=0
					if work="" or isnull(work) then work=0
					if jkid="" or isnull(jkid) then jkid=0
					if office="" or isnull(office) then office=0
					if insure="" or isnull(insure) then insure=0
					if repair="" or isnull(repair) then repair=0
					if book="" or isnull(book) then book=0
					If scdd&"" = "" Then scdd = 0
					If zdww&"" = "" Then zdww = 0
					If gxww&"" = "" Then gxww = 0
					If scsb&"" = "" Then scsb = 0
					ggtime=rs5("ggtime")
					If ggtime = "0:00:00" Then ggtime = ""
					startime=rs5("startime")
					If startime = "0:00:00" Then startime = ""
					endtime1=rs5("endtime1")
					If endtime1 = "0:00:00" Then endtime1 = ""
					startime1=rs5("startime1")
					If startime1 = "0:00:00" Then startime1 = ""
					endtime=rs5("endtime")
					If endtime = "0:00:00" Then endtime = ""
					retime=rs5("retime")
					If retime = "0:00:00" Then retime = ""
					xytime=rs5("xytime")
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,2).Value = "【申请明细】"
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,2).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,2).HorizontalAlignment=3
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,14).Value = fytype
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,14).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,14).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,15).Value = bh
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,15).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,15).HorizontalAlignment=1
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,16).Value = num1
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,16).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,16).HorizontalAlignment=1
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,17).Value = Formatnumber(money2,num_dot_xs,-1)
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,17).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,17).HorizontalAlignment=1
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,18).Value = note1
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,18).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,18).HorizontalAlignment=1
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,19).Value = startime
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,19).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,19).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,20).Value = rs5("staraddr")
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,20).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,20).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,21).Value = endtime
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,21).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,21).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,22).Value = rs5("endaddr")
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,22).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,22).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,23).Value = rs5("lc")
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,23).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,23).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,24).Value = rs5("bus")
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,24).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,24).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,25).Value = retime
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,25).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,25).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,26).Value = startime1
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,26).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,26).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,27).Value = endtime1
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,27).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,27).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,28).Value = rs5("city")
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,28).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,28).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,29).Value = rs5("hotel")
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,29).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,29).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,30).Value =ggtime
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,30).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,30).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,31).Value = ggcate
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,31).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,31).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,32).Value = rs5("ggintro")
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,32).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,32).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,33).Value = rs5("gglw")
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,33).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,33).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,34).Value = xytime
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,34).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,34).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,35).Value = rs5("yt")
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,35).font.Size=10
					If xytime = "0:00:00" Then xytime = ""
					xlWorksheet.Cells(2+i,35).font.bold=true
					If xytime = "0:00:00" Then xytime = ""
					fytype=setname("paytype","id",sort1,"sort1")
					vtel=setname("tel","ord",tel,"name")
					vperson=setname("person","ord",person,"name")
					vchance=setname("chance","ord",chance,"title")
					vcontract=setname("contract","ord",contract,"title")
					vcontractth=setname("contractth","ord",contractth,"title")
					vshouhou=setname("tousu","ord",shouhou,"title")
					vricheng=setname("plan1","ord",richeng,"intro")
					vfahuo=setname("send","ord",fahuo,"title")
					vcaigou=setname("caigou","ord",caigou,"title")
					vcaigouth=setname("caigouth","ord",caigouth,"title")
					vwork=setname("tel","ord",work,"name")
					vjkid=setname("payjk","id",jkid,"title")
					voffice=setname("O_kuin","id",office,"reg_name")
					if ZBRuntime.MC(18500) Then vscdd=setname("M2_ManuOrders","ID",scdd,"title")
					If 1=0 Then
						if ZBRuntime.MC(18700) Then vzdww=setname("M2_OutOrder","ID",zdww,"title")
						if ZBRuntime.MC(18610) Then vgxww=setname("M2_OutOrder","ID",gxww,"title")
						if ZBRuntime.MC(18900) Then vscsb=sdk.getSqlValue("select isnull(mi.name,'') name from M2_MachineList ml inner join M2_MachineInfo mi ON ml.MFID = mi.ID where ml.id="& scsb , "")
					end if
					sql4="select b.car_code from O_insure a"&_
					" left join O_carData b on a.iss_carid=b.car_id "&_
					" left join gate c on a.iss_cateid=c.ord where iss_id="&insure
					set rs4=conn.execute(sql4)
					if not rs4.eof then
						vinsure=rs4("car_code")
					else
						vinsure=""
					end if
					rs4.close
					set rs4=nothing
					sql4="select b.car_code from O_repair a"&_
					" left join O_carData b on a.rep_carid=b.car_id "&_
					" left join O_carSet c on a.rep_type=c.id and setType=4"&_
					" left join gate d on a.rep_cateid=d.ord where rep_id="&repair
					set rs4=conn.execute(sql4)
					if not rs4.eof then
						vrepair=rs4("car_code")
					else
						vrepair=""
					end if
					rs4.close
					set rs4=nothing
					vbook=setname("O_regBook","id",book,"bk_name")
					j=36
					if ZBRuntime.MC(1001) then
						xlWorksheet.Cells(2+i,j).Value = vtel
'if ZBRuntime.MC(1001) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(1001) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
'if ZBRuntime.MC(1001) then'
						j=j+1
'if ZBRuntime.MC(1001) then'
					end if
					if ZBRuntime.MC(2000) then
						xlWorksheet.Cells(2+i,j).Value = vperson
'if ZBRuntime.MC(2000) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(2000) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(2000) then'
					...
					if ZBRuntime.MC(3000) then
						xlWorksheet.Cells(2+i,j).Value = vchance
'if ZBRuntime.MC(3000) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(3000) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(3000) then'
					...
					if ZBRuntime.MC(7000) then
						xlWorksheet.Cells(2+i,j).Value = vcontract
'if ZBRuntime.MC(7000) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(7000) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(7000) then'
					...
					if ZBRuntime.MC(8000) then
						xlWorksheet.Cells(2+i,j).Value = vcontractth
'if ZBRuntime.MC(8000) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(8000) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(8000) then'
					...
					if ZBRuntime.MC(9000) then
						xlWorksheet.Cells(2+i,j).Value = vshouhou
'if ZBRuntime.MC(9000) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(9000) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(9000) then'
					...
					if ZBRuntime.MC(31000) then
						xlWorksheet.Cells(2+i,j).Value = vricheng
'if ZBRuntime.MC(31000) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(31000) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(31000) then'
					...
					if ZBRuntime.MC(17008) then
						xlWorksheet.Cells(2+i,j).Value = vfahuo
'if ZBRuntime.MC(17008) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(17008) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(17008) then'
					...
					if ZBRuntime.MC(15000) then
						xlWorksheet.Cells(2+i,j).Value = vcaigou
'if ZBRuntime.MC(15000) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(15000) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(15000) then'
					...
					if ZBRuntime.MC(16000) then
						xlWorksheet.Cells(2+i,j).Value = vcaigouth
'if ZBRuntime.MC(16000) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(16000) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(16000) then'
					...
					if ZBRuntime.MC(1002) then
						xlWorksheet.Cells(2+i,j).Value = vwork
'if ZBRuntime.MC(1002) then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(1002) then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(1002) then'
					...
					if ZBRuntime.MC(51000) then
						if ZBRuntime.MC(51001) then
							xlWorksheet.Cells(2+i,j).Value = voffice
'if ZBRuntime.MC(51001) then
							xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(51001) then
							xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(51001) then
						...
						if ZBRuntime.MC(51002) then
							xlWorksheet.Cells(2+i,j).Value = vinsure
'if ZBRuntime.MC(51002) then
							xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(51002) then
							xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
'if ZBRuntime.MC(51002) then
							j=j+1
'if ZBRuntime.MC(51002) then
							xlWorksheet.Cells(2+i,j).Value = vrepair
'if ZBRuntime.MC(51002) then
							xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(51002) then
							xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(51002) then
						...
						if ZBRuntime.MC(51003) then
							xlWorksheet.Cells(2+i,j).Value = vbook
'if ZBRuntime.MC(51003) then
							xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(51003) then
							xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(51003) then
					...
					if ZBRuntime.MC(18500) And scVer&""="0" then
						xlWorksheet.Cells(2+i,j).Value = vscdd
'if ZBRuntime.MC(18500) And scVer&""="0" then'
						xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(18500) And scVer&""="0" then'
						xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(18500) And scVer&""="0" then'
					...
					If 1=0 Then
						if ZBRuntime.MC(18700) then
							xlWorksheet.Cells(2+i,j).Value = vzdww
'if ZBRuntime.MC(18700) then'
							xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(18700) then'
							xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(18700) then'
						...
						if ZBRuntime.MC(18610) then
							xlWorksheet.Cells(2+i,j).Value = vgxww
'if ZBRuntime.MC(18610) then'
							xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(18610) then'
							xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(18610) then'
						...
						if ZBRuntime.MC(18900) then
							xlWorksheet.Cells(2+i,j).Value = vscsb
'if ZBRuntime.MC(18900) then'
							xlWorksheet.Cells(2+i,j).font.Size=10
'if ZBRuntime.MC(18900) then'
							xlWorksheet.Cells(2+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(18900) then'
	...
	rs.close
	set rs=nothing
	Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>费用导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!费用导出成功,共有"&(k-1)&"条记录!</B>"";</script>"
	set rs=nothing
	Response.write "" & vbcrlf & "</BODY>" & vbcrlf & "</HTML>" & vbcrlf & ""
	Set fs = CreateObject("Scripting.FileSystemObject")
	tfile=Server.MapPath("费用申请_"&session("name2006chen")&".xls")
	...
	Response.write """><font class=""red""><strong><u>下载导出的费用</u></strong></font></a></p> " & vbcrlf & ""
