...
'If font.color & "" <> "" Then cssText = cssText & "color:" & font.color & ";"
	...
	dotstr=""
		for i=1 to num_dot_xs
			...
			if open_6_10=3 then
				Str_Result=""
			elseif open_6_10=1 and intro_6_10<>"" then
				Str_Result=" and a.cateid in ("&intro_6_10&")"
			else
...
'if m2<>"" then
	...
	i=1
	sql5="select a.title,a.sp_date,a.cateid,b.*,"&_
	"isnull((select top 1 sort1 from f_pay fa inner join sortbz fb on fa.id=b.fid and fa.bz=fb.id),'人民币') bzname "&_
	"from paysq as a,paysqlist as b  where b.fid=a.id and a.del=1 and b.del=1 "&Str_Result&" "&pxResult
	set rs5 = server.CreateObject("adodb.recordset")
	rs5.open sql5,conn,1,1
	C1=rs5.recordcount
	xlApplication.Init "费用_"&session("name2006chen")&".xls",C1
	do until rs5.eof
		title=rs5("title")
		date1=rs5("sp_date")
		money1=zbcdbl(rs5("money1"))
		perid=rs5("cateid")
		sort1=rs5("sort1")
		bh=rs5("bh")
		note=rs5("note")
		...
		person=rs5("person")
		chance=rs5("chance")
		contract=rs5("contract")
		contractth=rs5("contractth")
		shouhou=rs5("shouhou")
		richeng=rs5("richeng")
		fahuo=rs5("fahuo")
		caigou=rs5("caigou")
		caigouth=rs5("caigouth")
		work=rs5("iwork")
		jkid=rs5("jkid")
		office=rs5("office")
		insure=rs5("insure")
		...
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,2).Value = bh
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,2).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,2).HorizontalAlignment=1
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,3).Value =  member2
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,3).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,3).HorizontalAlignment=1
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,4).Value = date1
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,4).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,4).HorizontalAlignment=1
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,5).Value = bzname
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,5).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,5).HorizontalAlignment=3
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,6).Value = Formatnumber(money1,num_dot_xs,-1)
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,6).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,6).HorizontalAlignment=1
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,7).Value = note
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,7).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,7).HorizontalAlignment=1
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,8).Value = fytype
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,8).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,8).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,9).Value = startime
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,9).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,9).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,10).Value = rs5("staraddr")
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,10).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,10).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,11).Value = endtime
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,11).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,11).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,12).Value = rs5("endaddr")
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,12).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,12).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,13).Value = rs5("lc")
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,13).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,13).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,14).Value = rs5("bus")
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,14).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,14).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,15).Value = retime
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,15).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,15).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,16).Value = startime1
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,16).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,16).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,17).Value = endtime1
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,17).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,17).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,18).Value = rs5("city")
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,18).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,18).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,19).Value = rs5("hotel")
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,19).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,19).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,20).Value =ggtime
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,20).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,20).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,21).Value = ggcate
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,21).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,21).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,22).Value = rs5("ggintro")
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,22).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,22).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,23).Value = rs5("gglw")
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,23).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,23).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,24).Value = xytime
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,24).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,24).font.bold=true
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,25).Value = rs5("yt")
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,25).font.Size=10
		xytime=rs5("xytime")
		xlWorksheet.Cells(1+i,25).font.bold=true
		xytime=rs5("xytime")
		j=26
		if ZBRuntime.MC(1001) then
			xlWorksheet.Cells(1+i,j).Value = vtel
'if ZBRuntime.MC(1001) then'
...
'if ZBRuntime.MC(1001) then'
		...
		if ZBRuntime.MC(2000) then
			xlWorksheet.Cells(1+i,j).Value = vperson
'if ZBRuntime.MC(2000) then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(2000) then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(2000) then'
		...
		if ZBRuntime.MC(3000) then
			xlWorksheet.Cells(1+i,j).Value = vchance
'if ZBRuntime.MC(3000) then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(3000) then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(3000) then'
		...
		if ZBRuntime.MC(7000) then
			xlWorksheet.Cells(1+i,j).Value = vcontract
'if ZBRuntime.MC(7000) then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(7000) then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(7000) then'
		...
		if ZBRuntime.MC(8000) then
			xlWorksheet.Cells(1+i,j).Value = vcontractth
'if ZBRuntime.MC(8000) then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(8000) then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(8000) then'
		...
		if ZBRuntime.MC(9000) then
			xlWorksheet.Cells(1+i,j).Value = vshouhou
'if ZBRuntime.MC(9000) then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(9000) then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(9000) then'
		...
		if ZBRuntime.MC(31000) then
			xlWorksheet.Cells(1+i,j).Value = vricheng
'if ZBRuntime.MC(31000) then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(31000) then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(31000) then'
		...
		if ZBRuntime.MC(17008) then
			xlWorksheet.Cells(1+i,j).Value = vfahuo
'if ZBRuntime.MC(17008) then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(17008) then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(17008) then'
		...
		if ZBRuntime.MC(15000) then
			xlWorksheet.Cells(1+i,j).Value = vcaigou
'if ZBRuntime.MC(15000) then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(15000) then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(15000) then'
		...
		if ZBRuntime.MC(16000) then
			xlWorksheet.Cells(1+i,j).Value = vcaigouth
'if ZBRuntime.MC(16000) then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(16000) then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(16000) then'
		...
		if ZBRuntime.MC(1002) then
			xlWorksheet.Cells(1+i,j).Value = vwork
'if ZBRuntime.MC(1002) then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(1002) then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(1002) then'
		...
		if ZBRuntime.MC(51000) then
			if ZBRuntime.MC(51001) then
				xlWorksheet.Cells(1+i,j).Value = voffice
'if ZBRuntime.MC(51001) then
				xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(51001) then
				xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(51001) then
			...
			if ZBRuntime.MC(51002) then
				xlWorksheet.Cells(1+i,j).Value = vinsure
'if ZBRuntime.MC(51002) then
				xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(51002) then
				xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
'if ZBRuntime.MC(51002) then
				j=j+1
'if ZBRuntime.MC(51002) then
				xlWorksheet.Cells(1+i,j).Value = vrepair
'if ZBRuntime.MC(51002) then
				xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(51002) then
				xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(51002) then
			...
			if ZBRuntime.MC(51003) then
				xlWorksheet.Cells(1+i,j).Value = vbook
'if ZBRuntime.MC(51003) then
				xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(51003) then
				xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(51003) then
		...
		if ZBRuntime.MC(18500) And scVer&""="0" then
			xlWorksheet.Cells(1+i,j).Value = vscdd
'if ZBRuntime.MC(18500) And scVer&""="0" then'
			xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(18500) And scVer&""="0" then'
			xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(18500) And scVer&""="0" then'
		...
		If 1=0 Then
			if ZBRuntime.MC(18700) then
				xlWorksheet.Cells(1+i,j).Value = vzdww
'if ZBRuntime.MC(18700) then'
				xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(18700) then'
				xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(18700) then'
			...
			if ZBRuntime.MC(18610) then
				xlWorksheet.Cells(1+i,j).Value = vgxww
'if ZBRuntime.MC(18610) then'
				xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(18610) then'
				xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(18610) then'
			...
			if ZBRuntime.MC(18900) then
				xlWorksheet.Cells(1+i,j).Value = vscsb
'if ZBRuntime.MC(18900) then'
				xlWorksheet.Cells(1+i,j).font.Size=10
'if ZBRuntime.MC(18900) then'
				xlWorksheet.Cells(1+i,j).HorizontalAlignment=1
...
'if ZBRuntime.MC(18900) then'
	...
	rs5.close
	set rs5=nothing
	Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>费用导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!费用明细导出成功,共有"&(i-1)&"条记录!</B>"";</script>"
	set rs5=nothing
	Response.write "" & vbcrlf & "</BODY>" & vbcrlf & "</HTML>" & vbcrlf & ""
	Set fs = CreateObject("Scripting.FileSystemObject")
	tfile=Server.MapPath("费用_"&session("name2006chen")&".xls")
