...
'if ret2<>"" then
	...
	j=1
	k=1
	sql="select a.*,b.che_title,b.che_bh,b.che_cateid,b.che_cateid,b.che_addcateid,b.che_addtime,b.che_bh,b.che_time,c.pro_name,d.sort1,e.name,f.prod_name,f.id as fid,f.prod_bh,f.prod_xh,k.sto_name,g.reg_fid,g.prod_ph,g.prod_xlh,g.prod_sctime,g.prod_ystime from O_kuCheList a "&_
	...
	if not rs.eof then
		do until rs.eof
			...
			xlWorksheet.Cells(1+i,1).Value =rs("che_title")
			prod_ystime=rs("prod_ystime")
			xlWorksheet.Cells(1+i,1).font.Size=10
			prod_ystime=rs("prod_ystime")
			xlWorksheet.Cells(1+i,2).Value =rs("che_bh")
			prod_ystime=rs("prod_ystime")
			...
			prod_ystime=rs("prod_ystime")
			xlWorksheet.Cells(1+i,8).Value =zbcdbl(rs("che_zmnum"))
			prod_ystime=rs("prod_ystime")
			xlWorksheet.Cells(1+i,8).font.Size=10
			prod_ystime=rs("prod_ystime")
			xlWorksheet.Cells(1+i,9).Value =zbcdbl(rs("che_sjnum"))
			prod_ystime=rs("prod_ystime")
			xlWorksheet.Cells(1+i,9).font.Size=10
			prod_ystime=rs("prod_ystime")
			xlWorksheet.Cells(1+i,10).Value =zbcdbl(rs("che_yknum"))
			prod_ystime=rs("prod_ystime")
			...
			prod_ystime=rs("prod_ystime")
			xlWorksheet.Cells(1+i,12).Value =rs("prod_ph")
			prod_ystime=rs("prod_ystime")
			xlWorksheet.Cells(1+i,12).font.Size=10
			prod_ystime=rs("prod_ystime")
			xlWorksheet.Cells(1+i,13).Value =rs("prod_xlh")
			prod_ystime=rs("prod_ystime")
