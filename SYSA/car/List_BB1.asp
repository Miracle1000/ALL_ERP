...
'if strW3<>"" Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/Javascript"" src=""Calendar.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/Javascript"" src=""addtr.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/cr_List_BB1.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<style>" & vbcrlf & ".IE5 #kh input.anybutton2{height:18px;line-height:16px;margin-bottom:-0.5px;}" & vbcrlf & "#ht1 table{margin-bottom:-1px}" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	set ml=new myClass
	ret          =request("ret")
	ret2 =request("ret2")
	A    =request("A")
...
'if L2<>"" then
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "  <form name=""data"" id=""data"" action=""List_BB1.asp"" method=""post"">" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">车辆查询</td>" & vbcrlf & "            <td></td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table><span id=""ht1"" style='display:none'></span>" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf &       "<tr class=""top"">" & vbcrlf &         "<td height=""30"" ><div align=""left""><img src=""../images/jiantou.gif""><a href=""javascript:void(0);"" onClick=""setHidden"""& vbcrlf & "            <tr name=""table_tr1"">" & vbcrlf & "                     <td width=""100%"">" & vbcrlf & "                  "
...
'if len(day1)=1 then day1=0&day1
	...
	page_count=15
	Response.write "" & vbcrlf & "                     <table border=""0"" cellpadding=""1"" cellspacing=""1""  width=""100%"" bgcolor=""#C0CCDD"">" & vbcrlf & "                                <tr>" & vbcrlf & "                                    <td height=""27"" colspan=""29"" bgcolor=""#FFFFFF""><div align=""right""><span id=""kh""><input type=""text"" name=""sel_time"" id=""sel_time""Class=""DatePick""  onclick=""datedlg.show();"" value="""
	Response.write sel_time
	Response.write """ readonly=""readonly"">&nbsp;<select name=""B"" id=""B"" style=""color:#000000"">" & vbcrlf & "                                <option value="""">--请选择--</option>" & vbcrlf & "                              <option value=""chp"" "
	'Response.write sel_time
	...
	Response.write ">车辆型号</option>" & vbcrlf & "                   </select>" & vbcrlf & "                       <input type=""text"" name=""C"" id=""C"" size=""12"" value="""
	Response.write C
	Response.write """/>" & vbcrlf & "               <input type=""submit"" class=""anybutton2"" name=""btn_1"" id=""btn_1"" value=""查询"" />" & vbcrlf & "                   "
	...
	Response.write "<a href=""###"" class=""AfterQuickSearch"" onclick=""callServer2();document.getElementById('kh').style.display='none';return false;""><img src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a></span></div></td>" & vbcrlf & "  </tr>" & vbcrlf & "                               <tr>" & vbcrlf & "                                    <td height=""20"" bgcolor=""#FFFFFF""><div align=""center"">车辆\时间</div></td>" & vbcrlf & "                                    <td bgcolor=""#FFFFFF""><div align=""center"">每天时间</div></td>" & vbcrlf & "                                       <td colspan=""8"" bgcolor=""#FFFFFF""><div class=""redDiv""></div>红色代表占用</td>" & vbcrlf & "                                        <td colspan=""8"" bgcolor=""#FFFFFF""><div class=""greenDiv""></div>绿色代表空闲</td>" & vbcrlf & "                                       <td colspan=""10"" bgcolor=""#FFFFFF""><div class=""origenDiv""></div>橙色代表待审批</td>" & vbcrlf & "                                   <td bgcolor=""#FFFFFF"">&nbsp;</td>" & vbcrlf & "                         </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                  <td height=""20"" bgcolor=""#FFFFFF""><div align=""center""><strong>车牌号</strong></div></td>" & vbcrlf & "                                      <td height=""20"" bgcolor=""#FFFFFF""><pre><div align=""center""><strong>00:00-07:59</strong></div></td>" & vbcrlf & "                                    <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>08</strong></div></td>" & vbcrlf & "                                     <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>09</strong></div></td>" & vbcrlf & "                                 <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>10</strong></div></td>" & vbcrlf & "                                   <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>11</strong></div></td>" & vbcrlf & "                                 <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>12</strong></div></td>" & vbcrlf & "                                 <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>13</strong></div></td>" & vbcrlf & "                                 <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>14</strong></div></td>" & vbcrlf & "                                 <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>15</strong></div></td>" & vbcrlf & "                                 <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>16</strong></div></td>" & vbcrlf & "                                 <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>17</strong></div></td>" & vbcrlf & "                                 <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>18</strong></div></td>" & vbcrlf &                                     "<td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>19</strong></div></td>" & vbcrlf &                                  "<td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>20</strong></div></td>" & vbcrlf & "                                       <td bgcolor=""#FFFFFF""><div align=""center""><pre><strong>21:00-23:59</strong></div></td>" & vbcrlf & "                              </tr>" & vbcrlf & "                           "
	red="red1"
	origen="origen"
	green="green"
	sql7="select a.*,b.drivername,b.phone,b.mobile,b.mobile2,b.addr from O_carData a left join O_carDriver b on a.car_driver=b.id "&Str_Result&" and car_state=1 and a.del=1 order by car_code desc"
	...
	if not rs7.eof then
		...
		do while not rs7.eof
			Response.write "" & vbcrlf & "                             <tr>" & vbcrlf & "                                    <td height=""20"" bgcolor=""#FFFFFF"">"
			Response.write rs7("car_code")
			Response.write "</td>" & vbcrlf & "                                        "
			sql8="select a.*,b.use_complete as F_complete from O_carUsemx a left join O_carUse b on a.use_fid=b.use_id where a.del=1 and a.use_complete=1 and b.use_complete in(1,2,3) and a.use_carid="&rs7("car_id")&" and not (a.use_startime>'"&sel_time&" 00:00:00' OR a.use_endtime<'"&sel_time&" 07:59:59' )"
			set rs8=conn.execute(sql8)
			if not rs8.eof then
				if rs8("F_complete")=1 or rs8("F_complete")=2 then
					Color=origen
				elseif rs8("F_complete")=3 then
					Color=red
				end if
			else
				Color=green
			...
			if Color=red then
				Response.write "<td bgcolor=""#FFFFFF"" OnMouseOver=""opentitle(this,'"&rs7("car_id")&"','"&sel_time&" 00:00:00','"&sel_time&" 07:59:59')"" OnMouseOut=""closetitle()"" class="&Color&"></td>"
			else
				Response.write "<td bgcolor=""#FFFFFF"" OnMouseOver=""opentitle(this,'"&rs7("car_id")&"','"&sel_time&" 00:00:00','"&sel_time&" 07:59:59')"" OnMouseOut=""closetitle()"" class="&Color&"></td>"
			end if
			set rs8=nothing
			...
			for i=1 to 26
				...
				Color=""
				sql8="select a.*,b.use_complete as F_complete from O_carUsemx a left join O_carUse b on a.use_fid=b.use_id where a.del=1 and a.use_complete=1 and b.use_complete in(1,2,3) and a.use_carid="&rs7("car_id")&" and not (a.use_startime>'"&sel_time&P_hour_temp&"' OR a.use_endtime<'"&sel_time&F_hour_temp&"' ) "
				set rs8=conn.execute(sql8)
				if not rs8.eof then
					if rs8("F_complete")=1 or rs8("F_complete")=2 then
						Color=origen
				...
				if Color=red then
					Response.write "<td width=""2%"" bgcolor=""#FFFFFF"" OnMouseOver=""opentitle(this,'"&rs7("car_id")&"','"&sel_time&F_hour_temp&"','"&sel_time&P_hour_temp&"')"" OnMouseOut=""closetitle()"" class="&Color&"></td>"
				else
					Response.write "<td width=""2%"" bgcolor=""#FFFFFF"" OnMouseOver=""opentitle(this,'"&rs7("car_id")&"','"&sel_time&F_hour_temp&"','"&sel_time&P_hour_temp&"')"" OnMouseOut=""closetitle()"" class="&Color&"></td>"
				end if
				set rs8=nothing
			next
			sql8="select a.*,b.use_complete as F_complete from O_carUsemx a left join O_carUse b on a.use_fid=b.use_id where a.del=1 and a.use_complete=1 and b.use_complete in(1,2,3) and a.use_carid="&rs7("car_id")&" and not (a.use_startime>'"&sel_time&" 23:59:59' OR a.use_endtime<'"&sel_time&" 21:00:00' )"
			set rs8=conn.execute(sql8)
			if not rs8.eof then
				if rs8("F_complete")=1 or rs8("F_complete")=2 then
					Color=origen
			...
			if Color=red then
				Response.write "<td bgcolor=""#FFFFFF"" OnMouseOver=""opentitle(this,'"&rs7("car_id")&"','"&sel_time&" 21:00:00','"&sel_time&" 23:59:59')"" OnMouseOut=""closetitle()"" class="&Color&"></td>"
			else
				Response.write "<td bgcolor=""#FFFFFF"" OnMouseOver=""opentitle(this,'"&rs7("car_id")&"','"&sel_time&" 21:00:00','"&sel_time&" 23:59:59')"" OnMouseOut=""closetitle()"" class="&Color&"></td>"
			end if
			set rs8=nothing
	...
	Response.write "" & vbcrlf & "                             <tr>" & vbcrlf & "                                    <td height=""25"" colspan=""29"" align=""right"">" & vbcrlf & "                                   "
	Response.write rs7.recordcount
	Response.write "个&nbsp;|&nbsp;"
	Response.write currpage
	Response.write "/"
	Response.write rs7.pagecount
	Response.write "页&nbsp;|&nbsp;15条信息/页" & vbcrlf & "                                   "
	if currpage=1 then
		Response.write "" & vbcrlf & "                                     首页" & vbcrlf & "                                    上一页" & vbcrlf & "                                  "
	else
		Response.write "" & vbcrlf & "                                     <a href=""List_BB1.asp?currpage=1&sel_time="
		Response.write sel_time
		Response.write "&px="
		Response.write px
		Response.write "&A="
		...
		Response.write "&zdy9="
		Response.write (zdy9)
		Response.write """>首页</a>" & vbcrlf & "                                        <a href=""List_BB1.asp?currpage="
	...
	if currpage=rs7.pagecount then
		...
		Response.write "" & vbcrlf & "                                      <a href=""List_BB1.asp?currpage="
		Response.write currpage+1
		Response.write "" & vbcrlf & "                                      <a href=""List_BB1.asp?currpage="
		Response.write "&sel_time="
		Response.write sel_time
		...
		Response.write "&zdy9="
		Response.write (zdy9)
		Response.write """>下一页</a>" & vbcrlf & "                                      <a href=""List_BB1.asp?currpage="
		Response.write rs7.pagecount
		Response.write "&sel_time="
		Response.write sel_time
		Response.write "&px="
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "                     </td>" & vbcrlf & "           </tr>" & vbcrlf & "    </table>" & vbcrlf & "       </form>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "        <td height=""3000""></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="车辆查询"
	call close_list(1)
	Response.write "" & vbcrlf & "<div id=""divsubmit"" class=""submitdiv""><img src=""../images/smico/proc.gif""></div>" & vbcrlf & "<div id=""title"" class=""showdiv""><img src=""../images/smico/proc.gif""></div>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
