...
'function IsTime(values)
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/mr_action_list1.js?ver="
	Response.write Application("sys.info.jsver")
	...
	if px="1" then
		Ptr_Result=" order by a.catetime desc"
	elseif px="2" then
		Ptr_Result=" order by a.catetime asc"
	elseif px="3" then
		Ptr_Result=" order by a.startime desc"
	elseif px="4" then
		Ptr_Result=" order by a.startime asc"
	elseif px="5" then
		Ptr_Result=" order by a.endtime desc"
	elseif px="6" then
		Ptr_Result=" order by a.endtime asc"
	end if
	...
	if ret<>"" Then
		...
		If Abs(datediff("y",ret,date))>40 Then
			...
			End  If
			if B=1 then
				Str_Result=Str_Result+" and  datediff("& v &",'"&ret&"',a.catetime)>=0 "
'if B=1 then
			elseif B=2 then
				Str_Result=Str_Result+" and  datediff("& v &",'"&ret&"',a.startime)>=0 "
			elseif B=2 then
			elseif B=3 then
				Str_Result=Str_Result+" and  datediff("& v &",'"&ret&"',a.endtime)>=0 "
			elseif B=3 then
			end if
		else
			ret="点击选择时间"
		...
		if ret2<>"" Then
			...
			If Abs(datediff("y",ret2,date))>40 Then
				...
				End  If
				if B=1 then
					Str_Result=Str_Result+" and  datediff("& v &",a.catetime,'"&ret2&"')>=0 "
'if B=1 then
				elseif B=2 then
					Str_Result=Str_Result+" and  datediff("& v &",a.startime,'"&ret2&"')>=0 "
				elseif B=2 then
				elseif B=3 then
					Str_Result=Str_Result+" and  datediff("& v &",a.endtime,'"&ret2&"')>=0 "
				elseif B=3 then
				end if
			else
				ret2="点击选择时间"
			...
			elseif open_66_15=1 then
				list=" and a.cateid in ("&intro_66_15&")"
			else
				list=" and a.cateid=0 "
			end if
			Str_Result=Str_Result&list
			Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "<form name=""data"" id=""data"" action=""action_list1.asp?tname="
			Response.write tname
			Response.write """ method=""get"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "         <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"" style=""height:44px;"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">操作日志归档</td>" & vbcrlf & "                       <td><A onclick=""Myopen(User);return false;"" href=""javascript:;"" class=""sortRule"">排序规则<IMG src=""../images/i10.gif"" alt=""排序规则"" width=""9"" height=""5"" border=""0""></A></td>" & vbcrlf & "            <td align=""right""><select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px   solid   #FFFFFF; overflow:hidden"">" & vbcrlf & "                     <option>-请选择-</option>" & vbcrlf & "                       <option value=""page_count=10"" "
			...
			Response.write ">每页显示200条</option>" & vbcrlf & "                </select></td>" & vbcrlf & "          <td width=""2""><img src=""../images/m_mpr.gif"" width=""1"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table><span id=""ht1""></span>" & vbcrlf & "   <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">    " & vbcrlf & "                <tr>" & vbcrlf & "              <td colspan=""5""  background=""../images/112.gif""  height=""30"" align=""right"" style=""border-bottom:0px;border-top:#C0CCDD 0px solid;border-left:#C0CCDD 0px solid;border-right:#C0CCDD 1px solid;"">" & vbcrlf & "             <span id=""kh"">" & vbcrlf & "            <label><input  type=""radio""name=""tname"" value=""1"" onclick=""javascript:window.location='action_list.asp?tname=1'"">日志列表</label>" & vbcrlf & "               <label><input type=""radio"" name=""tname"" value=""2"" checked onclick=""javascript:window.location='action_list1.asp?tname=2'"">归档列表</label>" & vbcrlf & "          自：<input type=""text"" name=""ret"" id=""ret"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" value="""
			Response.write ret
			...
			Response.write ret2
			Response.write """ readonly=""readonly"">" & vbcrlf & "              <select name=""B"" id=""B"" style=""color:#000000"">" & vbcrlf & "                        <option value=""1"" "
			if B="1" then Response.write "selected"
			Response.write ">操作时间</option>" & vbcrlf & "                   <option value=""2"" "
			if B="2" then Response.write "selected"
			Response.write ">开始时间</option>" & vbcrlf & "                   <option value=""3"" "
			if B="3" then Response.write "selected"
			Response.write ">结束时间</option>" & vbcrlf & "           </select>" & vbcrlf & "                       <input type=""submit"" class=""anybutton2"" id=""btnmit"" value=""检索"" onclick=""chkForm()""><input name=""page_count"" type=""hidden"" value="""
			Response.write page_count
			Response.write """><input name=""px"" type=""hidden"" value="""
			Response.write px
			Response.write """></span></td>" & vbcrlf & "            </tr>" & vbcrlf & "            <tr valign=""center"" class=""top"">" & vbcrlf & "              <td width=""20%"" height=""30"" align=""left"" valign=""middle""  class=""name""><div align=""center"">操作人员</div></td>" & vbcrlf & "              <td width=""20%"" align=""left"" valign=""middle""class=""name""><div align=""center"">操作时间</div></td>" & vbcrlf & "                   <td width=""20%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">开始时间</div></td>" & vbcrlf & "            <td width=""20%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">结束时间</div></td>" & vbcrlf & "               <td width=""20%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">查看</div></td>" & vbcrlf & "              </tr>" & vbcrlf & "            "
			currpage=Request("currpage")
			...
			currpage=clng(currpage)
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select a.*,b.name from action_list2 a left join gate b on a.cateid=b.ord "&Str_Result&" "&Ptr_Result
			rs7.open sql7,conn,1,1
			if rs7.RecordCount<=0 then
				Response.write "<tr><td colspan=7 height=30><table align='center'><tr><td>没有信息!</td></tr></table></td></tr>"
				currpage=0
			else
				...
				do while not rs7.eof
					Response.write "" & vbcrlf & "             <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "              <td width=""20%"" height=""30"" align=""left"" valign=""middle""  class=""name""><div align=""center"">"
					Response.write rs7("name")
					Response.write "</div></td>" & vbcrlf & "             <td width=""20%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">"
					Response.write rs7("catetime")
					Response.write "</div></td>" & vbcrlf & "             <td width=""20%"" align=""left"" valign=""middle"" class=""func""><div align=""center"">"
					Response.write rs7("startime")
					Response.write "</div></td>" & vbcrlf & "         <td width=""20%"" align=""left"" valign=""middle"" class=""func""><div align=""center"">"
					Response.write rs7("endtime")
					Response.write "</div></td>" & vbcrlf & "         <td width=""20%"" align=""left"" valign=""middle"" class=""func""><div align=""center""><a href=""javascript:void(0);"" onClick=""window.location='action_list2.asp?id="
					Response.write rs7("bakname")
					Response.write "'"">查看</a></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "            "
					o=o+1
					'Response.write "'"">查看</a></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "            "
			...
			Response.write "" & vbcrlf & "     </table>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "      <td class=""page"">" & vbcrlf & "         <table width=""100%"" border=""0"" align=""left"">" & vbcrlf & "    <tr>" & vbcrlf & "          <td width=""60"" height=""30"">&nbsp;</td>" & vbcrlf & "              <td>&nbsp;</td>"& vbcrlf &"       </form> "& vbcrlf &"       <form name=""oneself"" action=""action_list1.asp?px="""
			Response.write px
			Response.write "&A="
			Response.write A
			Response.write "&B="
			...
			Response.write "             " & vbcrlf & "                </div>" & vbcrlf & "          </td>" & vbcrlf & "           </form>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td colspan=""3"" height=""3000""></td>" & vbcrlf & "         </tr>" & vbcrlf & " </table>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:100%; height:140;display:none;"">" & vbcrlf & "<table width=""150"" height=""140""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""140"">" & vbcrlf & "        <table width=""150"" height=""132"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=1')""><font color=""#2F496E"">按操作时间排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=2')""><font color=""#2F496E"">按操作时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl""color=""#2F496E"">按开始时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=5')""><font color=""#2F496E"">按结束时间排序(降)</font></a> </td>" & vbcrlf & "    </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=6')""><font color=""#2F496E"">按结束时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>"& vbcrlf &"   </tr> "& vbcrlf &" </table> "& vbcrlf &" </div> "& vbcrlf &""
			rs7.close
			set rs7=nothing
			action1="操作日志归档"
			call close_list(1)
