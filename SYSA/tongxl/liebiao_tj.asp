...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr onMouseOut='this.style.backgroundColor=""""' onMouseOver='this.style.backgroundColor=""ecf5ff""'>" & vbcrlf & "<td colspan=""4""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';return false;><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td></tr>" & vbcrlf & "<tr onMouseOut='this.style.backgroundColor=""""' onMouseOver='this.style.backgroundColor=""ecf5ff""'>" & vbcrlf & "<td width=""10%""><div align=""right"">姓&nbsp;&nbsp;&nbsp;&nbsp;名：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "  <input name=""name"" type=""text"" id=""name"" size=""15"" />" & vbcrlf & "</div></td>" & vbcrlf & "<td width=""10%""><div align=""right"">电子邮件：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "  <input name=""email"" type=""text"" id=""email"" size=""15"" />" & vbcrlf & " "
	if open_77_13=1  and open_77_19<>1  then
		Response.write "<img style='height:auto;width:auto;' src=""../images/email.gif"" onClick=""sendEmail(email.value);function sendEmail(email){if (email.indexOf('@')>0){" & vbcrlf & "window.open('../email/index.asp?email='+email+'','newsSendEmail','width=900,height=800,fullscreen=no,scrollbars=0,toolbar=0,status=no,resizable=1,location=no,menubar=no,menubar=no,left=20,top=100');} else{ alert('请输入正确的邮箱！');}}""  style=""cursor:hand"" border=""0"" alt=""发送邮件"" align=""absbottom"">"
	end if
	Response.write "" & vbcrlf & "</div></td></tr>" & vbcrlf & "<tr onMouseOut='this.style.backgroundColor=""""' onMouseOver='this.style.backgroundColor=""ecf5ff""'>" & vbcrlf & "<td width=""10%""><div align=""right"">性&nbsp;&nbsp;&nbsp;&nbsp;别：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf& "  <input type=""radio"" name=""sex"" value=""男"" />" & vbcrlf & "  男" & vbcrlf & "  <input type=""radio"" name=""sex"" value=""女"" />" & vbcrlf & "  女 </div></td>" & vbcrlf & "<td width=""10%""><div align=""right"">QQ：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & " <input name=""qq"" type=""text"" id=""qq"" size=""15"" />" & vbcrlf & "</div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut='this.style.backgroundColor=""""' onMouseOver='this.style.backgroundColor=""ecf5ff""'>" & vbcrlf & "<td width=""10%""><div align=""right"">分&nbsp;&nbsp;&nbsp;&nbsp;类：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "  "
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from txltype where ord="&session("personzbintel2007")&" order by gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "  <input name=""sort"" type=""checkbox"" id=""sort"" value="""
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "</div></td>" & vbcrlf & "<td width=""10%""><div align=""right"">MSN：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "  <input name=""msn"" type=""text"" id=""msn"" size=""15"" />" & vbcrlf & "</div></td></tr>" & vbcrlf & "<tr onMouseOut='this.style.backgroundColor=""""' onMouseOver='this.style.backgroundColor=""ecf5ff""'>" & vbcrlf & "<td width=""10%""><div align=""right"">家庭电话：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "  <input name=""phone1"" type=""text"" id=""phone1"" size=""15"" />" & vbcrlf & "</div></td>" & vbcrlf & "<td width=""10%"">" & vbcrlf & "  <div align=""right"">生&nbsp;&nbsp;&nbsp;&nbsp;日：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">自：<input name=""ret5"" size=""9"" readonly=""readonly""  id=""daysOfMonth5Pos"" onmouseup='toggleDatePicker(""daysOfMonth5"",""date.ret5"")' value="""" />" & vbcrlf & "  <div id=""daysOfMonth5"" style=""POSITION: absolute;z-index:10""></div>" & vbcrlf & "  至：<input name=""ret6"" size=""9""  id=""daysOfMonth6Pos"" readonly=""readonly"" onmouseup='toggleDatePicker(""daysOfMonth6"",""date.ret6"")' value="""" />" & vbcrlf & "<div id=""daysOfMonth6"" style=""POSITION: absolute""></div></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut='this.style.backgroundColor=""""' onMouseOver='this.style.backgroundColor=""ecf5ff""'>" & vbcrlf & "<td width=""10%""><div align=""right"">办公电话：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "  <input name=""phone2"" type=""text"" id=""phone2"" size=""15"" />" & vbcrlf & "</div></td>" & vbcrlf & "<td width=""10%""><div align=""right"">年&nbsp;&nbsp;&nbsp;&nbsp;龄：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf &   "自：<input name=""age"" type=""text"" id=""age1"" onKeyUp=""value=value.replace(/[^\d]/g,'')"" size=""4"" />  至：<input name=""age2"" type=""text"" id=""age"" onKeyUp=""value=value.replace(/[^\d]/g,'')"" size=""4"" />" & vbcrlf & "</div></td></tr>" & vbcrlf & "<tr onMouseOut='this.style.backgroundColor=""""' onMouseOver='this.style.backgroundColor=""ecf5ff""'>" & vbcrlf & "<td width=""10%""><div align=""right"">传&nbsp;&nbsp;&nbsp;&nbsp;真：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "  <input name=""fax"" type=""text"" id=""fax"" size=""15"" />" & vbcrlf & "</div></td>" & vbcrlf & "<td width=""10%""><div align=""right"">家庭住址：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "  <input name=""familyadd"" type=""text"" id=""familyadd"" size=""15"" />" & vbcrlf & "</div></td></tr>" & vbcrlf & "<tr onMouseOut='this.style.backgroundColor=""""' onMouseOver='this.style.backgroundColor=""ecf5ff""'>" & vbcrlf & "<td width=""10%""><div align=""right"">手&nbsp;&nbsp;&nbsp;&nbsp;机：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf &   "<input name=""mobile1"" type=""text"" id=""mobile1"" size=""15"" />" & vbcrlf & "</div></td>" & vbcrlf & "<td width=""10%""><div align=""right"">公司地址：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "</div></td>" & vbcrlf & "<tr onMouseOut='this.style.backgroundColor=""""' onMouseOver='this.style.backgroundColor=""ecf5ff""'>" & vbcrlf & "<td width=""10%""><div align=""right"">传&nbsp;&nbsp;&nbsp;&nbsp;真：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "  <input name=""fax"" type=""text"" id=""fax"" size=""15"" />" & vbcrlf & "</div></td>" & vbcrlf & "<td width=""10%""><div align=""right"">家庭住址：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf & "  <input name=""familyadd"" type=""text"" id=""familyadd"" size=""15"" />" & vbcrlf & "</div></td></tr>" & vbcrlf & "<tr onMouseOut='this.style.backgroundColor=""""' onMouseOver='this.style.backgroundColor=""ecf5ff""'>" & vbcrlf & "<td width=""10%""><div align=""right"">手&nbsp;&nbsp;&nbsp;&nbsp;机：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">" & vbcrlf &   "<input name=""mobile1"" type=""text"" id=""mobile1"" size=""15"" />" & vbcrlf & "</div></td>" & vbcrlf & "<td width=""10%""><div align=""right"">公司地址：</div></td>" & vbcrlf & "<td width=""40%""><div align=""left"">"
	conn.close
	set conn=nothing
