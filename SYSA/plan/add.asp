...
'If Not rs.Eof Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<link href=""../inc/datePicker.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script language=""javascript"" src=""../Inc/DelUnusedFiles.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" src=""../inc/jquery-1.4.2.min.js?ver="
	'Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" src=""../inc/jquery.bgiframe.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" src=""../inc/date.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" src=""../inc/jquery.datePicker.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ charset=""utf-8""></script>" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
	MODULES=session("zbintel2010ms")
	session("personzbintel")=""
	set rs=server.CreateObject("adodb.recordset")
	sql="select isnull(num1,0) num1 from gate where ord="&session("personzbintel2007")&" "
	...
	rs.close
	set rs=nothing
	dateStr = dateadd("h",-num_del,now)
	set rs=nothing
	Response.write "" & vbcrlf & "Date.firstDayOfWeek = 0;" & vbcrlf & "Date.format = 'yyyy-mm-dd';" & vbcrlf & "$(function()" & vbcrlf & "{" & vbcrlf & "      $('#ret').datePicker({clickInput:true,startDate:'"
	set rs=nothing
	Response.write Format_Time(dateStr,2)
	Response.write "'})" & vbcrlf & "   $('#ret2').datePicker({clickInput:true,startDate:'"
	Response.write Format_Time(dateStr,2)
	Response.write "'})" & vbcrlf & "});" & vbcrlf & "</script>" & vbcrlf & "<script src= ""../Script/pn_add.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  type=""text/javascript""></script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%"" border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">"& vbcrlf & ""
	dim h,s
	h=request("h")
	if h="" then
		h=0
	...
	if open_71_6="1"  then
		set rs1=server.CreateObject("adodb.recordset")
		sql1="select ord,name,sorce,sorce2 from gate  where ord in ("&intro_71_6&") and del=1 order by sorce asc,sorce2 asc ,cateid asc ,ord asc"
		rs1.open sql1,conn,1,1
		if rs1.eof then
		else
			do until rs1.eof
	...
	dim date1,time1,time2 ,cateidzbintel
	date1=request("date1")
	if date1="" then date1=date
	time1=request("time1")
	if time1="" then time1="08"
	time2=request("time2")
	if time2="" then time2="00"
	cateidzbintel = session("cateidzbintel")
	if cateidzbintel&""="" then cateidzbintel = 0
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "<tr>" & vbcrlf & "<td class=""place place42"">日程添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "<td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "</tr>" & vbcrlf & "      </table>  " & vbcrlf & "     <form method=""POST"" action=""save.asp?h="""
	Response.write h
	Response.write "&s="
	Response.write s
	Response.write """ id=""demo"" onsubmit=""return Validator.Validate(this,2)&&DelUnusedFilesBeforeSubmit()"" name=""date"">" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "              "
	if cdbl(cateidzbintel)<5 then
		Response.write "" & vbcrlf & "             <tr>" & vbcrlf & "              <td width=""148""><div align=""right"">执行人： </div></td>" & vbcrlf & "             <td colspan=""3""><div align=""left"">"
		sort_zjjg = 4
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
		...
		Response.write "" & vbcrlf & "          <span class=""red"">（如果只是自己的日程，不需要任何选择。）</span></div></td>" & vbcrlf & "     </tr>" & vbcrlf & "               "
	end if
	Response.write "" & vbcrlf & "" & vbcrlf & "<tr>" & vbcrlf & "                    <td width=""148"">" & vbcrlf & "                    <div align=""right"">日程内容：       </div></td>" & vbcrlf & "                 <td colspan=""3""><textarea name=""intro3"" style=""display:none"" cols=""1"" rows=""1"">"
	if intro3<>"" then Response.write intro3
	Response.write "</textarea>" & vbcrlf & "<IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=intro3&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME><span class=""red"">*</span></td>" & vbcrlf & "               </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td width=""148"" align=""right"">" & vbcrlf & "        开始时间：" & vbcrlf & "           </td>" & vbcrlf & "        <td  colspan=""3""><input name=ret2 class=""date-pick"" value="""
	if intro3<>"" then Response.write intro3
	Response.write Format_Time(date,2)
	Response.write """ id=""ret2"" size=10 readonly=""readonly"">" & vbcrlf & "<span class=""gray""><span class=""red"">*</span></span>" & vbcrlf & "          <select name=""time11"">" & vbcrlf & "<option value=""00"">00</option>" & vbcrlf & "            <option value=""01"">01</option>" & vbcrlf & "            <option value=""02"">02</option>" & vbcrlf & "            <option value=""03"">03</option>" & vbcrlf & "            <option value=""04"">04</option>" & vbcrlf & "            <option value=""05"">05</option>" & vbcrlf & "            <option value=""06"">06</option>" & vbcrlf & " <option value=""07"">07</option>" & vbcrlf & "            <option value=""08"" selected>08</option>" & vbcrlf & "            <option value=""09"">09</option>" & vbcrlf & "            <option value=""10"">10</option>" & vbcrlf & "            <option value=""11"">11</option>" & vbcrlf & "  <option value=""12"">12</option>" & vbcrlf & "            <option value=""13"">13</option>" & vbcrlf & "            <option value=""14"">14</option>" & vbcrlf & "            <option value=""15"">15</option>" & vbcrlf & "            <option value=""16"">16</option>" & vbcrlf & "            <option value=""17"">17</option>" & vbcrlf & "            <option value=""18"">18</option>" & vbcrlf & "            <option value=""19"">19</option>" & vbcrlf & "            <option value=""20"">20</option>" & vbcrlf & "            <option value=""21"">21</option>" & vbcrlf & "            <option value=""22"">22</option>" & vbcrlf & "            <option value=""23"">23</option>" & vbcrlf & "          </select>" & vbcrlf & "                       时" & vbcrlf & "                      <select name=""time22"">" & vbcrlf & "                      <option value=""00"">00</option>" & vbcrlf & "                    <option value=""05"">05</option>" & vbcrlf & "                    <optionvalue=""10"">10</option>" & vbcrlf & "                         <option value=""15"">15</option>" & vbcrlf & "                    <option value=""20"">20</option>" & vbcrlf & "                    <option value=""25"">25</option>" & vbcrlf & "                    <option value=""30"">30</option>" & vbcrlf & "                    <option value=""35"">35</option>" & vbcrlf & "                    <option value=""40"">40</option>" & vbcrlf & "                   <option value=""45"">45</option>" & vbcrlf & "                    <option value=""50"">50</option>" & vbcrlf & "                    <option value=""55"">55</option>" & vbcrlf & "                  </select>" & vbcrlf & "                       分 " & vbcrlf & "" & vbcrlf & "<SCRIPT language=JavaScript1.2>" & vbcrlf &"    function Cancel() {hideElement(""daysOfMonth"");}" & vbcrlf & "</SCRIPT></td>" & vbcrlf & "       " & vbcrlf & "      </tr>" & vbcrlf & "          <tr> <td width=""148""><div  align=""right"">截止时间： </div></td>" & vbcrlf & "        <td  colspan=""3""><input name=ret class=""date-pick"" value="""
	Response.write Format_Time(date,2)
	Response.write Format_Time(date,2)
	Response.write """ id=""ret"" size=10 readonly=""readonly"">" & vbcrlf & "          <span class=""gray""><span class=""red"">*</span></span>" & vbcrlf & "          <select name=""time1"">" & vbcrlf & "            <option value=""00"">00</option>" & vbcrlf & "            <option value=""01"">01</option>" & vbcrlf & "            <option value=""02"">02</option>" & vbcrlf & "            <option value=""03"">03</option>" & vbcrlf & "            <option value=""04"">04</option>" & vbcrlf & "            <option value=""05"">05</option>" & vbcrlf & "            <option value=""06"">06</option>" & vbcrlf & "   <option value=""07"">07</option>" & vbcrlf & "            <option value=""08"">08</option>" & vbcrlf & "            <option value=""09"" selected>09</option>" & vbcrlf & "            <option value=""10"">10</option>" & vbcrlf & "            <option value=""11"">11</option>" & vbcrlf & "    <option value=""12"">12</option>" & vbcrlf & "            <option value=""13"">13</option>" & vbcrlf & "            <option value=""14"">14</option>" & vbcrlf & "            <option value=""15"">15</option>" & vbcrlf & "            <option value=""16"">16</option>" & vbcrlf & "            <option value=""17"">17</option>" & vbcrlf & "            <option value=""18"">18</option>" & vbcrlf & "            <option value=""19"">19</option>" & vbcrlf & "            <option value=""20"">20</option>" & vbcrlf & "            <option value=""21"">21</option>" & vbcrlf & "            <option value=""22"">22</option>" & vbcrlf & "            <option value=""23"">23</option>" & vbcrlf & "          </select>" & vbcrlf & "时" & vbcrlf & "<select name=""time2"">" & vbcrlf & "  <option value=""00"">00</option>" & vbcrlf & "  <option value=""05"">05</option>" & vbcrlf & "  <option value=""10"">10</option>" & vbcrlf & "  <option value=""15"">15</option>" & vbcrlf & "  <option value=""20"">20</option>" & vbcrlf & "  <option value=""25"">25</option>" & vbcrlf & "  <option value=""30"">30</option>" & vbcrlf & "  <option value=""35"">35</option>" & vbcrlf & "  <option value=""40"">40</option>" & vbcrlf & "  <option value=""45"">45</option>" & vbcrlf & "  <option value=""50"">50</option>" & vbcrlf & "  <option value=""55"">55</option>" & vbcrlf & "</select>" & vbcrlf & "分 " & vbcrlf & "" & vbcrlf & "<SCRIPT language=JavaScript1.2>" & vbcrlf & "    function Cancel() { hideElement(""daysOfMonth"");}" & vbcrlf & "</SCRIPT>" & vbcrlf & "</td></tr>" & vbcrlf &         "<tr>" & vbcrlf &           "<td width=""148""><div align=""right"">是否提醒： </div></td>" & vbcrlf &           "<td colspan=""3""><input name=""option1"" type=""radio"" value=""0"" checked>" & vbcrlf &             "提醒" & vbcrlf &"<input type=""radio"" name=""option1"" value=""1"">" & vbcrlf &             "不提醒</td>" & vbcrlf &         "</tr>" & vbcrlf &         "<td width=""148""><div align=""right"">重要级别："        & vbcrlf &         "</div></td>" & vbcrlf &         "<td colspan=""3""><input name=""gate"" type=""radio"" value=""4"" checked>" & vbcrlf &           "重要且紧急　" & vbcrlf &             "<input type=""radio"" name=""gate"" value=""3"">" & vbcrlf &             "重要不紧急　" & vbcrlf &             "<input type=""radio"" name=""gate"" value=""2"">" & vbcrlf &             "紧急不重要　" & vbcrlf &             "<input type=""radio"" name=""gate"" value=""1"">" & vbcrlf & "            不紧急不重要</td>" & vbcrlf & "        </tr>" & vbcrlf & " "
	If ZBRuntime.MC(1001) Then
		session("companyzbintel") = ""
		Response.write "" & vbcrlf & "             <tr>" & vbcrlf & "            <td><div align=""right"">关联客户：</div></td>" & vbcrlf & "              <td colspan=""3""><span id=""khmc"">" & vbcrlf & "            <input name=""company"" type=""text""  style=""color: #999999;"" size=""25"" onClick=""javascript:window.open('../search/result4.asp?cc=2&N=1','eventcom','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=100,top=100');return false;"" readonly=""true"" dataType=""Limit"" min=""0"" max="""
		session("companyzbintel") = ""
		Response.write company_name_length
		Response.write """  msg=""长度必须在1至"
		'Response.write company_name_length
		Response.write "个字之间"" value=""点击选择客户""></span></td> " & vbcrlf & "                </tr>" & vbcrlf & "   "
	end if
	If ZBRuntime.MC(2000) Then
		Session("personzbintel") = ""
		Response.write "" & vbcrlf & "             <tr><td  width=""148""><div align=""right"">关联联系人：</div></td>" & vbcrlf & "             <td colspan=""3""><IFRAME name=""I5"" SRC=""../event/personht.asp"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""150"" HEIGHT=""27"" marginwidth=""1"" marginheight=""1""></IFRAME>" & vbcrlf & "           <span class=""red""> </span></td>" & vbcrlf & "               </tr>" & vbcrlf & "   "
	end if
	If ZBRuntime.MC(3000) Then
		session("chancezbintel") = ""
		Response.write "" & vbcrlf & "             <tr><td  width=""148""><div align=""right"">关联项目：</div></td>" & vbcrlf & "               <td colspan=""3""><span id=""xmmc"">" & vbcrlf & "            <input name=""chance"" type=""text"" style=""color: #999999;""  size=""25"" onClick=""javascript:window.open('../search/result3.asp?cc=2','eventcom','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=100,top=100');return false;"" readonly=""true""  value=""点击选择项目"" >" & vbcrlf & "             </span></td>" & vbcrlf & "            </tr>" & vbcrlf & "   "
		session("chancezbintel") = ""
	end if
	Response.write "" & vbcrlf & "             <tr><td  width=""148""><div align=""right"">是否循环：</div></td>" & vbcrlf & "               <td colspan=""3""><input name=""isXunhuan"" type=""radio"" value=""0"" checked>不循环　<input name=""isXunhuan"" type=""radio"" value=""1"" >日循环　　<input name=""isXunhuan"" type=""radio"" value=""2"" >周循环　<input name=""isXunhuan"" type=""radio"" value=""3"" >月循环" & vbcrlf & "         </span></td>" & vbcrlf & "         </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""50"" colspan=""4"">" & vbcrlf & "          " & vbcrlf & "            <div align=""center"">" & vbcrlf & "                 <input type=""submit""name=""Submit42"" value=""增加""  class=""page""/>&nbsp;" & vbcrlf & "                       <input type=""submit"" name=""Submit42"" value=""保存""  class=""page"" autocomplete=""off""/>&nbsp;" & vbcrlf & "                        <input type=""reset"" value=""重填"" class=""page"" name=""B2"">　　　　　　　" & vbcrlf & "            </div></td>" & vbcrlf & "        </tr>         " & vbcrlf & "    </table>" & vbcrlf & "  </form> " & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""1130"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "       </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="日程添加"
	call close_list(1)
	Response.write "" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & "<script src= ""../Script/pn_add_1.js?ver="
	Response.write Application("sys.info.jsver")
