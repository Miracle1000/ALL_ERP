...
'bigsystemtype = ".mozi"
	...
	if open_8_10=3 then
		list=""
	elseif open_8_10=1 then
		list="and cateid in ("&intro_8_10&")"
	else
		list="and cateid=0"
	end if
...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	Response.write "" & vbcrlf & "<HTML>" & vbcrlf & "<HEAD>" & vbcrlf & "<TITLE>付款列表导出</TITLE>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"">" & vbcrlf & "</HEAD>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td class=""place"">付款列表导出</td>" & vbcrlf & "      <td>&nbsp;</td>" & vbcrlf & "      <td align=""right"">&nbsp;</td>" & vbcrlf & "      <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>"& vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr class=""top"">" & vbcrlf & "  <td colspan=2 class=tablebody1>&nbsp;</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr>" & vbcrlf & "  <td colspan=2 class=tablebody1>" & vbcrlf & "<span id=""CountTXTok"" name=""CountTXTok"" style=""font-size:10pt; color:#008040"">" & vbcrlf & "<B>正在导出付款列表,请稍后...</B></span>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""1"" cellpadding=""1"">" & vbcrlf & "<tr>" & vbcrlf & "<td bgcolor=000000>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""1"">" & vbcrlf & "<tr>" & vbcrlf & "<td bgcolor=ffffff height=9><img src=""../images/tiao.jpg"" width=""0"" height=""16"" id=""CountImage"" name=""CountImage"" align=""absmiddle""></td></tr></table>" & vbcrlf & "</td></tr></table> <span id=""CountTXT"" name=""CountTXT"" style=""font-size:9pt; color:#008040"">0</span><span style=""font-size:9pt; color:#008040"">%</span></td></tr>" & vbcrlf & "<tr class=""top"">" & vbcrlf & "  <td colspan=2 class=tablebody1 height=""40"">" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	sorttype=request("type")
	Ismode = Request("Ismode")
	if Ismode="" then
		Ismode=-1
'if Ismode="" then
	end if
	Dim fk_sp_open, ki
	fk_sp_open =  ZBRuntime.MC(224100)
	ki = Abs(fk_sp_open)
	dotstr=""
		for i=1 to num_dot_xs
			...
			xlApplication.ActiveSheet.Columns(3).ColumnWidth=8
			...
			xlApplication.ActiveSheet.Columns(4+fn1).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(4).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(4+fn1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(4).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(5+fn1).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(4).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(5+fn1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(4).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(5+fn1).NumberFormatLocal = "#,##0."&dotstr&"_ "
			xlApplication.ActiveSheet.Columns(4).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(6+fn1).ColumnWidth=10
			xlApplication.ActiveSheet.Columns(4).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(6+fn1).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(4).HorizontalAlignment=3
			fn2=0
			if sorttype<>1 then
				fn2=1
				xlApplication.ActiveSheet.Columns(7+fn1).ColumnWidth=10
				fn2=1
				xlApplication.ActiveSheet.Columns(7+fn1).HorizontalAlignment=3
				fn2=1
			end if
			fn3=0
			if sorttype<>1 then
				fn3=1
				xlApplication.ActiveSheet.Columns(7+fn1+fn2).ColumnWidth=10
				fn3=1
				xlApplication.ActiveSheet.Columns(7+fn1+fn2).HorizontalAlignment=3
				fn3=1
			end if
			fn4=0
			If fk_sp_open then
				fn4=1
				xlApplication.ActiveSheet.Columns(7+fn1+fn2+fn3).ColumnWidth=10
				fn4=1
				xlApplication.ActiveSheet.Columns(7+fn1+fn2+fn3).HorizontalAlignment=3
				fn4=1
			end if
			fn5=0
			if sorttype<>1 then
				fn5=1
				xlApplication.ActiveSheet.Columns(7+fn1+fn2+fn3+fn4).ColumnWidth=10
				fn5=1
				xlApplication.ActiveSheet.Columns(7+fn1+fn2+fn3+fn4).HorizontalAlignment=3
				fn5=1
			end if
			xlApplication.ActiveSheet.Columns(7+fn1+fn2+fn3+fn4+fn5).ColumnWidth=10
			fn5=1
			xlApplication.ActiveSheet.Columns(7+fn1+fn2+fn3+fn4+fn5).HorizontalAlignment=3
			fn5=1
			xlApplication.ActiveSheet.Columns(8+fn1+fn2+fn3+fn4+fn5).ColumnWidth=15
			fn5=1
			xlApplication.ActiveSheet.Columns(8+fn1+fn2+fn3+fn4+fn5).HorizontalAlignment=3
			fn5=1
			xlApplication.ActiveSheet.Columns(9+fn1+fn2+fn3+fn4+fn5).ColumnWidth=10
			fn5=1
			xlApplication.ActiveSheet.Columns(9+fn1+fn2+fn3+fn4+fn5).HorizontalAlignment=3
			fn5=1
			xlWorksheet.Cells(1,1).Value = "供应商名称"
			xlWorksheet.Cells(1,1).font.Size= 10
			xlWorksheet.Cells(1,1).font.bold = true
			xlWorksheet.Cells(1,2).Value = "关联单据"
			xlWorksheet.Cells(1,2).font.Size=10
			xlWorksheet.Cells(1,2).font.bold = true
			xlWorksheet.Cells(1,3).Value = "付款类型"
			xlWorksheet.Cells(1,3).font.Size = 10
			xlWorksheet.Cells(1,3).font.bold = true
			fn1=0
			if sorttype<>1 then
				fn1=1
				xlWorksheet.Cells(1,4).Value = "付款方式"
				xlWorksheet.Cells(1,4).font.Size=10
				xlWorksheet.Cells(1,4).font.bold=True
			end if
			xlWorksheet.Cells(1,4+fn1).Value = "币种"
			xlWorksheet.Cells(1,4).font.bold=True
			xlWorksheet.Cells(1,4+fn1).font.Size=10
			xlWorksheet.Cells(1,4).font.bold=True
			xlWorksheet.Cells(1,4+fn1).font.bold=true
			xlWorksheet.Cells(1,4).font.bold=True
			xlWorksheet.Cells(1,5+fn1).Value = "金额"
			xlWorksheet.Cells(1,4).font.bold=True
			xlWorksheet.Cells(1,5+fn1).font.Size=10
			xlWorksheet.Cells(1,4).font.bold=True
			xlWorksheet.Cells(1,5+fn1).font.bold=true
			xlWorksheet.Cells(1,4).font.bold=True
			xlWorksheet.Cells(1,6+fn1).Value = "应付日期"
			xlWorksheet.Cells(1,4).font.bold=True
			xlWorksheet.Cells(1,6+fn1).font.Size=10
			xlWorksheet.Cells(1,4).font.bold=True
			xlWorksheet.Cells(1,6+fn1).font.bold=true
			xlWorksheet.Cells(1,4).font.bold=True
			fn2=0
			if sorttype<>1 then
				fn2=1
				xlWorksheet.Cells(1,7+fn1).Value = "付款日期"
				fn2=1
				xlWorksheet.Cells(1,7+fn1).font.Size=10
				fn2=1
				xlWorksheet.Cells(1,7+fn1).font.bold=true
				fn2=1
			end if
			fn3=0
			if sorttype<>1 then
				fn3=1
				xlWorksheet.Cells(1,7+fn1+fn2).Value = "付款账户"
				fn3=1
				xlWorksheet.Cells(1,7+fn1+fn2).font.Size=10
				fn3=1
				xlWorksheet.Cells(1,7+fn1+fn2).font.bold=True
				fn3=1
			end if
			fn4=0
			If fk_sp_open then
				fn4=1
				xlWorksheet.Cells(1,7+fn1+fn2+fn3).Value = "审批状态"
				fn4=1
				xlWorksheet.Cells(1,7+fn1+fn2+fn3).font.Size=10
				fn4=1
				xlWorksheet.Cells(1,7+fn1+fn2+fn3).font.bold=true
				fn4=1
			end if
			fn5=0
			if sorttype<>1 then
				fn5=1
				xlWorksheet.Cells(1,7+fn1+fn2+fn3+fn4).Value = "付款状态"
				fn5=1
				xlWorksheet.Cells(1,7+fn1+fn2+fn3+fn4).font.Size=10
				fn5=1
				xlWorksheet.Cells(1,7+fn1+fn2+fn3+fn4).font.bold=true
				fn5=1
			end if
			xlWorksheet.Cells(1,7+fn1+fn2+fn3+fn4+fn5).Value = "备注"
			fn5=1
			xlWorksheet.Cells(1,7+fn1+fn2+fn3+fn4+fn5).font.Size=10
			fn5=1
			xlWorksheet.Cells(1,7+fn1+fn2+fn3+fn4+fn5).font.bold=true
			fn5=1
			xlWorksheet.Cells(1,8+fn1+fn2+fn3+fn4+fn5).Value = "单据人员"
			fn5=1
			xlWorksheet.Cells(1,8+fn1+fn2+fn3+fn4+fn5).font.Size=10
			fn5=1
			xlWorksheet.Cells(1,8+fn1+fn2+fn3+fn4+fn5).font.bold=true
			fn5=1
			Set rs=conn.execute("select Fname from ERP_CustomFields where TName=8 and IsUsing=1 and CanExport = 1 and del=1 order by FOrder asc")
			If Not rs.eof Then
				k = 9
				Do While Not rs.eof
					xlWorksheet.Cells(1,k+fn1+fn2+fn3+fn4+fn5).Value = rs(0)
'Do While Not rs.eof
					xlWorksheet.Cells(1,k+fn1+fn2+fn3+fn4+fn5).font.Size=10
'Do While Not rs.eof
					xlWorksheet.Cells(1,k+fn1+fn2+fn3+fn4+fn5).font.bold=True
'Do While Not rs.eof
					k = k + 1
'Do While Not rs.eof
					rs.movenext
			...
			rs.close
			set rs = nothing
			xlWorksheet.Range("A2:N2").Borders.LineStyle=1
			Response.Flush
			dim w,a ,b,c,d,e,f,sort1,sort2,order,m1,m2,skfs_type
			m1=request("ret")
			m2=request("ret2")
			A=request("A")
			A2=request("A2")
			...
			if A="3333333" or A="5555555" or newstate="1" then
				...
				if A="3333333" and timelg<>"" then
					noalt1=" and date7>'"&timelg&"'"
				end if
				set rs9=server.CreateObject("adodb.recordset")
				if newstate="1" then
					sql9="select ord,intro,num1,tq1,fw1 from setjm2  where ord=12  and cateid="&session("personzbintel2007")&""
				else
					sql9="select ord,intro,num1,tq1,fw1 from setjm  where ord=12  and cateid="&session("personzbintel2007")&""
				end if
				...
				if rs9.eof then
					...
					if rs9("fw1")="0" then
						...
						elseif open_8_1=1 then
							Str_Result_12="and payout.cateid in ("&intro_8_1&")"
						else
							Str_Result_12="and payout.cateid=0"
						end if
					else
						If len(status_sp)>1 And status_sp<>10 Then
							Str_Result_12="and payout.cateid_sp="&session("personzbintel2007")&""
						else
							Str_Result_12="and payout.cateid="&session("personzbintel2007")&""
						end if
					end if
					tq12=rs9("tq1")
				end if
				rs9.close
				set rs9=Nothing
				Str_Result="where del=1 "&Str_Result_12&" and  payout.date1<='"&dateadd("d",tq12,date)&"' and complete='1' "&noalt1&""
			end if
			If remind <> "" Then
				If remind = "212" Then
					Set helper = CreateReminderHelper(conn,remind,0)
					Str_Result=Str_Result &" and payout.ord in (SELECT payout FROM PayInvoiceList WHERE payinvoice IN (" & helper.listSQL("ids") & "))"
				else
					Set helper = CreateReminderHelper(conn,remind,0)
					Str_Result=Str_Result &" and payout.ord in (" & helper.listSQL("ids") & ")"
				end if
			end if
			if m1<>"" then
				if A="1" or A="4" or A="10" Or A="6" Or A="7"  then
					Str_Result=Str_Result+" and  datediff(d,payout.date1,'" & m1 & "') <= 0 "
'if A="1" or A="4" or A="10" Or A="6" Or A="7"  then
				elseif A="2" then
					Str_Result=Str_Result+" and  payout.date2>='"&m1&"'"
'elseif A="2" then
				end if
			end if
			if m2<>"" then
				if A="1" or A="10"  then
					Str_Result=Str_Result+" and datediff(d,payout.date1,'" & m2 & "') >=0 "
'if A="1" or A="10"  then
				elseif A="2" then
					Str_Result=Str_Result+" and  payout.date2<='"&m2&"'"
'elseif A="2" then
				end if
			end if
			if status_sp=10 then
				if(sorttype<>1 and Ismode<>0)then
				str_Result = str_Result + " and  payout.status_sp in (0,4) "
'if(sorttype<>1 and Ismode<>0)then
			else
				if remind<>"" or Ismode=0 then
					str_Result = str_Result + " and  payout.status_sp in (1,2,3,0,4) "
'if remind<>"" or Ismode=0 then
				else
					str_Result = str_Result + " and  payout.status_sp in (1,2,3) "
'if remind<>"" or Ismode=0 then
				end if
			end if
		else
			str_Result = str_Result + " and  payout.status_sp in ("&status_sp&" )"
'if remind<>"" or Ismode=0 then
		end if
		if A="1" then
			Str_Result=Str_Result+"and  payout.complete=1"
'if A="1" then
		elseif A="2" then
			Str_Result=Str_Result+"and  payout.complete=3"
'elseif A="2" then
		end if
		billtype = request("billtype")
		fromid = request("fromid")&""
		If isnumeric(fromid) = False Then
			fromid = deurl(fromid)
		end if
		If fromid&"" = "" Then fromid = 0
		If fromid&""<>"0" Then
			Select Case billtype&""
			Case "54003" : Str_Result=Str_Result &" and payout.cls=5 "
			Case "54006" : Str_Result=Str_Result &" and payout.cls=4 "
			End Select
			Str_Result=Str_Result &" and payout.contract="& fromid
		end if
		conn.execute("select * into #PayCaigou from (select ord, title,cgid, company,bz, money1,date3, 0 as cls,cateid  from caigou where del<>7 union all select ID, title,sn, gys, 14 bz,(select sum(money1) from M_OutOrderlists where outID=M_outorder.id) money1,odate, 2,isnull(creator,0) from M_OutOrder union all select ID, title,sn, gys, bz,money1 ,odate, (CASE isnull(wwType,0) WHEN 0 then 5 ELSE 4 END),isnull(ourperson,creator) from M2_OutOrder) x")
		If companyid&""<>"" Then str_Result=str_Result&" and exists(select 1 from #PayCaigou where company="& companyid &" and #PayCaigou.cls=payout.cls and #PayCaigou.ord=payout.contract)"
		cgid=request("cgid")
		if cgid&""<>"" then str_Result=str_Result&" and payout.contract =" & cgid &" and isnull(cls,0)=0 "
		...
		if W1&""<>"" or W2&""<>"" or W3&""<>"" then
			...
			W4=replace(W4,",","")
			if W4<>"" Then
				str_Result = str_Result + " and payout.cateid in("& W3 &") and payout.cateid<>0 "
'if W4<>"" Then
			end if
		end if
		if C<>"" then
			if B="khmc" then
				str_Result=str_Result+"and exists(select 1 from #PayCaigou where company in (select ord from tel where name like '%"& C &"%') and #PayCaigou.cls=payout.cls and #PayCaigou.ord=payout.contract)"
'if B="khmc" then
			elseif B="htzt" then
				str_Result=str_Result+"and exists(select 1 from #PayCaigou where  title like '%"& C &"%' and #PayCaigou.cls=payout.cls and #PayCaigou.ord=payout.contract)"
'elseif B="htzt" then
			elseif B="htid" then
				str_Result=str_Result+"and exists(select 1 from #PayCaigou where  cgid like '%"& C &"%' and #PayCaigou.cls=payout.cls and #PayCaigou.ord=payout.contract)"
'elseif B="htid" then
			ElseIf B="fkzh" Then
				str_Result = str_Result + "and exists(select 1 from sortbank where sort1 like '%"& C &"%' and sortbank.id=payout.bank)"
'ElseIf B="fkzh" Then
			end if
		end if
		...
		if px="" Then px=1
		if px=1 then
			px_Result="order by payout.date1 desc,payout.date7 desc"
		elseif px=2 then
			px_Result="order by payout.date1 asc,payout.date7 asc"
		elseif px=3 then
			px_Result="order by payout.date2 desc,payout.date7 desc"
		elseif px=4 then
			px_Result="order by payout.date2 asc,payout.date7 asc"
		elseif px=5 then
			px_Result="order by  payout.money1 desc,payout.date7 desc"
		elseif px=6 then
			px_Result="order by payout.money1 asc,payout.date7 asc"
		elseif px=9 then
			px_Result="order by complete desc,payout.date7 desc"
		elseif px=10 then
			px_Result="order by complete asc,payout.date7 asc"
		elseif px=11 then
			px_Result="order by bank desc,payout.date7 desc"
			px_Result2="order by bank asc,payout.date7 asc"
		elseif px=12 then
			px_Result="order by bank asc,payout.date7 asc"
			px_Result2="order by bank desc,payout.date7 desc"
		elseif px=13 then
			px_Result="order by t.name desc,payout.date7 desc"
			px_Result2="order by t.name asc,payout.date7 asc"
		elseif px=14 then
			px_Result="order by t.name asc,payout.date7 asc"
			px_Result2="order by t.name desc,payout.date7 desc"
		end if
		khmc = request("khmc")
		khbh = request("khbh")
		...
		htbh = request("htbh")
		if khmc<>"" then
			str_Result = str_Result + " and exists(select ord from #PayCaigou where company in (select ord from tel where name like '%"& khmc &"%') and #PayCaigou.cls=payout.cls and #PayCaigou.ord=payout.contract)"
'if khmc<>"" then
		end if
		if khbh<>"" then
			str_Result = str_Result + "and exists(select ord from #PayCaigou where company in (select ord from tel where khid like '%"& khbh &"%') and #PayCaigou.cls=payout.cls and #PayCaigou.ord=payout.contract)"
'if khbh<>"" then
		end if
		if contractname<>"" then
			str_Result = str_Result + "and exists(select ord from #PayCaigou where title like '%"& contractname &"%' and #PayCaigou.cls=payout.cls and #PayCaigou.ord=payout.contract) "
'if contractname<>"" then
		end if
		if htbh<>"" then
			str_Result = str_Result + "and exists(select ord from #PayCaigou where cgid like '%"& htbh &"%' and #PayCaigou.cls=payout.cls and #PayCaigou.ord=payout.contract) "
'if htbh<>"" then
		end if
		str_Result = str_Result & replace(searchExtended_Simple(8, "ord"),"ord in","payout.ord in")
		hkzt = request("hkzt")
		if hkzt<>"" Then str_Result = str_Result + " and  payout.complete in ("& hkzt &") "
		hkzt = request("hkzt")
		if skfs_type<>"" and skfs_type<>"0" Then
			if link="yes" Then
				If CStr(skfs_type)="999" Then
					str_Result = str_Result + " and payout.title='余额付款'"
'If CStr(skfs_type)="999" Then
				else
					str_Result = str_Result + "and  payout.pay in ("& replace(skfs_type," ","") &")"
'If CStr(skfs_type)="999" Then
				end if
			else
				str_Result = str_Result + "and ( payout.pay in ("& replace(skfs_type," ","") &")"
'If CStr(skfs_type)="999" Then
				If instr(","&replace(skfs_type," ","")&",",",999,")>0 Then str_Result = str_Result + " or payout.title='余额付款' "
'If CStr(skfs_type)="999" Then
...
'If CStr(skfs_type)="999" Then
		...
		fkzh = request("fkzh")
		if fkzh<>"" Then str_Result = str_Result + " and  payout.bank in ("& fkzh &") "
		fkzh = request("fkzh")
		if  Request("duemoney1")<>"" and Request("duemoney2")<>"" then
			str_Result=str_Result+" and payout.money1 between "&Request("duemoney1")&" and "&Request("duemoney2")
'if  Request("duemoney1")<>"" and Request("duemoney2")<>"" then
		end if
		if  Request("duepaydate1")<>"" Then
			str_Result=str_Result+" and datediff(d,payout.date1,'" & Request("duepaydate1") &"') <= 0 "
'if  Request("duepaydate1")<>"" Then
		end if
		If Request("duepaydate2")<>"" then
			str_Result=str_Result+" and datediff(d,payout.date1,'" & Request("duepaydate2") &"') > 0 "
'If Request("duepaydate2")<>"" then
		end if
...
'if cint(request("paytype"))>0 then
		...
		if Request("paydate1")<>"" then
			str_Result = str_Result + " and payout.date2>='"&Request("paydate1")&" 00:00:00'"
'if Request("paydate1")<>"" then
		end if
		if Request("paydate2")<>"" then
			str_Result = str_Result + " and payout.date2<'"&dateadd("d",1,Request("paydate2"))&"'"
'if Request("paydate2")<>"" then
		end if
		if Request("invdate1")<>"" then
			str_Result = str_Result + " and payout.date3>='"&Request("invdate1")&" 00:00:00'"
'if Request("invdate1")<>"" then
		end if
		if Request("invdate2")<>"" then
			str_Result = str_Result + " and payout.date3<'"&dateadd("d",1,Request("invdate2"))&"'"
'if Request("invdate2")<>"" then
		end if
		if request("invtype")<>"" then
			if cint(request("invtype"))>0 then
				str_Result=str_Result+" and isnull(tik,0) ="&cint(request("invtype"))
'if cint(request("invtype"))>0 then
			end if
		end if
		if request("tikname")<>"" then
			str_Result=str_Result+" and payout.tikname like '%"& request("tikname") &"%'"
'if request("tikname")<>"" then
		end if
		if request("intro")<>"" then
			str_Result=str_Result+" and payout.intro like '%"& request("intro") &"%'"
'if request("intro")<>"" then
		end if
		bz = request("bz")
		if bz<>"" then
			str_Result = str_Result + " and exists(select ord from #PayCaigou where bz in("&bz&") and #PayCaigou.cls=payout.cls and #PayCaigou.ord=payout.contract)"
'if bz<>"" then
		end if
		If bz&"" = "" Then bz = 14
		if request("intro")<>"" Then str_Result = str_Result + " and payout.intro like '%"& request("intro") &"%'"
'If bz&"" = "" Then bz = 14
		telid=request("telid")
		cgret=request("cgret")
		cgret2=request("cgret2")
		if telid<>"" then
			str_Result=str_Result&" and exists(select ord from #PayCaigou where company="&telid&" and bz="&bz&" and isnull(#PayCaigou.cls,0)=0 "
			If cgret&""<>"" Then Str_Result=Str_Result&" and datediff(d,'"& cgret &"',date3)>=0 "
			If cgret2&""<>"" Then  Str_Result=Str_Result&" and datediff(d,'"& cgret2 &"',date3)<=0 "
			str_Result=str_Result&" and #PayCaigou.cls=payout.cls and #PayCaigou.ord=payout.contract )"
		end if
		set rs1=server.CreateObject("adodb.recordset")
		set rs=server.CreateObject("adodb.recordset")
		Str_Result=replace(Str_Result,"payout.cateid","cateid")
		Str_Result=Replace(replace(Str_Result,"del=1","payout.del=1"),"cateid","payout.cateid")
		sql="select payout.ord,payout.contract,payout.cateid,payout.cateid_sp,payout.title,payout.money1,cls,cast(payout.intro as varchar(200)) as intro,CONVERT(VARCHAR(10),payout.date1,120)" &_
		"date1,payout.date2,payout.date3,payout.date7,bank,payout.status_sp,payout.complete,payout.complete2,payout.addcate,pay,tik,tikname,payout.del,isnull(glsp,0) as glsp1 "&_
		"from payout "&_
		"left join caigou a1 WITH(NOLOCK)  on isnull(payout.cls,0) in (0,1) and a1.ord = payout.contract "&_
		"left join M_OutOrder a2 WITH(NOLOCK)  on isnull(payout.cls,0) in (2) and a2.id = payout.contract "&_
		"left join M2_OutOrder a3 WITH(NOLOCK)  on isnull(payout.cls,0) in (4,5) and a3.id = payout.contract "&_
		"left join tel t on t.ord=isnull(a1.company,isnull(a2.gys,a3.gys)) " & Str_Result&" "&px_Result&""
		rs.open sql,conn,1,1
		C1=rs.recordcount
		xlApplication.Init "付款列表_"&session("name2006chen")&".xls",C1
		dim i
		i=1
		if rs.RecordCount<=0  then
			...
			do until rs.eof
				...
				djcateid = 0
				bzname=""
				cls = rs("cls") : contract = rs("contract")
				if contract&""<>"" then
					sql1="select ord,name,del,isnull(cateid,0) as cateid from tel where ord in (select company from caigou where ord="& contract &")"
					urlhref="../../SYSN/view/store/caigou/caigoudetails.ashx?view=details&ord="&pwurl(contract)&""
					sql2="select a.title,a.cateid ,a.del,isnull(b.sort1,'人民币') bzname from caigou a left join sortbz b on a.bz=b.id where ord="& contract &" "
					Select Case cls&""
					Case "2" :
					sql1="select ord,name,del,isnull(cateid,0) as cateid from tel where ord in (select gys from M_OutOrder where id="& contract &")"
					sql2="select a.title,isnull(a.creator, 0) cateid ,a.del,isnull(b.sort1,'人民币') bzname from M_OutOrder a left join sortbz b on 14=b.id where a.id="& contract &"  "
					Case "4" :
					sql1="select ord,name,del,isnull(cateid,0) as cateid from tel where ord in (select gys from M2_OutOrder where id="& contract &")"
					sql2="select a.title,isnull(a.ourperson, a.creator) cateid ,a.del,isnull(b.sort1,'人民币') bzname from M2_OutOrder a left join sortbz b on a.bz=b.id where a.id="& contract &"  "
					Case "5" :
					sql1="select ord,name,del,isnull(cateid,0) as cateid from tel where ord in (select gys from M2_OutOrder where id="& contract &")"
					sql2="select a.title,isnull(a.ourperson, a.creator) cateid ,a.del,isnull(b.sort1,'人民币') bzname from M2_OutOrder a left join sortbz b on a.bz=b.id where a.id="& contract &"  "
					End Select
...
'if rs1.eof=true then
						...
						djdel = rs1("del")
						djcateid =rs1("cateid")
						caigouname=rs1("title")
						bzname=rs1("bzname")
					end if
					rs1.close
				end if
				If gyscateid&"" = "" Then gyscateid = 0
				If djcateid&"" = "" Then djcateid = 0
				If cls&""="2" Or cls&""="4" Or cls&""="5" Then
					fkType = "委外付款"
				ElseIf caigouname = "期初应付" Then
					fkType = "期初付款"
				else
					fkType = "采购付款"
				end if
				...
				if rs("pay")<>"" then
					set rs7=server.CreateObject("adodb.recordset")
					sql7="select sort1 from sortonehy where ord="&rs("pay")&""
					rs7.open sql7,conn,1,1
					if rs7.eof then
						pay=""
					else
				...
				if pay="" and rs("title")="余额付款" Then pay="余额付款"
				spstatus=""
				If rs("status_sp")=0 Then
					spstatus="审批通过"
				ElseIf  rs("status_sp")=1 Then
					spstatus="未提交审批"
				ElseIf rs("status_sp")=2 Then
					spstatus="待审批"
				ElseIf rs("status_sp")=3 Then
					spstatus="审批中"
				ElseIf rs("status_sp")=4 Then
					spstatus="审批未通过"
				else
					spstatus=""
				end if
				...
				if djcateid&""<>"" then
					set rs7=server.CreateObject("adodb.recordset")
					sql7="select name from gate where ord="& djcateid &""
					rs7.open sql7,conn,1,1
					if rs7.eof then
						cateidname=""
					else
				...
				If gysdel = -100 Then
					bankname=""
					companyname = "供应商已彻底删除"
				ElseIf gysdel<>1 Then
					companyname= "供应商已删除"
				else
					If sdk.power.existsPowerIntro(26,1,gyscateid)=False Then companyname = ""
				end if
				mkTitle = "采购" : titleTip = "" : qxSort1 = 22
				Select Case cls&""
				Case "2" :
				mkTitle = "委外单" : titleTip = mkTitle&"：" : qxSort1 = 5025
				Case "4" :
				mkTitle = "工序委外" : titleTip = mkTitle&"：" : qxSort1 = 5026
				Case "5" :
				mkTitle = "整单委外" : titleTip = mkTitle&"：" : qxSort1 = 5025
				End Select
				If djdel = -100 Then
'End Select
					caigouname= mkTitle & "已彻底删除"
				ElseIf djdel=2 Then
					caigouname= mkTitle & "已删除"
				else
					If sdk.power.existsPowerIntro(qxSort1,1,djcateid) Then
						caigouname = titleTip & caigouname
					else
						caigouname = ""
					end if
				end if
				xlWorksheet.Cells(1+i,1).NumberFormatLocal = "@"
				caigouname = ""
				xlWorksheet.Cells(1+i,1).Value = companyname
				caigouname = ""
				xlWorksheet.Cells(1+i,1).font.Size=10
				caigouname = ""
				xlWorksheet.Cells(1+i,1).HorizontalAlignment=1
				caigouname = ""
				xlWorksheet.Cells(1+i,2).Value = caigouname
				caigouname = ""
				xlWorksheet.Cells(1+i,2).font.Size=10
				caigouname = ""
				xlWorksheet.Cells(1+i,2).HorizontalAlignment=1
				caigouname = ""
				xlWorksheet.Cells(1+i,3).Value = fkType
				caigouname = ""
				...
				if sorttype<>1 then
					fn1=1
					xlWorksheet.Cells(1+i,4).Value = pay
					fn1=1
					xlWorksheet.Cells(1+i,4).font.Size=10
					fn1=1
				end if
				xlWorksheet.Cells(1+i,4+fn1).NumberFormatLocal = "@"
				fn1=1
				xlWorksheet.Cells(1+i,4+fn1).Value = bzname
				fn1=1
				xlWorksheet.Cells(1+i,4+fn1).font.Size=10
				fn1=1
				xlWorksheet.Cells(1+i,4+fn1).HorizontalAlignment=3
				fn1=1
				xlWorksheet.Cells(1+i,5+fn1).Value = Formatnumber(zbcdbl(rs("money1")),num_dot_xs,-1)
				fn1=1
				xlWorksheet.Cells(1+i,5+fn1).font.Size=10
				fn1=1
				xlWorksheet.Cells(1+i,6+fn1).Value =date1
				fn1=1
				xlWorksheet.Cells(1+i,6+fn1).font.Size=10
				fn1=1
				fn2=0
				if sorttype<>1 then
					fn2=1
					xlWorksheet.Cells(1+i,7+fn1).Value = date2
					fn2=1
					xlWorksheet.Cells(1+i,7+fn1).font.Size=10
					fn2=1
				end if
				fn3=0
				if sorttype<>1 then
					fn3=1
					xlWorksheet.Cells(1+i,7+fn1+fn2).Value = bankname
					fn3=1
					xlWorksheet.Cells(1+i,7+fn1+fn2).font.Size=10
					fn3=1
				end if
				fn4=0
				If fk_sp_open then
					fn4=1
					xlWorksheet.Cells(1+i,7+fn1+fn2+fn3).Value = spstatus
					fn4=1
					xlWorksheet.Cells(1+i,7+fn1+fn2+fn3).font.Size=10
					fn4=1
				end if
				fn5=0
				if sorttype<>1 then
					fn5=1
					xlWorksheet.Cells(1+i,7+fn1+fn2+fn3+fn4).Value = complete
					fn5=1
					xlWorksheet.Cells(1+i,7+fn1+fn2+fn3+fn4).font.Size=10
					fn5=1
					xlWorksheet.Cells(1+i,7+fn1+fn2+fn3+fn4).HorizontalAlignment=1
					fn5=1
				end if
				xlWorksheet.Cells(1+i,7+fn1+fn2+fn3+fn4+fn5).Value = intro
				fn5=1
				xlWorksheet.Cells(1+i,7+fn1+fn2+fn3+fn4+fn5).font.Size=10
				fn5=1
				xlWorksheet.Cells(1+i,7+fn1+fn2+fn3+fn4+fn5).HorizontalAlignment=3
				fn5=1
				xlWorksheet.Cells(1+i,8+fn1+fn2+fn3+fn4+fn5).Value = cateidname
				fn5=1
				xlWorksheet.Cells(1+i,8+fn1+fn2+fn3+fn4+fn5).font.Size=10
				fn5=1
				Set rs9=conn.execute("select a.FValue from ERP_CustomValues a inner join ERP_CustomFields b on a.FieldsID = b.ID where b.TName=8 and b.IsUsing=1 and b.CanExport = 1 and b.del=1 and a.OrderID="&rs("ord")&" order by a.OrderID,b.FOrder asc")
				If Not rs9.eof Then
					k = 9
					Do While Not rs9.eof
						xlWorksheet.Cells(1+i,k+fn1+fn2+fn3+fn4+fn5).Value = rs9(0)
'Do While Not rs9.eof
						xlWorksheet.Cells(1+i,k+fn1+fn2+fn3+fn4+fn5).font.Size=10
'Do While Not rs9.eof
						k = k + 1
'Do While Not rs9.eof
						rs9.movenext
		...
		rs.close
		set rs=Nothing
		Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>付款列表导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!付款列表导出成功,共有"&(i-1)&"条记录!</B>"";</script>"
		set rs=Nothing
		Response.write "" & vbcrlf & "</BODY>" & vbcrlf & "</HTML>" & vbcrlf & ""
		Set fs = CreateObject("Scripting.FileSystemObject")
		tfile=Server.MapPath("付款列表_"&session("name2006chen")&".xls")
		...
		Response.write """><font class=""red""><strong><u>下载导出的付款列表</u></strong></font></a></p>" & vbcrlf & ""
