...
'Private Sub Class_Initialize
	...
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "<script src= ""../Script/cr_List_insureT_2.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  type=""text/javascript""></script>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	dflg=request("dflg")
	ord1=request("ord1")
	if dflg=2 and ord1<>"" then
		sqltext="update O_insure set iss_warn=2 where iss_id="&ord1
	...
	Str_Result=Str_Result&" and a.del=1 and (iss_warn=1 or iss_endtime='"&date&"') "&list&""
	set ml=new myClass
	ret          =request("ret")
	ret2 =request("ret2")
	A    =request("A")
...
'if Exit Sub2<>"" and Exit Sub2<>"点击选择时间" then
	...
	if newstate="1" then
		set rs9=server.CreateObject("adodb.recordset")
		sql9="select id,ord,intro,num1,tq1,fw1,gate1 from setjm2  where ord=74 and cateid=" & session("personzbintel2007")
		...
		rs9.close
		set rs9=nothing
		Str_Result=Str_Result&" and iss_cateid="&session("personzbintel2007")&" and iss_carid in (select car_id from O_carData) and iss_endtime<='"&dateadd("d",tq9,date)&"' "
	end if
	If request("remind") = "" Then
		remind = 155
	else
	...
	If remind <> "" Then
		...
		Str_Result=Str_Result& " and iss_id in (" & helper.listSQL("ids") & ")"
	end if
	...
	Response.write "" & vbcrlf & "<form name=""data"" id=""data"" action=""List_insureT.asp"" method=""get"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "           <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">提醒列表</td>" & vbcrlf & "                        <td><A onclick=""Myopen(User);return false;"" href=""javascript:;"" class=""sortRule"">排序规则<IMG src=""../images/i10.gif"" alt=""排序规则"" width=""9"" height=""5"" border=""0""></A></td>" & vbcrlf & "           <td width=""2""><img src=""../images/m_mpr.gif"" width=""1"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table><span id=""ht1""></span>" & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">      " & vbcrlf & "                <tr>" & vbcrlf & "              <td colspan=""11"" class=""top_btns""  background=""../images/112.gif""  height=""30"" align=""right"" style=""border-bottom:0px;border-top:#C0CCDD 0px solid;border-left:#C0CCDD 0px solid;border-right:#C0CCDD 1px solid;"">" & vbcrlf & "               <span id=""kh"">" & vbcrlf & "             自：<input type=""text"" value="""
	currpage=clng(currpage)
	Response.write ret
	Response.write """ name=""ret"" id=""ret"" Class=""DatePick"" onclick=""datedlg.show();"" readonly=""readonly"">&nbsp;至：<input type=""text"" value="""
	Response.write ret2
	Response.write """ name=""ret2"" id=""ret2"" Class=""DatePick"" onclick=""datedlg.show();"" readonly=""readonly"">" & vbcrlf & "              <select name=""B"" id=""B"" style=""color:#000000"">" & vbcrlf & "                               <option value=""cph"" "
	...
	Response.write px
	Response.write """>" & vbcrlf & "                        <input type=""submit"" class=""anybutton2"" id=""btnmit"" name=""btnmit"" value=""检索"">" & vbcrlf & "                   <a href=""javascript:void(0)"" class=""AfterQuickSearch"" onclick=""callServer2();document.getElementById('kh').style.display='none';document.getElementById('ht1').style.display='';return false;""><img src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a></span>                 </td>" & vbcrlf & "           </tr>" & vbcrlf & "            <tr valign=""center"" class=""top"">" & vbcrlf & "              <td width=""7%"" height=""30"" align=""left"" valign=""middle""  class=""name""><div align=""center"">选择</div></td>" & vbcrlf &                  "<td width=""8%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">车牌号</div></td>" & vbcrlf &                    "<td width=""7%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">险种</div></td>" & vbcrlf & "                 <td width=""7%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">经办人员</div></td>" & vbcrlf & "                 <td width=""11%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">保险公司</div></td>" & vbcrlf & "                <td width=""8%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">联系电话</div></td>" & vbcrlf & "              <td width=""6%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">保费</div></td>" & vbcrlf & "             <td width=""9%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">投保时间</div></td>" & vbcrlf & "            <td width=""9%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">结束时间</div></td>" & vbcrlf & "                 <td width=""16%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">距离到期</div></td>" & vbcrlf & "                <td width=""13%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">" & vbcrlf & "                     <select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px   solid   #FFFFFF; overflow:hidden"">" & vbcrlf & "                      <option>-请选择-</option>" & vbcrlf & "                       <option value=""page_count=10"" "
	Response.write px
	...
	if rs7.RecordCount<=0 then
		...
		do while not rs7.eof
			...
			stime=datediff("d",now,rs7("iss_endtime"))
			...
			If isnumeric(zbcdbl(rs7("iss_money"))) Then
				Response.write(FormatNumber(zbcdbl(rs7("iss_money")),num_dot_xs,-1))
'If isnumeric(zbcdbl(rs7("iss_money"))) Then
			else
...
'If isnumeric(zbcdbl(rs7("iss_money"))) Then
			...
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle"" class=""func""><div align=""center"">"
			if stime>0 then
				Response.write "还差"&stime
			elseif stime=0 then
				Response.write "今"
			elseif stime<0 then
				Response.write "过期"&abs(stime)
			end if
			Response.write "天</div></td>" & vbcrlf & "                   <td width=""13%"" height=""30"" align=""left"" valign=""middle""><div align=""center"">" & vbcrlf & "             "
			if rs7("iss_warn")=1 then
				Response.write "" & vbcrlf & "                      <input name=""button44"" type=""button""  class=""anybutton"" id=""submit44"" onClick=""javascript:window.location=('List_insureT.asp?ord1="
				Response.write rs7("iss_id")
				Response.write "&px="
				Response.write px
				Response.write "&A="
				...
				Response.write "&dflg=2')"" value=""取消提醒""/>" & vbcrlf & "                         "
			end if
	...
	Response.write "" & vbcrlf & "      </table>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "      <td class=""page"">" & vbcrlf & "         <table width=""100%"" border=""0"" align=""left"">" & vbcrlf & "    <tr>" & vbcrlf & "          <td width=""60"" height=""30"">&nbsp;</td>" & vbcrlf & "              <td>&nbsp;</td>"& vbcrlf &        "</form>" & vbcrlf &        "<form name=""oneself"" action=""List_insureT.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
	...
	conn.close
	set conn=nothing
	Response.write "" & vbcrlf & "<script language=javascript>" & vbcrlf & "function Myopen(divID){ //根据传递的参数确定显示的层" & vbcrlf & "     if(divID.style.display==""""){" & vbcrlf & "              divID.style.display=""none""" & vbcrlf & "        }else{" & vbcrlf & "          divID.style.display=""""" & vbcrlf & "    }" & vbcrlf & "       divID.style.left=300;" & vbcrlf & " divID.style.top=10;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function testall()" & vbcrlf & "{" & vbcrlf & "  if(!confirm('确认删除吗？'))" & vbcrlf & " {" & vbcrlf & "  window.location=""List_insureT.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
