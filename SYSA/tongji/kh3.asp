...
'bigsystemtype = ".mozi"
	...
	E=request("sort")
	F=request("sort1")
	Str_Result2=Str_Result2+"and sort3="&sort3&""&" and order1<>4 "
	F=request("sort1")
	gate_result=""
	if m1<>"" then
...
'if m2<>"" then
		Str_Result2=Str_Result2+"and date2<='"&m2&" 23:59:59' "
'if m2<>"" then
		m2name="  截止："&m2
	end if
	if E<>"" then
...
'if F<>"" then
	...
	Response.write "" & vbcrlf & "<div id=""user"" name=""user"" style=""position:absolute;left:0; top:0;width:100%; height:10;"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "   <tr>" & vbcrlf & "            <td class=""place"">"
	if sort3=1 then
		Response.write "客户"
	elseif sort3=2 then
		Response.write "供应商"
	...
	Response.write "</strong></td>" & vbcrlf & "                <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "      </tr>" & vbcrlf & "</table>" & vbcrlf & "<form method=""POST"" action=""kh3.asp?width_tj="
	Response.write width_tj
	Response.write "&sort3="
	Response.write sort3
	Response.write """ id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr class=""top"">" & vbcrlf & "<td class=""top_btns"">选择统计条件：" & vbcrlf & ""
	if sort3=1 then
		Dim arrShow()
		Dim arrName()
	...
	Response.write "" & vbcrlf & "<input type=""submit"" name=""Submit422"" value=""统计""  class=""anybutton2""/>" & vbcrlf & "  </tr></table>" & vbcrlf & "</form>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30""  align=""right"" class=""top_btns"">" & vbcrlf & "       <input type=""button"" name=""pillar"" value=""柱状图分析"" onClick=""window.location.href='kh3.asp?type_tj=1&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&sort3="
	...
	Response.write "&khhy="
	Response.write khhy
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "         <input type=""button"" name=""zxt"" value=""折线图分析"" onClick=""window.location.href='kh3.asp?type_tj=2&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&sort3="
	...
	Response.write "&khhy="
	Response.write khhy
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "     <input type=""button"" name=""line"" value=""饼图分析"" onClick=""window.location.href='kh3.asp?type_tj=3&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&sort3="
	...
	Response.write ">图宽=550</option>" & vbcrlf & "         <option value=""kh3.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=700</option>" & vbcrlf & "         <option value=""kh3.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=1000</option>" & vbcrlf & "        <option value=""kh3.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=1500</option>" & vbcrlf & "        <option value=""kh3.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=2000</option>" & vbcrlf & "        <option value=""kh3.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	if open_1_10=1 or open_1_10=3  then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认将统计结果导出为EXCEL文档？')){window.location.href='kh3.asp?type_tj=4&sort="
		Response.write E
		Response.write "&sort1="
		Response.write F
		Response.write "&sort3="
	...
	if counts<=0 then
		...
		do until rs1.eof
			set rs=server.CreateObject("adodb.recordset")
			sql="select ord  from  tel  where isnull(sp,0)=0 and cateid="&rs1("ord")&"  "&Str_Result2&" "
			rs.open sql,conn,1,1
			...
			title=rs1("name")
			if sort3=1 then
				lburl="../work/telhy.asp?fromTJ=1&W3="&rs1("ord")&"&E="&E&"&F="&F&"&ret3="&m1&"&ret4="&m2&"&D="&khhy&"&A3="&khly&"&A1="&khjz
			else
				lburl="../work2/telhy.asp?fromTJ=1&W3="&rs1("ord")&"&E="&E&"&F="&F&"&ret3="&m1&"&ret4="&m2&""
			end if
			total1(j,1)=numcg1
			total1(j,2)=title
			total1(j,0)=lburl
			...
			rs1.movenext
		Loop
		sql="select count(ord)  from  tel  where isnull(sp,0)=0 and  isnull(cateid,0)=0  "&Str_Result2&" "
		numcg1=conn.execute(sql)(0).value
		if sort3=1 then
			lburl="../work/telhy.asp?fromTJ=1&H=30&W3=0&E="&E&"&F="&F&"&ret3="&m1&"&ret4="&m2&"&D="&khhy&"&A3="&khly&"&A1="&khjz
		else
			lburl="../work2/telhy.asp?fromTJ=1&W3=0&E="&E&"&F="&F&"&ret3="&m1&"&ret4="&m2&""
		end if
		total1(j,1)=numcg1
		total1(j,2)="无销售人员"
		total1(j,0)=lburl
