...
'bigsystemtype = ".mozi"
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_2=0
		intro_94_2=0
	else
		open_94_2=rs1("qx_open")
		intro_94_2=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=7"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_7=0
		intro_94_7=0
	else
		open_94_7=rs1("qx_open")
		intro_94_7=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_8=0
		intro_94_8=0
	else
		open_94_8=rs1("qx_open")
		intro_94_8=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=10"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_10=0
		intro_94_10=0
	else
		open_94_10=rs1("qx_open")
		intro_94_10=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=11"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_11=0
		intro_94_11=0
	else
		open_94_11=rs1("qx_open")
		intro_94_11=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=3"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_3=0
		intro_94_3=0
	else
		open_94_3=rs1("qx_open")
		intro_94_3=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=6"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_6=0
		intro_94_6=0
	else
		open_94_6=rs1("qx_open")
		intro_94_6=rs1("qx_intro")
	end if
	rs1.close
	set rs1=Nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=9"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_9=0
		intro_94_9=0
	else
		open_94_9=rs1("qx_open")
		intro_94_9=rs1("qx_intro")
	end if
	rs1.close
	set rs1=Nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=12"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_12=0
		intro_94_12=0
	else
		open_94_12=rs1("qx_open")
		intro_94_12=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_13=0
		intro_94_13=0
	else
		open_94_13=rs1("qx_open")
		intro_94_13=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_16=0
		intro_94_16=0
	else
		open_94_16=rs1("qx_open")
		intro_94_16=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=19"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_19=0
		intro_94_19=0
	else
		open_94_19=rs1("qx_open")
		intro_94_19=rs1("qx_intro")
	end if
	rs1.close
	set rs1=Nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=Nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=32 and sort2=1"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_32_1=0
		intro_32_1=0
	else
		open_32_1=rs1("qx_open")
		intro_32_1=rs1("qx_intro")
	end if
	rs1.close
	set rs1=Nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=Nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=46 and sort2=1"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_46_1=0
		intro_46_1=0
	else
		open_46_1=rs1("qx_open")
		intro_46_1=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=46 and sort2=14"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_46_14=0
		intro_46_14=0
	else
		open_46_14=rs1("qx_open")
		intro_46_14=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	F2=request("F2")
	F3=request("F3")
	manyi1=request("manyi1")
	manyi2=request("manyi2")
	m1=request("ret")
	m2=request("ret2")
	...
	if W4<>"" Then
		...
		W1=tmp(0)
		W2=tmp(1)
		Str_Result = Str_Result + " and b.cateid>0 and b.cateid in("& W3 &") "
		W2=tmp(1)
	end if
	company=deurl(request("company"))
	If company<>"" Then Str_Result = Str_Result + " and b.company in("& company &") "
	company=deurl(request("company"))
	If A="" Then A=2
	if A1="" Then A1=0
	if A2="" Then A2=0
	...
	if A4="" Then A4=0
	if  A1<>"" And A1<>0 then
		Str_Result = Str_Result + " and  b.procsid = "& A1
'if  A1<>"" And A1<>0 then
	end if
	if  A2<>"" And A2<>0  then
		Str_Result = Str_Result + " and  b.projdid = "& A2
'if  A2<>"" And A2<>0  then
	end if
	if  A3<>"" And A3<>10 then
		Str_Result = Str_Result + " and  b.isback = "& A3
'if  A3<>"" And A3<>10 then
	end if
	if  A4<>"" And A4<>0 then
		Str_Result = Str_Result + " and  b.typeid = "& A4
'if  A4<>"" And A4<>0 then
	end if
	If F2<>"" Then
		Str_Result = Str_Result + " and  t.name like '%"& F2 &"%'"
'If F2<>"" Then
	end if
	If F3<>"" Then
		Str_Result = Str_Result + " and  e.name like '%"& F3 &"%'"
'If F3<>"" Then
	end if
	If manyi1<>"" Then
		Str_Result = Str_Result + " and  b.manyi>="&manyi1
'If manyi1<>"" Then
	end if
	If manyi2<>"" Then
		Str_Result = Str_Result + " and  b.manyi<="&manyi2
'If manyi2<>"" Then
	end if
	If A=2 Then
		if m1<>"" then
			Str_Result = Str_Result + " and b.servertime>='"&m1&"'"
'if m1<>"" then
		end if
		if m2<>"" then
			Str_Result = Str_Result + " and b.servertime<='"&m2&" 23:59:59'"
'if m2<>"" then
		end if
	else
		if m1<>"" then
			Str_Result = Str_Result + " and b.ybackTime>='"&m1&"'"
'if m1<>"" then
		end if
		if m2<>"" then
			Str_Result = Str_Result + " and b.ybackTime<='"&m2&" 23:59:59'"
'if m2<>"" then
		end if
	end if
	repID = Request("repID")
	If repID <> "" Then
		Str_Result = Str_Result + " AND  b.tb_id = "&repID&" "
'If repID <> "" Then
	end if
	propm = request("propm")
	If propm="1" Then
		tq72 = 0
		Set rs = conn.execute("select isnull(tq1,0) tq1 from setjm where ord = 72 and cateid=" & session("personzbintel2007"))
		If rs.eof = False Then
			tq72 = rs("tq1")
		end if
		rs.close
		set rs = nothing
		Str_Result= Str_Result + "  and b.cateid="& session("personzbintel2007") &" and dbo.dateDiffByDay(ybackTime,2,0,"& tq72 &",GETDATE())>=0 and b.isback=0 and isnull(b.setalt,0)=0 "
		tq72 = rs("tq1")
	end if
	If open_94_1=1 Then
		Str_Result = Str_Result + " and b.cateid in ("& intro_94_1 &")"
'If open_94_1=1 Then
	ElseIf open_94_1=0 Then
		Str_Result = Str_Result + " and 1=2"
'ElseIf open_94_1=0 Then
	end if
	If request("fromtj")="1" Then
		If open_94_11 = 3 Then
		ElseIf open_94_11 = 1 Then
			Str_Result = Str_Result & " and b.cateid in ("& intro_94_11 &") "
		else
			Str_Result = Str_Result & " and 1=2 "
		end if
	end if
	...
	if px=1 then
		px_Result="order by b.indate desc, b.company, b.ybacktime, b.id asc"
	elseif px=2 then
		px_Result="order by b.indate asc,b.company, b.ybacktime, b.id asc"
	elseif px=3 then
		px_Result="order by t.name desc,b.id desc"
	elseif px=4 then
		px_Result="order by t.name asc,b.id asc"
	elseif px=5 then
		px_Result="order by b.ybacktime desc,b.id desc"
	elseif px=6 then
		px_Result="order by b.ybacktime asc,b.id asc"
	elseif px=7 then
		px_Result="order by b.servertime desc,b.id desc"
	elseif px=8 then
		px_Result="order by b.servertime asc,b.id asc"
	elseif px=9 then
		px_Result="order by b.procsid desc,b.id desc"
	elseif px=10 then
		px_Result="order by b.procsid asc,b.id asc"
	elseif px=11 then
		px_Result="order by b.manyi desc,b.id desc"
	elseif px=12 then
		px_Result="order by b.manyi asc,b.id asc"
	elseif px=13 then
		px_Result="order by b.cateid desc,b.id desc"
	elseif px=14 then
		px_Result="order by b.cateid asc,b.id asc"
	end if
	undellist= request("undellist")
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "      </select>" & vbcrlf & "                       </td>" & vbcrlf & "      <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "     </tr>" & vbcrlf & "   </table>" & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""3"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;"">" & vbcrlf & "                <tr id=""zc"">" & vbcrlf & "       <td class=""resetHeadBg"" background=""../images/112.gif""  height=""30"" align=""right"" style=""border-top:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;"">" & vbcrlf & "          <select name=""A""><option value=""1"" "
	If A=1 Then Response.write "selected" End If
	Response.write ">应回访时间</option><option value=""2"" "
	If A=2 Then Response.write "selected" End If
	Response.write ">实际回访时间</option></select>"
	...
	Response.write "" & vbcrlf & "             <select name=""A1"">" & vbcrlf & "                        <option value=""0"" "
	if A1=0 then
		Response.write "selected"
	end if
	Response.write ">回访流程</option>" & vbcrlf & "                   "
	set rs7=conn.execute("select * from hf_config      where del=1 order by id desc")
	do until rs7.eof
		Response.write "" & vbcrlf & "                             <option value="""
		Response.write rs7("id")
		Response.write """ "
		if clng(A1)=rs7("id") then
			Response.write "selected"
		end if
		Response.write ">"
	...
	loop
	rs7.close
	Response.write "" & vbcrlf & "             </select>" & vbcrlf & "               <select name=""A2"">" & vbcrlf & "                        <option value=""0"" "
	if A2=0 then
		Response.write "selected"
	end if
	Response.write ">回访阶段</option>" & vbcrlf & "                   "
	If Trim(A1)&""<>"" And A1<>0 Then
		jdstr=" and mainid="&A1&""
	else
		jdstr=""
	end if
	set rs7=conn.execute("select * from hf_configList where del=1 "&jdstr&" order by id desc")
	do until rs7.eof
		Response.write "" & vbcrlf & "                             <option value="""
		Response.write rs7("id")
		Response.write """ "
		if clng(A2)=rs7("id") then
			Response.write "selected"
		end if
		Response.write ">"
		Response.write rs7("title")
	...
	loop
	rs7.close
	Response.write "" & vbcrlf & "             </select>" & vbcrlf & "               <select name=""A3"">" & vbcrlf & "                         <option value=""10"" "
	if clng(A3)=10 then
		Response.write "selected"
	end if
	Response.write ">回访状态</option>" & vbcrlf & "                    <option value=""0"" "
	if clng(A3)=0 then
		Response.write "selected"
	end if
	Response.write ">未回访</option>" & vbcrlf & "                      <option value=""1"" "
	if clng(A3)=1 then
		Response.write "selected"
	end if
	Response.write ">已回访</option>" & vbcrlf & "             </select>" & vbcrlf & "               <select name=""A4"">" & vbcrlf & "                        <option value=""0"" "
	if A4=0 then
		Response.write "selected"
	end if
	Response.write ">回访方式</option>" & vbcrlf & "                   "
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select * from sortonehy where gate2=56 order by gate1 desc"
	rs7.open sql7,conn,1,1
	do until rs7.eof
		Response.write "" & vbcrlf & "                      <option value="""
		Response.write rs7("ord")
		Response.write """ "
		if clng(A4)=rs7("ord") then
			Response.write "selected"
		end if
		Response.write ">"
		Response.write rs7("sort1")
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "             </select>" & vbcrlf & "               <input type=""submit"" name=""Submit422"" value=""检索""  class=""anybutton""/>" & vbcrlf & "   "
	If open_94_10=3 Or open_94_10=1 Then
		Response.write "" & vbcrlf & "                     <input type=""button"" name=""toExecel"" id=""toExecel"" value=""导出""  class=""anybutton"" style=""margin-left:0"" onclick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({from:'form_with_page_action',page:'../out/xls_sale.asp?"
'If open_94_10=3 Or open_94_10=1 Then
		Response.write sdk.ReturnURL("undellist=")
		Response.write "'});}""/>" & vbcrlf & "    "
	end if
	Response.write "" & vbcrlf & "  <a href=""javascript:void(0)"" class=""AfterQuickSearch"" onclick=""callServer2();document.getElementById('zc').style.display='none';document.getElementById('ht1').style.display='block';return false;""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" style=""display:none;"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a>" & vbcrlf & "  </td>" & vbcrlf & "    </tr>" & vbcrlf &"  </table>" & vbcrlf & "<span id=""ht1"" style=""padding:20px;display:none""></span>" & vbcrlf & "   </form>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""margin-left:20px"">" & vbcrlf & "        <tr class=""top"">" & vbcrlf &"   <td align=""center"" ><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "    <td height=""26"" align=""center""><div align=""center"">客户名称</div></td>" & vbcrlf & "        <td height=""23""><div align=""center""><strong>应回访时间</strong></div></td>" & vbcrlf & "          <td><div align=""center""><strong>实际回访时间</strong></div></td>" & vbcrlf & "     <td><div align=""center""><strong>回访流程</strong></div></td>" & vbcrlf & "      <td><div align=""center""><strong>回访阶段</strong></div></td>" & vbcrlf & "      <td><div align=""center""><strong>回访状态</strong></div></td>" & vbcrlf & "      <td><div align=""center""><strong>回访方式</strong></div></td>" & vbcrlf &     " <td><div align=""center""><strong>满意度</strong></div></td> "& vbcrlf &        " <td><div align=""center""><strong>回访人员</strong></div></td>" & vbcrlf &   "    <td width=""21%""><div align=""center"" ><strong>操作</strong></div></td> "& vbcrlf &   "   </tr>" & vbcrlf & ""
	dim n
	n=0
	set rs=server.CreateObject("adodb.recordset")
	sql="select b.company,t.cateid as khcateid,b.cateid,b.id,t.name,b.ybackTime,b.servertime,f.title as procs,l.title as projd, "&_
	"b.isback,r.sort1 as types,g.name as username,e.name as personname,b.manyi,isnull(b.procsid,0) as procsid , "&_
	"isnull(b.itype,0) as itype,isnull(b.tb_id,0) as tb_id, b.setalt,isnull(endtype,0) as endtype ,isnull(b.projdid,0) as projdid "&_
	"from Sale_CallBack b "&_
	"left join tel t on t.ord=b.company and t.del=1  "&_
	"left join hf_config f on f.id=b.procsid  "&_
	"left join hf_configlist l on l.id=b.projdid  "&_
	"left join sortonehy r on r.gate2=56 and r.ord=b.typeid  "&_
	"left join person e on e.ord=b.person_kh  "&_
	"left join gate g on g.ord = b.cateid and g.del=1  "&_
	"where b.del=1 " & Str_Result &" "& px_Result&" "
	...
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			...
			Response.write "" & vbcrlf & "                     <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "                           <td width=""4%"" align=""center"" class=""red"">" & vbcrlf & "                            "
			if open_94_3=3 or open_94_3=1 Or open_94_6=3 Or open_94_6=1 then
				Response.write "<input name=""selectid"" type=""checkbox"" id=""selectid"" value="""
				Response.write rs("id")
				Response.write """>"
			end if
			Response.write "" & vbcrlf & "                             </td>" & vbcrlf & "                           <td width=""10%"" align=""left"" height=""27"">" & vbcrlf & "                             "
			If rs("name")&"" ="" Then
				Response.write "客户已被删除"
			else
				If open_1_1=3 Or (open_1_1=1 And CheckPurview(intro_1_1,trim(khcateid))=True And khcateid<>0) or conn.execute("select top 1 1 from tel where ord ="& rs("company")&" and charindex(',"& session("personzbintel2007") &",',','+share+',')>0").eof = false Then
					Response.write "客户已被删除"
					If open_1_14=3 Or (open_1_14=1 And CheckPurview(intro_1_14,trim(khcateid))=True And khcateid<>0) Then
			...
			If InStr(","&undellist&",",","&rs("id")&",")>0 Then Response.write "&nbsp;<font color=red>不允许删除</font>"
			statusname = ""
			isback=rs("isback")
			If isback=0 Then
				statusname = "未回访"
			...
			canStart = False
			If endtype=2 Then
				Set nextRs = conn.execute("select top 1 n2.id from hf_config n1 inner join hf_configlist n2 on n1.effectivetime<=getdate() and n1.del=1 and n2.del=1 and n1.id =n2.mainid and n1.id = "&procsid&" and n2.id>"&projdid&"")
				If nextRs.eof = False Then
					nextprojdID = nextRs("id")
					canStart = True
					If conn.execute("select 1 from Sale_CallBack where del=1 and company="&rs("company")&" and procsid = "&procsid&" and projdid = "&nextprojdID&" and itype="&itype&" and tb_id = "&rs("tb_id")&"").eof = False Then canStart = False
				end if
				nextRs.close
			end if
			Response.write "" & vbcrlf & "                             </td>" & vbcrlf & "                           <td width=""11%"" align=""center"" height=""27"" >"
			Response.write rs("ybackTime")
			Response.write "</td>" & vbcrlf & "                                <td width=""11%"" align=""center"" height=""27"" >"
			Response.write rs("servertime")
			Response.write "</td>" & vbcrlf & "                                <td width=""10%"" align=""center"" height=""27"" >"
			Response.write rs("procs")
			Response.write "</td>" & vbcrlf & "                                <td width=""10%"" align=""center"" height=""27"" >"
			Response.write rs("projd")
			Response.write "</td>" & vbcrlf & "                                <td width=""6%"" align=""center"" height=""27"" >"
			Response.write statusname
			Response.write "</td>" & vbcrlf & "                                <td width=""10%"" align=""center"" height=""27"" >"
			Response.write rs("types")
			Response.write "</td>" & vbcrlf & "                                <td width=""6%"" align=""center"" height=""27"" >"
			If rs("manyi")&""<>"" Then Response.write Replace(Formatnumber(rs("manyi")&"",num1_dot,-1),",","")&"%" End If
			Response.write "</td>" & vbcrlf & "                                <td width=""6%"" class=""center"" height=""27"" ><div align=""center"">"
			Response.write rs("username")
			Response.write "</div></td>" & vbcrlf & "                      <td width=""12%""class=""func""><div align=""center"">" & vbcrlf & "                          "
			if open_94_14=3 or (open_94_14=1 and CheckPurview(intro_94_14,trim(cateid))=True  And cateid<>0) then
				Response.write "" & vbcrlf & "                                     <input type=""button"" name=""Submit3"" value=""详情""  onClick=""javascript:window.open('content.asp?ord="
				Response.write pwurl(rs("id"))
				Response.write "','newwin','width=' + 950 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=250,top=150')""/>" & vbcrlf & "                          "
				Response.write pwurl(rs("id"))
			end if
			If open_94_9=1 And isback=0 And cateid&""=session("personzbintel2007")&"" Then
				Response.write "" & vbcrlf & "                                  <input type=""button"" name=""Submit3c"" value=""回访""  onClick=""javascript:window.open('content_hf.asp?ord="
				Response.write pwurl(rs("id"))
				Response.write "','newwincor','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=300,top=200')""/>" & vbcrlf & "                               "
				Response.write pwurl(rs("id"))
			end if
			if open_94_6=3 or (open_94_6=1 and CheckPurview(intro_94_6,trim(cateid))=True  And cateid<>0) then
				Response.write "" & vbcrlf & "                                     <input type=""button"" name=""Submit3c"" value=""指派""  onClick=""javascript:window.open('order.asp?"
				Response.write sdk.ReturnURL("ord="& pwurl(rs("id")) &"&undellist=")
				Response.write "','newwin','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=250,top=150')"">"
				Response.write sdk.ReturnURL("ord="& pwurl(rs("id")) &"&undellist=")
			end if
			If open_94_13=1 And canStart=True Then
				Response.write "" & vbcrlf & "                                  <input type=""button"" name=""Submit3c"" value=""启动""  onClick=""javascript:window.open('openNext.asp?nextprojdID="
				Response.write pwurl(nextprojdID)
				Response.write "&company="
				Response.write pwurl(rs("company"))
				Response.write "&itype="
				Response.write itype
				Response.write "&tb_id="
				Response.write rs("tb_id")
				Response.write "&procsid="
				Response.write procsid
				Response.write "','newwincor','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=250,top=150')""/>                       " & vbcrlf & "                                "
				Response.write procsid
			end if
			if (open_94_3=3 or (open_94_3=1 and CheckPurview(intro_94_3,trim(cateid))=True  And cateid<>0)) And isback=1 then
				Response.write "" & vbcrlf & "                                     <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='Delete.asp?"
				Response.write sdk.ReturnURL("ord="& rs("id") &"&undellist=")
				Response.write "'}""/>" & vbcrlf & "                             "
			end if
		...
		loop
		Response.write "" & vbcrlf & "       </table>" & vbcrlf & "  </td>" & vbcrlf & "  </tr>" & vbcrlf & "          <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""5%"" height=""30""><div align=""center"">全选<inputname=""chkall"" type=""checkbox"" id=""chkall"" value=""all"" onClick=""mm(this.form)"" /></div></td>" & vbcrlf & "    <td>"
		if open_94_3=3 or open_94_3=1 then
			Response.write "" & vbcrlf & "                     <input type=""button"" onClick=""batdel();"" name=""Submit2"" value=""批量删除""  class=""anybutton2""/>" & vbcrlf & "        "
		end if
		if open_94_6=3 or open_94_6=1 then
			Response.write "" & vbcrlf & "                     <input type=""button"" name=""Submit4222"" value=""批量指派""  onclick=""ask();"" class=""anybutton2""/>" & vbcrlf & "            "
		end if
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""38"" colspan=""3""><div align=""right"">" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</form>" & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	action1="客户回访"
	Response.write "" & vbcrlf & "     <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td height=""10"" colspan=""2""><img src=""../image/pixel.gif"" width=""1"" height=""1""></td>" & vbcrlf & "    </tr>" & vbcrlf & "          <tr>" & vbcrlf & "      <td width=""16%"" height=""10""><div align=""right""></div></td>" & vbcrlf & "      <td width=""84%"">&nbsp;</td>" & vbcrlf & "    </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td height=""10"" colspan=""2"">&nbsp;</td>" & vbcrlf & "    </tr>" & vbcrlf & "          <tr>" & vbcrlf & "      <td height=""10"" colspan=""2"">&nbsp;</td>" & vbcrlf &          "</tr>" & vbcrlf &   "</table> "& vbcrlf &  "</td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<script language=""javascript""> "& vbcrlf & "function batdel()" & vbcrlf & "{" & vbcrlf &     "  if($(""input[name=selectid]:checked"").size()>0){ "& vbcrlf &         "   if(confirm('确认删除？')){" & vbcrlf & "                     document.all.form1.action = ""Delete.asp?"
	Response.write sdk.ReturnURL("undellist=")
	Response.write """;" & vbcrlf & "                        document.all.form1.submit();" & vbcrlf & "            }" & vbcrlf & "       }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               alert(""您没有选择任何客户回访，请选择后再删除！"");" & vbcrlf & "        }" & vbcrlf & "}" & vbcrlf & "function ask() {" & vbcrlf & "      document.all.form1.action = ""orderallhf.asp?"
	Response.write sdk.ReturnURL("undellist=")
	Response.write """;" & vbcrlf & "        document.all.form1.submit();" & vbcrlf & "}" & vbcrlf & "function mm(form)" & vbcrlf & "{" & vbcrlf & " for (var i=0;i<form.elements.length;i++)" & vbcrlf & "        {" & vbcrlf & "               var e = form.elements[i];" & vbcrlf & "               if (e.name != 'chkall')" & vbcrlf & "         e.checked = form.chkall.checked;" & vbcrlf & "        }" & vbcrlf & "}" & vbcrlf & "function Myopen(divID){" & vbcrlf & "       if(divID.style.display==""""){" & vbcrlf & "              divID.style.display=""none""" & vbcrlf & "        }else{" & vbcrlf & "          divID.style.display=""""" & vbcrlf & "    }" & vbcrlf & "       divID.style.left=300;" & vbcrlf & "   divID.style.top=0;" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:100%; height:400;display:none;"">" & vbcrlf & "<table width=""160"" height=""300""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""139"">" & vbcrlf &         "<table width=""160"" height=""115"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf &           "<tr valign=""middle"">" & vbcrlf &            " <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourlt></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=2');""><font color=""#2F496E"">按添加时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=3');""><font color=""#2F496E"">按客户名称排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=4');""><font color=""#2F496E"">按客户名称排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=5');""><font color=""#2F496E"">按应回访时间排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=6');""><font color=""#2F496E"">按应回访时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=7');""><font color=""#2F496E"">按实际回访时间排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=8');""><font color=""#2F496E"">按实际回访时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=9');""><font color=""#2F496E"">按回访流程排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=10');""><font color=""#2F496E"">按回访流程排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=11');""><font color=""#2F496E"">按满意度排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=12');""><font color=""#2F496E"">按满意度排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf &             "<td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourlnbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=14');""><font color=""#2F496E"">按回访人员排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<form action=""../out/xlsService.asp?reSt="
	...
	Response.write """>" & vbcrlf & "</form>" & vbcrlf & "</div>" & vbcrlf & ""
	call close_list(1)
