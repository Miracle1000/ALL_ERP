...
'dim sqlstr
	...
	if open_7_1=3 then
		Str_Result3=""
	elseif open_7_1=1 then
		str_Result3=" and a.cateid in ("&intro_7_1&") and a.cateid<>0 "
	else
		str_Result3=" and 1=0 "
	end if
	A=request("A")
	...
	If moneytype&""="" Then moneytype = 1
	money1 = request("money1")
	money2 = request("money2")
	If moneytype = 1 Then
		If Len(money1&"") > 0 Then Str_Result3 = Str_Result3 & " and m1.money1>=" & money1
		If Len(money2&"") > 0 Then Str_Result3 = Str_Result3 & " and m1.money1<=" & money2
	ElseIf moneytype = 2 Then
		If Len(money1&"") > 0 Then Str_Result3 = Str_Result3 & " and money4>=" & money1
		If Len(money2&"") > 0 Then Str_Result3 = Str_Result3 & " and money4<=" & money2
	end if
	m1=request("ret")
	m2=request("ret2")
	if D="" or IsNull(D) Then D=0
	if D<>"0" Then Str_Result3=Str_Result3+" and bz="&D&" "
'if D="" or IsNull(D) Then D=0
	if C<>"" then
		if B="khmc" Then Str_Result3=Str_Result3+ " and name like '%"&C&"%' "
'if C<>"" then
	end if
	Str_Result4 = ""
	if m1<>"" Then Str_Result4=Str_Result4+" and  s.date3>='"&m1&"' "
	Str_Result4 = ""
	if m2<>"" Then Str_Result4=Str_Result4+" and  s.date3<='"&m2&" 23:59:59' "
	Str_Result4 = ""
	px=request.QueryString("px")
	if px="" Then px=9
	Select Case px
	Case 1 : px_Result="order by name desc,ord desc"
	Case 2 : px_Result="order by name asc,ord asc"
	Case 3 : px_Result="order by money1 desc,ord desc"
	Case 4 : px_Result="order by money1 asc,ord asc"
	Case 5 : px_Result="order by money2 desc,ord desc"
	Case 6 : px_Result="order by money2 asc,ord asc"
	Case 7 : px_Result="order by money3 desc,ord desc"
	Case 8 : px_Result="order by money3 asc,ord asc"
	Case 9 : px_Result="order by money4 desc,ord desc"
	Case 10: px_Result="order by money4 asc,ord asc"
	End Select
...
'If khname="" Then khname="客户名称"
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "</head>" & vbcrlf & "<body oncontextmenu=self.event.returnValue=false >" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "    <form method=""get"" action=""khyfk.asp"" id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td class=""place"" style=""width:350px"">客户预收款统计分析</td>" & vbcrlf & "      <td align=""left"" width=""220"">&nbsp;<a class='px_btn' href=""#"" onClick=""Myopen(User);return false;"" class=""sortRule"">排序规则<img src=""../images/i10.gif"" width=""9"" height=""5"" border=""0""></a></td>" & vbcrlf & "      <td width=""55%""><div align=""right"">" & vbcrlf & "        <select name=""select2""  onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" >" & vbcrlf & "          <option>-请选择-</option>" & vbcrlf & "          <option value=""page_count=10"" "
	'Response.write Application("sys.info.jsver")
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "        </select>" & vbcrlf & "      </div></td>" & vbcrlf & "      <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "    </tr>" & vbcrlf & "              <tr height=""50"" class=""resetTrSearchBar"">" & vbcrlf & "                 <td colspan=""3"" align=""right"" class='ser_btn2'>" & vbcrlf & "                         <input type=""radio"" name=""moneytype"" value=""1"" "
	If moneytype = 1 then
		Response.write "checked"
	end if
	Response.write ">预收款总额&nbsp;<input type=""radio"" name=""moneytype"" value=""2"" "
	If moneytype = 2 then
		Response.write "checked"
	end if
	Response.write ">预收款余额&nbsp;" & vbcrlf & "                             从：<INPUT name=""money1"" size=9  id=""money1"" onpropertychange=""formatData(this,'money');"" onKeyUp=""checkDot('money1','"
	Response.write num_dot_xs
	Response.write "')""  value="""
	Response.write money1
	Response.write """>&nbsp;至：<INPUT name=""money2"" size=9  id=""money2"" onpropertychange=""formatData(this,'money');"" onKeyUp=""checkDot('money2','"
	Response.write num_dot_xs
	Response.write "')"" value="""
	...
	Response.write "" & vbcrlf & "                             <select name=""D"">" & vbcrlf & "                                 <option value=""0"">币种</option>" & vbcrlf & "                                   "
	set rs88=server.CreateObject("adodb.recordset")
	if open_bz=1 then
		rs88.open "select * from sortbz ",conn,1,1
	else
		rs88.open "select * from sortbz where id=14",conn,1,1
	end if
	...
	rs88.close
	set rs88=Nothing
	Response.write "" & vbcrlf & "                             </select>" & vbcrlf & "                               <select name=""B""><option value=""khmc"" "
	if B="khmc" then
		Response.write "selected"
	end if
	Response.write ">"
	Response.write khname
	Response.write "</option></select>" & vbcrlf & "                           <input type=""text"" name=""C"" value="""
	Response.write C
	...
	if open_7_10=1 or open_7_10=3 then
		Response.write "" & vbcrlf & "                                     <input type=""button"" name=""Submitdel2"" value=""EXCEL导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({debug:false,page:'../out/xls_khyfktj.asp'})}"" class=""anybutton""/>" & vbcrlf & "                             "
	end if
	...
	Response.write "" & vbcrlf & "                     </td>" & vbcrlf & "             </tr>" & vbcrlf & "      </table> " & vbcrlf & "   <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "     </form>" & vbcrlf & " <tr class=""top"">" & vbcrlf & "    <td height=""26""><div align=""center"">"
	Response.write khname
	Response.write "</div></td>" & vbcrlf & "    <td width=""8%""><div align=""center"">币种</div></td>" & vbcrlf & "          <td width=""12%""><div align=""center"">预收款总额</div></td>" & vbcrlf & "   <td width=""12%""><div align=""center"">使用预收款</div></td>" & vbcrlf & "   <td width=""12%""><div align=""center"">退预收款</div></td>" & vbcrlf & "          <td width=""12%""><div align=""center"">预收款余额</div></td>" & vbcrlf & "   <td width=""20%""><div align=""center"">退预收款</div></td>" & vbcrlf & "   </tr>" & vbcrlf & ""
	dim summoney1,summoney2,summoney3,summoney4,money1_all,money2_all,money3_all,money4_all,n
	money1_all=0
	money2_all=0
	money3_all=0
	money4_all=0
	...
	n=0
	set rs=server.CreateObject("adodb.recordset")
	sql="select a.ord,a.name,a.cateid,z.id as bz ,ISNULL(a.share,'-222') share,a.sort3,"&_
	"z.sort1 as sortbz,"&_
	"isnull(m1.money1,0) as money1,"&_
	"isnull(m1.money2,0) as money2, " &_
	"isnull(m1.money3,0) as money3, "&_
	"isnull(m1.money4,0) as money4 "&_
	"from tel a WITH(NOLOCK) "&_
	"inner join sortbz z WITH(NOLOCK) on 1=1 " &_
	"inner join ("&_
	"  select company,bz,isnull(sum(money1),0) as money1,isnull(sum(money2),0) as money2,isnull(sum(money3),0) as money3,isnull(sum(money4),0) as money4 "&_
	"  from ( "&_
	"  select s.company,s.bz,isnull(sum(s.money1),0) as money1,0 as money2 , 0 as money3 ,isnull(sum(s.money_left),0) as money4 from bankin2 s WITH(NOLOCK) where s.del=1 and isnull(s.status_sp,-1) in (1,-1) and isnull(s.BankinStatus,0) in (2,3) "& Str_Result4 &" group by s.company,s.bz " &_
	"  union all " &_
	"  select Bankin4_list.company,Bankin4_list.bz,0,isnull(sum(Bankin4_list.money1),0) as money2,0,0 from Bankin4_list WITH(NOLOCK) inner join bankin2 s on Bankin4_list.bankin2=s.id where s.del=1 and Bankin4_list.del=1   "& Str_Result4 &"  group by Bankin4_list.company,Bankin4_list.bz  " &_
	"  union all " &_
	"  select ts.company,k.bz,0,0,isnull(sum(ts.money1),0) as money3,0 from bankin3 ts WITH(NOLOCK) inner join sortbank k on k.id =ts.bank inner join bankin2 s on ts.bankin2=s.id where s.del=1 and ts.del=1  "& Str_Result4 &"  group by ts.company,k.bz" &_
	") m group by company,bz " &_
	") m1 on m1.company = a.ord and m1.bz=z.id "&_
	"where a.del =1 and (m1.money1<>0 or money2<>0 or money3<>0 or money4<>0) " & Str_Result3 & " "&px_Result&" "
	rs.open sql,conn,1,1
	if not rs.eof then
		do while not rs.eof
			money1_all=money1_all+cdbl(rs("money1"))
'do while not rs.eof
			money2_all=money2_all+cdbl(rs("money2"))
'do while not rs.eof
			money3_all=money3_all+cdbl(rs("money3"))
'do while not rs.eof
			money4_all=money4_all+cdbl(rs("money4"))
'do while not rs.eof
			rs.movenext
		loop
	end if
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			...
			'rs.absolutePage = CurrPage
			summoney2=summoney2+cdbl(rs("money2"))
			'rs.absolutePage = CurrPage
			summoney3=summoney3+cdbl(rs("money3"))
			'rs.absolutePage = CurrPage
			summoney4=summoney4+cdbl(rs("money4"))
			'rs.absolutePage = CurrPage
			sort3_kh = rs("sort3")
			share = rs("share")
			cateid_kh = rs("cateid")
			Response.write "" & vbcrlf & "       <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td align=""left"">" & vbcrlf & "             "
			If sort3_kh ="2" Then
				If open_26_1 = 3 Or (open_26_1 = 1 And CheckPurview(intro_26_1,trim(cateid_kh))=True) Then
					if open_26_14=3 or  CheckPurview(intro_26_14,trim(cateid_kh))=True  then
						...
						Response.write "','new25win','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')"" title="""
						'Response.write pwurl(rs("ord"))
				...
				If open_1_1 = 3 Or (open_1_1 = 1 And CheckPurview(intro_1_1,trim(cateid_kh))=True) Or InStr(1,","&share&",", ","&sdk.info.user&",",1) > 0 Or share = "1" Then
			...
			Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write Formatnumber(zbcdbl(rs("money2")),num_dot_xs,-1)
			Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write Formatnumber(zbcdbl(rs("money3")),num_dot_xs,-1)
			Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write "</td>" & vbcrlf & "            <td align=""right""><a href=""#"" onclick=""javascript:window.open('../money/planall_yfk_list.asp?company="
			Response.write pwurl(rs("ord"))
			Response.write "&bz="
			Response.write pwurl(rs("bz"))
			Response.write "','newww56insd3','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');return false;"" title=""查看操作日志"">"
			Response.write pwurl(rs("bz"))
			Response.write Formatnumber(zbcdbl(rs("money4")),num_dot_xs,-1)
			Response.write pwurl(rs("bz"))
			Response.write "</a></td>" & vbcrlf & "        <td align=""right""><div align=""center"">"
			if cdbl(rs("money4"))>0 then
				Response.write "<a href=""#"" onclick=""javascript:window.open('../money/back_yfk.asp?company="
				Response.write pwurl(rs("ord"))
				Response.write "&bz="
				Response.write pwurl(rs("bz"))
				Response.write "','newwwinsd3','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=150,top=150');return false;"" title=""点击退预收款""><font class=""red"">退预收款</font></a>"
				'Response.write pwurl(rs("bz"))
			end if
		...
		loop
		Response.write "     " & vbcrlf & "     <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "          <td colspan=""2""><div align=""right"">本页合计：</div></td>" & vbcrlf & "            <td class=""red"" align=""right"">"
		...
		Response.write "</td>" & vbcrlf & "            <td class=""red"" align=""right"">"
		Response.write "</td>" & vbcrlf & "            <td class=""name"" align=""center"">&nbsp;</td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "       <td colspan=""2""><div align=""right"">所有合计：</div></td>" & vbcrlf& "           <td class=""red"" align=""right"">"
...
'& "           <td class=""red"" align=""right"">"
		...
		Response.write "</td>" & vbcrlf & "            <td class=""red"" align=""right"">"
		Response.write "</td>" & vbcrlf & "            <td class=""name"" align=""center"">&nbsp;</td>" & vbcrlf & "    </tr>" & vbcrlf & "      </table>" & vbcrlf & "  </td>" & vbcrlf & "         </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "                 <tr>" & vbcrlf & "    <td width=""10%"" height=""30"">&nbsp;</td>" & vbcrlf & "    <td>&nbsp;</td>" & vbcrlf & "  </form> " & vbcrlf & "    <td width=""79%""><div align=""right"">" & vbcrlf & "    "
		...
		Response.write "条信息/页&nbsp;&nbsp;" & vbcrlf & "        <input name=""currpage"" id=""currpage""  type=""text""   onkeyup=""value=value.replace(/[^\d]/g,'')""  size=""3"">" & vbcrlf & "   <input type=""submit"" name=""Submit422"" value=""跳转"" onClick=""gotourl('currPage='+document.getElementById('currpage').value);""class=""anybutton2""/>" & vbcrlf & "   "
		if currpage=1 then
	...
	action1="客户预收款统计分析"
	call close_list(1)
	Response.write "   " & vbcrlf & "      <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "        <tr> " & vbcrlf & "          <td height=""10"" colspan=""2""><img src=""../image/pixel.gif"" width=""1"" height=""1""></td>" & vbcrlf & "        </tr> " & vbcrlf & "                        <tr>" & vbcrlf & "                     <td width=""16%"" height=""10""><div align=""right""></div></td>" & vbcrlf & "                    <td width=""84%"">&nbsp;</td>" & vbcrlf & "           </tr>" & vbcrlf & "                     <tr>" & vbcrlf & "                      <td height=""10"" colspan=""2"">&nbsp;</td>" & vbcrlf & "         </tr>" & vbcrlf & "                     <tr>" &vbcrlf & "                            <td height=""10"" colspan=""2"">&nbsp;</td>" & vbcrlf & "     </tr>" & vbcrlf & "      </table>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<script language=""javascript"">" & vbcrlf & "function Myopen(divID){" & vbcrlf & " if(divID.style.display==""""){ "& vbcrlf &            "   divID.style.display=""none""" & vbcrlf &    "     }else{ "& vbcrlf &    "       divID.style.display="""" "& vbcrlf & "    } "& vbcrlf &        "divID.style.left=310;" & vbcrlf &  "  divID.style.top=0; "& vbcrlf &" }" & vbcrlf &" </script>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:150;height:400;display:none;"">" & vbcrlf & "<table width=""150"" height="""
	if D<>"0" then
		Response.write "300"
	else
		Response.write "60"
	end if
	Response.write """  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""100"">" & vbcrlf & "        <table width=""150"" height=""60"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=1')""><font color=""#2F496E"">按客户名称排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=2')""><font color=""#2F496E"">按客户名称排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=3')""><font color=""#2F496E"">按预收款总额排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=4')""><font color=""#2F496E"">按预收款总额排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                 <tr  valign=""middle"">"& vbcrlf &          "   <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl;&nbsp;<a href=""###"" onClick=""gotourl('px=6')""><font color=""#2F496E"">按使用预收款排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=7')""><font color=""#2F496E"">按退预收款排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=8')""><font color=""#2F496E"">按退预收款排序(升)</font></a> </td>" & vbcrlf & "     </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=9')""><font color=""#2F496E"">按预收款余额排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                <tr  valign=""middle"">" & vbcrlf& "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=10')""><font color=""#2F496E"">按预收款余额排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & "</body>" & vbcrlf & "</html>"
