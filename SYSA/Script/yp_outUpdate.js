...
function addMx(id,prod_name,prod_bh,prod_xh,sort1,prod_num,sto_name,sto_id,pro_name,prod_ph,prod_xlh,prod_sctime,prod_ystime)
{
	...
	tr.appendChild(td0);
	td0.align="center";
	var delHref = "<div align=\"left\">"+prod_name+"&nbsp;&nbsp;<a href=\"###\" onclick=\"del_TR('"+tr.id+"','"+id+"')\"><img src=\"../images/del2.gif\"/></a>&nbsp;<span id='sortlist'>"+a+"</span><input type=\"hidden\" value=\""+id+"\" name=\"prod_id\"></div>";
	...
	tr.appendChild(td5);
	td5.align="center";
	var delHref = "<input name=\"prod_num\" value=\"1\" type=\"text\" id=\"prod_num\" onKeyUp=\"value=value.replace(/[^\\d*|\\.]/g,'')\" size=\"12\" onpropertychange=\"formatData(this,'number');\"><span class=\"red\" name=\"numtext\"></span>";
