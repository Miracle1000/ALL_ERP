...
'bigsystemtype = ".mozi"
	...
	sql="delete from O_MeetingUse where id in ("&ord&")"
	conn.execute(sql)
	sql="delete from O_MeetingUseList where lst_fid in ("&ord&")"
	conn.execute(sql)
	action1="会议室申请删除"
	call close_list(2)
	if r=1 then
		...
		Response.write "<script>window.location='List_meetUse.asp?CurrPage="&ml.Dep(CurrPage)&"&px="&px&"&A="&ml.Dep(A)&"&B="&ml.Dep(B)&"&C="&ml.Dep(C)&"&ret="&ret&"&ret2="&ret2&"&page_count="&page_count&"&L1="&ml.Dep(L1)&"&L2="&ml.Dep(L2)&"&D1="&ml.Dep(D1)&"&D2="&ml.Dep(D2)&"&D3="&ml.Dep(D3)&"&D4="&ml.Dep(D4)&"&D5="&ml.Dep(D5)&"&D6="&ml.Dep(D6)&"&D7="&ml.Dep(D7)&"&D8="&ml.Dep(D8)&"&D9="&ml.Dep(D9)&"&D10="&ml.Dep(D10)&"&D11="&ml.Dep(D11)&"&D12="&ml.Dep(D12)&"&D13="&ml.Dep(D13)&"&D14="&ml.Dep(D14)&"&D15="&ml.Dep(D15)&"&D16="&ml.Dep(D16)&"&D17="&ml.Dep(D17)&"&D18="&ml.Dep(D18)&"&D19="&ml.Dep(D19)&"&D20="&ml.Dep(D20)&"&D201="&ml.Dep(D201)&"&D21="&ml.Dep(D21)&"&D22="&ml.Dep(D22)&"&zdy1="&ml.Dep(zdy1)&"&zdy2="&ml.Dep(zdy2)&"&zdy3="&ml.Dep(zdy3)&"&zdy4="&ml.Dep(zdy4)&"&zdy5="&ml.Dep(zdy5)&"&zdy6="&ml.Dep(zdy6)&"&zdy7="&ml.Dep(zdy7)&"&zdy8="&ml.Dep(zdy8)&"&zdy9="&ml.Dep(zdy9)&"&W1="&W1&"&W2="&W2&"&W3="&W3&"&remind="&remind&"'</script>"
	end if
