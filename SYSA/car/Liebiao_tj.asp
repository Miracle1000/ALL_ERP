...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td></tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">车辆类型：</div></td>" & vbcrlf & "      <td colspan=""3"">"
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,setName from O_carSet where setType=2 order by setsort desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "             <input name=""D1"" type=""checkbox"" id=""D1"" value="""
		Response.write rs("id")
		Response.write """ />"
		Response.write rs("setName")
		rs.movenext
	loop
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "      </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">车辆状态：</div></td>" & vbcrlf & "      <td colspan=""3"">" & vbcrlf & "<input name=""D2"" type=""checkbox"" id=""D2"" value=""1"">正常" & vbcrlf & "<input name=""D2"" type=""checkbox"" id=""D2"" value=""2"">维护" & vbcrlf & "<input name=""D2"" type=""checkbox"" id=""D2"" value=""3"">报废" & vbcrlf & "<input name=""D2"" type=""checkbox"" id=""D2"" value=""4"">停用" & vbcrlf & "</td>" & vbcrlf & "  </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">车辆颜色：</div></td>" & vbcrlf & "      <td colspan=""3"">" & vbcrlf & "              "
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,setName from O_carSet where setType=1 order by setsort desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "                      <input name=""D3"" type=""checkbox"" id=""D3"" value="""
		Response.write rs("id")
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "         </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">负责司机：</div></td>" & vbcrlf & "      <td colspan=""3"">" & vbcrlf & "              "
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,drivername from O_carDriver "
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "                      <input name=""D17"" type=""checkbox"" id=""D17"" value="""
		Response.write rs("id")
		Response.write """>" & vbcrlf & "                 "
		Response.write rs("drivername")
		rs.movenext
	loop
	rs.close
	set rs=nothing
	...
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=803 and set_open=1 and js=1 and sort=1 order by gate1 asc "
	rs.open sql,conn,1,1
	if rs.eof then
	else
		do until rs.eof
			...
			Response.write "：</div></td><td colspan=""3"">" & vbcrlf & "           "
			set rs1=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "       <td><div align=""right"">车牌号：</div></td>" & vbcrlf & "                    <td width=""33%""><input name=""D4"" type=""text"" id=""D4"" size=""15""></td>" & vbcrlf & "  <td width=""15%""><div align=""right"">" & vbcrlf & "               <div align=""right"">车辆名称：</div>" & vbcrlf & "             </div></td>" & vbcrlf & "             <td width=""42%""><input name=""D5"" type=""text"" id=""D5"" size=""15"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">排量(升)：</div></td>" & vbcrlf & "         <td><input name=""D6"" type=""text"" id=""D6"" size=""15"" /></td>" & vbcrlf & "         <td><div align=""right"">车辆型号：</div></td>" & vbcrlf & "         <td><input name=""D7"" type=""text"" id=""D7"" size=""15"" /></td>" & vbcrlf & "       </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">发动机号：</div></td>" & vbcrlf & "             <td><input name=""D8"" type=""text"" id=""D8"" size=""15""></td>" & vbcrlf & "         <td><div align=""right"">底盘号：</div></td>" & vbcrlf & "         <td><input name=""D9"" type=""text"" id=""D9"" size=""15"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "          <td><div align=""right"">购买厂家：</div></td>" & vbcrlf & "      <td><input name=""D13"" type=""text"" id=""D13"" size=""15"" /></td>" & vbcrlf & "            <td><div align=""right"">购买金额：</div></td>" & vbcrlf & "         <td><input name=""D11"" type=""text"" id=""D11"" size=""12"" onpropertychange=""formatData(this,'money');"" />" & vbcrlf & "           - " & vbcrlf & "           <input name=""D12"" type=""text"" id=""D12"" size=""12"" onpropertychange=""formatData(this,'money');"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">其他参数：</div></td>" & vbcrlf & "    <td><input name=""D16"" type=""text"" id=""D16"" size=""15"" /></td>" & vbcrlf & "             <td><div align=""right"">最大载客数：</div></td>" & vbcrlf & "         <td><input name=""D14"" type=""text"" id=""D14"" size=""4"" onpropertychange=""formatData(this,'number');"" />" & vbcrlf & "         - " & vbcrlf & "         <input name=""D15"" type=""text"" id=""D15"" size=""4"" onpropertychange=""formatData(this,'number');"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">固定电话：</div></td>" & vbcrlf & "    <td><input name=""D18"" type=""text"" id=""D18"" size=""15"" /></td>" & vbcrlf &         "<td><div align=""right"">移动手机：</div></td>" & vbcrlf &          "<td><input name=""D19"" type=""text"" id=""D19"" size=""15"" /></td>" & vbcrlf &   "</tr>" & vbcrlf &   "<tr onMouseOut=""this.style.backgroundColor'"">" & vbcrlf & "    <td><div align=""right"">移动手机2：</div></td>" & vbcrlf & "    <td><input name=""D20"" type=""text"" id=""D20"" size=""15"" /></td>" & vbcrlf & "             <td><div align=""right""></div></td>" & vbcrlf & "         <td>&nbsp;</td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">司机地址：</div></td>" & vbcrlf & "    <td colspan=""3""><input name=""D21"" type=""text"" id=""D21"" size=""30"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">档案备注：</div></td>" & vbcrlf & "      <td colspan=""3""><input name=""D22"" type=""text"" id=""D22"" size=""30""></td>" & vbcrlf & "  </tr>  " & vbcrlf & "      "
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=803 and set_open=1 and js=1 and sort=2 order by gate1 asc "
	rs.open sql,conn,1,1
	if rs.eof then
	else
		num1=rs.RecordCount
		...
		do until rs.eof
			if clng(i_jm/2)=i_jm/2 and i_jm<>0 then
				Response.write("</tr><tr>")
				j_jm=j_jm+1
				Response.write("</tr><tr>")
			end if
			Response.write "" & vbcrlf & "             " & vbcrlf & "                <td><div align=""right"">"
			Response.write rs("title")
	...
	set rs=nothing
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=803 and set_open=1 and js=1 and sort=3 order by gate1 asc "
	rs.open sql,conn,1,1
	if rs.eof then
	else
		do until rs.eof
			Response.write "" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">"
			Response.write rs("title")
			Response.write "：</div></td>" & vbcrlf & "             <td colspan=""3"">&nbsp;自：<input type=""text"" name="""
			Response.write rs("name")
			Response.write """ id="""
			Response.write rs("name")
			Response.write """ Class=""DatePick""  onclick=""datedlg.show();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  "
			rs.movenext
		loop
	end if
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">购买日期：</div></td>" & vbcrlf & "      <td colspan=""3"">&nbsp;自：<input type=""text"" name=""M"" id=""M"" Class=""DatePick""  onclick=""datedlg.show();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""K"" id=""K"" Class=""DatePick""  onclick=""datedlg.show();"" readonly=""readonly""></td>" & vbcrlf &   "</tr>" & vbcrlf &    "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">添加日期：</div></td>" & vbcrlf & "      <td colspan=""3"">&nbsp;自：<input type=""text"" name=""L1"" id=""L1"" Class=""DatePick""  onclick=""datedlg.show();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""L2"" id=""L2"" Class=""DatePick""  onclick=""datedlg.show();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "      <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td width=""10%"">&nbsp;</td>" & vbcrlf & "       <td colspan=""3""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
