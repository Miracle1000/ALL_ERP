...
'Private Sub Class_Initialize
	...
	Sub fillinPower(s1,s2,ByRef qx_open,ByRef qx_intro)
		Dim rsPower
		Set rsPower = conn.execute("select qx_open,qx_intro from power where ord="&session("personzbintel2007")&" and sort1="&s1&" and sort2="&s2)
		if rsPower.eof then
			qx_open = 0
			qx_intro = "-222"
			qx_open = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script language=""javascript"">" & vbcrlf & "" & vbcrlf & "function callServer2() {" & vbcrlf & "  var url = ""dp_tj.asp?re_dp=1&timestamp="" + new Date().getTime() + ""&date1=""+ Math.round(Math.random()*100);" & vbcrlf & "  xmlHttp.open(""GET"", url, false); "& vbcrlf &"   xmlHttp.onreadystatechange = function(){ "& vbcrlf &"   updatePage2(); "& vbcrlf &"   }; "& vbcrlf &"   xmlHttp.send(null); "& vbcrlf &" } "& vbcrlf &" function updatePage2() { "& vbcrlf &" var test7=""ht1"" "& vbcrlf &"   if (xmlHttp.readyState < 4) {" & vbcrlf &  "ht1.innerHTML=""loading..."";" & vbcrlf & "  }" & vbcrlf & "  if (xmlHttp.readyState == 4) {" & vbcrlf & "    var response = xmlHttp.responseText;" & vbcrlf & "    ht1.innerHTML=response;" & vbcrlf & " xmlHttp.abort();" & vbcrlf & "  }" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"" ><!-- oncontextmenu=self.event.returnValue=false -->" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & ""
	W1=request("W1")
	W2=request("W2")
	W3=request("W3")
	m1=request("ret")
	...
	If m3<>"" Then m1=m3
	If m4<>"" Then m2=m4
	If m1="" And remind="" Then m1=dateadd("d",1-day(date),date)
	If m4<>"" Then m2=m4
	if m2="" And remind="" Then m2=Date
	If request("propm")=1 Or request("newstate")=1 Then
		m1=""
		m2=""
		Str_Result2=Str_Result2&" and isnull(y.alt,0)=0 "
	end if
	cateCondition = "and (" & vbcrlf
	Call fillinPower(1,5,qOpen,qIntro)
	cateCondition = cateCondition & " ( x.sort1=1 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	else
		cateCondition = cateCondition & " and 1=2"
	end if
	cateCondition = cateCondition & " ) "
	Call fillinPower(2,5,qOpen,qIntro)
	cateCondition = cateCondition & " or ( x.sort1=8 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	...
	cateCondition = cateCondition & " ) "
	Call fillinPower(3,5,qOpen,qIntro)
	cateCondition = cateCondition & " or ( x.sort1=2 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	...
	cateCondition = cateCondition & " ) "
	Call fillinPower(4,5,qOpen,qIntro)
	cateCondition = cateCondition & " or ( x.sort1=3 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	...
	cateCondition = cateCondition & " ) "
	Call fillinPower(5,5,qOpen,qIntro)
	cateCondition = cateCondition & " or ( x.sort1=4 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	...
	cateCondition = cateCondition & " ) "
	Call fillinPower(22,5,qOpen,qIntro)
	cateCondition = cateCondition & " or ( x.sort1=5 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	...
	cateCondition = cateCondition & " ) "
	Call fillinPower(41,5,qOpen,qIntro)
	cateCondition = cateCondition & " or ( x.sort1=7 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	...
	cateCondition = cateCondition & " ) "
	Call fillinPower(42,5,qOpen,qIntro)
	cateCondition = cateCondition & " or ( x.sort1=6 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	...
	cateCondition = cateCondition & " ) "
	Call fillinPower(75,5,qOpen,qIntro)
	cateCondition = cateCondition & " or ( x.sort1=75 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	...
	cateCondition = cateCondition & " ) "
	Call fillinPower(95,5,qOpen,qIntro)
	cateCondition = cateCondition & " or ( x.sort1=102001 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	...
	cateCondition = cateCondition & " ) "
	Call fillinPower(96,5,qOpen,qIntro)
	cateCondition = cateCondition & " or ( x.sort1=102002 "
	If qOpen = 3 Then
		cateCondition = cateCondition & ""
	ElseIf qOpen=1 Then
		cateCondition = cateCondition & " and (x.cateid is not null and x.cateid<>0 and x.cateid in ("&qIntro&")) "
	...
	"( 1=1 " & cateCondition & ") "&_
	"or x.share='1' "&_
	"or charindex(','+cast("&session("personzbintel2007")&"as varchar(12))+',',','+replace(cast(x.share as varchar(8000)),' ','')+',')>0"&_
	"or x.share='1' "&_
	")" & vbcrlf
	If remind <> "" Then
		Set helper = CreateReminderHelper(conn,56,0)
		Str_Result2 = Str_Result2&" and y.id in (" & helper.listSQL("ids") & ")"
	end if
	If intro<>"" Then Str_Result2=Str_Result2+"and x.intro like '%"&intro&"%' "
	'Str_Result2 = Str_Result2&" and y.id in (" & helper.listSQL("ids") & ")"
	If intro2<>"" Then Str_Result2=Str_Result2+"and y.intro like '%"&intro2&"%' "
	'Str_Result2 = Str_Result2&" and y.id in (" & helper.listSQL("ids") & ")"
	if m1<>"" Then Str_Result2=Str_Result2+"and y.date7>='"&m1&"' "
	'Str_Result2 = Str_Result2&" and y.id in (" & helper.listSQL("ids") & ")"
	if m2<>"" Then Str_Result2=Str_Result2+"and y.date7<='"&cdate(m2)&" 23:59:59' "
	'Str_Result2 = Str_Result2&" and y.id in (" & helper.listSQL("ids") & ")"
	sort1=request("sort1")
	If sort1<>"" Then Str_Result2=Str_Result2+"and x.sort1 in ("&sort1&")"
	'sort1=request("sort1")
	if W1="" then W1=0
	if W2="" then W2=0
	if W3="" then W3=0
	...
	W4=replace(W3,"0","")
	W4=replace(W4,",","")
	If W4<>"" Then Str_Result2=Str_Result2+"and y.cateid in ("&W3&")"
	W4=replace(W4,",","")
	Response.write "<form method=""get"" action=""dp.asp?remind="
	...
	Response.write sort_lm
	Response.write """ id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"" style=""margin:0"">" & vbcrlf & "            <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">上级给我的点评</td>" & vbcrlf & "                     <td align=""right"">" & vbcrlf & "                        <div id=""DP"">" & vbcrlf & "                             <strong>"
	Response.write sort_lmname
	Response.write W1name
	Response.write W2name
	Response.write W3name
	Response.write sort
	Response.write "" & vbcrlf & "                             自：<INPUT name=ret size=9  id=daysOfMonthPos onmouseup=""toggleDatePicker('daysOfMonth','date.ret')"" value="""
	Response.write m1
	Response.write """><DIV id=daysOfMonth style=""POSITION: absolute""></DIV>&nbsp;至：<INPUT name=ret2 size=9  id=daysOfMonth2Pos onmouseup=""toggleDatePicker('daysOfMonth2','date.ret2')"" value="""
	Response.write m2
	Response.write """>" & vbcrlf & "                                <DIV id=daysOfMonth2 style=""POSITION: absolute""></DIV>" & vbcrlf & "                            <SCRIPT language=JavaScript1.2>" & vbcrlf & "                         function Cancel() {" & vbcrlf & "                             hideElement(""daysOfMonth"");" & vbcrlf & "                               }" & vbcrlf & "" & vbcrlf & "                               </SCRIPT>" & vbcrlf & "" & vbcrlf & "                               <SCRIPT language=JavaScript1.2>" & vbcrlf & "                         <!--" & vbcrlf & "                            hideElement('daysOfMonth');" & vbcrlf & "                             hideElement('daysOfMonth2');" & vbcrlf & "                            //-->" & vbcrlf & "                           </SCRIPT></strong>" & vbcrlf & "                              <input type=""submit"" name=""Submit422"" value=""检索""  class=""anybutton2""/>"
	...
	Response.write "&nbsp;" & vbcrlf & "                               <a href=""javascript:void(0)"" class=""AfterQuickSearch"" onclick=""callServer2();document.getElementById('DP').style.display='none';document.getElementById('ht1').style.display='';return false;""><img src=""../images/icon_title.gif"" width=""8"" height=""8"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a>             " & vbcrlf &"                         </div> "& vbcrlf &"                   </td> "& vbcrlf &"             <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td> "& vbcrlf &"           </tr> "& vbcrlf &"         </table>   "& vbcrlf &"             <span id=""ht1""></span> "& vbcrlf &"    </form> "& vbcrlf &"  <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style='margin-top:-1px'> "& vbcrlf &"      <tr class=""top""> "& vbcrlf & "    <td width=""79"" align=""center"" ><div align=""center"">序号</div></td>"& vbcrlf & "         <td height=""27"" width=""471""  ><div align=""center"">洽谈进展</div></td>" & vbcrlf & "         <td height=""27"" width=""471""  ><div align=""center"">点评内容</div></td>" & vbcrlf & "         <td width=""171""  ><div align=""center"">点评人</div></td>" & vbcrlf & "     <td width=""171""  ><div align=""center"">被点评人</div></td>" & vbcrlf & "   <td width=""171""  ><div align=""center"">类型</div></td>" & vbcrlf & "       <td width=""141"" ><div align=""center"">点评时间</div></td>" & vbcrlf & "    <td width=""320""><div align=""center"">关联客户</div></td>" & vbcrlf & "     </tr>" & vbcrlf & " "
	set rs=server.CreateObject("adodb.recordset")
	sql="select x.id,x.ord,x.ord2,y.name,x.name2,x.date7 as date8,y.date7,x.intro as intro,x.uploadfile,y.intro as intro2,x.name as bname,x.sort1,y.id as DPID from reply as x join dianping as y on x.del=1 and x.id=y.ord where 1=1 "&cateCondition&" "&Str_Result2&" "&tel_Result&" order by y.date7 desc"
	...
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			...
			if rs("ord")<>"" then
				...
				sql7="select name from tel where ord="&rs("ord")&""
			...
			Response.write "</td>" & vbcrlf & "          <td width=""471"" height=""27"" class=""name""><div align=""left"">&nbsp;"
			Response.write rs("intro")
			uploadfile=rs("uploadfile")
			If Len(uploadfile&"")>0 Then Response.write Getuploadfile(uploadfile)
			Response.write "</div></td>" & vbcrlf & "    <td width=""471"" height=""27"" class=""name""><div align=""left"">&nbsp;" & vbcrlf & "        <a href=""javascript:void(0)"" onclick=""javascript:window.open('../work/content_dp.asp?ord="
			Response.write pwurl(rs("dpid"))
			Response.write "','new23win','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" title=""点击可查看此点评详情"">"
			Response.write pwurl(rs("dpid"))
			Response.write rs("intro2")
			Response.write "</a> " & vbcrlf & "           "
			If  request("propm")=1 Or request("newstate")=1 Then
				Response.write "<IMG style=""BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BORDER-TOP: 0px; BORDER-RIGHT: 0px"" src=""../images/hot-new.gif"">" & vbcrlf & "          "
'If  request("propm")=1 Or request("newstate")=1 Then
			end if
			Response.write "" & vbcrlf & "       </div></td>" & vbcrlf & "        <td width=""171"" height=""27"" class=""name""><div align=""center"">"
			Response.write rs("name")
			Response.write "</div></td>" & vbcrlf & "          <td width=""171"" height=""27"" class=""name""><div align=""center"">"
			...
			If sort1ID=5 Or sort1ID=75 Or sort1ID=76 Then
				Response.write "<a href=""javascript:void(0)"" onclick=""javascript:window.open('../work2/content.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "','new23win','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" title=""点击可查看此供应商详情"">"
				Response.write pwurl(rs("ord"))
				...
				Response.write pwurl(rs("ord"))
				Response.write "','new23win','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" title=""点击可查看此客户详情"">"
				Response.write pwurl(rs("ord"))
				Response.write cateid
				Response.write "</a> </td>" & vbcrlf & "             "
			end if
		...
		if currpage=1 then
			...
			Response.write "" & vbcrlf & "          <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='dp.asp?currPage="
			Response.write  1
			Response.write "&remind="
			Response.write remind
			Response.write "&ord="
			...
			Response.write "&sort_lm="
			Response.write sort_lm
			Response.write "'""/> <input type=""button"" name=""Submit42"" value=""上一页""  onClick=""window.location.href='dp.asp?currPage="
		...
		if currpage=rs.pagecount then
			...
			Response.write "" & vbcrlf & "         <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='dp.asp?currPage="
			Response.write  currpage + 1
			Response.write "&remind="
			Response.write remind
			Response.write "&ord="
			...
			Response.write "&sort_lm="
			Response.write sort_lm
			Response.write "'"" class=""page""/> <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href='dp.asp?currPage="
			Response.write  rs.PageCount
			Response.write "&remind="
			Response.write remind
			Response.write "&ord="
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "  " & vbcrlf & "<tr><td colspan=""3"">  <tr>" & vbcrlf & "    <td height=""68"" colspan=""3""><div align=""right""><p>&nbsp;" & vbcrlf & "      </p>" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & " "
	end if
	rs.close
	set rs=nothing
	action1="上级给我的点评"
