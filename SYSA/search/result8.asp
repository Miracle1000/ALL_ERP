...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "            </select>" & vbcrlf & "            </span>" & vbcrlf & "                                     <select name=""B"" style=""width:125px;"">" & vbcrlf & "              <option value=""mc"" "
	if B="mc" then
		Response.write "selected"
	end if
	Response.write ">---"
	...
	Response.write "" & vbcrlf & "          </select>" & vbcrlf & "            <input name=""C"" type=""text"" size=""12"" />" & vbcrlf & "          </div></td>" & vbcrlf & "               " & vbcrlf & "        <td >          <div align=""center"">" & vbcrlf & "            <input type=""hidden"" name=""ty"" value="""
	Response.write ty
	Response.write """>" & vbcrlf & "            <input type=""submit"" name=""Submit45"" value=""检索"" class=""page""/>" & vbcrlf & "            "
	if open_1_13=1 then
		Response.write "<input type=""button"" name=""Submit42"" value=""添加客户""  onClick=""javascript:"
		if ty&""="1" then Response.write("window.location.href='../work/add.asp'") else Response.write("window.open('../work/add.asp','newwin77','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')")
		'Response.write "<input type=""button"" name=""Submit42"" value=""添加客户""  onClick=""javascript:"
		Response.write """ class=""anniu""/>"
	end if
	Response.write "" & vbcrlf & "        </div></td>" & vbcrlf & "            <td width=""43"" >&nbsp;</td>" & vbcrlf & "      </form>" & vbcrlf & "    </tr>" & vbcrlf & "  </table></div></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "       </tr>" & vbcrlf & "      </table>  " & vbcrlf & "    " & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "    <td align=""center""><div align=""center""><strong>"
	...
	If Str_Result="" Then
		Str_Result= " where isnull(sp,0)=0 "
	else
		Str_Result=Str_Result & " and isnull(sp,0)=0 "
	end if
	set rs=server.CreateObject("adodb.recordset")
	sql="select ord ,khid,name,cateid from tel  "&Str_Result&"   order by date1 desc "
	...
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			...
			Response.write "</td>" & vbcrlf & "          <td width=""16%"" height=""28""><div align=""center""><a  href=""../person/add3.asp?ord="
			Response.write rs("ord")
			Response.write "&rd="
			Response.write rd
			Response.write "&ty="
			Response.write ty
			Response.write """  target=""_self"">点击选择此客户</a></div></td>" & vbcrlf & "          <td width=""41%""><div align=""left"">　"
			...
			Response.write "" & vbcrlf & "                </div></td>" & vbcrlf & "                <td class=""name"">                 " & vbcrlf & "                  <div align=""center"">"
			if open_1_14=3 or CheckPurview(intro_1_14,trim(cateid))=True then
				Response.write " <a  href=""#"" onclick=""javascript:window.open('../work/content.asp?page="
				Response.write  CurrPage
				Response.write "&ord="
				Response.write pwurl(rs("ord"))
				Response.write " ','newwin2','width=' + 900 + ',height=' + 500 + ',scrollbars=1,toolbar=0,resizable=1,left=0,top=0,left=150,top=150')"" >查看此客户详情</a>"
				Response.write pwurl(rs("ord"))
			end if
			...
			rs.movenext
		loop
		Response.write " " & vbcrlf & "      </table>" & vbcrlf & "      <table width=""80%"" border=""0"" align=""center"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td><div align=""right""><span class=""black"">"
		...
		if currpage=1 then
			Response.write "" & vbcrlf & "        <span class=""black"">首页 上一页</span>" & vbcrlf & "        "
		else
			Response.write "" & vbcrlf & "        <a Href=""result8.asp?currPage="
			Response.write  1
			Response.write "&A="
			Response.write A
			Response.write "&B="
			...
			Response.write "&E="
			Response.write E
			Response.write """ class=""black"">首页</a> <a Href=""result8.asp?currPage="
			...
			Response.write "&E="
			Response.write E
			Response.write """ class=""black"">上一页</a>" & vbcrlf & "        "
		end if
		if currpage=rs.pagecount then
			Response.write "" & vbcrlf & "        <span class=""black"">下一页 尾页</span>" & vbcrlf & "        "
		else
			Response.write "" & vbcrlf & "        <a Href=""result8.asp?currPage="
			Response.write currpage + 1
			Response.write "" & vbcrlf & "        <a Href=""result8.asp?currPage="
			...
			Response.write "&E="
			Response.write E
			Response.write """ class=""black"">下一页</a> <a Href=""result8.asp?currPage="
			Response.write  rs.PageCount
			Response.write "&A="
			Response.write A
			Response.write "&B="
			...
			Response.write "&E="
			Response.write E
			Response.write """ class=""black"">尾页</a>" & vbcrlf & "        "
		end if
