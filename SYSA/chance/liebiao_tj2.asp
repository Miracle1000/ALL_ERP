...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	Response.write "               " & vbcrlf & "<table width=""100%"" border=""1"" cellpadding=""6"" cellspacing=""1"" bordercolor=""#cccccc"" bgcolor=""#C0CCDD"" id=""content"" style=""border-color:#ccc"">" & vbcrlf & " <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "             <td colspan=""2""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=""superSearch(2)""><u><font class=""advanSearch"" style=""background:#EFEFEF!important"">正常检索</font></u></a></td>" & vbcrlf & "       </tr>" & vbcrlf & "   <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff""><td><div align=""right"">领用情况：</div></td><td><input type=""checkbox"" name=""G"" value=""2"" />已领用<input type=""checkbox"" name=""G"" value=""0"" />未领用<input type=""checkbox"" name=""G"" value=""3"" />待审批<input type=""checkbox"" name=""G"" value=""1"" />全公开</td>"& vbcrlf &"      </tr>    "& vbcrlf &"         <tr> "& vbcrlf &"             <td rowspan=""2""><div align=""right"">人员选择：</div></td> "& vbcrlf &"       <td onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff""><input name=""B"" type=""radio"" value=""1"" checked=""checked"" /> "& vbcrlf & "      主负责人" & vbcrlf & "    <input type=""radio"" name=""B"" value=""2"" />" & vbcrlf & "    放弃人员" & vbcrlf & "    <input type=""radio"" name=""B"" value=""3"" />" & vbcrlf & "    添加人员" & vbcrlf & "    <input type=""radio"" name=""B"" value=""4"" />" & vbcrlf & "    添加人员和主负责人" & vbcrlf & "    <input type=""radio"" name=""B"" value=""5"" />" & vbcrlf & "    添加人员和放弃人员" & vbcrlf & "               </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">                       " & vbcrlf & "                <td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & " </tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td><div align=""right"">项目分类：</div></td>" & vbcrlf & "              <td>" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	sql="select ord,sort1 from sortonehy where gate2=24 order by gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "           <input type=""checkbox"" name=""D"" value="""
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & " </tr>  " & vbcrlf & " <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">项目状态：</div></td>" & vbcrlf & "              <td>" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "      </td>" & vbcrlf & "   </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">项目阶段：</div></td>" & vbcrlf & "      <td>" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from sortjh2 order by gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "              </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td><div align=""right"">项目来源：</div></td>" & vbcrlf & "      <td>" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "              </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "               <td><div align=""right"">项目地区：</div></td>" & vbcrlf & "              <td>"
	execute sdk.vbs("../manager/search_area" &  Application("__saas__company")  & ".asp")
	Response.write "</td>" & vbcrlf & " </tr> " & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=3 and set_open=1 and js=1 and sort=1 order by gate1 asc "
	rs.open sql,conn,1,1
	if rs.eof then
	else
		do until rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "     <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "               <td><div align=""right"">项目关键字：</div></td>" & vbcrlf & "            <td>" & vbcrlf & "                    <select name=""B2"">" & vbcrlf & "                          <option value=""xmzt"">项目主题</option>" & vbcrlf &"                   <option value=""xmbh"">项目编号</option>" & vbcrlf & "                    <option value=""xmgy"">项目概要</option>" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=3 and set_open=1 and js=1 and sort=2 order by gate1 asc "
	rs.open sql,conn,1,1
	if rs.eof then
	else
		do until rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "                     </select>" & vbcrlf & "                       <input name=""C2"" type=""text"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "    "
	call Show_Search_Extended(3)
	Dim arrShow()
	Dim arrName()
	Set rs=conn.execute("select (case when isnull(name,'')='' then oldname else name end ) as name, (case when show>0 then 1 else 0 end) as show,gate1 from setfields where gate1 in (1,19,21,12) order by gate1 asc ")
	While Not rs.eof
		intgate1=rs("gate1")
	...
	Response.write "：</div></td>" & vbcrlf & "<td><input name=""khmc"" type=""text"" size=""26.5""></td></tr>" & vbcrlf & ""
	If arrShow(12)=1 Then
		Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
		Response.write arrName(19)
		Response.write "：</div></td>" & vbcrlf & "<td><input name=""khdh"" type=""text"" size=""26.5""></td></tr>" & vbcrlf & ""
	end if
	If arrShow(21)=1 Then
		Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
		Response.write arrName(21)
		Response.write "：</div></td>" & vbcrlf & "<td><input name=""khcz"" type=""text"" size=""26.5""></td></tr>" & vbcrlf & ""
	end if
	If arrShow(12)=1 Then
		Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
		Response.write arrName(12)
		Response.write "：</div></td>" & vbcrlf & "<td><input name=""khdz"" type=""text"" size=""26.5""></td></tr>" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">发现日期：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=ret3 size=9  id=daysOfMonth3Pos readonly onmouseup=toggleDatePicker(""daysOfMonth3"",""date.ret3"") value="""
	Response.write m3
	Response.write """ readonly><DIV id=daysOfMonth3 style=""POSITION: absolute;z-index:10""></DIV>" & vbcrlf & "&nbsp;至：<INPUT name=ret4 size=9  id=daysOfMonth4Pos readonly onmouseup=toggleDatePicker(""daysOfMonth4"",""date.ret4"") value="""
	Response.write m3
	Response.write m4
	Response.write """ readonly><DIV id=daysOfMonth4 style=""POSITION: absolute""></DIV></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">预计成单日期：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=ret5 size=9 readonly  id=daysOfMonth5Pos onmouseup=toggleDatePicker(""daysOfMonth5"",""date.ret5"") value="""
	Response.write m5
	Response.write """ readonly><DIV id=daysOfMonth5 style=""POSITION: absolute;z-index:10""></DIV>" & vbcrlf & "&nbsp;至：<INPUT name=ret6 size=9 readonly  id=daysOfMonth6Pos onmouseup=toggleDatePicker(""daysOfMonth6"",""date.ret6"") value="""
	Response.write m5
	Response.write m6
	Response.write """ readonly><DIV id=daysOfMonth6 style=""POSITION: absolute""></DIV></td></tr>" & vbcrlf & " <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "               <td><div align=""right"">添加日期：</div></td>" & vbcrlf & "              <td>&nbsp;自：<INPUT name=ret size=9  readonly id=daysOfMonthPos onmouseup=toggleDatePicker(""daysOfMonth"",""date.ret"") value="""
	Response.write m1
	Response.write """ readonly><DIV id=daysOfMonth style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<INPUT name=ret2 size=9 readonly  id=daysOfMonth2Pos onmouseup=toggleDatePicker(""daysOfMonth2"",""date.ret2"") value="""
	Response.write m1
	Response.write m2
	Response.write """ readonly><DIV id=daysOfMonth2 style=""POSITION: absolute""></DIV></td>" & vbcrlf & "      </tr>" & vbcrlf & "   <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "               <td width=""10%"">&nbsp;</td>" & vbcrlf & "               <td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
