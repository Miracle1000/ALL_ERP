...
function chtotal(id,num_dot_xs)
{
	...
	var price_cb= document.getElementById("price_cb_"+id);
	var num= document.getElementById("num"+id);
	if (document.getElementById("hl_"+id)){
		var hl= document.getElementById("hl_"+id);
		var money1=price.value.replace(/\,/g,'') * num.value.replace(/\,/g,'') * hl.value.replace(/\,/g,'');
		var moneycb=price_cb.value.replace(/\,/g,'') * num.value.replace(/\,/g,'') * hl.value.replace(/\,/g,'');
	}
	else{
		var money1=price.value.replace(/\,/g,'') * num.value.replace(/\,/g,'');
		var moneycb=price_cb.value.replace(/\,/g,'') * num.value.replace(/\,/g,'');
	}
	var moneyall= document.getElementById("moneyall"+id);
	var moneyall_cb= document.getElementById("money_cb_"+id);
	moneyall_cb.value=FormatNumber(moneycb,num_dot_xs);
