...
'bigsystemtype = ".mozi"
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style>" & vbcrlf & "html{" & vbcrlf & "scrollbar-3dlight-color:#d0d0e8;" & vbcrlf & "scrollbar-highlight-color:#fff;" & vbcrlf & "scrollbar-face-color:#f0f0ff;" & vbcrlf & "scrollbar-arrow-color:#c0c0e8;" & vbcrlf & "scrollbar-shadow-color:#d0d0e8;" & vbcrlf & "scrollbar-darkshadow-color:#fff;" & vbcrlf & "scrollbar-base-color:#ffffff;" & vbcrlf & "scrollbar-track-color:#fff;" & vbcrlf & "}" & vbcrlf & "#cp_search{" & vbcrlf & " width:211px!important;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "html,body{height:100%;}" & vbcrlf & ".page2 div{" & vbcrlf & "       width:203px;" & vbcrlf & "}" & vbcrlf & "#cpB{margin-top:-1px;}" & vbcrlf & "#productTree{" & vbcrlf & "        overflow-y:hidden !important;" & vbcrlf & "   margin-bottom:-20px;" & vbcrlf & "    padding-bottom:20px;" & vbcrlf & "}" & vbcrlf & ".pro-menu-wrap{" & vbcrlf & "    width: 213px!important;" & vbcrlf & "}" & vbcrlf & ".resetBorderColor.resetTransparent{" & vbcrlf & "       border:0!important;" & vbcrlf & "}" & vbcrlf & "</style>" & vbcrlf & "<body onmouseover=""try{ContinueMovePannel(event,1)}catch(e){};"" onmouseup=""try{ContinueMovePannel(event,0)}catch(e){};"" style=""OVERFLOW-y:scroll;OVERFLOW-X:HIDDEN;background:#fff!important"">" & vbcrlf & ""
	Response.write Application("sys.info.jsver")
