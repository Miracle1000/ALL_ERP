...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "form{padding:0px; margin:0px;}" & vbcrlf & "#tabmx a img{border:none;}" & vbcrlf & "</style>" & vbcrlf & "<script src= ""../Script/cC_add.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "</head>" & vbcrlf & "<body onresize=""setMXdiv()"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top""><input type=""hidden"" id=""I1"" />" & vbcrlf & ""
	session("caigouzbintel")=""
	dim actinon1
	action1="质检申请"
	sql="Delete caigouQC where addcate="&session("personzbintel2007")&" and del=7"
	conn.Execute(sql)
	If IsNumeric(request("top")) Then
		top=request("top")
	else
		top=deurl(request("top"))
	end if
	if top&"" <>"" then
		session("caigouzbintel")=top
	end if
	Response.write "" & vbcrlf & "<table class=""resetTableBg"" width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td class=""place"">质检申请</td>" & vbcrlf & "    <td>&nbsp;</td>" & vbcrlf & "    <td align=""right"">&nbsp;</td>"& vbcrlf & "    <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table> " & vbcrlf & "<form method=""POST"" action=""save.asp?ord="
	Response.write rd
	Response.write "&ty="
	Response.write ty
	Response.write """ id=""demo"" onsubmit=""return Validator.Validate(this,2)&&checkAllMX();"" name=""date"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""4"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "       <td colspan=""6"" background=""../images/m_table_top.jpg""><div align=""right"">" & vbcrlf & "         <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>        " & vbcrlf & "         <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "         <input type=""hidden"" name=""top"" value="""
	Response.write top
	Response.write """>" & vbcrlf & "       </div></td>" & vbcrlf & "       </tr>" & vbcrlf & "    <tr>" & vbcrlf & "        <td width=""12%"" align=""right"">关联采购：</td>" & vbcrlf & "        <td width=""21%"">" & vbcrlf & "        <IFRAME name=""I2"" SRC=""../event/caigouQC.asp"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""190"" HEIGHT=""22"" marginwidth=""1"" marginheight=""1""></IFRAME>" & vbcrlf & "        <span id=""caigou_info""><input type=""hidden"" name=""caigou"" id=""caigou""></span>" & vbcrlf & "        </td>" & vbcrlf & "        <td width=""12%"" align=""right"">关联供应商：</td>" & vbcrlf & "        <tdwidth=""21%""><span id=""gys_info""><input name=""gys"" id=""gys"" type=""text"" size=""15"" readonly></span></tdwidth=>" & vbcrlf & "        <td width=""12%"" align=""right"">申请日期：</td>" & vbcrlf & "        <td width=""21%""><INPUT name=""date1"" type=""text"" size=""10"" value="""
	Response.write date
	Response.write """ onclick=""javascript:datedlg.show();"" readonly dataType=""Date"" format=""ymd"" min=""1"" msg=""日期格式不正确"">" & vbcrlf & "           <span class=""red"">*</span>" & vbcrlf & "                </td>" & vbcrlf & "     </tr>" & vbcrlf & "     "
	Response.write getExtended(28,0)
	Response.write "" & vbcrlf & "   <tr class=""top"">" & vbcrlf & "      <td colspan=""6"" height=""30"">" & vbcrlf & "       <strong class=""blue2"" style=""margin-left:10px;"">来料质检明细信息</strong>" & vbcrlf & "           <input type=""button"" class=""anybutton"" value=""批量删除"" style=""margin-left:10px;"" onClick=""delMXitems()"">" & vbcrlf & "      </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td colspan=""6"" align=""center"">" & vbcrlf & "      <div id=""qcmx"" style=""text-align:left;width:100%"" onresize=""setMXdiv()"" onload='loadQCMX()'></div>" & vbcrlf & "      </td>" & vbcrlf & "  </tr>" & vbcrlf & "   <tr>" & vbcrlf & "                <td width=""12%"" align=""right"">概&nbsp;&nbsp;要：</td>" & vbcrlf & "               <td colspan=""5"">" & vbcrlf & "        <textarea name=""intro"" style=""display:none"" cols=""1"" rows=""1"">"
	if intro<>"" then Response.write intro
	Response.write "</textarea><IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=intro&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME>" & vbcrlf & "        </td>" & vbcrlf & "    </tr>" & vbcrlf & "    "
	Response.write getExtended1(28,0)
	Response.write "" & vbcrlf & "    <tr>" & vbcrlf & "        <td height=""37"" colspan=""6""  align=""center"">" & vbcrlf & "          <input type=""submit"" name=""Submit42"" value=""保存""  class=""page""/>　　　　　　          " & vbcrlf & "          <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" &vbcrlf & "        </td>" & vbcrlf & "    </tr>   " & vbcrlf & "    </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</form> " & vbcrlf & ""
	call close_list(1)
