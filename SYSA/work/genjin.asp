...
'Private Sub Class_Initialize
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script src= ""../Script/wk_genjin.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  type=""text/javascript""></script>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & ""
	dim MODULES, m_uid
	MODULES=session("zbintel2010ms")
	m_uid = session("personzbintel2007")
	...
	C=request("C")
	C1=request("C1")
	time1=clng(request("time1"))
	E=request("sort")
	F=request("sort1")
	m=request("m")
	needdp=request("needdp")
	khjz = Request("khjz")
	khhy = Request("khhy")
	khly = Request("khly")
	gjfs = Request("gjfs")
	dpTime1 = Request("dpTime1")
	dpTime2 = Request("dpTime2")
	gjTime1 = Request("gjTime1")
	gjTime2 = Request("gjTime2")
	gjfl = Request("gjfl")
	sType = Request("sType")
	...
	If gjfl <> "" And gjfl <> "0" Then
		If gjfl="100000" Then gjfl = ""
		sort_lm = gjfl
	else
		sort_lm=request("sort_lm")
	end if
	If khjz <> "" Then
		Str_Result2 = Str_Result2 & " AND ord IN (SELECT ord FROM tel WHERE jz IN ("& khjz &") ) "
	end if
	If khhy <> "" Then
		Str_Result2 = Str_Result2 & " AND ord IN (SELECT ord FROM tel WHERE trade IN ("& khhy &") ) "
	end if
	If khly <> "" Then
		Str_Result2 = Str_Result2 & " AND ord IN (SELECT ord FROM tel WHERE ly IN ("& khly &") ) "
	end if
	If searchType = "1" Then
		...
		If F2 <> "" Then
			Select Case F1
			Case 1
			tel_Result = tel_Result & " AND e.name LIKE '%"& F2 &"%' "
			Case 2
			tel_Result = tel_Result & " AND e.name NOT LIKE '%"& F2 &"%' "
			Case 3
			tel_Result = tel_Result & " AND e.name = '"& F2 &"' "
			Case 4
			tel_Result = tel_Result & " AND e.name <> '"& F2 &"' "
			Case 5
			tel_Result = tel_Result & " AND e.name LIKE '"& F2 &"%' "
		...
		If S2 <> "" Then
			Select Case S1
			Case 1
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM person WHERE name LIKE '%"& S2 &"%') AND sort1 = 8) "
			Case 2
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM person WHERE name NOT LIKE '%"& S2 &"%') AND sort1 = 8) "
			Case 3
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM person WHERE name = '"& S2 &"') AND sort1 = 8) "
			Case 4
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM person WHERE name <> '"& S2 &"') AND sort1 = 8) "
			Case 5
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM person WHERE name LIKE '"& S2 &"%') AND sort1 = 8) "
		...
		If G2 <> "" Then
			Select Case G1
			Case 1
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM chance WHERE title LIKE '%"& G2 &"%') AND sort1 = 2) "
			Case 2
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM chance WHERE title NOT LIKE '%"& G2 &"%') AND sort1 = 2) "
			Case 3
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM chance WHERE title = '"& G2 &"') AND sort1 = 2) "
			Case 4
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM chance WHERE title <> '"& G2 &"') AND sort1 = 2) "
			Case 5
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM chance WHERE title LIKE '"& G2 &"%') AND sort1 = 2) "
		...
		If H2 <> "" Then
			Select Case H1
			Case 1
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM price WHERE title LIKE '%"& H2 &"%') AND sort1 = 3) "
			Case 2
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM price WHERE title NOT LIKE '%"& H2 &"%') AND sort1 = 3) "
			Case 3
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM price WHERE title = '"& H2 &"') AND sort1 = 3) "
			Case 4
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM price WHERE title <> '"& H2 &"') AND sort1 = 3) "
			Case 5
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM price WHERE title LIKE '"& H2 &"%') AND sort1 = 3) "
		...
		If I2 <> "" Then
			Select Case I1
			Case 1
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM contract WHERE title LIKE '%"& I2 &"%') AND sort1 = 4) "
			Case 2
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM contract WHERE title NOT LIKE '%"& I2 &"%') AND sort1 = 4) "
			Case 3
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM contract WHERE title = '"& I2 &"') AND sort1 = 4) "
			Case 4
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM contract WHERE title <> '"& I2 &"') AND sort1 = 4) "
			Case 5
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM contract WHERE title LIKE '"& I2 &"%') AND sort1 = 4) "
		...
		If J2 <> "" Then
			Select Case J1
			Case 1
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM tousu WHERE title LIKE '%"& J2 &"%') AND sort1 = 6) "
			Case 2
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM tousu WHERE title NOT LIKE '%"& J2 &"%') AND sort1 = 6) "
			Case 3
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM tousu WHERE title = '"& J2 &"') AND sort1 = 6) "
			Case 4
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM tousu WHERE title <> '"& J2 &"') AND sort1 = 6) "
			Case 5
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM tousu WHERE title LIKE '"& J2 &"%') AND sort1 = 6) "
		...
		If K2 <> "" Then
			Select Case K1
			Case 1
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM caigou WHERE title LIKE '%"& K2 &"%') AND sort1 = 5) "
			Case 2
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM caigou WHERE title NOT LIKE '%"& K2 &"%') AND sort1 = 5) "
			Case 3
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM caigou WHERE title = '"& K2 &"') AND sort1 = 5) "
			Case 4
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM caigou WHERE title <> '"& K2 &"') AND sort1 = 5) "
			Case 5
			Str_Result2 = Str_Result2 & " AND (ord2 IN (SELECT ord FROM caigou WHERE title LIKE '"& K2 &"%') AND sort1 = 5) "
		...
		If L2 <> "" Then
			Select Case L1
			Case 1
			Str_Result2 = Str_Result2 & " AND intro LIKE '%"& L2 &"%' "
			Case 2
			Str_Result2 = Str_Result2 & " AND intro NOT LIKE '%"& L2 &"%' "
			Case 3
			Str_Result2 = Str_Result2 & " AND intro = '"& L2 &"' "
			Case 4
			Str_Result2 = Str_Result2 & " AND intro <> '"& L2 &"' "
			Case 5
			Str_Result2 = Str_Result2 & " AND intro LIKE '"& L2 &"%' "
		...
		If N2 <> "" Then
			Select Case N1
			Case 1
			Str_Result2 = Str_Result2 & " AND id IN (SELECT ord FROM dianping WHERE intro LIKE '%"& N2 &"%') "
			Case 2
			Str_Result2 = Str_Result2 & " AND id IN (SELECT ord FROM dianping WHERE intro NOT LIKE '%"& N2 &"%') "
			Case 3
			Str_Result2 = Str_Result2 & " AND id IN (SELECT ord FROM dianping WHERE intro = '"& N2 &"') "
			Case 4
			Str_Result2 = Str_Result2 & " AND id IN (SELECT ord FROM dianping WHERE intro <> '"& N2 &"') "
			Case 5
			Str_Result2 = Str_Result2 & " AND id IN (SELECT ord FROM dianping WHERE intro LIKE '"& N2 &"%') "
		...
		If sort4 <> "" Then
			tel_Result = tel_Result & " AND e.sort IN ("& sort4 &") "
		end if
		If sort5 <> "" Then
			tel_Result = tel_Result & " AND e.sort1 IN ("& sort5 &") "
		end if
		A2=Replace(Request("A2")," ","")
		If A2 <> "" Then
			Set rsf = conn.Execute("SELECT khqy = dbo.GetMenuArea('"& A2 &"','menuarea')")
			If Not rsf.eof Then
				A2 = rsf(0)
			end if
			rsf.Close
		...
		If A2 <> "" Then
			tel_Result = tel_Result & " AND e.area IN ("& A2 &") "
		end if
	end if
	...
	strW3=getLimitedW3(strW3,2,1,0, m_uid )
	...
	if strW1&""<>"" then W1=strW1
	if strW2&""<>"" then W2=strW2
	if strW3&""<>"" then W3=strW3
	if strW4&""<>"" then W4=strW4
	If W4 <> "" Then
		Select Case personType
		Case 1
		Str_Result2 = Str_Result2 & " AND cateid IN ("& W3 &") "
		Case 2
		Str_Result2 = Str_Result2 & " AND id IN (SELECT ord FROM dianping WHERE cateid IN ("& W3 &"))"
		Case 3
		Str_Result2 = Str_Result2 & " AND ( cateid IN ("& W3 &") OR id IN (SELECT ord FROM dianping WHERE cateid IN ("& W3 &")) ) "
		End Select
	end if
	if sort_lm="" then
		sort_lm=0
	end if
	if sort_lm<>"0" AND sort_lm<>"" then
		Str_Result=Str_Result+"and  sort1 IN ("&sort_lm&") "
'if sort_lm<>"0" AND sort_lm<>"" then
		Str_Result2=Str_Result2+"and  sort1 IN ("&sort_lm&")"
'if sort_lm<>"0" AND sort_lm<>"" then
	end if
	if sort_lm="1" then
		sort_lmname="客户跟进"
		sort_lmname=sort_lmname&">>"
	elseif sort_lm="2" then
		sort_lmname="项目跟进"
		sort_lmname=sort_lmname&">>"
	elseif sort_lm="3" then
		sort_lmname="报价跟进"
		sort_lmname=sort_lmname&">>"
	elseif sort_lm="4" then
		sort_lmname="合同跟进"
		sort_lmname=sort_lmname&">>"
	elseif sort_lm="5" then
		sort_lmname="采购跟进"
		sort_lmname=sort_lmname&">>"
	elseif sort_lm="6" then
		sort_lmname="售后跟进"
		sort_lmname=sort_lmname&">>"
	elseif sort_lm="7" then
		sort_lmname="退货跟进"
		sort_lmname=sort_lmname&">>"
	elseif sort_lm="8" then
		sort_lmname="联系人跟进"
		sort_lmname=sort_lmname&">>"
	elseif sort_lm="75" then
		sort_lmname="采购退货跟进"
		sort_lmname=sort_lmname&">>"
	elseif sort_lm="102001" then
		sort_lmname="投诉跟进"
		sort_lmname=sort_lmname&">>"
	elseif sort_lm="102002" then
		sort_lmname="建议跟进"
		sort_lmname=sort_lmname&">>"
	end if
	if time1=9 then
		Str_Result=Str_Result+"and  time1<12"
'if time1=9 then
		Str_Result2=Str_Result2+"and time1<12"
'if time1=9 then
		sw="上午"
...
'elseif time1=15 then
	...
	if m1<>"" then
		Str_Result=Str_Result+" and date7>='"&m1&"' "
'if m1<>"" then
		Str_Result2=Str_Result2+" and date7>='"&m1&"' "
'if m1<>"" then
	end if
	if m2<>"" then
		Str_Result=Str_Result+" and date7<='"&cdate(m2)+1&"' "
'if m2<>"" then
		Str_Result2=Str_Result2+" and date7<='"&cdate(m2)+1&"' "
'if m2<>"" then
	end if
	if m<>"" then
		Str_Result=Str_Result+" and datepart(hh,date7)="&m&""
'if m<>"" then
		Str_Result2=Str_Result2+" and datepart(hh,date7)="&m&" "
'if m<>"" then
	end if
	if W1<>"" And personType = "" then
		Str_Result=Str_Result+" and  cateid2 in ("&W1&")"
'if W1<>"" And personType = "" then
		Str_Result2=Str_Result2+" and  cateid2 in ("&W1&")"
'if W1<>"" And personType = "" then
	end if
	if W2<>"" And personType = "" then
		Str_Result=Str_Result+" and  cateid3 in ("&W2&")"
'if W2<>"" And personType = "" then
		Str_Result2=Str_Result2+" and  cateid3 in ("&W2&")"
'if W2<>"" And personType = "" then
	end if
	if W3<>"" And personType = "" then
...
'if W3<>"" And personType = "" then
	...
	gj_Result=""
	if E<>"" then
		gj_Result=gj_Result+" and gj1='"&E&"' "
'if E<>"" then
	end if
	if F<>"" then
		gj_Result=gj_Result+" and gj2='"&F&"' "
'if F<>"" then
	end if
	dim newstate
	newstate=trim(request("newstate"))
	if newstate="1" then
		tel_Result=tel_Result&" and e.sort3=1 "
		Str_Result2=Str_Result2&"  and id1 is null AND ISNULL(alt,0) = 0 "
		set rs9=server.CreateObject("adodb.recordset")
		sql9="select ord,intro,num1,tq1,fw1 from setjm2  where ord=32  and cateid="& m_uid &""
		rs9.open sql9,conn,1,1
		if rs9.eof then
		else
			if rs9("fw1")="1" Then
				gj_Result=gj_Result&" and cateid="& m_uid &" "
			end if
		end if
		rs9.close
		set rs9=nothing
	end if
	dim link,area,ly,trade,jz
	link=trim(request("link"))
	B=trim(request("B"))
	area=trim(request("area"))
	ly=trim(request("ly"))
	trade=trim(request("trade"))
	jz=trim(request("jz"))
	if link="yes" then
		tel_Result=tel_Result &" and e.ord in (select isnull(ord,0) from tel where sort3=1 and del=1)"
		if area<>"" then
			area = replace(area," ","")
			if right(area,1)="," then
				area = left(area,len(area)-1)
'if right(area,1)="," then
			end if
			tel_Result=tel_Result &" and e.area in ("& area &")"
		end if
		if ly<>"" then
			tel_Result=tel_Result &" and e.ly in ("& ly &")"
		end if
		if trade<>"" then
			tel_Result=tel_Result &" and e.trade in ("& trade &")"
		end if
		if jz<>"" then
			tel_Result=tel_Result &" and e.jz in ("& jz &")"
		end if
		if C<>"" and C<>"客户名称" then
			if B="name" then
				tel_Result=tel_Result &" and e.name like '%"& C &"%'"
			elseif B="pym" then
				tel_Result=tel_Result &" and e.pym like '%"& C &"%'"
			elseif B="phone" then
				tel_Result=tel_Result &" and e.phone like '%"& C &"%'"
			elseif B="product" then
				tel_Result=tel_Result &" and e.product like '%"& C &"%'"
			elseif B="zdy1" then
				tel_Result=tel_Result &" and e.zdy1 like '%"& C &"%'"
			elseif B="zdy2" then
				tel_Result=tel_Result &" and e.zdy2 like '%"& C &"%'"
			elseif B="zdy3" then
				tel_Result=tel_Result &" and e.zdy3 like '%"& C &"%'"
			elseif B="zdy4" then
				tel_Result=tel_Result &" and e.zdy4 like '%"& C &"%'"
			elseif B="fax" then
				tel_Result=tel_Result &" and e.fax like '%"& C &"%'"
			elseif B="address" then
				tel_Result=tel_Result &" and e.address like '%"& C &"%'"
			elseif B="intro" then
				tel_Result=tel_Result &" and e.intro like '%"& C &"%'"
			elseif B="zip" then
				tel_Result=tel_Result &" and e.zip like '%"& C &"%'"
			end if
		end if
		If gjfs <> "" Then
			tel_Result=tel_Result+"AND sort98s IN ("& gjfs &")"
'If gjfs <> "" Then '
		end if
		If sort_lm <> "" And sort_lm <> "0" Then
		end if
		If keywords <> "" Then
			If sType = "1" Then
				tel_Result=tel_Result+" AND e.name LIKE '%"& keywords &"%' "
'If sType = "1" Then
			ElseIf sType = "2" Then
				Str_Result2 = Str_Result2 & " AND intro LIKE '%"& keywords &"%' "
			end if
		end if
	else
		if C<>"客户名称" then
...
'If gjfs <> "" Then
		...
		If Len(needdp)>0 And isnumeric(needdp)=True Then
			tel_Result=tel_Result + " and e.ord in(select ord from dianping where sort=1) "
'If Len(needdp)>0 And isnumeric(needdp)=True Then
		end if
		If request("H")="30" Then
			Str_Result2=Str_Result2 + " and sort1=1 "
'If request("H")="30" Then
		end if
		If keywords <> "" Then
			If sType = "1" Then
...
'If sType = "1" Then
	...
	normalCate=""
	if inStr(Request.ServerVariables("Http_Referer")&"","PersonnelComparison.ashx")>0 then
		Str_Result2 = Str_Result2 & " AND f.cateidDel =1 "
		normalCate="?normalCate=1"
	end if
	dim W1name,W2name,W3name,sort,sort1
	W1name=""
	W2name=""
	W3name=""
	sort=""
	...
	if W1<>"" And personType = "" Then
		set rs=server.CreateObject("adodb.recordset")
		sql="select top 1 ord,sort1 from  gate1 where ord in ("& W1 &")"
	...
	if W2<>"" And personType = "" then
		set rs=server.CreateObject("adodb.recordset")
		sql="select top 1 ord,sort2 from  gate2 where ord in ( "&W2&") "
		rs.open sql,conn,3,1
		If Not rs.Eof Then
			W2name=rs("sort2")
			W2name=W2name&">>"
	...
	if W3<>"" And personType = "" then
		set rs=server.CreateObject("adodb.recordset")
		sql="select top 1 ord,name from  gate where ord in ("&W3&")"
	...
	if E<>"" then
		set rs=server.CreateObject("adodb.recordset")
		sql="select ord,sort1 from  sort4 where ord="&E&""
		rs.open sql,conn,3,1
		If Not rs.Eof Then
			sort=rs("sort1")
			sort=sort&">>"
	...
	if F<>"" then
		set rs=server.CreateObject("adodb.recordset")
		sql="select ord,sort1,sort2 from  sort5 where ord="&F&""
		rs.open sql,conn,3,1
		If Not rs.Eof Then
			sort1=rs("sort2")
			sort1=sort1&">>"
	...
	If remind <> "" Then
		Set helper = CreateReminderHelper(conn,154,0)
		Str_Result3 = Str_Result3 & " where id in (" & helper.listSQL("ids") & ")"
	end if
	Response.write "" & vbcrlf & "              <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">客户跟进情况（"
	Response.write sw
	Response.write "）</td>" & vbcrlf & "    <td align=""right"">" & vbcrlf & "   "
	if powerdetail(1,7) then
		Response.write "<input type=""button"" name=""Submit43"" value="" 打印 "" onClick=""window.print()"" class=""anybutton2"">" & vbcrlf & "        "
	end if
	Response.write "&nbsp;&nbsp;" & vbcrlf & "  "
	if powerdetail(1,10) then
		Response.write "" & vbcrlf & "      <input type=""button"" name=""Submitdel2"" value="" 导出 "" onClick=""if (confirm('确认将统计结果导出为EXCEL文档？')) { exportExcel({ debug: false, page:'../out/xls_genjin.asp"
		Response.write normalCate
		Response.write "'});}"" class=""anybutton2""/>&nbsp;&nbsp;" & vbcrlf & "      "
	end if
	Response.write "" & vbcrlf & "" & vbcrlf & "      </td>" & vbcrlf & "    <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table><form method=""get"" action=""genjin.asp"" id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"" style='display:inline'>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""margin-bottom:-1px;"">" & vbcrlf & "   <tr>" & vbcrlf & "            <td id=""quickSearch"" valign=""middle"" style='height:55px;line-height:55px;background:#f4fafe' align=""right""><strong>"
	Response.write sort_lmname
	Response.write W1name
	Response.write W2name
	Response.write W3name
	Response.write sort
	Response.write sort1
	Response.write "</strong>" & vbcrlf & "                     <input name=""W1"" type=""hidden""  value="""
	Response.write W1
	Response.write """><input name=""W2"" type=""hidden""  value="""
	Response.write W2
	Response.write """><input name=""W3"" type=""hidden""  value="""
	Response.write W3
	Response.write """><input name=""sort"" type=""hidden""  value="""
	Response.write E
	Response.write """><input name=""F"" type=""hidden""  value="""
	Response.write sort1
	Response.write """><input name=""sort_lm"" type=""hidden""  value="""
	Response.write sort_lm
	Response.write """>" & vbcrlf & "          自：<INPUT name=""ret"" size=""9"" readonly id=""daysOfMonthPos"" onmouseup=""toggleDatePicker('daysOfMonth','date.ret')"" value="""
	Response.write m1
	Response.write """><DIV id=daysOfMonth style=""POSITION: absolute""></DIV>&nbsp;至：<INPUT name=""ret2"" size=""9"" readonly id=""daysOfMonth2Pos"" onmouseup=""toggleDatePicker('daysOfMonth2','date.ret2')"" value="""
	Response.write m2
	Response.write """>" & vbcrlf & "                         <DIV id=""daysOfMonth2"" style=""POSITION: absolute""></DIV>" & vbcrlf & "<SCRIPT language=JavaScript1.2>" & vbcrlf & "    function Cancel() {" & vbcrlf & "            hideElement(""daysOfMonth"");" & vbcrlf & "    }" & vbcrlf & "</SCRIPT>" & vbcrlf & "<SCRIPT language=JavaScript1.2>" & vbcrlf & "<!--" & vbcrlf & "hideElement('daysOfMonth');" & vbcrlf & "hideElement('daysOfMonth2');" & vbcrlf & "//-->" & vbcrlf & "</SCRIPT>" & vbcrlf & "" & vbcrlf & "<select name=""gjfs"">" & vbcrlf & "      <option value="""">跟进方式</option>" & vbcrlf & "    "
	Response.write m2
	Set rs = server.CreateObject("adodb.recordset")
	sql = "SELECT id,sort1 FROM sortonehy WHERE gate2 = 98 ORDER BY gate1 DESC "
	...
	rs.close
	set rs = nothing
	Response.write "" & vbcrlf & "</select>" & vbcrlf & "<select name=""gjfl"">" & vbcrlf & "  <option value=""100000"">跟进分类</option>" & vbcrlf & "    "
	If ZBRuntime.MC(1000) Then
		Response.write "" & vbcrlf & "    <option value=""1"" "
		If gjfl = "1" Then Response.write("selected")
		Response.write ">客户跟进</option>" & vbcrlf & "    "
	end if
	If ZBRuntime.MC(3000) Then
		Response.write "" & vbcrlf & "    <option value=""2"" "
		If gjfl = "2" Then Response.write("selected")
		Response.write ">项目跟进</option>" & vbcrlf & "    "
	end if
	If ZBRuntime.MC(4000) Then
		Response.write "" & vbcrlf & "    <option value=""3"" "
		If gjfl = "3" Then Response.write("selected")
		Response.write ">报价跟进</option>" & vbcrlf & "    "
	end if
	If ZBRuntime.MC(7000) Then
		Response.write "" & vbcrlf & "    <option value=""4"" "
		If gjfl = "4" Then Response.write("selected")
		Response.write ">合同跟进</option>" & vbcrlf & "    "
	end if
	If ZBRuntime.MC(15000) Then
		Response.write "" & vbcrlf & "    <option value=""5"" "
		If gjfl = "5" Then Response.write("selected")
		Response.write ">采购跟进</option>" & vbcrlf & "    "
	end if
	If ZBRuntime.MC(9000) Then
		Response.write "" & vbcrlf & "    <option value=""6"" "
		If gjfl = "6" Then Response.write("selected")
		Response.write ">售后跟进</option>" & vbcrlf & "    "
	end if
	If ZBRuntime.MC(8000) Then
		Response.write "" & vbcrlf & "    <option value=""7"" "
		If gjfl = "7" Then Response.write("selected")
		Response.write ">退货跟进</option>" & vbcrlf & "    "
	end if
	If ZBRuntime.MC(2000) Then
		Response.write "" & vbcrlf & "    <option value=""8"" "
		If gjfl = "8" Then Response.write("selected")
		Response.write ">联系人跟进</option>" & vbcrlf & "    "
	end if
	If ZBRuntime.MC(9003) Then
		Response.write "" & vbcrlf & "    <option value=""102001"" "
		If gjfl = "102001" Then Response.write("selected")
		Response.write ">投诉跟进</option>" & vbcrlf & "    "
	end if
	If ZBRuntime.MC(9004) Then
		Response.write "" & vbcrlf & "    <option value=""102002"" "
		If gjfl = "102002" Then Response.write("selected")
		Response.write ">建议跟进</option>" & vbcrlf & "    "
	end if
	...
	Response.write ">客户名称</option>" & vbcrlf & "   <option value=""2"" "
	If sType = "2" Then Response.write("selected")
	Response.write ">洽谈进展</option>" & vbcrlf & "</select>" & vbcrlf & "" & vbcrlf & "<input type=""text"" name=""keywords"" value="""
	Response.write keywords
	Response.write """ size=""10"">" & vbcrlf & "<input type=""hidden"" name=""khjz"" value="""
	Response.write khjz
	Response.write """ />" & vbcrlf & "<input type=""hidden"" name=""khhy"" value="""
	Response.write khhy
	Response.write """ />" & vbcrlf & "<input type=""hidden"" name=""khly"" value="""
	Response.write khly
	Response.write """ />" & vbcrlf & "<input type=""hidden"" name=""link"" value="""
	Response.write link
	Response.write """ />" & vbcrlf & "<input type=""submit"" name=""Submit422"" value=""检索""  class=""anybutton2""/>" & vbcrlf & "<a href=""javascript:void(0);"" class=""zb-swith-btn AfterQuickSearch""><img src=""../images/icon_title.gif"" width=""5"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a></td>" & vbcrlf & "        </tr>" & vbcrlf & "</table></form>" & vbcrlf & "<div id=""advanced""></div>" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "  <tr class=""top"">" & vbcrlf & "    <td align=""center""width=""5%""><div align=""center""><strong>序号</strong></div></td> "& vbcrlf &"         <td height=""27"" width=""20%""><div align=""center""><strong>客户名称</strong></div></td> "& vbcrlf &"           <td width=""12%""><div align=""center""><strong>联系时间</strong></div></td> "& vbcrlf &"     <td width=""8%""><div align=""center""><strong>跟进方式</strong></div></td>" & vbcrlf & "       <td width=""54%""><div align=""center""><strong>洽谈进展</strong></div></td>" & vbcrlf & "  </tr>" & vbcrlf & ""
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open from power where ord="& m_uid &" and sort1=1 and sort2=7"
	...
	rs1.close
	sql1="select qx_open from power where ord="& m_uid &" and sort1=1 and sort2=10"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_1_10=0
	else
	...
	rs1.close
	sql1="select qx_open,qx_intro from power where ord="& m_uid &" and sort1=1 and sort2=1"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_1_1=0
		intro_1_1=0
	...
	rs1.close
	sql1="select qx_open,qx_intro from power where ord="& m_uid &" and sort1=1 and sort2=14"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_1_14=0
		intro_1_14=0
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& m_uid &" and sort1=2 and sort2=14"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_2_14=0
		intro_2_14=0
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& m_uid &" and sort1=3 and sort2=14"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_3_14=0
		intro_3_14=0
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& m_uid &" and sort1=4 and sort2=14"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_4_14=0
		intro_4_14=0
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& m_uid &" and sort1=5 and sort2=14"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_5_14=0
		intro_5_14=0
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& m_uid &" and sort1=22 and sort2=14"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_22_14=0
		intro_22_14=0
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& m_uid &" and sort1=42 and sort2=14"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_42_14=0
		intro_42_14=0
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& m_uid &" and sort1=41 and sort2=14"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_41_14=0
		intro_41_14=0
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& m_uid &" and sort1=95 and sort2=14"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_95_14=0
		intro_95_14=0
	else
		open_95_14=rs1("qx_open")
		intro_95_14=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& m_uid &" and sort1=96 and sort2=14"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_96_14=0
		intro_96_14=0
	else
		open_41_96=rs1("qx_open")
		intro_96_14=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& m_uid &" and sort1=1 and sort2=11"
	rs1.open sql1,conn,3,1
	if rs1.eof then
		open_1_11=0
		intro_1_11=0
	...
	str18=""
	str19=""
	if not (ZBRuntime.MC(12001) and ZBRuntime.MC(1000)) then    str11=" and 1=2"
	if not (ZBRuntime.MC(12002) and ZBRuntime.MC(2000)) then    str18=" and 1=2"
	if not (ZBRuntime.MC(12003) and ZBRuntime.MC(3000)) then    str12=" and 1=2"
	if not (ZBRuntime.MC(12004) and ZBRuntime.MC(4000)) then    str13=" and 1=2"
	if not (ZBRuntime.MC(12006) and ZBRuntime.MC(7000)) then    str14=" and 1=2"
	if not (ZBRuntime.MC(12010) and ZBRuntime.MC(15000)) then str15=" and 1=2"
	if not (ZBRuntime.MC(12007) and ZBRuntime.MC(9000)) then    str16=" and 1=2"
	if not (ZBRuntime.MC(12008) and ZBRuntime.MC(8000)) then    str17=" and 1=2"
	if not ZBRuntime.MC(16000) then     str19=" and 1=2"
	if not (ZBRuntime.MC(12000) and ZBRuntime.MC(9003))  then   str20=" and 1=2"
	if not (ZBRuntime.MC(12000) and ZBRuntime.MC(9004))  then   str21=" and 1=2"
	set rs=server.CreateObject("adodb.recordset")
	sql="select ISNULL(alt,0) alt1,isnull(rid,-1) remindId,isnull(isCanceled,0) isCanceled,c.* from ("&_
	"select * from ("&_
	"select r.id,r.id1,r.alt,r.ord,r.ord2,r.sort1,r.intro,r.cateid,r.cateid2,r.cateid3,r.time1,r.date7,"&_
	"r.del,r.uploadfile,r.name,r.name2,r.sort98,r.gj1,r.gj2,"&_
	"(case when r.sort1=1 "& str11 &" then p1.qx_open "&_
	"when r.sort1=2 "& str12 &" then p3.qx_open "&_
	"when r.sort1=3 "& str13 &" then p4.qx_open "&_
	"when r.sort1=4 "& str14 &" then p5.qx_open "&_
	"when r.sort1=5 "& str15 &" then p22.qx_open "&_
	"when r.sort1=6 "& str16 &" then p42.qx_open "&_
	"when r.sort1=7 "& str17 &" then p41.qx_open "&_
	"when r.sort1=8 "& str18 &" then p2.qx_open "&_
	"when r.sort1=75 "& str19 &" then p75.qx_open "&_
	"when r.sort1=102001 "& str20 &" then p95.qx_open "&_
	"when r.sort1=102002 "& str21 &" then p96.qx_open "&_
	"else 0 "&_
	"end) "&_
	"as qxopen, "&_
	"(case when r.sort1=1 "& str11 &" then cast(p1.qx_intro as nvarchar(3000)) "&_
	"when r.sort1=2 "& str12 &" then cast(p3.qx_intro as nvarchar(3000)) "&_
	"when r.sort1=3 "& str13 &" then cast(p4.qx_intro as nvarchar(3000)) "&_
	"when r.sort1=4 "& str14 &" then cast(p5.qx_intro as nvarchar(3000)) "&_
	"when r.sort1=5 "& str15 &" then cast(p22.qx_intro as nvarchar(3000)) "&_
	"when r.sort1=6 "& str16 &" then cast(p42.qx_intro as nvarchar(3000)) "&_
	"when r.sort1=7 "& str17 &" then cast(p41.qx_intro as nvarchar(3000)) "&_
	"when r.sort1=8 "& str18 &" then cast(p2.qx_intro as nvarchar(3000)) "&_
	"when r.sort1=75 "& str19 &" then cast(p75.qx_intro as nvarchar(3000)) "&_
	"when r.sort1=102001 "& str20 &" then cast(p95.qx_intro as nvarchar(3000)) "&_
	"when r.sort1=102002 "& str21 &" then cast(p96.qx_intro as nvarchar(3000)) "&_
	"else '0' "&_
	"end) "&_
	"as qxintro,isnull(r.sort98,0) as sort98s,(case isnull(t.replyShare,0) when 0 then '0' else ISNULL(r.share,'0') end) rShare " &_
	",isnull(t.name,'此客户已被删除') tel_name,isnull(t.cateid,0) as tel_cateid,isnull(t.share,0) as tel_share ,g.del as cateidDel " &_
	" from reply r "&_
	" left join dbo.gate g on r.cateid=g.ord "&_
	" left join tel t on t.ord=r.ord and t.del=1 " &_
	" left join power p1 on p1.sort1=1 and p1.sort2=5 and p1.ord="& m_uid &_
	" left join power p2 on p2.sort1=2 and p2.sort2=5 and p2.ord="& m_uid &_
	" left join power p3 on p3.sort1=3 and p3.sort2=5 and p3.ord="& m_uid &_
	" left join power p4 on p4.sort1=4 and p4.sort2=5 and p4.ord="& m_uid &_
	" left join power p5 on p5.sort1=5 and p5.sort2=5 and p5.ord="& m_uid &_
	" left join power p22 on p22.sort1=22 and p22.sort2=5 and p22.ord="& m_uid &_
	" left join power p41 on p41.sort1=41 and p41.sort2=5 and p41.ord="& m_uid &_
	" left join power p42 on p42.sort1=42 and p42.sort2=5 and p42.ord="& m_uid &_
	" left join power p75 on p75.sort1=75 and p75.sort2=5 and p75.ord="& m_uid &_
	" left join power p95 on p95.sort1=95 and p95.sort2=5 and p95.ord="& m_uid &_
	" left join power p96 on p96.sort1=96 and p96.sort2=5 and p96.ord="& m_uid &_
	" where r.del=1 "&_
	") as f "&_
	"where 1=1 "&Str_Result2&" and " &_
	"( "&_
	"  (" &_
	"          (qxopen=3 or (qxopen=1 and  charindex(','+cast(cateid as nvarchar(10))+',',','+qxintro+',')>0)) "&gj_Result&" "&_
	"          and ( "&open_1_1&" = 3 OR ( "&open_1_1&" = 1 AND Charindex(',' + Cast(cateid AS NVARCHAR(10)) + ',', ',' + '"&intro_1_1&"' + ',') > 0 ) )"&_
	"          and ( "&open_1_11&" = 3 OR ( "&open_1_11&" = 1 AND Charindex(',' + Cast(cateid AS NVARCHAR(10)) + ',', ',' + '"&intro_1_11&"' + ',') > 0 ) )"&_
	"  ) " &_
	"  OR (rShare = '1' OR CHARINDEX(','+ Cast("& m_uid &" AS NVARCHAR(10)) +',' , ','+rShare+',') > 0) " &_
	")" &_
	") as c "&_
	"inner join tel e on c.ord = e.ord "&tel_Result&" "&_
	"Left join (" &_
	"select max(id) as rid,orderId as remind_orderId from reminderQueue where reminderconfig=" & iif(remind<>"",remind,0) & " group by orderId " &_
	") d on d.remind_orderId = c.id " &_
	"left join (" & vbcrlf &_
	"select cateid as isCanceled,reminderId from reminderPersons where cateid=" & m_uid & " " & vbcrlf & _
	") __rp on __rp.reminderId=d.rid " & vbcrlf &_
	""&Str_Result3&" " &_
	" order by date7 desc"
	rs.open sql,conn,3,1
	if rs.RecordCount<=0 then
		Response.write "<table><tr><td  align='center'>没有信息!</td></tr><tr><td  align='center'  height='68'>&nbsp;</td></tr></table>"
	else
		i=1
		rs.PageSize=15
		...
		dim sortname, ord2
		do until rs.eof
			rid = CLng(rs("remindId"))
			sortname=rs("sort1")
			ord2=rs("ord2")
			cateid=rs("cateid")
			share=rs("tel_share")
			cateid_kh=rs("tel_cateid")
			catename=rs("tel_name")
			if sortname=2 then
				clsname="title"
				biao="chance"
				biao_name="项目"
				biao_url="chance"
			elseif sortname=3 then
				clsname="title"
				biao="price"
				biao_name="报价"
				biao_url="price"
			elseif sortname=4 then
				clsname="title"
				biao="contract"
				biao_name="合同"
				biao_url="contract"
			elseif sortname=5 then
				clsname="title"
				biao="caigou"
				biao_name="采购"
				biao_url="caigou"
			elseif sortname=6 then
				clsname="title"
				biao="tousu"
				biao_name="售后"
				biao_url="service"
			elseif sortname=7 then
				clsname="title"
				biao="contractth"
				biao_name="退货"
				biao_url="contractth"
			elseif sortname=8 then
				clsname="name"
				biao="person"
				biao_name="联系人"
				biao_url="person"
			elseif sortname=75 then
				clsname="title"
				biao="caigouth"
				biao_name="采购退货"
				biao_url="caigouth"
			elseif sortname="102001" then
				clsname="title"
				biao="sale_complaints"
				biao_name="投诉"
				biao_url="caigouth"
			elseif sortname="102002" then
				clsname="title"
				biao="sale_proposal"
				biao_name="建议"
				biao_url="caigouth"
			...
			Response.write Rs.pagesize*(currpage-1)+i
			Response.write "</td>" & vbcrlf & "    <td width=""332"" height=""27""  "
			If (open_1_14=3 or (CheckPurview(intro_1_14,trim(cateid_kh))=True) And cateid_kh<>0) then
				Response.write "class=""name"" "
			else
				Response.write "class=""cateLine"""
			end if
			Response.write ">" & vbcrlf & "      <div align=""left"">&nbsp;" & vbcrlf & "   "
			If (open_1_1=3 or (CheckPurview(intro_1_1,trim(cateid_kh))=True And cateid_kh<>0 )) Or share="1" Or (InStr(","&Replace(share," ","")&",",m_uid)>0 And m_uid<>0) then
				If (open_1_14=3 or (CheckPurview(intro_1_14,trim(cateid_kh))=True) And cateid_kh<>0) then
					Response.write "" & vbcrlf & "                        <a href=""#"" onclick=""javascript:window.open('../work/content.asp?ord="
					Response.write pwurl(rs("ord"))
					Response.write "','new23win','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" title=""点击可查看此客户详情"">" & vbcrlf & "                   "
					Response.write pwurl(rs("ord"))
				end if
				Response.write catename
				Response.write "</a>  " & vbcrlf & "                        <font class=""red"">" & vbcrlf & "                        "
				if sortname<>1 then
					Response.write "" & vbcrlf & "                              <br>&nbsp;关联"
					Response.write biao_name
					Response.write "：" & vbcrlf & "                            "
					if (sortname=2 and (open_3_1=3 or CheckPurview(intro_3_1,trim(cateid_kh))=True)) or (sortname=3 and (open_4_1=3 or CheckPurview(intro_4_1,trim(cateid_kh))=True)) or (sortname=4 and (open_5_1=3 or CheckPurview(intro_5_1,trim(cateid_kh))=True)) or (sortname=5 and (open_22_1=3 or CheckPurview(intro_22_1,trim(cateid_kh))=True)) or (sortname=6 and (open_42_1=3 or CheckPurview(intro_42_1,trim(cateid_kh))=True)) or (sortname=7 and (open_41_1=3 or CheckPurview(intro_41_1,trim(cateid_kh))=True)) or (sortname=8 and (open_2_1=3 or CheckPurview(intro_2_1,trim(cateid_kh))=True)) then
						Response.write "" & vbcrlf & "                                      <a href=""#"" onclick=""javascript:window.open('../"
						Response.write biao_url
						Response.write "/content.asp?ord="
						Response.write pwurl(ord2)
						Response.write "','new24win','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" title=""点击可查看详情"">" & vbcrlf & "                               "
						Response.write pwurl(ord2)
					ElseIf (sortname="102001" and (open_95_14=3 or CheckPurview(intro_95_14,trim(cateid_kh))=True)) or (sortname="102002" and (open_96_14=3 or CheckPurview(intro_96_14,trim(cateid_kh))=True)) Then
					end if
					if biao<>"" Then
						If sortname<>"102001" And sortname<>"102002" Then
							set rs7=conn.execute("select "&clsname&" from "&biao&" where ord="&ord2&"")
							if rs7.eof then
								Response.write "已被删除!"
							else
								Response.write ""&rs7(""&clsname&"")&""
							end if
							rs7.close
						else
							set rs7=conn.execute("select "&clsname&" from "&biao&" where id="&ord2&"")
							if rs7.eof then
								Response.write "已被删除!"
							else
								Response.write ""&rs7(""&clsname&"")&""
			...
			Response.write "" & vbcrlf & "               </div></td>" & vbcrlf & "          <td class=""name""><div align=""center"">"
			Response.write rs("date7")
			Response.write "</div></td>" & vbcrlf & "             <td class=""name""><div align=""center"">"
			Response.write getsort98(rs("sort98s"))
			Response.write "</div></td>" & vbcrlf & "          <td class=""cateLine"">" & vbcrlf & ""
			If remind <> "" Then
				if rid>0 And rs("isCanceled") = 0 Then
			...
			If Len(uploadfile&"")>0 Then Response.write Getuploadfile(uploadfile)
			Response.write "      " & vbcrlf & "           (跟进："
			Response.write rs("name")
			Response.write "&nbsp;&nbsp;"
			if rs("name2")<>"" then
				Response.write "对方联系人："
				Response.write rs("name2")
				Response.write "&nbsp;&nbsp;"
			end if
			Response.write rs("date7")
			Response.write ")<input type=""button"" name=""Submit423"" value=""点评""  onClick=""javascript:window.open('../contract/dianpin.asp?ord="
			Response.write pwurl(rs("id"))
			Response.write "&sortreply="
			Response.write pwurl(sortname)
			Response.write "','newwin22','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=150,top=150')""  class=""anybutton2""/>" & vbcrlf & "          "
			Response.write pwurl(sortname)
			If IsAllowHandle(rs("cateid"),rs("date7"),0) Then
				Response.write "" & vbcrlf & "          <input type=""button"" name=""Submit42"" value=""修改""  onClick=""javascript:window.open('correctreply.asp?ord="
				Response.write pwurl(rs("id"))
				Response.write "&ord1="
				Response.write pwurl(rs("ord"))
				Response.write "','newwin22','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=150,top=150')""  class=""anybutton2""/>" & vbcrlf & "          "
			...
			If IsAllowHandle(rs("cateid"),rs("date7"),1) Then
				Response.write "" & vbcrlf & "          <input type=""button"" name=""Submit2"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='delreply1.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "&id="
				Response.write pwurl(rs("id"))
				...
				Response.write "&ret2="
				Response.write m2
				Response.write "&s=2&remind="
				Response.write remind
				Response.write "'}"" class=""anybutton2""/>" & vbcrlf & "          "
			end if
			sql7 = "select id,intro,name,cateid,date7 from dianping where ord="& rs("id") &"  and sort="&sortname&" order by date7 desc"
			set rs7 = server.CreateObject("adodb.recordset")
			rs7.open sql7,conn,3,1
			if rs7.eof then
			else
				do until rs7.eof
					Response.write "" & vbcrlf & "                     <br><font class=""red"">点评："
					Response.write rs7("intro")
					Response.write "(点评人："
					Response.write rs7("name")
					Response.write "&nbsp;&nbsp;"
					Response.write rs7("date7")
					Response.write ")</font>" & vbcrlf & "                     "
					if rs7("cateid")=int( m_uid ) and rs7("date7")>dateadd("d",-1,now) then
						Response.write ")</font>" & vbcrlf & "                     "
						Response.write "<input type=""button"" name=""Submit42"" value=""修改""  onClick=""javascript:window.open('../contract/correctdp.asp?ord="
						Response.write pwurl(rs7("id"))
						Response.write "','newwin22','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=150,top=150')""  class=""anybutton2""/>" & vbcrlf & "         <input type=""button"" name=""Submit2"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='../contract/deldp.asp?id="
						Response.write pwurl(rs7("id"))
						Response.write "&url1=../work/genjin.asp&CurrPage="
						Response.write CurrPage
						Response.write "&W1="
						Response.write W1
						Response.write "&W2="
			...
			rs.movenext
		loop
		Response.write "" & vbcrlf & "    </table>" & vbcrlf & "</td>" & vbcrlf & "      </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""10%"" height=""30""><div align=""center""></div></td>" & vbcrlf & "    <td >&nbsp;    </td>" & vbcrlf & "    <td width=""79%""><div align=""right"">" & vbcrlf & "     <span class=""black"">"
		...
		Response.write "条信息/页</span>&nbsp;&nbsp;" & vbcrlf & "    "
		if currpage=1 then
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "<tr><td colspan=""3""><tr>" & vbcrlf & "    <td height=""68"" colspan=""3""><div align=""right""><p>&nbsp;" & vbcrlf & "      </p>" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	action1="客户跟进情况"
	call close_list(1)
	Response.write "" & vbcrlf & "</td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & ""
	If remind <> "" Then
		Response.write "" & vbcrlf & "<script>" & vbcrlf & "jQuery(function(){" & vbcrlf & "   BindCancelEvents({cfgId:"
		Response.write remind
		Response.write "});" & vbcrlf & "});" & vbcrlf & "</script>" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "</html>" & vbcrlf & ""
