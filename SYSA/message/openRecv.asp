...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	rs1.close
	set rs1=nothing
	Response.write "" & vbcrlf & "<!DOCTYPE html PUBLIC ""-//W3C//DTD XHTML 1.0 Transitional//EN"" ""http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"">" & vbcrlf & "<html xmlns=""http://www.w3.org/1999/xhtml"">" & vbcrlf & "<head>" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"" />" & vbcrlf & "<title>开启/关闭短信服务</title>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script language=""javascript"" src=""../inc/system.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript""></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "<!--" & vbcrlf & "var myBanlence=0;" & vbcrlf & "function   ExeRun(command)" & vbcrlf & "{" & vbcrlf & "   window.oldOnError=window.onerror;" & vbcrlf & "       window._command=command;" & vbcrlf & "        window.onerror=function(err)" & vbcrlf & "    {" & vbcrlf & "               if(err.indexOf( 'automation ')!=-1)" & vbcrlf & "             {" & vbcrlf & "                       alert( ""命令 ""+window._command+ ""已经被用户禁止! "");" & vbcrlf & "                        return   true;" & vbcrlf & "          }" & vbcrlf & "               else   return   false;" & vbcrlf & "  }" & vbcrlf & "        var   wsh=new   ActiveXObject( ""WScript.Shell"");" & vbcrlf & "  if(wsh)" & vbcrlf & "         wsh.Run('""'+command+'""');" & vbcrlf & " window.onerror=window.oldOnError;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "-->" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body  "
	'Response.write Application("sys.info.jsver")
	if open_67_8=0 then
	...
	if open_67_15<>1 then
		Response.write"<script language=javascript>alert('没有权限 ！'); window.opener=null;window.open('','_self');window.close();</script>"
		call db_close : Response.end
	end if
	set rs=server.CreateObject("adodb.recordset")
	...
	if not rs.eof then
		...
		openRecv=rs("openRecv")
		if isnull(openRecv) or  openRecv<>"1" then openRecv=0
	else
		Response.write "<script language='javascript'> alert('您还没有短信账户！'); window.opener=null;window.open('','_self');window.close();</script> "
		call db_close : Response.end
	end if
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""center"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <form id=""form1"" name=""form1"" method=""post""　onsubmit=""return Validator.Validate(this,2)"" action=""openRecv.asp?action=save"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">短信服务设置</td>" & vbcrlf & "            <td></td>" & vbcrlf & "<td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "      "
	If Request.ServerVariables("LOCAL_ADDR")= Request.ServerVariables("Remote_Host") Then
		Response.write "" & vbcrlf & "    <tr>" & vbcrlf & "      <td><table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" >" & vbcrlf & "          <tr class=""top"">" & vbcrlf & "            <td height=""30"" colspan=""2"" align=""left""><div align=""left"">是否打开/关闭短信服务</div></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr >" & vbcrlf & "            <td width=""15%"" height=""30"" align=""right""><div align=""right"">是否开启短信服务：</div></td>" & vbcrlf & "            <td width=""85%"" align=""left"" style=""font-weight: normal;""><input name=""openRecv"" type=""radio"" id=""closeRecv"" onClick=""document.getElementById('Err').innerHTML='';""  value=""0"" "
		if openRecv<>"1" then
			Response.write "checked=""checked"""
		end if
		Response.write ">" & vbcrlf & "              关闭" & vbcrlf & "              <input type=""radio"" id=""openeRecv"" name=""openRecv"" "
'if openRecv="1" then
'Response.write "checked=""checked"""
'end if
		Response.write " onClick=""document.getElementById('Err').innerHTML='开启将占用部分系统资源，请慎重';"" value=""1"" />" & vbcrlf & "              开启<span style=""color:#FF0000"" id=""Err""></span></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td height=""20px"" align=""right"">&nbsp;</td>" & vbcrlf & "            <td align=""left""><div align=""left"" id=""subBut"" style=""color:#FF0000"">" & vbcrlf & "                <input type=""submit"" style=""cursor:hand""  class=""anybutton"" id=""button"" value=""保 存"" name=""B8"" >" & vbcrlf & "                &nbsp;" & vbcrlf & "    <input type=""reset"" style=""cursor:hand""  class=""anybutton"" id=""B8""  value=""取 消"" name=""B82"">" & vbcrlf & "              </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "  "
	end if
	Response.write "" & vbcrlf & "    <tr>" & vbcrlf & "      <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "          <tr>" & vbcrlf & "            <td height=""30"" >" & vbcrlf & "                        "
	If Request.ServerVariables("LOCAL_ADDR")= Request.ServerVariables("Remote_Host") Then
		Response.write "" & vbcrlf & "                              注：开启之前，在浏览器安全设置中的【未标记为可安全执行脚本的ActiveX控件初始化并执行 】项设为启用状态。（必须在系统服务器上设置）" & vbcrlf & "                        "
	else
		Response.write "" & vbcrlf & "                              <font color=""red"">&nbsp;&nbsp;&nbsp;请在系统服务器上设置短信服务并开启。</font>" & vbcrlf & "                   "
	end if
	Response.write "" & vbcrlf & "                      </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "  </form>" & vbcrlf & "</table>" & vbcrlf & "" & vbcrlf & "<script type=""text/javascript"" language=""javascript"">" & vbcrlf & "    <!--" & vbcrlf & "    getBalance();" & vbcrlf & "      if(myBanlence==0)" & vbcrlf & "       {" & vbcrlf & "                       alert(""余额不足，不能开启此功能！请及时充值"");" & vbcrlf & "                    }" & vbcrlf & "                       else if(myBanlence<0)" & vbcrlf & "                   {" & vbcrlf & "                       alert(""短信账户有误！"");" & vbcrlf & "                  }" & vbcrlf & "" & vbcrlf & "       function getBalance()" & vbcrlf & "{" & vbcrlf & "" & vbcrlf & "    getWebPage('"
	...
	Response.write "'+""&stamp=""+Math.round(Math.random()*100));" & vbcrlf & "}" & vbcrlf & "function getWebPage(url) {" & vbcrlf & "  var my_url=""getSendUrl.asp?url=""+escape(url);" & vbcrlf & "  xmlHttp.open('get',my_url,false);" & vbcrlf & "  xmlHttp.onreadystatechange=function(){" & vbcrlf & "       if(xmlHttp.readyState==4){" & vbcrlf & "            if(xmlHttp.status==200){" & vbcrlf & "              var returnStr=xmlHttp.responseText;" & vbcrlf & "                                                     myBanlence=(Number(returnStr));" & vbcrlf & "            }" & vbcrlf & "       }" & vbcrlf & "  }" & vbcrlf & "  xmlHttp.send(null);" & vbcrlf & "}"& vbcrlf & vbcrlf & "     -->" & vbcrlf & "     </script>" & vbcrlf
	'Response.write urlStrBalance
	action=request.QueryString("action")
	intOpenRecv=request.Form("openRecv")
	strOpen=replace(server.MapPath("../message/clientSVR/setup.bat"),"\","\\")
	strClose=replace(server.MapPath("../message/clientSVR/Uninstall.bat"),"\","\\")
	if action="save" then
		if intOpenRecv<>"" then
			if intOpenRecv=0 then
				Response.write "" & vbcrlf & "<script type=""text/javascript"" language=""javascript"">" & vbcrlf & "     <!--" & vbcrlf & "" & vbcrlf & "    ExeRun( """
'if intOpenRecv=0 then
				Response.write strClose
				Response.write """);" & vbcrlf & "        document.getElementById(""openeRecv"").checked="""";" & vbcrlf & "                            document.getElementById(""closeRecv"").checked=""checked"";" & vbcrlf & "     -->" & vbcrlf & "     </script>" & vbcrlf & ""
				'Response.write strClose
				conn.execute("Update setMessage set openRecv="&intOpenRecv&"")
			elseif intOpenRecv=1 then
				clientUser=session("UniqueName")
				strConfig ="<?xml version=""1.0""?>"&vbCrLf
				strConfig =strConfig&"<configuration>"&vbCrLf
				strConfig =strConfig&"<startup>             "&vbCrLf
				strConfig =strConfig&"<supportedRuntime version=""v2.0.50727""/></startup>"&vbCrLf
				strConfig =strConfig&"  <appSettings>"&vbCrLf
				strConfig =strConfig&"     <add key=""ClientSettingsProvider.ServiceUri"" value=""""/>"&vbCrLf
				strConfig =strConfig&"     <add key=""ClientSettingsProvider.ConnectionStringName"" value=""DefaultConnection""/>"&vbCrLf
				strConfig =strConfig&"     <add key=""port"" value=""818""/>"&vbCrLf
				strConfig =strConfig&"     <add key=""baseserver"" value=""http://sms.zbintel.com""/>"&vbCrLf
				strConfig =strConfig&"     <add key=""localserver"" value='http://"&Request.ServerVariables("Http_Host") &""&replace(Request.ServerVariables("Url"),"message/openRecv.asp","")&"'/>"&vbCrLf
				strConfig =strConfig&"     <add key=""smssn"" value='"&clientUser&"'/>"&vbCrLf
				strConfig =strConfig&"  </appSettings>"&vbCrLf
				strConfig =strConfig&"  <system.web>"&vbCrLf
				strConfig =strConfig&"     <membership defaultProvider=""ClientAuthenticationMembershipProvider"">"&vbCrLf
				strConfig =strConfig&"       <providers>"&vbCrLf
				strConfig =strConfig&"         <add name=""ClientAuthenticationMembershipProvider"" type=""System.Web.ClientServices.Providers.ClientWindowsAuthenticationMembershipProvider, System.Web.Extensions, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35"" serviceUri="""" connectionStringName=""DefaultConnection"" credentialsProvider=""""/>"&vbCrLf
				strConfig =strConfig&"       </providers>"&vbCrLf
				strConfig =strConfig&"     </membership>"&vbCrLf
				strConfig =strConfig&"     <roleManager defaultProvider=""ClientRoleProvider"" enabled=""true"">"&vbCrLf
				strConfig =strConfig&"       <providers>"&vbCrLf
				strConfig =strConfig&"         <add name=""ClientRoleProvider"" type=""System.Web.ClientServices.Providers.ClientRoleProvider, System.Web.Extensions, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35"" serviceUri="""" cacheTimeout=""86400"" connectionStringName=""DefaultConnection""/>"&vbCrLf
				strConfig =strConfig&"       </providers>"&vbCrLf
				strConfig =strConfig&"     </roleManager>"&vbCrLf
				strConfig =strConfig&"  </system.web>"&vbCrLf
				strConfig =strConfig&"  <connectionStrings>"&vbCrLf
				strConfig =strConfig&"     <add name=""DefaultConnection"" connectionString=""Data Source = |SQL/CE|""/>"&vbCrLf
				strConfig =strConfig&"  </connectionStrings>"&vbCrLf
				strConfig =strConfig&"</configuration>"&vbCrLf
				filename ="zbintelSVR.exe.config"
				folderPath = server.mappath("zbintelSVR")
				If Not sdk.file.ExistsDir(folderPath) Then
					sdk.file.CreateFolder folderPath
				end if
				filePath="clientSVR/zbintelSVR.exe.config"
				filtCon=strConfig
				result = sdk.file.writealltext(filePath,filtCon)
				If result <> "" Then
	...
	Response.write "" & vbcrlf & "<script type=""text/javascript"" language=""javascript"">" & vbcrlf & "            <!--" & vbcrlf & "            if(myBanlence>0)" & vbcrlf & "                {" & vbcrlf & "                               ExeRun("""
	Set fso = nothing
	Response.write strOpen
	Response.write """);" & vbcrlf & "                               document.getElementById(""openeRecv"").checked=""checked"";" & vbcrlf & "                             document.getElementById(""closeRecv"").checked="""";" & vbcrlf & "                            }" & vbcrlf & "               else" & vbcrlf & "            {" & vbcrlf & "                               alert(""余额不足，不能开启此功能！请及时充值"");" & vbcrlf & "                    }" & vbcrlf & "               -->" & vbcrlf & "       </script>" & vbcrlf & ""
	conn.execute("Update setMessage set openRecv="&intOpenRecv&"")
	end if
else
Response.write"<script language=javascript>alert('请选择是否开启 ！'); history.back();</script>"
call db_close : Response.end
end if
end if
