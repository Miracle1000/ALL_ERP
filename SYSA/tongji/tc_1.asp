...
'bigsystemtype = ".mozi"
	...
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=44 and sort2=1"
	...
	if rs1.eof then
		...
		intro_44_1=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=44 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_44_2=0
		intro_44_2=0
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=44 and sort2=4"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_44_4=0
		intro_44_4=0
		...
		intro_44_4=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=44 and sort2=7"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_44_7=0
		intro_44_7=0
		...
		intro_44_7=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=44 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_44_8=0
		intro_44_8=0
	else
		open_44_8=rs1("qx_open")
		intro_44_8=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=44 and sort2=10"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_44_10=0
		intro_44_10=0
		...
		intro_44_10=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	if open_44_3=3 then
		list_tj=""
	elseif open_44_3=1 then
		list_tj="and cateid in ("&intro_44_3&") and cateid>0"
	else
	...
	if open_44_3="1"  then
		set rs1=server.CreateObject("adodb.recordset")
		sql1="select ord,name,sorce,sorce2 from gate  where ord in ("&intro_44_3&") and del=1 order by sorce asc,sorce2 asc ,cateid asc ,ord asc"
		rs1.open sql1,conn,1,1
		if rs1.eof then
		else
			do until rs1.eof
...
'If xsGoal&""="" Then xsGoal = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "      margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"">" & vbcrlf & "<!--" &vbcrlf & "function MM_jumpMenu(targ,selObj,restore){ //v3.0" & vbcrlf & "eval(targ+"".location=\'""+selObj.options[selObj.selectedIndex].value+""\'"");" & vbcrlf & "if (restore) selObj.selectedIndex=0;" & vbcrlf & "}" & vbcrlf & "//-->" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body oncontextmenu=self.event.returnValue=false  onMouseOver=""window.status='none';return true;""  scroll=AUTO>" & vbcrlf & ""
	...
	Str_contract=""
	if m1<>"" then
		Str_Result=Str_Result+"and date5>='"&m1&"' "
'if m1<>"" then
		Str_Result2=Str_Result2+"and date5>='"&m1&"' "
'if m1<>"" then
		Str_contract=Str_contract+"and date3>='"&m1&"'"
'if m1<>"" then
		m1name="  起始："&m1
	end if
	if m2<>"" then
		Str_Result=Str_Result+"and date5<='"&cdate(m2)&"' "
'if m2<>"" then
		Str_Result2=Str_Result2+"and date5<='"&cdate(m2)&"' "
'if m2<>"" then
		Str_contract=Str_contract+"and date3<='"&cdate(m2)&"'"
'if m2<>"" then
		m2name="  截止："&m2
	end if
	dim type_tj,width_tj
	type_tj=request("type_tj")
	if type_tj="" then type_tj=1
	width_tj=request("width_tj")
	if width_tj="" then width_tj=550
	Response.write "" & vbcrlf & "              <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "                 <tr>" & vbcrlf & "                            <td width=""254"" class=""place"">待发提成</td>" & vbcrlf & "                         <td width=""75%"" align=""left""><strong>"
	Response.write m1name
	Response.write m2name
	Response.write "</strong></td>" & vbcrlf & "                                <td width=""3"" align=""right""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "                  </tr>" & vbcrlf & "           </table>" & vbcrlf & "                <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                       <tr class=""top"">" & vbcrlf & "                  <form method=""POST"" action=""tc_1.asp?width_tj="
	...
	Response.write "" & vbcrlf & "                                      <input type=""submit"" name=""Submit422"" value=""统计""  class=""anybutton2""/>" & vbcrlf & "                                </td>" & vbcrlf & "                   </form>" & vbcrlf & "                 </tr>" & vbcrlf & "           </table>" & vbcrlf & "                <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" >" & vbcrlf & "                <tr>" & vbcrlf & "                            <td height=""30""  align=""right"">" & vbcrlf & "                                     <input type=""button"" name=""pillar"" value=""柱状图分析"" onClick=""window.location.href='tc_1.asp?type_tj=1&sort="
	Response.write E
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "                                       <input type=""button"" name=""zxt"" value=""折线图分析"" onClick=""window.location.href='tc_1.asp?type_tj=2&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&time1="
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "                                       <input type=""button"" name=""line"" value=""饼图分析"" onClick=""window.location.href='tc_1.asp?type_tj=3&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&time1="
	...
	Response.write ">图宽=550</option>" & vbcrlf & "                                    <option value=""tc_1.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=700</option>" & vbcrlf & "                                   <option value=""tc_1.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=1000</option>" & vbcrlf & "                                  <option value=""tc_1.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=1500</option>" & vbcrlf & "                                  <option value=""tc_1.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=2000</option>" & vbcrlf & "                                  <option value=""tc_1.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write "&nbsp;"
	if open_44_10=1 then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认将统计结果导出为EXCEL文档？')){window.location.href='tc_1.asp?type_tj=4&sort="
		Response.write E
		Response.write "&sort1="
		Response.write F
		Response.write "&ret="
	...
	Response.write "" & vbcrlf & "                             </td>" & vbcrlf & "                   </tr>" & vbcrlf & "           </table>" & vbcrlf & "                <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" id=""user2"">" & vbcrlf & "                        <tr bgcolor=""#FFFFFF"">" & vbcrlf & "                            <td align=""left"">" & vbcrlf & "                                 <div align=""left"">" & vbcrlf & "                                             <span id=""CountTXTok"" name=""CountTXTok"" style=""font-size:10pt;"">" & vbcrlf & "                                                      <B>正在处理数据...</B>" & vbcrlf & "                                          </span>" & vbcrlf & "                                 </div>" & vbcrlf & "                          </td>" & vbcrlf & "                   </tr>" & vbcrlf & "                   <tr>" & vbcrlf & "                            <td colspan=2 class=tablebody1>" & vbcrlf & "<table width=""600"" border=""0"" cellpadding=""1"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                                               <tr bgcolor=""#FFFFFF"">  " & vbcrlf & "                                                  <td bgcolor=ffffff height=9><img src=""../images/bj_tiao2.gif"" style="""" width=""0"" height=""16"" id=""CountImage"" name=""CountImage"" align=""absmiddle""><img src=""../images/bj_tiao2.gif"" style="""" width=""0"" height=""16"" id=""CountImage2"" name=""CountImage2"" align=""absmiddle""></td>" & vbcrlf & "                                          </tr>" & vbcrlf & "                                   </table>" & vbcrlf & "                                </td>" & vbcrlf & "                   </tr>" & vbcrlf & "                   <tr bgcolor=""#FFFFFF""><td><span id=""CountTXT"" name=""CountTXT"" style=""font-size:9pt; color:#008040"">0</span><span style=""font-size:9pt; color:#008040"">%</span></td></tr>" & vbcrlf & "          </table>" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" >" & vbcrlf &"                 <tr>" &vbcrlf & "                        <td align=""center"">" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	sql="select intro from setopen  where sort1=11 "
	...
	set rs=nothing
	set rs=server.CreateObject("adodb.recordset")
	sql="select intro from setopen  where sort1=12 "
	rs.open sql,conn,1,1
	if rs.eof then
		sort_tc2=""
	else
	...
	dim numcg1,zs1
	set rs1=server.CreateObject("adodb.recordset")
	conn.execute "exec erp_calcSaleTC"
	...
	if counts<=0 then
		...
		do until rs1.eof
			...
			money_tcall=0
			set rs=server.CreateObject("adodb.recordset")
			sql="select sum(case when money2<>0 then ROUND(money1/money2*ROUND(money_tc1,"& num_dot_xs &"),"& num_dot_xs &") else 0 end) as money_tcall from (select ord,contract,money1 ,money2=(select isnull(money1,0) from contract where ord=payback.contract),money_tc1=(select isnull(money_tc1,0) from contract where ord=payback.contract) from payback where exists(select top 1 1 from contract where ord=payback.contract)  and  cateid="&rs1("ord")&" and complete='3' and tc='0' "&Str_Result2&") k  "
			rs.open sql,conn,1,1
			if not rs.eof then
				money_tcall=rs("money_tcall")
				If money_tcall&""="" Then money_tcall=0
			end if
			rs.close
			set rs=nothing
			numcg1=Formatnumber(money_tcall,num_dot_xs,-1)
			set rs=nothing
			title=rs1("name")
			lburl="../money/planall2.asp?W3="&rs1("ord")&"&A=7&ret="&m1&"&ret2="&m2&""
			total1(j,1)=numcg1
			total1(j,2)=title
			total1(j,0)=lburl
			total2(j,0)=title
