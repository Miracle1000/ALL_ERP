...
'If Not rs.Eof Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "</head>" & vbcrlf & "<body oncontextmenu=self.event.returnValue=false>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  <form name=""form1"" method=""post"" action=""personEdit.asp"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">员工档案回收站</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right""><input type=""button"" name=""Submitdel2"" class=""anybutton"" value=""全部恢复"" onClick=""if(confirm('确认恢复本回收站里的所有内容？')){window.location.href='personEdit.asp?action=backAll'}""/>" & vbcrlf & "            <input type=""button"" name=""Submitdel"" class=""anybutton"" value=""全部清空"" onClick=""if(confirm& vbcrlf & ""        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "          <tr class=""top"">" & vbcrlf & "            <td align=""center""><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "            <td align=""center"" height=""24""><div align=""center"">员工编号</div></td>" & vbcrlf & "            <td height=""27"" ><div align=""center"">姓名</div></td>" & vbcrlf & "            <td width=""11%"" ><div align=""center"">手机</div></td>" & vbcrlf & "            <td ><div align=""center"">电子邮件</div></td>" & vbcrlf & "            <td ><div align=""center"">入职时间</div></td>" & vbcrlf & "            <td ><div align=""center"">删除人</div></td>" & vbcrlf & "            <td ><div align=""center"">删除日期</div></td>" & vbcrlf & "            <td ><div align=""center""><strong>操作</strong></div></td>" & vbcrlf & "       </tr>" & vbcrlf & ""
	dim n ,canDelete
	n=0
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from hr_person  where del<>0 order by id desc"
	...
	if rs.eof then
		...
		do until rs.eof
			canDelete = conn.execute("exec [erp_rela_finance_GetAssistIDs] "& session("personzbintel2007") &", 1,'4', '" & rs("userid") &"','"& Application("__saas__company") &"'").eof
			...
			Response.write rs("userbh")
			Response.write "</td>" & vbcrlf & "            <td width=""11%"" height=""27"" align=""center"" >"
			Response.write getGateName(rs("userID"))
			Response.write "</td>" & vbcrlf & "            <td width=""11%""align=""center"" >"
			Response.write rs("mobile")
			Response.write "</td>" & vbcrlf & "            <td width=""10%"" align=""center"" >"
			Response.write rs("email")
			Response.write "</td>" & vbcrlf & "            <td width=""12%"" align=""center"" >"
			Response.write rs("Entrydate")
			Response.write "</td>" & vbcrlf & "            <td width=""10%"" align=""center"" >"
			Response.write getGateName(rs("delcate"))
			Response.write "</td>" & vbcrlf & "            <td width=""12%"" align=""center"" >"
			Response.write rs("deldate")
			Response.write "</td>" & vbcrlf & "            <td width=""20%""><div align=""center"">" & vbcrlf & "                <input type=""button"" name=""Submit3c""  class=""anybutton""  value=""恢复""  onClick=""if(confirm('确认恢复？')){window.location.href='personEdit.asp?action=backOne&ord="
			Response.write pwurl(rs("id"))
			Response.write "&CurrPage="
			Response.write CurrPage
			Response.write "'}""/>" & vbcrlf & "                "
			if canDelete then
				Response.write "<input   type=""button"" name=""Submitdel"" class=""anybutton"" value=""彻底删除"" onClick=""if(confirm('您选择的是彻底删除，删除后不能再恢复，确认删除？')){window.location.href='personEdit.asp?action=delOne&ord="
				Response.write pwurl(rs("id"))
				Response.write "&CurrPage="
				Response.write CurrPage
				Response.write "'}""/>"
		...
		loop
		m=n
		Response.write "" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""10%"" height=""30""><div align=""center"">全选" & vbcrlf & "<input type=""checkbox"" name=""checkbox2"" value=""Check All"" onClick=""mm()""> "& vbcrlf &         "      </div></td> "& vbcrlf &      "       <td ><input type=""submit"" name=""Submit426"" value=""批量删除""   onClick=""return test();""  class=""anybutton2""> "& vbcrlf & "<input type=""button"" name=""Submit426"" value=""批量恢复""  onclick=""ask2();"" class=""anybutton2""/>" & vbcrlf & "            </td>" & vbcrlf & "            <td width=""69%""><div align=""right""> <span class=""black"">"
		...
		if currpage=1 then
			...
			Response.write "" & vbcrlf & "                <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='personFile.asp?currPage="
			Response.write  1
			Response.write "&a="
			Response.write a
			Response.write "&b="
			...
			Response.write "&c="
			Response.write c
			Response.write "'""/>" & vbcrlf & "                <input type=""button"" name=""Submit42"" value=""上一页""  onClick=""window.location.href='personFile.asp?currPage="
		...
		if currpage=rs.pagecount then
			...
			Response.write "" & vbcrlf & "                <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='personFile.asp?currPage="
			Response.write  currpage + 1
			Response.write "&a="
			Response.write a
			Response.write "&b="
			...
			Response.write "&c="
			Response.write c
			Response.write "'"" class=""page""/>" & vbcrlf & "                <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href='personFile.asp?currPage="
			Response.write  rs.PageCount
			Response.write "&a="
			Response.write a
			Response.write "&b="
		...
		Response.write "" & vbcrlf & "              </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <script language=javascript>" & vbcrlf & "function test()" & vbcrlf & "{" & vbcrlf & "if (!confirm(""您选择的是彻底删除，删除后不能再恢复，确认删除？？"")) {" & vbcrlf & "            window.event.returnValue = false;" & vbcrlf & "        }" & vbcrlf & "else" & vbcrlf & "{document.all.form1.action = ""personEdit.asp?action=delSome&currPage="
		Response.write currPage
		Response.write """; " & vbcrlf & "document.all.form1.submit(); " & vbcrlf & "" & vbcrlf & "}" & vbcrlf & "}" & vbcrlf & " " & vbcrlf & "function mm()" & vbcrlf & "{" & vbcrlf & "   var a = document.all(""checkbox2"");" & vbcrlf & "   var c = document.getElementsByName(""selectid"")" & vbcrlf & "       if(a.checked==true)" & vbcrlf & "      {" & vbcrlf & "               for(var i=0;i<c.length;i++)" & vbcrlf & "             c[i].checked=true;" & vbcrlf & "      }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               for(var i=0;i<c.length;i++)" & vbcrlf & "             c[i].checked=false" & vbcrlf & "      }" & vbcrlf & "}" & vbcrlf & "function ask2() { " & vbcrlf & "if (!confirm(""确认要批量恢复选中的信息？"")) {" & vbcrlf & "            window.event.returnValue = false;" & vbcrlf & "        }" & vbcrlf & "else" & vbcrlf & "{" & vbcrlf & "document.all.form1.action = ""personEdit.asp?action=backSome&currPage="
		Response.write currPage
		Response.write """; " & vbcrlf & "document.all.form1.submit(); " & vbcrlf & "}" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "          <tr>" & vbcrlf & "            <td height=""38"" colspan=""3""><div align=""right"">" & vbcrlf & "                <p>&nbsp; </p>" & vbcrlf & "              </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "        "
	end if
	rs.close
	set rs=nothing
	dim actinon1
	action1="员工档案回收站"
	call close_list(1)
	Response.write "" & vbcrlf & "        <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""100%"" height=""10""><img src=""../image/pixel.gif"" width=""1"" height=""1""></td>" & vbcrlf & "          </tr>" & vbcrlf & "         <tr>" & vbcrlf & "            <td height=""10"">&nbsp;</td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "  </form>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>"
