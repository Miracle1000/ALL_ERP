...
document.writeln('<iframe id=endDateLayer frameborder=0 width=310 height=240 style="position: absolute;  z-index: 9998; display: none"></iframe>');   
strFrame='<style>';   
...
strFrame+='         onmouseover="style.color=\'#ff0000\'" onmouseout="style.color=\'#1478eb\'" title="当前日期时间">当前</span>&nbsp;<span style="cursor:hand" id=evaAllOK onmouseover="style.color=\'#ff0000\'" onmouseout="style.color=\'#1478eb\'" style="font-size:12px;cursor: hand" onclick="parent.closeLayer()" title="关闭日历">关闭&nbsp;</span></td></tr>';   
...
{   
        ...
        //{   
                ...
                bImgSwitch();   
                odatelayer.bUseTimeLayer.innerHTML=bImg;   
                meizzWriteHead1(meizzTheYear,meizzTheMonth);   
        //}   
        //else   
        //{   
        //        bUseTime=false;   
