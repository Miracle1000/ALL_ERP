...
'if m2<>"" then
	...
	elseif px=5 then
		pxResult=" order by sp_date desc,adddate desc,id desc"
	elseif px=6 then
		pxResult=" order by sp_date asc,adddate desc,id desc"
	end if
	UUrl=ReturnUrl()
	dim tmpurl,tmps
	if instr(UUrl,"&")>0 then
		tmps=""
		tmpurl=split(UUrl,"&")
		for i=0 to ubound(tmpurl)
			if instr(tmpurl(i),"money1=")=0 and  instr(tmpurl(i),"id_sp=")=0 and instr(tmpurl(i),"id_sp_old=")=0 and instr(tmpurl(i),"intro=")=0 and instr(tmpurl(i),"remark=")=0 then
				if right(tmpurl(i),1)<>"=" then
					tmps=tmps & "&" & tmpurl(i)
				end if
			end if
		next
		UUrl=tmps
		if len(UUrl)>1 then UUrl=right(UUrl,len(UUrl)-1)
		UUrl=tmps
	end if
	Response.write "" & vbcrlf & "<!DOCTYPE HTML PUBLIC ""-//W3C//DTD HTML 4.01 Transitional//EN""" & vbcrlf & """http://www.w3.org/TR/html4/loose.dtd"">" & vbcrlf & "<html>" & vbcrlf & "<head>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "   #kh select[name=""select2""]{" & vbcrlf & "               margin-right:26px;" & vbcrlf & " }" & vbcrlf & "</style>" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"">" & vbcrlf & "<title>"
	UUrl=tmps
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "     <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">        " & vbcrlf & "    <form action=""paysq.asp"" method=""get""　id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "            <tr>" & vbcrlf & "       <td class=""place"">申请列表</td>" & vbcrlf & "       <td><div align=""left""><A class='px_btn' onclick=""Myopen(User);return false;"" href=""javascript:void(0)"">排序规则<IMG src=""../images/i10.gif"" alt=""排序规则"" width=""9"" height=""5"" border=""0""></A></div></td>" & vbcrlf & "      <td align=""right""><div id=""kh"" style='height:22px;line-height:22px;'>" & vbcrlf & "        <select name=""select2""  onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"">" & vbcrlf & "                     <option>-请选择-</option>" & vbcrlf & "               <option value=""page_count=10"" "
	'Response.write Application("sys.info.jsver")
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "              </select></div></td>" & vbcrlf & "      <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "    </tr>" & vbcrlf & "  </table> " & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & " <tr>" & vbcrlf & "    <td colspan=""9"" class='ser_btn'  style='padding-top:0;padding-bottom:0;height:50px;line-height:50px;' align=""right""><input type=""radio"" name=""rad1"" checked=""checked"">列表<input type=""radio"" onClick=""javascript:window.location.href='paysqdet.asp?"
	Response.write sdk.ReturnURL("")
	Response.write "'"" name=""rad1"">明细" & vbcrlf & " "
	...
	Response.write "" & vbcrlf & "                     <select name=""T"" id=""T"">" & vbcrlf & "                             <option value="""">审批状态</option>" & vbcrlf & "                    <option value=""1"" "
	if T="1" then
		Response.write "selected"
	end if
	Response.write ">审批通过</option>" & vbcrlf & "                <option value=""0"" "
	if T="0" then
		Response.write "selected"
	end if
	...
	Response.write ">审批未通过</option>         " & vbcrlf & "      </select>" & vbcrlf & "                 <select name=""B"" id=""B"">" & vbcrlf & "                 <option value=""1"" "
	if B="1" then
		Response.write "selected"
	end if
	...
	Response.write ">费用总额</option>" & vbcrlf & "                    <option value=""5"" "
	if B="5" then
		Response.write "selected"
	end if
	Response.write ">天数</option>" & vbcrlf & "                        <option value=""6"" "
	if B="6" then
		Response.write "selected"
	end if
	Response.write ">申请概要</option>" & vbcrlf & "                    <option value=""20"" "
	if B="20" then
		Response.write "selected"
	end if
	Response.write ">申请备注</option>" & vbcrlf & "      </select>" & vbcrlf & "                            <input name=""C"" type=""text"" size=""10""  value="""
	Response.write C
	...
	if open_6_10=1 or open_6_10=3 then
		Response.write "" & vbcrlf & "                      <input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({debug:false,page:'../out/xls_sq.asp'})}"" class=""anybutton2""/>" & vbcrlf & "                "
	end if
	...
	Response.write "" & vbcrlf & "                             </td>" & vbcrlf & "                   </tr>" & vbcrlf & "           </form>" & vbcrlf & " <tr class=""top"">" & vbcrlf & "    <td width=""5%"" align=""center"" ><div align=""center"">选择</div></td>" & vbcrlf & "    <td><div align=""center"">申请主题</div></td>       " & vbcrlf & "         <td width=""11%"" ><div align=""center"" >申请总额</div></td>" & vbcrlf & "         <td width=""7%"" ><div align=""center"" >单据张数</div></td>" & vbcrlf & "   <td width=""9%"" ><div align=""center"" >申请人员</div></td>" & vbcrlf & "    <td width=""9%"" ><div align=""center"" >添加人员</div></td>" & vbcrlf & "   <td width=""10%"" ><div align=""center"" >申请日期</div></td>" & vbcrlf & "         <td width=""9%"" ><div align=""center"">审批状态</div></td>" & vbcrlf & "     <td width=""18%""><div align=""center"">操作</div></td>" & vbcrlf & "       </tr>" & vbcrlf & ""
	dim n
	n=0
	set rs=server.CreateObject("adodb.recordset")
	sql="select *,case when exists(select top 1 1 from  PrinterInfo a where a.sort = 23  and a.formid = paysq.id) then '<span style=''color:#009900''>[已打印]</span>' else '<span  style=''color:#FF0000''>[未打印]</span>' end  as printStatus  from paysq WITH(NOLOCK) where del=1 "&Str_Result&" "&pxResult
	rs.open sql,conn,1,1
	if err.number <> 0 then
		conn.close
		reponse.redirect "pay/paysq.asp"
		call db_close : Response.end
	end if
	if rs.RecordCount<=0 then
		Response.write "<table><tr><td>没有信息!</td></tr><tr><td height='80'>&nbsp;</td></tr></table>"
	else
		almoney=getrsval("select isnull(sum(sqmoney),0) as money1 from paysq where del=1 "&Str_Result)
		...
		Response.write "      " & vbcrlf & "   <form name=""form1"" method=""post"" action=""deletesqall.asp?"
		Response.write sdk.ReturnURL("")
		Response.write """>" & vbcrlf & ""
		do until rs.eof
			dim k,k2
			...
			addname=setname("gate","ord",rs("addcateid"),"name")
			money11=zbcdbl(rs("sqmoney"))
			amoney=cdbl(money11)+cdbl(amoney)
			money11=zbcdbl(rs("sqmoney"))
			trade8=selbz(bz)
			if trade8="" or isnull(trade8) then trade8="RMB"
			if  timelg<>"" and datediff("s",timelg,rs("adddate"))>0 then
				k=k&new_list
			end if
			Response.write "" & vbcrlf & "     <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td width=""5%"" align=""center""><div align=""center""><span class=""red"">" & vbcrlf & "      "
			...
			Response.write "<span style=""color:red""></span>        </td>" & vbcrlf & "        <td width=""11%""><div align=""right"">"
			Response.write trade8
			Response.write "&nbsp;"
			Response.write Formatnumber(money11,num_dot_xs,-1)
			Response.write "&nbsp;"
			Response.write "</div></td>" & vbcrlf & "          <td width=""7%"" class=""func""><div align=""center"">"
			Response.write num
			Response.write "</div></td>" & vbcrlf & "          <td width=""9%""> <div align=""center"">"
			...
			if open_6_14=3 or CheckPurview(intro_6_14,trim(cateid))=True then
				Response.write "" & vbcrlf & "               <input type=""button"" name=""Submit53"" value=""详情""  onClick=""javascript:window.open('paysqdetail.asp?ord="
				Response.write rs("id")
				Response.write "','neww3win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>" & vbcrlf & "                 "
				Response.write rs("id")
			end if
			If rs("sp")>0 And (rs("cateid_sp")&""="" Or rs("cateid_sp")&""="0") And rs("addcateid")&""=session("personzbintel2007")&"" Then
				Response.write "<input type=""button"" name=""Submit"" value=""提交"" onClick=""window.open('../pay/setsq2.asp?ord="
				Response.write pwurl(rs("id"))
				Response.write "&money1="
				Response.write money11
				Response.write "&H=1&id_sp_old="
				Response.write rs("sp")
				Response.write "','neww3win','width=' + 700 + ',height=' + 400 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');"">" & vbcrlf & "            "
				Response.write rs("sp")
			end if
			if (open_6_17=3 or CheckPurview(intro_6_17,trim(cateid))=True) and rs("complete")="0" then
				Response.write "" & vbcrlf & "               <input type=""button"" name=""Submit53"" value=""修改""  onClick=""javascript:window.location=('paysqupdate.asp?"
				Response.write sdk.ReturnURL("ord=" & rs("id") &"")
				Response.write "')""/>" & vbcrlf & "               "
			end if
			if (open_6_17=3 or CheckPurview(intro_6_17,trim(cateid))=True) and (rs("complete")="2" or rs("complete")="1") then
				Response.write "" & vbcrlf & "               <input type=""button"" name=""Submit53"" value=""修改""  onClick=""javascript:window.location=('paysqupdate1.asp?"
				Response.write sdk.ReturnURL("ord=" & rs("id") &"")
				Response.write "')""/>" & vbcrlf & "               "
			end if
			if (open_6_16=3 or CheckPurview(intro_6_16,trim(cateid))=True) and trim(cateid_sp)=trim(session("personzbintel2007")) and (rs("complete")="2" or rs("complete")="0") then
				Response.write "" & vbcrlf & "               <input type=""button"" name=""Submit33"" value=""审批""  onClick=""javascript:window.location=('setsq.asp?"
				Response.write sdk.ReturnURL("ord=" & pwurl(rs("id")) &"")
				Response.write "')""/>" & vbcrlf & "               "
			end if
			if open_6_3=3 or CheckPurview(intro_6_3,trim(cateid))=True then
				Response.write "" & vbcrlf & "               <input type=""button"" name=""Submit"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='Deletesq.asp?"
				Response.write sdk.ReturnURL("ord=" & rs("id") &"")
				Response.write "'}""/>" & vbcrlf & "             "
			end if
		...
		loop
		Response.write "" & vbcrlf & "                     <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td height=""27"" colspan=""2""><div align=""right"">本页合计：</div></td>" & vbcrlf & "          <td width=""10%"" class=""red""><div align=""right"">"
		if listbz<>"" then
			Response.write trade8
			Response.write "&nbsp;"
		end if
		...
		Response.write "&nbsp;"
		Response.write "</div></td>" & vbcrlf & "        <td colspan=""6"" class=""func"">&nbsp;</td>" & vbcrlf & "      </tr>" & vbcrlf & "                   <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td height=""27"" colspan=""2""><div align=""right"">所有合计：</div></td>" & vbcrlf & "             <td width=""10%"" class=""red""><div align=""right"">"
		if listbz<>"" then
			Response.write trade8
			Response.write "&nbsp;"
		end if
		...
		Response.write "&nbsp;"
		Response.write "</div></td>" & vbcrlf & "        <td colspan=""6"" class=""func"">&nbsp;</td>" & vbcrlf & "      </tr>" & vbcrlf & "             </table>" & vbcrlf & "    </td>" & vbcrlf & "       </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""10%"" height=""30""><div align=""center"">全选" & vbcrlf & "          <input type=""checkbox"" name=""chkall"" id=""chkall"" value=""Check All"" onClick=""mm()"">" & vbcrlf & "    </div></td>" & vbcrlf & "    <td >"
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:150; height:152;display:none;"">" & vbcrlf & "<table width=""150"" height=""160""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""152"">" & vbcrlf & "        <table width=""150"" height=""152"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=1')""><font color=""#2F496E"">按申请主题排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=2')""><font color=""#2F496E"">按申请主题排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=3')""><font color=""#2F496E"">按添加日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <tdheight=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=4')""><font color=""#2F496E"">按添加日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=5')""><font color=""#2F496E"">按申请日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=6')""><font color=""#2F496E"">按申请日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & "<div id=""w""  title=""高级检索""  style=""width:600px;height:450px;padding:5px;background: #fafafa;top:60px;display:none;"" class=""easyui-window"" closed=""true"" >" & vbcrlf & "<form method=""get"" action=""paysq.asp"" id=""date1"" onSubmit=""return Validator.Validate(this,2)"" style=""margin:0px"" name=""date22"">" & vbcrlf & "<div id=""hideDiv"" style=""border-style: none; border-width: 0px; border-color: inherit; margin: 0px; display:none; padding:0px;"">" & vbcrlf & "                       <div region=""center"" border=""false"" style=""padding:5px;background:#fff;border:1px solid #ccc; width:550px"">" & vbcrlf & "                           <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "                            <a class=""easyui-linkbutton""  href=""###"" onClick=""document.getElementById('date1').submit()"">确认</a>" & vbcrlf & "                         <a class=""easyui-linkbutton"" href=""###"" onClick=""$('#w').window('close');"">取消</a>" & vbcrlf & "                   </div>" & vbcrlf & "                  <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "" & vbcrlf & "          <td width=""20%"" class=""func""><div align=""right"">申请主题</div></td>" & vbcrlf & "                  <td width=""80%""><label>" & vbcrlf & "                  <input name=""title"" type=""text"" id=""title"">" & vbcrlf & "          </label></td>" & vbcrlf & "              </tr>" & vbcrlf & "               <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                 <td width=""20%""><div align=""right"">申请概要</div></td>" & vbcrlf & "                 <td width=""80%""><input name=""intro"" type=""text"" id=""intro""></td>" & vbcrlf & "               </tr>" & vbcrlf & "               <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                 <td width=""20%""><div align=""right"">申请备注</div></td>" & vbcrlf & "                 <td width=""80%""><input name=""remark"" type=""text"" id=""remark""></td>" & vbcrlf & "               </tr>" & vbcrlf & "               <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                 <td width=""20%""><div align=""right"">申请金额</div></td>" & vbcrlf & "                 <td width=""80%""><input name=""money1"" type=""text""  class=""easyui-numberbox"" id=""money1"" size=""10"" maxlength=""10"" min=""0"" max=""999999999"" precision=""2"" onKeyUp=""value=value.replace(/[^ \d\.]/g,'');checkDot('money1','"
	Response.write num_dot_xs
	Response.write "')"" value=""0"">" & vbcrlf & "                   -" & vbcrlf & "                 <input name=""money12"" type=""text"" id=""money12"" size=""10"" maxlength=""10"" class=""easyui-numberbox"" min=""0"" max=""999999999"" precision=""2"" onKeyUp=""value=value.replace(/[^ \d\.]/g,'');checkDot('money12','"
	Response.write num_dot_xs
	Response.write "')"" value=""999999999""></td>" & vbcrlf & "               </tr>" & vbcrlf & "                         <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                 <td width=""20%""><div align=""right"">审批状态</div></td>" & vbcrlf & "              <td width=""80%"">                            " & vbcrlf & "                       <input name=""e1"" type=""checkbox"" id=""e1""  value=""1"">审批通过&nbsp;" & vbcrlf & "                      <input name=""e1"" type=""checkbox"" id=""e1""  value=""2"">审批中&nbsp;" & vbcrlf & "                <input name=""e1"" type=""checkbox"" id=""e1""  value=""0"">待审批&nbsp;" & vbcrlf & "                     <input name=""e1"" type=""checkbox"" id=""e1""  value=""3"">审批未通过" & vbcrlf & "                        </td>" & vbcrlf & "                      </tr>" & vbcrlf & "               <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                 <td width=""20%""><div align=""right"">申请时间</div></td>" & vbcrlf & "                 <td width=""80%"">" & vbcrlf & "                                       <INPUT name=""rett"" size=""9"" readonly id=""duepaydate1divPos"" onmouseup=toggleDatePicker(""duepaydate1div"",""date.rett"") value="""
	Response.write m1
	...
	Response.write m1
	Response.write m2
	Response.write """>" & vbcrlf & "         <DIV id=""duepaydate2div"" style=""POSITION: absolute;z-index:10"" name =""duepaydate2div""></DIV>                           </td>" & vbcrlf & "               </tr>" & vbcrlf & "               <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                 <td width=""20%""><div align=""right"">币种</div></td>" & vbcrlf & "                 <td width=""80%"">" & vbcrlf & "                       <select name=""listbz"">" & vbcrlf & "                    "
	sql8="select bz from setbz"
	set rs8=conn.execute(sql8)
	bz=rs8("bz")
	set rs8=nothing
	...
	set rs8=nothing
	Response.write "" & vbcrlf & "                      </select></td>" & vbcrlf & "               </tr>" & vbcrlf & "                         <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                 <td width=""20%""><div align=""right"">申请人员</div></td>" & vbcrlf & "             <td width=""80%"">"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & "                    </tr>" & vbcrlf & "                        </table>" & vbcrlf & "                        </div>" & vbcrlf & "                  <div region=""south"" border=""false"" style=""padding-top:5px;text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "                            <a class=""easyui-linkbutton""  href=""###"" onClick=""document.getElementById('date1').submit()"">确认</a>" & vbcrlf & "                             <a class=""easyui-linkbutton"" href=""###"" onClick=""$('#w').window('close');"">取消</a>" & vbcrlf & "                   </div>" & vbcrlf & "  </div>" & vbcrlf & "</form>" & vbcrlf & "  </div>" & vbcrlf & ""
	action1="申请列表"
	call close_list(1)
	Response.write "" & vbcrlf & "<script src= ""../Script/py_paysq.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<script language=""javascript"">" & vbcrlf & ""
	if remind<>"" then
