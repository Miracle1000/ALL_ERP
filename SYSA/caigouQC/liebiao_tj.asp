...
'If ycgnum1&"" = "" Then ycgnum1 = 0 Else ycgnum1 = CDBL(ycgnum1)
	...
	Response.write "               " & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td colspan=""2""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=document.getElementById""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">人员选择：</div></td>" & vbcrlf & "<td><div style=""margin-bottom:10px;""><input type=""radio"" name=""ry"" value=""0"">申请人员&nbsp;&nbsp;<input type=""radio"" name=""ry"" value=""1"">质检人员</div>" & vbcrlf & ""
	Str_gate31="and ord="&session("personzbintel2007")&""
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">质检方案：</div></td><td>" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	sql="select ord,sort1 from sortonehy where del=1 and gate2=3001 and isNull(isStop,0)=0 order by gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write " " & vbcrlf & "<input name=""G"" type=""checkbox"" value="""
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "</td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">质检状态：</div></td>" & vbcrlf & "<td>" & vbcrlf & "     <input type=""checkbox"" name=""E"" value=""0"">待质检 " & vbcrlf & "    <input type=""checkbox"" name=""E"" value=""1"">质检中 " & vbcrlf & "    <input type=""checkbox"" name=""E"" value=""2"">待审批 " & vbcrlf & "    <input type=""checkbox"" name=""E"" value=""3"">质检完毕 " & vbcrlf & "</td>" & vbcrlf & "</tr>" & vbcrlf & ""
	if ShowRKInfo() then
		Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td align=""right"">入库状态：</td><td>" & vbcrlf & "    <input type=""checkbox"" name=""Z1"" value=""1"">未入库 " & vbcrlf & "    <input type=""checkbox"" name=""Z1"" value=""2"">部分入库 " & vbcrlf & "    <input type=""checkbox"" name=""Z1"" value=""3"">入库完毕 " & vbcrlf & "</td></tr>" & vbcrlf
	end if
	Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td align=""right"">质检类型：</td><td>" & vbcrlf & "  <input type=""checkbox"" name=""F"" value=""0"">全检 " & vbcrlf & "    <input type=""checkbox"" name=""F"" value=""1"">抽检" & vbcrlf & "</td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">质检等级：</div></td><td>" & vbcrlf
	set rs=server.CreateObject("adodb.recordset")
	sql="select ord,sort1 from sortonehy where gate2=78 order by gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "</td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">质检主题：</div></td>" & vbcrlf & "<td><select name=""F1"">" & vbcrlf & "<option value=""1"">包含</option>" & vbcrlf & "<optionvalue=""2"">不包含</option>" & vbcrlf & "<option value=""3"">等于</option>" & vbcrlf & "<option value=""4"">不等于</option>" & vbcrlf & "<option value=""5"">以..开始</option>" & vbcrlf & "<option value=""6"">以..结束</option>" & vbcrlf & "</select>" & vbcrlf & " <input name=""F2"" type=""text"" size=""15""></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">质检编号：</div></td>" & vbcrlf & "<td><select name=""S1"">" & vbcrlf & "<option value=""1"">包含</option>" & vbcrlf & "<option value=""2"">不包含</option>" & vbcrlf & "<option value=""3"">等于</option>" & vbcrlf & "<option value=""4"">不等于</option>" & vbcrlf & "<option value=""5"">以..开始</option>" & vbcrlf & "<option value=""6"">以..结束</option>" & vbcrlf & "</select>" & vbcrlf & " <input name=""S2"" type=""text"" size=""15""></td></tr>" & vbcrlf & " "
	call Show_Search_Extended(28)
	Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">关联采购：</div></td>" & vbcrlf & "<td><select name=""G1"">" & vbcrlf & "<option value=""1"">包含</option>" & vbcrlf & "<option value=""2"">不包含</option>" & vbcrlf & "<option value=""3"">等于</option>" & vbcrlf & "<option value=""4"">不等于</option>" & vbcrlf & "<option value=""5"">以..开始</option>" & vbcrlf & "<option value=""6"">以..结束</option>" & vbcrlf & "</select>" & vbcrlf & " <input name=""G2"" type=""text"" size=""15""></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">关联供应商：</div></td>" & vbcrlf & "<td><select name=""P1"">" & vbcrlf & "<option value=""1"">包含</option>" & vbcrlf & "<option value=""2"">不包含</option>" & vbcrlf & "<option value=""3"">等于</option>" & vbcrlf & "<option value=""4"">不等于</option>" & vbcrlf & "<option value=""5"">以..开始</option>" & vbcrlf & "<option value=""6"">以..结束</option>" & vbcrlf & "</select>" & vbcrlf & " <input name=""P2"" type=""text"" size=""15""></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">产品名称：</div></td>" & vbcrlf & "<td><select name=""I1"">" & vbcrlf & "<option value=""1"">包含</option>" & vbcrlf & "<option value=""2"">不包含</option>" & vbcrlf & "<option value=""3"">等于</option>" & vbcrlf & "<option value=""4"">不等于</option>" & vbcrlf & "<option value=""5"">以..开始</option>" & vbcrlf & "<option value=""6"">以..结束</option>" & vbcrlf & "</select>" & vbcrlf & " <input name=""I2"" type=""text"" size=""15""></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">产品编号：</div></td>" & vbcrlf & "<td><select name=""J1"">" & vbcrlf & "<option value=""1"">包含</option>" & vbcrlf & "<option value=""2"">不包含</option>" & vbcrlf & "<option value=""3"">等于</option>" & vbcrlf & "<option value=""4"">不等于</option>" & vbcrlf & "<option value=""5"">以..开始</option>" & vbcrlf & "<option value=""6"">以..结束</option>" & vbcrlf & "</select>" & vbcrlf & " <input name=""J2"" type=""text"" size=""15""></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">产品型号：</div></td>" & vbcrlf & "<td><select name=""K1"">" & vbcrlf & "<option value=""1"">包含</option>" & vbcrlf & "<option value=""2"">不包含</option>" & vbcrlf & "<option value=""3"">等于</option>" & vbcrlf & "<option value=""4"">不等于</option>" & vbcrlf & "<option value=""5"">以..开始</option>" & vbcrlf & "<option value=""6"">以..结束</option>" & vbcrlf & "</select>" & vbcrlf & " <input name=""K2"" type=""text"" size=""15""></td></tr>" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	sql="select title,sorce,name,kd from zdymx where sort1=28 and set_open=1 and sorce between 9 and 15 order by gate1 asc "
	rs.open sql,conn,1,1
	if not rs.eof then
		rs_zdymx = rs.GetRows()
	end if
	...
	for i=0 to len_zdymx
		...
		if sorce<14 then
			...
			Response.write zdyname
			Response.write "_2"" type=""text"" size=""15""></td></tr>" & vbcrlf & " " & vbcrlf & ""
		elseif sorce=14 or sorce=15 then
			Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
			Response.write title
			Response.write "：</div></td><td>" & vbcrlf & ""
			set rs=conn.execute("select b.ord,b.sort1 from zdy a left join sortonehy b on a.gl=b.gate2 where a.sort1=21 and a.sort=1 and a.name='"& zdyname &"'  order by a.gate1 asc")
			while not rs.eof
				Response.write " " & vbcrlf & "<input name="""
				Response.write zdyname
				Response.write """ type=""checkbox"" value="""
	...
	next
	Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">添加时间：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=""ret3"" size=10  onclick=""javascript:datedlg.show();"" value="""
	Response.write m3
	Response.write """>&nbsp;至：<INPUT name=""ret4"" size=10 onClick=""javascript:datedlg.show();"" value="""
	Response.write m4
	Response.write """></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">申请日期：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=""ret7"" size=10 onClick=""javascript:datedlg.show();"" value="""
	Response.write m7
	Response.write """>&nbsp;至：<INPUT name=""ret8"" size=10 onClick=""javascript:datedlg.show();"" value="""
	Response.write m8
	Response.write """></td></tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">质检日期：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=""ret5"" size=10 onClick=""javascript:datedlg.show();"" value="""
	Response.write m5
	Response.write """>&nbsp;至：<INPUT name=""ret6"" size=10 onClick=""javascript:datedlg.show();"" value="""
	Response.write m6
	Response.write """></td></tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td width=""10%"">&nbsp;</td>" & vbcrlf & "<td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr></table>" & vbcrlf & ""
	conn.close
	set conn=nothing
