...
'If Not rs.Eof Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style></head>" & vbcrlf & "" & vbcrlf & "<body>" & vbcrlf & ""
	Response.write Application("sys.info.jsver")
	if open_77_17<>1 then
		Response.write"<script language=javascript>alert('您还没有邮件模板分类权限!');window.opener=null;window.open('','_self');window.close();</script>"
		call db_close : Response.end
	end if
	dim  ord,sortName,order1
	if request("ord")="" then
	else
		ord=deurl(request("ord"))
		set rs=server.CreateObject("adodb.recordset")
		sql="select * from email_maoban_sort where ord="&ord&" "
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0""  cellpadding=""0"" cellspacing=""0"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "        <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"" background=""../images/m_mpbg.gif""> "& vbcrlf &          "     <tr>" & vbcrlf &           "      <td  class=""place"">设置邮件模板分类</td> "& vbcrlf &               "  <td align=""right"">&nbsp;</td> "& vbcrlf &   "      </tr>" & vbcrlf &   "    </table>  " & vbcrlf & vbcrlf &   " <table width=""100%"" border=""0"" cellpadding=""3""cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "   <form method=""post"" action=""UpdateSort.asp?ord="
	Response.write pwurl(ord)
	Response.write """  id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "    <tr class=""top""> " & vbcrlf & "      <td colspan=""2"">"
	if sortName<>"" then
		Response.write "修改"
	else
		Response.write "添加"
	...
	Response.write " </td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td width=""23%"" height=""20"" ><div align=""right"">分类名称：</div></td>" & vbcrlf & "      <td width=""77%"" > <input type=""text"" name=""sort1"" value="""
	Response.write sortName
	Response.write """   size=""30""  dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1个至50个字之间"">" & vbcrlf & "        <span class=""red"">*</span></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td height=""20""><div align=""right"">重要指数：</div></td>" & vbcrlf & "      <td height=""20"">" & vbcrlf & "              <input type=""text"" name=""order1"" value="""
	Response.write order1
	Response.write """   size=""30""　onKeyUp=""value=value.replace(/[^ \d]/g,'')""     dataType=""Limit"" min=""1"" max=""10""  msg=""长度必须在1个至10个数字之间"">" & vbcrlf & "             <span class=""red"">*</span>         </td>" & vbcrlf & "    </tr>" & vbcrlf & "" & vbcrlf & "    <tr> " & vbcrlf & "      <td  colspan=""2"" >" & vbcrlf & "        <div align=""center"">" & vbcrlf & "            <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>　　　　　" & vbcrlf & " " & vbcrlf & "            <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "          </div></td>" & vbcrlf & "</tr>" & vbcrlf & "    </form>" & vbcrlf & "  </table>" & vbcrlf & "  </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""80"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "</td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="设置邮件模板分类"
	call close_list(1)
