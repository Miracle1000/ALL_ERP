...
'function IsTime(values)
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "" & vbcrlf & "a=2" & vbcrlf & "b=2" & vbcrlf & "function Addtr()" & vbcrlf & "{" & vbcrlf & "        try" & vbcrlf & "     {" & vbcrlf & "               var Tbody=document.getElementById('Tbody');" & vbcrlf & "             var tr=document.createElement(""tr"");" & vbcrlf & "            tr.id=""tr_""+j;" & vbcrlf & "            tr.name=""table_tr"";" & vbcrlf & "               Tbody.appendChild(tr);" & vbcrlf & "          var td0 = document.createElement('td');" & vbcrlf & "         tr.appendChild(td0);" & vbcrlf & "            Href = ""<div align=\""left\""><div align=\""left\""><a href=\""javascript:void(0)\"" onClick=\""Addtr()\""><span class=\""red\"">√</span></a>&nbsp;&nbsp;<input name=\""wr_assname\"" value=\""点击选择资产\"" style=\""color:#CCCCCC\"" onClick=\""javascript:window.open('../search/search_asset.asp?name1=wr_assname&id=wr_assID&args=""+b+""','neww37win','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');\"" type=\""text\"" id=\""wr_assname_""+b+""\"" size=\""20\"" maxlength=\""100\""><input type=\""hidden\"" name=\""wr_assID\"" id=\""wr_assID_""+b+""\"" dataType=\""Limit\"" min=\""1\"" max=\""100\"" msg=\""必填\"">&nbsp;<span class=\""red\"">*</span>&nbsp;&nbsp;<a href=\""###\"" onclick=\""del_TR('""+tr.id+""')\""><img src=\""../images/del2.gif\""/></a>&nbsp;<span id='sortlist'>""+a+""</span></div>"";" & vbcrlf & "               td0.innerHTML=Href;" & vbcrlf & "             var td1 = document.createElement('td');" & vbcrlf &"          tr.appendChild(td1);" & vbcrlf & "            Href = ""<div align=\""center\"" id=\""ass_type_""+b+""\""></div>"";" & vbcrlf & "            td1.innerHTML=Href;" & vbcrlf & "             var td2 = document.createElement('td');" & vbcrlf & "         tr.appendChild(td2);" & vbcrlf & "            Href = ""<div align=\""center\"" id=\""ass_bh_""+b+""\"">"";" & vbcrlf & "             td2.innerHTML=Href;" & vbcrlf & "             var td3 = document.createElement('td');" & vbcrlf & "         tr.appendChild(td3);" & vbcrlf & "            Href = ""<div align=\""center\"" id=\""ass_cycle1_""+b+""\""></div>"";" & vbcrlf & "          td3.innerHTML=Href;" & vbcrlf & "             var td4 = document.createElement('td');" & vbcrlf & "         tr.appendChild(td4);" & vbcrlf & "            Href = ""<div align=\""center\""><input name=\""wr_working\"" type=\""text\"" id=\""wr_working_""+b+""\"" size=\""10\"" maxlength=\""12\"" onKeyUp=\""value=value.replace(/[^\\d]/g,'')\"" dataType=\""Limit\"" min=\""1\"" max=\""12\"" msg=\""必填\"">&nbsp;<span class=\""red\"">*</span></div>"";" & vbcrlf & "          td4.innerHTML=Href;" & vbcrlf & "             a=a+1;" & vbcrlf & "          b=b+1;" & vbcrlf & "  }" & vbcrlf & "       catch(e)" & vbcrlf & "        {}" & vbcrlf & "}" & vbcrlf & "function del_TR(id)" & vbcrlf & "{" & vbcrlf & " var tr=document.getElementById(id);" & vbcrlf & "  tr.parentNode.removeChild(tr);" & vbcrlf & "  setSortList();" & vbcrlf & "}" & vbcrlf & "function setSortList()" & vbcrlf & "{" & vbcrlf & "  var sortlist=document.getElementsByName('sortlist');" & vbcrlf & "    for (i=0;i<sortlist.length;i++)" & vbcrlf & " {" & vbcrlf & "               sortlist[i].innerHTML=i+1;" & vbcrlf & "       }" & vbcrlf & "       a=a-1;" & vbcrlf & "}" & vbcrlf & "function ask1()" & vbcrlf & "{" & vbcrlf & " " & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "       margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "img{" & vbcrlf & "border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "" & vbcrlf & "-->" & vbcrlf & ".top.top_tr td{padding-bottom:0!important}" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
	set ml=new myclass
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">录入工作量</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "        <form action=""Save_assetBB1.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1""  bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top top_tr resetGroupTableBg"">" & vbcrlf & "    <td height=""27"" ><div align=""left""><strong>基本信息</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""4"">" & vbcrlf & "                <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "              <input type=""reset""value=""重填"" class=""page"" name=""B22"">" & vbcrlf &  "              </div></td>" & vbcrlf &  "       </tr>" & vbcrlf & "            <tr><td colspan=""5"">" & vbcrlf &   "                    <table class=""detailTable"" style=""width:100%"">" & vbcrlf &"                         <tr class=""top"">" & vbcrlf &   "                              <td height=""30""><div align=""center""><strong>资产名称</strong></div></td>" & vbcrlf & "                                <td width=""20%"" height=""30""><div align=""center""><strong>资产分类</strong></div></td>" & vbcrlf & "                          <td width=""20%"" height=""30""><div align=""center""><strong>资产编号</strong></div></td>" & vbcrlf & "                          <td width=""15%"" height=""30""><div align=""center""><strong>单位</strong></div></td>" & vbcrlf & "                            <td width=""15%"" height=""30""><div align=""center""><strong>本期工作量</strong></div></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                   "
	sql="select a.*,b.sort1 from O_asset a left join O_assSetname b on a.ass_type=b.id where ass_del=1 and ass_cycle1 in(3,4,5) "
	set rs=conn.execute(sql)
	if not rs.eof then
		do while not rs.eof
			Response.write "" & vbcrlf & "                        <tr>" & vbcrlf & "                          <td height=""30""><div align=""center""><input name=""wr_assname"" type=""text"" id=""wr_assname"" size=""20"" value="""
			Response.write rs("ass_name")
			Response.write """ maxlength=""100""><input type=""hidden"" name=""wr_assID"" id=""wr_assID"" value="""
			Response.write rs("ass_id")
			Response.write """></td>" & vbcrlf & "                            <td width=""20%"" height=""30""><div align=""center"" id=""ass_type_1"">"
			Response.write rs("sort1")
			Response.write "</div></td>" & vbcrlf & "                           <td width=""20%"" height=""30""><div align=""center"" id=""ass_bh_1"">"
			Response.write rs("ass_bh")
			Response.write "</div></td>" & vbcrlf & "                           <td width=""15%"" height=""30""><div align=""center"" id=""ass_cycle1_1"">" & vbcrlf & "                              "
			...
			elseif rs("ass_cycle1")=3 then
				Response.write "台班"
			elseif rs("ass_cycle1")=4 then
				Response.write "小时"
			elseif rs("ass_cycle1")=5 then
				Response.write "公里"
			end if
			Response.write "</div></td>" & vbcrlf & "                           <td width=""15%"" height=""30""><div align=""center""><input name=""wr_working"" type=""text"" id=""wr_working"" size=""10"" maxlength=""12"" onpropertychange=""formatData(this,'int');"" value=""0""></div></td>" & vbcrlf & "                        </tr>" & vbcrlf & "                   "
			rs.movenext
		loop
	else
		Response.write "<tr><td colspan=5 align=center height=30>暂无需要添加的工作量！</td></tr>"
	end if
	set rs=nothing
	Response.write "" & vbcrlf & "                      </table>" & vbcrlf & "                        </td></tr>" & vbcrlf & "     <tr>" & vbcrlf & "        <td colspan=""5"" class=""gray"">" & vbcrlf & "                    <div align=""center"">" & vbcrlf & "                        <input type=""submit"" name=""Submit42"" value=""保存"" class=""page""/>" & vbcrlf & "                        <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "                 </div></td>" & vbcrlf & "      </tr> " & vbcrlf & "    </table>" & vbcrlf & "     </form>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "              <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""adsDiv"" style=""position:absolute;z-index:2001;display:none;padding:2px 2px 2px 2px;background-color:lightblue"">" & vbcrlf & "<iframe src="""" name=""adsIF"" id=""adsIF"" width=""195px"" frameborder=""0"" border=""0"" scrolling=""no""></iframe>" & vbcrlf & "</div>" & vbcrlf & "<form target=""ssIF"" action=""../asset/Select_All.asp"" id=""ssIFForm"" style=""display:none"" method=""post"">" & vbcrlf & "</form>" & vbcrlf & ""
	action1="录入工作量"
	call close_list(1)
