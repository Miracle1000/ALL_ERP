...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	xlWorksheet.Cells(1,1).Value = "名称"
	xlWorksheet.Cells(1,2).Value = "数据"
	...
	do until rs.eof
		...
		if rs("sort")<>"" then
			...
			sql7="select sort1 from sort4 where ord="&rs("sort")&""
		...
		if rs("sort1")<>"" then
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select sort2 from sort5 where ord="&rs("sort1")&""
			rs7.open sql7,conn,1,1
			if rs7.eof then
				sort2=""
			else
		...
		if rs("jz")<>"" then
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select sort1 from sortonehy where ord="&rs("jz")&""
			rs7.open sql7,conn,1,1
			if rs7.eof then
				jz=""
			else
		...
		if rs("area")<>"" then
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select sort2 from sort where ord="&rs("area")&""
			rs7.open sql7,conn,1,1
			if rs7.eof then
				area=""
			else
		...
		if rs("trade")<>"" then
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select sort1 from sortonehy where ord="&rs("trade")&""
			rs7.open sql7,conn,1,1
			if rs7.eof then
				trade=""
			else
		...
		if rs("person")>0  then
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select name,sex,part1,job,phone,fax,mobile,email from person where ord="&rs("person")&""
			rs7.open sql7,conn,1,1
			if rs7.eof then
				person=""
				sex=""
		...
		sql1="select intro,date7 from reply  where ord="&rs("ord")&" and del=1 order by date7 asc"
		...
		date7=rs("date1")
		xlWorksheet.Cells(1+i,3).Value = sort1
		date7=rs("date1")
		xlWorksheet.Cells(1+i,4).Value = sort2
		date7=rs("date1")
		xlWorksheet.Cells(1+i,5).Value = jz
		date7=rs("date1")
		xlWorksheet.Cells(1+i,6).Value = ly
		date7=rs("date1")
		xlWorksheet.Cells(1+i,7).Value = area
		date7=rs("date1")
		xlWorksheet.Cells(1+i,8).Value = trade
		date7=rs("date1")
		xlWorksheet.Cells(1+i,9).Value = person
		date7=rs("date1")
		xlWorksheet.Cells(1+i,10).Value = sex
		date7=rs("date1")
		xlWorksheet.Cells(1+i,11).Value = part1
		date7=rs("date1")
		xlWorksheet.Cells(1+i,12).Value = job
		date7=rs("date1")
		xlWorksheet.Cells(1+i,13).Value = phone
		date7=rs("date1")
		xlWorksheet.Cells(1+i,14).Value = fax
		date7=rs("date1")
		xlWorksheet.Cells(1+i,15).Value = mobile
		date7=rs("date1")
		xlWorksheet.Cells(1+i,16).Value = email
		date7=rs("date1")
		xlWorksheet.Cells(1+i,17).Value = url
		date7=rs("date1")
		xlWorksheet.Cells(1+i,18).Value = address
		date7=rs("date1")
		xlWorksheet.Cells(1+i,19).Value = zip
		date7=rs("date1")
		xlWorksheet.Cells(1+i,20).Value = product
		date7=rs("date1")
		xlWorksheet.Cells(1+i,21).Value = c2
		date7=rs("date1")
		xlWorksheet.Cells(1+i,22).Value = c3
		date7=rs("date1")
		xlWorksheet.Cells(1+i,23).Value = c4
		date7=rs("date1")
		xlWorksheet.Cells(1+i,24).Value = intro
		date7=rs("date1")
		xlWorksheet.Cells(1+i,25).Value = intro2
		date7=rs("date1")
		xlWorksheet.Cells(1+i,26).Value = cateid
		date7=rs("date1")
		xlWorksheet.Cells(1+i,27).Value = date7
		date7=rs("date1")
	...
	tfile=Server.MapPath("customer"&session("personzbintel2007")&".xls")
	...
	Response.write """><font class=""red""><strong><u>下载导出的客户资料</u></strong></font></a></p> " & vbcrlf & ""
