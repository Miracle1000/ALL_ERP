...
'if strW3<>"" Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "      margin-top: 0px;" & vbcrlf & "}" & vbcrlf & ".style17 {color: #FF8040}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script src=""../inc/loadingBar.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "        <tr>" & vbcrlf & "          <td class=""place"">邮件地址添加</td>" & vbcrlf & "          <td>&nbsp;</td>" & vbcrlf & "          <tdalign=""right"">&nbsp;</td>" & vbcrlf & "          <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>" & vbcrlf & "" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                <form name=""form1"" method=""post"" action=""addPerson.asp?px="
	Response.write px
	Response.write "&page_count="
	Response.write page_count
	Response.write "&H=1&type=2"">" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人来源：</div></td>" & vbcrlf & "            <td><input type=""radio"" name=""s3"" value=""1"">客户&nbsp;<input type=""radio"" name=""s3"" value=""2"">供应商&nbsp;<input type=""radio"" name=""s3"" checked value=""0"">全部&nbsp;</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人姓名：</div></td>" & vbcrlf & "            <td><select name=""F1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""F2"" type=""text"" size=""15"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人性别：</div></td>" & vbcrlf & "            <td> 男" & vbcrlf & "              <input name=""sex"" type=""radio"" value=""男""/>" & vbcrlf & "              女" & vbcrlf & "              <input type=""radio"" name=""sex"" value=""女""/>" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "           "
	Response.write "" & vbcrlf & "                 <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">所有者：</div></td>" & vbcrlf & "            <td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">客户分类：</div></td>" & vbcrlf & "            <td>"
	dim i5
	i5=2
	set rs1=server.CreateObject("adodb.recordset")
	...
	if rs1.RecordCount<=0 then
		...
		do until rs1.eof
			...
			if rs2.RecordCount<=0 then
				...
				do until rs2.eof
					Response.write "" & vbcrlf & "                <span class='gray'>" & vbcrlf & "                <input name='F' type='checkbox' value='"
	...
	rs1.close
	set rs1=nothing
	Response.write "" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                      <td align=""right"">客户来源：</td><td>" & vbcrlf & "                     "
	set rs=server.CreateObject("adodb.recordset")
	sql="select ord,sort1 from sortonehy where gate2=13 order by gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""A3"" value="""
	...
	set rs=server.CreateObject("adodb.recordset")
	sql="select ord,sort1 from sortonehy where gate2=14 order by gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""A1"" value="""
		Response.write rs("ord")
		Response.write """>"
		Response.write rs("sort1")
		rs.movenext
	...
	rs.close
	set rs=Nothing
	Response.write "" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">客户区域：</div></td>" & vbcrlf & "            <td>"
	execute sdk.vbs("../manager/search_area" &  Application("__saas__company")  & ".asp")
	Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">客户行业：</div></td>" & vbcrlf & "            <td>"
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">客户名称：</div></td>" & vbcrlf & "            <td><select name=""C1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""C2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "                    "
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=1 and set_open=1 and js=1 and sort=2 order by gate1 asc "
	rs.open sql,conn,1,1
	if Not rs.eof then
		do until rs.eof
			Response.write "" & vbcrlf & "                                     <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                                       <td><div align=""right"">"
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人部门：</div></td>" & vbcrlf & "            <td><select name=""P1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option> "& vbcrlf &          "     </select>" & vbcrlf &            "   <input name=""P2"" type=""text"" size=""50"">" & vbcrlf &         "    </td> "& vbcrlf &         " </tr> "& vbcrlf &      "     <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=ecf5ff""> "& vbcrlf &            " <td><div align=""right"">联系人职务：</div></td> "& vbcrlf &     "        <td><select name=""J1""> "& vbcrlf &          "       <option value=""1"">包含</option>" & vbcrlf &         "        <option value=""2"">不包含</option>" & vbcrlf &            "     <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""J2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人手机：</div></td>" & vbcrlf & "            <td><select name=""Mob1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""Mob2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人电话：</div></td>" & vbcrlf & "            <td><select name=""T1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""T2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人传真：</div></td>" & vbcrlf & "            <td><select name=""Fax1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""Fax2"" type=""text"" size=""50"">" & vbcrlf & "            </td>"& vbcrlf &       "   </tr>" & vbcrlf &      "     <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff""> "& vbcrlf &        "     <td><div align=""right"">联系人QQ：</div></td>" & vbcrlf &       "      <td><select name=""QQ1""> "& vbcrlf &              "   <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "       <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""QQ2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人MSN：</div></td>" & vbcrlf & "            <td><select name=""MSN1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "       <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""MSN2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人邮箱：</div></td>" & vbcrlf & "            <td><select name=""Email1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""Email2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人地址：</div></td>" & vbcrlf & "            <td><select name=""Add1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""Add2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人爱好：</div></td>" & vbcrlf & "            <td><select name=""Joy1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">以..开始</option>" & vbcrlf & "                <option value=""4"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""Joy2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人拼音码：</div></td>" & vbcrlf & "            <td><select name=""Pym1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">等于</option>" & vbcrlf & "                <option value=""4"">不等于</option>" & vbcrlf & "                <option value=""5"">以..开始</option>" & vbcrlf & "                <option value=""6"">以..结束</option>" & vbcrlf & "              </select>" &vbcrlf & "              <input name=""Pym2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">联系人备注：</div></td>" & vbcrlf & "            <td><select name=""Intro1"">" & vbcrlf & "                <option value=""1"">包含</option>" & vbcrlf & "                <option value=""2"">不包含</option>" & vbcrlf & "                <option value=""3"">以..开始</option>" & vbcrlf & "                <option value=""4"">以..结束</option>" & vbcrlf & "              </select>" & vbcrlf & "              <input name=""Intro2"" type=""text"" size=""50"">" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">添加日期：</div></td>" & vbcrlf & "            <td>&nbsp;自：" & vbcrlf & "              <INPUT name=ret size=9  id=daysOfMonthPos onmouseup=toggleDatePicker(""daysOfMonth"",""date.ret"") value="""
	Response.write m1
	Response.write """>" & vbcrlf & "              <DIV id=daysOfMonth style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至:" & vbcrlf & "              <INPUT name=ret2 size=9  id=daysOfMonth2Pos onmouseup=toggleDatePicker(""daysOfMonth2"",""date.ret2"") value="""
	Response.write m1
	Response.write m2
	Response.write """>" & vbcrlf & "              <DIV id=daysOfMonth2 style=""POSITION: absolute""></DIV></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td width=""23%"">&nbsp;</td>" & vbcrlf & "            <td width=""77%""><input type=""submit"" name=""Submit45"" IsShowProcessBar=""True"" value=""检索""  class=""page""/>" & vbcrlf & "              &nbsp;&nbsp;" & vbcrlf & "              <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "            &nbsp;&nbsp;" & vbcrlf & "              <input type=""button"" value=""返回"" onClick=""history.back();"" class=""page"" name=""B22""></td>" & vbcrlf & "          </tr>" & vbcrlf & "                          </form>" & vbcrlf & "        </table>" & vbcrlf & "      </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "    <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "        <tr>" & vbcrlf & "          <td height=""1630"" ><div align=""center""></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
	Response.write "" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & "    function checkAll2(str){" & vbcrlf & "        var a=document.getElementById(""u""+str).getElementsByTagName(""input"");" & vbcrlf & "        var b=document.getElementById(""e""+str);" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf & "            a[i].checked=b.checked;" & vbcrlf & "        }" & vbcrlf & "    }" & vbcrlf & "" & vbcrlf & "    function fixChk2(str){" & vbcrlf & "        var a=document.getElementById(""u""+str).getElementsByTagName(""input"");" & vbcrlf & " var b=document.getElementById(""e""+str);" & vbcrlf & "        for(var i=0;i<a.length;i++){" & vbcrlf & "            if(a[i].checked==false){" & vbcrlf & "                b.checked=false;" & vbcrlf & "                return ;" & vbcrlf & "            }" & vbcrlf & "        }" & vbcrlf & "    b.checked=true;" & vbcrlf & "    }" & vbcrlf & "  </script>"
