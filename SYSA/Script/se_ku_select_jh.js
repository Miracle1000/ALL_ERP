...
function add(ord,id,contractlist,top,kuoutlist,ckid) {
  ...
  var url = "cu_kuin_jh.asp?ord="+escape(ord)+"&num1="+escape(num1)+"&num1old="+escape(num1old)+"&num3="+escape(num3)+"&id="+escape(id)+"&contractlist="+escape(contractlist)+"&top="+escape(top)+"&kuoutlist="+escape(kuoutlist)+"&ckid="+escape(ckid)+"&timestamp=" + new Date().getTime() + "&date1="+ Math.round(Math.random()*100);
...
function check_ck(ord,id,contractlist,top,kuoutlist,i) {
  ...
  add(ord,id,contractlist,top,kuoutlist,i)
  return false;
  }
