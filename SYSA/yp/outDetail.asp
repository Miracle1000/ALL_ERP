...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/javascript"" src=""myJsClass.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "" & vbcrlf & "function pro_type1(val)" & vbcrlf & "{" & vbcrlf & "       url=""getDate.asp?tp=1&Sid=""+val;" & vbcrlf & "  xmlHttp.open(""GET"",url,false)" & vbcrlf & "     xmlHttp.onreadystatechange=function()" & vbcrlf & "   {" & vbcrlf & "               if (xmlHttp.readyState==4)" & vbcrlf & "              {" & vbcrlf & "                       var test=xmlHttp.responseText;" & vbcrlf & "                  var re1=test.indexOf('</noscript>');" & vbcrlf & "                    var re2=test.length;" & vbcrlf & "                    ajaxhtml=test.substring(re1+11,re2);" & vbcrlf & "                    document.getElementById('test2').innerHTML=""(""+ajaxhtml+"")"";" & vbcrlf & "                     " & vbcrlf & "                }" & vbcrlf & "               " & vbcrlf & "                " & vbcrlf & "        }" & vbcrlf & "       " & vbcrlf & "        xmlHttp.send(null);     " & vbcrlf & "}" & vbcrlf & "//function ask1()" & vbcrlf & "//{" & vbcrlf & "// if(document.getElementById('prod_type').value=="""")" & vbcrlf & "//   {" & vbcrlf & "//             document.getElementById('test1').innerHTML=""*必填""" & vbcrlf & "//              return false;" & vbcrlf & "// }" & vbcrlf & "//     document.getElementById('test1').innerHTML=""*"";" & vbcrlf & "// return true;" & vbcrlf & "//}" & vbcrlf & "var a=1" & vbcrlf & "function setMx()" & vbcrlf & "{" & vbcrlf & "  $('#ddd').dialog('open');" & vbcrlf & "}" & vbcrlf & "function addMx(id,prod_name,prod_bh,prod_xh,sort1,prod_num,pro_name)" & vbcrlf & "{" & vbcrlf & " var tablename=""prod_mx"";" & vbcrlf & "  var table=document.getElementById(tablename);" & vbcrlf & "   var tr = document.createElement('tr');" & vbcrlf & "      tr.onmouseover=function(){this.style.backgroundColor='efefef';}" & vbcrlf & " tr.onmouseout=function(){this.style.backgroundColor='';}" & vbcrlf & "        tr.id = ""jstr_""+id;" & vbcrlf & "       tr.name = ""nameTr"";       " & vbcrlf & "        table.appendChild(tr);" & vbcrlf & "        var td0 = document.createElement('td');" & vbcrlf & " tr.appendChild(td0);" & vbcrlf & "    td0.align=""center"";" & vbcrlf & "       var delHref = ""<div align=\""center\""><a href=\""###\"" onclick=\""del_TR('""+tr.id+""','""+id+""')\""><img src=\""../images/del2.gif\""/></a>&nbsp;&nbsp;""+prod_name+""</div><input type=\""hidden\"" value=\""+id+"\" name=\""prod_id\""></input>;" & vbcrlf & "       td0.innerHTML=delHref;" & vbcrlf & "  var td1 = document.createElement('td');" & vbcrlf & " tr.appendChild(td1);" & vbcrlf & "    td1.align=""center"";" & vbcrlf & "       var delHref = ""<div align=\""center\"">""+prod_bh+""</div>"";" & vbcrlf & " td1.innerHTML=delHref;" & vbcrlf & "  var td2 = document.createElement" & vbcrlf & "        var td3 = document.createElement('td');" & vbcrlf & " tr.appendChild(td3);" & vbcrlf & "    td3.align=""center"";" & vbcrlf & "       var delHref = ""<div align=\""center\"">""+sort1+""</div>""" & vbcrlf & " var td5 = document.createElement('td');" & vbcrlf & " tr.appendChild(td5);" & vbcrlf & "td5.align=""center"";" & vbcrlf & "       var delHref = ""<input name=\""prod_num\"" type=\""text\"" id=\""prod_num\"" onKeyUp=\""value=value.replace(/[^\\d]/g,'')\""  size=\""12\"" maxlength=\""12\"">"";" & vbcrlf & "  var td6 = document.createElement('td');" & vbcrlf & " tr.appendChild(td6);" & vbcrlf &"  td6.align=""center"";" & vbcrlf & "       delHref=""<div align=\""center\""><select name=\""sto_id\"">""" & vbcrlf & "      "
	sql8="select * from O_store order by sto_gate2 desc"
...
'do while not rs8.eof
	...
	rs8.close
	set rs8=nothing
	Response.write "" & vbcrlf & "      delHref = delHref+""</select></div>"";" & vbcrlf & "      td6.innerHTML=delHref;" & vbcrlf & "  var td4 = document.createElement('td');" & vbcrlf & " tr.appendChild(td4);" & vbcrlf & "    td4.align=""center"";" & vbcrlf & "       var delHref = ""<div align=\""center\"">""+prod_num+""</div>""" & vbcrlf & "        td4.innerHTML=delHref;" & vbcrlf & "  var td9 = document.createElement('td');" & vbcrlf & " tr.appendChild(td9);" & vbcrlf & "    td9.align=""center"";" & vbcrlf & "       var delHref =""<div align=\""center\"">""+pro_name+""</div>""" & vbcrlf & "       td9.innerHTML=delHref;" & vbcrlf & "  var td12 = document.createElement('td');" & vbcrlf & " tr.appendChild(td12);" & vbcrlf & "   td12.align=""center"";" & vbcrlf & "      var delHref =""<INPUT type=\""text\"" maxlength=\""200\"" size=\""15\"">""" & vbcrlf & "      td12.innerHTML=delHref;" & vbcrlf & " document.getElementById('tr_'+id).style.display='none';" & vbcrlf & "}" & vbcrlf & "function del_TR(id,id1)" & vbcrlf & "{" & vbcrlf & "       var tr=document.getElementById(id);" & vbcrlf & "     tr.parentNode.removeChild(tr);" & vbcrlf & "  document.getElementById('tr_'+id1).style.display='';" & vbcrlf & "}" & vbcrlf & "function chaValue(val)" & vbcrlf & "{" & vbcrlf & "     var num=""prod_num""+val" & vbcrlf & "    var price=""prod_price""+val" & vbcrlf & "        var num1=document.getElementById(num).value;" & vbcrlf & "    var price1=document.getElementById(price).value;" & vbcrlf & "        if (num1!="""" && price1!="""")" & vbcrlf & " {" & vbcrlf & "               document.getElementById(""prod_allmoney""+val).value=parseFloat(num1)*parseFloat(price1);" & vbcrlf & "  }" & vbcrlf & "}" & vbcrlf & "function batch(name,value)" & vbcrlf & "{" & vbcrlf & "   var obj=document.getElementsByName(name)[0];" & vbcrlf & "    var tgname=obj?obj.tagName:""input"";" & vbcrlf & "       var arrlist=document.getElementsByTagName(tgname);" & vbcrlf & "   for(i=0;i<arrlist.length;i++)" & vbcrlf & "   {" & vbcrlf & "               if(arrlist[i].name.indexOf(name)==0)" & vbcrlf & "            {" & vbcrlf & "                       arrlist[i].value=value;" & vbcrlf & "         }" & vbcrlf & "       }" & vbcrlf & "}" & vbcrlf & "function ask1()" & vbcrlf & "{" & vbcrlf & "var arrlist=document.getElementsByTagName(""input"");" & vbcrlf & "       for(i=0;i<arrlist.length;i++)" & vbcrlf & "   {" & vbcrlf & "               if(arrlist[i].value.indexOf(", ")>=0 && (!arrlist[i].onpropertychange))" & vbcrlf & "           {"  & vbcrlf & "                      arrlist[i].value=arrlist[i].value.replace(/,\s/g,""^#$6a"");" & vbcrlf & "               }" & vbcrlf & "       //arrlist[i].value=arrlist[i].value.replace("", "",'%^$a');" & vbcrlf & " }" & vbcrlf & "       return true;" & vbcrlf & "}" & vbcrlf & "function changeindex(val)" & vbcrlf & "{" & vbcrlf & " var obj=document.getElementsByTagName(""li"")" & vbcrlf & "       if(val!="""")" & vbcrlf& "        {" & vbcrlf & "               for(i=0;i<obj.length;i++)" & vbcrlf & "               {" & vbcrlf & "                       if(obj[i].innerText.indexOf(val)>=0)" & vbcrlf & "                    {                       " & vbcrlf & "                                obj[i].style.display='';" & vbcrlf & "                        }" & vbcrlf & "                       else" & vbcrlf & "                    {" & vbcrlf & "                               obj[i].style.display='none';" & vbcrlf & "                    }" & vbcrlf & "            }" & vbcrlf & "       }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               for(i=0;i<obj.length;i++)" & vbcrlf & "               {" & vbcrlf & "                       if(obj[i].innerText.indexOf(val)==0)" & vbcrlf & "                    {                       " & vbcrlf & "                                obj[i].style.display='';" & vbcrlf & "                        }" & vbcrlf & "               }" & vbcrlf & "       }" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "   margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "img{" & vbcrlf & "border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "-->" & vbcrlf & "#prod_type{" & vbcrlf & "width:150px;" & vbcrlf & "height:auto;" & vbcrlf & "margin-bottom:20px;" & vbcrlf & "border:1px solid #CAE3FF;" & vbcrlf & "background-color: #F4F9FF;" & vbcrlf & "position:absolute;" & vbcrlf & "padding:5px;" & vbcrlf & "display:none;" & vbcrlf & "filter:alpha(Opacity=80);-moz-opacity:0.5;opacity: 0.5;" & vbcrlf & "}" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	ord=request("ord")
	sql="select * from O_productOut where id="&ord
	set rs=conn.execute(sql)
	if not rs.eof then
		addcateid=rs("get_addcateid")
		Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">领用详情</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">" & vbcrlf & "                        "
		if open_101_7=3 or CheckPurview(intro_101_7,trim(session("personzbintel2007")))=True then
			Response.write "<input type=""button"" name=""Submit43"" value=""打印""  onClick=""window.print();return  false;""   class=""anybutton2""/>" & vbcrlf & "                       "
		end if
		if rs("get_type")=2 and rs("get_storecateid")=session("personzbintel2007") and rs("get_store")=2 and open_101_17=1 then
			Response.write "" & vbcrlf & "                   <input name=""button3"" type=""button""  class=""anybutton2"" id=""submit3"" onClick=""javascript:window.open('outku.asp?ord="
			Response.write rs("id")
			Response.write "','neww38win','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=300,top=300')"" value=""确认""/>" & vbcrlf & "                "
			Response.write rs("id")
		end if
		if (open_101_2=3 or CheckPurview(intro_101_2,trim(addcateid))=True) and rs("get_type")=2 and rs("get_store")=2 then
			Response.write "" & vbcrlf & "                       <input name=""button4"" type=""button""  class=""anybutton2"" id=""submit4"" onClick=""javascript:window.open('outUpdate.asp?ord="
			Response.write rs("id")
			Response.write "','neww36win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')"" value=""修改""/>" & vbcrlf & "                      "
			Response.write rs("id")
		end if
		if (open_101_2=3 or CheckPurview(intro_101_2,trim(addcateid))=True) and rs("get_type")<>2 and rs("get_store")<>2 then
			Response.write "" & vbcrlf & "                       <input name=""button4"" type=""button""  class=""anybutton2"" id=""submit4"" onClick=""javascript:window.open('outUpdate1.asp?ord="
			Response.write rs("id")
			Response.write "','neww36win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')"" value=""修改""/>" & vbcrlf & "                      "
			Response.write rs("id")
		end if
		del_bool=true
		sqltext="select * from O_proRetList where prod_id in (select id from O_proOutList where get_fid="&rs("id")&")"
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			del_bool=false
		end if
		set rstxt=nothing
		if (open_101_3=3 or CheckPurview(intro_101_3,trim(addcateid))=True) and del_bool then
			Response.write "" & vbcrlf & "                      <input name=""button5"" type=""button""  class=""anybutton2"" id=""submit5"" onClick=""if(confirm('确认删除吗？')){window.location=('outdel.asp?ord="
			Response.write rs("id")
			Response.write "&px="
			Response.write px
			...
			Response.write "&ret2="
			Response.write ret2
			Response.write "&r=1')}"" value=""删除""/>" & vbcrlf & "                      "
		end if
		Response.write "</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "   <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">"& vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" colspan=""6"" ><div align=""left""><strong>基本情况</strong></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "          <tr>" & vbcrlf & "      <td width=""14%"" height=""27""><div align=""right"">领用主题：</div></td>" & vbcrlf & "          <td width=""22%"" class=""gray"">"
		Response.write rs("get_title")
		Response.write "</td>" & vbcrlf & "        <td width=""13%""><div align=""right"">领用编号：</div></td>" & vbcrlf & "        <td width=""21%"" class=""gray"">"
		Response.write rs("get_bh")
		Response.write "</td>" & vbcrlf & "        <td width=""12%""><div align=""right"">领用时间：</div></td>" & vbcrlf & "              <td width=""18%"" class=""gray"">"
		Response.write rs("get_time")
		Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""14%"" height=""27""><div align=""right"">发放/申请人员：</div></td>" & vbcrlf & "     <td width=""22%"" class=""gray"">" & vbcrlf & "           "
		get_lycateid=rs("get_lycateid")
		if get_lycateid="" or isnull(get_lycateid) then get_lycateid=0
		sql8="select  * from gate where ord="&get_lycateid
		set rs8=conn.execute(sql8)
		if not rs8.eof then
		...
		rs8.close
		set rs8=nothing
		Response.write "             </td>" & vbcrlf & "        <td width=""13%""><div align=""right"">领用分类：</div></td>" & vbcrlf & "        <td width=""21%"" class=""gray"">" & vbcrlf & "              "
		get_type=rs("get_type")
		if get_type=1 then
			Response.write "用品发放"
		elseif get_type=2 then
			Response.write "用品申请"
		end if
		Response.write "</td>" & vbcrlf & "        <td width=""12%""><div align=""right"">"
		if rs("get_type")=2 then
			Response.write "库管人员："
		end if
		Response.write "</div></td>" & vbcrlf & "            <td width=""18%"" class=""gray"">"
		if rs("get_type")=2 then
			get_storecateid=rs("get_storecateid")
			if get_storecateid="" or isnull(get_storecateid) then get_storecateid=0
			sql8="select  * from gate where ord="&get_storecateid
			set rs8=conn.execute(sql8)
			if not rs8.eof then
				Response.write rs8("name")
			end if
		...
		if rs("get_type")=2 then
			Response.write "" & vbcrlf & "       <tr>" & vbcrlf & "      <td width=""14%"" height=""27""><div align=""right"">出库状态：</div></td>" & vbcrlf & "          <td width=""22%"" class=""gray"">"
			if rs("get_store")=2 then
				Response.write "未出库"
			elseif rs("get_store")=3 then
				Response.write "已否决"
			else
				Response.write "已出库"
			end if
			Response.write "</td>" & vbcrlf & "        <td height=""37""><div align=""right"">添加人员：</div></td>" & vbcrlf & "        <td class=""gray"">"
			get_addcateid=rs("get_addcateid")
			if get_addcateid="" or isnull(get_addcateid) then get_addcateid=0
			sql8="select  * from gate where ord="&get_addcateid
			set rs8=conn.execute(sql8)
			if not rs8.eof then
				Response.write rs8("name")
			end if
			rs8.close
			set rs8=nothing
			Response.write "</td>" & vbcrlf & "        <td><div align=""right"">添加时间：</div></td>" & vbcrlf & "        <td class=""gray"">"
			Response.write rs("get_addtime")
			Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "   "
		end if
		Response.write "" & vbcrlf & "       <tr>" & vbcrlf & "      <td height=""27""><div align=""right"">确认时间：</div></td>" & vbcrlf & "            <td class=""gray"">"
		Response.write rs("get_storetime")
		Response.write "</td>" & vbcrlf & "            <td><div align=""right"">确认意见：</div></td>" & vbcrlf & "      <td colspan=""3"" class=""gray"">"
		Response.write rs("get_Chnote")
		Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "                <tr>" & vbcrlf & "             <td height=""27""><p align=""right"">领用备注：</td>" & vbcrlf & "            <td colspan=""5"" class=""gray ewebeditorImg"">"
		Response.write rs("get_note")
		Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" align=""center"">" & vbcrlf & "          <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">" & vbcrlf & "         <tr>" & vbcrlf & "                    <td valign=""top"">" & vbcrlf & "                 <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                      <tr class=""top"">" & vbcrlf & "                          <td height=""27"" colspan=""14""><div align=""left"">用品明细</div></td>" & vbcrlf & "                            </tr>" & vbcrlf & "                   <tr>" & vbcrlf & "                            <td width=""10%"" height=""27""><div align=""center""><strong>名称</strong></div></td>" & vbcrlf & "                             <td width=""8%"" height=""27""><div align=""center""><strong>编号</strong></div></td>" & vbcrlf & "                               <td width=""9%"" height=""27""><div align=""center""><strong>型号</strong></div></td>" & vbcrlf & "                               <td width=""5%"" height=""27""><div align=""center""><strong>单位</strong></div></td>" & vbcrlf & "                          <td width=""7%"" height=""27""><div align=""center""><strong>领用数量</strong></div></td>" & vbcrlf & "                           <td width=""7%"" height=""27""><div align=""center""><strong>出库仓库</strong></div></td>" & vbcrlf & "                           <td width=""7%"" height=""27""><div align=""center""><strong>分类</strong></div></td>" & vbcrlf & "                               <td width=""7%"" height=""27""><div align=""center""><strong>批号</strong></div></td>" & vbcrlf & "                               <td width=""8%"" height=""27""><div align=""center""><strong>序列号</strong></div></td>" & vbcrlf & "                             <td width=""7%"" height=""27""><div align=""center""><strong>生产日期</strong></div></td>" & vbcrlf & "                               <td width=""8%"" height=""27""><div align=""center""><strong>有效日期</strong></div></td>" & vbcrlf & "                           <td width=""17%"" height=""27""><div align=""center""><strong>备注</strong></div></td>" & vbcrlf & "                      </tr>" & vbcrlf & "                     "
		sql7="select a.*,c.id as pid,b.reg_fid,b.prod_ph,b.prod_xlh,b.prod_sctime,b.prod_ystime,c.prod_name,c.prod_bh,c.prod_xh,d.sort1,e.sto_name,f.pro_name from O_proOutList a inner join "&_
		" O_kuinlist b on a.prod_id=b.id "&_
		" inner join O_product c on c.id=b.prod_id "&_
		" left join sortonehy d on d.id=b.prod_unit "&_
		" left join O_store e on e.id=a.sto_id "&_
		" left join O_officeType f on c.prod_type=f.id where a.get_fid="&ord
		set rs7=conn.execute(sql7)
		if not rs7.eof then
			do while not rs7.eof
				nums=zbcdbl(rs7("get_num"))
				if nums="" or isnull(nums) then nums=0
				numall=cdbl(numall)+cdbl(nums)
'if nums="" or isnull(nums) then nums=0
				Response.write "" & vbcrlf & "                     <tr>" & vbcrlf & "                            <td width=""10%"" height=""27""><div align=""left"">" & vbcrlf & "                                  "
				if open_101_16=3 or CheckPurview(intro_101_16,trim(addcateid))=True then
					Response.write "" & vbcrlf & "                                           <a href=""javascript:void(0);"" onClick=""javascript:window.open('productDetail.asp?ord="
					Response.write rs7("pid")
					Response.write "','neww37win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')"">"
					Response.write rs7("pid")
					Response.write rs7("prod_name")
					Response.write "</a>" & vbcrlf & "                       "
				else
					Response.write rs7("prod_name")
				end if
				Response.write "" & vbcrlf & "                               </div></td>" & vbcrlf & "                           <td width=""8%"" height=""27""><div align=""center"">"
				Response.write rs7("prod_bh")
				Response.write "</div></td>" & vbcrlf & "                          <td width=""9%"" height=""27""><div align=""center"">"
				Response.write rs7("prod_xh")
				...
				Response.write Formatnumber(zbcdbl(rs7("get_num")),num1_dot,-1)
				Response.write "</div></td>" & vbcrlf & "                          <td width=""7%"" height=""27""><div align=""center"">"
				Response.write rs7("sto_name")
				Response.write "</div></td>" & vbcrlf & "                          <td width=""7%"" height=""27""><div align=""center"">"
				Response.write rs7("pro_name")
				Response.write "</div></td>" & vbcrlf & "                          <td width=""7%"" height=""27""><div align=""center"">"
				Response.write rs7("prod_ph")
				Response.write "</div></td>" & vbcrlf & "                          <td width=""8%"" height=""27""><div align=""center"">"
				Response.write rs7("prod_xlh")
				Response.write "</div></td>" & vbcrlf & "                          <td width=""7%"" height=""27""><div align=""center"">"
				Response.write rs7("prod_sctime")
				Response.write "</div></td>" & vbcrlf & "                          <td width=""8%"" height=""27""><div align=""center"">"
				Response.write rs7("prod_ystime")
				Response.write "</div></td>" & vbcrlf & "                          <td height=""27""><div align=""center"">"
				Response.write rs7("get_intro")
		...
		rs7.close
		set rs7=nothing
		Response.write "" & vbcrlf & "                     <tr>" & vbcrlf & "                            <td height=""27"" colspan=""4""><div align=""right"">合计：</div></td>" & vbcrlf & "                              <td width=""7%"" height=""27""><div align=""center"">"
		Response.write Formatnumber(numall,num1_dot,-1)
		Response.write "</div></td>" & vbcrlf & "                          <td height=""27"" colspan=""7"">&nbsp;</td>" & vbcrlf & "                     </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                        </td>" & vbcrlf & "           </tr>" & vbcrlf & "           </table></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr class=""top"">" & vbcrlf & "        <td colspan=""4"" height=""27""><a href=""javascript:void(0)"" onClick=""setHidden('tr','table_tr')"">关联返还单</a></td>" & vbcrlf & "          "
		jilu=0
		sqltext="select count(*) from O_proReturn where id in(select Exit Sub_fid from O_proRetList where prod_id in (select id from O_proOutList where get_fid="&ord&"))"
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			jilu=rstxt(0)
		end if
		set rstxt=nothing
		Response.write "" & vbcrlf & "               <td height=""30"" colspan=""2""><div align=""right"">"
		if jilu>3 then
			Response.write "<a href=""javascript:void(0)"" onClick=""javascript:window.open('outMX.asp?ord="
			Response.write ord
			Response.write "&lx=1','neww37win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')"">更多>>></a>"
			Response.write ord
		end if
		Response.write "</div></td>" & vbcrlf & "      </tr>" & vbcrlf & "         "
		sqltext="select * from O_proReturn where id in(select Exit Sub_fid from O_proRetList where prod_id in (select id from O_proOutList where get_fid="&ord&"))"
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			do while not rstxt.eof
				Response.write "" & vbcrlf & "       <tr name=""table_tr"" onMouseOver=""this.style.backgroundColor='efefef';"" onMouseOut=""this.style.backgroundColor='';"">" & vbcrlf & "        <td height=""27"" colspan=""2""><div align=""left"">"
				Response.write rstxt("ret_title")
				Response.write "</div></td>" & vbcrlf & "          <td colspan=""2""><div align=""left"">"
				Response.write rstxt("ret_time")
				Response.write "</div></td>" & vbcrlf & "          <td colspan=""2""><a href=""javascript:void(0);"" onClick=""javascript:window.open('returnDetail.asp?ord="
				Response.write rstxt("id")
				Response.write "','neww37win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')""><div align=""right"" class=""red"">查看此返还详情..>>></div></A></td>" & vbcrlf & "      </tr>" & vbcrlf & "         "
				'Response.write rstxt("id")
				rstxt.movenext
			loop
		else
			Response.write "" & vbcrlf & "       <tr>" & vbcrlf & "        <td colspan=""6"" height=""27"" align=""center"">暂无记录！</td>" & vbcrlf & "      </tr>     " & vbcrlf & "        "
		end if
		rstxt.close
		set rstxt=nothing
		Response.write "" & vbcrlf & "    </table>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & vbcrlf & "   </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf
	end if
	rs.close
	if get_type=1 then
		action1="用品发放详情"
