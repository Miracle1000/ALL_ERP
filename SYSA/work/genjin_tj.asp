...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	sorce_user=0
	sorce_user2=0
	set rs=conn.execute("select * from gate where ord="&session("personzbintel2007")&" ")
	If rs.eof Then
		sorce_user=rs("sorce")
		sorce_user2=rs("sorce2")
	end if
	rs.close
	Select Case catesafe
	Case "1" : Str_gate1=""
	Case "2" :
	...
	End Select
	Response.write "<form name=""adSearch"" method=""get"" action=""?"" style='display:inline'>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td colspan=""2"" align=""left""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" id=""closeAD""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf &"  <td rowspan=""2""><div align=""right"">人员选择：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "        <input type=""radio"" name=""personType"" value=""1"" checked=""checked"" />跟进人员" & vbcrlf & "            <input type=""radio"" name=""personType"" value=""2"" />点评人员" & vbcrlf & "               <input type=""radio"" name=""personType"" value=""3"" />跟进人员和点评人员" & vbcrlf & "        </div>" & vbcrlf & "    </td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td><div align=""left"">"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td><div align=""right"">跟进分类：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "                        "
	If ZBRuntime.MC(1000) Then
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""gjfl"" value=""1"" id=""g1"" /><label for=""g1"">客户跟进</label>" & vbcrlf & "            "
	end if
	If ZBRuntime.MC(3000) Then
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""gjfl"" value=""2"" id=""g2"" /><label for=""g2"">项目跟进</label>" & vbcrlf & "            "
	end if
	If ZBRuntime.MC(4000) Then
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""gjfl"" value=""3"" id=""g3"" /><label for=""g3"">报价跟进</label>" & vbcrlf & "            "
	end if
	If ZBRuntime.MC(7000) Then
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""gjfl"" value=""4"" id=""g4"" /><label for=""g4"">合同跟进</label>" & vbcrlf & "            "
	end if
	If ZBRuntime.MC(15000) Then
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""gjfl"" value=""5"" id=""g5"" /><label for=""g5"">采购跟进</label>" & vbcrlf & "            "
	end if
	If ZBRuntime.MC(9000) Then
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""gjfl"" value=""5"" id=""g5"" /><label for=""g6"">售后跟进</label>" & vbcrlf & "            "
	end if
	If ZBRuntime.MC(8000) Then
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""gjfl"" value=""7"" id=""g7"" /><label for=""g7"">退货跟进</label>" & vbcrlf & "            "
	end if
	If ZBRuntime.MC(2000) Then
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""gjfl"" value=""8"" id=""g8"" /><label for=""g8"">联系人跟进</label>" & vbcrlf & "            "
	end if
	If ZBRuntime.MC(9003) Then
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""gjfl"" value=""102001"" id=""g102001"" /><label for=""g102001"">投诉跟进</label>" & vbcrlf & "            "
	end if
	If ZBRuntime.MC(9004) Then
		Response.write "" & vbcrlf & "                              <input type=""checkbox"" name=""gjfl"" value=""102002"" id=""g102002"" /><label for=""g102002"">建议跟进</label>" & vbcrlf & "            "
	end if
	...
	If ZBRuntime.MC(1000) Then
		...
		dim i5
		i5=2
		set rs1=conn.execute("select * from sort4 order by ord")
		do until rs1.eof
			Response.write "<input name='sort4' type='checkbox' value='"& rs1("ord")&"' id='e" & i5& "' onClick=document.getElementById('u"& i5 &"').style.display=(this.checked==1?'':'none');checkAll2('"& i5& "') "
			...
			if CheckPurview(zbintel_sort_history,trim(rs1("ord")))=True  Then
				...
				Response.write " style='border:1px  dotted  #000000;display:none;' "
			end if
			Response.write ">"
			set rs2=conn.execute("select * from sort5  where sort1="&rs1("ord")&" order by ord")
			do until rs2.eof
				Response.write "<span class='gray'><input name='sort5' type='checkbox' value='"& rs2("ord")&"' "
		...
		loop
		rs1.close
		Response.write "</div>" & vbcrlf & "        </td>" & vbcrlf & "    </tr>" & vbcrlf & "    " & vbcrlf & "    <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "        <td><div align=""right"">"
		Response.write arrName(7)
		Response.write "：</div></td><td><div align=""left"">"
		execute sdk.vbs("../manager/search_area" &  Application("__saas__company")  & ".asp")
		Response.write "</div></td>" & vbcrlf & "    </tr>" & vbcrlf & "    " & vbcrlf & "    "
		Call print_search_scope(1,arrShow(8),arrName(8), 11 ,"khhy")
		Call print_search_scope(1,arrShow(6),arrName(6), 13 ,"khly")
		Response.write "" & vbcrlf & "    <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "        <td><div align=""right"">跟进方式：</div></td>" & vbcrlf & "        <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "            "
		Set rs = server.CreateObject("adodb.recordset")
		sql = "SELECT id,sort1 FROM sortonehy WHERE gate2 = 98 ORDER BY gate1 DESC "
		rs.open sql,conn,1,1
		If Not rs.Eof Then
			Do While rs.Eof = False
				Response.write("<input type='checkbox' name='gjfs' value='"&rs("id")&"' ")
				If rs("id")&"" = gjfs Then
		...
		rs.close
		set rs = nothing
		Response.write "" & vbcrlf & "            " & vbcrlf & "            </div>" & vbcrlf & "        </td>" & vbcrlf & "    </tr>" & vbcrlf & ""
		Call print_search_scope(2,arrShow(1),arrName(1), "F1" ,"F2")
	end if
	If ZBRuntime.MC(2000) Then
		Call print_search_scope(2,arrShow(1),arrName(17), "S1" ,"S2")
	end if
	If ZBRuntime.MC(3000) Then
		Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">项目主题：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "        <select name=""G1"">" & vbcrlf & "            <option selected value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" & vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""G2"" type=""text"" size=""15""/>" & vbcrlf & "          </div>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & ""
	end if
	If ZBRuntime.MC(4000) Then
		Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">报价主题：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "        <select name=""H1"">" & vbcrlf & "            <option selected value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" & vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""H2"" type=""text"" size=""15""/>" & vbcrlf & "          </div>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & ""
	end if
	If ZBRuntime.MC(6000) And ZBRuntime.MC(7000) Then
		Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">合同主题：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "        <select name=""I1"">" & vbcrlf & "            <option selected value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" & vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""I2"" type=""text"" size=""15""/>" & vbcrlf & "          </div>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & ""
	end if
	If ZBRuntime.MC(9000) Then
		Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">售后主题：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "        <select name=""J1"">" & vbcrlf & "            <option selected value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" & vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""J2"" type=""text"" size=""15""/>" & vbcrlf & "          </div>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & ""
	end if
	If ZBRuntime.MC(15000) Then
		Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">采购主题：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "        <select name=""K1"">" & vbcrlf & "            <option selected value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" & vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""K2"" type=""text"" size=""15""/>" & vbcrlf & "          </div>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">跟进内容：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "        <select name=""L1"">" & vbcrlf &" <option selected value=""1"">包含</option> "& vbcrlf &"             <option value=""2"">不包含</option> "& vbcrlf &"             <option value=""3"">等于</option> "& vbcrlf &"             <option value=""4"">不等于</option> "& vbcrlf &"             <option value=""5"">以..开始</option> "& vbcrlf &" <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""L2"" type=""text"" size=""15""/>" & vbcrlf & "            </div>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "      <td><div align=""right"">点评内容：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "        <select name=""N1"">" & vbcrlf & "            <option selected value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option> "& vbcrlf &"             <option value=""3"">等于</option> "& vbcrlf &"             <option value=""4"">不等于</option> "& vbcrlf &"             <option value=""5"">以..开始</option> "& vbcrlf &"             <option value=""6"">以..结束</option> "& vbcrlf &"         </select> "& vbcrlf &" <input name=""N2"" type=""text"" size=""15""/>" & vbcrlf & "        </div>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td><div align=""right"">点评时间：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "            <div align=""left"">" & vbcrlf & "        自：<input name=""dpTime1"" type=""text"" size=""10"" readonly onMouseDown=""datedlg.show()"" /> 至：<input name=""dpTime2"" type=""text"" size=""10"" readonly onMouseDown=""datedlg.show()"" />" & vbcrlf & "       </div>" & vbcrlf &" </td> "& vbcrlf &" </tr> "& vbcrlf &" "& vbcrlf &" <tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff""> "& vbcrlf &"      <td><div align=""right"">跟进时间：</div></td> "& vbcrlf &"       <td> "& vbcrlf &"             <div align=""left""> "& vbcrlf &"         自：<input name=""gjTime1"" type=""text"" size=""10"" readonly onMouseDown=""datedlg.show()"" /> 至：<input name=""gjTime2"" type=""text"" size=""10"" readonly onMouseDown=""datedlg.show()"" />" & vbcrlf & "          </div>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td width=""10%"">&nbsp;</td>" & vbcrlf & "<td width=""90%"">" & vbcrlf & "<div align=""left"">" & vbcrlf & "<input type=""hidden"" name=""searchType"" value=""1"" />" & vbcrlf & "<input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "</div>" & vbcrlf & "</td></tr>" & vbcrlf & "</table></form>" & vbcrlf & "" & vbcrlf & ""
	Sub print_search_scope(HType, isShow, fieldName, scope, valName)
		If isShow=1 Then
			Response.write "<tr onMouseOut=this.style.backgroundColor='' onMouseOver=this.style.backgroundColor='efefef'>"
			Response.write "<td align='right'>"& fieldName &"：</td><td>"
			Response.write "<div align='left'>"
			Select Case HType
			Case 1 :
			set rs=conn.execute("select ord,sort1 from sortonehy where gate2='"&scope&"' order by gate1 desc")
			do until rs.eof
				Response.write "<input type='checkbox' name='"&valName&"' value='"& rs("ord")& "' />"& rs("sort1")& " "
				rs.movenext
			loop
			rs.close
			Case 2 :
			Response.write "<select name='"&scope&"'>"
			Response.write "<option value='1'>包含</option><option value='2'>不包含</option><option value='3'>等于</option><option value='4'>不等于</option><option value='5'>以..开始</option><option value='6'>以..结束</option>"
			Response.write "</select>"
			Response.write "&nbsp;<input name='"& valName &"' type='text' size='15'>"
			Case 3 :
			strHtml_h=""
			For i=0 To 23
				s=""&i
				If Len(s)=1 Then s="0"&s
				strHtml_h=strHtml_h& "<option value='"& s &"'>"& s &"</option>"
			next
			strHtml_m=""
			For i=0 To 55 Step 5
				s=""&i
				If Len(s)=1 Then s="0"&s
				strHtml_m=strHtml_m& "<option value='"& s &"'>"& s &"</option>"
			next
			Response.write "&nbsp;自：<INPUT name=ret size=9  id=daysOfMonthPos onmouseup=toggleDatePicker('daysOfMonth','date.ret') value='"& m1&"'><DIV id=daysOfMonth style='POSITION: absolute;z-index:10'></DIV>&nbsp;&nbsp;<select name='time1'>"
			strHtml_m=strHtml_m& "<option value='"& s &"'>"& s &"</option>"
			Response.write strHtml_h
			Response.write "</select>&nbsp;时&nbsp;<select name='time2'>"
			Response.write strHtml_m
			Response.write "</select>&nbsp;分"
			Response.write "&nbsp;至：<INPUT name=ret2 size=9  id=daysOfMonth2Pos onmouseup=toggleDatePicker('daysOfMonth2','date.ret2') value='"& m2&"'><DIV id=daysOfMonth2 style='POSITION: absolute'></DIV>&nbsp;&nbsp;<select name='time3'>"
			Response.write strHtml_h
			Response.write "</select>&nbsp;时&nbsp;<select name='time4'>"
			Response.write strHtml_m
			Response.write "</select>&nbsp;分"
			End Select
