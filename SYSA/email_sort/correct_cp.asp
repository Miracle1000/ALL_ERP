...
'sub index()
		...
		Response.write Application("sys.info.jsver")
		Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"">" & vbcrlf & "<!--" & vbcrlf & "function MM_jumpMenu(targ,selObj,restore){ //v3.0" & vbcrlf & "  eval(targ+"".location=\'""+selObj.options[selObj.selectedIndex].value+""\'"");" & vbcrlf & "     if (restore) selObj.selectedIndex=0;" & vbcrlf & "}" & vbcrlf & "function ask() { " & vbcrlf & "  document.getElementById(""demo"").action = ""add_area.asp?sort=2""; " & vbcrlf & "}" & vbcrlf & "function ask2() { " & vbcrlf & " document.getElementById(""demo"").action = ""add_area.asp?sort=3"";  "& vbcrlf & "} "& vbcrlf &" //-->" & vbcrlf & "</script>" & vbcrlf &" </head> "& vbcrlf & "<body>" & vbcrlf
		'Response.write Application("sys.info.jsver")
		dim clo
		clo=request("clo")
		if clo<>"" then
		...
		if rd<>"" then
			...
			if rs.eof then
				...
				W3=rs("User_List")
				session("smsPsmenu_list")=rs("parent")
			end if
			rs.close
			set rs=nothing
		end if
		If W3&""="" Then W3 = "0"
		Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "      <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"">" & vbcrlf & "              <tr>" & vbcrlf & "                <td width=""5%"" height=""27""  background=""../images/contentbg.gif""><div align=""center""><img src=""../images/contenttop.gif""height=""27""> </div></td> " & vbcrlf & "                <td width=""95%""  background=""../images/contentbg.gif"">" & vbcrlf & "                  <strong><font color=""#1445A6"">联系人分组设置</font></strong> </td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>" & vbcrlf & "" & vbcrlf & "<form name=""date"" method=""post"" action=""updatecp_cp.asp?id="
		Response.write rd
		Response.write """ onsubmit=""return Validator.Validate(this,2)"" id=""demo"" style=""margin:0"">" & vbcrlf & "       <span style=""font-size: 9pt""><input type=hidden name=menu1 value=addto></span>" & vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""> "& vbcrlf & "    <tr class=""top""> "& vbcrlf &     " <td  colspan=""2"">" & vbcrlf &     "    <div align=""center"">修改联系人分组</div>           </td>" & vbcrlf &  "   </tr> "& vbcrlf & "    <tr>" & vbcrlf &     "  <td width=""15%"" align=""right"" height=""33"">上级分组：</td> "& vbcrlf &    "   <td width=""85%""><IFRAME name=""I2"" SRC=""correct.asp?ID=company"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""95%"" HEIGHT=""27"" marginwidth=""1"" marginheight=""1""></IFRAME></td> "& vbcrlf & "    </tr> "& vbcrlf &   "  <tr> "& vbcrlf &    "   <td width=""15%"" align=""right"" height=""33"">分组名称：</td>" & vbcrlf & "      <td width=""85%""><input name=""menuname"" type=""text"" id=""menuname"" value="""
		...
		Response.write """  onkeyup=""value=value.replace(/\D/g,'')""  size=""10"">（排序框里只能输入数字，排序时将按照数字从大到小排序）</td>" & vbcrlf & "    </tr>" & vbcrlf & "              <tr>" & vbcrlf & "            <td width=""15%"" align=""right"" height=""33"">使用范围：</td>" & vbcrlf & "            <td width=""85%""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                <tr class=""gray"">" & vbcrlf & "                  <td style=""padding:5px""><input type=""radio"" name=""allcansee"" value=""1"" "
		if W3="0,0" or W3="0" then
			Response.write " checked=""true"""
		end if
		Response.write " id=""rbtn1"" onclick=""document.getElementById('tb1').style.display='none';"" />" & vbcrlf & "                    <label for=""rbtn1"">允许所有用户调用</label>" & vbcrlf & "                    <input type=""radio"" name=""allcansee"" value=""0"" id=""rbtn2"" "
		if W3<>"0,0" and W3<>"" and W3<>"0" then
			Response.write " checked=""true"""
		end if
		Response.write " onclick=""document.getElementById('tb1').style.display='';"" />" & vbcrlf & "                    <label for=""rbtn2"">选择允许调用用户</label>" & vbcrlf & "                    <span id=""ulist1"" class=""red""></span> </td>" & vbcrlf & "                </tr>" & vbcrlf & "                <tr  "
		if W3="0,0" or W3="0" or  W3="" then
			Response.write " style=""display:none"""
		end if
		Response.write " id=""tb1"">" & vbcrlf & "                  <td style=""padding:5px"">"
		sort_zjjg=2
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
		...
		Response.write "" & vbcrlf & "                  </td>" & vbcrlf & "                </tr>" & vbcrlf & "              </table></td>" & vbcrlf & "          </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td height=""35"" bordercolorlight=""#000000"" bordercolordark=""#000000"" bordercolor=""#CCFFFF"" colspan=""2"">" & vbcrlf &      "   <div align=""center""> "& vbcrlf &      "    <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/> "& vbcrlf & "　　" & vbcrlf & vbcrlf & vbcrlf & vbcrlf & "　　"  & vbcrlf & "<input type=""reset"" value=""重填"" class=""page"" name=""B2""> "& vbcrlf & "</div></td>" & vbcrlf & "    </tr>" & vbcrlf & "    </table>" & vbcrlf & "    </form> " & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "    " & vbcrlf & "      " & vbcrlf & "      </td>" & vbcrlf & "    </tr>" & vbcrlf & "  </table>" & vbcrlf & "  </center>" & vbcrlf & "</div>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & " " & vbcrlf & "  "
		call db_close : Response.end
	end sub
	action1="联系人分组设置"
	call close_list(1)
