...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	sql="DELETE MessagePerson where  ord in( select ord  FROM MessagePerson E WHERE E.ord> (SELECT MIN(X.ord) FROM MessagePerson X WHERE X.clictPhone = E.clictPhone  "&Str_Result&" ) "&Str_Result&") "&Str_Result&""
	conn.Execute(sql)
	action1="短信客户删除"
	call close_list(2)
	Response.redirect "all.asp?page_count="&page_count&"&currpage="&currpage&"&takeName="&strid&""
