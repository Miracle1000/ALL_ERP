...
'if strW3<>"" Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script src= ""../Script/sk_correct.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""JavaScript""></script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "    margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style></head>" & vbcrlf & "" & vbcrlf & "<body  onunload=""window.opener.location.reload();"" >" & vbcrlf & ""
	Response.write Application("sys.info.jsver")
	dim clo
	clo=request("clo")
	if clo<>"" then
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0""  cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "             <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"">" & vbcrlf& "      <tr>" & vbcrlf & "        <td width=""5%"" height=""27""  background=""../images/contentbg.gif""><div align=""center""><img src=""../images/contenttop.gif""height=""27""> </div></td>" & vbcrlf & "        <td width=""95%""  background=""../images/contentbg.gif""><strong><font color=""#1445A6"">设置银行账户</font></strong></td>" & vbcrlf & "      </tr>" & vbcrlf & "    </table>" & vbcrlf & ""
	CurrBookID=request("ord")
	set rs=server.CreateObject("adodb.recordset")
	sql="select *  from sortbank Where id="&CurrBookID&" "
	rs.open sql,conn,1,1
	if not rs.eof then
		AccountType=rs("AccountType")
		IsOpenCharge=rs("IsOpenCharge")
		ChargeMax=rs("ChargeMax")
		ChargeMin=rs("ChargeMin")
		ord=rs("id")
		sort1=rs("sort1")
		bz1=rs("bz")
		intro=rs("intro")
		...
		gate1=rs("gate1")
		minus = rs("minus")
		if IsNull(minus) = True or minus = "" then minus = 0
		minusMoney = rs("minusMoney")
	end if
	rs.close
	set rs=nothing
	if minusMoney&""="" then
	...
	Response.write "" & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "  <form method=""post"" action=""Updatecp.asp?ord="
	Response.write ord
	Response.write """ id=""demo"" onsubmit=""return Validator.Validate(this,2) && checkSLForm()"" name=""date"">" & vbcrlf & "    <tr class=""top"">" & vbcrlf & "      <td colspan=""2""><div align=""center"">修改银行账户</div></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td width=""24%""> <div align=""right"">账户名称：</div></td>" & vbcrlf & "      <td width=""76%""><input type=""text"" name=""sort1"" value="""
	Response.write sort1
	Response.write """ size=""30"" class=""text""  dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1个至50个字之间"">" & vbcrlf & "        <span class=""red"">*</span></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td><div align=""right"">银行账号：</div></td>" & vbcrlf & "      <td><input type=""text"" name=""may""  size=""30""  class=""text""  dataType=""Limit"" min=""0"" max=""50""  msg=""太长了"" value="""
	Response.write intro
	Response.write """>          </td>" & vbcrlf & "    </tr>" & vbcrlf & "" & vbcrlf & "    <tr>" & vbcrlf & "      <td><div align=""right"">开户银行：</div></td>" & vbcrlf & "      <td><input type=""text"" name=""may2""  size=""30""  class=""text""  dataType=""Limit"" min=""0"" max=""50""  msg=""太长了"" value="""
	Response.write intro2
	Response.write """></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td><div align=""right"">币　　种：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "         <select name=""bz"">" & vbcrlf & ""
	set rs2=server.CreateObject("adodb.recordset")
	if open_bz=1 then
		set rs7=server.CreateObject("adodb.recordset")
		if ord="" or isnull(ord) then ord=0
		rs7.open "select * from bank where bank="&ord&"",conn,1,1
		if rs7.eof then
			sql2="select * from sortbz order by gate1 desc"
		else
			sql2="select * from sortbz where id="&bz1&" "
		end if
		rs7.close
		set rs7=nothing
		...
		if bz1="" or isnull(bz1) then bz1=0
		sql2="select * from sortbz where id="&bz1&" "
		rs2.open sql2,conn,1,1
		if not rs2.eof then
			Response.write "" & vbcrlf & "                <option value="""
	...
	set rs2=nothing
	Response.write "" & vbcrlf & "        </select>" & vbcrlf & "      </td>" & vbcrlf & "    </tr>" & vbcrlf & "         <tr>" & vbcrlf & "      <td><div align=""right"">隶属部门：</div></td>" & vbcrlf & "      <td><input name=""sorce"" type=""radio"" value=""0"" checked>" & vbcrlf & "        总部" & vbcrlf & "        "
	Response.write "" & vbcrlf & "               </td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td><div align=""right"">主管出纳：</div></td>" & vbcrlf & "      <td>"
	sort_zjjg=4
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "<span style=""color:red"">&nbsp 温馨提示：主管出纳中勾选用户，代表此用户能够在本系统内查看、操作当前银行账户；</span></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td><div align=""right"">是否启用：</div></td>" & vbcrlf & "      <td><input name=""del"" type=""radio"" value=""1"" "
	if del=1 then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "启用" & vbcrlf & "  <input type=""radio"" name=""del"" value=""0"" "
	if del=0 then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "暂停使用</td>" & vbcrlf & "    </tr>" & vbcrlf & "" & vbcrlf & "    <tr>" & vbcrlf & "        <td><div align=""right"">账户性质：</div>" & vbcrlf & "        </td>" & vbcrlf & "        <td>" & vbcrlf & "        <input name=""AccountType"" type=""radio"" value=""0"" "
	if AccountType=0 then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "            银行账户" & vbcrlf & "        <input type=""radio"" name=""AccountType"" value=""1"" "
	if AccountType=1 then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "        现金账户" & vbcrlf & "        </td>" & vbcrlf & "    </tr>" & vbcrlf & "" & vbcrlf & "    <tr>" & vbcrlf & "      <td><div align=""right"">手续费启用：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "        <input id=""IsOpenCharge1"" name=""IsOpenCharge"" type=""radio"" value=""0"" "
	if IsOpenCharge=0 then
		Response.write "checked"
	end if
	Response.write " onClick=""document.getElementById('SxfminesMax').style.display = 'none'; document.getElementById('SxfmaxesMax').style.display = 'none'"">否" & vbcrlf & "" & vbcrlf & "        <input type=""radio"" id=""IsOpenCharge2"" name=""IsOpenCharge"" value=""1"" "
	if IsOpenCharge=1 then
		Response.write "checked"
	end if
	Response.write " onClick=""document.getElementById('SxfmaxesMax').style.display = 'inline-block'; document.getElementById('SxfminesMax').style.display = 'inline-block';if (document.getElementById('ChargeMax').value == '' || document.getElementById('ChargeMax').value == 0) { document.getElementById('ChargeMax').value = 200.5 };document.getElementById('SxfminesMax').style.display = 'inline-block';if (document.getElementById('ChargeMin').value == '' || document.getElementById('ChargeMin').value == 0) { document.getElementById('ChargeMin').value =5 }"">是" & vbcrlf & "" & vbcrlf & "        <span id=""SxfmaxesMax"" style=""display:"
	if IsOpenCharge=1 then
		Response.write "inline-block"
'if IsOpenCharge=1 then
	else
		Response.write "none"
	end if
	Response.write "; margin-left:20px;"">最小值：<input name=""ChargeMin"" id=""ChargeMin"" type=""text"" value="""
	Response.write "none"
	Response.write ChargeMin
	Response.write """  dataType=""Range"" min=""0"" max=""9999999999"" msg=""必须在1—9999999999之间""onkeyup=""value=value.replace(/[^\d\.]/g,'');checkDot('ChargeMin','"
	Response.write num_dot_xs
	Response.write "');"" style=""width:90px;"" ></span>" & vbcrlf & "" & vbcrlf & "        <span id=""SxfminesMax"" style=""display:"
	if IsOpenCharge=1 then
		Response.write "inline-block"
'if IsOpenCharge=1 then
	else
	...
	Response.write "; margin-left:20px;"">最大值：<input name=""ChargeMax"" id=""ChargeMax"" type=""text"" value="""
	Response.write "none"
	Response.write ChargeMax
	Response.write """  dataType=""Range"" min=""0"" max=""9999999999"" msg=""必须在1—9999999999之间""onkeyup=""value=value.replace(/[^\d\.]/g,'');checkDot('ChargeMax','"
	Response.write num_dot_xs
	Response.write "');"" style=""width:90px;"" ></span>" & vbcrlf & "         <span id=""information"" style=""color:red;display:none;"">不允许大于最大值！</span>" & vbcrlf & "      </td>" & vbcrlf & "    </tr>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "    <tr>" & vbcrlf & "      <td><div align=""right"">是否允许负出账：</div></td>" & vbcrlf & "      <td><input name=""minus"" type=""radio"" value=""0"" "
	if minus=0 then
		Response.write "checked"
	end if
	Response.write " onClick=""document.getElementById('minesMax').style.display='none'"">否" & vbcrlf & "  <input type=""radio"" name=""minus"" value=""1"" "
	if minus=1 then
		Response.write "checked"
	end if
	Response.write " onClick=""document.getElementById('minesMax').style.display='inline-block'"">是<span id=""minesMax"" style=""display:"
	Response.write "checked"
	if minus=1 then
		Response.write "inline-block"
'if minus=1 then
	...
	Response.write "; margin-left:20px;"">最大金额：<input name=""minusMoney"" type=""text"" value="""
	Response.write "none"
	Response.write minusMoney
	Response.write """  dataType=""Range"" min=""0"" max=""9999999999"" msg=""金额位数过长"" onkeyup=""value=value.replace(/[^\d\.]/g,'');"" style=""width:90px;"" ></span>" & vbcrlf & "" & vbcrlf & "      </td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td><div align=""right"">重要指数：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "        <select name=""gate1"" size=""1"">" & vbcrlf & "            <option>"
	Response.write gate1
	Response.write "</option>" & vbcrlf & "            <option>1</option>" & vbcrlf & "            <option>2</option>" & vbcrlf & "            <option>3</option>" & vbcrlf & "            <option>4</option>" & vbcrlf & "            <option>5</option>" & vbcrlf & "            <option>6</option>" & vbcrlf & "       <option>7</option>" & vbcrlf & "            <option>8</option>" & vbcrlf & "            <option>9</option>" & vbcrlf & "            <option>10</option>" & vbcrlf & "                                          <option>11</option>" & vbcrlf & "            <option>12</option>" & vbcrlf & "            <option>13</option>" & vbcrlf & "<option>14</option>" & vbcrlf & "            <option>15</option>" & vbcrlf & "            <option>16</option>" & vbcrlf & "            <option>17</option>" & vbcrlf & "            <option>18</option>" & vbcrlf & "            <option>19</option>" & vbcrlf & "            <option>20</option>" & vbcrlf & "                                           <option>21</option>" & vbcrlf & "            <option>22</option>" & vbcrlf & "            <option>23</option>" & vbcrlf & "            <option>24</option>" & vbcrlf & "            <option>25</option>" & vbcrlf & "            <option>26</option>" & vbcrlf & "            <option>27</option>" & vbcrlf & "            <option>28</option>" & vbcrlf & "            <option>29</option>" & vbcrlf & "            <option>30</option>" & vbcrlf & "                                            <option>31</option>" & vbcrlf & "            <option>32</option>" & vbcrlf & "            <option>33</option>" & vbcrlf & "          <option>34</option>" & vbcrlf & "            <option>35</option>" & vbcrlf & "            <option>36</option>" & vbcrlf & "            <option>37</option>" & vbcrlf & "            <option>38</option>" & vbcrlf & "            <option>39</option>" & vbcrlf & "            <option>40</option>" & vbcrlf & "          </select>" & vbcrlf & "        </td>" & vbcrlf & "    </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td colspan=""2""><div align=""center"">" & vbcrlf & "        <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "        <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "      </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</form>" & vbcrlf & "</table>" & vbcrlf &  "</td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""80"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "</td></tr></table>" & vbcrlf & ""
	action1="修改银行账户"
	call close_list(1)
	Response.write "" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & "<script src= ""../Script/sk_correct_1.js?ver="
	Response.write Application("sys.info.jsver")
