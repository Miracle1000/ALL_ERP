...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/Javascript"" src=""../car/Addtr.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/Javascript"" src=""../car/Calendar.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "a=1" & vbcrlf & "b=1" & vbcrlf & "function addtr(){" & vbcrlf & "        var Table=document.getElementById('add_tr');" & vbcrlf & "    var tr=document.createElement(""tr"");" & vbcrlf & "      tr.id=""tr_""+a;" & vbcrlf & " tr.name=""table_tr"";" & vbcrlf & "       Table.appendChild(tr);" & vbcrlf & "  tr.onmouseover=function(){this.style.backgroundColor='efefef';}" & vbcrlf & " tr.onmouseout=function(){this.style.backgroundColor='';}" & vbcrlf & "        var td1 = document.createElement('td');" & vbcrlf & " tr.appendChild(td1);" & vbcrlf & "     var Href = ""<div align=\""center\""><a href=\""javascript:void(0);\"" onClick=\""addtr()\""  title=\""添加明细\""><font color=\""#FF0000\"">√</font></a> <select name=\""iss_type\"">"";" & vbcrlf & "   "
	sql7="select id,setName from O_carSet where setType=3 order by setsort desc"
	set rs7=conn.execute(sql7)
	if not rs7.eof then
		do while not rs7.eof
			Response.write "" & vbcrlf & "      Href = Href+""<option value=\"""
'do while not rs7.eof
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "      Href = Href+""</select> <a href=\""javascript:void(0);\"" onClick=\""del_TR('tr_""+a+""')\""  title=\""删除明细\""><font color=\""#FF0000\"">×</font></a></div>"";" & vbcrlf & "     td1.innerHTML=Href;" & vbcrlf & "     var td2 = document.createElement('td');" & vbcrlf & " tr.appendChild(td2);" & vbcrlf & "   var Href = ""<div align=\""center\""><input name=\""iss_company\"" type=\""text\"" id=\""iss_company\"" size=\""15\"" maxlength=\""100\"" min=\""1\"" max=\""200\""></div>"";" & vbcrlf & "       td2.innerHTML=Href;" & vbcrlf & "     var td3 = document.createElement('td');" & vbcrlf & " tr.appendChild(td3);" & vbcrlf & "        var Href = ""<div align=\""center\""><input name=\""iss_money\"" type=\""text\"" id=\""iss_money_""+b+""\"" onpropertychange=\""formatData(this,'money');\"" size=\""12\"" maxlength=\""200\"" min=\""1\"" dataType='Limit' max=\""9999999999.99\""></div>"";" & vbcrlf & "       td3.innerHTML=Href;" & vbcrlf & "      var td4 = document.createElement('td');" & vbcrlf & " tr.appendChild(td4);" & vbcrlf & "    var Href = ""<div align=\""center\""><input type=\""text\"" name=\""iss_startime\"" id=\""iss_startime\"" Class=\""DatePick\""  onclick=\""datedlg.show();\"" readonly=\""readonly\""></div>""" & vbcrlf & "  td4.innerHTML=Href;" & vbcrlf & "     var td5 = document.createElement('td');" & vbcrlf & " tr.appendChild(td5);" & vbcrlf & "    var Href = ""<div align=\""center\""><input type=\""text\"" name=\""iss_endtime\"" id=\""iss_endtime\"" Class=\""DatePick\""  onclick=\""datedlg.show();\"" readonly=\""readonly\""></div>"" " & vbcrlf &   "td5.innerHTML=Href;"      & vbcrlf &         "var td9 = document.createElement('td');" & vbcrlf & " tr.appendChild(td9);" & vbcrlf & "    var Href = ""<div align=\""center\""><select name=\""iss_warn\"">""" & vbcrlf & " Href = Href+""<option value=\""1\"" selected>是</option>""" & vbcrlf & "     Href = Href+""<option value=\""2\"">否</option>""" & vbcrlf & "       Href = Href+""</select></div>"";" & vbcrlf & "    td9.innerHTML=Href;" & vbcrlf & "     b=b+1" & vbcrlf & "   a=a+1" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<script src= ""../Script/cr_Add_insure.js?ver="""
	set rs7=nothing
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {       margin-top: 0px;}" & vbcrlf & "img{border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf &"<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	...
	if car_id="" or isnull(car_id) then
		...
		sql7="select car_code from O_carData where car_id="&car_id
		set rs7=conn.execute(sql7)
		if not rs7.eof then
			car_name=rs7("car_code")
		else
			car_name="点击选择车牌号"
		end if
		rs7.close
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">保险添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf &           "</tr>" & vbcrlf &       "</table>"  & vbcrlf &   "<form action=""Save_insure.asp"" method=""POST"" name=""demo"" id=""demo"" onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf &   "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td width=""13%"" height=""27"" ><img src=""../images/jiantou.gif""><a href=""javascript:void(0);"" onClick=""setHidden('tr','table_tr');"">基本明细</a></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "              <div align=""right"">" & vbcrlf & "                             <input type=""submit"" name=""Submit424"" value=""保存"" class=""anybutton2""  onClick=""return ask1('1');""/>" & vbcrlf & "                              <input type=""submit"" name=""Submit425"" value=""保存并新增"" class=""anybutton2"" onClick=""return ask1('2');""/>" & vbcrlf & "                               <input type=""reset"" value=""重填"" class=""anybutton2"" name=""B22"">" & vbcrlf & "             </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr name=""table_tr"">" & vbcrlf & "        <td width=""13%"" height=""27""><div align=""right"">车牌号：</div></td>" & vbcrlf & "          <td width=""20%"" class=""gray""><input name=""iss_carname"" type=""text"" "
	if car_name="点击选择车牌号" then
		Response.write "style=""color:#CCCCCC;"""
	end if
	Response.write " id=""iss_carname"" readonly=""true"" value="""
	Response.write car_name
	Response.write """ size=""15"" maxlength=""20"" max=""200"" onClick=""javascript:window.open('../search/search_person5.asp?name1=iss_carname&id=iss_carid','neww37win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');""><input type=""hidden"" name=""iss_carid"" value="""""
	Response.write car_id
	Response.write """ id=""iss_carid"" style=""width:0px;height:0px;"" dataType=""Limit""  min=""1"" max=""200"" msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">经办人员：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input type=""text"" name=""iss_catename"" style=""color:#CCCCCC;"" value=""点击选择人员"" readonly=""true"" id=""iss_catename"" size=""12"" onClick=""javascript:window.openolbar=0,resizable=1,left=150,top=150');""><input type=""hidden"" name=""iss_cateid"" id=""iss_cateid"" style=""width:0px;height:0px;"" dataType=""Limit""  min=""1"" max=""200"" msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">联系电话：</div></td>" & vbcrlf & "           <td width=""24%"" class=""gray""><input name=""iss_phone"" type=""text"" id=""iss_phone"" size=""15"" maxlength=""200"" min=""1"" max=""200""  ></td>" & vbcrlf & "      </tr>" & vbcrlf & "    <tr class=""top"">" & vbcrlf & "            <td height=""30"" colspan=""6""><div align=""left""><img src=""../images/jiantou.gif""><a href=""javascript:void(0);"" onClick=""setHidden('tr','table_tr2');"">保险明细</a>&nbsp;<a href=""javascript:void(0);"" onClick=""addtr()"" title=""添加明细"">添加明细<img src=""../images/add.gif"" /></a></div></td>" & vbcrlf &      "</tr>" & vbcrlf &          "<tr name=""table_tr2"">" & vbcrlf & "        <td height=""30"" colspan=""6"">" & vbcrlf & "                    <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                              <tr>" & vbcrlf & "                                    <td width=""17%"">&nbsp;</td>" & vbcrlf & "                                       <td width=""17%"" height=""27""><div align=""center"">" & vbcrlf &                                           "<input name=""isscompany"" type=""text"" id=""isscompany"" size=""15"" maxlength=""200"" min=""1"" max=""200"" onpropertychange=""batch('isscompany');"">" & vbcrlf &  "                                    </div></td>" & vbcrlf &                                      "<td width=""17%""><div align=""center"">" & vbcrlf &"<input name=""issmoney"" type=""text"" onpropertychange=""formatData(this,'money');batch('issmoney');"" id=""issmoney""  size=""12"" maxlength=""200"" dataType=""Limit"" min=""0"" max=""9999999999.99"">" & vbcrlf &                                         "</div></td>" & vbcrlf &                                      "<td><div align=""center"">" & vbcrlf & "<input type=""text"" name=""alliss_startime"" Class=""DatePick""  onclick=""datedlg.show();"" onchange=""setAll(this.value,'iss_startime')"">" & vbcrlf & "                                       </div></td>" & vbcrlf & "                                   <td><div align=""center"">" & vbcrlf & "                                    <input type=""text"" name=""alliss_endtime"" Class=""DatePick""  onclick=""datedlg.show();"" onchange=""setAll(this.value,'iss_endtime')"">" & vbcrlf & "                                         </div></td>" & vbcrlf & "                                   <td><div align=""center"">" & vbcrlf & "                                    <select name=""isswarn"" id=""isswarn"" onChange=""batch('isswarn');"">" & vbcrlf & "                                       <option value=""1"">是</option>" & vbcrlf & "                                           <option value=""2"">否</option>" & vbcrlf & "                               </select>" & vbcrlf & "                             </div></td>" & vbcrlf & "                         </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                    <td width=""17%""><div align=""center"">&nbsp;<strong>车险险种</strong>&nbsp;&nbsp;&nbsp;</div></td>" & vbcrlf & "    <td width=""17%"" height=""27""><div align=""center""><strong>保险公司</strong></div></td>" & vbcrlf & "                                  <td width=""17%""><div align=""center""><strong>保险费用</strong></div></td>" & vbcrlf & "                                    <td width=""17%"" height=""27""><div align=""center""><strong>投保时间</strong></div></td>" & vbcrlf & "<td width=""17%""><div align=""center""><strong>结束时间</strong></div></td>" & vbcrlf & "                                    <td><div align=""center""><strong>是否提醒</strong></div></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                               <tbody id=""add_tr"">" & vbcrlf & "                                       <tr id=""tr_9999"" onMouseOver=""this.style.backgroundColor='efefef';"" onMouseOut=""this.style.backgroundColor='';"">" & vbcrlf & "                                        <td height=""27""><div align=""center""><a href=""javascript:void(0);"" onClick=""addtr()"" title=""添加明细""><font color=""#FF0000"">√</font></a>" & vbcrlf & "                                    <select name=""iss_type"">" & vbcrlf
	sql7="select * from O_carSet where setType=3 order by setsort desc"
	set rs7=conn.execute(sql7)
	if not rs7.eof then
		do while not rs7.eof
	...
	set rs7=nothing
	Response.write "" & vbcrlf & "                                     </select>" & vbcrlf & "                                         <a href=""javascript:void(0);"" onClick=""del_TR('tr_9999')""  title=""删除明细""><font color=""#FF0000"">×</font></a></div></td>" & vbcrlf & "                                      <td height=""27""><div align=""center""><input name=""iss_company"" type=""text"" id=""iss_company"" size=""15"" maxlength=""200"" min=""1"" max=""200""></div></td>" & vbcrlf & "                                         <td><div align=""center""><input name=""iss_money"" type=""text"" id=""iss_money"" onpropertychange=""formatData(this,'money');"" size=""12"" maxlength=""200"" min=""1"" max=""9999999999.99"" dataType=""Limit""></div></td>" & vbcrlf & "                                    <td height=""27""><div align=""center""><input type=""text"" name=""iss_startime"" Class=""DatePick""  onclick=""datedlg.show();""></div></td>" & vbcrlf & "                                                <td><div align=""center""><input type=""text"" name=""iss_endtime"" Class=""DatePick""  onclick=""datedlg.show();""></div></td>" & vbcrlf & "                                              <td><div align=""center"">" & vbcrlf & "                                          <select name=""iss_warn"">" & vbcrlf & "                                                  <option value=""1"">是</option>" & vbcrlf & "                                                     <option value=""2"">否</option>" & vbcrlf & "                                             </select></div></td>" & vbcrlf & "                                    </tr>" & vbcrlf & "                           </tbody>" & vbcrlf & "                        </table>" & vbcrlf & "                </td>" & vbcrlf & "     </tr>" & vbcrlf & "         <tr>" & vbcrlf & "              <td width=""13%""><p align=""right"">保险备注：</td>" & vbcrlf & "            <td colspan=""5"" class=""gray""><textarea name=""iss_note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "          <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=iss_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "      </tr> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray"">" & vbcrlf & "                   <div align=""center"">" & vbcrlf & "                        <input type=""submit"" name=""Submit42"" value=""保存"" class=""anybutton2""  onClick=""return ask1('1');""/>" & vbcrlf & "                       <input type=""submit"" name=""Submit423"" value=""保存并新增"" class=""anybutton2"" onClick=""return ask1('2');""/>" & vbcrlf & "                       <input type=""reset"" value=""重填"" class=""anybutton2"" name=""B2"">" & vbcrlf & "                 </div></td>" & vbcrlf & "      </tr> " & vbcrlf & "    </table>" & vbcrlf & "    </form>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf &    "<table width=""100%"" border=""0"" align=""left"" >" & vbcrlf &          "<tr>" & vbcrlf &                     "<td height=""30"" ><div align=""center""></div></td>" & vbcrlf &             "</tr>" & vbcrlf &    "</table>" & vbcrlf &   "</td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="车辆保险添加"
	call close_list(1)
