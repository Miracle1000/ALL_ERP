...
'function IsTime(values)
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body { margin-top: 0px;}" & vbcrlf & "img{border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	spid=0
	set ml=new myclass
	ord=ml.IsNum(request("ord"))
	sql="select ass_name from O_asset where ass_id="&ord
	set rs=conn.execute(sql)
	if not rs.eof then
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">资产变动</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf &  "     </table>  " & vbcrlf & "    <form action=""Save_assetChange.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return false;"">" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top resetGroupTableBg"">" & vbcrlf & "        <td height=""27"" ><divalign=""left""><strong>基本信息</strong></divalign=></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "               <div align=""right"">" & vbcrlf & "                 <input type=""button"" name=""Submit422"" value=""保存""  class=""page"" onClick=""ask1("
	Response.write spid
	Response.write ")""/>" & vbcrlf & "                   <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "               </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "      <td width=""13%"" height=""30""><div align=""right"">变动主题：</div></td>" & vbcrlf & "          <td width=""22%"" height=""30"" class=""gray""><input name=""H_title"" type=""text"" id=""H_title"" size=""20"" datatype=""Limit""  min=""1"" max=""100"" msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "           <td width=""11%"" ><div align=""right"">变动类型：</div></td>" & vbcrlf & "           <td class=""gray"">" &vbcrlf & "       <select name=""H_type"" id=""H_type"" onchange=""SetAsset(this.value);"" dataType=""Limit""  min=""1"" max=""100"" msg=""必填"">" & vbcrlf & "            <option value="""">---请选择---</option>" & vbcrlf & "            "
	Response.write spid
	sql7="select id,W_name from O_assChangeWay order by id asc "
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "          </select>&nbsp;<span class=""red"">*</span>     </td>" & vbcrlf & "        <td height=""30""><div align=""right"">变动资产：</div></td>" & vbcrlf & "        <td height=""30"" class=""gray"">" & vbcrlf & "          <input name=""H_assname"" onClick=""ChooseAsset()"" type=""text""id=""H_assname"" size=""20"" value="""
	Response.write asset_name
	Response.write """ "
	Response.write style1
	Response.write " maxlength=""100""><input type=""hidden"" name=""H_assID"" id=""H_assID"" "
	if ord<>0 then
		Response.write "value="""
		Response.write ord
		Response.write """"
	end if
	Response.write " dataType=""Limit"" min=""1"" max=""100"" msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "      </tr>" & vbcrlf & "   <tr>" & vbcrlf & "        <td height=""30""><div align=""right"">变动时间：</div></td>" & vbcrlf & "        <td height=""30"" class=""gray""><input type=""text"" name=""H_time"" id=""H_time"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly""></td>" & vbcrlf & "        <td height=""30""><div align=""right"">变动代码：</div></td>" & vbcrlf & "        <td height=""30"" class=""gray""><div id=""W_code""></div></td>" & vbcrlf &         "<td height=""30""><div align=""right"">变动方式：</div></td>" & vbcrlf & "        <td height=""30"" class=""gray""><div id=""W_method""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""30""><div align=""right"">凭证字：</div></td>" & vbcrlf & "            <td width=""20%"" height=""30"" class=""gray""><div id=""W_pz""></div></td>" & vbcrlf & "       <td width=""13%"" height=""30""><div align=""right"">变动摘要：</div></td>" & vbcrlf &  "         <td width=""19%"" height=""30"" class=""gray""><div id=""W_zy""></div></td>" & vbcrlf & "     <td width=""11%"" height=""30""><div align=""right"">变动备注：</div></td>" & vbcrlf & "                <td width=""24%"" height=""30"" class=""gray""><div id=""W_note""></div></td>" & vbcrlf & "      </tr>" & vbcrlf & "        <tbody id=""Tbody"">" & vbcrlf & "        </tbody> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray"">" & vbcrlf & "                      <div align=""center"">" & vbcrlf & "                        <input type=""button"" name=""Submit42"" value=""保存"" class=""page"" onClick=""ask1("
	Response.write spid
	Response.write ")""/>" & vbcrlf & "                         <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "               </div></td>" & vbcrlf & "      </tr> " & vbcrlf & "     </table>" & vbcrlf & "    </form>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & "    <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="资产变动"
	call close_list(1)
