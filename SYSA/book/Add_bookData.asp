...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	set rs7=nothing
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">图书登记</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td> "& vbcrlf &      "     </tr>" & vbcrlf &    "   </table>"   & vbcrlf &        "  <form action=""Save_bookData.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)&&ask1()"">" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" ><div align=""left""><strong>基本信息</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "            <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "              <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "                </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">书名：</div></td>" & vbcrlf & "      <td colspan=""5"" class=""gray""><input name=""bk_name"" type=""text"" id=""bk_name"" size=""30"" maxlength=""1000"" dataType=""Limit""  min=""1"" max=""200"" msg=""必填"">&nbsp;<span class=""red"">*</span></td> "& vbcrlf &     "    </tr> "& vbcrlf &      " <tr>" & vbcrlf &     "  <td width=""13%"" height=""27""><div align=""right"">编号：</div></td> "& vbcrlf &      " <td width=""20%"" class=""gray""><input name=""bk_bh"" type=""text"" id=""bk_bh"" size=""20"" maxlength=""500""></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">分类：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><select name=""bk_type"" id=""bk_type"" dataType=""Limit""  min=""1"" max=""200"" msg=""必填"">" & vbcrlf & "          "
	...
	next
	Response.write "" & vbcrlf & "                </select>" & vbcrlf & "               </td>" & vbcrlf & "      </tr>" & vbcrlf & "        <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">作者：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray""><input name=""bk_auther"" type=""text"" id=""bk_auther"" size=""20"" maxlength=""500""></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">出版时间：</div></td>" & vbcrlf & "        <td colspan=""3"" class=""gray""><input name=""bk_pubtime"" type=""text"" size=""9"" value="""
	Response.write date
	Response.write """ id=""daysOfMonthPosy"" onmouseup=toggleDatePicker(""daysOfMonthy"",""date.bk_pubtime"") readonly=""true""><DIV id=daysOfMonthy style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">出版社：</div></td>" & vbcrlf & "     <td colspan=""5"" class=""gray""><input name=""bk_publishing"" type=""text"" id=""bk_publishing"" size=""30"" maxlength=""500""></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">版次：</div></td>" & vbcrlf & "         <td width=""20%"" class=""gray""><input name=""bk_pubnum"" type=""text"" id=""bk_pubnum"" size=""15"" maxlength=""500"" max=""200""></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">页数：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray"">" & vbcrlf & "                    <input name=""bk_pagenum"" type=""text"" id=""bk_pagenum"" size=""10"" onpropertychange=""formatData(this,'int');"" maxlength=5 dataType=""Limit"" min=""0"" max=""5""  msg=""请输入正确数字""></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">字数：</div></td>" & vbcrlf & "                <td width=""24%"" class=""gray""><input name=""bk_pagesize"" type=""text"" id=""bk_pagesize"" size=""10"" maxlength=""20"" onpropertychange=""formatData(this,'int');""></td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">印刷时间：</div></td>" & vbcrlf & "       <td width=""20%"" class=""gray""><input name=""bk_printtime"" type=""text"" size=""9"" value="""
	Response.write date
	Response.write """ id=""daysOfMonthPosz"" onmouseup=toggleDatePicker(""daysOfMonthz"",""date.bk_printtime"") readonly=""true""><DIV id=daysOfMonthz style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">开本：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input name=""bk_format"" type=""text"" id=""bk_format"" size=""10"" maxlength=""100"" ></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">纸张：</div></td>" & vbcrlf & "           <td width=""24%"" class=""gray""><input name=""bk_paper"" type=""text"" id=""bk_paper"" size=""10"" maxlength=""50""></td>" & vbcrlf &     "    </tr>" & vbcrlf &  "  <tr>" & vbcrlf &    "   <td width=""13%"" height=""27""><div align=""right"">印次：</div></td>" & vbcrlf &    "   <td width=""20%"" class=""gray""><input name=""bk_printnum"" type=""text"" id=""bk_printnum"" size=""10"" maxlength=""100""></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">ISBN：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input name=""bk_ISBN"" type=""text"" id=""bk_ISBN"" size=""20"" maxlength=""500""></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">装帧：</div></td>" &vbcrlf & "         <td width=""24%"" class=""gray""><input name=""bk_binding"" type=""text"" id=""bk_binding"" size=""20"" maxlength=""500""></td>" & vbcrlf & "       </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">单价：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray""><input name=""bk_price"" type=""text"" id=""bk_price"" size=""10"" maxlength=""20"" onKeyUp=""checkDot('bk_price','"
	Response.write CommPrice_dot_num
	Response.write "')"" onpropertychange=""formatData(this,'CommPrice');sum('bk_price','bk_num','bk_allmoney');""></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">数量：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input name=""bk_num"" type=""text"" id=""bk_num"" size=""10"" maxlength=""20""  onpropertychange=""formatData(this,'int');sum('bk_price','bk_num','bk_allmoney')""></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">总价：</div></td>" & vbcrlf & "            <td width=""24%"" class=""gray""><input name=""bk_allmoney"" type=""text"" id=""bk_allmoney"" size=""10""maxlength=""20"" onKeyUp=""value=value.replace(/[^\d*|\.]/g,'');checkDot('bk_price','"
	Response.write num_dot_xs
	Response.write "')"" readonly=""true""></td>" & vbcrlf & "      </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">存放位置：</div></td>" & vbcrlf & "          <td colspan=""5"" class=""gray""><input name=""bk_postion"" type=""text"" id=""bk_postion"" size=""30"" maxlength=""500""></td>" & vbcrlf & "            </tr>         " & vbcrlf & "        <tr>" & vbcrlf & "            <td><p align=""right"">图书备注：</td>" & vbcrlf & "              <td colspan=""5"" class=""gray""><textarea name=""bk_note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "          <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=bk_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "        </tr> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray"">" & vbcrlf & "                 <div align=""center"">" & vbcrlf & "                        <input type=""submit"" name=""Submit42"" value=""保存"" class=""page""/>" & vbcrlf & "                        <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "               </div></td>" & vbcrlf & "      </tr> " & vbcrlf & "    </table>" & vbcrlf & "     </form>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "</table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="图书登记添加"
	call close_list(1)
