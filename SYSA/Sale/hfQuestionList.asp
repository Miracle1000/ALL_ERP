...
'If Not rs.Eof Then
	...
	'Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "$(document).ready(function(){" & vbcrlf & "//列表的批量删除" & vbcrlf & "$(""#Del_Batch"").click(function(){" & vbcrlf & "   if($("".Del_Item_List"").attr(""checked"")){$("".Del_Item_List"").removeAttr(""checked""); }" & vbcrlf &   " else{$("".Del_Item_List"").attr(""checked""type=""checkbox""][class=""Del_Item_List""]:checked');" & vbcrlf & "               check.each(function()" & vbcrlf & "           {" & vbcrlf & "                       if(list=="""")" & vbcrlf & "                      {" & vbcrlf & "                               list=$(this).val();" & vbcrlf & "                             }" & vbcrlf & "                       else" & vbcrlf & "                    {" & vbcrlf & "                               list=list+"",""+$(this).val();"& vbcrlf &                             " }"& vbcrlf &               " });" & vbcrlf &           "   if (list=="")" & vbcrlf &            "  {" & vbcrlf &                      "  alert(""没有选择任何题目,请选择后再删除!"");" & vbcrlf &                        " return; "& vbcrlf &      "    }" & vbcrlf &         "       window.location.href=""HfQuestion.asp?action=dellist&OrdList=""+list+""&CurrPage=""+$(""#pageid"").val();" & vbcrlf & "}" & vbcrlf & "});" & vbcrlf & "});" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <form method=""post"" name=""demo""  action="""" id=""demo"" onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "<td class=""place"">回访题目列表</td>" & vbcrlf &            " <td>&nbsp;</td>" & vbcrlf &         "    <td align=""right""><input type=""button"" class=""anybutton2"" name=""Submitdel22"" value=""添加回访题目""  onClick=""javascript:window.open('HfQuestion.asp','newQuestTJ','width=' + 1100 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')""/></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                                       <tr class=""top"">" & vbcrlf & "                                          <td width=""6%""><div align=""center"">选择</div></td>" & vbcrlf & "                                          <td width=""25%""><div align=""center"">题目内容</div></td>" & vbcrlf & "                                             <td width=""15%""><div align=""center"">题目类型</div></td>" & vbcrlf & "                                          <td width=""15%""><div align=""center"">重要指数</div></td>" & vbcrlf & "                                             <td width=""24%""><div align=""center"">操作</div></td>" & vbcrlf & "                                 </tr>" & vbcrlf & ""
	Set Rs=server.CreateObject("adodb.recordset")
	SQL="Select a.title,Case a.Qtype When 1 Then '单选题' When 2 Then '多选题' When 3 Then '简答题' else '' End As Qtype,a.Gate1,a.id,a.Creator From hf_Question a Where 1=1 and a.Del=1 Order By gate1 Desc,a.id desc"
	...
	If Not Rs.Eof Then
		...
		Do While Not Rs.Eof
			Response.write "" & vbcrlf & "                                      <tr>" & vbcrlf & "                                            <td><div align=""center""><input name=""Del_Item_List"" type=""checkbox""  class=""Del_Item_List""  id=""Del_Item_List"" value="""
			Response.write rs("id")
			Response.write """></div></td>" & vbcrlf & "                                              <td><div align=""center"">"
			Response.write Rs("title")
			Response.write "</div></td>" & vbcrlf & "                                           <td><div align=""center"">"
			Response.write Rs("Qtype")
			Response.write "</div></td>" & vbcrlf & "                                           <td><div align=""center"">"
			Response.write Rs("Gate1")
			Response.write "</div></td>" & vbcrlf & "                                           <td class=""func""><div align=""center"">" & vbcrlf & "                                               <input type=""button"" name=""Submit3"" value=""详情""  onClick=""javascript:window.open('HfQuestionCon.asp?ord="
			Response.write pwurl(rs("id"))
			Response.write "','newHrss','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>" & vbcrlf & "                                          <input type=""button"" name=""Submit3c"" value=""修改""  onClick=""javascript:window.open('HfQuestion.asp?action=edit&ord="
			Response.write pwurl(rs("id"))
			Response.write pwurl(rs("id"))
			Response.write "&CurrPage="
			Response.write CurrPage
			Response.write "','newQuestup','width=' + 1100 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')""/>" & vbcrlf & "                                              "
			Response.write CurrPage
			if conn.execute("select count(1) from hf_Template where id in (select mainid from hf_TemplateList where questionid="&rs("id")&" and del=1) and del=1")(0)=0 then
				Response.write "" & vbcrlf & "                                              <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='HfQuestion.asp?action=del&ord="
				Response.write pwurl(rs("id"))
				Response.write "&CurrPage="
				Response.write CurrPage
...
'if k>=rs.pagesize then exit do
		...
		Response.write "" & vbcrlf & "      <tr>" & vbcrlf & "    <td align=""center"" colspan=""6"">暂无内容</td>" & vbcrlf & "        </tr>" & vbcrlf & ""
	end if
	rs.close
	Set Rs=Nothing
	Response.write "" & vbcrlf & "</table>" & vbcrlf & "    <tr>" & vbcrlf & "      <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""20%"" height=""60""  align=""left"" valign=""center"" >&nbsp<input type=""checkbox"" name=""Del_Batch"" id=""Del_Batch"">全选&nbsp;&nbsp;<input type=""button"" class=""anybutton2"" name=""Submitdel2"" value=""批量删除"" id=""Del_List"" /></td>" & vbcrlf & "            <td width=""97%""  align=""left"" valign=""center"" ><div align=""right""> <span class=""black"">共"
	Response.write BookNum
	Response.write "条&nbsp; "
	Response.write currpage
	Response.write "/"
	Response.write PageCount
	Response.write "页</span>&nbsp;" & vbcrlf & "                  <input id=""curp1"" name=""currpage""  type=""text""   onkeyup=""value=value.replace(/[^\d\.]/g,'')"" maxlength=10 size=3 />" & vbcrlf & "                           &nbsp;<input type=""hidden"" name=""pageid"" id=""pageid"" value="""
	Response.write CurrPage
	...
	Response.write CurrPage
	if currpage=1 then
		Response.write "" & vbcrlf & "                                <input type=""button"" name=""Submit4"" value=""首页""  class=""anybutton2""/>" & vbcrlf & "                                  <input type=""button"" name=""Submit422"" value=""上页""  class=""anybutton2""/>" & vbcrlf & "                                "
	else
		Response.write "" & vbcrlf & "                                <input type=""button"" name=""Submit4"" value=""首页""   class=""anybutton2"" onClick=""gotourl('currPage=1');""/>" & vbcrlf & "                                  <input type=""button"" name=""Submit422"" value=""上页""  onclick=""gotourl('currPage="
	...
	Response.write "" & vbcrlf & "            </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "  </form>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>"
