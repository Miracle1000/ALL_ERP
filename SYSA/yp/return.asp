...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/yp_return.js?ver="
	Response.write Application("sys.info.jsver")
	...
	'Response.write Application("sys.info.jsver")
	set rs=server.CreateObject("adodb.recordset")
	sql="select id from O_productOut where year(get_addtime)="&year(date)&" and month(get_addtime)="&month(date)&" and day(get_addtime)="&day(date)&""
	rs.open sql,conn,1,1
	num1=rs.RecordCount+1
	num2=num1
	rs.close
	set rs=nothing
	dim bh_1,bh_2,bh_3,bh_4,bh_5
	bh_1=""
	bh_2=""
	bh_3=""
	bh_4=""
	...
	sql7="select id,title,sort,intro1,intro2 from zdybh where sort1=802 and set_open=1 order by gate1 asc "
	...
	if rs7.eof then
		...
		do until rs7.eof
			...
			elseif rs7("sort")=2 then
				if rs7("intro1")=2 then
					bh_2=right(year(date()),2)
				else
					bh_2=year(date())
				end if
				khid=khid&bh_2
			elseif rs7("sort")=3 then
				if rs7("intro1")=1 then
					bh_3=month(date())
				else
					bh_3=month(date())
					if bh_3<=9 then
			...
			elseif rs7("sort")=4 then
				...
				khid=khid&bh_4
			elseif rs7("sort")=5 then
				if rs7("intro1")=1 then
					bh_5=num1
				elseif rs7("intro1")=2 then
					if rs7("intro2")=1 then
						bh_5=num1
					else
						if num1<=9 then
							bh_5="0"&num1
				...
				elseif rs7("intro1")=3 then
					if rs7("intro2")=1 then
						bh_5=num1
					else
						if num1<=9 then
							bh_5="00"&num1
						elseif num1>9 and num1<=99 then
							bh_5="0"&num1
						else
							bh_5=num1
						end if
					end if
				elseif rs7("intro1")=4 then
					if rs7("intro2")=1 then
						bh_5=num1
					else
						if num1<=9 then
						...
						elseif num1>9 and num1<=99 then
							bh_5="00"&num1
						elseif num1>99 and num1<=999 then
							bh_5="0"&num1
						else
							bh_5=num1
						end if
	...
	function bhid(id1)
		...
		sqls="select id from O_productOut where get_bh='"&id1&"'"
...
'if rss.eof then
			set rs=server.CreateObject("adodb.recordset")
			sql="select id,title,intro1,intro2 from zdybh where sort1=802 and sort=5 and set_open=1"
			rs.open sql,conn,1,1
			if rs.eof then
			else
				if rs("intro1")=1 then
					bh_5=num2
				elseif rs("intro1")=2 then
					if rs("intro2")=1 then
						bh_5=num2
					else
						if num2<=9 then
				...
				elseif rs("intro1")=3 then
					if rs("intro2")=1 then
						bh_5=num2
					else
						if num2<=9 then
							bh_5="00"&num2
						elseif num2>9 and num2<=99 then
							bh_5="0"&num2
						else
							bh_5=num2
						end if
					end if
				elseif rs("intro1")=4 then
					if rs("intro2")=1 then
						bh_5=num2
					else
						if num2<=9 then
						...
						elseif num2>9 and num2<=99 then
							bh_5="00"&num2
						elseif num2>99 and num2<=999 then
							bh_5="0"&num2
						else
							bh_5=num2
						end if
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">   " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">返还添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "       <form action=""save_return.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)&&ask1()"">" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">       " & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" ><div align=""left""><strong>基本情况</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "                <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "              <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "             </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "      <td width=""14%"" height=""37""><div align=""right"">返还主题：</div></td>" & vbcrlf & "          <td width=""22%"" class=""gray""><input name=""ret_title"" type=""text"" id=""ret_title"" dataType=""Limit"" min=""1"" max=""200""  msg=""长度必须在1至200个字之间"">" & vbcrlf & "          &nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">返还时间：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input name=""ret_time"" type=""text"" size=""9"" value="""
	Response.write date
	Response.write """ id=""daysOfMonthPosx"" onmouseup=toggleDatePicker(""daysOfMonthx"",""date.ret_time"") readonly=""true"">" & vbcrlf & "            <DIV id=daysOfMonthx style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "        <td width=""10%""><div align=""right"">返还人员：</div></td>" & vbcrlf &"        <td width=""24%"" class=""gray"">"
	Response.write regname
	Response.write "<input type=""hidden"" id=""ret_cateid"" name=""ret_cateid"" value="""
	Response.write session("personzbintel2007")
	Response.write """/></td>" & vbcrlf & "    </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""14%"" height=""37""><div align=""right"">库管人员：</div></td>" & vbcrlf & "          <td height=""37"" colspan=""5"" class=""gray"">" & vbcrlf & "         <select name=""ret_bcateid"" id=""ret_bcateid"">" & vbcrlf & "                "
	sql="select ord,name from gate where del=1 and ord in (select ord from power where sort1=101 AND sort2=17 and qx_open=1)"
	set rs=conn.execute(sql)
	if not rs.eof then
		do while not rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "        </select>" & vbcrlf & "            </td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" align=""center"" style=""padding:0"">" & vbcrlf & "         <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">" & vbcrlf & "         <tr>" & vbcrlf & "                    <td valign=""center"" style=""padding:6px 0px 6px 32px"">" & vbcrlf & "                       <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" class=""detailTable"">" & vbcrlf & "                    <tr class=""tbheader"">" & vbcrlf & "                             <td height=""27"" colspan=""13""><div align=""left""><a href=""###"" onClick=""setMx()"">添加明细<img src=""../images/add.gif"" border=""0"" style=""border:0px;""/></a></div></td>" & vbcrlf &  "                    </tr>" & vbcrlf &  "                  <tr>" & vbcrlf & "                            <td width=""8%"" height=""27""><div align=""center""><strong>名称</strong></div></td>" & "                                <td width=""8%"" height=""27""><div align=""center""><strong>编号</strong></div></td>" & vbcrlf & "                               <td width=""8%"" height=""27""><div align=""center""><strong>型号</strong></div></td>" & vbcrlf & "                               <td width=""5%"" height=""27""><div align=""center""><strong>单位</strong></div></td>" & vbcrlf & "                             <td width=""8%"" height=""27""><div align=""center""><strong>返还数量</strong></div></td>" & vbcrlf & "                           <td width=""6%"" height=""27""><div align=""center""><strong>应还数量</strong></div></td>" & vbcrlf & "                           <td width=""6%"" height=""27""><div align=""center""><strong>终止返还</strong></div></td>" & vbcrlf & "                           <td width=""8%"" height=""27""><div align=""center""><strong>批号</strong></div></td>" & vbcrlf & "                               <td width=""8%"" height=""27""><div align=""center""><strong>序列号</strong></div></td>" & vbcrlf & "                             <td width=""8%"" height=""27""><div align=""center""><strong>生产日期</strong></div></td>" & vbcrlf & "                             <td width=""8%"" height=""27""><div align=""center""><strong>有效日期</strong></div></td>" & vbcrlf & "                           <td width=""8%"" height=""27""><div align=""center""><strong>用品类型</strong></div></td>" & vbcrlf & "                           <td height=""27""><div align=""center""><strong>备注</strong></div></td>" & vbcrlf & "                   </tr>           " & vbcrlf & "                        <tbody id=""prod_mx"">" & vbcrlf & "                      </tbody>" & vbcrlf & "                        </table></td>" & vbcrlf & "           </tr>" & vbcrlf & "           </table></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "            <td><p align=""right"">返还备注：</td>" & vbcrlf & "              <td colspan=""5"" class=""gray""><textarea name=""ret_note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "                    <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=ret_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "     </tr> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray""><p align=""center"">" & vbcrlf & "           <input type=""submit"" name=""Submit42"" value=""保存"" class=""page""/>" & vbcrlf & "                <input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr>               " & vbcrlf & "    </table>" & vbcrlf & "    </form>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"" height=""2000"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "<tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "   </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""ddd"" class=""easyui-dialog"" icon=""icon-search"" title=""选择明细""  style=""width:900px;height:500px;padding:5px;background:#fafafa;top:0px"" closed=""true"">" & vbcrlf & "      <div region=""south"" border=""false"" style=""text-align:right;height:40px;line-height:30px;"">" & vbcrlf & "    <select name=""u_type"" id=""u_type"" onchange=""searchMe(this.value,1);"" style=""width:80px;"">" & vbcrlf & "<option value="">用品分类</option>" & vbcrlf & "        "
	...
	rs.close
	set rs = nothing
	Response.write "" & vbcrlf & "     </select>" & vbcrlf & "       用品名称：<input  id=""u_name"" name=""sKeyword"" value="""
	Response.write t
	Response.write """ type=""text"" size=""12"" style=""width:80px;"" onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & "   用品编号：<input  id=""u_bh"" name=""sKeyword"" value="""
	Response.write t
	Response.write """ type=""text"" size=""10"" style=""width:80px;""  onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & "  用品型号：<input  id=""u_xh"" name=""sKeyword"" value="""
	Response.write t
	Response.write """ type=""text"" size=""10"" style=""width:80px;""  onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & "  用品批号：<input  id=""u_ph"" name=""sKeyword"" value="""
	Response.write t
	Response.write """ type=""text"" size=""10 style=""width:80px;"" "" onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & "  序列号：<input  id=""u_xlh"" name=""sKeyword"" value="""
	Response.write t
	Response.write """ type=""text"" size=""10"" style=""width:80px;""  onpropertychange=""searchMe(this.value,1);"">  " & vbcrlf & "        </div>" & vbcrlf & "  <div id=""selectiddiv"" region=""center"" border=""false"" style=""padding:5px;background:#fff;width:100%"">" & vbcrlf & "    </div>" & vbcrlf & "  <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "          <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$('#ddd').window('close');"">关闭</a>         " & vbcrlf & "        </div>" & vbcrlf & "</div>" & vbcrlf & ""
	Response.write t
	action1="用品返还添加"
	call close_list(1)
