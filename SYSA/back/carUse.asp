...
'bigsystemtype = ".mozi"
	...
	'Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write "' defer='defer'></script>" & vbcrlf & "</head>" & vbcrlf & "<body oncontextmenu=self.event.returnValue=false>" & vbcrlf & "<form name=""form1"" method=""post"" action=""../car/Del_carUse.asp?realDel=1&CurrPage="
	Response.write CurrPage
	Response.write """>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "            <td width=""100%"" valign=""top"">" & vbcrlf & "                      <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "<tr>" & vbcrlf &                              "       <td class=""place"">车辆申请回收站</td> "& vbcrlf &                                    "  <td>&nbsp;</td> "& vbcrlf &                       "           <td align=""right""><input type=""button"" name=""Submitdel"" class=""anybutton"" value=""全部清空"" onClick=""if(confirm('确认清空本回收站里的所有内容？')){window.location.href='../car/Del_carUse.asp?ord=-634&realDel=1&CurrPage="
	Response.write CurrPage
	Response.write "'}""/></td>" & vbcrlf & "                                 <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "                              </tr>" & vbcrlf & "                   </table> " & vbcrlf & "                       <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf& "                                <tr class=""top""  height=""27"">" & vbcrlf & "                                       <td width=""5%"" align=""center""><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "                                    <td width=""5%"" align=""center""><div align=""center""><strong>序号</strong></div></td>" & vbcrlf & "                                    <td width=""10%""><div align=""center""><strong>使用人员</strong></div></td> "& vbcrlf &                                    " <td width=""10%""><div align=""center""><strong>申请类型</strong></div></td> "& vbcrlf &                      "               <td width=""10%""><div align=""center""><strong>审批状态</strong></div></td> "& vbcrlf &                               "      <td width=""10%""><div align=""center""><strong>添加人</strong></div></td>" & vbcrlf & "                                       <td width=""10%""><div align=""center""><strong>删除人</strong></div></td>" & vbcrlf & "                                      <td width=""20%""><div align=""center"">删除时间</div></td>" & vbcrlf & "                                     <td width=""20%""><div align=""center""><strong>操作</strong></div></td>" & vbcrlf & "                                </tr>" & vbcrlf& ""
	dim n
	n=0
	set rs=server.CreateObject("adodb.recordset")
	sql="select a.use_id,case when a.use_type=1 then '申请' else '派车' end useType," & vbcrlf &_
	"case when a.use_complete=1 then '待审批' when a.use_complete=2 then '审批中' when a.use_complete=3 then '审批通过' end spStatus " & vbcrlf &_
	",isnull(g3.name,'') useName,isnull(g1.name,'') addName,isnull(g2.name,'') delName,a.deldate,a.use_cateid," & vbcrlf &_
	"case when exists(" & vbcrlf &_
	"select top 1 1 from O_carUseMx sa " & vbcrlf &_
	"inner join O_carUse sb on sa.use_fid = sb.use_id and sb.use_id = a.use_id " & vbcrlf &_
	"and exists (" & vbcrlf &_
	"select top 1 1 from O_carUseMx sc " & vbcrlf &_
	"inner join O_carUse sd on sc.use_fid = sd.use_id and sd.del=1 and sc.del=1 " & vbcrlf &_
	"and sc.use_carid = sa.use_carid and sc.use_id <> sa.use_id " & vbcrlf &_
	"and not (sa.use_startime>sc.use_endtime OR sa.use_endtime<use_startime) " & vbcrlf &_
	")" & vbcrlf &_
	") then 0 else 1 end canResume " & vbcrlf &_
	"from O_carUse a " & vbcrlf &_
	"left join gate g1 on g1.ord=a.use_addcateid " & vbcrlf &_
	"left join gate g2 on g2.ord=a.delcate " & vbcrlf &_
	"left join gate g3 on g3.ord=a.use_cateid " & vbcrlf &_
	"where a.del=2 order by a.deldate desc"
	...
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			...
			Response.write id
			Response.write """>" & vbcrlf & "                                         </span>" & vbcrlf & "                                 </td> " & vbcrlf & "                                  <td align=""center"" height=""24"">"
			Response.write Rs.recordcount-Rs.pagesize*(currpage-1)-n
			Response.write "</td>" & vbcrlf & "                                 <td height=""27"" class=""name"" >" & vbcrlf & "                                              <div align=""center"">" & vbcrlf & ""
			if open_102_14=3 or CheckPurview(intro_102_14,trim(use_cateid))=True Then
				Response.write "" & vbcrlf & "                                                      <a href=""javascript:void(0)"" onclick=""window.open('../car/Detail_carUse.asp?ord="
				Response.write id
				Response.write "','carUse','width=900,height=500,fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=100,top=100');return false;"" title="""
				Response.write rs("useName")
				Response.write """>"
				Response.write rs("useName")
			...
			Response.write "" & vbcrlf & "                                              </div>" & vbcrlf & "                                  </td>" & vbcrlf & "                                   <td class=""name""><div align=""center""><font class=""name"">"
			Response.write rs("useType")
			Response.write "</font></div></td>" & vbcrlf & "                                    <td class=""name""><div align=""center"">"
			Response.write rs("spStatus")
			Response.write "</div></td> " & vbcrlf & "                                  <td class=""name""><div align=""center"">"
			Response.write rs("addName")
			Response.write "</div></td> " & vbcrlf & "                                  <td class=""name""><div align=""center"">"
			Response.write rs("delName")
			Response.write "</div></td> " & vbcrlf & "                                  <td class=""name""><div align=""center"">"
			Response.write rs("deldate")
			Response.write "</div></td>" & vbcrlf & "                                   <td> " & vbcrlf & "                                           <div align=""center"">" & vbcrlf & "                                                      <input type=""button"" name=""Submit3c"" "
			Response.write iif(rs("canResume")=1,""," disabled ")
			Response.write " class=""anybutton"" value=""恢复"" onClick=""if(confirm('确认恢复？')){window.location.href='setCarUse.asp?ord="
			Response.write id
			Response.write "&CurrPage="
			Response.write CurrPage
			Response.write "'}""/><input type=""button"" name=""Submitdel"" class=""anybutton"" value=""彻底删除"" onClick=""if(confirm('您选择的是彻底删除，删除后不能再恢复，确认删除？')){window.location.href='../car/Del_carUse.asp?realDel=1&ord="
			Response.write id
			Response.write "&CurrPage="
			Response.write CurrPage
		...
		loop
		m=n
		Response.write "       " & vbcrlf & "                      </table>" & vbcrlf & "                </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td  class=""page"">" & vbcrlf & "                        <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "                         <tr>" & vbcrlf & "                                    <td width=""10%"" height=""30"">" & vbcrlf & "                                                <div align=""center"">全选" & vbcrlf & "                                               <input type=""checkbox"" name=""checkbox2"" value=""Check All"" onClick=""mm()"">" & vbcrlf & "                                               </div>" & vbcrlf & "                                  </td>" & vbcrlf & "                                   <td >" & vbcrlf & "                                           <input type=""submit"" name=""Submit426"" value=""批量删除""   onClick=""return test();""  class=""anybutton2"">" & vbcrlf & "                                              <input type=""button"" name=""Submit426"" value=""批量恢复""  onclick=""ask2();"" class=""anybutton2""/>" & vbcrlf & "                                    </td>" & vbcrlf & "                                   <td width=""69%"">" & vbcrlf & "                                          <div align=""right"">" & vbcrlf & "                                               "
		...
		Response.write "" & vbcrlf & "                                             </div>" & vbcrlf & "                                  </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                           <script type=""text/Javascript"">window.currask2Url=""setCarUse.asp?currPage="
		Response.write currPage
		Response.write """;</script>" & vbcrlf & "                               <script src='../script/bk_comm01.js?ver="
		Response.write Application("sys.info.jsver")
		Response.write "'></script>" & vbcrlf & "                          <tr>" & vbcrlf & "                                    <td height=""38"" colspan=""3"">" & vbcrlf & "                                                <div align=""right""><p>&nbsp;</p></div>" & vbcrlf & "                                    </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                   </table>" & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	dim actinon1
