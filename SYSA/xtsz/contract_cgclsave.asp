...
'c = Lcase(Mid(name, i, 1))
	...
	If Len(sort9&"")=0 Then sort9=1
	sort10=request.form("sort10")
	If Len(sort10&"")=0 Then sort10=0
	sort11=request.form("sort11")
	If Len(sort11&"")=0 Then sort11=0
	sortdr=request.form("sortdr")
	If Len(sortdr&"")=0 Then sortdr=0
	sort12=request.form("sort12")
	If Len(sort12&"")=0 Then sort12=0
	call setsort(48,sort1)
	call setsort(49,sort2)
	call setsort(2016102101,sort3)
	call setsort(2016102102,sort4)
	call setsort(2016102103,sort5)
	call setsort(2016102801,sort6)
	call setsort(2019030101,sort7)
	call setsort(320173101,sort8)
	call setsort(320173102,sort9)
	call setsort(320173103,sort10)
	call setsort(320173104,sort11)
	call setsort(320310701,sortdr)
	call setsort(320173105,sort12)
	conn.close
	set conn=nothing
	Response.write"<script language=javascript>alert('设置成功！');window.location='contract_cgcl.asp';</script>"
	call db_close : Response.end
	Function setsort(byval sort1str,byval introstr)
		if isnul(sort1str) then sort1str=0
		if isnul(introstr) then introstr=0
		conn.execute("delete setopen where sort1="&sort1str&" ")
		dim rsobi : set rsobj = getrs("select * from setopen where sort1="&sort1str)
		if rsobj.eof then    rsobj.addnew
		rsobj("intro") = introstr
		rsobj("sort1") = sort1str
		rsobj.update
		call closers(rsobj)
	end function
%>
