...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""1"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""border-color:#CCC"" bordercolor=""#CCCCCC"">" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td colspan=""2""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';return false;><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td></tr>" & vbcrlf
	Sub print_search_scope(HType, isShow, fieldName, scope, valName)
		If isShow=1 Then
			...
			Case 3 :
			Response.write "&nbsp;自：<INPUT name=ret size=9  id=daysOfMonthPos onmouseup=toggleDatePicker('daysOfMonth','date.ret') value='"& m1&"'><DIV id=daysOfMonth style='POSITION: absolute;z-index:10'></DIV>"
			Case 3 :
			Response.write "&nbsp;至：<INPUT name=ret2 size=9  id=daysOfMonth2Pos onmouseup=toggleDatePicker('daysOfMonth2','date.ret2') value='"& m2&"'><DIV id=daysOfMonth2 style='POSITION: absolute'></DIV>"
			Case 4 :
			If scope="sex" Then
				Response.write "<input type='checkbox' name='"&valName&"' value='男'/>男  "
				Response.write "<input type='checkbox' name='"&valName&"' value='女'/>女"
			end if
			Case 5 :
			If scope="age" Then
				Response.write "&nbsp;从：<input type='text' size=9 name='"&valName&"_0' id='"&valName&"_0' onpropertychange=""formatData(this,'int');"" onKeyUp=""checkDot('"&valName&"_0','0')""/>"
				Response.write "&nbsp;到：<input type='text' size=9 name='"&valName&"_1' onpropertychange=""formatData(this,'int');"" onKeyUp=""checkDot('"&valName&"_1','0')""/>"
			end if
			End Select
			Response.write "</td></tr>"
		end if
	end sub
	Response.write "" & vbcrlf & "      <td rowspan=""2""><div align=""right"">人员选择：</div></td>" & vbcrlf & "    <td><div align=""left"">" & vbcrlf & "            <input type=""radio"" name=""B"" value=""1"" checked />"
	if s3=2 then
		Response.write "采购"
	else
		Response.write "销售"
	end if
	Response.write "人员" & vbcrlf & "          <input type=""radio"" name=""B"" value=""2"" />添加人员" & vbcrlf & "             <input type=""radio"" name=""B"" value=""3"" />"
	if s3=2 then
		Response.write "采购"
	else
		Response.write "销售"
	end if
	Response.write "人员和添加人员" & vbcrlf & "        </div>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td><div align=""left"">"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
	if s3=2 then
		Response.write "供应商分类"
	else
		Response.write arrName(4)
	end if
	Response.write "：</div></td>" & vbcrlf & "<td>" & vbcrlf & "    "
	if s3=2 Then
		Response.write "<select name='ly'><option value='0' selected>选择分类</option>"
		set rs8=conn.execute("select * from sortonehy where gate2=17 order by gate1 desc ")
		do while not rs8.eof
			Response.write "<option value='"&rs8("id")&"'>"&rs8("sort1")&"</option>"
			rs8.movenext
		loop
		rs8.close
		Response.write "</select>"
		...
		do until rs1.eof
			...
			do until rs2.eof
				Response.write "<span class='gray'><input name='F' type='checkbox' value='"&rs2("ord")&"' onClick=fixChk2('"&i5&"') "
	...
	Response.write "" & vbcrlf & "</td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
	if s3=2 then
		Response.write "供应商区域"
	else
...
'intname=1
	...
	Call print_search_scope(1,inttrade,settrade, 11 ,"D")
	Call print_search_scope(2,arrShow(17),arrName(17), "F1" ,"F2")
	Call print_search_scope(2,intname,setname, "C1" ,"C2")
	Call print_search_scope(2,arrShow(27),arrName(27), "P1" ,"P2")
	Call print_search_scope(2,arrShow(28),arrName(28), "J1" ,"J2")
	Call print_search_scope(2,arrShow(20),arrName(20), "Mob1" ,"Mob2")
	Call print_search_scope(2,arrShow(20),arrName(20)&"2", "Mob3" ,"Mob4")
	Call print_search_scope(2,arrShow(19),arrName(19), "T1" ,"T2")
	Call print_search_scope(2,arrShow(21),arrName(21), "Fax1" ,"Fax2")
	Call print_search_scope(2,arrShow(100),arrName(100), "wx1" ,"wx2")
	Call print_search_scope(2,arrShow(23),arrName(23), "QQ1" ,"QQ2")
	Call print_search_scope(2,arrShow(24),arrName(24), "MSN1" ,"MSN2")
	Call print_search_scope(2,arrShow(22),arrName(22), "Email1" ,"Email2")
	Call print_search_scope(2,1,"联系人地址", "Add1" ,"Add2")
	Call print_search_scope(2,1,"联系人爱好", "Joy1" ,"Joy2")
	Call print_search_scope(2,1,"联系人拼音码", "Pym1" ,"Pym2")
	Call print_search_scope(2,1,"联系人备注", "Intro1" ,"Intro2")
	Call print_search_scope(3,1,"添加日期", "" ,"")
	Call print_search_scope(4,arrShow(30),arrName(30), "sex" ,"sex")
	Call print_search_scope(5,arrShow(32),arrName(32), "age" ,"age")
