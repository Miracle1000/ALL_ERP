...
'function IsTime(values)
	...
	if px="1" then
		Ptr_Result=" order by zdy5 desc"
	elseif px="2" then
		Ptr_Result=" order by zdy5 asc"
	elseif px="3" then
	...
	if ret<>"" then
		Str_Result=Str_Result+" and  datediff(s,'"&ret&"',zdy5)>=0 "
'if ret<>"" then
	end if
	ret2=ChangeDate(ret2,2)
	if ret2<>"" then
		Str_Result=Str_Result+" and  datediff(s,zdy5,'"&ret2&"')>=0 "
'if ret2<>"" then
	end if
	if C<>"" then
		if B="name" then
	...
	Response.write px
	Response.write """>" & vbcrlf & "                        <input type=""submit"" class=""anybutton2"" id=""btnmit"" name=""btnmit"" value=""检索""></span></td>" & vbcrlf & "            " & vbcrlf & "           </tr>" & vbcrlf & "            <tr valign=""center"" class=""top"">" & vbcrlf & "              <td width=""7%"" height=""30"" align=""left"" valign=""middle""  class=""name""><div align=""center"">选择</div></td>" & vbcrlf & "                <td width=""8%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">资产名称</div></td>" & vbcrlf & "                 <td width=""14%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">资产编号</div></td>" & vbcrlf & "                   <td width=""14%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">资产分类</div></td>" & vbcrlf & "                <td width=""10%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">单位</div></td>" & vbcrlf & "            <td width=""7%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">期次</div></td>" & vbcrlf & "             <td width=""9%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">工作量</div></td>" & vbcrlf & "            <td width=""13%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">添加时间</div></td>" & vbcrlf & "              <td width=""18%"" align=""left"" valign=""middle""  class=""name""><div align=""center""><select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" class=""reseetTextColor"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px   solid   #FFFFFF; overflow:hidden"">" & vbcrlf & "                          <option>-请选择-</option>" & vbcrlf & "                       <option value=""page_count=10"" "
	Response.write px
	...
	currpage=clng(currpage)
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select CONVERT(VARCHAR(10),a.zdy5,120) tjtime,a.*,b.ass_name,b.ass_cycle,b.ass_bh,b.ass_type,b.ass_cycle1,b.ass_ycycle,c.sort1 from O_assWork a left join O_asset b on a.wr_assID=b.ass_id left join O_assSetname c on b.ass_type=c.id "&Str_Result&" "&Ptr_Result
	rs7.open sql7,conn,1,1
	if rs7.RecordCount<=0 then
		...
		do while not rs7.eof
			addcateid=rs7("zdy5")
			Response.write "" & vbcrlf & "             <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "              <td width=""7%"" height=""30"" align=""left"" valign=""middle""  class=""name""><div align=""center"">" & vbcrlf & "                  "
			...
			Response.write "</div></td>" & vbcrlf & "             <td width=""10%"" align=""left"" valign=""middle""><div align=""center"">" & vbcrlf & "               "
			if rs7("ass_cycle1")=1 then
				Response.write "年"
			elseif rs7("ass_cycle1")=2 then
				Response.write "月"
			elseif rs7("ass_cycle1")=3 then
				Response.write "台班"
			elseif rs7("ass_cycle1")=4 then
				Response.write "小时"
			elseif rs7("ass_cycle1")=5 then
				Response.write "公里"
			end if
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""><div align=""center"">"
			Response.write rs7("ass_ycycle")
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""><div align=""center"">"
			Response.write rs7("wr_working")
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""><div align=""center"">"
			Response.write rs7("tjtime")
			Response.write "</div></td>" & vbcrlf & "             <td width=""18%"" height=""30"" align=""left"" valign=""middle""><div align=""center"">" & vbcrlf & "                  "
			if (open_105_3=3 or CheckPurview(intro_105_3,trim(addcateid))=True) then
				Response.write "" & vbcrlf & "                     <input name=""button5"" type=""button""  class=""anybutton2"" id=""submit5"" onClick=""if(confirm('确认删除吗？')){window.location=('Del_assetBB1.asp?ord="
				Response.write rs7("id")
				Response.write "&px="
	...
	Response.write "&CurrPage="
	Response.write CurrPage
	Response.write """;" & vbcrlf & "}" & vbcrlf & "else" & vbcrlf & "{" & vbcrlf & "   document.getElementById('data').action=""Del_assetBB1.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
