...
'bigsystemtype = ".mozi"
	...
	Response.write Application("sys.info.jsver")
	Response.write "' defer='defer'></script>" & vbcrlf & "</head>" & vbcrlf & "<body  oncontextmenu=self.event.returnValue=false >" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "   <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf &        "   <tr> "& vbcrlf &        "     <td class=""place"">费用返还回收站</td> "& vbcrlf &         "    <td>&nbsp;</td> "& vbcrlf &         "    <td align=""right""><input type=""button"" name=""Submitdel"" class=""anybutton"" value=""全部清空"" onClick=""if(confirm('确认清空本回收站里的所有内容？')){window.location.href='delpay.asp?ord=pay&url=pay3.asp&bank=4'}""/></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table> " & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr  class=""top"">" & vbcrlf & "        <td align=""center"" ><div align=""center"">选择</div></td>" & vbcrlf & "        <td height=""26""align=""center"" ><div align=""center"">标题</div></td>" & vbcrlf & "        <td height=""26""  ><div align=""center""><strong>金额</strong></div></td>" & vbcrlf & "        <td width=""11%"" ><div align=""center"" ><strong>借款人</strong></div><div align=""center""></div></td>" & vbcrlf & "        "
	if c="" then
'end if
'if c="" then
		Response.write "" & vbcrlf & "        <td ><div align=""center""><strong>删除人</strong></div></td>" & vbcrlf & "        "
	end if
	Response.write "" & vbcrlf & "        <td ><div align=""center""><strong>删除日期</strong></div></td>" & vbcrlf & "        <td ><div align=""center"" ><strong>操作</strong></div></td>" & vbcrlf & "      </tr>" & vbcrlf & "      "
	dim n , canDelete
	n=0
	canDelete = True
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from pay where del=2 and (complete=7 or complete=8 or complete=12 or complete=11) order by deldate desc"
	...
	if rs.RecordCount<=0 then
		...
		Response.write "" & vbcrlf & "      <form name=""form1"" method=""post"" action=""deletepay3all.asp?ord="
		...
		do until rs.eof
			...
			Response.write "" & vbcrlf & "      <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "   <td width=""9%"" align=""center""><span class=""red"">" & vbcrlf & "      <input name=""selectid"" type=""checkbox"" id=""selectid"" value="""
			Response.write rs("ord")
			Response.write """>" & vbcrlf & " </span></td>" & vbcrlf & "    <td width=""24%"" align=""center"" height=""26"">" & vbcrlf & "   "
			if open_6_14=3 or CheckPurview(intro_6_14,trim(cateid))=True then
				Response.write "" & vbcrlf & "      <a href=""javascript:void(0);"" onClick=""javascript:window.open('../pay/content3.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "','neww34win','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"">"
				Response.write pwurl(rs("ord"))
				Response.write k
			...
			Response.write "" & vbcrlf & "      </td>" & vbcrlf & "   <td width=""12%"" height=""26"" >" & vbcrlf & "       <div align=""center"">"
			if rs("money1")&""="" then
...
'if rs("money1")&""="" then
			...
			if rs("cateid")<>"" then
				set rs1=server.CreateObject("adodb.recordset")
				sql1="select * from gate where ord="&rs("cateid")&" "
				rs1.open sql1,conn,1,1
				if rs1.eof then
				else
					trade5=rs1("name")
			...
			canDelete = conn.execute("exec [erp_rela_finance_GetCollectionIDs] "& session("personzbintel2007") &", 1, '" & rs("ord") &"',4, 8, '8010' ").eof
			...
			Response.write "</div></td>" & vbcrlf & "  <td width=""21%""><div align=""center"">" & vbcrlf & "        <input type=""button"" name=""Submit3c""  class=""anybutton""  value=""恢复""  onClick=""if(confirm('确认恢复？')){window.location.href='setpay3.asp?ord="
			Response.write rs("ord")
			Response.write "&CurrPage="
			Response.write CurrPage
			Response.write "'}""/>" & vbcrlf & "     "
			if canDelete then
				Response.write "<input   type=""button"" name=""Submitdel"" class=""anybutton"" value=""彻底删除"" onClick=""if(confirm('您选择的是彻底删除，删除后不能再恢复，确认删除？')){window.location.href='deletepay3.asp?ord="
				Response.write rs("ord")
				Response.write "&CurrPage="
				Response.write CurrPage
				Response.write "'}""/>"
		...
		if currpage=1 then
			...
			Response.write "" & vbcrlf & "          <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='pay3.asp?currPage="
			Response.write  1
			Response.write "&a="
			Response.write a
			Response.write "&b="
			...
			Response.write "&c="
			Response.write c
			Response.write "'""/> <input type=""button"" name=""Submit42"" value=""上一页""  onClick=""window.location.href='pay3.asp?currPage="
		...
		if currpage=rs.pagecount then
			...
			Response.write "" & vbcrlf & "         <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='pay3.asp?currPage="
			Response.write  currpage + 1
			Response.write "&a="
			Response.write a
			Response.write "&b="
			...
			Response.write "&c="
			Response.write c
			Response.write "'"" class=""page""/> <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href='pay3.asp?currPage="
			Response.write  rs.PageCount
			Response.write "&a="
			Response.write a
			Response.write "&b="
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <script type=""text/Javascript"">window.currask2Url=""setpay3all.asp?currPage="
		Response.write currPage
