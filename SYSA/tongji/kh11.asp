...
'if F<>"" then
	...
	Response.write "新增每周走势"
	Response.write m1name
	Response.write m2name
	Response.write "</strong></td>" & vbcrlf & "               <td width=""3""><img class=""resetElementHidden"" src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "     </tr>" & vbcrlf & "</table>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr class=""top"">" & vbcrlf & "<form method=""POST"" action=""kh11.asp?sort3="
	...
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "          <input type=""button"" name=""zxt"" value=""折线图分析"" onClick=""window.location.href='kh11.asp?type_tj=2&W1="
	Response.write W1
	Response.write "&W2="
	Response.write W2
	Response.write "&W3="
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "      <input type=""button"" name=""line"" value=""饼图分析"" onClick=""window.location.href='kh11.asp?type_tj=3&W1="
	Response.write W1
	Response.write "&W2="
	Response.write W2
	Response.write "&W3="
	...
	Response.write ">图宽=550</option>" & vbcrlf & "        <option value=""kh11.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=700</option>" & vbcrlf & "        <option value=""kh11.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=1000</option>" & vbcrlf & "        <option value=""kh11.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=1500</option>" & vbcrlf & "        <option value=""kh11.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=2000</option>" & vbcrlf & "        <option value=""kh11.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	if open_1_10=1 or open_1_10=3  then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认将统计结果导出为EXCEL文档？')){window.location.href='kh11.asp?type_tj=4&W1="
		Response.write W1
		Response.write "&W2="
		Response.write W2
		Response.write "&W3="
...
'for j=1 to m
		...
		month1=month(tdw)
		set rs=server.CreateObject("adodb.recordset")
		sql="select ord  from  tel  where isnull(sp,0)=0 and datediff(n,date2,'"&cdate(tdw)&"')<=0 and datediff(n,date2,'"&dateadd("ww",1,tdw)&"')>0 "&Str_Result2&""
		rs.open sql,conn,1,1
		...
		title=day1&"周"
		if sort3=1 then
			lburl="../work/telhy.asp?fromTJ=1&W1="&W1&"&W2="&W2&"&W3="&W3&"&sort="&E&"&sort1="&F&"&ret3="&tdw&"&ret4="&dateadd("ww",1,tdw)-1&""
'if sort3=1 then
		else
			lburl="../work2/telhy.asp?W1="&W1&"&W2="&W2&"&W3="&W3&"&sort="&E&"&sort1="&F&"&ret3="&tdw&"&ret4="&dateadd("ww",1,tdw)-1&""
'if sort3=1 then
		end if
		total1(j,1)=numcg1
		total1(j,2)=title
		...
		total2(j,0)=title
		total2(j,1)=numcg1
		total2(0,1)="#FF0000,1.5,1,3,每周走势"
		total2(j,2)=lburl
		total3(j,0)=title
		total3(j,1)=numcg1
		total3(j,2)=lburl
