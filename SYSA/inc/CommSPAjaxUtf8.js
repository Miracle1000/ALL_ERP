function SpClinetClass(){
	var  base = new Object();
	base.onProcComplete = function (spord, spid , spuser , ADDobj) {
	    //项目总览页使用了此处审批流程处理，此处已不具备公共使用性
	    jQuery.ajax({
	        url: "../../../../SYSA/Design/content.asp?__msgid=doSpHandle",
	        data: { id: spord, "@__sp_level_id": spid, "@__sp_cateid": spuser  },
	        type: 'post',
	        success: function (r) {
	...
	base.GetNextSP = function(page, spord , money, sptype, useCateid, isback, ADDobj , top , left, virPath){
		...
		if(typeof(left) == "undefined"){left = 450;}
		...
		if(spid!="0"){
			...
			html = html+"<tr class='top'><td colspan='4' height='27' bgcolor='#ecf5ff'><b>请选择下级审批人</b></td></tr>";
			html = html+"<tr><td width='42%' height='27' bgcolor='#ffffff'><div align='right'>下级审批人：</div></td><td bgcolor='#ffffff' width='58%' colspan='3'><div align='left'><span class='gray'>";
			...
			html = html+"</span>";
			html = html+"</div></td></tr>";
			html = html+"<tr><td height='27' bgcolor='#ffffff' colspan=4 align='center' style='border:0'><input type='button' class='oldbutton anybutton' value=' 确定 ' id='_sp_sbmit'>&nbsp;&nbsp;<input type='button' class='oldbutton anybutton' value=' 取消 ' id='_sp_close' ></td></tr>";
			html = html+"</table></div>";
			obj.innerHTML=html;
