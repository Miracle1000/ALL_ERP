...
'if currid&""="" then currid = 0
	...
	Response.redirect "add.asp?top="& request("top")
	Response.end
	dim MODULES
	...
	if unitallList="" then unitallList=0
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	sqlStr="Insert Into product(addcate,date7,del) values('"
	sqlStr=sqlStr & session("personzbintel2007") & "','"
	sqlStr=sqlStr & now & "','"
	sqlStr=sqlStr & 7 & "')"
	Conn.execute(sqlStr)
	dim rd
	rd = GetIdentity("product","ord","addcate","")
	khid= ""
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script>" & vbcrlf & "    window.BillExtSN.Reg(16001, ""order1"");" & vbcrlf & "    var  cfun  =  window.__ChangeMenuArea;" & vbcrlf & "    window.__ChangeMenuArea = function(){" & vbcrlf & "        if(cfun) { cfun(); }" & vbcrlf & "        var doc =document.getElementById(""menuclsframe"").contentWindow.document;" & vbcrlf & "        var alinks =doc.getElementsByTagName(""a"");" & vbcrlf & "        var sort1value = 0;" & vbcrlf & "        if(alinks.length>0) {" & vbcrlf & "            sort1value = alinks[0].outerHTML.split(""productmenu="")[1].split(""'"")[0];"& vbcrlf & "        } else {" & vbcrlf & "            sort1value = 0;" & vbcrlf & "        }" & vbcrlf & "        document.getElementById(""sort1"").value=(sort1value);" & vbcrlf & "        window.BillExtSN.Refresh();" & vbcrlf & "    }" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<bodyonload=setTimeout(""document.getElementById('tabbb1').focus()"",1) >" & vbcrlf & "   <table border=""0"" width=""100%"" cellspacing=""0"" cellpadding=""0"" bgcolor=""#FFFFFF"">" & vbcrlf & "         <tr>" & vbcrlf & "                    <td valign=""top"">" & vbcrlf & "                         <table width=""100%"" border=""0"" cellpadding=""0""cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf &                                    "<tr>" & vbcrlf &                                             "<td class=""place"">产品添加<a id=""tabbb1"" href=""###"" onFocus=""this.blur();"">&nbsp;</a></td>" & vbcrlf &                                               "<td>&nbsp;</td>" & vbcrlf &                                          "<td align=""right"">&nbsp;</td>" & vbcrlf &                                              "<td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "                                   </tr>" & vbcrlf & "                           </table>" & vbcrlf & "                                <input type=""hidden"" name=""flag1"" id=""flag1"" value=""0"">" & vbcrlf & "                         <input type=""hidden"" name=""flag2"" id=""flag2"" value=""0"">" & vbcrlf & "                            <input type=""hidden"" name=""flag3"" id=""flag3"" value=""0"">" & vbcrlf & "                         <form method=""POST"" action=""save_list1.asp?ord="
	Response.write rd
	Response.write "&top="
	Response.write pwurl(top)
	Response.write """ onSubmit=""return CheckSelection()&&DelUnusedFilesBeforeSubmit()&&formCheck()""  name=""date"" id=""productForm"">" & vbcrlf & "                          <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                                      <tr class=""top accordion"">" & vbcrlf & "                                           <td colspan=""6"" class=""accordion-bar-bg"">" & vbcrlf & "                                                   <div  class=""accordion-bar-tit"">" & vbcrlf & "                                                          基本信息<span class=""accordion-arrow-down""></span>" & vbcrlf & "                                                        </div>" & vbcrlf & "                                                  <div class=""accordion-bar-btns"">" & vbcrlf & "                                                          <input type=""submit"" name=""Submit422222"" value=""保存""  class=""page""/>" & vbcrlf &                                                            "<input type=""submit"" name=""Submit424222"" value=""增加"" onClick=""ask2();""  class=""page""/>" & vbcrlf &                                                            "<input type=""reset"" value=""重填""  class=""page"" name=""B2222"">" & vbcrlf &                                                     "</div>" & vbcrlf & "                                          </td>" & vbcrlf & "                                   </tr>" & vbcrlf & "                                   <tr>" & vbcrlf & "                                            <td width=""11%""><div align=""right"">产品名称：</div></td>" & vbcrlf & "                                            <td colspan=""3"">" & vbcrlf & "                                                  <TEXTAREA  name=""title"" style=""float:left;OVERFLOW-Y: hidden;WIDTH: 150px;HEIGHT: 22px; WORD-BREAK: break-all"" "
	'Response.write pwurl(top)
	...
	Response.write " max=""500"" msg=""长度不能超过500个字"" id=""keyword"" onKeyUp=""keyupdeal(event);ff();keyUpChangeSize(this,event)"" onClick=""keyupdeal(event);ff();"" onMouseOver=""this.focus();"" autocomplete=""off"">"
	Response.write title
	Response.write "</TEXTAREA>"
	if CheckPurview(bt_kh,"1")=True then
		Response.write "&nbsp;<span class=""red"">*</span>"
	end if
	Response.write "&nbsp;" & vbcrlf & "" & vbcrlf & "                                                       &nbsp;&nbsp;拼音码：<input id=pym size=15 name=pym max=""100"" msg=""拼音码长度必须在1至100个字符之间"" dataType=""Limit"" value="""
	Response.write pym
	Response.write """><span id=""test1"" class=""red""></span>" & vbcrlf & "                                                        <div ID=""floater1"" style=""position: absolute; left: 121px; top: 90px; width: 293px;""><div id=""suggest""  ></div></div>" & vbcrlf & "                                         </td>" & vbcrlf & "                                           <td width=""11%""><div align=""right"">产品编号：</div></td>" & vbcrlf & "                                            <td width=""22%"">" & vbcrlf & "                                                  <div align=""left"">" & vbcrlf & "                                                                <input type=""text"" name=""order1"" size=""20"" id=""order1"" "
	...
	Response.write " max=""500"" msg=""长度不能超过500个字""  value="""
	Response.write khid
	Response.write """>" & vbcrlf & ""
	if CheckPurview(bt_kh,"2")=True then
		Response.write "" & vbcrlf & "                                                             <span class=""red"">*</span>" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "                                                             <span id=""test2"" class=""red""></span>" & vbcrlf & "                                                        </div>" & vbcrlf & "                                          </td>" & vbcrlf & "                                   </tr>" & vbcrlf & "                                   <tr>" & vbcrlf & "                                            <td width=""11%"" align=""center""><div align=""right"">产品分类：</div></td>" & vbcrlf & "                                               <td width=""22%"">" & vbcrlf & "                            <input  name=""sort1"" id=""sort1"" type=""hidden"">" & vbcrlf & "                                                    <IFRAME  id='menuclsframe'  name=""I2"" SRC=""../event/product2.asp?ID=company"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""95%"" HEIGHT=""27"" marginwidth=""1"" marginheight=""1""></IFRAME></td>" & vbcrlf & ""
	if ZBRuntime.MC(18000) then
		Response.write "" & vbcrlf & "                                             <td width=""11%""><div align=""right"">生产周期：</div></td>" & vbcrlf & "                                            <td width=""22%"">" & vbcrlf & "                                                  <input name=""num_sc"" type=""text"" size=""10""  onkeyup=""value=value.replace(/[^\d\.]/g,'')""  onpropertychange=formatData(this,""number2"")>天" & vbcrlf & "  </td>" & vbcrlf & "                                           <td width=""11%""><div align=""right"">产品型号：</div></td>" & vbcrlf & "                                            <td width=""22%"">" & vbcrlf & "                                                  <input type=""text"" name=""type1"" size=""20"" id=""type1"" "
		if CheckPurview(ts_kh,"3")=True then
			Response.write " onChange=""callServer_ts(3,'type1');"""
		end if
		Response.write " dataType=""Limit"" value="""
		Response.write type1
		Response.write """ "
		if  CheckPurview(bt_kh,"3")=True  then
			Response.write " min=""1"" "
		end if
		Response.write " max=""500"" msg=""长度不能超过500个字"">" & vbcrlf & ""
		if CheckPurview(bt_kh,"3")=True then
			Response.write "" & vbcrlf & "                                                     <span class=""red"">*</span>  "
		end if
		Response.write "<span id=""test3"" class=""red""></span>" & vbcrlf & "                                             </td>" & vbcrlf & ""
	else
		Response.write "" & vbcrlf & "                                             <td width=""11%""><div align=""right"">产品型号：</div></td>" & vbcrlf & "                                            <td width=""22%"" colspan=""3""><input type=""text"" size=""20"" name=""type1"" id=""type1"" "
		if CheckPurview(ts_kh,"3")=True then
			Response.write " onChange=""callServer_ts(3,'type1');"""
		end if
		Response.write " dataType=""Limit"" value="""
		...
		Response.write "" & vbcrlf & "                                                     <span id=""test3"" class=""red""></span>" & vbcrlf & "                                                </td>" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "                                     </tr>" & vbcrlf & "                                   <tr>" & vbcrlf & "                                            <td width=""11%""><div align=""right"">可调用范围：</div></td>" & vbcrlf & "                                          <td colspan=""5"">" & vbcrlf & "                                                  <table width=""100%""  border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "                                                                <tr class=""gray"">" & vbcrlf & "                                                                   <td>" & vbcrlf & "                                                                            <input type=""radio"" name=""allcansee"" value=""1"" checked id=""rbtn1"" onclick=""document.getElementById('tb1').style.display='none';"" /><label for=""rbtn1"">允许所有用户调用</label>" & vbcrlf & "                                                                              <input type=""radio"" name=""allcansee"" value=""0"" id=""rbtn2"" onclick=""document.getElementById('tb1').style.display='';"" /><label for=""rbtn2"">选择允许调用用户</label>" & vbcrlf & "                                                                            <span id=""ulist1"" class=""red""></span>" & vbcrlf & "                                                                       </td>" & vbcrlf & "                                                           </tr>" & vbcrlf & "                                                           <tr style=""display:none"" id=""tb1"">"& vbcrlf &                                                                     "<td>"
	sort_zjjg=2
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	if ZBRuntime.MC(18000) Then
		TimeInAdvance = 0
		Costs = 0
		Response.write "" & vbcrlf & "                                     <tr class=""top accordion"">" & vbcrlf & "                                                <td colspan=""6"" class=""accordion-bar-bg"">" & vbcrlf & "                                                   <div  class=""accordion-bar-tit"">" & vbcrlf & "                                                          策略信息<span class=""accordion-arrow-down""></span>" & vbcrlf & "                                                        </div>" & vbcrlf & "                                          </td>" & vbcrlf & "                                  </tr>" & vbcrlf & "                                   <tr>" & vbcrlf & "                                            <td height=""35"" align=""center""><div align=""right"">MRP参数设置：</div></td>" & vbcrlf & "                                            <td colspan=""8"" style=""border-right:0px;"">" & vbcrlf & "                                                  <table border=""0"" cellspacing=""0"" cellpadding=""0"" width=""100%"">" & vbcrlf & "                                                          <tr>" & vbcrlf & "                                                                    <td height=""35"" align=""left"" style=""border-right:0px;"">计划策略:" & vbcrlf & "                                                                              <select name=""M_Tactics"" id=""M_Tactics"" onpropertychange=""changeForm(this.selectedIndex)"">" & vbcrlf & "                                                                                    <option value="""">选择计划策略</option>" & vbcrlf & "                                                                                        <option value=""1"">MRP计划</option>" & vbcrlf & "                                                                                        <option value=""2"">ROP计划</option>" & vbcrlf & "                                                                                </select>" & vbcrlf & "                                                                       </td>" & vbcrlf & "                                                           </tr>" & vbcrlf & "                                                           <tr id=""MRPSetupPanel"" style=""display:none"">" & vbcrlf & "                                                                        <td id=""MRPSetup"">" & vbcrlf & "                                                                          <table border='0' cellspacing='1' cellpadding='1' width='100%'>" & vbcrlf & "                                                                                 <tr>" & vbcrlf & "                                                                                            <td height=""35"" align=""right"">主题:</td>" & vbcrlf & "                                                                                            <td width='130px' colspan=""3"" align=""left"">" & vbcrlf & "                                                                                                 <input type=""text"" name=""M_MRPTitle"" id=""M_MRPTitle"" style=""width:100px"" value="""">" & vbcrlf & "                                                                                            </td>" & vbcrlf & "                                                                                   </tr>" & vbcrlf & "                                                                                   <tr>" & vbcrlf & "                                                                                            <td height=""30"" width='100px' align='right'>批量规则:</td>" & vbcrlf & "                                                                                                <td width='130px'>"& vbcrlf &                                                                                                     "<div align=""left"">" & vbcrlf &                                                                                                                 "<select name=""M_BatchRules"" id=""M_BatchRules"" onpropertychange=""objLock2"">固定批量法</option>" & vbcrlf & "                                                                                                              <!-- <option value='3'>固定周期法</option> -->" & vbcrlf & "                                                                                                  </select>" & vbcrlf & "                                                                                               </div>" & vbcrlf & "                                                                                  </td>" & vbcrlf & "                                                                                           <td width='100px' align='right'>固定批量:</td>" & vbcrlf & "                                                                                          <td width='130px'>" & vbcrlf & "                                                                                                        <div align=""left"">" & vbcrlf & "                                                                                                                <input type=""text"" name=""M_BatNum"" style=""width:50px"" id=""M_BatNum"" onBlur=""checkNumeric(this);"" onKeyUp=""checkNumeric(this);"" value="""
		Response.write BatNum
		Response.write """>" & vbcrlf & "                                                                                                        </div>" & vbcrlf & "                                                                                          </td>" & vbcrlf & "                                                                                           <td><div></div></td>" & vbcrlf & "                                                                                    </tr>" & vbcrlf & "                                                                                   <tr>" & vbcrlf & "                                                                                            <td height=""30"" align=""right"">日需求量:</td>" & vbcrlf & "                                                                                                <td align=""left""><input type=""text"" style=""width:50px"" name=""M_NumRequest"" id=""M_NumRequest"" onBlur=""checkNumeric(this);"" onKeyUp=""checkNumeric(this);"" value="""
		Response.write NumRequest
		Response.write """></td>" & vbcrlf & "                                                                                           <td align=""right"">保证供应天数:</td>" & vbcrlf & "                                                                                              <td align=""left""><input type=""text"" style=""width:50px"" name=""M_DayProvide"" id=""M_DayProvide"" onBlur=""checkNumeric(this);"" onKeyUp=""checkNumeric(this);"" value="""
		Response.write DayProvide
		Response.write """></td>" & vbcrlf & "                                                                                           <td></td>" & vbcrlf & "                                                                                       </tr>" & vbcrlf & "                                                                                   <tr>" & vbcrlf & "                                                                                            <td height=""30"" align=""right"">订货点数量:</td>" & vbcrlf & "                                                                                              <td align=""left""><input type=""text"" style=""width:50px"" name=""M_ReorderPoint"" id=""M_ReorderPoint"" onBlur=""checkNumeric(this);"" onKeyUp=""checkNumeric(this);"" value="""
		Response.write ReorderPoint
		Response.write """></td>" & vbcrlf & "                                                                                           <td align=""right"">安全库存量:</td>" & vbcrlf & "                                                                                                <td align=""left""><input type=""text"" style=""width:50px"" name=""M_SaveNum"" id=""M_SaveNum"" onBlur=""checkNumeric(this);"" onKeyUp=""checkNumeric(this);"" value="""
		Response.write SaveNum
		Response.write """><input type=""hidden"" style=""width:50px"" name=""M_TimeInAdvance"" id=""M_TimeInAdvance"" onBlur=""checkNumeric(this);"" onKeyUp=""checkNumeric(this);"" value="""
		Response.write TimeInAdvance
		Response.write """></td>" & vbcrlf & "                                                                                           <td></td>" & vbcrlf & "                                                                                       </tr>" & vbcrlf & "                                                                                   <tr>" & vbcrlf & "                                                                                            <td height=""30"" align=""right"">单位成本:</td>" & vbcrlf & "                                                                                                <td align=""left""><input type=""text"" style=""width:50px"" onBlur=""checkNumeric(this);"" onKeyUp=""checkNumeric(this);"" name=""M_Costs"" id=""M_Costs"" value="""
		Response.write Costs
		Response.write """></td>" & vbcrlf & "                                                                                           <td align=""right"">产品损耗率:</td>" & vbcrlf & "                                                                                                <td align=""left""><input type=""text"" style=""width:50px"" name=""M_AttritionRate"" id=""M_AttritionRate"" onBlur=""checkNumeric(this);"" onKeyUp=""checkNumeric(this);"" value="""
		Response.write AttritionRate
		Response.write """>％</td>" & vbcrlf & "                                                                                         <td></td>" & vbcrlf & "                                                                                       </tr>" & vbcrlf & "                                                                                   <tr>" & vbcrlf & "                                                                                            <td height=""30"" align=""right"">产品属性:</td>" & vbcrlf & "                                                                                                <td colspan=""4"" align=""left"">" & vbcrlf & "                                                                                                       <input style='display:none' type=""checkbox"" name=""Property_Sale"" "
		if Property_Sale then Response.write " checked"
		Response.write " value=""1"" id=""property1""><label for=""property1"" style='display:none' >销售件</label>" & vbcrlf & "                                                                                                      <input style='display:none' type=""checkbox"" name=""Property_Buy"" "
		if Property_Buy then Response.write " checked"
		Response.write " value=""1"" id=""property2""><label for=""property2"" style='display:none' >外购件</label>" & vbcrlf & "                                                                                                      <input style='display:none' type=""checkbox"" name=""Property_Consume"" "
		if Property_Consume then Response.write " checked"
		Response.write " value=""1"" id=""property3""><label for=""property3"" style='display:none'>生产消耗件</label>" & vbcrlf & "                                                                                                   <input type=""checkbox"" name=""Property_Homemade"" "
		if Property_Homemade then Response.write " checked"
		Response.write " value=""1"" id=""property4""><label for=""property4"">自制件</label>" & vbcrlf & "                                                                                                    <input style='display:none' type=""checkbox"" name=""Property_Making"" "
		if Property_Making then Response.write " checked"
		Response.write " value=""1"" id=""property5""><label for=""property5"" style='display:none'>在制件</label>" & vbcrlf & "                                                                                                       <input style='display:none' type=""checkbox"" name=""Property_Virtul"" "
		if Property_Virtul then Response.write " checked"
		Response.write " value=""1"" id=""property6""><label for=""property6"" style='display:none'>虚拟件</label>" & vbcrlf & "                                                                                                       <input type=""checkbox"" name=""Property_OutHair"" "
		if Property_OutHair then Response.write " checked"
		Response.write " value=""1"" id=""property7""><label for=""property7"">委外件</label>" & vbcrlf & "                                                                                                    <span id=""PropertyPanel"" style=""color:red""></span>" & vbcrlf & "                                                                                          </td>" & vbcrlf & "                                                                                   </tr>" & vbcrlf & "                                                                   </table>" & vbcrlf & "                                                                </td>" & vbcrlf & "                                                   </tr>" & vbcrlf & "                                                </table>" & vbcrlf & "                                          </td>" & vbcrlf & "                                 </tr>" & vbcrlf & ""
	end if
	if ZBRuntime.MC(1002) then
		if ZBRuntime.MC(17000) then
			Response.write "" & vbcrlf & "                                     <tr>" & vbcrlf & "                                            <td width=""11%""><div align=""right"">库存下限：</div></td>" & vbcrlf & "                                            <td width=""22%""><input name=""aleat1"" id=""aleat1"" type=""text"" size=""15"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot('aleat1','"
			Response.write num1_dot
			Response.write "')"" onpropertychange=formatData(this,""number"")  dataType=""Limit"" min=""0"" max=""10""  msg=""长度必须在10位之内""  value="""
			Response.write aleat1
			Response.write """></td>" & vbcrlf & "                                           <td width=""11%""><div align=""right"">库存上限：</div></td>" & vbcrlf & "                                            <td width=""22%""><input name=""aleat2"" id=""aleat2"" type=""text"" size=""15"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot('aleat2','"
			Response.write num1_dot
			Response.write "')"" onpropertychange=formatData(this,""number"")  dataType=""Limit"" min=""0"" max=""10""  msg=""长度必须在10位之内""  value="""
			Response.write aleat2
			Response.write """></td>" & vbcrlf & "                                           <td width=""11%""><div align=""right"">主供应商：</div></td>" & vbcrlf & "                                            <td width=""22%""><IFRAME name=""I5"" SRC=""../event/company_gys.asp?ID=company"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""200"" HEIGHT=""27"" marginwidth=""1"" marginheight=""1""></IFRAME></td>" & vbcrlf & "                                       </tr>" & vbcrlf & ""
		else
			Response.write "" & vbcrlf & "                                     <tr>" & vbcrlf & "                                            <td width=""11%""><div align=""right"">主供应商：</div></td>" & vbcrlf & "                                            <td colspan=""5""><IFRAME name=""I5"" SRC=""../event/company_gys.asp?ID=company"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""200"" HEIGHT=""27"" marginwidth=""1"" marginheight=""1""></IFRAME></td>" & vbcrlf &                                     "</tr>" & vbcrlf
		end if
	else
		if ZBRuntime.MC(17000) then
			Response.write "" & vbcrlf & "                                     <tr>" & vbcrlf & "                                            <td width=""11%""><div align=""right"">库存下限：</div></td>" & vbcrlf & "                                            <td width=""22%""><input name=""aleat1"" id=""aleat1"" type=""text"" size=""15"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot('aleat1','"
			...
			Response.write "')"" onpropertychange=formatData(this,""number"")  dataType=""Limit"" min=""0"" max=""10""  msg=""长度必须在10位之内""  value="""
			Response.write aleat1
			Response.write """></td>" & vbcrlf & "                                           <td width=""11%""><div align=""right"">库存上限：</div></td>" & vbcrlf & "                                            <td colspan=""3""><input name=""aleat2"" id=""aleat2"" type=""text"" size=""15"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot('aleat2','"
			Response.write num1_dot
			Response.write "')""  onpropertychange=formatData(this,""number"") dataType=""Limit"" min=""0"" max=""10""  msg=""长度必须在10位之内""  value="""
			Response.write aleat2
	...
	If ZBRuntime.MC(17000) And ZBRuntime.MC(15000) And ZBRuntime.MC(17009) Then
		Dim spanNum : spanNum = 1
		Response.write "" & vbcrlf & "                                     <tr>" & vbcrlf & "                                            "
		If ZBRuntime.MC(17000) Then
			If ZBRuntime.MC(15000) = False And ZBRuntime.MC(17009) = False Then
				spanNum = 5
			end if
			Response.write "" & vbcrlf & "                                             <td><div align=""right"">失效提前期：</div></td>" & vbcrlf & "                                            <td colspan="""
			Response.write spanNum
			Response.write """>" & vbcrlf & "                                                        <input name=""RemindNum"" type=""text"" size=""15"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');"" onpropertychange=formatData(this,""number2"")  dataType=""Limit"" min=""0"" max=""15""  msg=""长度必须在15位之内"">" & vbcrlf & "                                                     <select name=""RemindUnit"" id=""RemindUnit"">" & vbcrlf & "                                                              <option value=""1"">小时</option>" & vbcrlf & "<option value=""2"" selected>天</option>" & vbcrlf & "                                                            <option value=""3"">周</option>" & vbcrlf & "                                                             <option value=""4"">月</option>" & vbcrlf & "                                                             <option value=""5"">年</option>" & vbcrlf & "                                                     </select>" & vbcrlf & "                                                </td>" & vbcrlf & "                                           "
		end if
		If ZBRuntime.MC(17009) Then
			spanNum = 1
			If ZBRuntime.MC(15000) = False And ZBRuntime.MC(17000) = True Then
				spanNum = 3
			end if
			If ZBRuntime.MC(15000) = False And ZBRuntime.MC(17000) = False Then
				spanNum = 5
			end if
			Response.write "" & vbcrlf & "                                             <td><div align=""right""> "
			If ZBRuntime.MC(17009) Then Response.write "养护周期："
			Response.write "</div></td>" & vbcrlf & "                                          <td colspan="""
			Response.write spanNum
			Response.write """>"
			If ZBRuntime.MC(17009) Then
				Response.write "<input name=""MaintainNum"" type=""text"" size=""15"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');"" onpropertychange=formatData(this,""number2"")  dataType=""Limit"" min=""0"" max=""15""  msg=""长度必须在15位之内"">" & vbcrlf & "                                                <select name=""MaintainUnit"" id=""MaintainUnit"">" & vbcrlf & "      <option value=""1"">小时</option>" & vbcrlf & "                                                           <option value=""2"" selected>天</option>" & vbcrlf & "                                                            <option value=""3"">周</option>" & vbcrlf & "                                                             <option value=""4"">月</option>" & vbcrlf & "                                                             <option value=""5"">年</option>" & vbcrlf & "                                                     </select>" & vbcrlf & "       "
			end if
			Response.write " </td>" & vbcrlf & "                                               "
		end if
		If ZBRuntime.MC(15000) Then
			spanNum = 1
			If ZBRuntime.MC(17009) = False Or ZBRuntime.MC(17000) = False Then
				spanNum = 3
			end if
			If ZBRuntime.MC(17009) = False And ZBRuntime.MC(17000) = False Then
				spanNum = 5
			end if
			Response.write "" & vbcrlf & "                                             <td><div align=""right"">"
			If ZBRuntime.MC(15000) Then Response.write "预计销售周期: "
			Response.write "</div></td>" & vbcrlf & "                                          <td colspan="""
			Response.write spanNum
			Response.write """>"
			If ZBRuntime.MC(15000) Then
				Response.write "<input name=""period"" type=""text"" size=""15"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');"" onpropertychange=formatData(this,""number2"")  dataType=""Limit"" min=""0"" max=""10""  msg=""长度必须在10位之内""  value=""3.5""> 月"
			end if
			Response.write "</td>" & vbcrlf & "                                                "
		end if
		Response.write "" & vbcrlf & "                                     </tr>" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "                                     <tr>" & vbcrlf & "                                            <td height=""35"" align=""center""><div align=""right"">质检方案：</div></td>" & vbcrlf & "                                               <td colspan=""5""><select name=""QC_id"" id=""QC_id"">" & vbcrlf & "                                              <option value=""0"">            </option>" & vbcrlf & "                                           "
	set rs=server.CreateObject("adodb.recordset")
	...
	If isUsingExtend(21) Then
		Response.write "" & vbcrlf & "             <tr class=""top accordion"">" & vbcrlf & "                        <td colspan=""6"" class=""accordion-bar-bg"">" & vbcrlf & "                           <div  class=""accordion-bar-tit"">" & vbcrlf & "                                  扩展信息<span class=""accordion-arrow-down""></span>" & vbcrlf & "                                </div>" & vbcrlf & "                  </td>" & vbcrlf & "           </tr>" & vbcrlf & ""
	end if
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=21 and set_open=1 order by gate1 asc "
	rs.open sql,conn,1,1
	num1=rs.RecordCount
	i_jm=0
	j_jm=1
	if rs.eof then
		...
		do until rs.eof
			...
			if rs("sort")=2 then
				...
				'Response.write rs("name")
				Response.write """ "
				if CheckPurview(ts_kh,rs("name"))=True then
					Response.write "onChange=""callServer_ts('"
				...
				Response.write " dataType=""Limit""  max=""200""  msg=""长度不能超过200个字"" "
				if  CheckPurview(bt_kh,rs("name"))=True  then
					Response.write " min=""1"" "
				end if
				Response.write ">" & vbcrlf & "                                                    <span id=""test"
				Response.write rs("id")
			...
			elseif rs("sort")=1 then
				...
				Response.write " id="""
				Response.write rs("name")
				Response.write """ dataType=""Limit"" max=""50"" msg=""长度不能超过50个字""  "
				if  CheckPurview(bt_kh,rs("name"))=True  then
					Response.write " min=""1"" "
				end if
				Response.write ">" & vbcrlf & ""
				...
				rs7.close
				set rs7=nothing
				Response.write "" & vbcrlf & "                                                     </select>" & vbcrlf & "                                                       <span id=""test"
				Response.write rs("id")
				Response.write """ class=""red""></span>" & vbcrlf & ""
			end if
			if CheckPurview(bt_kh,rs("name"))=True then
	...
	rs.close
	set rs=nothing
	Response.write getExtended(21,0)
	If ZBRuntime.MC(19000) Then
		Response.write "" & vbcrlf & "                                     <tr class=""top accordion"">" & vbcrlf & "                                                <td colspan=""6"" class=""accordion-bar-bg"">" & vbcrlf & "                                                   <div  class=""accordion-bar-tit"">" & vbcrlf & "                                                          价格信息<span class=""accordion-arrow-down""></span>" & vbcrlf & "                                                        </div>" & vbcrlf & "                                          </td>" & vbcrlf & "                                  </tr>" & vbcrlf & "                                   <tr>" & vbcrlf & "                                            <td>" & vbcrlf & "                                                    <div align=""right"">是否含税：</div>" & vbcrlf & "                                               </td>" & vbcrlf & "                                           <td>" & vbcrlf & "                                                    <input type=""radio"" name=""includeTax"" id=""includeTax1"" value=""1""><label for=""includeTax1"">含税</label>"& vbcrlf & "                                                      <input type=""radio"" name=""includeTax"" id=""includeTax2"" checked value=""0""><label for=""includeTax2"">不含税</label>" & vbcrlf & "                                          </td>" & vbcrlf & "                                           <td>" & vbcrlf & "                                                    <div align=""right"">可开具票据类型：</div>" & vbcrlf & "                                         </td>" & vbcrlf & "                                           <td "
		If sdk.power.ExistsModel(17001)=false or sdk.power.ExistsModel(17003)=false Then
		...
		While rsConfig.eof = False
			...
			Response.write rsConfig("id")
			Response.write """><label for=""invoiceConfig_"
			Response.write rsConfig("id")
			Response.write """>"
		...
		Response.write "" & vbcrlf & "                                             </td>" & vbcrlf & "                                           "
		If sdk.power.ExistsModel(17001) and sdk.power.ExistsModel(17003) Then
			Response.write "" & vbcrlf & "                                                     <td><div align=""right"">计价方式：</div></td>" & vbcrlf & "                                                      <td style=""padding-right:5px;"">" & vbcrlf & "                                                           <select name=""priceMode"" id=""priceMode"">" & vbcrlf & "                                                            <option value=0 >先进先出法</option>" & vbcrlf & "                                <option value=3 >移动加权平均法</option>" & vbcrlf & "                                                         <option value=1 >个别计价法</option>" & vbcrlf & "                                                            <option value=2 >全月平均法</option>" & vbcrlf & "                                                            </select>" & vbcrlf & "                                                       </td>" & vbcrlf & "                                           "
		end if
		Response.write "" & vbcrlf & "                                     </tr>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "                                   <tr>" & vbcrlf & "                                            <td width=""11%""><div align=""right"">基本单位：</div></td>" & vbcrlf & "                                            <td width=""19%""><span id=""trpx_unit1"">" & vbcrlf & "                                                      <select name=""unit"" id=""unit1"" onChange=""callServer2()"";  dataType=""Limit"" min=""1"" max=""100"" msg=""请选择基本单位"">" & vbcrlf & "                                                         <option value=""""></option>" & vbcrlf & ""
		set rs2=server.CreateObject("adodb.recordset")
		sql2="select ord,sort1 from sortonehy where gate2=61  and isNull(isStop,0)=0 order by gate1 desc"
		...
		rs2.close
		set rs2=nothing
		Response.write "" & vbcrlf & "                                                       </select>" & vbcrlf & "                                                       <font color=""#FF0000"">*</font></span></td>" & vbcrlf & "                                                        <td width=""11%""><div align=""right"">"
		if sort2="3" then
			Response.write "提成比例："
		end if
		Response.write "</div></td>" & vbcrlf & "                                                   <td width=""22%"">"
		if sort2="3" then
			Response.write "<input name=""num_tc"" type=""text"" size=""15"" onKeyUp=""value=value.replace(/[^\d\.]/g,'')""   dataType=""Limit"" onpropertychange=formatData(this,""number"") min=""0"" max=""10""  msg=""长度必须在10位之内""  value="""
			Response.write num_tc
			Response.write """>" & vbcrlf & "                                                         %"
		end if
		Response.write "" & vbcrlf & "                                                      </td>" & vbcrlf & "                                                   <td width=""9%"">" & vbcrlf & "                                                   <div align=""right"">"
		If ZBRuntime.MC(17003) Then
			Response.write "产品属性："
		end if
		Response.write "</div>" & vbcrlf & "                                                </td>" & vbcrlf & "                                           <td width=""31%"">" & vbcrlf & "                                                  "
		If ZBRuntime.MC(17003) Then
			Response.write "" & vbcrlf & "                                                      <input type=""radio"" name=""canOutStore"" id=""canOutStore2"" checked value=""1""><label for=""canOutStore2"">实体</label>" & vbcrlf & "                                                 <input type=""radio"" name=""canOutStore"" id=""canOutStore1"" value=""0""><label for=""canOutStore1"">虚拟</label>" & vbcrlf & "                         <span>(注：虚拟产品不会参与出入库)</span>" & vbcrlf & "                                                       "
		end if
		Response.write "" & vbcrlf & "                                              </td>" & vbcrlf & "                                           </tr>" & vbcrlf & "                                           <tr>" & vbcrlf & "                                                    <td width=""11%""><div align=""right"">辅助单位：</div></td>" & vbcrlf & "                                                    <td colspan=""5""><span id=""trpx_unit2"">" & vbcrlf & ""
		session("num_click2009cp")=0
		Session("unitallList")=0
		sql="Delete  mxpxcp Where cateid="&session("personzbintel2007")&" "
		conn.Execute(sql)
		set rs=server.CreateObject("adodb.recordset")
		sql="select ord,sort1 from sortonehy where gate2=61 and isNull(isStop,0)=0 and ord not in ("&unitallList&") order by gate1 desc "
		rs.open sql,conn,1,1
		if rs.eof then
		else
			do until rs.eof
				Response.write("&nbsp;<input type='checkbox' name='unitall' id='unitall2' value='"&rs("ord")&"' onclick=callServer4('"&rs("ord")&"');controlBorder();>"&rs("sort1")&"")
				rs.movenext
			loop
		end if
		rs.close
		set rs=nothing
		Response.write "" & vbcrlf & "                                                              </span>" & vbcrlf & "                                                 </td>" & vbcrlf & "                                           </tr>" & vbcrlf & "                                           <tr>" & vbcrlf & "                                                    <td width=""11%"" align=""right""><div id=""idv_div"" align=""right"">价格策略：</div></td>" & vbcrlf & "                                                     <td colspan=""5"" valign=""top"">" & vbcrlf & "                                                               <div style=""overflow-x:auto;width:600px;"" id=""celue_div"">" & vbcrlf & ""
		'set rs=nothing
		set rs7=server.CreateObject("adodb.recordset")
...
'if proStore=1 then
		...
		Response.write colLen*80+170
		Response.write """ border=""0"" cellpadding=""3"" style=""table-layout:fixed;word-break:break-all;word-wrap:break-word;border-collapse:collapse;"">" & vbcrlf & "                                                                                     <tr class=""top"" style=""border-top:1px solid #ccc"">" & vbcrlf & "                                                                                          <td width=""50"" style='border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">单位</div></td>" & vbcrlf & "                                                                                                <td width=""60"" style='border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">单位比例</div></td>" & vbcrlf & "                                                                                             <td  width=""70"" style='border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">部门</div></td>" & vbcrlf & ""
		if proStore=1 then
			Response.write "" & vbcrlf & "                                                                                              <td width=""70"" style='border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">主仓库</div></td>" & vbcrlf & "                                                                                           <td width=""70"" style='border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">仓库容量</div></td>" & vbcrlf & "                                                                                          <td width=""50"" style='border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">辅仓库</div></td>" & vbcrlf & ""
'if proStore=1 then
		end if
		Response.write "" & vbcrlf & "                                                                                              <td width=""70"" style='border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">条形码</div></td>" & vbcrlf & "                                                                                           <td width=""70"" style='"
'if proStore=1 then
		Response.write strDisplay21_21
		Response.write ";border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">建议进价</div></td>" & vbcrlf & "                                                                                          <td width=""70"" style='"
		Response.write strDisplay21_21
		Response.write strDisplay21_21
		Response.write ";border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">最高进价</div></td>" & vbcrlf & "                                                                                          <td width=""70"" style='"
		Response.write strDisplay21_21
		Response.write strDisplay21_22
		Response.write ";border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">建议售价</div></td>" & vbcrlf & "                                                                                          <td width=""70"" style='"
		'Response.write strDisplay21_22
		Response.write strDisplay21_22
		Response.write ";border-bottom:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;padding:3px!important;line-height:35px;'><div align=""center"">最低售价</div></td>" & vbcrlf & ""
		Response.write strDisplay21_22
		do until rs7.eof
...
'for i=1 to 100
	...
	Response.write "" & vbcrlf & "" & vbcrlf & "<tr class=""top accordion"">" & vbcrlf & "<td colspan=""6"" class=""accordion-bar-bg"">" & vbcrlf & "<div  class=""accordion-bar-tit"">图片信息<span class=""accordion-arrow-down""></span></div>" & vbcrlf & "                                            </td>" & vbcrlf & "                                   </tr>" & vbcrlf & "                                        <tr>" & vbcrlf & "                                            <td width=""10%"" align=""right"" height=""27"">产品图片：</td>" & vbcrlf & "                                             <td colspan=""6"">" & vbcrlf & "                                                  <div class=""multimage-gallery"">" & vbcrlf & "                                                           <input type=""hidden"" id=""primaryImg"" name=""primaryImg"" value="""
...
'For i = 1 To 6
	...
	next
	Response.write "" & vbcrlf & "                                                             </ul>" & vbcrlf & "                                                           <div style=""clear:both;""></div>" & vbcrlf & "                                                   <table id=""atttb"" border=""0"" cellspacing=""1"" cellpadding=""0"" bgcolor=""#C0CCDD"" style=""display:none;"">" & vbcrlf & "" & vbcrlf & "                                                       </table>                                                " & vbcrlf & "" & vbcrlf & "        </div>" & vbcrlf & "" & vbcrlf & "                                                  <span style=""cursor:hand"" onClick=""showUploadForm(this);""><div style=""vertical-align:middle;float:left""><img src='../images/smico/3.gif'/></div><div id=""addImgBtn"" style=""padding-top:3px;"">添加图片</div>" & vbcrlf & "                                               </td>" & vbcrlf & "                                   </tr>" & vbcrlf & "" & vbcrlf & "                                               <tr class=""top accordion"">" & vbcrlf & "                                                        <td colspan=""6"" class=""accordion-bar-bg"">" & vbcrlf & "                                                           <div  class=""accordion-bar-tit"">" & vbcrlf & "                                                                  概要信息<span class=""accordion-arrow-down""></span>" & vbcrlf & "                                                                </div>" & vbcrlf &"                                                 </td>" & vbcrlf & "                                           </tr>" & vbcrlf & "                                           <tr>" & vbcrlf & "                                                    <td width=""11%""><div align=""right"">产品说明：</div></td>" & vbcrlf & "                                                    <td colspan=""5"">" & vbcrlf & "                                                          <span class=""gray"">" & vbcrlf & "                                                                       <textarea name=""intro1"" cols=""80"" rows=""6"" dataType=""Limit"" min=""0"" max=""3000""  msg=""产品说明必须在3000个字之内"">"
	Response.write intro1
	Response.write "</textarea>" & vbcrlf & "                                                          </span>" & vbcrlf & "                                                 </td>" & vbcrlf & "                                           </tr>" & vbcrlf & "                                           <tr>" & vbcrlf & "                                                    <td width=""11%""><div align=""right"">产品参数：</div></td>" & vbcrlf & "                                                    <td colspan=""5"">" & vbcrlf & "                                                          <span class=""gray"">" & vbcrlf & "                                                       <textarea name=""intro2"" cols=""80"" rows=""6"" dataType=""Limit"" min=""0"" max=""3000""  msg=""产品参数必须在3000个字之内"">"
	Response.write intro2
	Response.write "</textarea>" & vbcrlf & "                                                          </span>" & vbcrlf & "                                                 </td>" & vbcrlf & "                                           </tr>" & vbcrlf & "                                           <tr>" & vbcrlf & "                                                    <td width=""11%""><div align=""right"">图片与附件：</div></td>" & vbcrlf & "                                                  <td colspan=""5"">" & vbcrlf & "                                                          <span class=""gray"">" & vbcrlf & "                                               <textarea name=""intro3"" style=""display:none"" cols=""1"" rows=""1"">"
