...
'if isnull(values) then IsTime = null : exit function
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "" & vbcrlf & "function ask1()" & vbcrlf & "{" & vbcrlf & "       " & vbcrlf & "        return true;" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & " margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "img{" & vbcrlf & "border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
	set ml=new myClass
	ord=request("ord")
	...
	set rs=conn.execute(sql)
	if not rs.eof then
		Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">图书修改</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf &      "     </tr> "& vbcrlf &  "     </table> "  & vbcrlf &       " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""> "& vbcrlf &        "<form action=""SaveUpdate_bookData.asp?ord="
		Response.write ord
		Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)&&ask1()"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" ><div align=""left""><strong>基本信息</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf& "                  <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "              <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "               </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "    <td width=""13%"" height=""27""><div align=""right"">书名：</div></td>" & vbcrlf & "     <td colspan=""5"" class=""gray""><input name=""bk_name"" type=""text"" id=""bk_name"" value="""
		Response.write rs("bk_name")
		Response.write """ size=""30"" maxlength=""1000"" dataType=""Limit""  min=""1"" max=""200"" msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        </tr>" & vbcrlf & "     <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">编号：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray""><input name=""bk_bh"" type=""text"" id=""bk_bh"" size=""20"" value="""
		Response.write rs("bk_bh")
		Response.write """ maxlength=""500""></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">分类：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><select name=""bk_type"" id=""bk_type"" dataType=""Limit""  min=""1"" max=""200"" msg=""必填"">" & vbcrlf & "          "
		...
		if not rs7.eof then
			do while not rs7.eof
				...
				Response.write """ "
				if rs7("id")=rs("bk_type") then Response.write "selected"
				Response.write ">"
		...
		set rs7=nothing
		Response.write "" & vbcrlf & "        </select>&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">借阅周期：</div></td>" & vbcrlf & "                <td width=""24%"" class=""gray"">" & vbcrlf & "               <select name=""bk_returnnum"">" & vbcrlf & "                    "
		for i=1 to 12
			Response.write "" & vbcrlf & "                      <option value="""
			Response.write i
			Response.write """ "
			if i=rs("bk_returnnum") then Response.write "selected"
			Response.write ">"
			Response.write i
			Response.write "个月</option>" & vbcrlf & "                 "
		next
		Response.write "" & vbcrlf & "                </select>" & vbcrlf & "               </td>" & vbcrlf & "      </tr>" & vbcrlf & "        <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">作者：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray""><input name=""bk_auther"" type=""text"" value="""
		Response.write rs("bk_auther")
		Response.write """ id=""bk_auther"" size=""20"" maxlength=""500""></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">出版时间：</div></td>" & vbcrlf & "        <td colspan=""3"" class=""gray""><input name=""bk_pubtime"" type=""text"" value="""
		Response.write rs("bk_pubtime")
		Response.write """ size=""9"" id=""daysOfMonthPosy"" onmouseup=toggleDatePicker(""daysOfMonthy"",""date.bk_pubtime"") readonly=""true"">" & vbcrlf & "          <DIV id=daysOfMonthy style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "        </tr>" & vbcrlf & "       <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">出版社：</div></td> "& vbcrlf &        "  <td colspan=""5"" class=""gray""><input name=""bk_publishing"" type=""text"" value="""
		Response.write rs("bk_publishing")
		Response.write """ id=""bk_publishing"" size=""30"" maxlength=""500""></td>" & vbcrlf & "        </tr>" & vbcrlf & "          <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">版次：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray""><input name=""bk_pubnum"" type=""text"" id=""bk_pubnum"" value="""
		Response.write rs("bk_pubnum")
		Response.write """ size=""15"" maxlength=""500"" max=""200""></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">页数：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray"">" & vbcrlf & "                     <input name=""bk_pagenum"" type=""text"" id=""bk_pagenum"" size=""10"" value="""
		Response.write rs("bk_pagenum")
		Response.write """ onkeyup=""value=value.replace(/[^\d]/g,'')"" dataType=""Limit"" min=""0"" max=""5"" msg=""请输入正确数字"" onpropertychange ='if(event.propertyName==""value""){formatData(this,""number"");}' maxlength=5></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">字数：</div></td>" & vbcrlf & "     <td width=""24%"" class=""gray""><input name=""bk_pagesize"" type=""text"" id=""bk_pagesize"" value="""
		Response.write rs("bk_pagesize")
		Response.write """ size=""10"" maxlength=""20"" onkeyup=""value=value.replace(/[^\d]/g,'')""></td>" & vbcrlf & "        </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">印刷时间：</div></td>" & vbcrlf & "          <td width=""20%"" class=""gray""><input name=""bk_printtime"" type=""text"" value="""
		Response.write rs("bk_printtime")
		Response.write """ size=""9"" id=""daysOfMonthPosz"" onmouseup=toggleDatePicker(""daysOfMonthz"",""date.bk_printtime"") readonly=""true""><DIV id=daysOfMonthz style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">开本：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input name=""bk_format"" type=""text"" value="""
		Response.write rs("bk_format")
		Response.write """ id=""bk_format"" size=""10"" maxlength=""100"" ></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">纸张：</div></td>" & vbcrlf & "                <td width=""24%"" class=""gray""><input name=""bk_paper"" type=""text"" value="""
		Response.write rs("bk_paper")
		Response.write """ id=""bk_paper"" size=""10"" maxlength=""50""></td>" & vbcrlf & "     </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">印次：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray""><input name=""bk_printnum"" type=""text"" value="""
		Response.write rs("bk_printnum")
		Response.write """ id=""bk_printnum"" size=""10"" maxlength=""100""></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">ISBN：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input name=""bk_ISBN"" type=""text"" id=""bk_ISBN"" value="""
		Response.write rs("bk_ISBN")
		Response.write """ size=""20"" maxlength=""500""></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">装帧：</div></td>" & vbcrlf & "              <td width=""24%"" class=""gray""><input name=""bk_binding"" type=""text"" id=""bk_binding"" value="""
		Response.write rs("bk_binding")
		Response.write """ size=""20"" maxlength=""500""></td>" & vbcrlf & "        </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">单价：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray""><input name=""bk_price"" type=""text"" id=""bk_price"" value="""
		Response.write Formatnumber(zbcdbl(rs("bk_price")),CommPrice_dot_num,true,0,0)
		Response.write """ size=""10"" maxlength=""20"" onKeyUp=""value=value.replace(/[^\d*|\.]/g,'');checkDot('bk_price','"
		Response.write CommPrice_dot_num
		Response.write "')"" onpropertychange=""sum('bk_price','bk_num','bk_allmoney');""></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">数量：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input name=""bk_num"" type=""text"" id=""bk_num"" value="""
		Response.write rs("bk_num")
		Response.write """ size=""10"" maxlength=""20"" onkeyup=""value=value.replace(/[^\d]/g,'')"" onpropertychange=""sum('bk_price','bk_num','bk_allmoney')""></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">总价：</div></td>" & vbcrlf & "             <td width=""24%"" class=""gray""><input name=""bk_allmoney"" type=""text"" id=""bk_allmoney"" value="""
		Response.write Formatnumber(zbcdbl(rs("bk_allmoney")),num_dot_xs,true,0,0)
		Response.write """ size=""10"" maxlength=""20"" onKeyUp=""value=value.replace(/[^\d*|\.]/g,'');checkDot('bk_price','"
		Response.write num_dot_xs
		Response.write "')"" readonly=""true""></td>" & vbcrlf & "     </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">存放位置：</div></td>" & vbcrlf & "          <td colspan=""5"" class=""gray""><input name=""bk_postion"" type=""text"" id=""bk_postion"" value="""
		Response.write rs("bk_postion")
		Response.write """ size=""30"" maxlength=""500""></td>" & vbcrlf & "         </tr>         " & vbcrlf & "        <tr>" & vbcrlf & "            <td><p align=""right"">图书备注：</td>" & vbcrlf & "              <td colspan=""5"" class=""gray""><textarea name=""bk_note"" style=""display:none"" cols=""1"" rows=""1"">"
		Response.write rs("bk_note")
		Response.write "</textarea>" & vbcrlf & "          <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=bk_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "            </tr> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray"">" & vbcrlf & "                 <div align=""center"">" & vbcrlf & "                        <input type=""submit"" name=""Submit42"" value=""保存"" class=""page""/>" & vbcrlf & "                        <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "               </div></td>" & vbcrlf & "     </tr> " & vbcrlf & "         </form>" & vbcrlf & "    </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "               </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	else
		Response.write "<script>alert('记录不存在或已删除');history.back();</script>"
	end if
	action1="图书修改"
	call close_list(1)
