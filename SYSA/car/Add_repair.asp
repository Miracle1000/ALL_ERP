...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/cr_Add_repair.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "       margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "img{" & vbcrlf & "border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	set ml=new myClass
	...
	if car_id="" or isnull(car_id) then
		...
		sql7="select * from O_carData where car_id="&car_id
		set rs7=conn.execute(sql7)
		if not rs7.eof then
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">维护添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf &           "</tr>" & vbcrlf &      "</table>"   & vbcrlf &         "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf &        "<form action=""Save_repair.asp"" method=""POST"" name=""demo""id=""demo"" onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td width=""13%"" height=""27"" ><img src=""../images/jiantou.gif""><a href=""javascript:void(0);"" onClick=""setHidden('tr','table_tr');"">基本明细</a></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf &             "<div align=""right"">" & vbcrlf &                   "           <input type=""submit"" name=""Submit424"" value=""保存"" class=""anybutton2""/>" & vbcrlf &   "                      <input type=""reset"" value=""重填"" class=""anybutton2"" name=""B22"">" & vbcrlf &              "</div></td>" & vbcrlf &   "     </tr>"& vbcrlf & "         <tr name=""table_tr"">" & vbcrlf & "        <td width=""13%"" height=""27""><div align=""right"">车牌号：</div></td>" & vbcrlf & "            <td width=""20%"" class=""gray""><input name=""rep_carname"" type=""text"" "
	if car_name="点击选择车牌号" then
		Response.write "style=""color:#CCCCCC;"""
	end if
	Response.write " id=""rep_carname"" readonly=""true"" value="""
	Response.write car_name
	Response.write """ size=""15"" maxlength=""20"" max=""200"" onClick=""javascript:window.open('../search/search_person5.asp?name1=rep_carname&id=rep_carid','neww37win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');""><input type=""hidden"" value="""
	Response.write car_name
	Response.write car_id
	Response.write """ name=""rep_carid"" id=""rep_carid"" style=""width:0px;height:0px;"" dataType=""Limit""  min=""1"" max=""200"" msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">经办人员：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input type=""text"" name=""rep_catename"" style=""color:#CCCCCC;"" value=""点击选择人员"" readonly=""true"" id=""rep_catename"" size=""12"" onClick=""javascript:window.open('../search/search_person1.asp?parse1=rep_catename&parse2=rep_cateid','neww37win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');""><input type=""hidden"" name=""rep_cateid"" id=""rep_cateid"" style=""width:0px;height:0px;"" dataType=""Limit""  min=""1"" max=""200"" msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">维护日期：</div></td>" & vbcrlf & "                 <td width=""24%"" class=""gray""><span class=""red"">" & vbcrlf & "                     <input type=""text"" name=""rep_time"" id=""rep_time"" Class=""DatePick""  onclick=""datedlg.show();"" readonly=""readonly"">" & vbcrlf & "             </span></td>" & vbcrlf & "      </tr>" & vbcrlf & "         <tr name=""table_tr"">" & vbcrlf & "        <td width=""13%"" height=""27""><div align=""right"">维护类型：</div></td>" & vbcrlf & "          <td width=""20%"" class=""gray"">" & vbcrlf & "           <select name=""rep_type"" id=""rep_type"" dataType=""Limit""  min=""1"" max=""200"" msg=""必填"">" & vbcrlf & "               "
	sql7="select * from O_carSet where setType=4 order by setsort desc"
	set rs7=conn.execute(sql7)
	if not rs7.eof then
	...
	set rs7=nothing
	Response.write "" & vbcrlf & "        </select>&nbsp;<span class=""red"">*</span>" & vbcrlf & "               </td>" & vbcrlf & "        <td width=""13%""><div align=""right"">维护费用：</div></td>" & vbcrlf & "        <td colspan=""3"" class=""gray""><input name=""rep_money"" type=""text"" id=""rep_money"" onpropertychange=""formatData(this,'money');"" onKeyUp=""checkDot('rep_money','"""
	Response.write num_dot_xs
	Response.write "')"" size=""12"" maxlength=""200"" min=""1"" dataType=""Limit"" max=""9999999999.99""></td>" & vbcrlf & "        </tr>" & vbcrlf & "          <tr name=""table_tr"">" & vbcrlf & "        <td><div align=""right"">维护原因：</div></td>" & vbcrlf & "      <td colspan=""5"" class=""gray""><input name=""rep_reason"" type=""text"" id=""rep_reason"" size=""40"" ></td>" & vbcrlf &         "</tr>" & vbcrlf &                "<tr>" & vbcrlf &             "  <td width=""13%""><p align=""right"">维护备注：</td>"& vbcrlf &             "<td colspan=""5"" class=""gray""><textarea name=""rep_note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "          <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=rep_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "           </tr> " & vbcrlf & "      <tr>" & vbcrlf & "    <td colspan=""6"" class=""gray"">" & vbcrlf & "                        <div align=""center"">" & vbcrlf & "                        <input type=""submit"" name=""Submit42"" value=""保存"" class=""anybutton2""/>" & vbcrlf & "                          <input type=""reset"" value=""重填"" class=""anybutton2"" name=""B2"">" & vbcrlf & "                 </div></td>" & vbcrlf & "</tr> " & vbcrlf & "         </form>" & vbcrlf & "    </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "                </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""ddd"" class=""easyui-dialog"" icon=""icon-search"" title=""选择车辆""  style=""width:800px;height:500px;padding:5px;background:#fafafa;top:0px"" closed=""true"" >" & vbcrlf & "    <div region=""center"" border=""false"" style=""padding:10px;background:#fff;border:1px solid #ccc;width:100%"">" & vbcrlf & "            <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""  style=""word-break:break-all;word-wrap:break-word;""> " & vbcrlf & "                  <tr>" & vbcrlf & "                            <td height=""27""><div align=""center""><strong>车牌号</strong></div></td>" & vbcrlf & "                              <td height=""27""><div align=""center""><strong>车辆名称</strong></div></td>" & vbcrlf & "                            <td height=""27""><div align=""center""><strong>车辆型号</strong></div></td>" & vbcrlf & "                              <td height=""27""><div align=""center""><strong>发动机号</strong></div></td>" & vbcrlf & "                            <td height=""27""><div align=""center""><strong>底盘号</strong></div></td>" & vbcrlf & "                              <td height=""27""><div align=""center""><strong>车辆类型</strong></div></td>    " & vbcrlf & "                                <td height=""27""><div align=""center""><strong>当前状态</strong></div></td>      " & vbcrlf & "                        </tr>" & vbcrlf & "                   "
	sql7="select * from O_carData where car_state<>3 "&list
	set rs7=conn.execute(sql7)
	if not rs7.eof then
		do while not rs7.eof
			car_type=rs7("car_type")
			if car_type="" or isnull(car_type) then car_type=0
			sql8="select * from O_carSet where setType=2 and id="&car_type
			set rs8=conn.execute(sql8)
			if not rs8.eof then
				car_type=rs8("setName")
			end if
			set rs8=nothing
			Response.write "" & vbcrlf & "                     <tr>" & vbcrlf & "                            <td height=""27""><div align=""center""><a href=""javascript:void(0)"" onClick=""setcarid('"" "
			Response.write rs7("car_id")
			Response.write "','"
			Response.write ml.Dep(rs7("car_code"))
			Response.write "')""><font color=""#FF0000"">√</font></a>"
			...
			Response.write "</div></td>" & vbcrlf & "                          <td height=""27""><div align=""center"">"
			Response.write car_type
			Response.write "</div></td>" & vbcrlf & "                          <td height=""27""><div align=""center"">"
			if rs7("car_state")="1" then
				Response.write "正常"
			elseif rs7("car_state")="2" then
				Response.write "维护"
			elseif rs7("car_state")="3" then
				Response.write "报废"
			elseif rs7("car_state")="4" then
				Response.write "停用"
			end if
	...
	set rs7=nothing
	Response.write "" & vbcrlf & "             </table>" & vbcrlf & "        </div>" & vbcrlf & "  <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "            <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$('#ddd').window('close');"">关闭</a>" & vbcrlf & " </div>" & vbcrlf & "</div>" & vbcrlf & ""
	action1="车辆维护添加"
	call close_list(1)
