...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	Response.write "               " & vbcrlf & "<table width=""100%"" border=""1"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#CCC"" bordercolor=""#CCC"" id=""content"" style=""border-color:#CCC"">" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='#efefef'"">" & vbcrlf & "<td colspan=""2""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=""superSearch(2)""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td></tr>" & vbcrlf & "<tr><td><div align=""right"">项目分类：</div></td>" & vbcrlf & "        <td>"
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "      </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">项目状态：</div></td>" & vbcrlf & "      <td>"
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "  </tr>" & vbcrlf & " <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">项目阶段：</div></td>" & vbcrlf & "      <td>"
	set rs=server.CreateObject("adodb.recordset")
	sql="select ord,sort1 from sortjh2 order by gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "  </tr>" & vbcrlf & "     <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">项目来源：</div></td>" & vbcrlf & "      <td>"
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "  </tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">项目地区：</div></td>" & vbcrlf & "<td>"
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">人员选择：</div></td>" & vbcrlf & "<td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">项目关键字：</div></td>" & vbcrlf & "<td>" & vbcrlf & "  <select name=""B2"">" & vbcrlf & "    <option value=""xmzt"">项目主题</option>" & vbcrlf & "    <option value=""xmbh"">项目编号</option>" & vbcrlf & "    <option value=""xmgy"">项目概要</option>" & vbcrlf & "      "
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "  </select>" & vbcrlf & "  <input name=""C2"" type=""text"" size=""15""></td></tr>" & vbcrlf & ""
	If ZBRuntime.MC(203103) Then call Show_Search_Extended(3)
	Dim arrShow()
	Dim arrName()
	...
	Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">发现日期：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=ret3 size=9  id=daysOfMonth3Pos onmouseup=toggleDatePicker(""daysOfMonth3"",""date.ret3"")value="""
	Response.write m3
	Response.write """ readonly><DIV id=daysOfMonth3 style=""POSITION: absolute;z-index:10""></DIV>" & vbcrlf & "&nbsp;至：<INPUT name=ret4 size=9  id=daysOfMonth4Pos onmouseup=toggleDatePicker(""daysOfMonth4"",""date.ret4"") value="""
	Response.write m3
	Response.write m4
	Response.write """ readonly><DIV id=daysOfMonth4 style=""POSITION: absolute""></DIV></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">预计成单日期：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=ret5 size=9  id=daysOfMonth5Pos onmouseup=toggleDatePicker(""daysOfMonth5"",""date.ret5"") value="""
	Response.write m5
	Response.write """ readonly><DIV id=daysOfMonth5 style=""POSITION: absolute;z-index:10""></DIV>" & vbcrlf & "&nbsp;至：<INPUT name=ret6 size=9  id=daysOfMonth6Pos onmouseup=toggleDatePicker(""daysOfMonth6"",""date.ret6"") value="""
	Response.write m5
	Response.write m6
	Response.write """ readonly><DIV id=daysOfMonth6 style=""POSITION: absolute""></DIV></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">添加日期：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=ret size=9  id=daysOfMonthPos onmouseup=toggleDatePicker(""daysOfMonth"",""date.ret"") value="""
	Response.write m1
	Response.write """ readonly><DIV id=daysOfMonth style=""POSITION: absolute;z-index:10""></DIV>" & vbcrlf & "&nbsp;至：<INPUT name=ret2 size=9  id=daysOfMonth2Pos onmouseup=toggleDatePicker(""daysOfMonth2"",""date.ret2"") value="""
	Response.write m1
	Response.write m2
	Response.write """ readonly><DIV id=daysOfMonth2 style=""POSITION: absolute""></DIV></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td width=""10%"">&nbsp;</td>" & vbcrlf & "<td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2Reset""></td></tr></table>" & vbcrlf & ""
	conn.close
	set conn=nothing
