		...
		function addreply(){
			...
			ntd.colSpan='2';
			//ntd.width='45%';
			ntd.innerHTML="<div align='left'><input name='reply"+vi.toString()+"' type='text' id='reply"+vi.toString()+"' size='15' dataType='Number' min='0' max='10000' msg='数字在0-10000之间' value='1' onKeyUp='autoztday()'> 天（与上一次联系天数间隔）</div>"
