...
'if request("hiddenflag")="1" then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script src= ""../Script/ti_bbdd3.js?ver="
	Response.write Application("sys.info.jsver")
	...
	'Response.write C
	action1="人员业绩年对比"
	Call InitReportBar("人员业绩年对比")
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & " <tr>" & vbcrlf & "          <td><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "             <form action=""bbdd3.asp?px="
	Response.write px
	Response.write "&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write """ method=""get""　id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"" >" & vbcrlf & "                         <tr>" & vbcrlf & "                <td  class=""place2"">人员业绩年对比</td>" & vbcrlf & "                <td  width=""450"">" & vbcrlf & "                              <table width=""100%"" cellspacing=""2"">" & vbcrlf & "            <tr height=""25"">" & vbcrlf & "            <td align=""center""><a href=""#"" onClick=""date.hiddenflag.value=1;date.submit();""><img src=""../images/main_2.gif"" width=""8"" height=""8"" border=""0"" /> 前一年</a></td>" & vbcrlf & "              <td colspan=""3"" align=""center"">"
	Response.write tdyear
	Response.write "年"
	Response.write tdmonth
	Response.write "月份</td>" & vbcrlf & "              <td align=""center""><a href=""#"" onClick=""date.hiddenflag.value=2;date.submit();"">后一年 <img src=""../images/main_1.gif"" width=""8"" height=""8"" border=""0"" /></a></td>" & vbcrlf & "                     <td align=""center""><DIV id=daysOfMonth1 style=""POSITION: absolute""></DIV>" & vbcrlf & "          <INPUT name=""ret1"" type=""hidden"" size=10 >" & vbcrlf & "          <span style=""margin-left:20px;"">" & vbcrlf & "                         <input type=""radio"" name=""lhbtype"" id=""lhbtype"" value=""bbdd3_w.asp"" onClick=""window.location.href=this.value"">每周" & vbcrlf & "                                <input type=""radio"" name=""lhbtype"" id=""lhbtype2"" value=""bbdd3_m.asp"" onClick=""window.location.href=this.value"">每月" & vbcrlf & "                 </span>" & vbcrlf & "                 </td>" & vbcrlf & "            </tr>" & vbcrlf & "                 </table></td>" & vbcrlf & "                <td align=""right"">" & vbcrlf & "" & vbcrlf & "                         <div align=""right"">关键词：" & vbcrlf & "                             <input name=""C"" type=""text"" size=""10""  value="""
	Response.write C
	...
	Response.write tdate
	Response.write """>" & vbcrlf & "         </form>" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "     <tr class=""top"">" & vbcrlf & "    <td height=""26"" ><div align=""center"">姓名</div></td>" & vbcrlf & "       <td colspan=""10"" ><div align=""center"">业绩对比</div></td>" & vbcrlf & "   </tr>" & vbcrlf & " <tr>" & vbcrlf & "      <td height=""27"" >&nbsp;</td>" & vbcrlf & "      <td colspan=""4""  align=""center"">当年</td>" & vbcrlf & "   <td colspan=""4""  align=""center"">上一年</td>" & vbcrlf & "   <td colspan=""2""   align=""center"">历史</td>" & vbcrlf & "          </tr>" & vbcrlf & " <tr>" & vbcrlf & "      <td height=""26"" ></td>" & vbcrlf & "    <td  colspan=""2""  align=""center"">本月</td>" & vbcrlf & "          <td  colspan=""2""  align=""center"">累计</td>" & vbcrlf & "          <td  colspan=""2""  align=""center"">本月</td>" & vbcrlf & "         <td  colspan=""2""  align=""center"">累计</td>" & vbcrlf & "          <td  colspan=""2"" align=""center"">总计</td>" & vbcrlf & "   </tr>" & vbcrlf & "    <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" &vbcrlf & "            <td align=""center"">&nbsp;</td>" & vbcrlf & "            <td  width=""8%"" align=""center""><a href=""bbdd3.asp?px=1&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>数量</u></a></td>" & vbcrlf & "            <td  width=""9%"" align=""center""><a href=""bbdd3.asp?px=m1&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>金额</u></a></td>" & vbcrlf & "            <td  width=""8%"" align=""center""><a href=""bbdd3.asp?px=2&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>数量</u></a></td>" & vbcrlf & "            <td  width=""9%"" align=""center""><a href=""bbdd3.asp?px=m2&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>金额</u></a></td>" & vbcrlf & "            <td  width=""8%"" align=""center""><a href=""bbdd3.asp?px=3&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>数量</u></a></td>" & vbcrlf & "            <td  width=""9%"" align=""center""><a href=""bbdd3.asp?px=m3&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>金额</u></a></td>" & vbcrlf & "            <td  width=""8%"" align=""center""><a href=""bbdd3.asp?px=4&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>数量</u></a></td>" & vbcrlf & "            <td  width=""9%"" align=""center""><a href=""bbdd3.asp?px=m4&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>金额</u></a></td>" & vbcrlf & "            <td  width=""8%"" align=""center""><a href=""bbdd3.asp?px=5&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>数量</u></a></td>" & vbcrlf & "            <td  width=""9%"" align=""center""><a href=""bbdd3.asp?px=m5&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>金额</u></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "   "
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select * from (select g.ord,g.name,isnull(sum(c.numcg1),0) as numcg1,isnull(sum(c.numcg1m),0) as numcg1m,isnull(sum(c.numcg2),0) as numcg2,isnull(sum(c.numcg2m),0) as numcg2m,isnull(sum(c.numcg3),0) as numcg3,isnull(sum(c.numcg3m),0) as numcg3m,isnull(sum(c.numcg4),0) as numcg4,isnull(sum(c.numcg4m),0) as numcg4m,isnull(sum(c.numcg5),0) as numcg5,isnull(sum(c.numcg5m),0) as numcg5m from gate g WITH(NOLOCK) "&_
	" left join (select cateid,count(ord) as numcg1,isnull(sum(money2),0) as numcg1m,0 as numcg2,0 as numcg2m,0 as numcg3,0 as numcg3m,0 as numcg4,0 as numcg4m,0 as numcg5,0 as numcg5m "&_
	"           from contract WITH(NOLOCK) where year(date3)="&tdyear&" and month(date3)="&tdmonth&" and del=1 and isnull(status,-1) in (-1,1) group by cateid "&_
	"           union all select cateid,0,0,count(ord) as numcg2,isnull(sum(money2),0) as numcg2m,0,0,0,0,0,0 from contract WITH(NOLOCK) where year(date3)="&tdyear&" and del=1 and isnull(status,-1) in (-1,1)  group by cateid "&_
	"           union all select cateid,0,0,0,0,count(ord) as numcg3,isnull(sum(money2),0) as numcg3m,0,0,0,0 from contract WITH(NOLOCK) where year(date3)="&tdyear2&" and month(date3)="&tdmonth&" and del=1  and isnull(status,-1) in (-1,1) group by cateid "&_
	"           union all select cateid,0,0,0,0,0,0,count(ord) as numcg4,isnull(sum(money2),0) as numcg4m,0,0 from contract WITH(NOLOCK) where year(date3)="&tdyear2&" and del=1 and isnull(status,-1) in (-1,1)  group by cateid "&_
	"           union all select cateid,0,0,0,0,0,0,0,0,count(ord) as numcg5,isnull(sum(money2),0) as numcg5m from contract WITH(NOLOCK) where del=1 and isnull(status,-1) in (-1,1) group by cateid "&_
	" ) c on c.cateid=g.ord where g.del=1 and ("&open_5_11&"=3 or ("&open_5_11&"=1 and g.ord in("&intro_5_11&") and g.ord>0)) "&gate_result&" group by g.ord,g.name) aa "&px_Result&" "
	...
	rs1.close
	set rs1=nothing
	Response.write "" & vbcrlf & "  <script src= ""../Script/ti_bbdd3_1.js?ver="
	Response.write Application("sys.info.jsver")
