...
'Private Sub Class_Initialize
	...
	sqltext="Update learntz set del=2 ,delcate="&session("personzbintel2007")&",deldate='"&date&"' where ord="&CurrBookID&""
	conn.Execute(sqltext)
	Set helper = CreateReminderHelper(conn,2,0)
	Call helper.dropRemindByOID(CurrBookID)
	action1="公告删除"
	call close_list(2)
	Response.redirect "edit.asp?"&sdk.ReturnURL("ord=")
%>
