...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	rs1.close
	set rs1=nothing
	Response.write "" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "<!DOCTYPE html PUBLIC ""-//W3C//DTD XHTML 1.0 Transitional//EN"" ""http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"">" & vbcrlf & "<html xmlns=""http://www.w3.org/1999/xhtml"">" & vbcrlf & "<head>" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"" />" & vbcrlf & "<title>发送短信</title>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style>" & vbcrlf & "    .help_explan_ico{float:left;display:block;width: 20px;height:20px;cursor: pointer;margin-left: 3px;background: url(../../SYSN/skin/default/img/explan_blue.png) no-repeat center center;}" & vbcrlf & "    .bill_help_expaln_text{background-color:#b2dbfd;width:200px;position:absolute;margin-left:25px;margin-top:0px;padding:15px;font-weight:normal !important;}" & vbcrlf & "    .bill_help_expaln_close{display: block;float: right;margin-right: 3px;width: 16px;height:16px;cursor: pointer;font-size: 14px;background-position: -48px 32px;text-decoration: none;position:absolute;top:6px;right:2px;}" & vbcrlf & "</style>" & vbcrlf & "<script src= ""../Script/pt_add.js?ver="
	'Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write """  type=""text/javascript""></script>" & vbcrlf & "<script language=""javascript"" src=""../inc/system.js?ver="
	Response.write Application("sys.info.jsver")
	...
	if not rs.eof then
		user=rs("DXuserName")
		pwd=rs("DXpassWord")
		signature=rs("lastCon")
		openSignature=rs("openLastCon")
	end if
	set rs=server.CreateObject("adodb.recordset")
	...
	action1="短信设置"
	call close_list(1)
	Response.write "" & vbcrlf & "<form id=""form1"" name=""form1"" method=""post"" onsubmit=""if(document.getElementById('openLast').style.display==''){if(document.getElementById('signature').value.length>0){return Validator.Validate(this,2) && Sensitivewords(document.getElementById('signature').value ,true)}else{alert('请填写签名内容！');return false;}}else{return Validator.Validate(this,2)&& Sensitivewords(document.getElementById('signature').value ,true);}"" action=""saveEdit.asp"" style=""margin:0"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""center"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">短信设置</td>" & vbcrlf & "            <td></td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td> " & vbcrlf & "            <td align=""right""><a href=""../../SYSA/message/openRecv.asp"" style=""color:blue"">短信接收设置</a></td>" & vbcrlf & "            <td align=""center""><span class=""help_explan_ico"" onclick=""showHelpExplan(1)"" ></span></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr> <td align=""center"" width=""78%""></td>" & vbcrlf & "              <td><div id=""bill_help_expaln_text"" class=""bill_help_expaln_text"" style=""display:none;font-weight:100"">" & vbcrlf & "                                          </br>温馨提示：</br></br>此功能用于控制短信接收功能。</br>" & vbcrlf & "                                          <a title=""关闭"" href=""javascript:;""  onclick=""closediv(1)"" class=""bill_help_expaln_close"">×</a>" & vbcrlf & "                                          </div></td>" & vbcrlf & "               <td></td>" & vbcrlf & "          </tr>" & vbcrlf & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td><table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                                    <tr class=""top"">" & vbcrlf & "            <td height=""30"" colspan=""2"" align=""left""><div align=""left"">短信内容设置</div> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                                                      <tr >" & vbcrlf & "            <td width=""15%"" height=""30"" align=""right""><div align=""right"">是否开启短信签名：</div></td>" & vbcrlf & "            <td width=""85%"" align=""left"" style=""font-weight: normal;""><input name=""openSignature"" type=""radio"" onClick=""document.getElementById('openLast').style.display='none';"" "
	call close_list(1)
	if openSignature<>1  then
		Response.write "checked=""checked"""
	end if
	Response.write " value=""0""  />" & vbcrlf & "            关闭" & vbcrlf & "              <input type=""radio"" name=""openSignature"" "
	if openSignature=1 then
		Response.write "checked=""checked"""
	end if
	Response.write "  onclick=""document.getElementById('openLast').style.display='';"" value=""1"" />" & vbcrlf & "开启</td>" & vbcrlf & "                                                      </tr>" & vbcrlf & "                                                           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"" id=""openLast"" "
	if openSignature<>1 then
		Response.write " style=""display:none"""
	end if
	Response.write ">" & vbcrlf & "            <td width=""15%"" height=""30"" align=""right""><div align=""right"">短信签名：</div></td>" & vbcrlf & "            <td width=""85%"" align=""left"" style=""font-weight: normal;""><input name=""signature""　dataType=""Limit"" min=""1"" max=""50""  value="""
	Response.write " style=""display:none"""
	Response.write signature
	Response.write """ type=""text"" id=""signature"" size=""32"" maxlength=""50"" />" & vbcrlf & "              例：<a href=""###"" onClick=""document.getElementById('signature').value='"
	Response.write("【"&intro5&"】")
	Response.write "'"" title=""点击复制"">【"
	Response.write intro5
	Response.write "】</a>，注：字数尽量精简</td>" & vbcrlf & "                                                    </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td height=""20px"" align=""right"">&nbsp;</td>" & vbcrlf & "            <td align=""left""><div align=""left"" id=""subBut"" style=""color:#FF0000"">" & vbcrlf & "                <input type=""submit"" style=""cursor:hand""  class=""anybutton"" id=""button"" value=""保 存"" name=""B8"" >" & vbcrlf & "                &nbsp;<input type=""reset"" style=""cursor:hand""  class=""anybutton"" id=""B8""  value=""取 消"" name=""B82"">" & vbcrlf & "            </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td  class=""page""><table width=""100%"" border=""0"" align=""left"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td height=""30"" ></td>" & vbcrlf & "          </tr>" & vbcrlf & "</table></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "</form>" & vbcrlf & "</body>" & vbcrlf & "</html>"
