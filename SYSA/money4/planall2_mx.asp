...
'if D1<>"" and D1<>"0" then
	...
	if m1<>"" then
		str_Result11=str_Result11+" and date1>='"&m1&"' "
'if m1<>"" then
	end if
	if m2<>"" then
		str_Result11=str_Result11+" and date1<='"&m2&"' "
'if m2<>"" then
	end if
...
'if cint(request("bz"))>0 then
	...
	Response.write "企业管理软件</title>" & vbcrlf & "<link rel=""stylesheet"" type=""text/css"" href=""../inc/themes/default/easyui.css?ver="
	Response.write Application("sys.info.jsver")
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & ".IE5 .top_btns input.anybutton2{height:18px;line-height:16px;margin-bottom:-0.5px;}" & vbcrlf & "</style>" & vbcrlf & "<script src= ""../Script/m4_planall2_mx.js?ver="
	'Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	...
	Response.write " onMouseOver=""window.status='none';return true;"" >" & vbcrlf & "<form method=""get"" action=""planall2_mx.asp?clrtype="
	Response.write clrtype
	Response.write """ id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "           <form method=""get"" action=""planall2_mx.asp?clrtype="
	Response.write clrtype
	Response.write """ id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "             <tr>" & vbcrlf & "            <td class=""place"">采购退款明细表</td>" & vbcrlf & "                   <td>&nbsp;<a href=""#"" onClick=""Myopen_px(User);return false;"" class=""sortRule"">排序规则<img src=""../images/i10.gif"" width=""9"" height=""5"" border=""0""></a></td>" & vbcrlf & "            <td align=""right""><div id=""kh"" style=""height:20px;line-height:20px;"">" & vbcrlf & "              <select name=""select2""  onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"">" & vbcrlf & "  <option>-请选择-</option>" & vbcrlf & "                <option value=""page_count=10"" "
	Response.write clrtype
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "              </select>" & vbcrlf & "            </div></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "     <table width=""100%"" border=""0"" cellpadding=""3"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;"">" & vbcrlf & "              <tr>" & vbcrlf & "                <td class=""top_btns resetHeadBg"" height=""30"" align=""center"" style=""border-top:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;height:50px;background:#f4fafe""  valign=""middle""><input name=""D"" type=""radio"" value=""1"" onClick=""go('planall2_hz.asp?clrtype="
	Response.write "selected"
	Response.write clrtype
	Response.write "&A="
	Response.write A
	...
	Response.write request("companyname")
	Response.write "&companyid="
	Response.write request("companyid")
	Response.write "&thdmc="
	Response.write request("thdmc")
	Response.write "&thdbh="
	Response.write request("thdbh")
	...
	Response.write page_count
	Response.write "');"">" & vbcrlf & "汇总模式<input type=""radio"" name=""D"" value=""2"" checked>明细模式"
	...
	Response.write "'>"
	Response.write "" & vbcrlf & "<!--<select name=""A"">" & vbcrlf & "  <option value=""10"" "
	if A=10 then
		Response.write "selected"
	end if
	Response.write ">退款状态</option> " & vbcrlf & "  <option value=""1"" "
	if A=1 then
		Response.write "selected"
	end if
	...
	Response.write ">已退款</option>" & vbcrlf & "</select> --><select name=""A2"">" & vbcrlf & "        <option value=""0"" >币种</option>" & vbcrlf & ""
	Response.write "selected"
	...
	rs88.close
	if open_bz=1 then
		sql88="select * from sortbz order by gate1 desc"
	else
		sql88="select * from sortbz where id=14 "
	end if
	...
	rs88.close
	set rs88=nothing
	Response.write "" & vbcrlf & "</select>" & vbcrlf & "<select name=""B"">" & vbcrlf & "  <option value=""khmc"" "
	if B="khmc" then
		Response.write "selected"
	end if
	...
	Response.write ">供应商编号</option>" & vbcrlf & "  <option value=""thzt"" "
	if B="thzt" then
		Response.write "selected"
	end if
	Response.write ">退货主题</option>" & vbcrlf & "  <option value=""thid"" "
	if B="thid" then
		Response.write "selected"
	end if
	Response.write ">退货编号</option>" & vbcrlf & "  <option value=""thry"" "
	if B="thry" then
		Response.write "selected"
	end if
	Response.write ">退货人员</option>" & vbcrlf & "</select>" & vbcrlf & "<input type=""hidden"" name=""clrtype"" value="""
	Response.write clrtype
	Response.write """"" />" & vbcrlf & "<input name=""C"" type=""text"" size=""10""  value="""
	Response.write C
	Response.write """/> <input type=""submit"" name=""Submit422"" value=""检索""  class=""anybutton2""/> <input type=""button"" name=""openbn"" id=""openbn"" value=""高级检索""  class=""anybutton2"" onclick=""$('#w').show();$('#w').window('open');""/><span id='ss1'>"
	if open_76_10=1 or open_76_10=3 then
		Response.write " <input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({debug:false,page:'../out/xls_cgtkmx.asp'})}"" class=""anybutton2""/>"
	end if
	if open_76_7=1 or open_76_7=3 then
		Response.write " <input type=""button""  name=""print"" onclick=""javascript:$('#ss1').hide();window.print();return  false;"" value=""打印"" class=""anybutton2""/>"
	end if
	Response.write "</span></td>" & vbcrlf & "        </tr>" & vbcrlf & "             </form>" & vbcrlf & "      </table>" & vbcrlf & "          <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      </form>" & vbcrlf & " <tr class=""top"">" & vbcrlf & "    <td width=""13%""><div align=""center"">供应商名称</div></td>" & vbcrlf & "          <!--<td width=""7%""><div align=""center"">部门</div></td>" & vbcrlf & "      <td width=""7%""><div align=""center"">小组</div></td> -->" & vbcrlf & "      <td width=""8%""><div align=""center"">应退金额</div></td> " & vbcrlf & "     <td width=""8%""><div align=""center"">实退金额</div></td>" & vbcrlf & "          <td width=""8%""><div align=""center"">应退日期</div></td>" & vbcrlf & "      <td width=""8%""><div align=""center"">退款日期</div></td>" & vbcrlf & "      <td width=""8%""><div align=""center"">退款方式</div></td>" & vbcrlf & "      <td width=""12%""><div align=""center"">关联采购退货单</div></td>" & vbcrlf & "     <td width=""9%"">" & vbcrlf & "           "
	if ZBRuntime.MC(15000) and ZBRuntime.MC(18700) then
		Response.write "" & vbcrlf & "               <div align=""center"">关联采购/委外单</div>" & vbcrlf & "                 "
	elseif ZBRuntime.MC(15000) and ZBRuntime.MC(18700)=false then
		Response.write "" & vbcrlf & "               <div align=""center"">关联采购单</div>" & vbcrlf & "              "
	elseif ZBRuntime.MC(18700) and ZBRuntime.MC(15000)=false then
		Response.write "" & vbcrlf & "               <div align=""center"">关联委外单</div>" & vbcrlf & "              "
	end if
	Response.write "" & vbcrlf & "       </td>" & vbcrlf & "   <td width=""7%""><div align=""center"">退货人员</div></td>" & vbcrlf & "      <td width=""10%""><div align=""center"">备注</div></td>" & vbcrlf & "       </tr>" & vbcrlf & ""
	dim n
	n=0
	set rs=server.CreateObject("adodb.recordset")
	sql="select *,"&_
	...
	" from payout3 WITH(NOLOCK) "&Str_Result&" "&str_Result11&" "&px_Result&""
	...
	if rs.RecordCount<=0 then
		...
		Response.write "" & vbcrlf & "      <form name=""form1"" method=""get"" action=""deleteall2.asp?ord="
		...
		do until rs.eof
			...
			Response.write "       " & vbcrlf & "      <tr height=""27"" onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td>" & vbcrlf & "             "
			if delname="已彻底删除" then
				Response.write "" & vbcrlf & "                     <span style=""color:red;"">"
				Response.write delname
				Response.write "</span></td>" & vbcrlf & "         "
			else
				Response.write "" & vbcrlf & "                     <div align=""left"">" & vbcrlf & "                        "
				if sort3=2 and (open_26_1=3 or CheckPurview(intro_26_1,trim(cateid_gys))=True) then
					if open_26_14=3 or CheckPurview(intro_26_14,trim(cateid_gys))=True then
				...
				elseif sort3=1 and ((open_1_1=3 or CheckPurview(intro_1_1,trim(cateid_gys))=True) or (InStr(1,","&share&"," , ","& sdk.user &",",1) Or share = "1" )) then
					if open_1_14=3 or CheckPurview(intro_1_14,trim(cateid_gys))=True then
						Response.write "" & vbcrlf & "                             <a href=""#"" onclick=""javascript:window.open('../work/content.asp?ord="
						Response.write pwurl(company)
						Response.write "','contractcon','width=' + 850 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"">" & vbcrlf & "                          "
						Response.write pwurl(company)
					end if
					Response.write telname
					Response.write "<span style=""color:red;"">"
			...
			if IsNull(zbcdbl(rs("money2"))) or rs("money2")="" then
				...
				money2=cdbl(rs("money2"))
			end if
			summoney1=summoney1+cdbl(rs("money1"))
			money2=cdbl(rs("money2"))
...
'if cateid_th="" or cateid_th=0 then
			...
			Response.write "" & vbcrlf & "       <td ><div align=""center"">"
			if open_75_14=3 or CheckPurview(intro_75_14,trim(cateid_th))=True then
				Response.write "<a href=""#"" onclick=""javascript:window.open('../caigouth/content.asp?ord="
				Response.write pwurl(th)
				Response.write "','neww78in','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" >"
				Response.write pwurl(th)
			end if
			Response.write thname
			Response.write "</a></div></td>" & vbcrlf & ""
			if rs("fromtype")<>"" then
				...
				if rs("fromtype")=1 then
					...
					if open_22_14=3 or CheckPurview(intro_22_14,trim(rs("cateid")))=True then
						isDetailsPower=1
						detailsUrl="../../SYSN/view/store/caigou/CaigouDetails.ashx"
					end if
				...
				elseif rs("fromtype")=3 then
					...
					if open_5025_14=3 or CheckPurview(intro_5025_14,trim(rs("cateid")))=True then
						isDetailsPower=1
						detailsUrl="../../SYSN/view/produceV2/ProductionOutsource/ProOutsourceAdd.ashx"
					end if
				elseif rs("fromtype")=4 then
					...
					if open_5026_14=3 or CheckPurview(intro_5026_14,trim(rs("cateid"))) then
						isDetailsPower=1
						detailsUrl="../../SYSN/view/produceV2/OutProcedure/AddOutProcedure.ashx"
					end if
				end if
				...
				if rs1.eof then
					...
					detailsUrl=detailsUrl & "?view=details&ord="&pwurl(rs1("ord"))&""
				end if
				rs1.close
				set rs1=nothing
			else
...
'if cateid_cg="" or cateid_cg=0 then
			...
			Response.write " " & vbcrlf & "     <td><div align=""center"">"
			if isDetailsPower=1 and billdel="" then
				Response.write "" & vbcrlf & "              <a href=""#"" onclick=""javascript:window.open('"
				Response.write detailsUrl
				Response.write "','neww78in','width=' + 1000 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" >"
				Response.write detailsUrl
				Response.write billname
				Response.write "<span style=""color:red;"">"
				Response.write billdel
				Response.write "</span></a>" & vbcrlf & "           "
			else
				Response.write billname
				Response.write "<span style=""color:red;"">"
			...
			Response.write "" & vbcrlf & "          </div></td>" & vbcrlf & "<!--退货人员-->" & vbcrlf & "  <td><div align=""center"">"
			Response.write "</span>" & vbcrlf & "               "
			Response.write cateidname
			Response.write "</div></td>" & vbcrlf & "   <td class=""func""><div align=""left"">"
		...
		loop
		m=n
		Response.write "" & vbcrlf & "    <tr height=""27"" onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td class=""func""><div align=""right""><strong>合计：</strong></div></td>" & vbcrlf & "      <td><div align=""right"">"
		Response.write Formatnumber(summoney1,num_dot_xs,-1)
		Response.write "</div></td>" & vbcrlf & "    <td><div align=""right"">"
		Response.write Formatnumber(summoney2,num_dot_xs,-1)
		Response.write "</div></td>" & vbcrlf & "    <td><div align=""right"">"
		Response.write "</div></td>" & vbcrlf & "    <td colspan=""7"">&nbsp;</td>" & vbcrlf & "       </tr>" & vbcrlf & "      </table>" & vbcrlf & "  </td>" & vbcrlf & "      </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""7%"" height=""30"">&nbsp;</td>" & vbcrlf & "    <td width=""33%"" >&nbsp;</td>" & vbcrlf & "       </form>" & vbcrlf & "    <td width=""60%""><div align=""right"">" & vbcrlf & "     <span class=""black"">"
		...
		Response.write "条信息/页</span>&nbsp;&nbsp;" & vbcrlf & "  <input name=""currpage"" id=""currpage"" type=""text"" onkeyup=""value=value.replace(/[^\d]/g,'')""  size=""3"">" & vbcrlf & "     <input type=""submit"" name=""Submit422"" value=""跳转""  class=""anybutton2""  onclick=""gotourl('currPage='+document.getElementById('currpage').value);""/>" & vbcrlf & "    "
		if currpage=1 then
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <script language=javascript>" & vbcrlf & "function test()" & vbcrlf & "{" & vbcrlf & "  if(!confirm('确认删除吗？')) return false;" & vbcrlf & "}" & vbcrlf & "function ask() { " & vbcrlf & "document.all.form1.action = ""tcall.asp?CurrPage="
		Response.write CurrPage
		Response.write "&A="
		Response.write A
		Response.write "&W1="
		...
		Response.write "&page_count="
		Response.write page_count
		Response.write """; " & vbcrlf & "document.all.form1.submit(); " & vbcrlf & "} " & vbcrlf & "function mm(form) " & vbcrlf & "{" & vbcrlf & "     for (var i=0;i<form.elements.length;i++)" & vbcrlf & "        {" & vbcrlf & "               var e = form.elements[i]; " & vbcrlf & "              if (e.name != 'chkall') " & vbcrlf & "                e.checked = form.chkall.checked; " & vbcrlf & "  } " & vbcrlf & "} " & vbcrlf & "</script>" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""138"" colspan=""3""><div align=""right""><p>&nbsp;" & vbcrlf & "      </p>" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</form>        " & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	Response.write "   " & vbcrlf & "      <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "        <tr> " & vbcrlf & "          <td width=""100%"" height=""10""><img src=""../images/pixel.gif"" width=""1"" height=""1""></td>" & vbcrlf & "        </tr>" & vbcrlf & "                       <tr>" &vbcrlf & "                            <td height=""10"">&nbsp;</td>" & vbcrlf & "       </tr>" & vbcrlf & "      </table>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<script src= ""../Script/m4_planall2_mx_1.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript""></script>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:150; height:400;display:none;"">" & vbcrlf & "<table width=""150"" height=""410""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""139"">" & vbcrlf & "        <table width=""150"" height=""115"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "            <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=1');""><font color=""#2F496E"">按供应商名称排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=2');""><font color=""#2F496E"">按供应商名称排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=3');""><font color=""#2F496E"">按应退金额排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=4');""><font color=""#2F496E"">按应退金额排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=5');""><font color=""#2F496E"">按实退金额排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=6');""><font color=""#2F496E"">按实退金额排序(升)</font></a> </td>" & vbcrlf & "  </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=7');""><font color=""#2F496E"">按应退日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=8');""><font color=""#2F496E"">按应退日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=9');""><font color=""#2F496E"">按实退日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=10');""><font color=""#2F496E"">按实退日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=11');""><font color=""#2F496E"">按退款方式排序(降)</font></a> </td>" & vbcrlf & "        </tr>" & vbcrlf & "                <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=12');""><font color=""#2F496E"">按退款方式排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                <tr  valign=""middle"">" & vbcrlf & "<td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=13');""><font color=""#2F496E"">按退货人员排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=14');""><font color=""#2F496E"">按退货人员排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & "<div id=""w"" class=""easyui-window"" title=""高级检索"" style=""width:580px;height:480px;padding:5px;background: #fafafa;top:0px;display:none""  closed=""true"" >" & vbcrlf & "    <form method=""get"" action=""planall2_mx.asp"" id=""date1"" onSubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "                  <div region=""north"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "                          <a class=""easyui-linkbutton""  href=""###"" onClick=""document.getElementById""                 </div>" & vbcrlf & "                  <div region=""center"" border=""false"" style=""padding:5px;background:#fff;border:1px solid #ccc;width:530px"">" & vbcrlf & "                    <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                              <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                  <td width=""24%"" class=""func"">&nbsp;" & vbcrlf & "                    <div align=""right"">供应商名称</div>" & vbcrlf & "                    <div align=""right""></div></td>" & vbcrlf & "     <td width=""76%""><label><input name=""companyname"" type=""text"" id=""companyname""></label></td>" & vbcrlf & "              </tr>" & vbcrlf & "                   <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                  <td width=""24%"" class=""func"">&nbsp;" & vbcrlf & "                    <div align=""right"">供应商编号</div>" & vbcrlf & "                    <div align=""right""></div></td>" & vbcrlf & "                  <td width=""76%""><label><input name=""companyid"" type=""text"" id=""companyid""></label></td>" & vbcrlf & "              </tr>" & vbcrlf & "                     <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                  <td width=""24%"" class=""func"">&nbsp;" & vbcrlf & "                    <div align=""right"">退货单名称</div>" & vbcrlf & "         <div align=""right""></div></td>" & vbcrlf & "                  <td width=""76%""><label><input name=""thdmc"" type=""text"" id=""thdmc""></label></td>" & vbcrlf & "              </tr>" & vbcrlf & "                   <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                  <td width=""24%"" class=""func"">&nbsp;" & vbcrlf & "                    <div align=""right"">退货单编号</div>" & vbcrlf & "                    <div align=""right""></div></td>" & vbcrlf & "                  <td width=""76%""><label><input name=""thdbh"" type=""text"" id=""thdbh""></label></td>" & vbcrlf & "              </tr>" & vbcrlf & "                    <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                 <td><div align=""right"">金额</div></td>" & vbcrlf & "                 <td><input name=""duemoney1"" type=""text""  class=""easyui-numberbox"" id=""duemoney1"" size=""10"" maxlength=""10"" min=""0"" max=""999999999"" precision=""2""  value=""0"">" & vbcrlf & "                   -" & vbcrlf & "                 <input name=""duemoney2"" type=""text"" id=""duemoney2"" size=""10"" maxlength=""10"" class=""easyui-numberbox"" min=""0"" max=""999999999"" precision=""2""  value=""999999999""></td>" & vbcrlf & "               </tr>" & vbcrlf & "               <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                 <td><div align=""right"">退货人员</div></td>" & vbcrlf & "                 <td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & "               </tr>" & vbcrlf & "               <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                 <td><div align=""right"">应退日期</div></td>" & vbcrlf & "                 <td><INPUT name=duepaydate1size=9  readonly id=duepaydate1divPos onmouseup=toggleDatePicker(""duepaydate1div"",""date.duepaydate1"") value="""
	Response.write m1
	Response.write """><DIV id=duepaydate1div style=""POSITION: absolute;z-index:10"" name =""duepaydate1div""></DIV>" & vbcrlf & "-" & vbcrlf & "         <INPUT name=duepaydate2 size=9  id=duepaydate2divPos readonly onmouseup=toggleDatePicker(""duepaydate2div"",""date.duepaydate2"") value="""
	Response.write m1
	Response.write m2
	Response.write """><DIV id=duepaydate2div style=""POSITION: absolute;z-index:10"" name =""duepaydate2div""></DIV>                           </td>" & vbcrlf & "               </tr>" & vbcrlf & "                     <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "            <td><div align=""right"">币种</div></td>" & vbcrlf & "                 <td>" & vbcrlf & "                                      <select name=""A2"">" & vbcrlf & "                                                <option value=""0"" >币种</option>" & vbcrlf & "                                  "
	set rs88=server.CreateObject("adodb.recordset")
	if open_bz=1 then
		sql88="select * from sortbz order by gate1 desc"
	else
	...
	rs88.close
	set rs88=nothing
	Response.write "" & vbcrlf & "                                     </select>" & vbcrlf & "                               </td>" & vbcrlf & "               </tr>" & vbcrlf & "              </table>" & vbcrlf & "                 </div>" & vbcrlf & "                  <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "                            <a class=""easyui-linkbutton""  href=""###"" onClick=""document.getElementById('date1').submit()"">确认</a>" & vbcrlf & "                          <a class=""easyui-linkbutton"" href=""###"" onClick=""$('#w').window('close');"">取消</a>" & vbcrlf & "                   </div>" & vbcrlf & "          </form>" & vbcrlf & " </div>" & vbcrlf & "  " & vbcrlf & ""
	set rs88=nothing
	action1="采购退款明细表"
	call close_list(1)
