...
'dim i
		...
		Sub page_load
			...
			tt = "会计科目"
			sql = "exec erp_accountSubject_List "& Info.user &",'" & Application("_sys_sql_db") &  "' "
			Export_Fields = "上级会计科目代码,上级会计科目名称,会计科目代码,会计科目名称,助记码,发生额方向,余额方向,现金科目,银行科目,其他科目,日记账,现金流,汇兑损益,本年利润科目,外币核算,期末调汇"
			Dim adapter
			...
			adapter.vPath="../../"
			adapter.fileName = tt
			adapter.lvw.distinctSpaceCol = "上级会计科目代码,上级会计科目名称"
