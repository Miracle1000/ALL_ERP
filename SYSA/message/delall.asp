...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	elseif open_67_3= 1 then
		Str_Result=" and (addcate in("&intro_67_3&")) "
	else
		Str_Result=" and 1=2"
	end if
	if strid<>"" then
	...
	sql="Delete  MessagePerson where 1=1  "&Str_Result&" "&str_sql_checkid&""
	conn.Execute(sql)
	action1="短信地址删除"
	call close_list(2)
	Response.write"<script language=javascript>window.location.href='all.asp?page_count="&page_count&"&currpage="&currpage&"&takeName="&strid&"';window.parent.location.reload();</script>"
