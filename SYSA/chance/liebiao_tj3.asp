...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	Response.write "               " & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "     <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "               <td colspan=""2""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';return false;><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td>" & vbcrlf & "      </tr>   " & vbcrlf & "        <tr>" & vbcrlf & "            <td><div align=""right"">项目负责人：</div></td>" & vbcrlf & "      <td onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "" & vbcrlf & "              </td>" & vbcrlf & "   </tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">发现日期：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=ret3 size=9  id=daysOfMonth3Pos onmouseup=toggleDatePicker(""daysOfMonth3"",""date.ret3"") value="""
	Response.write m3
	...
	Response.write m3
	Response.write m4
	Response.write """ readonly><DIV id=daysOfMonth4 style=""POSITION: absolute""></DIV></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">预计签单日期：</div></td>" & vbcrlf & "<td>&nbsp;自：<INPUT name=ret5 size=9  id=daysOfMonth5Pos onmouseup=toggleDatePicker(""daysOfMonth5"",""date.ret5"") value="""
	Response.write m5
	...
	Response.write m5
	Response.write m6
	Response.write """ readonly><DIV id=daysOfMonth6 style=""POSITION: absolute""></DIV></td></tr>" & vbcrlf & "  <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "               <td width=""10%"">&nbsp;</td>" & vbcrlf & "               <td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "        </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
