...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "<script src= ""../Script/cr_List_carDriver_2.js?ver="
	Response.write Application("sys.info.jsver")
	...
	if C<>"" then
		if B = "xm" then
			Str_Result=Str_Result+" and  drivername like '%"& ml.De(C) &"%'"
'if B = "xm" then
		elseif B = "dh1" then
			Str_Result=Str_Result+" and  phone like '%"& ml.De(C) &"%'"
'elseif B = "dh1" then
		elseif B = "dh2" then
			Str_Result=Str_Result+" and  mobile like '%"& ml.De(C) &"%'"
'elseif B = "dh2" then
		elseif B = "dh3" then
			Str_Result=Str_Result+" and  mobile2 like '%"& ml.De(C) &"%'"
'elseif B = "dh3" then
		end if
	end if
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "<form name=""data"" id=""data"" action=""List_carDriver.asp"" method=""get"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "          <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf &           "<tr>" & vbcrlf &             "<td class=""place"">司机列表</td>" & vbcrlf &                       "<td></td>" & vbcrlf &                        "<td><div align=""right"" class=""top_btns""><span id=""kh"">" & vbcrlf &                           "<select name=""B"" id=""B"" style=""color:#000000"">" & vbcrlf & "                           <option value="""">--请选择--</option>" & vbcrlf & "                                  <option value=""xm"" "
	currpage=clng(currpage)
	if B="xm" then Response.write "selected"
	Response.write ">司机姓名</option>                  " & vbcrlf & "                                  <option value=""dh1"" "
	if B="dh1" then Response.write "selected"
	Response.write ">固定电话</option>" & vbcrlf & "                                    <option value=""dh2"" "
	if B="dh2" then Response.write "selected"
	Response.write ">移动电话</option>" & vbcrlf & "                                    <option value=""dh3"" "
	if B="dh3" then Response.write "selected"
	Response.write ">移动电话2</option>" & vbcrlf & "                     </select>" & vbcrlf & "                       <input type=""text"" name=""C"" id=""C"" value="""
	Response.write C
	Response.write """ size=""10"">" & vbcrlf & "                   <input name=""page_count"" type=""hidden"" value="""
	...
	if open_102_13<>0 then
		Response.write "" & vbcrlf & "                        <input type=""submit"" class=""anybutton2"" id=""btnmit12"" name=""btnmit12"" value=""添加司机"" onclick=""javascript:window.open('Add_carDriver.asp','newwin','width=' +700 + ',height=' + 450 + ',fullscreen =no,scrollbars=1,toolbar=0, status=no,resizable=1,location=no,menubar=no,menubar=no,left=480,top=240')"">" & vbcrlf & "                    "
	end if
	Response.write "" & vbcrlf & "                      </span></div></td>" & vbcrlf & "           <td width=""2""><img src=""../images/m_mpr.gif"" width=""1"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table><span id=""ht1""></span>" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">      " & vbcrlf & "                 <tr valign=""center"" class=""top"">" & vbcrlf & "              <td width=""8%"" height=""30"" align=""left"" valign=""middle""  class=""name""><div align=""center"">选择</div></td>" & vbcrlf & "                   <td width=""15%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">司机姓名</div></td>" & vbcrlf & "            <td width=""12%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">固定电话</div></td>" & vbcrlf & "                <td width=""13%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">移动电话</div></td>" & vbcrlf & "               <td width=""12%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">移动电话2</div></td>" & vbcrlf & "               <td width=""20%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">司机地址</div></td>" & vbcrlf & "                <td width=""20%"" align=""left"" valign=""middle""  class=""name""><div align=""center""><select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px   solid   #FFFFFF; overflow:hidden"">" & vbcrlf & "                       <option>-请选择-</option>" & vbcrlf & "                       <option value=""page_count=10"" "
',menubar=no,left=480,top=240')"">" & vbcrlf & "                    "
	...
	currpage=clng(currpage)
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select * from O_carDriver where 1=1 "&Str_Result
	rs7.open sql7,conn,1,1
	if rs7.RecordCount<=0 then
		...
		do while not rs7.eof
			...
			Response.write "" & vbcrlf & "             <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "              <td width=""8%"" height=""30"" align=""left"" valign=""middle""  class=""name""><div align=""center"">" & vbcrlf & "                  "
			...
			Response.write "" & vbcrlf & "                </div></td>" & vbcrlf & "             <td width=""15%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">"
			...
			Response.write rs7("phone")
			Response.write "</div></td>" & vbcrlf & "             <td width=""13%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">"
			Response.write rs7("mobile")
			Response.write "</div></td>" & vbcrlf & "             <td width=""12%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">"
			Response.write rs7("mobile2")
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle"" class=""func""><div align=""center"">"
			Response.write rs7("addr")
			Response.write "</div></td>" & vbcrlf & "             <td width=""20%"" height=""30"" align=""left"" valign=""middle""  class=""func""><div align=""center"">" & vbcrlf & "                 "
			if (open_102_2=3 or CheckPurview(intro_102_2,trim(addcateid))=True) then
				Response.write "" & vbcrlf & "                  <input name=""button4"" type=""button""  class=""page"" id=""submit4"" onClick=""javascript:window.open('Add_carDriver.asp?ord="
				Response.write rs7("id")
				Response.write "&A="
				Response.write A
				Response.write "&B="
				...
				Response.write CurrPage
				Response.write "','neww35win','width=' + 700 + ',height=' + 450 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" value=""修改""/>" & vbcrlf & "                     "
				Response.write CurrPage
			end if
			if open_102_3=3 or CheckPurview(intro_102_3,trim(addcateid))=True then
				Response.write "" & vbcrlf & "                     <input name=""button5"" type=""button""  class=""page"" id=""submit5"" onClick=""if(confirm('确认删除吗？')){window.location=('Del_carDriver.asp?ord="
				Response.write rs7("id")
				Response.write "&px="
				Response.write px
				Response.write "&currPage="
	...
	Response.write "             " & vbcrlf & "                </div>" & vbcrlf & "          </td>" & vbcrlf & "           </form>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td colspan=""3"" height=""3000""></td>" & vbcrlf & "         </tr>" & vbcrlf & " </table>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "" & vbcrlf & ""
	rs7.close
	set rs7=nothing
	action1="司机列表"
	call close_list(1)
	Response.write "" & vbcrlf & "<script language=javascript>" & vbcrlf & "function Myopen(divID){ //根据传递的参数确定显示的层" & vbcrlf & "     if(divID.style.display==""""){" & vbcrlf & "              divID.style.display=""none""" & vbcrlf & "        }else{" & vbcrlf & "          divID.style.display=""""" & vbcrlf & "    }" & vbcrlf & "       divID.style.left=300;" & vbcrlf & " divID.style.top=20;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function testall()" & vbcrlf & "{" & vbcrlf & "  if(!confirm('确认删除吗？'))" & vbcrlf & " {" & vbcrlf & "  window.location=""List_carDriver.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
	...
	Response.write "&CurrPage="
	Response.write CurrPage
	Response.write """;" & vbcrlf & " }" & vbcrlf & " else" & vbcrlf & " {" & vbcrlf & "       document.getElementById('data').action=""Del_carDriver.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
