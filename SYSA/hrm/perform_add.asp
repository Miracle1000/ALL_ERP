...
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=1"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_1=0
intro_81_1=0
else
open_81_1=rs1("qx_open")
intro_81_1=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=2"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_2=0
intro_81_2=0
else
open_81_2=rs1("qx_open")
intro_81_2=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=14"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_14=0
intro_81_14=0
else
open_81_14=rs1("qx_open")
intro_81_14=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=7"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_7=0
intro_81_7=0
else
open_81_7=rs1("qx_open")
intro_81_7=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=8"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_8=0
intro_81_8=0
else
open_81_8=rs1("qx_open")
intro_81_8=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=10"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_10=0
intro_81_10=0
else
open_81_10=rs1("qx_open")
intro_81_10=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=11"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_11=0
intro_81_11=0
else
open_81_11=rs1("qx_open")
intro_81_11=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=3"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_3=0
intro_81_3=0
else
open_81_3=rs1("qx_open")
intro_81_3=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=12"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_12=0
intro_81_12=0
else
open_81_12=rs1("qx_open")
intro_81_12=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=13"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_13=0
intro_81_13=0
else
open_81_13=rs1("qx_open")
intro_81_13=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=16"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_16=0
intro_81_16=0
else
open_81_16=rs1("qx_open")
intro_81_16=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=81 and sort2=19"
rs1.open sql1,conn,1,1
if rs1.eof then
open_81_19=0
intro_81_19=0
else
open_81_19=rs1("qx_open")
intro_81_19=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
...
cateCondition = " AND (CHARINDEX(',"&uid&",',','+cast(b.share1 as varchar(8000))+',')>0 OR CHARINDEX(',"&uid&",',','+cast(b.share2 as varchar(8000))+',')>0 OR CHARINDEX(',"&workPosition&",',','+cast(b.postView as varchar(8000))+',')>0 OR CHARINDEX(',"&workPosition&",',','+cast(b.postDown as varcha							r(8000))+',')>0) "
'Dim workPosition : workPosition = cn.execute("SELECT workPosition FROM gate WHERE ord = "& uid)(0).value
sql = "SELECT COUNT(*) REMIND_CNT FROM reminderQueue a  with(nolock) " & vbcrlf &_
" [CANCELJOINTABLE] " & _
...
if open_81_13<>1 then
call jsBack("您还没有绩效添加权限！")
call db_close : Response.end
end if
...
'Response.write Application("sys.info.jsver")
Response.write Application("sys.info.jsver")
Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "<script src= ""../Script/hm_perform_add.js?ver="
Response.write Application("sys.info.jsver")
Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<script>" & vbcrlf & "$(document).ready(function(){" & vbcrlf & " $(""input[name='allcansee']"").click(function(){" & vbcrlf & "            if($(this).attr(""id"")==""rbtn1""){" & vbcrlf & "                    $(""#tb1"").hide();" & vbcrlf & "         	}else if($(this).attr(""id"")==""rbtn2""){" & vbcrlf & "                   $(""#tb1"").show();" & vbcrlf & "                 getmoreperson();" & vbcrlf & "                }" & vbcrlf & "       });" & vbcrlf & "});" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body "
if open_81_8=0 then
...
title=trim(SaveRequestForm("title"))
project=replace(trim(SaveRequestForm("project")),", ",",")
startTime=trim(SaveRequestForm("startTime"))
endTime=trim(SaveRequestForm("endTime"))
sp_Time1=trim(SaveRequestForm("sp_Time1"))
sp_Time2=trim(SaveRequestForm("sp_Time2"))
salary_time=trim(SaveRequestForm("salary_time"))
salaryClass=trim(SaveRequestForm("salaryClass"))
sortid=trim(SaveRequestForm("sortid"))
...
ygzt=replace(trim(SaveRequestForm("ygzt")&"")," ","")
W3=getW3(W1,W2,W3,ygzt)
Dtype=trim(SaveRequestUrl("type"))
ss_Time1=trim(SaveRequestForm("ss_Time1"))
ss_Time2=trim(SaveRequestForm("ss_Time2"))
If W3="" Or isnull(W3) Then
W3=0
end if
If intro_81_1="" Or isnull(intro_81_1) Then
intro_81_1=0
end if
If open_81_1=1 Then
Set rs=conn.execute("select isnull(userid,-1) as userid from hr_person where userid in ( "&W3&") and userid in ("&intro_81_1&")")
'If open_81_1=1 Then
If rs.eof Then
w3=""
else
...
rs.movenext
wend
w3=Left(Trim(w4),Len(Trim(w4))-1)
w4=rs("userid")&","&w4
end if
end if
if title=""  then call jsAlert(inName1&"不能为空")
if project=""  then call jsAlert(inName2&"不能为空")
if startTime="" or isdate(startTime)=false  then call jsAlert(inName3&"不能为空")
if endTime="" or isdate(endTime)=false  then call jsAlert(inName3&"不能为空")
if datediff("d",startTime,endTime)<0 then call jsAlert(inName3&"中的起始日期必须小于截止日期")
if sp_Time1="" or isdate(sp_Time1)=false  then call jsAlert(inName4&"不能为空")
if sp_Time2="" or isdate(sp_Time2)=false  then call jsAlert(inName4&"不能为空")
if datediff("d",sp_Time1,sp_Time2)<0 then call jsAlert(inName4&"中的起始日期必须小于截止日期")
if datediff("d",endTime,sp_Time1)<=0 then call jsAlert(inName4&"中的起始日期必须大于"&inName3&"截止日期")
if ss_Time1="" or isdate(ss_Time1)=false  then call jsAlert(inName9&"不能为空")
if ss_Time2="" or isdate(ss_Time2)=false  then call jsAlert(inName9&"不能为空")
if datediff("d",ss_Time1,ss_Time2)<0 then call jsAlert(inName9&"中的起始日期必须小于截止日期")
if datediff("d",sp_Time2,ss_Time2)<0 then call jsAlert(inName9&"中的截止日期必须大于等于"&inName4&"截止日期")
if salary_time="" or isdate(salary_time)=false  then call jsAlert(inName7&"不能为空")
if salaryClass=""   then call jsAlert(inName8&"不能为空")
if sortid="" or isnumeric(sortid)=false then call jsAlert(inName5&"不能为空")
if allcansee="" or isnumeric(sortid)=false then call jsAlert("请选择使用范围")
if allcansee=0 and W3="" then call jsAlert(inName6&"不能为空")
project_string=""
Set rss=conn.execute("select id,title,base,prop,content from hr_perform_project where id in ("&project&") and isnull(isopen,0)=0 order by px desc,id desc")
If Not rss.eof Then
While Not rss.eof
project_string=project_string&rss("id")&Chr(1)&rss("title")&Chr(1)&rss("base")&Chr(1)&rss("prop")&Chr(1)&rss("content")&Chr(2)
rss.movenext
wend
project_string=Left(project_string,Len(project_string)-1)
'rss.movenext
end if
rss.close
sp_list_string=""
Set rss=conn.execute("select * from hr_perform_sp_list where sortid="&sortid&" and lv>0 ")
If Not rss.eof Then
While Not rss.eof
sp_list_string=sp_list_string&rss("id")&Chr(1)&rss("title")&Chr(1)&rss("sortID")&Chr(1)&rss("lv")&Chr(1)&rss("prop")&Chr(1)&rss("sp_id")&Chr(1)&rss("id")&Chr(2)
rss.movenext
wend
sp_list_string=Left(sp_list_string,Len(sp_list_string)-1)
'rss.movenext
end if
rss.close
if Dtype="add" then
actionName="添加"'
set rs=server.CreateObject("adodb.recordset")
sql="select * from hr_perform_sort  where title='"&title&"' and del=0"
rs.open sql,conn,1,1
if rs.eof then
sp_lv=conn.execute("select min(lv) from hr_perform_sp_list where  sortid="&sortid&"")(0)
if isnumeric(sp_lv)=false then call jsBack("还没有设置审批流程！")
conn.execute "insert into hr_perform_sort(title,project_list,startTime,endTime,sp_Time1,sp_Time2,ss_Time1,ss_Time2,salary_time,sortid,isall,user_list,sp_lv,sp_complete,creator,inDate,del,salaryClass,project_string,sp_list_string) values('"&title&"','"&project&"','"&startTime&"','"&endTime&"','"&sp_Time1&"','"&sp_Time2&"','"&ss_Time1&"','"&ss_Time2&"','"&salary_time&"',"&sortid&","&allcansee&",'"&W3&"',"&sp_lv&",1,"&session("personzbintel2007")&",'"&now()&"',0,"&salaryClass&",'"&Replace(project_string,"'","''")&"','"&Replace(sp_list_string,"'","''")&"')"
ord = GetIdentity("hr_perform_sort","id","creator","conn")
Set helper = CreateReminderHelper(conn,210,0)
helper.appendRemind(ord)
Response.write "" & vbcrlf & "             <script language='javascript'>" & vbcrlf & "                  alert(""添加成功"");" & vbcrlf & "                        try {" & vbcrlf & "                           if (window.parent.opener) {" & vbcrlf & "                                     window.parent.open('', '_self');" & vbcrlf & "                                        window.parent.opener.location.reload();" & vbcrlf & "                                 window.parent.close(	);" & vbcrlf & "                          }else {" & vbcrlf & "                                 window.parent.location.href = ""perform_list.asp"";" & vbcrlf & "                         }" & vbcrlf & "                       }catch(e){" & vbcrlf & "                              window.parent.location.href = ""perform_list.asp"";" & vbcrlf & "                 }" & vbcrlf & "               </script>" & vbcrlf & "               "
else
call jsBack(inName1&"不能重复")
end if
rs.close
set rs=nothing
...
sp_lv=conn.execute("select min(lv) from hr_perform_sp_list where  sortid="&sortid&"")(0)
if isnumeric(sp_lv)=false then call jsBack("还没有设置审批流程！")
conn.execute "update hr_perform_sort set title='"&title&"',project_list='"&project&"',startTime='"&startTime&"',endTime='"&endTime&"',sp_Time1='"&sp_Time1&"',sp_Time2='"&sp_Time2&"',ss_Time1='"&ss_Time1&"',ss_Time2='"&ss_Time2&"',salary_time='"&salary_time&"',salaryClass='"&salaryClass&"',sortid="&	sortid&",isall="&allcansee&",user_list='"&W3&"',sp_lv="&sp_lv&",project_string='"&Replace(project_string,"'","''")&"',sp_list_string='"&Replace(sp_list_string,"'","''")&"' where id="&ord&" and del=0"
Set helper = CreateReminderHelper(conn,210,0)
helper.appendRemind(ord)
Response.write "" & vbcrlf & "             <script language='javascript'>" & vbcrlf & "                  alert(""修改成功"");" & vbcrlf & "                        try {" & vbcrlf & "                           if (window.parent.opener==undefined) {" & vbcrlf & "                                  window.parent.open('', '_self');" & vbcrlf & "                                        window.parent.opener.location.reload();" & vbcrlf & "                                 window.pa	rent.close();" & vbcrlf & "                               }else {" & vbcrlf & "                                 window.parent.location.href = ""perform_list.asp"";" & vbcrlf & "                         }" & vbcrlf & "                       }catch(e){" & vbcrlf & "                              window.parent.location.href = ""perform_list.asp"";" & vbcrlf & "                 }" & vbcrlf & "               </script>" & vbcrlf & "               "
action1="绩效考核修改"
call add_logs(1)
end if
...
call add_logs(1)
set rs=server.CreateObject("adodb.recordset")
sql="select * from hr_perform_sort  where id="&ord&" and del=0"
rs.open sql,conn,1,1
if not rs.eof then
s_title=rs("title")
ord=rs("id")
s_project=rs("project_list")
s_sortid=rs("sortid")
s_startTime=rs("startTime")
s_endTime=rs("endTime")
s_sp_Time1=rs("sp_Time1")
s_sp_Time2=rs("sp_Time2")
s_ss_Time1=rs("ss_Time1")
s_ss_Time2=rs("ss_Time2")
s_salary_time=rs("salary_time")
...
action1="绩效考核删除"
call add_logs(2)
conn.execute "update hr_perform_sort set del=1 where id="&ord&""
call jsLocat("删除成功",sdk.clearURL("perform_list.asp?"& sdk.ReturnURL("action=&ord=&remind="&remind) &""))
else
actionName="添加"'
action1="绩效考核添加"
call add_logs(1)
end if
Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor="""">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""	../images/m_mpbg.gif"">" & vbcrlf & "        <tr>" & vbcrlf & "          <td class=""place"">绩效考核"
Response.write actionName
Response.write "</td>" & vbcrlf & "          <td>&nbsp;</td>" & vbcrlf & "          <td align=""right"">&nbsp;</td>" & vbcrlf & "          <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>" & vbcrlf & "        <form method=""post"" name=""demo""  action=""perform_add.asp?action=update"" id=""demo"" onsubmit=""return Validator.Validate(this,2)"" target=""callBackFrame"">" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <t	r class=""top"">" & vbcrlf & "          <td  height=""26"" colspan=""2"" class=""name"">绩效考核"
Response.write actionName
Response.write "</td>" & vbcrlf & "        </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""16%""  height=""26"" align=""right"" class=""name"">"
Response.write inName1
Response.write "：</td>" & vbcrlf & "            <td width=""86%""  height=""26""  class=""name""><input name=""title"" type=""text"" id=""sort13"" value="""
Response.write s_title
Response.write """ size=""30"" dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1至50个字之间"">" & vbcrlf & "              <span id=""ulist1"" class=""red"">*&nbsp;</span></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr >" & vbcrlf & "            <td width=""16%""  height=""26"" align=""right"" cl	ass=""name"">"
Response.write inName2
Response.write "：</td>" & vbcrlf & "            <td  height=""26""  class=""name"">"
set rsT=server.CreateObject("adodb.recordset")
sqlT="select * from hr_perform_project  where del=0 and isnull(isopen,0)=0 order by px desc,id desc"
...
T_prop=rsT("prop")
T_ord=rsT("id")
Response.write "" & vbcrlf & "              <input name=""project"" type=""checkbox"" id=""project"" value="""
Response.write T_ord
Response.write """ "
if instr(","&s_project&",",","&T_ord&",")>0 then
Response.write " checked"
end if
Response.write ">" & vbcrlf & "              "
Response.write T_title
Response.write "("
Response.write T_prop
Response.write "%)" & vbcrlf & "              "
rsT.movenext
loop
else
Response.write "" & vbcrlf & "              您还没有设置项目<a href=""../manufacture/inc/Bill.asp?orderid=1014"" style=""color:#FF0000"">点击这里</a>设置" & vbcrlf & "              "
end if
rsT.close
set rsT=nothing
Response.write "" & vbcrlf & "              <span class=""red"">*</span></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""16%""  height=""26"" align=""right"" class=""name"">"
Response.write inName3
Response.write "：</td>" & vbcrlf & "            <td  height=""26""  class=""name""><input name=""startTime"" type=""text""   id=""startTime""  value="""
Response.write s_startTime
Response.write """ size=""15"" maxlength=""50""    Class=""DatePick""  onchange=""if(document.getElementById('rbtn2').checked){getmoreperson()}"" onclick=""datedlg.show();"" readonly dataType=""Limit"" min=""1"" max=""50""  msg=""必填"">--<input name=""endTime"" type=""text""   id=""endTime""  value="""
Response.write s_startTime
Response.write s_endTime
Response.write """ size=""15"" maxlength=""50""    Class=""DatePick""  onclick=""datedlg.show();"" readonly  dataType=""Limit"" min=""1"" max=""50""  msg=""必填"">" & vbcrlf & "              <span class=""red"">*</span></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td w	idth=""16%""  height=""26"" align=""right"" class=""name"">"
Response.write inName4
Response.write "：</td>" & vbcrlf & "            <td  height=""26""  class=""name""><input name=""sp_Time1"" type=""text""   id=""sp_Time1""  value="""
Response.write s_sp_Time1
Response.write """ size=""15"" maxlength=""50""   Class=""DatePick""  onclick=""datedlg.show();"" readonly dataType=""Limit"" min=""1"" max=""50""  msg=""必填"">--<input name=""sp_Time2"" type=""text""   id=""sp_Time2""  value="""
Response.write s_sp_Time1
Response.write s_sp_Time2
Response.write """ size=""15"" maxlength=""50""   Class=""DatePick""  onclick=""datedlg.show();"" readonly  dataType=""Limit"" min=""1"" max=""50""  msg=""必填"">" & vbcrlf & "              <span class=""red"">* &nbsp; "
Response.write inName4
Response.write "起始日期 >  "
Response.write inName3
Response.write "截止日期 &nbsp;</span></td>" & vbcrlf & "          </tr>" & vbcrlf & "                                      <tr>" & vbcrlf & "            <td width=""16%""  height=""26"" align=""right"" class=""name"">"
Response.write inName9
Response.write "：</td>" & vbcrlf & "            <td  height=""26""  class=""name""><input name=""ss_Time1"" type=""text""   id=""ss_Time1""  value="""
Response.write s_ss_Time1
Response.write """ size=""15"" maxlength=""50""   Class=""DatePick""  onclick=""datedlg.show();"" readonly dataType=""Limit"" min=""1"" max=""50""  msg=""必填"">--<input name=""ss_Time2"" type=""text""   id=""ss_Time2""  value="""
Response.write s_ss_Time1
Response.write s_ss_Time2
Response.write """ size=""15"" maxlength=""50""   Class=""DatePick""  onclick=""datedlg.show();"" readonly  dataType=""Limit"" min=""1"" max=""50""  msg=""必填"">" & vbcrlf & "              <span class=""red"">* &nbsp; "
Response.write inName9
Response.write "截止日期 >= "
Response.write inName4
Response.write "截止日期 &nbsp;</span></td>" & vbcrlf & "          </tr>" & vbcrlf & "                                        <tr >" & vbcrlf & "            <td width=""16%""  height=""26"" align=""right"" class=""name"">"
Response.write inName7
Response.write "：</td>" & vbcrlf & "            <td width=""86%""  height=""26""  class=""name""><input name=""salary_time"" type=""text""   id=""salary_time""  value="""
Response.write s_salary_time
Response.write """ size=""15"" maxlength=""50""   Class=""DatePick""  onclick=""datedlg.show();"" readonly dataType=""Limit"" min=""1"" max=""50""  msg=""必填"">" & vbcrlf & "              (如:发1月工资,则填写1月份中的任何一天)<span class=""red"">*</span>&nbsp;</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr >" & 	vbcrlf & "            <td width=""16%""  height=""26"" align=""right"" class=""name"">"
Response.write inName5
Response.write "：</td>" & vbcrlf & "            <td width=""86%""  height=""26""  class=""name""><select name=""sortid"" size=""1"" id=""sortid"" dataType=""Limit"" min=""1""  msg=""必选"">" & vbcrlf & "                <option value="""">请选择</option>" & vbcrlf & "                "
sql="select * from hr_perform_sp where del=0 order by id asc"
set rs=conn.execute(sql)
if not rs.eof then
do until rs.eof
...
Response.write inName8
Response.write "：</td>" & vbcrlf & "            <td width=""86%""  height=""26""  class=""name""><select name=""salaryClass"" size=""1"" id=""salaryClass"" dataType=""Limit"" min=""1""  msg=""必选"">" & vbcrlf & "                <option value="""">请选择</option>" & vbcrlf & "                "
sql="select * from hr_perform_result where del=0 order by id asc"
set rs=conn.execute(sql)
if not rs.eof then
do until rs.eof
Response.write "" & vbcrlf & "                <option value="""
...
Response.write "：</td>" & vbcrlf & "            <td width=""86%""  height=""26""  class=""name""><input type=""radio"" name=""allcansee"" value=""1"" "
if allcansee="1" or allcansee="" then
Response.write " checked=""true"""
end if
Response.write "  id=""rbtn1"" />" & vbcrlf & "              <label for=""rbtn1"">所有用户调用</label>" & vbcrlf & "              <input type=""radio"" name=""allcansee"" value=""0"" id=""rbtn2"" "
if allcansee="0" then
Response.write " checked=""true"""
end if
Response.write "  />" & vbcrlf & "              <label for=""rbtn2"">选择调用用户</label>" & vbcrlf & "              <span id=""ulist1"" class=""red""> *&nbsp;</span>" & vbcrlf & "                       <script language=""javascript"">" & vbcrlf & "            function getstr(obj){" & vbcrlf & "                   //obj为对象checkbox数组;" & vbcrlf & "                        var ztstr =new Array();" & vbcrlf & "                        var ii=0;" & vbcrlf & "                       for(var i=0 ;i<obj.length;i++){" & vbcrlf & "                         if(obj[i].checked){" & vbcrlf & "                                     ztstr[ii]=obj[i].value;" & vbcrlf & "                                 ii=ii+1;" & vbcrlf & "                                 }" & vbcrlf & "                      }" & vbcrlf & "                       return ztstr.join("","");" & vbcrlf & "           }" & vbcrlf 	& "                function getmoreperson(){" & vbcrlf & "                       var nowstatuslist=getstr(document.getElementsByName(""ygzt""));" & vbcrlf & "                     var user_w1=getstr(document.getElementsByName(""w1""));" & vbcrlf & "                     var user_w2=getstr(document.getElementsByName(""w2""));" & vbcrlf & "                     var user_liststr="""
Response.write user_list
Response.write """;" & vbcrlf & "                        var user_list=getstr(document.getElementsByName(""w3""));" & vbcrlf & "                   if (user_list.length>0)" & vbcrlf & "                 {" & vbcrlf & "                               if (user_liststr.length>0)" & vbcrlf & "                              {" & vbcrlf & "                                       user_list=user_list+"",""+user_liststr;" & vbcrlf & "                             }" & vbcrlf & "                       }"& vbcrlf & "                      else" & vbcrlf & "                    {" & vbcrlf & "                               user_list=user_liststr;" & vbcrlf & "                 }" & vbcrlf & "                       var TdEndDay = document.getElementById(""startTime"").value;" & vbcrlf & "                        $.post(""share_person_type.asp"",{nowstatus:nowstatuslist,user_w1:user_w1,user_w2:user_w2,user_list:user_list	,TdEndDay:TdEndDay},function(result){" & vbcrlf & "                               document.getElementById(""moreperson"").innerHTML=result;" & vbcrlf & "                   })" & vbcrlf & "              }" & vbcrlf & "               </script>" & vbcrlf & "               "
nowstatuslist=0
If Len(user_list)>0 Then
Set rs=conn.execute("select distinct nowstatus from hr_person where userid in ("&user_list&")")
While Not rs.eof
nowstatuslist=nowstatuslist&","&rs(0)
rs.movenext
wend
rs.close
Set rs=Nothing
end if
if nowstatuslist=0 then nowstatuslist="1,5,7"
Response.write "" & vbcrlf & "             </td>" & vbcrlf & "          </tr>" & vbcrlf & "                                        <tr "
if allcansee="1" or allcansee="" then
Response.write " style=""display:none"""
end if
Response.write " id=""tb1"">" & vbcrlf & "                                                     <td width=""16%""  height=""26"" align=""right"" class=""name"" valign=""top"">" & vbcrlf & "                                                     "
For i=1 To 7
If InStr(","&nowstatuslist&",",","&i&",")>0 Then
checked=" checked "
else
checked=" "
end if
...
Response.write "" & vbcrlf & "                                                     <input type=""checkbox"" name=""ygzt"" onclick=""getmoreperson()"" "
Response.write checked
Response.write " value="""
Response.write i
Response.write """><br>" & vbcrlf & "                                            "
next
Response.write "</td>" & vbcrlf & "            <td width=""84%""  height=""26""  class=""name"" valign=""top""><div id=""moreperson"" ></div></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr class=""buttonTableGray"">" & vbcrlf & "            <td width=""16%""  height=""26"" align=""right"" class=	""name"">&nbsp;</td>" & vbcrlf &  "           <td  height=""26""  class=""name"">"
if action="edit" then
Response.write "" & vbcrlf & "              <input name=""button22"" class=""anybutton2"" onClick=""if(checkw3()==false){return false;};document.all.demo.action='perform_add.asp?action=update&type=save&ord="
Response.write pwurl(ord)
Response.write "'""  value=""保存"" type=""submit"">" & vbcrlf & "              "
else
Response.write "" & vbcrlf & "              <input name=""button23"" class=""anybutton2"" value=""保存""  onClick=""if(checkw3()==false){return false;};document.all.demo.action='perform_add.asp?action=update&type=add'"" type=""submit"">" & vbcrlf & "              "
end if
Response.write "</td>" & vbcrlf & "          </tr>        " & vbcrlf & "      </table></form></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "    <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "        <tr>" & vbcrlf & "          <td height=""1130"" ><div align=	""center""></div></td>" & vbcrlf &"         </tr>" & vbcrlf &  "     </table></td>" & vbcrlf & "  </tr> "& vbcrlf &" </table>" & vbcrlf &" <iframe name=""callBackFrame"" width=""0"" height=""0""></iframe>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf
if allcansee="1" or allcansee="" Then
else
Response.write "<script language='javascript'>getmoreperson();</script>"
end if
on error resume next
conn.close
set conn = nothing
