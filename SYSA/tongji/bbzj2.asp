...
'if request("hiddenflag")="1" then
	...
	elseif px="1" then
		px_Result="order by num1 desc"
	elseif px="2" then
		px_Result="order by num2 desc"
	elseif px="3" then
		px_Result="order by num3 desc"
	elseif px="4" then
		px_Result="order by num4 desc"
	elseif px="5" then
		px_Result="order by num5 desc"
	elseif px="m1" then
		px_Result="order by money1 desc"
	elseif px="m2" then
		px_Result="order by money2 desc"
	elseif px="m3" then
		px_Result="order by money3 desc"
	elseif px="m4" then
		px_Result="order by money4 desc"
	elseif px="m5" then
		px_Result="order by money5 desc"
	end if
	dim C,x
	C=request("C")
	if C <> "" then
		gate_result=" and  (name like '%"& C &"%' or sort1 like '%"& C &"%')"
	end if
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & ""
	Call InitReportBar("挑战纪录")
	Response.write "" & vbcrlf & "" & vbcrlf & "<script src= ""../Script/ti_bbzj2.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=JavaScript1.2></script>" & vbcrlf & "<script>" & vbcrlf & "      function setDay(day,eltName) {" & vbcrlf & "       displayElement.value =displayYear+""-""+(displayMonth + 1)+ ""-"" +day;" & vbcrlf & "       hideElement(eltName);" & vbcrlf & "     document.location.href=""bbdd3.asp?px="
	Response.write px
	Response.write "&C="
	Response.write C
	Response.write "&x=1&jtdate=""+displayYear+""-""+(displayMonth + 1)+""""" & vbcrlf & "     }" & vbcrlf & "" & vbcrlf & "function aa()" & vbcrlf & "{" & vbcrlf & "document.date.action=""bbzj2.asp?px="
	Response.write C
	Response.write px
	Response.write "&jtdate="
	Response.write tdate
	Response.write "&x=1&C=""+document.date.C.value;" & vbcrlf & "document.date.submit();" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function ChecklhbType(values)" & vbcrlf & "{" & vbcrlf & "  //alert(values);" & vbcrlf & "  document.location.href=values + ""?px="
	Response.write tdate
	Response.write px
	Response.write "&jtdate="
	Response.write tdate
	...
	Response.write "&W3="
	Response.write W3
	Response.write "&W4=1&type=1&dongjie=0&huishouzhan=0""" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</SCRIPT>" & vbcrlf & "</head>" & vbcrlf & "<body oncontextmenu=self.event.returnValue=false >" & vbcrlf & ""
	action1="挑战纪录"
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & " <tr>" & vbcrlf & "          <td><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "             <form action=""bbzj2.asp?px="
	Response.write px
	Response.write "&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write """ method=""post""　id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"" > " & vbcrlf & "                       <tr>" & vbcrlf & "                <td  class=""place2"">挑战纪录</td>" & vbcrlf & "                <td  width=""280""> " & vbcrlf & "                           <table width=""100%"" cellspacing=""2"">  " & vbcrlf & "            <tr height=""25"">" & vbcrlf & "            <td align=""center"">"
	Response.write date
	Response.write "</td>" & vbcrlf & "              <td colspan=""3"" align=""center""></td>" & vbcrlf & "            </tr>" & vbcrlf & "                  </table></td>" & vbcrlf & "                <td align=""right"">" & vbcrlf & "                           " & vbcrlf & "                              <div align=""right"">关键词：" & vbcrlf & "                         <input name=""C"" type=""text"" size=""10"" onkeypress=""KeyUp()"" />" & vbcrlf & "                                      " & vbcrlf & "" & vbcrlf & "                            <input type=""button"" onclick=""aa()"" id=""Submit45"" name=""Submit45"" value=""检索"" class=""anybutton2""/>&nbsp;"
	...
	Response.write tdate
	Response.write """>" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" class=""detailTable"" style=""width:100%"">" & vbcrlf & " <tr class=""top"">" & vbcrlf & "    <td height=""26"" ><div align=""center"">姓名</div></td>" & vbcrlf & "      <td colspan=""9"" ><div align=""center"">挑战记录</div></td>" & vbcrlf & "    </tr>" & vbcrlf & " <tr>" & vbcrlf & "      <td height=""27"" >&nbsp;</td>" & vbcrlf & "      <td colspan=""4""  align=""center"">销售记录</td>" & vbcrlf & "       <td colspan=""4""  align=""center"">回款记录</td>" & vbcrlf & "     <td   align=""center"">所在部门</td>" & vbcrlf & "        </tr>" & vbcrlf & " <tr>" & vbcrlf & "      <td height=""26"" ></td>" & vbcrlf & "    <td  colspan=""2""  align=""center"">单日最高</td>" & vbcrlf & "      <td  colspan=""2""  align=""center"">单月最高</td>" & vbcrlf &"   <td  colspan=""2""  align=""center"">单日最高</td>" & vbcrlf & "      <td  colspan=""2""  align=""center"">单月最高</td>" & vbcrlf & "      <td align=""center"">&nbsp;</td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "          <td align=""center"">&nbsp;</td>" & vbcrlf & "            <td  width=""8%"" align=""center""><a href=""bbzj2.asp?px=1&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>数量</u></a></td>" & vbcrlf & "            <td  width=""9%"" align=""center""><a href=""bbzj2.asp?px=m1&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>金额</u></a></td>" & vbcrlf & "            <td  width=""8%"" align=""center""><a href=""bbzj2.asp?px=2&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>数量</u></a></td>" & vbcrlf & "            <td  width=""9%"" align=""center""><a href=""bbzj2.asp?px=m2&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>金额</u></a></td>" & vbcrlf & "            <td  width=""8%"" align=""center""><a href=""bbzj2.asp?px=3&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>数量</u></a></td>" & vbcrlf & "            <td  width=""9%"" align=""center""><a href=""bbzj2.asp?px=m3&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>金额</u></a></td>" & vbcrlf & "            <td  width=""8%"" align=""center""><a href=""bbzj2.asp?px=4&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>数量</u></a></td>" & vbcrlf & "            <td  width=""9%"" align=""center""><a href=""bbzj2.asp?px=m4&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1""><u>金额</u></a></td>" & vbcrlf & "            <td align=""center""><a href=""bbdd3.asp?px=5&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	...
	dim numcg1,numcg2,numcg3,numcg4,numxs1,numxs2,numxs3,numxs4,numkc1,numkc2,numkc3,numkc4,numml1,numml2,numml3,numml4,sumcg1,sumcg2,sumcg3,sumcg4,sumxs1,sumxs2,sumxs3,sumxs4,sumkc1,sumkc2,sumkc3,sumkc4,summl1,summl2,summl3,summl4
	sumcg1=0
	sumcg2=0
	sumcg3=0
	sumcg4=0
	...
	elseif open_5_11=1 then
		gate_str=" and ord in("&intro_5_11&") and ord>0"
	else
		gate_str=" and ord=0"
	end if
	If conn.execute("Select 1 Where exists(Select 1 From contract having count(1) > 1000) And exists(Select 1 From gate having count(1) > 30)").eof Then
		Call DisReportBar()
	else
		Call DoProc(100,1)
	end if
	sql1="select * from (select * from (select ord,name,sorce,"&session("personzbintel2007")&" as cateid,"&_
	" isnull((select top 1 count(date3) as numxz from contract WITH(NOLOCK) where cateid=g.ord and del=1 and isnull(status,-1) in (-1,1) group by date3 order by numxz desc),0) as num1,"&_
	"isnull((select top 1 isnull(sum(money2),0) as numxz from contract WITH(NOLOCK) where cateid=g.ord and del=1 and isnull(status,-1) in (-1,1) group by date3 order by numxz desc),0) as money1,"&_
	"isnull((select top 1 count(date3) as numxz from contract WITH(NOLOCK) where cateid=g.ord and del=1 and isnull(status,-1) in (-1,1) group by year(date3),month(date3) order by numxz desc),0) as num2,"&_
	"isnull((select top 1 isnull(sum(money2),0) as numxz from contract WITH(NOLOCK) where cateid=g.ord and del=1 and isnull(status,-1) in (-1,1) group by year(date3),month(date3) order by numxz desc),0) as money2,"&_
	"isnull((select top 1 count(date5) as numxz from payback WITH(NOLOCK) where cateid=g.ord and del=1 and complete=3 group by date5 order by numxz desc),0) as num3,"&_
	" isnull((select top 1 isnull(sum(money1),0) as numxz from payback WITH(NOLOCK) where cateid=g.ord and del=1 and complete=3 group by date5 order by numxz desc),0) as money3,"&_
	" isnull((select top 1 count(date5) as numxz from payback WITH(NOLOCK) where cateid=g.ord and del=1 and complete=3 group by year(date5),month(date5) order by numxz desc),0) as num4,"&_
	" isnull((select top 1 isnull(sum(money1),0) as numxz from payback WITH(NOLOCK) where cateid=g.ord and del=1 and complete=3 group by year(date5),month(date5) order by numxz desc),0) as money4,"&_
	" (select sort1 from gate1_full where ord=g.sorce) as sort1 from gate as g  where del=1) b where 1=1"&gate_result&gate_str&") a where cateid="&session("personzbintel2007")&" "&px_Result&""
	...
	if rs1.RecordCount<=0 then
		...
		for i=1 to benye.pagesize
			If rs1.eof=True Then Exit for
			Response.write "" & vbcrlf & "" & vbcrlf & "      " & vbcrlf & "         <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td align=""center"">"
			Response.write rs1("name")
			Response.write "</td>" & vbcrlf & "            <td align=""center"" class=""red"">"
			Response.write Formatnumber(zbcdbl(rs1("num1")),num1_dot,-1)
			'Response.write "</td>" & vbcrlf & "            <td align=""center"" class=""red"">"
			Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write Formatnumber(zbcdbl(rs1("money1")),num_dot_xs,-1)
			'Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write "</td>" & vbcrlf & "            <td align=""center"" class=""red"">"
			Response.write Formatnumber(zbcdbl(rs1("num2")),num1_dot,-1)
			'Response.write "</td>" & vbcrlf & "            <td align=""center"" class=""red"">"
			Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write Formatnumber(zbcdbl(rs1("money2")),num_dot_xs,-1)
			'Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write "</td>" & vbcrlf & "            <td align=""center"" class=""red"">"
			Response.write Formatnumber(zbcdbl(rs1("num3")),num1_dot,-1)
			'Response.write "</td>" & vbcrlf & "            <td align=""center"" class=""red"">"
			Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write Formatnumber(zbcdbl(rs1("money3")),num_dot_xs,-1)
			'Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write "</td>" & vbcrlf & "            <td align=""center"" class=""red"">"
			Response.write Formatnumber(zbcdbl(rs1("num4")),num1_dot,-1)
			'Response.write "</td>" & vbcrlf & "            <td align=""center"" class=""red"">"
			Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write Formatnumber(zbcdbl(rs1("money4")),num_dot_xs,-1)
			'Response.write "</td>" & vbcrlf & "            <td align=""right"">"
			Response.write "</td>" & vbcrlf & "            <td align=""center"">"
			Response.write rs1("sort1")
			Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "       "
			sumcg1=sumcg1+zbcdbl(rs1("num1"))
			'Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "       "
			sumcg2=sumcg2+zbcdbl(rs1("num2"))
			'Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "       "
			sumcg3=sumcg3+zbcdbl(rs1("num3"))
			'Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "       "
			sumcg4=sumcg4+zbcdbl(rs1("num4"))
			'Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "       "
			sumcg1m=sumcg1m+zbcdbl(rs1("money1"))
			'Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "       "
			sumcg2m=sumcg2m+zbcdbl(rs1("money2"))
			'Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "       "
			sumcg3m=sumcg3m+zbcdbl(rs1("money3"))
			'Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "       "
			sumcg4m=sumcg4m+zbcdbl(rs1("money4"))
			'Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "       "
		...
		Set rst=conn.execute("select sum(num1) as sumnum1,sum(money1) as summoney1,sum(num2) as sumnum2,sum(money2) as summoney2,sum(num3) as sumnum3,sum(money3) as summoney3,sum(num4) as sumnum4,sum(money4) as summoney4 from (select * from (select ord,name,sorce,"&session("personzbintel2007")&" as cateid,isnull((select top 1 count(date3) as numxz from contract where cateid=g.ord and del=1 group by date3 order by numxz desc),0) as num1,isnull((select top 1 isnull(sum(money2),0) as numxz from contract where cateid=g.ord and del=1 group by date3 order by numxz desc),0) as money1,isnull((select top 1 count(date3) as numxz from contract where cateid=g.ord and del=1 group by year(date3),month(date3) order by numxz desc),0) as num2,isnull((select top 1 isnull(sum(money2),0) as numxz from contract where cateid=g.ord and del=1 group by year(date3),month(date3) order by numxz desc),0) as money2,isnull((select top 1 count(date5) as numxz from payback where cateid=g.ord and del=1 and complete=3 group by date5 order by numxz desc),0) as num3,isnull((select top 1 isnull(sum(money1),0) as numxz from payback where cateid=g.ord and del=1 and complete=3 group by date5 order by numxz desc),0) as money3,isnull((select top 1 count(date5) as numxz from payback where cateid=g.ord and del=1 and complete=3 group by year(date5),month(date5) order by numxz desc),0) as num4,isnull((select top 1 isnull(sum(money1),0) as numxz from payback where cateid=g.ord and del=1 and complete=3 group by year(date5),month(date5) order by numxz desc),0) as money4,(select sort1 from gate1_full where ord=g.sorce) as sort1 from gate as g  where del=1) b where 1=1"&gate_result&gate_str&") a where cateid="&session("personzbintel2007")&"")
		If Not rst.eof then
			Response.write "" & vbcrlf & "     <tr>" & vbcrlf & "          <td ><div align=""center"">所有合计</div></td>" & vbcrlf & "          <td  align=""center"" class=""red"">"
			Response.write Formatnumber(rst("sumnum1"),num1_dot,-1)
			Response.write "</td>" & vbcrlf & "          <td  align=""right"">"
			Response.write Formatnumber(rst("summoney1"),num_dot_xs,-1)
			Response.write "</td>" & vbcrlf & "          <td  align=""right"">"
			Response.write "</td>" & vbcrlf & "          <td  align=""center"" class=""red"">"
			Response.write Formatnumber(rst("sumnum2"),num1_dot,-1)
			Response.write "</td>" & vbcrlf & "          <td  align=""center"" class=""red"">"
			Response.write "</td>" & vbcrlf & "          <td  align=""right"">"
			Response.write Formatnumber(rst("summoney2"),num_dot_xs,-1)
			Response.write "</td>" & vbcrlf & "          <td  align=""right"">"
			Response.write "</td>" & vbcrlf & "          <td  align=""center"" class=""red"">"
			Response.write Formatnumber(rst("sumnum3"),num1_dot,-1)
			Response.write "</td>" & vbcrlf & "          <td  align=""center"" class=""red"">"
			Response.write "</td>" & vbcrlf & "          <td  align=""right""><span class=""name"">"
			Response.write Formatnumber(rst("summoney3"),num_dot_xs,-1)
			Response.write "</td>" & vbcrlf & "          <td  align=""right""><span class=""name"">"
			Response.write "</span></td>" & vbcrlf & "          <td  align=""center"" class=""red"">"
			Response.write Formatnumber(rst("sumnum4"),num1_dot,-1)
			Response.write "</span></td>" & vbcrlf & "          <td  align=""center"" class=""red"">"
			Response.write "</td>" & vbcrlf & "          <td  align=""right"">"
			Response.write Formatnumber(rst("summoney4"),num_dot_xs,-1)
			Response.write "</td>" & vbcrlf & "          <td  align=""right"">"
			Response.write "</td>" & vbcrlf & "          <td  align=""center"" class=""red"">&nbsp;</td>" & vbcrlf & "        </tr>" & vbcrlf & ""
		end if
		rst.close:Set rst=nothing
		Response.write "" & vbcrlf & "" & vbcrlf & "       </table>" & vbcrlf & "  </td>" & vbcrlf & "         </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""10%"" height=""30""></td>" & vbcrlf & "    <td ></td>" & vbcrlf & "    <td width=""79%""><div align=""right"">"
		Response.write benye.showpage()
		Response.write "</div></td>" & vbcrlf & "  </tr>" & vbcrlf & "  "
		rs1.close
		set rs1=nothing
	end if
	Response.write "" & vbcrlf & "  <script src= ""../Script/ti_bbzj2_1.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=javascript></script>" & vbcrlf & " " & vbcrlf & "</table>" & vbcrlf & "</form>            " & vbcrlf & " "
	call close_list(1)
