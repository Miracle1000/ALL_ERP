...
'if W3&""<>"" and W3&""<>"0" then
	...
	Response.write "</strong></td>" & vbcrlf & "    <td width=""3""><img class=""resetElementHidden"" src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf &" <tr class=""top"">" & vbcrlf & "<form method=""POST"" action=""kh6.asp?width_tj="
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "          <input type=""button"" name=""zxt"" value=""折线图分析"" onClick=""window.location.href='kh6.asp?type_tj=2&W1="
	Response.write W1
	Response.write "&W2="
	Response.write W2
	Response.write "&W3="
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "      <input type=""button"" name=""line"" value=""饼图分析"" onClick=""window.location.href='kh6.asp?type_tj=3&W1="
	Response.write W1
	Response.write "&W2="
	Response.write W2
	Response.write "&W3="
	...
	Response.write ">图宽=550</option>" & vbcrlf & "        <option value=""kh6.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=700</option>" & vbcrlf & "        <option value=""kh6.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=1000</option>" & vbcrlf & "        <option value=""kh6.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=1500</option>" & vbcrlf & "        <option value=""kh6.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=2000</option>" & vbcrlf & "        <option value=""kh6.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	if open_1_10=1 or open_1_10=3  then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认将统计结果导出为EXCEL文档？')){window.location.href='kh6.asp?type_tj=4&W1="
		Response.write W1
		Response.write "&W2="
		Response.write W2
		Response.write "&W3="
	...
	dim numcg1,zs1
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select ord,sort1 from sortonehy where gate2=14  order by gate1 desc"
	rs1.open sql1,conn,1,1
	...
	if counts<=0 then
		...
		do until rs1.eof
			set rs=server.CreateObject("adodb.recordset")
			sql="select ord  from  tel  where isnull(sp,0)=0 and jz="&rs1("ord")&"  "&Str_Result2&" "
			rs.open sql,conn,1,1
			numcg1=rs.recordCount
			rs.close
			set rs=nothing
			title=rs1("sort1")
			lburl="../work/telhy.asp?fromTJ=1&A1="&rs1("ord")&"&W1="&W1&"&W2="&W2&"&W3="&W3&"&ret3="&m1&"&ret4="&m2&""
			total1(j,1)=numcg1
			total1(j,2)=title
			total1(j,0)=lburl
			total2(j,0)=title
			...
			rs1.movenext
		Loop
		sql="select count(ord)  from  tel  where isnull(sp,0)=0 and  isnull(jz,0)=0  "&Str_Result2&" "
		numcg1=conn.execute(sql)(0).value
		if sort3=1 then
			lburl="../work/telhy.asp?fromTJ=1&H=30&jz=0"&"&W1="&W1&"&W2="&W2&"&W3="&W3&"&ret3="&m1&"&ret4="&m2&""
		end if
		total1(j,1)=numcg1
		total1(j,2)="无价值评估"
		total1(j,0)=lburl
