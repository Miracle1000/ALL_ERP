...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/Javascript"" src=""../car/Calendar.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/Javascript"" src=""Addtr.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & ""
	set rssp=conn.execute("select top 0 id from sp where gate2=21 order by gate1")
	if rssp.eof then
		spid=0
	else
		spid=rssp(0)
	...
	set rssp=nothing
	If spid&"" = "" Then spid = 0
	Response.write "" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "window.meetSpid = "
	Response.write spid
	Response.write ";" & vbcrlf & "</script>" & vbcrlf & "<script src= ""../Script/mt_Add_meetUse.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "      <style>" & vbcrlf & " #ajaxdiv{" & vbcrlf & "               padding-left:32px;" & vbcrlf & "      }" & vbcrlf & "       #ajaxdiv td{" & vbcrlf & "            border:1px solid #CCC;" & vbcrlf & "  }" & vbcrlf & "       #ajaxdiv tr:first-child td{" & vbcrlf & "border:0px;" & vbcrlf & "             border-left: 1px solid #fff; "& vbcrlf &  "   }" & vbcrlf &"        #ajaxdiv tr:last-child td{" & vbcrlf & "              border:0px;" & vbcrlf & "             border-left: 1px solid #fff;" & vbcrlf & "    }"& vbcrlf &  "      </style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"" onLoad=""car_img('"
	Response.write date
	...
	set ml=new MyClass
	call ml.UpdateMeeting
	me_id=ml.IsNum(request("met_id"))
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">会议室申请添加</td>" & vbcrlf & "            <td></td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "      <form action=""Save_meetUse.asp?ord="
	Response.write ord
	Response.write "&sort1="
	Response.write sort1
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return false"">" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td width=""15%"" height=""30"" ><div align=""left""><img src=""../images/jiantou.gif"">基本信息</div></div></td>" & vbcrlf & "        <td height=""30"" colspan=""5"">" & vbcrlf & "                 <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit422"" value=""保存""  class=""page"" onclick=""return ask()""/>" & vbcrlf & "                 <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "                    </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "            <tr name=""table_tr1"">" & vbcrlf & "                     <td colspan=""6"">" & vbcrlf & "                  <div id=""ajaxdiv"" style=""width:100%;"" align=""center""><img src=""../images/smico/proc.gif""></div></td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td height=""30"" align=""right"">会议室：</td>" & vbcrlf & "                 <td width=""20%"" height=""30"" class=""gray"">" & vbcrlf & "                     <select name=""use_meeting"" id=""use_meeting"" onChange=""Fun_meet(this.value);"">" & vbcrlf & "                         <option value=""0"">请选择</option>" & vbcrlf & "                         "
	sql7="select * from O_Meeting order by id asc "
	set rs7=conn.execute(sql7)
	if not rs7.eof then
		do while not rs7.eof
			...
			Response.write """ "
			if cdbl(me_id)=cdbl(rs7("id")) then Response.write "selected"
			Response.write ">"
	...
	set rs7=nothing
	Response.write "" & vbcrlf & "                      </select>&nbsp;<span class=""red"" id=""test1"">*</span>                        </td>" & vbcrlf & "               <td width=""11%"" height=""30""><div align=""right"">会议主题：</div></td>" & vbcrlf & "                  <td width=""19%"" height=""30"" class=""gray""><input type=""text"" name=""use_title"" id=""use_title"" maxlength=""200"" style=""width:150px"">&nbsp;<span class=""red"" id=""test2"">*</span></td>" & vbcrlf & "             <td width=""14%"" height=""30""><div align=""right"">会议性质：</div></td>" & vbcrlf & "                  <td width=""19%"" height=""30"" class=""gray"">" & vbcrlf & "                 <select name=""use_property"">" & vbcrlf & "                           "
	sql7="select * from O_MeetingSet where set_type=1 order by set_gate1 desc "
	set rs7=conn.execute(sql7)
	if not rs7.eof then
		do while not rs7.eof
			Response.write "" & vbcrlf & "                              <option value="""
	...
	set rs7=nothing
	Response.write "" & vbcrlf & "                      </select></td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td height=""30"" align=""right"">重要程度：</td>" & vbcrlf & "                       <td height=""30"" class=""gray"">" & vbcrlf & "                       <select name=""use_important"">" & vbcrlf & "                             "
	sql7="select * from O_MeetingSet where set_type=2 order by set_gate1 desc "
	set rs7=conn.execute(sql7)
	if not rs7.eof then
		do while not rs7.eof
			Response.write "" & vbcrlf & "                             <option value="""
	...
	set rs7=nothing
	Response.write "" & vbcrlf & "                     </select>                       </td>" & vbcrlf & "               <td height=""30""><div align=""right"">会议纪要员：</div></td>" & vbcrlf & "                  <td height=""30"" class=""gray""><input name=""use_jyyname"" type=""text"" id=""use_jyyname"" size=""20"" maxlength=""400"" onClick=""javascript:window.open('../search/search_person1.asp?parse1=use_jyyname&parse2=use_jyy&sel=1&ord="
	Response.write dev_alike
	Response.write "','neww37win','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');"" readonly=""true"" value=""点击选择人员"" style=""color:#CCCCCC""><input name=""use_jyy"" type=""hidden"" id=""use_jyy"" maxlength=""2000""></td>" & vbcrlf & "               <td height=""30""><div align=""right"">会议主持人：</div></td>" & vbcrlf & "               <td height=""30"" class=""gray""><input name=""use_zcrname"" type=""text"" id=""use_zcrname"" size=""20"" maxlength=""2000"" onClick=""javascript:window.open('../search/search_person4.asp?name=use_zcrname&id=use_zcr&sel=1&ord="
	Response.write dev_alike
	Response.write "','neww37win','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');"" readonly=""true"" value=""点击选择人员"" style=""color:#CCCCCC"">" & vbcrlf & "              <input name=""use_zcr"" type=""hidden"" id=""use_zcr"" maxlength=""2000""></td>" & vbcrlf &"         </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td height=""30"" align=""right"">资源准备：</td>" & vbcrlf & "                       <td height=""30"" colspan=""5"" class=""gray""><input name=""use_device"" type=""text"" id=""use_device"" onClick=""javascript:window.open('Select_Summary.asp?name=use_device&id=use_deviceid&sel=1&ord="
	Response.write dev_alike
	Response.write "','neww37win','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');"" style=""color:#CCCCCC"" value=""点击选择资源"" size=""80"" maxlength=""2000"" readonly=""true""><input name=""use_deviceid"" type=""hidden"" id=""use_deviceid"" ></td>" & vbcrlf & "            </tr>" & vbcrlf & "             <tr>" & vbcrlf & "                    <td height=""30"" align=""right"">出席人员(内)：</td>" & vbcrlf & "               <td height=""30"" colspan=""5"">"
	ReDim d_at(54)
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write CBaseUserTreeHtml(basesql,"", "","","W3",  "", "", "", use_cxry)
	Response.write "&nbsp;<span class=""red"" id=""test3"">*</span></td>" & vbcrlf & "         </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td height=""30"" align=""right"">出席人员(外)：</td>" & vbcrlf & "                   <td height=""30"" colspan=""5"" class=""gray""><input type=""text"" size=""80"" name=""use_cxry2"" id=""use_cxry2"" maxlength=""2000"">" & vbcrlf & "                      人员用逗号&nbsp;,&nbsp;分隔开(例:张三,李四)</td>" & vbcrlf & "             </tr>" & vbcrlf & "              <tr>" & vbcrlf & "                    <td height=""30"" align=""right"">周期会议：</td>" & vbcrlf & "                       <td height=""30"" class=""gray""><input type=""radio"" name=""use_meetingcycle"" value=""1"" checked=""checked"" onClick=""rediobtn('1')"">否<input type=""radio"" name=""use_meetingcycle"" value=""2"" onclick=""rediobtn('2')"">是</td>" & vbcrlf & "                <td height=""30""><div align=""right"" id=""cycle1"" style=""display:none"">开始日期：</div><div align=""right"" id=""cycle5"">开始时间：</div></td>" & vbcrlf & "<td height=""30"" class=""gray""><div align=""left"" id=""cycle2"" style=""display:none""><input type=""text"" name=""use_stardate"" id=""use_stardate"" Class=""DatePick""  onclick=""datedlg.show();"" readonly=""readonly"">&nbsp;<span class=""red"" id=""test6"">*</span></div><div align=""left""id=""cycle6""><input type=""text"" name=""use_startime"" id=""use_startime"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly"">&nbsp;<span class=""red"" id=""test7"">*</span></div></td> "& vbcrlf & "                 <td height=""30""><div align=""right"" id=""cycle3"" style=""display:none"">截止日期：</div><div align=""right"" id=""cycle7"">截止时间：</div></td>" & vbcrlf & "                <td height=""30"" class=""gray""><div align=""left"" id=""cycle4"" style=""display:none""><input type=""text"" name=""use_enddate"" id=""use_enddate"" Class=""DatePick""  onclick=""datedlg.show();"" readonly=""readonly"">&nbsp;<span class=""red"" id=""test8"">*</span></div><div align=""left"" id=""cycle8""><input type=""text"" name=""use_endtime"" id=""use_endtime"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly"">&nbsp;<span class=""red"" id=""test9"">*</span></div></td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tbody id=""addtr"" style=""display:none"">" & vbcrlf & "                     <tr>" & vbcrlf & "                            <td height=""30"" align=""right"">周期明细：</td>" & vbcrlf & "                               <td height=""30"" class=""gray""><a href=""javascript:void(0);"" onClick=""addtr();"">添加</a>&nbsp;1</td>" & vbcrlf & "                              <td height=""30""><div align=""right"" id=""div"">开始时间：</div></td>" & vbcrlf & "                             <td height=""30"" class=""gray""><input type=""text"" name=""startime"" id=""startime_1"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly""><span class=""red"" id=""test10"">*</span></td>" & vbcrlf & "                         <td height=""30""><div align=""right"" id=""div2"">截止时间：</div></td>" & vbcrlf & "                            <td height=""30"" class=""gray""><input type=""text"" name=""endtime"" id=""endtime_1"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly""><span class=""red"" id=""test11"">*</span></td>" & vbcrlf & "                        </tr>" & vbcrlf &  "          </tbody>" & vbcrlf &  "               <tr>" & vbcrlf &  "                   <td height=""30""><div align=""right"">申请时间：</div></td>" & vbcrlf & "                <td height=""30"" class=""gray""><input type=""text"" name=""use_time"" value="
	Response.write now()
	Response.write """ id=""use_time"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly"">&nbsp;<span class=""red"" id=""test4"">*</span></td>" & vbcrlf & "               <td height=""30""><div align=""right"">申请人员：</div></td>" & vbcrlf & "                    <td height=""30"" class=""gray""><input name=""use_catename"" type=""text"" id=""use_catename"" value="""
	Response.write regname
	Response.write """ size=""12"" maxlength=""400"" onClick=""javascript:window.open('../search/search_person1.asp?parse1=use_catename&parse2=use_cateid&sel=1&ord="
	Response.write dev_alike
	Response.write "','neww37win','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');"" readonly=""true""><input name=""use_cateid"" value="""
	Response.write dev_alike
	Response.write gateord
	Response.write """ type=""hidden"" id=""use_cateid"" size=""12"" maxlength=""400"">&nbsp;<span class=""red"" id=""test5"">*</span></td>" & vbcrlf & "                <td height=""30""><div align=""right"">写入日程：</div></td>" & vbcrlf & "                    <td height=""30"" class=""gray""><input type=""radio"" name=""use_intro"" value=""1"" checked=""checked"">否<input type=""radio"" name=""use_intro"" value=""2"">是</td> "& vbcrlf &  "               </tr> "& vbcrlf & "          <tr>" & vbcrlf & "                    <td height=""30"" align=""right"">短信通知：</td>" & vbcrlf & "                       <td height=""30"" colspan=""5"" class=""gray""><input type=""radio"" name=""use_sms"" value=""1"" checked=""checked"">否<input type=""radio"" name=""use_sms"" value=""2"">是</td>" & vbcrlf &  "       </tr>" & vbcrlf & "        <tr>" & vbcrlf & "           <td width=""15%""><p align=""right"">会议内容：</td>" & vbcrlf & "            <td colspan=""5"" class=""gray""><textarea name=""use_note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "          <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=use_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "       </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray"">" & vbcrlf & "                    <div align=""center"">" & vbcrlf & "                        <input type=""submit"" name=""Submit42"" value=""保存"" class=""page"" onclick=""return ask()""/>" & vbcrlf & "                   <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "              </div></td>" & vbcrlf & "      </tr>" & vbcrlf & "    </table></form>" & vbcrlf & "      </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                     <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""ddd"" class=""easyui-dialog"" icon=""icon-search"" title=""会议室制度""  style=""width:550px;height:350px;padding:5px;background:#fafafa;top:0px"" closed=""true"" >" & vbcrlf & "    <div region=""center"" border=""false"" style=""padding:5px;background:#fff;border:1px solid #ccc;width:98%"">" & vbcrlf & "              <div id=""manager_div""></div>" & vbcrlf & "      </div>" & vbcrlf & "  <div region=""south"" border=""false"" style=""padding-top:5px;text-align:right;height:25px;line-height:25px;"">" & vbcrlf & "           <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$('#ddd').window('close');"">关闭</a>" & vbcrlf & " </div>" & vbcrlf & "</div>" & vbcrlf & "<div id=""divsubmit"" class=""submitdiv""><img src=""../images/smico/proc.gif""></div>" & vbcrlf & "<div id=""title"" class=""showdiv""><img src=""../images/smico/proc.gif""></div>" & vbcrlf & ""
	action1="会议室申请添加"
	call close_list(1)
	Response.write "" & vbcrlf & "<script language='javascript'>" & vbcrlf & "var slbl=document.getElementById(""member2_"
	Response.write session("personzbintel2007")
	Response.write """);" & vbcrlf & "if(slbl) slbl.fireEvent(""onclick"");" & vbcrlf & "</script>" & vbcrlf & ""
