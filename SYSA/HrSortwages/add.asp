...
'if hasNumStr(j)<>"" and hasNumStr(j)<>"0" then
	...
	sub index()
		...
		'sub index()
			...
			Response.write Application("sys.info.jsver")
			Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & ".salaryclass li{" & vbcrlf & "   border: 1px solid #C0CCDD;" & vbcrlf & "      line-height: 26px;" & vbcrlf & "      margin: 2px;" & vbcrlf & "    float: left;" & vbcrlf & "    width: 140px;" & vbcrlf & "   text-align: center;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"" src=""../inc/system.js?ver="
			Response.write Application("sys.info.jsver")
			Response.write """></script>" & vbcrlf & "<script src= ""../Script/Hs_add.js?ver="
			Response.write Application("sys.info.jsver")
			Response.write """  language=""JavaScript"" type=""text/JavaScript""></script>" & vbcrlf & "<script src= ""../Script/Hs_add_1.js?ver="
			Response.write Application("sys.info.jsver")
			Response.write """ ></script>" & vbcrlf & "<script src= ""../Script/Hs_add_2.js?ver="
			Response.write Application("sys.info.jsver")
			Response.write """  language=JavaScript1.2></SCRIPT>" & vbcrlf & "</head>" & vbcrlf & "<body  onunload=""window.opener.location.reload();"" >" & vbcrlf & ""
			dim clo
			clo=request("clo")
			if clo<>"" Then
				Response.write "<script language='javascript'>window.close();</script>"
			end if
			Response.write "" & vbcrlf & "<table width=""100%""  border=""0""  cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "<tr>" & vbcrlf & "<td width=""100%"" valign=""top"">" & vbcrlf & "       <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"">" & vbcrlf & "       <tr>" & vbcrlf & "    <td width=""5%"" height=""27""  background=""../images/contentbg.gif""><div align=""center""><img src=""../images/contenttop.gif""height=""27""> </div></td> " & vbcrlf & "       <td width=""95%""  background=""../images/contentbg.gif""><strong><font color=""#1445A6"">设置工资项目</font></strong></td>" & vbcrlf & " </tr>" & vbcrlf & "   </table>" & vbcrlf & "        <form method=""post"" action=""add.asp"" id=""demo"" onsubmit="" return onsubm(this)"" name=""date"" style=""margin:0"">" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "    <tr class=""top""><td colspan=""2""><div align=""left""><input type=hidden name=menu1 value=addto>添加工资项目</div></td></tr>" & vbcrlf & "    <tr>" & vbcrlf & "            <td width=""18%""><div align=""right"">工资项目：</div></td>" & vbcrlf & "            <td width=""82%"">" & vbcrlf & "                  <input name=""sort1"" type=""text"" id=""sort13"" size=""30""  dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1个至50个字之间"">" & vbcrlf & "                        <span class=""red"">*</span>" & vbcrlf & "                </td>" & vbcrlf & "    </tr>" & vbcrlf & "  <tr>" & vbcrlf & "            <td><div align=""right"">类型：</div></td>" & vbcrlf & "          <td><input name=""may""  type=""radio"" id='may1' onchange=""choose(this)"" onpropertychange=""choose(this)"" value=""1"" checked>增项 "& vbcrlf &"                        <input type=""radio"" onchange=""choose(this)"" onpropertychange=""choose(this)""  name=""may"" id='may2' value=""-1"">减项 "& vbcrlf &"                  <input type=""radio"" onchange=""choose(this)"" onpropertychange=""choose(this)"" name=""may"" id='may3' value=""0"">不操作" & vbcrlf & "            <input type=""checkbox""   name=""may4"" id='may4' value=""1""><span id=""span4"">参与应扣计算</span>" & vbcrlf & "               </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td><div align=""right"">计算公式：</div></td>" & vbcrlf & "            <td><input name=""salaryClass"" type=""text"" id=""salaryClass"" size=""60"" maxlength=""500""> 只能包含参数及&nbsp;&nbsp;+&nbsp;&nbsp;-&nbsp;&nbsp;*&nbsp;&nbsp;/&nbsp;&nbsp;(&nbsp;&nbsp;) </td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "         <td><div align=""right"">重要指数：</div></td> "& vbcrlf &  "          <td>" & vbcrlf & "                    <select name=""gate1"" size=""1"">"
			For i=1 To 40
				Response.write "<option>"
				Response.write i
				'Response.write "</option>"
			next
			Response.write "" & vbcrlf & "            </select> (指数越高排在越前面)" & vbcrlf & "            </td>" & vbcrlf & "    </tr>" & vbcrlf & "  <tr>" & vbcrlf & "            <td colspan=""2"">" & vbcrlf & "                  <div class=""salaryclass"" id=""strlist"">" & vbcrlf & "            "
			If ZBRuntime.MC(36000)=False or ZBRuntime.MC(26002)=False Then gzSQL= " and flag<>'$jjcw'"
			If ZBRuntime.MC(18900)=False or ZBRuntime.MC(26002)=False Then gzSQL= gzSQL & " and flag<>'$jjgz'"
			If ZBRuntime.MC(18900)=False Then gzSQL= gzSQL & " and flag<>'$jsgz'"
			If ZBRuntime.MC(18900)=False Then gzSQL= gzSQL & " and flag<>'$JFJE'"
			set rsli=server.CreateObject("adodb.recordset")
			sqlli="select * from hr_SalaryClass Where del=0 " & gzSQL &" order by id  "
			rsli.open sqlli,conn,1,1
			if not rsli.eof then
				do while not rsli.eof
					Response.write "" & vbcrlf & "                                      <li title=""点击复制"
					Response.write rsli("title")
					Response.write """ style=""list-style:none"" id=""salary"
					Response.write rsli("title")
					Response.write rsli("id")
					Response.write """ onclick=""copyClick(this.id)"" "
					if salaryClass=rsli("id")then
					end if
					Response.write ">"
					Response.write rsli("title")
			...
			set rsli=Nothing
			set rsli=server.CreateObject("adodb.recordset")
			sqlli="SELECT * FROM dbo.HrKQ_AttendanceType WHERE Status = 1 AND isRelatedWage = 1 ORDER BY OnlyID ,CreateDate"
			rsli.open sqlli,conn,1,1
			if not rsli.eof then
				do while not rsli.eof
					Response.write "<li title=""点击复制{"
					Response.write rsli("title")
					Response.write UnitName(rsli("Unit"))
					Response.write "}"" style=""list-style:none"" id=""appholiday"
					Response.write UnitName(rsli("Unit"))
					Response.write rsli("id")
					Response.write """ onclick=""copyClick(this.id)"" >{"
					Response.write rsli("title")
			...
			Response.write "" & vbcrlf & "                      </div>" & vbcrlf & "          </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td colspan=""2"">" & vbcrlf & "                  <div align=""center"">" & vbcrlf & "                              <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "                              <input type=""reset"" value=""重填"" class=""page"" name=""B2"" />" & vbcrlf & "                       </div>" & vbcrlf & "          </td>" & vbcrlf & "   </tr>    " & vbcrlf & "    <tr>" & vbcrlf & "        <td colspan=""2"">" & vbcrlf & "            <p style=""color:red"">温馨提示:当选择减项时，勾选参与应扣计算，则此项算在应扣里；</p>" & vbcrlf & "             <p style=""color:red"">&nbsp &nbsp &nbsp 如果不勾选参与应扣计算，则此项算在应发里；</p>" & vbcrlf & "        </td>" & vbcrlf & "    </tr>" & vbcrlf & "  </table>" & vbcrlf & "        </form>" & vbcrlf & "</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr>" & vbcrlf & "<td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" ><tr><td height=""80"" ><div align=""center""></div></td></tr></table>" & vbcrlf & " "
			call db_close : Response.end
		end sub
		sub addto()
			dim sort1,may,gate1,ord,may4
			may4=SaveRequestForm("may4")
			If may4 = "" Or IsNumeric(may4) = false Then may4 = 0
			sort1=SaveRequestForm("sort1")
			may=SaveRequestForm("may")
			gate1=SaveRequestForm("gate1")
			salaryClass=SaveRequestForm("salaryClass")
			if instr(salaryClass,"{个人所得税}")>0 and salaryClass<>"{个人所得税}" then
				Response.write("<script language='javascript' type='text/javascript'>alert('个人所得税不能与别的栏目关联');history.back()</script>")
				call db_close : Response.end
			ElseIf instr(salaryClass,"{年终奖}")>0 and salaryClass<>"{年终奖}" then
				Response.write("<script language='javascript' type='text/javascript'>alert('年终奖不能与别的栏目关联');history.back()</script>")
				call db_close : Response.end
			ElseIf instr(salaryClass,"{年终奖所得税}")>0 and salaryClass<>"{年终奖所得税}" then
				Response.write("<script language='javascript' type='text/javascript'>alert('年终奖所得税不能与别的栏目关联');history.back()</script>")
				call db_close : Response.end
			end if
			if sort1 = "" Then message="* 请填写工资项目！\n"
			if gate1 = "" Then message="* 请填写重要指数！\n"
			if salaryClass="" Then message="* 请填写关联项目！\n"
			if instr(sort1,"子女教育")>0 or instr(sort1,"继续教育")>0 or instr(sort1,"大病医疗")>0 or instr(sort1,"住房贷款")>0  or instr(sort1,"住房租金")>0 or instr(sort1,"赡养老人")>0 then
				message="* 此工资项目已存在，请添加其它工资项目！\n"
				call error(""&message&"")
			end if
			sql = "select * from sortwages where sort1= '"&sort1&"'"
			Set Rs = server.CreateObject("adodb.recordset")
