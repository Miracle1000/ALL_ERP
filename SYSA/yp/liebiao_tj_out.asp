...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td colspan=""2""><a href=""###"" class=""AfterQuickSearch"" onClick=""document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';return false;""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a>     </td>" & vbcrlf & "           </tr>" & vbcrlf & "          " & vbcrlf & "         <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">人员选择：</div></td>" & vbcrlf & "<td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">领用类型：</div></td>" & vbcrlf & "         <td>" & vbcrlf & "             <input name=""N"" type=""checkbox"" id=""N"" value=""1"">用品发放" & vbcrlf & "                   <input name=""N"" type=""checkbox"" id=""N"" value=""2"">用品申请" & vbcrlf & "                      </td>" & vbcrlf & "             </tr>" & vbcrlf & " <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">分类属性：</div></td>" & vbcrlf & "              <td>" & vbcrlf & "             <input name=""attr"" type=""checkbox"" id=""attr"" value=""1"">易耗品" & vbcrlf & "                   <input name=""attr"" type=""checkbox"" id=""attr"" value=""2"">非易耗品" & vbcrlf & "                        </td>" & vbcrlf & "             </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">领用主题：</div></td>" & vbcrlf & "         <td><input name=""C"" type=""text"" id=""C"" size=""15"" /></td>" & vbcrlf & "       </tr>" & vbcrlf & "          <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">领用编号：</div></td>" & vbcrlf & "         <td><input name=""D"" type=""text"" id=""D"" size=""15"" /></td>" & vbcrlf & "       </tr>" & vbcrlf & "      <tr onMouseOut=is.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "          <td><div align=""right"">用品编号：</div></td>" & vbcrlf & "      <td><input name=""F"" type=""text"" id=""F"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">用品型号：</div></td>" & vbcrlf & "      <td><input name=""G"" type=""text"" id=""G"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onmouseover=""this.style.backgroundColor='efefef'"" onmouseout=""this.style.backgroundColor=''"">" & vbcrlf & "    <td><div align=""right"">批号：</div></td>" & vbcrlf & "    <td><input name=""H"" type=""text"" id=""H"" size=""15"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onmouseover=""this.style.backgroundColor='efefef'"" onmouseout=""this.style.backgroundColor=''"">" & vbcrlf & "    <td><div align=""right"">序列号：</div></td>" & vbcrlf & "    <td><input name=""I"" type=""text"" id=""I"" size=""15"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onmouseover=""this.style.backgroundColor='efefef'"" onmouseout=""this.style.backgroundColor=''"">"& vbcrlf & "    <td><div align=""right"">供应商：</div></td>" & vbcrlf & "    <td><input name=""M"" type=""text"" id=""M"" size=""15"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onmouseover=""this.style.backgroundColor='efefef'"" onmouseout=""this.style.backgroundColor=''"">" & vbcrlf & "    <td><div align=""right"">明细备注：</div></td>" & vbcrlf & "    <td><input name=""J"" type=""text"" id=""J"" size=""30"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  " & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">领用日期：</div></td>" & vbcrlf & "        <td>自：<input name=""ret"" type=""text"" size=""9"" value="""" id=""daysOfMonthPos"" onmouseup=toggleDatePicker(""daysOfMonth"",""date.ret"") readonly=""true""><DIV id=daysOfMonth style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<input name=""ret2"" type=""text"" size=""9"" value="""" id=""daysOfMonthPos1"" onmouseup=toggleDatePicker(""daysOfMonth1"",""date.ret2"") readonly=""true""><DIV id=daysOfMonth1 style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "  </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''""onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "       <td><div align=""right"">添加日期：</div></td>" & vbcrlf & "      <td>自：<input name=""L1"" type=""text"" size=""9"" value="""" id=""daysOfMonthPosL1"" onmouseup=toggleDatePicker(""daysOfMonthL1"",""date.L1"") readonly=""true""><DIV id=daysOfMonthL1 style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<input name=""L2"" type=""text"" size=""9"" value="""" id=""daysOfMonthPosL2"" onmouseup=toggleDatePicker(""daysOfMonthL2"",""date.L2"") readonly=""true""><DIV id=daysOfMonthL2 style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "  </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''""onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "<td><input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "     </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
