...
'if isnull(values) then IsTime = null : exit function
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "function ask1(tp)" & vbcrlf & "{" & vbcrlf & "     var chk_title=document.getElementById('chk_title').value;" & vbcrlf & "       var chk_cateid=document.getElementById('chk_cateid').value;" & vbcrlf & "     var Chk_bkid=document.getElementsByName('Chk_bkid');" & vbcrlf & "     var Chk_pdnum=document.getElementsByName('Chk_pdnum');" & vbcrlf & "  if(chk_title=="""")" & vbcrlf & " {" & vbcrlf & "               document.getElementById('test1').innerHTML=""* 必填"";" & vbcrlf & "              return false;" & vbcrlf & "   }" & vbcrlf & "       else"& vbcrlf & "       {document.getElementById('test1').innerHTML=""*"";}" & vbcrlf & " if(chk_cateid=="""")" & vbcrlf & "        {" & vbcrlf & "               document.getElementById('test2').innerHTML=""* 必填"";" & vbcrlf & "              return false;" & vbcrlf & "   }" & vbcrlf & "       else" & vbcrlf & "    {document.getElementById('test2').innerHTML=""*"";}" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "  margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "img{" & vbcrlf & "border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "#adddiv{" & vbcrlf & "width:1000px;" & vbcrlf & "height:300px;" & vbcrlf & "OVERFLOW:auto;" & vbcrlf & "SCROLLBAR-FACE-COLOR:#F0F4FD;SCROLLBAR-HIGHLIGHT-COLOR:#ffffff;SCROLLBAR-SHADOW-COLOR:#919192;SCROLLBAR-3DLIGHT-COLOR:#ffffff;SCROLLBAR-ARROW-COLOR:#919192;SCROLLBAR-TRACK-COLOR:#ffffff;SCROLLBAR-DARKSHADOW-COLOR:#ffffff;}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">       " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">盘点修改</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & "         "
	set ml=new myClass
	ord=ml.IsNum(request("ord"))
	sql="select a.*,b.name from O_ChkBook a left join gate b on a.chk_cateid=b.ord where a.id="&ord
	set rs=conn.execute(sql)
	if not rs.eof then
		Response.write "" & vbcrlf & "       <form action=""SaveUpdate_Check.asp?ord="
		Response.write ord
		Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)&&ask1()"">" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td width=""15%"" height=""27"" ><div align=""left""><strong>基本信息</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "                  <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit44"" value=""保存"" class=""page""/>" & vbcrlf & "                <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "              </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "            <tr>" & vbcrlf & "                    <td height=""30""><div align=""right"">盘点主题：</div></td>" & vbcrlf & "                    <td width=""23%""><input type=""text"" name=""chk_title"" id=""chk_title"" maxlength=""500"" value="""
		Response.write rs("chk_title")
		Response.write """>&nbsp;<span id=""test1"" class=""red"">*</span></td>" & vbcrlf & "                 <td width=""12%""><div align=""right"">盘点时间：</div></td>" & vbcrlf & "                    <td width=""16%""><input name=""chk_time"" type=""text"" size=""18"" style=""width:140px"" value="""
		Response.write rs("chk_time")
		Response.write """ id=""daysOfMonthPosy"" onclick=""datedlg.showDateTime();"" readonly=""true""><DIV id=""daysOfMonthy"" style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "                <td width=""12%""><div align=""right"">盘点人员：</div></td>" & vbcrlf & "                    <td width=""19%""><input type=""text"" name=""chk_name"" readonly=""true"" id=""chk_name"" style=""width:150px;"" maxlength=""200"" onClick=""javascript:window.open('../search/search_person1.asp?parse1=chk_name&parse2=chk_cateid','neww37win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');"" value="""
		Response.write rs("name")
		Response.write """><input type=""hidden"" name=""chk_cateid"" value="""
		Response.write rs("chk_cateid")
		Response.write """ id=""chk_cateid"" maxlength=""200"">&nbsp;<span id=""test2"" class=""red"">*</span></td>" & vbcrlf & "         </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td height=""30""><div align=""right"">盘点备注：</div></td>" & vbcrlf & "                    <td colspan=""5""><textarea name=""chk_note"" style=""display:none"" cols=""1"" rows=""1"">"
		Response.write rs("chk_note")
		Response.write "</textarea>" & vbcrlf & "          <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=chk_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "              </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray"">" & vbcrlf & "                        <div align=""center"">" & vbcrlf & "                      <input type=""submit"" name=""Submit44"" value=""保存"" class=""page""/>" & vbcrlf & "                        <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "                 </div></td>" & vbcrlf & "        </tr> " & vbcrlf & "    </table>" & vbcrlf & "     </fo0rm>" & vbcrlf & "       "
	else
		Response.write "<div align='center'>记录不存在或已删除！</div>"
	end if
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "      </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "    </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="图书盘点修改"
	call close_list(1)
