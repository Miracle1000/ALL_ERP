...
'Public Function AddFormValue(name,  value)
	...
	dotstr_num=""
		for i=1 to num1_dot
			...
			xlApplication.ActiveSheet.Columns(9 ).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(9 ).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(10).ColumnWidth=12
			...
			xlApplication.ActiveSheet.Columns(11+ProductAttrColNum).NumberFormatLocal = "#,##0."&dotstr_num&"_ "
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(11+ProductAttrColNum).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(11+ProductAttrColNum).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12+ProductAttrColNum).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12+ProductAttrColNum).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12+ProductAttrColNum).NumberFormatLocal = "#,##0."&dotstr_num&"_ "
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(13+ProductAttrColNum).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(13+ProductAttrColNum).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(13+ProductAttrColNum).NumberFormatLocal = "#,##0."&dotstr_num&"_ "
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(14+ProductAttrColNum).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(14+ProductAttrColNum).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(15+ProductAttrColNum).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(15+ProductAttrColNum).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(16+ProductAttrColNum).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(16+ProductAttrColNum).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(17+ProductAttrColNum).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(17+ProductAttrColNum).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(18+ProductAttrColNum).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(18+ProductAttrColNum).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(19+ProductAttrColNum).ColumnWidth=12
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(19+ProductAttrColNum).HorizontalAlignment=3
			xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
			xlWorksheet.Cells(1,1 ).Value = "借货主题"
			xlWorksheet.Cells(1,1 ).font.Size=10
			xlWorksheet.Cells(1,1 ).font.bold=true
			xlWorksheet.Cells(1,2 ).Value = "借货编号"
			xlWorksheet.Cells(1,2 ).font.Size=10
			xlWorksheet.Cells(1,2 ).font.bold=true
			xlWorksheet.Cells(1,3 ).Value = "借货状态"
			xlWorksheet.Cells(1,3 ).font.Size=10
			xlWorksheet.Cells(1,3 ).font.bold=true
			xlWorksheet.Cells(1,4 ).Value = "借货日期"
			...
			if isOpenProductAttrV then
				xlWorksheet.Cells(1,11).Value = "产品属性1"
				xlWorksheet.Cells(1,11).font.Size=10
				xlWorksheet.Cells(1,11).font.bold=true
				xlWorksheet.Cells(1,12).Value = "产品属性2"
				xlWorksheet.Cells(1,12).font.Size=10
				xlWorksheet.Cells(1,12).font.bold=true
			end if
			xlWorksheet.Cells(1,11+ProductAttrColNum).Value = "借货数量"
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,11+ProductAttrColNum).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,11+ProductAttrColNum).font.bold=true
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,12+ProductAttrColNum).Value = "转合同数"
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,12+ProductAttrColNum).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,12+ProductAttrColNum).font.bold=true
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,13+ProductAttrColNum).Value = "归还数"
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,13+ProductAttrColNum).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,13+ProductAttrColNum).font.bold=true
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,14+ProductAttrColNum).Value = "应还日期"
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,14+ProductAttrColNum).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,14+ProductAttrColNum).font.bold=true
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,15+ProductAttrColNum).Value = "实还日期"
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,15+ProductAttrColNum).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,15+ProductAttrColNum).font.bold=true
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,16+ProductAttrColNum).Value = "仓库"
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,16+ProductAttrColNum).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,16+ProductAttrColNum).font.bold=true
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,17+ProductAttrColNum).Value = "批号"
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,17+ProductAttrColNum).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,17+ProductAttrColNum).font.bold=true
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,18+ProductAttrColNum).Value = "序列号"
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,18+ProductAttrColNum).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,18+ProductAttrColNum).font.bold=true
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,19+ProductAttrColNum).Value = "包装"
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,19+ProductAttrColNum).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,19+ProductAttrColNum).font.bold=true
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,20+ProductAttrColNum).Value = "备注"
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,20+ProductAttrColNum).font.Size=10
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Cells(1,20+ProductAttrColNum).font.bold=true
			xlWorksheet.Cells(1,12).font.bold=true
			xlWorksheet.Range("A1:P1").Borders.LineStyle=1
			Response.Flush
...
'elseif px=8 then
			...
			rs1.close
			set rs1=nothing
			if open_37_10=3 then
				list=""
			elseif open_37_10=1 then
				list="and cateid in ("&intro_37_10&")"
			else
				list="and cateid=0"
			end if
			...
			list="and cateid=0"
			set rs=server.CreateObject("adodb.recordset")
			sql="select *,CONVERT(VARCHAR(10),kujh.date3,120) date3 from kujh  "&Str_Result&" "&px_Result&""
			rs.open sql,conn,1,1
			C1=rs.recordcount
			xlApplication.Init "借货单_"&session("name2006chen")&".xls",C1
			dim i
			i=1
			j=1
			...
			do until rs.eof
				...
				cateidname=""
				xlWorksheet.Cells(1+i,2).Value = jhbh
				cateidname=""
				xlWorksheet.Cells(1+i,2).font.Size=10
				cateidname=""
				xlWorksheet.Cells(1+i,3).Value = zt
				cateidname=""
				xlWorksheet.Cells(1+i,3).font.Size=10
				cateidname=""
				xlWorksheet.Cells(1+i,4).Value =date3
				cateidname=""
				xlWorksheet.Cells(1+i,4).font.Size=10
				cateidname=""
				xlWorksheet.Cells(1+i,5).Value = cateidname
				cateidname=""
				xlWorksheet.Cells(1+i,5).font.Size=10
				cateidname=""
				xlWorksheet.Cells(1+i,6).Value = cateout
				cateidname=""
				xlWorksheet.Cells(1+i,6).font.Size=10
				cateidname=""
				sql1 = "select jl.id, case when len(isnull(nl.serinum,''))>0 then 1 else isnull(jl.num1,0) end as num1,isnull(jl.num2,0) as num2,isnull((select sum(num1) from contractlist where del=1 and kujhlist=jl.id),0) as contract_num, "&_
				"   jl.ord,jl.unit,jl.ku,jl.ph,jl.date2,jl.date3,jl.bz,jl.price1,jl.ku2, case when isnull(s2.id,0)=0 then jl.xlh else nl.serinum end xlh,jl.ProductAttr1,jl.ProductAttr2 "&_
				"  from kujhlist jl "&_
				"  inner join kuoutlist2 k2 on k2.contractlist=jl.id "&_
				"  inner join kuout kt on k2.kuout=kt.ord and kt.sort1=6 "&_
				...
				"  where jl.kujh="&id&_
				"  order by jl.date7 asc,jl.id asc "
				set rs1 = server.CreateObject("adodb.recordset")
				rs1.open sql1,conn,1,1
				if rs1.eof then
				else
					do until rs1.eof
						...
						If num2 & "" = "" Then num2 = 0
						contract_num = rs1("contract_num")
						dateYH = rs1("date2")
						dateSH = rs1("date3")
						unit=rs1("unit")
						ProductAttr1=rs1("ProductAttr1")
						ProductAttr2=rs1("ProductAttr2")
						sql6 = "select * from product where ord="&ord&""
						...
						if ck1<>"" then
							set rs7=server.CreateObject("adodb.recordset")
							sql7="select sort1 from sortck  where ord="&ck1&""
							rs7.open sql7,conn,1,1
							if rs7.eof then
								ck1name=""
							else
						...
						if ck2<>"" then
							set rs7=server.CreateObject("adodb.recordset")
							sql7="select sort1 from sortck  where ord="&ck2&""
							rs7.open sql7,conn,1,1
							if rs7.eof then
								ck2name=""
							else
						...
						i=i+1
						set rs7=nothing
						xlWorksheet.Cells(1+i,1).Value = "借货明细"
						set rs7=nothing
						xlWorksheet.Cells(1+i,1).font.Size=9
						set rs7=nothing
						xlWorksheet.Cells(1+i,1).font.color=333333
						set rs7=nothing
						xlWorksheet.Cells(1+i,7).Value = product
						set rs7=nothing
						xlWorksheet.Cells(1+i,7).font.Size=10
						set rs7=nothing
						xlWorksheet.Cells(1+i,8).Value = order1
						set rs7=nothing
						xlWorksheet.Cells(1+i,8).font.Size=10
						set rs7=nothing
						xlWorksheet.Cells(1+i,9).Value = type1
						set rs7=nothing
						xlWorksheet.Cells(1+i,9).font.Size=10
						set rs7=nothing
						xlWorksheet.Cells(1+i,10).Value = unitname
						set rs7=nothing
						xlWorksheet.Cells(1+i,10).font.Size=10
						set rs7=nothing
						if isOpenProductAttrV then
							xlWorksheet.Cells(1+i,11).Value = GetProductAttrNameById(ProductAttr1)
'if isOpenProductAttrV then
							xlWorksheet.Cells(1+i,11).font.Size=10
'if isOpenProductAttrV then
							xlWorksheet.Cells(1+i,12).Value =  GetProductAttrNameById(ProductAttr2)
'if isOpenProductAttrV then
							xlWorksheet.Cells(1+i,12).font.Size=10
'if isOpenProductAttrV then
						end if
						xlWorksheet.Cells(1+i,11+ProductAttrColNum).Value = num1
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,11+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,12+ProductAttrColNum).Value = contract_num
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,12+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,13+ProductAttrColNum).Value = num2
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,13+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,14+ProductAttrColNum).Value = dateYH
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,14+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,15+ProductAttrColNum).Value = dateSH
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,15+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,16+ProductAttrColNum).Value = ck2name
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,16+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,17+ProductAttrColNum).Value = ph
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,17+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,18+ProductAttrColNum).Value = xlh
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,18+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,19+ProductAttrColNum).Value = sortname
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,19+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,20+ProductAttrColNum).Value = intro
'if isOpenProductAttrV then
						xlWorksheet.Cells(1+i,20+ProductAttrColNum).font.Size=10
'if isOpenProductAttrV then
						rs1.movenext
					loop
				end if
			...
			rs.close
			set rs=Nothing
			Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>借货单导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!借货单导出成功,共有"&(j-1)&"条记录!</B>"";</script>"
			set rs=Nothing
			Response.write "" & vbcrlf & "</BODY>" & vbcrlf & "</HTML>" & vbcrlf & ""
			Set fs = CreateObject("Scripting.FileSystemObject")
			tfile=Server.MapPath("借货单_"&session("name2006chen")&".xls")
			...
			Response.write """><font class=""red""><strong><u>下载导出的借货单</u></strong></font></a></p> " & vbcrlf & ""
