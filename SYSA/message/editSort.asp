...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "" & vbcrlf & "<body bgcolor=""#ebebeb""  "
	'Response.write Application("sys.info.jsver")
	if open_67_8=0 then
	...
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			...
			Response.write  currpage
			Response.write "','editMessageSort','width=' + 600 + ',height=' + 400 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=200,top=150')""/>&nbsp;&nbsp;"
			Response.write  currpage
			if open_67_3=3 or open_67_3=1  then
				Response.write "" & vbcrlf & "      <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='delSort.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "&currPage="
				Response.write  currpage
				Response.write "'}""/>"
