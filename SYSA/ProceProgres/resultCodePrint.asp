...
'cn.close
	...
	Sub Page_load
		Dim codeType :codeType = app.getInt("codeType")
		Response.write "<div style='text-align:right'><button class='oldbutton' onclick='window.print()'>打印</button></div><br>"
'Dim codeType :codeType = app.getInt("codeType")
		If codeType = 2 Then
			Response.write "<div style='text-align:center'><img src='../code2/view.asp?sn=view&ct=46&data=ZJJG:1&width=120&errorh=3'></div><div style='text-align:center'>Y</div><br>"
'If codeType = 2 Then
			Response.write "<div style='text-align:center'><img src='../code2/view.asp?sn=view&ct=46&data=ZJJG:2&width=120&errorh=3'></div><div style='text-align:center'>N</div><br>"
'If codeType = 2 Then
			Response.write "<div style='text-align:center'><img src='../code2/view.asp?sn=view&ct=46&data=ZJJG:3&width=120&errorh=3'></div><div style='text-align:center'>S</div>"
'If codeType = 2 Then
		ElseIf codeType = 128 Then
			Response.write "<div style='text-align:center'><img src='../code2/viewCode.asp?codeType=128&title=Y&data=ZJJG:1&height=60' ></div><div style='text-align:center'>Y</div><br>"
'ElseIf codeType = 128 Then
			Response.write "<div style='text-align:center'><img src='../code2/viewCode.asp?codeType=128&title=N&data=ZJJG:2&height=60' ></div><div style='text-align:center'>N</div><br>"
'ElseIf codeType = 128 Then
			Response.write "<div style='text-align:center'><img src='../code2/viewCode.asp?codeType=128&title=S&data=ZJJG:3&height=60' ></div><div style='text-align:center'>S</div>"
'ElseIf codeType = 128 Then
		end if
	end sub
%>
