...
'sub index()
		...
		Response.write Application("sys.info.jsver")
		Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"">" & vbcrlf & "<!--" & vbcrlf & "function MM_jumpMenu(targ,selObj,restore){ //v3.0" & vbcrlf & "eval(targ+"".location=\'""+selObj.options[selObj.selectedIndex].value+""\'"");" & vbcrlf & "if (restore) selObj.selectedIndex=0;" & vbcrlf & "}" & vbcrlf & "function ask() { " & vbcrlf & "        document.getElementById(""demo"").action = ""add_cp.asp?sort=2""; " & vbcrlf & "}" & vbcrlf & "function ask2() { " & vbcrlf & "   document.getElementById(""demo"").action = ""add_cp.asp?sort=3""; " &vbcrlf & "}" & vbcrlf & "//-->" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & ""
		Response.write Application("sys.info.jsver")
		dim clo
		clo=request("clo")
		if clo<>"" then
			Response.write "" & vbcrlf & "<script language='javascript'>window.opener.location.reload();window.close();</script>" & vbcrlf & ""
		end if
		rd=request("rd")
		if rd<>"" then
			set rs=server.CreateObject("adodb.recordset")
			sql="select *  from MessagePersonClass Where id="&rd&" "
		...
		session("smsPsmenu_list")=request.QueryString("id")
		Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"">" & vbcrlf & "        <tr>" & vbcrlf & "          <td width=""5%"" height=""27""  background=""../images/contentbg.gif""><div align=""center""><img src=""../images/contenttop.gif""height=""27""> </div></td>" & vbcrlf & "          <td width=""95%""  background=""../images/contentbg.gif""><strong><font color=""#1445A6"">联系人分组设置</font></strong> </td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>" & vbcrlf & "     <form name=""date"" method=""post"" action=""add_cp.asp"" onsubmit=""return Validator.Validate(this,2)"" id=""demo"" style=""margin:0"">" & vbcrlf & "     <table width=""100%"" border=""0""cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "          <span style=""font-size: 9pt"">" & vbcrlf & "          <input type=hidden name=menu1 value=addto>" & vbcrlf & "          </span>" & vbcrlf & "          <tr class=""top"">" & vbcrlf & "            <td  colspan=""2""><div align=""center"">添加联系人分组</div></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""15%"" align=""right"" height=""33"">上级分组：</td>" & vbcrlf & "            <td width=""85%""><IFRAME name=""I2"" SRC=""correct.asp?ID=company"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""95%"" HEIGHT=""27"" marginwidth=""1"" marginheight=""1""></IFRAME></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""15%"" align=""right"" height=""33"">分组名称：</td>" & vbcrlf & "            <td width=""85%""><input name=""menuname"" type=""text"" id=""menuname"" value="""
		Response.write  menuname
		Response.write """ size=""20"" dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1至50个字之间"" ></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""15%"" align=""right"" height=""33"">分组排序：</td>" & vbcrlf & "            <td width=""85%""><input name=""gate1"" type=""text"" id=""gate1"" value="""
		Response.write  gate1
		Response.write """ maxlength=8  onkeyup=""value=value.replace(/\D/g,'')""  size=""10"">" & vbcrlf & "              （排序框里只能输入数字，排序时将按照数字从大到小排序）</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""15%"" align=""right"" height=""33"">使用范围：</td>" & vbcrlf & "        <td width=""85%""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                <tr class=""gray"">" & vbcrlf & "                  <td style=""padding:5px""><input type=""radio"" name=""allcansee"" value=""1"" checked=""true"" id=""rbtn1"" onclick=""document.getElementById('tb1').style.display='none';"" />" & vbcrlf & "                    <label for=""rbtn1"">允许所有用户使用</label>" & vbcrlf & "                    <input type=""radio"" name=""allcansee"" value=""0"" id=""rbtn2"" onclick=""document.getElementById('tb1').style.display='';"" />" & vbcrlf & "                    <label for=""rbtn2"">选择允许使用用户</label>" & vbcrlf & "                    <span id=""ulist1"" class=""red""></span> </td>" & vbcrlf & "                </tr>" & vbcrlf & "                <tr style=""display:none"" id=""tb1"">" & vbcrlf & "            <td style=""padding:5px"">"
		ReDim d_at(54)
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
		...
		Response.write CBaseUserTreeHtml(basesql,"orgsid", "W1","W2","W3",  W1 & "," & W2, W1, W2,  W3)
		
		Response.write "</td>" & vbcrlf & "                </tr>" & vbcrlf & "              </table></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td height=""35"" bordercolorlight=""#000000"" bordercolordark=""#000000"" bordercolor=""#CCFFFF"" colspan=""2""><div align=""center"">" & vbcrlf & "                <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "                <input type=""submit"" name=""Submit42"" value=""增加"" onClick=""ask();"" class=""page""/>" & vbcrlf & "                <input type=""submit"" name=""Submit423"" value=""复制"" onClick=""ask2();"" class=""page""/>" & vbcrlf & "                <input type=""reset"" value=""重填"" class=""page"" name=""B2"" />" & vbcrlf & "             </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & "   </form>" & vbcrlf & "         </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "    <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "        <tr>" & vbcrlf & "          <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</center>" & vbcrlf & "</div>" & vbcrlf & ""
		call db_close : Response.end
	end sub
	sub addto()
		dim sort1,gate1,ord
		...
		if id1="" then id1=0
		set rs=conn.execute("select title,depth from MessagePersonClass where id="&id1)
		if rs.eof then
			gate2=0
		else
			gate2=rs("depth")
		...
		if gate1="" Or IsNumeric(gate1)=false then
			gate1=0
		end if
		sort=request("sort")
		if sort<>"" then
		...
		allcansee=request("allcansee")
		if allcansee="1" then
			W1=0
			W2=0
			W3=0
		else
			W1=replace(trim(request.form("W1"))," ","")
			W2=replace(trim(request.form("W2"))," ","")
			W3=replace(trim(request.form("W3"))," ","")
		end if
		W3=getW3(W1,W2,W3)
		If W3&""="0" Or W3&""="" Then W3="0,0"
		if menuname = "" then
			Response.write"<script language=javascript>alert('请填写分类！');history.back()</script>"
			call db_close : Response.end
		end if
		sql = "select id from MessagePersonClass where title='"&menuname&"' and parent="&id1&""
		Set Rs = server.CreateObject("adodb.recordset")
		Rs.open sql,conn,3,2
		if rs.eof  then
		else
			Response.write"<script language=javascript>alert('此分类已存在，请添加其它新的分类！');history.back()</script>"
			call db_close : Response.end
		end if
		rs.close
		set rs=nothing
		sqlStr="Insert Into MessagePersonClass(parent,title,sort,depth,User_List,addcate) values('"
		sqlStr=sqlStr & id1 & "','"
		...
		rs.close
		if sort=1 then
			Response.redirect "add_cp.asp?clo=35"
		elseif sort=2 then
			Response.redirect "add_cp.asp?id="&id1&""
		elseif sort=3 then
			Response.redirect "add_cp.asp?rd="&rd&"&id="&id1&""
		end if
	end sub
	conn.close
	set conn = nothing
