...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td colspan=""2""><a href=""###"" class=""AfterQuickSearch"" onClick=""document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';return false;""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td>" & vbcrlf & "        </tr>" & vbcrlf & "           <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">人员选择：</div></td>" & vbcrlf & "<td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td></tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">用品单位：</div></td>" & vbcrlf & "      <td>"
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,sort1 from sortonehy where gate2=605 order by gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "             <input name=""A"" type=""checkbox"" id=""A"" value="""
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "      </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">用品仓库：</div></td>" & vbcrlf & "      <td>"
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from O_store where charindex(',"&session("personzbintel2007")&",',','+replace(sto_intro,' ','')+',')>0 or sto_intro='' or sto_intro='0' order by sto_gate2 desc"
	'set rs=server.CreateObject("adodb.recordset")
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "<input name=""B"" type=""checkbox"" id=""B"" value="""
		Response.write rs("id")
		Response.write """>"
		Response.write rs("sto_name")
		rs.movenext
	loop
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "  </tr>" & vbcrlf & "     <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">用品分类：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "                "
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from O_officeType order by pro_gate2 desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "                      <input name=""N"" type=""checkbox"" id=""N"" value="""
		Response.write rs("id")
	...
	rs.close
	set rs=nothing
	Response.write "               </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">用品类型：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "                       <input name=""S"" type=""checkbox"" id=""S"" value=""2"">" & vbcrlf & "                      非易耗品" & vbcrlf & "                        <input name=""S"" type=""checkbox"" id=""S"" value=""1"">" & vbcrlf & "                       易耗品           </td>" & vbcrlf & "          </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td><div align=""right"">入库主题：</div></td>" & vbcrlf & "                       <td><input name=""D"" type=""text"" id=""D"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">用品名称：</div></td>" & vbcrlf & "         <td><input name=""E"" type=""text"" id=""E"" size=""15"" /></td>" & vbcrlf & "       </tr>" & vbcrlf & "          <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">用品编号：</div></td>" & vbcrlf & "          <td><input name=""F"" type=""text"" id=""F"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td><div align=""right"">用品型号：</div></td>" & vbcrlf & "         <td><input name=""G"" type=""text"" id=""G"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td><div align=""right"">批号：</div></td>" & vbcrlf & "          <td><input name=""H"" type=""text"" id=""H"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">序列号：</div></td>" & vbcrlf & "        <td><input name=""I"" type=""text"" id=""I"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">供应商：</div></td>" & vbcrlf & "        <td><input name=""C"" type=""text"" id=""C"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "       <td><div align=""right"">明细备注：</div></td>" & vbcrlf & "      <td><input name=""J"" type=""text"" id=""J"" size=""30""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">购置日期：</div></td>" & vbcrlf & "      <td>&nbsp;自：<input name=""ret"" type=""text"" size=""9"" value="""" id=""daysOfMonthPos"" onmouseup=toggleDatePicker(""daysOfMonth"",""date.ret"") readonly=""true""><DIV id=daysOfMonth style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<input name=""ret2"" type=""text"" size=""9"" value="""" id=""daysOfMonthPos1"" onmouseup=toggleDatePicker(""daysOfMonth1"",""date.ret2"") readonly=""true""><DIV id=daysOfMonth1 style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "          <td><div align=""right"">生产日期：</div></td>" & vbcrlf & "      <td>&nbsp;自：<input name=""M"" type=""text"" size=""9"" value="""" id=""daysOfMonthmPos"" onmouseup=toggleDatePicker(""daysOfMonthm"",""date.M"") readonly=""true""><DIV id=daysOfMonthm style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<input name=""K"" type=""text"" size=""9"" value=""""id=""daysOfMonthkPos"" onmouseup=toggleDatePicker(""daysOfMonthk"",""date.k"") readonly=""true""><DIV id=daysOfMonthk style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "  </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "       <td><div align=""right"">有效日期：</div></td>" & vbcrlf & "      <td>&nbsp;自：<input name=""L1"" type=""text"" size=""9"" value="""" id=""daysOfMonthPosL1"" onmouseup=toggleDatePicker(""daysOfMonthL1"",""date.L1"") readonly=""true""><DIV id=daysOfMonthL1 style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<input name=""L2"" type=""text"" size=""9"" value="""" id=""daysOfMonthPosL2"" onmouseup=toggleDatePicker(""daysOfMonthL2"",""date.L2"") readonly=""true""><DIV id=daysOfMonthL2 style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "  </tr>" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td width=""10%"">&nbsp;</td>" & vbcrlf & "       <td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填""class=""page"" name=""B2""></td>" & vbcrlf & "     </tr>" & vbcrlf & "</table>" & vbcrlf
	conn.close
	set conn=nothing
