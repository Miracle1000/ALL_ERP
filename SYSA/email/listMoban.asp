...
'bigsystemtype = ".mozi"
	...
	Response.write "智能销售平台</title>" & vbcrlf & "<link href=""css/style.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script language=""javascript"" type=""text/javascript"" src=""../Manufacture/inc/base.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin: 0px;" & vbcrlf & "    height:100%;" & vbcrlf & "}" & vbcrlf & ".style17 {color: #FF8040}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script src=""../inc/system.js?ver="
	Response.write Application("sys.info.jsver")
	...
	Response.write " onMouseOver=""window.status='none';return true;"" >" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">邮件模板</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td><div align=""right"" ><input type=""button"" class=""anybutton""  style="" cursor:hand"" name=""Submit3c"" value=""添加模板""  onClick=""javascript:window.open('editMoban.asp')""/>&nbsp;&nbsp;&nbsp;</div></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "</table>" & vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "       <tr class=""top"">" & vbcrlf & "   <td align=""center""><div align=""center"">序号</div></td>" & vbcrlf & "                      <td ><div align=""center"">标题</div></td>" & vbcrlf & "    <td height=""27"" ><div align=""center"">分类</div></td>" & vbcrlf & "        <td ><div align=""center"">添加人</div></td>" & vbcrlf & "        <td width=""17%"" ><div align=""center"">时间</div></td>" & vbcrlf & "        <td width=""16%"" ><div align=""center"">操作</div></td>" & vbcrlf & "        </tr>" & vbcrlf & ""
	if open_77_1=3 then
		Str_Result=""
	elseif open_77_1=1 then
		Str_Result="and (addcate="& session("personzbintel2007") &" or charindex(','+cast(addcate as varchar(20))+',',',"& Replace(intro_77_1&""," ","")&",')>0 or share='0' or charindex(',"&session("personzbintel2007")&",',','+cast(shareinfo as varchar(8000))+',')>0 )"
'elseif open_77_1=1 then
	else
		Str_Result="and addcate=0"
	end if
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from email_maoban where del=1 "&Str_Result&" order by clikNum ,ord desc "
	rs.open sql,conn,1,1
	if rs.RecordCount<=0 then
		Response.write "<tr><td  align='center' colspan='6'  class='gray' height='200'>模板库里没有数据，请先添加模板!</td></tr>"
	else
		i=1
		rs.PageSize=10
		...
		do until rs.eof
			...
			title=rs("title")
			set rs1=server.CreateObject("adodb.recordset")
			sql1="select * from email_maoban_sort  where ord="&getint(sortid)&" "
			rs1.open sql1,conn,1,1
			if rs1.eof  then
				sortName="未分类"
			else
			...
			if addcate<>"" then
				set rs1=server.CreateObject("adodb.recordset")
				sql1="select name from gate where del=1 and ord="&addcate&""
				rs1.open sql1,conn,1,1
				if not rs1.eof then
					addName=rs1(0)
				end if
			...
			Response.write "" & vbcrlf & "        " & vbcrlf & "      <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'""> " & vbcrlf & "                <td width=""11%"" align=""center"">"
			Response.write i
			Response.write "</td>" & vbcrlf & "          <td width=""22%"" height=""28"" onMouseOver=""return openDiv('"
			Response.write ord
			Response.write "')"" onMouseOut=""closeDiv('"
			Response.write ord
			Response.write "')"" >" & vbcrlf & "          <div align=""left""><a href=""#"" onClick=""javascript:window.open('readMoban.asp?ord="
			Response.write pwurl(rs("ord"))
			Response.write "&currPage="
			Response.write currpage
			Response.write "','editMessageMoban','width=' + 800 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=200,top=150')"" >"
			Response.write currpage
			Response.write title
			Response.write "</a></div>" & vbcrlf & "          <div  id="""
			Response.write ord
			Response.write """ style=""display:none; border:solid 1px black; color:#000000; background-color:#ffffe1; width:350px;position:absolute; padding:5px"" >"
			Response.write ord
			Response.write content
			Response.write "</div>" & vbcrlf & "          </td>" & vbcrlf & "          <script>" & vbcrlf & "                               function openDiv(id)" & vbcrlf & "                            {" & vbcrlf & "                                       var emailDiv = document.getElementById(id);" & vbcrlf & "                                     emailDiv.style.display='block';" & vbcrlf & "                                 emailDiv.style.left=event.x + 70 + ""px"";" & vbcrlf &                           "              emailDiv.style.top=event.y+""px"";" & vbcrlf &          "                 } "& vbcrlf &       "                         function closeDiv(id) "& vbcrlf &         "                   { "& vbcrlf &        "                                var emailDiv = document.getElementById(id); "& vbcrlf &             "                         emailDiv.style.display"& "          " & vbcrlf & "                <td width=""15%"" height=""28""><div align=""center"">"
			Response.write sortName
			Response.write "</div></td>" & vbcrlf & "                <td width=""19%"" height=""28""><div align=""center"">"
			Response.write addName
			Response.write "</div></td>" & vbcrlf & "                <td><div align=""center"">"
			Response.write addtime
			Response.write "</div></td>" & vbcrlf & "          <td  class=""func""><div align=""center"">" & vbcrlf & "          <input type=""button""   style="" cursor:hand"" name=""Submit3c"" value=""详情""  onClick=""javascript:window.open('readMoban.asp?ord="
			Response.write pwurl(rs("ord"))
			Response.write "&currPage="
			Response.write currpage
			Response.write "','editMessageMoban','width=' + 800 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=200,top=150')""/>&nbsp;<input type=""button""   style="" cursor:hand"" name=""Submit3c"" value=""修改""  onClick=""javascript:window.open('editMoban.asp?ord="
			Response.write currpage
			Response.write pwurl(rs("ord"))
			Response.write "&currPage="
			Response.write currpage
			...
			if open_77_3=3 or open_77_3=1  then
				Response.write "<input type=""button"" name=""Submitdel"" value=""删除"" style="" cursor:hand"" onClick=""if(confirm('确认删除？')){window.location.href='delMoban.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "&currPage="
				Response.write currpage
				Response.write "'}""/>"
			end if
			Response.write "</div></td>" & vbcrlf & "        " & vbcrlf & "        </tr>" & vbcrlf & "     "
			i=i+1
			Response.write "</div></td>" & vbcrlf & "        " & vbcrlf & "        </tr>" & vbcrlf & "     "
			if i>rs.PageSize then exit do
			rs.movenext
		loop
		Response.write "  " & vbcrlf & "      </table>" & vbcrlf & "       " & vbcrlf & " " & vbcrlf & "" & vbcrlf & " " & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "    " & vbcrlf & "         <tr>" & vbcrlf & "      <td  class=""page""><table width=""100%"" border=""0"" align=""center"">" & vbcrlf & "  <tr>" & vbcrlf &"    <td width=""24%"" height=""38""></td>" & vbcrlf & "    <td width=""76%""><div align=""right"">" & vbcrlf & "              " & vbcrlf & "                 <span class=""black"">"
		...
		Response.write "条信息/页</span>&nbsp;&nbsp;" & vbcrlf & "                 <input id=""curp1"" name=""currpage""  type=text  onkeyup=""value=value.replace(/[^\d]/g,'')""  size=3  maxlength=8/>&nbsp;" & vbcrlf & "                 <input type=""button"" name=""Submit422"" value=""跳转"" onClick=""window.location.href='listMoban.asp?page_count="
		...
		if currpage=1 then
			...
			Response.write "" & vbcrlf & "                  <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='listMoban.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
			Response.write  1
			Response.write "&A2="
			...
			Response.write "&ret2="
			Response.write m2
			Response.write "'""/>" & vbcrlf & "                  <input type=""button"" name=""Submit42"" value=""上一页""  onClick=""window.location.href='listMoban.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
		...
		if currpage=rs.pagecount then
			...
			Response.write "" & vbcrlf & "                  <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='listMoban.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
			Response.write  currpage + 1
			Response.write "&currPage="
			...
			Response.write "&ret2="
			Response.write m2
			Response.write "'"" class=""page""/>" & vbcrlf & "                  <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href='listMoban.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
			Response.write  rs.PageCount
			Response.write "&A2="
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & " "
	end if
	rs.close
	set rs=nothing
	action1="邮件模板"
	call close_list(1)
	Response.write "   </td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "<script language='javascript' type=""text/javascript"">" & vbcrlf & "<!--" & vbcrlf & "function viewCon(conStr){" & vbcrlf & "" & vbcrlf & "div_send=window.DivOpen('email_send_qf' ,'邮件模板详情', 600,400,'right',20,true,20);" & vbcrlf & "div_send.innerHTML = conStr;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</script>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & "" & vbcrlf & ""
'call close_list(1)
