...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/javascript"" language=""javascript"">" & vbcrlf & "" & vbcrlf & "function showmanager(args)" & vbcrlf & "{" & vbcrlf & "    $('#ddd').dialog('move',{left:100,top:100});" & vbcrlf & "    url=""getManager.asp?met_id=""+args+""&timestamp="" + new Date().getTime() + ""&date1=""+ Math.round(Math.random()*100);" & vbcrlf & "     xmlHttp.open(""GET"",url,false)" & vbcrlf & "     xmlHttp.onreadystatechange=function()" & vbcrlf & "   {" & vbcrlf & "               if (xmlHttp.readyState==4)" & vbcrlf & "              {" & vbcrlf & "                       document.getElementById('manager_div').innerHTML=xmlHttp.responseText;" & vbcrlf & "         }" & vbcrlf & "       }" & vbcrlf & "       xmlHttp.send(null);     " & vbcrlf & "        $('#ddd').dialog('open');" & vbcrlf & "}" & vbcrlf & "function car_img1(val,currpage,meet_name)" & vbcrlf & "{" & vbcrlf & "    url=""Car_Img1.asp?sel_time=""+val+""&currpage=""+currpage+""&meet_name=""+meet_name+""&timestamp="" + new Date().getTime() + ""&date1=""+ Math.round(Math.random()*100);" & vbcrlf & "    xmlHttp.open(""GET"",url,false)" & vbcrlf & "     xmlHttp.onreadystatechange=function()" & vbcrlf & "   {" & vbcrlf & "               if (xmlHttp.readyState==4)" & vbcrlf & "              {" & vbcrlf & "                       var ajaxhtml=xmlHttp.responseText;" & vbcrlf & "                        document.getElementById('ajaxdiv').innerHTML=ajaxhtml;" & vbcrlf & "          }" & vbcrlf & "       }" & vbcrlf & "       xmlHttp.send(null);     " & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"" onLoad=""car_img1('"
	Response.write date
	Response.write "',1,'')"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">        " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf &   "        <tr>" & vbcrlf & "            <td class=""place"">会议室查询</td>" & vbcrlf & "            <td></td> "& vbcrlf &  "           <td align=""right"">&nbsp;</td>" & vbcrlf &  "           <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "   <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "              <tr name=""table_tr1"">" & vbcrlf & "                     <td width=""100%"">"& vbcrlf & "                       <div id=""ajaxdiv"" style=""width:100%;"" align=""center""><img src=""../images/smico/proc.gif""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "    </table>" & vbcrlf & "       </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "                <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""ddd"" class=""easyui-dialog"" icon=""icon-search"" title=""会议室制度""  style=""width:550px;height:350px;padding:5px;background:#fafafa;top:0px"" closed=""true"" >" & vbcrlf & " <div region=""center"" border=""false"" style=""padding:10px;background:#fff;border:1px solid #ccc;width:100%"">" & vbcrlf & "            <div id=""manager_div""></div>"& vbcrlf & "     </div>" & vbcrlf & "  <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "            <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$crlf & ""</div>""" & vbcrlf & "<div id=""divsubmit"" class=""submitdiv""><img src=""../images/smico/proc.gif""></div>" & vbcrlf & "<div id=""title"" class=""showdiv""><img src=""../images/smico/proc.gif""></div>" & vbcrlf & ""
	action1="会议室查询"
	call close_list(1)
