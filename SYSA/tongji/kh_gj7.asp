...
'if m1="" then
	...
	m1=cdate(year(m1)&"-1"&"-1")
	m = 0
	m2=cdate(year(m2)&"-12"&"-31")
	m = 0
	tdw=m1
	if time1="" then
		time1=0
...
'if ZBRuntime.MC(12000) and ZBRuntime.MC(9004) then
	...
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "          <input type=""button"" name=""zxt"" value=""折线图分析"" onClick=""window.location.href='kh_gj7.asp?type_tj=2&W1="
	Response.write W1
	Response.write "&W2="
	Response.write W2
	Response.write "&W3="
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "        <input type=""button"" name=""line"" value=""饼图分析"" onClick=""window.location.href='kh_gj7.asp?type_tj=3&W1="
	Response.write W1
	Response.write "&W2="
	Response.write W2
	Response.write "&W3="
	...
	Response.write ">图宽=550</option>" & vbcrlf & "              <option value=""kh_gj7.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=700</option>" & vbcrlf & "              <option value=""kh_gj7.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=1000</option>" & vbcrlf & "              <option value=""kh_gj7.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=1500</option>" & vbcrlf & "              <option value=""kh_gj7.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=2000</option>" & vbcrlf & "              <option value=""kh_gj7.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	if open_1_10=1 or open_1_10=3  then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认将统计结果导出为EXCEL文档？')){window.location.href='kh_gj7.asp?type_tj=4&W1="
		Response.write W1
		Response.write "&W2="
		Response.write W2
		Response.write "&W3="
	...
	for j=1 to m
		...
		sql="select ord from reply a inner join (select ord as khord, isnull(replyShare,0) replyShare from tel where del=1) b on b.khord=a.ord and year(date7)="&year(tdw)&"  "&Module_Result&"   "&Str_Result2&" "&powerWhere&""
		rs.open sql,conn,1,1
		numcg1=rs.recordCount
		rs.close
		set rs=nothing
		title=year1&"年"
		lburl="../work/genjin.asp?W1="&W1&"&W2="&W2&"&W3="&W3&"&sort="&E&"&sort1="&F&"&khjz="&khjz&"&khhy="&khhy&"&khly="&khly&"&ret="&tdw&"&ret2="&dateadd("yyyy",1,tdw)-1&"&time1="&time1&"&sort_lm="&sort_lm&""
		title=year1&"年"
		total1(j,1)=numcg1
		total1(j,2)=title
		total1(j,0)=lburl
