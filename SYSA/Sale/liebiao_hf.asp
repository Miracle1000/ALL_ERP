...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	lxrname=conn.execute("select (case when isnull(name,'')='' then oldname else name end ) as name from setfields where gate1=17 ")(0)
	If lxrname="" Then lxrname="联系人名称"
	Response.write "" & vbcrlf & "<table width=""100%"" border=""1"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#CCC"" bordercolor=""#CCCCCC"" id=""content"" style=""border-color:#CCC"">" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td colspan=""2""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=document.getElementById('zc').style.display='';document.getElementById('ht1').style.display='none';return false;><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" style=""display:none;"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td></tr> "& vbcrlf &" <tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">回访人员：</div></td>" & vbcrlf & "<td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
	Response.write khname
	Response.write "：</div></td><td><input name=""F2"" type=""text"" size=""15""></td></tr>" & vbcrlf & "<td><div align=""right"">"
	Response.write lxrname
	Response.write "：</div></td><td><input name=""F3"" type=""text"" size=""15""></td></tr>" & vbcrlf & "<td><div align=""right"">满意率：</div></td><td><input name=""manyi1"" type=""text"" size=""5"" onkeyup=""value=value.replace(/[^\d\.]/g,'');checkDot('manyi1','2')"">%&nbsp;-&nbsp;<input name=""manyi2"" type=""text"" size=""5"" onkeyup=""value=value.replace(/[^\d\.]/g,'');checkDot('manyi2','2')"">%</td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td width=""10%"">&nbsp;</td>" & vbcrlf & "<td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr>" & vbcrlf & "" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
