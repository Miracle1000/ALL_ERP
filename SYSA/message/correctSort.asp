...
'If Not rs.Eof Then
	...
	if request("ord")="" then
		...
		set rs=server.CreateObject("adodb.recordset")
		sql="select * from sortMessage where ord="&ord&" "
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0""  cellpadding=""0"" cellspacing=""0"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "        <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"" background=""../images/m_mpbg.gif"">" & vbcrlf & "              <tr>" & vbcrlf & "                <td  class=""place"">设置短信模板分类</td>" & vbcrlf & "                <td align=""right"">&nbsp;</td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>  " & vbcrlf & "   <form method=""post"" action=""UpdateSort.asp?ord="""
	Response.write pwurl(ord)
	Response.write """  id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"" style=""margin:0"">" & vbcrlf & "   <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "    <tr class=""top""> " & vbcrlf & "      <td colspan=""2"">"
	if sortName<>"" then
		Response.write "修改"
	else
		Response.write "添加"
	...
	Response.write """ size=""30"" onKeyUp=""value=value.replace(/[^ \d]|(^\s*)|(\s*$)/g,'')""  dataType=""Limit"" min=""1"" max=""8""  msg=""长度必须在1个至8个数字之间"">" & vbcrlf & "               <span class=""red"">*</span>         </td>" & vbcrlf & "    </tr>" & vbcrlf & "" & vbcrlf & "    <tr> " & vbcrlf & "      <td  colspan=""2"" > " & vbcrlf & "        <div align=""center"">" & vbcrlf & "            <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>　　　　　" & vbcrlf & " " & vbcrlf & "            <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "          </div></td>" & vbcrlf & "    </tr>" & vbcrlf & "  </table>" & vbcrlf & "  </form>" & vbcrlf & "  </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""80"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "</td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="设置短信模板分类"
	call close_list(1)
