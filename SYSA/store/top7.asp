...
'set rs=nothing
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"" src='sccz2.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write "'></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"" src='storeselbox.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write "'></script>" & vbcrlf & "<script>" & vbcrlf & "    function UnitCustomFun(sobj,ord,type,id,inx){" & vbcrlf & "    if(type==""assistUnit""){" & vbcrlf & "        var inx=sobj.id.split(""_"")[1] ;" & vbcrlf & "        var id=sobj.name.split(""_"")[1] ;" & vbcrlf & "        //var tdobj =obj.parentElement" & vbcrlf & "         var pid=ord;" & vbcrlf & "            var unit= $(""#unit""+inx).val();" & vbcrlf & "           var num=$(""#num""+id).val();" & vbcrlf & "        var assistUnit=sobj.value;" & vbcrlf & "    }" & vbcrlf & "    if(type==""num""){" & vbcrlf & "      var pid=ord;" & vbcrlf & "            var unit= $(""#unit""+inx).val();" & vbcrlf & "            var num=$(""#num""+id).val();" & vbcrlf & "        var assistUnit=$(""#AssistUnit_""+inx).val();" & vbcrlf & "    }" & vbcrlf & "    if(pid&&unit&&assistUnit&&assistUnit!=""0""){" & vbcrlf & "        var url = ""../store/CommonReturn.asp?act=assistnum&pid="" + pid + ""&unit="" + unit + ""&assistUnit="" + assistUnit + ""&num=1&stamp="" + Math.round(Math.random() * 100);" & vbcrlf &         "xmlHttp.open(""GET"", url, false); "& vbcrlf &      "     xmlHttp.send(null); "& vbcrlf &     " var result = xmlHttp.responseText;" & vbcrlf &     "  xmlHttp.abort();" & vbcrlf & "        window.assignBl = result;" & vbcrlf & "       $(""#AssNum_""+id).val(FormatNumber(num * result,"
	'Response.write Application("sys.info.jsver")
	Response.write num1_dot
	Response.write "));" & vbcrlf & "       $(""#AssNum_""+id).text(FormatNumber(num * result,"
	Response.write num1_dot
	Response.write num1_dot
	Response.write "));" & vbcrlf & "           if("""
	Response.write isFixAssRat
	Response.write """==""False""){$(""#AssNum_""+id).removeAttr(""readonly"")};" & vbcrlf & "    }else{" & vbcrlf & "          $(""#AssNum_""+id).attr(""readonly"",""readonly"");" & vbcrlf & "         $(""#AssNum_""+id).val("""");" & vbcrlf & "       $(""#AssNum_""+id).text("""");" & vbcrlf & "    }" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<SCRIPT language=JavaScript1.2>" & vbcrlf & "// 一个简单的测试是否IE浏览器的表达式" & vbcrlf & "// 得到IE中各元素真正的位移量，即使这个元素在一个表格中" & vbcrlf & "function getIEPosX(elt) { return getIEPos(elt,""Left""); }" & vbcrlf & "function getIEPosY(elt) { return getIEPos(elt,""Top""); }" & vbcrlf & "function getIEPos(elt,which) {" & vbcrlf & " iPos = 0" & vbcrlf & " while (elt!=null) {" & vbcrlf & "  iPos += elt[""offset"" + which]" & vbcrlf & "  elt = elt.offsetParent" & vbcrlf & " }" & vbcrlf & " return iPos" & vbcrlf & "}" & vbcrlf & "// -->" & vbcrlf & "</SCRIPT>" & vbcrlf & "  <style>.place{height:43px!important}#cp_search{width:221px!important}</style>" & vbcrlf & "</head>" & vbcrlf & ""
	...
	Response.write "" & vbcrlf & "<body onLoad=""txmFocus();BuildEvent();UpdatePrice();"" onclick=""TexTxmFocus(event);""   onUnload=""window.opener.location.reload();"" class=""BillUI"">" & vbcrlf & ""
...
'ElseIf treeType = "TC" Then
	...
	Call ShowLeftTree
	Response.write "" & vbcrlf & "      </td>" & vbcrlf & "    <td valign=""top"">" & vbcrlf & "    <form method=""post"" action=""savelistcz.asp?top="
	Response.write top
	Response.write """ target=""sumitFrame""  id=""demo"" onSubmit=""return Validator.Validate(this,2) && checkFormSubmit()"" name=""date"">" & vbcrlf & "    <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "        <tr>" & vbcrlf & "          <td width=""100%"" valign=""center""class=""nopadding32"" style=""background-color:white""> "& vbcrlf & vbcrlf &""
	'Response.write top
	Dim kdtall,kdck
	kdtall=0
	kdck=conn.execute("select kd from zdymx where sort1=1005 and set_open=1 and sorce=8")(0)
	Set rs=conn.execute("select kd,set_open,sorce from zdymx where sort1=1005 and set_open=1 order by gate1 asc")
	while Not rs.eof
		kdtall=kdtall+rs("kd")
'while Not rs.eof
		rs.movenext
	wend
	rs.close:Set rs=Nothing
	Response.write "" & vbcrlf & "                <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "            <tr>" & vbcrlf & "              <td class=""place"">父件清单</td>" & vbcrlf & "              <td><div>&nbsp; <input type=""submit"" name=""Submit4222"" value=""保存清单""  class=""anybutton2""/>&nbsp;&nbsp;&nbsp;&nbsp;<input type=""reset"" name=submit2  value=""重新填写"" class=""anybutton2""/></div></td>" & vbcrlf & "              <td align=""right"">"
	if session("pro1zbintel2007")="1" then
		Response.write "" & vbcrlf & "                <input type=""button"" name=""Submit3"" value=""添加产品""  onclick=""javascript:window.open('../product/add_list.asp?ord="
		Response.write pwurl(89)
		Response.write "','newwproductin','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')"" class=""anybutton""/>" & vbcrlf & "                "
		'Response.write pwurl(89)
	end if
	Response.write "</td>" & vbcrlf & "              <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "            </tr>" & vbcrlf & "          </table>" & vbcrlf & "" & vbcrlf & "               " & vbcrlf & "" & vbcrlf & "          <table width=""100%"" class=""resetHeadBg"" border=""0"" cellpadding=""3""  background=""../images/112.gif"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;table-layout:fixed;"">" & vbcrlf & "            <tr class="""">" & vbcrlf & "                "
	'Response.write pwurl(89)
	Set rs=conn.execute("select kd,set_open,sorce from zdymx where sort1=1005 and set_open=1 order by gate1 asc")
	while Not rs.eof
		...
		Case 8 :
		Response.write "" & vbcrlf & "                                                     <td  width=""195px"" style="""">" & vbcrlf & "                                                        "
		if proStore<>1 then
			Response.write "" & vbcrlf & "                                                             <table style='width:100%' cellspacing=0 cellpadding=0><tr><td width=""179px"">" & vbcrlf & "                                                              <input type='hidden' name=""dfggck"" id=""ckall_2"" text=''  onChange=""ck('"
			Response.write num_dot_xs
			Response.write "',true);"">" & vbcrlf & "                                                                <div style='float:left;'><input style='float:left;' id='for_ckall_2' type='button' class='storeButton'></div>" & vbcrlf & "                                                           </td><td style='width:16px;'><img  style='cursor:pointer;' src='../images/11645.png' onClick=""showStoreDlg('ckall_2')""></td>" & vbcrlf & "                                                         </tr></table>" & vbcrlf & "                                                   "
		end if
		Response.write " " & vbcrlf & "                                                    </td>" & vbcrlf & "                                                   "
		Case 11 :
		Response.write "" & vbcrlf & "                                                     <td  width="""
		Response.write rs("kd")
		Response.write """ style=""""><div align=""center"">" & vbcrlf & "                                                               <select name=""bzall_2""  id=""bzall_2""  onpropertychange=""bzz()"" onchange=""bzz()"">" & vbcrlf & "                                                                <option value=""""></option>" & vbcrlf & "                                                                "
		set rs2=server.CreateObject("adodb.recordset")
		...
		Case Else
		Response.write "<td width='"&rs("kd")&"'  style=''>&nbsp;</td>"
		End select
		rs.movenext
	wend
	rs.close:Set rs=Nothing
	Response.write "" & vbcrlf & "              </tr>" & vbcrlf & "            </table>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "            <table width=""100%""  border=""0"" cellpadding=""3""  background=""../images/m_table_top.jpg"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;table-layout:fixed;"">" & vbcrlf & "              <tr class=""top"">" & vbcrlf & "                             "
'rs.close:Set rs=Nothing
	num1_ls=0
	adressNum1=0
	set rs=conn.execute("select * from zdymx where sort1=1005 and set_open=1 order by gate1 asc ")
	If Not rs.eof Then
		do until rs.eof
			sorce=rs("sorce")
			kd=rs("kd")
...
'Case 4 :
			if isOpenProductAttrV then
				Response.write "<td  width='90' align='center' background='../images/m_table_top.jpg' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><strong>产品属性1</strong></div></td>"
'if isOpenProductAttrV then
				Response.write "<td  width='90' align='center' background='../images/m_table_top.jpg' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><strong>产品属性2</strong></div></td>"
'if isOpenProductAttrV then
			end if
			Case 6,7 :
...
'Case else :
	...
	rs.close
	Response.write "" & vbcrlf & "              </tr>" & vbcrlf & "            </table>" & vbcrlf & "" & vbcrlf & "            <span id=""main_lists"">" & vbcrlf & "              "
	id1_old=0
	sqls = "select * from kuoutlist2 where contract="&top&" and sort1=9 and del=7 order by area asc,date7 asc,id asc"
...
'if rss.eof then
		...
		do until rss.eof
			...
			rs7.close
			set rs7=nothing
			conn.execute("update kuinlist set sort="&id&" where sort="&rss("area")&"")
			conn.execute("update kuoutlist2 set area="&id&" where area="&rss("area")&"")
			if IsNumeric(ku) And Len(ku&"")>0 and ku>0   Then
				checked_zd1=""
				checked_zd2="checked"
				sqltext="Update kuoutlist2 set  mxid="&id&", kuout =null where id="&rss("id")&""
				conn.execute(sqltext)
			else
				checked_zd1="checked"
				checked_zd2=""
			...
			kcxz=""
			set rs=server.CreateObject("adodb.recordset")
			sql="select sum(num2) as num1,ck,unit from ku  where ord="&ord&" and ck="&ck&" and ck in (select id from sortck where del=1 and (intro like '"&session("personzbintel2007")&",%' or intro like '%,"&session("personzbintel2007")&",%' or intro like '%, "&session("personzbintel2007")&",%' or intro like '%, "&session("personzbintel2007")&"'  or intro like '%,"&session("personzbintel2007")&"' or intro like '"&session("personzbintel2007")&"' or intro like '0')) group by ck,unit having sum(num2)>0 order by ck asc"
			...
			if rs.RecordCount<=0 then
				...
				do until rs.eof
					...
					if rs7.eof then
						...
						ckname=rs7("sort1")
						storeSort=""
						sql="select * from sortck1 where id="&rs7("sort")
						set rssort=conn.execute(sql)
						if not rssort.eof then
							storeSort=rssort("sort1")
							set rstmp=conn.execute("select * from sortck1 where id="&rssort("ParentID"))
...
'num_kclimit=num_kc2
						kcxz=kcxz+""&ck1name&" "&ckname&" "&unit2name&" "&FormatNumber(num_kc2,num1_dot,true,0,0)&"<br>"
'num_kclimit=num_kc2
						kcxz=kcxz+"</font>"
'num_kclimit=num_kc2
					end if
					if clng(unit)<>unit2 then
						kcxz=kcxz+"<font color='#546C95'>"&ck1name&" "&ckname&" </font>"&unit2name&" "&FormatNumber(num_kc2,num1_dot,true,0,0)&""
'if clng(unit)<>unit2 then
			...
			Response.write("<span id='trpx"&m&"'><span id='trpx"&"_"&id&"'>")
			...
			set rs=server.CreateObject("adodb.recordset")
			sql="select id,title,name,sort,kd,set_open,sorce,gate1 from zdymx where sort1=1005 and set_open=1 order by gate1 asc "
			rs.open sql,conn,1,1
			do until rs.eof
				sorce=rs("sorce")
				kd=rs("kd")
...
'If qxOpen > 0 Then
				...
				if bom=0 Then
					list=list+"<font class='red'>"
'if bom=0 Then  '
				end if
				list=list+""&k&"</a>  <a href='javascript:void(0)' onclick=del2('tpx"&id&"','"&id&"');><img src='../images/del2.gif'  border=0/ alt='删除此产品'></a>"&i&" <input name='numdata1_"  & id & "' value='" & zzdata & "' type='hidden'><input name='gys_"&id&"' type='hidden'   value='"&company_ord&"' size='7'><input name='caigoulist_"&id&"' type='hidden'   value='"&caigoulist&"' size='7'></td>"
				Case 2:
				list=list&"<td width='"&kd&"' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'>"&order1&"</td>"
'Case 2:
				Case 3:
				list=list&"<td width='"&kd&"' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'><input type='hidden' id='moneythisall_"&id&"' name='moneythisall_"&id&"' value='"&money1&"'>"&type1&"</td>"
'Case 3:
				Case 4:
				list=list&"<td align='center' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><select name='unit_"&id&"' id='unit2_"&i&"' width='50' onchange=newbom($('#unit2_"&i&"').val(),'"&ord&"','"&top&"','tpx"&id&"','"&id&"',$('#ProductAttr1_"&i&""
				set rs7=server.CreateObject("adodb.recordset")
...
'set rs7=nothing
				...
				Case 5:
				list=list+"<td  class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><input Name='num1_"&id&"' id='num2_"&id&"' value='"&FormatNumber(num1,num1_dot,true,0,0)&"' onkeyup=value=value.replace(/[^\d\.]/g,'');checkDot('num2_"&id&"','"&num1_dot&"') onblur=chtotal3("&ord&","&top&","&id&","&i&","&num_dot_xs&","&unit&")  type='text' style='height: 28px; solid;font-size: 9pt;' size='5' dataType='Range' msg='数量不足' min='0.00000000000001' max='"&num_kclimit&"'></div></td>"
'Case 5:   '
				Case 6:
				list=list&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;"& displayStr &"'><div align='center'><input name='price1_"&id&"'  id='pricetest2_"&id&"' old_val='"&Formatnumber(price1,StorePrice_dot_num,true,0,0)&"' type='text' if price1=0 then onfocus=if(value==defaultValue){value='';this.style.color='#000'}  onBlur=if(!value){value=defaultValue;this.style.color='#000'}  value='"&Formatnumber(price1,StorePrice_dot_num,true,0,0)&"' onkeyup=value=value.replace(/[^\d\.]/g,'');checkDot('pricetest2_"&id&"','"&StorePrice_dot_num&"') onpropertychange=chtotal2("&id&","&num_dot_xs&");   readOnly = true onfocus = null onpropertychange = null style='color:#888888;border:1px solid #999; height: 28px; solid;font-size: 9pt;text-align:right'  size='7'></div></td>"
'Case 6:
				Case 7:
				list=list&"<td width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;"& displayStr &"'><div align='right'><input name='moneyall_"&id&"' id='moneyall2_"&id&"' type='text'  value='"&Formatnumber(money1,num_dot_xs,true,0,0)&"'  onkeyup=value=value.replace(/[^\d\.]/g,'');checkDot('moneyall2_"&id&"','"&num_dot_xs&"')  size='10'   readOnly = true onfocus = null onpropertychange = null style='color:#888888;border:1px solid #999; color: #666666;border: #CCCCCC 1px solid;text-align:right' ><span id='moneyall2tips_"&id&"'></span></div></td>"
'Case 7:
				Case 8:
				list=list&"<td width='195px' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'>"
'Case 8:   '
				Set ckrs = conn.execute("select sort1 from sortck where ord=" & CLng(ck))
				...
				ckrs.close
				list = list & "<table style='width:100%' cellspacing=0 cellpadding=0><tr><td width='100%'>" & _
				"<input type='hidden' name='ck_"& id &"' id='ck2_"&i&"' text='" & ckname & "' value='" & ck & "'  onChange=ckxz5('"&ord&"','"&i&"','"&id&"','trpx"&"_"&id&"','2');  dataType='Limit' min='1' max='100' msg='请选择仓库'>" & _
...
'if IsNumeric(ku)and ku>0 Then
				...
				list=list&"<td  width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><input type='radio' name='way1_"&id&"' onclick=del_zd('"&id&"');  value='1' "&checked_zd1&"/>随机&nbsp;<input type='radio' name='way1_"&id&"' value='2'  onclick=if(check_ckxz('"&i&"'))javascript:window.open('../store/ku_select_ck.asp?ord="&ord&"&unit="&unit&"&id="&id&"&ck='+document.getElementById('ck2_"&i&"').value+'&num1="&num1&"&contractlist="&contractlist&"&kuout="&kuout&"&kuoutlist="&kuoutlist&"&ProductAttr1="&parentProductAttr1&"&ProductAttr2="&parentProductAttr2&"','newwin23','width='+900+',height='+400+',toolbar=0,scrollbars=1,resizable=1,left=50,top=100'); "&checked_zd2&">指定<span id='zdkc"&id&"'>"& yzdhtml &"</span></td>"
'if IsNumeric(ku)and ku>0 Then
				Case 11:
...
'set rs2=nothing
				Case 12:
				list=list&"<td width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><input name='js_"&id&"' id='js2_"&i&"' value='"&js&"' type='text' onkeyup=value=value.replace(/[^\d\.]/g,'')  style='height: 28px; solid;font-size: 9pt;'  size='5'></div></td>"
				Case 13:
				...
				Case 14:
				list=list+"<td align='center' width='"&kd&"' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'><textarea name='zdy1_"&id&"' id='zdy1"&i&"'  type='text' style='overflow-y:hidden;word-break:break-all;width:50px' onFocus='this.style.posHeight=this.scrollHeight' onpropertychange='this.style.posHeight=this.scrollHeight'  datatype='Limit' min='0' max='200' msg='不要超过200个字' rows='1'>"&replace(rss(""&rs("name")&"")&"","<br>",chr(10))&"</textarea></td>"
				Case 15:
				list=list+"<td align='center' width='"&kd&"' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'><textarea name='zdy2_"&id&"' id='zdy2"&i&"'  type='text' cols='10' style='overflow-y:hidden;word-break:break-all;width:50px' onFocus='this.style.posHeight=this.scrollHeight' onpropertychange='this.style.posHeight=this.scrollHeight'  datatype='Limit' min='0' max='200' msg='不要超过200个字' rows='1'>"&replace(rss(""&rs("name")&"")&"","<br>",chr(10))&"</textarea></td>"
				Case 16:
				list=list+"<td align='center' width='"&kd&"' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'><textarea name='zdy3_"&id&"' id='zdy3"&i&"'  type='text' cols='10' style='overflow-y:hidden;word-break:break-all;width:50px' onFocus='this.style.posHeight=this.scrollHeight' onpropertychange='this.style.posHeight=this.scrollHeight'  datatype='Limit' min='0' max='200' msg='不要超过200个字' rows='1'>"&replace(rss(""&rs("name")&"")&"","<br>",chr(10))&"</textarea></td>"
				Case 17:
				list=list+"<td align='center' width='"&kd&"'  type='text' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'><textarea name='zdy4_"&id&"' id='zdy4"&i&"' cols='10' style='overflow-y:hidden;word-break:break-all;width:50px' onFocus='this.style.posHeight=this.scrollHeight' onpropertychange='this.style.posHeight=this.scrollHeight'  datatype='Limit' min='0' max='200' msg='不要超过200个字' rows='1'>"&replace(rss(""&rs("name")&"")&"","<br>",chr(10))&"</textarea></td>"
				Case 18:
...
'for j=m to num_cpmx_yl
	...
	Response.write "" & vbcrlf & "" & vbcrlf & "                      </span>" & vbcrlf & "            <p></p>" & vbcrlf & "" & vbcrlf & ""
	Dim kdtall2
	kdtall2=0
	Set rs=conn.execute("select kd,set_open,sorce from zdymx where sort1=1004 and set_open=1 order by gate1 asc")
	while Not rs.eof
...
'while Not rs.eof
	...
	wend
	rs.close:Set rs=Nothing
	if isOpenProductAttrV then kdtall2=kdtall2+200
	'rs.close:Set rs=Nothing
	Response.write "" & vbcrlf & "" & vbcrlf & "            <div id='zbmxlist' class=""nopadding32"">" & vbcrlf & "              <table width="""
	Response.write kdtall2+260
	Response.write """ border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "                <tr>" & vbcrlf & "                  <td class=""place"">子件清单</td>" & vbcrlf & "                  <td>&nbsp;</td>" & vbcrlf & "                  <td align=""right"">"
	if session("pro1zbintel2007")="1" then
		Response.write "" & vbcrlf & "                    <input type=""button"" name=""Submit3"" value=""添加产品""  onclick=""javascript:window.open('../product/add_list.asp?ord="
		Response.write pwurl(89)
		Response.write "','newwproductin','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')"" class=""anybutton""/>" & vbcrlf & "                    "
	...
	Response.write "</td>" & vbcrlf & "                  <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "                </tr>" & vbcrlf & "              </table>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "              <table width="""
	Response.write kdtall2
	Response.write """ class=""resetHeadBg bgfff"" border=""0"" cellpadding=""3""  background=""../images/112.gif"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;table-layout:fixed;"">" & vbcrlf & "              <tr class="""">" & vbcrlf & "                              "
	'Response.write kdtall2
	Response.write qmbcdyg2
	Set rs=conn.execute("select kd,set_open,sorce from zdymx where sort1=1004 and set_open=1 order by gate1 asc")
	j=0
	while Not rs.eof
		sorce=rs("sorce")
		...
		Select Case sorce
		Case 4 :
		Response.write "<td width='"&kd&"' height='26'>"&pl&"</td>"
		if isOpenProductAttrV then
			Response.write "<td width='90' height='26'>"&pl&"</td>"
			Response.write "<td width='90' height='26'>"&pl&"</td>"
		end if
		case 5:
		if isOpenAssUnit then
			Response.write "<td width='"&kd&"' height='26'>"&pl&"</td>"&_
			"<td  width='70' align='center'></td>"&_
		...
		Case 7 :
		Response.write "<td width='"&kd&"' height='26' style='"& displayStr &"'><div align='center'>批量录入：</div></td>"
		Case 8 :
		Response.write "" & vbcrlf & "                                       <td width='"
		Response.write kd
		Response.write "' height='26' style='' ><div align=""center"">" & vbcrlf & "                                                                   "
		if proStore<>1 then
			Response.write "" & vbcrlf & "                                                                          <table style=""width:100%"" cellspacing=0 cellpadding=0><tr><td width=""100%"">" & vbcrlf & "                                                                         <input type='hidden' name=""dfggck"" id=""ckall"" text=""""   onChange=""ckk()"" >" & vbcrlf & "                                                                      <div style='float:left;'><input style='float:left;' id=""for_ckall"" type=""button"" class=""storeButton"" style=""width:60px;overflow:hidden""></div>" & vbcrlf & "                                                                       </td><td style=""width:16px;""><img  style=""cursor:pointer;"" src=""../images/11645.png"" onClick=""showStoreDlg('ckall')""></td>" & vbcrlf & "                                                                      </tr></table>" & vbcrlf & "                                                                 "
		end if
		Response.write "" & vbcrlf & "                                                                  </div></td>" & vbcrlf & "                                                             "
		Case 9 :
		Response.write "" & vbcrlf & "                                                                 <td width='"
		Response.write kd
		Response.write "' height='26'>" & vbcrlf & "                                                                   <div align=""center""><strong><input name=""num3353all"" type=""text"" id=""phall"" size=""9""   onpropertychange=""ph()"" style='height: 28px; solid;font-size: 9pt;'  datatype='Limit' max='50' msg='不要超过50个字' /></strong></div></td>" & vbcrlf & "                                                                  "
		Case 11 :
		Response.write "" & vbcrlf & "                                                                     <td  width="""
		Response.write kd
		Response.write """ style=""""><div align=""center""><strong><input name=ret7 size=9  onpropertychange=""datesc()"" onchange=""datesc()"" id=""daysOfMonth7Pos"" readonly=true onMouseUp=""toggleDatePicker('daysOfMonth7','date.ret7')""  style='height: 28px; solid;font-size: 9pt;' /><div id=daysOfMonth7 style=""POSITION: absolute""></DIV></strong></div></td>" & vbcrlf & "                                                            "
		Case 12 :
		Response.write "" & vbcrlf & "                                                                 <td  width="""
		Response.write kd
		Response.write """ style=""""><div align=""center""><strong><input name=ret8 size=9  onpropertychange=""dateyx()"" onchange=""dateyx()"" id=""daysOfMonth8Pos"" readonly=true onMouseUp=""toggleDatePicker('daysOfMonth8','date.ret8')""  style='height: 28px; solid;font-size: 9pt;' /><div id=daysOfMonth8 style=""POSITION: absolute""></DIV></strong></div></td>" & vbcrlf & "                                                               "
		Case 13 :
		Response.write "" & vbcrlf & "                                                                      <td  width="""
		Response.write kd
		Response.write """ style=""""><div align=""center"">" & vbcrlf & "                                                                               <select name=""bzall""  id=""bzall""  onpropertychange=""bz()"" >" & vbcrlf & "                                                                                                   <option value=""""></option>" & vbcrlf & "                                                                                 "
		set rs2=server.CreateObject("adodb.recordset")
		sql2="select ord,sort1 from sortonehy where gate2=82 order by gate1 desc"
		rs2.open sql2,conn,1,1
		do until rs2.eof
...
'End Select
	...
	wend
	rs.close:Set rs=Nothing
	Response.write "" & vbcrlf & "                </tr>" & vbcrlf & "                </table>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "                <table width='"
	Response.write kdtall2
	Response.write "' class=""noMargin"" border='0' cellpadding='3' style='word-break:break-all;word-wrap:break-word;border-collapse:collapse;table-layout:fixed;'>" & vbcrlf & "                <tr class=""top"">" & vbcrlf & "                  "
	'Response.write kdtall2
	num1_ls=0
	adressNum1=0
	sqls="select * from zdymx where sort1=1004 and set_open=1 order by gate1 asc "
	set rs = server.CreateObject("adodb.recordset")
...
'Case else:
	...
	rs.close
	Response.write "" & vbcrlf & "                </tr>" & vbcrlf & "              </table>" & vbcrlf & "             " & vbcrlf & "            "
	...
	m=1
	if rss.eof then
		Response.write "" & vbcrlf & "              <span id=""zjtrpx0"">" & vbcrlf & "                <table width="""
		Response.write kdtall2+260
		Response.write """ border=""0""  cellpadding=""3"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;table-layout:fixed;"" class=""bgfff"">" & vbcrlf & "                  <tr >" & vbcrlf & "                    <td height=""30"" style=""border-bottom:#CCC 1px solid;border-left:#CCC 1pxsolid;border-right:#CCC 1px solid;"">无产品明细！</td>" & vbcrlf & "                  </tr>" & vbcrlf & "                </table>" & vbcrlf & "                </span>" & vbcrlf & "            "
	else
		us_i=1
		Ismode=0
		do until rss.eof
...
'If price1&"" = "" Then price1 = 0 Else price1 = CDBL(price1)
			...
			if Ismode>0 and Ismode<>id1 then
				...
				sumtrclos=sumtrclos+"<table width='"&kdtall2&"' border='0' id='tpx9'  cellpadding='3' style='word-break:break-all;word-wrap:break-word;border-collapse:collapse;table-layout:fixed;'><tr   onmouseout=this.style.backgroundColor='' onmouseover=this.style.backgroundColor='efefef'>"
'sumtrclos="<span id='sumspan"&Ismode&"'>"
...
'sumtrclos="<span id='sumspan"&Ismode&"'>"
			...
			set rs2=nothing
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select id from mxpx where cateid="&session("personzbintel2007")&" and sort1=3 "
			rs7.open sql7,conn,1,1
			i=rs7.RecordCount
			rs7.close
			set rs7=nothing
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select title,type1,order1,price1,company,unit from product where ord="&ord&""
			rs7.open sql7,conn,1,1
			if rs7.eof then
				k=""
				type1=""
...
'cpyxqHours = PhXlhManage(2)
			...
			list="<table width='"&kdtall2&"' border='0' id='tpx"&i-1&"' cellpadding='3' style='word-break:break-all;word-wrap:break-word;border-collapse:collapse;table-layout:fixed;'><tr   onmouseout=this.style.backgroundColor='' onmouseover=this.style.backgroundColor='efefef'>"
			sumtdclos=""
			set rs=server.CreateObject("adodb.recordset")
			sql="select id,title,name,sort,kd,set_open,sorce,gate1 from zdymx where sort1=1004 and set_open=1 order by gate1 asc "
			rs.open sql,conn,1,1
			do until rs.eof
				sorce=rs("sorce")
				kd=rs("kd")
				Select Case sorce
				Case 1:
				list=list+"<td width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;' id='cpmx_title_td"&i&"'><a href='javascript:void(0)'  onclick=javascript:window.open('../product/content.asp?ord="&pwurl(ord)&"','newwin21','width='+800+',height='+500+',toolbar=0,scrollbars=1,resizable=1,left=100,top=100');return false; alt='查看产品详情'>&nbsp;"&k&"</a>  <a href='javascript:void(0)' onclick=del('trpx"&i-1&"_"&id&"','"&id&"','"&id1&"');><img src='../images/del2.gif'  border=0 alt='删除此产品'></a><label id=""inx_"&id&""">"&i&"</label><input name='company_"&id&"' id='company"&i&"' type='hidden'   value='"&company_ord&"' size='7'><input name='w_"&id&"' id='w"&i&"' type='hidden'   value='trpx"&i-1&"_"&id&"' size='7'></td>"
'Case 1:
...
'Case 3:
				Case 4:
				list=list&"<td align='center' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><select name='unit_"&id&"' id='unit"&i&"' width='50' onChange=ckxz('"&ord&"','"&i&"','"&id&"',"&id1&",'trpx"&i-1&"_"&id&"','2','"&num_dot_xs&"');  dataType='Range' msg='不能为空' min='1' max='9999999999999'>"
...
'='Range' msg='不能为空' min='1' max='9999999999999'>"
				set rs7=server.CreateObject("adodb.recordset")
				sql7="select ord,sort1 from sortonehy where gate2=61 and id in ("&unitall&") order by gate1 desc"
				rs7.open sql7,conn,1,1
				do until rs7.eof
...
'ctAttr2)&"</td>"
				...
				Case 5:
				list=list&"<td  class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><input Name='num1_"&id&"' id='num"&id&"' value='"&FormatNumber(num1,num1_dot,true,0,0)&"'  onkeyup=value=value.replace(/[^\d\.]/g,'');checkDot('num"&id&"','"&num1_dot&"')  onpropertychange=chtotal("&id&","&id1&","&num_dot_xs&","&unit&","&ord&","&i&"); type='text' style='height: 28px; font-size: 9pt;' size='5'  dataType='Range' msg='不能为0' min='0.0000001' max='9999999999999'></div></td>"
'Case 5:
				sumtdclos=sumtdclos&"<td  class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div id='sumnums"&id1&"'>"&Formatnumber(sumnum1,num1_dot,-1,0,0)&"</div></td>"
'Case 5:
				if isOpenAssUnit then
					...
					sumtdclos=sumtdclos&"<td align='center' width='70' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'></td>"
'>"
					set rs7=server.CreateObject("adodb.recordset")
					...
					do until rs7.eof
						list=list&"<option value='"&rs7("ord")&"'"
						if clng(AssistUnit)=rs7("ord") then
							list=list&" selected"
						end if
						list=list&">"&rs7("sort1")&"</option>"
						rs7.movenext
					...
					list=list&"<td  class='name' width='70' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><input "&readonly&" Name='AssistNum_"&id&"' id='AssNum_"&id&"'  value='"&AssistNum&"' onkeyup=value=value.replace(/[^\d\.]/g,'');checkDot('num2_"&id&"','"&num1_dot&"'); onblur=chtotal3("&ord&","&top&","&id&","&i&","&num_dot_xs&") type='text' style='height: 28px; solid;font-size: 9pt;' size='5' dataType='Range' max='9999999999999'></div></td>"
'if isFixAssRat then readonly="readonly"
					sumtdclos=sumtdclos&"<td  class='name' width='70' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'></div></td>"
'if isFixAssRat then readonly="readonly"
				end if
				Case 6:
				list=list&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;"& displayStr &"'><div align='center'><input name='price1_"&id&"'  id='pricetest"&id&"' type='text' if price1=0 then onfocus=if(value==defaultValue){value='';this.style.color='#000'}  onBlur=if(!value){value=defaultValue;this.style.color='#000'} value='"&FormatNumber(price1,StorePrice_dot_num,true,0,0)&"' onkeyup=value=value.replace(/[^\d\.]/g,'');checkDot('pricetest"&id&"','"&StorePrice_dot_num&"') onpropertychange=chtotal("&id&","&id1&","&num_dot_xs&");style='height: 28px; solid;font-size: 9pt;text-align:right'  size='7' ></div></td>"
'Case 6:
				sumtdclos=sumtdclos&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;"& displayStr &"'><div align='center'></div></td>"
'Case 6:
				Case 7:
				list=list&"<td width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;"& displayStr &"'><div align='right'><input name='moneyall_"&id&"' id='moneyall"&id&"' type='text' if price1=0 then onfocus=if(value==defaultValue){value='';this.style.color='#000'} value='"&FormatNumber(money1,num_dot_xs,true,0,0)&"' onBlur=if(!value){value=defaultValue;this.style.color='#666'}  onkeyup=value=value.replace(/[^\d\.]/g,'');checkDot('moneyall"&id&"','"&num_dot_xs&"') onpropertychange=chtotal4("&id&","&id1&","&num_dot_xs&","&unit&","&ord&","&i&") size='10' style='text-align:right' ></div></td>"
'Case 7:
...
'Case 7:
				Case 8:
				list = list&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'>"
'Case 8:
				sumtdclos = sumtdclos&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'>"
'Case 8:
				Set ckrs = conn.execute("select sort1 from sortck where ord=" & CLng(ck))
				If ckrs.eof = False Then
					ckname = ckrs.fields(0).value
				...
				ckrs.close
				list = list & "<table style='width:100%' cellspacing=0 cellpadding=0><tr><td width='100%'>" & _
				"<input type='hidden' name='ck_"& id &"' id='ck"& i &"' text='" & ckname & "' value='" & ck & "' dataType='Limit' min='1' max='100' msg='请选择仓库'>" & _
				...
				list=list+"</td>"
'</tr></table>
				sumtdclos = sumtdclos & "<table style='width:100%' cellspacing=0 cellpadding=0><tr><td width='100%'>" & _
				"<div style='float:left;'></div>" & _
				"</td><td style='width:16px;'></td>" & _
				"</tr></table></td>"
				Case 9:
				list=list&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><input name='ph_"&id&"' id='ph2_"&i&"' type='text'  style='height: 28px; solid;font-size: 9pt;' value='"&ph&"'  size='10' dataType='Limit' "& iif(phManage=1," min='1' ","") &" max='50' msg='"& iif(phManage=1,"长度必须在1到50个字之间","不要超过50个字") &"'>"& iif(phManage=1," <span class='red'>*</span>","") &" <span id='ph_tip_"&id&"' class='red'></span></div></td>"
				sumtdclos=sumtdclos&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'></div></td>"
				Case 10:
				xlhid = "100"
				If Len(trim(xlh&""))>0 And cdbl(num1)>1 Then
					...
					arr_xlh = split(trim(xlh&""),chr(1))
					If xlhid = 0 Then xlhid = "100"
				end if
				list=list&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><input name='xlh_"&id&"' id='xlh2_"&i&"' type='hidden'  style='height: 28px; solid;font-size: 9pt;'  value='"&xlh&"' size='10' dataType='Limit' "& iif(xlhManage=1," min='1'","") &" msg='"& iif(xlhManage=1,"必填","") &"'><input type='text' style='height: 28px; solid;font-size: 9pt;' size='9' canevent='0' id='scanxlh"&i&"' onkeydown=""setContentZZ("& i &",'xlh2_','xlh_','num')"" value='"
				If xlhid = 0 Then xlhid = "100"
				if trim(xlh&"")<>"" then
					arr_xlh = split(trim(xlh&""),chr(1))
					list=list&arr_xlh(ubound(arr_xlh))
				end if
				list=list&"' onblur=""setBlurContentZZ("& i &",'xlh2_','xlh_','num')"" onfocus='this.select()'><img id='xlhimg"& i&"' src='../images/percent"& xlhid &".png' title='序列号管理' style='width:12px;height:18px;vertical-align:bottom;cursor:hand' onclick=""SetAllXlhZZ("&i&",'xlh2_','xlh_','cpmx_title_td','cpmx_order1_td','cpmx_type1_td','num')""><span id='xlhts"& i &"' style='color:red'></span>"& iif(xlhManage=1," <span class='red'>*</span>","") &" <span id='xlh_tip_"&id&"' class='red'></span></div></td>"
				sumtdclos=sumtdclos&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'></td>"
				Case 11:
				list=list&"<td align='center' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><INPUT name='datesc_"&id&"'  id='daysdatesc"&i&"Pos' cpyxqHours='"& cpyxqHours &"' onchange=""dateYxqSet('datesc','daysdatesc"&i&"Pos','daysdateyx"&i&"Pos')"" size=9  style='height: 28px; solid;font-size: 9pt;' value='"&datesc&"' readonly=true onmouseup=toggleDatePicker('daysdatesc"&i&"','date.datesc_"&id&"') ><DIV id='daysdatesc"&i&"' style='POSITION: absolute'></DIV></td>"
'Case 11:
...
'Case 11:
				Case 12:
				list=list&"<td align='center' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><INPUT name='dateyx_"&id&"'  id='daysdateyx"&i&"Pos' cpyxqHours='"& cpyxqHours &"' onchange=""dateYxqSet('dateyx','daysdatesc"&i&"Pos','daysdateyx"&i&"Pos')"" size=9  style='height: 28px; solid;font-size: 9pt;' value='"&dateyx&"' readonly=true onmouseup=toggleDatePicker('daysdateyx"&i&"','date.dateyx_"&id&"') ><DIV id='daysdateyx"&i&"' style='POSITION: absolute'></DIV></td>"
'Case 12:
				sumtdclos=sumtdclos&"<td align='center' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'></td>"
'Case 12:
				Case 13:
				list=list&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><select name='bz2_"&id&"' id='bz2_"&i&"'>"
'Case 13:
				If Len(bz&"")=0 Then bz=0
				set rs2=server.CreateObject("adodb.recordset")
				sql2="select ord,sort1 from sortonehy where gate2=82 order by gate1 desc"
...
'If rs2("ord")=CInt(bz) then
				...
				list=list+"</select></div></td>"
'set rs2=nothing
				sumtdclos=sumtdclos&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'></td>"
'set rs2=nothing
				Case 14:
				list=list&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><input name='js_"&id&"'  id='js"&i&"' type='text'  value='"&js&"' onkeyup=value=value.replace(/[^\d\.]/g,'')  style='height: 28px; solid;font-size: 9pt;'  size='5'></div></td>"
'Case 14:
				sumtdclos=sumtdclos&"<td class='name' width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'></div></td>"
'Case 14:
				Case 15:
				list=list&"<td width='"&kd&"' style='border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;'><div align='center'><textarea name='intro_"&id&"' id='intro_"&i&"' type='text' style='overflow-y:hidden;word-break:break-all;' onfocus='this.style.posHeight=this.scrollHeight' onpropertychange='this.style.posHeight=this.scrollHeight' dataType='Limit' min='0' max='200' msg='不要超过200个字' cols='9' rows='1'>"&intro&"</textarea></div></td>"
				...
				Case 16:
				list=list+"<td class='name' align='center' width='"&kd&"' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'><textarea name='zdy1_"&id&"' cols='9' rows='1' id='zdy12_"&i&"' style='overflow-y:hidden;word-break:break-all;width:50px' onFocus='this.style.posHeight=this.scrollHeight' onpropertychange='this.style.posHeight=this.scrollHeight'  datatype='Limit' min='0' max='200' msg='不要超过200个字'>"&replace(rss(""&rs("name")&"")&"","<br>",chr(10))&"</textarea></td>"
				sumtdclos=sumtdclos+"<td class='name' align='center' width='"&kd&"' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'></td>"
				Case 17:
				list=list+"<td align='center' width='"&kd&"' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'><textarea name='zdy2_"&id&"' id='zdy22_"&i&"' cols='9' rows='1' style='overflow-y:hidden;word-break:break-all;width:50px' onFocus='this.style.posHeight=this.scrollHeight' onpropertychange='this.style.posHeight=this.scrollHeight'  datatype='Limit' min='0' max='200' msg='不要超过200个字'>"&replace(rss(""&rs("name")&"")&"","<br>",chr(10))&"</textarea></td>"
				sumtdclos=sumtdclos+"<td align='center' width='"&kd&"' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'></td>"
				Case 18:
...
'if rs7("ord")=rss(""&rs("name")&"") Then
				...
				list=list+"</select></td>"
'rs7.close
				sumtdclos=sumtdclos+"<td align='center' class='name' width='"&kd&"' style='BORDER-BOTTOM:#CCC  1px  solid; BORDER-LEFT:#CCC 1px solid;BORDER-RIGHT:#CCC 1px solid;'></td>"
'rs7.close
				Case 21:
...
'for j=1 to num_cpmx_yl
	next
	Response.write(""&list_ys&"")
	Response.write "" & vbcrlf & "            </div>" & vbcrlf & "                    " & vbcrlf & "                        " & vbcrlf & "                        " & vbcrlf & "                        </td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "          <td  class=""page"">" & vbcrlf & "                  <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "                 </td>"& vbcrlf &       " </tr> "& vbcrlf &        " <tr>" & vbcrlf &       "    <td height=""40"" style=""padding-top:0"" colspan=""2"">&nbsp;&nbsp;<span id=""all_num""> "& vbcrlf &        "     <input name=""636r"" type=""hidden"" size=""6"" value="""
	'Response.write(""&list_ys&"")
	Response.write session("num_click2009")+1
	'Response.write(""&list_ys&"")
	Response.write """ id=""alli"" />" & vbcrlf & "            <input name=""636t"" type=""hidden""  value="""
	Response.write session("num_click2010")+1
	Response.write """ id=""alli_2"" />" & vbcrlf & "            </span>" & vbcrlf & "            <input type=""submit"" name=""Submit4222"" value=""保存清单""  class=""anybutton2""/>" & vbcrlf & "            &nbsp;&nbsp;&nbsp;&nbsp;" & vbcrlf & "            <input type=""reset"" name=submit2  value=""重新填写"" class=""anybutton2""/>" & vbcrlf & "              <p style=""margin-top:15px;color:red"">全月平均法同先进先出法，子件默认按照出库批次成本价显示</p>" & vbcrlf & "          </td>" & vbcrlf & "          <td width=""65%"">&nbsp;" & vbcrlf & "            <input name=""top2""   type='hidden' value="""
	Response.write top
	Response.write """ /></td>" & vbcrlf & "        </tr>" & vbcrlf & "    </table></td>" & vbcrlf & " </tr>" & vbcrlf & "</table>" & vbcrlf & " </form>" & vbcrlf & " <iframe width=""100%"" height=""500"" style=""display:none"" id=""sumitFrame"" frameborder=""0"" scrolling=""auto"" name=""sumitFrame"" src=""about:blank""></iframe>" & vbcrlf & "</div>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
	action1="拆装明细"
	call close_list(1)
%>
