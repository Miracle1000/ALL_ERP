...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	set ml=new myClass
	ord=request("ord")
	sql="select a.id,a.bk_fid,a.bk_name,a.bk_type,a.bk_bh,a.bk_auther,a.bk_publishing,a.bk_ISBN,a.bk_pubtime,a.bk_pagesize,a.bk_pagenum,a.bk_pubnum,a.bk_printtime,a.bk_returnnum,a.bk_paper,a.bk_printnum,a.bk_binding,a.bk_format,isnull(a.bk_num,0) as bk_num,a.bk_price,isnull(a.bk_allnum,0) as bk_allnum,a.bk_allmoney,a.bk_postion,a.bk_note,a.bk_addcateid,a.bk_addtime,a.bk_del,a.bk_updateid,a.bk_updatetime,a.bk_updateIP,a.sign,b.set_name,c.name from O_regbook_his a left join O_bookset b on a.bk_type=b.id left join gate c on a.bk_updateid=c.ord where a.id="&ml.isNum(ord)
	set rs=conn.execute(sql)
	if not rs.eof then
		sign=rs("sign")
		arr=split(sign,",")
		Response.write "" & vbcrlf & "<body bgcolor=""#ebebeb"" "
		if open_103_8=0 or (open_103_8=1 and CheckPurview(intro_103_8,trim(ml.isNum(rs("bk_updateid"))))=False) then
		...
		Response.write ">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">   " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">图书修改详情</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "     <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "       <form action=""Save_bookData.asp?ord="
		Response.write ord
		Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)&&ask1()"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" colspan=""6"" ><div align=""left""><strong>基本信息</strong></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "     <tr>" & vbcrlf & "            <td width=""13%"" height=""30""><div align=""right"">书名：</div></td>" & vbcrlf & "      <td height=""30"" colspan=""5"" "
		if arr(0)=0 then
		...
		Response.write "</td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "      <td width=""13%"" height=""30""><div align=""right"">编号：</div></td>" & vbcrlf & "      <td width=""20%"" height=""30"" "
		if arr(2)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        <td width=""13%"" height=""30""><div align=""right"">分类：</div></td>" & vbcrlf & "        <td width=""19%"" height=""30"" "
		if arr(1)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        <td width=""11%"" height=""30""><div align=""right"">借阅周期：</div></td>" & vbcrlf & "             <td width=""24%"" height=""30"" "
		if arr(11)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "个月</td>" & vbcrlf & "      </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td width=""13%"" height=""30""><div align=""right"">作者：</div></td>" & vbcrlf & "      <td width=""20%"" height=""30"" "
		if arr(3)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        <td width=""13%"" height=""30""><div align=""right"">出版时间：</div></td>" & vbcrlf & "        <td height=""30"" colspan=""3"" "
		if arr(6)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "      <td width=""13%"" height=""30""><div align=""right"">出版社：</div></td>" & vbcrlf & "            <td colspan=""5"" height=""30"" "
		if arr(4)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "      <td width=""13%"" height=""30""><div align=""right"">版次：</div></td>" & vbcrlf & "      <td width=""20%"" height=""30"" "
		if arr(9)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        <td width=""13%"" height=""30""><div align=""right"">页数：</div></td>" & vbcrlf & "        <td width=""19%"" height=""30"" "
		if arr(8)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        <td width=""11%"" height=""30""><div align=""right"">字数：</div></td>" & vbcrlf & "              <td width=""24%"" height=""30"" "
		if arr(7)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""30""><div align=""right"">印刷时间：</div></td>" & vbcrlf & "          <td width=""20%"" height=""30"" "
		if arr(10)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        <td width=""13%"" height=""30""><div align=""right"">开本：</div></td>" & vbcrlf & "        <td width=""19%"" height=""30"" "
		if arr(15)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        <td width=""11%"" height=""30""><div align=""right"">纸张：</div></td>" & vbcrlf & "              <td width=""24%"" height=""30"" "
		if arr(12)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""30""><div align=""right"">印次：</div></td>" & vbcrlf & "      <td width=""20%"" height=""30"" "
		if arr(13)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        <td width=""13%"" height=""30""><div align=""right"">ISBN：</div></td>" & vbcrlf & "        <td width=""19%"" height=""30"" "
		if arr(5)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "        <td width=""11%"" height=""30""><div align=""right"">装帧：</div></td>" & vbcrlf & "              <td width=""24%"" height=""30"" "
		if arr(14)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""30""><div align=""right"">单价：</div></td>" & vbcrlf & "      <td width=""20%"" height=""30"" "
		if arr(17)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
...
'if bk_price="" or isnull(bk_price) then bk_price=0
		Response.write "</td>" & vbcrlf & "        <td width=""13%"" height=""30""><div align=""right"">数量：</div></td>" & vbcrlf & "        <td width=""19%"" height=""30"" "
		if arr(18)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		'Response.write ">"
		Response.write "</td>" & vbcrlf & "        <td width=""11%"" height=""30""><div align=""right"">总价：</div></td>" & vbcrlf & "              <td width=""24%"" height=""30"" "
		if arr(19)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
...
'if bk_allmoney="" or isnull(bk_allmoney) then bk_allmoney=0
		Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "         <tr>" & vbcrlf & "                    <td width=""13%"" height=""30""><div align=""right"">可借阅数量：</div></td>" & vbcrlf & "                        <td height=""30"" "
		if arr(16)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		'Response.write ">"
		Response.write "</td>" & vbcrlf & "                        <td width=""13%"" height=""30""><div align=""right"">存放位置：</div></td>" & vbcrlf & "                  <td height=""30"" colspan=""3"" "
		if arr(20)=0 then
			Response.write "class=""gray"""
		else
			Response.write "class=""red"""
		...
		Response.write "</td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td width=""13%"" height=""30""><div align=""right"">添加人员：</div></td>" & vbcrlf & "                  <td width=""20%"" height=""30"" class=""gray"">"
		...
		set rs7=nothing
		Response.write "</td>" & vbcrlf & "                        <td width=""13%"" height=""30""><div align=""right"">添加时间：</div></td>" & vbcrlf & "                  <td height=""30"" colspan=""3"" class=""gray"">"
		Response.write rs("bk_addtime")
		Response.write "</td>" & vbcrlf & "                  </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                  <td width=""13%"" height=""30""><div align=""right"">修改人员：</div></td>" & vbcrlf & "                  <td width=""20%"" height=""30"" class=""gray"">"
		Response.write rs("name")
		Response.write "</td>" & vbcrlf & "                        <td width=""13%"" height=""30""><div align=""right"">修改时间：</div></td>" & vbcrlf & "                  <td height=""30"" class=""gray"">"
		Response.write rs("bk_updatetime")
		Response.write "</td>" & vbcrlf & "                    <td height=""30""><div align=""right"">IP地址：</div></td>" & vbcrlf & "              <td height=""30"" class=""gray"">"
		Response.write rs("bk_updateIP")
		Response.write "</td>" & vbcrlf & "                  </tr>" & vbcrlf & "        <tr>" & vbcrlf & "               <td height=""30""><p align=""right"">图书备注：</td>" & vbcrlf & "            <td height=""30"" colspan=""5"" "
		if arr(21)=0 then
			Response.write "class=""gray ewebeditorImg"""
		else
			Response.write "class=""red ewebeditorImg"""
		end if
		Response.write ">"
		Response.write rs("bk_note")
		Response.write "</td>" & vbcrlf & "            </tr> " & vbcrlf & "       </form>" & vbcrlf & "    </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "                </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	else
