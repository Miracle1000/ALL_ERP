...
Response.write Application("sys.info.jsver")
Response.write """ language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "body{background:url(""../images/body_bg.jpg"") repeat-x -159px top;}" & vbcrlf & "</style>" & vbcrlf & "<script src= ""../Script/ca_tophome3.js?ver="
Response.write Application("sys.info.jsver")
'Response.write Application("sys.info.jsver")
...
sorce=0
sorce2=0
sql="select isnull(num1,0) as num1,sorce,sorce2 from gate where ord="&cateid&" "
rs.open sql,conn,1,1
if not rs.eof then
num_del=rs("num1")
sorce=rs("sorce")
...
tdate=cdate(request("hiddendate"))
end if
flag=0
td=cdate(year(tdate)&"-"&month(tdate)&"-1")''
flag=0
tdmonth=month(tdate)''
tdyear=year(tdate)
Dim gate_person
...
Response.write "" & vbcrlf & "<style>#w1, #w2, #w3{width:100px;}</style>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""1"">" & vbcrlf & "  <tr>" & vbcrlf & "<td valign=""top"">" & vbcrlf & "   <form action="""" method=""post""　id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"" >" & vbcrlf & "   <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "  <td><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif""  style='margin-top:-1px'>"& vbcrlf & "  <tr>" & vbcrlf & "<td  class=""place2"" style='width:160px;background-position:right top;padding-left:20px;border-left:1px solid #c0ccdc;background:url(../images/m_mplace2.gif) no-repeat center center'>销售月报表</td>" & vbcrlf & "<td  width=""240"">" & vbcrlf & "  <table width=""100%"" cellspacing=""2"">" & vbcrlf & "<tr height=""25"">" & vbcrlf & "  <td align=""center""><a href=""tophome3.asp?hiddendate="
Response.write DateAdd("m",-1,cdate(td))
Response.write "&cateid="
Response.write cateid
Response.write """><img src=""../images/main_2.gif"" width=""8"" height=""8"" border=""0"" /> 前一月</a></td>" & vbcrlf & "  <td colspan=""3"" align=""center"">"
Response.write tdyear
Response.write "年"
Response.write tdmonth
Response.write "月份</td>" & vbcrlf & "  <td align=""center""><a href=""tophome3.asp?hiddendate="
Response.write DateAdd("m",1,cdate(td))
Response.write "&cateid="
Response.write cateid
Response.write """>后一月 <img src=""../images/main_1.gif"" width=""8"" height=""8"" border=""0"" /></a></td>" & vbcrlf & "<td></td>" & vbcrlf & "</tr>" & vbcrlf & "</table></td>" & vbcrlf & "<td align=""right"">" & vbcrlf & "   <input type=""button"" name=""Submit43"" value=""打印""  onClick=""window.print()""  class=""anybutton""/>" & vbcrlf & " <input name=""Submit6"" type=""button""  onClick=""window.location.href='tophome1.asp?cateid="
Response.write cateid
...
Response.write cateid
Response.write "'"" class=""anybutton"" value=""周报"" />" & vbcrlf & "  <input name=""Submit6"" type=""button"" onClick=""window.location.href='tophome4.asp?cateid="
Response.write cateid
...
Response.write "" & vbcrlf & " </td>" & vbcrlf & "<td  width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr>" & vbcrlf & "  <td><table class=""detailTable"" width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""  style=""margin-top:0px"">" & vbcrlf & " <tr class=""top"">" & vbcrlf & "  <td colspan=""9""><div align=""left"">&nbsp;&nbsp;月目标与完成情况评定</div></td>" & vbcrlf & "</tr>" & vbcrlf
num_update=8
sql1="select isnull(num_month,0) from gate where ord="&cateid
rs1.open sql1,conn
if not rs1.eof then
num_update=rs1(0)
end if
rs1.close
sql1="select ord,intro,date7,addcatename from plan2  where   date1='"&td&"' and type=3 and cateid="&cateid&" "
rs1.open sql1,conn,1,1
if rs1.eof then
p3=""
pord3=0
...
rs1.close
sql1="select ord,intro,date7,addcatename from plan2  where   date1='"&td&"' and type=4 and cateid="&cateid&" "
rs1.open sql1,conn,1,1
if rs1.eof then
p4=""
date74=td
...
pord4=rs1("ord")
date74=rs1("date7")
addcatename4=rs1("addcatename")
end if
rs1.close
sql1="select ord,intro,date7,cateid,addcatename from plan2  where   date1='"&td&"' and type=5 and cateid="&cateid&" "
rs1.open sql1,conn,1,1
if rs1.eof then
p5=""
pord5=0
...
pord5=rs1("ord")
date75=rs1("date7")
addcatename5=rs1("addcatename")
end if
rs1.close
sql1="select ord,intro,date7,cateid,addcatename from plan2  where   date1='"&td&"' and type=6 and cateid="&cateid&" "
rs1.open sql1,conn,1,1
if rs1.eof then
p6=""
pord6=0
...
pord6=rs1("ord")
date76=rs1("date7")
addcatename6=rs1("addcatename")
end if
rs1.close
sql1="select count(*) from plan2  where  date1='"&td&"' and type=13 and cateid="&cateid&" "
pc2=conn.execute(sql1)(0)
sql1="select count(*) from plan2  where  date1='"&td&"' and type=14 and cateid="&cateid&" "
pc1=conn.execute(sql1)(0)
Response.write "" & vbcrlf & " <tr>" & vbcrlf & "<td><div align=""center"">本月目标</div></td>" & vbcrlf & "<td class=""ewebeditorImg_plan"" colspan=""7"" "
...
Response.write "&cateid="
Response.write cateid
Response.write "&H=5&time1=11','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen=no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" title=""点击添加本月目标"""
'Response.write cateid
else
Response.write "onclick=""javascript:window.open('../plan/correcthome2.asp?id="
Response.write pwurl(pord5)
Response.write "&H=5','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"""
'Response.write pwurl(pord5)
end if
else
...
if p5<>"" and PowerV_71_1 then
Response.write p5
Response.write " <font class=""red"">（"
Response.write addcatename5&" "&date75
Response.write "）</font>"
end if
...
if now()<=dateadd("h",num_update,dateadd("m",1,td)) and int(cateid)=int(session("personzbintel2007")) then
if p6="" then
Response.write "onClick=""javascript:window.open('../plan/addhome2.asp?date1="
Response.write td
Response.write "&cateid="
Response.write cateid
Response.write "&H=6&time1=11','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen=no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" title=""点击添加本月目标总结"""
'Response.write cateid
else
Response.write "onclick=""javascript:window.open('../plan/correcthome2.asp?id="
Response.write pwurl(pord6)
Response.write "&H=6','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"""
'Response.write pwurl(pord6)
end if
else
Response.write " onClick=""confirm('"
...
Response.write " style=""cursor:pointer"">" & vbcrlf & "   "
if p6<>"" and PowerV_71_1 then
Response.write p6
Response.write " <font class=""red"">（"
Response.write addcatename6&" "&date76
Response.write "）</font>"
end if
...
" and type=14 and cateid="&cateid&" and spid in("&rs("charSpId")&") and lcb="&rs("intLevel")&" order by ord desc"
rs2.open strSql2,conn
...
Response.write "&H=14','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"">【修改】</a>" & vbcrlf & "  "
'Response.write pwurl(rs2("ord"))
end if
else
...
Response.write "&H=14&time1=11','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen=no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"">【添加评定】</a>" & vbcrlf & ""
'Response.write rs("intLevel")
end if
end if
rs2.close
...
Response.write "" & vbcrlf & " <tr>" & vbcrlf & "<td><div align=""center"">本月计划</div></td>" & vbcrlf & "<td class=""ewebeditorImg_plan"" colspan=""7"" "
if now()<=dateadd("h",num_update,td) and int(cateid)=int(session("personzbintel2007")) then
if p3="" then
Response.write "onClick=""javascript:window.open('../plan/addhome2.asp?date1="
Response.write td
Response.write "&cateid="
Response.write cateid
Response.write "&H=3&time1=11','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen=no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" title=""点击添加本月计划"""
'Response.write cateid
else
Response.write "onclick=""javascript:window.open('../plan/correcthome2.asp?id="
Response.write pwurl(pord3)
...
Response.write " style=""cursor:pointer"">" & vbcrlf & "   "
if p3<>"" and PowerV_71_1 then
Response.write p3
Response.write " <font class=""red"">（"
Response.write addcatename3&" "&date73
Response.write "）</font>"
end if
Response.write "" & vbcrlf & " </td>" & vbcrlf & "</tr>" & vbcrlf & "  <tr>" & vbcrlf & "<td><div align=""center"">本月总结</div></td>" & vbcrlf & "<td class=""ewebeditorImg_plan"" colspan=""7"" "
if now()<=dateadd("h",num_update,dateadd("m",1,td)) and int(cateid)=int(session("personzbintel2007")) then
if p4="" then
Response.write "onClick=""javascript:window.open('../plan/addhome2.asp?date1="
Response.write td
Response.write "&cateid="
Response.write cateid
Response.write "&H=4&time1=11','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen=no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" title=""点击添加本月计划总结"""
'Response.write cateid
else
Response.write "onclick=""javascript:window.open('../plan/correcthome2.asp?id="
Response.write pwurl(pord4)
...
Response.write " style=""cursor:pointer"">" & vbcrlf & "   "
if p4<>"" and PowerV_71_1 then
Response.write p4
Response.write " <font class=""red"">（"
Response.write addcatename4&" "&date74
Response.write "）</font>"
end if
Response.write "" & vbcrlf & " </td>" & vbcrlf & "</tr>" & vbcrlf & "  <tr>" & vbcrlf & "<td rowspan="""
Response.write iif(rowspan<=0,1,rowspan)
Response.write """><div align=""center"">领导评定</div></td>" & vbcrlf & "" & vbcrlf & ""
strSql="select charSpId,charName,intLevel,isnull(time1,0) as time1 from sp_schedule order by intLevel"
rs.open strSql,conn
do while not rs.eof
time1=rs("time1")
...
Response.write "" & vbcrlf & " <tr class=""top"">" & vbcrlf & "   <td colspan=""8""><div align=""left"">&nbsp;&nbsp;每周计划与完成情况</div></td>" & vbcrlf & "</tr>" & vbcrlf & "   "
tdmonth=month(td)
tdyear=year(td)
i=1
for j=1 to 31
...
Response.write "" & vbcrlf & "  <tr>" & vbcrlf & "<td width=""10%"" rowspan="""
Response.write rowspan2
Response.write """ align=""center"" bgcolor=""#FFFFFF"">自："
Response.write td1
Response.write "<br /><div  class=""daynumber""><a href=""tophome2.asp?cateid="
Response.write cateid
Response.write "&jtdate="
Response.write td1
Response.write """><b><font "
if datediff("d",td1,date())>0 and  datediff("d",td1,date())<7 then
...
Response.write ">第"
Response.write i
Response.write "周</font></b></a></div>至："
Response.write td2
...
p3=""
num_update1=8
sql1="select num_week from gate where ord="&cateid
rs1.open sql1,conn
if not rs1.eof then
num_update1=rs1(0)
end if
...
sql1="select ord,intro,date7,addcatename from plan2  where   date1='"&td1&"' and type=1 and cateid="&cateid&" "
rs1.open sql1,conn,1,1
dim pord,p
if rs1.eof then
p=""
...
rs1.close
sql1="select ord,intro,date7,addcatename from plan2  where   date1='"&td1&"' and type=2 and cateid="&cateid&" "
rs1.open sql1,conn,1,1
dim pord2,p2
if rs1.eof then
p2=""
...
rs1.close
sql1="select ord,intro,date7,cateid,addcatename from plan2  where   date1='"&td1&"' and type=12 and cateid="&cateid&" "
rs1.open sql1,conn,1,1
if rs1.eof then
p12=""
pord12=0
...
date712=rs1("date7")
addcate=rs1("cateid")
addcatename12=rs1("addcatename")
end if
rs1.close
sql1="select count(*) from plan2  where  date1='"&td1&"' and type=12 and cateid="&cateid&" "
pc3=conn.execute(sql1)(0)
Response.write "" & vbcrlf & "<td width=""8%"" align=""center"">本周计划</td>" & vbcrlf & "<td class=""ewebeditorImg_plan"" colspan=""6"" "
...
Response.write "&cateid="
Response.write cateid
Response.write "&H=1&time1=11','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen=no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" title=""点击添加本周计划"""
'Response.write cateid
else
Response.write "onclick=""javascript:window.open('../plan/correcthome2.asp?id="
Response.write pwurl(pord)
Response.write "&H=1','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"""
'Response.write pwurl(pord)
end if
else
if p<>"" then
...
Response.write "" & vbcrlf & "  </td>" & vbcrlf & " </tr>" & vbcrlf & "   <tr>" & vbcrlf & "<td align=""center"">本周总结</td>" & vbcrlf & "<td class=""ewebeditorImg_plan"" colspan=""6"" "
if now()<=dateadd("h",num_update1,cDate(td1+7)) and int(cateid)=int(session("personzbintel2007")) then
if p2="" then
Response.write "onClick=""javascript:window.open('../plan/addhome2.asp?date1="
Response.write td1
Response.write "&cateid="
Response.write cateid
Response.write "&H=2&time1=11','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen=no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" title=""点击添加本周总结"""
'Response.write cateid
else
Response.write "onclick=""javascript:window.open('../plan/correcthome2.asp?id="
Response.write pwurl(pord2)
Response.write "&H=2','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"""
'Response.write pwurl(pord2)
end if
else
if p2<>"" then
...
" and type=12 and cateid="&cateid&" and spid in("&rs("charSpId")&") and lcb="&rs("intLevel")&" order by ord desc"
rs2.open strSql2,conn
if not rs2.eof then
Response.write rs2("intro")
Response.write " <font class=""red"">（"
...
Response.write "" & vbcrlf & " <a href=""javascript:void(0)"" onClick=""javascript:window.open('../plan/correcthome2.asp?id="
Response.write pwurl(rs2("ord"))
Response.write "&H=12','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"">【修改】</a>" & vbcrlf & "  "
'Response.write pwurl(rs2("ord"))
end if
else
if CheckPurview(rs("charSpId"),session("personzbintel2007"))  and ((open_71_16=1 and CheckPurview(intro_71_16,cateid)) or open_71_16=3) then
...
Response.write "&lcb="
Response.write rs("intLevel")
Response.write "&H=12&time1=11','newwin','width=' + 800 + ',height=' + 500 + ',fullscreen=no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"">【添加评定】</a>" & vbcrlf & ""
'Response.write rs("intLevel")
end if
end if
rs2.close
