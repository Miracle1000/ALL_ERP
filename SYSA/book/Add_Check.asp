...
'if isnull(values) then IsTime = null : exit function
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "" & vbcrlf & "var a="
	Response.write ordnum
	Response.write "" & vbcrlf & "var b="
	Response.write ordnum
	Response.write "" & vbcrlf & "function addtr(Chk_pdnum)" & vbcrlf & "{" & vbcrlf & "    if(typeof(Chk_pdnum) == ""undefined""){Chk_pdnum = 1;}" & vbcrlf & "    $('#ddd').dialog('close');" & vbcrlf & "        var Table=document.getElementById('add_tr');" & vbcrlf & "    var tr=document.createElement(""tr"");" & vbcrlf &"  tr.id=""tr_""+b;" & vbcrlf & "    tr.name=""table_tr"";" & vbcrlf & "       Table.appendChild(tr);" & vbcrlf & "  tr.onmouseover=function(){this.style.backgroundColor='efefef';}" & vbcrlf & " tr.onmouseout=function(){this.style.backgroundColor='';}" & vbcrlf & "        " & vbcrlf & "        "
	Response.write ordnum
	...
	if not rs7.eof then
		do while not rs7.eof
			if rs7("name")="书名" then
				Response.write "" & vbcrlf & "      var td1 = document.createElement('td');" & vbcrlf & " tr.appendChild(td1);" & vbcrlf & "    var Href = ""<div align=\""center\""><input type=\""text\"" readonly='true' style='color:#CCCCCC;' name=\""bookname\"" id=\""bookname""+b+""\"" size=\""15\"" value=\""点击选择图书\"" maxlength=\""2000\""><input type=\""hidden\"" id=\""Chk_bkid""+b+""\"" name=\""Chk_bkid\"">&nbsp;<a href=\""###\"" onclick=\""del_TR('""+tr.id+""')\""><img src=\""../images/del2.gif\""/></a>&nbsp;<span id='sortlist'>""+a+""</span></div>"";" & vbcrlf & "   td1.innerHTML=Href;" & vbcrlf & "     "
'if rs7("name")="书名" then
			end if
			if rs7("name")="编号" then
...
'if rs7("name")="添加时间" then
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "     var td23 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td23);" & vbcrlf & "   var Href = ""<div align=\""center\"" id='Chk_sjnum1""+b+""'>0</div><input name=\""Chk_sjnum\"" type=\""hidden\"" id=\""Chk_sjnum""+b+""\"" value=\""0\"">"";" & vbcrlf & "    td23.innerHTML=Href;" & vbcrlf & " var td28 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td28);" & vbcrlf & "   var Href = ""<div align=\""center\""><input name=\""Chk_pdnum\"" type=\""text\"" id=\""Chk_pdnum\"" value=\""""+Chk_pdnum+""\"" size=\""10\"" maxlength=\""20\"" onkeyup=\""value=value.replace(/[^\\d]/g,'')\"" onpropertychange=\""allsum()\""></div>"";" & vbcrlf & " td28.innerHTML=Href;" & vbcrlf & "    var td24 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td24);" & vbcrlf & "   var Href = ""<div align=\""center\""><input name=\""Chk_yknum\"" type=\""text\"" id=\""Chk_yknum\"" readonly=\""true\"" value=\""1\"" size=\""10\"" maxlength=\""20\""></div>"";" & vbcrlf & "      td24.innerHTML=Href;" & vbcrlf & "    var td27 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td27);" & vbcrlf & "   var Href = ""<div align=\""center\""><input type=\""\"" name=\""Chk_note1\"" id=\""Chk_note1\"" size=\""15\"" maxlength=\""2000\""></div>"";" & vbcrlf & "       td27.innerHTML=Href;" & vbcrlf & "    " & vbcrlf & "        allsum();" & vbcrlf & "       a=a+1;" & vbcrlf & "  b=b+1;" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body { margin-top:0px;}" & vbcrlf & "img{border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "#adddiv{width:1000px;height:300px;OVERFLOW:auto;" & vbcrlf & "SCROLLBAR-FACE-COLOR:#F0F4FD;SCROLLBAR-HIGHLIGHT-COLOR:#ffffff;SCROLLBAR-SHADOW-COLOR:#919192;SCROLLBAR-3DLIGHT-COLOR:#ffffff;SCROLLBAR-ARROW-COLOR:#919192;SCROLLBAR-TRACK-COLOR:#ffffff;SCROLLBAR-DARKSHADOW-COLOR:#ffffff;}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"" scroll=""auto"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">     " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">盘点添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "         <form action=""Save_Return.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)&&ask1()"">" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td width=""15%"" height=""27"" ><div align=""left""><strong>基本信息</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "                 <div align=""right"">" & vbcrlf & "                 <input type=""button"" name=""Submit44"" value=""保存"" class=""page"" onClick=""ask1('1')""/>" & vbcrlf & "                  <input type=""button"" name=""Submit45"" value=""暂存"" class=""page"" onClick=""ask1('2')""/>" & vbcrlf & "             <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "               </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "            <tr>" & vbcrlf & "                    <td height=""30""><div align=""right"">盘点主题：</div></td>" & vbcrlf &            "         <td width=""18%""><input type=""text"" name=""chk_title"" id=""chk_title"" maxlength=""500"" style=""width:150px;"">&nbsp;<span id=""test1"" class=""red"">*</span></td> "& vbcrlf &               "      <td width=""16%""><div align=""right"">盘点时间：</div></td> "& vbcrlf &                 "    <td width=""16%""><input name=""chk_time"" type=""text"" size=""18"" style=""width:140px"" value="""
	Response.write now
	Response.write """ id=""daysOfMonthPosy"" onclick=""datedlg.showDateTime();"" readonly=""true""><DIV id=""daysOfMonthy"" style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "               <td width=""16%""><div align=""right"">盘点人员：</div></td>" & vbcrlf & "                    <td width=""19%""><input type=""text"" name=""chk_name"" readonly=""true"" id=""chk_name"" maxlength=""200"" onClick=""javascript:window.open('../search/search_person1.asp?parse1=chk_name&parse2=chk_cateid','neww37win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');"" value="""
	Response.write now
	Response.write session("name2006chen")
	Response.write """ style=""width:150px;""><input type=""hidden"" name=""chk_cateid"" value="""
	Response.write session("personzbintel2007")
	Response.write """ id=""chk_cateid"" maxlength=""200"">&nbsp;<span id=""test2"" class=""red"">*</span></td>" & vbcrlf & "                </tr>" & vbcrlf & "        <tr>" & vbcrlf & "                 <td colspan=""6"">" & vbcrlf & "                  <div id=""adddiv"" style=""width:100%"">" & vbcrlf & "                      <table border=""0"" width=""100%"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                               <tr class=""top"">" & vbcrlf & "                          "
	...
	if rs7.eof Then
		...
		action1="图书盘点添加":call close_list(1)
		Response.end()
	else
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "                                     <td height=""27"" width=""100"" align=""center""><pre><b>账面数量</b></td>" & vbcrlf & "                                  <td height=""27"" width=""100"" align=""center""><pre><b>实际数量</b></td>" & vbcrlf & "                                  <td height=""27"" width=""100"" align=""center""><pre><b>盈亏数量</b></td>" & vbcrlf & "                                  <td height=""27"" align=""center""><pre><b>备注</b></td>" & vbcrlf & "                            </tr>" & vbcrlf & "                           <tbody id=""add_tr"">" & vbcrlf & "                               "
	if ord<>"" then
		h=1
		sql8="select a.*,b.set_name,c.name from O_regbook a left join O_bookSet b on a.bk_type=b.id left join gate c on a.bk_addcateid=c.ord  where a.id in ("&ord&")"
				...
				if not rs7.eof then
					...
					do while not rs7.eof
						if rs7("name")="书名" then
							...
							Response.write """ maxlength=""2000""><input type=""hidden"" id=""Chk_bkid"
							Response.write h
							Response.write """ name=""Chk_bkid"" value="""
...
'if bk_allmoney="" or isnull(bk_allmoney) then bk_allmoney=0
				...
				rs7.close
				set rs7=nothing
				Response.write "" & vbcrlf & "                                             <td height=""27""><div align=""center"" id=""Chk_sjnum1"
				Response.write h
				Response.write """>"
				Response.write rs8("bk_num")
				Response.write "</div><input name=""Chk_sjnum"" type=""hidden"" id=""Chk_sjnum"
				Response.write h
				Response.write """ size=""10"" value="""
				Response.write rs8("bk_num")
				Response.write """></td>" & vbcrlf & "                                           <td height=""27""><div align=""center""><input name=""Chk_pdnum"" type=""text"" id=""Chk_pdnum"" size=""10"" maxlength=""20"" onkeyup=""value=value.replace(/[^\d]/g,'')"" onpropertychange=""allsum()"" value="""
				Response.write rs8("bk_num")
				Response.write """></div></td>" & vbcrlf & "                                             <td height=""27""><input name=""Chk_yknum"" type=""text"" id=""Chk_yknum"" readonly=""true"" size=""10"" maxlength=""20"" value="""
				Response.write yknum
				Response.write """></td>" & vbcrlf & "                                           <td height=""27""><div align=""center""><input type="""" name=""Chk_note1"" id=""Chk_note1"" size=""15"" value="""" maxlength=""2000""></div></td>" & vbcrlf & "                                      </tr>" & vbcrlf & "                                   "
				h=h+1
				allnums1=ml.IsNum(allnums1)+rs8("bk_num")
				allnums2=ml.IsNum(allnums2)+1
				allnums3=ml.IsNum(allnums3)+yknum
				rs8.movenext
			loop
		end if
		rs8.close
	...
	Response.write "</div></td>" & vbcrlf & "                                  <td align=""center""><div id=""allnums2"">"
	Response.write allnums2
	Response.write "</div></td>" & vbcrlf & "                                  <td align=""center""><div id=""allnums3"">"
	Response.write allnums3
	Response.write "</div></td>" & vbcrlf & "                                  <td align=""center""></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                  </div></td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td height=""30""><div align=""center"">盘点备注：</div></td>" & vbcrlf & "                   <td colspan=""5""><textarea name=""chk_note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "          <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=chk_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "         </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray"">" & vbcrlf & "                  <div align=""center"">" & vbcrlf & "                      <input type=""button"" name=""Submit42"" value=""保存"" class=""page"" onClick=""ask1('1')""/>" & vbcrlf & "                      <input type=""button""name=""Submit43"" value=""暂存"" class=""page"" onClick=""ask1('2')""/>" & vbcrlf &               "    <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf &             "     </div></td> "& vbcrlf &    "   </tr> " & vbcrlf &   "  </table>" & vbcrlf &    "  </form> "& vbcrlf &      "   </td>" & vbcrlf &"   </tr> "& vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""ddd"" class=""easyui-dialog"" icon=""icon-search"" title=""选择图书""  style=""width:900px;height:500px;padding:5px;background:#fafafa;top:0px"" closed=""true"" >" & vbcrlf & " <div region=""center"" border=""false"" style=""padding:10px;background:#fff;border:1px solid #ccc;width:100%"">" & vbcrlf & "          <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""  style=""word-break:break-all;word-wrap:break-word;"">" & vbcrlf & "                    <tr>" & vbcrlf & "                            <td height=""27""><div id=""resultbook""></div></td>" & vbcrlf & "                    </tr>" & vbcrlf & "               </table>" & vbcrlf & "        </div>" & vbcrlf & "  <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "            <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$('#ddd').window('close');"">关闭</a>" & vbcrlf & "  </div>" & vbcrlf & "</div>" & vbcrlf & ""
	action1="图书盘点添加"
	call close_list(1)
