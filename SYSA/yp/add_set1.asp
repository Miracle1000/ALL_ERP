...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "      margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "function ask1()" & vbcrlf & "{" & vbcrlf & "        if(document.getElementById('name1').value=="""")" & vbcrlf & "    {" & vbcrlf & "               alert('名称不能为空');" & vbcrlf & "          return false;" & vbcrlf & "   }" & vbcrlf & "       if ($(""input[name=member1]:checked"").val()==""1"")" & vbcrlf & "    {" & vbcrlf & "               if ($(""input[name=member2]:checked"").size()==0)" & vbcrlf & "           {" & vbcrlf & "                       alert('请勾选查看人员');" & vbcrlf & "                        return false;   " & vbcrlf & "                }" & vbcrlf & "       }" & vbcrlf & "       document.date.action=""save_set1.asp?tp=1&ord="
	Response.write ord
	Response.write """" & vbcrlf & "  document.date.submit();" & vbcrlf & "}" & vbcrlf & "function ask2()" & vbcrlf & "{" & vbcrlf & "        if(document.getElementById('name1').value=="""")" & vbcrlf & "    {" & vbcrlf & "               alert('名称不能为空');" & vbcrlf & "          return false;" & vbcrlf & "   }" & vbcrlf & "       if ($(""input[name=member1]:checked"").val()==""1"")" & vbcrlf & "   {" & vbcrlf & "               if ($(""input[name=member2]:checked"").size()==0)" & vbcrlf & "           {" & vbcrlf & "                       alert('请勾选查看人员');" & vbcrlf & "                        return false;   " & vbcrlf & "                }       " & vbcrlf & "        }" & vbcrlf & "       document.date.action=""save_set1.asp?ord="
	Response.write ord
	Response.write """" & vbcrlf & "  document.date.submit();" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function showHidden(typ)" & vbcrlf & "{" & vbcrlf & "       if(typ=='1')" & vbcrlf & "    {" & vbcrlf & "               document.getElementById('tdr').style.display='block';" & vbcrlf & "   }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               document.getElementById('tdr').style.display='none';" & vbcrlf & "    }" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & ""
	Dim sto_intro : sto_intro = ""
	if ord="" or isnull(ord) then ord=0
	if ord<>0 then
		sql7="select * from O_store where id="&ord
		set rs7=conn.execute(sql7)
		if not rs7.eof then
			sto_name=rs7("sto_name")
			sto_gate2=rs7("sto_gate2")
			sto_note=rs7("sto_note")
			sto_state=rs7("sto_state")
			sto_intro=replace(rs7("sto_intro")&""," ","")
		end if
		rs7.close
	end if
	if sto_state="" or isnull(sto_state) then sto_state=1
	Dim member1 : member1 = 0
	If Len(sto_intro)>0 And sto_intro<>"0" Then
		member1 = 1
	end if
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top""> " & vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">仓库"
	if ord<>0 then
		Response.write "修改"
	else
		Response.write "添加"
	end if
	Response.write "</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & "     <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "     <form method=""post"" action=""save_set.asp?ord="
	Response.write ord
	Response.write """ id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "      <tr>" & vbcrlf & "        <td width=""20%"" height=""30"" ><div align=""right"">仓库名称：</div></td>" & vbcrlf & "        <td ><input name=""name1"" type=""text"" id=""name1"" maxlength=""200"" value="""
	Response.write sto_name
	Response.write """><span id=""test1"" class=""red""></span></td>" & vbcrlf & "        </tr>" & vbcrlf & "               <tr>" & vbcrlf & "                    <td height=""30""><div align=""right"">仓库状态：</div></td>" & vbcrlf & "                    <td height=""30""><input name=""type1"" type=""radio"" value=""1"" "
	if sto_state=1 then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "                     启用<input type=""radio"" name=""type1"" value=""2"" "
	if sto_state=2 then
		Response.write "checked"
	end if
	Response.write ">暂停</td>" & vbcrlf & "            </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td height=""30""><div align=""right"">查看人员：</div></td>" & vbcrlf & "                    <td height=""30"">" & vbcrlf & "                  <table width=""100%"" border=""0"" cellpadding=""5"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">      " & vbcrlf & "<tr>" & vbcrlf & "                                     <td colspan=""4"" height=""37"">" & vbcrlf & "                                        <div align=""left""><input type=""radio"" name=""member1"" value=""1"" "
	if member1=1 then
		Response.write "checked"
	end if
	Response.write " onclick=""showHidden(1)"">允许以下用户查看此仓库（在被允许用户前面的方框打勾） <input type=""radio"" name=""member1"" "
	if member1=0 then
		Response.write "checked"
	end if
	Response.write " onclick=""showHidden(0)"" value=""0"">允许所有用户查看 </div></td>" & vbcrlf & "                                    </tr>" & vbcrlf & "                                    <tr id=""tdr"" style="""
	If member1=0 Then
		Response.write "display:none;"
	end if
	Response.write """>" & vbcrlf & "                                    <td colspan=""4"">" & vbcrlf & "                                          <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style='min-width:600px'>" & vbcrlf & "                                              <tr>" & vbcrlf & "                                                 <td colspan=""4"">" & vbcrlf & "                                          "
	Response.write "display:none;"
	...
	Response.write CBaseUserTreeHtml(basesql,"", "","","member2",  "", "", "", sto_intro)
	Response.write "" & vbcrlf & "                                              </td></tr>" & vbcrlf & "                                                </table>" & vbcrlf & "                                              </td>" & vbcrlf & "                                    </tr>" & vbcrlf & "                  </table>" & vbcrlf & "                        </td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td height=""30""><div align=""right"">仓库备注：</div></td>" & vbcrlf & "                    <td height=""30""><input name=""note"" type=""text"" id=""note"" size=""50"" maxlength=""2000"" value="""
	Response.write sto_note
	Response.write """></td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr>" & vbcrlf & "        <td height=""30""><div align=""right"">重要指数：</div></td>" & vbcrlf & "        <td height=""30""><select name=""gate2"" id=""gate2"">" & vbcrlf & "              "
	for i=1 to 40
		Response.write "" & vbcrlf & "             <option value="""
		Response.write i
		Response.write """ "
		if cdbl(sto_gate2)=cdbl(i) then
	...
	next
	Response.write "" & vbcrlf & "        </select>        </td>" & vbcrlf & "        </tr>" & vbcrlf & "    <tr>" & vbcrlf & "        <td height=""30"" colspan=""2""><div align=""center"">" & vbcrlf & "          <input name=""Submit22"" type=""button"" class=""anybutton2"" value="""
	if ord<>0 then
		Response.write "保存"
	else
		Response.write "保存"
	...
	if ord=0 then
		...
		Response.write "并添加"" onClick=""ask1()"">" & vbcrlf & "              "
	end if
	Response.write "" & vbcrlf & "          <input name=""Submit223"" type=""reset"" class=""anybutton2"" value=""重置"">" & vbcrlf & "        </div></td>" & vbcrlf & "      </tr> " & vbcrlf & "  </form> " & vbcrlf & "    </table>" & vbcrlf & " " & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf& "  <td  class=""page"">" & vbcrlf & "     <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""40"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" & vbcrlf & "           </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<script language=""javascript"">" & vbcrlf & "function checkAll()" & vbcrlf & "{" & vbcrlf & "      var checkbox=document.getElementsByName('member2');" & vbcrlf & "     var checkall=document.getElementById('checkall');" & vbcrlf & "       if (checkall.checked==true)" & vbcrlf & "     {" & vbcrlf & "               for (i=0;i<checkbox.length;i++)" & vbcrlf & "                {" & vbcrlf & "                       checkbox[i].checked=true;" & vbcrlf & "               }" & vbcrlf & "       }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               for (i=0;i<checkbox.length;i++)" & vbcrlf & "         {" & vbcrlf & "                       checkbox[i].checked=false;" & vbcrlf & "              }" & vbcrlf & "       }       " & vbcrlf &"}" & vbcrlf & "</script>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
