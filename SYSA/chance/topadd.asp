...
'bigsystemtype = ".mozi"
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"" />" & vbcrlf & "<style> " & vbcrlf & " #cp_search{width:221px!important;padding:0;padding-top:5px}" & vbcrlf & " .ie5 #cp_search{width:215px!important;}" & vbcrlf & " #demo table td span table tr{" & vbcrlf & "     background-color:#FFF;" & vbcrlf & " }"& vbcrlf & "</style>" & vbcrlf & "<script language=""javascript"" src=""../sortcp/function.js?ver="
	Response.write Application("sys.info.jsver")
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/ce_topadd.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=JavaScript1.2></SCRIPT>" & vbcrlf & "</head>" & vbcrlf & "<body class=""BillUI"" onLoad=""txmFocus();"" onclick=""TexTxmFocus(event);"" oncontextmenu=self.event.returnValue=false onmouseover=""jQuery('#info_show_div').hide();"">" & vbcrlf & ""
	dim MODULES
	...
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select sum(kd) as num1 from zdymx where sort1=3 and set_open=1"
	rs7.open sql7,conn,1,1
	if not rs7.eof then
		num1_kd=zbcdbl(rs7("num1"))
	end if
	rs7.close
	set rs7=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""5"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""515"" valign=""top"">" & vbcrlf & "     "
...
'ElseIf treeType = "TC" Then
	...
	Call ShowLeftTree
	Response.write "" & vbcrlf & "      </td>" & vbcrlf & "    <td valign=""top"">" & vbcrlf & "        <form name=""date"" id=""demo"" class='pagefrm' method=""post"" action=""savelistadd.asp"" onSubmit=""return Validator.Validate(this,2)"" >" & vbcrlf & " <table width="""
	Response.write num1_kd+120
	Response.write """ border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "        <td class=""place place42"">项目产品清单</td>" & vbcrlf & "            <td>"
	...
	Response.write "</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & "<table class=""bgfff"" width=""100%"" border=""0""  background=""../images/m_table_top.jpg""  cellpadding=""3"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;table-layout:fixed;background:#FFF;"">" & vbcrlf & "     " & vbcrlf & "        <tr  id='productlistHead'>" & vbcrlf & ""
	'Response.write pwurl(top)
	set rs=server.CreateObject("adodb.recordset")
	...
	do until rs.eof
		strDisplay=""
		if ((rs("sorce")=5 or rs("sorce")=7) and open_3_21=0) then
			strDisplay=" display:none;"
			Response.write "" & vbcrlf & "<td class=""resetBorderColor"" dbname='"
			Response.write rs.fields("name").value
			Response.write "' width="""
			Response.write rs("kd")
			Response.write """ height=""26"" align=""center"" style="""
			Response.write strDisplay
			Response.write "border-top:#CCC 1px solid;border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;""><strong>"
			Response.write strDisplay
			Response.write rs("title")
			Response.write "</strong></td>" & vbcrlf & ""
		elseif ((rs("sorce")=16 or rs("sorce")=17) and open_3_22=0) then
			strDisplay=" display:none;"
			Response.write "" & vbcrlf & "<td class=""resetBorderColor"" dbname='"
			Response.write rs.fields("name").value
			Response.write "' width="""
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "     </tr>" & vbcrlf & "</table>" & vbcrlf & "<span id=""trpx0"">" & vbcrlf & "<table width=""100%"" border=""0""  cellpadding=""3"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;background:#FFF;"">" & vbcrlf & "<tr >" & vbcrlf & "     <td class=""resetBorderColor"" height=""40"" valign=""middle"" style=""border-bottom:#CCC 1px solid;border-left:#CCC 1px solid;border-right:#CCC 1px solid;"">无产品明细！</td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "</span>" & vbcrlf & ""
	'set rs=nothing
	for i=1 to num_cpmx_yl
		list_ys=list_ys+"<span id='trpx"&i&"'></span>"
'for i=1 to num_cpmx_yl
	next
	Response.write(""&list_ys&"")
	Response.write "" & vbcrlf & "  </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""50"" colspan=""2"">&nbsp;&nbsp;<span id=""all_num""><input name=""636r"" type=""hidden"" size=""6"" value="
	Response.write i+1
'hidden" size="6" value="
	...
	Response.write top
	Response.write """></td></tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="项目产品清单"
	call close_list(2)
	Response.write " " & vbcrlf & "" & vbcrlf & "</td>" & vbcrlf & " </tr> " & vbcrlf & "</table></form> " & vbcrlf & "</td>" & vbcrlf & "</tr></table>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
