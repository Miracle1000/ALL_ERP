...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td colspan=""2""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=""document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';return false;""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td>" & vbcrlf & "     </tr>" & vbcrlf & "           <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">申请人员：</div></td>" & vbcrlf & "<td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td></tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">会议室：</div></td>" & vbcrlf & "        <td>"
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from O_Meeting order by id desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "             <input name=""D1"" type=""checkbox"" id=""D1"" value="""
		Response.write rs("id")
		Response.write """ />"
		Response.write rs("met_name")
		rs.movenext
	loop
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "      </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">审批状态：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "<input name=""D2"" type=""checkbox"" id=""D2""value=""1"">待审批" & vbcrlf & "<input name=""D2"" type=""checkbox"" id=""D2"" value=""2"">审批中" & vbcrlf & "<input name=""D2"" type=""checkbox"" id=""D2"" value=""3"">审批通过" & vbcrlf & "<input name=""D2"" type=""checkbox"" id=""D2"" value=""4"">审批未通过</td>" & vbcrlf & "  </tr>" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">会议性质：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "                "
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from O_MeetingSet where set_type=1 order by set_gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "         </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">重要程度：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "                "
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from O_MeetingSet where set_type=2 order by set_gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "      </td>" & vbcrlf & "           </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td><div align=""right"">会议主题：</div></td>" & vbcrlf & "                  <td><input name=""D4"" type=""text"" id=""D4"" size=""30"" maxlength=""500""></td>" & vbcrlf & "  </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">周期会议：</div></td>" & vbcrlf & "         <td><input name=""D6"" type=""checkbox"" id=""D6"" value=""1"" />" & vbcrlf & "         否" & vbcrlf & "         <input name=""D6"" type=""checkbox"" id=""D6"" value=""2"" />" & vbcrlf & "         是</td>" & vbcrlf & "       </tr>" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "          <td><div align=""right"">写入日程：</div></td>" & vbcrlf & "      <td><input name=""D8"" type=""checkbox"" id=""D8"" value=""1"" />" & vbcrlf & "否" & vbcrlf & "  <input name=""D8"" type=""checkbox"" id=""D8"" value=""2"" />" & vbcrlf & "是</td>" & vbcrlf & "  </tr>" & vbcrlf & "      <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "       <td><div align=""right"">短信通知：</div></td>" & vbcrlf & "      <td><input name=""D13"" type=""checkbox"" id=""D13"" value=""1"" />" & vbcrlf & "否" & vbcrlf & "  <input name=""D13"" type=""checkbox"" id=""D13"" value=""2"" />" & vbcrlf & "是</td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">会议内容：</div></td>" & vbcrlf & "    <td colspan=""3""><input name=""D16"" type=""text"" id=""D16"" size=""50"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <!--<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">固定电话：</div></td>" & vbcrlf & "    <td><input name=""D18"" type=""text"" id=""D18"" size=""15"" /></td>" & vbcrlf & "           <td><div align=""right"">移动手机：</div></td>" & vbcrlf & "         <td><input name=""D19"" type=""text"" id=""D19"" size=""15"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">移动手机2：</div></td>" & vbcrlf & "    <td><input name=""D20"" type=""text"" id=""D20"" size=""15"" /></td>" & vbcrlf & "      <td><div align=""right""></div></td>" & vbcrlf & "         <td>&nbsp;</td>" & vbcrlf & "  </tr>" & vbcrlf &"  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">司机地址：</div></td>" & vbcrlf & "    <td colspan=""3""><input name=""D21"" type=""text"" id=""D21"" size=""30"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & " <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td><div align=""right"">档案备注：</div></td>" & vbcrlf & "      <td colspan=""3""><input name=""D22"" type=""text"" id=""D22"" size=""30""></td>" & vbcrlf & "  </tr>-->  " & vbcrlf & " " & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">申请日期：</div></td>" & vbcrlf & "      <td>&nbsp;自：<input type=""text"" name=""M"" id=""M"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""K"" id=""K"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">添加日期：</div></td>" & vbcrlf & "      <td>&nbsp;自：<input type=""text"" name=""L1"" id=""L1"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""L2"" id=""L2"" Class=""DateTimePick""onclick=""datedlg.showDateTime();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td width=""10%"">&nbsp;</td>" & vbcrlf & "       <td><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "     </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
