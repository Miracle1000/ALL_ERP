...
'bigsystemtype = ".mozi"
	...
	dotstr=""
		for i=1 to num_dot_xs
			...
			xlApplication.ActiveSheet.Columns(4).NumberFormatLocal = "0."&dotstr&"%"
			...
			do until rs.eof
				...
				money_th=zbcdbl(rs("money5"))
				money_th_cost=zbcdbl(rs("money6"))
				total_money_ll=total_money_ll+cdbl(money_ll)
				money_th_cost=zbcdbl(rs("money6"))
				total_pay=total_pay+cdbl(pay)
				money_th_cost=zbcdbl(rs("money6"))
				total_money1=total_money1+cdbl(money1)
				money_th_cost=zbcdbl(rs("money6"))
				total_numht=total_numht+cdbl(numht)
				money_th_cost=zbcdbl(rs("money6"))
				total_money_th=total_money_th+cdbl(money_th)
				money_th_cost=zbcdbl(rs("money6"))
				total_money_th_cost=total_money_th_cost+cdbl(money_th_cost)
				money_th_cost=zbcdbl(rs("money6"))
				total_money_cpall=total_money_cpall+cdbl(money_cpall)
				money_th_cost=zbcdbl(rs("money6"))
				total_money_mlall=total_money_mlall+cdbl(money_mlall)
				money_th_cost=zbcdbl(rs("money6"))
				set rs7=server.CreateObject("adodb.recordset")
				sql7="select name,khid,cateid from tel where ord="&rs("ord")&""
				...
				if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(1+i,3).Value =Formatnumber(money_mlall,num_dot_xs,-1)
'if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(1+i,3).font.Size=10
'if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(1+i,4).Value =Formatnumber(money_ll,num_dot_xs,-1)&"%"
'if open_5_17=1 or open_5_17=3 then
...
'if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(1+i,7).Value =Formatnumber(money_th,num_dot_xs,-1)
'if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(1+i,7).font.Size=10
'if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(1+i,8).Value =Formatnumber(money_th_cost,num_dot_xs,-1)
'if open_5_17=1 or open_5_17=3 then
...
'if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(1+i,10).Value =numht
'if open_5_17=1 or open_5_17=3 then
...
'if open_5_17=1 or open_5_17=3 then
'if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(2+i,3).Value =Formatnumber(total_money_mlall,num_dot_xs,-1)
'if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(2+i,3).font.Size=10
'if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(2+i,5).Value =Formatnumber(total_money_cpall,num_dot_xs,-1)
'if open_5_17=1 or open_5_17=3 then
					xlWorksheet.Cells(2+i,5).font.Size=10
'if open_5_17=1 or open_5_17=3 then
				end if
				xlWorksheet.Cells(2+i,6).Value =Formatnumber(total_pay,num_dot_xs,-1)
'if open_5_17=1 or open_5_17=3 then
				xlWorksheet.Cells(2+i,6).font.Size=10
'if open_5_17=1 or open_5_17=3 then
				xlWorksheet.Cells(2+i,7).Value =Formatnumber(total_money_th,num_dot_xs,-1)
'if open_5_17=1 or open_5_17=3 then
				xlWorksheet.Cells(2+i,7).font.Size=10
'if open_5_17=1 or open_5_17=3 then
				xlWorksheet.Cells(2+i,8).Value =Formatnumber(total_money_th_cost,num_dot_xs,-1)
'if open_5_17=1 or open_5_17=3 then
				xlWorksheet.Cells(2+i,8).font.Size=10
'if open_5_17=1 or open_5_17=3 then
				xlWorksheet.Cells(2+i,9).Value =Formatnumber(total_money1,num_dot_xs,-1)
'if open_5_17=1 or open_5_17=3 then
				xlWorksheet.Cells(2+i,9).font.Size=10
'if open_5_17=1 or open_5_17=3 then
				xlWorksheet.Cells(2+i,10).Value =total_numht
'if open_5_17=1 or open_5_17=3 then
...
'if open_5_17=1 or open_5_17=3 then
			...
			rs.close
			set rs=Nothing
			Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>客户利润总额排行导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!客户利润总额排行导出成功,共有"&(i-1)&"条记录!</B>"";</script>"
			set rs=Nothing
			Response.write "" & vbcrlf & "</BODY>" & vbcrlf & "</HTML>" & vbcrlf & ""
			Set fs = CreateObject("Scripting.FileSystemObject")
			tfile=Server.MapPath("客户利润总额排行_"&session("name2006chen")&".xls")
			...
			Response.write """><font class=""red""><strong><u>下载导出的客户利润总额排行</u></strong></font></a></p> " & vbcrlf & ""
