...
'bigsystemtype = ".mozi"
	...
	page_count=10
	Response.write "" & vbcrlf & "<table border=""0"" cellpadding=""1"" cellspacing=""1"" width=""100%"" bgcolor=""#C0CCDD"">" & vbcrlf & "" & vbcrlf & "       <tr>" & vbcrlf & "      <td height=""20"" colspan=""29"" bgcolor=""#FFFFFF"" align=""right""><a href=""javascript:void(0)"" onclick=""car_img1('"
	...
	Response.write """ onclick=""datedlg.show();"" readonly=""readonly""><DIV id=daysOfMonth style=""POSITION: absolute;z-index:10""></DIV><a href=""javascript:void(0)"" onclick=""car_img1('"
	Response.write sel_time
	...
	Response.write """ id=""meet_name"" size=""12"" maxlength=""200""/>&nbsp;<input type=""button"" class=""anybutton2"" name=""btn_1"" id=""btn_1"" value=""查询"" onclick=""car_img1(document.getElementById('sel_time').value,'"
	Response.write currpage
	...
	if not rs7.eof then
		...
		do while not rs7.eof
			Response.write "" & vbcrlf & "      <tr>" & vbcrlf & "            <td height=""20"" bgcolor=""#FFFFFF""><a href=""javascript:void(0);"" onclick=""window.location='Add_meetUse.asp?met_id="
			Response.write rs7("id")
			Response.write "'""><span class=""red"">√</span></a>&nbsp;<a href=""javascript:void(0);"" onclick=""showmanager('"
			Response.write rs7("id")
			Response.write "')"">"
			Response.write rs7("met_name")
			Response.write "</a></td>             " & vbcrlf & "                "
			sql8="select * from O_MeetingUse where use_state=1 and use_meeting="&rs7("id")&" and use_meetingcycle=1 and not (use_startime>'"&sel_time&" 07:59:59' OR use_endtime<'"&sel_time&" 00:00:00' ) "
			set rs8=conn.execute(sql8)
			if not rs8.eof then
				if rs8("use_complete")=1 or rs8("use_complete")=2 then
					Color=origen
				elseif rs8("use_complete")=3 then
					Color=red
				else
					Color=green
				end if
			...
			next
			sql8="select * from O_MeetingUse where use_state=1 and use_meeting="&rs7("id")&" and use_meetingcycle=1 and not (use_startime>'"&sel_time&" 23:59:59' OR use_endtime<'"&sel_time&" 21:00:00' ) "
			set rs8=conn.execute(sql8)
			if not rs8.eof then
				if rs8("use_complete")=1 or rs8("use_complete")=2 then
					Color=origen
	...
	if currpage=1 then
		...
		Response.write "" & vbcrlf & "             <a href=""javascript:void(0)"" onclick=""car_img1('"
		Response.write sel_time
		Response.write "',1,'"
		Response.write ml.Dep(meet_name)
		Response.write "')"">首页</a>" & vbcrlf & "              <a href=""javascript:void(0)"" onclick=""car_img1('"
		Response.write sel_time
		Response.write "',"
	...
	if currpage=rs7.pagecount then
		...
		Response.write ",'"
		Response.write ml.Dep(meet_name)
		Response.write "')"">下一页</a>" & vbcrlf & "            <a href=""javascript:void(0)"" onclick=""car_img1('"
		Response.write sel_time
		Response.write "',"
		Response.write rs7.pagecount
		Response.write ",'"
