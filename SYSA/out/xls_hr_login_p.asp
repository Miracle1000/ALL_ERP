...
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=1"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_1=0
intro_80_1=0
else
open_80_1=rs1("qx_open")
intro_80_1=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=2"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_2=0
intro_80_2=0
else
open_80_2=rs1("qx_open")
intro_80_2=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=14"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_14=0
intro_80_14=0
else
open_80_14=rs1("qx_open")
intro_80_14=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=7"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_7=0
intro_80_7=0
else
open_80_7=rs1("qx_open")
intro_80_7=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=8"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_8=0
intro_80_8=0
else
open_80_8=rs1("qx_open")
intro_80_8=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=10"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_10=0
intro_80_10=0
else
open_80_10=rs1("qx_open")
intro_80_10=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=11"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_11=0
intro_80_11=0
else
open_80_11=rs1("qx_open")
intro_80_11=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=3"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_3=0
intro_80_3=0
else
open_80_3=rs1("qx_open")
intro_80_3=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=12"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_12=0
intro_80_12=0
else
open_80_12=rs1("qx_open")
intro_80_12=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=13"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_13=0
intro_80_13=0
else
open_80_13=rs1("qx_open")
intro_80_13=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=16"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_16=0
intro_80_16=0
else
open_80_16=rs1("qx_open")
intro_80_16=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
set rs1=server.CreateObject("adodb.recordset")
sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=80 and sort2=19"
rs1.open sql1,conn,1,1
if rs1.eof then
open_80_19=0
intro_80_19=0
else
open_80_19=rs1("qx_open")
intro_80_19=rs1("qx_intro")
end if
rs1.close
set rs1=nothing
if open_80_1=3 then
...
list_tj1=""
list_per=""
elseif open_80_1=1 then
list_tj=" and creator in ("&intro_80_1&")"
list_tj1=" and ord in ("&intro_80_1&")"
list_per=" and userID in ("&intro_80_1&")"
else
...
list_gate=""
elseif open_80_1=1 then
list_gate=" and ord in ("&intro_80_1&")"
else
list_gate=" and ord=0"
end if
if request("jtdate")<>""  and isdate(startDate)=false then
startDate=request("jtdate")
else
startDate=date()
end if
...
if open_80_1="1"  then
set rs1=server.CreateObject("adodb.recordset")
sql1="select ord,name,sorce,sorce2 from gate  where ord in ("&intro_80_1&") and del=1 order by sorce asc,sorce2 asc ,cateid asc ,ord asc"
rs1.open sql1,conn,1,1
if rs1.eof then
else
do until rs1.eof
...
Str_power3=" and ord in ("&sorce3&")  and dbo.HrIsShowGate('"&startDate&"',ord)=1"
Str_power33=" where ord in ("&sorce3&") and dbo.HrIsShowGate('"&startDate&"',ord)=1"
elseif open_80_1="3" then
Str_power=" where ord>0"
Str_power11=" and ord>0"
Str_power2=" and ord>0"
Str_power22=" where ord>0"
Str_power3=" and ord>0  and dbo.HrIsShowGate('"&startDate&"',ord)=1"
Str_power33=" where ord>0 and dbo.HrIsShowGate('"&startDate&"',ord)=1"
else
Str_power=" where ord<0"
Str_power2=" and ord<0 and "
Str_power22=" where ord<0"
...
xlWorksheet.Cells(1,1).Value = "人员"
...
Response.Flush
W3=trim(request("W3"))
startDate=trim(request("m1"))
endDate=trim(request("m2"))
...
if isdate(endDate) and isdate(startDate) and W3<>"" then
set rs=server.CreateObject("adodb.recordset")
sql="exec HrLoginListPerson '"&startDate&"','"&endDate&"',"&W3&" "
...
wend
rs.movefirst
xlApplication.Init "考勤记录_"&session("name2006chen")&".xls",C1
dim i
i=1
do until rs.eof
creator=rs("creator")
today=(rs("today"))
week=weekdayname(weekday(rs("today")))
loginTime=rs("loginTime")
outTime=rs("outTime")
result=GetKQClassName1(rs("result"))
if datediff("s",dayLoginOut,now())<0 and datediff("d",today,date())=0 then result=replace(result,"早退","")
content=rs("content")
xlWorksheet.Cells(1+i,1).Value = creator
content=rs("content")
xlWorksheet.Cells(1+i,1).font.Size=10
content=rs("content")
xlWorksheet.Cells(1+i,1).HorizontalAlignment=1
content=rs("content")
xlWorksheet.Cells(1+i,2).Value =today
content=rs("content")
xlWorksheet.Cells(1+i,2).font.Size=10
content=rs("content")
xlWorksheet.Cells(1+i,3).Value = week
content=rs("content")
xlWorksheet.Cells(1+i,3).font.Size=10
content=rs("content")
xlWorksheet.Cells(1+i,4).Value = loginTime
content=rs("content")
xlWorksheet.Cells(1+i,4).font.Size=10
content=rs("content")
xlWorksheet.Cells(1+i,5).Value = outTime
content=rs("content")
xlWorksheet.Cells(1+i,5).font.Size=10
content=rs("content")
xlWorksheet.Cells(1+i,6).Value = result
content=rs("content")
xlWorksheet.Cells(1+i,6).font.Size=10
content=rs("content")
xlWorksheet.Cells(1+i,7).Value = content
content=rs("content")
...
C1 = 0
xlApplication.Init "考勤记录_"&session("name2006chen")&".xls",0
end if
rs.close
set rs=Nothing
Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>考勤记录导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!考勤记录导出成功,共有"&(C1)&"条记录!</B>"";</script>"
else
xlApplication.Init "考勤记录_"&session("name2006chen")&".xls",0
Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>考勤记录导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!考勤记录导出成功,共有0条记录!</B>"";</script>"
end if
Response.write "" & vbcrlf & "</BODY>" & vbcrlf & "</HTML>" & vbcrlf & ""
Set fs = CreateObject("Scripting.FileSystemObject")
tfile=Server.MapPath("考勤记录_"&session("name2006chen")&".xls")
...
Response.write """><font class=""red""><strong><u>下载导出的考勤记录</u></strong></font></a></p> " & vbcrlf & ""
