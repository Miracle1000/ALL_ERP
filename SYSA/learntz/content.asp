...
'Private Sub Class_Initialize
	...
	set rs=server.CreateObject("adodb.recordset")
	sql="select *,author=(select top 1 name from gate where ord=learntz.cateid) from learntz  where ord="&ord&""
	rs.open sql,conn,1,1
	...
	sqltext="Update learntz set alt='"&ProductList&"' where ord="&ord&""
	conn.execute(sqltext)
	cateid=rs("cateid")
	Dim helper
	Set helper = CreateReminderHelper(conn,2,0)
	helper.cancelRemind(helper.getRemindIdByOID(ord))
	Call AddBrowseRecords("learntz",ord,Products)
	Response.write "" & vbcrlf & "<!DOCTYPE HTML PUBLIC ""-//W3C//DTD HTML 4.01 Transitional//EN"">" & vbcrlf & "<html>" & vbcrlf & "<head>" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"">" & vbcrlf & "<title>详细内容</title>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Call AddBrowseRecords("learntz",ord,Products)
	Response.write Application("sys.info.jsver")
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<link rel=""stylesheet"" type=""text/css"" href=""BrwStyle.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """>" & vbcrlf & "<style>" & vbcrlf & "    #content td.ewebeditorImg{padding:0 24px;}" & vbcrlf & "    .BillUI #kh input.anybutton[type='button']{background:#FFF!important}" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body  "
	if open_72_8=0 or (open_72_8=1 and CheckPurview(intro_72_8,trim(cateid))=False) then
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td  valign=""center"" > " & vbcrlf & "        <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"">" & vbcrlf & "              <tr>" & vbcrlf & "<td width=""5%"" height=""27""  style=""padding:0;height:42px;"" background=""../images/contentbg.gif""><div align=""center"" style=""height:42px;overflow:hidden""><img src=""../images/contenttop.gif"" height=""43""> </div></td> " & vbcrlf & "                <td width=""47%""  background=""../images/contentbg.gif"">" & vbcrlf & "                  <strong><font color=""#1445A6"">公告详情</font></strong> </td>" & vbcrlf & "                <td width=""48%""  background=""../images/contentbg.gif""><div align=""right"">" & vbcrlf & "                  <div id=""kh"" style=""height:42px; line-height:42px;"">" & vbcrlf & "                  "
	Response.write "" & vbcrlf & "<script language='javascript'>window.close();</script>" & vbcrlf & ""
	Call ShowPrevOrNext("learntz","ord",ord,1)
	if open_72_7=3 or CheckPurview(intro_72_7,trim(cateid))=True then
	...
	Response.write "<div>" & vbcrlf & "                </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>  " & vbcrlf & "     <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <tr class="""">" & vbcrlf & "          <td colspan=""2""><div align=""center"" class=""name""><strong>"
	Response.write rs("title")
	Response.write "</strong></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "          <td colspan=""2""><div align=""center"">发布人："
	Response.write rs("author")
	Response.write "&nbsp;&nbsp;发布时间："
	Response.write rs("date7")
	Response.write "&nbsp;&nbsp;"
	Response.write BwsBarHTML("learntz",ord,Products)
	Response.write "</div></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr> " & vbcrlf & "          <td colspan=""2"" class=""ewebeditorImg""> "
	Response.write Replace(rs("intro").value & "","=""/edit/","=""../edit/")
	Response.write "          </td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""><a href=""javascript:window.close()"" class=""gray"">【关闭】</a></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "     </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	rs.close
	set rs=nothing
	action1="公告详情"
	call close_list(1)
