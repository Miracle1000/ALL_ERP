...
'If Not rs.Eof Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "</head>" & vbcrlf & "<body oncontextmenu=self.event.returnValue=false >" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "        <tr>" & vbcrlf & "          <td class=""place"">来电回收站</td>" & vbcrlf & "          <td>&nbsp;</td>" & vbcrlf & "          <td align=""right""><input type=""button"" name=""Submitdel"" class=""anybutton"" value=""全部清空"" onClick=""if(confirm('确认清空本回收站里的所有内容？')){window.location.href='delall.asp?ord=call&url=call.asp'}""/></td>" & vbcrlf & "          <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <tr class=""top"">" & vbcrlf & "          <td align=""center"" ><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "          <td height=""26"" align=""center"" ><div align=""center""><strong>编号</strong></div></td>" & vbcrlf & "          <td height=""23""  ><div align=""center""><strong>来电号码</strong></div></td>" & vbcrlf & "          <td height=""23""  ><div align=""center""><strong>来电客户</strong></div></td>" & vbcrlf & "          <td ><div align=""center"" ><strong>联系人</strong></div></td>" & vbcrlf & "          <td ><div align=""center"" ><strong>登记者</strong></div></td>" & vbcrlf & "          <td ><div align=""center"" ><strong>删除人</strong></div></td>" & vbcrlf & "          <td ><div align=""center"">删除日期</div></td>" & vbcrlf & "          <td width=""23%"" ><div align=""center"" ><strong>操作</strong></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "        "
	dim n
	n=0
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from call where del=2  order by deldate desc"
	...
	if rs.RecordCount<=0 then
		...
		Response.write "" & vbcrlf & "        <form name=""form1"" method=""post"" action=""deleteldall.asp?ord="
		...
		do until rs.eof
			...
			Response.write "</td>" & vbcrlf & "   " & vbcrlf & "          <td class=""name"">"
			Response.write TbCompanyName(rs("company"))
			Response.write "</td>" & vbcrlf & "          <td class=""name"">"
			Response.write TbPersonName(rs("person"))
			Response.write "</td>" & vbcrlf & "          <td class=""name""><div align=""center"">"
			...
			Response.write "</div></td>" & vbcrlf & "          <td><div align=""center"">" & vbcrlf & "              <input type=""button"" name=""Submit3c""  class=""anybutton""  value=""恢复""  onClick=""if(confirm('确认恢复？')){window.location.href='setld.asp?ord="
			Response.write rs("ord")
			Response.write "&CurrPage="
			Response.write CurrPage
			Response.write "'}""/>" & vbcrlf & "              <input type=""button"" name=""Submitdel"" class=""anybutton"" value=""彻底删除"" onClick=""if(confirm('您选择的是彻底删除，删除后不能再恢复，确认删除？')){window.location.href='deleteld.asp?ord="
			Response.write rs("ord")
			Response.write "&CurrPage="
			Response.write CurrPage
		...
		if currpage=1 then
			...
			Response.write "" & vbcrlf & "              <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='call.asp?currPage="
			Response.write  1
			Response.write "'""/>" & vbcrlf & "              <input type=""button"" name=""Submit42"" value=""上一页""  onClick=""window.location.href='call.asp?currPage="
		...
		if currpage=rs.pagecount then
			...
			Response.write "" & vbcrlf & "              <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='call.asp?currPage="
			Response.write  currpage + 1
			Response.write "'"" class=""page""/>" & vbcrlf & "              <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href='call.asp?currPage="
			Response.write  rs.PageCount
			Response.write "'"" class=""page""/>" & vbcrlf & "              "
		end if
		Response.write "" & vbcrlf & "            </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <script language=javascript>" & vbcrlf & "function test()" & vbcrlf & "{" & vbcrlf & "  if(!confirm('确认删除吗？')) return false;" & vbcrlf & "}" & vbcrlf & " " & vbcrlf & "function mm()" & vbcrlf & "{" & vbcrlf &"   var a = document.getElementsByTagName(""input"");" & vbcrlf & "   if(a[0].checked==true){" & vbcrlf & "   for (var i=0; i<a.length; i++)" & vbcrlf & "      if (a[i].type == ""checkbox"") a[i].checked = false;" & vbcrlf & "   }" & vbcrlf & "   else" & vbcrlf & "   {" & vbcrlf & "   for (var i=0;i<a.length; i++)" & vbcrlf & "      if (a[i].type == ""checkbox"") a[i].checked = true;" & vbcrlf & "   }" & vbcrlf & "}" & vbcrlf & "function ask2() { " & vbcrlf & "if (!confirm(""确认要批量恢复选中的信息？"")) {" & vbcrlf & "            window.event.returnValue = false;" & vbcrlf & "        }" & vbcrlf & "else" & vbcrlf & "{" & vbcrlf & "document.all.form1.action = ""setldall.asp?currPage="
		Response.write currPage
		Response.write """; " & vbcrlf & "document.all.form1.submit(); " & vbcrlf & "}" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "        <tr>" & vbcrlf & "          <td height=""38"" colspan=""3""><div align=""right"">" & vbcrlf & "              <table width=""98%""  border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "                <tr>" & vbcrlf & "                  <td width=""8%"">&nbsp;</td>" & vbcrlf & "                  <td width=""92%"">&nbsp;</td>" & vbcrlf & "                </tr>" & vbcrlf & "                <tr>" & vbcrlf & "                  <td height=""27""><div align=""right""></div></td>" & vbcrlf &              "     <td height=""27"">&nbsp;</td> "& vbcrlf &             "    </tr>" & vbcrlf &             "    <tr> "& vbcrlf &                "   <td height=""27"">&nbsp;</td> "& vbcrlf &         "          <td height=""27"">&nbsp;</td> "& vbcrlf &         "        </tr>" & vbcrlf & "                <tr>" & vbcrlf & "                  <td height=""27"">&nbsp;</td>" & vbcrlf & "                  <td height=""27"">&nbsp;</td>" & vbcrlf & "                </tr>" & vbcrlf & "              </table>" & vbcrlf & "              <p>&nbsp; </p>" & vbcrlf & "            </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>" & vbcrlf & "      </form>" & vbcrlf & "      "
	end if
	rs.close
	set rs=nothing
	dim actinon1
