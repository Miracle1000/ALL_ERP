...
'bigsystemtype = ".mozi"
	...
	Response.write "销售管理平台</title>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script language=""javascript"" src=""../Inc/DelUnusedFiles.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "</head>" & vbcrlf & "<body onresize=fixPositions()  >" & vbcrlf & "<table width=""100%"" border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">"& vbcrlf & ""
	id=getInt(deurl(request("id")))
	H=request("H")
	if H="1" then
		planContent="周计划内容"
	elseif H="2" then
	...
	set rs=server.CreateObject("adodb.recordset")
	sql="select intro  from plan2 Where ord="&id&" "
	...
	Response.write "修改</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "       <form method=""post"" action=""updatehome2.asp?id="
	Response.write id
	Response.write "&H="
	Response.write H
	Response.write """ id=""demo"" onsubmit=""return Validator.Validate(this,2)&&DelUnusedFilesBeforeSubmit()"" name=""date"">" & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "" & vbcrlf & "             <tr>" & vbcrlf & "        <td width=""20%"">" & vbcrlf & "          <div align=""right"">"
	Response.write planContent
	Response.write "：       </div></td>" & vbcrlf & "        <td width=""80%"" colspan=""3"">" & vbcrlf & ""
...
'If Len(exists_Pics) = 0 Then
	...
	call close_list(1)
	Response.write "" & vbcrlf & "              <textarea name=""intro3"" cols=""1"" rows=""1"" style=""display:none"">"
	Response.write intro3
	Response.write "</textarea>" & vbcrlf & "           <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=intro3&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME>" & vbcrlf & "          <span class=""gray""><span class=""red"">*</span></span></td>" & vbcrlf & "      </tr>" & vbcrlf & "" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""50"" colspan=""4"">" & vbcrlf & "" & vbcrlf & "            <div align=""center"">" & vbcrlf & "              <input type=""submit"" name=""Submit42"" value=""保存""  class=""page""/>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "              <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "              </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "    </table>" & vbcrlf & "     </form>" & vbcrlf & "       </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" &vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""60"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "      </td>" & vbcrlf & "" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
