...
'Public Function AddFormValue(name,  value)
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-top: 0px;" & vbcrlf & "        margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "     background-color: #FFFFFF;" & vbcrlf & "     border:0!important;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & "window.onload = function() {" & vbcrlf & "        try {" & vbcrlf & "           parent.document.getElementById(""mxlist"").style.height = document.body.scrollHeight;" & vbcrlf & "              parent.document.getElementById(""mxlist"").style.width = document.body.scrollWidth;" & vbcrlf & "         parent.parent.document.getElementById(""I1"").style.height = parent.document.body.scrollHeight;" & vbcrlf & "             parent.parent.document.getElementById(""I1"").style.width = parent.document.body.scrollWidth;" & vbcrlf & "  }" & vbcrlf & "       catch (e){ }" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "" & vbcrlf & "<body >" & vbcrlf & ""
	...
	set rs8=conn.execute("select qx_open from power where ord="&session("personzbintel2007")&" and sort1=21 and sort2=14 ")
	if not rs8.eof then
		open_21_14=rs8(0).value
	else
		open_21_14=0
	end if
	set rs8=nothing
	dim ProductList,ord,iszz
	ord=clng(session("bom_idzbintel"))
	iszz=request("iszz")&""
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "    <tr class=""top"">" & vbcrlf & "          <td width=""15%"" height=""27"" class=""name""><div align=""center"">产品名称</div></td>" & vbcrlf & "                <td width=""10%""><div align=""center"">编号</div></td>" & vbcrlf & "           <td width=""10%""><div align=""center"">型号</div></td>" & vbcrlf & "         <td width=""8%"" class=""name""><div align=""center"">单位</div></td>" & vbcrlf & "        "
	if isOpenProductAttrV then
		Response.write "" & vbcrlf & "                  <td width=""10%"" class=""name""><div align=""center"">产品属性1</div></td>" & vbcrlf & "                 <td width=""10%"" class=""name""><div align=""center"">产品属性2</div></td>" & vbcrlf & "        "
	end if
	Response.write "" & vbcrlf & "              <td width=""8%"" class=""name"" style="""
	Response.write displayStr
	Response.write """><div align=""center"">单价</div></td>" & vbcrlf & "                <td width=""8%"" class=""name""><div align=""center"">数量</div></td>" & vbcrlf & "               <td width=""8%"" class=""name"" style="""
	Response.write displayStr
	Response.write """><div align=""center"">总价</div></td>" & vbcrlf & "                <td width=""13%"" class=""name""><div align=""center"">备注</div></td>" & vbcrlf & "      </tr>" & vbcrlf & ""
	dim k2
	sql = "select * from bomlist where bom="&ord&" and del=7 order by id asc"
	set Rss = server.CreateObject("adodb.recordset")
	Rss.open sql,conn,1,1
	if rss.eof then
		Response.write "" & vbcrlf & "      <tr>" & vbcrlf & "            <td height=""27"" colspan="""
		Response.write 8+ProductAttrColNum
		Response.write "" & vbcrlf & "      <tr>" & vbcrlf & "            <td height=""27"" colspan="""
		Response.write """><div align=""center"">暂无明细 <img src=""../images/jiantou.gif""><a href=""javascript:;"" onClick=""javascript:window.open('../make/top_bom.asp?top="
		Response.write pwurl(ord)
		Response.write "&f=101','plancor5','width=' + 950 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=0,top=50');return false;"" title=""点击添加产品明细""><font class=""blue2"">添加产品明细</font></a></div></td>" & vbcrlf & "      </tr>" & vbcrlf & ""
		'Response.write pwurl(ord)
	else
		dim sum,num,zk
		sum=0
		...
		k2 = 0
		do until rss.eof
			sql6 = "select title,type1,order1 from product where ord="&rss("ord")&" and del=1"
			...
			if money1="" or isnull(money1) then
				money1=0
			end if
			if num1="" or isnull(num1) then
				num1=0
			end if
			if price1="" or isnull(price1) then
				price1=0
			end if
			if moneyall="" or isnull(moneyall) then
				moneyall=0
			end if
			sum_price1 = sum_price1 + cdbl(price1)
			moneyall=0
			sum_num1 = sum_num1 + cdbl(num1)
			'moneyall=0
			sum_money1 = sum_money1 + cdbl(money1)
			'moneyall=0
			if unitjb<>"" and not isnull(unitjb) then
				set rs2=server.CreateObject("adodb.recordset")
				sql2="select sort1 from sortonehy where id="&unitjb&""
			...
			if isOpenProductAttrV then
				if rss("ProductAttr1")<>"" then
					set rs7=server.CreateObject("adodb.recordset")
					sql7="select title from Shop_GoodsAttr where id="&rss("ProductAttr1")&""
					rs7.open sql7,conn,1,1
					if rs7.eof then
						ProductAttr1Name=""
					else
						ProductAttr1Name=rs7("title")
					end if
					rs7.close
					set rs7=nothing
				else
				...
				if rss("ProductAttr2")<>"" then
					set rs7=server.CreateObject("adodb.recordset")
					sql7="select title from Shop_GoodsAttr where id="&rss("ProductAttr2")&""
					rs7.open sql7,conn,1,1
					if rs7.eof then
						ProductAttr2Name=""
					else
						ProductAttr2Name=rs7("title")
					end if
					rs7.close
					set rs7=nothing
				else
			...
			Response.write "" & vbcrlf & "     <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td  height=""20"" ><div align=""left"">" & vbcrlf & "                <span class=""name"">"
			...
			Response.write""&k6&""
			Response.write "" & vbcrlf & "             </a></span></div></td>" & vbcrlf & "          <td height=""27""><div align=""center"" >"
			...
			if isOpenProductAttrV then
				...
				Response.write ProductAttr1Name
				Response.write "</div></td>" & vbcrlf & "              <td><div align=""center"">"
				Response.write ProductAttr2Name
				Response.write "</div></td>" & vbcrlf & "        "
			end if
			...
			Response.write "</div></td>" & vbcrlf & "          <td><div align=""center"">"
			Response.write "</div></td>" & vbcrlf & "          <td style="""
			Response.write displayStr
			Response.write """><div align=""right""  >"
			...
			rss.movenext
		loop
		session("caigoumoney_all")=sum_money1
		...
		Response.write 4+ProductAttrColNum
		Response.write """><div align=""center"">合计 " & vbcrlf & "         <img src=""../images/jiantou.gif""><a href=""javascript:;"" onClick=""javascript:window.open('../make/top_bom.asp?top="
		Response.write pwurl(ord)
		Response.write "','newwin22','width=' + 950 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=0,top=50');return false;""  title=""点击编辑明细"">重新编辑</a>" & vbcrlf & "              </div></td>" & vbcrlf & "        <td  style="""
		'Response.write pwurl(ord)
		Response.write displayStr
		Response.write """>&nbsp;</td>" & vbcrlf & "             <td height=""20"" class=""red""><div align=""center"">"
		Response.write Formatnumber(sum_num1,num1_dot,-1)
		Response.write "</td>" & vbcrlf & "                <td height=""20"" class=""red""  style="""
		Response.write displayStr
		Response.write """><div align=""right"">"
		Response.write Formatnumber(sum_money1,num_dot_xs,-1)
		Response.write """><div align=""right"">"
		Response.write "</div></td>" & vbcrlf & "        <td>&nbsp;</td>" & vbcrlf & "   </tr>" & vbcrlf & "   "
		If iszz<>"1" Then
			sql8 = "select * from caigoubz where caigou="&ord&""
			set rs8 = server.CreateObject("adodb.recordset")
			rs8.open sql8,conn,1,1
			if not rs8.eof then
				Response.write "" & vbcrlf & "             <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "                   <td height=""27""><div align=""center"">付款方式</div></td>" & vbcrlf & "                     <td height=""20"" colspan=""7"">"
				Response.write rs8("intro3")
				Response.write "</td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "                   <td height=""27""><div align=""center"">交货地址</div></td>" & vbcrlf & "                     <td height=""20"" colspan=""7"">"
				Response.write rs8("intro4")
				Response.write "</td>" & vbcrlf & "                </tr> " & vbcrlf & "          <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "                   <td height=""27""><div align=""center"">交货方式</div></td>" & vbcrlf & "                     <td height=""20"" colspan=""7"">"
				Response.write rs8("intro5")
				Response.write "</td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "                   <td height=""27""><div align=""center"">交货时间</div></td>" & vbcrlf & "                     <td height=""20"" colspan=""7"">"
				Response.write rs8("intro6")
				Response.write "</td>" & vbcrlf & "                </tr> " & vbcrlf & "          <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "                   <td height=""27""><div align=""center"">配件</div></td>" & vbcrlf & "                 <td height=""20"" colspan=""7"">"
				Response.write rs8("intro1")
				Response.write "</td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "                   <td height=""27""><div align=""center"">备注</div></td>" & vbcrlf & "                 <td height=""20"" colspan=""7"">"
				Response.write rs8("intro2")
				Response.write "</td>" & vbcrlf & "                </tr> " & vbcrlf & "          "
			end if
			rs8.close
			set Rs8 = Nothing
	...
	conn.close
	set conn=nothing
	Response.write "" & vbcrlf & "</table>" & vbcrlf & "<script language=""javascript"">" & vbcrlf & "var obj=parent.document.getElementById(""mxcount"");" & vbcrlf & "if (obj)" & vbcrlf & "{" & vbcrlf & "        obj.value="""
	Response.write k2
	Response.write """;" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</body>" & vbcrlf & "</html>"
