...
'Public Function AddFormValue(name,  value)
	...
	Conn.execute(sqlStr)
	dim rd
	rd = GetIdentity("bom","id","cateid","")
	session("bom_idzbintel")=rd
	Response.write "" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td class=""place"">组装清单添加</td>" & vbcrlf & "      <td>&nbsp;</td>" & vbcrlf & "      <td align=""right"">&nbsp;" & vbcrlf & "   "
	if not conn.execute("select 1 from [power] where sort1 = 56 and sort2 = 9 and ord = " & session("personzbintel2007") & " and qx_open =1").eof then
		Response.write "<input type=button value='导入明细' onclick='clistdr(" & rd & ")' class='anybutton'>"
	end if
	Response.write "&nbsp;&nbsp;</td>" & vbcrlf & "      <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "    </tr>" & vbcrlf & "    </table>" & vbcrlf & "<form method=""POST"" action=""save_bom.asp?ord="
	Response.write rd
	Response.write """ id=""demo"" onsubmit=""return Validator.Validate(this,2)&&DelUnusedFilesBeforeSubmit()&& checkdata()"" name=""date"" style='display:inline'><table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <tr>" & vbcrlf & "        "
	if isOpenProductAttr  then
		Response.write "" & vbcrlf & "        <td><div align=""right"">父件名称：</div></td>" & vbcrlf & "        <td width=""25%""> <span id=""khmc""><input name=""company"" type=""text""  style=""color: #999999;text-align:center;"" size=""20"" onClick=""javascript:window.open('../search/result_cp.asp','eventcom','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=100,top=100');return false;"" readonly dataType=""Limit"" min=""1"" max=""500""  msg=""请选择产品"">" & vbcrlf & "            <span class=""red"">*</span></span></td>" & vbcrlf & "        <td width=""10%""><div align=""right"">父件单位：</div></td>" & vbcrlf & "        <td width=""19%""><span id=""unit""></span></td>" & vbcrlf & "        <td width=""10%""><div align=""right"" id=""ProductAttr1Name"">产品属性1：</div></td>" & vbcrlf & "        <td width=""19%""><span id=""ProductAttr1""></span></td>" & vbcrlf & "     </tr>" & vbcrlf & "         <tr>" & vbcrlf & "        <td width=""10%""><div align=""right"" id=""ProductAttr2Name"">产品属性2：</div></td>" & vbcrlf & "        <td width=""19%""><span id=""ProductAttr2""></span></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">父件数量：</div></td>" & vbcrlf & "        <tdwidth=""23%""><div align=""left""><span class=""red"">" & vbcrlf & "          <input name=""num1"" id=""num1"" type=""text""  onpropertychange=""formatData(this,'number');"" onKeyUp=""checkDot('num1','"
		Response.write num1_dot
		Response.write "')"" value=""1"" size=""10""   dataType=""Range"" min=""0.000000001"" max=""999999999999999""  msg=""必须是1—15位大于0的数字"" style=""color: #666666;border: #CCCCCC 1px solid;""> *</span></div></td>        " & vbcrlf & "" & vbcrlf & "       <td><div align=""right"">BOM编号：</div></td>" & vbcrlf & "       <td><input name=""bombh"" type=""text""  value="""
		Response.write khid
		Response.write """ size=""15"" " & vbcrlf & "                 dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1至50个字之间"" " & vbcrlf & "                       class='jquery-auto-bh' autobh-options='cfgId:56,recId:"
		Response.write khid
		Response.write rd
		Response.write ",autoCreate:false'" & vbcrlf & "            >" & vbcrlf & "         <span class=""red"">*</span></td>" & vbcrlf & "     </tr>" & vbcrlf & "        <tr>" & vbcrlf & "       <td><div align=""right"">编制日期：</div></td>" & vbcrlf & "       <td><INPUT name=ret3 type=""text"" size=10 value="""
		Response.write date
		Response.write """  id=""daysOfMonth3Pos"" onmouseup=""toggleDatePicker('daysOfMonth3','date.ret3')""  dataType=""Limit"" min=""1"" max=""50""  msg=""必填"" > " & vbcrlf & "        <span class=""red"">*</span> " & vbcrlf & "        <DIV id=daysOfMonth3 style=""POSITION: absolute""></DIV></td>" & vbcrlf & "     <td><div align=""right"">编制人员：</div></td>" & vbcrlf & "       <td>&nbsp;"
		Response.write session("name2006chen")
		Response.write "</td>" & vbcrlf & "       <td><div align=""right""></div></td>" & vbcrlf & "       <td></td>" & vbcrlf & "     </tr>" & vbcrlf & "    "
	else
		Response.write "" & vbcrlf & "         <td><div align=""right"">父件名称：</div></td>" & vbcrlf & "            <td width=""25%""> <span id=""khmc""><input name=""company"" type=""text""  style=""color: #999999;text-align:center;"" size=""20"" onClick=""javascript: window.open('../search/result_cp.asp', 'eventcom','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=100,top=100'); return false;"" readonly dataType=""Limit"" min=""1"" max=""500""  msg=""请选择产品"">" & vbcrlf & "                <span class=""red"">*</span></span></td>" & vbcrlf & "            <td width=""10%""><div align=""right"">父件单位：</div></td>" & vbcrlf & "            <td width=""19%"">" & vbcrlf & "                   <span id=""unit""></span></td>" & vbcrlf & "            <td width=""11%""><div align=""right"">父件数量：</div></td>" & vbcrlf & "            <td width=""23%""><div align=""left""><span class=""red"">"& vbcrlf & "              <input name=""num1"" id=""num1"" type=""text""  onpropertychange=""formatData(this"
		Response.write num1_dot
		Response.write "')"" value=""1"" size=""10""   dataType=""Range"" min=""0.000000001"" max=""999999999999999""  msg=""必须是1—15位大于0的数字"" style=""color: #666666;border: #CCCCCC 1px solid;"">" & vbcrlf & "    *</span></div></td>     " & vbcrlf & "         </tr>" & vbcrlf & "       <tr>" & vbcrlf & "           <td><div align=""right"">BOM编号：</div></td>" & vbcrlf & "           <td><input name=""bombh"" type=""text""  value="""
		Response.write khid
		Response.write """ size=""15"" " & vbcrlf & "                     dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1至50个字之间"" " & vbcrlf & "                       class='jquery-auto-bh' autobh-options='cfgId:56,recId:"
		Response.write khid
		Response.write rd
		Response.write ",autoCreate:false'" & vbcrlf & "                >" & vbcrlf & "             <span class=""red"">*</span></td>" & vbcrlf & "           <td><div align=""right"">编制日期：</div></td>" & vbcrlf & "           <td><INPUT name=ret3 type=""text"" size=10 value="""
		Response.write date
		Response.write """  id=""daysOfMonth3Pos"" onmouseup=""toggleDatePicker('daysOfMonth3','date.ret3')""  dataType=""Limit"" min=""1"" max=""50""  msg=""必填"" > " & vbcrlf & "            <span class=""red"">*</span> " & vbcrlf & "            <DIV id=daysOfMonth3 style=""POSITION: absolute""></DIV></td>" & vbcrlf & "           <td><div align=""right"">编制人员：</div></td>" & vbcrlf & "           <td>&nbsp;"
		Response.write session("name2006chen")
		Response.write "</td>" & vbcrlf & "         </tr>" & vbcrlf & "    "
	end if
	Response.write "" & vbcrlf & "         <tr>" & vbcrlf & "            <td><div align=""right"">子件明细：</div></td>"
	Response.write "" & vbcrlf & "                 <td colspan=""5""><IFRAME name=""I3"" SRC=""../event/bommx.asp?ID=company&iszz=1"" id=""mxlist"" width=""100%"" height=""50"" onload=""frameResize()"" scrolling=no BORDER=0 marginheight=0 marginwidth=0 frameborder=0 target=""_self"" ></IFRAME></td>" & vbcrlf & "           </tr>"& vbcrlf & "      <tr>" & vbcrlf & "        <td width=""12%"">" & vbcrlf & "          <div align=""right"">备　　注：       </div></td>" & vbcrlf & "        <td colspan=""5""><textarea name=""intro3"" style=""display:none"" cols=""1"" rows=""1"">"
	if intro3<>"" then Response.write intro3
	Response.write "</textarea>" & vbcrlf & "                    <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=intro3&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "      </tr>" & vbcrlf & "" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""37"" colspan=""6""><div align=""center"">" & vbcrlf & "          <input type=""hidden"" name=""mxcount"" id=""mxcount"" value=""0""/>          " & vbcrlf & "          <input type=""submit"" name=""Submit42"" value=""保存"" class=""page""/>" & vbcrlf & "          <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "        </div></td>" & vbcrlf & "        </tr>  " & vbcrlf & "    </table></form> " & vbcrlf & "       </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">"& vbcrlf &"    <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "   </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf
	dim actinon1
	action1="组装清单添加"
	call close_list(1)
