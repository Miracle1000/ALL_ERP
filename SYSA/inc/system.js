	...
	function TexTxmFocus(event)
{
	...
	if(obj.name==undefined)
	{
		...
		try
		{
			...
			eo.style.left=left+"px";
			eo.style.top="-100px";
						eo.focus();
			eo.style.cssText = "overflow:hidden;font-size:1px;position:absolute;top:" + ((document.documentElement.scrollTop||document.body.scrollTop)+2) + "px;left:" + ((document.documentElement.scrollLeft||document.body.scrollLeft)+2) + "px;border:0px;width:1px;height:1px;background:none;outline:none";
