...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "" & vbcrlf & "function pro_type1(val)" & vbcrlf & "{" & vbcrlf & "   url=""getDate.asp?tp=1&Sid=""+val;" & vbcrlf & "  xmlHttp.open(""GET"",url,false)" & vbcrlf & "     xmlHttp.onreadystatechange=function()" & vbcrlf & "       {" & vbcrlf & "               if (xmlHttp.readyState==4)" & vbcrlf & "              {" & vbcrlf & "                       var test=xmlHttp.responseText;" & vbcrlf & "                  ajaxhtml=test" & vbcrlf & "                   document.getElementById('test2').innerHTML=""(""+ajaxhtml+"")"";" & vbcrlf & "                }" & vbcrlf & "       }" & vbcrlf & "  " & vbcrlf & "        xmlHttp.send(null);     " & vbcrlf & "}" & vbcrlf & "function ask1()" & vbcrlf & "{" & vbcrlf & "       if(document.getElementById('prod_type').value=="""")" & vbcrlf & "        {" & vbcrlf & "               document.getElementById('test1').innerHTML=""*必填""" & vbcrlf & "                return false;" & vbcrlf & "   }"& vbcrlf & "       document.getElementById('test1').innerHTML=""*"";" & vbcrlf & "   return true;" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "   margin-top: 0px;" & vbcrlf & "}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
	set rs88 = conn.execute("EXEC erp_getdjbh 801,"&session("personzbintel2007"))
	khid=rs88(0).value
	rs88.close
	set rs88=nothing
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">档案添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "         <form action=""save_prod.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" ><div align=""left""><strong>基本情况</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "              <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit422"" value=""保存""  class=""page"" onclick=""return ask1()""/>" & vbcrlf & "                <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf &  "              </div></td>" & vbcrlf &  "       </tr>" & vbcrlf & "      <tr>" & vbcrlf & "      <td width=""14%"" height=""37""><div align=""right"">用品名称：</div></td>" & vbcrlf & "          <td width=""22%"" class=""gray""><input name=""prod_name"" type=""text"" id=""prod_name"" dataType=""Limit"" min=""1"" max=""200""  msg=""必须在1至200个字之间"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""13%""><div align=""right"">用品编号：</div></td>" & vbcrlf & "        <td width=""21%"" class=""gray""><input name=""prod_bh"" type=""text"" id=""prod_bh"" " & vbcrlf & "                     maxlength=""200"" value="""
	Response.write khid
	Response.write """" & vbcrlf & "                  class='jquery-auto-bh' autobh-options='cfgId:801,autoCreate:false'" & vbcrlf & "              ></td>" & vbcrlf & "        <td width=""12%""><div align=""right"">用品型号：</div></td>" & vbcrlf & "              <td width=""18%"" class=""gray""><input name=""prod_xh"" type=""text"" id=""prod_xh"" maxlength=""200""></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td width=""14%""><div align=""right"">用品分类：</div></td>" & vbcrlf & "        <td height=""33"" class=""gray"">" & vbcrlf & "                <select name=""prod_type"" id=""prod_type"" onChange=""pro_type1(this.value)"">" & vbcrlf & "               <option value="""">--请选择--</option>" & vbcrlf & "              "
	'Response.write khid
	sql7="select * from O_officeType order by pro_gate2 desc"
	...
	Response.write "" & vbcrlf & "        </select>&nbsp;<span id=""test1"" class=""red"">*</span>&nbsp;<span id=""test2""></span>" & vbcrlf & "        </td>" & vbcrlf & "        <td width=""13%""><div align=""right"">最低库存：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""prod_less"" type=""text""id=""prod_less"" onpropertychange=""formatData(this,'number');""  size=""12"" maxlength=""12""></td>" & vbcrlf & "        <td width=""12%""><div align=""right"">最高库存：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""prod_more"" type=""text"" id=""prod_more"" onpropertychange=""formatData(this,'number');"" size=""12"" maxlength=""12""></td>" & vbcrlf & "      </tr>              " & vbcrlf & "                "
	set rs8=server.CreateObject("adodb.recordset")
	sql8="select * from zdy where sort1=802 and set_open=1 order by gate1 asc "
	...
	rs8.close
	set rs8=nothing
	Response.write "" & vbcrlf & "        <tr>" & vbcrlf & "           <td><p align=""right"">用品备注：</td>" & vbcrlf & "              <td colspan=""5"" class=""gray""><textarea name=""note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "                    <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "     </tr> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray""><p align=""center"">" & vbcrlf & "           <input type=""submit"" name=""Submit42"" value=""保存""  class=""page"" onclick=""return ask1()""/>" & vbcrlf & "                <input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr> " & vbcrlf & "    </table>" & vbcrlf & " </form>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "" & vbcrlf & "   </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="档案添加"
	call close_list(1)
