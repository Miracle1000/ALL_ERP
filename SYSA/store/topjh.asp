...
'set rs=nothing
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" src= ""../inc/ptdmanger.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"" src='storeselbox.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write "'></script>" & vbcrlf & "<script language=""javascript"" src=""../Scripts/jquery-1.4.1.min.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/se_topjh.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "</head>" & vbcrlf & "<body onLoad=""txmFocus();"" onclick=""TexTxmFocus(event);""  oncontextmenu=self.event.returnValue=false onUnload=""window.opener.location.reload();"">" & vbcrlf & ""
	Dim qxOpen
	...
	Response.write "" & vbcrlf & "<style>" & vbcrlf & "  tr.top_tr td{padding-top:0;padding-bottom:0}" & vbcrlf & "  tr.top td{height:40px;line-height:40px;padding-top:0;padding-bottom:0}" & vbcrlf & "  #cpB{margin-top:-1px }" & vbcrlf & "  .ie5  #cpB{margin-top:0px }" & vbcrlf & "  table[background=""../images/m_mpbg.gif""] td{background:#EFEFEF;}" & vbcrlf & "  td.productPadding{padding-left:0!important;}" & vbcrlf & "  table[background=""../images/112.gif""] td{background:#FFF;}" & vbcrlf & "  table td{background:#fff}" & vbcrlf & "</style>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0""cellspacing=""5""> "& vbcrlf &"   <tr> "& vbcrlf &   "  <td width=""215"" valign=""top"">" & vbcrlf & "  "
...
'ElseIf treeType = "TC" Then
	...
	Call ShowLeftTree
	Response.write "" & vbcrlf & "      </td>" & vbcrlf & "    <td valign=""top""><form name=""date"" class='pagefrm' id=""demo"" method=""post"" action=""savelistjh.asp?top="
	Response.write top
	Response.write """ onSubmit=""return Validator.Validate(this,2)"" >" & vbcrlf & "     <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""center"" class=""productPadding"">" & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">借货明细</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">"
	...
	Response.write "</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & "<table width=""100%"" class=""resetHeadBg"" border=""0"" cellpadding=""3""  background=""../images/112.gif"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;background-position:-1;table-layout: fixed;"">" & vbcrlf & " <tr class=""top_tr"">" & vbcrlf & "         <td width=""120"" height=""26""  style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">&nbsp;</td>" & vbcrlf & "     <td  width=""70"" height=""26""  style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">&nbsp;</td>" & vbcrlf & "         <td  width=""50"" height=""26""  style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">&nbsp;</td>" & vbcrlf & "      "
	'Response.write pwurl(89)
	if isOpenProductAttr then
		Response.write "" & vbcrlf & "            <td  width=""90"" height=""26""  style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">&nbsp;</td>" & vbcrlf & "       <td  width=""90"" height=""26""  style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">&nbsp;</td>" & vbcrlf & "      "
'if isOpenProductAttr then
	end if
	Response.write "" & vbcrlf & "        <td  width=""45"" height=""26""  style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">&nbsp;</td>" & vbcrlf & "       <td  width=""80"" style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">" & vbcrlf & "                 "
'if isOpenProductAttr then
	if proStore<>1 then
		...
		Response.write top
		Response.write "')"">" & vbcrlf & "                       <div style='float:left;'><input style='float:left;' id='for_ckall' type='button' class='storeButton'></div>" & vbcrlf & "                     </td><td style='width:16px;'><img  style='cursor:pointer;' src='../images/11645.png' onClick=""showStoreDlg('ckall')""></td>" & vbcrlf & "                        </tr></table>" & vbcrlf & "                 "
	end if
	Response.write "" & vbcrlf & "        </td>" & vbcrlf & "   <td  width=""200"" style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">&nbsp;</td>" & vbcrlf & "         <td  width=""100"" style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">&nbsp;</td>" & vbcrlf & "     <td  width=""70"" height=""26""  style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">&nbsp;</td>" & vbcrlf & "       <td  width=""70"" style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center"">" & vbcrlf & "       <select id=""bzall"" name=""bzall"" onpropertychange=""bz()"" onchange=""bz()"" style=""width:70px"">" & vbcrlf & "         <option value=""""></option>" & vbcrlf & "           "
	...
	rs2.close
	set rs2=nothing
	Response.write "" & vbcrlf & "            </select>" & vbcrlf & "     </div></td>" & vbcrlf & "   <td  width=""110"" style=""border-top:#ccc 1px solid;border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">&nbsp;</td>" & vbcrlf & "       </tr>" & vbcrlf & "   </table>" & vbcrlf & "<table width=""100%""  border=""0"" cellpadding=""3""  background=""../images/m_table_top.jpg"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;table-layout: fixed;"">" & vbcrlf & " " & vbcrlf & "       <tr class=""top"">" & vbcrlf & "    <td  width=""120"" height=""26"" align=""center"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>产品名称</strong></div></td>" & vbcrlf & "      <td  width=""70"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>型号</strong></div></td>" & vbcrlf & "      <td  width=""50"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>单位</strong></div></td>" & vbcrlf & "      "
	'set rs2=nothing
	if isOpenProductAttr then
		Response.write "" & vbcrlf & "            <td  width=""90"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>产品属性1</strong></div></td>" & vbcrlf & "        <td  width=""90"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>产品属性2</strong></div></td>" & vbcrlf & "      "
'if isOpenProductAttr then
	end if
	Response.write "" & vbcrlf & "        <td  width=""45"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>数量</strong></div></td>" & vbcrlf & "     <td  width=""80"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>仓库</strong></div></td>" & vbcrlf & "         <td  width=""200"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>库存信息</strong></div></td>" & vbcrlf & "        <td  width=""100"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>出库方式</strong></div></td>" & vbcrlf & "          <td  width=""70"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>应还日期</strong></div></td>" & vbcrlf & "          <td  width=""70"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;""><div align=""center""><strong>包装</strong></div></td>" & vbcrlf & "     <td  width=""110"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1pxsolid;border-right:#ccc 1px solid;""><div align=""center""><strong>备注</strong></div></td>" & vbcrlf & "   </tr>" & vbcrlf & "</table>" & vbcrlf & ""
'if isOpenProductAttr then
	sqls = "select * from kujhlist where kujh="&top&" and del=7 order by date7 asc,id asc"
	set rss = server.CreateObject("adodb.recordset")
	rss.open sqls,conn,1,1
	i=1
	if rss.eof then
		Response.write "" & vbcrlf & "<span id=""trpx0"">" & vbcrlf & "<table width=""100%"" border=""0""  cellpadding=""3"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;"">" & vbcrlf & "<tr >" & vbcrlf & "       <td height=""30"" style=""border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;"">无产品明细！</td>" & vbcrlf & "       </tr>" & vbcrlf & "</table>" & vbcrlf & "</span>" & vbcrlf & ""
'if rss.eof then
	else
		do until rss.eof
			kujhlistid= rss("id")
			...
			set rs7=nothing
			zdHTML=""
			if IsNumeric(ku2) Then
				If conn.execute("select count(1) from kuoutlist2  where  sort1=6 and ku=" &  ku2 & " and id=abs("& oldmxid &") and addcate="&session("personzbintel2007")&" and del=7")(0)=0 Then
					conn.execute("Update kujhlist set ku2=null where  id="&kujhlistid)
					checked_zd1="checked"
					checked_zd2=""
				else
					checked_zd1=""
					checked_zd2="checked"
					zdHTML="<font class='red' size='2'><b><br>已指定："&Formatnumber(rss("num1"),num1_dot,-1)&"</b></font>"
					'checked_zd2="checked"
					sqltext="Update kuoutlist2 set  mxid="&id&" where  sort1=6 and ku=" &  ku2 & "  and id=abs("& oldmxid &") and addcate="&session("personzbintel2007")&" and del=7"
					conn.execute(sqltext)
					sqltext="Update kujhlist set  mxid="&id&" where id="&kujhlistid
					'conn.execute(sqltext)
				end if
			else
				checked_zd1="checked"
			...
			set rs7=server.CreateObject("adodb.recordset")
			sql7="select title,order1,type1,price1,company,unit,unitjb from product where ord="&ord&" and del=1"
			rs7.open sql7,conn,1,1
			if rs7.eof then
				k="产品已被删除"
				order1=""
			...
			kcxz=""
			set rs=server.CreateObject("adodb.recordset")
			sql="select sum(num2) as num1,ck,unit from ku  where ord="&ord&" and (isnull(ProductAttr1,0)="&ProductAttr1&" or "&ProductAttr1&"=0 ) and (isnull(ProductAttr2,0)="&ProductAttr2&" or "&ProductAttr2&"=0 )  and ck="&ck&" and ck in (select id from sortck where del=1 and (intro like '"&session("personzbintel2007")&",%' or intro like '%,"&session("personzbintel2007")&",%' or intro like '%, "&session("personzbintel2007")&",%' or intro like '%, "&session("personzbintel2007")&"'  or intro like '%,"&session("personzbintel2007")&"' or intro like '"&session("personzbintel2007")&"' or intro like '0')) group by ck,unit having sum(num2)>0 order by ck asc"
			...
			if rs.RecordCount<=0 then
				...
				do until rs.eof
					...
					if rs7.eof then
						...
						ckname=rs7("sort1")
						sql="select * from sortck1 where id="&rs7(1)
					...
					rs7.close
					set rs7=nothing
					num_kclimit = sdk.getSqlValue("select sum( assistnum/num3 * num2) num2 from ku where num2>0 and ord="& ord &" and assistunit=" & unit,0)
					if clng(unit)=clng(unit2) then
						num_kclimit=num_kclimit+cdbl(num_kc2)
'if clng(unit)=clng(unit2) then
						kcxz=kcxz+"<font class='red'>"
'if clng(unit)=clng(unit2) then
						kcxz=kcxz+""&ck1name&" "&ckname&" "&unit2name&" "&Formatnumber(num_kc2,num1_dot,-1)&"<br>"
'if clng(unit)=clng(unit2) then
						kcxz=kcxz+"</font>"
'if clng(unit)=clng(unit2) then
					end if
					...
					if clng(unit)<>unit2 then
						kcxz=kcxz+"<font color='#546C95'>"&ck1name&" "&ckname&" </font>"&unit2name&" "&Formatnumber(num_kc2,num1_dot,-1)&""
'if clng(unit)<>unit2 then
						kcxz=kcxz+"<a href='javascript:void(0)'  onclick=javascript:window.open('../../sysn/view/store/kuout/KuAppointSplit.ashx?productid="&pwurl(ord)&"&unit="&unit&"&ck="&ck2&"&moreunit="&unit2&"&Ismode=1&id="&id&"','newwin23','width='+800+',height='+400+',toolbar=0,scrollbars=1,resizable=1,left=100,top=100');><img src='../images/jiantou.gif' border='0' alt='选择'>拆分</a><br>"
					end if
					rs.movenext
				loop
			end if
			...
			Response.write("<input name='ord_"&id&"' id='ord_"&i&"' type='hidden'  value='"&ord&"'><input name='id_"&id&"' id='id"&i&"' type='hidden'  value='"&id&"'>")
			...
			list=list+"<td width='120' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'>"
			If qxOpen > 0 Then
...
'If qxOpen > 0 Then
			...
			list=list+"&nbsp;"&k&"</a>  <a href='javascript:void(0)' onclick=del('trpx"&i-1&"_"&id&"','"&id&"');><img src='../images/del2.gif'  border=0/ alt='删除此产品'></a><input name='w_"&id&"' id='w"&i&"' type='hidden'   value='trpx"&i-1&"_"&id&"' size='7'></td>"
'If qxOpen > 0 Then
			list=list+"<td width='70' style='BORDER-BOTTOM:#ccc  1px  solid; BORDER-LEFT:#ccc 1px solid;BORDER-RIGHT:#ccc 1px solid;'>"&type1&"</td>"
'If qxOpen > 0 Then
			list=list+"<td align='center' width='50' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'><select name='unit_"&id&"' id='unit"&i&"' width='50' onChange=ckxz('"&ord&"','"&i&"','"&id&"','trpx"&i-1&"_"&id&"','2');  dataType='Range' msg='不能为空' min='1' max='9999999999999'>"
			set rs7=server.CreateObject("adodb.recordset")
...
'set rs7=nothing
			if isOpenProductAttr then
				list=list+" <td align='center' width='90' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'><select name='ProductAttr1_"&id&"' id='ProductAttr1_"&i&"' width='50' onChange=ckxz('"&ord&"','"&i&"','"&id&"','trpx"&i-1&"_"&id&"','2','"&top&"');  dataType='Range'> "
...
'do until rs7.eof
				...
				list=list+"</select></td>"
'set rs7=nothing
				list=list+" <td align='center' width='90' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'><select name='ProductAttr2_"&id&"' id='ProductAttr2_"&i&"' width='50' onChange=ckxz('"&ord&"','"&i&"','"&id&"','trpx"&i-1&"_"&id&"','2','"&top&"');  dataType='Range'>"
...
'set rs7=nothing
			...
			list=list+"<td   width='45' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'><div align='center'><input Name='num1_"&id&"' id='num"&i&"'  if num1=0 then onfocus=if(value==defaultValue){value='';this.style.color='#000'}  onBlur=if(!value){value=defaultValue;this.style.color='#000'}  value='"&Replace(Formatnumber(num1,num1_dot,-1),",","")&"'  onkeyup=value=value.replace(/[^\d\.]/g,'');checkDot('num"&i&"','"&num1_dot&"') type='text' style='height: 19px; solid;' size='5' dataType='Range' msg='库存不足' min='0' max='"&num_kclimit&"'></div></td>"
			set rs7=nothing
			list=list+"<td width='80' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'>"
'set rs7=nothing
			...
			"<input type='hidden' name='ck_"& id &"' id='ck"& i &"' text='" & ckname & "' value='" & ck & "'  onchange=""ckxz('"&ord&"','"&i&"','"&id&"','trpx"&i-1&"_"&id&"','1');""  dataType='Limit' min='1' max='100' msg='请选择仓库'>" & _
			...
			"</tr></table>"
			list=list&"</td>"
			list=list+"<td  width='200' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'><span id='ck2xz_"&id&"'>"&kcxz&"</span></td>"
			list=list&"</td>"
			list=list+"<td  width='100' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'><input type='radio' name='way1_"&id&"' onclick=del_zd('"&id&"'); value='1' "&checked_zd1&"/>随机&nbsp;<input type='radio' name='way1_"&id&"' value='2'  onclick=add_zd('"&i&"','"&ord&"','"&unit&"','"&id&"','"&ck&"','"&contractlist&"','"&kuout&"','"&kuoutlist&"','"&ProductAttr1&"','"&ProductAttr2&"') "&checked_zd2&">指定<span id='zdkc"&id&"'>"&zdHtml&"</span></td>"
			list=list+"<td align='center' width='70' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'><INPUT name='date1_"&id&"'  id='daysdate1_"&i&"Pos' size=9  value='"&date2&"' style='height: 19px; solid;' onmouseup=toggleDatePicker('daysdate1_"&i&"','date.date1_"&id&"') ><DIV id='daysdate1_"&i&"' style='POSITION: absolute'></DIV></td>"
			list=list+"<td width='70' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'><div align='center'><select name='bz_"&id&"' id='bz"&i&"' style='width:70'>"
'&id&"') ><DIV id='daysdate1_"&i&"' style='POSITION: absolute'></DIV></td>"
			set rs2=server.CreateObject("adodb.recordset")
			sql2="select * from sortonehy where gate2=82 order by gate1 desc"
			rs2.open sql2,conn,1,1
			do until rs2.eof
...
'if clng(bz)=rs2("ord") then
			...
			set rs2=nothing
			list=list+"<td width='110' style='border-bottom:#ccc 1px solid;border-left:#ccc 1px solid;border-right:#ccc 1px solid;'><div align='center'><textarea name='intro_"&id&"' id='intro"&i&"' type='text' style='overflow-y:hidden;word-break:break-all;width:100px;' onfocus='this.style.posHeight=this.scrollHeight' onpropertychange='this.style.posHeight=this.scrollHeight' dataType='Limit' min='0' max='200' msg='不要超过200个字' rows='1'>"&intro&"</textarea><script>document.getElementById('intro"&i&"').focus();</script></div></td>"
			list=list+"</tr></table>"
	...
	rss.close
	set rss=nothing
	for j=i to num_cpmx_yl
		list_ys=list_ys+"<span id='trpx"&j&"'></span>"
'for j=i to num_cpmx_yl
	next
	Response.write(""&list_ys&"")
	Response.write "" & vbcrlf & "</td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""40"" style=""padding-top:0"" colspan=""2"">&nbsp;&nbsp;<span id=""all_num""><input name=""636r"" type=""hidden"" size=""6"" value="""
	Response.write i+1
't name=""636r"" type=""hidden"" size=""6"" value="""
	...
	action1="借货明细"
	call close_list(1)
	Response.write "" & vbcrlf & "" & vbcrlf & "</table>" & vbcrlf & " </form>" & vbcrlf & "</td>" & vbcrlf & " </tr>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>"
