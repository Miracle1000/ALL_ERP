...
'bigsystemtype = ".mozi"
	...
	Response.write "" & vbcrlf & "<!DOCTYPE HTML PUBLIC ""-//W3C//DTD HTML 4.01 Transitional//EN"">" & vbcrlf & "<html>" & vbcrlf & "<head>" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"">" & vbcrlf & "<title>"
	Response.write title_xtjm
	Response.write "</title>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "      background-color: #FFFFFF;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style></head>" & vbcrlf & "<body  topmargin=""0"" leftmargin=""0"">" & vbcrlf & "   <tablewidth=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""center"" bgcolor=""#FFFFFF"">" & vbcrlf & "      <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"">" & vbcrlf & "              <tr>" & vbcrlf & "                <td width=""5%"" height=""27""  background=""../images/contentbg.gif""><div align=""center""><img src=""../images/contenttop.gif""height=""27""> </div></td> " & vbcrlf & "                <td width=""95%""  background=""../images/contentbg.gif"">" & vbcrlf & " "
	dim ord
	dim sharecontact
	sharecontact=0
	ord=deurl(request("ord"))
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from mobanMessage where ord="&ord&" "
	rs.open sql,conn,1,1
	dim  share,name,cateid
	W3=rs("shareinfo")
	member1=rs("share")
	cateid=rs("addcate")
	sharecontact=rs("share")
	rs.close
	set rs=nothing
	if cateid="" then
		cateid=0
	end if
	if isnull(sharecontact) then
		sharecontact=0
	end if
	if member1="1" then
		check_mem1=""
	...
	Response.write "" & vbcrlf & "                 <strong><font color=""#1445A6"">短信模板共享</font></strong></td>" & vbcrlf & "        </tr>" & vbcrlf & "</table>  " & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "  <form name=""form"" method=""POST"" action=""saveshare_moban.asp?ord="
	Response.write pwurl(ord)
	Response.write """>" & vbcrlf & "   " & vbcrlf & "                       <tr>" & vbcrlf & "                      <td colspan=""4""><input name=""member1"" type=""radio"" value=""0"" onClick=""document.getElementById('sort_member').style.display=''""; "
	Response.write check_mem1
	Response.write ">" & vbcrlf & "                 <strong>共享给以下用户</strong>（在需要共享用户前面的方框打勾）" & vbcrlf & "                 </td>" & vbcrlf & "                     </tr>" & vbcrlf & "                 <tr id=""sort_member"" style="""
