...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	if action="save" Then
		...
		Response.write "" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "alert(0);" & vbcrlf & "            window.opener.GetUserVal("""
		Response.write InputId
		Response.write ""","""
		Response.write W3
		Response.write ""","""
		Response.write W3Name
		Response.write """);" & vbcrlf & "                winClose();" & vbcrlf & "function winClose()" & vbcrlf & "{" & vbcrlf & " try" & vbcrlf & "     {" & vbcrlf & "               window.opener=null;" & vbcrlf & "             window.open('','_self');" & vbcrlf & "                window.close();" & vbcrlf & " }catch(e)" & vbcrlf & "       {}" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "</script>" & vbcrlf & ""
	end if
	...
	Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "//处理返回信息函数" & vbcrlf & "function GateCheckResponse(){" & vbcrlf & "               if(xmlHttpRequest.readyState == 4){" & vbcrlf & "                             if(xmlHttpRequest.status == 200){" & vbcrlf & "                              var tempStr = xmlHttpRequest.responseText;" & vbcrlf & "                              if(tempStr.indexOf(""$$"")>0)" & vbcrlf & "                               {" & vbcrlf & "                                       window.opener.GetUserVal("""
	Response.write InputId
	Response.write """,tempStr.split(""$$"")[0].split(""|"")[0],tempStr.split(""$$"")[1].replace("" "",""""));" & vbcrlf & "                                      winClose();" & vbcrlf & "                             }" & vbcrlf & "                               else" & vbcrlf & "                            {" & vbcrlf & "                                       window.alert(""请求页面异常"");" & vbcrlf & "                             }" & vbcrlf & "" & vbcrlf & "                               }else{" & vbcrlf & "// window.alert(""请求页面异常"");" & vbcrlf &                          "}" & vbcrlf &                "}" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<script src= ""../Script/ic_Search_GateCheck.js?ver="""
	Response.write Application("sys.info.jsver")
	...
	Response.write CBaseUserTreeHtmlRadio(basesql,"", "","","W3",  "", "", "", w3)
	Response.write "" & vbcrlf & "              </td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "    <td align=""center"" class=""gray"" colspan=""2""><input type=""button"" name=""Submit42"" id=""GetVale"" value=""保存""  class=""page""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=""button"" name=""Submit42"" id=""w_close"" value=""取消""  onclick=""winClose()"" class=""page""/></td>" & vbcrlf & " </tr>" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "  </form>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>"
