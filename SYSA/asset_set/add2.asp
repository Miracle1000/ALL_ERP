...
'If sc>0 Then v = v & ";"
	...
	sub index()
		...
		Response.write Application("sys.info.jsver")
		Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"">" & vbcrlf & "if(window.opener.location.href.indexOf('edit_ck.asp')>0)window.opener=window.opener.parent;" & vbcrlf & "" & vbcrlf & "function MM_jumpMenu(targ,selObj,restore){ //v3.0" & vbcrlf & "eval(targ+"".location=\'""+selObj.options[selObj.selectedIndex].value+""\'"");" & vbcrlf & "if (restore) selObj.selectedIndex=0;" & vbcrlf & "}" & vbcrlf & "function ask() { " & vbcrlf & "document.all.date.action = ""add2.asp?sort=2""; " & vbcrlf & "}" & vbcrlf & "function ask2() { " & vbcrlf & "document.all.date.action = ""add2.asp?sort=3""; " & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function shDiv(divid,pdivid)" & vbcrlf & "{" & vbcrlf & "      document.getElementById(pdivid).className=document.getElementById(pdivid).className==""menu3""?""menu4"":""menu3""" & vbcrlf & "  document.getElementById(divid).style.display=document.getElementById(divid).style.display=='none'?'block':'none';" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function showCK(objid)" & vbcrlf & "{" & vbcrlf & "      //document.getElementById(""ckr_""+objid).checked=true;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function CheckSort()" & vbcrlf & "{" & vbcrlf & "    if(document.getElementById(""sttp"").checked)" & vbcrlf & "       {" & vbcrlf & "               var ckobj=document.getElementsByName(""cksort"");" & vbcrlf & "           for(var i=0;i<ckobj.length;i++)" & vbcrlf & "         {" & vbcrlf & "                       if(ckobj[i].disabled!=true&&ckobj[i].checked) return true;" & vbcrlf & "          }" & vbcrlf & "               alert(""请选择正确的目录"");" & vbcrlf & "                return false;" & vbcrlf & "   }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               return true;" & vbcrlf & "    }" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "var expaned=true;" & vbcrlf & "function ExpandAll(obj)" & vbcrlf & "{"& vbcrlf &     " obj.innerHTML=expaned?""全部展开"":""全部收缩"";" & vbcrlf &     "    var divobjs=document.getElementById(""leftmenuall"").getElementsByTagName(""div""); "& vbcrlf &  "    for(var i=0;i<divobjs.length;i++) "& vbcrlf &   "     { "& vbcrlf &            "    if(divobjs[i].onclick&&divobjs[i].onclick.toString().indexOf')>0"&""&"((expaned&&divobjs[i+1].style.display!='none')||(!expaned&&divobjs[i+1].style.display=='none')))" & vbcrlf & "               {" & vbcrlf & "                       divobjs[i].click();" & vbcrlf & "                     //divobjs[i].fireEvent('onclick');" & vbcrlf & "              }" & vbcrlf & "       }" & vbcrlf & "       expaned=!expaned;" & vbcrlf & "}" & vbcrlf & ""& vbcrlf &" </script> "& vbcrlf &" </head> "& vbcrlf & "<body onunload=""window.opener.location.reload();"">" & vbcrlf
		dim clo
		clo=request("clo")
		if clo<>"" then
		...
		if rd<>"" then
			set rs=server.CreateObject("adodb.recordset")
			sql="select parentid,sort1,gate1,StoreCode from O_assSetType Where id="&rd&" "
		...
		Response.write "" & vbcrlf & "      <table width=""100%""  border=""0"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "            <tr>" & vbcrlf & "                    <td width=""100%"" valign=""top"">" & vbcrlf & "                              <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"" style=""background: url('../images/detail_top_bg.png') repeat-x;"">" & vbcrlf & "                                       <tr>" & vbcrlf & "                                            <td width=""5%"" height=""27""  background=""../images/contentbg.gif""><div align=""center""><img src=""../images/contenttop.gif""height=""27""> </div></td>" & vbcrlf & "                                            <tdwidth=""95%""  background=""../images/contentbg.gif""><strong><font color=""#1445A6"">目录设置</font></strong></td>" & vbcrlf & "                                     </tr>" & vbcrlf & "                           </table>" & vbcrlf & "                                <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<form name=""date"" method=""post"" action=""add2.asp"" onsubmit=""return Validator.Validate(this,2)&&CheckSort()"" id=""demo"">" & vbcrlf & "                                    <span style=""font-size: 9pt""><input type=hidden name=menu1 value=addto></span>" & vbcrlf & "                                    <tr class=""top"">" & vbcrlf & "                                          <td  colspan=""2""><div align=""center"">添加目录</div></td>" & vbcrlf & "                                    </tr>" & vbcrlf & "                                   <tr>" & vbcrlf & "                                            <td width=""120px""><div align=""right"">目录名称：</div></td>" & vbcrlf & "                                          <td>" & vbcrlf & "                                                    <div align=""left"">" & vbcrlf & "                                                                <input name=""sort1"" type=""text"" id=""sort1"" size=""20""  dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1个至50个字之间""  value="""
		Response.write sort1
		Response.write """>" & vbcrlf & "                                                         <span class=""red"">*</span>" & vbcrlf & "                                                        </div>" & vbcrlf & "                                          </td>" & vbcrlf & "                                   </tr>" & vbcrlf & "                                   <tr>" & vbcrlf & "                                            <td>" & vbcrlf & "                                            <div align=""right"">上级目录：</div></td>" & vbcrlf & "                                          <td>" & vbcrlf & "                                                    <div style=""height:30px"">" & vbcrlf & "                                                                <input type=""radio"" name=""cktp"" id=""rttp"" value=""1"" onclick=""document.getElementById('leftmenuall').style.display='none';"" "
		if pid="0" then Response.write " checked"
		Response.write ">根分类" & vbcrlf & "                                                               <input type=""radio"" name=""cktp"" id=""sttp"" value=""0"" onclick=""document.getElementById('leftmenuall').style.display='block';"" "
		if pid<>"0" then Response.write " checked"
		Response.write ">子分类" & vbcrlf & "                                                               <a href=""javascript:void(0);"" onclick=""ExpandAll(this);"">全部收缩</a>" & vbcrlf & "                                                       </div>" & vbcrlf & "                                                  <div align=""left"" id=""leftmenuall"" "
        ...
        sql="select isnull(max(depth),0) from O_assSetType where del=1"
        set rs=conn.execute(sql)
        Depth=rs(0)
        rs.close
        set rs=nothing
        for i=0 to Depth
            sql="select id,sort1,gate1,parentid,depth,storecode,isLeef,isnull((select count(*) from O_assSetname where sort=a.id),0) as StoreCount from O_assSetType a where del=1 and Depth="&i&" order by gate1 desc"
            set rs=conn.execute(sql)
            while not rs.eof
...
'else '
        ...
        next
        Response.write "" & vbcrlf & "                                                             </select>(指数越高排在越前面）" & vbcrlf & "                                                  </div>" & vbcrlf & "                                          </td>" & vbcrlf & "                   </tr>" & vbcrlf & "                   <tr>" & vbcrlf & "                            <td>" & vbcrlf & "                                                    <div align=""right"">目录代码：</div>" & vbcrlf & "                                 </td>" & vbcrlf & "                                         <td>" & vbcrlf & "                                                    <div style=""height:30px"">" & vbcrlf & "                                                             <input type=""text"" name=""StoreCode"" value="""
        Response.write scode
        Response.write """ maxlength=""50"">" & vbcrlf & "                                                   </div>" & vbcrlf & "                                          </td>" & vbcrlf & "                                   </tr>" & vbcrlf & "                       <tr>" & vbcrlf & "                              <td height=""35"" bordercolorlight=""#000000"" bordercolordark=""#000000"" bordercolor=""#CCFFFF"" colspan=""2"">" & vbcrlf & "                             <div align=""center"">" & vbcrlf &                      "            <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf &                                                     "        <input type=""submit"" name=""Submit42"" value=""增加"" onClick=""ask();"" class=""page""/> "& vbcrlf &                                           "               <input type=""submit"" name=""Submit423"" value=""复制"" onClick=""ask2();"" class=""page""/>" & vbcrlf & "                                                           <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "                                                        </div>" & vbcrlf & "                                          </td>" & vbcrlf & "                                   </tr>  " & vbcrlf & "                                 </form>" & vbcrlf & "                         </table>" & vbcrlf & "                        </td>" & vbcrlf & "   </tr>" & vbcrlf & "      <tr>" & vbcrlf & "                    <td  class=""page"">" & vbcrlf & "                                <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "                                 <tr>" & vbcrlf & "                                            <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "                                    </tr>" & vbcrlf & "                           </table>" & vbcrlf & "                        </td>" & vbcrlf & "   </tr>" & vbcrlf & "   </table>" & vbcrlf & ""
        call db_close : Response.end
    end sub
    sub addto()
        dim sort1,gate1,ord
        ...
        sql = "select id from O_assSetType where sort1='"&ml.De(sort1)&"'"
        Set Rs = server.CreateObject("adodb.recordset")
        ...
        if cktp=1 then
            ...
            sql="select * from O_assSetType where del=1 and id="&cksort
            set rs=conn.execute(sql)
            if rs.eof then
                Response.write "<script>alert('父目录不存在或者已被删除！');window.history.back();</script>"
                call db_close : Response.end
            else
                ParentID=cksort
                ...
                isLeef=1
                if rs("isLeef") then
                    conn.execute("update O_assSetType set isLeef=0 where id="&cksort)
                end if
            end if
        end if
        if StoreCode<>"" and not isnull(StoreCode) then
            sql7="select * from O_assSetType WHERE ParentID="&ParentID&" AND storecode='"&ml.De(StoreCode)&"'"
            set rs7=conn.execute(sql7)
            if not rs7.eof then
                Response.write"<script language=javascript>alert('目录代码已存在,请重新填写！');history.back()</script>"
                call db_close : Response.end
            end if
            set rs7=nothing
        end if
        sqlStr="Insert Into O_assSetType(sort1,gate1,ParentID,Depth,isLeef,RootID,StoreCode) values("&_
        "'" & ml.De(sort1) & "'," &_
        gate1 & "," &_
        ParentID & "," &_
        Depth & "," &_
        ...
        rd=rs(0)
        rs.close
        if cktp=1 then conn.execute "update O_assSetType set RootID=id where id="&rd
        if sort=1 then
            Response.redirect "add2.asp?clo=35"
        elseif sort=2 then
            Response.redirect "add2.asp?pid="&cksort
        elseif sort=3 then
            Response.redirect "add2.asp?rd="&rd
        end if
    end sub
