...
'Private Sub Class_Initialize
	...
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open from power where ord="&session("personzbintel2007")&" and sort1=21 and sort2=14"
	...
	rs1.close
	sql1="select qx_open from power where ord="&session("personzbintel2007")&" and sort1=23 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_23_13=0
	else
		open_23_13=rs1("qx_open")
	end if
	rs1.close
	sql1="select qx_open from power where ord="&session("personzbintel2007")&" and sort1=31 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_31_16=0
	else
		open_31_16=rs1("qx_open")
	end if
	rs1.close
	sql1="select qx_open from power where ord="&session("personzbintel2007")&" and sort1=32 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_32_16=0
	else
		open_32_16=rs1("qx_open")
	end if
	rs1.close
	sql1="select qx_open from power where ord="&session("personzbintel2007")&" and sort1=23 and sort2=12"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_23_12=0
	else
		open_23_12=rs1("qx_open")
	end if
	rs1.close
	sql1="select qx_open from power where ord="&session("personzbintel2007")&" and sort1=25 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_25_13=0
	else
		open_25_13=rs1("qx_open")
	end if
	rs1.close
	set rs1=nothing
	if open_23_13=0 then
		str_Result=" and 1=0 "
	end if
	if open_21_1=3 then
	elseif open_21_1=1 then
		str_Result=str_Result & " and addcate in ("&intro_21_1&") "
	else
		str_Result=str_Result & " and 1=0 "
	end if
	if open_31_16=0 and open_32_16=0 then
		str_Result=str_Result & " and 1=0 "
	end if
	Dim A,B,C,D,E,F
	A=request("A")
	...
	kccheck = Request("kccheck")
	lp = Request("lp")
	if  IsNumeric(lp) and IsNumeric(kccheck) then
		conn.execute("update home_usConfig set nvalue="&lp&",tvalue="&kccheck&" where name='YJLimitPercentage'")
	end if
	if B="3333333" or B="5555555" then
		set rs9=server.CreateObject("adodb.recordset")
		sql9="select ord,intro,num1,tq1,fw1 from setjm  where ord=20  and cateid="&session("personzbintel2007")&""
		rs9.open sql9,conn,1,1
		if rs9.eof then
		else
			Str_Result_20=""
			if open_23_13=0 then
				Str_Result_20=Str_Result_20+" and 1=2 "
'if open_23_13=0 then
			end if
			if open_31_16=0 and open_32_16=0 then
				Str_Result_20=Str_Result_20 & " and 1=2 "
			...
			if rs9("fw1")="0" then
				if open_21_1=3 then
				elseif open_21_1=1 then
					Str_Result_20=Str_Result_20 & " and addcate in ("&intro_21_1&") "
				else
					Str_Result_20=Str_Result_20 & " and 1=2 "
				end if
			else
			...
			tq20=rs9("tq1")
			Str_Result_20=Str_Result_20 & "and date7<='"&dateadd("d",tq20,now)&"'"
		end if
		rs9.close
		set rs9=nothing
	end if
...
'elseif F1=6 then
	...
	if Z2<>"" then
		if Z1=1 then
			str_Result=str_Result+"and pym like '%"& Z2 &"%'"
'if Z1=1 then
		elseif Z1=2 then
			str_Result=str_Result+"and pym not like '%"& Z2 &"%'"
'elseif Z1=2 then
		elseif Z1=3 then
			str_Result=str_Result+"and pym='"&Z2&"'"
'elseif Z1=3 then
		elseif Z1=4 then
			str_Result=str_Result+"and pym<>'"&Z2&"'"
'elseif Z1=4 then
...
'elseif P1=6 then
	...
	if I2<>"" then
		if I1=1 then
			str_Result=str_Result+"and alert1>"&I2&""
'if I1=1 then
		elseif I1=2 then
			str_Result=str_Result+"and alert1>="&I2&""
'elseif I1=2 then
...
'elseif I1=5 then
	...
	if H2<>"" then
		if H1=1 then
			str_Result=str_Result+" and ord in (select product from jiage where txm like '%"& H2 &"%' )"
'if H1=1 then
		end if
	end if
	if J2<>"" then
		if J1=1 then
			str_Result=str_Result+"and alert2>"&J2&""
'if J1=1 then
		elseif J1=2 then
			str_Result=str_Result+"and alert2>="&J2&""
'elseif J1=2 then
...
'elseif J1=5 then
	...
	if T2<>"" then
		if T1=1 then
			str_Result=str_Result+"and intro1 like '%"& T2 &"%'"
'if T1=1 then
		elseif T1=2 then
			str_Result=str_Result+"and intro1 not like '%"& T2 &"%'"
'elseif T1=2 then
		elseif T1=3 then
			str_Result=str_Result+"and intro1='"& T2 &"'"
'elseif T1=3 then
		elseif T1=4 then
			str_Result=str_Result+"and intro1<>'"& T2 &"'"
'elseif T1=4 then
...
'elseif T1=6 then
	...
	if U2<>"" then
		if U1=1 then
			str_Result=str_Result+"and intro2 like '%"& U2 &"%'"
'if U1=1 then
		elseif U1=2 then
			str_Result=str_Result+"and intro2 not like '%"& U2 &"%'"
'elseif U1=2 then
		elseif U1=3 then
			str_Result=str_Result+"and intro2='"& U2 &"'"
'elseif U1=3 then
		elseif U1=4 then
			str_Result=str_Result+"and intro2<>'"& U2 &"'"
'elseif U1=4 then
...
'elseif U1=6 then
	...
	if E2<>"" then
		if E1=1 then
			str_Result=str_Result+"and intro3 like '%"& E2 &"%'"
'if E1=1 then
		elseif E1=2 then
			str_Result=str_Result+"and intro3 not like '%"& E2 &"%'"
'elseif E1=2 then
		elseif E1=3 then
			str_Result=str_Result+"and intro3='"& E2 &"'"
'elseif E1=3 then
		elseif E1=4 then
			str_Result=str_Result+"and intro3<>'"& E2 &"'"
'elseif E1=4 then
...
'elseif zdy4_1=6 then
	...
	if N2<>"" then
		if N1=1 then
			str_Result=str_Result+"and per1>"&N2&""
'if N1=1 then
		elseif N1=2 then
			str_Result=str_Result+"and per1>="&N2&""
'elseif N1=2 then
...
'elseif N1=5 then
	...
	if N4<>"" then
		if N3=1 then
			str_Result=str_Result+"and per2>"&N4&""
'if N3=1 then
		elseif N3=2 then
			str_Result=str_Result+"and per2>="&N4&""
'elseif N3=2 then
...
'elseif N3=5 then
	...
	if GY2<>"" then
		if GY1=1 then
			str_Result=str_Result+"and company in ( select ord from tel where sort3=2 and del=1 and name like '%"& GY2 &"%' ) "
'if GY1=1 then
		elseif GY1=2 then
			str_Result=str_Result+"and company not in ( select ord from tel where sort3=2 and del=1 and name like '%"& GY2 &"%' ) "
'elseif GY1=2 then
		elseif GY1=3 then
			str_Result=str_Result+"and company in ( select ord from tel where sort3=2 and del=1 and name='"& GY2 &"' ) "
'elseif GY1=3 then
		elseif GY1=4 then
			str_Result=str_Result+"and company not in ( select ord from tel where sort3=2 and del=1 and name='"& GY2 &"' ) "
'elseif GY1=4 then
		elseif GY1=5 then
			str_Result=str_Result+"and company in ( select ord from tel where sort3=2 and del=1 and name like '"& GY2 &"%' ) "
'elseif GY1=5 then
...
'elseif GY1=6 then
	...
	If remind <> "" Then
		...
		Str_Result = Str_Result &" and e.ord in (" & helper.listSQL("ids") & ")"
	end if
	dim px
	px=request("px")
	if px="" Then
	...
	if px="1" then
		px_Result=px_Result+" order by title desc,date7 desc "
'if px="1" then
	elseif px="2" Then
		px_Result=px_Result+" order by title asc,date7 asc "
'elseif px="2" Then
	ElseIf px="3" Then
		px_Result=px_Result+" order by order1 desc,date7 desc "
'ElseIf px="3" Then
	ElseIf px="4" then
		px_Result=px_Result+" order by order1 asc,date7 asc "
'ElseIf px="4" then
	elseif px="5" then
		px_Result=px_Result+" order by type1 desc,date7 desc "
'elseif px="5" then
	elseif px="6" then
		px_Result=px_Result+" order by type1 asc,date7 asc "
'elseif px="6" then
	elseif px="7" then
		px_Result=px_Result+" order by sortname desc,date7 desc "
'elseif px="7" then
	elseif px="8" Then
		px_Result=px_Result+" order by sortname asc,date7 asc "
'elseif px="8" Then
	ElseIf px="9" then
		px_Result=px_Result+" order by ku_num desc,date7 desc "
'ElseIf px="9" then
	elseif px="10" then
		px_Result=px_Result+" order by ku_num asc,date7 asc "
'elseif px="10" then
	ElseIf px="11" then
		px_Result=px_Result+" order by alert1 desc,date7 desc "
'ElseIf px="11" then
	elseif px="12" then
		px_Result=px_Result+" order by alert1 asc,date7 asc "
'elseif px="12" then
	elseif px="13" then
		px_Result=px_Result+" order by alert2 desc,date7 desc "
'elseif px="13" then
	elseif px="14" then
		px_Result=px_Result+" order by alert2 asc,date7 asc "
'elseif px="14" then
	end if
	...
	if currpage<="0" or currpage="" Or isnumeric(currpage)=False  then
		currpage=1
	end if
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style>" & vbcrlf & ".IE5 #kh input.anybutton2{margin-bottom:-5px;}" & vbcrlf & " .tip_table{background:#fff;border:1px solid #ccc;}" & vbcrlf & " .tip_table td{border:0}" & vbcrlf & " .tip_table td table{border-collapse:collapse;}" & vbcrlf & " .tip_table td td{border:1px solid #c0ccdd}" & vbcrlf & " #content.tip_table tr.top td{border:1px solid #c0ccdd!important}" & vbcrlf & " .tip_table td table{background-color:#fff}" & vbcrlf & " #content.tip_table td tr.top{border-right:1px solid #c0ccdd}" & vbcrlf & " #content.tip_table td tr.top td{border-right:0!important;border-collapse:collapse}" & vbcrlf & " #ht1 table{margin-bottom:-1px}" & vbcrlf & " #content.contentlist{table-layout:fixed}" & vbcrlf & ".createWindow_closeBtn{" & vbcrlf & "      height:16px;" & vbcrlf & "    width:16px;" & vbcrlf & "     display:inline-block;" & vbcrlf & "   float: right;" & vbcrlf & "   background: url(../../sysn/skin/default/img/panel_tools_del.png) no-repeat -16px 0px;" & vbcrlf & "   cursor:pointer;" & vbcrlf & "}" & vbcrlf & "    .yggsmain {" & vbcrlf & "        margin:10px 10px;" & vbcrlf & "        height:120px;" & vbcrlf & "        border:1px solid #b6c0c9;" & vbcrlf & "        background-color:#FFF;" & vbcrlf & "        display:flex;" & vbcrlf & "        justify-content:space-around;" & vbcrlf & "        align-items:center;" & vbcrlf & "    }" & vbcrlf & "    .fontw{" & vbcrlf & "        font-weight:bold;" & vbcrlf & "    }" & vbcrlf & "    .br {" & vbcrlf & "        border-radius:4px;" & vbcrlf & "    }" & vbcrlf & "    .itemys {" & vbcrlf & "        background-color:#409EFF;" & vbcrlf & "        border-radius:4px;" & vbcrlf & "        display: flex;" & vbcrlf & "        align-items: center; /*定义body的元素垂直居中*/" & vbcrlf & "        justify-content: center; /*定义body的里的元素水平居中*/" & vbcrlf & "        color:#fff;" & vbcrlf & "    }" & vbcrlf & "    .itemct{" & vbcrlf & "        width:80px;" & vbcrlf & "        height:30px;" & vbcrlf & "    }" & vbcrlf & "    .itemfh{" & vbcrlf & "        width:30px;" & vbcrlf & "        height:30px;" & vbcrlf & "    }" & vbcrlf & "</style>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"" src=""../contract/cp_ajax.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "" & vbcrlf & "function callServer2() {" & vbcrlf & "  var url = ""liebiao_tj.asp?timestamp="" + new Date().getTime() + ""&date1=""+ Math.round(Math.random()*100);" & vbcrlf & "  xmlHttp.open(""GET"", url, false);" & vbcrlf &  " xmlHttp.onreadystatechange = function(){ "& vbcrlf &   "updatePage2();" & vbcrlf &  " };" & vbcrlf &  " xmlHttp.send(null);" & vbcrlf & "}" & vbcrlf & "function updatePage2() {" & vbcrlf &" var test7=""ht1""" & vbcrlf &  " if (xmlHttp.readyState < 4) { "& vbcrlf &    "  ht1.innerHTML=""loading..."";" & vbcrlf & "  }" & vbcrlf & "  if (xmlHttp.readyState == 4) {" & vbcrlf & "    var response = xmlHttp.responseText;" & vbcrlf & "   ht1.innerHTML=response.replace('&quot;','\'');" & vbcrlf & "  xmlHttp.abort();" & vbcrlf & "  }" & vbcrlf & "}" & vbcrlf & "function callServer5(s, unit, ord, id, attr1id, attr2id) {" & vbcrlf & "    var w = s;" & vbcrlf & "       w = document.all[w];" & vbcrlf & "    var url = ""../contract/cu_kccx.asp?unit="" + escape(unit) + ""&ord="" + escape(ord) + ""&id="" + escape(id) + ""&attr1id="" + attr1id + ""&attr2id="" + attr2id + ""&timestamp="" + new Date().getTime() + ""&date1="" + Math.round(Math.random() * 100);" & vbcrlf & "    xmlHttp.open(""GET"", url, false);" & vbcrlf & "    xmlHttp.onreadystatechange = function () {" & vbcrlf & "        updatePage_kc(w);" & vbcrlf & "    };" & vbcrlf & "    xmlHttp.send(null);" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function updatePage_kc(w) {" & vbcrlf & "    var test6 = w" & vbcrlf & "    if (xmlHttp.readyState < 4) {" & vbcrlf & "        test6.innerHTML = ""loading..."";" & vbcrlf & "    }" & vbcrlf & "    if (xmlHttp.readyState == 4) {" & vbcrlf & "           var response = xmlHttp.responseText;" & vbcrlf & "        var img = $(test6).prev()[0] || """";" & vbcrlf & "           var imgH = $(img).height();" & vbcrlf & "        var pos = img && img.getBoundingClientRect();" & vbcrlf & "                var docH = (window.document.documentElement.clientHeight || window.document.body.clientHeight);" & vbcrlf & "         vardocW = (window.document.documentElement.clientwidth || window.document.body.clientwidth);" & vbcrlf & "           var scrollT = document.documentElement.scrollTop;" & vbcrlf & "        var top = pos.top + imgH;" & vbcrlf & "              var left = pos.left;" & vbcrlf & "            test6.innerHTML = response;" & vbcrlf & "             vartext6w = $(test6).width();" & vbcrlf & "          var test6h = $(test6).height();" & vbcrlf & "        if (left + text6w > docW) { left = left - text6w } //else { left = left - text6w / 2; }" & vbcrlf & "        if (top + test6h > docH) { top = top - test6h - 10; }" & vbcrlf & "        test6.style.top = top + scrollT + ""px"";" & vbcrlf & "            test6.style.left = left + ""px"";" & vbcrlf & "        xmlHttp.abort();" & vbcrlf & "    }" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function callServer6(t, nameitr, ord, id) {" & vbcrlf & "    var w = t;" & vbcrlf & "    w = document.all[w]" & vbcrlf & "    w.innerHTML = """";" & vbcrlf & "    xmlHttp.abort();" & vbcrlf & "}" & vbcrlf & "batchYg = function () {" & vbcrlf & "    var params="""";" & vbcrlf & "    if ($(""input[id^='yj_']:checked"") && $(""input[id^='yj_']:checked"").length > 0) {" & vbcrlf & "        $(""input[id^='yj_']:checked"").each(function () {" & vbcrlf & "            params+= (params.length>0?""_"":"""")+$(this).val();" & vbcrlf & "        })" & vbcrlf & "        window.open(""../../SYSN/view/store/yugou/YuGou.ashx?fromType=91&selectid="" + params, ""_blank"")" & vbcrlf & "    } else {" & vbcrlf & "        alert(""未勾选任何信息，请重新选择"")" & vbcrlf &     "}" & vbcrlf & "}" & vbcrlf &" </script>" & vbcrlf &" <script language=""javascript"" src=""../inc/system.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "</head>" & vbcrlf & "<body >" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "<td width=""100%"" valign=""top"">" & vbcrlf & "<form action=""aleat.asp?page_count="
	Response.write page_count
	Response.write "&px="
	Response.write px
	Response.write """ method=""get""　id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date""  style=""margin:0"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & " <tr>" & vbcrlf & "        <td class=""place"">库存预警</td>" & vbcrlf & "        <td>&nbsp;<a href=""javascript:void(0)"" onClick=""Myopen_px(User);return false;"" class=""sortRule"">排序规则<img src=""../images/i10.gif"" width=""9"" height=""5"" border=""0""></a></td>" & vbcrlf & "        <td align=""right""><div id=""kh"" style=""height:32px;line-height:22px;"">" & vbcrlf & "            "
	if open_23_12=1 then
		Response.write "<input type=""button"" onclick=""yggsDiv()"" value=""待预购公式""  class=""anybutton2""/>"
	end if
	if open_23_10=1 or open_23_10=3 then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出资料"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({from:'form_with_page_action',page:'../out/xls_aleat.asp?"
		Response.write Url
		Response.write "'});}"" class=""anybutton2""/>"
	end if
	Response.write "" & vbcrlf & "              <a href=""javascript:void(0)"" class=""AfterQuickSearch"" onclick=""callServer2();document.getElementById('kh').style.display='none';document.getElementById('ht1').style.display='';return false;""><img src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a>&nbsp;</div></td> "& vbcrlf &      "   <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf &   "  </tr> "& vbcrlf & "</table> "& vbcrlf & "<span id=""ht1""></span>" & vbcrlf & "</form> "& vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "   <tr class=""top"">" & vbcrlf & "        <td width=""4%"" ><div align=""center"">选择</div></td>" & vbcrlf & "           <td width=""10%"" ><div align=""center"">产品名称</div></td>" & vbcrlf & "            <td width=""10%"" height=""26"" ><div align=""center"">编号</div></td>" & vbcrlf & "         <td width=""10%"" ><div align=""center"">型号</div></td>" & vbcrlf & "                <td width=""6%"" ><div align=""center"">基本单位</div></td>" & vbcrlf & "    <td width=""10%"" ><div align=""center"">分类</div></td>" & vbcrlf & "    <td width=""8%"" ><div align=""center""> 可用库存</div></td>" & vbcrlf & "    <td width=""7%"" ><div align=""center"">库存下限</div></td>" & vbcrlf & "    <td width=""7%"" ><div align=""center"">库存上限</div></td>" & vbcrlf & "    <td width=""6%"" ><div align=""center"">待预购数量</div></td>" & vbcrlf & "    <td width=""6%"" ><div align=""center"">下限紧急度</div></td>" & vbcrlf & "    <td width=""6%"" ><div align=""center"">上限紧急度</div></td>" & vbcrlf & "    <td width=""10%"" ><div align=""center"" ><font id=""kh"">" & vbcrlf & "    <select name=""select2"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"">" & vbcrlf & "      <option>-请选择-</option>" & vbcrlf & "      <option value=""page_count=10"" "
	Response.write "'});}"" class=""anybutton2""/>"
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "    </select></font></div></td>" & vbcrlf & "        </tr>" & vbcrlf & ""
	dim YJLimitPercentage:YJLimitPercentage=100
	dim kcCheck:kcCheck=1
	Set rsUsConfig= conn.execute("select isnull(nvalue,100)nvalue,isnull(tvalue,'1')tvalue from home_usConfig where name='YJLimitPercentage'")
	If rsUsConfig.eof= False Then
		YJLimitPercentage=rsUsConfig("nvalue")
		kcCheck=cdbl(rsUsConfig("tvalue"))
	end if
	rsUsConfig.close
	storelist_sort5 = "0"
	Set rsUsConfig= conn.execute("select isnull(tvalue,'0') tvalue from home_usConfig where name='storelist_sort5' and isnull(uid, 0) =" &  session("personzbintel2007") )
	...
	showKuLimitZeroSQL = ""
	if storelist_sort5 = "0" then
		showKuLimitZeroSQL = " and (isnull(alert1,0)>0 or isnull(alert2,0)>0)"
	end if
	dim rs109
	Set rs109= conn.execute("select isnull(intro,'0')intro from setopen  with(nolock) where sort1=109")
	If rs109.eof= False Then sort109=rs109("intro")
	If sort109&"" = "" Or isnumeric(sort109&"")=False Then sort109=0
	dim rs20171221
	Set rs20171221= conn.execute("select isnull(num1,2)num1,ord from setjm3 where ord in (20171221)")
	If rs20171221.eof= False Then num20171221=rs20171221("num1")
	If num20171221&"" = "" Or isnumeric(num20171221&"")=False Then num20171221=0
	dim xd:xd=""
	for i=1 to num20171221
		xd=xd&"\d"
	next
	if len(xd)>0 then
		xd="("&xd&")"
	end if
	YJLimitPercentage=Formatnumber(YJLimitPercentage,num20171221,-1,-2,0)
	xd="("&xd&")"
	showzore =0
	Set rsUsConfig= conn.execute("select (case cast(tvalue as varchar(10)) when '1' then 1 else 0 end) v from home_usConfig  with(nolock) where uid="& session("personzbintel2007") &" and name='storelist_sort1' ")
	if rsUsConfig.eof=false  then
	...
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from ("&_
	"select a.ord,addcate,title,order1,a.sort1,a.company,type1,a.unit,unitjb,pym,zdy1,zdy2,zdy3,zdy4,zdy5,zdy6,intro1,intro2,intro3,a.roles,"&_
	"(case when isnull(aleat1,0)=0 then 0 else isnull(aleat1,0) end) as alert1,"&_
	"(case when isnull(aleat2,0)=0 then 0 else isnull(aleat2,0) end) as alert2,"&_
	"(select sort1 from sortonehy where ord=a.unitjb) as unitname,"&_
	"(select menuname from menu where id=a.sort1) as sortname,"&_
	"date7,isnull(ku_num,0) ku_num,"&_
	"(case when isnull(ku_num,0)<aleat1 then (aleat1-isnull(ku_num,0))/(CASE WHEN isnull(aleat1,0)=0 THEN 1 ELSE isnull(aleat1,0) END)*100 else 0 END) as per1,"&_
	"(case when isnull(ku_num,0)>aleat2 then (isnull(ku_num,0)-aleat2)/(CASE WHEN isnull(aleat2,0)=0 THEN 1 ELSE isnull(aleat2,0) END)*100 else 0 END) as per2 "&_
	"from product a "&_
	"LEFT JOIN ("&_
	" SELECT ord,SUM(numjb) AS ku_num "&_
	" FROM ("&_
	"  Select suba.ord,(CASE WHEN suba.unit=subb.unitjb THEN num2 ELSE num2*ISNULL((SELECT TOP 1 bl FROM jiage WHERE product=suba.ord AND unit=suba.unit),0) END) numjb "&_
	"  FROM ku suba "&_
	"  INNER JOIN product subb ON suba.ord=subb.ord and exists(select ord from sortck where ord=suba.ck and del=1 and (charindex(',"&session("personzbintel2007")&",',','+replace(cast(intro as varchar(4000)),' ','')+',')>0 or replace(cast(intro as varchar(4000)),' ','') = '0')) "&_
	" ) subaa GROUP BY ord "&_
	") AS b ON a.ord=b.ord "&_
	" where a.canoutstore=1 and a.del=1 "& showZeroSQL&" and (isnull(ku_num,0)<=aleat1 or isnull(ku_num,0)>aleat2) "&_
	") as e "&_
	" where 1=1 "&Str_Result_20&" "& showKuLimitZeroSQL &" "&str_Result&" "&px_Result&" "
	rs.open sql,conn,1,1
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			ord=rs("ord")
			ords=iif(len(ords)>0,ords&",","")&ord
			unit=rs("unit")
			if UBound(split(unit,","))>0 then
				Dim iOrd
				for iOrd=0 To  UBound(split(unit,","))-1
'Dim iOrd
					ords=iif(len(ords)>0,ords&",","")&ord
				next
			end if
			units=iif(len(units)>0,units&",","")&unit
			m=m+1
'units=iif(len(units)>0,units&",","")&unit
			rs.movenext
			if rs.eof or m>=rs.PageSize then exit do
		loop
		if rs.RecordCount>0 then
			rs.movefirst
			rs.absolutePage = CurrPage
		...
		conn.execute("create TABLE [#ZTYD_list](  "&_
		"[id] int NULL,[ord] int NULL, [unit] int NULL,[bl] decimal(25,12) NULL,[ck] int NULL,  "&_
		"[num2] decimal(25,12)  NULL, [locknum1] decimal(25,12)  NULL, [money1] decimal(25,12)  NULL,[AssistNum] decimal(25,12)  NULL,[AssistUnit] int NULL,   "&_
		"[ProductAttr1] int NULL,[ProductAttr2] int NULL,[ydnum] decimal(25,12)  NULL, ztnum decimal(25,12)  NULL  "&_
		") ON [PRIMARY];insert into [#ZTYD_list](ord, unit ,bl ,ck , num2, locknum1, money1, AssistNum, AssistUnit , ProductAttr1 ,ProductAttr2, ydnum , ztnum) exec [erp_store_kulist_ZT_YD] '"&ords&"','"&units&"',"&session("personzbintel2007")&",2;  ")
		sql1="select ord,(case when bl<>1 then bl else 1 end)*ydnum as ydnum ,sum((case when bl<>1 then bl else 1 end)*ztnum)ztnum,sum((case when bl<>1 then bl else 1 end)*isnull(locknum1,0))locknum1  from #ZTYD_list group by ord,ydnum,bl"
		set rssYDZT=server.CreateObject("adodb.recordset")
		rssYDZT.open sql1,conn,1,1
		do until rs.eof
			needYgNum=0
			num1=cdbl(rs("ku_num"))
			kynum=cdbl(rs("ku_num"))
			ord=rs("ord")
			k=sdk.base64.Utf8CharHtmlConvert(rs("title"))
			unitjb=rs("unitjb")
			do until rssYDZT.eof
				ordRss=rssYDZT("ord")
				ydnumRss=rssYDZT("ydnum")
				ztnumRss=rssYDZT("ztnum")
				locknum1Rss=rssYDZT("locknum1")
				if ordRss=ord then
					kynum=CDbl(kynum) - CDbl(ydnumRss) + CDbl(ztnumRss) - CDbl(locknum1Rss) * CDbl(sort109)
'if ordRss=ord then
				end if
				rssYDZT.movenext
			loop
			if rssYDZT.RecordCount>0 then
				rssYDZT.MoveFirst
			end if
			alert1=cdbl(rs("alert1"))
			alert2=cdbl(rs("alert2"))
			per1=cdbl(rs("per1"))
			per2=cdbl(rs("per2"))
			if   kynum <  alert1 then
				if alert1=0 then
					per1=(alert1-kynum)*100
'if alert1=0 then
				else
					per1=(alert1-kynum)/alert1*100
'if alert1=0 then
				end if
			end if
			if   kynum >  alert2 then
				if alert2=0 then
					per2=(kynum-alert2)*100
'if alert2=0 then
				else
					per2=(kynum-alert2)/alert2*100
'if alert2=0 then
				end if
			end if
			per1=Formatnumber(per1,num1_dot,-1)
'if alert2=0 then
			per2=Formatnumber(per2,num1_dot,-1)
'if alert2=0 then
			if kcCheck=1 then
				needYgNum=kynum-(alert1*YJLimitPercentage)/100
'if kcCheck=1 then
			else
				needYgNum=num1-(alert1*YJLimitPercentage)/100
'if kcCheck=1 then
			end if
			roles=rs("roles")
			CanYg="1"
			Set YGToCGProductRolesRs=conn.execute("select ISNULL(intro,1) intro from setopen where sort1=2021070521")
			If YGToCGProductRolesRs.eof= False Then YGToCGProductRolesControl=YGToCGProductRolesRs("intro")
			if YGToCGProductRolesControl&""<>"1" And InStr( rs("roles"),"3" ) =< 0 then
				CanYg="0"
			end if
			Response.write "" & vbcrlf & "    <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td width=""4%"" align=""center"" >"
			if needYgNum<0 And CanYg="1" then
				Response.write "<input type=""checkbox"" id=""yj_"
				Response.write id
				Response.write """ value="""
				Response.write  ord&"|"& unitjb
				Response.write """/><input type=""text"" style=""display:none"" id=""ku_"
				Response.write id
				Response.write """ value="""
				Response.write num1
				Response.write """/>"
			end if
			Response.write "</td>" & vbcrlf & "      <td width=""10%"" height=""27"">&nbsp;"
			...
			Response.write""&k&""
			Response.write "</a></td>" & vbcrlf & "      <td width=""10%"" height=""27"" align=""center"">"
			Response.write rs("order1")
			Response.write "</td>" & vbcrlf & "      <td width=""10%""><div align=""center"">"
			Response.write rs("type1")
			Response.write "</div></td>" & vbcrlf & "                  <td width=""8%""><div align=""center"">"
			Response.write sdk.base64.Utf8CharHtmlConvert(rs("unitname"))
			Response.write "<input type=""hidden"" name=""unit_"
			Response.write id
			Response.write """ id=""u_nametest"
			Response.write id
			Response.write """ value="""
			Response.write unitjb
			Response.write """/></div></td>" & vbcrlf & "                    <td width=""8%""><div align=""center"">"
			Response.write sdk.base64.Utf8CharHtmlConvert(rs("sortname"))
			Response.write "</div></td>" & vbcrlf & "      <td width=""8%""><div align=""center"">"
			Response.write FormatNumber(kynum,num1_dot,-1)
			Response.write "</div></td>" & vbcrlf & "      <td width=""8%""><div align=""center"">"
			Response.write "&nbsp;<img class='ko""&ko&""' src='../images/116.png' onmouseover=""callServer5('ttttest"
			Response.write id
			Response.write "','"
			Response.write unitjb
			Response.write "','"
			...
			Response.write "','"
			Response.write id
			Response.write "')"" border=0 style=""cursor:pointer""><span id=""ttttest"
			Response.write id
			Response.write """ style=""position:absolute;margin-left:0;z-index:10;max-width:800px""></span></div></td>" & vbcrlf & "      <td width=""7%""><div align=""center"">"
			Response.write id
			Response.write FormatNumber(alert1,num1_dot,-1)
			Response.write id
			Response.write "</div></td>" & vbcrlf & "                  <td width=""7%""><div align=""center"">"
			Response.write FormatNumber(alert2,num1_dot,-1)
			Response.write "</div></td>" & vbcrlf & "                  <td width=""7%""><div align=""center"">"
			Response.write "</div></td>" & vbcrlf & "                <td width=""6%"" ><div align=""center"" style="""
			Response.write iif(needYgNum>=0,"","color:red")
			Response.write """>"
			Response.write iif(needYgNum>=0,"--",FormatNumber(Abs(needYgNum),num1_dot,-1))
			Response.write """>"
			Response.write "</div></td>" & vbcrlf & "                  <td width=""6%""><div align=""center"">"
			if per1>0 then
			...
			if open_21_14=1 then
				Response.write "<input type=""button"" name=""Submit3"" value=""详情"" onClick=""javascript:window.open('../product/content.asp?ord="
				Response.write pwurl(rs("ord"))
		...
		loop
		Response.write "" & vbcrlf & "</table>" & vbcrlf & "</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr>" & vbcrlf & "<td class=""page"">" & vbcrlf & "<table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & " <tr>" & vbcrlf & "      <td width=""21%"" height=""30"">" & vbcrlf & "          <input type=""checkbox"" id=""qx"" value=""全选"" onchange=""check(this)""/>全选" & vbcrlf & "          "
		if open_25_13=1 or open_25_13=3 then
			Response.write "<input type=""button""  value=""批量预购"" onClick=""batchYg()""  class=""anybutton2""/>"
		end if
		Response.write "" & vbcrlf & "       </td>" & vbcrlf & "   <td width=""79%""><div align=""right"">" & vbcrlf & "               "
	...
	action1="库存预警"
	call close_list(1)
	Response.write "" & vbcrlf & "</td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<script language=""javascript"">" & vbcrlf & "function Myopen_px(divID){ //根据传递的参数确定显示的层" & vbcrlf & "        if(divID.style.display==""""){" & vbcrlf & "              divID.style.display=""none""" & vbcrlf & "        }else{" & vbcrlf & "          divID.style.display=""""" & vbcrlf & "      }" & vbcrlf & "       divID.style.left=300;" & vbcrlf & "   divID.style.top=10;" & vbcrlf & "}" & vbcrlf & "check = function (e) {" & vbcrlf & "    if (e.checked) {" & vbcrlf & "        $(""input[id^='yj_']"").each(function () {" & vbcrlf & "            $(this)[0].checked = true;" & vbcrlf & "        });" & vbcrlf & "    }" & vbcrlf & "    else {" & vbcrlf & "        $(""input[id^='yj_']"").attr(""checked"", false)" & vbcrlf & "    }" & vbcrlf & "}" & vbcrlf & "function yggsDiv() { //根据传递的参数确定显示的层" & vbcrlf & "    if ($(""#yggs"").css(""display"") == """" || $(""#yggs"").css(""display"") == ""block"") { "& vbcrlf &        " $(""#yggs"").css(""display"", ""none"") "& vbcrlf &   "  } else { "& vbcrlf &      "   $(""#yggs"").css(""display"", """")" & vbcrlf &    " }" & vbcrlf &   " $(""#yggs"").css({ ""right"": ""60px"", ""top"": ""40px"" })" & vbcrlf & "} "& vbcrlf & "closeWindow = function () {" & vbcrlf & "    $(""#yggs"").css(""display"", ""none"")" & vbcrlf & "}" & vbcrlf & "isRealNum = function (val) {" & vbcrlf & "    // isNaN()函数 把空串 空格 以及NUll 按照0来处理 所以先去除，" & vbcrlf & "    if (val === """" || val == null) {" & vbcrlf & "        return false;" & vbcrlf & "    }" & vbcrlf & "    if (!isNaN(val)) {" & vbcrlf & "        //对于空数组和只有一个数值成员的数组或全是数字组成的字符串，isNaN返回false，例如：'123'、[]、[2]、['123'],isNaN返回false," & vbcrlf & "        //所以如果不需要val包含这些特殊情况，则这个判断改写为if(!isNaN(val) && typeof val === 'number' )" & vbcrlf & "        return true;" & vbcrlf & "    }" & vbcrlf & "    else {" & vbcrlf & "        return false;" & vbcrlf & "    }" & vbcrlf & "}" & vbcrlf & "saveFormula = function () {" & vbcrlf & "    kccheck = $(""select[name='kccheck']"").val();" & vbcrlf & "    lp = $(""input[name='LimitPercentage']"").val();" & vbcrlf & "    if (!isRealNum(lp) || !isRealNum(kccheck)) {" & vbcrlf & "        alert(""只可录入大于0的数字！"");" & vbcrlf & "    }" & vbcrlf & "    else {" & vbcrlf & "        if (lp<=0) {" & vbcrlf & "            alert(""只可录入大于0的数字！"");" & vbcrlf & "        }" & vbcrlf & "        else {" & vbcrlf & "            gotourl(""kccheck="" + kccheck+ ""&lp="" + lp);" & vbcrlf & "        }" & vbcrlf & "    }" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<div id=""yggs"" class=""resetGroupTableBg"" style=""position:absolute;width:500px; height:200px;display:none;background-color:#D5EBFB"" class=""br"">" & vbcrlf & "    <div style=""display:flex;justify-content:space-between;margin:10px 10px;height:15px;"">" & vbcrlf & "        <font class=""tableTitleLinks"" style=""font-weight:bold;color:#000080"">待预购数量计算公式</font>" & vbcrlf & "        <span class=""createWindow_closeBtn"" title=""点击关闭窗口"" onclick=""closeWindow()""></span>" & vbcrlf& "    </div>" & vbcrlf & "    <div class=""yggsmain br"">" & vbcrlf & "        <div class=""itemys itemct ""><span>待预购数量</span></div>" & vbcrlf & "        <span class=""fontw"">=</span>" & vbcrlf & "        <select name=""kccheck"">" & vbcrlf & "            <option value=""1"" "
	Response.write iif(kcCheck=1,"selected","")
	Response.write ">可用库存</option>" & vbcrlf & "            <option value=""0"" "
	Response.write iif(kcCheck=0,"selected","")
	Response.write ">现有库存</option>    " & vbcrlf & "        </select>" & vbcrlf & "        <span class=""fontw"">-</span>" & vbcrlf & "        <span class=""itemys itemct "">库存下限</span>" & vbcrlf & "        <span class=""fontw"">*</span>" & vbcrlf & "        <span class=""itemys itemct""><input type=""text"" name=""LimitPercentage"" onkeyup=""this.value=this.value.replace(/[^\d.]/g,'').replace(/\.{2,}/g,'.').replace('.', '$#$').replace(/\./g,'').replace('$#$', '.').replace(/^(\-)*(\d+)\."
	Response.write iif(kcCheck=0,"selected","")
	Response.write xd
	Response.write ".*$/,'$1$2"
	Response.write iif(xd&""="","",".$3")
	Response.write "')"" style=""width:45px;margin-right:5px"" value="""
	Response.write iif(xd&""="","",".$3")
	Response.write YJLimitPercentage
	Response.write """""/><span>%</span></span>" & vbcrlf & "    </div>" & vbcrlf & "    <div style=""text-align:center""><input type=""button"" class=""anybutton2"" title=""点击保存公式"" value=""确认"" onclick=""saveFormula()""/></div>" & vbcrlf & "</div>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:200px; height:460px;display:none;"">" & vbcrlf & "<table width=""150"" height=""460""  border=""0"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""460"">" & vbcrlf & "        <table width=""160"" height=""460"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "   <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=1');""><font color=""#2F496E"">按产品名称排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "                <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=2');""><font color=""#2F496E"">按产品名称排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=3');""><font color=""#2F496E"">按产品编号排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=4');""><font color=""#2F496E"">按产品编号排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "<tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=5');""><font color=""#2F496E"">按产品型号排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=6');""><font color=""#2F496E"">按产品型号排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=7');""><font color=""#2F496E"">按产品分类排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=8');""><font color=""#2F496E"">按产品分类排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=9');""><font color=""#2F496E"">按现有库存排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl=""#2F496E"">按库存下限排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=12');""><font color=""#2F496E"">按库存下限排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=13');""><font color=""#2F496E"">按库存上限排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=14');""><font color=""#2F496E"">按库存上限排序(升)</font></a> </td> "& vbcrlf &       "    </tr>" & vbcrlf &" <!--           <tr  valign=""middle"">" & vbcrlf &            " <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=15');""><fontcolor=""#2F496E"">按下限紧急度排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=16');""><font color=""#2F496E"">按下限紧急度排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=17');""><font color=""#2F496E"">按上限紧急度排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <tdheight=""24"" colspan=""2""><a href=""###"" onClick=""gotourl('px=18');""><font color=""#2F496E"">按上限紧急度排序(升)</font></a> </td>" & vbcrlf & "          </tr>-->" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & "</body>" &vbcrlf & "</html>"
