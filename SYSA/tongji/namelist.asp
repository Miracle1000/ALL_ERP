...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & ""
	sort_zjjg=request.QueryString("sort_zjjg")
	Dim IsType,dongjie,huishouzhan
	IsType=1
	If Len(Trim(request.QueryString("dongjie")))>0 then
		dongjie = Trim(request.QueryString("dongjie"))
		end if
		If Len(Trim(request.QueryString("huishouzhan")))>0 then
			huishouzhan = Trim(request.QueryString("huishouzhan"))
		end if
		...
		Response.write "       " & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">日期选择：</div></td>" & vbcrlf & "<td>" & vbcrlf & "  <select name=""selyear"" id=""selyear"">" & vbcrlf & "    "
		Response.write Pubcla.DateList(Datetype,year(tdate),2010,year(now()))
		Response.write "" & vbcrlf & "  </select>年" & vbcrlf & "  "
		IF url="bbzj1.asp" or TRIM(url)="bbzj1_month.asp" THEN
			Response.write "" & vbcrlf & "  <select name=""selmonth"" id=""selmonth"" onchange=""getPart('fresh_day.asp?month='+this.value+'&year='+document.getElementById('selyear').value+'&url="
'IF url="bbzj1.asp" or TRIM(url)="bbzj1_month.asp" THEN
			Response.write url
			Response.write "','daysdiv')"">" & vbcrlf & "  "
			Response.write Pubcla.DateList(Datetype,month(tdate),1,12)
			Response.write "" & vbcrlf & "  </select>月" & vbcrlf & "  "
		end if
		Response.write "" & vbcrlf & "  " & vbcrlf & "  <span id=""daysdiv"">" & vbcrlf & "  "
		IF url="bbzj1.asp" THEN
			Response.write "" & vbcrlf & "  <select name=""selday"" id=""selday"">" & vbcrlf & "  "
			Response.write Pubcla.DateList(Datetype,day(tdate),1,31)
			Response.write "" & vbcrlf & "  </select>日" & vbcrlf & "  "
		end if
		Response.write "" & vbcrlf & "  </span>" & vbcrlf & "    <!--input type=""text"" name=""jtdate"" id=""jtdate"" size=""10""  value="""
		Response.write "" & vbcrlf & "  </select>日" & vbcrlf & "  "
		Response.write tdate
		Response.write """ onclick=""setday(this)"" /-->" & vbcrlf & "  " & vbcrlf & "" & vbcrlf & "  <!--input name=ret2 size=10  id=""daysOfMonth2Pos"" onMouseUp=""toggleDatePicker('daysOfMonth2','date.ret2')"">" & vbcrlf & "            <DIV id=daysOfMonth2 " & vbcrlf & "style=""POSITION: absolute""></DIV-->" & vbcrlf & "<!--select name=""time1"">" & vbcrlf & "    <option value=""00"">00</option>" & vbcrlf & "    <option value=""01"">01</option>" & vbcrlf & "    <option value=""02"">02</option>" & vbcrlf & "    <option value=""03"">03</option>" & vbcrlf & "    <option value=""04"">04</option>" & vbcrlf & "   <option value=""05"">05</option>" & vbcrlf & "    <option value=""06"">06</option>" & vbcrlf & "    <option value=""07"">07</option>" & vbcrlf & "    <option value=""08"">08</option>" & vbcrlf & "    <option value=""09"">09</option>" & vbcrlf & "    <option value=""10"">10</option>" & vbcrlf & "   <option value=""11"">11</option>" & vbcrlf & "    <option value=""12"">12</option>" & vbcrlf & "    <option value=""13"">13</option>" & vbcrlf & "    <option value=""14"">14</option>" & vbcrlf & "    <option value=""15"">15</option>" & vbcrlf & "    <option value=""16"">16</option>" & vbcrlf & "   <option value=""17"">17</option>" & vbcrlf & "    <option value=""18"">18</option>" & vbcrlf & "    <option value=""19"">19</option>" & vbcrlf & "    <option value=""20"">20</option>" & vbcrlf & "    <option value=""21"">21</option>" & vbcrlf & "    <option value=""22"">22</option>" & vbcrlf & "   <option value=""23"">23</option>" & vbcrlf & "  </select>" & vbcrlf & "时" & vbcrlf & "<select name=""time2"">" & vbcrlf & "  <option value=""00"">00</option>" & vbcrlf & "  <option value=""05"">05</option>" & vbcrlf & "  <option value=""10"">10</option>" & vbcrlf & "  <option value=""15"">15</option>" & vbcrlf & "  <option value=""20"">20</option>" & vbcrlf & "  <option value=""25"">25</option>" & vbcrlf & "  <option value=""30"">30</option>" & vbcrlf & "  <option value=""35"">35</option>" & vbcrlf & "  <option value=""40"">40</option>" & vbcrlf & "  <option value=""45"">45</option>" & vbcrlf& "  <option value=""50"">50</option>" & vbcrlf & "  <option value=""55"">55</option>" & vbcrlf & "</select>" & vbcrlf & "分&nbsp;至：<INPUT name=ret2 size=9  id=daysOfMonth2Pos onmouseup=toggleDatePicker(""daysOfMonth2"",""date.ret2"") value="""
		Response.write m2
		Response.write """><DIV id=daysOfMonth2 style=""POSITION: absolute""></DIV>" & vbcrlf & "??<select name=""time3"">" & vbcrlf & "    <option value=""00"">00</option>" & vbcrlf & "    <option value=""01"">01</option>" & vbcrlf & "    <option value=""02"">02</option>" & vbcrlf & "    <option value=""03"">03</option>" & vbcrlf & "    <option value=""04"">04</option>" & vbcrlf & "    <option value=""05"">05</option>" & vbcrlf & "    <option value=""06"">06</option>" & vbcrlf & "    <option value=""07"">07</option>" & vbcrlf & "    <option value=""08"">08</option>" & vbcrlf & "    <option value=""09"">09</option>" & vbcrlf & "    <option value=""10"">10</option>" & vbcrlf & "    <option value=""11"">11</option>" & vbcrlf & "    <option value=""12"">12</option>" & vbcrlf & "    <option value=""13"">13</option>" & vbcrlf & "    <option value=""14"">14</option>" & vbcrlf & "    <option value=""15"">15</option>" & vbcrlf & "    <option value=""16"">16</option>" & vbcrlf & "    <option value=""17"">17</option>" & vbcrlf & "    <option value=""18"">18</option>" & vbcrlf & "    <option value=""19"">19</option>" & vbcrlf & "    <option value=""20"">20</option>" & vbcrlf & "    <option value=""21"">21</option>" & vbcrlf & "    <option value=""22"">22</option>" & vbcrlf & "    <option value=""23"">23</option>" & vbcrlf & "  </select>" & vbcrlf & "时" & vbcrlf & "<select name=""time4"">" & vbcrlf & "  <option value=""00"">00</option>" & vbcrlf & "  <option value=""05"">05</option>" & vbcrlf & "  <optionvalue=""10"">10</option>" & vbcrlf & "  <option value=""15"">15</option>" & vbcrlf & "  <option value=""20"">20</option>" & vbcrlf & "  <option value=""25"">25</option>" & vbcrlf & "  <option value=""30"">30</option>" & vbcrlf & "  <option value=""35"">35</option>" & vbcrlf & "  <option value=""40"">40</option>" & vbcrlf & "  <option value=""45"">45</option>" & vbcrlf &  " <option value=""50"">50</option>" & vbcrlf & "  <option value=""55"">55</option>" & vbcrlf & "</select-->" & vbcrlf & "<label>" & vbcrlf & "</label></td></tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "  <td><div align=""right"">人员选择：</div></td>" & vbcrlf & "  <td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
		...
		Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td width=""10%"">&nbsp;</td>" & vbcrlf & "<td width=""90%""><!--input type=""submit"" name=""Submit45"" value=""检索"" onclick=""javascript:if(window.checkaction){checkaction();}"" class=""page""/-->" & vbcrlf & "<input type=""submit"" name=""Submit45"" value=""检索"" class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr></table>" & vbcrlf & ""
		Response.write "</td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & ""
		conn.close
		set conn=nothing
		Class Pubclass
