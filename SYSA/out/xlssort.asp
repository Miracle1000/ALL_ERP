...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	xlWorksheet.Cells(1,2).Value = "客户分类"
	xlWorksheet.Range("A2:F2").Borders.LineStyle=1
	Response.Flush
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from sort4  "
	...
	rs.close
	set rs=Nothing
	Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!客户分类代码导出成功,共有"&(i-1)&"条记录!</B>"";</script>"
	set rs=Nothing
	Response.write "" & vbcrlf & "</BODY>" & vbcrlf & "</HTML>" & vbcrlf & ""
	Set fs = CreateObject("Scripting.FileSystemObject")
	tfile=Server.MapPath("sort.xls")
	...
	Response.write """><font class=""red""><strong><u>下载导出的客户分类对应表</u></strong></font></a></p> " & vbcrlf & ""
