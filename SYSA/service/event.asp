...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=42 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_42_2=0
		intro_42_2=0
	else
		open_42_2=rs1("qx_open")
		intro_42_2=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=42 and sort2=3"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_42_3=0
		intro_42_3=0
	else
		open_42_3=rs1("qx_open")
		intro_42_3=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=42 and sort2=5"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_42_5=0
		intro_42_5=0
	else
		open_42_5=rs1("qx_open")
		intro_42_5=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=42 and sort2=6"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_42_6=0
		intro_42_6=0
	else
		open_42_6=rs1("qx_open")
		intro_42_6=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=42 and sort2=7"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_42_7=0
		intro_42_7=0
	else
		open_42_7=rs1("qx_open")
		intro_42_7=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=42 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_42_8=0
		intro_42_8=0
	else
		open_42_8=rs1("qx_open")
		intro_42_8=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=42 and sort2=10"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_42_10=0
		intro_42_10=0
	else
		open_42_10=rs1("qx_open")
		intro_42_10=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=42 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_42_13=0
	else
		open_42_13=rs1("qx_open")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=42 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_42_16=0
		intro_42_16=0
	else
		open_42_16=rs1("qx_open")
		intro_42_16=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=42 and sort2=17"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_42_17=0
		intro_42_17=0
	else
		open_42_17=rs1("qx_open")
		intro_42_17=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=1"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_1=0
		intro_94_1=0
	else
		open_94_1=rs1("qx_open")
		intro_94_1=rs1("qx_intro")
	end if
	rs1.close
	set rs1=Nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=94 and sort2=14"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_94_14=0
		intro_94_14=0
	else
		open_94_14=rs1("qx_open")
		intro_94_14=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	if open_42_1=3 then
		list=""
		list1=""
	elseif open_42_1=1 then
		list=" and (addcate in ("&intro_42_1&") or (catelead in ("&intro_42_1&") and catelead>0) " & vbcrlf &_
		"or cate1 in ("&intro_42_1&") " & vbcrlf &_
		"or cate2 in ("&intro_42_1&") " & vbcrlf &_
		"or cate3 in ("&intro_42_1&") " & vbcrlf &_
		"or cate4 in ("&intro_42_1&") " & vbcrlf &_
		"or cate5 in ("&intro_42_1&") " & vbcrlf &_
		"or cate6 in ("&intro_42_1&") " & vbcrlf &_
		"or cate7 in ("&intro_42_1&") " & vbcrlf &_
		"or cate8 in ("&intro_42_1&") " & vbcrlf &_
		"or member1 in ("&intro_42_1&") " & vbcrlf &_
		"or CHARINDEX(','+CAST("&session("personzbintel2007")&" AS VARCHAR)+',' , ','+Replace(share, ' ', '')+',') > 0 " & vbcrlf &_
		"or member1 in ("&intro_42_1&") " & vbcrlf &_
		"or share='0' " & vbcrlf &_
		"or dbo.erp_HasIntersection(REPLACE(share,' ',''),replace('"&intro_42_1&"',' ',''))>0 ) "
		list1=" and addcate in ("&intro_42_1&") "
	else
		list=" and 1=2 "
		list1=" and 1=2 "
	end if
	Str_Result=" where del=1 "&list&" "
	Str_Result2=" where del=1 "&list1&" "
...
'Private Sub Class_Initialize
	...
	Dim helper
	gatety = Request("gatety")
	lay = request("lay")
	if lay<>"" then
		set rs1=server.CreateObject("adodb.recordset")
		sql1="select qx_open,qx_intro from power WITH(NOLOCK) where ord="&session("personzbintel2007")&" and sort1=42 and sort2=11"
		rs1.open sql1,conn,1,1
		if rs1.eof then
			open_42_11=0
			intro_42_11=0
		else
			open_42_11=rs1("qx_open")
			intro_42_11=rs1("qx_intro")
		end if
		rs1.close
		set rs1=nothing
		if open_42_11=3 then
			list1=""
		elseif open_42_11=1 then
			list1=" and addcate in ("&intro_42_11&") "
		else
			list1=" and 1=2 "
		end if
		Str_Result2=" where del=1 "&list1&" "
	...
	If request("fromTJ")&""="1" Then
		If w1<>"" Then
			Str_Result=Str_Result+" and addcate in ("& GetUserIdsByOrgsID(w1) &")"
'If w1<>"" Then
		end if
		If w2<>"" Then Str_Result=Str_Result+" and addcate3="& W2 &""
'If w1<>"" Then
		If w3<>"" Then Str_Result=Str_Result+" and addcate="& W3 &""
'If w1<>"" Then
	else
		W3=getW3(W1,W2,W3)
		W4=replace(W3,"0","")
		...
		if W4<>"" Then
			...
			If InStr(gatety, ",1,") > 0 Then
				Str_Result=Str_Result+" and ( (catelead in("& W3 &") and catelead<>0)  "
'If InStr(gatety, ",1,") > 0 Then
				ghs = true
			end if
'If InStr(gatety, ",2,") > 0 Then
			If ghs = True Then
				Str_Result=Str_Result+" or (member1 in("& W3 &") and addcate<>0)  "
'If ghs = True Then
			else
				ghs  = True
				Str_Result=Str_Result+" and ( (member1 in("& W3 &") and addcate<>0) "
				ghs  = True
			end if
		end if
		If ghs  = True  Then
...
'If ghs  = True  Then
	...
	dim link,userid,sqlcon,way,sort,great
	link = trim(request("link"))
	userid = trim(request("userid"))
	way=trim(request("way"))
	sort=trim(request("sort"))
	great=trim(request("great"))
	sqlcon=" and (catemain is not null OR wxUserID > 0) "
	if userid<>"" then
		select case link
		case "dcl":
		sqlcon=sqlcon+" and del = 1 and result1=0 and catelead in ("& userid &")"
'case "dcl":
		case "yes":
		Str_Result = Str_Result + " and addcate in("& userid &") and addcate<>0 "
'case "yes":
		case "js":
		Str_Result = Str_Result + " and (cate1="& userid &" or cate2="& userid &"  or cate3="& userid &"  or cate4="& userid &"  or cate5="& userid &"  or cate6="& userid &"  or cate7="& userid &"  or cate8="& userid &" )"
'case "js":
		end select
	end if
	if way<>"" then
		sqlcon=sqlcon+" and way1 in ("& way &")"
'if way<>"" then
	end if
	if sort<>"" then
		sqlcon=sqlcon+" and sort1 in ("& sort &")"
'if sort<>"" then
	end if
	if great<>"" then
		sqlcon=sqlcon+" and great1 in ("& great &")"
'if great<>"" then
	end if
	dim newstate
	...
	if newstate="1" then
		...
		sql9="select id,ord,intro,num1,tq1,fw1,gate1 from setjm2 WITH(NOLOCK) where ord=36 and cateid="&session("personzbintel2007")&""
		...
		if not rs9.eof then
			if rs9("fw1")="0" then
				if open_42_1 = 3 then
					Str_Result_22=""
				elseif open_42_1=1 then
					Str_Result_22=" and (addcate in ("&intro_42_1&") or (catelead in ("&intro_42_1&") and catelead>0) or cate1 in ("&intro_42_1&") or cate2 in ("&intro_42_1&") or cate3 in ("&intro_42_1&") or cate4 in ("&intro_42_1&") or cate5 in ("&intro_42_1&") or cate6 in ("&intro_42_1&") or cate7 in ("&intro_42_1&") or cate8 in ("&intro_42_1&") or member1 in ("&intro_42_1&") or share='0' or charindex(',"&session("personzbintel2007")&",',','+replace(share,' ','')+',')>0 or dbo.erp_HasIntersection(REPLACE(share,' ',''),replace('"&intro_42_1&"',' ',''))>0)"
'elseif open_42_1=1 then     '
				else
					Str_Result_22=" and 1=2"
				end if
			else
				Str_Result_22=" and (addcate in ("&session("personzbintel2007")&") or (catelead in ("&session("personzbintel2007")&") and catelead>0) or cate1 in ("&session("personzbintel2007")&") or cate2 in ("&session("personzbintel2007")&") or cate3 in ("&session("personzbintel2007")&") or cate4 in ("&session("personzbintel2007")&") or cate5 in ("&session("personzbintel2007")&") or cate6 in ("&session("personzbintel2007")&") or cate7 in ("&session("personzbintel2007")&") or cate8 in ("&session("personzbintel2007")&") or member1 in ("&session("personzbintel2007")&") or share='0' or charindex(',"&session(personzbintel2007)&",',','+replace(share,' ','')+',')>0 or dbo.erp_HasIntersection(REPLACE(share,' ',''),replace('"&session(personzbintel2007)&"',' ',''))>0)"
'else        '
			end if
		end if
		rs9.close
		set rs9=nothing
		Str_Result="where del=1 "&Str_Result_22
	end if
	if E="3333333" or E="5555555" then
		new_list="<span class='alt_tx'></span>"
		timelg=session("timezbintel2007")
'if E="3333333" and timelg<>"" then
		noalt1=" and a.date8>'"&timelg&"'"
	end if
	Dim sql9
	set rs9=server.CreateObject("adodb.recordset")
	sql9="select id,ord,intro,num1,tq1,fw1,gate1 from setjm WITH(NOLOCK) where ord=22 and cateid="&session("personzbintel2007")&""
	rs9.open sql9,conn,1,1
	if rs9.eof then
		tq22=0
	else
		if open_42_1=3 then
			str_result_22=""
		elseif open_42_1=1 then
			str_result_22="and addcate in ("&intro_42_1&")  "
		else
			str_result_22="and 1=0 "
		end if
		if rs9("fw1")="0" then
			str_result_22 = str_result_22 & " and isnull(catelead,0) > 0 "
		else
			str_result_22 = str_result_22 & " and catelead="& session("personzbintel2007") &" "
'end if
			tq22=rs9("tq1")
		end if
		rs9.close
		set rs9=nothing
		Str_Result="where del=1 "&Str_Result_22&"  and result1=0"
	end if
	if D<>"" then
...
'if D<>"" then
	...
	if H="2" then
		Str_Result=Str_Result + " and result1=0 "
'if H="2" then'
	end if
	Servicfl_list=-1
'if H="2" then'
	if F2<>"" then
		ary_Return = Split(F2,",")
		For i = 0 To UBound(ary_Return)
			n=0
			set rs=server.CreateObject("adodb.recordset")
			sql="select id from sortonehy WITH(NOLOCK) where id1="&ary_Return(i)&" "
			rs.open sql,conn,1,1
			if rs.eof then
				n=0
			else
				do until rs.eof
					if  CheckPurview(F2,trim(rs("id")))=True  then
						n=1
					end if
					if n=1 then exit do
					rs.movenext
			...
			set rs=nothing
			if n=0 then
				menuservice1(ary_Return(i))
			end if
		next
	end if
	if F2<>"" then
		Str_Result = Str_Result + " and  sort1 in ("&Servicfl_list&")"
'if F2<>"" then
	end if
	if sA<>"" then
		Str_Result = Str_Result + " and  way1 in ("&sA&") "
'if sA<>"" then'
	end if
	if sB<>"" then
		Str_Result = Str_Result + " and  great1 in ("&sB&") "
'if sB<>"" then '
	end if
	if sC<>"" and E<>"3333333" and E<>"5555555" then
		Str_Result = Str_Result + " and  result1 in ("&sC&") "
'if sC<>"" and E<>"3333333" and E<>"5555555" then '
	end if
	if sPrt<>"" then
		Str_Result = Str_Result + " and (case (select count(PrinterInfo.ord) from PrinterInfo where PrinterInfo.formID = a.ord) when 0 then 0 else 1 end) in ("& sPrt &") "
'if sPrt<>"" then '
	end if
	If sD2 <> "" Then
		If sD1 = 1 Then
			str_Result = str_Result + "and title like '%" & sD2 & "%'"
'If sD1 = 1 Then
		ElseIf sD1 = 2 Then
			str_Result = str_Result + "and title not like '%" & sD2 & "%'"
'ElseIf sD1 = 2 Then
		ElseIf sD1 = 3 Then
			str_Result = str_Result + "and title='" & sD2 & "'"
'ElseIf sD1 = 3 Then
		ElseIf sD1 = 4 Then
			str_Result = str_Result + "and title<>'" & sD2 & "'"
'ElseIf sD1 = 4 Then
...
'ElseIf sD1 = 6 Then
	...
	If sE2 <> "" Then
		If sE1 = 1 Then
			str_Result = str_Result + "and shid like '%" & sE2 & "%'"
'If sE1 = 1 Then
		ElseIf sE1 = 2 Then
			str_Result = str_Result + "and shid not like '%" & sE2 & "%'"
'ElseIf sE1 = 2 Then
		ElseIf sE1 = 3 Then
			str_Result = str_Result + "and shid='" & sE2 & "'"
'ElseIf sE1 = 3 Then
		ElseIf sE1 = 4 Then
			str_Result = str_Result + "and shid<>'" & sE2 & "'"
'ElseIf sE1 = 4 Then
...
'ElseIf sE1 = 6 Then
	...
	If sF2 <> "" Then
		If sF1 = 1 Then
			str_Result = str_Result + "and introts like '%" & sF2 & "%'"
'If sF1 = 1 Then
		ElseIf sF1 = 2 Then
			str_Result = str_Result + "and introts not like '%" & sF2 & "%'"
'ElseIf sF1 = 2 Then
		ElseIf sF1 = 3 Then
			str_Result = str_Result + "and introts='" & sF2 & "'"
'ElseIf sF1 = 3 Then
		ElseIf sF1 = 4 Then
			str_Result = str_Result + "and introts<>'" & sF2 & "'"
'ElseIf sF1 = 4 Then
...
'ElseIf sF1 = 6 Then
	...
	If sG2 <> "" Then
		If sG1 = 1 Then
			str_Result = str_Result + "and intro like '%" & sG2 & "%'"
'If sG1 = 1 Then
		ElseIf sG1 = 2 Then
			str_Result = str_Result + "and intro not like '%" & sG2 & "%'"
'ElseIf sG1 = 2 Then
		ElseIf sG1 = 3 Then
			str_Result = str_Result + "and intro='" & sG2 & "'"
'ElseIf sG1 = 3 Then
		ElseIf sG1 = 4 Then
			str_Result = str_Result + "and intro<>'" & sG2 & "'"
'ElseIf sG1 = 4 Then
...
'ElseIf sG1 = 6 Then
	...
	If sH2 <> "" Then
		If sH1 = 1 Then
			str_Result = str_Result + "and (intro1 like '%" & sH2 & "%' or intro2 like '%" & sH2 & "%' or intro3 like '%" & sH2 & "%' or intro4 like '%" & sH2 & "%' or intro5 like '%" & sH2 & "%' or intro6 like '%" & sH2 & "%' or intro7 like '%" & sH2 & "%' or intro8 like '%" & sH2 & "%')"
'If sH1 = 1 Then
		ElseIf sH1 = 2 Then
			str_Result = str_Result + "and (intro1 not like '%" & sH2 & "%' or intro2 not like '%" & sH2 & "%' or intro3 not like '%" & sH2 & "%' or intro4 not like '%" & sH2 & "%' or intro5 not like '%" & sH2 & "%' or intro6 not like '%" & sH2 & "%' or intro7 not like '%" & sH2 & "%' or intro8 not like '%" & sH2 & "%')"
		ElseIf sH1 = 3 Then
			str_Result = str_Result + "and (intro1 = '" & sH2 & "' or intro2 = '" & sH2 & "' or intro3 = '" & sH2 & "' or intro4 = '" & sH2 & "' or intro5 = '" & sH2 & "' or intro6 = '" & sH2 & "' or intro7 = '" & sH2 & "' or intro8 = '" & sH2 & "')'"
'ElseIf sH1 = 3 Then
		ElseIf sH1 = 4 Then
			str_Result = str_Result + "and (intro1 <> '" & sH2 & "' or intro2 <> '" & sH2 & "' or intro3 <> '" & sH2 & "' or intro4 <> '" & sH2 & "' or intro5 <> '" & sH2 & "' or intro6 <> '" & sH2 & "' or intro7 <> '" & sH2 & "' or intro8 <> '" & sH2 & "')'"
'ElseIf sH1 = 4 Then
...
'ElseIf sH1 = 6 Then
	...
	Call searchExtended(88,"a.ord")
	if m3<>"" then
		Str_Result = Str_Result + " and date1>='"&m3&"'"
'if m3<>"" then
	end if
	if m4<>"" then
		Str_Result = Str_Result + " and date1<='"&m4&"'"
'if m4<>"" then
	end if
	If wF<>"" Then
		If wF = "-100001" Then
'If wF<>"" Then
			Str_Result = Str_Result+" and  company in (select ord  from tel WITH(NOLOCK) where del=1 and isnull(sort1,0) not in (select ord from sort5 WITH(NOLOCK))) "
'If wF<>"" Then
		else
			Str_Result = Str_Result+" and  company in (select ord from tel WITH(NOLOCK) where del=1  and sort1 in  ("&wF&")) "
'If wF<>"" Then
		end if
	end if
	if wE<>"" and wF="" then Str_Result=Str_Result+" and  company in (select ord from tel WITH(NOLOCK) where del=1  and  sort in  ("&wE&")) "
'If wF<>"" Then
	if wA<>"" then Str_Result=Str_Result+" and  company in (select ord from tel WITH(NOLOCK) where del=1  and ly in  ("&wA&")) "
'If wF<>"" Then
	if wB<>"" then Str_Result=Str_Result+" and  company in (select ord from tel WITH(NOLOCK) where del=1  and jz in  ("&wB&")) "
'If wF<>"" Then
	area_list=-1
'If wF<>"" Then
	function menuarea(id)
		Dim rs,strid
		strid=""
	...
	if A2<>"" then
		area_list = menuarea(A2)
		Str_Result = Str_Result + " and area in ("&area_list&")"
		area_list = menuarea(A2)
	end if
	if wC<>"" then Str_Result=Str_Result+" and company in (select ord from tel WITH(NOLOCK) where del=1  and trade in  ("&wC&")) "
	area_list = menuarea(A2)
	if wD2<>"" then
		if wD1=1 then
			str_Result=str_Result+" and company in (select ord from tel WITH(NOLOCK) where del=1  and name like '%"& wD2 &"%')"
'if wD1=1 then
		elseif wD1=2 then
			str_Result=str_Result+" and company in (select ord from tel WITH(NOLOCK) where del=1  and name not like '%"& wD2 &"%')"
'elseif wD1=2 then
		elseif wD1=3 then
			str_Result=str_Result+" and company in (select ord from tel WITH(NOLOCK) where del=1  and name='"&wD2&"')"
'elseif wD1=3 then
		elseif wD1=4 then
			str_Result=str_Result+" and company in (select ord from tel WITH(NOLOCK) where del=1  and name<>'"&wD2&"')"
'elseif wD1=4 then
...
'elseif wD1=6 then
		elseif wD1=7 then
			Str_Result=Str_Result+" and company in (select ord from tel WITH(NOLOCK) where del=1  and exists(select 1 from person b WITH(NOLOCK) where del=1 and (tel.person=b.ord or b.company=tel.ord) and name like '%"&wD2&"%' ))"
'elseif wD1=7 then
		elseif wD1=8 then
			Str_Result=Str_Result+" and company in (select ord from tel WITH(NOLOCK) where del=1  and exists(select 1 from person b WITH(NOLOCK) where del=1 and (tel.person=b.ord or b.company=tel.ord) and phone like '%"&wD2&"%'))"
'elseif wD1=8 then
		elseif wD1=9 then
			Str_Result=Str_Result+" and company in (select ord from tel WITH(NOLOCK) where del=1  and exists(select 1 from person b WITH(NOLOCK) where del=1 and (tel.person=b.ord or b.company=tel.ord) and mobile like '%"&wD2&"%'))"
'elseif wD1=9 then
		end if
	end if
	area_list2=-1
'elseif wD1=9 then
	function menuarea2(id1)
		set rsarea=server.CreateObject("adodb.recordset")
		sqlarea="select id,id1 from menu WITH(NOLOCK) where id1="&id1&" "
		rsarea.open sqlarea,conn,1,1
		if rsarea.eof then
			gateord22=id1
			If Len(area_list2) = 0 Then
				area_list2 = "" & gateord22 & ""
			ElseIf InStr( area_list2, gateord22 ) <= 0 Then
				area_list2 = area_list2 & ", " & gateord22 & ""
			end if
		else
			do until rsarea.eof
				gateord22=rsarea("id")
	...
	if pA2<>"" then
		aryReturn2 = Split(pA2,",")
		For i = 0 To UBound(aryReturn2)
			n=0
			set rs=server.CreateObject("adodb.recordset")
			sql="select id from menu WITH(NOLOCK) where id1="&aryReturn2(i)&" "
			rs.open sql,conn,1,1
			if rs.eof then
				n=0
			else
				do until rs.eof
					if  CheckPurview(pA2,trim(rs("id")))=True  then
						n=1
					end if
					if n=1 then exit do
					rs.movenext
			...
			set rs=nothing
			if n=0 then
				menuarea2(aryReturn2(i))
			end if
		next
	end if
	if  pA2<>"" then
		Str_Result=Str_Result+"and  product in (select ord from product WITH(NOLOCK) where sort1 in ("&area_list2&") and sort1<>'') "
'if  pA2<>"" then
	end if
	If pB2 <> "" Then
		If pB1 = 1 Then
			str_Result = str_Result + "and product in (select ord from product WITH(NOLOCK) where title like '%" & pB2 & "%')"
'If pB1 = 1 Then
		ElseIf pB1 = 2 Then
			str_Result = str_Result + "and product in (select ord from product WITH(NOLOCK) where title not like '%" & pB2 & "%')"
'ElseIf pB1 = 2 Then
		ElseIf pB1 = 3 Then
			str_Result = str_Result + "and product in (select ord from product WITH(NOLOCK) where title='" & pB2 & "')"
'ElseIf pB1 = 3 Then
		ElseIf pB1 = 4 Then
			str_Result = str_Result + "and product in (select ord from product WITH(NOLOCK) where title<>'" & pB2 & "')"
'ElseIf pB1 = 4 Then
...
'ElseIf pB1 = 6 Then
	...
	If pC2 <> "" Then
		If pC1 = 1 Then
			str_Result = str_Result + "and product in (select ord from product WITH(NOLOCK) where order1 like '%" & pC2 & "%')"
'If pC1 = 1 Then
		ElseIf pC1 = 2 Then
			str_Result = str_Result + "and product in (select ord from product WITH(NOLOCK) where order1 not like '%" & pC2 & "%')"
'ElseIf pC1 = 2 Then
		ElseIf pC1 = 3 Then
			str_Result = str_Result + "and product in (select ord from product WITH(NOLOCK) where order1='" & pC2 & "')"
'ElseIf pC1 = 3 Then
		ElseIf pC1 = 4 Then
			str_Result = str_Result + "and product in (select ord from product WITH(NOLOCK) where order1<>'" & pC2 & "')"
'ElseIf pC1 = 4 Then
...
'ElseIf pC1 = 6 Then
	...
	If link = "js" Then
		Dim jsdatesql, itemsql
		For i = 1 To 8
			itemsql = ""
			if m1<>"" Then itemsql  = itemsql  &  " date1" & i & ">='"&m1&"'"
			If m2<>"" Then
				if m1<>"" Then itemsql  = itemsql  & " and "
				itemsql  = itemsql  &  " date1" & i & "<='"&m2&"'"
			end if
			If Len(itemsql) > 0 Then
				If Len(jsdatesql) > 0 Then jsdatesql = jsdatesql & " or "
				jsdatesql = jsdatesql & " (" & itemsql & ") "
			end if
		next
		If Len(jsdatesql) > 0 Then Str_Result = Str_Result & " and (" & jsdatesql & ") "
	else
		if m1<>"" Then Str_Result = Str_Result + " and date1>='"&m1&"'"
		If Len(jsdatesql) > 0 Then Str_Result = Str_Result & " and (" & jsdatesql & ") "
		if m2<>"" Then Str_Result = Str_Result + " and date1<='"&m2&"'"
		If Len(jsdatesql) > 0 Then Str_Result = Str_Result & " and (" & jsdatesql & ") "
	end if
	Prt = request("Prt")
	If Prt&""<>"" Then
		Str_Result = Str_Result + " and case (select count(PrinterInfo.ord) from PrinterInfo where PrinterInfo.formID = a.ord) when 0 then 0 else 1 end = "&Prt
'If Prt&""<>"" Then
	end if
	area_list3 = "-1"
'If Prt&""<>"" Then
	function menu3(id1)
		set rsarea=server.CreateObject("adodb.recordset")
		sqlarea="select ord from sortonehy WITH(NOLOCK) where gate2=51 and id1="&id1&" "
		rsarea.open sqlarea,conn,1,1
		if rsarea.eof then
		else
			do until rsarea.eof
				gateord22=rsarea("ord")
				If Len(area_list3) = 0 Then
					area_list3 = "" & gateord22 & ""
				ElseIf InStr( area_list3, gateord22 ) <= 0 Then
					area_list3 = area_list3 & ", " & gateord22 & ""
				end if
				menu3(rsarea("ord"))
				rsarea.movenext
			loop
	...
	if F<>0 then
		area_list3 = ""
		menu3(F)
		if area_list3<>"" and area_list3<>"-1" then
			menu3(F)
			Str_Result = Str_Result + " and sort1 in("&F&","& area_list3 &")"
			menu3(F)
		else
	...
	if A1<>0 then
		Str_Result = Str_Result + " and  way1="&A1&" "
'if A1<>0 then'
	end if
	if A3<>0 then
		Str_Result = Str_Result + " and  great1="&A3&" "
'if A3<>0 then '
	end if
	if E<>10 and E<>"3333333" and E<>"5555555" then
		Str_Result = Str_Result + " and  result1="&E&" "
'if E<>10 and E<>"3333333" and E<>"5555555" then '
	end if
	if C<>"" then
		if B = "shzt" then
			sqlcon=sqlcon+" and title like '%"& C &"%' "
'if B = "shzt" then
		elseif B = "shid" then
			Str_Result = Str_Result + " and shid like '%"& C &"%' "
'elseif B = "shid" then
		elseif B = "shnr" then
			sqlcon=sqlcon+" and introts like '%"& C &"%' "
'elseif B = "shnr" then
		elseif B = "jdry" then
			Str_Result = Str_Result + " and addcate in (select ord from gate WITH(NOLOCK) where name like '%"& C &"%') "
'elseif B = "jdry" then
		elseif B = "bz" then
			Str_Result = Str_Result + " and intro like '%"& C &"%' "
'elseif B = "bz" then
		elseif B = "clyj" then
			sqlcon=sqlcon+" and (intro1 like '%"& C &"%' or intro2 like '%"& C &"%' or intro3 like '%"& C &"%' or intro4 like '%"& C &"%' or intro5 like '%"& C &"%' or intro6 like '%"& C &"%' or intro7 like '%"& C &"%' or intro8 like '%"& C &"%') "
'elseif B = "clyj" then
		end if
	end if
	if deepth<>"" then
		Str_Result = Str_Result + " and sort1 in(select id from sortonehy WITH(NOLOCK) where deepth="&deepth&")"
'if deepth<>"" then
	end if
	if product_sh<>"" then
		Str_Result = Str_Result + " and product="&product_sh&" "
'if product_sh<>"" then
	end if
	currpage=Request("currpage")
	if currpage&""="" Or currpage&""="0" Or isnumeric(currpage)=False  then
		currpage=1
	end if
	...
	elseif px=5 then
		px_Result="order by shid desc,ord desc"
	elseif px=6 then
		px_Result="order by shid asc,ord asc"
	elseif px=7 then
		px_Result="order by date1 desc,ord desc"
	elseif px=8 then
		px_Result="order by date1 asc,ord asc"
	elseif px=9 then
		px_Result="order by addcate desc,ord desc"
	elseif px=10 then
		px_Result="order by addcate asc,ord asc"
	end if
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script src= ""../Script/se_event.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<style>" & vbcrlf & ".ser_btn .anybutton{*height:21px;*line-height:13px;*margin-bottom:0;*padding-top:2px}" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body  "
	'Response.write Application("sys.info.jsver")
	if open_42_8=0 then
	...
	Response.write " onMouseOver=""window.status='none';return true;"">" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "             <form method=""get"" action=""event.asp"" id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"" style=""margin:0"">" & vbcrlf & "            <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "           <input type=""hidden"" name=""product_sh"" value="""
	Response.write product_sh
	Response.write """>" & vbcrlf & "                  <tr>" & vbcrlf & "       <td class=""place"">"
	if H="1" then
		Response.write "售后检索"
	elseif H="2" then
		Response.write "待处理售后"
	else
		Response.write "售后列表"
	end if
	Response.write "</td>" & vbcrlf & "       <td>&nbsp;<a href=""javascript:void(0)"" onClick=""Myopen(User);return false;"" class=""sortRule"">排序规则<img src=""../images/i10.gif"" width=""9"" height=""5"" border=""0""></a></td>" & vbcrlf & "       <td align=""right"">" & vbcrlf & "                             <select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#000;border:0px solid #FFFFFF; overflow:hidden"">        " & vbcrlf & "        <option>-请选择-</option>" & vbcrlf & "        <option value=""page_count=10"" "
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "      </select>" & vbcrlf & "                       </td>" & vbcrlf & "      <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "     </tr>" & vbcrlf & "   </table>" & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""3"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;"">" & vbcrlf & "                <tr id=""zc"">" & vbcrlf & "       <td  height=""50"" class='ser_btn' align=""right"" style=""height:50px;border-top:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;"">" & vbcrlf & "           <input name=""company"" type=""hidden""  value="""
	Response.write trim(Request.QueryString("company"))
	Response.write """/>" & vbcrlf & "          <input name=""chance"" type=""hidden""  value="""
	Response.write trim(Request.QueryString("chance"))
	Response.write """/>" & vbcrlf & "          <input name=""contract"" type=""hidden""  value="""
	Response.write trim(Request.QueryString("contract"))
	Response.write """/>" & vbcrlf & "          "
	...
	Response.write "" & vbcrlf & "<select name=""Prt"">" & vbcrlf & "  <option value="""" "
	if Prt="" then
		Response.write "selected"
	end if
	Response.write ">打印状态</option>" & vbcrlf & "  <option value=""0"" "
	if Prt="0" then
		Response.write "selected"
	end if
	Response.write ">未打印</option>" & vbcrlf & "  <option value=""1"" "
	if Prt="1" then
		Response.write "selected"
	end if
	Response.write ">已打印</option>" & vbcrlf & "</select>" & vbcrlf & "<select name=""A1"">" & vbcrlf & "<option value=""0"" "
	if A1=0 then
		Response.write "selected"
	end if
	Response.write ">售后方式</option>" & vbcrlf & ""
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select ord, sort1 from sortonehy WITH(NOLOCK) where gate2=55 order by gate1 desc"
	rs7.open sql7,conn,1,1
	do until rs7.eof
		Response.write "" & vbcrlf & " <option value="""
		Response.write rs7("ord")
		Response.write """ "
		if clng(A1)=rs7("ord") then
			Response.write "selected"
		end if
		Response.write ">"
		Response.write rs7("sort1")
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "</select>" & vbcrlf & "<select name=""A3"">" & vbcrlf & "<option value=""0"" "
	if A3=0 then
		Response.write "selected"
	end if
	Response.write ">紧急程度</option>" & vbcrlf & ""
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select ord, sort1 from sortonehy WITH(NOLOCK) where gate2=52 order by gate1 desc"
	rs7.open sql7,conn,1,1
	do until rs7.eof
		Response.write "" & vbcrlf & " <option value="""
		Response.write rs7("ord")
		Response.write """ "
		if clng(A3)=rs7("ord") then
			Response.write "selected"
		end if
		Response.write ">"
		Response.write rs7("sort1")
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "</select>" & vbcrlf & "<select name=""E"">" & vbcrlf & "  <option value=""10"" "
	if E=10 then
		Response.write "selected"
	end if
	Response.write ">处理结果</option> " & vbcrlf & "  <option value=""0"" "
	if E=0 then
		Response.write "selected"
	end if
	Response.write ">处理中</option>" & vbcrlf & "  <option value=""1"" "
	if E=1 then
		Response.write "selected"
	end if
	Response.write ">处理完毕</option>" & vbcrlf & "</select>" & vbcrlf & "<select name=""B"">" & vbcrlf & "  <option value=""shzt"" "
	if B="shzt" then
		Response.write "selected"
	end if
	Response.write ">售后主题</option>" & vbcrlf & "  <option value=""shid"" "
	if B="shid" then
		Response.write "selected"
	end if
	Response.write ">售后编号</option>" & vbcrlf & "  <option value=""shnr"" "
	if B="shnr" then
		Response.write "selected"
	end if
	Response.write ">售后内容</option>" & vbcrlf & "  <option value=""jdry"" "
	if B="jdry" then
		Response.write "selected"
	end if
	Response.write ">接待人员</option>" & vbcrlf & "  <option value=""bz"" "
	if B="bz" then
		Response.write "selected"
	end if
	Response.write ">备注</option>" & vbcrlf & "  <option value=""clyj"" "
	if B="clyj" then
		Response.write "selected"
	end if
	Response.write ">处理内容</option>" & vbcrlf & "</select>" & vbcrlf & "<input name=""C"" type=""text"" size=""10""  value="""
	Response.write C
	Response.write """/>" & vbcrlf & "<input name=""H"" type=""text"" size=""10""  value="""
	Response.write H
	Response.write """ hidden/>" & vbcrlf & "  <input type=""submit"" name=""Submit422"" value=""检索""  class=""anybutton""/>" & vbcrlf & "  "
	If open_42_10=3 or open_42_10 = 1 Then
		Response.write "" & vbcrlf & "     <input type=""button"" name=""toExecel"" id=""toExecel"" value=""导出""  class=""anybutton"" style=""margin-left:0""/>" & vbcrlf & "  "
'If open_42_10=3 or open_42_10 = 1 Then
	end if
	Response.write "" & vbcrlf & "  <a href=""javascript:void(0)"" class=""AfterQuickSearch"" id=""advancedSearch""  style='display:inline-block;width:108px;*height:20px;*line-height:20px;*padding:0;padding-top:4px;margin:0;*margin-left:-5px' onclick=""callServer2();document.getElementById('zc').style.display='none';document.getElementById('ht1').style.display='block';return false;""><img src=""../images/icon_title.gif"" width=""6"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a>" & vbcrlf & "  </td>" & vbcrlf & "    </tr>           " & vbcrlf & "  </table> " & vbcrlf & "  <span id=""ht1"" style=""display:none;padding:20px""></span>" & vbcrlf & "  </form> " & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""margin-left:20px;"">    " & vbcrlf & "        <tr class=""top"">" & vbcrlf & "    <td align=""center"" ><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "     <td height=""26"" align=""center""><div align=""center"">售后编号</div></td>" & vbcrlf & "        <td height=""23""><div align=""center""><strong>售后主题</strong></div></td>" & vbcrlf & "    <td><div align=""center""><strong>关联客户</strong></div></td>" & vbcrlf & "   <td><div align=""center""><strong>售后日期</strong></div></td>" & vbcrlf & "      <td><div align=""center""><strong>紧急程度</strong></div></td>" & vbcrlf & "      <td><div align=""center""><strong>处理结果</strong></div></td>" & vbcrlf & "      <td><div align=""center""><strong>当前处理人</strong></div></td>" & vbcrlf & "          <td><div align=""center""><strong>接待人员</strong></div></td>" & vbcrlf & "      <td width=""21%""><div align=""center"" ><strong>操作</strong></div></td>" & vbcrlf & "     </tr>" & vbcrlf & ""
	dim n,toExecelIdStr
	dim fromContent,fromChance
	fromContent=trim(Request.QueryString("company"))
	if fromContent<>"" then
		fromContent=" and company=" & fromContent
	end if
	...
	if fromContract<>"" then
		fromContent=" and contract="&fromContract&""
	end if
	n=0
	toExecelIdStr=0
	set rs=server.CreateObject("adodb.recordset")
	If remind <> "" Then
		...
		h_listSql = Replace(helper.listSQL("ids"),"'","''")
	else
		h_listSql = ""
	end if
	Str_Result = Replace(Str_Result,"'","''")
	sqlcon = Replace(sqlcon,"'","''")
	fromContent = Replace(fromContent,"'","''")
	px_Result = Replace(px_Result,"'","''")
	sql = "exec [zbintel_service_list] "&session("personzbintel2007")&",'"&link&"','"&remind&"','"&h_listSql&"','"&Str_Result&"','"&sqlcon&"','"&fromContent&"','"&px_Result&"',"&page_count&","&currpage&",0"
	rs.open sql,conn,3,1
	Dim rCount,pIndex,maxPage,pSize
	rCount = rs(0)
	pIndex = rs(1)
	maxPage = rs(2)
	pSize = rs(3)
	...
	if rs.RecordCount<=0 then
		Response.write "<table><tr><td align='center' class='gray'>没有信息!</td></tr></table>"
	else
		Response.write "" & vbcrlf & "   <form name=""form1"" method=""post"" action=""deleteall.asp?"
		Response.write sdk.ReturnURL("")
		Response.write """>" & vbcrlf & ""
		do until rs.eof
			toExecelIdStr=toExecelIdStr&","&Rs("ord")
			dim k
			k=rs("title")
			cateid=rs("addcate")
			cateid_name=rs("cateidname")
			if  timelg<>"" and datediff("s",timelg,rs("date7"))>0 then
				k=k&new_list
			end if
			catelead = rs("catelead")
			if catelead <> "" and catelead > 0 then
				set rs0 = conn.execute("select name from gate WITH(NOLOCK) where ord = "&catelead&" ")
				if rs0.eof then
					curPerson=""
				else
					curPerson = rs0(0)
			...
			telOrd = rs("telOrd")
			telName = rs("telName")
			telCateid = rs("telCateid")
			telShare = rs("telShare")
			IsPrt = rs("IsPrt")
			Response.write "" & vbcrlf & "     <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td width=""6%"" align=""center"" class=""red"">"
			if open_42_3=3 or (open_42_3=1 and CheckPurview(intro_42_3,trim(cateid))=True) then
			...
			Response.write rs("shid")
			Response.write "</td>" & vbcrlf & "    <td width=""22%"" height=""27"" class=""name"">&nbsp;"
			if open_42_14=3 or (open_42_14=1 and CheckPurview(intro_42_14,trim(cateid))=True) then
				Response.write "<a href=""javascript:void(0)"" onclick=""javascript:window.open('content.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "','newwin','width=' + 1000 + ',height=' + 700 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"">"
				Response.write pwurl(rs("ord"))
			end if
			Response.write""&k&""
			Response.write "</a>"
			If IsPrt = "未打印" Then
				Response.write "<span class='red'>["& IsPrt &"]</span>"
			ElseIf IsPrt = "已打印" Then
				Response.write "<span style='color:#009933'>["& IsPrt &"]</span>"
			end if
			Response.write "</td>" & vbcrlf & "    <td width=""15%""><div align=""left"">" & vbcrlf & "    "
			If telName = "del" Then
				Response.write("<span class='red'>客户已被删除</span>")
			else
				If rs("sort3").value="2" Then
					If open_26_1=3 or (open_26_1=1 And CheckPurview(intro_26_1,trim(telCateid))=True) Then
						If open_26_14=3 or (open_26_14=1 and CheckPurview(intro_26_14,trim(telCateid))=True) Then
							Response.write "" & vbcrlf & "                                     <a href=""javascript:void(0)"" onClick=""javascript:window.open('../work2/content.asp?ord="
							Response.write pwurl(telOrd)
							Response.write "','newwin','width=' + 1100 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" onMouseOver=""window.status='none';return true;""  title=""点击可查看此客户详情"">"
							Response.write pwurl(telOrd)
							Response.write telName
							Response.write "</a>" & vbcrlf & "                         "
						else
							Response.write telName
						end if
					...
					If open_1_1=3 or (open_1_1=1 And CheckPurview(intro_1_1,trim(telCateid))=True) or InStr(1,","&telShare&",",","&session("personzbintel2007")&",",1) Then
						If open_1_14=3 or (open_1_14=1 and CheckPurview(intro_1_14,trim(telCateid))=True) Then
			...
			Response.write "    " & vbcrlf & "    </div></td>" & vbcrlf & "    <td width=""7%"" class=""name""><div align=""center"">"
			Response.write rs("date1")
			Response.write "</div></td>" & vbcrlf & ""
			great1=""
			if rs("great1")<>"" and not isnull(rs("great1")) then
				set rs7=conn.execute("select sort1 from sortonehy where ord="&rs("great1")&" ")
				if not rs7.eof then
					great1=rs7(0).value
				end if
				set rs7=nothing
			end if
			Response.write "" & vbcrlf & "    <td width=""8%"" class=""name""><div align=""center"">"
			Response.write great1
			Response.write "</div></td>" & vbcrlf & "    <td width=""7%"" class=""name"" ><div align=""center"">"
			if rs("result1")=0 then
				Response.write "处理中"
			elseif rs("result1")=1 then
				Response.write "处理完毕"
			end if
			Response.write "</div></td>" & vbcrlf & "    <td width=""7%"" class=""name""><div align=""center"">"
			Response.write curPerson
			Response.write "</div></td>" & vbcrlf & "    <td width=""6%"" class=""name""><div align=""center"">"
			Response.write cateid_name
			Response.write "</div></td> " & vbcrlf & " <td width=""10%"" class=""func""><div align=""center"">"
			if open_42_14=3 or (open_42_14=1 and CheckPurview(intro_42_14,trim(cateid))=True) then
			...
			if session("personzbintel2007")=rs("catelead") and rs("result1")=0 then
				Response.write "" & vbcrlf & "             <input type=""button"" name=""Submit3c"" value=""处理""  onClick=""javascript:window.open('chuli.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "','newwincor_"
				Response.write rs("ord")
				Response.write "','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/> "
				Response.write rs("ord")
			end if
			if open_42_2=3 or (open_42_2=1 and CheckPurview(intro_42_2,trim(cateid))=True) then
				Response.write "" & vbcrlf & "             <input type=""button"" name=""Submit3c"" value=""修改""  onClick=""javascript:window.open('add.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "&addtype=edit','newwincor','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>"
				Response.write pwurl(rs("ord"))
			end if
			if open_42_3=3 or (open_42_3=1 and CheckPurview(intro_42_3,trim(cateid))=True) then
				Response.write "" & vbcrlf & "    <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='Delete.asp?"
		...
		Loop
		Response.write "     " & vbcrlf & "          </table>" & vbcrlf & "  </td>" & vbcrlf & "  </tr>" & vbcrlf & "          <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""10%"" height=""30""><div align=""center"">全选" & vbcrlf & "       <input name=""chkall"" type=""checkbox"" id=""chkall"" value=""all"" onClick=""mm(this.form)"" />" & vbcrlf & "    </div></td>" & vbcrlf & "    <td>"
		if open_42_3=1 or open_42_3=3 then
			Response.write "<input class=""resetElementHidden"" type=image src=""../images/m_an_del.gif""   onClick=""return test();""  name=submit><input style=""display:none;"" class=""resetElementShow anybutton"" type=submit  value='批量删除' onClick=""return test();""  name=submit>"
		end if
		Response.write "</td>" & vbcrlf & "    <td width=""79%""><div align=""right"">" & vbcrlf & "    "
		Response.write rCount
		Response.write "个 | "
		Response.write pIndex
		Response.write "/"
		...
		if pIndex=1 then
			...
			Response.write pIndex-1
			Response.write "');"" class=""page""/>" & vbcrlf & "    "
		end if
		if pIndex=maxPage then
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <script src= ""../Script/se_event_1.js?ver="
		Response.write Application("sys.info.jsver")
		Response.write """  language=javascript></script>" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""38"" colspan=""3""><div align=""right"">" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</form>            " & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	action1="售后列表"
	call close_list(1)
	Response.write "  " & vbcrlf & "     <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "    <tr> " & vbcrlf & "      <td height=""10"" colspan=""2""><img src=""../image/pixel.gif"" width=""1"" height=""1""></td>" & vbcrlf & "    </tr> " & vbcrlf & "        <tr>" & vbcrlf & "      <td width=""16%"" height=""10""><div align=""right""></div></td>" & vbcrlf & "      <td width=""84%"">&nbsp;</td>" & vbcrlf & "    </tr>" & vbcrlf & "        <tr>" & vbcrlf & "      <td height=""10"" colspan=""2"">&nbsp;</td>" & vbcrlf & "    </tr>" & vbcrlf & "          <tr>" & vbcrlf & "      <td height=""10"" colspan=""2"">&nbsp;</td>" & vbcrlf & "     </tr>" & vbcrlf & "  </table>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<script src= ""../Script/se_event_2.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript""></script>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:100%; height:400;display:none;"">" & vbcrlf & "<table width=""150"" height=""300""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""139"">" & vbcrlf & "        <table width=""150"" height=""115"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=1');""><font color=""#2F496E"">按添加时间排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "                <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=2');""><font color=""#2F496E"">按添加时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=3');""><font color=""#2F496E"">按售后主题排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=4');""><font color=""#2F496E"">按售后主题排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=5');""><font color=""#2F496E"">按售后编号排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=6');""><font color=""#2F496E"">按售后编号排序(升)</font></a> </td>" & vbcrlf & "</tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=7');""><font color=""#2F496E"">按售后日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl&nbsp;<a href='###' onclick=""gotourl('px=9');""><font color=""#2F496E"">按接待人员排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=10');""><font color=""#2F496E"">按接待人员排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<form action=""../out/xlsService_old.asp?reSt="
	Response.write request.QueryString("H")
	Response.write "&"
	Response.write request.QueryString
	Response.write """ name=""toExecelForm"" id=""toExecelForm"" method=""post"">" & vbcrlf & "<input name=""toExecelId"" id=""toExecelId"" type=""hidden"" value="""
	Response.write toExecelIdStr
	Response.write """>" & vbcrlf & "</form>" & vbcrlf & "</div>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & "<script src= ""../Script/se_event_3.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript""></script>" & vbcrlf & ""
	function menuservice(id1)
		set rsarea=server.CreateObject("adodb.recordset")
		sqlarea="select id,id1 from sortonehy WITH(NOLOCK) where id1="&id1&" "
		rsarea.open sqlarea,conn,1,1
		if rsarea.eof then
			gateord22=id1
			If Len(Servicfl_list) = 0 Then
				Servicfl_list = "" & gateord22 & ""
			ElseIf InStr( Servicfl_list, gateord22 ) <= 0 Then
				Servicfl_list = Servicfl_list & ", " & gateord22 & ""
			end if
		else
			do until rsarea.eof
				gateord22=rsarea("id")
	...
	function menuservice1(id1)
		set rsarea=server.CreateObject("adodb.recordset")
		sqlarea="select id,id1 from sortonehy WITH(NOLOCK) where id="&id1&" and id1=0 "
		rsarea.open sqlarea,conn,1,1
		if rsarea.eof then
			gateord22=id1
			Servicfl_list = Servicfl_list & ", " & gateord22 & ""
