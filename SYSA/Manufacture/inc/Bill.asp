...
'Dim mhtml
				...
				Elseif PageType = "script" Then
					...
					"<td style='float:left;'>共<b style='color:red' id='lvw_RowCount_B" & id & "'>" & recordcount & "</b>行记录&nbsp;&nbsp;每页:</td>"
					AddHtml htmls, "</tr></table>" &_
					app.iif (treemode and  i = 1 ,"<td style='float:left;'><select style='font-size:12px;height:16px;line-height:16px;' onchange='lvw.JsPageSizeChange(this)'> " & pSizeOpt & "      </select></td>", "") &_
					"<td style='font-family:arial;float:left;'>行&nbsp;</td>" &_
					"</tr> " &_
					"</table>"
				end if
			...
			AddHtml htmls, ("<input type='hidden' id='ctl_listview_spd_" & id & "' value=""" & replace(Replace(Replace(hData,"<","$＜"),">","$＞"),"""","&quot;") & """/></div></div>" )
