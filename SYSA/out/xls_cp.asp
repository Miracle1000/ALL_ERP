...
'sqltext = sqltext & " select " & ProductAttrValue & " as Num1 ,'" & attrs & AttrID &"' as Attrs "
		...
		Dim Str_Result ,canShowBuyPrice, canShowSalePrice , showPrice_Intro ,canShowPrice
		Sub page_load
			Set conn = cn
			Dim open_21_10,intro_21_10
			Dim list
			Call fillPowerInfo(21,10,open_21_10,intro_21_10)
			if open_21_10=3 then
				list=""
			elseif open_21_10=1 then
				list=" and p.addcate in ("&intro_21_10&") "
			else
				list=" and p.addcate=0 "
			end if
			Str_Result="where p.del=1 "&list&" "
			Dim W1,W2,W3,B,C,D,E1,E2,F,H,H1,H2,A1,A2,Z1,Z2,A3,m1,m2,F1,F2,G1,G2,P1,P2,I1,I2,J1,J2,K1,K2,T1,T2,U1,U2
			Dim zdy1_1,zdy1_2,zdy2_1,zdy2_2,zdy3_1,zdy3_2,zdy4_1,zdy4_2,zdy5,zdy6,ksjs,ksjs2,qc_id
			W1=request("W1")
			W2=request("W2")
			W3=request("W3")
			B=request("B")
			...
			if ksjs<>"" then
				if ksjs="cpmc" then
					F1=1
					F2=ksjs2
				elseif ksjs="cpbh" then
					G1=1
					G2=ksjs2
				elseif ksjs="cpxh" then
					P1=1
					P2=ksjs2
				elseif ksjs="cpsm" then
					T1=1
					T2=ksjs2
				elseif ksjs="cpcs" then
					U1=1
					U2=ksjs2
				elseif ksjs="cpbz" then
					E1=1
					E2=ksjs2
				elseif ksjs="txm" then
					H1=1
					H2=ksjs2
				elseif ksjs="cpbh" then
					G1=1
			...
			Dim area_list,rsmenu,parentid
			area_list=-1
'Dim area_list,rsmenu,parentid
			if A2<>"" Then
				area_list=menuarea2(Replace(A2," ",""),"menu")
				If Len(area_list) = 0 Then
					area_list = A2
				end if
				If area_list<>"" Then
					if Str_Result="" then
						Str_Result="where p.sort1 in ("&area_list&")"
					else
						Str_Result=Str_Result+"and  p.sort1 in ("&area_list&")"
						Str_Result="where p.sort1 in ("&area_list&")"
					end if
				end if
			end if
			if m1<>"" Then Str_Result=Str_Result+"and  p.date7>='"&m1&"'"
			Str_Result="where p.sort1 in ("&area_list&")"
			if m2<>"" Then Str_Result=Str_Result+"and  p.date7<='"&cdate(m2)+1&"'"
			Str_Result="where p.sort1 in ("&area_list&")"
			if zdy5<>"" Then Str_Result=Str_Result+"and  p.zdy5 in  ("&zdy5&")"
			Str_Result="where p.sort1 in ("&area_list&")"
			if zdy6<>"" Then Str_Result=Str_Result+"and  p.zdy6 in  ("&zdy6&")"
			Str_Result="where p.sort1 in ("&area_list&")"
			if F2<>"" then
				if F1=1 then
					str_Result=str_Result+"and p.title like '%"& F2 &"%'"
'if F1=1 then
				elseif F1=2 then
					str_Result=str_Result+"and p.title not like '%"& F2 &"%'"
'elseif F1=2 then
				elseif F1=3 then
					str_Result=str_Result+"and p.title='"&F2&"'"
'elseif F1=3 then
				elseif F1=4 then
					str_Result=str_Result+"and p.title<>'"&F2&"'"
'elseif F1=4 then
...
'elseif F1=6 then
			...
			if Z2<>"" then
				if Z1=1 then
					str_Result=str_Result+"and p.pym like '%"& Z2 &"%'"
'if Z1=1 then
				elseif Z1=2 then
					str_Result=str_Result+"and p.pym not like '%"& Z2 &"%'"
'elseif Z1=2 then
				elseif Z1=3 then
					str_Result=str_Result+"and p.pym='"&Z2&"'"
'elseif Z1=3 then
				elseif Z1=4 then
					str_Result=str_Result+"and p.pym<>'"&Z2&"'"
'elseif Z1=4 then
...
'elseif Z1=6 then
			...
			if G2<>"" then
				if G1=1 then
					str_Result=str_Result+"and p.order1 like '%"& G2 &"%'"
'if G1=1 then
				elseif G1=2 then
					str_Result=str_Result+"and p.order1 not like '%"& G2 &"%'"
'elseif G1=2 then
				elseif G1=3 then
					str_Result=str_Result+"and p.order1='"& G2 &"'"
'elseif G1=3 then
				elseif G1=4 then
					str_Result=str_Result+"and p.order1<>'"& G2 &"'"
'elseif G1=4 then
...
'elseif G1=6 then
			...
			if P2<>"" then
				if P1=1 then
					str_Result=str_Result+"and p.type1 like '%"& P2 &"%'"
'if P1=1 then
				elseif P1=2 then
					str_Result=str_Result+"and p.type1 not like '%"& P2 &"%'"
'elseif P1=2 then
				elseif P1=3 then
					str_Result=str_Result+"and p.type1='"& P2 &"'"
'elseif P1=3 then
				elseif P1=4 then
					str_Result=str_Result+"and p.type1<>'"& P2 &"'"
'elseif P1=4 then
...
'elseif P1=6 then
			...
			if I2<>"" then
				if I1=1 then
					str_Result=str_Result+"and p.aleat1>"&I2&""
'if I1=1 then
				elseif I1=2 then
					str_Result=str_Result+"and p.aleat1>="&I2&""
'elseif I1=2 then
...
'elseif I1=5 then
			...
			if J2<>"" then
				if J1=1 then
					str_Result=str_Result+"and p.aleat2>"&J2&""
'if J1=1 then
				elseif J1=2 then
					str_Result=str_Result+"and p.aleat2>="&J2&""
'elseif J1=2 then
...
'elseif J1=5 then
			...
			if T2<>"" then
				if T1=1 then
					str_Result=str_Result+"and p.intro1 like '%"& T2 &"%'"
'if T1=1 then
				elseif T1=2 then
					str_Result=str_Result+"and p.intro1 not like '%"& T2 &"%'"
'elseif T1=2 then
				elseif T1=3 then
					str_Result=str_Result+"and cast(p.intro1 as nvarchar(4000))='"& T2 &"'"
'elseif T1=3 then
				elseif T1=4 then
					str_Result=str_Result+"and cast(p.intro1 as nvarchar(4000))<>'"& T2 &"'"
'elseif T1=4 then
...
'elseif T1=6 then
			...
			if U2<>"" then
				if U1=1 then
					str_Result=str_Result+"and p.intro2 like '%"& U2 &"%'"
'if U1=1 then
				elseif U1=2 then
					str_Result=str_Result+"and p.intro2 not like '%"& U2 &"%'"
'elseif U1=2 then
				elseif U1=3 then
					str_Result=str_Result+"and cast(p.intro2 as nvarchar(4000))='"& U2 &"'"
'elseif U1=3 then
				elseif U1=4 then
					str_Result=str_Result+"and cast(p.intro2 as nvarchar(4000))<>'"& U2 &"'"
'elseif U1=4 then
...
'elseif U1=6 then
			...
			if E2<>"" then
				if E1=1 then
					str_Result=str_Result+"and p.intro3 like '%"& E2 &"%'"
'if E1=1 then
				elseif E1=2 then
					str_Result=str_Result+"and p.intro3 not like '%"& E2 &"%'"
'elseif E1=2 then
				elseif E1=3 then
					str_Result=str_Result+"and cast(p.intro3 as nvarchar(4000))='"& E2 &"'"
'elseif E1=3 then
				elseif E1=4 then
					str_Result=str_Result+"and cast(p.intro3 as nvarchar(4000))<>'"& E2 &"'"
'elseif E1=4 then
...
'elseif E1=6 then
			...
			if zdy1_2<>"" then
				if zdy1_1=1 then
					str_Result=str_Result+"and p.zdy1 like '%"& zdy1_2 &"%'"
'if zdy1_1=1 then
				elseif zdy1_1=2 then
					str_Result=str_Result+"and p.zdy1 not like '%"& zdy1_2 &"%'"
'elseif zdy1_1=2 then
				elseif zdy1_1=3 then
					str_Result=str_Result+"and p.zdy1='"& zdy1_2 &"'"
'elseif zdy1_1=3 then
...
'elseif zdy1_1=6 then
			...
			if zdy2_2<>"" then
				if zdy2_1=1 then
					str_Result=str_Result+"and p.zdy2 like '%"& zdy2_2 &"%'"
'if zdy2_1=1 then
				elseif zdy2_1=2 then
					str_Result=str_Result+"and p.zdy2 not like '%"& zdy2_2 &"%'"
'elseif zdy2_1=2 then
				elseif zdy2_1=3 then
					str_Result=str_Result+"and p.zdy2='"& zdy2_2 &"'"
'elseif zdy2_1=3 then
...
'elseif zdy2_1=6 then
			...
			if zdy3_2<>"" then
				if zdy3_1=1 then
					str_Result=str_Result+"and p.zdy3 like '%"& zdy3_2 &"%'"
'if zdy3_1=1 then
				elseif zdy3_1=2 then
					str_Result=str_Result+"and p.zdy3 not like '%"& zdy3_2 &"%'"
''elseif zdy3_1=2 then
				elseif zdy3_1=3 then
					str_Result=str_Result+"and p.zdy3='"& zdy3_2 &"'"
'elseif zdy3_1=3 then
...
'elseif zdy3_1=6 then
			...
			if zdy4_2<>"" then
				if zdy4_1=1 then
					str_Result=str_Result+"and p.zdy4 like '%"& zdy4_2 &"%'"
'if zdy4_1=1 then
				elseif zdy4_1=2 then
					str_Result=str_Result+"and p.zdy4 not like '%"& zdy4_2 &"%'"
'elseif zdy4_1=2 then
				elseif zdy4_1=3 then
					str_Result=str_Result+"and p.zdy4='"& zdy4_2 &"'"
'elseif zdy4_1=3 then
...
'elseif zdy4_1=6 then
			...
			if H2<>"" then
				if H1=1 then
					str_Result=str_Result+" and p.ord in (select product from jiage where txm like '%"& H2 &"%' )"
'if H1=1 then
				end if
			end if
			if ZBRuntime.MC(15000) And ZBRuntime.MC(215102) Then
				If Len(qc_id)&"" > 0 and qc_id<>"0" Then
					str_Result=str_Result+"and isnull(qc_id,0) in ("& qc_id &")"
'If Len(qc_id)&"" > 0 and qc_id<>"0" Then
				ElseIf qc_id="0" then
					str_Result=str_Result+"and isnull(qc_id,0) in ("& qc_id &")"
'ElseIf qc_id="0" then
			...
			Call searchExtended(21,"p.ord")
			Dim W4
			W4=replace(W3,"0","")
			W4=replace(W4,",","")
			if W4<>"" then    str_Result=str_Result+"and p.addcate in  ("&W3&")"
			W4=replace(W4,",","")
			Dim pricemode : pricemode = request("pricemode")
			If len(pricemode)>0 Then str_Result=str_Result+" and charindex(','+cast(isnull(p.priceMode,0) as varchar(10))+',',',"& Replace(pricemode," ","") &",')>0 "
'Dim pricemode : pricemode = request("pricemode")
			Dim px,px_Result
			px=request.QueryString("px")
			if px="" Then px=1
			if px=1 then
				px_Result=" order by p.date7 desc,p.ord desc"
			elseif px=2 then
				px_Result=" order by p.date7 asc,p.ord desc"
			elseif px=3 then
				px_Result=" order by p.title desc,p.ord desc"
			elseif px=4 then
				px_Result=" order by p.title asc,p.ord desc"
			elseif px=5 then
				px_Result=" order by p.order1 desc,p.ord desc"
			elseif px=6 then
				px_Result=" order by p.order1 asc,p.ord desc"
			elseif px=7 then
				px_Result=" order by p.type1 desc,p.ord desc"
			elseif px=8 then
				px_Result=" order by p.type1 asc,p.ord desc"
			elseif px=9 then
				px_Result=" order by p.aleat1 desc,p.ord desc"
			elseif px=10 then
				px_Result=" order by p.aleat1 asc,p.ord desc"
			elseif px=11 then
				px_Result=" order by p.aleat2 desc,p.ord desc"
			elseif px=12 then
				px_Result=" order by p.aleat2 asc,p.ord desc"
			else
				px_Result=" order by p.date7 desc,p.ord desc"
			end if
			Dim baseSql
			...
			cfidx=0
			fields = "产品名称,产品编号,产品型号,产品分类"
			dim CaigourkclShow
			CaigourkclShow = ZBRuntime.MC(15000) and ZBRuntime.MC(17002)
			If CaigourkclShow = False Then
				CantExport_Fields(cfidx) = "采购入库超量上限" : cfidx=cfidx+1
'If CaigourkclShow = False Then
			end if
			if  ZBRuntime.MC(15000) = false then
				CantExport_Fields(cfidx) = "预计销售周期" : cfidx=cfidx+1
'if  ZBRuntime.MC(15000) = false then
			end if
			dim phXlhManageShow
			phXlhManageShow = ZBRuntime.MC(34000) and ZBRuntime.MC(17002)
			If phXlhManageShow = False Then
				CantExport_Fields(cfidx) = "批号必填" : cfidx=cfidx+1
'If phXlhManageShow = False Then
				CantExport_Fields(cfidx) = "产品有效期" : cfidx=cfidx+1
'If phXlhManageShow = False Then
				CantExport_Fields(cfidx) = "有效期单位" : cfidx=cfidx+1
'If phXlhManageShow = False Then
			end if
			If ZBRuntime.MC(17000)=False  Then
				CantExport_Fields(cfidx) = "损耗率" : cfidx=cfidx+1
'If ZBRuntime.MC(17000)=False  Then  '
				CantExport_Fields(cfidx) = "安全库存" : cfidx=cfidx+1
'If ZBRuntime.MC(17000)=False  Then  '
			end if
			If ZBRuntime.MC(18400)=False  Then
				CantExport_Fields(cfidx) = "固定制造提前期" : cfidx=cfidx+1
'If ZBRuntime.MC(18400)=False  Then  '
				CantExport_Fields(cfidx) = "变动制造提前期" : cfidx=cfidx+1
'If ZBRuntime.MC(18400)=False  Then  '
				CantExport_Fields(cfidx) = "变动制造提前期批量" : cfidx=cfidx+1
'If ZBRuntime.MC(18400)=False  Then  '
			end if
			If ZBRuntime.MC(15000) =False Then
				CantExport_Fields(cfidx) = "采购提前期" : cfidx=cfidx+1
'If ZBRuntime.MC(15000) =False Then  '
			end if
			If not (ZBRuntime.MC(1002) or ZBRuntime.MC(17000) or ZBRuntime.MC(18000)) Then
				CantExport_Fields(cfidx) = "库存上限" : cfidx=cfidx+1
'If not (ZBRuntime.MC(1002) or ZBRuntime.MC(17000) or ZBRuntime.MC(18000)) Then  '
				CantExport_Fields(cfidx) = "库存下限" : cfidx=cfidx+1
'If not (ZBRuntime.MC(1002) or ZBRuntime.MC(17000) or ZBRuntime.MC(18000)) Then  '
				CantExport_Fields(cfidx) = "生产周期" : cfidx=cfidx+1
'If not (ZBRuntime.MC(1002) or ZBRuntime.MC(17000) or ZBRuntime.MC(18000)) Then  '
				CantExport_Fields(cfidx) = "主供应商" : cfidx=cfidx+1
'If not (ZBRuntime.MC(1002) or ZBRuntime.MC(17000) or ZBRuntime.MC(18000)) Then  '
			end if
			If ZBRuntime.MC(17003) = False Then
				CantExport_Fields(cfidx) = "产品属性" : cfidx=cfidx+1
'If ZBRuntime.MC(17003) = False Then '
				CantExport_Fields(cfidx) = "产品角色" : cfidx=cfidx+1
'If ZBRuntime.MC(17003) = False Then '
			end if
			If ZBRuntime.MC(17001) = False Or ZBRuntime.MC(17003) = False Then
				CantExport_Fields(cfidx) = "计价方式" : cfidx=cfidx+1
'If ZBRuntime.MC(17001) = False Or ZBRuntime.MC(17003) = False Then '
			end if
			If ZBRuntime.MC(17009) = False Then
				CantExport_Fields(cfidx) = "养护周期" : cfidx=cfidx+1
'If ZBRuntime.MC(17009) = False Then '
				CantExport_Fields(cfidx) = "周期单位" : cfidx=cfidx+1
'If ZBRuntime.MC(17009) = False Then '
				CantExport_Fields(cfidx) = "失效提前期" : cfidx=cfidx+1
'If ZBRuntime.MC(17009) = False Then '
				CantExport_Fields(cfidx) = "提前期单位" : cfidx=cfidx+1
'If ZBRuntime.MC(17009) = False Then '
			end if
			if ZBRuntime.MC(15000) = False And ZBRuntime.MC(215102) = False Then
				CantExport_Fields(cfidx) = "质检方案" : cfidx=cfidx+1
'if ZBRuntime.MC(15000) = False And ZBRuntime.MC(215102) = False Then  '
			end if
			CantExport_Fields(cfidx) = "单位ID" : cfidx=cfidx+1
'if ZBRuntime.MC(15000) = False And ZBRuntime.MC(215102) = False Then  '
			CantExport_Fields(cfidx) = "部门ID" : cfidx=cfidx+1
'if ZBRuntime.MC(15000) = False And ZBRuntime.MC(215102) = False Then  '
			Dim rs,zdyFields(),j
			ReDim zdyFields(1,0)
			sql="select id,title,name,set_open,dc from zdy where sort1=21 order by gate1 asc "
			Set rs=conn.execute(sql)
			do while not rs.eof
...
'If rs("set_open") <> 1 Or rs("dc") <> 1 Then
			loop
			rs.close
			Dim exZdyFields(),exJoinTables,exZdyField,exZdyNullField, CGMainUnitTactics,UnitAttributeTactics
			...
			UnitAttributeTactics = sdk.getSqlValue("select isnull(nvalue,0) nvalue from home_usConfig where name='UnitAttributeTactics' and isnull(uid,0)=0" , 0)
			ReDim exZdyFields(1,0)
			Dim hasExZdyFields : hasExZdyFields = False
			j = 0
			sql="select ID,FName from ERP_CustomFields where isUsing=1 and canexport=1 and tname=21 and del=1 order by id"
			exJoinTables = "":exZdyField="":exZdyNullField=""
			set rs=cn.execute(sql)
			While rs.eof = False
				hasExZdyFields = True
				...
				exZdyField = exZdyField & "extb"&j&".FValue " & exZdyFields(0,j) & ","
				exZdyNullField = exZdyNullField & "null,"
				exJoinTables = exJoinTables & vbcrlf & " left join ERP_CustomValues extb"&j&" on extb"&j&".OrderID=p.ord and extb"&j&".FieldsID=" & rs(0)
				rs.movenext
				j = j + 1
			wend
			rs.close
			Set rs=Nothing
			dim dbname
			sql = "select a.dbname,s.inx-1 inx "&_
			"from sys_sdk_BillFieldInfo a "&_
			"left join (select ROW_NUMBER() over (order by id) inx,   ID from ERP_CustomFields where isUsing=1 and canexport=1 and tname=21 and del=1 ) s on 'ext'+cast(s.id as varchar(20))  = a.dbname "&_
			" from sys_sdk_BillFieldInfo a "&_
			" where a.billtype=16001 and a.ListType='0' and a.isused=1 and a.candc=1 order by a.Showindex "
			set rs=cn.execute(sql)
			While rs.eof = False
				dbname = rs("dbname").value
				if instr(dbname,"zdy")>0 then
					if not instr(","+fields+",",","&dbname&",")>0 then
'if instr(dbname,"zdy")>0 then
						fields = fields & "," & dbname
					end if
				else
					if not instr(","+fields+",",",exzdy" & rs("inx").value&",")>0 then
						fields = fields & "," & dbname
						fields = fields & "," & "exzdy" & rs("inx").value
					end if
				end if
				rs.movenext
			wend
			rs.close
			Set rs=Nothing
			fields = fields &",产品说明,产品参数,图片与附件,产品属性,产品角色,主供应商,采购提前期,质检方案,采购入库超量上限,预计销售周期,库存下限,库存上限,生产周期,安全库存,计价方式,"&_
			"批号必填,产品有效期,有效期单位,失效提前期,提前期单位,养护周期,周期单位,固定制造提前期,变动制造提前期,变动制造提前期批量,损耗率,是否含税,可开具票据类型," &_
			"提成比例,基本单位,包含单位"
			canShowPrice = app.power.existsPower(21,18)
			showPrice_Intro = app.power.getPowerIntro(21,18)
			canShowSalePrice = app.power.existsPower(21,22)
			canShowBuyPrice = app.power.existsPower(21,21)
			fields = fields & ",单位,比例"& app.iif(UnitAttributeTactics&"" = "1",",分组属性,属性项","")& app.iif(CGMainUnitTactics&"" = "1",",采购主单位","") & app.iif(phXlhManageShow,",序列号管理","") &",部门,条形码"
			If canShowPrice Then
				If canShowBuyPrice Then fields = fields & ",建议进价,最高进价"
				If canShowSalePrice Then fields = fields & ",建议售价,最低售价"
			end if
			Dim fenleiFields(),fenleiInitFlag,fenleiField,fenleiNullField
			fenleiField="":fenleiNullField=""
			sql="select (b.sort1+'->'+a.sort2),a.id from sort5 a inner join sort4 b on a.sort1=b.ord where a.time1=1 order by a.sort1 asc,a.gate2 desc"
			fenleiField="":fenleiNullField=""
			Set rs=conn.execute(sql)
			j = 0
			fenleiInitFlag=(rs.eof = False) And canShowSalePrice And canShowPrice
			If fenleiInitFlag Then
				While rs.eof = False
					ReDim Preserve fenleiFields(1,j)
					fenleiFields(0,j) = "stPrice" & j
					fenleiFields(1,j) = rs(0)
					fenleiField = fenleiField & "max(case j.sort when " & rs(1) & " then j.price3 else 0 end) as " & fenleiFields(0,j) & ","
					fenleiNullField = fenleiNullField & " null as "&fenleiFields(0,j)&","
					fields = fields & "," & fenleiFields(0,j)
					rs.movenext
					j = j + 1
					fields = fields & "," & fenleiFields(0,j)
				wend
			...
			rs.close
			Set rs=Nothing
			fields = fields & ",cateid,ord,unitjb,单位ID,部门ID"
			baseSql = " exec erp_xls_cp '"& replace(Str_Result,"'","''") &"','"& replace(px_Result,"'","''") &"','"& replace(exZdyField,"'","''") &"','"& replace(exZdyNullField,"'","''") &"','"& replace(exJoinTables,"'","''") &"','"& replace(fenleiField,"'","''") &"','"& replace(fenleiNullField,"'","''") '&"','"& replace(fields,
			Dim adapter
			Dim sqls,sheetSetting
			Set adapter = New ExcelExportAdapter
			adapter.fileName = "产品资料"
			...
			For i = 0 To ubound(fds)
				...
				hd.excelAlign = "right"
				hd.canSum = False
				hd.formula = "showprice(@value,rs(""cateid"") ,1)"
				hd.ignoreNonnumeric = True
				Case "建议售价","最低售价":
				...
				hd.excelAlign = "right"
				hd.canSum = False
				hd.formula = "showprice(@value,rs(""cateid"") ,2)"
				hd.ignoreNonnumeric = True
				Case "分组属性":
				hd.width = 80
				hd.Formula = " LoadUnitAttrHtml(""readonly"" , 0,rs(""ord"") ,0, rs(""单位ID""))"
				Case "属性项":
				hd.width = EX_WIDTH_TEXT
				hd.Formula = "LoadFormulaParameter(""readonly"" , 0,rs(""ord"") , rs(""单位ID"") ,"&app.info.FloatNumber&" )"
				Case "比例","库存上限","库存下限","损耗率","安全库存","变动制造提前期批量","采购入库超量上限","养护周期","产品有效期","失效提前期","预计销售周期":
				hd.dbtype = "number"
				If sname = "损耗率" Then hd.title = "损耗率(%)"
				If sname = "采购入库超量上限" Then hd.title = "采购入库超量上限(%)"
				hd.width = EX_WIDTH_DIGIT
				hd.canSum = False
				hd.excelAlign = "right"
				hd.ignoreNonnumeric = True
				Case "产品名称","产品编号","产品型号","包含单位","可开具票据类型","条形码","主供应商":
				hd.width = EX_WIDTH_TEXT
				If sname = "包含单位" Then
					hd.Formula = "FormatUnit(@value)"
				ElseIf sname = "可开具票据类型" Then
					hd.Formula = "FormatInvoiceType(@value)"
				end if
				hd.canSum = False
				Case "基本单位","单位","部门","产品属性","是否含税","质检方案","采购主单位","批号必填","有效期单位","序列号管理","周期单位","提前期单位","采购提前期":
				hd.width = 80
				Case "固定制造提前期","变动制造提前期":
				If sname = "固定制造提前期" Then hd.title = "固定制造提前期(天)"
				If sname = "变动制造提前期" Then hd.title = "变动制造提前期(天)"
				hd.width = 120
				Case "产品说明","产品参数","图片与附件":
				hd.width = EX_WIDTH_MULTILINE
				hd.Formula = "noHTML(rs("""&sname&"""))"
				Case Else :
				If InStr(sname,"stPrice")=1 Then
					hd.dbtype = "salesprice"
					hd.width = EX_WIDTH_DIGIT
					hd.excelAlign = "right"
					hd.canSum = False
			...
			For i=0 To ubound(zdyFields,2)
				...
				If zdyFields(1,i) & "" <> "" Then
					...
					hd.title = "未命名" & noNameIdx : noNameIdx = noNameIdx + 1
					hd.title = zdyFields(1,i)
				end if
				sheetSetting.headerSettings.add(hd)
			next
			If hasExZdyFields Then
			...
			If fenleiInitFlag Then
				For i=0 To ubound(fenleiFields,2)
					Set hd = New HeaderColumnSetting
					hd.dbname = fenleiFields(0,i)
					If fenleiFields(1,i) & "" <> "" Then
						hd.title = fenleiFields(1,i)
					else
						hd.title = "未命名" & noNameIdx : noNameIdx = noNameIdx + 1
						hd.title = fenleiFields(1,i)
					end if
					hd.formula = "showprice(@value,rs(""cateid"") ,3)"
					sheetSetting.headerSettings.add(hd)
				next
			end if
			Set hd = New HeaderColumnSetting
		...
		Function showprice(v , cateid , stype)
			Dim s : s= ""
			If stype = 1 Then
				If canShowBuyPrice And canShowPrice Then
					If Len(showPrice_Intro)=0 Or InStr(","& showPrice_Intro &",",","& cateid &",")>0 Then s = v
				end if
			ElseIf stype = 2 Then
				If canShowSalePrice And canShowPrice Then
					If Len(showPrice_Intro)=0 Or InStr(","& showPrice_Intro &",",","& cateid &",")>0 Then s = v
				end if
			else
				If Len(showPrice_Intro)=0 Or InStr(","& showPrice_Intro &",",","& cateid &",")>0 Then s = v
		...
		Function canSplit(rs)
			canSplit = instr(rs("产品名称")&"","【价格策略】")<=0
		end function
		Function FormatUnit(v)
			Dim rs,sth:sth=""
			If Len(v&"")>0 then
				Set rs = conn.execute("select stuff((select ',' + sort1 from sortonehy where gate2=61 and del=1 and isnull(isStop,0) = 0 and CHARINDEX(','+CAST(ord as varchar(10))+',',',"&v&",')>0 for xml path('')),1,1,'') as sort1")
'If Len(v&"")>0 then
				If Not rs.eof then
					sth = rs(0)
				end if
		...
		Function FormatInvoiceType(v)
			Dim rs,sth:sth=""
			If Len(v&"")>0 then
				Set rs = conn.execute("select stuff((select ',' + sort1 from sortonehy where gate2 = 34 and isnull(isStop,0) = 0 and CHARINDEX(','+CAST(ord as varchar(10))+',',',"&v&",')>0 for xml path('')),1,1,'') as sort1")
'If Len(v&"")>0 then
				If Not rs.eof then
					sth = rs(0)
				end if
		...
		Function getUnitAttrHtml(ord,unitjb)
			result = LoadUnitAttrHtml("readonly" , 0,ord ,0, unitjb)
			getUnitAttrHtml=result
		end function
