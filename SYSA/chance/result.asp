...
'Private Sub Class_Initialize
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=3 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_3_2=0
		intro_3_2=0
	else
		open_3_2=rs1("qx_open")
		intro_3_2=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=3 and sort2=3"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_3_3=0
		intro_3_3=0
	else
		open_3_3=rs1("qx_open")
		intro_3_3=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=3 and sort2=4"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_3_4=0
		intro_3_4=0
	else
		open_3_4=rs1("qx_open")
		intro_3_4=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=3 and sort2=5"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_3_5=0
		intro_3_5=0
	else
		open_3_5=rs1("qx_open")
		intro_3_5=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=3 and sort2=6"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_3_6=0
		intro_3_6=0
	else
		open_3_6=rs1("qx_open")
		intro_3_6=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=3 and sort2=7"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_3_7=0
		intro_3_7=0
	else
		open_3_7=rs1("qx_open")
		intro_3_7=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=3 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_3_8=0
		intro_3_8=0
	else
		open_3_8=rs1("qx_open")
		intro_3_8=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=3 and sort2=10"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_3_10=0
		intro_3_10=0
	else
		open_3_10=rs1("qx_open")
		intro_3_10=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=4 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_4_13=0
		intro_4_13=0
	else
		open_4_13=rs1("qx_open")
		intro_4_13=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=3 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_3_16=0
		intro_3_16=0
	else
		open_3_16=rs1("qx_open")
		intro_3_16=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	if open_3_1=3 then
		list1=""
	elseif open_3_1=1 then
		list1="and cateid in ("&intro_3_1&")"
	else
		list1="and cateid=0"
	end if
	spinfo=request("spinfo")
	IF spinfo = "3" Then
		dbt=" and sp=0"
	end if
	If request("spState") = "" or request("spState") = "0" then
		Str_Result="where ((del=1 "&list1&dbt&")  or  ((','+replace(isnull(share,'0'),' ','')+',' like '%,"&session("personzbintel2007")&",%' or share='1') and del=1))"
'If request("spState") = "" or request("spState") = "0" then
		Str_Result2="where ((del=1 "&list1&dbt&")  or  ((','+replace(isnull(share,'0'),' ','')+',' like '%,"&session("personzbintel2007")&",%' or share='1') and del=1))"
'If request("spState") = "" or request("spState") = "0" then
		If request("khid")&""<>"" Then
			Str_Result="where ((del<>2 "&list1&dbt&")  or  ((','+replace(isnull(share,'0'),' ','')+',' like '%,"&session("personzbintel2007")&",%' or share='1') and del<>2 ))"
'If request("khid")&""<>"" Then
			Str_Result2="where ((del<>2 "&list1&dbt&")  or  ((','+replace(isnull(share,'0'),' ','')+',' like '%,"&session("personzbintel2007")&",%' or share='1') and del<>2 ))"
'If request("khid")&""<>"" Then
		end if
	else
		If  request("spState") = "1" then
			IF spinfo = "2" Then
				dbt="1=1 "&list1&" and sp>0 and cateid_sp>0 and del=3"
			else
				dbt="del=3 "&list1&" and sp>0"
			end if
			If request("remind") <> "" Then
				Set helper = CreateReminderHelper(conn,64,0)
				dbt = dbt& " and a.ord in (" & helper.listSQL("ids") & ")"
			end if
			Str_Result="where (("&dbt&")  or  ((','+replace(isnull(share,'0'),' ','')+',' like '%,"&session("personzbintel2007")&",%' or share='1') and del=3 and sp>0))"
			'dbt = dbt& " and a.ord in (" & helper.listSQL("ids") & ")"
			Str_Result2="where (("&dbt&")  or  ((','+replace(isnull(share,'0'),' ','')+',' like '%,"&session("personzbintel2007")&",%' or share='1') and del=3 and sp>0))"
			'dbt = dbt& " and a.ord in (" & helper.listSQL("ids") & ")"
		ElseIf  request("spState") = "2" then
			Str_Result="where ((del=3 "&list1&" and sp=-1)  or  ((','+replace(isnull(share,'0'),' ','')+',' like '%,"&session("personzbintel2007")&",%' or share='1') and del=3 and sp=-1))"
'ElseIf  request("spState") = "2" then
			Str_Result2="where ((del=3 "&list1&" and sp=-1)  or  ((','+replace(isnull(share,'0'),' ','')+',' like '%,"&session("personzbintel2007")&",%' or share='1') and del=3 and sp=-1))"
'ElseIf  request("spState") = "2" then
		else
			Str_Result="where ((del=3 "&list1&")  or  ((','+replace(isnull(share,'0'),' ','')+',' like '%,"&session("personzbintel2007")&",%' or share='1') and del=3))"
'ElseIf  request("spState") = "2" then
			Str_Result2="where ((del=3 "&list1&")  or  ((','+replace(isnull(share,'0'),' ','')+',' like '%,"&session("personzbintel2007")&",%' or share='1') and del=3))"
'ElseIf  request("spState") = "2" then
		end if
	end if
...
'If sdk.power.existsPowerIntro(5029,14, designer) Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<!--[if IE 6]>  " & vbcrlf & "<style>" & vbcrlf & "html{_background-image:url(about:blank);_background-attachment:fixed;}" & vbcrlf & "</style>" & vbcrlf & "<![endif]-->" & vbcrlf & "<style>" & vbcrlf & "    /*自定义固定行标题*/ " & vbcrlf & "   /*#content tr.tophead {background-color:#C0CCDD;}*/" & vbcrlf & " .zdy{" & vbcrlf & "           position:relative;" & vbcrlf & "        *position:static;" & vbcrlf & "             top: expression(this.offsetParent.scrollTop); " & vbcrlf & "        *top:0;" & vbcrlf & "           border-bottom: 0px solid #C0CCDD;" & vbcrlf & "               background-color:#C0CCDD;   " & vbcrlf & "        }" & vbcrlf & "       .zdy1{" & vbcrlf & "          position:relative;" & vbcrlf & "              top: expression(this.offsetParent.scrollTop); " & vbcrlf & "         *position:static;" & vbcrlf & "         *top:0;" & vbcrlf & "        }" & vbcrlf & "       tr.tophead {left:0px;}" & vbcrlf & "  tr.topheadtd {" & vbcrlf & "                border-right:0px solid #C0CCDD;" & vbcrlf & "         border-bottom:0px solid #C0CCDD;" & vbcrlf & "                border-top:0px solid #C0CCDD;" & vbcrlf & "           padding:0px;" & vbcrlf & "    }" & vbcrlf & "       table.xiang td {background-color:transparent;color:#5b7cae;}" & vbcrlf & "</style>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"" src=""cp_ajax.js?ver="
	'Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "</head>" & vbcrlf & "<body  "
	if open_3_8=0 then
	...
	Response.write ">" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & ""
	dim MODULES
	MODULES=session("zbintel2010ms")
	Dim helper
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power WITH(NOLOCK) where ord="&session("personzbintel2007")&" and sort1=3 and sort2=21"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_3_21=0
	else
		open_3_21=rs1("qx_open")
	end if
	rs1.close
	set rs1=nothing
	If conn.execute("select 1 from home_usConfig where name='chance_last_callback' and nvalue =  CAST(GETDATE() as int)").eof  Then
		conn.execute "exec erp_xmAutoRevoke"
		conn.execute "update home_usConfig set nvalue =  CAST(GETDATE() as int) where name='chance_last_callback'", n
		If n = 0 Then
			conn.execute "insert into home_usConfig(name, nvalue, uid) values ('chance_last_callback', CAST(GETDATE() as int),0)"
		end if
	end if
	dim W1,W2,W3,A1,A2,B,C,D,E,F,H,sort1,sort2 , spState , ty
	spState = request("spState")
	If Len(spState) = 0 Or isnumeric(spState) = False Then
		spState = 0
	end if
	spState = CLng(spState)
	A1=request("A1")
	A2=request("A2")
	D=request("D")
	E=request("E")
	...
	If remind <> "" Then
		...
		Str_Result = " WHERE a.ord in (" & helper.listSQL("ids") & ")"
	end if
	needProc = request("needProc")
	If needProc&""= "" Then needProc = "" Else needProc = CInt(needProc)
	if ty="loudou" then
		if open_3_1=3 then
			Str_Result="where ((a.del=1 "&list1&") or (isnull(a.cateid,0)=0 and a.del=1) or ((a.share like '%"&session("personzbintel2007")&"%' or a.share='1') and a.cateid <>"&session("personzbintel2007")&" and a.del=1))"
			Str_Result2="and ((a.del=1 "&list1&")  or (isnull(a.cateid,0)=0 and a.del=1) or ((a.share like '%"&session("personzbintel2007")&"%' or a.share='1') and a.cateid <>"&session("personzbintel2007")&" and a.del=1))"
		else
			Str_Result="where ((a.del=1 "&list1&") or ((a.share like '%"&session("personzbintel2007")&"%' or a.share='1') and a.cateid <>"&session("personzbintel2007")&" and a.del=1))"
			Str_Result2="and ((a.del=1 "&list1&") or ((a.share like '%"&session("personzbintel2007")&"%' or a.share='1') and a.cateid <>"&session("personzbintel2007")&" and a.del=1))"
		end if
	end if
	Dim noWhere,Rsw : noWhere = (Len(w1) = 0 And Len(w2) = 0 And Len(w3) = 0) or (W1="0" and W2="0" and W3="0")
	If Not noWhere And w1<>"999999999" Then
		...
		if clng("0" & request.QueryString("IsShare"))=1 then
			if  clng("0" & request.QueryString("IsOther"))= 0 and Len(w1)>0 then
				Str_Result=Str_Result+" and (a.share='1' or exists(select top 1 1 from dbo.gate g  where (g.orgsid="&clng(W1)&" or exists(select top 1 1 from orgs_parts o inner join dbo.orgs_parts og on charindex(+','+o.fullids+',', ','+og.fullids+',')=1 and og.Stoped=0  where o.Stoped=0 and g.orgsid=og.ID and o.PID="&clng(W1)&")) and g.ord in("& w3 &") and CHARINDEX(',' + cast(g.ord as varchar(20)) + ',', +','+isnull(a.share,'')+',')>0))"
'if  clng("0" & request.QueryString("IsOther"))= 0 and Len(w1)>0 then
			else
				Str_Result=Str_Result+" and (a.share='1' or exists(select top 1 1 from dbo.gate g  where g.ord in("& w3 &") and CHARINDEX(',' + cast(g.ord as varchar(20)) + ',', +','+isnull(a.share,'')+',')>0))"
'if  clng("0" & request.QueryString("IsOther"))= 0 and Len(w1)>0 then
			end if
		else
			Rsw = "select ord from gate where 1=1 "
			If Len(w1)>0  and Len(w3)=0 Then
				Rsw = GetUserIdsByOrgsID(w1)
			end if
			If Len(w2)>0  and Len(w3)=0  Then
				Rsw = Rsw & " and sorce2 in ("&w2&")"
			end if
			If Len(w3)>0 and w3<>"0" Then
				Rsw = Rsw & " and ord in ("&w3&")"
			end if
			Str_Result=Str_Result &" and a.cateid in ("& Rsw &") "
		end if
	End If
...
'If w1="999999999" Then
	...
	If request("spinfo") = "5" Then
		Str_Result=Str_Result &"  and exists(select 1 from dbo.erp_chance_callbackList('" & now & "') x where x.chanceid=a.ord and x.backdays <= ISNULL((SELECT ISNULL(tq1,5) FROM setjm WHERE cateid = "& session("personzbintel2007") &" AND ord = 215 AND intro = '1'),5)) "
	end if
	Str_Result = Str_Result & " and del<>7"
	datatype = request("datatype")
	fromid = request("fromid")
	If datatype&""<>"" And fromid&""<>"" Then
		fromid = deurl(fromid)
		Str_Result = Str_Result & " and a.ord in("& getRelevanceOrds("chance", datatype, fromid) &") "
	end if
	area_list=-1
	'Str_Result = Str_Result & " and a.ord in("& getRelevanceOrds("chance", datatype, fromid) &") "
	if A2<>"" then
		function menuarea(id1)
			...
			sqlarea="select id,id1 from menuarea WITH(NOLOCK) where id1="&id1&" "
        ...
        For i = 0 To UBound(aryReturn2)
            n=0
            set rs=server.CreateObject("adodb.recordset")
            sql="select id from menuarea WITH(NOLOCK) where id1="&aryReturn2(i)&" "
            rs.open sql,conn,1,1
            if rs.eof then
                n=0
            else
	...
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select top 1 bz from setbz WITH(NOLOCK) "
	rs7.open sql7,conn,1,1
	if not rs7.eof then
		setbz=rs7("bz")
	end if
	rs7.close
	set rs7=nothing
	function getHL(bzid,bzdate)
		set rsf = conn.execute("select H.hl from hl H WITH(NOLOCK) left join sortbz B WITH(NOLOCK) on H.bz=B.id where datediff(dd,H.date1,'"& bzdate &"')=0 and B.id="& bzid &"")
		if not rsf.eof then
			if isnull(rsf(0)) or rsf(0)="" then getHL = 1 else getHL = cdbl(rsf(0))
		else
			getHL = 1
		end if
		rsf.close
	...
	function getbz(bz)
		if setbz="1" then
			if bz<>"" and  bz<>"0" then
				set rs7=server.CreateObject("adodb.recordset")
				sql7="select intro from sortbz WITH(NOLOCK) where id="&bz&" "
				rs7.open sql7,conn,1,1
				if rs7.eof then
					getbz=""
				else
	...
	if Len(lie_1&"")=0 then lie_1=1
	lie_2=request.QueryString("lie_2")
	if Len(lie_2&"")=0 Then lie_2=1
	lie_3=request.QueryString("lie_3")
	if ZBRuntime.MC(12003) then
		if Len(lie_3&"")=0 then lie_3=1
	else
		if Len(lie_3&"")=0 then lie_3=2
	end if
	lie_4=request.QueryString("lie_4")
	if Len(lie_4&"")=0 then lie_4=1
	lie_5=request.QueryString("lie_5")
	if Len(lie_5&"")=0 then lie_5=1
	page_count=request.QueryString("page_count")
	if page_count="" then page_count=10
	sql="if exists(select top 1 * from zdymx where sort1=1003 and name like 'lie_%') "&_
	"update zdymx set sort1=1010 where sort1=1003 and name like 'lie_%'"
	conn.execute sql
	sql="if not exists(select top 1 * from zdymx where sort1=1010 and kd2="&session("personzbintel2007")&" and sort=1) "&_
	"insert into zdymx(title,name,sort,set_open,kd,kd2,gate1,sort1,sorce) values('项目主题','lie_1',1,1,80,"&session("personzbintel2007")&",8,1010,1)"
	conn.execute sql
	sql="if not exists(select top 1 * from zdymx where sort1=1010 and kd2="&session("personzbintel2007")&" and sort=2) "&_
	"insert into zdymx(title,name,sort,set_open,kd,kd2,gate1,sort1,sorce) values('发现日期','lie_2',2,1,80,"&session("personzbintel2007")&",8,1010,1)"
	conn.execute sql
	sql="if not exists(select top 1 * from zdymx where sort1=1010 and kd2="&session("personzbintel2007")&" and sort=3) "&_
	"insert into zdymx(title,name,sort,set_open,kd,kd2,gate1,sort1,sorce) values('项目阶段','lie_3',3,1,80,"&session("personzbintel2007")&",8,1010,1)"
	conn.execute sql
	sql="if not exists(select top 1 * from zdymx where sort1=1010 and kd2="&session("personzbintel2007")&" and sort=4) "&_
	"insert into zdymx(title,name,sort,set_open,kd,kd2,gate1,sort1,sorce) values('主负责人','lie_4',4,1,80,"&session("personzbintel2007")&",8,1010,1)"
	conn.execute sql
	sql="if not exists(select top 1 * from zdymx where sort1=1010 and kd2="&session("personzbintel2007")&" and sort=5) "&_
	"insert into zdymx(title,name,sort,set_open,kd,kd2,gate1,sort1,sorce) values('每页显示','lie_5',5,1,80,"&session("personzbintel2007")&",8,1010,1)"
	conn.execute sql
	...
	s_it1=get_Items(1010,1)
	s_it2=get_Items(1010,2)
	s_it3=get_Items(1010,3)
	s_it4=get_Items(1010,4)
	s_it5=get_Items(1010,5)
	if (request("lie_1")="" or isnull(request("lie_1"))) and s_it1<>999 then lie_1=s_it1
	if (request("lie_2")="" or isnull(request("lie_2"))) and s_it2<>999 then lie_2=s_it2
	if (request("lie_3")="" or isnull(request("lie_3"))) and s_it3<>999 then lie_3=s_it3
	if (request("lie_4")="" or isnull(request("lie_4"))) and s_it4<>999 then lie_4=s_it4
	if (request("lie_5")="" or isnull(request("lie_5"))) and s_it5<>999 then lie_5=s_it5
	if request("lie_1")="" then
		slie_1=0
	else
		slie_1=cdbl(request("lie_1"))
	end if
	if request("lie_2")="" then
		slie_2=0
	else
		slie_2=cdbl(request("lie_2"))
	end if
	if request("lie_3")="" then
		slie_3=0
	else
		slie_3=cdbl(request("lie_3"))
	end if
	if request("lie_4")="" then
		slie_4=0
	else
		slie_4=cdbl(request("lie_4"))
	end if
	if request("lie_5")="" then
		slie_5=0
	else
		slie_5=cdbl(request("lie_5"))
	end if
	if (slie_1=cdbl(s_it1) or lie_1=s_it1) and (slie_2=cdbl(s_it2) or lie_2=s_it2) and (slie_3=cdbl(s_it3) or lie_3=s_it3) and (slie_4=cdbl(s_it4) or lie_4=s_it4) and (slie_5=cdbl(s_it5) or lie_5=s_it5) then
		Flag_LockItems=true
	else
	...
	End Select
	if  A2<>"" then
		Str_Result=Str_Result &" and  a.area in ("&area_list&")"
	end if
	if D<>"" then
		Str_Result=Str_Result &" and  a.trade in ("&D&")"
	end if
	if E<>"" then
		Str_Result=Str_Result &" and  a.complete1 in ("&E&")"
	end if
	if F<>"" then
		if F = "0" then
			Str_Result=Str_Result &" and  a.complete2 not in (select ord from sortjh2)"
		else
			Str_Result=Str_Result &" and  a.complete2 in ("&F&")"
		end if
	end if
	if A1<>"" then
		Str_Result=Str_Result &" and  a.sorce in ("&A1&")"
	end if
	if m3<>"" then
		Str_Result=Str_Result &" and  a.date1>='"&m3&"'"
	end if
	if m4<>"" then
		Str_Result=Str_Result &" and  a.date1<='"&cdate(m4)&" 23:59:59'"
	end if
	if m5<>"" then
		Str_Result=Str_Result &" and  a.date2>='"&m5&"'"
	end if
	if m6<>"" then
		Str_Result=Str_Result &" and  a.date2<='"&cdate(m6)&" 23:59:59'"
	end if
	If Not noWhere Then
		if m1<>"" then
		...
		if m2<>"" then
			Str_Result=Str_Result &" and a.date1<='"&cdate(m2)&" 23:59:59'"
		end if
	else
		if m1<>"" then
			Str_Result=Str_Result &" and a.date7>='"&m1&"'"
		end if
		if m2<>"" then
			Str_Result=Str_Result &" and a.date7<='"&cdate(m2)&" 23:59:59'"
		end if
	end if
	If khid&""<>"" Then
		Str_Result=Str_Result &" and charindex('," & khid & ",',','+a.company+',')>0"
'If khid&""<>"" Then
	end if
	If needProc&""="0" Then
		Str_Result=Str_Result &" and  isnull(a.procid,0) = 0"
	ElseIf needProc&""="1" Then
		Str_Result=Str_Result &" and  isnull(a.procid,0) > 0"
	end if
	kh_js=""
	If khmc<>"" Then
		kh_js=kh_js &" and name like '%"&khmc&"%'"
	end if
	If khdh<>"" Then
		kh_js=kh_js &" and phone like '%"&khdh&"%'"
	end if
	If khcz<>"" Then
		kh_js=kh_js &" and fax like '%"&khcz&"%'"
	end if
	If khdz<>"" Then
		kh_js=kh_js &" and address like '%"&khdz&"%'"
	end if
	if kh_js<>"" Then
		Set rs=conn.execute("select ord from tel WITH(NOLOCK) where del=1 and sort3=1 "&kh_js&"")
		If rs.eof Then
			...
			khnum=0
			While Not rs.eof
				If khnum<>0 Then strsql_kh=strsql_kh&" or "
				strsql_kh=strsql_kh & " charindex(',"&rs("ord")&",',','+replace(a.company,' ','')+',')>0"
'If khnum<>0 Then strsql_kh=strsql_kh&" or "
				khnum=khnum+1
'If khnum<>0 Then strsql_kh=strsql_kh&" or "
				rs.movenext
			wend
			Str_Result=Str_Result&" and ("&strsql_kh&") "
		end if
		rs.close
	end if
	if zdy5<>"" then
		Str_Result=Str_Result &" and  a.zdy5 in  ("&zdy5&")"
	end if
	if zdy6<>"" then
		Str_Result=Str_Result &" and  a.zdy6 in  ("&zdy6&")"
	end if
	if C2<>"" then
		if B2="xmzt" then
			Str_Result=Str_Result &" and  a.title like '%"&C2&"%'"
		elseif B2="xmbh" then
			Str_Result=Str_Result &" and  a.xmid like '%"&C2&"%'"
		elseif B2="xmgy" then
			Str_Result=Str_Result &" and  a.intro like '%"&C2&"%'"
		elseif B2="zdy1" then
			Str_Result=Str_Result &" and  a.zdy1 like '%"&C2&"%'"
		elseif B2="zdy2" then
			Str_Result=Str_Result &" and  a.zdy2 like '%"&C2&"%'"
		elseif B2="zdy3" then
			Str_Result=Str_Result &" and  a.zdy3 like '%"&C2&"%'"
		elseif B2="zdy4" then
			Str_Result=Str_Result &" and  a.zdy4 like '%"&C2&"%'"
		elseif B2="khmc" then
			Str_Result=Str_Result &" and  a.ord in (select y.ord from tel x WITH(NOLOCK) inner join chance y WITH(NOLOCK) on x.del=1 and y.del=1 and x.sort3=1 and x.name like '%"&C2&"%' and charindex(','+cast(x.ord as nvarchar(4000))+',',','+y.company+',')>0)"
		elseif B2="khmc" then
		end if
	end if
	Call searchExtended(3,"a.ord")
	if D<>"" then
		set rs=server.CreateObject("adodb.recordset")
		sql="select sort1 from sortonehy WITH(NOLOCK) where ord in ("&D&") "
		rs.open sql,conn,1,1
		if rs.eof then
		else
			trade1="项目分类>>"&rs("sort1")
		end if
		rs.close
		set rs=nothing
	end if
	if A1<>"" then
		...
		sql="select sort1 from sortonehy WITH(NOLOCK) where ord in ("&A1&") "
		rs.open sql,conn,1,1
		if rs.eof then
		else
			A1name="项目来源>>"&rs("sort1")
		end if
		rs.close
		set rs=nothing
	end if
	if E<>"" then
		set rs=server.CreateObject("adodb.recordset")
		sql="select sort1 from sortonehy WITH(NOLOCK) where ord in ("&E&") "
		rs.open sql,conn,1,1
		if rs.eof then
		else
			sortone="项目状态>>"&rs("sort1")
		end if
		rs.close
		set rs=nothing
	end if
	if F<>"" then
		set rs=server.CreateObject("adodb.recordset")
		sql="select sort1 from sortjh2 WITH(NOLOCK) where ord in ("&F&") "
		rs.open sql,conn,1,1
		if rs.eof then
		else
			sorttwo="项目阶段>>"&rs("sort1")
		end if
		rs.close
		set rs=nothing
	end if
	...
	if newstate="1" then
		set rs=server.CreateObject("adodb.recordset")
		sql="select ord,intro,num1,tq1,fw1 from setjm2 WITH(NOLOCK) where ord=33 and cateid="&session("personzbintel2007")&""
		rs.open sql,conn,1,1
		if not rs.eof then
			If rs("fw1")="1" Then
				Str_Result= Str_Result & " and (cateid="&session("personzbintel2007")&" or (share='1' or charindex(',"&session("personzbintel2007")&",',','+isnull(share,'0')+',')>0))"
'If rs("fw1")="1" Then
			end if
			Str_Result= Str_Result & " and del=1 and isnull(sp,0)=0 and charindex(',"&session("personzbintel2007")&",',','+isnull(alt2,'0')+',')=0 "
'If rs("fw1")="1" Then
		end if
		rs.close
		set rs=nothing
	Elseif newstate="3" Then
		Set rs=conn.execute("select id,ord,intro,num1,tq1,fw1,gate1 from setjm2 WITH(NOLOCK) where intro=1  and cateid="&session("personzbintel2007")&" and ord=89")
		If Not rs.eof Then
			If intro_3_16&""<>"" Then intro_3_16 = Replace(intro_3_16," ","")
			Str_Result= Str_Result & " and a.cateid_sp = "&session("personzbintel2007")&" and sp<>0 and sp<>-1 and ("& open_3_16 &"=3 or ("& open_3_16 &"=1 and charindex(','+cast(a.cateid as varchar(10))+',',',"& intro_3_16 &",')>0)) "
'If intro_3_16&""<>"" Then intro_3_16 = Replace(intro_3_16," ","")
		else
	...
	propm = request("propm")
	If propm&""="1" Then
		Set rs=conn.execute("select id,ord,intro,num1,tq1,fw1,gate1 from setjm WITH(NOLOCK) where intro=1  and cateid="&session("personzbintel2007")&" and ord=54")
		If Not rs.eof Then
			If rs("fw1")="1" Then
				Str_Result= Str_Result & " and (share='1' or charindex(',"&session("personzbintel2007")&",',','+isnull(share,'0')+',')>0 )"
'If rs("fw1")="1" Then
			end if
			Str_Result= Str_Result & " and isnull(share,'0')<>'0' and del=1 and charindex(',"&session("personzbintel2007")&",',','+isnull(alt,'0')+',')=0 "
'If rs("fw1")="1" Then
		end if
		rs.close
		set rs = nothing
		px=11
	ElseIf propm&""="2" Then
		Set rs=conn.execute("select id,ord,intro,num1,tq1,fw1,gate1 from setjm WITH(NOLOCK) where intro=1  and cateid="&session("personzbintel2007")&" and ord=64")
		If Not rs.eof Then
			If intro_3_16&""<>"" Then intro_3_16 = Replace(intro_3_16," ","")
			Str_Result= Str_Result & " and a.cateid_sp = "&session("personzbintel2007")&" and sp<>0 and sp<>-1 and ("& open_3_16 &"=3 or ("& open_3_16 &"=1 and charindex(','+cast(a.cateid as varchar(10))+',',',"& intro_3_16 &",')>0)) "
'If intro_3_16&""<>"" Then intro_3_16 = Replace(intro_3_16," ","")
		...
		set rs = nothing
	ElseIf propm&""="3" Then
		Set rs=conn.execute("select id,ord,intro,num1,tq1,fw1,gate1 from setjm WITH(NOLOCK) where intro=1  and cateid="&session("personzbintel2007")&" and ord=63")
		If Not rs.eof Then
			If rs("fw1")="1" Then
				Str_Result= Str_Result & " and (cateid="&session("personzbintel2007")&" or (share='1' or charindex(',"&session("personzbintel2007")&",',','+isnull(share,'0')+',')>0))"
'If rs("fw1")="1" Then
...
'If rs("fw1")="1" Then
	...
	If request("newstate")&""="2" Then
		Set rs=conn.execute("select id,ord,intro,num1,tq1,fw1,gate1 from setjm2 WITH(NOLOCK) where cateid="&session("personzbintel2007")&" and ord=84")
		If Not rs.eof Then
			If rs("fw1")="1" Then
				Str_Result= Str_Result & " and (share='1' or charindex(',"&session("personzbintel2007")&",',','+isnull(share,'0')+',')>0 )"
'If rs("fw1")="1" Then
...
'If rs("fw1")="1" Then
	...
	if px=1 then
		px_Result=" order by a.title desc"
	elseif px=2 then
		px_Result=" order by a.title asc"
	elseif px=3 then
		px_Result=" order by a.xmid desc"
	elseif px=4 then
		px_Result=" order by a.xmid asc"
	elseif px=5 then
		px_Result=" order by a.money1 desc,a.date7 desc"
	elseif px=6 then
		px_Result=" order by a.money1 asc,a.date7 desc"
	elseif px=7 then
		px_Result=" order by a.money2 desc"
	elseif px=8 then
		px_Result=" order by a.money2 asc"
	elseif px=9 then
		px_Result=" order by a.date7 desc"
	elseif px=10 then
		px_Result=" order by a.date7 asc"
	elseif px=11 then
		px_Result=" order by a.date1 desc"
	elseif px=12 then
		px_Result=" order by a.date1 asc"
	elseif px=13 then
		px_Result=" order by b.gate1 desc,a.date7 desc"
	elseif px=14 then
		px_Result=" order by b.gate1 asc,a.date7 desc"
	elseif px=15 then
		px_Result=" order by (select name from gate where ord=a.cateid) desc,a.date7 desc"
	elseif px=16 then
		px_Result=" order by (select name from gate where ord=a.cateid) asc,a.date7 desc"
	elseif px=17 then
		px_Result=" order by (select top 1 date7 from reply where ord2=a.ord and sort1=2 order by date7 desc) desc,a.date7 desc"
	elseif px=18 then
		px_Result=" order by (select top 1 date7 from reply where ord2=a.ord and sort1=2 order by date7 desc) asc,a.date7 desc"
	elseif px=19 then
		px_Result=" order by s.date1 desc"
	elseif px=20 then
		px_Result=" order by s.date1 asc"
	end if
	if H="7" then
		str_Result1=" and isnull(a.share,'0')<>'0' and a.share<>'' and a.share<>'0' and a.share<>'-1' and a.cateid ="&session("personzbintel2007")&" and a.del=1"
'if H="7" then
	elseif H="8" then
		if cstr(trim(w3))="0" Or Len(w3)=0 then w3=session("personzbintel2007")
		str_Result1="  and (','+a.share+',' like '%"&","&w3&","&"%' or a.share='1') and a.cateid <>"&session("personzbintel2007")&" and a.del=1"
'if cstr(trim(w3))="0" Or Len(w3)=0 then w3=session("personzbintel2007")
	elseif H="81" Then
		str_Result = " where a.cateid <> "&getint(Trim(request("W3")))&" "
		str_Result1="  and (','+a.share+',' like '%"&","&getint(Trim(request("W3")))&","&"%' or a.share='1') and a.del=1"
		str_Result = " where a.cateid <> "&getint(Trim(request("W3")))&" "
		if F<>"" then
			if F = "0" then
				Str_Result=Str_Result &" and  a.complete2 not in (select ord from sortjh2)"
	...
	ElseIf h="101" Then
		if cstr(trim(w3))="0" Or Len(w3)=0 then w3=session("personzbintel2007")
		str_Result1="  and (','+a.share+',' like '%"&","&w3&","&"%' or a.share='1') and a.del=1"
'if cstr(trim(w3))="0" Or Len(w3)=0 then w3=session("personzbintel2007")
	end if
	str_Result=str_Result & str_Result1
	Response.write "" & vbcrlf & "     <form action=""result.asp"" method=""get""　id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"" style=""margin:0"">" & vbcrlf & "          <input type=""hidden"" name=""px"" value="""
	Response.write px
	Response.write """>" & vbcrlf & "          <input type=""hidden"" name=""page_count"" value="""
	Response.write page_count
	Response.write """>" & vbcrlf & "          <input type=""hidden"" name=""H"" value="""
	Response.write H
	Response.write """>" & vbcrlf & "          <input type=""hidden"" name=""spState"" value="""
	Response.write spState
	Response.write """>" & vbcrlf & "          <input type=""hidden"" name=""newstate"" value="""
	Response.write newstate
	Response.write """>" & vbcrlf & "          <input type=""hidden"" name=""propm"" value="""
	Response.write propm
	Response.write """>" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"" id=""tttt"" class=""zdy"" style=""z-index:9999"">" & vbcrlf & "              <tr>" & vbcrlf & "            <td class=""place place42"" style=""width:380px"">"
	Response.write propm
	if H="1" then
		Response.write "项目检索"
	else
		If request("spState")="1" then
			Response.write "" & vbcrlf & "                     审批中项目 " & vbcrlf & "                     "
		ElseIf request("spState")="2" then
			Response.write "" & vbcrlf & "                     未通过项目 " & vbcrlf & "                     "
		else
			Response.write "" & vbcrlf & "                     项目列表" & vbcrlf & "                        "
		end if
		Response.write area1
		Response.write trade1
		Response.write A1name
		Response.write sortone
		Response.write sorttwo
	end if
	Response.write "</td>" & vbcrlf & "                        "
	Response.write "" & vbcrlf & "            <td>&nbsp;<div style=""position:absolute;width:200px;left:390px;top:23px;z-index:10000""><a href=""#"" onClick=""Myopen(User);return false;"" style=""font-weight:bold"" class=""sortRule"">排序规则<img src=""../images/i10.gif"" width=""9"" height=""5"" border=""0""></a>" &vbcrlf & "                        </div>" & vbcrlf & "                  </td>" & vbcrlf & "                   "
	Response.write "" & vbcrlf & "            <td align=""right"">" & vbcrlf & "                 <font id=""kh"" >" & vbcrlf & "                   "
	If ZBRuntime.MC(203101) Then
		Response.write "" & vbcrlf & "                     <input type=""radio"" name=""needProc"" value=""0"" "
		If needProc&""="0" Then Response.write "checked"
		Response.write " onClick=""gotourl('needProc=0');"">不需要流程&nbsp;<input type=""radio"" name=""needProc"" value=""1"" "
		If needProc&""="1" Then Response.write "checked"
		Response.write " onClick=""gotourl('needProc=1');"">需要流程&nbsp;<input type=""radio"" name=""needProc"" value="""" "
		If needProc="" Then Response.write "checked"
		Response.write " onClick=""gotourl('needProc=');"">所有项目&nbsp;" & vbcrlf & "                        "
	end if
	if (open_3_10=1 or open_3_10=3) then
		Response.write "<input type=""button"" name=""Submitdel2"" style=""margin-top:-2px;"" value=""EXCEL导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({debug:false,page:'../out/xls_xm.asp'})}"" class=""anybutton2""/>"
'if (open_3_10=1 or open_3_10=3) then
	end if
	if (open_3_7=1 or open_3_7=3) then
		Response.write "<input type=""button"" style=""margin-top:-2px;"" name=""Submit43"" value=""打印""  onClick=""javascript: kh.style.display = 'none'; window.print(); kh.style.display = 'block';return  false;""   class=""anybutton""/>"
'if (open_3_7=1 or open_3_7=3) then
	end if
	Response.write "" & vbcrlf & "              <a style='display:inline-block;width:108px;' class=""AfterQuickSearch"" href=""javascript:;"" onclick=""search_lb();""><img src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><u style='color:red'><font class=""advanSearch"" style=""height:26px;"">高级检索</font></u></a></font></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td> "& vbcrlf &"           </tr> "& vbcrlf &"       </table> "& vbcrlf &"     <span id=""ht1"" style=""padding:20px;""></span> "& vbcrlf &"   </form> "& vbcrlf &" <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""0"" bgcolor=""transparent"" id=""content"" style=""margin-left:20px"">" & vbcrlf & "  <form name=""form1"" method=""post"" action=""deleteall6.asp?"
'if (open_3_7=1 or open_3_7=3) then
	Response.write sdk.ReturnURL("")
	Response.write """>" & vbcrlf & "        <tr id=""gd2"" class=""zdy1 top tophead"">" & vbcrlf & "        <td align=""center"" width=""5%""><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "    <td width=""18%"" height=""27"" align=""center""><div align=""center""><strong>" & vbcrlf & "             <select name=""select"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style=""HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E; overflow:hidden"" > "& vbcrlf &"             <option>-请选择-</option> "& vbcrlf &"             <option value=""lie_1=1"
	Response.write sdk.ReturnURL("")
	if lie_1=1 then
		Response.write "selected"
	end if
	Response.write "><strong>项目主题</strong></option>" & vbcrlf & "            <option value=""lie_1=2"" "
	if lie_1=2 then
		Response.write "selected"
	end if
	Response.write ">项目编号</option>" & vbcrlf & "          </select>" & vbcrlf & "            </strong></div></td>" & vbcrlf & "          <td width=""12%"" class=""gray""><div align=""center""><strong>" & vbcrlf & "       <select name=""select2"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style="" HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E; overflow:hidden"" >" & vbcrlf & "          <option>-请选择-</option>" & vbcrlf & "          <option value=""lie_2=1"" "
	Response.write "selected"
	if lie_2=1 then
		Response.write "selected"
	end if
	Response.write ">发现日期</option>" & vbcrlf & "          <option value=""lie_2=2"" "
	if lie_2=2 then
		Response.write "selected"
	end if
	Response.write ">预计签单</option>" & vbcrlf & "                           <option value=""lie_2=3"" "
	if lie_2=3 then
		Response.write "selected"
	end if
	Response.write ">项目总额</option>" & vbcrlf & "                           <option value=""lie_2=4"" "
	if lie_2=4 then
		Response.write "selected"
	end if
	Response.write ">预计金额</option>" & vbcrlf & "                           <option value=""lie_2=5"" "
	if lie_2=5 then
		Response.write "selected"
	end if
	Response.write ">预计费用</option>" & vbcrlf & "" & vbcrlf & "        </select>" & vbcrlf & "    </strong></div></td>" & vbcrlf & "    <td width=""28%"" class=""gray"">     <div align=""center"">" & vbcrlf & "          <select name=""select3"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}""  style="" HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E; overflow:hidden"" >" & vbcrlf & "          <option>-请选择-</option>" & vbcrlf & "             "
	Response.write "selected"
	if ZBRuntime.MC(12003) then
	...
	Response.write ">项目阶段</option>" & vbcrlf & "          <option value=""lie_3=3"" "
	if lie_3=3 then
		Response.write "selected"
	end if
	Response.write ">项目状态</option>" & vbcrlf & "          <option value=""lie_3=4"" "
	if lie_3=4 then
		Response.write "selected"
	end if
	Response.write ">项目来源</option>" & vbcrlf & "          <option value=""lie_3=5"" "
	if lie_3=5 then
		Response.write "selected"
	end if
	Response.write ">项目分类</option>" & vbcrlf & "        </select>" & vbcrlf & "    </div></td>" & vbcrlf & "     <td width=""15%"">" & vbcrlf & "            <div align=""center"">" & vbcrlf & "        <select name=""select4"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}""  style="" HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E; overflow:hidden"" >" & vbcrlf & "                <option>-请选择-</option>" & vbcrlf & "               <option value=""lie_4=1"" "
	Response.write "selected"
	if lie_4=1 then
		Response.write "selected"
	end if
	Response.write ">主负责人</option>" & vbcrlf & "            <option value=""lie_4=2"" "
	if lie_4=2 then
		Response.write "selected"
	end if
	Response.write ">协作人</option>" & vbcrlf & "             <option value=""lie_4=3"" "
	if lie_4=3 then
		Response.write "selected"
	end if
	Response.write ">添加日期</option>" & vbcrlf & "            "
	Set rs = server.CreateObject("adodb.recordset")
	sql = "select name,title from zdy where sort1 = 3 and set_open = 1 order by gate1"
	rs.open sql,conn,1,1
	If Not rs.Eof Then
		Do While rs.Eof = False
			fieldName = rs("name")
			Response.write("<option value='lie_4="&right(fieldName,1)+10&"' ")
			fieldName = rs("name")
			If Cdbl(lie_4) = right(fieldName,1)+10 Then
				fieldName = rs("name")
				Response.write("selected")
			end if
	...
	rs.close
	set rs = nothing
	Response.write "" & vbcrlf & "             </select>" & vbcrlf & "          </div></td>" & vbcrlf & "    <td width=""32%"" class=""gray""><div align=""center"">" & vbcrlf & "       <select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style="" HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E; overflow:hidden"">" & vbcrlf & "          <option>-请选择-</option>" & vbcrlf & "                   <option value=""lie_5=1"" "
'Loop
	if lie_5=1 then
		Response.write "selected"
	end if
	Response.write ">每页显示10条</option>" & vbcrlf & "                         <option value=""lie_5=2"" "
	if lie_5=2 then
		Response.write "selected"
	end if
	Response.write ">每页显示20条</option>" & vbcrlf & "                         <option value=""lie_5=3"" "
	if lie_5=3  then
		Response.write "selected"
	end if
	Response.write ">每页显示30条</option>" & vbcrlf & "                         <option value=""lie_5=4"" "
	if lie_5=4  then
		Response.write "selected"
	end if
	Response.write ">每页显示50条</option>" & vbcrlf & "                         <option value=""lie_5=5"" "
	if lie_5=5  then
		Response.write "selected"
	end if
	Response.write ">每页显示100条</option>" & vbcrlf & "                        <option value=""lie_5=6"" "
	if lie_5=6  then
		Response.write "selected"
	end if
	Response.write ">每页显示200条</option>" & vbcrlf & "        </select>" & vbcrlf & "             &nbsp;<input type=""checkbox"" id=""LockItems"" onClick=""SaveItems(1010,"
	...
	fromContract=trim(Request.QueryString("contract"))
	if fromContract<>"" then
		fromContent=" and a.ord in (select isnull(chance,0) from contract where ord="&fromContract&")"
	end if
	dim summoney1_2,summoney2_2,summoney_pay_2,summoney1_3,summoney3_2,summoney_pay_3
	summoney1_2 = 0
	summoney2_2 = 0
	summoney_pay_2 = 0
	summoney1_3 = 0
	...
	summoney_pay_3 = 0
	set rs=server.CreateObject("adodb.recordset")
	sql =       "select a.ord,a.title,a.xmid,a.complete1,a.complete2,a.sorce,a.money1,a.money2,a.money3,a.pay1,a.date1,a.date2,a.date7,a.cateid,a.sp, a.cateid_sp,a.trade,b.color,a.bz,a.share,isnull(a.alt2,'0') alt2,zdy1,zdy2,zdy3,zdy4,(select top 1 sort1 from sortonehy WITH(NOLOCK) where gate2=301 AND id = ISNULL(a.zdy5,0)) zdy5,(select top 1 sort1 from sortonehy WITH(NOLOCK) where gate2=302 AND id = ISNULL(a.zdy6,0)) zdy6 "&_
	",(select top 1 sort1 from sortonehy WITH(NOLOCK) where ord = ISNULL(a.complete1,0)) complete1Sort "
	if lie_3=2 then
		sql=sql &" ,(select top 1 sort1 from sortjh2 WITH(NOLOCK) where ord=ISNULL(a.complete2,0)) complete2Sort "
	end if
	if lie_3=4 then
		sql=sql &" ,(select top 1 sort1 from sortonehy WITH(NOLOCK) where ord=ISNULL(a.sorce,0)) sorceSort "
	end if
	if lie_3=5 then
		sql=sql &" ,(select top 1 sort1 from sortonehy WITH(NOLOCK) where ord=ISNULL(a.trade,0)) tradeSort "
	end if
	if lie_4=1 then
		sql=sql &" ,(select top 1 name from gate WITH(NOLOCK) where ord=ISNULL(a.cateid,0)) cateName "
	end if
	fromSql=" from chance a WITH(NOLOCK) left join sortjh2 b WITH(NOLOCK) on a.complete2=b.ord "
	If px = 19 Or px=20 Then
		fromSql=fromSql & "LEFT JOIN (SELECT ord,max(date1) as date1 FROM sp_intro WHERE sort1 = 25 group by ord) s ON s.ord = a.ord   "
	end if
	sqlCount = "select count(1) from ( "& sql & fromSql & Str_Result & fromContent &" ) t "
	...
	curSql = "select * from ( " & sql & ",(row_number() OVER( "& px_Result &" ))  as rownum "& fromSql & Str_Result & fromContent &" ) t "&_
	"where (rownum between " & (page_count*(currpage-1)+1) & " and " & (page_count*currpage) & ") order by rownum "
	rs.open curSql,conn,3,1
	if rs.RecordCount<=0 then
		Response.write "<table><tr><td>没有信息!</td></tr><tr><td height='100'></td></tr></table>"
	else
		if lie_3=1 then
			if open_3_5=3 or open_3_5=1 Then
				chanceIds=""
				do until rs.eof
					chanceIds=chanceIds+cstr(rs("ord"))+","
					chanceIds=""
					rs.movenext
				loop
				rs.movefirst
				chanceIds=left(chanceIds,len(chanceIds)-1)
				'rs.movefirst
				sql1 = ""
				powerWhere = " and (("&open_3_5&"=3 or ("&open_3_5&"=1 AND CHARINDEX(','+CAST(cateid AS nvarchar(50))+',' , ','+cast('"&intro_3_5&"' as nvarchar(max))+',') > 0)) or CHARINDEX(','+CAST("&session("personzbintel2007")&" AS VARCHAR(50))+',' , ','+isnull(share,0)+',') > 0)"
				sql1 = ""
				sql1 = "select * from (select ord2,intro,date7,cateid,uploadfile,ROW_NUMBER()over(partition by ord2 order by date7 desc) as inx from reply WITH(NOLOCK) where sort1=2 and del=1 and ord2 in ("& chanceIds &")" & powerWhere &" )t  where t.inx=1"
		...
		if lie_2=3 or lie_2=4 or lie_2=5 then
			sumMoneySql2="select sum(isnull(a.money1,0)) as money1 "&_
			",sum(isnull(a.money1,0) * isnull(c.hl,1)) as RMBmoney1 "&_
			",sum(isnull(a.money2,0)) as money2 "&_
			",sum(isnull(a.money3,0)) as RMBmoney2 "&_
			",sum(isnull(a.pay1,0)) as pay1 "&_
			",sum(isnull(a.pay1,0) * isnull(c.hl,1)) as RMBpay1 "&_
			"from chance a with(nolock) "&_
			"left join sortjh2 b WITH(NOLOCK) on a.complete2=b.ord "&_
			"left join hl c with(nolock) on a.bz=c.bz and a.date7=c.date1 "& Str_Result & fromContent
			set rsSumMoney=conn.execute(sumMoneySql2)
			summoney1_2=rsSumMoney(0)
			summoney1_3=rsSumMoney(1)
			summoney2_2=rsSumMoney(2)
			summoney3_2=rsSumMoney(3)
			summoney_pay_2=rsSumMoney(4)
			summoney_pay_3=rsSumMoney(5)
			rsSumMoney.close
		end if
		dim k,xmid,complete1,complete2,sorce,money1,money2,pay1,date1,date2,date7,cateid,summoney1,summoney3,summoney_pay,bz,summoney1_1,summoney3_1,summoney_pay_1
		summoney1 = 0
		summoney3 = 0
		summoney_pay = 0
		summoney1_1 = 0
		...
		do until rs.eof
			...
			zdy6 = rs("zdy6")
			if lie_2=3 or lie_2=4 or lie_2=5 then
				if bz&"" <>"" then nowhl = getHL(bz,date1) else nowhl = 1
				if rs("money1")="" or isnull(zbcdbl(rs("money1"))) then
					money1=0
					money1_1=0
				else
					...
					money1 =zbcdbl( rs("money1"))
					money1_1 =zbcdbl( rs("money1")) * nowhl
					money1_1=Formatnumber(money1_1,num_dot_xs,-1)
					money1_1 =zbcdbl( rs("money1")) * nowhl
				end if
				if rs("money2")="" or isnull(zbcdbl(rs("money2"))) then
					money2=0
				else
					money2=Formatnumber(zbcdbl(rs("money2")),num_dot_xs,-1)
					money2=0
				end if
				if rs("money3")="" or isnull(zbcdbl(rs("money3"))) then
					money3=0
				else
					
					
					money3=Formatnumber(zbcdbl(rs("money3")),num_dot_xs,-1)
				end if
				if rs("pay1")="" or isnull(rs("pay1")) then
					pay1=0
					pay1_1=0
				else
					pay1 = rs("pay1")
					If pay1&"" = "" Then pay1 = 0 Else pay1 = CDBL(pay1)
					pay1_1 = pay1 * nowhl
					pay1=Formatnumber(pay1,num_dot_xs,-1)
					pay1_1 = pay1 * nowhl
					pay1_1=Formatnumber(pay1_1,num_dot_xs,-1)
					pay1_1 = pay1 * nowhl
				end if
			end if
			dim intro
				...
				if arrReplyCount>0 then
					For row = 0 To UBound(arrReply, 2)
						if arrReply(0,row)=rs("ord") Then
							...
							date71=arrReply(2,row)
							cateid2=arrReply(3,row)
			...
			Response.write "" & vbcrlf & "      <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td width=""5%"" align=""center"">"
			if open_3_6=3 or (open_3_6=1 and CheckPurview(intro_3_6,trim(cateid))=True) or open_3_3=3 or (open_3_3=1 and CheckPurview(intro_3_3,trim(cateid))=True) or open_3_4=3 or (open_3_4=1 and CheckPurview(intro_3_4,trim(cateid))=True) then
				Response.write "" & vbcrlf & "        <input name=""selectid"" type=""checkbox"" id=""selectid"" value="""
				Response.write rs("ord")
				Response.write """ title="""
				if open_3_6=3 or (open_3_6=1 and CheckPurview(intro_3_6,trim(cateid))=True) Then Response.write "指派权限"&vbcrlf
				if open_3_3=3 or (open_3_3=1 and CheckPurview(intro_3_3,trim(cateid))=True) Then Response.write "删除权限"&vbcrlf
				If open_3_4=3 or (open_3_4=1 and CheckPurview(intro_3_4,trim(cateid))=True) Then Response.write "共享权限"
				Response.write """>" & vbcrlf & "   "
			end if
			Response.write "</td>" & vbcrlf & "         <td height=""27"">" & vbcrlf & "          "
			if lie_1=1 then
				if open_3_14=3 or CheckPurview(intro_3_14,trim(cateid))=True then
					Response.write "" & vbcrlf & "                                      <a href=""#"" onClick=""javascript:window.open('content.asp?ord="
					Response.write pwurl(rs("ord"))
					Response.write "','newwin_xm','width=' + 1180 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" title=""点击可查看此项目详情""><span class='tableLinks' style=""color:"
					Response.write pwurl(rs("ord"))
					...
					Response.write "" & vbcrlf & "                                      <span class='tableLinks' style=""color:"
					Response.write color
					Response.write """>"
					Response.write ""&k&""
					Response.write "</span>" & vbcrlf & "                               "
			...
			If request("propm")&""="1" Or request("newstate")&""="2" Then
				Response.write "&nbsp;<img src='../images/hot-new.gif' style='border:0'>"
'If request("propm")&""="1" Or request("newstate")&""="2" Then
			elseif (open_3_14=3 or CheckPurview(intro_3_14,trim(cateid))=True) then
				Response.write "&nbsp;<img alt=""总览"" src=""../images/eye.png"" style=""border:0;cursor:pointer;vertical-align: middle;"" onclick=""javascript:window.open('../../SYSN/view/sales/project/ProjectOverView.ashx?ord="
'elseif (open_3_14=3 or CheckPurview(intro_3_14,trim(cateid))=True) then
				Response.write pwurl(rs("ord"))
				Response.write "','newwin_zl"
				Response.write rs("ord")
				Response.write "','width=' + 1180 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" />"
				Response.write rs("ord")
			end if
			Response.write "" & vbcrlf & "              " & vbcrlf & "                </td>" & vbcrlf & "         <td class=""name"" " & vbcrlf & "            "
			If lie_2=1 Or lie_2=2 then
			...
			elseif lie_2=3 then
				if open_3_21<>0 then
					Response.write getbz(bz) & Formatnumber(money1,num_dot_xs,-1)
'if open_3_21<>0 then
					summoney1 = summoney1 + money1
'if open_3_21<>0 then
					summoney1_1 = summoney1_1 + money1_1
'if open_3_21<>0 then
				else
					Response.write "&nbsp;"
				end if
			elseif lie_2=4 then
				if open_3_21<>0 then
					Response.write getbz(bz) & Formatnumber(money2,num_dot_xs,-1)
'if open_3_21<>0 then
					summoney3 = summoney3 + money2
'if open_3_21<>0 then
					summoney3_1 = summoney3_1 + money3
'if open_3_21<>0 then
				else
					Response.write "&nbsp;"
				end if
			elseif lie_2=5 then
				if open_3_21<>0 then
					Response.write getbz(bz) & Formatnumber(pay1,num_dot_xs,-1)
'if open_3_21<>0 then
					summoney_pay = summoney_pay + pay1
'if open_3_21<>0 then
					summoney_pay_1 = summoney_pay_1 + pay1_1
'if open_3_21<>0 then
				else
					Response.write "&nbsp;"
				end if
			...
			if complete1<>"" then
				dim trade5
				if rs("complete1Sort")="" then
					trade5=""
				else
					trade5=rs("complete1Sort")
				end if
			end if
			Response.write "" & vbcrlf & "<td class=""name"" align=""center"">" & vbcrlf & ""
			If lie_3=1 Then
				Response.write "" & vbcrlf & "         <div id=""reply_"
				Response.write rs("ord")
				Response.write """ align=""left"">" & vbcrlf & ""
				if ZBRuntime.MC(12003) then
					if intro<>"" then
						Response.write "" & vbcrlf & "             <a href=""#"" onClick=""javascript:window.open('all.asp?ord="
						Response.write pwurl(rs("ord"))
						Response.write "&sortreply="
						...
						Response.write date71
						Response.write ")</font>" & vbcrlf & ""
					end if
					if open_3_5=3 or (open_3_5=1 and CheckPurview(intro_3_5,trim(cateid))=True) then
						Response.write "" & vbcrlf & "             <img src=""../images/jiantou.gif""><a href=""#"" onClick=""javascript:window.open('reply_s.asp?ord="
						Response.write pwurl(rs("ord"))
			...
			elseif lie_3=2 then
				...
				name2=""
				if complete2<>"" then
					if rs("complete2Sort")="" then
					else
						name2=rs("complete2Sort")
					end if
				end if
			...
			elseif lie_3=4 then
				...
				sorcename=""
				if sorce<>"" then
					if rs("sorceSort")="" then
					else
						sorcename=rs("sorceSort")
					end if
				end if
				Response.write ""&sorcename&""
			elseif lie_3=5 then
				dim tradename
				tradename=""
				if trade<>"" then
					if rs("tradeSort")="" then
					else
						tradename=rs("tradeSort")
					end if
				end if
				Response.write ""&tradename&""
			end if
			Response.write "" & vbcrlf & "</td>" & vbcrlf & "<td width=""12%"" class=""name""><div align=""center"">" & vbcrlf & ""
			if lie_4=1 then
				catename=""
				if cateid<>"" then
					if rs("cateName")="" then
			...
			elseif lie_4=2 then
				...
				if trim(share)<>"" then
					if share="1" then
						...
						share = replace(share,","," ")
						share = replace(trim(share)," ",",")
						i4 = 1
						if share&""<>"" then
							set rs7 = conn.execute("select name from gate WITH(NOLOCK) where ord in("& share &") order by cateid")
							while rs7.eof = false
								Response.write(rs7("name") & "&nbsp;")
								if i4 mod 4 = 0 then Response.write("<br>")
								i4 = i4 + 1
'if i4 mod 4 = 0 then Response.write("<br>")
								rs7.movenext
							wend
			...
			elseif lie_4=3 then
				...
				Response.write year(date7)
				Response.write "-"
				Response.write year(date7)
				Response.write month(date7)
				Response.write "-"
				Response.write month(date7)
				Response.write day(date7)
				Response.write "</div>" & vbcrlf & ""
			ElseIf lie_4 = 11 Then
				Response.write(zdy1)
			ElseIf lie_4 = 12 Then
				Response.write(zdy2)
			ElseIf lie_4 = 13 Then
				Response.write(zdy3)
			ElseIf lie_4 = 14 Then
				Response.write(zdy4)
			ElseIf lie_4 = 15 Then
				Response.write(zdy5)
			ElseIf lie_4 = 16 Then
				Response.write(zdy6)
			end if
			...
			if open_3_14=3 or (open_3_14=1 and CheckPurview(intro_3_14,trim(cateid))=True) then
				Response.write "<input type=""button"" name=""Submit3"" value=""详情""  onClick=""javascript:window.open('content.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "&spState="
				Response.write request("spState")
				Response.write "','newwin_xm','width=' + 1180 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>" & vbcrlf & "              "
				Response.write request("spState")
			end if
			canAddDesign = True
			Call showDesignButton(conn, 1 ,rs("ord"), canAddDesign , pwurl(rs("ord")) , "list")
			If spState = 0 then
				if open_3_4=3 or (open_3_4=1 and CheckPurview(intro_3_4,trim(cateid))=True) then
					Response.write "" & vbcrlf & "             <input type=""button"" name=""Submit32"" value=""共享""  onClick=""window.open('share.asp?"
					Response.write sdk.ReturnURL("ord=" & pwurl(rs("ord")) &"")
					Response.write "','newwin5','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""  />" & vbcrlf & ""
					Response.write sdk.ReturnURL("ord=" & pwurl(rs("ord")) &"")
				end if
			end if
			if session("personzbintel2007")=rs("cateid_sp") and rs("sp")&""<>"0" and rs("sp")&""<>"-1"  and  (open_3_16=3 or CheckPurview(intro_3_16,trim(cateid))=True) then
				Response.write sdk.ReturnURL("ord=" & pwurl(rs("ord")) &"")
				Response.write "" & vbcrlf & "                               <input type=""button"" name=""Submit33"" value=""审批""  onClick=""javascript:if(!hwndsp||hwndsp.closed){hwndsp=window.open('set.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "','neww3win','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');}else{hwndsp.focus();}""/>" & vbcrlf & " "
				Response.write pwurl(rs("ord"))
			end if
			if open_3_2=3 or (open_3_2=1 and CheckPurview(intro_3_2,trim(cateid))=True) then
			...
			if open_3_3=3 or (open_3_3=1 and CheckPurview(intro_3_3,trim(cateid))=True) then
				Response.write "" & vbcrlf & " <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='delete6.asp?"
				Response.write sdk.ReturnURL("ord=" & rs("ord") &"")
				Response.write "'}""/>" & vbcrlf & ""
			end if
			Response.write "" & vbcrlf & "        </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "   "
			rs.movenext
		loop
		if lie_2=3 or lie_2=4 or lie_2=5 then
			Response.write "" & vbcrlf & "   <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td height=""27"" colspan=""2"" class=""name"" align=""right"">&nbsp;本页合计：</td>" & vbcrlf & "            <td align=""right"" class=""red"">" & vbcrlf & "              "
			if lie_2=3 and open_3_21<>0 then
				Response.write Formatnumber(summoney1,num_dot_xs,-1)
'if lie_2=3 and open_3_21<>0 then
			end if
			if lie_2=4 and open_3_21<>0 then
				Response.write Formatnumber(summoney3,num_dot_xs,-1)
'if lie_2=4 and open_3_21<>0 then
			end if
			if lie_2=5 and open_3_21<>0 then
				Response.write Formatnumber(summoney_pay,num_dot_xs,-1)
'if lie_2=5 and open_3_21<>0 then
			end if
			Response.write "</td>" & vbcrlf & "                <td colspan=""3"" class=""red"" align=""left"">" & vbcrlf & "             "
			if lie_2=3 and open_3_21<>0 then
				Response.write "RMB "& Formatnumber(summoney1_1,num_dot_xs,-1)
'if lie_2=3 and open_3_21<>0 then
			end if
			if lie_2=4 and open_3_21<>0 then
				Response.write "RMB "& Formatnumber(summoney3_1,num_dot_xs,-1)
'if lie_2=4 and open_3_21<>0 then
			end if
			if lie_2=5 and open_3_21<>0 then
				Response.write "RMB "& Formatnumber(summoney_pay_1,num_dot_xs,-1)
'if lie_2=5 and open_3_21<>0 then
			end if
			Response.write "</td>" & vbcrlf & "                </td>" & vbcrlf & "     </tr>" & vbcrlf & "   <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td height=""27"" colspan=""2"" class=""name"" align=""right"">&nbsp;所有合计：</td>" & vbcrlf & "            <td align=""right"" class=""red"">" & vbcrlf & "         "
			if lie_2=3 and open_3_21<>0 then
				Response.write Formatnumber(summoney1_2,num_dot_xs,-1)
'if lie_2=3 and open_3_21<>0 then
			end if
			if lie_2=4 and open_3_21<>0 then
				Response.write Formatnumber(summoney2_2,num_dot_xs,-1)
'if lie_2=4 and open_3_21<>0 then
			end if
			if lie_2=5 and open_3_21<>0 then
				Response.write Formatnumber(summoney_pay_2,num_dot_xs,-1)
'if lie_2=5 and open_3_21<>0 then
			end if
			Response.write "</td>" & vbcrlf & "                <td colspan=""3"" class=""red"" align=""left"">" & vbcrlf & "             "
			if lie_2=3 and open_3_21<>0 then
				Response.write "RMB "& Formatnumber(summoney1_3,num_dot_xs,-1)
'if lie_2=3 and open_3_21<>0 then
			end if
			if lie_2=4 and open_3_21<>0 then
				Response.write "RMB "& Formatnumber(summoney3_2,num_dot_xs,-1)
'if lie_2=4 and open_3_21<>0 then
			end if
			if lie_2=5 and open_3_21<>0 then
				Response.write "RMB "& Formatnumber(summoney_pay_3,num_dot_xs,-1)
'if lie_2=5 and open_3_21<>0 then
			end if
			Response.write "</td>" & vbcrlf & "                </td>" & vbcrlf & "     </tr>" & vbcrlf & "   "
		end if
		Response.write "" & vbcrlf & "             " & vbcrlf & "      </table>" & vbcrlf & "</td>" & vbcrlf & "       </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""7%""><div align=""center"">全选" & vbcrlf & "          <input name=""chkall"" type=""checkbox"" id=""chkall"" value=""all"" onclick=""mm(this.form)"" />" & vbcrlf & "    </div></td>" & vbcrlf & "    <td width=""30%"">  " & vbcrlf & "        <div  style=""white-space:nowrap;"">    " & vbcrlf & "            "
		Response.write "</td>" & vbcrlf & "                </td>" & vbcrlf & "     </tr>" & vbcrlf & "   "
		if open_3_3=1 or open_3_3=3 then
			Response.write "" & vbcrlf & "                     <input type=""submit"" onClick=""return test();"" name=""Submit2"" value=""批量删除""  class=""anybutton2""/>"
		end if
		if (open_3_6=1 or open_3_6=3) And spState<>2  then
			Response.write "" & vbcrlf & "                             <input type=""submit"" name=""Submit422"" value=""批量指派""  onClick=""ask();"" class=""anybutton2""/>" & vbcrlf & "             "
		end if
		if (open_3_4=3 or open_3_4=1) And spState<>2 and spState<>1 then
			Response.write "" & vbcrlf & "                     <input type=""button"" name=""Submit426"" value=""批量共享""  onclick=""ask3();"" class=""anybutton2""/>" & vbcrlf & "        "
		end if
		Response.write "" & vbcrlf & "        </div>" & vbcrlf & "    </td>" & vbcrlf & "    <td width=""63%""><div align=""right"">" & vbcrlf & "    "
		Response.write recCount
		Response.write "个 | "
		...
		Response.write "页 | &nbsp;"
		Response.write page_count
		Response.write "条信息/页&nbsp;&nbsp;" & vbcrlf & "        <input id=""curp1"" name=""currpage""  type=text   onpropertychange=""formatData(this,'int');"" maxlength=8 onkeyup=""checkDot('currpage',0,8)""  size=3 />" & vbcrlf & "          &nbsp;" & vbcrlf & "    <input type=""button"" name=""Submit422"" value=""跳转"" onClick=""gotourl('currPage='+document.getElementById('curp1').value);""  class=""page""/>" & vbcrlf & "    "
		Response.write page_count
		if currpage=1 then
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""150"" colspan=""3""><div align=""right""><p>&nbsp;" & vbcrlf & "      </p>" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</form>" & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "" & vbcrlf & "<script language=javascript>" & vbcrlf & "window.ReturnUrl = """
	Response.write sdk.ReturnURL("")
	...
	Response.write "" & vbcrlf & "</script>" & vbcrlf & "<script src= ""../Script/ce_result.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=javascript></script>" & vbcrlf & "" & vbcrlf & ""
	action1="项目列表"
	call close_list(1)
	Response.write "" & vbcrlf & "     </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""User"" style=""z-index:10000;position:absolute;left:310px;top:10px;width:150px; height:400;display:none;"">" & vbcrlf & "<table width=""150"" height=""350""  border=""0"" cellpadding=""-2"" cellspacing=""-2""> "& vbcrlf &"   <tr> "& vbcrlf &"     <td height=""139""> "& vbcrlf &"         <table width=""150"" height=""115"" bgcolor=""#ecf5ff"" border=""0"" > "& vbcrlf &"           <tr  valign=""middle""> "& vbcrlf &"                      <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=1');""><font color=""#2F496E"">按项目主题排序(降)</font></a> </td>" & vbcrlf & "         </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=2');""><font color=""#2F496E"">按项目主题排序(升)</font></a> </td>" & vbcrlf & "                </tr>" & vbcrlf & "   <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=3');""><font color=""#2F496E"">按项目编号排序(降)</font></a> </td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=4');""><font color=""#2F496E"">按项目编号排序(升)</font></a> </td>" & vbcrlf & "              </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=5');""><font color=""#2F496E"">按项目总额排序(降)</font></a> </td>" & vbcrlf & "             </tr>" & vbcrlf & "           <tr valign=""middle"">" & vbcrlf & "                      <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=6');""><font color=""#2F496E"">按项目总额排序(升)</font></a></td>" & vbcrlf & "         </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf& "                       <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=7');""><font color=""#2F496E"">按预计金额排序(降)</font></a> </td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tr valign=""middle"">" & vbcrlf & "                      <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=8');""><font color=""#2F496E"">按预计金额排序(升)</font></a></td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=9');""><font color=""#2F496E"">按添加日期排序(降)</font></a> </td>" & vbcrlf & "                </tr>" & vbcrlf & "            <tr  valign=""middle""> "& vbcrlf &"                      <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl96E"">按发现日期排序(升)</font></a> </td>" & vbcrlf & "         </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=13');""><font color=""#2F496E"">按项目阶段指数(降)</font></a> </td>" & vbcrlf & "               </tr>" & vbcrlf & "           <tr  valign=""middle""> "& vbcrlf &"                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl###"" onclick=""gotourl('px=15');""><font color=""#2F496E"">按项目主负责人(降)</font></a> </td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=16');""><font color=""#2F496E"">按项目主负责人(升)</font></a> </td>" & vbcrlf & "               </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=17');""><font color=""#2F496E"">按最近联系排序(降)</font></a> </td>" & vbcrlf & "               </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=18');""><font color=""#2F496E"">按最近联系排序(升)</font></a> </td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=19');""><font color=""#2F496E"">按最后审批日期(降)</font></a> </td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "                     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=20');""><font color=""#2F496E"">按最后审批日期(升)</font></a> </td>" & vbcrlf & "               </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & "</body>" & vbcrlf & "</html>"
