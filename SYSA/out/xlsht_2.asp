		...
		for i=1 to num_dot_xs
			...
			dotstr_num=""
				for i=1 to num1_dot
					...
					xlApplication.ActiveSheet.Columns(14).ColumnWidth=18
					xlApplication.ActiveSheet.Columns(14).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(15).ColumnWidth=10
					...
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+4).ColumnWidth=20
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+4).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+5).ColumnWidth=20
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+5).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+6).ColumnWidth=10
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+6).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+7).ColumnWidth=10
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					...
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+11).ColumnWidth=10
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+11).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+11).NumberFormatLocal = "#,##0."&saledotstr_num&"_ "
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+12).ColumnWidth=10
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+12).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
					xlApplication.ActiveSheet.Columns(j0+12).NumberFormatLocal = "#,##0."&dotstr&"_ "
					xlApplication.ActiveSheet.Columns(j0).HorizontalAlignment=3
...
'elseif zt="7" then
	...
	do until rs.eof
		...
		set rs7=server.CreateObject("adodb.recordset")
		sql7="select name,khid from tel where ord="&rs("company")&""
		rs7.open sql7,conn,1,1
		if rs7.eof then
			name1=""
			hkid=""
		...
		set rs7=server.CreateObject("adodb.recordset")
		sql7="select isnull(sum(num1),0) as num1,isnull(sum(num2),0) as num2 from contractlist where contract="&rs("ord")&" and del=1"
		rs7.open sql7,conn,1,1
		if not rs7.eof then
			num_1=cdbl(rs7("num1"))
			num_2=cdbl(rs7("num2"))
...
'if open_5_21<>0 then
		xlWorksheet.Cells(1+i,14).Value = zt1
'if open_5_21<>0 then
		xlWorksheet.Cells(1+i,14).font.Size=10
'if open_5_21<>0 then
		xlWorksheet.Cells(1+i,15).Value = zt2
'if open_5_21<>0 then
...
'if not rs77.eof then
		...
		xlWorksheet.Cells(1+i,j2).font.Size=10
		set rs88=nothing
		xlWorksheet.Cells(1+i,j2+1).Value = cateid
		set rs88=nothing
		xlWorksheet.Cells(1+i,j2+1).font.Size=10
		set rs88=nothing
		xlWorksheet.Cells(1+i,j2+2).Value = addcate
		set rs88=nothing
		xlWorksheet.Cells(1+i,j2+2).font.Size=10
		set rs88=nothing
		xlWorksheet.Cells(1+i,j2+3).Value = date7
		set rs88=nothing
		...
		if rs1.eof then
			...
			do until rs1.eof
				...
				xlWorksheet.Cells(1+i,2).font.Size=10
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+4).Value = product
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+4).font.Size=10
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+4).HorizontalAlignment=1
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+5).Value = order1
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+5).font.Size=10
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+6).Value = type1
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+6).font.Size=10
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+7).Value = num1
				money1=zbcdbl(rs1("money1"))
				xlApplication.ActiveSheet.Columns(j2+7).NumberFormatLocal = "#,##0."&dotstr_num&"_ "
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+7).font.Size=10
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+8).Value = num2
				money1=zbcdbl(rs1("money1"))
				xlApplication.ActiveSheet.Columns(j2+8).NumberFormatLocal = "#,##0."&dotstr_num&"_ "
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+8).font.Size=10
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+9).Value = num3
				money1=zbcdbl(rs1("money1"))
				xlApplication.ActiveSheet.Columns(j2+9).NumberFormatLocal = "#,##0."&dotstr_num&"_ "
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+9).font.Size=10
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+10).Value = num4
				money1=zbcdbl(rs1("money1"))
				xlApplication.ActiveSheet.Columns(j2+10).NumberFormatLocal = "#,##0."&dotstr_num&"_ "
				money1=zbcdbl(rs1("money1"))
				xlWorksheet.Cells(1+i,j2+10).font.Size=10
				money1=zbcdbl(rs1("money1"))
				if open_5_21<>0 then
					xlWorksheet.Cells(1+i,j2+11).Value = price1
'if open_5_21<>0 then
				else
					xlWorksheet.Cells(1+i,j2+11).Value = ""
'if open_5_21<>0 then
				end if
				xlWorksheet.Cells(1+i,j2+11).font.Size=10
				if open_5_21<>0 then
'if open_5_21<>0 then
					xlWorksheet.Cells(1+i,j2+12).Value = money1
'if open_5_21<>0 then
				else
					xlWorksheet.Cells(1+i,j2+12).Value = ""
'if open_5_21<>0 then
				end if
				xlWorksheet.Cells(1+i,j2+12).font.Size=10
'if open_5_21<>0 then
				rs1.movenext
			loop
		end if
