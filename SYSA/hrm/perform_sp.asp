...
prop=trim(SaveRequestForm("prop"))
sp_id=replace(trim(SaveRequestForm("sp_id"))," ","")
Dtype=trim(SaveRequestUrl("type"))
if lv="" or isnumeric(lv)=false then call jsBack(inName1&"不能为空")
if sortid="" or isnumeric(sortid)=false then call jsBack(inName2&"不能为空")
if title=""   then call jsBack(inName3&"不能为空")
if prop=""  then call jsBack(inName5&"不能为空")
if sp_id=""  then call jsBack(inName6&"不能为空")
if Dtype="add" then
action1="绩效审批添加"
has_sp=0
sql="select count(*) from hr_perform_sort where sortID='"&sortid&"' and del=0 and isnull(khzt,0)<>1"
...
set rss=nothing
if has_sp>0 then
call jsBack("此类审批下尚有未结束的考核单据，不能修改审批流程。")
end if
call add_logs(1)
set rs=server.CreateObject("adodb.recordset")
sql="select * from hr_perform_sp_list  where (title='"&title&"' or lv="&lv&" or sp_id="&sp_id&") and sortid="&sortid&"  and del=0"
rs.open sql,conn,1,1
if rs.eof then
conn.execute "insert into hr_perform_sp_list (title,lv,sortid,prop,sp_id,creator,inDate,del) values('"&title&"',"&lv&","&sortid&","&prop&","&sp_id&","&session("personzbintel2007")&",'"&now()&"',0)"
call jsLocat("添加成功","perform_sp.asp")
else
call jsBack("同一类型的级别及名称、审批人不能重复")
end if
rs.close
set rs=nothing
...
call add_logs(1)
set rs=server.CreateObject("adodb.recordset")
sql="select * from hr_perform_sp_list  where (title='"&title&"' or lv="&lv&" or sp_id="&sp_id&") and sortid="&sortid&"  and del=0 and id<>"&ord&""
rs.open sql,conn,1,1
if rs.eof then
conn.execute "update hr_perform_sp_list set title='"&title&"',lv="&lv&",sortid="&sortid&",prop="&prop&",sp_id="&sp_id&"  where id="&ord&" and del=0"
call jsLocat("修改成功","perform_sp.asp")
else
call jsBack("同一类型的级别及名称、审批人不能重复")
end if
end if
...
set rs=server.CreateObject("adodb.recordset")
sql="select * from hr_perform_sp_list  where id="&ord&" and del=0"
rs.open sql,conn,1,1
if not rs.eof then
title=rs("title")
ord=rs("id")
...
call add_logs(2)
set rs=server.CreateObject("adodb.recordset")
sql="select * from hr_perform_sort  where sortid=(select sortid from hr_perform_sp_list where id="&ord&") and del=0 and isnull(khzt,0)<>1"
rs.open sql,conn,1,1
if not rs.eof then
title=rs("title")
call jsBack("有未结束的关联绩效考核主题【"&title&"】,不允许删除！")
call db_close : Response.end
else
call hrDelPower(ord,"hr_perform_sp_list",open_81_3,intro_81_3)
conn.execute "delete hr_perform_sp_list  where id="&ord&""
call jsLocat("删除成功","perform_sp.asp")
end if
rs.close
set rs=nothing
end if
Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "        <tr>" & vbcrlf & "          <td class=""place"">绩效审批设置</td>" & vbcrlf & "          <td>&nbsp;</td>" & vbcrlf & "          <td align=""right"">&nbsp;</td>" & vbcrlf & "          <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""3	2"" /></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        "
if open_81_13=1 or ((open_81_2=3 or CheckPurview(intro_81_2,trim(creator))=True) and ord<>"") then
Response.write "" & vbcrlf & "        <tr class=""top"">" & vbcrlf & "          <td  height=""26"" colspan=""2"" class=""name"">绩效审批基本设置</td>" & vbcrlf & "        </tr>" & vbcrlf & "        <form method=""post"" name=""demo""  action=""perform_sp.asp?action=update"" id=""demo"" onsubmit=""return Validator.Val	idate(this,2)"">" & vbcrlf & "          <tr >" & vbcrlf & "            <td width=""14%""  height=""26"" align=""right"" class=""name"">"
...
rs.close
set rs=nothing
Response.write "" & vbcrlf & "              </select>" & vbcrlf & "              <span class=""red"">*</span><a href=""perform_sp_class.asp"" style=""color:#FF0000"">点击这里</a>添加分类</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""14%""  height=""26"" align=""rig	ht"" class=""name"">"
...
Response.write """ size=""30"" dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1至50个字之间"">" & vbcrlf & "              <span id=""ulist1"" class=""red"">*&nbsp;</span></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <!-- <tr >" & vbcrlf & "            <td width=""14%""  height=""26"" align=""right	"" class=""name"">"
Response.write inName4
Response.write "：</td>" & vbcrlf & "            <td  height=""26""  class=""name""><input name=""base""  type=""text"" id=""base"" onkeyup=""value=value.replace(/[^\d\.]/g,'')"" value="""
Response.write base
Response.write """ size=""10"" dataType=""Limit"" min=""1"" max=""10""  >" & vbcrlf & "              <span class=""red"">*</span>(例：100)</td>" & vbcrlf & "          </tr>-->" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""14%""  height=""26"" align=""right"" class=""name"">"
Response.write base
Response.write inName5
Response.write "：</td>" & vbcrlf & "            <td  height=""26""  class=""name""><input name=""prop""  type=""text"" id=""prop"" onkeyup=""value=value.replace(/[^\d\.]/g,'')"" value="""
Response.write prop
Response.write """ size=""10"" dataType=""Limit"" min=""1"" max=""10"" msg=""必填""  >" & vbcrlf & "              <span class=""red"">*</span>(%)</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""14%""  height=""26"" align=""right"" class=""name"">"
Response.write inName1
Response.write "：</td>" & vbcrlf & "            <td  height=""26""  class=""name""><select name=""lv"" size=""1"" id=""lv"" dataType=""Limit"" min=""1""  msg=""必选"">" & vbcrlf & "                "
for i=1 to 12
Response.write "" & vbcrlf & "                <option value="""
Response.write i
Response.write """ "
...
Response.write "</option>" & vbcrlf & "                "
next
Response.write "" & vbcrlf & "              </select>" & vbcrlf & "              <span class=""red""> *</span></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""14%""  height=""26"" align=""right"" class=""name""><span class=""name"">"
Response.write inName6
Response.write "：</span></td>" & vbcrlf & "            <td>"
set rs=server.CreateObject("adodb.recordset")
sql="select ord,name from gate where ord in (select ord from power where (qx_open=1 or qx_open=3) and sort1=81 and sort2=16) and del=1 order by ord asc"
rs.open sql,conn,1,1
if rs.RecordCount<=0 then
else
do until rs.eof
Response.write "" & vbcrlf & "              <input name=""sp_id"" type=""radio"" id=""sp_id"" value="""
Response.write rs("ord")
Response.write """ "
if sp_id=rs("ord") then
...
rs.close
set rs=nothing
Response.write "" & vbcrlf & "            </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""14%""  height=""26"" align=""right"" class=""name"">&nbsp;</td>" & vbcrlf & "            <td  height=""26""  class=""name"">"
if action="edit" then
Response.write "" & vbcrlf & "              <input name=""button22"" class=""anybutton2"" onClick=""javascript:document.all.demo.action='perform_sp.asp?action=update&type=save&ord="
Response.write pwurl(ord)
Response.write "'""  value=""保  存"" type=""submit"">" & vbcrlf & "              "
else
Response.write "" & vbcrlf & "              <input name=""button23"" class=""anybutton2"" value=""保  存""  onClick=""javascript:document.all.demo.action='perform_sp.asp?action=update&type=add'"" type=""submit"">" & vbcrlf & "              "
end if
Response.write "" & vbcrlf & "              &nbsp;&nbsp;</td>" & vbcrlf & "          </tr>" & vbcrlf & "        </form>" & vbcrlf & ""
end if
set rs=server.CreateObject("adodb.recordset")
sql="select * from hr_perform_sp_list  where del=0 order by sortid,lv asc"
rs.open sql,conn,1,1
if not rs.eof then
Response.write "" & vbcrlf & "        <tr class=""top"">" & vbcrlf & "          <td  height=""26"" colspan=""2"" class=""name"">绩效审批列表</td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "          <td  height=""26"" colspan=""2"" class=""name""><table width=""100%"" border=""0"" cellpadding	=""4"" cellspacing=""1"" bgcolor=""#C0CCDD"" >" & vbcrlf & "              <tr class=""top"">" & vbcrlf & "                <td width=""14%"" align=""center""><div align=""center"">"
Response.write inName1
Response.write "</div></td>" & vbcrlf & "                <td width=""20%"" align=""center""><div align=""center"">"
Response.write inName3
Response.write "</div></td>" & vbcrlf & "                <td width=""15%"" align=""center""><div align=""center"">"
Response.write inName2
...
do while not rs.eof
D_title=rs("title")
D_sortid=performClassName(rs("sortid"))
D_prop=rs("prop")
D_lv=rs("lv")
D_sp_id=getgatename(rs("sp_id"))
ord=rs("id")
Response.write "" & vbcrlf & "              <tr>" & vbcrlf & "                <td align=""center"">"
Response.write D_lv
Response.write "</td>" & vbcrlf & "                <td align=""center"">"
Response.write D_title
Response.write "</td>" & vbcrlf & "                <td align=""center"">"
Response.write D_sortid
Response.write "</td>" & vbcrlf & "                <!--<td align=""center"">"
Response.write D_sortid
Response.write D_base
Response.write "</td>-->" & vbcrlf & "                <td align=""center"">"
Response.write D_base
Response.write D_prop
Response.write "%</td>" & vbcrlf & "                <td align=""center"">"
Response.write D_sp_id
Response.write "</td>" & vbcrlf & "                <td align=""center"">&nbsp;" & vbcrlf & "                         "
has_sp=0
sql="select count(*) from hr_perform_sort where sortID='"&rs("sortid")&"' and del=0 and isnull(khzt,0)<>1 "
set rss=conn.execute(sql)
if not rss.eof then
has_sp=rss(0)
end if
rss.close
set rss=nothing
Response.write "" & vbcrlf & "                  <input name=""button3"" class=""anybutton2"" "
if has_sp>0 then Response.write " disabled='disabled' " end if
Response.write " value=""修改"" onClick=""javascript:window.location.href='perform_sp.asp?action=edit&ord="
Response.write pwurl(ord)
Response.write "'"" type=""button"">" & vbcrlf & "                  &nbsp;" & vbcrlf & "                  <input name=""button32"" class=""anybutton2"" "
if has_sp>0 then Response.write " disabled='disabled' " end if
Response.write " value=""删除"" onClick=""if(confirm('确认删除？')){javascript:window.location.href='perform_sp.asp?action=del&ord="
Response.write pwurl(ord)
Response.write "'}"" type=""button"">" & vbcrlf & "                  &nbsp;</td>" & vbcrlf & "              </tr>" & vbcrlf & "              "
k=k+1
rs.movenext
loop
...
rs.close
Response.write "" & vbcrlf & "      </table></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "    <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "        <tr>" & vbcrlf & "          <td height=""1130"" ><div align=""center""></div></td>" & vbcrlf & "        </tr>"	& vbcrlf &  "     </table></td>" & vbcrlf & "  </tr> "& vbcrlf & "</table>" & vbcrlf
call db_close
