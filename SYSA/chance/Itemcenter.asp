...
' if len(Application("_ZBM_Lib_Cache") & "") = 0 thenss
...
'If ii<Len(formula) then
	...
	Sub Page_Load
		...
		"<style>html { overflow-y: scroll; overflow-x:scroll;}" & vbcrlf & _
		"<script type='text/JavaScript' src='../inc/echarts.min.js'></script>"& vbcrlf &_
...
'Response.write "</div>"
		Response.write "' class='smdate' onmouseup='datedlg.show()' name='date4' id=""date4"" readonly style=""MARGIN-TOP:0px;*top:3px; HEIGHT:17px;width:103px; line-height:20px;*line-height:22px; padding-top:0px;""></font> " & vbcrlf & "            <INPUT id=""u14"" type=""button"" class=""oldbutton"" value=""检索""  style=""height:20px;line-height:17px;"" onclick=""Fnitemzygl($BI('date3').value,$BI('date4').value,'c');""> </span>        " & vbcrlf & "        </td></tr>" & vbcrlf & "        <tr><td><div id=""itemzygl""><!--Ajax数据呈现，资源管理统计结果--></div></td></tr>" & vbcrlf & "                  <TBODY>" & vbcrlf & "        </table>" & vbcrlf & " </td></tr>" & vbcrlf & " " & vbcrlf & "  <tr><td>        " & vbcrlf & "<TABLE id='mycontent' style=""BORDER-COLLAPSE: collapse; WORD-WRAP: break-word; WORD-BREAK: break-all;table-layout:fixed;width:100%;BORDER-BOTTOM: #c0ccdd 1px solid; BORDER-LEFT: #c0ccdd 1px solid; BORDER-TOP: #c0ccdd 1px solid; BORDER-RIGHT: #c0ccdd 1px solid"" border=0 cellPadding=3 width=""100%"">" & vbcrlf & "         <TBODY>" & vbcrlf & "         <tr>" & vbcrlf & "                    <td class=""resetTableBg"" style=""text-align:left;BORDER-BOTTOM: #c0ccdd 1px solid; BORDER-LEFT: #c0ccdd 1px solid; BORDER-TOP: #c0ccdd 1px solid; BORDER-RIGHT: #c0ccdd 1px solid;font-weight:bold;*padding-top:0"" height=""34"" valign=""middle"" width=""100%"" align=middle >&nbsp;项目阶段工作<span style=""margin-left:300px;""><font style=""font-weight:normal"">" & vbcrlf & "            <span onclick=""Fndatetimefy($BI('date5').value,'ss')"" style=""cursor:hand;""><img class=""resetElementHidden"" src=""../images/main_2.gif"" style=""*margin-bottom:-8px;"" width=""8"" height=""8"" border=""0"" align=""absMiddle"" /><img class=""resetElementShow"" src=""../skin/default/images/ico16/lvwbar_1_1.png"" style=""*margin-bottom:-8px;display:none;vertical-align:0;"" width=""8"" height=""8"" border=""0"" align=""absMiddle"" /> 上一月</span>&nbsp;" & vbcrlf & "            自 <input type='text' name='date5' id=""date5"" value='"
'Response.write "</div>"
		Response.write year(date)&"-"&month(date)&"-01"
'Response.write "</div>"
		Response.write "' readonly class='smdate' onmouseup='datedlg.show()' style=""MARGIN-TOP:0px;*top:3px; HEIGHT:17px;width:103px; line-height:20px;*line-height:22px; padding-top:0px;"" > " & vbcrlf & "            至：<input type='text' value='"
'Response.write "</div>"
		Response.write dateadd("d",-1,dateadd("m",1,CDate(year(now())&"-"&month(now())&"-01")))
'Response.write "</div>"
		Response.write "' class='smdate' onmouseup='datedlg.show()' name='date6' id=""date6"" readonly style=""MARGIN-TOP:0px;*top:3px; HEIGHT:17px;width:103px; line-height:20px;*line-height:22px; padding-top:0px;"">" & vbcrlf & "             <span onclick=""Fndatetimefy($BI('date5').value,'xx')"" style=""cursor:hand;"">&nbsp;下一月 <img class=""resetElementHidden"" src=""../images/main_1.gif"" width=""8"" height=""8"" border=""0""  /><img class=""resetElementShow"" src=""../skin/default/images/ico16/lvwbar_4_1.png"" style=""display:none;vertical-align:0;"" width=""8"" height=""8"" border=""0""  /></span>" & vbcrlf & "            &nbsp;&nbsp;项目主题：&nbsp;&nbsp;<input name=""xmzt"" type=""text"" id=""xmzt"" size=""14"" maxlength=""50""></font>" & vbcrlf & "             <INPUT id=""u15"" type=""button"" class=""oldbutton"" value=""检索"" onclick=""Fnitemjdgz($BI('date5').value,$BI('date6').value,$BI('xmzt').value,'c');""> </span>" & vbcrlf & "        </td></tr>" & vbcrlf & "        <tr><td><div id=""itemjdgz""><!--Ajax数据呈现，阶段工作统计结果--></div></td></tr>" & vbcrlf & "                   <TBODY>" & vbcrlf & "        </table>" & vbcrlf & "  </td></tr>" & vbcrlf & " " & vbcrlf & "  <tr><td>          " & vbcrlf & "        <TABLE id='mycontent' style=""BORDER-COLLAPSE: collapse; WORD-WRAP: break-word; WORD-BREAK: break-all;table-layout:fixed;width:100%;BORDER-BOTTOM: #c0ccdd 1px solid; BORDER-LEFT: #c0ccdd 1px solid; BORDER-TOP: #c0ccdd 1px solid; BORDER-RIGHT: #c0ccdd 1px solid"" border=0 cellPadding=3 width=""100%"">" & vbcrlf & "                <TBODY>" & vbcrlf & "                <tr>" & vbcrlf & "                    <td class=""resetTableBg"" style=""text-align:left;BORDER-BOTTOM: #c0ccdd 1px solid; BORDER-LEFT: #c0ccdd 1px solid; BORDER-TOP: #c0ccdd 1px solid; BORDER-RIGHT: #c0ccdd 1px solid;font-weight:bold;*padding-top:0"" height=""34"" valign=""middle"" width=""100%"" align=middle >" & vbcrlf & "                    &nbsp;项目进度一览<span style=""margin-left:300px;""><font style=""font-weight:normal"">发现日期：</font>" & vbcrlf & "                    <font style=""font-weight:normal"">自</font> <input type='text' name='t3_1' id='t3_1'  value='"
		Response.write year(date)&"-"&month(date)&"-01"
't' name='t3_1' id='t3_1'  value='"
...
'IF glist&"" <> "" Then
		...
		If v1="" Then v1=CDate("2000-1-1")
'v3 = " and a.title like '%"&v3&"%'"
		If v2="" Then v2=CDate("2100-1-1")
'v3 = " and a.title like '%"&v3&"%'"
		Set lvw = New listview
		lvw.sql = "select a.title as '项目主题',a.date1 as '发现日期',a.date2 as '预计日期',"&money1&"  as '项目总额',b.sort1 as '项目阶段',"&money2&"  as '预计金额',a.ord as '操作',isnull(a.cateid,0) as cateid from chance a WITH(NOLOCK) inner join sortjh2 b WITH(NOLOCK) on a.complete2=b.ord where "&cateidw&" (a.date1 between '"&v1&"' and '"&v2&"')"&v4&v3&" and isnull(sp,0)=0 and del=1"
		lvw.checkbox = False
		lvw.indexbox = False
		lvw.CurrSum=False
		lvw.AllSum=False
...
'lvw.headers(8).display="none"
	...
	Function GetReportLinks(f,v1,v2,addcate)
		...
		dps=v1
		Case "链接"
		r="PMGanttchart.asp?ord="&v2&"&title="&v1&"&cord="&addcate
		dps="甘特图"
		Case else
		End Select
		If Len(r) > 0 Then
