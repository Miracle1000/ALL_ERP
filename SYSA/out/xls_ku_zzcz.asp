				...
				for i=1 to StorePrice_dot_num
					...
					dotstr_num=""
						for i=1 to num1_dot
							...
							xlApplication.ActiveSheet.Columns(1).ColumnWidth=6
							xlApplication.ActiveSheet.Columns(1).HorizontalAlignment=3
							xlApplication.ActiveSheet.Columns(1).NumberFormatLocal = "@"
							...
							if isOpenProductAttrV then
								xlApplication.ActiveSheet.Columns(12).ColumnWidth=12
								xlApplication.ActiveSheet.Columns(12).HorizontalAlignment=3
								xlApplication.ActiveSheet.Columns(13).ColumnWidth=12
								xlApplication.ActiveSheet.Columns(13).HorizontalAlignment=3
							end if
							dim PriceColNum : PriceColNum = 0
							if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(12+ProductAttrColNum).ColumnWidth=10
'if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(12+ProductAttrColNum).HorizontalAlignment=3
'if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(12+ProductAttrColNum).NumberFormatLocal = "#,##0."&dotPricestr&"_ "
'if IsOpenRKPrice then
								PriceColNum = 1
							end if
							xlApplication.ActiveSheet.Columns(12+ProductAttrColNum + PriceColNum).ColumnWidth=10
							PriceColNum = 1
							xlApplication.ActiveSheet.Columns(12+ProductAttrColNum+ PriceColNum).HorizontalAlignment=3
							PriceColNum = 1
							xlApplication.ActiveSheet.Columns(12+ProductAttrColNum+ PriceColNum).NumberFormatLocal = "#,##0."&dotstr_num&"_ "
							PriceColNum = 1
							if isOpenAssUnit then
								xlApplication.ActiveSheet.Columns(13+ProductAttrColNum+ PriceColNum).ColumnWidth=12
'if isOpenAssUnit then
								xlApplication.ActiveSheet.Columns(13+ProductAttrColNum+ PriceColNum).HorizontalAlignment=3
'if isOpenAssUnit then
							end if
							dim MoneyColNum : MoneyColNum = 0
							if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(13+ProductAttrColNum+AssColNum+ PriceColNum).ColumnWidth=10
'if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(13+ProductAttrColNum+AssColNum+ PriceColNum).HorizontalAlignment=3
'if IsOpenRKPrice then
								xlApplication.ActiveSheet.Columns(13+ProductAttrColNum+AssColNum+ PriceColNum).NumberFormatLocal = "#,##0."&dotstr&"_ "
'if IsOpenRKPrice then
								MoneyColNum = 1
							end if
							xlApplication.ActiveSheet.Columns(13+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).ColumnWidth=10
							MoneyColNum = 1
							xlApplication.ActiveSheet.Columns(13+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).HorizontalAlignment=3
							MoneyColNum = 1
							xlApplication.ActiveSheet.Columns(14+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).ColumnWidth=10
							MoneyColNum = 1
							xlApplication.ActiveSheet.Columns(14+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).HorizontalAlignment=3
							MoneyColNum = 1
							xlApplication.ActiveSheet.Columns(15+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).ColumnWidth=10
							MoneyColNum = 1
							xlApplication.ActiveSheet.Columns(15+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).HorizontalAlignment=3
							MoneyColNum = 1
							xlApplication.ActiveSheet.Columns(16+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).ColumnWidth=10
							MoneyColNum = 1
							xlApplication.ActiveSheet.Columns(16+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).HorizontalAlignment=3
							MoneyColNum = 1
							xlWorksheet.Cells(1,1).Value = "序号"
							...
							xlWorksheet.Cells(1,3).Value = "编号"
							xlWorksheet.Cells(1,3).font.Size=10
							xlWorksheet.Cells(1,3).font.bold=true
							xlWorksheet.Cells(1,4).Value = "状态"
							xlWorksheet.Cells(1,4).font.Size=10
							xlWorksheet.Cells(1,4).font.bold=true
							xlWorksheet.Cells(1,5).Value = "经手人"
							xlWorksheet.Cells(1,5).font.Size=10
							xlWorksheet.Cells(1,5).font.bold=true
							xlWorksheet.Cells(1,6).Value = "日期"
							xlWorksheet.Cells(1,6).font.Size=10
							xlWorksheet.Cells(1,6).font.bold=true
							xlWorksheet.Cells(1,7).Value = "概要"
							xlWorksheet.Cells(1,7).font.Size=10
							xlWorksheet.Cells(1,7).font.bold=true
							xlWorksheet.Cells(1,8).Value = "产品名称"
							xlWorksheet.Cells(1,8).font.Size=10
							xlWorksheet.Cells(1,8).font.bold=true
							xlWorksheet.Cells(1,9).Value = "产品编号"
							xlWorksheet.Cells(1,9).font.Size=10
							xlWorksheet.Cells(1,9).font.bold=true
							xlWorksheet.Cells(1,10).Value = "产品型号"
							xlWorksheet.Cells(1,10).font.Size=10
							xlWorksheet.Cells(1,10).font.bold=true
							xlWorksheet.Cells(1,11).Value = "单位"
							xlWorksheet.Cells(1,11).font.Size=10
							xlWorksheet.Cells(1,11).font.bold=true
							if isOpenProductAttrV then
								xlWorksheet.Cells(1,12).Value = "产品属性1"
								xlWorksheet.Cells(1,12).font.Size=10
								xlWorksheet.Cells(1,12).font.bold=true
								xlWorksheet.Cells(1,13).Value = "产品属性2"
								xlWorksheet.Cells(1,13).font.Size=10
								xlWorksheet.Cells(1,13).font.bold=true
							end if
							if IsOpenRKPrice then
								xlWorksheet.Cells(1,12+ProductAttrColNum).Value = "单价"
'if IsOpenRKPrice then
								xlWorksheet.Cells(1,12+ProductAttrColNum).font.Size=10
'if IsOpenRKPrice then
								xlWorksheet.Cells(1,12+ProductAttrColNum).font.bold=true
'if IsOpenRKPrice then
							end if
							xlWorksheet.Cells(1,12+ProductAttrColNum + PriceColNum).Value = "数量"
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,12+ProductAttrColNum + PriceColNum).font.Size=10
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,12+ProductAttrColNum + PriceColNum).font.bold=true
'if IsOpenRKPrice then
							if isOpenAssUnit then
								xlWorksheet.Cells(1,13+ProductAttrColNum + PriceColNum).Value = "辅助数量"
'if isOpenAssUnit then
								xlWorksheet.Cells(1,13+ProductAttrColNum + PriceColNum).font.Size=10
'if isOpenAssUnit then
								xlWorksheet.Cells(1,13+ProductAttrColNum + PriceColNum).font.bold=true
'if isOpenAssUnit then
							end if
							if IsOpenRKPrice then
								xlWorksheet.Cells(1,13+ProductAttrColNum+AssColNum + PriceColNum).Value = "总价"
'if IsOpenRKPrice then
								xlWorksheet.Cells(1,13+ProductAttrColNum+AssColNum + PriceColNum).font.Size=10
'if IsOpenRKPrice then
								xlWorksheet.Cells(1,13+ProductAttrColNum+AssColNum + PriceColNum).font.bold=true
'if IsOpenRKPrice then
							end if
							xlWorksheet.Cells(1,13+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).Value = "仓库"
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,13+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,13+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.bold=true
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,14+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).Value = "包装"
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,14+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,14+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.bold=true
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,15+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).Value = "件数"
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,15+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,15+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.bold=true
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,16+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).Value = "备注"
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,16+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
							xlWorksheet.Cells(1,16+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.bold=true
'if IsOpenRKPrice then
							Response.Flush
							set rs1=server.CreateObject("adodb.recordset")
							sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=34 and sort2=10"
							rs1.open sql1,conn,1,1
							if rs1.eof then
								open_34_10=0
								intro_34_10=0
							else
								open_34_10=rs1("qx_open")
								intro_34_10=rs1("qx_intro")
							end if
							rs1.close
							if open_34_10=3 then
								list=""
							elseif open_34_10=1 then
								list=" and cateid in ("&intro_34_10&") "
							else
								list=" and 1=2 "
							end if
							Str_Result=""
							isnew = request("isnew")
							If isnumeric(isnew & "") = False Then
								isnew = "0"
							end if
							If isnew = "0" Then
								Str_Result = Str_Result & " and isnull(isnew,0) = 0 "
							else
								Str_Result = Str_Result & " and isnull(isnew,0) = 1 "
							end if
							dim m1,m2,zzState,zzCondi,Title,C1
							m1=iif(isdate(request("ret")),request("ret"),"")
							m2=iif(isdate(request("ret2")),request("ret2"),"")
							zzState=trim(request("zzState"))
							zzCondi=trim(Request("zzCondi"))
							Title=request("Title")
							if m1<>"" then
								Str_Result=Str_Result&" and CONVERT(VARCHAR(10),date3,120) >='"&m1&"'"
							end if
							if m2<>"" then
								Str_Result=Str_Result&" and CONVERT(VARCHAR(10),date3,120) <=dateadd(s,-1,dateadd(d,1,'"&m2&"'))"
'if m2<>"" then
							end if
							if zzState<>"" then
								if zzState=1 then
									Str_Result=Str_Result&" and zztype=1 "
								elseif zzState=0 then
									Str_Result=Str_Result&" and (zztype=0 or zztype is null) "
								end if
							end if
							if Title<>"" then
								select case zzCondi
								case 0
								Str_Result=Str_Result&" and charindex('"&Title&"',title)>0 "
								case 1
								Str_Result=Str_Result&" and charindex('"&Title&"',zzid)>0 "
								case else
								Str_Result=Str_Result&" and charindex('"&Title&"',intro)>0 "
								end select
							end if
							Str_Result="where del=1 "&list&""&Str_Result
							dim i,p,top,x
							i=1
							p=1
							x=0
							set rs=server.CreateObject("adodb.recordset")
							sql="select *,CONVERT(VARCHAR(20),date3,120) date3,(select name from gate where gate.ord=kuzz.cateid) as catename from kuzz   "&Str_Result&" order by ord desc"
							rs.open sql,conn,1,1
							C1=rs.recordcount
							If isnew = "1" Then
								xlApplication.Init "组装单资料_"&session("name2006chen")&".xls",C1
							else
								xlApplication.Init "组装拆装清单资料_"&session("name2006chen")&".xls",C1
							end if
							do while not rs.eof
								ord=rs("ord")
								top=ord
								...
								if complate="0" then
									completename="未组装"
								elseif complate="1" then
									if zztype=1 then
										completename="拆装中"
									else
										completename="组装中"
									end if
								elseif complate="3" then
									if zztype=1 then
										completename="拆装完成"
									else
										completename="组装完成"
								...
								x=x+1
								completename="组装完成"
								xlWorksheet.Cells(i+1,1).Value = x
								completename="组装完成"
								xlWorksheet.Cells(i+1,1).font.Size=10
								completename="组装完成"
								xlWorksheet.Cells(i+1,1).font.bold=false
								completename="组装完成"
								xlWorksheet.Cells(i+1,2).Value = title
								completename="组装完成"
								xlWorksheet.Cells(i+1,2).font.Size=10
								completename="组装完成"
								xlWorksheet.Cells(i+1,2).font.bold=false
								completename="组装完成"
								xlWorksheet.Cells(i+1,3).Value = zzid
								completename="组装完成"
								xlWorksheet.Cells(i+1,3).font.Size=10
								completename="组装完成"
								xlWorksheet.Cells(i+1,3).font.bold=false
								completename="组装完成"
								xlWorksheet.Cells(i+1,4).Value = completename
								completename="组装完成"
								xlWorksheet.Cells(i+1,4).font.Size=10
								completename="组装完成"
								xlWorksheet.Cells(i+1,4).font.bold=false
								completename="组装完成"
								xlWorksheet.Cells(i+1,5).Value = catename
								completename="组装完成"
								xlWorksheet.Cells(i+1,5).font.Size=10
								completename="组装完成"
								xlWorksheet.Cells(i+1,5).font.bold=false
								completename="组装完成"
								xlWorksheet.Cells(i+1,6).Value = date3
								completename="组装完成"
								xlWorksheet.Cells(i+1,6).font.Size=10
								completename="组装完成"
								xlWorksheet.Cells(i+1,6).font.bold=false
								completename="组装完成"
								xlWorksheet.Cells(i+1,7).Value = intro
								completename="组装完成"
								xlWorksheet.Cells(i+1,7).font.Size=10
								completename="组装完成"
								xlWorksheet.Cells(i+1,7).font.bold=false
								completename="组装完成"
								dim k2
								sql = "select * from kuoutlist2 where contract="&top&" and sort1=9 order by date7 asc,id asc"
...
'if rss.eof then
									if zztype=1 then
										xlWorksheet.Cells(i+1,2).Value = "【父件明细】"
'if zztype=1 then
									else
										xlWorksheet.Cells(i+1,2).Value = "【子件明细】"
'if zztype=1 then
									end if
									xlWorksheet.Cells(i+1,2).font.Size=10
'if zztype=1 then
									xlWorksheet.Cells(i+1,2).font.bold=false
'if zztype=1 then
									xlWorksheet.Cells(i+1,8).Value = "没有信息"
'if zztype=1 then
									xlWorksheet.Cells(i+1,8).font.Size=10
'if zztype=1 then
									xlWorksheet.Cells(i+1,8).font.bold=false
'if zztype=1 then
									xlWorksheet.Cells(i+1,9).Value = ""
'if zztype=1 then
									xlWorksheet.Cells(i+1,9).font.Size=10
'if zztype=1 then
									xlWorksheet.Cells(i+1,9).font.bold=false
'if zztype=1 then
									xlWorksheet.Cells(i+1,10).Value = ""
'if zztype=1 then
									xlWorksheet.Cells(i+1,10).font.Size=10
'if zztype=1 then
									xlWorksheet.Cells(i+1,10).font.bold=false
'if zztype=1 then
									xlWorksheet.Cells(i+1,11).Value = ""
'if zztype=1 then
									xlWorksheet.Cells(i+1,11).font.Size=10
'if zztype=1 then
									xlWorksheet.Cells(i+1,11).font.bold=false
'if zztype=1 then
									if isOpenProductAttrV then
										xlWorksheet.Cells(1+i,12).Value = ""
'if isOpenProductAttrV then
										xlWorksheet.Cells(1+i,12).font.Size=10
'if isOpenProductAttrV then
										xlWorksheet.Cells(1+i,13).Value =  ""
'if isOpenProductAttrV then
										xlWorksheet.Cells(1+i,13).font.Size=10
'if isOpenProductAttrV then
									end if
									if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,12+ProductAttrColNum).Value = ""
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,12+ProductAttrColNum).font.Size=10
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,12+ProductAttrColNum).font.bold=false
'if IsOpenRKPrice then
									end if
									xlWorksheet.Cells(i+1,12+ProductAttrColNum+PriceColNum).Value = ""
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,12+ProductAttrColNum+PriceColNum).font.Size=10
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,12+ProductAttrColNum+PriceColNum).font.bold=false
'if IsOpenRKPrice then
									if isOpenAssUnit then
										xlWorksheet.Cells(i+1,13+ProductAttrColNum+ PriceColNum).Value = ""
'if isOpenAssUnit then
										xlWorksheet.Cells(i+1,13+ProductAttrColNum+ PriceColNum).font.Size=10
'if isOpenAssUnit then
										xlWorksheet.Cells(i+1,13+ProductAttrColNum+ PriceColNum).font.bold=false
'if isOpenAssUnit then
									end if
									if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum).Value = ""
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum).font.Size=10
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum).font.bold=false
'if IsOpenRKPrice then
									end if
									xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).Value = ""
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.bold=false
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,14+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).Value = ""
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,14+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,14+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.bold=false
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,15+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).Value = ""
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,15+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,15+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.bold=false
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,16+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).Value = ""
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,16+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
									xlWorksheet.Cells(i+1,16+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.bold=false
'if IsOpenRKPrice then
								else
									do until rss.eof
										ord=rss("ord")
										...
										num3=zbcdbl(rss("num3"))
										price1=zbcdbl(rss("price1"))
										...
										numall1=numall1+cdbl(rss("num1"))
										AssistNum=rss("AssistNum")
										numall2=numall2+cdbl(rss("num2"))
										AssistNum=rss("AssistNum")
										numall3=numall3+cdbl(rss("num3"))
										AssistNum=rss("AssistNum")
										sql6 = "select * from product where ord="&rss("ord")&" and del=1"
										...
										if AssistUnit&""<>"" then
											set rs7=server.CreateObject("adodb.recordset")
											sql7="select sort1 from sortonehy  where ord="&AssistUnit&""
											rs7.open sql7,conn,1,1
											if rs7.eof then
												AssistUnitName=""
											else
										...
										if ck<>"" then
											set rs7=server.CreateObject("adodb.recordset")
											sql7="select sort1 from sortck  where ord="&ck&""
											rs7.open sql7,conn,1,1
											if rs7.eof then
												ckname=""
											else
...
'if zztype=1 then
										xlWorksheet.Cells(i+1,2).font.bold=false
'if zztype=1 then
										xlWorksheet.Cells(i+1,8).Value = k6
'if zztype=1 then
										xlWorksheet.Cells(i+1,8).font.Size=10
'if zztype=1 then
										xlWorksheet.Cells(i+1,8).font.bold=false
'if zztype=1 then
										xlWorksheet.Cells(i+1,9).Value = order1
'if zztype=1 then
										xlWorksheet.Cells(i+1,9).font.Size=10
'if zztype=1 then
										xlWorksheet.Cells(i+1,9).font.bold=false
'if zztype=1 then
										xlWorksheet.Cells(i+1,10).Value = type1
'if zztype=1 then
										xlWorksheet.Cells(i+1,10).font.Size=10
'if zztype=1 then
										xlWorksheet.Cells(i+1,10).font.bold=false
'if zztype=1 then
										xlWorksheet.Cells(i+1,11).Value = unitname
'if zztype=1 then
										xlWorksheet.Cells(i+1,11).font.Size=10
'if zztype=1 then
										xlWorksheet.Cells(i+1,11).font.bold=false
'if zztype=1 then
										if isOpenProductAttrV then
											xlWorksheet.Cells(1+i,12).Value = GetProductAttrNameById(ProductAttr1)
'if isOpenProductAttrV then
											xlWorksheet.Cells(1+i,12).font.Size=10
'if isOpenProductAttrV then
											xlWorksheet.Cells(i+1,12).font.bold=false
'if isOpenProductAttrV then
											xlWorksheet.Cells(1+i,13).Value =  GetProductAttrNameById(ProductAttr2)
'if isOpenProductAttrV then
											xlWorksheet.Cells(1+i,13).font.Size=10
'if isOpenProductAttrV then
											xlWorksheet.Cells(i+1,13).font.bold=false
										end if
										if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,12+ProductAttrColNum).Value = Formatnumber(price1,StorePrice_dot_num,-1)
'if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,12+ProductAttrColNum).font.Size=10
'if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,12+ProductAttrColNum).font.bold=False
'if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,12+ProductAttrColNum).NumberFormatLocal = "￥#,##0.00;￥-#,##0.00"
'if IsOpenRKPrice then
										end if
										xlWorksheet.Cells(i+1,12+ProductAttrColNum+ PriceColNum).Value = Formatnumber(zbcdbl(Rss("num1")),num1_dot,-1)
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,12+ProductAttrColNum+ PriceColNum).font.Size=10
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,12+ProductAttrColNum+ PriceColNum).font.bold=false
'if IsOpenRKPrice then
										if isOpenAssUnit then
											if AssistUnitName&""<>""then
												if AssistNum&""="" then AssistNum=0
												xlWorksheet.Cells(i+1,13+ProductAttrColNum+ PriceColNum).Value =Formatnumber(zbcdbl(AssistNum),num1_dot,-1)&" "&AssistUnitName
'if AssistNum&""="" then AssistNum=0
											else
												xlWorksheet.Cells(i+1,13+ProductAttrColNum+ PriceColNum).Value =""
'if AssistNum&""="" then AssistNum=0
...
'if AssistNum&""="" then AssistNum=0
										...
										if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum).Value = money1
'if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum).font.Size=10
'if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum).font.bold=False
'if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum).NumberFormatLocal = "￥#,##0.00;￥-#,##0.00"
'if IsOpenRKPrice then
										end if
										xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).Value = ckname
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.bold=false
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,14+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).Value = sortname
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,14+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,14+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.bold=false
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,15+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).Value = js
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,15+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,15+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.bold=false
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,16+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).Value = intro
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,16+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,16+ProductAttrColNum+AssColNum+ PriceColNum+ MoneyColNum).font.bold=false
'if IsOpenRKPrice then
								...
								Rss.close
								numall1=0
								sql = "select * from kuinlist where caigou="&top&" and sort1=9 order by id asc"
								set Rss = server.CreateObject("adodb.recordset")
								Rss.open sql,conn,1,1
								if rss.eof then
									i=i+1
...
'if IsOpenRKPrice then
									...
									do until rss.eof
										...
										dateyx=rss("dateyx")
										bz=rss("bz")
										price2=zbcdbl(rss("price1"))
										money2=zbcdbl(rss("money1"))
										intro=rss("intro")
										num1=zbcdbl(rss("num1"))
										num2=zbcdbl(rss("num2"))
										date2=rss("date2")
...
'if isOpenProductAttrV then
										...
										if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,12+ProductAttrColNum).Value = Formatnumber(price2,StorePrice_dot_num,-1)
'if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,12+ProductAttrColNum).font.Size=10
'if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,12+ProductAttrColNum).font.bold=False
...
'if AssistNum&""="" then AssistNum=0
										...
										if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum).Value = money2
'if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum).font.Size=10
'if IsOpenRKPrice then
											xlWorksheet.Cells(i+1,13+ProductAttrColNum+AssColNum+ PriceColNum).NumberFormatLocal = "￥#,##0.00;￥-#,##0.00"
...
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,15+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.bold=false
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,15+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).Value = intro
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,15+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.Size=10
'if IsOpenRKPrice then
										xlWorksheet.Cells(i+1,15+ProductAttrColNum+AssColNum + PriceColNum+ MoneyColNum).font.bold=false
'if IsOpenRKPrice then
							...
							rs.close
							set rs=Nothing
							Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>组装清单资料导出全部完成!</b></font> 100"";CountTXTok.innerHTML=""<B>恭喜!组装清单资料导出成功,共有"&(p-1)&"条记录!</B>"";</script>"
							set rs=Nothing
							Response.write "" & vbcrlf & "</BODY>" & vbcrlf & "</HTML>" & vbcrlf & ""
							Set fs = CreateObject("Scripting.FileSystemObject")
							tfile=Server.MapPath("组装拆装清单资料_"&session("name2006chen")&".xls")
							...
							Response.write """><font class=""red""><strong><u>下载导出的组装拆装清单资料</u></strong></font></a></p>" & vbcrlf & "" & vbcrlf & ""
