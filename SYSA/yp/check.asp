...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/yp_check.js?ver="
	Response.write Application("sys.info.jsver")
	...
	'Response.write Application("sys.info.jsver")
	set rs88 = conn.execute("EXEC erp_getdjbh 803,"&session("personzbintel2007"))
	khid=rs88(0).value
	rs88.close
	set rs88=nothing
	sql="select name from gate where ord="&session("personzbintel2007")
	set rs=conn.execute(sql)
	if not rs.eof then
		regname=rs("name")
	end if
	set rs=nothing
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">盘点添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td> "& vbcrlf &   "        </tr> "& vbcrlf & "      </table>   "& vbcrlf & "        <form action=""save_check.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""data"" onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">       " & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" ><div align=""left""><strong>基本情况</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "            <div align=""right"">" & vbcrlf & "                 <input type=""button"" name=""Submit4222"" value=""暂存""  class=""page"" onClick=""ask1('1')""/>" & vbcrlf & "                   <input type=""button""name=""Submit422"" value=""保存""  class=""page"" onClick=""ask1('2')""/> "& vbcrlf &  "            <input type=""reset"" value=""重填"" class=""page"" name=""B22""> "& vbcrlf &    "            </div></td> "& vbcrlf &  "       </tr> "& vbcrlf & "      <tr> "& vbcrlf &   "    <td width=""14%"" height=""37""><div align=""right"">盘点主题：</div></td>" & vbcrlf & "           <td width=""22%"" class=""gray""><input name=""che_title"" type=""text"" id=""che_title"" dataType=""Limit"" min=""1"" max=""200""  msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">盘点编号：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray""><input name=""che_bh"" type=""text"" id=""che_bh"" value="""
	Response.write khid
	Response.write """" & vbcrlf & "                  class='jquery-auto-bh' autobh-options='cfgId:803,autoCreate:false'" & vbcrlf & "              ></td>" & vbcrlf & "        <td width=""10%""><div align=""right"">盘点人员：</div></td>" & vbcrlf & "        <td width=""24%"" class=""gray"">"
	'Response.write khid
	Response.write regname
	Response.write "<input type=""hidden"" id=""che_cateid"" name=""che_cateid"" value="""
	Response.write session("personzbintel2007")
	Response.write """/></td>" & vbcrlf & "     </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""14%"" height=""37""><div align=""right"">盘点时间：</div></td>" & vbcrlf & "          <td height=""37"" colspan=""5"" class=""gray""><div align=""left"">" & vbcrlf & "       <input name=""che_time"" type=""text"" size=""9"" value="""
	Response.write date
	Response.write """ id=""daysOfMonthPosx"" onmouseup=toggleDatePicker(""daysOfMonthx"",""date.che_time"") readonly=""true"">" & vbcrlf & "          <DIV id=daysOfMonthx style=""POSITION: absolute;z-index:10""></DIV>" & vbcrlf & "            </div></td>" & vbcrlf & "     </tr>" & vbcrlf & "      <tr>" & vbcrlf & "    <td colspan=""6"" align=""center"">" & vbcrlf & "              <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">" & vbcrlf & "         <tr>" & vbcrlf & "                    <td valign=""top"">" & vbcrlf & "                 <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                      <tr class=""top"">" & vbcrlf & "                          <td height=""27"" colspan=""14""><div align=""left""><a href=""###"" onClick=""setMx()"">添加明细<img src=""../images/add.gif"" border=""0"" style=""border:0px;""/></a></div></td>" & vbcrlf & "                     </tr>" & vbcrlf & "                   <tr>" & vbcrlf & "                            <td width=""9%"" height=""27""><div align=""center""><strong>名称</strong></div></td>" & vbcrlf & "                          <td width=""9%"" height=""27""><div align=""center""><strong>编号</strong></div></td>" & vbcrlf & "                               <td width=""9%"" height=""27""><div align=""center""><strong>型号</strong></div></td>" & vbcrlf & "                               <tdwidth=""6%"" height=""27""><div align=""center""><strong>单位</strong></div></td>" & vbcrlf & "                               <td width=""8%"" height=""27""><div align=""center""><strong>账面数量</strong></div></td>" & vbcrlf & "                           <td width=""8%"" height=""27""><div align=""center""><strong>实际数量</strong></div></td>" & vbcrlf & "<td width=""8%"" height=""27""><div align=""center""><strong>盈亏数量</strong></div></td>" & vbcrlf & "                           <td width=""6%"" height=""27""><div align=""center""><strong>仓库</strong></div></td>" & vbcrlf & "                               <td width=""7%""><div align=""center""><strong>批号</strong></div></td>" & vbcrlf & "                         <td width=""6%""><div align=""center""><strong>序列号</strong></div></td>" & vbcrlf & "                         <td width=""8%""><div align=""center""><strong>生产日期</strong></div></td>" & vbcrlf & "                             <td width=""7%""><div align=""center""><strong>有效日期</strong></div></td>" & vbcrlf & "                             <td width=""9%"" height=""27""><div align=""center""><strong>备注</strong></div></td>" & vbcrlf & "                   </tr>           " & vbcrlf & "                        <tbody id=""prod_mx"">" & vbcrlf & "                      </tbody>" & vbcrlf & "                        </table></td>" & vbcrlf & "           </tr>" & vbcrlf & "           </table></td>" & vbcrlf & "        </tr>" & vbcrlf & "        <tr>" & vbcrlf & "            <td><p align=""right"">盘点备注：</td>" & vbcrlf & "                <td colspan=""5"" class=""gray""><textarea name=""che_note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "                    <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=che_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no""WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "           </tr> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray""><p align=""center"">" & vbcrlf & "           <input type=""button"" name=""Submit4223"" value=""暂存""  class=""page"" onClick=""ask1('1')""/>" & vbcrlf & "                <input type=""button"" name=""Submit425"" value=""保存""  class=""page"" onClick=""ask1('2')""/>" & vbcrlf & "                <input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr>              " & vbcrlf & "    </table>" & vbcrlf & "    </form>" & vbcrlf & "</td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"">" & vbcrlf & "        <tr>" & vbcrlf & "            <td><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "      </table>" & vbcrlf & " </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""ddd"" class=""easyui-dialog"" icon=""icon-search"" title=""选择明细""  style=""width:900px;height:500px;padding:5px;background:#fafafa;top:0px"" closed=""true"">" & vbcrlf & "      <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "   <select name=""u_type"" id=""u_type"" onchange=""searchMe(this.value,1);"" style=""width:80px;"">" & vbcrlf & "       <option value="""">用品分类</option>" & vbcrlf & "        "
	Response.write date
	...
	Response.write t
	Response.write """ type=""text"" size=""12"" style=""width:100px;"" onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & "   用品编号：<input  id=""u_bh"" name=""sKeyword"" value="""
	Response.write t
	...
	Response.write t
	Response.write """ type=""text"" size=""10"" style=""width:80px;"" onpropertychange=""searchMe(this.value,1);"">" & vbcrlf & "    </div>" & vbcrlf & "  <div id=""selectiddiv"" region=""center"" border=""false"" style=""padding:5px;background:#fff;border:1px solid #ccc;width:100%"">" & vbcrlf & "      </div>" & vbcrlf & " <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "            <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$('#ddd').window('close');"">关闭</a>         " & vbcrlf & "        </div>" & vbcrlf & "</div>" & vbcrlf & ""
	Response.write t
	action1="用品盘点添加"
	call close_list(1)
