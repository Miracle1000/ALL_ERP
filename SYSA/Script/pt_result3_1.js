...
function getChildNodes(pid,cname,px_1,topid,lt,sflg)
{
	if($("a"+pid)!=null)
	{
		if($("a"+pid).cells[0].innerHTML.length==0)
		{
		  var url = "../inc/getChildNodes.asp?pid="+pid+"&l="+cname+"&px_1="+px_1+"&top="+topid+"&lt="+lt+"&s="+sflg+"&"+Math.round(Math.random()*100);
