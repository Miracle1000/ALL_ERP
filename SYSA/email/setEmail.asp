...
'If Not rs.Eof Then
	...
	if open_77_19<>1 then
		Dim theTestObj(1,1)
		theTestObj(1,0) = "JMail.SmtpMail"
		theTestObj(1,1) = "(Dimac JMail 邮件收发)"
		set rs=server.CreateObject("adodb.recordset")
		...
		if EmailName="" then
			set rs=server.CreateObject("adodb.recordset")
			sql="select email from gate  where ord="&session("personzbintel2007")&" "
			rs.open sql,conn,1,1
			if not  rs.eof then
				EmailName=rs("email")
			end if
		...
		set rs=server.CreateObject("adodb.recordset")
		sql="select top 1 * from email_Signature  where addcate="&session("personzbintel2007")&" order by SignatureDefault desc "
		rs.open sql,conn,1,1
		if rs.eof then
			SignatureName=""
			SignatureCon=""
		...
		Response.write "<script language='javascript'> alert('友情提示：您的邮件权限已关闭！'); history.back();</script> "
		call db_close : Response.end
	end if
	Function GetObjInfo(startnum,endnum)
		dim i,Outstr
		Outstr = Outstr & "<Select name=SmtpObj Style='width:260px;'>"
		if SmtpObj="" then
			Outstr = Outstr & "<OPTION value='' style='color: #FF0000;' selected>请选择</OPTION>"
		end if
		for i=startnum to endnum
			If Not IsObjInstalled(theTestObj(i,0)) Then
				if SmtpObj=theTestObj(i,0) then selectobj="selected" else selectobj=""
				Outstr = Outstr & "<OPTION style='color: #FF0000;' value=" & theTestObj(i,0) & " "& selectobj & ">" & theTestObj(i,0) &" &nbsp; " & theTestObj(i,1)&"&nbsp; ×" & "</OPTION>"
			else
'if SmtpObj=theTestObj(i,0) then selectobj="selected" else selectobj=""
				Outstr = Outstr & "<OPTION value=" & theTestObj(i,0) & " "& selectobj & ">" & theTestObj(i,0)&" &nbsp; " & theTestObj(i,1)&" &nbsp; √" & "</OPTION>"
			end if
		next
		Outstr = Outstr & "</Select>"
		Response.write(Outstr)
	end function
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "        <tr>" & vbcrlf & "          <td class=""place"">邮箱设置</td>" & vbcrlf & "          <td>&nbsp;</td>" & vbcrlf & "          <td align=""right"">&nbsp;</td>" & vbcrlf & "          <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32""/></td>" & vbcrlf &     "    </tr> "& vbcrlf &   "    </table>" & vbcrlf &     "  <form method=""post"" name=""demo""  action=""Update_setEmail.asp"" id=""demo"" style=""margin:0"" >" & vbcrlf & "     <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "          <tr class=""top"">" & vbcrlf & "            <td  height=""26"" class=""name"" colspan=""4"">默认用户名、密码和服务器设置</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""10%"" height=""26"" class=""name"" align=""right""> Email地址：</td>" & vbcrlf & "                        <td width=""30%"">" & vbcrlf & "              <input name=""EmailName"" onBlur=""autoGetEmailServer(this.value)"" type=""text"" id=""EmailUrl""  value="""
	Response.write EmailUrl
	Response.write """ size=""23"" maxlength=""50""   dataType=""Limit"" min=""1"" max=""15""  msg=""必填"">" & vbcrlf & "              <span class=""red""> *</span><span  id=""urlID"">(例：admin@163.com)</span></td>" & vbcrlf & "                     <td width=""10%"" class=""name"" align=""right"">Email密码：</td>" & vbcrlf & "                   <td width=""50%"">" & vbcrlf & "              <input name=""EmailPasswd"" type=""password"" id=""EmailPasswd""  value="""
	Response.write EmailPasswd
	Response.write """ size=""23"" maxlength=""100""   dataType=""Limit"" min=""1"" max=""15""  msg=""必填"">" & vbcrlf & "              <span class=""red"">*</span>(邮箱密码)</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td  height=""26"" class=""name""  align=""right"">smtp服务器：</td>" & vbcrlf & "                   <td>" & vbcrlf & "              <input name=""Emailsmtp"" type=""text"" id=""Emailsmtp""  value="""
	Response.write Emailsmtp
	Response.write """ size=""23"" maxlength=""50""   dataType=""Limit"" min=""1"" max=""15""  msg=""必填"">" & vbcrlf & "              <span class=""red"">*</span>(例：smtp.163.com)</td>" & vbcrlf & "                      <td class=""name""  align=""right"">pop3服务器：</td>" & vbcrlf & "                   <td>" & vbcrlf & "              <input name=""EmailPop3"" type=""text"" id=""EmailPop3""  value="""
	Response.write EmailPop3
	Response.write """ size=""23"" maxlength=""50""   dataType=""Limit"" min=""1"" max=""15""  msg=""必填"">" & vbcrlf & "              <span class=""red"">*</span>(例：pop3.163.com)&nbsp;&nbsp;" & vbcrlf & "              <input name=""EmailOrd"" type=""hidden"" value="""
	Response.write EmailOrd
	Response.write """></td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr>" & vbcrlf & "            <td  height=""26"" class=""name""  align=""right"">&nbsp;smtp端口号：</td>" & vbcrlf & "                        <td>" & vbcrlf & "              <input name=""smtpPort"" type=""text"" id=""smtpPort""  onKeyUp=""value=value.replace(/[^ \d]/g,'')"" value="""
	Response.write port
	Response.write """ size=""15"" maxlength=""50""   dataType=""Limit"" min=""1"" max=""15""  msg=""必填"">" & vbcrlf & "              <span class=""red"">*</span>&nbsp;&nbsp;(如非465，请咨询邮件提供商)</td>" & vbcrlf & "                 <td class=""name""  align=""right"">&nbsp;是否ssl加密：</td>" & vbcrlf & "                    <td>" & vbcrlf & "            <input type=""radio"" name=""ssl"" value=""1""  onclick=""document.getElementById('smtpPort').value='465'""  "
	if ssl="1"  then
		Response.write " checked"
	end if
	Response.write ">" & vbcrlf & "              是" & vbcrlf & "              <input name=""ssl"" type=""radio"" value=""2"" onclick=""document.getElementById('smtpPort').value='25'""  "
	if ssl="2" or ssl="" then
		Response.write " checked"
	end if
	Response.write ">" & vbcrlf & "              否<span class=""red"">*</span>&nbsp;&nbsp;(默认不加密，如非请咨询邮件提供商)</td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr>" & vbcrlf & "            <td  height=""26"" class=""name""  align=""right"">邮件组件：</td><td colspan=""3"">"
	Response.write GetObjInfo(1,1)
	Response.write " </td>" & vbcrlf & "          </tr>" & vbcrlf & "                 <tr>" & vbcrlf & "            <td  height=""26"" class=""name""  align=""right"">删除邮件：</td><td colspan=""3"">" & vbcrlf & "              <input name=""delMail"" type=""radio"" value=""1"" "
	if delMail="1" then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "              删除" & vbcrlf & "              <input type=""radio"" name=""delMail"" value=""0"" "
	if delMail="0" or delMail=""  then
		Response.write "checked"
	end if
	Response.write ">" & vbcrlf & "              不删除<span class=""red"">*</span>(本地下载邮件后，是否删除邮件服务器上的邮件？)</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td  height=""26"" class=""name""  align=""right"">单次收取邮件数量：</td><td colspan=""3"">" & vbcrlf & "            <select name=""receiveTotal"" id=""receiveTotal""> "& vbcrlf &   "          <option value=""10"" "
	if receiveNum=10 then
		Response.write "  selected "
	end if
	Response.write ">10</option>" & vbcrlf & "            <option value=""20"" "
	if receiveNum=20 then
		Response.write "  selected "
	end if
	Response.write ">20</option>" & vbcrlf & "            <option value=""30"" "
	if receiveNum=30 then
		Response.write "  selected "
	end if
	Response.write ">30</option>" & vbcrlf & "            <option value=""50"" "
	if receiveNum=50 then
		Response.write "  selected "
	end if
	Response.write ">50</option>" & vbcrlf & "            <option value=""100"" "
	if receiveNum=100 then
		Response.write "  selected "
	end if
	Response.write ">100</option>" & vbcrlf & "            <option value=""200"" "
	if receiveNum=200 then
		Response.write "  selected "
	end if
	Response.write ">200</option>" & vbcrlf & "            <option value=""0"" "
	if receiveNum=0 then
		Response.write "  selected "
	end if
	Response.write ">全部</option>" & vbcrlf & "            </select>" & vbcrlf & "            </td>" & vbcrlf & "            </tr>" & vbcrlf & "          "
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from email_sender  where gate="&session("personzbintel2007")&" "
	rs.open sql,conn,1,1
	if not rs.eof then
		k=1
		Response.write "" & vbcrlf & "          <tr class=""top"">" & vbcrlf & "            <td  height=""26"" class=""name""  colspan=""4"">Email列表（多个邮箱新增、修改，请在以下设置）</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td  height=""26"" class=""name"" colspan=""4"">" & vbcrlf & "             <table width=""100%"" border=""0"" cellpadding=""4"" cellspacing=""1"" bgcolor=""#C0CCDD"" >" & vbcrlf & "                <tr class=""top"">" & vbcrlf & "                  <td width=""6%"" align=""center""><div align=""center"">序号</div></td>" & vbcrlf & "                  <td width=""15%"" align=""center""><div align=""center"">Email地址</div></td>" & vbcrlf &             "      <td width=""16%"" align=""center""><div align=""center"">smtp服务器</div></td> "& vbcrlf &           "        <td width=""17%"" align=""center""><div align=""center"">pop3服务器</div></td>" & vbcrlf &              "     <tdwidth=""18%"" align=""center""><div align=""center"">是否为默认邮箱</div></tdwidth=>" & vbcrlf & "                  <td width=""28%"" align=""center""><div align=""center"">操作</div></td>" & vbcrlf & "                </tr>" & vbcrlf & "                "
		do while not rs.eof
			EmailNameList=rs("EmailName")
			EmailsmtpList=rs("Emailsmtp")
			EmailPop3List=rs("EmailPop3")
			EmailUrlList=rs("EmailUrl")
			defaultList=rs("EmailDefault")
			ordList=rs("ord")
			if defaultList="" then defaultList=0
			if defaultList=1 then
				defaultList="是"
			else
				defaultList="否"
			end if
			...
			Response.write EmailNameList
			Response.write "</td>" & vbcrlf & "                  <td align=""center"">"
			Response.write EmailsmtpList
			Response.write "</td>" & vbcrlf & "                  <td align=""center"">"
			Response.write EmailPop3List
			Response.write "</td>" & vbcrlf & "                  <td align=""center"">"
			Response.write defaultList
			Response.write "</td>" & vbcrlf & "                  <td align=""center""><input name=""button2"" class=""anybutton2"" value=""新增""  onClick=""javascript:window.open('EmailAccount.asp','newEmail','width=' + 930 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" type=""button"">&nbsp;<input name=""button3"" class=""anybutton2"" value=""修改"" onClick=""javascript:window.open"
			Response.write ordList
			Response.write "&Result=Edit&t="
			Response.write now
			Response.write "','newEmail','width=' + 930 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=120,top=120')"" type=""button"">&nbsp;<input name=""button32"" class=""anybutton2"" value=""删除"" onClick=""if(confirm('确认删除？')){javascript:window.open('EmailAccount.asp?ord="
			Response.write now
			Response.write ordList
			Response.write "&Result=del','newEmail','width=' + 930 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=120,top=120')}"" type=""button"">&nbsp;"
			Response.write ordList
			if defaultList<>"是" then
				Response.write "<input name=""button""  onClick=""if(confirm('确认设为默认邮箱？')){javascript:window.location.href='EmailAccount.asp?ord="
				Response.write ordList
				Response.write "&Result=setDefault'}""  class=""anybutton2"" value=""设为默认"" type=""button"">"
			end if
	...
	rs.close
	Response.write "" & vbcrlf & "          <tr class=""top"" >" & vbcrlf & "            <td  height=""26"" class=""name"" colspan=""4"">默认签名设置</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td  height=""26"" class=""name""  align=""right"">签名名称：</td>" & vbcrlf & "                    <td colspan=""3"">" & vbcrlf & "              <input name=""SignatureName"" type=""text"" id=""SignatureName""  value="""
	Response.write SignatureName
	Response.write """ size=""30"" maxlength=""50""   dataType=""Limit"" min=""1"" max=""15""  ></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td  height=""26"" class=""name""  align=""right"">签名内容：</td>" & vbcrlf & "                       <td colspan=""3"">" & vbcrlf & "              <textarea name=""SignatureCon"" cols=""60"" rows=""4"" id=""SignatureCon"" style=""display:none""  dataType=""Limit"" max=""4000""  msg=""最多4000个字"">"
	Response.write SignatureCon
	Response.write "</textarea>" & vbcrlf & "              <iframe id=""eWebEditor1"" src=""../editor_min/ewebeditor.asp?id=SignatureCon&nomenu=1"" frameborder=""0"" scrolling=""no"" style="" border:1px solid #C0CCDD;"" WIDTH=""460"" HEIGHT=""260""  marginwidth=""1"" marginheight=""1"" name=""newsEmail"" class=""borderLine""></iframe>" & vbcrlf & "                                                    <input name=""SignatureOrd"" type=""hidden"" value="""
	Response.write SignatureOrd
	Response.write """></td>" & vbcrlf & "          </tr>" & vbcrlf & "          "
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from email_Signature  where addcate="&session("personzbintel2007")&" "
	rs.open sql,conn,1,1
	if not rs.eof then
		k=1
		Response.write "" & vbcrlf & "          <tr class=""top"">" & vbcrlf & "            <td  height=""26"" class=""name""  colspan=""4"">Email签名列表（多个签名，请在以下设置）</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td  height=""26"" class=""name"" colspan=""4"">" & vbcrlf & "                           <table width=""100%"" border=""0"" cellpadding=""4"" cellspacing=""1"" bgcolor=""#C0CCDD"" >" & vbcrlf & "                <tr class=""top"">" & vbcrlf & "                  <td width=""15%"" align=""center""><div align=""center"">序号</div></td>" & vbcrlf & "                  <td width=""32%"" align=""center""><div align=""center"">签名名称</div></td>" & vbcrlf & "                  <td width=""19%"" align=""center""><div align=""center"">是否为默认签名</div></td>" & vbcrlf & "                  <td width=""34%"" align=""center""><div align=""center"">操作</div></td>" & vbcrlf & "                </tr>" & vbcrlf & "                "
		do while not rs.eof
			SigNameList=rs("SignatureName")
			SigConList=rs("SignatureCon")
			SigOrdList=rs("ord")
			SigDefList=rs("SignatureDefault")
			if SigDefList="" then SigDefList=0
			if SigDefList=1 then
				SigDefList="是"
			else
				SigDefList="否"
			end if
			...
			Response.write k
			Response.write "</td>" & vbcrlf & "                  <td align=""center"">"
			Response.write SigNameList
			Response.write "</td>" & vbcrlf & "                  <td align=""center"">"
			Response.write SigDefList
			Response.write "</td>" & vbcrlf & "                  <td align=""center""><input name=""button2"" class=""anybutton2"" value=""新增""  onClick=""javascript:window.open('EmailSignature.asp','newEmail','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" type=""button"">&nbsp;<input name=""button3"" class=""anybutton2"" value=""修改"" onClick=""javascript:window.open('EmailSignature.asp?ord="
			Response.write SigOrdList
			Response.write "&Result=Edit','newEmail','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=120,top=120')"" type=""button"">&nbsp;<input name=""button322"" class=""anybutton2"" value=""删除"" onClick=""if(confirm('确认删除？')){javascript:window.open('EmailSignature.asp?ord="
			Response.write SigOrdList
			Response.write "&Result=del','newEmail','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=125,top=125')}"" type=""button"">&nbsp;"
			Response.write SigOrdList
			if SigDefList<>"是" then
				Response.write "<input name=""button""  onClick=""if(confirm('确认设为默认签名？')){javascript:window.location.href='EmailSignature.asp?ord="
				Response.write SigOrdList
				Response.write "&Result=setDefault'}""  class=""anybutton2"" value=""设为默认"" type=""button""> "
			end if
			Response.write "</td>" & vbcrlf & "                </tr>" & vbcrlf & "                "
	...
	rs.close
	Response.write "" & vbcrlf & "          <tr>" & vbcrlf & "            <td height=""40"" colspan=""4""><div align=""center"">" & vbcrlf & "                <input type=""submit"" name=""Submit42"" value=""保存""  class=""page""/>" & vbcrlf & "                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & vbcrlf & "           <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "              </div></td>" & vbcrlf & "          </tr> " & vbcrlf & "      </table></form>" & vbcrlf & "   </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "    <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "        <tr>" & vbcrlf & "          <td height=""30px"" ><div align=""center""></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="邮箱设置"
	call close_list(1)
	Response.write "" & vbcrlf & "<script type=""text/javascript"" language=""javascript"">" & vbcrlf & "<!--" & vbcrlf & "function autoGetEmailServer(lastStr){" & vbcrlf & "if(lastStr!=""""){" & vbcrlf & "document.getElementById(""urlID"").innerHTML=""(例：admin@163.com)"";" & vbcrlf & "document.getElementById(""urlID"").className="""";" & vbcrlf & "document.getElementById(""Emailsmtp"").value=""smtp.""+lastStr.split(""@"")[1];" & vbcrlf & "document.getElementById(""EmailPop3"").value=""pop3.""+lastStr.split(""@"")[1];" & vbcrlf & "}" & vbcrlf & "else{" & vbcrlf & "document.getElementById(""urlID"").innerHTML=""Email地址不能为空！"";" & vbcrlf & "document.getElementById(""urlID"").className=""red"";" & vbcrlf & "}" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</script>" & vbcrlf & "</body>" & vbcrlf & "</html>"
'call close_list(1)
