...
document.all.date.action = "savelistadd13.asp"; 
    ...
    function callServer(nameitr, ord, i, id) {
        ...
        var url = "cu_add.asp?unit=" + escape(u_name) + "&ord=" + escape(ord) + "&num1=" + escape(num1) + "&intro1=" + escape(intro1) + "&id=" + escape(id) + "&i=" + escape(i) + "&nameitr=" + escape(nameitr) + "&timestamp=" + new Date().getTime() + "&date1=" + Math.round(Math.random() * 100);
...
;
    ...
    function updatePage_del(str) {
        var needRemove=document.getElementById(str)
        needRemove.parentNode.removeChild(needRemove);
    }
