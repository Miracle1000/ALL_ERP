...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write " onMouseOver=""window.status='none';return true;"" >" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">短信模板</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td><div align=""right"" >"
	if open_67_13=1 then
		Response.write "<input type=""button"" class=""anybutton""  style="" cursor:hand"" name=""Submit3c"" value=""添加模板""  onClick=""javascript:window.open('editMoban.asp','addMessageMoban','width=' + 600 + ',height=' + 400 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=200,top=150')""/>"
'if open_67_13=1 then
	end if
	Response.write "&nbsp;&nbsp;&nbsp;</div></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "</table>" & vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "   <tr class=""top"">" & vbcrlf & "   <td align=""center""><div align=""center"">序号</div></td>" & vbcrlf & "                      <td ><div align=""center"">内容</div></td>" & vbcrlf & "          <td height=""27"" ><div align=""center"">分类</div></td>" & vbcrlf & "        <td ><div align=""center"">添加人</div></td>" & vbcrlf & "     <td width=""14%"" ><div align=""center"">时间</div></td>" & vbcrlf & "        <td width=""20%"" ><div align=""center"">操作</div></td>" & vbcrlf & "        </tr>" & vbcrlf & ""
	if open_67_1=3 then
		Str_Result=""
	elseif open_67_1=1 then
		Str_Result="and ( share='1' or ','+shareinfo+',' like '%,"&session("personzbintel2007")&",%' or charindex(','+cast(addcate as varchar(10))+',',',"&Replace(intro_67_1," ","")&",')>0)"
'elseif open_67_1=1 then
	else
		Str_Result="and ( share='1' or ','+shareinfo+',' like '%,"&session("personzbintel2007")&",%')"
'elseif open_67_1=1 then
	end if
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from mobanMessage where del=1 and '"& open_67_13 &"'= '1' "&Str_Result&" order by clikNum ,ord desc "
	rs.open sql,conn,1,1
	if rs.RecordCount<=0 then
		Response.write "<tr><td  align='center' colspan='6'  class='gray' height='30'>暂无数据!</td></tr>"
	else
		i=1
		rs.PageSize=10
		...
		do until rs.eof
			...
			clikNum=rs("clikNum")
			set rs1=server.CreateObject("adodb.recordset")
			sql1="select * from sortMessage  where ord="&sortid&" "
			rs1.open sql1,conn,1,1
			if rs1.eof  then
				sortName="未分类"
			else
			...
			Response.write i
			Response.write "</td>" & vbcrlf & "                <td width=""28%"" height=""28""><div align=""left"">"
			Response.write content
			Response.write "</div></td>" & vbcrlf & "          <td width=""14%"" height=""28""><div align=""center"">"
			Response.write sortName
			Response.write "</div></td>" & vbcrlf & "                <td width=""13%"" height=""28""><div align=""center"">"
			Response.write addName
			Response.write "</div></td>" & vbcrlf & "                <td><div align=""center"">"
			Response.write addtime
			Response.write "</div></td>" & vbcrlf & "          <td  class=""func""><div align=""center"">" & vbcrlf & "                                                       <input type=""button"" name=""Submit32"" value=""共享""  onClick=""window.open('share_maoban.asp?ord="
			Response.write pwurl(ord)
			Response.write "','newwin5','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""  />" & vbcrlf & "                                        <input type=""button""   style="" cursor:hand"" name=""Submit3c"" value=""修改""  onClick=""javascript:window.open('editMoban.asp?ord="
			Response.write pwurl(ord)
			Response.write pwurl(rs("ord"))
			Response.write "&currPage="
			Response.write currpage
			Response.write "','editMessageMoban','width=' + 600 + ',height=' + 400 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=200,top=150')""/>&nbsp;"
			Response.write currpage
	...
	action1="短信模板"
	call close_list(1)
	Response.write "   </td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & "" & vbcrlf & ""
