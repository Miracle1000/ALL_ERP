...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	Response.write "" & vbcrlf & "        " & vbcrlf & "<table width=""100%"" border=""1"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" bordercolor=""#ccc"" id=""content"" style=""border-color:#CCC"">" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td colspan=""2""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=document.getElementById('zc').style.display='';document.getElementById('ht1').style.display='none';return false;><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td></tr>" & vbcrlf & vbcrlf &" <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "        <td rowspan=2><div align=right >人员选择：</div></td>" & vbcrlf & "        <td><input type='checkbox' name='gatety' value='1' checked>处理人员  &nbsp;<input type='checkbox' name='gatety' value='2' checked>接待人员</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "" & vbcrlf & "      </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">售后分类：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "       "
	execute sdk.vbs("../manager/search_Service" & Application("__saas__company") & ".asp")
	Response.write "" & vbcrlf & "      </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td><div align=right >售后方式：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "             "
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select ord, sort1 from sortonehy where gate2=55 order by gate1 desc"
	rs7.open sql7,conn,1,1
	do until rs7.eof
		Response.write "" & vbcrlf & "            <input name=""sA"" type=""checkbox"" value="""
		Response.write rs7("ord")
		Response.write """ "
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "    </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "       <td><div align=right >紧急程度：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "             "
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select ord, sort1 from sortonehy where gate2=52 order by gate1 desc"
	rs7.open sql7,conn,1,1
	do until rs7.eof
		Response.write "" & vbcrlf & "            <input name=""sB"" type=""checkbox"" value="""
		Response.write rs7("ord")
		Response.write """ "
		if clng(A1)=rs7("ord") then
			Response.write "checked"
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "      </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td><div align=right >处理结果：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "        <input name=""sC"" type=""checkbox"" value=""0"" >处理中" & vbcrlf & "        <input name=""sC"" type=""checkbox"" value=""1"" >处理完毕" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td><div align=right >打印状态：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "        <input name=""sPrt"" type=""checkbox"" value=""0"" >未打印" & vbcrlf & "        <input name=""sPrt"" type=""checkbox"" value=""1"" >已打印" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf &  " <td><div align=right >售后主题：</div></td>" & vbcrlf & "    <td> "& vbcrlf &"         <select name=""sD1"">" & vbcrlf & "            <option value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "<option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" & vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""sD2"" type=""text"" size=""15""></td>" & vbcrlf & "     </td> "& vbcrlf & "</tr>" & vbcrlf & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td><div align=right >售后编号：</div></td>" & vbcrlf &    " <td>" & vbcrlf & "        <select name=""sE1"">" & vbcrlf & "            <option value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" &vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""sE2"" type=""text"" size=""15""></td>" & vbcrlf & "    </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "        <td><div align=right >售后内容：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "        <select name=""sF1"">" & vbcrlf & "            <option value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" & vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""sF2"" type=""text"" size=""15""></td>" &vbcrlf & " </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td><div align=right >备　注：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "        <select name=""sG1"">" & vbcrlf & "        <option value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" & vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""sG2"" type=""text"" size=""15""></td>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "  <td><div align=right >处理内容：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "        <select name=""sH1"">" & vbcrlf & "            <option value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "<option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" & vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""sH2"" type=""text"" size=""15""></td>" & vbcrlf & "        </td>" & vbcrlf &"</tr>" & vbcrlf & "" & vbcrlf & ""
	call Show_Search_Extended(88)
	Dim arrShow()
	Dim arrName()
	...
	wend
	rs.close
	Response.write "" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td><div align=right >售后日期：</div></td>" & vbcrlf & "    <td>"
	...
	Response.write "</td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "<!--客户检索条件 begin-->" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
	Response.write arrName(4)
	Response.write "：</div></td>" & vbcrlf & "<td>" & vbcrlf & ""
	zbintel_sort_history=request("wE")
	zbintel_sort1_history=request("wF")
	dim i5
	i5=2
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select ord, sort1 from sort4  order by ord"
	rs1.open sql1,conn,1,1
	if rs1.RecordCount<=0 then
		Response.write "&nbsp;"
	else
		do until rs1.eof
			Response.write "" & vbcrlf & "    <input name=""wE"" type=""checkbox"" value="""
			...
			sql2="select ord, sort2 from sort5  where sort1="&rs1("ord")&" order by ord"
			rs2.open sql2,conn,1,1
			if rs2.RecordCount<=0 then
				Response.write "&nbsp;"
			else
				do until rs2.eof
					Response.write "" & vbcrlf & "        <span class='gray'><input name='wF' type='checkbox' value='"
					Response.write rs2("ord")
					Response.write "' "
					if CheckPurview(zbintel_sort1_history,trim(rs2("ord")))=True  then
						Response.write "checked=""checked"""
					end if
					Response.write ">"
	...
	rs1.close
	set rs1=nothing
	Response.write "" & vbcrlf & "</td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td align=""right"">"
	...
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "<input type=""checkbox"" name=""wA"" value="""
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "</td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
	Response.write "：</div></td>" & vbcrlf & "<td>" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	sql="select ord,sort1 from sortonehy where gate2=14 order by gate1 desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "<input type=""checkbox"" name=""wB"" value="""
		Response.write rs("ord")
		Response.write """>"
		Response.write rs("sort1")
		rs.movenext
	...
	Response.write "：</div></td>" & vbcrlf & "<td><div id=""tel_area"">"
	execute sdk.vbs("../manager/search_area" &  Application("__saas__company")  & ".asp")
	Response.write "</div></td></tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
	...
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "<input name=""wC"" type=""checkbox"" value="""
		Response.write rs("ord")
		Response.write """>"
		Response.write rs("sort1")
		rs.movenext
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "</td></tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
	Response.write arrName(1)
	Response.write "：</div></td>" & vbcrlf & "<td><select name=""wD1"">" & vbcrlf & "<option value=""1"">包含</option>" & vbcrlf & "<option value=""2"">不包含</option>" & vbcrlf & "<option value=""3"">等于</option>" & vbcrlf & "<option value=""4"">不等于</option>" & vbcrlf & "<option value=""5"">以..开始</option>" & vbcrlf & "<option value=""6"">以..结束</option>" & vbcrlf & "</select>" & vbcrlf & "<input name=""wD2"" type=""text"" size=""15""></td></tr>" & vbcrlf & "<!--客户检索条件 end-->" & vbcrlf & vbcrlf & vbcrlf & "<!--产品检索条件 begin-->" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">产品分类：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "         <div id=""pro_sort"">"
	execute sdk.vbs("../manager/search_product.asp")
	Response.write "</div>" & vbcrlf & "    </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">产品名称：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "        <select name=""pB1"">" & vbcrlf & "            <option value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" &vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""pB2"" type=""text"" size=""15"">" & vbcrlf & "    </td>" & vbcrlf & "</tr>" & vbcrlf & "" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">产品编号：</div></td>" & vbcrlf & "    <td>" & vbcrlf & "        <select name=""pC1"">" & vbcrlf & "            <option value=""1"">包含</option>" & vbcrlf & "            <option value=""2"">不包含</option>" & vbcrlf & "            <option value=""3"">等于</option>" & vbcrlf & "            <option value=""4"">不等于</option>" & vbcrlf & "            <option value=""5"">以..开始</option>" & vbcrlf & "            <option value=""6"">以..结束</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""pC2"" type=""text"" size=""15"">"& vbcrlf & "    </td>" & vbcrlf &" </tr>" & vbcrlf &" <!--产品检索条件 end-->" & vbcrlf & vbcrlf & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td width=""10%"">&nbsp;</td>" & vbcrlf & "<td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr>" & vbcrlf & vbcrlf & "</table>" & vbcrlf
	conn.close
	set conn=nothing
