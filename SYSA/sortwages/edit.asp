...
'bigsystemtype = ".mozi"
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "      margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"">" & vbcrlf & "<!--" &vbcrlf & "    function MM_jumpMenu(targ, selObj, restore) { //v3.0" & vbcrlf & "        eval(targ + "".location=\'"" + selObj.options[selObj.selectedIndex].value + ""\'"");" & vbcrlf & "        if (restore) selObj.selectedIndex = 0;" & vbcrlf & "    }" & vbcrlf & "//-->" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">工资项目设置</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">" & vbcrlf & ""
	If ZBRuntime.MC(26002) Then
		Response.write "<input type=""button"" value=""计件工资"" class=""anniu"" onclick=""window.location='../sortwagesjj/edit2.asp';"">"
	end if
	Response.write "" & vbcrlf & "              <input type=""button"" name=""Submit32"" value=""添加项目""  class=""anniu"" onClick=""javascript:window.open('add.asp','newwin','width=' + 600 + ',height=' + 400 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=10,left=200,top=150')""/></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & ""
	...
	if rs.RecordCount<=0 then
		...
		Response.write "" & vbcrlf & "      <div align=""center"">" & vbcrlf & "  <center>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & " <tr border=1 valign=""center"" class=""top resetGroupTableBg"">" & vbcrlf & "    <td width=""258"" height=""27"" align=""center"" valign=""middle"" bgcolor=""#F8F8F8"">      <div align=""center""><font style=""font-size: 9pt"">工资项目</font></div></td>" & vbcrlf & "    <td width=""176"" align=""center"" valign=""middle"" bgcolor=""#F8F8F8""><div align=""center"">类型</div></td>" & vbcrlf & "    <td width=""176"" align=""center"" valign=""middle"" bgcolor=""#F8F8F8""><div align=""center""><font style=""font-size: 9pt"">重要指数</font></div></td>" & vbcrlf & "    <td width=""318"" height=""32"" align=""center"" valign=""middle"" bgcolor=""#F8F8F8""><div align=""center""><font style=""font-size: 9pt"">操作</font>　</div></td>" & vbcrlf & "    </tr>" & vbcrlf & "  "
		do until rs.eof
			sql="select distinct l.sort1 from wages w inner join wageslist l on l.wages=w.id where w.complete1=0 and l.sort1="&rs("id")&" "
			...
			Response.write "','newwincor','width=' + 600 + ',height=' + 400 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=150')""/>　　<input type=""button"" name=""Submitdel"" "
			'Response.write rs("id")
			Response.write disabled
