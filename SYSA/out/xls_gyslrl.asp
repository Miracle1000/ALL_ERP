...
'bigsystemtype = ".mozi"
	...
	dotstr=""
		for i=1 to num_dot_xs
			...
			Response.Flush
			set rs=server.CreateObject("adodb.recordset")
			sql="select * from linshi where cateid="&session("personzbintel2007")&" order by num1 desc"
...
'if open_5_17=1 or open_5_17=3 then
			...
			rs.close
			set rs=Nothing
			Response.write "<script>CountImage.width=710;CountTXT.innerHTML=""<font color=red><b>供应商利润率排行导出全部完成!</b></font>  100"";CountTXTok.innerHTML=""<B>恭喜!供应商利润率排行导出成功,共有"&(i-1)&"条记录!</B>"";</script>"
			set rs=Nothing
			Response.write "" & vbcrlf & "</BODY>" & vbcrlf & "</HTML>" & vbcrlf & ""
			Set fs = CreateObject("Scripting.FileSystemObject")
			tfile=Server.MapPath("供应商利润率排行_"&session("name2006chen")&".xls")
			...
			Response.write """><font class=""red""><strong><u>下载导出的供应商利润率排行</u></strong></font></a></p> " & vbcrlf & ""
