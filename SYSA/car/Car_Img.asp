...
'bigsystemtype = ".mozi"
	...
	if car_code="undefined" then car_code=""
	if car_code<>"" and (not isnull(car_code)) then
		Str_Result=Str_Result&" and car_code like '%"&ml.De(car_code)&"%' "
	end if
	...
	page_count=5
	Response.write "" & vbcrlf & "<table border=""0"" cellpadding=""1"" cellspacing=""1""  width=""100%"" bgcolor=""#C0CCDD"">" & vbcrlf & "      <tr>" & vbcrlf & "            <td height=""20"" colspan=""29"" bgcolor=""#FFFFFF""><div align=""right""><a href=""javascript:void(0)"" onclick=""car_img('"
	Response.write P_sel_time
	Response.write "','"
	Response.write currpage
	Response.write "','"
	Response.write ml.Dep(car_code)
	...
	Response.write "','"
	Response.write ml.Dep(car_code)
	Response.write "');"">后一天&nbsp;<img src=""../images/icon_sanjiao.gif"" title=""后一天""/></a>" & vbcrlf & "            车牌号：<input type=""text"" name=""car_code"" id=""car_code"" size=""12"" style=""width:100px;"" value="""
	Response.write car_code
	Response.write """/> <input type=""button"" class=""anybutton2"" name=""btn_1"" id=""btn_1"" value=""查询"" onclick=""car_img(document.getElementById('sel_time').value,'"
	Response.write currpage
	Response.write "',document.getElementById('car_code').value);""/></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "       <tr>" & vbcrlf & "            <td height=""20"" bgcolor=""#FFFFFF""><div align=""center"">车辆\时间</div></td>" & vbcrlf & "            <td bgcolor=""#FFFFFF""><div align=""center"">每天时间</div></td>" & vbcrlf & "               <td colspan=""8"" bgcolor=""#FFFFFF""><div class=""redDiv""></div>红色代表占用</td>" & vbcrlf & "             <td colspan=""8"" bgcolor=""#FFFFFF""><div class=""greenDiv""></div>绿色代表空闲</td>" & vbcrlf & "               <td colspan=""10"" bgcolor=""#FFFFFF""><div class=""origenDiv""></div>橙色代表待审批</td>" & vbcrlf & "           <td bgcolor=""#FFFFFF"">&nbsp;</td>" & vbcrlf &      "</tr>" & vbcrlf &    "<tr>" & vbcrlf &             "<td height=""20"" bgcolor=""#FFFFFF""><div align=""center""><strong>车牌号</strong></div></td>" & vbcrlf &               "<td height=""20"" bgcolor=""#FFFFFF""><pre><div align=""center""><strong>00:00-07:59</strong></div></td>" & vbcrlf &             "<tdwidth=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>08</strong></div></td>" & vbcrlf & "          <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>09</strong></div></td>" & vbcrlf & "         <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>10</strong></div></td>" & vbcrlf & "              <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>11</strong></div></td>" & vbcrlf & "         <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>12</strong></div></td>" & vbcrlf & "         <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>13</strong></div></td>" & vbcrlf & "               <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>14</strong></div></td>" & vbcrlf & "         <td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>15</strong></div></td>" & vbcrlf &             "<td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>16</strong></div></td>" & vbcrlf &          "<td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>17</strong></div></td>" & vbcrlf &          "<td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>18</strong></div></td>" & vbcrlf &               "<td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>19</strong></div></td>" & vbcrlf &          "<td width=""4%"" colspan=""2"" bgcolor=""#FFFFFF""><div align=""center""><strong>20</strong></div></td>" & vbcrlf & "          <td bgcolor=""#FFFFFF""><div align=""center""><pre><strong>21:00-23:59</strong></div></td>" & vbcrlf & "      </tr>" & vbcrlf & "   "
	Response.write currpage
	red="red1"
	origen="origen"
	green="green"
	sql7="select * from O_carData  "&Str_Result&" and del=1 and car_state=1 order by car_code desc"
	...
	if not rs7.eof then
		...
		do while not rs7.eof
			Response.write "" & vbcrlf & "      <tr>" & vbcrlf & "            <td height=""20"" bgcolor=""#FFFFFF""><a href=""javascript:void(0)"" onclick=""addtr('"
			Response.write rs7("car_id")
			Response.write "','"
			Response.write ml.Dep(rs7("car_code"))
			Response.write "','"
			Response.write ml.Dep(rs7("car_driver"))
			Response.write "')"" ><span class=""red"">√</span></a>&nbsp;"
...
'sql8="select a.*,b.use_complete as F_complete from O_carUsemx a left join O_carUse b on a.use_fid=b.use_id where a.del=1 and a.use_complete=1 and b.use_complete in(1,2,3) and a.use_carid="&rs7("car_id")&" and not (a.use_startime>'"&sel_time&" 00:00:00' OR a.use_endtime<'"&sel_time&" 07:59:59' ) "
			...
			if Color=red then
				...
				Response.write "<td bgcolor=""#FFFFFF"" onclick=""add_tr('""&rs7(""car_id"")&""','""&ml.Dep(rs7(""car_code""))&""','""&ml.Dep(rs7(""car_driver""))&""','""&sel_time&"" 00:00:00','""&sel_time&"" 07:59:59')"" OnMouseOver=""opentitle(this,'""&rs7(""car_id"")&""','""&sel_time&"" 00:00:00','""&sel_time&"" 07:59:59')"" OnMouseOut=""closetitle()"" class=""&Color&""></td>"
			end if
			set rs8=nothing
			h_hour=8
			t_temp=0
			for i=1 to 26
				...
				if Color=red then
					...
					Response.write "<td width=""2%"" bgcolor=""#FFFFFF"" onclick=""add_tr('""&rs7(""car_id"")&""','""&ml.Dep(rs7(""car_code""))&""','""&ml.Dep(rs7(""car_driver""))&""','""&sel_time&F_hour_temp&""','""&sel_time&P_hour_temp&""')"" OnMouseOver=""opentitle(this,'""&rs7(""car_id"")&""','""&sel_time&F_hour_temp&""','""&sel_time&P_hour_temp&""')"" OnMouseOut=""closetitle()"" class=""&Color&""></td>"
				end if
				set rs8=nothing
			next
