...
'If Not rs.Eof Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "</head>" & vbcrlf & "<body  oncontextmenu=self.event.returnValue=false >" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" &vbcrlf & "    <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "        <tr>" & vbcrlf & "          <td width=""208"" height=""32"" class=""place"">短信提醒模板</td>" & vbcrlf & "          <td>&nbsp;</td>" & vbcrlf & "          <td align=""right"">&nbsp;</td>" & vbcrlf & "          <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "  <tr class=""top"">" & vbcrlf & "    <td width=""6%"" align=""center""><div align=""center"">序号</div></td>" & vbcrlf & "    <td width=""15%"" align=""center""><div align=""center"">标题</div></td>" & vbcrlf & "    <td width=""23%"" align=""center""><div align=""center"">模板内容</div></td>" & vbcrlf & "    <td width=""11%"" align=""center""><div align=""center"">所属分类</div></td>" & vbcrlf & "    <td width=""10%"" align=""center""><div align=""center"">添加人</div></td>" & vbcrlf & "    <td width=""12%"" align=""center""><div align=""center"">是否主模板</div></td>" & vbcrlf & "    <td width=""23%"" align=""center""><div align=""center"">操作</div></td>" & vbcrlf & "  </tr>" & vbcrlf & "  "
	...
	Dim wxGoods,invoiceAbutment
	wxGoods = ZBRuntime.MC(76000)
	invoiceAbutment = ZBRuntime.MC(23004)
	set rs=server.CreateObject("adodb.recordset")
	sql="SELECT * from sms_temp  "&Str_Result&" AND (content NOT LIKE '%$wxuser%' OR (content LIKE '%$wxuser%' AND '"& wxGoods &"' = 'true')) AND (title <>'发送电子发票' OR '"& invoiceAbutment &"'='true') ORDER BY sortid ASC"
	...
	if not rs.eof then
		...
		do while not rs.eof
			...
			Response.write "</td>" & vbcrlf & "    <td align=""center"">"
			Response.write SMSTempSort(sorid)
			Response.write "</td>" & vbcrlf & "    <td align=""center"">"
			Response.write getGateName(addcate)
			Response.write "</td>" & vbcrlf & "    <td align=""center"">"
			Response.write smsDefault(isdefault)
			Response.write "</td>" & vbcrlf & "    <td align=""center""><input name=""button2"" class=""anybutton2"" value=""新增""  onClick=""javascript:window.location.href='sms_temp_edit.asp'"" type=""button"">" & vbcrlf & "      &nbsp;" & vbcrlf & "      <input name=""button3"" class=""anybutton2"" value=""修改"" onClick=""javascript:window.location.href='sms_temp_edit.asp?ord="
			Response.write pwurl(ord)
			Response.write "&action=edit'"" type=""button"">" & vbcrlf & "      &nbsp;" & vbcrlf & "      <input name=""button32"" class=""anybutton2"" value=""删除"" onClick=""if(confirm('确认删除？')){javascript:window.location.href='sms_temp_edit.asp?ord="
			Response.write pwurl(ord)
			Response.write "&action=del';}"" type=""button""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  "
			k=k+1
			'Response.write "&action=del';}"" type=""button""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  "
			rs.movenext
		loop
	...
	Response.write "" & vbcrlf & "</table>" & vbcrlf & "</td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "    <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "        <tr>" & vbcrlf & "          <td height=""30"" valign=""center"" ><div align=""right"">" & vbcrlf & "" & vbcrlf & "                 " & vbcrlf & "                 <span class=""black"">"
	...
	Response.write "条信息/页</span>&nbsp;<input   name=""currpage""  type=text id=""currpage""  onkeyup=""value=value.replace(/[^\d\.]/g,'')""  size=3  >" & vbcrlf & "     &nbsp;<input type=""button"" name=""Submit422"" value=""跳转""  class=""anybutton2"" onClick=""gotourl('currPage='+document.getElementById('currpage').value);""/>&nbsp;" & vbcrlf & "                  "
	if currpage=1 then
		...
		Response.write "" & vbcrlf & "                  <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='sms_temp_list.asp?page_count="
	...
	if currpage=rs.pagecount then
		...
		Response.write "" & vbcrlf & "                  <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='sms_temp_list.asp?page_count="
		Response.write page_count
		Response.write "&currPage="
		Response.write  currpage + 1
		'Response.write "&currPage="
		Response.write "'"" class=""page""/>" & vbcrlf & "                  <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href='sms_temp_list.asp?page_count="
		Response.write page_count
		Response.write "&currPage="
		Response.write  rs.PageCount
		Response.write "'"" class=""page""/>" & vbcrlf & "                  "
	end if
	Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
	function SMSTempSort(id)
		if id<>"" and isnumeric(id) then
			set rs8=server.CreateObject("adodb.recordset")
			sql8="select * from sms_temp_sort  where ord="&id&" and del=1"
			rs8.open sql8,conn,1,1
			if not rs8.eof then
				SMSTempSort=rs8("title")
			else
				SMSTempSort="无关联分类"
			end if
			rs8.close
