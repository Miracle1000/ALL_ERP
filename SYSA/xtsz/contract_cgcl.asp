...
'call nocache
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "      margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"">" & vbcrlf & "<!--" & vbcrlf & "function MM_jumpMenu(targ,selObj,restore){ //v3.0" & vbcrlf & "eval(targ+"".location=\'""+selObj.options[selObj.selectedIndex].value+""\'"");" & vbcrlf & "if (restore) selObj.selectedIndex=0;" & vbcrlf & "}" & vbcrlf & "//-->" & vbcrlf & "</script>" & vbcrlf & "<script language=javascript>" & vbcrlf & "function inselect4()" & vbcrlf & "{" & vbcrlf & "document.date.sort1.length=0;" & vbcrlf & "if(document.date.sort.value==""0""||document.date.sort.value==null)" & vbcrlf & "document.date.sort1.options[0]=new Option('客户分类','0');" & vbcrlf & "else" & vbcrlf & "{" & vbcrlf & "for(i=0;i<ListUserId4[document.date.sort.value].length;i++)" & vbcrlf & "{" & vbcrlf & "document.date.sort1.options[i]=new Option(ListUserName4[document.date.sort.value][i],ListUserId4[document.date.sort.value][i]);" & vbcrlf & "}" & vbcrlf & "}" & vbcrlf & "var index=document.date.sort.selectedIndex;" & vbcrlf & "//sname.innerHTML=document.date.sort.options[index].text" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "//-->" & vbcrlf & "                      function chgSort2(intro) {" & vbcrlf & "                              if (intro == 1) {" & vbcrlf & "                                       document.getElementById(""sort2-other"").style.display = ""inline"";" & vbcrlf & "                            }" & vbcrlf & "                               else {" & vbcrlf & "                                  document.getElementById(""sort2-other"").style.display = ""none"";" & vbcrlf & "                              }" & vbcrlf & "                       }" & vbcrlf & "" & vbcrlf & "</script>" & vbcrlf & ""
...
'set rss=nothing
	...
	dim sort1 , sort2 , sort3 , sort4 , sort5
	sort1 = getrsval("select intro from setopen where sort1=48 ")
	If sort1&""="" Then sort1=0
	sort2 = getrsval("select intro from setopen where sort1=49 ")
	If sort2&""="" Then sort2=0
	sort3 = getrsval("select intro from setopen where sort1=2016102101 ")
	If sort3&""="" Then sort3=0
	sort4 = getrsval("select intro from setopen where sort1=2016102102 ")
	If sort4&""="" Then sort4=0
	sort5 = getrsval("select intro from setopen where sort1=2016102103 ")
	If sort5&""="" Then sort5=0
	sort6 = getrsval("select intro from setopen  where sort1=2016102801 ")
	If sort6&""="" Then sort6=0
	sort7 = getrsval("select intro from setopen  where sort1=2019030101 ")
	If sort7&""="" Then sort7=0
	sort8 = getrsval("select intro from setopen where sort1=320173101 ")
	If sort8&""="" Then sort8=0
	sort9 = getrsval("select intro from setopen where sort1=320173102 ")
	If sort9&""="" Then sort9=1
	sort10=getrsval("select intro from setopen where sort1=320173103 ")
	If sort10&""="" Then sort10=0
	sort11=getrsval("select intro from setopen where sort1=320173104 ")
	If sort11&""="" Then sort11=0
	sortdr=getrsval("select intro from setopen where sort1=320310701 ")
	If sortdr&""="" Then sortdr=0
	sort12=getrsval("select intro from setopen where sort1=320173105 ")
	If sort12&""="" Then sort12=0
	str=""
	If ZBRuntime.MC(24000) and ZBRuntime.MC(24001) then str="付款、收票计划和申请单"
	If ZBRuntime.MC(215102)  then str=str&"、来料质检单"
	If ZBRuntime.MC(17002)  then str=str&"、入库单"
	set rs=server.CreateObject("adodb.recordset")
	sql="select top 1 1 from sp where gate2=73001 order by gate1 asc"
	...
	set rs=nothing
	set rs=server.CreateObject("adodb.recordset")
	sql="select  1 from sp_ApprovalRules where gate2=73001  "
	rs.open sql,conn,1,1
	if rs.eof then
		sp_ck=0
	else
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" >" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & " <tr>" & vbcrlf & "            <td class=""place"">采购策略控制</td>" & vbcrlf & "               <td>&nbsp;</td>" & vbcrlf & "         <td align=""right"">&nbsp;</td>" & vbcrlf & "             <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>"& vbcrlf & "     </tr> "& vbcrlf & "    </table> "& vbcrlf &  "      <form method=""post"" action=""contract_cgclsave.asp"" id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date""> "& vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & " <tr class=""top""><td height=""30"" colspan=""6"" >采购策略控制</td></tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "            <label><input name=""sort3"" type=""checkbox"" value=""1"" "
	if sort3="1" then
		Response.write "checked "
	end if
	Response.write ">项目转采购不允许重复采购</label>" & vbcrlf & "            &nbsp;<label><input name=""sort1"" type=""checkbox"" value=""1"" "
	if sort1="1" then
		Response.write "checked "
	end if
	Response.write ">合同转采购不允许重复采购</label>" & vbcrlf & "            &nbsp;<label><input name=""sort4"" type=""checkbox"" value=""1"" "
	if sort4="1" then
		Response.write "checked "
	end if
	Response.write ">预购转采购不允许重复采购</label>" & vbcrlf & "            &nbsp;<label><input name=""sort6"" type=""checkbox"" value=""1"" "
	if sort6="1" then
		Response.write "checked "
	end if
	Response.write ">询价转采购不可重复采购</label>" & vbcrlf & "              </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr class=""top""><td height=""30"" colspan=""6"" >合并明细策略控制</td></tr>" & vbcrlf & "       <tr>" & vbcrlf & "            <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "            <label><input name=""sort7"" type=""checkbox"" value=""1"" "
	if sort7&""="1" then
		Response.write "checked "
	end if
	Response.write ">合并相同明细</label>" & vbcrlf & "                <span class=""gray"" style=""margin-left:10px;"">（温馨提示）：勾选后将在‘项目’‘合同’‘预购’‘询价’中合并除价格外字段内容相同的明细</span>" & vbcrlf & "                </td>" & vbcrlf & "   </tr>" & vbcrlf & "   "
	'Response.write "checked "
	If ZBRuntime.MC(215102) then
		Response.write "" & vbcrlf & "             <tr class=""top"">" & vbcrlf & "          <td height=""30"" colspan=""6"" >采购来料质检策略控制</td>" & vbcrlf & "              </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "                            <label><input name=""sort2"" type=""radio"" value=""0"" onpropertychange=""chgSort2(0);"" "
		if sort2="0" then Response.write("checked")
		Response.write ">不启用来料质检</label>" & vbcrlf & "                      </td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "                            <label><input name=""sort2"" type=""radio"" value=""1"" onpropertychange=""chgSort2(1);"" "
'if sort2="1" then Response.write("checked")
		Response.write ">录入采购单时选择是否需要来料质检</label>" & vbcrlf & "                            <span id=""sort2-other"" "
'if sort2="1" then Response.write("checked")
		if sort2<>"1" then Response.write("style='display:none;'")
		Response.write ">" & vbcrlf & "                                    <span class=""gray"" style=""margin-left:10px;"">默认选项：</span>" & vbcrlf & "                                      <label><input name=""sort8"" type=""radio"" value=""0"" "
'if sort2<>"1" then Response.write("style='display:none;'")
		if sort8="0" then Response.write("checked")
		Response.write ">不需要质检</label>" & vbcrlf & "                                  <label><input name=""sort8"" type=""radio"" value=""1"" "
		if sort8="1" then Response.write("checked")
		Response.write ">需要质检</label>" & vbcrlf & "                            </span>" & vbcrlf & "                 </td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "                             <label><input name=""sort2"" type=""radio"" value=""2"" onpropertychange=""chgSort2(2);"" "
		if sort2="2" then Response.write("checked")
		Response.write ">一直启用来料质检</label>" & vbcrlf & "                    </td>" & vbcrlf & "           </tr>" & vbcrlf & "           "
	end if
	Response.write "" & vbcrlf & "     <tr class=""top""><td height=""30"" colspan=""6"" >采购主题策略（来源上级单据）</td></tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "                    <label><input name=""sort9"" type=""radio"" value=""1"" "
	if sort9="1" then Response.write("checked")
	Response.write ">转自xxx：上级单据主题</label>&nbsp;" & vbcrlf & "                 <label><input name=""sort9"" type=""radio"" value=""2"" "
	if sort9="2" then Response.write("checked")
	Response.write ">供应商+编号</label>" & vbcrlf & "         </td>" & vbcrlf & "   </tr>" & vbcrlf & "   "
'if sort9="2" then Response.write("checked")
	If ZBRuntime.MC(17002) and sp=0 and sp_ck=0 then
		Response.write "" & vbcrlf & "     <tr class=""top""><td height=""30"" colspan=""6"" >采购流程设置</td></tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "                    <label><input name=""sort10"" type=""checkbox"" value=""1"" "
		if sort10&""="1" then
			Response.write "checked "
		end if
		Response.write ">添加采购时完成入库申请</label>" & vbcrlf & "              </td>" & vbcrlf & "   </tr>" & vbcrlf & "   "
	end if
	Response.write "" & vbcrlf & "     <tr class=""top""><td height=""30"" colspan=""6"" >采购单审批通过后的修改控制</td></tr>" & vbcrlf & "     <tr>" & vbcrlf & "            <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "                    <label><input name=""sort11"" type=""radio"" value=""0"" "
	if sort11="0" then Response.write("checked")
	Response.write ">无需审批</label>&nbsp;" & vbcrlf & "                      <label><input name=""sort11"" type=""radio"" value=""1"" "
	if sort11="1" then Response.write("checked")
	Response.write ">需要审批</label>&nbsp;" & vbcrlf & "                      <label><input name=""sort11"" type=""radio"" value=""2"" "
	if sort11="2" then Response.write("checked")
	Response.write ">不允许修改</label>" & vbcrlf & "          </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr class=""top""><td height=""30"" colspan=""6"" >采购导入策略控制</td></tr>" & vbcrlf & "       <tr>" & vbcrlf & "            <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "                    <label><input name=""sortdr"" type=""radio"" value=""0"
	if sortdr="0" then Response.write("checked")
	Response.write ">无需审批</label>&nbsp;" & vbcrlf & "                      <label><input name=""sortdr"" type=""radio"" value=""1"" "
	if sortdr="1" then Response.write("checked")
	Response.write ">需要审批</label>&nbsp;" & vbcrlf & "              </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr class=""top""><td height=""30"" colspan=""6"" >采购删除策略</td></tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "                    <label><input name=""sort12"" type=""checkbox"" value=""1"" "
	if sort12&""="1" then
		Response.write "checked "
	end if
	Response.write ">采购拥有下级单据不允许删除</label>" & vbcrlf & "                  <span class=""gray"" style=""margin-left:10px;"">（付款、收票计划和申请单、来料质检单、入库单）</span>" & vbcrlf & "          </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr class=""top"" style=""display:none""><td height=""30"" colspan=""6"" >采购超量入库策略</td></tr>" & vbcrlf & "    <tr style=""display:none"">" & vbcrlf & "            <td  height=""26"" colspan=""6"" class=""name"">" & vbcrlf & "            <label><input name=""sort5"" type=""checkbox"" value=""1"" "
	if sort5="1" then
		Response.write "checked "
	end if
	Response.write ">允许超量入库</label>" & vbcrlf & "                </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td height=""40""><div align=""center"">" & vbcrlf & "                <input type=""submit"" name=""Submit42"" value=""保存""  class=""page""/>" & vbcrlf & "               <input type=""reset"" value=""重填"" class=""page"" name=""B2""> "& vbcrlf & "         </div></td> "& vbcrlf & "     </tr> "& vbcrlf & "    <tr><td><span style=""color:red"">温馨提示：</span></br></br><span style=""color:red;margin-top:5px;"">如果采购设置审批流程，则不显示添加采购时完成入库申请操作策略。</span> </td></tr>" & vbcrlf & "        </table> "& vbcrlf & "        </form> "& vbcrlf & "</td> "& vbcrlf & "</tr>" & vbcrlf & "<tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "                <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr><td height=""30"" ><div align=""center""></div></td></tr>" & vbcrlf & "           </table>" & vbcrlf & "        </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "</body>"& vbcrlf & "</html> "& vbcrlf
	conn.close
	set conn=nothing
%>
