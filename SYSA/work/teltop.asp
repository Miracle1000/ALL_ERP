...
'if strW3<>"" Then
	...
	dim open_1_1,intro_1_1,kh_list
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=1 and sort2=4"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_1_4=0
		intro_1_4=0
	else
		open_1_4=rs1("qx_open")
		intro_1_4=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=1 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_1_2=0
		intro_1_2=0
	else
		open_1_2=rs1("qx_open")
		intro_1_2=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=1 and sort2=3"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_1_3=0
		intro_1_3=0
	else
		open_1_3=rs1("qx_open")
		intro_1_3=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=1 and sort2=6"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_1_6=0
		intro_1_6=0
	else
		open_1_6=rs1("qx_open")
		intro_1_6=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=1 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_1_8=0
		intro_1_8=0
	else
		open_1_8=rs1("qx_open")
		intro_1_8=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open from power  where ord="&session("personzbintel2007")&" and sort1=1 and sort2=9"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_1_9=0
	else
		open_1_9=rs1("qx_open")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	elseif open_1_1=1 then
		list="and cateid in ("&intro_1_1&")"
	else
		list="and cateid=0"
	end if
	dim rs,sql,Str_Result,Str_Result2
	Str_Result="where ((del=1 and sort3=1 "&list&")  or  ((share like '%"&session("personzbintel2007")&"%' or share='1') and cateid <>"&session("personzbintel2007")&" and del=1 and sort3=1) or  ((order1<>'2' and order1<>'3' or (order1=3 and cateid4="&session("personzbintel2007")&")) and del=1 and sort3=1))"
	Str_Result2="and ((del=1 and sort3=1  "&list&") or  ((share like '%"&session("personzbintel2007")&"%' or share='1') and cateid <>"&session("personzbintel2007")&" and del=1 and sort3=1)  or   ((order1<>'2' and order1<>'3' or (order1=3 and cateid4="&session("personzbintel2007")&")) and del=1 and sort3=1))"
...
'Private Sub Class_Initialize
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "#kh .anybutton{*margin-bottom:-0.5px}" & vbcrlf & ".tableTitleLinks{" & vbcrlf & "      color:#000!important;" & vbcrlf & "}" & vbcrlf & "</style>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "function do_search(){" & vbcrlf & "  //if(trim(document.getElementById(""sear"").value)=="""") {alert('请输入搜索内容');return;}" & vbcrlf & "     var val=document.getElementById(""sear"").value; "& vbcrlf &"    if(document.getElementById(""tit_1"").value==""F2""){window.location=""?F1=1&F2=""+UrlEncode(val)+""&sear=""+UrlEncode(val);}; "& vbcrlf &"   if(document.getElementById(""tit_1"").value==""S2""){window.location=""?S1=1&S2=""+UrlEncode(val)+""&sear=""+UrlEncode(val);}; "& vbcrlf & "       if(document.getElementById(""tit_1"").value==""Y2""){window.location=""?Y1=1&Y2=""+UrlEncode(val)+""&sear=""+UrlEncode(val);};" & vbcrlf & "  if(document.getElementById(""tit_1"").value==""G2""){window.location=""?G1=1&G2=""+UrlEncode(val)+""&sear=""+UrlEncode(val);};" & vbcrlf & "  if(document.getElementById(""tit_1"").value==""P2""){window.location=""?P1=1&P2=""+UrlEncode(val)+""&sear=""+UrlEncode(val);};" & vbcrlf & "   if(document.getElementById(""tit_1"").value==""J2""){window.location=""?J1=1&J2=""+UrlEncode(val)+""&sear=""+UrlEncode(val);};" & vbcrlf & "  if(document.getElementById(""tit_1"").value==""T2""){window.location=""?T1=1&T2=""+UrlEncode(val)+""&sear=""+UrlEncode(val);};" & vbcrlf & "}" & vbcrlf & "jQuery(document).ready(function(){" & vbcrlf & "    jQuery('#sear').bind('keydown',function(e){" & vbcrlf & "        if(event.keyCode==13){" & vbcrlf & "                       jQuery('.anybutton:button[value=""检索""]').trigger('click');" & vbcrlf & "                  return false;" & vbcrlf & "        }" & vbcrlf & "  });" & vbcrlf & "})" & vbcrlf & "function callServer2() {" & vbcrlf & "  var url = ""liebiao_tj2.asp?TName=1&timestamp="" + new Date().getTime() + ""&date1=""+ Math.round(Math.random()*100)+""&E="
	Response.write request("E")
	Response.write "&F="
	Response.write request("F")
	Response.write """;" & vbcrlf & "  xmlHttp.open(""GET"", url, false);" & vbcrlf & "  xmlHttp.onreadystatechange = function(){" & vbcrlf & "  updatePage2();" & vbcrlf & "  };" & vbcrlf & "  xmlHttp.send(null);" & vbcrlf & "}" & vbcrlf & "function updatePage2() {" & vbcrlf & "var test7=""ht1""" & vbcrlf & "  if(xmlHttp.readyState < 4) {" & vbcrlf & "  ht1.innerHTML=""loading..."";" & vbcrlf & "  }" & vbcrlf & "  if (xmlHttp.readyState == 4) {" & vbcrlf & "    var response = xmlHttp.responseText;" & vbcrlf & "    ht1.innerHTML=response;" & vbcrlf & " xmlHttp.abort();" & vbcrlf & "  }" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body "
	if open_1_8=0 then
	...
	Response.write " onMouseOver=""window.status='none';return true;"">" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & ""
	W1=request("W1")
	W2=request("W2")
	W3=request("W3")
	A2=request("A2")
	...
	time3=request("time3")
	time4=request("time4")
	if request("time1")="" or isnull(request("time1")) Then time12="00"
	if request("time2")="" or isnull(request("time2")) Then time22="00"
	if request("time3")="" or isnull(request("time3")) Then time3="23"
	if request("time4")="" or isnull(request("time4")) Then time4="59"
	dim del
	del=trim(request("del"))
	sort46=0
	set rs=conn.execute("select intro from setopen  where sort1=46 ")
	If Not rs.eof then
		sort46=rs("intro")
	end if
	rs.close
	Str_Result=replace(Str_Result,"where","and")
	if B<>"" or (open_1_6=3 or open_1_6=1) or (F1<>"" and F2<>"") or (sort46=1 or sort46=2) then
		Str_Result=" and del=1 and  sort3=1 "
	end if
	If Abandon<>"" Then
		Abandon=Replace(Abandon," ","")
		Str_Result=Str_Result+" and  sortfq in ("&Abandon&") "
		'Abandon=Replace(Abandon," ","")
	end if
	if G<>"" then
		Str_Result=Str_Result+" and  order1 in ("&G&") "
'if G<>"" then
		Response.expires=-1
'if G<>"" then
		Response.AddHeader"pragma","no-cache"
...
'if G<>"" then
	...
	if W4<>"" Then
		...
		case 1:
		If InStr(","&Replace(G," ","")&",",",3,")>0 Then
			Str_Result=Str_Result+"and  (cateid in  ("&W3&") or cateid4 in  ("&W3&"))"
'If InStr(","&Replace(G," ","")&",",",3,")>0 Then
		else
...
'If InStr(","&Replace(G," ","")&",",",3,")>0 Then
		...
		case 2:
		Str_Result=Str_Result+"and  cateidgq in  ("&W3&")"
'case 2:
		case 3:
		Str_Result=Str_Result+"and  cateadd in  ("&W3&")"
'case 3:
		case 4:
		Str_Result=Str_Result+"and  (cateid in  ("&W3&") and cateadd in ("&W3&"))"
'case 4:
		case 5:
		Str_Result=Str_Result+"and  (cateidgq in  ("&W3&") and cateadd in ("&W3&"))"
'case 5:
		end select
	end if
	Function selects(id)
		...
		rs.close
		If Len(strid)=0 Then strid = -1
		strid = strid&","&rs(0)
		selects=strid
	end function
	if A2<>"" Then Str_Result=Str_Result+"and  area in ("&selects(Replace(A2," ",""))&")"
	'selects=strid
	if D<>"" Then Str_Result=Str_Result+"and  trade in  ("&D&")"
	'selects=strid
	if A1<>"" Then Str_Result=Str_Result+"and  jz in  ("&A1&")"
	'selects=strid
	if A3<>"" Then Str_Result=Str_Result+"and  ly in  ("&A3&")"
	'selects=strid
	if E<>"" Then Str_Result=Str_Result+"and  sort in  ("&E&")"
	'selects=strid
	if F<>"" Then Str_Result=Str_Result+"and  sort1 in  ("&F&")"
	'selects=strid
	if zdy5<>"" Then Str_Result=Str_Result+"and  zdy5 in  ("&zdy5&")"
	'selects=strid
	if zdy6<>"" Then Str_Result=Str_Result+"and  zdy6 in  ("&zdy6&")"
	'selects=strid
	if m1<>"" Then Str_Result=Str_Result+" and date1>='"&m1&" "&time12&":"&time22&":01 '"
	'selects=strid
	if m2<>"" Then Str_Result=Str_Result+" and date1<='"&m2&" "&time3&":"&time4&":59 ' "
	'selects=strid
	if N1<>"" Then Str_Result=Str_Result+" and dategq>='"&N1&"' "
	'selects=strid
	if N2<>"" Then Str_Result=Str_Result+" and dategq<='"&N2&"' "
	'selects=strid
	If H="" Then H=0
	Select Case H
	Case "3" : Str_Result=Str_Result+"and x='2'"
'Select Case H
	Case "4" : Str_Result=Str_Result+"and h='2'"
'Select Case H
	Case "5" : Str_Result=Str_Result+"and datealt<>''"
'Select Case H
	Case "6" : Str_Result=Str_Result+"and profect1=1"
'Select Case H
	Case "7" : str_Result=" and share<>'' and share<>'0' and share<>'0,0' and cateid ="&session("personzbintel2007")&" and del=1"
	Case "8" : str_Result=" and (charindex('," & session("personzbintel2007") & ",',','+cast(share as varchar(8000))+',')>0 or share='1') and cateid <>"&session("personzbintel2007")&" and del=1"
	Case "35" :
	t2=request("t2")
	w3=request("W3")
	Str_Result=" and del=1 "
	If Len(W3)>0 Then Str_Result= Str_Result & " and isnull(cateadd,0) in ("&w3&")"
	If isdate(t2) Then Str_Result= Str_Result & " and datediff(d,'"&t2&"',date1)=0 "
	Case "53" :
	if open_1_6=3 then
		Str_Result_53=""
	elseif open_1_6=1 then
		Str_Result_53="and cateid4 in ("&intro_1_6&")"
	else
		Str_Result_53="and 1=0"
	end if
	Str_Result=Str_Result+"and order1=3" +Str_Result_53
	'Str_Result_53="and 1=0"
	Case "31" :
	v2=request("v2")
	...
	If W31="0" Then W31=session("personzbintel2007")
	Str_Result=Str_Result + " and cateadd in(" & W31 &") and datediff(d,date1,'" & t2 & "')=0 and isnull(sp,0)=0 and del=1 and sort3=1"
	If W31="0" Then W31=session("personzbintel2007")
	If sortord>0 Then
		If sort1ord>0 Then
...
'If sort1ord>0 Then
	...
	Case Else
	If isdate(v2)=True then Str_Result=Str_Result+" and datediff(d,date2,'" & v2 & "')>=0 and  cateid4 in  ("&W31&")"
'Case Else
	End Select
	end Select
...
'Select Case intType
	...
	if px=1 then
		px_Result1="order by date1 desc"
		px_Result2="order by date1 asc"
		px_Result="order by tel.date1 desc,tel.ord asc"
	elseif px=2 then
		px_Result1="order by date1 asc"
		px_Result2="order by date1 desc"
		px_Result="order by tel.date1 asc,tel.ord asc"
	elseif px=3 then
		px_Result1="order by name desc,date1 desc"
		px_Result2="order by name asc,date1 asc"
		px_Result="order by tel.name desc,tel.date1 desc,tel.ord asc"
	elseif px=4 then
		px_Result1="order by name asc,date1 asc"
		px_Result2="order by name desc,date1 desc"
		px_Result="order by tel.name asc,tel.date1 asc,tel.ord asc"
	elseif px=5 then
		px_Result1="order by khid desc,date1 desc"
		px_Result2="order by khid asc,date1 asc"
		px_Result="order by tel.khid desc,tel.date1 desc,tel.ord asc"
	elseif px=6 then
		px_Result1="order by khid asc,date1 asc"
		px_Result2="order by khid desc,date1 desc"
		px_Result="order by tel.khid asc,tel.date1 asc,tel.ord asc"
	elseif px=7 then
		px_Result1="order by date2 desc,date1 desc"
		px_Result2="order by date2 asc,date1 asc"
		px_Result="order by tel.date2 desc,tel.date1 desc,tel.ord asc"
	elseif px=8 then
		px_Result1="order by date2 asc,date1 asc"
		px_Result2="order by date2 desc,date1 desc"
		px_Result="order by tel.date2 asc,tel.date1 asc,tel.ord asc"
	elseif px=9 then
		px_Result1="order by datealt desc,date1 desc"
		px_Result2="order by datealt asc,date1 asc"
		px_Result="order by tel.datealt desc,tel.date1 desc,tel.ord asc"
	elseif px=10 then
		px_Result1="order by datealt asc,date1 asc"
		px_Result2="order by datealt desc,date1 desc"
		px_Result="order by tel.datealt asc,tel.date1 asc,tel.ord asc"
	elseif px=12 then
		px_Result1="order by cname desc,date1 desc"
		px_Result2="order by cname asc,date1 asc"
		px_Result="order by [销售人员] desc,tel.date1 desc,tel.ord asc"
	elseif px=13 then
		px_Result1="order by cname asc,date1 asc"
		px_Result2="order by cname desc,date1 desc"
		px_Result="order by [销售人员] asc,tel.date1 asc,tel.ord asc"
	end if
	sort_9=0
	set rs=conn.execute("select intro from setopen  where sort1=30 ")
	if Not rs.eof Then
		sort_9=rs("intro")
	end if
	rs.close
	if sort_9="1" Then Str_Result=Str_Result+"and  profect1<>1"
	'sort_9=rs("intro")
	currpage=Request("currpage")
	if currpage<="0" or currpage="" Then currpage=1
	currpage=clng(currpage)
	s_it1=get_Items(1001,1)
	s_it2=get_Items(1001,2)
	s_it5=get_Items(1001,5)
	...
	slie_2=0
	slie_5=0
	if request("lie_1")&""<>"" Then slie_1=cdbl(request("lie_1"))
	if request("lie_2")&""<>"" Then slie_2=cdbl(request("lie_2"))
	if request("lie_5")&""<>"" Then slie_5=cdbl(request("lie_5"))
	Flag_LockItems=false
	if (slie_1=cdbl(s_it1) or lie_1=s_it1) and (slie_2=cdbl(s_it2) or lie_2=s_it2) and (slie_5=cdbl(s_it5) or lie_5=s_it5) Then Flag_LockItems=true
	Select Case lie_5
	...
	Dim arrName()
	Dim arrFelds()
	Set rs=conn.execute("select (case when isnull(name,'')='' then oldname else name end ) as name, (case when show>0 then 1 else 0 end) as show,fieldName,gate1 from setfields order by gate1 asc ")
	While Not rs.eof
		intgate1=rs("gate1")
	...
	wend
	rs.close
	Response.write "  <form action=""teltop.asp?page_count="
	Response.write page_count
	Response.write """ method=""get""　id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"" style=""margin:0"">" & vbcrlf & "        <table class=""resetTableBg"" width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "        <tr>" & vbcrlf & "    <td class=""place"">客户池</td>" & vbcrlf & "       <td>&nbsp;<a class=""tableTitleLinks sortRule"" href=""javascript:void(0)"" onClick=""Myopen(User);return false;"">排序规则<img src=""../images/i10.gif"" width=""9"" height=""5"" border=""0""></a></td>" & vbcrlf & "      <td align=""right""><div id=""kh"" style=""height:22px;line-height:22px;""> "& vbcrlf &"            <SELECT id=""tit_1""> "& vbcrlf &"                <OPTION "
	Response.write page_count
	if F2<>"" and request("sear")<>"" then Response.write("selected='selected'") end if
	Response.write " value=""F2"">"
	Response.write arrName(1)
	Response.write "</OPTION>" & vbcrlf & "            <OPTION "
	if S2<>"" and request("sear")<>"" then Response.write("selected='selected'") end if
	Response.write "  value=""S2"">"
	Response.write arrName(2)
	Response.write "</OPTION>" & vbcrlf & "            <OPTION "
	if Y2<>"" and request("sear")<>"" then Response.write("selected='selected'") end if
	Response.write "  value=""Y2"">"
	Response.write arrName(3)
	Response.write "</OPTION>" & vbcrlf & "            "
	If arrShow(19)=1 Then
		Response.write "" & vbcrlf & "                     <OPTION "
		if G2<>"" and request("sear")<>"" then Response.write("selected='selected'") end if
		Response.write "  value=""G2"">"
		Response.write arrName(19)
		Response.write "</OPTION>" & vbcrlf & "            "
	end if
	If arrShow(21)=1 Then
		Response.write "" & vbcrlf & "                     <OPTION "
		if P2<>"" and request("sear")<>"" then Response.write("selected='selected'") end if
		Response.write "  value=""P2"">"
		Response.write arrName(21)
		Response.write "</OPTION>" & vbcrlf & "            "
	end if
	If arrShow(12)=1 Then
		Response.write "" & vbcrlf & "                     <OPTION "
		if J2<>"" and request("sear")<>"" then Response.write("selected='selected'") end if
		Response.write "  value=""J2"">"
		Response.write arrName(12)
		Response.write "</OPTION>" & vbcrlf & "            "
	end if
	If arrShow(37)=1 Then
		Response.write "" & vbcrlf & "             <OPTION "
		if T2<>"" and request("sear")<>"" then Response.write("selected='selected'") end if
		Response.write "  value=""T2"">"
		Response.write arrName(37)
		Response.write "</OPTION>" & vbcrlf & "            "
	end if
	Response.write "" & vbcrlf & "             </SELECT>" & vbcrlf & "               <input type=""text"" maxlength=""50"" size=""18"" id=""sear"" name=""sear"" style=""width:114px;"" value="""
	Response.write Replace(request("sear"),"""","&#34;")
	Response.write """>" & vbcrlf & "                <input type=""button""  value=""检索"" class=""anybutton"" onClick=""do_search()"" >" & vbcrlf & "            "
	if open_1_9=1 then
		Response.write "" & vbcrlf & "             <input type=""button"" name=""Submitdel22"" value=""客户导入"" onClick=""window.location.href='../load/iXs_UpLoadPost.asp?bgColor=F1F3F5&amp;Wid=0'"" class=""anybutton""/>" & vbcrlf & "         "
	end if
	Response.write "&nbsp;" & vbcrlf & "    "
	if open_1_10=1 or open_1_10=3 then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出资料"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({page:'../out/xls.asp?actdc=1',postParams:[{n:'px_v',v:document.getElementById('px_1').value},{n:'Str_Result_v',v:document.getElementById('ReportOrds_1').value}]});}"" class=""anybutton2""/>"
	end if
	Response.write "" & vbcrlf & "    <a href=""javascript:void(0)"" class=""AfterQuickSearch"" onclick=""callServer2();document.getElementById('kh').style.display='none';document.getElementById('ht1').style.display='block';return false;""><img src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a></div></td><td width=""3""><img class=""resetElementHidden"" src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td> "& vbcrlf &"     </tr> "& vbcrlf &"   </table> "& vbcrlf &"     <span id=""ht1"" style=""padding:20px;display:none""></span> "& vbcrlf & "        </form>" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" class=""detailTable"" style=""margin-left:20px"">" & vbcrlf & "     <tr class=""top"">" & vbcrlf & "    <td align=""center"" width=""6%""><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "   <td width=""20%"" height=""27"" align=""center""><div align=""center""><strong>"
	Response.write arrName(1)
	Response.write "</strong></div></td>" & vbcrlf & "   <td width=""8%""><div align=""center""><strong>领用情况</strong></div></td>" & vbcrlf & "     <td width=""7%""><div align=""center""><strong>领用人</strong></div></td>" & vbcrlf & "       <td width=""7%""><div align=""center""><strong>指派人</strong></div></td>" & vbcrlf &"   <td width=""9%""><div align=""center""><strong>领用日期</strong></div></td>" & vbcrlf & "     <td width=""12%""><div align=""center"">" & vbcrlf & "          <select name=""select"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style=""max-width:110px;BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px solid #FFFFFF; overflow:hidden"" >" & vbcrlf & "          <option>-请选择-</option>" & vbcrlf & "          <option value=""lie_1=1"" "
	Response.write arrName(1)
	if lie_1=1 then
		Response.write "selected"
	end if
	Response.write "><strong>放弃原因</b></option>" & vbcrlf & "          <option value=""lie_1=2"" "
	if lie_1=2 then
		Response.write "selected"
	end if
	Response.write ">"
	Response.write arrName(4)
	Response.write "</option>" & vbcrlf & "              <option value=""lie_1=3"" "
	if lie_1=3 then
		Response.write "selected"
	end if
	Response.write ">"
	Response.write arrName(6)
	Response.write "</option>" & vbcrlf & "              <option value=""lie_1=4"" "
	if lie_1=4 then
		Response.write "selected"
	end if
	Response.write ">"
	...
	While Not rst.eof
		If rst("name")="zdy1" Then
			arr(0)=rst("name")
			zdyname=5
			Response.write "" & vbcrlf & "                                      <option value=""lie_1="
	...
	Response.write "" & vbcrlf & "        </select>" & vbcrlf & "        </div></td>" & vbcrlf & "     <td width=""7%""><div align=""center"">" & vbcrlf & "           <select name=""select2"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px solid #FFFFFF; overflow:hidden"" >" & vbcrlf & "          <option>-请选择-</option>" & vbcrlf & "          <option value=""lie_2=1"" "
	'rst.close:Set rst=nothing
	if lie_2=1 then
		Response.write "selected"
	end if
	Response.write ">放弃人</option>" & vbcrlf & "          <option value=""lie_2=2"" "
	if lie_2=2 then
		Response.write "selected"
	end if
	Response.write ">"
	Response.write arrName(5)
	Response.write "</option>" & vbcrlf & "          <option value=""lie_2=3"" "
	if lie_2=3 then
		Response.write "selected"
	end if
	Response.write ">保护状态</option>" & vbcrlf & "              <option value=""lie_2=4"" "
	if lie_2=4 then
		Response.write "selected"
	end if
	Response.write ">"
	...
	ReDim arr(6)
	While Not rst.eof
		If rst("name")="zdy5" Then
			arr(4)=rst("name")
			zdyname=5
			Response.write "" & vbcrlf & "                                       <option value=""lie_2="
			Response.write zdyname
			Response.write """ "
			if lie_2=5 then
				Response.write "selected"
	...
	wend
	rst.close:Set rst=nothing
	Response.write "" & vbcrlf & "        </select>" & vbcrlf & "       </div></td>" & vbcrlf & "     <td width=""8%""><div align=""center"">放弃日期</div></td>" & vbcrlf & "      <td width=""16%""><div align=""center"">" & vbcrlf & "          <select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px solid #FFFFFF; overflow:hidden"">" & vbcrlf & "          <option>-请选择-</option>" & vbcrlf & "          <option value=""lie_5=1"" "
	'rst.close:Set rst=nothing
	if lie_5=1 then
		Response.write "selected"
	end if
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "        </select>" & vbcrlf & "        &nbsp;<input type=""checkbox"" id=""LockItems"" onClick=""SaveItems(1001,"
	...
	Response.write ")"" "
	if Flag_LockItems then Response.write " title='取消标题栏' checked " else Response.write " title='默认标题栏'" end if
	Response.write ">" & vbcrlf & "       </div></td>" & vbcrlf & "    </tr>" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	sql="select intro from setopen  where sort1=47 "
	rs.open sql,conn,1,1
	if rs.eof then
		sort47=0
	else
	...
	rs.close
	set rs=nothing
	openPower1="" : intro_1_18 = "0"
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open, qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=1 and sort2=18"
	rs1.open sql1,conn,1,1
	if rs1.eof = False then
		openPower1=rs1("qx_open") : intro_1_18 = rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	If intro_1_18&"" = "" Then intro_1_18 = "0"
	if isnull(openPower1) or not isNumeric(openPower1) or openPower1="" then
		openPower1=0
	end if	
	if sort46<>0 and sort46<>"" then
		if openPower1=1 then
			if sort46=1 then
				if  sort47=1 then
					Str_Result=Str_Result&" and (order1<>2 and (cateadd in("& intro_1_18 &"))) "
				elseif sort47=2 then
					Str_Result=Str_Result&" and (order1<>2 and (cateidgq in("& intro_1_18 &"))) "
				else
					Str_Result=Str_Result&" and (order1<>2 and (cateidgq in("& intro_1_18 &") or cateadd in("& intro_1_18 &"))) "
				end if
			elseif sort46=2 then
				if  sort47=1 then
					Str_Result=Str_Result&"  and (cateadd in("& intro_1_18 &")) "
				elseif sort47=2 then
					Str_Result=Str_Result&"  and (cateidgq in("& intro_1_18 &")) "
				elseif sort47=3 then
					Str_Result=Str_Result&"  and (cateid in("& intro_1_18 &")) "
				else
					Str_Result=Str_Result&"  and (cateidgq in("& intro_1_18 &") or cateadd in("& intro_1_18 &")) "
				end if
			else
			end if
		elseif openPower1=3 or openPower1="" then
		else
			Str_Result=Str_Result&" and 1=2 "
		end if
	end if
	Dim remind,helper,remindCondition
	remind = request("remind")
	If remind <> "" Then
		Set helper = CreateReminderHelper(conn,remind,0)
		remindCondition = " and ord in (" & helper.listSql("ids") & ")"
	end if
	Dim ishaszdy5 : ishaszdy5 = (conn.execute("select 1 from zdy where sort1=1 and set_open=1 and name='zdy5' ").eof = false)
	Dim ishaszdy6 : ishaszdy6 = (conn.execute("select 1 from zdy where sort1=1 and set_open=1 and name='zdy6' ").eof = false)
	dim share
	set rs2=server.CreateObject("adodb.recordset")
	sql2="select top 1 intro  from setsort  "
	rs2.open sql2,conn,1,1
	If rs2.eof=False Then share=trim(rs2("intro"))
	if share="" or isnull(share) then share=0
	rs2.close
	sqlcount="select count(*) from tel where isnull(sp,0)=0 "&Str_Result & remindCondition & " and sort1 in ("&share&")"
...
'if currpage=pagecount then
	...
	set rs=server.CreateObject("adodb.recordset")
	set rs7=server.CreateObject("adodb.recordset")
	Str_Result = Str_Result & remindCondition & " and sort1 in ("&share&")"
	sql="select "&_
	"(case when cateid>0 then (select name from gate where ord=tel.cateid) else NULL  end ) as cname,"&_
	"*,s1.zdy5name,s2.zdy6name from tel WITH(NOLOCK) "&_
	"inner join (select ord as telord from (select top "&intcount&" (case when cateid>0 then (select name from gate where ord=tel.cateid) else NULL  end ) as cname, ord from tel WITH(NOLOCK) where ord in (select ord from (select top "&page_count*CurrPage&" (case when cateid>0 then (select name from gate where ord=tel.cateid) else NULL  end ) as cname,ord from tel WITH(NOLOCK) "&_
	" where isnull(sp,0)=0 " & Str_Result &_
	" "&px_Result1&",ord asc) as t1 )  "&px_Result2&",ord desc) as t2 ) xxa on xxa.telord=tel.ord " &_
	" left join (select ord as zdy5_ord ,sort1 as zdy5name from sortonehy where gate2=101) s1 on s1.zdy5_ord =isnull(tel.zdy5,0) " &_
	" left join (select ord as zdy6_ord ,sort1 as zdy6name from sortonehy where gate2=102) s2 on s2.zdy6_ord =isnull(tel.zdy6,0) " &_
	" where 1=1 "&px_Result1&",ord asc "
	rs.open sql,conn,3,1
	if rs.eof then
		Response.write "<table><tr><td  align='center' class='name'>没有信息!</td></tr></table>"
	else
		i=0
		Response.write "" & vbcrlf & "   <form name=""form1"" method=""post"" action=""deletetopall.asp?"
		Response.write sdk.ReturnURL("")
		Response.write """>" & vbcrlf & ""
		dim k, cateid, cateagree,catefqname
		do until rs.eof
			k=rs("name")
			cateid=rs("cateid")
			cateid4=rs("cateid4")
			...
			zdy4=rs("zdy4")
			zdy5=rs("zdy5")
			zdy5name = rs("zdy5name")&""
			zdy6=rs("zdy6")
			zdy6name = rs("zdy6name")&""
			If Len(zdy5&"")=0 Then zdy5=0
			If Len(zdy6&"")=0 Then zdy6=0
			If Len(time1&"")=0 Then time1=0
			if cateid<>"" then
				sql1="select num_6,num_7 from gate WITH(NOLOCK) where ord="&cateid&" "
			...
			trade=rs("trade")
			area=rs("area")
			If Len(trade&"")=0 Then trade=0
			rs7.open "select sort1 from sortonehy WITH(NOLOCK) where gate2=11 and ord="&trade&" ",conn,1,1
			If Not rs7.eof Then
				tradeName=rs7("sort1")
			else
				tradeName=""
			...
			if open_1_3=3 or (open_1_3=1 and CheckPurview(intro_1_3,trim(cateid))=True) or open_1_6=3 or (open_1_6=1 and (CheckPurview(intro_1_6,trim(cateid))=True Or CheckPurview(intro_1_6,trim(rs("cateadd")))=True or CheckPurview(intro_1_6,trim(cateid4)))) then
				Response.write "<input name=""selectid"" type=""checkbox"" id=""selectid"" value="""
				Response.write rs("ord")
				Response.write """>"
			end if
			Response.write "</td>" & vbcrlf & "          <td height=""27"" align=""center""><div align=""left"">"
			if open_1_14=3 Or (open_1_14=1 And CheckPurview(intro_1_14,trim(cateid))=True  And cateid<>0) then
				...
				Response.write "','newttwin','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,resizable=1,toolbar=0,left=100,top=100');return false;"">"
				Response.write pwurl(rs("ord"))
				if rs("profect1")=2 then
					Response.write "<font class="""
					if rs("order1")<>"2" then
						Response.write "red"
					end if
					Response.write """>"
					Response.write""&k&""
					Response.write "</font>"
				elseif (rs("datepro")+time1-now)<=time2 and rs("profect1")=1 then
					Response.write "</font>"
					Response.write "<font class=""blue2"">"
					Response.write""&k&""
					Response.write "</font>"
				else
					Response.write""&k&""
				...
				if rs("profect1")=2 then
					...
					Response.write""&k&""
					Response.write "</font>"
				elseif (rs("datepro")+time1-now)<=time2 then
					Response.write "</font>"
					Response.write "<font class=""blue2"">"
					Response.write""&k&""
					Response.write "</font>"
			...
			if del&""<>"" then
				if Instr(","&del&",",","&rs("ord")&",")>0 then
					Response.write "" & vbcrlf & "                     <font color=""red"">不允许删除</font>" & vbcrlf & "                       "
				end if
			end if
			Response.write "" & vbcrlf & "       </div></td>" & vbcrlf & "   <td ><div align=""center"">" & vbcrlf & " "
			if rs("order1")="3" then
				Response.write "" & vbcrlf & "     <font class=""red"">待审批</font>" & vbcrlf & "   "
			elseif rs("order1")="2" then
				Response.write "" & vbcrlf & "     <font class=""name"">已领用</font>" & vbcrlf & "  "
			elseif rs("order1")="1" then
				Response.write "" & vbcrlf & "     <font class=""name"">全公开</font>" & vbcrlf & "  "
			else
				Response.write "" & vbcrlf & "未领用" & vbcrlf & ""
			end if
			Response.write "" & vbcrlf & "</div></td>" & vbcrlf & ""
			cateidname=""
			if rs("order1")="1" then
				cateidname="全公开"
			elseif rs("order1")="3" then
				sql7="select name from gate WITH(NOLOCK) where ord='"&rs("cateid4")&"'"
				rs7.open sql7,conn,1,1
				if not rs7.eof then cateidname=rs7("name")
				rs7.close
			elseif rs("order1")="2" then
				sql7="select name from gate WITH(NOLOCK) where ord='"&rs("cateid")&"'"
				rs7.open sql7,conn,1,1
				if not rs7.eof then cateidname=rs7("name")
				rs7.close
			end if
			...
			cateorder1=""
			catefqname=""
			cateidgq=rs("cateidgq")
			cateadd=rs("cateadd")
			if rs("cateorder1")<>"" then
				sql7="select name from gate WITH(NOLOCK) where ord="&rs("cateorder1")&""
				rs7.open sql7,conn,1,1
				if not rs7.eof then cateorder1=rs7("name")
				rs7.close
			end if
			if rs("cateidgq")<>"" then
				sql7="select name from gate WITH(NOLOCK) where ord="&rs("cateidgq")&""
				rs7.open sql7,conn,1,1
				if not rs7.eof then catefqname=rs7("name")
				rs7.close
			else
				catefqname=""
			end if
			Response.write "" & vbcrlf & "          <td><div align=""center"">"
			Response.write cateorder1
			...
			If lie_1=1 then
				Select Case rs("sortfq")&""
				Case "1" : Response.write "领用未联系"
				Case "2" : Response.write "间隔未联系"
				Case "3" : Response.write "跟进未成功"
				Case "4" : Response.write "保护过期"
				Case "5" : Response.write "主动放弃"
				Case "6" : Response.write "主管收回"
				Case "7" : Response.write "跟进超期收回"
				Case "8" : Response.write "领用超期收回"
				End Select
			ElseIf lie_1=3 then
				lyname=""
				if ly<>"" then
					sql7="select sort1 from sortonehy WITH(NOLOCK) where ord="&ly&""
			...
			ElseIf lie_1=4 then
				jzname=""
				if jz<>"" then
					sql7="select sort1 from sortonehy WITH(NOLOCK) where ord="&jz&""
					rs7.open sql7,conn,3,1
					if not rs7.eof then
						jzname=rs7("sort1")
					end if
			...
			ElseIf lie_1=2 then
				sort67=""
				if sort<>"" then
					sql7="select sort1 from sort4 WITH(NOLOCK) where ord="&sort&""
					rs7.open sql7,conn,1,1
					if not rs7.eof then sort67=rs7("sort1")
					rs7.close
				end if
				Response.write ""&sort67&""
			ElseIf lie_1=5 Then
				Response.write ""&zdy1
			ElseIf lie_1=6 Then
				Response.write ""&zdy2
			...
			Response.write "" & vbcrlf & "          </div></td>" & vbcrlf & "          <td><div align=""center"">" & vbcrlf & ""
			if lie_2=1 then
				Response.write ""&catefqname&""
			elseif lie_2=2 then
				sort1=""
				if sortlist<>"" then
					sql7="select sort2 from sort5 WITH(NOLOCK) where ord="&sortlist&""
					rs7.open sql7,conn,1,1
					if not rs7.eof then sort1=rs7("sort2")
					rs7.close
				end if
				Response.write ""&sort1&""
			elseif lie_2=3 then
				if rs("profect1")=1 then
					Response.write "已保护"
				elseif rs("profect1")=2 then
					Response.write "保护过期"
				else
					Response.write "未保护"
				end if
			...
			ElseIf lie_2=5 Then
				Response.write ""&zdy5Name
			ElseIf lie_2=6 Then
				Response.write ""&zdy6Name
			end if
			islingy=True
			islingy = canGetCompany(rs("ord"),false, True, True , 0 , true ,0,"","","","","","","","","", False, session("personzbintel2007") ,sort,sort1,ly,jz,trade,area,zdy5,zdy6, False, ishaszdy5, ishaszdy6)
			Response.write "" & vbcrlf & "                                             </div></td>" & vbcrlf & "          <td><div align=""center"">"
			Response.write rs("dategq")
			Response.write "</div></td>" & vbcrlf & "                  <td class=""func""><div align=""center"">" & vbcrlf & "                       "
			if rs("order1")="3" then
				if open_1_6=3 or (open_1_6=1 and (CheckPurview(intro_1_6,trim(cateid)) or CheckPurview(intro_1_6,trim(cateid4)))) then
					Response.write "" & vbcrlf & "                                     <input type=""button"" name=""Submit"" value=""同意"" onClick=""if(confirm('确认同意？')){window.location.href='sqyes.asp?"
					Response.write sdk.ReturnURL("ord="& rs("ord") &"&member2="& rs("cateid4") &"")
					Response.write "'}""/>" & vbcrlf & "                                     <input type=""button"" name=""Submit"" value=""否决"" onClick=""if(confirm('确认否决？')){window.location.href='sqno.asp?"
					Response.write sdk.ReturnURL("ord="& rs("ord") &"")
					Response.write "'}""/>" & vbcrlf & "                             "
				end if
			else
				if rs("order1")="0" And islingy then
					Response.write "" & vbcrlf & "                                     <input type=""button"" name=""Submit"" value=""申请"" onClick=""if(confirm('确认申请？')){window.location.href='ordersq.asp?"
					Response.write sdk.ReturnURL("ord="& rs("ord") &"")
					Response.write "'}""  /> " & vbcrlf & "                          "
				end if
				if open_1_6=3 or CheckPurview(intro_1_6,trim(cateadd))=True then
					Response.write "" & vbcrlf & "                                     <input type=""button"" name=""Submit3"" value=""指派""  onClick=""javascript:window.open('order.asp?ord="
					Response.write pwurl(rs("ord"))
					Response.write "','newwin','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>" & vbcrlf & "                                  "
					Response.write pwurl(rs("ord"))
					If (rs("order1")=2 And cateid&""<>"") Or (rs("order1")=3 And rs("cateid4")&""<>"") Or rs("order1")=1 Then
						Response.write "<input type=""button"" name=""Submit"" value=""收回"" onClick=""if(confirm('确认收回？')){window.location.href='saveback.asp?"
						Response.write sdk.ReturnURL("ord="& pwurl(rs("ord")) &"")
						Response.write "'}""  />"
					end if
				end if
				if open_1_3=3 or CheckPurview(intro_1_3,trim(cateid))=True then
					Response.write "" & vbcrlf & "                                     <input type=""button"" name=""Submit"" value=""删除"" onClick=""window.location.href='delkhconfirm.asp?"
					Response.write sdk.ReturnURL("pag=2&ord="& pwurl(rs("ord")) &"")
					Response.write "';""/>" & vbcrlf & "                             "
				end if
			end if
			...
			rs.movenext
		loop
		Response.write "" & vbcrlf & "      </table>" & vbcrlf & "    </td>" & vbcrlf & "        </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""8%"" height=""30""><div align=""center"">全选 <input name=""chkall"" type=""checkbox"" id=""chkall"" value=""all"" onclick=""mm(this.form)"" />" & vbcrlf & "    </div></td>" & vbcrlf & "    <td width=""34%"">" & vbcrlf & "        "
		if open_1_3=1 or open_1_3=3 then
			Response.write "" & vbcrlf & "             <input type=""submit"" onClick=""test();"" name=""Submit2"" value=""批量删除""  class=""anybutton2""/>" & vbcrlf & "      "
		end if
		if open_1_6=1 or open_1_6=3 then
			Response.write "" & vbcrlf & "             <input type=""button"" name=""Submit422"" value=""批量指派""  onclick=""ask();"" class=""anybutton2""/>" & vbcrlf & "             <input type=""button"" name=""Submit426"" value=""批量收回""  onclick=""ask2();"" class=""anybutton2""/>" & vbcrlf & "            <input type=""button"" name=""Submit427"" value=""批量审批""  onclick=""ask3();"" class=""anybutton2""/>" & vbcrlf & "       "
		end if
		Response.write "" & vbcrlf & "     </td>" & vbcrlf & "           </form>" & vbcrlf & "" & vbcrlf & "         <td width=""48%""><div align=""right"">" & vbcrlf & "     <span class=""black"">共"
		Response.write recCount
		Response.write "条 &nbsp;"
		Response.write page_count
		Response.write "/页  "
		...
		Response.write "/"
		Response.write PageCount
		Response.write "页</span>&nbsp;" & vbcrlf & "     <input  size=3  type=text id=""currpage"" name=""currPage""  onpropertychange=""formatData(this,'int');"" maxlength=8 onkeyup=""checkDot('currpage',0,8)""        >&nbsp;<input type=""button"" name=""Submit422"" value=""跳转"" onClick=""gotourl('currPage='+document.getElementById('currpage').value);""  class=""anybutton2""/>" & vbcrlf & "      "
		if currpage=1 then
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <script language=javascript>" & vbcrlf & "function test()" & vbcrlf & "{" & vbcrlf & "  document.all.form1.action = ""delkhconfirm.asp?"
		Response.write sdk.ReturnURL("pag=2")
		Response.write """;" & vbcrlf & "        document.all.form1.submit();" & vbcrlf & "}" & vbcrlf & "function ask()" & vbcrlf & "{" & vbcrlf & "    document.all.form1.action = ""orderall.asp?"
		Response.write sdk.ReturnURL("")
		Response.write """;" & vbcrlf & "        document.all.form1.submit();" & vbcrlf & "}" & vbcrlf & "function ask2()" & vbcrlf & "{" & vbcrlf & "   document.all.form1.action = ""savebackall.asp?"
		Response.write sdk.ReturnURL("")
		Response.write """;" & vbcrlf & "        document.all.form1.submit();" & vbcrlf & "}" & vbcrlf & "function ask3()" & vbcrlf & "{" & vbcrlf & "   document.all.form1.action = ""sqyesall.asp?"
		Response.write sdk.ReturnURL("")
		Response.write """;" & vbcrlf & "        document.all.form1.submit();" & vbcrlf & "}" & vbcrlf & "function mm(form)" & vbcrlf & "{" & vbcrlf & "for (var i=0;i<form.elements.length;i++)" & vbcrlf & "{" & vbcrlf & "var e = form.elements[i];" & vbcrlf & "if (e.name != 'chkall')" & vbcrlf & "e.checked = form.chkall.checked;" & vbcrlf & "}" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""38"" colspan=""3""><div align=""right""><p>&nbsp;" & vbcrlf & "      </p>" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & " "
	end if
	rs.close
	set rs=nothing
	Set rs7 = Nothing
	action1="客户池"
	call close_list(1)
	Response.write "" & vbcrlf & "     </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<script language=""javascript"">" & vbcrlf & "function Myopen(divID){" & vbcrlf & " if(divID.style.display==""""){" & vbcrlf & "              divID.style.display=""none""" & vbcrlf & "        }else{" & vbcrlf & "          divID.style.display=""""" & vbcrlf &"         } "& vbcrlf &"        divID.style.left=300; "& vbcrlf & "   divID.style.top=0; "& vbcrlf &" } "& vbcrlf &" </script> "& vbcrlf & "<div id=""User"" style=""position:absolute;width:100%; height:400;display:none;""> "& vbcrlf &" <table width=""150"" height=""300""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""139"">" & vbcrlf & "        <table width=""150"" height=""115"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=1');""><font color=""#2F496E"">按添加时间排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=2');""><font color=""#2F496E"">按添加时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=3');""><font color=""#2F496E"">按"
	Response.write arrName(1)
	Response.write "排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=4');""><font color=""#2F496E"">按"
	Response.write arrName(1)
	Response.write "排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=5');""><font color=""#2F496E"">按"
	Response.write arrName(3)
	Response.write "排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=6');""><font color=""#2F496E"">按"
	Response.write arrName(3)
	Response.write "排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=7');""><font color=""#2F496E"">按领用日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>"& vbcrlf & "                 <tr  valign=""middle""> "& vbcrlf &"             <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=gotourl<td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=9');""><font color=""#2F496E"">按待联日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl人排序(降)""</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onClick=""gotourl('px=13');""><font color=""#2F496E"">按领用人排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & ""
