...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {     margin-top: 0px;}" & vbcrlf & "-->" & vbcrlf & "#kh{height:20px!important;line-height:20px!important;}" & vbcrlf & "#ht1 table{margin-bottom:-1px}" & vbcrlf & "</style>" & vbcrlf & "<script src=""../inc/system.js?ver="
	Response.write Application("sys.info.jsver")
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/yp_returnDlist.js?ver="
	Response.write Application("sys.info.jsver")
	...
	if open_101_1=3 then
		list=""
	elseif open_101_1=1 then
		list=" and r.ret_addcateid in ("&intro_101_1&")"
	else
		list=" and r.ret_addcateid=0"
	end if
	Str_Result=" where r.ret_del=1 "&list&""
	Ptr_Result=""
	px=request("px")
	if px="" or isnull(px) then px="1"
	if px="1" then
		Ptr_Result=" order by r.ret_addtime desc"
	elseif px="2" then
		Ptr_Result=" order by r.ret_addtime asc"
	elseif px="3" then
		Ptr_Result=" order by r.ret_time desc"
	elseif px="4" then
		Ptr_Result=" order by r.ret_time asc"
	elseif px="5" then
		Ptr_Result=" order by r.ret_btime desc"
	elseif px="6" then
		Ptr_Result=" order by r.ret_btime asc"
	end if
	ret          =request("ret")
	ret2 =request("ret2")
	A    =request("A")
	...
	if D<>"" then
		Str_Result=Str_Result&" and b.prod_gys like '%"&D&"%' "
	end if
	if E<>"" then
	...
	if J<>"" then
		Str_Result=Str_Result&" and ret_intro like '%"&J&"%' "
	end if
	if L1<>"" then
		Str_Result=Str_Result+" and  datediff(s,'"&L1&" 00:00:00',ret_addtime)>=0 "
'if L1<>"" then
	end if
	if L2<>"" then
		Str_Result=Str_Result+" and  datediff(s,ret_addtime,'"&L2&" 23:59:59')>=0 "
'if L2<>"" then
	end if
	if ret <>"" and not isnull(ret) then
		Str_Result=Str_Result+" and  datediff(s,'"&ret&" 00:00:00',ret_time)>=0 "
'if ret <>"" and not isnull(ret) then
	end if
	if ret2 <>"" and not isnull(ret2) then
		Str_Result=Str_Result+" and  datediff(s,ret_time,'"&ret2&" 23:59:59')>=0 "
'if ret2 <>"" and not isnull(ret2) then
	end if
	if W4<>"" and not isnull(W4) then
		Str_Result=Str_Result&" and ret_cateid in ("&W3&") "
	end if
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "              <form name=""data"" id=""data"" action=""returnDList.asp"" method=""get"">" & vbcrlf & "              <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">返还明细表</td>" & vbcrlf & "                     <td><A onclick=""Myopen(User);return false;"" href=""javascript:;"" class=""sortRule"">排序规则<IMG src=""../images/i10.gif"" alt=""排序规则"" width=""9"" height=""5"" border=""0""></A></td>" & vbcrlf & "            <td align=""right""><div id=""kh"">" & vbcrlf & "                    "
	if open_101_10=3 or (open_101_10=1 and CheckPurview(intro_101_10,trim(session("personzbintel2007"))))=True then
		Response.write "<input name=""submit2"" type=""button""  class=""anybutton2"" value=""导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({from:'form_with_page_action',page:'../out/xls_returnDlist.asp?px="
		Response.write px
		Response.write "&A="
		Response.write A
		Response.write "&B="
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "                </select><a href=""###"" class=""AfterQuickSearch"" onclick=""callServer2();document.getElementById('kh').style.display='none';document.getElementById('ht1').style.display='';return false;""><img src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a></div></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & "        <span id=""ht1""></span>" & vbcrlf & "  </form>"& vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">      " & vbcrlf & "                 <tr valign=""center"" class=""top"">" & vbcrlf & "              <td height=""25"" align=""left"" valign=""middle""  class=""name""><div align=""center"">返还主题</div></td>" &vbcrlf & "                   <td align=""left"" valign=""middle""  class=""name""><div align=""center"">返还时间</div></td>" & vbcrlf & "                  <td align=""left"" valign=""middle""  class=""name""><div align=""center"">名称</div></td>" & vbcrlf & "              <td align=""left"" valign=""middle""  class=""name""><div align=""center"">编号</div></td>" & vbcrlf & "               <td align=""left"" valign=""middle""  class=""name""><div align=""center"">型号</div></td>" & vbcrlf & "          <td align=""left"" valign=""middle""  class=""name""><div align=""center"">单位</div></td>" & vbcrlf & "              <td align=""left"" valign=""middle""  class=""name""><div align=""center"">数量</div></td>" & vbcrlf & "          <td align=""left"" valign=""middle""  class=""name""><div align=""center"">批号</div></td>" & vbcrlf & "              <td align=""left"" valign=""middle""  class=""name""><div align=""center"">序列号</div></td>" & vbcrlf & "            <td align=""left"" valign=""middle""  class=""name""><div align=""center"">生产日期</div></td>" & vbcrlf & "               <td align=""left"" valign=""middle""  class=""name""><div align=""center"">有效日期</div></td>" & vbcrlf & "          <td align=""left"" valign=""middle""  class=""name""><div align=""center"">分类</div></td>" & vbcrlf & "           <td align=""left"" valign=""middle""  class=""name""><div align=""center"">入库仓库</div></td>" & vbcrlf & "            <td align=""left"" valign=""middle""  class=""name""><div align=""center"">备注</div></td>" & vbcrlf & "            </tr>" & vbcrlf & "            "
	currpage=Request("currpage")
	...
	currpage=clng(currpage)
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select a.*,b.reg_fid,b.prod_ph,b.prod_xlh,b.prod_sctime,b.prod_ystime,c.prod_name,c.prod_bh,c.prod_xh,d.sort1,f.pro_name,h.sto_name,r.ret_addcateid,r.ret_title,r.ret_time from O_proRetList a "&_
	" left join O_proReturn r on a.ret_fid=r.id "&_
	" left join O_proOutList g on a.prod_id=g.id "&_
	" left join O_kuinlist b on g.prod_id=b.id "&_
	" left join O_product c on c.id=b.prod_id "&_
	" left join sortonehy d on d.id=b.prod_unit "&_
	" left join O_store h on h.id=b.sto_id "&_
	" left join O_officeType f on c.prod_type=f.id "&Str_Result&" "&Ptr_Result
	rs7.open sql7,conn,1,1
	if rs7.RecordCount<=0 then
		...
		do while not rs7.eof
			...
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""  class=""name""><div align=""left"">" & vbcrlf & "                 "
			...
			Response.write "</div></td>" & vbcrlf & "         <td align=""left"" valign=""middle""  class=""func""><div align=""center"">"
			Response.write Formatnumber(zbcdbl(rs7("prod_num")),num1_dot,-1)
			Response.write "</div></td>" & vbcrlf & "         <td align=""left"" valign=""middle""  class=""func""><div align=""center"">"
			...
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""  class=""func""><div align=""center"">"
			Response.write rs7("ret_intro")
			Response.write "</div></td>" & vbcrlf & "          </tr>" & vbcrlf & "                   "
			num=zbcdbl(rs7("prod_num"))
			if num="" or isnull(num) then num=0
...
'if num="" or isnull(num) then num=0
	...
	Response.write "" & vbcrlf & "              <tr>" & vbcrlf & "              <td height=""25"" colspan=""6"" align=""left"" valign=""middle""  class=""name""><div align=""right"">合计：</div></td>" & vbcrlf & "                 <td width=""57"" align=""left"" valign=""middle""  class=""name""><div align=""center"">"
	Response.write Formatnumber(allnum,num1_dot,-1)
	Response.write "</div></td>" & vbcrlf & "         <td colspan=""7"" align=""left"" valign=""middle""  class=""name"">&nbsp;</td>" & vbcrlf & "         </tr>" & vbcrlf & "     </table>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "      <td class=""page"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"">" & vbcrlf & "          <tr>" & vbcrlf & "          <td width=""60"" height=""30""></td>" & vbcrlf & "            <td></td>         " & vbcrlf & "      <form name=""oneself"" action=""returnDList.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
