...
'Public Function AddFormValue(name,  value)
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & "window.onload = function (){" & vbcrlf & "    try" & vbcrlf & "     {" & vbcrlf & "               parent.document.getElementById(""mxlist"").style.height=document.body.scrollHeight;" & vbcrlf & "         parent.document.getElementById(""mxlist"").style.width=document.body.scrollWidth;" & vbcrlf & "         parent.parent.document.getElementById(""I1"").style.height=parent.document.body.scrollHeight;" & vbcrlf & "               parent.parent.document.getElementById(""I1"").style.width=parent.document.body.offsetWidth;" & vbcrlf & " }" &vbcrlf & " catch(e){}" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-left: 0px;" & vbcrlf & "       margin-top: 0px;" & vbcrlf & "        margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "     background-color: #FFFFFF;" & vbcrlf & "     border:0!important" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style></head>" & vbcrlf & "" & vbcrlf & "<body >" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
	dim ProductList,ord
	ord=clng(session("storejh_idzbintel"))
	ProductAttrColNum=0
	isOpenProductAttrV=isOpenProductAttr
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "    <tr class=""top"">" & vbcrlf & "          <td height=""27"" class=""name""><div align=""center"">产品名称</div></td>" & vbcrlf & "          <td height=""20"" class=""name""><div align=""center"">产品编号</div></td>" & vbcrlf & "              <td class=""name""><div align=""center"">产品型号</div></td>" & vbcrlf & "            <td class=""name""><div align=""center"">单位</div></td>" & vbcrlf & "        "
	if isOpenProductAttrV then
		ProductAttrColNum=2
		Response.write "" & vbcrlf & "                  <td width=""9%"" height=""20"" class=""name""><div align=""center"">产品属性1</div></td> " & vbcrlf & "               <td width=""9%"" height=""20"" class=""name""><div align=""center"">产品属性2</div></td> " & vbcrlf & "        "
	end if
	Response.write "" & vbcrlf & "              <td width=""6%"" height=""20"" class=""name""><div align=""center"">数量</div></td> " & vbcrlf & "            <td width=""10%"" class=""name""><div align=""center"">仓库</div></td>" & vbcrlf & "              <td width=""9%"" class=""name""><div align=""center"">应还日期</div></td>" & vbcrlf & "           <td width=""7%"" class=""name""><div align=""center"">包装</div></td>" & vbcrlf &"                 <td width=""10%"" height=""20"" colspan=""2"" class=""name""><div align=""center"">备注</div></td>" & vbcrlf & "  </tr>" & vbcrlf
	dim k2
	sql = "select * from kujhlist where kujh="&ord&" and del=7 order by id asc"
	set rss = server.CreateObject("adodb.recordset")
	rss.open sql,conn,1,1
	if rss.eof then
		Response.write "" & vbcrlf & "      <tr >" & vbcrlf & "           <td height=""27"" colspan="""
		Response.write 10+ProductAttrColNum
		'Response.write "" & vbcrlf & "      <tr >" & vbcrlf & "           <td height=""27"" colspan="""
		Response.write """ ><div align=""center"">暂无明细<img src=""../images/jiantou.gif""><a href=""#"" onClick=""javascript:window.open('../store/topjh.asp?top="
		Response.write pwurl(ord)
		Response.write "&f=101','plancor5','width=' + 1450 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=0,top=100');return false;"" title=""点击添加明细""><font class=""blue2"">添加借货明细</font></a></div></td>" & vbcrlf & "        </tr>" & vbcrlf & ""
		'Response.write pwurl(ord)
	else
		dim sum,num,zk
		sum=0
...
'do until rss.eof
			...
			Response.write "" & vbcrlf & "     <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td width=""16%"" height=""27""><div align=""left""><span class=""name"">&nbsp;" & vbcrlf & "         "
			If qxOpen > 0 Then
			...
			Response.write""&k&""
			Response.write "" & vbcrlf & "             </a></span></div></td>" & vbcrlf & "          <td width=""9%"" height=""20""><div align=""center"">"
			Response.write order1
			Response.write "</div></td>" & vbcrlf & "          <td width=""8%"" height=""20""><div align=""center"">"
			Response.write type1
			Response.write "</div></td>" & vbcrlf & "          <td width=""8%"" height=""20""><div align=""center"">"
			Response.write unitname
			Response.write "</div></td>" & vbcrlf & "        "
			if isOpenProductAttrV then
				Response.write "" & vbcrlf & "                 <td width=""9%"" height=""20""><div align=""center"">"
				Response.write ProductAttr1Name
				Response.write "</div></td>" & vbcrlf & "              <td width=""9%"" height=""20""><div align=""center"">"
				Response.write ProductAttr2Name
				Response.write "</div></td>" & vbcrlf & "        "
			end if
			Response.write "" & vbcrlf & "             <td height=""20""><div align=""center"" id=""num1_"
			Response.write rss("mxid")
			Response.write """>"
			...
			Response.write "</div></td>" & vbcrlf & "          <td height=""20"" colspan=""2""><div align=""center"">"
			Response.write rss("price1")&""
		...
		Response.write """><div align=""center"">合计<img src=""../images/jiantou.gif""><a href=""#"" onClick=""javascript:window.open('../store/topjh.asp?top="
		Response.write pwurl(ord)
		Response.write "','newwin22','width=' + 1400 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=0,top=100');return false;""  title=""点击编辑明细"">重新编辑</a></div></td>" & vbcrlf & "         <td height=""27"" class=""red""><div align=""center"" class=""red"">"
		Response.write pwurl(ord)
		Response.write Formatnumber(num,num1_dot,-1)
		Response.write pwurl(ord)
		Response.write "</div></td>" & vbcrlf & "          <td height=""27"" colspan=""5"">&nbsp;</td>" & vbcrlf & "     </tr>" & vbcrlf & ""
	end if
	rss.close
	set Rss = nothing
	conn.close
	set conn=nothing
	Response.write "" & vbcrlf & "             </table>" & vbcrlf & "       </div></td>" & vbcrlf & "       </tr>" & vbcrlf & "  </table>" & vbcrlf & "</body>" & vbcrlf & "</html>"
