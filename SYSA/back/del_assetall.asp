...
'If Len(exists_Pics) = 0 Then
	...
	dim actinon1
	if ord="asset1" then
		conn.execute "delete from O_asset where ass_del=2"
		action1="资产登记清空"
	elseif ord="asset2" then
		conn.execute "delete from O_assRepair where R_del=2"
		action1="资产维护清空"
	elseif ord="asset3" then
		conn.execute "delete from O_assChange where H_del=2"
		action1="资产变动清空"
	elseif ord="asset4" then
		conn.execute "delete from O_assDeprect where D_del=3"
		action1="资产折旧清空"
	end if
	call close_list(2)
	Response.redirect ""&url&""
