...
'if strW3<>"" Then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "</head>" & vbcrlf & "<body  topmargin=""0"" leftmargin=""0"" >" & vbcrlf & "    <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""center"" bgcolor=""#FFFFFF"">" & vbcrlf &         "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"">" & vbcrlf &     "<tr>" & vbcrlf &       "<td width=""3%"" height=""64""  background=""../images/contentbg.gif""><div align=""center""><img src=""../images/contenttop.gif""height=""27""> </div></td> " & vbcrlf & "      <td width=""97%""  background=""../images/contentbg.gif"">" & vbcrlf & "                 <strong><font style=""line-height:24px;position:absolute"" color=""#1445A6"">人员选择</font></strong>  " & vbcrlf & "          <input style=""float:right"" type=""button"" name=""Submit42"" value=""确定选择""  class=""anybutton"" onclick=""Userchoose()""/>" & vbcrlf & "" & vbcrlf & "      </td>" & vbcrlf & "        </tr>" & vbcrlf & "</table>  " & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "   " & vbcrlf & "<tr>" & vbcrlf & "                <td>可调用范围:</td>" & vbcrlf & "                          <td >" & vbcrlf & "                <input type=""radio"" name=""member1"" value=""1"" style=""margin-top:0px;"" onclick=""document.getElementById('sort_member').style.display = 'none'""; "
	'Response.write Application("sys.info.jsver")
	Response.write check_mem2
	Response.write ">" & vbcrlf & "            允许所有用户调用" & vbcrlf & "                   <input name=""member1"" type=""radio"" value=""0"" style=""margin-top:0px;"" onClick=""document.getElementById('sort_member').style.display = ''""; "
	Response.write check_mem2
	Response.write check_mem1
	Response.write ">" & vbcrlf & "                 共享给以下用户（在需要共享用户前面的方框打勾）" & vbcrlf & "                </td>" & vbcrlf & "                " & vbcrlf & "               </tr>" & vbcrlf & "          <tr id=""sort_member"" style="""
	Response.write sort_display
	Response.write """>" & vbcrlf & "            <td>范围选择</td>" & vbcrlf & "            <td colspan=""4"" height=""16"">"
	sort_zjjg=2
