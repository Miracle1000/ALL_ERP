...
'Private Sub Class_Initialize
	...
	elseif px="5" then
		Ptr_Result=" order by get_bh desc"
	elseif px="6" then
		Ptr_Result=" order by get_bh asc"
	end if
	ret          =request("ret")
	ret2 =request("ret2")
	A    =request("A")
	...
	if ret<>"" then
		Str_Result=Str_Result&" and datediff(dd,'"& ret &"',get_time)>=0"
	end if
	if ret2<>"" then
		Str_Result=Str_Result&" and datediff(dd,get_time,'"& ret2 &"')>=0"
	end if
	if A<>"" then
	end if
	if C<>"" then
		...
		elseif B="ffbh" then
			Str_Result=Str_Result&" and get_bh like '%"&C&"%'"
		elseif B="ffry" then
			Str_Result=Str_Result&" and get_lycateid in (select ord from gate where name like '%"&C&"%')"
		elseif B="ffbz" then
			Str_Result=Str_Result&" and get_note  like '%"&C&"%'"
		end if
	end if''
	dim newstate
	newstate=trim(request("newstate"))
	if newstate="1" then
		Str_Result=Str_Result&" and get_store=2 and get_storecateid="&session("personzbintel2007")
	end if
	If remind <> "" Then
	...
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "<form name=""data"" id=""data"" action=""outList.asp"" method=""get"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "         <table width=""100%""border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">领用列表</td>" & vbcrlf & "                        <td><A onclick=""Myopen(User);return false;"" href=""javascript:;"" class=""sortRule"">排序规则<IMG src=""../images/i10.gif"" alt=""排序规则"" width=""9"" height=""5"" border=""0""></A></td>" & vbcrlf & "            <td align=""right"" class=""top_btns""><span id=""kh"">自：<input id=""daysOfMonthPos"" onmouseup=""toggleDatePicker('daysOfMonth','date.ret')"" size=""9"" style=""width:80px"" name=""ret"" value="""
	Response.write ret
	...
	Response.write ret2
	Response.write """/><DIV id=daysOfMonth2 style=""POSITION: absolute""></DIV>&nbsp;<select name=""B"" id=""B"" style=""color:#000000"">" & vbcrlf & "                              <option value="""">--请选择--</option>" & vbcrlf & "                              <option value=""ffzt"" "
	Response.write ret2
	if B="ffzt" then
		Response.write "selected"
	end if
	Response.write ">领用主题</option>" & vbcrlf & "                            <option value=""ffbh"" "
	if B="ffbh" then
		Response.write "selected"
	end if
	Response.write ">领用编号</option>" & vbcrlf & "                           <option value=""ffry"" "
	if B="ffry" then
		Response.write "selected"
	end if
	Response.write ">领用人员</option>" & vbcrlf & "                           <option value=""ffbz"" "
	if B="ffbz" then
		Response.write "selected"
	end if
	Response.write ">领用备注</option>" & vbcrlf & "                   </select>" & vbcrlf & "                       <input type=""text"" name=""C"" id=""C"" size=""10"" value="""
	Response.write C
	Response.write """><input type=""hidden"" name=""page_count"" size=""10"" value="""
	...
	if open_101_10=3 or (open_101_10=1 and CheckPurview(intro_101_10,trim(session("personzbintel2007"))))=True then
		Response.write "<input name=""submit2"" type=""button""  class=""anybutton2"" value=""导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({from:'form_with_page_action',page:'../out/xls_out.asp?px="
		Response.write px
		Response.write "&A="
		Response.write A
		Response.write "&B="
	...
	Response.write "" & vbcrlf & "                       <a href=""javascript:;"" onClick=""callServer2();document.getElementById('kh').style.display='none';document.getElementById('ht1').style.display='';return false;""></a></span></td>" & vbcrlf & "           <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">      " & vbcrlf & "                 <tr valign=""center"" class=""top"">" & vbcrlf & "              <td width=""5%"" height=""25"" align=""left"" valign=""middle""  class=""name""><div align=""center"">选择</div></td>" & vbcrlf & "               <td width=""17%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">领用主题</div></td>" & vbcrlf & "                <td width=""13%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">领用编号</div></td>" & vbcrlf & "                 <td width=""10%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">领用/申请人员</div></td>" & vbcrlf & "                   <td width=""8%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">领用时间</div></td>" & vbcrlf & "                 <td width=""8%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">领用分类</div></td>" & vbcrlf & "                 <td width=""7%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">出库状态</div></td>" & vbcrlf & "                 <td width=""18%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">领用备注</div></td>" & vbcrlf & "               <td width=""17%"" align=""left"" valign=""middle""  class=""name""><div align=""center""><select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px   solid   #FFFFFF; overflow:hidden"">" & vbcrlf & "                        <option>-请选择-</option>" & vbcrlf & "                       <option value=""page_count=10"" "
	...
	currpage=clng(currpage)
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select * from O_productOut "&Str_Result&" "&Ptr_Result
	rs7.open sql7,conn,1,1
	if rs7.RecordCount<=0 then
		...
		do while not rs7.eof
			...
			Response.write "" & vbcrlf & "             <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "              <td height=""25"" align=""left"" valign=""middle""  class=""name""><div align=""center"">" & vbcrlf & "                   "
			del_bool=true
			sqltext="select * from O_proRetList where prod_id in (select id from O_proOutList where get_fid="&rs7("id")&")"
			...
			Response.write "" & vbcrlf & "                </div></td>" & vbcrlf & "             <td height=""25"" align=""left"" valign=""middle""  class=""name"">" & vbcrlf & "             "
			...
			Response.write "</td>" & vbcrlf & "                   <td align=""left"" valign=""middle""  class=""func""><div align=""center"">"
			Response.write rs7("get_bh")
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""  class=""func""><div align=""center"">" & vbcrlf & "               <div align=""center"">" & vbcrlf & "               "
			get_lycateid=rs7("get_lycateid")
			if get_lycateid="" or isnull(get_lycateid) then get_lycateid=0
			sql8="select  name from gate where ord="&get_lycateid
			...
			rs8.close
			set rs8=nothing
			Response.write "" & vbcrlf & "                    </div>" & vbcrlf & "              </div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""  class=""func""><div align=""center"">"
			Response.write rs7("get_time")
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""  class=""func"">" & vbcrlf & "                 <div align=""center"">"
			if rs7("get_type")=1 then
				Response.write "用品发放"
			elseif rs7("get_type")=2 then
				Response.write "用品申请"
			end if
			Response.write "" & vbcrlf & "                </div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""  class=""func""><div align=""center"">"
			If rs7("get_store")=1 Then
				Response.write "已出库"
			ElseIf rs7("get_store")=2 Then
				Response.write "未出库"
			elseif rs7("get_store")=3 then
				Response.write "已否决"
			end if
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""  class=""func ewebeditorImg"">"
			Response.write rs7("get_note")
			Response.write "</td>" & vbcrlf & "                   <td align=""left"" valign=""middle""  class=""func""><div align=""center"">" & vbcrlf & ""
			If remind <> "" Then
			...
			if rs7("get_type")=2 and rs7("get_storecateid")=session("personzbintel2007") and rs7("get_store")=2 and open_101_17=1 then
				Response.write "" & vbcrlf & "                 <input name=""button3"" type=""button""  class=""page"" id=""submit3"" onClick=""javascript:window.open('outku.asp?ord="
				Response.write rs7("id")
				Response.write "','neww35win','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=300,top=300')"" value=""确认""/>" & vbcrlf & "               "
				Response.write rs7("id")
			end if
			if open_101_14=3 or CheckPurview(intro_101_14,trim(addcateid))=True then
				Response.write "" & vbcrlf & "                  <input name=""button3"" type=""button""  class=""page"" id=""submit3"" onClick=""javascript:window.open('outDetail.asp?ord="
				Response.write rs7("id")
			...
			if (open_101_2=3 or CheckPurview(intro_101_2,trim(addcateid))=True) and rs7("get_type")=2 and rs7("get_store")=2 then
				Response.write "" & vbcrlf & "                      <input name=""button4"" type=""button""  class=""page"" id=""submit4"" onClick=""javascript:window.open('outUpdate.asp?ord="
				Response.write rs7("id")
			...
			if (open_101_2=3 or CheckPurview(intro_101_2,trim(addcateid))=True) and rs7("get_store")<>2 then
				Response.write "" & vbcrlf & "                      <input name=""button4"" type=""button""  class=""page"" id=""submit4"" onClick=""javascript:window.open('outUpdate1.asp?ord="
				Response.write rs7("id")
				Response.write "','neww35win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"" value=""修改""/>" & vbcrlf & "                     "
				Response.write rs7("id")
			end if
			if (open_101_3=3 or CheckPurview(intro_101_3,trim(addcateid))=True) and del_bool then
				Response.write "" & vbcrlf & "                     <input name=""button5"" type=""button""  class=""page"" id=""submit5"" onClick=""if(confirm('确认删除吗？')){window.location=('outdel.asp?ord="
				Response.write rs7("id")
				Response.write "&px="
				Response.write px
	...
	Response.write "             " & vbcrlf & "                </div>" & vbcrlf & "          </td>" & vbcrlf & "           </form>" & vbcrlf & "   </tr>" & vbcrlf & " </table>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:100%; height:200;display:none;"">" & vbcrlf & "<table width=""150"" height=""150""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""192"">" & vbcrlf & "        <table width=""150"" height=""150"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "           <td height=""24"" colspan=""2"" style=""padding-left:15px;""><a href=""###"" onClick=""gotourl('px=1')""><font color=""#2F496E"">按添加时间排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:15px;""><a href=""###"" onClick=""gotourl('px=2')""><font color=""#2F496E"">按添加时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:15px;""><a href=""###"" onClick=""gotourl('px=3')""><font color=""#2F496E"">按领用时间排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:15px;""><a href=""###"" onClick=""gotourl('px=4')""><font color=""#2F496E"">按领用时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:15px;""><a href=""###"" onClick=""gotourl('px=5')""><font color=""#2F496E"">按领用编号排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:15px;""><a href=""###"" onClick=""gotourl('px=6')""><font color=""#2F496E"">按领用编号排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & ""
	rs7.close
	set rs7=nothing
	action1="领用列表"
	call close_list(1)
	Response.write "" & vbcrlf & "<script language=javascript>" & vbcrlf & "function Myopen(divID){ //根据传递的参数确定显示的层" & vbcrlf & "     if(divID.style.display==""""){" & vbcrlf & "              divID.style.display=""none""" & vbcrlf & "        }else{" & vbcrlf & "          divID.style.display=""""" & vbcrlf & "    }" & vbcrlf & "       divID.style.left=300;" & vbcrlf & " divID.style.top=0;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function testall()" & vbcrlf & "{" & vbcrlf & "  if(!confirm('确认删除吗？'))" & vbcrlf & " {" & vbcrlf & "   document.getElementById('data').action=""outList.asp?px="
	Response.write px
	Response.write "&currPage="
	Response.write currpage
	Response.write "&A="
	...
	Response.write "&remind="
	Response.write remind
	Response.write """;" & vbcrlf & "        document.getElementById('data').submit();" & vbcrlf & " }" & vbcrlf & " else" & vbcrlf & " {" & vbcrlf & "      document.getElementById('data').action=""outdel.asp?px="
	Response.write px
	Response.write "&currPage="
	Response.write currpage
	Response.write "&A="
