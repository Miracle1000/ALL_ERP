...
'bigsystemtype = ".mozi"
	...
	sql="delete from O_MeetingSummary where id in ("&ord&")"
	conn.execute(sql)
	action1="纪要删除"
	call close_list(2)
	if r=1 then
