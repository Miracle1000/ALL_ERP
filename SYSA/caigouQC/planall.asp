...
'if strW3<>"" Then
	...
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=1"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_1=0
		intro_28_1=0
	else
		open_28_1=rs1("qx_open")
		intro_28_1=rs1("qx_intro")
	end if
	rs1.close
	If open_28_1&"" = "" Then open_28_1 = 0
	If intro_28_1&"" = "" Then intro_28_1 = "-222" else intro_28_1 = replace(intro_28_1&""," ","")
	If open_28_1&"" = "" Then open_28_1 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=14"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_14=0
		intro_28_14=0
	else
		open_28_14=rs1("qx_open")
		intro_28_14=rs1("qx_intro")
	end if
	rs1.close
	If open_28_14&"" = "" Then open_28_14 = 0
	If intro_28_14&"" = "" Then intro_28_14 = "-222" else intro_28_14 = replace(intro_28_14&""," ","")
	If open_28_14&"" = "" Then open_28_14 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_2=0
		intro_28_2=0
	else
		open_28_2=rs1("qx_open")
		intro_28_2=rs1("qx_intro")
	end if
	rs1.close
	If open_28_2&"" = "" Then open_28_2 = 0
	If intro_28_2&"" = "" Then intro_28_2 = "-222" else intro_28_2 = replace(intro_28_2&""," ","")
	If open_28_2&"" = "" Then open_28_2 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=3"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_3=0
		intro_28_3=0
	else
		open_28_3=rs1("qx_open")
		intro_28_3=rs1("qx_intro")
	end if
	rs1.close
	If open_28_3&"" = "" Then open_28_3 = 0
	If intro_28_3&"" = "" Then intro_28_3 = "-222" else intro_28_3 = replace(intro_28_3&""," ","")
	If open_28_3&"" = "" Then open_28_3 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=5"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_5=0
		intro_28_5=0
	else
		open_28_5=rs1("qx_open")
		intro_28_5=rs1("qx_intro")
	end if
	rs1.close
	If open_28_5&"" = "" Then open_28_5 = 0
	If intro_28_5&"" = "" Then intro_28_5 = "-222" else intro_28_5 = replace(intro_28_5&""," ","")
	If open_28_5&"" = "" Then open_28_5 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=6"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_6=0
		intro_28_6=0
	else
		open_28_6=rs1("qx_open")
		intro_28_6=rs1("qx_intro")
	end if
	rs1.close
	If open_28_6&"" = "" Then open_28_6 = 0
	If intro_28_6&"" = "" Then intro_28_6 = "-222" else intro_28_6 = replace(intro_28_6&""," ","")
	If open_28_6&"" = "" Then open_28_6 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=7"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_7=0
		intro_28_7=0
	else
		open_28_7=rs1("qx_open")
		intro_28_7=rs1("qx_intro")
	end if
	rs1.close
	If open_28_7&"" = "" Then open_28_7 = 0
	If intro_28_7&"" = "" Then intro_28_7 = "-222" else intro_28_7 = replace(intro_28_7&""," ","")
	If open_28_7&"" = "" Then open_28_7 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_8=0
		intro_28_8=0
	else
		open_28_8=rs1("qx_open")
		intro_28_8=rs1("qx_intro")
	end if
	rs1.close
	If open_28_8&"" = "" Then open_28_8 = 0
	If intro_28_8&"" = "" Then intro_28_8 = "-222" else intro_28_8 = replace(intro_28_8&""," ","")
	If open_28_8&"" = "" Then open_28_8 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=10"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_10=0
		intro_28_10=0
	else
		open_28_10=rs1("qx_open")
		intro_28_10=rs1("qx_intro")
	end if
	rs1.close
	If open_28_10&"" = "" Then open_28_10 = 0
	If intro_28_10&"" = "" Then intro_28_10 = "-222" else intro_28_10 = replace(intro_28_10&""," ","")
	If open_28_10&"" = "" Then open_28_10 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=11"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_11=0 : intro_28_11=0
	else
		open_28_11=rs1("qx_open") : intro_28_11=rs1("qx_intro")
	end if
	rs1.close
	If open_28_11&"" = "" Then open_28_11 = 0
	If intro_28_11&"" = "" Then intro_28_11 = "-222" else intro_28_11 = replace(intro_28_11&""," ","")
	If open_28_11&"" = "" Then open_28_11 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_16=0
		intro_28_16=0
	else
		open_28_16=rs1("qx_open")
		intro_28_16=rs1("qx_intro")
	end if
	rs1.close
	If open_28_16&"" = "" Then open_28_16 = 0
	If intro_28_16&"" = "" Then intro_28_16 = "-222" else intro_28_16 = replace(intro_28_16&""," ","")
	If open_28_16&"" = "" Then open_28_16 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_13=0
		intro_28_13=0
	else
		open_28_13=rs1("qx_open")
		intro_28_13=rs1("qx_intro")
	end if
	rs1.close
	If open_28_13&"" = "" Then open_28_13 = 0
	If intro_28_13&"" = "" Then intro_28_13 = "-222" else intro_28_13 = replace(intro_28_13&""," ","")
	If open_28_13&"" = "" Then open_28_13 = 0
	...
	rs1.close
	If open_28_12&"" = "" Then open_28_12 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=21"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_21=0
	else
		open_28_21=rs1("qx_open")
	end if
	rs1.close
	If open_28_21&"" = "" Then open_28_21 = 0
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=28 and sort2=19"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_28_19=0
	else
		open_28_19=rs1("qx_open")
	end if
	rs1.close
	If open_28_19&"" = "" Then open_28_19 = 1
	...
	rs1.close
	If open_21_14&"" = "" Then open_21_14 = 0
	If intro_21_14&"" = "" Then intro_21_14 = "-222" else intro_21_14 = replace(intro_21_14&""," ","")
	If open_21_14&"" = "" Then open_21_14 = 0
	...
	rs1.close
	If open_26_14&"" = "" Then open_26_14 = 0
	If intro_26_14&"" = "" Then intro_26_14 = "-222" else intro_26_14 = replace(intro_26_14&""," ","")
	If open_26_14&"" = "" Then open_26_14 = 0
	...
	rs1.close
	If open_26_1&"" = "" Then open_26_1 = 0
	If intro_26_1&"" = "" Then intro_26_1 = "-222" else intro_26_1 = replace(intro_26_1&""," ","")
	If open_26_1&"" = "" Then open_26_1 = 0
	...
	rs1.close
	If open_22_14&"" = "" Then open_22_14 = 0
	If intro_22_14&"" = "" Then intro_22_14 = "-222" else intro_22_14 = replace(intro_22_14&""," ","")
	If open_22_14&"" = "" Then open_22_14 = 0
	...
	rs1.close
	set rs1=nothing
	If open_22_1&"" = "" Then open_22_1 = 0
	If intro_22_1&"" = "" Then intro_22_1 = "-222" else intro_22_1 = replace(intro_22_1&""," ","")
	If open_22_1&"" = "" Then open_22_1 = 0
	if open_28_1=3 then
		list=""
	elseif open_28_1=1 then
		list="and addcate in ("&intro_28_1&") and addcate<>0 "
	else
		list="and addcate=0"
	end if
...
'Private Sub Class_Initialize
	...
	dim currCate, hasRkMC, open_31_13, intro_31_13, open_31_19
	Function ShowRKInfo()
		dim ret
		ret = false
		If isEmpty(currCate) Then
			currCate = session("personzbintel2007")
		end if
		If currCate&"" = "" Then currCate = 0
		If isEmpty(hasRkMC) Then
			hasRkMC = ZBRuntime.MC(17002)
		end if
		If isEmpty(open_31_19) Then
			set rs1=conn.execute("select qx_open from power where ord="& currCate &" and sort1=31 and sort2=19")
			if rs1.eof = false then
				open_31_19=rs1("qx_open")
			end if
			rs1.close
			set rs1=nothing
			If open_31_19&"" = "" Then open_31_19 = 1
		end if
		if hasRkMC and open_31_19=0 then
			ret = True
		end if
		ShowRKInfo = ret
	end function
	Function CanBatRuku()
		...
		If isEmpty(open_31_13) Then
			set rs1=conn.execute("select qx_open,qx_intro from power  where ord="& currCate &" and sort1=31 and sort2=13")
			if rs1.eof = false then
				open_31_13=rs1("qx_open") : intro_31_13=rs1("qx_intro")
			end if
			rs1.close
			set rs1=nothing
			If open_31_13&"" = "" Then open_31_13 = 0
			If intro_31_13 & "" = "" Then intro_31_13 = "-222"
			If open_31_13&"" = "" Then open_31_13 = 0
		end if
		if hasRkMC and (open_31_13=3 or open_31_13=1) then
			ret = True
		end if
		CanBatRuku = ret
	end function
	Function CaigouQCRkAble(qcord)
		dim rs,rs1,rs2,sql, ret, currCate, cgord, cgmxid, cgcateid, isstop
		dim zt1, zt2, cgMoney1, cgsp, cpord, cankuproduct, cglimit, paymoney, limitmoney, percentmoney, limitpercent
		ret = false
		if qcord&""="" then qcord = 0
		If isEmpty(currCate) Then
			currCate = session("personzbintel2007")
		end if
		If currCate&"" = "" Then currCate = 0
		...
		if hasRkMC and (open_31_13=3 or (open_31_13=1 and intro_31_13 <> "-222")) then
			If open_31_13&"" = "" Then open_31_13 = 0
			Set rs = conn.execute("select a.caigou,a.caigoulist,a.productid,isnull(c.cateid,0) cgcateid,isnull(p.canoutstore,0) canoutstore from caigouQC a left join caigou c on c.ord=a.caigou left join product p on p.ord=a.productid where a.del=1 and a.Complete=3 and a.id="& qcord)
			If rs.eof = False Then
				cgord = rs("caigou") : cgmxid = rs("caigoulist") : cpord = rs("productid") : cgcateid = rs("cgcateid")
				if rs("canoutstore") = 1 then cankuproduct = 1 else cankuproduct = 0
				If cgord&"" = "" Then cgord = 0
				If cgmxid&"" = "" Then cgmxid = 0
				If cpord&"" = "" Then cpord = 0
				If cgcateid&"" = "" Then cgcateid = 0
				if cankuproduct = 1 and cgord>0 and (open_31_13=3 or (open_31_13=1 and CheckPurview(intro_31_13,trim(cgcateid))=True)) then
					Set rs1 = conn.execute("select zt1,isstop,limit,money1,limitmoney,limitpercent,isnull(status,-1)status from caigou where ord="& cgord)
					If rs1.eof = False Then
						zt1 = rs1("zt1") : isstop = rs1("isstop") : cglimit = rs1("limit") : limitmoney = rs1("limitmoney")
						cgMoney1 = rs1("money1") : limitpercent = rs1("limitpercent") : cgstatus = rs1("status")
						zt2 = GetCaigouRKStatus(cgord)
						paymoney = sdk.getSqlValue("select isnull(sum(money1),0) from payout where complete=3 and isnull(cls,0)=0 and del=1 and contract="& cgord, 0)
					end if
					rs1.close
					Set rs1 = Nothing
					If zt1&"" = "" Then zt1 = 0
					...
					If cgstatus&"" = "" Then cgstatus = -1 else cgstatus = CDBL(cgstatus)
					If isstop&"" = "" Then isstop = 0
					If paymoney&"" = "" Then paymoney = 0 Else paymoney = CDBL(paymoney)
					If cgMoney1&"" = "" Then cgMoney1 = 0 Else cgMoney1 = CDBL(cgMoney1)
					If limitmoney&"" = "" Then limitmoney = 0 Else limitmoney = CDBL(limitmoney)
					If limitpercent&"" = "" Then limitpercent = 0 Else limitpercent = CDBL(limitpercent)
					If cgMoney1=0 Then
						percentmoney=CDbl(paymoney)/1
					else
						percentmoney=CDbl(paymoney)/CDbl(cgMoney1)
					end if
					if (zt1&""<>"3" and zt1&""<>"4" and zt2=1) and isstop=0 and (cgstatus=1 or cgstatus=-1)  then
						percentmoney=CDbl(paymoney)/CDbl(cgMoney1)
						if ((cglimit&""="1" and paymoney>=limitmoney) or (cglimit&""="2" and percentmoney*100>=limitpercent) or cglimit&""="0") then
							Set rs2 = conn.execute("select top 1 1 from dbo.[FUN_CaigouQCRknum]("& cgord &",2,'"& qcord &"') t where (okNum-krkNum)>0 " )
	...
	Function GetCaigouRKStatus(ord)
		...
		set rs = conn.execute(sql)
		If rs.eof= False Then
			num1 = FormatNumber(rs("num1").value, num1_dot ,-1)
'If rs.eof= False Then
			num2 = FormatNumber(rs("num2").value, num1_dot ,-1)
'If rs.eof= False Then
	...
	Function getQCRkstatus(cgord,qcord)
		dim rs, okNum, yrkNum, ret
		Set rs = conn.execute("select okNum,yrkNum from dbo.FUN_CaigouQCRknum("& cgord &",2,'"& qcord &"') t")
		If rs.eof = False Then
			okNum = rs("okNum") : yrkNum = rs("yrkNum")
		end if
		rs.close
		set rs = nothing
		If okNum&"" = "" Then okNum = 0 Else okNum = CDBL(okNum)
		If yrkNum&"" = "" Then yrkNum = 0 Else yrkNum = CDBL(yrkNum)
		if okNum = 0 or yrkNum = 0 then
			ret = "未入库"
		ElseIf yrkNum>0 and okNum>yrkNum then
			ret = "部分入库"
		ElseIf yrkNum>0 and okNum=yrkNum then
			ret = "入库完毕"
		end if
	...
	Function CaigouQCJSChange(qcord, ctype, noDel)
		dim rs, rs2, jsnum, price1, caigou, caigouList
		dim plan, invoicePlan, cgbz, cgdate7, hl, ycgnum1, cgnum1, fromNum
		if qcord&"" = "" then qcord = "0"
		if noDel&"" = "" then noDel = "0"
		if ctype&"" = "" then ctype = "1"
		noDel = sdk.FormatNumList(noDel)
		set rs2 = conn.execute("select caigou,caigoulist,isnull(sum(case SpResult when 5 then recnum when 6 then FailNum end),0) as jsNum from caigouQC where id in("& qcord &") and id not in("& noDel &") and SpResult in(5,6) group by caigou,caigoulist")
		dim autoAreatorCaigous
		while not rs2.eof
			jsnum = 0
			price1 = 0
			jsNum = cdbl(rs2("jsNum"))
			caigou = rs2("caigou")
			caigouList = rs2("caigouList")
			if caigou&"" <>"" and caigouList&""<>"" and jsnum>0 then
				plan = -1
'if caigou&"" <>"" and caigouList&""<>"" and jsnum>0 then
				invoicePlan = -1
'if caigou&"" <>"" and caigouList&""<>"" and jsnum>0 then
				set rs = conn.execute("select top 1 isnull(fyhk,0) as fyhk,area,trade,cateid,cateid2,cateid3,company,sort,money1,money2,bz,date7,isnull(invoicePlan,0) invoicePlan from caigou where ord="& caigou)
				if not rs.eof then
					plan = rs("fyhk")
					cgarea = rs("area")
					cgtrade = rs("trade")
					cgcateid = rs("cateid")
					cgcateid2 = rs("cateid2")
					cgcateid3 = rs("cateid3")
					cgcompany = rs("company")
					cgsort = rs("sort")
					cgmoney1 = cdbl(rs("money1"))
					cgmoney2 = cdbl(rs("money2"))
					cgbz = rs("bz")
					cgdate7 = rs("date7")
				...
				set rs = nothing
				if jsnum>0 then
					cgnum1 = 0 : cgnum2 = 0 : cglistMoney1 = 0 : cgmoney1_2 = 0 : cgmoney2_2 = 0
					hl = getHL(cgbz,cgdate7)
					Set rs = conn.execute("select fromUnit, fromNum, num1, unit from caigoulist where id="& caigoulist)
					If rs.eof = False Then
						ycgnum1 = rs("num1")
					end if
					rs.close
					set rs = nothing
					If ycgnum1&"" = "" Then ycgnum1 = 0 Else ycgnum1 = CDBL(ycgnum1)
					sql = " update caigoulist set num1= num1"& iif(ctype&""="1","+","-") &""& jsnum &"  where id = "& caigoulist
'If ycgnum1&"" = "" Then ycgnum1 = 0 Else ycgnum1 = CDBL(ycgnum1)
					conn.execute(sql)
					Set rs = conn.execute("select fromUnit, fromNum, num1, unit from caigoulist where id="& caigoulist)
					If rs.eof = False Then
						fromNum = rs("fromNum") : cgnum1 = rs("num1")
						if fromNum&""<>"" then
							fromNum = cdbl(fromNum)
							If cgnum1&"" = "" Then cgnum1 = 0 Else cgnum1 = CDBL(cgnum1)
							if fromNum>0 then
								if ycgnum1 = 0 then
									newFromNum = 0
								else
									newFromNum = cgnum1 * (fromNum/ycgnum1)
								end if
								conn.execute("update caigoulist set fromNum="& newFromNum &" where id="& caigoulist)
							end if
						end if
					end if
					rs.close
					set rs = nothing
					sql = " update caigoulist set moneyAfterDiscount= priceAfterDiscount*num1 ,"&_
					"  money1=priceAfterDiscountTax*num1,"&_
					"  taxValue = (priceAfterDiscountTax-priceAfterDiscount)*num1 "&_
					"  money1=priceAfterDiscountTax*num1,"&_
					"  where id = "& caigoulist
					conn.execute(sql)
					sql = "update caigou set premoney =(select sum(money1) from caigoulist where caigou="& caigou &") where ord = "& caigou
					conn.execute(sql)
					sql = "update caigou set money1=premoney-yhmoney, money2=(premoney-yhmoney)*"& hl &" where ord = "& caigou
					conn.execute(sql)
					conn.execute(sql)
				end if
			end if
	...
	function getHL(bzid,bzdate)
		cnhl = 1
		set rsf = conn.execute("select H.hl from hl H left join sortbz B on H.bz=B.id where datediff(dd,H.date1,'"& bzdate &"')=0 and B.id=14")
		if not rsf.eof then
			if isnull(rsf(0)) or rsf(0)="" then cnhl = 1 else cnhl = rsf(0)
		else
			cnhl = 1
		end if
		rsf.close
		set rsf = nothing
		set rsf = conn.execute("select H.hl from hl H left join sortbz B on H.bz=B.id where datediff(dd,H.date1,'"& bzdate &"')=0 and B.id="& bzid &"")
		if not rsf.eof then
			if isnull(rsf(0)) or rsf(0)="" then
				tohl = 1
			else
				tohl = FormatNumber(ZBCDbl(rsf(0)) / ZBCDbl(cnhl),num_dot_xs,true,0,0)
			end if
		else
			tohl = 1
		end if
	...
	W2=request("W2")
	W3=request("W3")
	intro_1=request("intro_1")
	intro_2=request("intro_2")
	...
	Z1=request("Z1")
	if ret3&"" <>"" then
		Str_Result = Str_Result + " and  datediff(dd,'"& ret3 &"',date7)>=0 "
'if ret3&"" <>"" then
	end if
	if ret4&"" <>"" then
		Str_Result = Str_Result + " and  datediff(dd,date7,'"& ret4 &"')>=0 "
'if ret4&"" <>"" then
	end if
	if ret5&"" <>"" then
		Str_Result = Str_Result + " and  datediff(dd,'"& ret5 &"',QCTime)>=0 "
'if ret5&"" <>"" then
	end if
	if ret6&"" <>"" then
		Str_Result = Str_Result + " and  datediff(dd,QCTime,'"& ret6 &"')>=0 "
'if ret6&"" <>"" then
	end if
	if ret7&"" <>"" then
		Str_Result = Str_Result + " and  datediff(dd,'"& ret7 &"',date1)>=0 "
'if ret7&"" <>"" then
	end if
	if ret8&"" <>"" then
		Str_Result = Str_Result + " and  datediff(dd,date1,'"& ret8 &"')>=0 "
'if ret8&"" <>"" then
	end if
	if telord>0 then
...
'if telord>0 then
	...
	if ry&"" <>"" then
		...
		W4=replace(W4,",","")
		if W4<>"" then
			Str_Result=Str_Result+" and "& ryFiled &" in  ("&W3&")"
'if W4<>"" then
		end if
	end if
	if D&"" <>"" then
		if instr(D,",")>0 then
			Str_Result = Str_Result + " and  id in(select caigouQC from caigouQClist where QCRank in("& D &") and del=1) "
'if instr(D,",")>0 then
		else
			Str_Result = Str_Result + " and  id in(select caigouQC from caigouQClist where QCRank="& D &" and del=1) "
'if instr(D,",")>0 then
		end if
	end if
	If Z1&""<>"" Then
		Z1 = Replace(Z1&""," ","")
		Str_Result = Str_Result + " and id in(select qcord from dbo.FUN_CaigouQCRknum(0,2,'0') t where cgord=a.caigou and qcord=a.id and charindex(','+(case when okNum=0 or yrkNum=0 then '1' when yrkNum>0 and okNum>yrkNum then '2' when yrkNum>0 and okNum=yrkNum then '3' else '0' end)+',',',"& Z1 &",')>0) "
		Z1 = Replace(Z1&""," ","")
	end if
	if F2<>"" then
		if F1=1 then
...
'elseif F1=6 then
	...
	if S2<>"" then
		if S1=1 then
			str_Result=str_Result+"and qcid like '%"& S2 &"%'"
'if S1=1 then
		elseif S1=2 then
			str_Result=str_Result+"and qcid not like '%"& S2 &"%'"
'elseif S1=2 then
		elseif S1=3 then
			str_Result=str_Result+"and qcid='"&S2&"'"
'elseif S1=3 then
		elseif S1=4 then
			str_Result=str_Result+"and qcid<>'"&S2&"'"
'elseif S1=4 then
...
'elseif S1=6 then
	...
	if G2<>"" then
		if G1=1 then
			str_Result=str_Result+"and caigou in(select ord from caigou where title like '%"& G2 &"%' and del=1)"
'if G1=1 then
		elseif G1=2 then
			str_Result=str_Result+"and caigou in(select ord from caigou where title not like '%"& G2 &"%' and del=1)"
'elseif G1=2 then
		elseif G1=3 then
			str_Result=str_Result+"and caigou in(select ord from caigou where title='"& G2 &"' and del=1)"
'elseif G1=3 then
		elseif G1=4 then
			str_Result=str_Result+"and caigou in(select ord from caigou where title<>'"& G2 &"' and del=1)"
'elseif G1=4 then
...
'elseif G1=6 then
	...
	if P2<>"" then
		if P1=1 then
			str_Result=str_Result+"and company in(select ord from tel where name like '%"& P2 &"%' and sort3=2 and del=1)"
'if P1=1 then
		elseif P1=2 then
			str_Result=str_Result+"and company in(select ord from tel where name not like '%"& P2 &"%' and sort3=2 and del=1)"
'elseif P1=2 then
		elseif P1=3 then
			str_Result=str_Result+"and company in(select ord from tel where name='"& P2 &"' and sort3=2 and del=1)"
'elseif P1=3 then
		elseif P1=4 then
			str_Result=str_Result+"and company in(select ord from tel where name<>'"& P2 &"' and sort3=2 and del=1)"
'elseif P1=4 then
...
'elseif P1=6 then
	...
	if I2<>"" then
		if I1=1 then
			str_Result=str_Result+"and productid in(select ord from product where title like '%"& I2 &"%' and del=1)"
'if I1=1 then
		elseif I1=2 then
			str_Result=str_Result+"and productid in(select ord from product where title not like '%"& I2 &"%' and del=1)"
'elseif I1=2 then
		elseif I1=3 then
			str_Result=str_Result+"and productid in(select ord from product where title='"& I2 &"' and del=1)"
'elseif I1=3 then
		elseif I1=4 then
			str_Result=str_Result+"and productid in(select ord from product where title<>'"& I2 &"' and del=1)"
'elseif I1=4 then
...
'elseif I1=6 then
	...
	if J2<>"" then
		if J1=1 then
			str_Result=str_Result+"and productid in(select ord from product where order1 like '%"& J2 &"%' and del=1)"
'if J1=1 then
		elseif J1=2 then
			str_Result=str_Result+"and productid in(select ord from product where order1 not like '%"& J2 &"%' and del=1)"
'elseif J1=2 then
		elseif J1=3 then
			str_Result=str_Result+"and productid in(select ord from product where order1='"& J2 &"' and del=1)"
'elseif J1=3 then
		elseif J1=4 then
			str_Result=str_Result+"and productid in(select ord from product where order1<>'"& J2 &"' and del=1)"
'elseif J1=4 then
...
'elseif J1=6 then
	...
	if K2<>"" then
		if K1=1 then
			str_Result=str_Result+"and productid in(select ord from product where type1 like '%"& K2 &"%' and del=1)"
'if K1=1 then
		elseif K1=2 then
			str_Result=str_Result+"and productid in(select ord from product where type1 not like '%"& K2 &"%' and del=1)"
'elseif K1=2 then
		elseif K1=3 then
			str_Result=str_Result+"and productid in(select ord from product where type1='"& K2 &"' and del=1)"
'elseif K1=3 then
		elseif K1=4 then
			str_Result=str_Result+"and productid in(select ord from product where type1<>'"& K2 &"' and del=1)"
'elseif K1=4 then
...
'elseif K1=6 then
	...
	if intro_2<>"" then
		if intro_1=1 then
			str_Result=str_Result+"and intro2 like '%"& intro_2 &"%'"
'if intro_1=1 then
		elseif intro_1=2 then
			str_Result=str_Result+"and intro2 not like '%"& intro_2 &"%'"
'elseif intro_1=2 then
		elseif intro_1=3 then
			str_Result=str_Result+"and intro2='"& intro_2 &"'"
'elseif intro_1=3 then
		elseif intro_1=4 then
			str_Result=str_Result+"and intro2<>'"& intro_2 &"'"
'elseif intro_1=4 then
		elseif intro_1=5 then
			str_Result=str_Result+"and intro2 like '"& intro_2 &"%'"
'elseif intro_1=5 then
		elseif intro_1=6 then
			str_Result=str_Result+"and intro2 like '%"& intro_2 &"'"
'elseif intro_1=6 then
		end if
	end if
...
'elseif zdy4_1=6 then
	...
	if F&"" <>"" then
		if instr(F,",")>0 then
			Str_Result = Str_Result + " and  QCType in ("& replace(F," ","") &") "
'if instr(F,",")>0 then
		else
			Str_Result = Str_Result + " and  QCType="& F &" "
'if instr(F,",")>0 then
		end if
	end if
	if G&"" <>"" then
		if instr(G,",")>0 then
			Str_Result = Str_Result + " and  qc_id in ("& replace(G," ","") &") "
'if instr(G,",")>0 then
		else
			Str_Result = Str_Result + " and  qc_id = "& G &" "
'if instr(G,",")>0 then
		end if
	end if
	if ret&"" <>"" then
		Str_Result = Str_Result + " and  datediff(dd,'"& ret &"',date1)>=0 "
'if ret&"" <>"" then
	end if
	if ret2&"" <>"" then
		Str_Result = Str_Result + " and  datediff(dd,date1,'"& ret2 &"')>=0 "
'if ret2&"" <>"" then
	end if
	if E&""<>"" then
		if instr(E,",")>0 then
			if instr(E,"4")>0 then
				...
				Es2 = replace(E,","," ")
				Es2 = replace(" "& Es2 &" "," 4 "," ")
				Es2 = replace(trim(Es2)," ",",")
				Str_Result = Str_Result + " and  (Complete in ("& Es2 &")  or (Complete=3 and  cateid_sp>0))"
				Es2 = replace(trim(Es2)," ",",")
			else
				Str_Result = Str_Result + " and  Complete in ("& replace(E," ","") &") "
				Es2 = replace(trim(Es2)," ",",")
			end if
		else
			select case E&""
			case "0","1","2","3" : Str_Result = Str_Result + " and  Complete = "& E &" "
'select case E&""
			case "4" : Str_Result = Str_Result + " and  Complete = 3 and cateid_sp>0 "
'select case E&""
			case "10" : Str_Result = Str_Result + ""
'select case E&""
			end select
		end if
	end if
	if C&""<>"" then
		select case B
		case "zjzt" : Str_Result = Str_Result + " and  title like '%"& C &"%'"
'select case B
		case "zjbh" : Str_Result = Str_Result + " and  qcid like '%"& C &"%'"
'select case B
		case "sqry" : Str_Result = Str_Result + " and  addcate in(select ord from gate where name like '%"& C &"%' and del=1) "
'select case B
		case "zjry" : Str_Result = Str_Result + " and  Inspector in(select ord from gate where name like '%"& C &"%' and del=1) "
'select case B
		case "glcg" : Str_Result = Str_Result + " and  caigou in (select ord from caigou where title like '%"& C &"%') "
'select case B
		case "gys" : Str_Result = Str_Result + " and  company in (select ord from tel where name like '%"& C &"%' and del=1 and sort3=2) "
'select case B
		case "cpmc" : Str_Result = Str_Result + " and  productid in(select ord from product where title like '%"& C &"%' and del=1) "
'select case B
		case "cpbh" : Str_Result = Str_Result + " and  productid in(select ord from product where order1 like '%"& C &"%' and del=1) "
'select case B
		case "cpxh" : Str_Result = Str_Result + " and  productid in(select ord from product where type1 like '%"& C &"%' and del=1) "
'select case B
		end select
	end if
	str33=""
	Call searchExtended(28,"id")
	If remind <> "" Then
		Set helper = CreateReminderHelper(conn,remind,0)
		Str_Result=Str_Result &" and id in (" & helper.listSQL("ids") & ")"
	end if
	...
	elseif px=3 then
		px_Result="order by QCTime desc"
	elseif px=4 then
		px_Result="order by QCTime asc"
	elseif px=5 then
		px_Result="order by title desc"
	elseif px=6 then
		px_Result="order by title asc"
	elseif px=7 then
		px_Result="order by qcid desc"
	elseif px=8 then
		px_Result="order by qcid asc"
	elseif px=9 then
		px_Result="order by Complete desc"
	elseif px=10 then
		px_Result="order by Complete asc"
	elseif px=11 then
		px_Result="order by cateid_zj desc"
	elseif px=12 then
		px_Result="order by cateid_zj asc"
	elseif px=13 then
		px_Result="order by cateid_add desc"
	elseif px=14 then
		px_Result="order by cateid_add asc"
	end if
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {margin-top: 0px;}" & vbcrlf & "form{margin:0px; padding:0px;}" & vbcrlf & "-->" & vbcrlf & "#ht1 #content{margin-bottom:-1px;}" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body  "
	if open_28_8=0 then
	...
	Response.write " onMouseOver=""window.status='none';return true;"">" & vbcrlf & "<form method=""get"" action=""planall.asp"" id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top""><input type=""hidden"" name=""sp"" value="""
	Response.write sp1
	Response.write """>" & vbcrlf & "         <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "           <tr>" & vbcrlf & "      <td class=""place"">"
	if H="1" then
		Response.write "质检单检索"
	else
		Response.write "质检单列表"
	end if
	Response.write "" & vbcrlf & "      </td>" & vbcrlf & "      <td>&nbsp;<a class='px_btn sortRule' href=""javascript:void(0)"" onClick=""Myopen(User);return false;"" class=""sortRule"">排序规则<img src=""../images/i10.gif"" width=""9"" height=""5"" border=""0""></a></td>" & vbcrlf & "      <td align=""right"">" & vbcrlf & "     <select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"">" & vbcrlf & "              <option>-请选择-</option>" & vbcrlf & "       <option value=""page_count=10"" "
	Response.write "质检单列表"
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "          </select>" & vbcrlf & "    </td>" & vbcrlf & "    <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""3"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td class='ser_btn' align=""right"" id=""kh"" style=""border-top:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;"">" & vbcrlf & "        <div>" & vbcrlf & "       申请日期： <INPUT name=""ret"" size=10 type=""text"" onClick=""javascript:datedlg.show();"" value="""
	Response.write ret
	Response.write """>&nbsp;至：<INPUT name=""ret2"" size=10 type=""text"" onClick=""javascript:datedlg.show();"" value="""
	Response.write ret2
	Response.write """>                " & vbcrlf & "        <input type=""hidden"" name=""H"" value=""1"">" & vbcrlf & "        <select name=""E"">" & vbcrlf & "          <option value=""10"" "
	if E="10" then
		Response.write "selected"
	end if
	Response.write ">质检状态</option>" & vbcrlf & "          <option value=""0"" "
	if E="0" then
		Response.write "selected"
	end if
	Response.write ">待质检</option>" & vbcrlf & "          <option value=""1"" "
	if E="1" then
		Response.write "selected"
	end if
	Response.write ">质检中</option>" & vbcrlf & "          <option value=""2"" "
	if E="2" then
		Response.write "selected"
	end if
	Response.write ">待审批</option>" & vbcrlf & "          <option value=""3"" "
	if E="3" then
		Response.write "selected"
	end if
	Response.write ">质检完毕</option>" & vbcrlf & "        </select>" & vbcrlf & "        <select name=""B"">" & vbcrlf & "          <option value=""zjzt"" "
	if B="zjzt" then
		Response.write "selected"
	end if
	Response.write ">质检主题</option>" & vbcrlf & "          <option value=""zjbh"" "
	if B="zjbh" then
		Response.write "selected"
	end if
	Response.write ">质检编号</option>" & vbcrlf & "          <option value=""sqry"" "
	if B="sqry" then
		Response.write "selected"
	end if
	Response.write ">申请人员</option>" & vbcrlf & "          <option value=""zjry"" "
	if B="zjry" then
		Response.write "selected"
	end if
	Response.write ">质检人员</option>" & vbcrlf & "          <option value=""glcg"" "
	if B="glcg" then
		Response.write "selected"
	end if
	Response.write ">关联采购</option>" & vbcrlf & "          <option value=""gys"" "
	if B="gys" then
		Response.write "selected"
	end if
	Response.write ">供应商</option>" & vbcrlf & "          <option value=""cpmc"" "
	if B="cpmc" then
		Response.write "selected"
	end if
	Response.write ">产品名称</option>" & vbcrlf & "          <option value=""cpbh"" "
	if B="cpbh" then
		Response.write "selected"
	end if
	Response.write ">产品编号</option>" & vbcrlf & "          <option value=""cpxh"" "
	if B="cpxh" then
		Response.write "selected"
	end if
	Response.write ">产品型号</option>          " & vbcrlf & "        </select>" & vbcrlf & "        <input name=""C"" type=""text"" size=""10""  value="""
	Response.write C
	Response.write """/>" & vbcrlf & "        <input type=""submit"" name=""Submit422"" value=""检索""  class=""anybutton""/>"
	if open_28_10=1 or open_28_10=3 then
		Response.write "" & vbcrlf & "        <input type=""button"" name=""Submitdel2"" value=""质检单导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({from:'form_with_page_action',page:'../out/xls_zj.asp?B="
		Response.write B
		Response.write "&C="
		...
		Response.write "&Z1="
		Response.write Z1
		Response.write pub_cf
		Response.write "'})}"" class=""anybutton""/>" & vbcrlf & "            "
	end if
	if open_28_7=1 or open_28_7=3 then
		Response.write "<span  id=""s1""><input type=""button""  name=""print"" onclick=""javascript:s1.style.display='none';window.print();return  false;"" value=""打印"" class=""anybutton""/></span>"
	end if
	Response.write "<a href=""javascript:void(0)"" class=""AfterQuickSearch"" style='display:inline-block;width:108px;' onclick=""callServer2();document.getElementById('kh').style.display='none';document.getElementById('ht1').style.display='';return false;""><img src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "<span id=""ht1""></span>" & vbcrlf & "</form>" & vbcrlf & "       <form name=""form1"" method=""post"" action=""planall.asp?B="
	Response.write B
	Response.write "&C="
	Response.write Server.UrlEncode(C)
	Response.write "&D="
	...
	Response.write "&W3="
	Response.write W3
	Response.write str33
	Response.write """>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""5"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "    <td width=""4%"" align=""center""><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "    <td height=""24"" width=""10%""><div align=""center""><strong>质检单编号</strong></div></td>" & vbcrlf & "    <td height=""28"" width=""18%""><div align=""center""><strong>质检单主题</strong></div></td>" & vbcrlf & "        <td width=""15%"" ><div align=""center""><strong>关联采购</strong></div></td>" & vbcrlf & "   <td width=""6%""><div align=""center""><strong>状态</strong></div></td>" & vbcrlf & "      <td width=""8%""><div align=""center""><strong>质检人员</strong></div></td>" & vbcrlf & "      <td width=""7%""><div align=""center""><strong>质检时间</strong></div></td>" & vbcrlf & "     <td width=""8%""><div align=""center""><strong>申请人员</strong></div></td>" & vbcrlf & "      <td width=""7%""><div align=""center""><strong>申请日期</strong></div></td>" & vbcrlf & "          <td width=""15%"" ><div align=""center""><strong>操作</strong></div></td>" & vbcrlf & "    </tr>" & vbcrlf & ""
	dim n
	n=0
	sql2 = ""
	if px=11 or px=12 then
		sql2 = ",(select name from gate where ord=a.Inspector) as cateid_zj"
	elseif px=13 or px=14 then
		sql2 = ",(select name from gate where ord=a.addcate) as cateid_add"
	end if
	set rs=server.CreateObject("adodb.recordset")
	sql="select id, title, qcid, company, caigou, Complete, addcate, QCTime, Inspector, date1, cateid_sp,isnull(productid,0) productid,isnull(unit,0) unit "& sql2 &" from caigouQC a WITH(NOLOCK)  "&Str_Result&""&fromContent&" "&px_Result
    rs.open sql,conn,1,1
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			...
			date1 = rs("date1")
			cateid_sp = rs("cateid_sp")
			if cateid_sp&"" = "" then cateid_sp = 0
			if caigou&"" = "" then caigou = 0
			usecount = 0
			useCountSql="select count(1) from kuinlist a inner join kuin x on a.kuin=x.ord and x.sort1=1 and a.del<>2 left join caigouQClist b on b.caigouQC="& id &" and b.del<>2 where ((isnull(a.caigouqc,0)>0 and a.caigouqc="& id &") or (isnull(a.caigouqc,0)=0 and a.caigouQClist=b.id)) and (("& caigou &"=0 and x.caigou=b.caigou) or x.caigou="& caigou &") and a.ord="& rs("productid") &" and a.unit="& rs("unit")
			useCount=conn.Execute(useCountSql)(0)
			caigouthSql="select count(1) from caigouth where del=1 and QcId="& id &""
			If usecount > 0 Then
				chkDisabled=" disabled=""disabled"" "
			Elseif conn.Execute(caigouthSql)(0)>0 Then
				chkDisabled=" disabled=""disabled"" "
			else
				chkDisabled=""
			end if
			canQCRK = CaigouQCRkAble(id)
			...
			if (open_28_3=3 or (open_28_3=1 and CheckPurview(intro_28_3,trim(addcate))=True)) or ((open_28_6=3 or (open_28_6=1 and CheckPurview(intro_28_6,trim(addcate))=True)) and Complete=0) or canQCRK or (open_28_7=3 or (open_28_7=1 and CheckPurview(intro_28_7,trim(addcate))=True)) then
				c = c +1
				Response.write "<input name=""selectid"" type=""checkbox"" value="""
				Response.write id
				Response.write """ canQCRK="""
				Response.write iif(canQCRK,"1","0")
				Response.write """ cg="""
				Response.write pwurl(caigou)
				Response.write """ candy="""
				Response.write iif((open_28_7=3 or (open_28_7=1 and CheckPurview(intro_28_7,trim(addcate))=True)),"1","0")
				Response.write """>"
			end if
			Response.write "" & vbcrlf & "       </span></td>" & vbcrlf & "      <td align=""center"" height=""24"">"
			Response.write qcid
			Response.write "</td>" & vbcrlf & "      <td height=""27""  >"
			if open_28_14=3 or CheckPurview(intro_28_14,trim(addcate))=True then
				Response.write "<a href=""javascript:void(0)"" onclick=""javascript:window.open('content.asp?ord="
				Response.write pwurl(id)
				Response.write "','contractcon','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" title="""
				Response.write pwurl(id)
				Response.write qctitle
				Response.write """>"
			end if
			Response.write""&qctitle&""
			Response.write "</a><span id=""ci"
			Response.write id
			Response.write """ class=""red"">"
			if tip2&""<>"" then
				if instr(tip2 &",",","& id &",")>0 then
					Response.write(" 不允许")
					if instr(tip2,"noDel")>0 then
						Response.write("删除")
					elseif instr(tip2,"noZP")>0 then
						Response.write("指派")
					end if
				end if
			end if
			Response.write "</span>"
			Response.write GetPrintInfo(conn, 28 , rs("id") ,1)
			Response.write "" & vbcrlf & "       </td>" & vbcrlf & "   <td><div align=""left"">" & vbcrlf & "          "
			if open_22_1=3 or CheckPurview(intro_22_1,trim(addcate))=True then
				set rs2=conn.execute("select top 1 title,del from caigou where ord="&caigou&"")
				if not rs2.eof then
					if open_22_14=3 or (open_22_14=1 and CheckPurview(intro_22_14,trim(addcate))=True) then
						Response.write "" & vbcrlf & "                                     <a href=""javascript:void(0)"" onclick=""javascript:window.open('../../SYSN/view/store/caigou/caigoudetails.ashx?view=details&ord="
						Response.write pwurl(caigou)
						Response.write "','contractcon','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');return false;"" title="""
						Response.write pwurl(caigou)
						...
						Response.write rs2("title")
						Response.write "</a>" & vbcrlf & "                                 "
						If rs2("del")=2 Then Response.write "<font color =red>（已删除）</font>"
					else
						Response.write rs2("title")
'If rs2("del")=2 Then Response.write "<font color =red>（已删除）</font>"
					end if
			...
			case 0 : Response.write("待质检")
			case 1 : Response.write("质检中")
			case 2 : Response.write("待审批")
			case 3 : Response.write("质检完毕")
			end select
			Response.write "</div></td>" & vbcrlf & "        <td><div align=""center"">" & vbcrlf & "            "
			if Inspector&"" <>"" then
				set rs2 = conn.execute("select top 1 name from gate where ord = "& Inspector)
				if not rs2.eof then
			...
			Response.write "" & vbcrlf & "      </div></td>" & vbcrlf & "      <td><div align=""center"">"
			Response.write QCTime
			Response.write "</div></td>" & vbcrlf & "      <td><div align=""center"">"
			if addcate&"" <>"" then
				set rs2 = conn.execute("select top 1 name from gate where ord = "& addcate)
				if not rs2.eof then
					Response.write(rs2("name"))
				end if
				rs2.close
			...
			If remind <> "" Then
				If helper.canCancel Then
					rid = helper.getRemindIdByOID(id)
			...
			if session("personzbintel2007")=cateid_sp and Complete=2 and (open_28_16=3 or (open_28_16=1 And CheckPurview(intro_28_16,trim(addcate))=True)) then
				Response.write "" & vbcrlf & "            <input type=""button"" name=""Submit33"" value=""审批""  onClick=""javascript:window.open('qcsp.asp?"
				Response.write sdk.ReturnURL("ord=" & pwurl(id) &"&pn=16")
				Response.write "','neww4win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');""/>" & vbcrlf & "            "
				Response.write sdk.ReturnURL("ord=" & pwurl(id) &"&pn=16")
			end if
			if open_28_14=3 or (open_28_14=1 And CheckPurview(intro_28_14,trim(addcate)))=True then
				Response.write "<input type=""button"" name=""Submit3"" value=""详情""  onClick=""javascript:window.open('content.asp?"
				Response.write sdk.ReturnURL("ord=" & pwurl(id) &"&pn=14")
				Response.write "','newwin','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>"
				Response.write sdk.ReturnURL("ord=" & pwurl(id) &"&pn=14")
			end if
			if canQCRK then
				Response.write "" & vbcrlf & "                     <input type=""button"" name=""Submit3"" value=""入库""  onClick=""javascript:if(!hwndrk||hwndrk.closed){hwndrk=window.open('../../SYSN/view/store/kuin/kuin.ashx?billtype=73001&billid="
				Response.write pwurl(caigou)
				Response.write "&tagid=2&ords="
				Response.write id
				Response.write "','newwin22','width=' + 1070 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=50,top=50');}else{hwndrk.focus();}""/>"
				Response.write id
			end if
			if (open_28_5=3 or (open_28_5=1 And CheckPurview(intro_28_5,trim(addcate)))) and Inspector=session("personzbintel2007") and Complete<2 then
				Response.write "" & vbcrlf & "                             <input type=""button"" name=""Submit3"" value=""质检""  onClick=""javascript:window.open('qcheck.asp?"
				Response.write sdk.ReturnURL("ord=" & pwurl(id) &"&pn=5")
				Response.write "','newyr3win','width=' + 1070 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=50,top=50');""/>" & vbcrlf & "                       "
				Response.write sdk.ReturnURL("ord=" & pwurl(id) &"&pn=5")
			end if
			if open_28_2=3 or (open_28_2=1 And CheckPurview(intro_28_2,trim(addcate)))=True then
				Response.write "" & vbcrlf & "         <input type=""button"" name=""Submit3c"" value=""修改""  onClick=""javascript:window.open('correct.asp?ord="
				Response.write pwurl(id)
				Response.write "','newwincor','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>"
				Response.write pwurl(id)
			end if
			if open_28_3=3 or (open_28_3=1 And CheckPurview(intro_28_3,trim(addcate)))=True then
				Response.write "" & vbcrlf & "                 <input type=""button"" name=""Submitdel"" "
				Response.write chkDisabled
				Response.write " value=""删除"" onClick=""delqc("
				Response.write id
				Response.write ")""/>" & vbcrlf & "               "
			end if
		...
		loop
		m=n
		Response.write "" & vbcrlf & "      </table>" & vbcrlf & "      <input type=""hidden"" name=""allc"" id=""allc"" value="""
		Response.write c
		Response.write """>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""10%"" height=""30""><div align=""center"">全选" & vbcrlf & "          <input name=""chkall"" type=""checkbox"" id=""chkall"" value=""all"" onclick=""mm(this.form)"" />" & vbcrlf & "    </div></td>" & vbcrlf & "    <td >"
		if open_28_3=1 or open_28_3=3 then
			Response.write "<input type=""button"" name=""submit2"" onclick=""batdel()"" value=""批量删除""  class=""anybutton2""/>"
		end if
		Response.write "" & vbcrlf & "     &nbsp;"
		if (open_28_6=1 or open_28_6=3)  then
			Response.write "<input type=""button"" name=""Submit4222"" value=""批量指派""  onclick=""pizhipai()"" class=""anybutton2""/>"
		end if
		if CanBatRuku() then
			Response.write "" & vbcrlf & "     &nbsp;<input type=""button"" value=""批量入库""  onclick=""batRuku()"" class=""anybutton2""/>"
		end if
		if open_28_7=3 or open_28_7=1 then
			Response.write "" & vbcrlf & "     &nbsp;<input type=""button"" value=""批量打印""  onclick=""batPrint()"" class=""anybutton2""/>"
		end if
		Response.write "" & vbcrlf & "     </td>" & vbcrlf & "    <td width=""50%""><div align=""right"">" & vbcrlf & "    "
		...
		Response.write "条信息/页&nbsp;&nbsp;" & vbcrlf & "    <input type=""text"" name=""CurrPage"" id=""topage"" size=""4"" value="""
		Response.write currpage
		Response.write """ onKeyUp=""this.value=this.value.replace(/[^\d]/g,'')"" maxlength=""9"">" & vbcrlf & "    <input type=""button"" value=""跳转"" class=""page"" onClick=""gotourl('currPage='+document.getElementById('topage').value)"">" & vbcrlf & "    "
		Response.write currpage
		if currpage=1 then
		...
		if Cint(currpage)=rs.pagecount then
		...
		Response.write "" & vbcrlf & "</div></td>" & vbcrlf & "  </tr>" & vbcrlf & "" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""138"" colspan=""3""><div align=""right""><p>&nbsp;" & vbcrlf & "      </p>" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</form>" & vbcrlf & ""
	end if
	rs.close
	set rs=Nothing
	Response.write "" & vbcrlf & "<script src= ""../Script/cC_planall.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=javascript></script>" & vbcrlf & "<script>" & vbcrlf & "function ask() {" & vbcrlf & "  document.all.form1.action =""orderallhy.asp?CurrPage="
	Response.write CurrPage
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write "&sp="
	Response.write sp1
	Response.write "&nopay="
	Response.write nopay
	Response.write """;" & vbcrlf & "        document.all.form1.submit();" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<link rel=""stylesheet"" type=""text/css"" href=""../inc/themes/default/easyui.css?ver="
	Response.write Application("sys.info.jsver")
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<div id=""w"" class=""easyui-window"" title=""请选择质检人""  style=""width:300px;height:210px;padding:5px;background: #fafafa;top:200px;display:none""  closed=""true"" closable=""false""  collapsible=""false"" minimizable=""false"" maximizable=""false"" modal=""true"">" & vbcrlf & "    <div region=""center"" border=""false"" style=""padding:5px;background:#fff;border:1px solid #ccc; width:260px; margin-top:10px;"">" & vbcrlf & "    <table width=""260"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "          <td colspan=""2"">请选择需要指派的质检人</td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "          <td width=""30%"" height=""30""><div align=""right"">质检人：</div></td>" & vbcrlf & "          <td><select name=""tozjr"" id=""tozjr"">" & vbcrlf & "          "
	set rs = conn.execute("select G.ord,G.name from gate G inner join power P on G.ord=P.ord where G.del=1 and P.sort1=28 and P.sort2=5 and (P.qx_open=3 or (P.qx_open=1 and charindex('"&session("personzbintel2007")&"',P.qx_intro)>0)) order by G.sorce,G.sorce2")
	if not rs.eof then
		rs_zjry = rs.GetRows()
	end if
	rs.close
	set rs = nothing
	if isArray(rs_zjry) then
		len_zjry = ubound(rs_zjry,2)
	else
		len_zjry = -1
		len_zjry = ubound(rs_zjry,2)
	end if
	...
	for i=0 to len_zjry
		Response.write "" & vbcrlf & "            <option value="""
		Response.write rs_zjry(0,i)
		Response.write """>"
		Response.write rs_zjry(1,i)
		Response.write "</option>" & vbcrlf & "            "
	next
	Response.write "" & vbcrlf & "          </select></td>" & vbcrlf & "      </tr>" & vbcrlf & "    </table>" & vbcrlf & "    <br>" & vbcrlf & "    </div>" & vbcrlf & "    <div region=""south"" border=""false"" style=""text-align:right;height:25px;line-height:25px; margin-top:8px;"">" & vbcrlf & "        <a class=""easyui-linkbutton""  href=""###"" icon=""icon-ok"" onClick=""dozhipai();"">确定</a>" & vbcrlf & "        <a class=""easyui-linkbutton""  href=""###"" icon=""icon-cancel"" onClick=""$('#w').window('close');"">取消</a>" & vbcrlf & "    </div>" & vbcrlf & "</div>" & vbcrlf & "" & vbcrlf & "" & vbcrlf &""
	call close_list(1)
	Response.write "" & vbcrlf & "  <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td height=""10"" colspan=""2""><img src=""../image/pixel.gif"" width=""1"" height=""1""></td>" & vbcrlf & "    </tr>" & vbcrlf & "     <tr>" & vbcrlf & "      <td width=""16%"" height=""10""><div align=""right""></div></td>" & vbcrlf & "      <td width=""84%"">&nbsp;</td>" & vbcrlf & "         </tr>" & vbcrlf & "     <tr>" & vbcrlf & "      <td height=""10"" colspan=""2"">&nbsp;</td>" & vbcrlf & "         </tr>" & vbcrlf & "     <tr>" & vbcrlf & "      <td height=""10"" colspan=""2"">&nbsp;</td>" & vbcrlf & "   </tr>" & vbcrlf & "  </table>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:180px;; height:340;display:none;"">" & vbcrlf & "<table width=""160"" height=""340""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""340"">" & vbcrlf & "        <table width=""160"" height=""340"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=1')""><font>按申请日期排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=2')""><font>按申请日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=3')""><font>按质检时间排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=4')""><font>按质检时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=5')""><font>按质检单主题排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=6')""><font>按质检单主题排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=7')""><font>按质检单编号排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=8')""><font>按质检单编号排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=9')""><font>按质检状态排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=10')""><font>按质检状态排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=11')""><font>按质检人员排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=12')""><font>按质检人员排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=13')""><font>按申请人员排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onclick=""gotourl('px=14')""><font>按申请人员排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & "<script language=""javascript"">" & vbcrlf & ""
	if remind<>"" then
		Response.write "" & vbcrlf & "jQuery(function(){" & vbcrlf & "     BindCancelEvents({cfgId:"
		Response.write remind
		Response.write "});" & vbcrlf & "});" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "</script>" & vbcrlf & "</body>" & vbcrlf & "</html>"
