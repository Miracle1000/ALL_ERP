...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "<td colspan=""2""><div align=""left""><a href=""#"" class=""AfterQuickSearch"" onClick=""jQuery('#adSearchForm').hide();document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';return false;""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><imgclass=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor=""""onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td class=""func""><div align=""right"">"
	Response.write khname
	Response.write "：</div></td>" & vbcrlf & "    <td>&nbsp;<div align=""left""><input name=""khmc"" type=""text"" id=""khmc""></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td class=""func""><div align=""right"">客户编号：</div></td>" & vbcrlf & "    <td>&nbsp;<div align=""left""><input name=""khbh"" type=""text"" id=""khbh""></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td class=""func""><div align=""right"">合同主题：</div></td>" & vbcrlf & "    <td>&nbsp;<div align=""left""><input name=""contractname"" type=""text"" id=""contractname""></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf& "    <td class=""func""><div align=""right"">合同编号：</div></td>" & vbcrlf & "    <td>&nbsp;<div align=""left""><input name=""htbh"" type=""text"" id=""htbh""></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">"& vbcrlf &  "   <td><div align=""right"">销售人员：</div></td> "& vbcrlf &    " <td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td class=""func""><div align=""right"">收款计划进展：</div></td>" & vbcrlf & "    <td>&nbsp;<div align=""left"">" & vbcrlf & "        <select name=""hkjz""> "& vbcrlf & "          <option value=""1"">未生成</option> "& vbcrlf &    "      <option value=""2"">部分生成</option> "& vbcrlf &          "      <option value=""10"" selected>收款计划进展</option> "& vbcrlf & " </select> "& vbcrlf &    "    </div></td> "& vbcrlf &" </tr> "& vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td><div align=""right"">币&nbsp;&nbsp;种：</div></td>" & vbcrlf & "      <td><div align=""left"">&nbsp;"
	dim bz  : bz = sdk.getSqlvalue("select top 1 bz from setbz",0)
	if bz=0 then
		Response.write "<input type='checkbox' name='bz' value=""14"">人民币&nbsp;"
	else
		set rs=conn.execute("select id,sort1 from sortbz order by gate1 desc")
		do while not rs.eof
			Response.write "<input type='checkbox' name='bz' value="&rs("id")&">"&rs("sort1")&"&nbsp;"
			rs.movenext
		loop
		rs.close
		set rs=nothing
	end if
	Response.write "</div>" & vbcrlf & "    </td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">优惠后总额：</div></td>" & vbcrlf & "    <td><div align=""left"">&nbsp;自：<input type=""text"" name=""duemoney1"" id=""duemoney1"" size=""8"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot(this,'"
	Response.write num_dot_xs
	Response.write "')"" > 至：<input type=""text"" name=""duemoney2"" id=""duemoney2"" size=""8"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot(this,'"
	Response.write num_dot_xs
	Response.write "')"" ></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">收款计划金额：</div></td>" & vbcrlf & "    <td><div align=""left"">&nbsp;自：<input type=""text"" name=""duemoney3"" id=""duemoney3"" size=""8"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot(this,'"
	Response.write num_dot_xs
	Response.write "')"" > 至：<input type=""text"" name=""duemoney4"" id=""duemoney4"" size=""8"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot(this,'"
	Response.write num_dot_xs
	Response.write "')"" ></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">收款金额：</div></td>" & vbcrlf & "    <td><div align=""left"">&nbsp;自：<input type=""text"" name=""duemoney5""id=""duemoney5"" size=""8"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot(this,'"
	Response.write num_dot_xs
	Response.write "')"" > 至：<input type=""text"" name=""duemoney6"" id=""duemoney6"" size=""8"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot(this,'"
	Response.write num_dot_xs
	Response.write "')"" ></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">收款计划余额：</div></td>" & vbcrlf & "    <td><div align=""left"">&nbsp;自：<input type=""text"" name=""duemoney7"" id=""duemoney7"" size=""8"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot(this,'"
	Response.write num_dot_xs
	Response.write "')"" > 至：<input type=""text"" name=""duemoney8"" id=""duemoney8"" size=""8"" onKeyUp=""value=value.replace(/[^\d\.]/g,'');checkDot(this,'"
	Response.write num_dot_xs
	Response.write "')"" ></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & " <td><div align=""right"">签订日期：</div></td>" & vbcrlf & "      <td><div align=""left"">&nbsp;自：<INPUT readonly=""true"" name=""ret"" size=9 onmousedown=""datedlg.show()"" value="""
	Response.write m1
	Response.write """>&nbsp;至：<INPUT name=""ret2"" readonly=""true"" size=9 onmousedown=""datedlg.show()"" value="""
	Response.write m2
	Response.write """></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">合同添加日期：</div></td>" & vbcrlf & "  <td><div align=""left"">&nbsp;自：<INPUT readonly=""true"" name=""ret3"" size=9 onmousedown=""datedlg.show()"" value="""
	Response.write m3
	Response.write """>&nbsp;至：<INPUT name=""ret4"" readonly=""true"" size=9 onmousedown=""datedlg.show()"" value="""
	Response.write m4
	Response.write """></div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td width=""14%"">&nbsp;</td>" & vbcrlf & "       <td width=""86%""><div align=""left""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></div></td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
