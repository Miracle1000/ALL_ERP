...
'If Not rs.Eof Then
	...
	Response.write "</title>" & vbcrlf & "<script type=""text/javascript"" src=""../inc/jquery.easyui.min.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/JavaScript"" src=""../inc/CommSPAjax.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=javascript>" & vbcrlf & "function askk()" & vbcrlf & "{" & vbcrlf & "    document.getElementById(""eWebEditor1"").contentWindow.syncText();" & vbcrlf & "  if(document.getElementById('title').value=="""")" & vbcrlf & "    {" & vbcrlf & "               document.getElementById('tit').innerHTML=""必填""" & vbcrlf & "         return false;" & vbcrlf & "   }" & vbcrlf & "       if(document.getElementById('jklist').value=="""")" & vbcrlf & "   {" & vbcrlf & "               document.getElementById('jkl').innerHTML=""必填""" & vbcrlf & "           return false;" & vbcrlf & "   }" & vbcrlf & "       if(document.getElementById('sid').value=="""")" & vbcrlf & " {" & vbcrlf & "               alert('借款单无效，请重新选择');" & vbcrlf & "                return false;" & vbcrlf & "   }" & vbcrlf & "       var money1 =document.getElementById('paymoney').value;" & vbcrlf & "  if (money1 == """")" & vbcrlf & " {" & vbcrlf & "               document.getElementById('sm1').innerHTML=""必填""" & vbcrlf & "             return false;" & vbcrlf & "   }" & vbcrlf & "       if (money1.length == 0) money1 = 0;" & vbcrlf & "     var member2 = $(""input[name=member2]"")[0].value;" & vbcrlf & "  spclient.GetNextSP('payfh', 0, money1, 0, member2);" & vbcrlf & "     return false;" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	...
	Response.write Application("sys.info.jsver")
	Response.write """>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & ""
	sqltext="delete from pay where complete=11 and sp is null and cateid_sp is null and addcate = " & session("personzbintel2007")
	conn.execute(sqltext)
	dim ordbool,jktype,sorce,sorce1,sorce2,bz,spmoney,title,paymoney
	jktype="":sorce="":sorce1="":sorce2="":bz="":spmoney="":title="":paymoney=""
	ord=request("ord")
	...
	if ordbool=true then
		sql="select * from payjk where id="&ord
		set rs=server.CreateObject("adodb.recordset")
		...
		if rs.RecordCount<=0 then
			...
			sorce2=rs("sorce2")
			bz=rs("bz")
			paymoney=zbcdbl(rs("spmoney"))
			title=rs("title")
		end if
	end if
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "     <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "   <tr>" & vbcrlf & "            <td class=""place"">费用返还添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right""><div align=""center""></div>" & vbcrlf & "                </a></div></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table> " & vbcrlf & "      <form method=""POST"" action=""save3.asp"" id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"" style=""margin:0"">" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""> " & vbcrlf & "           <tr class=""top"">" & vbcrlf & "            <td colspan=""3"">基本信息</td>" & vbcrlf & "             <td><div align=""right""><input name=""Submit2"" type=""submit"" class=""anniu"" value=""保存"" onclick=""return askk();"">" & vbcrlf & "              <input name=""Submit4"" type=""reset"" class=""anniu"" value=""重置""></div></td>" & vbcrlf & "       </tr>" & vbcrlf & "               <tr>" & vbcrlf & "            <td width=""12%"" height=""37""><div align=""right"">关联借款单：</div></td>" & vbcrlf & "                   <td width=""30%"" height=""37"">" & vbcrlf & "  <div align=""left"">" & vbcrlf & "                   "
	if title="" or isnull(title) then
		Response.write "" & vbcrlf & "               <input type='text' value=""关联费用借款单"" style=""text-align:center; color:#CCCCCC"" size='20' name='jklist' id='jklist' readonly=""true"" onClick=""javascript:window.open('../search/jkpay.asp','eventcom1','width=' + 900 + ',height=' + 550 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=200,top=200')""/>&nbsp;<font style=""color:red"" id=""jkl"">*</font>" & vbcrlf & "                     "
	else
		Response.write "" & vbcrlf & "                         <input type='text' value="""
		Response.write title
		Response.write """ size='20' style=""text-align:center;"" name='jklist' id='jklist' readonly=""true"" onClick=""javascript:window.open('../search/jkpay.asp','eventcom1','width=' + 900 + ',height=' + 550 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=200,top=200')""/>&nbsp;<font style=""color:red""id=""jkl"">*</font>" & vbcrlf & "                        "
	end if
	Response.write "" & vbcrlf & "            </div></td>                " & vbcrlf & "                       <td width=""10%"" height=""37""><div align=""right"">返还主题：</div></td>" & vbcrlf & "                  <td height=""37""><div align=""left"">" & vbcrlf & "              <!--#bug145-->" & vbcrlf & "                        <input name=""title""  type=""text"" id=""title"" maxlength='30' size=""30"">&nbsp;<font id=""tit"" style=""color:red"">*</font>" & vbcrlf & "                       <input name=""sid"" type=""hidden"" id=""sid"" value="""
	Response.write ord
	Response.write """>" & vbcrlf & "             </div></td>" & vbcrlf & "         </tr>" & vbcrlf & "             <tr>" & vbcrlf & "            <td width=""12%"" height=""37""><div align=""right"">返还日期：</div></td>" & vbcrlf & "                  <td width=""30%"" height=""37"" style=""padding-top:0!important;padding-bottom:0!important""><div align=""left"">" & vbcrlf & "                <TABLE border=0 align=""left"" >" & vbcrlf & "          <TBODY>" & vbcrlf & "            <TR>" & vbcrlf & "              <TD><INPUT name=""ret"" readonly onmouseup=""toggleDatePicker('daysOfMonth','date.ret')"" value="""
	Response.write date
	Response.write """ size=""10"">" & vbcrlf & "              <input type=""button"" class=""anybutton"" style=""margin-bottom:-0.5px;"" value=""选择日期"" align=""absMiddle""  border=""0""  id=""daysOfMonthPos"" name=""daysOfMonthPos""  onmouseup=""toggleDatePicker('daysOfMonth','date.ret')"" />" & vbcrlf & "      <span class=""red"">*</span>" & vbcrlf & "              <DIV id=""daysOfMonth"" style=""POSITION: absolute""></DIV></TD>" & vbcrlf & "            </TR>" & vbcrlf & "          </TBODY>" & vbcrlf & "        </TABLE>" & vbcrlf & "              </div></td>" & vbcrlf & "                   <td width=""10%"" height=""37""><div align=""right"">返还人员：</div></td>" & vbcrlf & "                        <td height=""37""><div align=""left""><input name=""member2"" type=""hidden"" id=""member2"" value="""
	Response.write sorce2
	Response.write """>" & vbcrlf & "                 <font id=""ry"">"
	if ordbool=true then
		ry=setname("gate","ord",sorce2,"name")
		Response.write ry
	end if
	Response.write "</font>" & vbcrlf & "                       </div></td>" & vbcrlf & "               </tr>" & vbcrlf & "          <tr>" & vbcrlf & "              <td width=""12%"" height=""37""><div align=""right"">返还金额：</div></td>" & vbcrlf & "                  <td height=""37""><div align=""left"">" & vbcrlf & "                    "
	if ordbool=true then
		jkmoney=getrsval("select sum(money1) as money1 from pay where del=1 and complete in (7,8,11) and jkid="&rs("id"))
		dmoney=getrsval("select sum(dkmoney) as dmoney from dk where jkid="&rs("id")&" and del=1 ")
		if dmoney="" or isnull(dmoney) then dmoney=0
		if jkmoney="" or isnull(jkmoney) then jkmoney=0
		sm=cdbl(paymoney)-cdbl(jkmoney)-cdbl(dmoney)
'if jkmoney="" or isnull(jkmoney) then jkmoney=0
	end if
	Response.write "" & vbcrlf & "              <input type='text' value="""
	Response.write sm
	Response.write """ size='30' name='paymoney' id='paymoney' onpropertychange=""formatData(this,'money');""  onKeyUp=""checkDot('paymoney','"
	Response.write num_dot_xs
	Response.write "')""/>" & vbcrlf & "              <font id=""sm1"" style=""color:red"">*</font>" & vbcrlf & "              </div></td>" & vbcrlf & "              <td width=""10%"" height=""37""><div align=""right"">币种： </div></td>" & vbcrlf & "             <td height=""37""><font id=""bz"">"
	if ordbool=true then
		bzs=setname("payjk","id",ord,"bz")
		bzname=setname("sortbz","id",bzs,"sort1")
	...
	Response.write "</font></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "             <td width=""12%""><div align=""right"">返还概要：</div></td>           " & vbcrlf & "                   <td  colspan=""5""><textarea name=""note"" style=""display:none"" cols=""1"" rows=""1"">"
	if note<>"" then Response.write note
	Response.write "</textarea>" & vbcrlf & "             <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>                   " & vbcrlf & "              </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""50"" colspan=""8"">" & vbcrlf & "              <div align=""center""><input name=""Submit2"" type=""submit"" class=""anniu"" value=""保存"" onclick=""return askk();"">" & vbcrlf & "              <input name=""Submit4"" type=""reset"" class=""anniu"" value=""重置"">" & vbcrlf & "              </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "    </table>" & vbcrlf & "    </form>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""1000"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "        " & vbcrlf & "</table>" & vbcrlf & "        </td>" & vbcrlf & "   "
	action1="费用返还添加"
	call close_list(1)
	Response.write "" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>"
