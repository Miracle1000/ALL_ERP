...
'If Quali_rs.eof Then
	...
	conn.execute "delete from tel where cateid=" & session("personzbintel2007") & " and del=7"
	set rs88 = conn.execute("EXEC erp_getdjbh 26,"&session("personzbintel2007"))
	khid=rs88(0).value
	set rs88=nothing
	sqlStr="Insert Into tel(cateid,date1,khid,del) values('"
	sqlStr=sqlStr & session("personzbintel2007") & "','"
	sqlStr=sqlStr & date & "','"
	sqlStr=sqlStr & khid & "','"
	sqlStr=sqlStr & 7 & "')"
	Conn.execute(sqlStr)
	rd = GetIdentity("tel","ord","cateid","")
	...
	ord = 0
	Dim openSp
	If ZBRuntime.MC(201201) Then
		openSp = isOpenSet(102)
	else
		openSp = 0
	end if
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & " margin-top: 0px;" & vbcrlf & "}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "-->" & vbcrlf & ".gray.low{padding-bottom:8px!important;}" & vbcrlf & "</style>" & vbcrlf & "<script language=javascript>" & vbcrlf & "function ask(ntype) { " & vbcrlf & " var openSp = """
	Response.write openSp
	Response.write """;" & vbcrlf & " if (ntype==4){" & vbcrlf & "          setbt(0);" & vbcrlf & "       }else{" & vbcrlf & "          if (openSp == ""1""){" & vbcrlf & "                       if (document.getElementsByName(""isNeedQuali"")[0].checked){setbt(1);}" & vbcrlf & "              }" & vbcrlf & "       }" & vbcrlf & "       document.getElementById(""demo"").action = ""save3.asp?sort2=1&sort4=""+ntype; " & vbcrlf &"        if(test1.innerHTML.length>0){ "& vbcrlf & "           if(!confirm('同名公司已存在，是否继续提交！')){ "& vbcrlf &      "            return false;"  & vbcrlf &  "         } "& vbcrlf &"        } "& vbcrlf &"        if (Validator.Validate(document.getElementById(""demo""),2)){                "& vbcrlf &"                 if (ntype!=4&&openSp==""1""){" & vbcrlf & "                   if (document.getElementsByName(""isNeedQuali"")[0].checked){" & vbcrlf & "                                if ($(""#qualifications"").attr(""oldvalue"")!=$(""#qualifications"").val()){" & vbcrlf & "                                       spclient.GetNextSP('gys',0);" & vbcrlf & "                                    return false;" & vbcrlf & "                           }" & vbcrlf & "               }" & vbcrlf & "               }" & vbcrlf & "               document.getElementById(""demo"").submit();" & vbcrlf & " }" & vbcrlf & "} " & vbcrlf & "</script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "" & vbcrlf & "function callServer() {" & vbcrlf & "  var u_name = document.getElementById(""u_name"").value;" & vbcrlf & "  if ((u_name == null) || (u_name == """")) return;" & vbcrlf & "  var url = ""cu.asp?name="" + escape(u_name);" & vbcrlf & "  xmlHttp.open(""GET"", url, false);" & vbcrlf & "  xmlHttp.onreadystatechange = updatePage;" & vbcrlf & "  xmlHttp.send(null);  " & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function updatePage() {" & vbcrlf & "  if (xmlHttp.readyState < 4) {" & vbcrlf & "     test1.innerHTML=""loading..."";" & vbcrlf & "  }" & vbcrlf & "  if (xmlHttp.readyState == 4) {" & vbcrlf & "    var response = xmlHttp.responseText;" & vbcrlf & "  test1.innerHTML=response;" & vbcrlf & "  }" & vbcrlf & "" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">供应商添加</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "                 <form method=""POST"" action=""save3.asp?sort2=1"" id=""demo"" name=""date"">" & vbcrlf & "             <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "         <tr  class=""top"">" & vbcrlf & "           <td  height=""36"" align=""left""><div align=""left"">基本情况</div></td>" & vbcrlf & "        <td  height=""36"" colspan=""5"" align=""left"">" & vbcrlf & "             <div align=""right"">" & vbcrlf & "               <input type=""button"" name=""Submit424"" value=""暂存"" onclick=""ask(4);"" class=""page""/>" & vbcrlf & "                                <input type=""button"" name=""Submit4222"" value=""保存"" onclick=""ask(1);"" class=""page""/>" & vbcrlf & "                                <input type=""button"" name=""Submit423"" value=""增加"" onclick=""ask(2);"" class=""page""/>" & vbcrlf & "                               <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "             </div></td>" & vbcrlf & "           </tr>" & vbcrlf &" <tr> "& vbcrlf & "        <td width=""10%""  height=""36"">" & vbcrlf & "          <div align=""right"">供应商名称：</div></td> "& vbcrlf &"         <td colspan=""3"" style=""padding-right:150px;""><input name=""name""  type='text' id=""u_name"" onChange=""callServer();ff()""    onKeyUp=""ff()""size=""25"" min=""1""  dataType=""Limit"" max=""100""  msg=""名称必须在1至100个字之间"">" & vbcrlf & "          <span class=""red"">*</span>&nbsp;&nbsp;拼音码：<input name=""pym"" type=""text"" id=""pym"" size=""15"" dataType=""Limit"" max=""100""  msg=""长度不能超过100个字"">" & vbcrlf & "          <span id=""test1"" class=""red""></span>" & vbcrlf & "          "
	...
	Response.write "" & vbcrlf & "          </td>" & vbcrlf & "        <td width=""10%""><div align=""right"">供应商编号：</div></td>" & vbcrlf & "        <td width=""20%"" class=""gray""><input name=""khid"" type=""text"" size=""15"" value="""
	Response.write khid
	Response.write """ " & vbcrlf & "                         dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1至50个字之间"" " & vbcrlf & "                               class='jquery-auto-bh' autobh-options='cfgId:26,recId:"
	'Response.write khid
	Response.write rd
	Response.write ",autoCreate:false'" & vbcrlf & "                    >" & vbcrlf & "          <span class=""red"">*</span></td>" & vbcrlf & "         </tr>" & vbcrlf & "         <tr>" & vbcrlf & "           <td height=""36""><div align=""right"">供应商分类：</div></td>" & vbcrlf & "           <td class=""gray"" ><select name=""ly"">"& vbcrlf &"   "
	dim trade7,trade8
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "           </select></td>" & vbcrlf & "           <td ><div align=""right"">供应商级别：</div></td>" & vbcrlf & "           <td colspan=""3"" class=""gray"" ><select name=""jz"">" & vbcrlf & "             "
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "           </select></td>" & vbcrlf & "           </tr>" & vbcrlf & "         <tr>" & vbcrlf & "                 <td height=""36""><div align=""right"">地　　区：</div></td>" & vbcrlf & "          <td class=""graylow"" > <IFRAME name=""I2"" SRC=""../event/area.asp?ID=company"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""95%"" HEIGHT=""27"" marginwidth=""1"" marginheight=""1""></IFRAME></td> "& vbcrlf &"                 <td ><div align=""right"">行　　业：</div></td> "& vbcrlf & "             <td colspan=""3"" class=""gray"" ><select name=""trade""> "& vbcrlf &   "   "
	dim trade,trade2
	set rs=server.CreateObject("adodb.recordset")
	...
	If ZBRuntime.MC(201201) Then Call add_Quali_set(101,0)
	Response.write "" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""36""><div align=""right"">联 系 人：</div></td>" & vbcrlf & "        <td width=""20%"" class=""gray""><input name=""person"" type=""text"" onKeyUp=""ff2()"" id=""person1"" size=""15"" dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间"">" & vbcrlf & "         <input name=""pym2""  type=""hidden"" id=""pym2"" readonly size=""15""></td>" & vbcrlf & "        <td width=""10%""><div align=""right"">部　　门：</div></td>" & vbcrlf & "        <td width=""20%""><span class=""gray"">" & vbcrlf & "          <input name=""part1"" type=""text"" size=""15"" dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间"">" & vbcrlf & "        </span></td>" & vbcrlf & "        <td><div align=""right"">职　　务：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""job"" type=""text"" size=""15"" dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""36""><div align=""right"">性　　别：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""sex"" type=""radio"" value=""男"" checked>" & vbcrlf & "男" & vbcrlf & "  <input type=""radio"" name=""sex"" value=""女"">" & vbcrlf & "女</td>" & vbcrlf & "        <td ><div align=""right"">年　　龄：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""age"" type='text' onkeyup=""value=value.replace(/[^\d]/g,'')"" dataType=""Limit"" max=""3""  msg=""年龄不会超过3位数"" size=""15"">          <div align=""center""></div></td>" & vbcrlf & "        <td><div align=""right"">籍　　贯：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""jg"" type=""text"" size=""15"" dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""36""><div align=""right"">办公电话：</div></td> "& vbcrlf &"         <td class=""gray""><input name=""phone"" type=""text"" size=""15"" dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td> "& vbcrlf &"         <td ><div align=""right"">传　　真：</div></td> "& vbcrlf &"         <td class=""gray""><input name=""fax"" type=""text"" size=""15"" dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td> "& vbcrlf & "        <td><div align=""right"">手　　机：</div></td> "& vbcrlf &"         <td class=""gray""><input name=""mobile"" type=""text"" size=""15"" dataType=""Limit"" id=""mobile"" max=""50""  msg=""必须在1至50个字之间"">"
	...
	Response.write "</td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""36""><div align=""right"">家庭电话：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""phone2"" type=""text"" size=""15"" dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "   <td><div align=""right"">QQ：</div></td>" & vbcrlf & "         <td class=""gray""><span class=""gray""><input name=""qq"" ID=""qq"" type=""text"" size=""15"" onkeyup=""value=value.replace(/[^\d]/g,'').replace(/^0(\d+)$/,'$1')"" require=""false"" dataType=""Limit"" min=""5""  msg=""QQ最少位数是5位""></span></td>" & vbcrlf & "        <td><div align=""right"">MSN：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""msn"" type=""text"" size=""15"" dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""36""><div align=""right"">供应商网址：</div></td>" & vbcrlf & "        <td colspan=""3"" class=""gray""><input name=""url"" type=""text"" value=""http://"" size=""46"" require=""false"" dataType=""Url"" msg=""非法的Url，记得前面要加http://"">          " & vbcrlf & "        <div align=""center""></div></td>" & vbcrlf& "        <td><div align=""right"">电子邮件：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""email"" id=""email"" type=""text"" size=""15"" dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间"">"
	...
	Response.write "</td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""36""><div align=""right"">供应商地址：</div></td>" & vbcrlf & "        <td colspan=""3"" class=""gray""><input name=""address"" type=""text"" value="""" size=""46"" datatype=""Limit"" max=""100"" msg=""地址太长了，最多100个字""></td>" & vbcrlf & "        <td><div align=""right"">邮　　编：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""zip"" type=""text"" size=""15"" onkeyup=""value=value.replace(/[^\d]/g,'')"" dataType=""Limit"" max=""6""  msg=""邮编填错了""></td>" & vbcrlf & "      </tr>" & vbcrlf & "     <tr>" & vbcrlf & "        <td height=""36""><div align=""right"">法人代表：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""faren"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "        <td ><div align=""right"">注册资本：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""zijin"" id=""zijin"" type=""text"" size=""10"" onpropertychange=""formatData(this,'money');"" onkeyup=""checkDot('zijin','"
	Response.write num_dot_xs
	Response.write "')"" oncontextmenu='self.event.returnValue=false'  dataType=""number"" max=""999999999.9999"" cannull=""1"" msg=""必须是数字"">" & vbcrlf & "          万元&nbsp;</td>" & vbcrlf & "        <td><div align=""right"">人员数量：</div></td>" & vbcrlf & "        <td class=""gray"">销售" & vbcrlf & "          <input name=""pernum1"" type=""text"" size=""5""  onKeyUp=""this.value=this.value.replace(/\D/g,'')""  dataType=""LimitB"" min=""0"" max=""6""  msg=""长度必须在6位之内"">" & vbcrlf & "          技术" & vbcrlf & "          <input name=""pernum2"" type=""text"" size=""5""  onKeyUp=""this.value=this.value.replace(/\D/g,'')""   dataType=""LimitB"" min=""0"" max=""6""  msg=""长度必须在6位之内""></td>" & vbcrlf & "      </tr>" & vbcrlf & ""
	If ZBRuntime.MC(201203) Then Response.write getExtended(26,0)
	If ZBRuntime.MC(201201) Then call show_Quali_list(ord,101,0,"edit",6,6)
	Response.write "" & vbcrlf & "       </table>" & vbcrlf & "        <script language=""JavaScript"">" & vbcrlf & "<!--" & vbcrlf & "function showLay(divId){" & vbcrlf & "      var objDiv = eval(divId);" & vbcrlf & "       if (objDiv.style.display==""none""){" & vbcrlf & "                eval(""sp""+divId+"".innerHTML=''"");" & vbcrlf & "           objDiv.style.display="""";" & vbcrlf & "  }else{" & vbcrlf & "          eval(""sp""+divId+"".innerHTML=''"");" & vbcrlf & "           objDiv.style.display=""none"";" & vbcrlf & "      }" & vbcrlf & "}" & vbcrlf & "// -->" & vbcrlf & "    </script>" & vbcrlf & "    <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""margin-top: -1px;"">" & vbcrlf & "        <tr  class=""top"">" & vbcrlf & "        <td height=""36"" colspan=""6""> <div align=""left""><a target=""_self"" href=""javascript:;"" onClick=""showLay('Layer1')""><span id=""spLayer1""></span>业务情况（点击即可弹开收回）</font></a></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "       </table>" & vbcrlf & "              <div id=""Layer1"">" & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""margin-top: -1px;"">" & vbcrlf & "      <tr >" & vbcrlf & "      <td width=""10%"" height=""30""><div align=""right"">供应商简介：</div></td>" & vbcrlf & "        <td width=""80%"" colspan=""5""><textarea name=""product"" cols=""80"" rows=""4"" dataType=""Limit"" max=""4000""  msg=""最多4000个字""></textarea></td>" & vbcrlf & "        </tr>" & vbcrlf & "       <tr>" & vbcrlf& "        <td height=""30""><div align=""right"">合作现状：</div></td>" & vbcrlf & "        <td colspan=""5""><div align=""right""></div>          " & vbcrlf & "          <div align=""left"">" & vbcrlf & "            <textarea name=""c2"" cols=""80"" rows=""4"" dataType=""Limit"" max=""4000""  msg=""最多4000个字""></textarea>" & vbcrlf & "          </div></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""30""><div align=""right"">合作前景：</div></td>" & vbcrlf & "        <td colspan=""5""><div align=""right""></div>          " & vbcrlf & "          <div align=""left"">"& vbcrlf & "            <textarea name=""c3"" cols=""80"" rows=""4"" dataType=""Limit"" max=""4000""  msg=""最多4000个字""></textarea>" & vbcrlf & "          </div></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td height=""30""><div align=""right"">跟进策略：</div></td>" & vbcrlf & "        <td colspan=""5""><div align=""right""></div>          " & vbcrlf & "          <div align=""left"">" & vbcrlf & "            <textarea name=""c4"" cols=""80"" rows=""4"" dataType=""Limit"" max=""4000""  msg=""最多4000个字""></textarea>" & vbcrlf & "          </div></td>" & vbcrlf & "      </tr>" & vbcrlf & "     <tr>" & vbcrlf & "        <td height=""30""><div align=""right"">备　　注：</div></td>" & vbcrlf & "        <td colspan=""5""><div align=""right""></div>          " & vbcrlf & "          <div align=""left"">" & vbcrlf & "            <textarea name=""intro"" cols=""80"" rows=""4"" dataType=""Limit"" max=""8000""  msg=""最多8000个字"" style=""display:none""></textarea>" & vbcrlf & "            <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=intro&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME> "& vbcrlf &"           </div></td> "& vbcrlf &"       </tr> "& vbcrlf &"    "
	If ZBRuntime.MC(201203) Then Response.write getExtended1(26,0)
	Response.write "" & vbcrlf & "       </table>" & vbcrlf & "       </div>" & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""margin-top:-1px"">" & vbcrlf & "         <tr  class=""top"">" & vbcrlf & "        <td height=""36"" colspan=""6""> <div align=""left""><a target=""_self"" href=""javascript:;"" onClick=""showLay('Layer2')""><span id=""spLayer2""></span>财务信息（点击即可弹开收回）</font></a></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "          </table>" & vbcrlf & "              <div id=""Layer2"" style=""display:none;"">" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "       <tr>" & vbcrlf & "        <td  width=""10%""><div align=""right"">开户银行1：</div></td>" & vbcrlf & "        <td width=""20%"" class=""gray""><input name=""bank_1"" type=""text"" size=""15"" dataType=""Limit"" max=""100""  msg=""必须在1至100个字之间""></td> "& vbcrlf &"         <td width=""10%""><div align=""right"">开户名称1：</div></td> "& vbcrlf &"         <td width=""20%""><span class=""gray""> "& vbcrlf &"           <input name=""bank_2"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间"">" & vbcrlf & "        </span></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">银行行号1：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""bank_7"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "       </tr>" & vbcrlf & "          <tr>" & vbcrlf & "        <td width=""10%""><div align=""right"">银行账号1：</div></td>" & vbcrlf & "        <td width=""20%"" class=""gray""><input name=""bank_3"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "      <td height=""36""><div align=""right"">税　　号1：</div></td>" & vbcrlf & "       <td class=""gray""><input name=""bank_4"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "       <td ><div align=""right"">地　　址1：</div></td>" & vbcrlf & "            <td class=""gray""><input name=""bank_5"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr>" & vbcrlf & "          <td><div align=""right"">电　　话1：</div></td>" & vbcrlf & "          <td class=""gray""><input name=""bank_6"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "           <td height=""36""><div align=""right"">开户银行2：</div></td>" & vbcrlf & "           <td class=""gray""><input name=""bank2_1"" type=""text"" size=""15"" dataType=""Limit"" max=""100""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "              <td ><div align=""right"">开户名称2：</div></td> "& vbcrlf &"            <td class=""gray""><input name=""bank2_2"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td> "& vbcrlf &"               </tr> "& vbcrlf &"          <tr> "& vbcrlf &"             <td><div align=""right"">银行行号2：</div></td> "& vbcrlf &"              <td class=""gray""><input name=""bank2_7"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "         <td><div align=""right"">银行账号2：</div></td>" & vbcrlf & "             <td class=""gray""><input name=""bank2_3"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td> "& vbcrlf &"         <td height=""36""><div align=""right"">税　　号2：</div></td> "& vbcrlf &"            <td class=""gray""><input name=""bank2_4"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>         "& vbcrlf &"       </tr> "& vbcrlf &"         <tr> "& vbcrlf &" <td ><div align=""right"">地　　址2：</div></td>" & vbcrlf & "        <td class=""gray""><input name=""bank2_5"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "      <td><div align=""right"">电　　话2：</div></td>" & vbcrlf & "     <td class=""gray""><input name=""bank2_6"" type=""text"" size=""15""  dataType=""Limit"" max=""50""  msg=""必须在1至50个字之间""></td>" & vbcrlf & "        <td></td>" & vbcrlf & "        <td></td>" & vbcrlf & "        </tr>" & vbcrlf & "           <tr>" & vbcrlf & "        <td ><div align=""right"">账　　期：</div></td>" & vbcrlf & "     <td class=""gray""><input name=""fkdays"" id=""fkdays"" type=""text"" size=""15"" maxlength=""3"" onpropertychange=""formatData(this,'int');"" onKeyUp=""checkDot('fkdays','0')""  dataType=""Range"" min=0 max=""365""  msg=""账期必须是0到365之间的数字""> 天</td>" & vbcrlf & "       <td><div align=""right"">结算日期：</div></td>" & vbcrlf & "      <td class=""gray"">每月 <select name=""fkdate"" >" & vbcrlf & "                   <option value=""0""></option>" & vbcrlf & "                       "
	For i=1 To 31
		Response.write "" & vbcrlf & "                             <option value="""
		Response.write i
		Response.write """>"
		...
		Response.write "</option>" & vbcrlf & "                            "
	next
	Response.write "" & vbcrlf & "                     </select>号</td>" & vbcrlf & "        <td></td>" & vbcrlf & "        <td></td>" & vbcrlf & "        </tr>" & vbcrlf & "   </table>" & vbcrlf & "    <div class='red' style='margin-top:12px; margin-left:30px;'>温馨提示：如果当前月没有31号，则结算日期为30或31号时，按照当前月最后一天生成付款计划；</div>" & vbcrlf & "   </div>" & vbcrlf & "         <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""0"" bgcolor=""#C0CCDD"" id=""content"" height=50 style=""margin-top:-1px;"">" & vbcrlf & "          <tr>" & vbcrlf & "        <td colspan=""6"" valign=""top""><div align=""center"">    " & vbcrlf & "                       <input type=""button"" name=""Submit424"" value=""暂存"" onclick=""ask(4);"" class=""page""/>" & vbcrlf & "                   <input type=""button"" name=""Submit422"" value=""保存"" onclick=""ask(1);"" class=""page""/>" & vbcrlf & "            <input type=""button"" name=""Submit42"" value=""增加"" onclick=""ask(2);"" class=""page""/>" & vbcrlf & "                   <input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf & "            <br>" & vbcrlf & "            <br>" & vbcrlf & "        </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table>" & vbcrlf & "    </form> " & vbcrlf & "    </td>" & vbcrlf & "  </tr>" &vbcrlf & "</table>" & vbcrlf & "<div id=""w2"" class=""easyui-window"" title=""人员选择""  style=""width:570px;height:390px;padding:5px;background: #fafafa;top:130px;left:290px;""  closed=""true"" ></div>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
	Response.write "</option>" & vbcrlf & "                            "
	call close_list(1)
