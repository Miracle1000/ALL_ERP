...
'if strW3<>"" Then
	...
	if W4<>"" Then
		...
		W1=tmp(0)
		W2=tmp(1)
		Str_Result2=Str_Result2+" and cateid in("& W3 &") and cateid<>0 "
		W2=tmp(1)
	end if
	m1=request("ret")
	m2=request("ret2")
...
'if m1="" then
	...
	if open_10_11=3 then
	elseif open_10_11=1 then
		Str_Result2=Str_Result2+" and  cateid in("&intro_10_11&")"
'elseif open_10_11=1 then
	else
		Str_Result2=Str_Result2+" and  cateid=0"
'elseif open_10_11=1 then
	end if
...
'if CDate(m1)>CDate(m2) then m1=m2
	...
	Response.write person_type
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "          <input type=""button"" name=""zxt"" value=""折线图分析"" onClick=""window.location.href='hrgz5.asp?type_tj=2&W1="
	Response.write W1
	Response.write "&W2="
	Response.write W2
	Response.write "&W3="
	...
	Response.write "&person_type="
	Response.write person_type
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "        <input type=""button"" name=""line"" value=""饼图分析"" onClick=""window.location.href='hrgz5.asp?type_tj=3&W1="
	Response.write W1
	Response.write "&W2="
	Response.write W2
	Response.write "&W3="
	...
	Response.write ">图宽=550</option>" & vbcrlf & "              <option value=""hrgz5.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=700</option>" & vbcrlf & "              <option value=""hrgz5.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=1000</option>" & vbcrlf & "              <option value=""hrgz5.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=1500</option>" & vbcrlf & "              <option value=""hrgz5.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	Response.write ">图宽=2000</option>" & vbcrlf & "              <option value=""hrgz5.asp?type_tj="
	Response.write type_tj
	Response.write "&W1="
	Response.write W1
	Response.write "&W2="
	...
	if open_10_10=1 or open_10_10=3  then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认将统计结果导出为EXCEL文档？')){window.location.href='hrgz5.asp?type_tj=4&W1="
		Response.write W1
		Response.write "&W2="
		Response.write W2
		Response.write "&W3="
	...
	for j=1 to m
		...
		money2=0
		set rs=server.CreateObject("adodb.recordset")
		sql="select money1,sort1,wages,updown  from  wageslist a inner join (select id from wages where del=1 and complete1=1 and isnull(salaryClass,0)>0 and  year(date2)='"&year(tdw)&"' and  year(date2)='"&year(tdw)&"' "&Str_Result4&" ) b on a.wages=b.id left join (select b.userid , b.nowstatus from gate_person a inner join hr_person b on a.ord=b.userid) c on c.userid =a.cateid  where del=1  "&Str_Result2&""
...
'if rs("updown")=1 then
		...
		'set rs=nothing
		title=year1&"年"
		lburl="../hrwages/planallall.asp?W1="&W1&"&W2="&W2&"&W3="&W3&"&E="&E&"&F="&F&"&ret="&tdw&"&ret2="&dateadd("yyyy",1,tdw)-1&"&person_type="& person_type &""
		'title=year1&"年"
		total1(j,1)=numcg1
		total1(j,2)=title
		total1(j,0)=lburl
		total2(j,0)=title
		total2(j,1)=numcg1
		total2(0,1)="#FF0000,1.5,1,3,每年走势"
		total2(j,2)=lburl
		total3(j,0)=title
		total3(j,1)=numcg1
		total3(j,2)=lburl
