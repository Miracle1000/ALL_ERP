...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td></tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">用品分类：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "                "
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from O_officeType order by pro_gate2 desc"
	rs.open sql,conn,1,1
	do until rs.eof
		Response.write "" & vbcrlf & "                      <input name=""D"" type=""checkbox"" id=""D"" value="""
	...
	rs.close
	set rs=nothing
	Response.write "               </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">用品类型：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "                       <input name=""E"" type=""checkbox"" id=""E"" value=""2"">" & vbcrlf & "                      非易耗品" & vbcrlf & "                        <input name=""E"" type=""checkbox"" id=""E"" value=""1"">" & vbcrlf & "                       易耗品</td>" & vbcrlf & "             </tr>" & vbcrlf & "           "
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=802 and set_open=1 and js=1 and sort=1 order by gate1 asc "
	rs.open sql,conn,1,1
	if rs.eof then
	else
		do until rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">用品名称：</div></td>" & vbcrlf & "         <td><input name=""F"" type=""text"" id=""F"" size=""15"" /></td>" & vbcrlf & "       </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">用品编号：</div></td>" & vbcrlf & "      <td><input name=""G"" type=""text"" id=""G"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf &"     <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">用品型号：</div></td>" & vbcrlf & "      <td><input name=""H"" type=""text"" id=""H"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  "
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=802 and set_open=1 and js=1 and sort=2 order by gate1 asc "
	rs.open sql,conn,1,1
	if rs.eof then
	else
		do until rs.eof
			Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">"
			Response.write rs("title")
			Response.write "：</div></td>" & vbcrlf & "<td>" & vbcrlf & " <input name="""
			Response.write rs("name")
			Response.write """ type=""text"" size=""15""></td></tr>" & vbcrlf & ""
			rs.movenext
		loop
	end if
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td><div align=""right"">最低库存：</div></td>" & vbcrlf & "      <td><input name=""L1"" type=""text"" id=""L1"" onKeyUp=""value=value.replace(/[^\d*|\.]/g,'')"" size=""12"" maxlength=""12"">" & vbcrlf & "              -" & vbcrlf & "           <input name=""L2"" type=""text"" id=""L2"" onKeyUp=""value=value.replace(/[^\d*|\.]/g,'')""  size=""12"" maxlength=""12"">&nbsp;&nbsp;<font id=""L_1"" style=""color:red""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">最高库存：</div></td>" & vbcrlf & "      <td><input name=""L3"" type=""text"" id=""L3"" onKeyUp=""value=value.replace(/[^\d*|\.]/g,'')""  size=""12"" maxlength=""12"">"& vbcrlf & "              -" & vbcrlf & "           <input name=""L4"" type=""text"" id=""L4"" onKeyUp=""value=value.replace(/[^\d*|\.]/g,'')""  size=""12"" maxlength=""12"">&nbsp;&nbsp;<font id=""L_2"" style=""color:red""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "       <td><div align=""right"">档案备注：</div></td>" & vbcrlf & "      <td><input name=""M"" type=""text"" id=""M"" size=""30""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td><div align=""right"">添加时间：</div></td>" & vbcrlf & "      <td>&nbsp;自：<input name=""ret3"" type=""text"" size=""9"" value="""" id=""daysOfMonthPos3"" onmouseup=toggleDatePicker(""daysOfMonth3"",""date.ret3"") readonly=""true""><DIV id=daysOfMonth3 style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<input name=""ret4"" type=""text"" size=""9"" value="""" id=""daysOfMonthPos4"" onmouseup=toggleDatePicker(""daysOfMonth4"",""date.ret4"") readonly=""true""><DIV id=daysOfMonth4 style=""POSITION: absolute;z-index:10""></DIV></td>" & vbcrlf & "  </tr>" & vbcrlf & "      <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td width=""10%"">&nbsp;</td>" & vbcrlf & "       <td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page"" onclick=""return ask();""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "     </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
