...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td colspan=""2""><a href=""#"" class=""AfterQuickSearch"" onClick=""document.getElementById('DP').style.display='';document.getElementById('ht1').style.display='none';return false;""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td>" & vbcrlf & "    </tr>" & vbcrlf & "   <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">"& vbcrlf & "               <td><div align=right >类型：</div></td>" & vbcrlf & "         <td>" & vbcrlf & "                    <input type='checkbox' name='sort1' value='1'>客户&nbsp;" & vbcrlf & "                        <input type='checkbox' name='sort1' value='2'>项目&nbsp;" & vbcrlf & "                        <input type='checkbox' name='sort1' value='3'>报价&nbsp;" & vbcrlf & "                <input type='checkbox' name='sort1' value='4'>合同&nbsp;" & vbcrlf & "                        <input type='checkbox' name='sort1' value='5'>采购&nbsp;" & vbcrlf & "                        <input type='checkbox' name='sort1' value='6'>售后&nbsp;" & vbcrlf & "                        <input type='checkbox' name='sort1' value='7'>销售退货&nbsp;" & vbcrlf & "                    <input type='checkbox' name='sort1' value='8'>联系人&nbsp;" & vbcrlf & "                        <input type='checkbox' name='sort1' value='24'>询价&nbsp;" & vbcrlf & "                       <input type='checkbox' name='sort1' value='75'>采购退货&nbsp;" & vbcrlf & "                   <input type='checkbox' name='sort1' value='76'>供应商&nbsp;" & vbcrlf & "                     <input type='checkbox'name='sort1' value='102001'>客户投诉&nbsp;" & vbcrlf & "                  <input type='checkbox' name='sort1' value='102002'>客户建议&nbsp;" & vbcrlf & "               </td>" & vbcrlf & "   </tr>   " & vbcrlf & "        <tr>" & vbcrlf & "            <td><div align=""right"">" & vbcrlf & "                   "
	If request("re_dp")=1 Then
		Response.write "点评人："
	else
		Response.write "被点评人："
	end if
	Response.write "</div>" & vbcrlf & "                </td>" & vbcrlf & "           <td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & " </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">洽谈进展：</div></td>" & vbcrlf & "      <td><input name=""intro"" type=""text"" size=""28"" /></td>" & vbcrlf &" </tr> "& vbcrlf &"    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'""> "& vbcrlf &"         <td><div align=""right"">点评内容：</div></td> "& vbcrlf &"       <td><input name=""intro2"" type=""text"" size=""28"" /></td> "& vbcrlf &"    </tr> "& vbcrlf &"    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">点评日期：</div></td>" & vbcrlf & "          <td>"
