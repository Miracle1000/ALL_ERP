...
'elseif request("hiddenflag")="4" then
	...
	if len(selyear)>0 and len(selmonth)>0 and len(selday)>0 then tdate=selyear & "-" & selmonth & "-" & selday
	tdate=request("jtdate")
	tdday=day(tdate)
	tdmonth=month(tdate)
	tdyear=year(tdate)
	...
	dim W1,W2,W3,selyear,selmonth,selday
	W1=request("W1")
	W2=request("W2")
	W3=request("W3")
	If w3="" Then
...
'If Right(MoveR,1)=Fstr Then
	...
	If open_5_11=1 Then
		...
		If Len(Trim(Replace(W3," ","")))>0 Then gate_result=gate_result+" and g.ord in  ("&W3&")"
		W3 = intro_5_11
	else
		if W4<>"" And W3<>"" then       gate_result=gate_result+" and g.ord in  ("&W3&")"
		W3 = intro_5_11
	End If
	w3 = MoveR(w3,",")
	if C <> "" then
...
'if C <> "" then
	...
	If W4="" And  C="" And request.QueryString("type")=1 Then
		gate_result=" where name<>''and (g.del=1 "& SearStr &")"
	end if
	Response.write "" & vbcrlf & "<!DOCTYPE HTML PUBLIC ""-//W3C//DTD HTML 4.01 Transitional//EN""" & vbcrlf & """http://www.w3.org/TR/html4/loose.dtd"">" & vbcrlf & "<html>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "var IsOpen = false;  //判断是否执行callServer2()函数，未执行过为假，执行过为真" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "function callServer2() {" & vbcrlf & "  //var url = ""liebiao_tj2.asp?timestamp="" + new Date().getTime() + ""&date1=""+ Math.round(Math.random()*100);" & vbcrlf & "  IsOpen = true;" & vbcrlf & "  var dongjie = document.getElementById(""dongjie"");" & vbcrlf & "  var huishouzhan = document.getElementById(""huishouzhan"");" & vbcrlf & "  var djzh = """";" & vbcrlf & "  var hszzh = """";" & vbcrlf & "  if (dongjie.checked)" & vbcrlf & "  {" & vbcrlf & "              djzh=1;" & vbcrlf & "  }" & vbcrlf & "  if (huishouzhan.checked)" & vbcrlf & "  {" & vbcrlf & "          hszzh=1;" & vbcrlf & "  }" & vbcrlf & "" & vbcrlf & "  var url = ""namelist.asp?tdate="
	Response.write tdate
	Response.write "&sort_zjjg=3&dongjie=""+ djzh +""&huishouzhan=""+ hszzh +""&url=bbzj1.asp&timestamp="" + new Date().getTime() + ""&date1=""+ Math.round(Math.random()*100);" & vbcrlf & "  xmlHttp.open(""GET"", url, false);" & vbcrlf & "  xmlHttp.onreadystatechange = function(){" & vbcrlf & "  updatePage2();" &vbcrlf & "  };" & vbcrlf & "  xmlHttp.send(null);" & vbcrlf & "}" & vbcrlf & "function updatePage2() {" & vbcrlf & "var test7=""ht1""" & vbcrlf & "  if (xmlHttp.readyState < 4) {" & vbcrlf & "  ht1.innerHTML=""loading..."";" & vbcrlf & "  }" & vbcrlf & "  if (xmlHttp.readyState == 4) {" & vbcrlf & "var response = xmlHttp.responseText;" & vbcrlf & "    ht1.innerHTML=response;" & vbcrlf & " xmlHttp.abort();" & vbcrlf & "  }" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<head>" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"">" & vbcrlf & "<title>"
	'Response.write tdate
	Response.write title_xtjm
	Response.write "</title>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<SCRIPT language=""javascript1.2"">" & vbcrlf & "//获取选择的日期" & vbcrlf & "function toggleDatePicker(eltName,formElt) {" & vbcrlf & "  //alert(formElt);" & vbcrlf & "  var x = formElt.indexOf('.');" & vbcrlf & "  var formName = formElt.substring(0,x);" & vbcrlf & "  var formEltName = formElt.substring(x+1);" & vbcrlf & "  newCalendar(eltName,document.forms[formName].elements[formEltName]);" & vbcrlf & "  toggleVisible(eltName);" & vbcrlf & "}" & vbcrlf & "//将获取到日期更新到显示页面" & vbcrlf & "function fSetDate(iYear,iMonth,iDay){" & vbcrlf & "        var iMonthNew=new String(iMonth);" & vbcrlf & "     var iDayNew=new String(iDay);" & vbcrlf & "   if(iMonthNew.length<2){iMonthNew=""0""+iMonthNew;}" & vbcrlf & "  if(iDayNew.length<2){iDayNew=""0""+iDayNew;}" & vbcrlf & "        " & vbcrlf & "        var d = iYear+splitChar+iMonthNew+splitChar+iDayNew;fHideCalendar();" &vbcrlf & "        if(document.getElementById(""CalendarOnlyDate_tr"").style.display==""none""){" & vbcrlf & "           d+= "" "" + document.getElementById(""datedlg_hour"").value + "":"" + document.getElementById(""datedlg_mill"").value + "":"" + document.getElementById(""datedlg_secd"").value" & vbcrlf & " }" & vbcrlf & " document.location.href=""bbzj1.asp?px="
	Response.write px
	Response.write "&C="
	Response.write C
	...
	Response.write "&W3="
	Response.write W3
	Response.write "&W4=1&x=1&type=1&jtdate=""+d+""""" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<script language=""javascript1.2"">" & vbcrlf & "function ChecklhbType(values)" & vbcrlf & "{" & vbcrlf & "  //alert(values);" & vbcrlf & "  document.location.href=values + ""?px="
	'Response.write W3
	Response.write px
	...
	Response.write """" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<script language=""JavaScript"" >" & vbcrlf & "function dh()" & vbcrlf & "{" & vbcrlf & "    checkaction();" & vbcrlf & "  if (IsOpen)" & vbcrlf & "     {" & vbcrlf & "               callServer2();" & vbcrlf & "  }" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function checkaction(){" & vbcrlf & "  var strdongjie = document.getElementById(""dongjie"");" & vbcrlf & "      var strhuishouzhan = document.getElementById(""huishouzhan"");" & vbcrlf & "      var strdjzh="""";" & vbcrlf & "   var strhszzh="""";" & vbcrlf & "  if (strdongjie.checked)" & vbcrlf & " {" & vbcrlf & "               strdjzh=1;" & vbcrlf & "   }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               strdjzh=0;" & vbcrlf & "      }" & vbcrlf & "       if (strhuishouzhan.checked)" & vbcrlf & "     {" & vbcrlf & "               strhszzh=1;" & vbcrlf & "     }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               strhszzh=0;" & vbcrlf & "     }" & vbcrlf & "//     var strurl =""bbzj1.asp?px="
	Response.write px
	Response.write "&jtdate="
	Response.write tdate
	Response.write "&C="
	...
	Response.write "&lhbtype="
	Response.write lhbtype
	Response.write "&type=1&dongjie=""+ strdjzh +""&huishouzhan="" + strhszzh" & vbcrlf & "      var strurl =""bbzj1.asp?px="
	Response.write lhbtype
	Response.write px
	Response.write "&jtdate="
	Response.write tdate
	...
	Response.write "&W3="
	Response.write W3
	Response.write "&W4=1&type=1&dongjie=""+ strdjzh +""&huishouzhan="" + strhszzh" & vbcrlf & " document.location.href=strurl;" & vbcrlf & "  //document.date.action=strurl;" & vbcrlf & "  //date.submit();" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style>" & vbcrlf & "       #content>tbody>tr.billgrouptitlebar>td:first-child{" & vbcrlf & "              padding:0;" & vbcrlf & "              background:#fff;" & vbcrlf & "        }" & vbcrlf & "       #content .billgrouptitlebar td:after{" & vbcrlf & "           display:none;" & vbcrlf & "   }" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body oncontextmenu=self.event.returnValue=false >" & vbcrlf & ""
	...
	Call InitReportBar("今日龙虎榜")
	action1="龙虎榜（业绩）"
	lhbtype=request("lhbtype")
	Response.write "" & vbcrlf & "<span id=""contentdiv"">" & vbcrlf & "<table width=""99.9%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "     <td>" & vbcrlf & "            <form action="""" method=""get""　id=""demo"" onsubmit=""return Validator.Validate(this,2)"" name=""date"" style=""margin:0"" >" & vbcrlf & "         <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0""  style=""background:url(../images/m_mpbg.gif) repeat-x"">" & vbcrlf & "            <tr>" & vbcrlf & "                    <td  class=""place2"" style=""width:30%;"">龙虎榜（业绩）</td>" & vbcrlf & "                  <td  width=""70%"" align=""left"">" & vbcrlf & "                         <table width=""100%"" cellspacing=""2"" align=""left"">" & vbcrlf & "                             <tr height=""25"">" & vbcrlf & "                          <td align=""left"">" & vbcrlf & "                                 <a href=""#"" onClick=""date.hiddenflag.value=4;date.submit();"">" & vbcrlf & "                                               <img class=""resetElementHidden"" src=""../images/main_2.gif"" width=""8"" height=""8"" border=""0"" /><img class=""resetElementShowNoAlign"" src=""../skin/default/images/ico16/lvwbar_1_1.png"" width=""8"" height=""8"" border=""0"" style=""display:none;"" /> 前一天</a>" & vbcrlf & "                                       "
	Response.write tdate
	Response.write "" & vbcrlf & "                                     <a href=""#"" onClick=""date.hiddenflag.value=5;date.submit();"">后一天 <img class=""resetElementHidden"" src=""../images/main_1.gif"" width=""8"" height=""8"" border=""0"" /> <img class=""resetElementShowNoAlign"" src=""../skin/default/images/ico16/lvwbar_4_1.png"" width=""8""height=""8"" border=""0"" style=""display:none;"" /></a>" & vbcrlf & "                                       <input type=""button"" class=""anybutton"" value=""选择日期"" align=""absMiddle""  border=""0""  id=""daysOfMonth1Pos"" name=""daysOfMonth1Pos""  onmouseup=""datedlg.show();"" />" & vbcrlf & "                                      <DIV id=daysOfMonth1 style=""POSITION: absolute""></DIV>" & vbcrlf & "                                 <INPUT name=""ret1"" type=""hidden"" size=10 >           " & vbcrlf & "                               </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                           </table>" & vbcrlf & "                        </td>" & vbcrlf & "                   <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "</tr>" & vbcrlf & "           <tr class=""resetHeadBg"">" & vbcrlf & "                  <td width=""100%"" valign=""center"" colspan=""4"" >" & vbcrlf & "                        <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "                           <tr>" & vbcrlf & "                                  <td>&nbsp;</td>" & vbcrlf & "                                 <td align=""right"">" & vbcrlf & "                                       <input type=""checkbox"" name=""dongjie"" id=""dongjie"" onClick=""dh()"" value=""1"""
	If StrDj=1 then
		Response.write "checked"
	end if
	...
	Response.write " /><label for=""huishouzhan"">含回收站</label>" & vbcrlf & "                           人员姓名：<input name=""C1"" type=""text"" size=""10""  value="""
	Response.write C
	Response.write """""/>" & vbcrlf & "                           "
	...
	Response.write "" & vbcrlf & "                             <input type=""button"" name=""Submit45"" value=""高级"" class=""anybutton2"" onClick=""callServer2();document.getElementById('ht1').style.display='';return false;""/>" & vbcrlf & "                                      </td>" & vbcrlf & "                                   <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "                              </tr>" & vbcrlf & "                   </table>"  & vbcrlf & "                     </td>" & vbcrlf & "           </tr>" & vbcrlf & "           </table>" & vbcrlf & "                <span id=""ht1""></span>" & vbcrlf & "        <input type=""hidden"" name=""C"" value="
	Response.write C
	Response.write """>" & vbcrlf & "                <input type=""hidden"" name=""hiddendate"" value="""
	Response.write tdate
	...
	Response.write """>" & vbcrlf & "       </form>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "                      " & vbcrlf & "" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "<table width=""100%"" border=""1"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""margin-top:0px!important;"">" & vbcrlf & "       <tr class=""top"">" & vbcrlf & "    <td height=""26"" ><div align=""center"">姓名</div></td>" & vbcrlf & "        <td colspan=""8"" ><div align=""center"">龙虎榜</div></td>" & vbcrlf & "      <td ><div align=""center""><SELECT style=""BORDER-BOTTOM: #ffffff 0px solid; BORDER-LEFT: #ffffff 0px solid; BACKGROUND: #ffffff; HEIGHT: 20px; COLOR: #2f496e; FONT-SIZE: 12px; OVERFLOW: hidden; BORDER-TOP: #ffffff 0px solid; FONT-WEIGHT: bold; BORDER-RIGHT: #ffffff 0px solid"" onchange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.name+'='+this.value);}""name=""pz"">" & vbcrlf & "                         <OPTION>-请选择-</OPTION>" & vbcrlf & "                               <OPTION value=""10"""
	Response.write request("w3")
	...
	Response.write ">每页显示200条</OPTION>" & vbcrlf & "                              </SELECT></div></td>" & vbcrlf & "      </tr>" & vbcrlf & " <tr>" & vbcrlf & "      <td height=""27"" >&nbsp;</td>" & vbcrlf & "      <td colspan=""4""  align=""center"">销售龙虎榜</td>" & vbcrlf & "     <td colspan=""4""  align=""center"">到账龙虎榜</td>" & vbcrlf & "     <td   align=""center"">&nbsp;</td>" & vbcrlf & "       </tr>" & vbcrlf & " <tr>" & vbcrlf & "      <td height=""26"" ></td>" & vbcrlf & "    <td  colspan=""2""  align=""center"">今日</td>" & vbcrlf & "          <td  colspan=""2""  align=""center"">累计</td>" & vbcrlf & "          <td  colspan=""2""  align=""center"">今日</td>" & vbcrlf & "       <td  colspan=""2""  align=""center"">累计</td>" & vbcrlf & "          <td align=""center"">&nbsp;</td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td align=""center"">&nbsp;</td>" & vbcrlf & "       <td  width=""9%"" align=""center""><a href=""bbzj1.asp?px=1&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	...
	Response.write "&huishouzhan="
	Response.write StrDel
	Response.write """><u>数量</u></a></td>" & vbcrlf & "        <td  width=""9%"" align=""center""><a href=""bbzj1.asp?px=m1&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1&lhbtype="
	...
	Response.write "&huishouzhan="
	Response.write StrDel
	Response.write """><u>金额</u></a></td>" & vbcrlf & "        <td  width=""9%"" align=""center""><a href=""bbzj1.asp?px=2&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1&lhbtype="
	...
	Response.write "&huishouzhan="
	Response.write StrDel
	Response.write """><u>数量</u></a></td>" & vbcrlf & "        <td  width=""9%"" align=""center""><a href=""bbzj1.asp?px=m2&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1&lhbtype="
	...
	Response.write "&huishouzhan="
	Response.write StrDel
	Response.write """><u>金额</u></a></td>" & vbcrlf & "        <td  width=""9%"" align=""center""><a href=""bbzj1.asp?px=3&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1&lhbtype="
	...
	Response.write "&huishouzhan="
	Response.write StrDel
	Response.write """><u>数量</u></a></td>" & vbcrlf & "        <td  width=""9%"" align=""center""><a href=""bbzj1.asp?px=m3&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1&lhbtype="
	...
	Response.write "&huishouzhan="
	Response.write StrDel
	Response.write """><u>金额</u></a></td>" & vbcrlf & "        <td  width=""9%"" align=""center""><a href=""bbzj1.asp?px=4&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1&lhbtype="
	...
	Response.write "&huishouzhan="
	Response.write StrDel
	Response.write """><u>数量</u></a></td>" & vbcrlf & "        <td  width=""9%"" align=""center""><a href=""bbzj1.asp?px=m4&jtdate="
	Response.write tdate
	Response.write "&C="
	Response.write C
	Response.write "&x=1&lhbtype="
	...
	sumcg1=0 : sumcg2=0 : sumcg3=0 : sumcg4=0
	sumxs1=0 : sumxs2=0 : sumxs3=0 : sumxs4=0
	sumkc1=0 : sumkc2=0 : sumkc3=0 : sumkc4=0
	summl1=0 : summl2=0 : summl3=0 : summl4=0
	...
	"  where  date3='"&tdate&"' and del=1 and isnull(status,-1) in (1,-1) group by cateid  "&_
	"  union all  "&_
	"  select cateid,0,0,count(ord) as numcg2,isnull(sum(money2),0) as numcg2m,0,0,0,0  "&_
	"  from contract WITH(NOLOCK)  "&_
	"  where del=1  and isnull(status,-1) in (1,-1) group by cateid  "&_
	"  union all  "&_
	...
	"  where a.date5='"&tdate&"' and a.del=1 and a.contract=b.ord group by a.cateid  "&_
	"  union all  "&_
	...
	if rs1.RecordCount<=0 then
		...
		Response.write "</div></td>" & vbcrlf & "  </tr>" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""80%"" height=""30"" style="" padding-left:20px;"">" & vbcrlf & "         <p>温馨提示：</p>" & vbcrlf & "               <p>销售龙虎榜取当前销售人员关联的合同的优惠后总额及合同个数；</p>" & vbcrlf & "               <p>到账龙虎榜取当前销售人员关联的已收款的收款计划的金额及条数。" & vbcrlf & "         </p></td>" & vbcrlf& "        <td ></td>" & vbcrlf & "    <td width=""10%""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  "
		rs1.close
		set rs1=nothing
	end if
