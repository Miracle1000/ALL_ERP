...
'elseif C1=6 then
	...
	Response.write " onMouseOver=""window.status='none';return true;"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" >" & vbcrlf & "  <form name=""date"" method=""post"" action=""DraftList.asp?page_count="
	...
	Response.write "&ret2="
	Response.write m2
	Response.write """>" & vbcrlf & "    <tr>" & vbcrlf & "      <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">邮件草稿箱</td>" & vbcrlf & "          <td>&nbsp;</td>" & vbcrlf & "            <td><div align=""right""  id=""kh"">" & vbcrlf & "                "
	if open_77_3=3 or open_77_3=1  then
		Response.write "&nbsp;<input  name=submit22332 type=""button"" onClick=""if(confirm('确认清除全部？')){window.location.href='delallDraft.asp?complete=1&page_count="
		Response.write page_count
	...
	Response.write "" & vbcrlf & "              </div></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "        <span id=""ht1""></span>" & vbcrlf & "        <table width=""100%""border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf &        "   <tr class=""top"">" & vbcrlf &      "       <td height=""27"" align=""center""><div align=""center"">选择</div></td>" & vbcrlf &      "       <td width=""44%"" ><div align=""center"">标题</div></td>" & vbcrlf & "            <td ><div align=""center"">保存人</div></td>" & vbcrlf & "            <td ><div align=""center"">" & vbcrlf & "                <select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){window.open(this.value,'_self');}this.selectedIndex=0;"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px   solid   #FFFFFF; overflow:hidden"">" & vbcrlf & "                  <option>-请选择-</option>" & vbcrlf & "                  <option value=""DraftList.asp?page_count=10&currPage="
	'Response.write "'}"" style=""cursor:hand"" class=""anybutton2""  value=""清除全部"">"
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	...
	Response.write ">每页显示10条</option>" & vbcrlf & "                  <option value=""DraftList.asp?page_count=20&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	Response.write ">每页显示20条</option>" & vbcrlf & "                  <option value=""DraftList.asp?page_count=30&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	Response.write ">每页显示30条</option>" & vbcrlf & "                  <option value=""DraftList.asp?page_count=50&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	Response.write ">每页显示50条</option>" & vbcrlf & "                  <option value=""DraftList.asp?page_count=100&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	Response.write ">每页显示100条</option>" & vbcrlf & "                  <option value=""DraftList.asp?page_count=200&currPage="
	Response.write  currPage
	Response.write "&A2="
	Response.write A2
	Response.write "&A1="
	...
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from email_Drafts  where del=1  "&Str_Result2&" order by ord desc "
	rs.open sql,conn,1,1
	if rs.RecordCount<=0 then
		Response.write "<tr><td  align='center' colspan='10'  class='gray' height='200'>没有日志记录！</td></tr>"
	else
		i=1
		...
		do until rs.eof
			...
			content=rs("content")
			stract=rs("stract")
			Response.write "" & vbcrlf & "          <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td width=""7%"" align=""center""><input name=""selectid"" type=""checkbox"" id=""selectid"" value="""
			Response.write ord
			Response.write """></td>" & vbcrlf & "            <td height=""28""><div align=""center"">" & vbcrlf & "                "
			if stract=1 then
				Response.write "" & vbcrlf & "                <strong>" & vbcrlf & "                "
			end if
			Response.write "" & vbcrlf & "                <a href=""sendemail.asp?draft="
			Response.write ord
			...
			Response.write "" & vbcrlf & "            <td width=""28%""><div align=""center"">"
			Response.write cateid
			Response.write "</div></td>" & vbcrlf & "            <td width=""21%"" class=""gray""><div align=""center"">" & vbcrlf & "                "
			if open_77_3=3 or CheckPurview(intro_77_3,trim(addcate))=True then
				Response.write "" & vbcrlf & "                <input  name=submit2 type=""button"" class=""anybutton""   onClick=""if(!confirm('确认删除吗？')){return false;}else{window.location.href='DraftDel.asp?ord="
			...
			rs.movenext
		loop
		Response.write "" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "    <tr>" & vbcrlf & "      <td  class=""page""><table width=""100%"" border=""0"" align=""center"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""7%"" height=""980"" valign=""top""><div align=""center"">全选" & vbcrlf & "                <input name=""chkall"" type=""checkbox"" id=""chkall"" value=""all"" onclick=""mm(this.form)"" />" & vbcrlf & "              </div></td>" & vbcrlf & "            <td width=""17%"" valign=""top"">"
		if open_77_3=3 or open_77_3=1  then
		...
		Response.write "</td>" & vbcrlf & "            <td width=""76%"" valign=""top""><div align=""right""> <span class=""black"">"
		...
		Response.write "条信息/页</span>&nbsp;" & vbcrlf & "                <input   name=""currpage""  type=text   onkeyup=""value=value.replace(/[^\d\.]/g,'')""  size=3  >" & vbcrlf & "                &nbsp;" & vbcrlf & "                <input type=""submit"" name=""Submit422"" onClick=""submit5()"" value=""跳转""  class=""anybutton2""/>" & vbcrlf & "                &nbsp;" & vbcrlf & "                "
		if currpage=1 then
			...
			Response.write "" & vbcrlf & "                <input type=""button"" name=""Submit4"" value=""首页""   class=""page"" onClick=""window.location.href='DraftList.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
			Response.write  1
			Response.write "&A2="
			...
			Response.write "&ret2="
			Response.write m2
			Response.write "'""/>" & vbcrlf & "                <input type=""button"" name=""Submit42"" value=""上一页""  onClick=""window.location.href='DraftList.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
		...
		if currpage=rs.pagecount then
			...
			Response.write "" & vbcrlf & "                <input type=""button"" name=""Submit43"" value=""下一页""  onClick=""window.location.href='DraftList.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
			Response.write  currpage + 1
			Response.write "&currPage="
			...
			Response.write "&ret2="
			Response.write m2
			Response.write "'"" class=""page""/>" & vbcrlf & "                <input type=""button"" name=""Submit43"" value=""尾页""  onClick=""window.location.href='DraftList.asp?page_count="
			Response.write page_count
			Response.write "&currPage="
			Response.write  rs.PageCount
			Response.write "&A2="
		...
		Response.write "" & vbcrlf & "              </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "        <script language=javascript>" & vbcrlf & "function test()" & vbcrlf & "{" & vbcrlf & "  if(!confirm('确认删除吗？')) return false;" & vbcrlf & "}" & vbcrlf & " " & vbcrlf & "function mm(form) " & vbcrlf & "{ ///定义函数checkall,参数为form " & vbcrlf & "" & vbcrlf & "for (var i=0;i<form.elements.length;i++)" & vbcrlf & "" & vbcrlf & "///循环,form.elements.length得到表单里的控件个数" & vbcrlf & "{" & vbcrlf & "" & vbcrlf & "///把表单里的内容依依付给e这个变量 " & vbcrlf & "var e = form.elements[i]; " & vbcrlf & "if (e.name != 'chkall')  "& vbcrlf &" e.checked = form.chkall.checked; " & vbcrlf &" } " & vbcrlf & "} " & vbcrlf &" </script>" & vbcrlf &       "  <script language=""javascript"" type=""text/javascript""> "& vbcrlf &" <!-- "& vbcrlf &" function submit1() "& vbcrlf &" {" & vbcrlf & "document.all.date.action = ""delallDraft.asp?complete=1&type=1&page_count="
		Response.write page_count
		Response.write "&currPage="
		Response.write  currpage
		Response.write "&A2="
		...
		Response.write "&page_count="
		Response.write page_count
		Response.write """;" & vbcrlf & "}" & vbcrlf & "function submit4()" & vbcrlf & "{" & vbcrlf & "document.all.date.action = ""DraftList.asp?page_count="
		Response.write page_count
		Response.write """;" & vbcrlf & "}" & vbcrlf & "function submit5()" & vbcrlf & "{" & vbcrlf & "document.all.date.action = ""DraftList.asp?page_count="
		Response.write page_count
		Response.write "&A2="
		Response.write A2
		Response.write "&A1="
		...
		Response.write "&ret2="
		Response.write m2
		Response.write """;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</script>" & vbcrlf & "      </td>" & vbcrlf & "    </tr>" & vbcrlf & "  </form>" & vbcrlf & "</table>" & vbcrlf & ""
		'Response.write m2
	end if
	rs.close
	set rs=nothing
