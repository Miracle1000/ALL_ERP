...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	company_name_length=conn.execute("select length/2 from syscolumns where id=(select id from sysobjects where name='tel') and name='name'")(0)
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script type=""text/javascript"" src=""../inc/jquery-1.4.2.min.js?ver="
'Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/javascript"" src=""../inc/jquery.autocomplete.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/Se_add3.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript""></script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "       <tr>" & vbcrlf & "            <td width=""100%"" valign=""top"">" & vbcrlf & "                      <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "                           <tr>" & vbcrlf & "                            <td class=""place"">客户回访添加</td>" & vbcrlf & "                               <td>&nbsp;</td>" & vbcrlf & "                         <td align=""right"">&nbsp;</td>" & vbcrlf & "                             <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                        <form method=""POST"" action=""save.asp?id="
	Response.write id
	Response.write "&ty="
	Response.write ty
	Response.write """ id=""demo"" onsubmit=""gethtml();return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "                  <table border=""1"" width=""100%"" id=""table2"" cellspacing=""0"" cellpadding=""5"" style=""border-collapse: collapse"" bordercolor=""#C0CCDD"">" & vbcrlf & "                           <tr>" & vbcrlf & "                                    <td width=""10%""><div align=""right"">回访主题：</div></td>" & vbcrlf & "                                      <td  class=""gray""><div align=""left"">" & vbcrlf & "                                                <input name=""title"" type=""text"" size=""20"" id=""title"" dataType=""Limit"" min=""1"" max=""100"" msg=""必须在1到100个字之间"">" & vbcrlf & "                                             <span class=""red"" id=""title_tip"">*</span><span id=""queryresult"" class=""red""></span></div></td>" & vbcrlf & "                                 <td><div align=""right"">关联客户：</div></td>" & vbcrlf & "                                      <td width=""22%""  height=""27""><span id=""khmc"">" & vbcrlf & "                                   <input name=""company"" type=""text""  style=""color: #999999;text-align:center;"" size=""20"" onClick=""javascript:window.open('../search/result4.asp?cc=2','eventcom','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=0,left=100,top=100');return false;"" readonly=""true"" dataType=""Limit"" min=""1"" max="""
	Response.write ty
	Response.write company_name_length
	Response.write """  msg=""长度必须在1至"
	Response.write company_name_length
	Response.write "个字之间""></span>" & vbcrlf & "                                    <span class=""red"">*</span></td>" & vbcrlf & "                                 <td><div align=""right"">关联联系人：</div></td>" & vbcrlf & "                                    <td width=""23%"" class=""gray"">" & vbcrlf & "                                               <IFRAME name=""I5"" SRC=""../event/personht.asp"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""150"" HEIGHT=""27"" marginwidth=""1"" marginheight=""1""></IFRAME></td>" & vbcrlf & "                                </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                    <td><div align=""right"">回访模板：</div></td>" & vbcrlf & "                                      <td  class=""gray""><div align=""left"">" & vbcrlf & "                                                <select id=""temp"" name=""temp"" onchange=""getcontent(this.value)"" dataType=""Limit"" min=""1"" msg=""请选择回访模板"">" & vbcrlf & "                                          "
	Set rs=conn.execute("select id,title from hf_Template where del=1 and Used=1 order by id asc")
	If Not rs.eof Then
		tempid=rs("id")
		While Not rs.eof
			If rs("title")&""<>"" Then
	...
	rs.close
	Response.write "" & vbcrlf & "                                              </select>" & vbcrlf & "                                               <span class=""red"">*</span><span class=""red"" id=""Cproc""></span></div></td>" & vbcrlf & "                                     <td><div align=""right"">回访方式：</div></td>" & vbcrlf & "                                      <td width=""23%"" class=""gray"">" & vbcrlf & "                                               <select id=""types"" name=""types""dataType=""Limit"" min=""1"" msg=""请选择回访方式""> "& vbcrlf &""
	Set rs=conn.execute("select ord,sort1 from sortonehy where del=1 and gate2=56 order by ord asc")
	If Not rs.eof Then
		While Not rs.eof
			If rs("sort1")&""<>"" Then
	...
	rs.close
	Response.write "" & vbcrlf & "                                              </select>" & vbcrlf & "                                               <span class=""gray""><span class=""red"">*</span></td>" & vbcrlf & "                          " & vbcrlf & "                                        <td><div align=""right"">回访时间：</div></td>" & vbcrlf & "                                      <td width=""23%"" class=""gray"">" & vbcrlf & "                                               <INPUT name=""ret"" readonly id=""daysOfMonthPos"" onclick=""datedlg.showDateTime()"" value="""
	Response.write now
	Response.write """ size=20 dataType=""Limit"" min=""1"" msg=""请填写回访时间"">" & vbcrlf & "                                         <DIV id=daysOfMonth style=""POSITION: absolute""></DIV>" & vbcrlf & "                                             <span class=""gray""><span class=""red"">*</span></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                    <td><div align=""right"">回访人员：</div></td>" & vbcrlf & "                                        <td class=""gray"" colspan=""5""><div align=""left"">" & vbcrlf & "                                               <select id=""person_hf"" name=""person_hf""  dataType=""Limit"" min=""1"" msg=""请选择回访人员"">" & vbcrlf & "                                           <option value=""""></option>" & vbcrlf & "                                                "
	Set rs=conn.execute("select ord,name from gate where del=1 and exists(select 1 from power where ord =gate.ord and sort1=94 and sort2=9 and qx_open=1) order by ord asc")
	If Not rs.eof Then
		While Not rs.eof
			Response.write "<option value="&rs("ord")&">"&rs("name")&"</option>"
			rs.movenext
		wend
	end if
	rs.close
	Response.write "" & vbcrlf & "                                              </select>" & vbcrlf & "                                               <span class=""red"">*</span><span class=""red""></span></div></td>" & vbcrlf & "                              </tr>" & vbcrlf & "" & vbcrlf & "                           <tr>" & vbcrlf & "                                            <td><div align=""right"">回访内容：</div></td>" & vbcrlf & "                                              <td height=""30px"" colspan=""5"" id=""allcontent"">" & vbcrlf & "                                              " & vbcrlf & "                                                        "
	Set rs1=conn.execute ("select q.id ,q.title,q.qtype from hf_TemplateList t inner join hf_question q on q.id =t.questionid and q.del=1 where t.del=1 and t.mainid="& tempid  &" order by t.id asc ,q.gate1 asc")
	If Not rs1.eof Then
		allpoint=0
		danpoint=0
		Response.write "<table  width='100%' border='0' cellpadding='3' cellspacing='1' bgcolor='#C0CCDD' id='content'>"
		While Not rs1.eof
			one_point=0
			qtype=rs1("qtype")
			If qtype&"" = "" Then qtype = 0
			QtypeName=""
			Select Case qtype&""
			Case "3" : QtypeName = "简答题："
			Case "2" : QtypeName = "多选题："
			Case "1" : QtypeName = "单选题："
			End Select
			Response.write "<tr class='top' ><td height='27'>"&QtypeName&rs1("title")&"</td></tr><tr><td height='27'>"
			Set rs2=conn.execute("select answer, isnull(point,0) as point from hf_QuestionLists where del=1 and mainid="&rs1("id")&"")
			If rs2.eof Then
				If qtype=3 Then
					Response.write "<textarea name='an_"&rs1("id")&"'  type='text' style='word-break:break-all;width:800px;' dataType='Limit' min='0' max='500' msg='不要超过500个字' rows='4' maxlength='500'></textarea>"
'If qtype=3 Then
				end if
			else
				While Not rs2.eof
					If qtype=1 Then
						Response.write "<input type='radio'  name='an_"&rs1("id")&"' value='"&rs2("point")&"' onclick='Jsuan()'>"&rs2("answer")&"（"&rs2("point")&"）&nbsp;"
						If cdbl(rs2("point"))>cdbl(one_point) Then
							one_point=cdbl(rs2("point").value)
						end if
					ElseIf qtype=2 Then
						Response.write "<input type='checkbox'  name='an_"&rs1("id")&"' value='"&rs2("point")&"' onclick='Jsuan()'>"&rs2("answer")&"（"&rs2("point")&"）&nbsp;"
						allpoint=cdbl(allpoint)+cdbl(rs2("point").value)
					else
						Response.write "<textarea name='an_"&rs1("id")&"'  type='text' style='word-break:break-all;width:800px;margin-bottom:3px;' dataType='Limit' min='0' max='500' msg='不要超过500个字' rows='4' maxlength='500'></textarea>（"&rs2("point")&"）<br>"
					end if
					rs2.movenext
				wend
			end if
			...
			danpoint=cdbl(danpoint)+cdbl(one_point)
			Response.write "</td></tr>"
			rs1.movenext
		wend
		allpoint=cdbl(allpoint)+cdbl(danpoint)
		rs1.movenext
		Response.write "<input type='hidden' name='allpoint' id='allpoint' value=" & allpoint & ">"
		Response.write "</table>"
	end if
	rs1.close
	Response.write "" & vbcrlf & "                                             </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                            <td><div align=""right"">备注：</div></td>" & vbcrlf & "                                          <td height=""80px"" colspan=""5"">" & vbcrlf & "                                                      <textarea style=""display:none"" cols=""1"" rows=""1"" name=""remark""></textarea>" & vbcrlf & "                                                     <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=remark&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME>" & vbcrlf & "                                              </td>" & vbcrlf & "                           </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                <td height=""37"" colspan=""6"" class=""gray"">" & vbcrlf & "                             <div align=""center"">" & vbcrlf & "                              <input type=""hidden"" name=""manyidu"" id=""manyidu"" value=""0"">" & vbcrlf & "                             <input type=""hidden"" name=""Ccontent"" id=""Ccontent"">" & vbcrlf & "                           <input type=""submit"" name=""Submit42"" value=""保存""  class=""page""/> "& vbcrlf &  "                          <input type=""reset"" value=""重填"" class=""page"" name=""B2""> "& vbcrlf &  "                               </div></td> "& vbcrlf &  "                            </tr> "& vbcrlf & "                   </table> "& vbcrlf &  "                       </form> "& vbcrlf &   "       </td> "& vbcrlf & "   </tr> "& vbcrlf & "   <tr> "& vbcrlf & "<td  class=""page"">" & vbcrlf & "                    <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "                         <tr>" & vbcrlf & "                            <td height=""580"" ><div align=""center""></div></td>" & vbcrlf & "                   </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                </td>" & vbcrlf & "   </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="客户回访添加"
	call close_list(1)
	Response.write "" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & "<script src= ""../Script/Se_add_1.js?ver="
	Response.write Application("sys.info.jsver")
