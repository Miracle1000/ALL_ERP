...
'If Not rs.Eof Then
	...
	if open_6_1=3 then
		Str_Result=""
	elseif open_6_1=1 then
		Str_Result=" and sorce2 in ("&intro_6_1&")"
	else
		Str_Result=" and sorce2=0"
	end if
	if C<>"" then
		if B="bt" then
			Str_Result=" and title like '%"&C&"%'"
		elseif B="sm" then
			Str_Result=" and note like '%"&C&"%'"
		end if
	end if
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf & "}" & vbcrlf & ".style17 {color: #FF8040}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "<script type=""text/javascript"" language=""javascript"">" & vbcrlf & "function setOpenr(id,title,bz,jktype,cateid,ry,sm)" & vbcrlf & "{" & vbcrlf & "   var sid=id;" & vbcrlf & "     var uname=title;" & vbcrlf & "    var bz=bz;" & vbcrlf & "      var jktype=jktype;" & vbcrlf & "      var ry=ry;" & vbcrlf & "      var sm=sm;" & vbcrlf & "      opener.document.getElementById('sid').value=sid;" & vbcrlf & "        opener.document.getElementById('jklist').value=uname;" & vbcrlf & "   opener.document.getElementById('jklist').style.color='black';" & vbcrlf & "    opener.document.getElementById('bz').innerHTML=bz;" & vbcrlf & "      //opener.document.getElementById('jktype').innerHTML=jktype;" & vbcrlf & "    opener.document.getElementById('ry').innerHTML=ry;" & vbcrlf & "      opener.document.getElementById('paymoney').value = sm;" & vbcrlf & "  var member2 = opener.document.getElementById('member2');" & vbcrlf & "       if (member2) {" & vbcrlf & "      member2.value = cateid;" & vbcrlf & "     }" & vbcrlf & "       window.close();" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body oncontextmenu=self.event.returnValue=false >" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"" height=""500"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & ""
	CurrPage=clng(Request("CurrPage"))
	B=request("B")
	C=Request("C")
	lx=Request("lx")
	if lx = "1" then
		str_Result=" and jktype =1"
	elseif lx= "2" then
		Str_Result=Str_Result+" and jktype =2"
'elseif lx= "2" then
	end if
	if B = "bt" then
...
'if B = "bt" then
	elseif B = "sm" then
		Str_Result=Str_Result+" and  note like '%"& C &"%'"
'elseif B = "sm" then
	end if
	Response.write "" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">借款单检索</td>" & vbcrlf & "            <td><div align=""left"">" & vbcrlf & "                        <table width=""98%"" border=""0"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "                        <tr>" & vbcrlf & "                      <form name=""form"" method=""post"" action=""jkpay.asp""> " & vbcrlf & "                                <td  align=""center""  class=""top"">  " & vbcrlf & "                           <div align=""right"">" & vbcrlf & "                                 <select name=""B"">" & vbcrlf & "<option value=""bt"">借款标题</option>                  " & vbcrlf & "                                    <option value=""sm"">借款概要</option>" & vbcrlf & "                              </select>" & vbcrlf & "                                     <input name=""C"" type=""text"" size=""12"" />" & vbcrlf & "                                      <input type=""submit"" name=""Submit45"" value=""检索"" class=""page""/>" & vbcrlf & "</div></td>" & vbcrlf &              ""               & vbcrlf &                                 "<td width=""43"" >&nbsp;</td>" & vbcrlf &                          "</form>" & vbcrlf &                        "</tr>" & vbcrlf &              "</table>" & vbcrlf &       "</div></td>" & vbcrlf &              "<td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf &         "</tr>" & vbcrlf & "  </table>  " & vbcrlf & "      " & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "    <td align=""center""><div align=""center""><strong>序号</strong></div></td>" & vbcrlf & "<td height=""27"" class=""gray""><div align=""center""><strong>选择</strong></div></td>" & vbcrlf &      "<td class=""gray""><div align=""center""><strong>借款单标题</strong></div></td>" & vbcrlf &          "<td width=""16%"" class=""gray""><div align=""center""><strong>操作</strong></div></td>" & vbcrlf &      "</tr>" & vbcrlf & ""
	set rs=server.CreateObject("adodb.recordset")
	sql="select b.*,sm=b.spmoney-b.jkmoney-b.dmoney from (select id,bz,jktype,spmoney,title,sorce2,date7,jkmoney=isnull((select sum(isnull(money1,0)) from pay where del=1 and complete in(7,8,11) and jkid=a.id),0),dmoney=isnull((select sum(isnull(dkmoney,0)) from dk where jkid=a.id and del=1),0) from payjk a where del=1 and payid=3 "&Str_Result&") b where b.spmoney-b.jkmoney-b.dmoney >0 order by b.date7 desc "
	set rs=server.CreateObject("adodb.recordset")
	...
	if rs.RecordCount<=0 then
		...
		do until rs.eof
			bz=setname("sortbz","id",rs("bz"),"sort1")
			if bz="" or isnull(bz) then bz="人民币"
			jk=rs("jktype")
			paymoney=rs("spmoney")
			if jk=1 then jktype="普通借款"
			if jk=2 then jktype="出差借款"
			ry=setname("gate","ord",rs("sorce2"),"name")
			sm=rs("sm")
			...
			Response.write i+1
			Response.write "</td>" & vbcrlf & "                 <td width=""16%"" height=""28""><div align=""center""><a href=""javascript:void(0);"" onClick=""setOpenr('"
			...
			Response.write bz
			Response.write "','"
			Response.write jktype
			Response.write "','"
			Response.write rs("sorce2")
			Response.write "','"
			Response.write ry
			Response.write "','"
			Response.write sm
			Response.write "')"">点击选择此借款单</a></div></td>" & vbcrlf & "                        <td width=""41%""><div align=""left"">"
			Response.write rs("title")
			Response.write "</div></td>" & vbcrlf & "                  <td class=""name"">                 " & vbcrlf & "              <div align=""center"">"
			if open_1_14=3 or CheckPurview(intro_1_14,trim(cateid))=True then
				Response.write " " & vbcrlf & "                <a  href=""#"" onclick=""javascript:window.open('../pay/jkdetail.asp?ord="
				Response.write pwurl(rs("id"))
				Response.write " ','newwin2','width=' + 900 + ',height=' + 500 + ',scrollbars=1,toolbar=0,resizable=1,left=0,top=0,left=150,top=150')"" >查看此借款单详情</a>" & vbcrlf & "                "
				Response.write pwurl(rs("id"))
			end if
			...
			rs.movenext
		loop
		Response.write "  <tr>" & vbcrlf & "       <td colspan=""4"" class=""page"">" & vbcrlf & "       <div align=""right""><span class=""black"">"
		...
		if currpage=1 then
			...
			Response.write "" & vbcrlf & "        <a Href=""jkpay.asp?ty="
			Response.write ty
			Response.write "&currPage="
			Response.write  1
			Response.write "&B="
			...
			Response.write "&C="
			Response.write C
			Response.write """ class=""black"">首页</a> <a Href=""jkpay.asp?ty="
			Response.write ty
			Response.write "&currPage="
		...
		if currpage=rs.pagecount then
			...
			Response.write "&C="
			Response.write C
			Response.write """ class=""black"">下一页</a> <a Href=""jkpay.asp?ty="
			Response.write ty
			Response.write "&currPage="
			Response.write  rs.PageCount
			Response.write "&B="
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "     </table>" & vbcrlf & "  </td> " & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	conn.close
