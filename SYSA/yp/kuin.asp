...
'If Not rs.Eof Then
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_2=0
		intro_101_2=""
	else
		open_101_2=rs1("qx_open")
		intro_101_2=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=3"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_3=0
		intro_101_3=""
	else
		open_101_3=rs1("qx_open")
		intro_101_3=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=5"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_5=0
		intro_101_5=""
	else
		open_101_5=rs1("qx_open")
		intro_101_5=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=7"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_7=0
		intro_101_7=""
	else
		open_101_7=rs1("qx_open")
		intro_101_7=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_8=0
		intro_101_8=""
	else
		open_101_8=rs1("qx_open")
		intro_101_8=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=9"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_9=0
		intro_101_9=""
	else
		open_101_9=rs1("qx_open")
		intro_101_9=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=10"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_10=0
		intro_101_10=""
	else
		open_101_10=rs1("qx_open")
		intro_101_10=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=11"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_11=0
		intro_101_11=""
	else
		open_101_11=rs1("qx_open")
		intro_101_11=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=12"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_12=0
		intro_101_12=""
	else
		open_101_12=rs1("qx_open")
		intro_101_12=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_13=0
		intro_101_13=""
	else
		open_101_13=rs1("qx_open")
		intro_101_13=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=131"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_131=0
		intro_101_131=""
	else
		open_101_131=rs1("qx_open")
		intro_101_131=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=132"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_132=0
		intro_101_132=""
	else
		open_101_132=rs1("qx_open")
		intro_101_132=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=133"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_133=0
		intro_101_133=""
	else
		open_101_133=rs1("qx_open")
		intro_101_133=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=134"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_134=0
		intro_101_134=""
	else
		open_101_134=rs1("qx_open")
		intro_101_134=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=15"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_15=0
		intro_101_15=""
	else
		open_101_15=rs1("qx_open")
		intro_101_15=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_16=0
		intro_101_16=""
	else
		open_101_16=rs1("qx_open")
		intro_101_16=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=17"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_17=0
		intro_101_17=""
	else
		open_101_17=rs1("qx_open")
		intro_101_17=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=101 and sort2=19"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_101_19=0
		intro_101_19=""
	else
		open_101_19=rs1("qx_open")
		intro_101_19=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	if open_101_1=3 then
		list=""
	elseif open_101_1=1 then
		list=" and prod_addcateid in ("&intro_101_1&")"
	else
		list=" and prod_addcateid=0"
	end if
	Str_Result=" where prod_del=1 "&list&""
...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Class myClass
		function addKuLog(cztime,cateid,djtype,prod_name,prod_bh,prod_xh,unit,store,ph,xlh,ystime,sctime,ynum,bnum,xnum,djtypeid,storeid,unitid,ord)
			if ynum="" or isnull(ynum) then ynum=0
			if bnum="" or isnull(bnum) then bnum=0
			if xnum="" or isnull(xnum) then xnum=0
			sqlx="select * from O_kuLog where 1=2 "
			...
			rsx("cateid")=cateid
			rsx("djtype")=djtype
			rsx("prod_name")=prod_name
			rsx("prod_bh")=prod_bh
			rsx("prod_xh")=prod_xh
			rsx("unit")=unit
			rsx("unitid")=unitid
			rsx("storeid")=storeid
			rsx("djtypeid")=djtypeid
			rsx("store")=store
			rsx("ph")=ph
			rsx("mxid")=ord
			rsx("xlh")=xlh
		...
		function delRepeat(arr1,arr2)
			arr11=split(replace(arr1," ",""),",")
			arr22=split(replace(arr2," ",""),",")
			for i=0 to Ubound(arr11)
				for j=0 to Ubound(arr22)
					if arr11(i)<>"" and arr11(i)=arr22(j) then
						arr11(i)=""
					end if
				next
			next
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/JavaScript"" src=""../inc/checkPublicMethod.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & ".bgdiv{" & vbcrlf & "padding:200px;" & vbcrlf & "font-size:14px;" & vbcrlf & "position:absolute;" & vbcrlf & "top:0%;left:0%;" & vbcrlf & "width:100%;height:100%;" & vbcrlf & "background-color:ffffff;" & vbcrlf & "z-index:1001;" & vbcrlf & "}" & vbcrlf & ".detailTable.whiteBorder{" & vbcrlf & "      box-shadow:none!important;" & vbcrlf & "}" & vbcrlf & "</style>" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
	dim jRs,num1,num88
	set jRs = server.CreateObject("adodb.recordset")
	jRs.Open "select num1=(select top 1 isnull(num1,2) from setjm3 where ord=1 order by id desc),num88=(select top 1 isnull(num1,2) from setjm3 where ord=88 order by id desc)",conn,3,1
	if not jRs.EOF then
		num1=jRs(0)
		num88=jRs(1)
	else
	...
	jRs.close
	set jRs=nothing
	Response.write "" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "window,dotNum1 = """
	Response.write num1
	Response.write """;" & vbcrlf & "var a=1" & vbcrlf & "function add_ProType(prod_name,prod_bh,prod_xh,id)" & vbcrlf & "{" & vbcrlf & "       var tablename=""prod_mx"";" & vbcrlf & "  var table=document.getElementById(tablename);" & vbcrlf & "   var tr = document.createElement('tr');" & vbcrlf & "  tr.onmouseover=function(){this.style.backgroundColor='efefef';}" & vbcrlf & "    tr.onmouseout=function(){this.style.backgroundColor='';}" & vbcrlf & "        tr.id = ""nameTr""+a;" & vbcrlf & "       tr.name = ""nameTr"";       " & vbcrlf & "        table.appendChild(tr);" & vbcrlf & "  var td0 = document.createElement('td');" & vbcrlf & " tr.appendChild(td0);" & vbcrlf & "  td0.align=""left"";" & vbcrlf & " var delHref = ""<div align=\""left\"">""+prod_name+""<input type=\""hidden\"" value=\""""+id+""\"" name=\""prod_id\"">&nbsp;&nbsp;<a href=\""###\"" onclick=\""del_TR('""+tr.id+""')\""><img src=\""../images/del2.gif\""/></a>&nbsp;<span id='sortlist'>""+a+""</span></div>"";" & vbcrlf & "       td0.innerHTML=delHref;" & vbcrlf & "  var td1 = document.createElement('td');" & vbcrlf & " tr.appendChild(td1);" & vbcrlf & "    td1.align=""center"";" & vbcrlf & "       var delHref = ""<div align=\""center\"">""+prod_bh+""</div>"";" & vbcrlf & "      td1.innerHTML=delHref;" & vbcrlf & "     var td2 = document.createElement('td');" & vbcrlf & " tr.appendChild(td2);" & vbcrlf & "    td2.align=""center"";" & vbcrlf & "       var delHref = ""<div align=\""center\"">""+prod_xh+""</div>"";" & vbcrlf & "      td2.innerHTML=delHref;" & vbcrlf & "  var td3 = document.createElement('td');" & vbcrlf & "    tr.appendChild(td3);" & vbcrlf & "    td3.align=""center"";" & vbcrlf & "       var delHref = ""<div align=\""center\""><select name=\""prod_unit\"">""" & vbcrlf & "     delHref= delHref+""<option value=\""0\"">请选择</option>""" & vbcrlf & "      "
	Response.write num1
	sql8="select * from sortonehy where gate2=605 order by gate1 desc"
	set rs8=conn.execute(sql8)
	if not rs8.eof then
		do while not rs8.eof
			Response.write "" & vbcrlf & "      delHref = delHref+""<option value=\"""
'do while not rs8.eof
	...
	rs8.close
	set rs8=nothing
	Response.write "" & vbcrlf & "      delHref = delHref+""</select></div>"";" & vbcrlf & "      td3.innerHTML=delHref;" & vbcrlf & "  var td4 = document.createElement('td');" & vbcrlf & " tr.appendChild(td4);" & vbcrlf & "    td4.align=""center"";" & vbcrlf & "       var delHref = ""<input name=\""prod_num\"" type=\""text\"" id=\""prod_num\""+a onpropertychange=\""formatData(this,'number');chaValue('""+a+""','"
	'set rs8=nothing
	Response.write num_dot_xs
	Response.write "')\"" onkeyup=\""value=formatDot(value,'"
	Response.write num88
	Response.write "')\""  dataType=\""number\"" max=\""9999999999\"" value='"
	Response.write FormatNumber(1,num1_dot,-1,0,0)
	Response.write "')\""  dataType=\""number\"" max=\""9999999999\"" value='"
	Response.write "' size=\""9\"" style=\""width:60px;\"" maxlength=\""12\"" >"";" & vbcrlf & "  td4.innerHTML=delHref;" & vbcrlf & "  var td5 = document.createElement('td');" & vbcrlf & " tr.appendChild(td5);" & vbcrlf & "    td5.align=""center"";" & vbcrlf & "       var delHref = ""<input name=\""prod_price\"" type=\""text\"" id=\""prod_price""+a+""\"" onpropertychange=\""formatData(this,'CommPrice');chaValue('""+a+""','"
	Response.write "')\""  dataType=\""number\"" max=\""9999999999\"" value='"
	Response.write num_dot_xs
	Response.write "')\"" onkeyup=\""value=formatDot(value,'"
	Response.write CommPrice_dot_num
	Response.write "')\"" dataType=\""number\"" max=\""9999999999\"" value='"
	Response.write FormatNumber(0,CommPrice_dot_num,-1,0,0)
	Response.write "')\"" dataType=\""number\"" max=\""9999999999\"" value='"
	Response.write "' size=\""9\"" style=\""width:60px;\"" maxlength=\""12\"">"";" & vbcrlf & "   td5.innerHTML=delHref;" & vbcrlf & "  var td6 = document.createElement('td');" & vbcrlf & " tr.appendChild(td6);" & vbcrlf & "    td6.align=""center"";" & vbcrlf & "       var delHref = ""<input name=\""prod_allmoney\"" type=\""text\"" id=\""prod_allmoney""+a+""\"" dataType=\""number\"" max=\""9999999999\"" value='"
	Response.write "')\"" dataType=\""number\"" max=\""9999999999\"" value='"
	Response.write FormatNumber(0,num_dot_xs,-1,0,0)
	Response.write "')\"" dataType=\""number\"" max=\""9999999999\"" value='"
	Response.write "' readonly=true onkeyup=\""value=value.replace(/[^\\d\\.]\/g,'');value=formatDot(value,'"
	Response.write num1
	Response.write "')\"" size=\""9\"" style=\""width:60px;\"" maxlength=\""12\"" >"";" & vbcrlf & "    td6.innerHTML=delHref;" & vbcrlf & "  var td7 = document.createElement('td');" & vbcrlf & " tr.appendChild(td7);" & vbcrlf & "    td7.align=""center"";" & vbcrlf & "       var delHref = ""<div align=\""center\""><select name=\""sto_id\"">""" & vbcrlf & "      "
	sql8="select * from O_store where ( charindex(',"&session("personzbintel2007")&",',','+replace(cast(sto_intro as varchar(8000)),' ','')+',')>0 or sto_intro='' or sto_intro='0') and sto_state=1 order by sto_gate2 desc"
    'e=\""sto_id\"">""" & vbcrlf & "      "
	set rs8=conn.execute(sql8)
	if not rs8.eof then
		do while not rs8.eof
...
'do while not rs8.eof
	...
	rs8.close
	set rs8=nothing
	Response.write "" & vbcrlf & "      delHref = delHref+""</select></div>"";" & vbcrlf & "      td7.innerHTML=delHref;" & vbcrlf & "  var td8 = document.createElement('td');" & vbcrlf & " tr.appendChild(td8);" & vbcrlf & "    td8.align=""center"";" & vbcrlf & "       var delHref =""<INPUT name='reg_gztime""+a+""' onmouseup=\""toggleDatePicker('xdaysOfMonthx""+id+""_""+a+""','date.reg_gztime""+a+""')\"" value=\"""
'set rs8=nothing
	Response.write date
	Response.write "\"" size=10 style=\""width:80px;\"" id=\""xdaysOfMonthPosx""+id+""_""+a+""\""  readonly=\""true\""><DIV id='xdaysOfMonthx""+id+""_""+a+""' style=\""POSITION: absolute\""></DIV>""" & vbcrlf & "        td8.innerHTML=delHref;" & vbcrlf & "  var td9 = document.createElement('td');" & vbcrlf & " tr.appendChild(td9);" & vbcrlf & "   td9.align=""center"";" & vbcrlf & "       var delHref = ""<input name=\""prod_gys\"" type=\""text\"" id=\""prod_gys\"" size=\""12\"" style=\""width:100px;\"" maxlength=\""200\""><input name=\""prod_ph\"" type=\""hidden\"" id='prod_ph""+id+""_""+a+""' size=\""12\"" maxlength=\""200d9.innerHTML=delHref;" & vbcrlf & "        var td10 = document.createElement('td');" & vbcrlf & "        tr.appendChild(td10);" & vbcrlf & "   td10.align=""center"";" & vbcrlf & "      var delHref = ""<a href=\""###\"" onclick=\""openDiv('""+id+""_""+a+""')\"">更多</a>"";" & vbcrlf & "     td10.innerHTML=delHref;" & vbcrlf & "a=a+1" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<script src= ""../Script/yp_kuin.js?ver="
	Response.write date
	Response.write Application("sys.info.jsver")
	Response.write """  language=javascript></script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "   margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "img{" & vbcrlf & "border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "-->" & vbcrlf & "#prod_type{" & vbcrlf & "width:150px;" & vbcrlf & "height:auto;" & vbcrlf & "margin-bottom:20px;" & vbcrlf & "border:1px solid #CAE3FF;" & vbcrlf & "background-color: #F4F9FF;" & vbcrlf & "position:absolute;" & vbcrlf & "padding:5px;" & vbcrlf & "display:none;" & vbcrlf & "filter:alpha(Opacity=80);-moz-opacity:0.5;opacity: 0.5;" & vbcrlf & "}" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<script src= ""../Script/yp_kuin_1.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ ></script>" & vbcrlf & "<body bgcolor=""#ebebeb"" onmousemove=""MouseMoveToResize(event);"" onmouseup=""MouseUpToResize();"" onLoad=""searchMe('',1);"">" & vbcrlf & ""
	set ml=new myclass
	sql7="select name from gate where ord="&session("personzbintel2007")
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">   " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">入库添加</td>" & vbcrlf & "            <td></td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "       <form action=""save_kuin.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return Validator.Validate(this,2)&&ask1()"">" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">       " & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td height=""27"" ><div align=""left""><strong>基本情况</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "                <div align=""right"">" & vbcrlf & "                 <input type=""submit"" name=""Submit422"" value=""保存"" onClick=""return checkSelectInfo('prod_unit')""  class=""page""/>" & vbcrlf & "                 <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "               </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "      <td width=""14%"" height=""37""><div align=""right"">入库主题：</div></td>" & vbcrlf & "          <td width=""22%"" class=""gray""><inputname=""reg_title"" type=""text"" id=""reg_title"" dataType=""Limit"" min=""1"" max=""200""  msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""11%""><div align=""right"">入库人员：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray"">"
	Response.write regname
	Response.write "<input type=""hidden"" id=""reg_userid"" name=""reg_userid"" value="""
	Response.write session("personzbintel2007")
	Response.write """/></td>" & vbcrlf & "        <td width=""12%""><div align=""right"">入库时间：</div></td>" & vbcrlf & "                <td width=""22%"" class=""gray""><input name=""reg_time"" type=""text"" size=""9"" dataType=""Limit"" min=""1"" max=""20""  msg=""必填"" value="""
	Response.write date
	Response.write """ id=""daysOfMonthPosx"" onmouseup=toggleDatePicker(""daysOfMonthx"",""date.reg_time"") readonly=""true""><DIV id=daysOfMonthx style=""POSITION: absolute;z-index:10""></DIV>&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" align=""center"">           " & vbcrlf & "                <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"" height=""470px"">" & vbcrlf & "            <tr>" & vbcrlf & "                    <td id=""left_td"" width=""170"" height=""470px"" align=""left"" valign=""top"">" & vbcrlf & "                    <table border=""0"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "                 <tr>" & vbcrlf
	sql8="select * from O_prosearch order by id desc"
	set rs8=conn.execute(sql8)
	if not rs8.eof then
		search=rs8("search")
	else
		sqltext="insert into O_prosearch VALUES('1',1,'1',"&session("personzbintel2007")&")"
		conn.execute(sqltext)
		search="1"
	end if
	rs8.close
	set rs8=nothing
	Response.write "" & vbcrlf & "                             <td height=""470px"" valign=""top"">" & vbcrlf & "                                    <div id=""setdiv"" class=""resetBorderColor"" style=""border:1px solid #CCC;height:470px;min-width:190px;overflow:hidden;"">" & vbcrlf & "                                        <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "                                    <tr>" & vbcrlf & "                                            <td height=""30px"" class=""resetGroupTableBg"" style=""background-color:#EFEFEF""><select name=""u_select"" id=""u_select"">" & vbcrlf & "                                               <option value=""1"" "
	set rs8=nothing
	if search="1" then
		Response.write "selected"
	end if
	Response.write ">用品名称</option>" & vbcrlf & "                                           <option value=""2"" "
	if search="2" then
		Response.write "selected"
	end if
	Response.write ">用品编号</option>" & vbcrlf & "                                           <option value=""3"" "
	if search="3" then
		Response.write "selected"
	end if
	Response.write ">用品型号</option>" & vbcrlf & "                                           <option value=""4"" "
	if search="4" then
		Response.write "selected"
	end if
	Response.write ">用品备注</option>" & vbcrlf & "                                           </select> <input  id=""u_name"" name=""sKeyword"" type=""text"" size=""12"" style=""width:80px;"" onpropertychange=""searchMe(this,1);"" onFocus=""searchMe(this,1);"">" & vbcrlf & "                                             </td>" & vbcrlf & "                                   </tr>" & vbcrlf & "                                   <tr>" & vbcrlf & "                                            <td><div id=""searchdiv"" style=""height:440px;overflow-y:auto; overflow-x:hidden;scrollbar-3dlight-color:#d0d0e8; scrollbar-highlight-color:#fff; scrollbar-face-color:#f0f0ff; scrollbar-arrow-color:#c0c0e8; scrollbar-shadow-color:#d0d0e8; scrollbar-darkshadow-color:#fff; scrollbar-base-color:#ffffff; scrollbar-track-color:#fff;""></div></td>" & vbcrlf & "                                       </tr>" & vbcrlf & "                                   </table>" & vbcrlf & "                                        </div>" & vbcrlf & "                          </td>" & vbcrlf & "                           <td>" & vbcrlf & "                            <div id=""cldiv"" style=""cursor:pointer""><img class=""resetElementHidden"" src=""../images/left-ban1.gif"" onClick=""setLeftBanner()"" /><img class=""resetElementShowNoAlign"" style=""display:none;"" src=""../skin/default/images/MoZihometop/content/btn_left.png"" onClick=""setLeftBanner()"" /></div>" & vbcrlf & "                         </td>" & vbcrlf & "                   </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                        </td>" & vbcrlf & "                   <td valign=""top"" style='padding-left:0;padding-right:0'>" & vbcrlf & "                     <table titleflg=""1"" width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                   <tr class=""top noBefore"">" & vbcrlf & "                         <td height=""27"" width=""64%"" colspan=""7""><div align=""left"">用品明细</div></td>" & vbcrlf & "                            <td width=""9%"" height=""27""><div align=""center"">" & vbcrlf & "                               <select name=""abs"" onChange=""batch('sto_id',this.value)"">" & vbcrlf & "                           <option value="""">-请选择-</option>" & vbcrlf & "                                "
	Response.write "selected"
	sql8="select * from O_store where ( charindex(',"&session("personzbintel2007")&",',','+replace(cast(sto_intro as varchar(8000)),' ','')+',')>0 or sto_intro='' or sto_intro='0') and sto_state=1 order by sto_gate2 desc"
	Response.write "selected"
	set rs8=conn.execute(sql8)
	...
	rs8.close
	set rs8=nothing
	Response.write "" & vbcrlf & "                             </select>" & vbcrlf & "                               </div></td>" & vbcrlf & "                             <td width=""10%"" height=""27""><div align=""center"">" & vbcrlf & "                                <input name=""date1"" type=""text"" size=""9"" style=""width:80px;"" id=""daysOfMonthPosy"" onmouseup=toggleDatePicker(""daysOfMonthy"",""date.date1"") readonly=""true"" onchange=""batch('reg_gztime',this.value)""><DIV id=daysOfMonthy style=""POSITION: absolute;z-index:10""></DIV></div></td>" & vbcrlf & "                            <td width=""11%"" height=""27""><div align=""center"">" & vbcrlf & "                                <input name=""txt_gys"" type=""text"" id=""txt_gys"" size=""12"" style=""width:100px;"" maxlength=""200"" onkeyup=""batchcrlf""" & "                   </tr></table>" & vbcrlf & "                   <table class=""detailTable"" jsflg=""1"" border=""0"" width=""100%"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style=""margin-top:-1px;"">" & vbcrlf & "                     <tr class=""top"" >" & vbcrlf & "                         <td width=""10%"" height=""27""><div align=""center""><strong>名称</strong></div></td>" & vbcrlf & "                                <td width=""11%"" height=""27""><div align=""center""><strong>编号</strong></div></td>" & vbcrlf & "                              <td width=""9%"" height=""27""><div align=""center""><strong>型号</strong></div></td>" & vbcrlf & "                               <td width=""7%"" height=""27""><div align=""center""><strong>单位</strong></div></td>" & vbcrlf & "                            <td width=""9%"" height=""27""><div align=""center""><strong>数量</strong></div></td>" & vbcrlf & "                               <td width=""9%"" height=""27""><div align=""center""><strong>单价</strong></div></td>" & vbcrlf & "                               <td width=""9%"" height=""27""><div align=""center""><strong>总价</strong></div></td>" & vbcrlf & "                         <td width=""9%"" height=""27""><div align=""center""><strong>入库仓库</strong></div></td>" & vbcrlf & "                           <td width=""10%"" height=""27""><div align=""center""><strong>购置时间</strong></div></td>" & vbcrlf & "                          <td width=""11%"" height=""27""><div align=""center""><strong>供应商</strong></div></td>" & vbcrlf & "                          <td width=""6%"" height=""27""><div align=""center"">操作</div></td>" & vbcrlf & "                                </tr>           " & vbcrlf & "                                <tbody id=""prod_mx""></tbody>" & vbcrlf & "                      </table>" & vbcrlf & "                        </td>" & vbcrlf & "           </tr>" & vbcrlf &"         </table>" & vbcrlf & "                </td>" & vbcrlf & "        </tr>              " & vbcrlf & "        <tr>" & vbcrlf & "              <td><p align=""right"">入库备注：</td>" & vbcrlf & "              <td colspan=""5"" class=""gray""><textarea name=""note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "                <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "       </tr> " & vbcrlf & "      <tr class=""buttonTableGray"">" & vbcrlf &"        <td colspan=""6"" class=""gray""><p align=""center"">" & vbcrlf & "                <input type=""submit"" name=""Submit42"" value=""保存""  onClick=""return checkSelectInfo('prod_unit')""  class=""page""/>" & vbcrlf & "          <input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr>              " & vbcrlf& "    </table>" & vbcrlf & "   </form>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td  class=""page"" height=""2000"">" & vbcrlf & "   <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "    </tr>" & vbcrlf & "</table>" & vbcrlf & "" & vbcrlf & "   </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="用品入库添加"
	call close_list(1)
	Response.write "" & vbcrlf & "<script>" & vbcrlf & "var jstarget=document.getElementsByTagName(""table"");" & vbcrlf & "var tbobj=null;" & vbcrlf & "for(var i=0;i<jstarget.length;i++)" & vbcrlf & "{" & vbcrlf & " if($(jstarget[i]).attr(""jsflg"")==""1"")" & vbcrlf & "       {" & vbcrlf & "               tbobj=jstarget[i];" & vbcrlf & "           g_tb=tbobj;" & vbcrlf & "     }" & vbcrlf & "       else if($(jstarget[i]).attr(""titleflg"")==""1"")" & vbcrlf & "       {" & vbcrlf & "               g_tb=jstarget[i];" & vbcrlf & "       }" & vbcrlf & "}" & vbcrlf & "ResizeTable_Init(tbobj,true,true);" & vbcrlf & "</script>" & vbcrlf & "<div id=""ddd"" class=""easyui-dialog"" icon=""icon-search"" title=""详细信息""  style=""width:510px;height:240px;padding:5px;background:#fafafa;top:0px"" closed=""true"" >" & vbcrlf & "        <div region=""center"" border=""false"" style=""padding:5px;background:#fff;border:1px solid #ccc;width:98%"">" & vbcrlf & "              <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""  style=""word-break:break-all;word-wrap:break-word;""> " & vbcrlf & "                    <tr>" & vbcrlf & "                            <td height=""27""><div align=""center""><strong>生产日期</strong></div></td>" & vbcrlf & "                            <td height=""27""><div align=""center""><strong>有效日期</strong></div></td>" & vbcrlf & "                         <td height=""27""><div align=""center""><strong>批号</strong></div></td>" & vbcrlf & "                                <td height=""27""><div align=""center""><strong>序列号</strong></div></td>                              " & vbcrlf & "                        </tr>" & vbcrlf & "                   <tr>" & vbcrlf & "                            <td height=""27""><div align=""center""><INPUT name='c' readonly onmouseup=""toggleDatePicker('ydaysOfMonthy','date.c')"" value="""
	Response.write date
	Response.write """ size=9 style=""width:80px"" id=""ydaysOfMonthPosy""><DIV id='ydaysOfMonthy' style=""POSITION: absolute""></DIV></div></td>" & vbcrlf & "                          <td height=""27""><div align=""center""><INPUT name='d' readonly onmouseup=""toggleDatePicker('zdaysOfMonthz','date.d')"" value="""
	Response.write date
	Response.write """ size=9 style=""width:80px"" id=""zdaysOfMonthPosz""><DIV id='zdaysOfMonthz' style=""POSITION: absolute""></DIV></div></td>" & vbcrlf & "                          <td height=""27""><div align=""center""><input name=""a"" type=""text"" id=""aa"" size=""12"" style=""width:120px"" maxlength=""200""></div></td>" & vbcrlf & "                           <td height=""27""><div align=""center""><input name=""b"" type=""text"" id=""bb"" size=""12"" style=""width:120px"" maxlength=""200""></div><input type=""hidden"" name=""setID"" id=""setID"" value=""""></td>                         " & vbcrlf & "                        </tr>" & vbcrlf & "           </table>" & vbcrlf & "        </div>" & vbcrlf& "       <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "            <input type=""hidden"" name=""sflg"" value=""1"">" & vbcrlf & "           <input type=""hidden"" name=""page_count"" value="""
	'Response.write date
	Response.write page_count
	Response.write """>" & vbcrlf & "                <input type=""hidden"" name=""px"" value="""
	Response.write px
	Response.write """><br />" & vbcrlf & "          <a class=""easyui-linkbutton"" icon=""icon-search"" href=""javascript:void(0)"" onClick=""Savetr();"">保存</a>" & vbcrlf & "          <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$('#ddd').window('close');"">取消</a>         " & vbcrlf & "        </div>" & vbcrlf & "</div>" & vbcrlf & "<div id=""ccc"" class=""easyui-dialog"" icon=""icon-search"" title=""批量设置""  style=""width:510px;height:240px;padding:5px;background:#fafafa;top:0px"" closed=""true"" >" & vbcrlf & "       <div region=""center"" border=""false"" style=""padding:5px;background:#fff;border:1px solid #ccc;width:98%"">" & vbcrlf & "            <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content""  style=""word-break:break-all;word-wrap:break-word;""> " & vbcrlf & "                   <tr>" & vbcrlf & "                            <td height=""27""><div align=""center""><strong>生产日期</strong></div></td>" & vbcrlf & "                          <td height=""27""><div align=""center""><strong>有效日期</strong></div></td>" & vbcrlf & "                            <td height=""27""><div align=""center""><strong>批号</strong></div></td>" & vbcrlf & "                                <td height=""27""><div align=""center""><strong>序列号</strong></div></td>                              " & vbcrlf & "                        </tr>" & vbcrlf & "                   <tr>" & vbcrlf & "                            <td height=""27""><div align=""center""><input name=""date2"" type=""text"" size=""9"" id=""daysOfMonthPosl"" onmouseup=toggleDatePicker(""daysOfMonthl"",""date.date2"") readonly=""true"" onchange=""batch('prod_sctime',this.value)""><DIV id=daysOfMonthl style=""POSITION: absolute;z-index:10""></DIV></div></td>" & vbcrlf & "                           <td height=""27""><div align=""center""><input name=""date3"" type=""text"" size=""9"" id=""daysOfMonthPosk"" onmouseup=toggleDatePicker(""daysOfMonthk"",""date.date3"") readonly=""true"" onchange=""batch('prod_ystime',this.value)""><DIV id=daysOfMonthk style=""POSITION: absolute;z-index:10""></DIV></div></td>" & vbcrlf & "                            <td height=""27""><div align=""center""><input name=""txt_ph"" type=""text"" id=""txt_ph"" size=""12"" maxlength=""200"" onkeyup=""batch('prod_ph',this.value)""></div></td>" & vbcrlf & "                            <td height=""27""><div align=""center""><input name=""txt_xlh"" type=""text"" id=""txt_xlh"" size=""12"" maxlength=""200"" onkeyup=""batch('prod_xlh',this.value)""></div></td>" & vbcrlf & "                       </tr>" & vbcrlf & "           </table>" & vbcrlf & "        </div>" & vbcrlf & "  <div region=""south"" border=""false"" style=""text-align:right;height:30px;line-height:30px;"">" & vbcrlf & "             <input type=""hidden"" name=""sflg"" value=""1"">" & vbcrlf & "           <input type=""hidden"" name=""page_count"" value="""
	Response.write px
	Response.write page_count
	Response.write """>" & vbcrlf & "                <input type=""hidden"" name=""px"" value="""
	Response.write px
	Response.write """><br />" & vbcrlf & "          <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""javascript:void(0)"" onClick=""$('#ccc').window('close');"">关闭</a>" & vbcrlf & " </div>" & vbcrlf & "</div>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
	Response.write px
