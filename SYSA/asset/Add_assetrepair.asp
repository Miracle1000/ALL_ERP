...
'function IsTime(values)
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "" & vbcrlf & "function ask1()" & vbcrlf & "{" & vbcrlf & "       var fromobj=document.getElementById(""demo"");" & vbcrlf & "      if(Validator.Validate(fromobj,2)==false)" & vbcrlf & "        {" & vbcrlf & "               return;" & vbcrlf & "   }" & vbcrlf & "       else" & vbcrlf & "    {" & vbcrlf & "               var sid=document.getElementById(""R_cateid"").value;" & vbcrlf & "                check_SP(fromobj,23,0,0,0,'"
	Response.write now
	Response.write "',"
	Response.write session("personzbintel2007")
	Response.write ",sid);" & vbcrlf & "        }       " & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "       margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "img{" & vbcrlf & "border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "" & vbcrlf & "-->"& vbcrlf &" </style>" & vbcrlf & "</head> "& vbcrlf & "<body bgcolor=""#ebebeb""> "& vbcrlf
	set ml=new myclass
	ord=ml.IsNum(request("ord"))
	sql="select * from O_asset where ass_id="&ord
	set rs=conn.execute(sql)
	if not rs.eof then
		asset_name=rs("ass_name")
		style1=""
	else
		asset_name="点击选择资产"
	...
	set rs=nothing
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">资产维护</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf &  "         </tr> "& vbcrlf &  "     </table> "  & vbcrlf &    "     <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf &  "      <form action=""Save_assetrepair.asp?ord="
	Response.write ord
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return false"">" & vbcrlf & "      <tr class=""top resetGroupTableBg"">" & vbcrlf & "        <td height=""27"" ><div align=""left""><strong>基本信息</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5"">" & vbcrlf & "               <div align=""right"">" & vbcrlf & "                   <input type=""button"" name=""Submit422"" value=""保存""  class=""page"" onClick=""ask1()""/>" & vbcrlf & "               <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "               </div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      <tr>" & vbcrlf & "           <td width=""13%"" height=""30""><div align=""right"">资产名称：</div></td>" & vbcrlf & "          <td width=""22%"" height=""30"" class=""gray""><input name=""R_assname"" onClick=""javascript:window.open('../search/search_asset.asp?name1=R_assname&id=R_assID','neww27win','width=' + 800 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150');"" type=""text"" id=""R_assname"" size=""20"" value="""
	Response.write ord
	Response.write asset_name
	Response.write """ "
	Response.write style1
	Response.write " maxlength=""100""><input type=""hidden"" name=""R_assID"" id=""R_assID"" "
	if ord<>0 then
		Response.write "value="""
		Response.write ord
		Response.write """"
	end if
	Response.write " dataType=""Limit"" min=""1"" max=""100"" msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf & "        <td width=""11%"" height=""30""><div align=""right"">维护类型：</div></td>" & vbcrlf & "        <td width=""19%"" height=""30"" class=""gray"">" & vbcrlf & "           <select name=""R_type"" dataType=""Limit""  min=""1"" max=""100"" msg=""必填"">" & vbcrlf & "                        "
	sql7="select * from O_assSetRepair order by set_sort desc "
	...
	Response.write "" & vbcrlf & "              </select>&nbsp;<span class=""red"">*</span>         </td>" & vbcrlf & "        <td width=""11%"" height=""30""><div align=""right"">维护人员：</div></td>" & vbcrlf & "        <td width=""24%"" height=""30"" class=""gray""><input name=""R_catename"" type=""text"" id=""R_catename"" size=""20"" maxlength=""400"" onClick=""javascript:window.open"& vbcrlf & "          <input name=""R_cateid"" type=""hidden"" id=""R_cateid"" maxlength=""100"" dataType=""Limit""  min=""1"" max=""100"" msg=""必填"">&nbsp;<span class=""red"">*</span></td>" & vbcrlf &  "       </tr>" & vbcrlf &  "  <tr>" & vbcrlf & "      <td height=""30""><div align=""right"">短信提醒：</div></td>" & vbcrlf & "         <td height=""30"" class=""gray""><input type=""radio"" name=""R_sms"" value=""0"" checked=""checked"">否<input type=""radio"" name=""R_sms"" value=""1"">是</td>" & vbcrlf & "            <td height=""30""><div align=""right"">提醒时间：</div></td>" & vbcrlf & "            <td height=""30"" class=""gray""><input type=""text"" name=""R_alt"" id=""R_alt"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly""></td>" & vbcrlf & "           <td height=""30""><div align=""right"">维护时间：</div></td>" & vbcrlf & "        <td height=""30"" class=""gray""><input type=""text"" name=""R_time"" id=""R_time"" Class=""DateTimePick"" onclick=""datedlg.showDateTime();"" readonly=""readonly""></td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">维护内容：</div></td>" & vbcrlf & "          <td colspan=""5"" class=""gray""><textarea name=""R_content"" cols=""80"" rows=""5"" id=""R_content"" dataType=""Limit""  min=""0"" max=""2000"" msg=""必须输入少于2000个字""></textarea></td>" & vbcrlf & "      </tr>" & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray""><div align=""center"">" & vbcrlf & "                       <input type=""button"" name=""Submit42"" value=""保存"" class=""page"" onClick=""ask1()""/>" & vbcrlf & "                   <input type=""reset"" value=""重填"" class=""page"" name=""B2""></div></td>" & vbcrlf & "     </tr> " & vbcrlf & "         </form>" & vbcrlf & "    </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & "     <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	action1="资产维护"
	call close_list(1)
