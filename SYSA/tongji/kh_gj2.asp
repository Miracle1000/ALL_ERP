...
'if ZBRuntime.MC(12000) and ZBRuntime.MC(9004) then
	...
	Response.write "&nbsp;&nbsp;"
	Response.write sw
	Response.write "" & vbcrlf & "    </strong>" & vbcrlf & "                        </td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & " <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "<tr class=""top"">" & vbcrlf & "<form method=""POST"" action=""kh_gj2.asp?width_tj="
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "          <input type=""button"" name=""zxt"" value=""折线图分析"" onClick=""window.location.href='kh_gj2.asp?type_tj=2&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&khjz="
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "        <input type=""button"" name=""line"" value=""饼图分析"" onClick=""window.location.href='kh_gj2.asp?type_tj=3&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&khjz="
	...
	Response.write ">图宽=550</option>" & vbcrlf & "              <option value=""kh_gj2.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=700</option>" & vbcrlf & "              <option value=""kh_gj2.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=1000</option>" & vbcrlf & "              <option value=""kh_gj2.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=1500</option>" & vbcrlf & "              <option value=""kh_gj2.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=2000</option>" & vbcrlf & "              <option value=""kh_gj2.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	if open_1_10=1 or open_1_10=3  then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认将统计结果导出为EXCEL文档？')){window.location.href='kh_gj2.asp?type_tj=4&sort="
		Response.write E
		Response.write "&sort1="
		Response.write F
		Response.write "&khjz="
	...
	dim numcg1,zs1
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select * from (select ord,sort1,sort2,gate2 from gate2 "&Str_power22&" union all select 0,9999999,'无小组',-1) t order by sort1 asc,gate2 desc"
	'set rs1=server.CreateObject("adodb.recordset")
	rs1.open sql1,conn,1,1
	...
	if counts<=0 then
		...
		do until rs1.eof
			set rs=server.CreateObject("adodb.recordset")
			sql="select ord from reply where ord in (select ord from tel where del=1) and isnull(cateid3,0)="&rs1("ord")&"  "&Module_Result&"  "&Str_Result2&" "
			rs.open sql,conn,1,1
			numcg1=rs.recordCount
			rs.close
			set rs=nothing
			title=rs1("sort2")
			lburl="../work/genjin.asp?W2="&rs1("ord")&"&sort="&E&"&sort1="&F&"&khjz="&khjz&"&khhy="&khhy&"&khly="&khly&"&ret="&m1&"&ret2="&m2&"&time1="&time1&"&sort_lm="&sort_lm&""
			total1(j,1)=numcg1
			total1(j,2)=title
			total1(j,0)=lburl
			total2(j,0)=title
