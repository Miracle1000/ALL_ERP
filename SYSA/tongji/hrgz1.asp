...
'dim sqlstr
	...
	Response.write "" & vbcrlf & "<html xmlns:v=""urn:schemas-microsoft-com:vml"" xmlns:o=""urn:schemas-microsoft-com:office:office"">" & vbcrlf & "" & vbcrlf & "<!--[if !mso]>" & vbcrlf & "<style>" & vbcrlf & "v\:*         { behavior: url(#default#VML) }" & vbcrlf & "o\:*         { behavior: url(#default#VML) }"& vbcrlf & ".shape       { behavior: url(#default#VML) }" & vbcrlf & "</style>" & vbcrlf & "<![endif]-->" & vbcrlf & "<head>" & vbcrlf & "<meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"">" & vbcrlf & "<title>"
	Response.write title_xtjm
	Response.write "</title>" & vbcrlf & "<link href=""../inc/cskt.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {      margin-top: 0px;}" & vbcrlf & "-->" & vbcrlf & ".IE5 .top_btns input.anybutton2 {height:18px;line-height:16px;margin-bottom:-0.5px;}" & vbcrlf & ".top_btns  select{height:20px!important;line-height:20px;}" & vbcrlf & ".IE5 .top_btns  select{height:22px!important;line-height:22px;}" & vbcrlf & "#calendarPanel{" & vbcrlf & "   top:60px!important;" & vbcrlf & "}" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "" & vbcrlf & "<body  >" & vbcrlf & ""
	'Response.write Application("sys.info.jsver")
...
'if CDate(m1)>CDate(m2) then m1=m2
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "           <input type=""button"" name=""zxt"" value=""折线图分析"" onClick=""window.location.href='hrgz1.asp?type_tj=2&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&time1="
	...
	Response.write "&width_tj="
	Response.write width_tj
	Response.write "'"" class=""anybutton2"">" & vbcrlf & "        <input type=""button"" name=""line"" value=""饼图分析"" onClick=""window.location.href='hrgz1.asp?type_tj=3&sort="
	Response.write E
	Response.write "&sort1="
	Response.write F
	Response.write "&time1="
	...
	Response.write ">图宽=550</option>" & vbcrlf & "              <option value=""hrgz1.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=700</option>" & vbcrlf & "              <option value=""hrgz1.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=1000</option>" & vbcrlf & "              <option value=""hrgz1.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=1500</option>" & vbcrlf & "              <option value=""hrgz1.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	Response.write ">图宽=2000</option>" & vbcrlf & "              <option value=""hrgz1.asp?type_tj="
	Response.write type_tj
	Response.write "&sort="
	Response.write E
	Response.write "&sort1="
	...
	if open_10_10=1 or open_10_10=3  then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""导出"" onClick=""if(confirm('确认将统计结果导出为EXCEL文档？')){window.location.href='hrgz1.asp?type_tj=4&sort="
		Response.write E
		Response.write "&sort1="
		Response.write F
		Response.write "&ret="
...
'if m2<>"" and isdate(m2) then
	...
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select ord,sort1 from gate1 "&Str_power&" order by gate1 desc"
	rs1.open sql1,conn,1,1
...
'if sort1=1 then
			...
			rs.close
			set rs=nothing
			numcg1=Formatnumber(cdbl(money1)-cdbl(money2),num_dot_xs,-1)
			'set rs=nothing
			title=rs1("sort1")
			lburl="../hrwages/planallall.asp?W1="&rs1("ord")&"&a=1&F="&F&"&ret="&m1&"&ret2="&m2&"&person_type="& person_type &""
			total1(j,1)=numcg1
			total1(j,2)=title
			total1(j,0)=lburl
			total2(j,0)=title
			total2(j,1)=numcg1
			total2(0,1)="#FF0000,1.5,1,2,部门分布"
			total2(j,2)=lburl
			total3(j,0)=title
			total3(j,1)=numcg1
			total3(j,2)=lburl
...
'If colTipHxt&""<>"" Then
	...
	call close_list(1)
	Response.write "" & vbcrlf & "</td></tr>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
