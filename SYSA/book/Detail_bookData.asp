...
'If Len(intro_67_1&"") = 0 Then intro_67_1 = 0
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & " margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "img{" & vbcrlf & "border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & ""
	Dim MODULES
	MODULES=session("zbintel2010ms")
	set ml=new myClass
	ord=request("ord")
	sql="select a.*,b.set_name from O_regbook a left join O_bookSet b on a.bk_type=b.id where a.id="&ml.isNum(ord)
	set rs=conn.execute(sql)
	if not rs.eof then
		addcateid=rs("bk_addcateid")
		Response.write "" & vbcrlf & "<body bgcolor=""#ebebeb"" "
		if open_103_8=0 or (open_103_8=1 and CheckPurview(intro_103_8,trim(ml.isNum(rs("bk_addcateid"))))=False) then
		...
		Response.write ">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">   " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">图书详情</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right""><span id=""kh"">" & vbcrlf & "                   "
		if ZBRuntime.MC(27000) then
			if open_6_13=3 or (open_6_13=1 and CheckPurview(intro_6_13,trim(addcateid))=True) then
				Response.write " " & vbcrlf & "                             <input type=""button"" name=""Submit6"" value=""费用""  onClick=""javascript:window.open('../pay/add2.asp?qttype=book&qtord="
				Response.write pwurl(ord)
				Response.write "','newwin62','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')""  class=""anybutton2""/>" & vbcrlf & "                       "
				Response.write pwurl(ord)
			end if
		end if
		manbool=true
		sqltext="select * from O_LendBookmx where Ld_bkid="&rs("id")
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			manbool=false
		end if
		set rstxt=nothing
		sqltext="select * from O_ChkBookmx where Chk_bkid="&rs("id")
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			manbool=false
		end if
		set rstxt=nothing
		if open_103_131=1 and rs("bk_num")>0 then
			Response.write "" & vbcrlf & "                        <input name=""button5"" type=""button""  class=""anybutton2"" id=""submit5"" onClick=""window.location=('Add_Lend.asp?ord="
			Response.write rs("id")
			Response.write "')"" value=""借阅""/>" & vbcrlf & "                     "
		end if
		if open_103_133=1 then
			Response.write "" & vbcrlf & "                        <input name=""button5"" type=""button""  class=""anybutton2"" id=""submit5"" onClick=""window.location=('Add_Check.asp?ord="
			Response.write rs("id")
			Response.write "')"" value=""盘点""/>" & vbcrlf & "                   "
		end if
		if (open_103_2=3 or CheckPurview(intro_103_2,trim(addcateid))=True) and manbool then
			Response.write "" & vbcrlf & "                       <input name=""button4"" type=""button""  class=""anybutton2"" id=""submit4"" onClick=""javascript:window.open('Update_bookData.asp?ord="
			Response.write rs("id")
		...
		if (open_103_3=3 or CheckPurview(intro_103_3,trim(addcateid))=True) and manbool then
			Response.write "" & vbcrlf & "                      <input name=""button5"" type=""button""  class=""anybutton2"" id=""submit5"" onClick=""if(confirm('确认删除吗？')){window.location=('Del_bookData.asp?ord="
			Response.write rs("id")
			Response.write "&px="
			Response.write px
			Response.write "&A="
		...
		Response.write "" & vbcrlf & "                     </span>" & vbcrlf & "                 </td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf &  "     <tr class=""top""> "& vbcrlf &    "     <td height=""27"" colspan=""6"" ><div align=""left""><strong>基本信息</strong></div></td> "& vbcrlf &        " </tr> "& vbcrlf &    "  <tr>" & vbcrlf &      " <td width=""13%"" height=""27""><div align=""right"">书名：</div></td>" & vbcrlf & "        <td colspan=""5"" class=""gray"">"
		Response.write rs("bk_name")
		Response.write "</td>" & vbcrlf & "        </tr>" & vbcrlf & "     <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">编号：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray"">"
		Response.write rs("bk_bh")
		Response.write "</td>" & vbcrlf & "        <td width=""13%""><div align=""right"">分类：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray"">"
		Response.write rs("set_name")
		Response.write "</td>" & vbcrlf & "        <td width=""11%""><div align=""right"">借阅周期：</div></td>" & vbcrlf & "              <td width=""24%"" class=""gray"">"
		Response.write rs("bk_returnnum")
		Response.write "个月</td>" & vbcrlf & "      </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">作者：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray"">"
		Response.write rs("bk_auther")
		Response.write "</td>" & vbcrlf & "        <td width=""13%""><div align=""right"">出版时间：</div></td>" & vbcrlf & "        <td colspan=""3"" class=""gray"">"
		Response.write rs("bk_pubtime")
		Response.write "</td>" & vbcrlf & "        </tr>" & vbcrlf & "     <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">出版社：</div></td>" & vbcrlf & "            <td colspan=""5"" class=""gray"">"
		Response.write rs("bk_publishing")
		Response.write "</td>" & vbcrlf & "        </tr>" & vbcrlf & "     <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">版次：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray"">"
		Response.write rs("bk_pubnum")
		Response.write "</td>" & vbcrlf & "        <td width=""13%""><div align=""right"">页数：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray"">"
		Response.write FormatNumber(rs("bk_pagenum"),num1_dot,-1)
		Response.write "</td>" & vbcrlf & "        <td width=""11%""><div align=""right"">字数：</div></td>" & vbcrlf & "                <td width=""24%"" class=""gray"">"
		Response.write FormatNumber(rs("bk_pagesize"),num1_dot,-1)
		Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">印刷时间：</div></td>" & vbcrlf & "          <td width=""20%"" class=""gray"">"
		Response.write rs("bk_printtime")
		Response.write "</td>" & vbcrlf & "        <td width=""13%""><div align=""right"">开本：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray"">"
		Response.write rs("bk_format")
		Response.write "</td>" & vbcrlf & "        <td width=""11%""><div align=""right"">纸张：</div></td>" & vbcrlf & "                <td width=""24%"" class=""gray"">"
		Response.write rs("bk_paper")
		Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">印次：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray"">"
		Response.write rs("bk_printnum")
		Response.write "</td>" & vbcrlf & "        <td width=""13%""><div align=""right"">ISBN：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray"">"
		Response.write rs("bk_isbn")
		Response.write "</td>" & vbcrlf & "        <td width=""11%""><div align=""right"">装帧：</div></td>" & vbcrlf & "                <td width=""24%"" class=""gray"">"
		Response.write rs("bk_binding")
		Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "   <tr>" & vbcrlf & "      <td width=""13%"" height=""27""><div align=""right"">单价：</div></td>" & vbcrlf & "      <td width=""20%"" class=""gray"">"
		bk_price=zbcdbl(rs("bk_price"))
		if bk_price="" or isnull(bk_price) then bk_price=0
		Response.write Formatnumber(bk_price,CommPrice_dot_num,-1)
'if bk_price="" or isnull(bk_price) then bk_price=0
		Response.write "</td>" & vbcrlf & "        <td width=""13%""><div align=""right"">数量：</div></td>" & vbcrlf & "        <td width=""19%"" class=""gray"">"
		Response.write FormatNumber(rs("bk_allnum"),num1_dot,-1)
		Response.write "</td>" & vbcrlf & "        <td width=""11%""><div align=""right"">总价：</div></td>" & vbcrlf & "                <td width=""24%"" class=""gray"">"
		bk_allmoney=zbcdbl(rs("bk_allmoney"))
		if bk_allmoney="" or isnull(bk_allmoney) then bk_allmoney=0
		Response.write Formatnumber(bk_allmoney,num_dot_xs,-1)
'if bk_allmoney="" or isnull(bk_allmoney) then bk_allmoney=0
		Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "         <tr>" & vbcrlf & "                    <td width=""13%"" height=""27""><div align=""right"">可借阅数量：</div></td>" & vbcrlf & "                        <td class=""gray"">"
		Response.write FormatNumber(rs("bk_num"),num1_dot,-1)
		Response.write "</td>" & vbcrlf & "                        <td width=""13%"" height=""27""><div align=""right"">存放位置：</div></td>" & vbcrlf & "                  <td colspan=""3"" class=""gray"">"
		Response.write rs("bk_postion")
		Response.write "</td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td width=""13%"" height=""27""><div align=""right"">添加人员：</div></td>" & vbcrlf & "                  <td width=""20%"" class=""gray"">"
		sql7="select name from gate where ord="&ml.isNum(rs("bk_addcateid"))
		set rs7=conn.execute(sql7)
		if not rs7.eof then
			Response.write rs7("name")
		end if
		set rs7=nothing
		Response.write "</td>" & vbcrlf & "                        <td width=""13%""><div align=""right"">添加时间：</div></td>" & vbcrlf & "                    <td colspan=""3"" class=""gray"">"
		Response.write rs("bk_addtime")
		Response.write "</td>" & vbcrlf & "                  </tr>   " & vbcrlf & "        <tr>" & vbcrlf & "            <td height=""30""><p align=""right"">图书备注：</td>" & vbcrlf & "            <td colspan=""5"" class=""gray ewebeditorImg"">"
		Response.write rs("bk_note")
		Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "               <tr class=""top"">" & vbcrlf & "                  <td colspan=""4"" height=""27""><a href=""javascript:void(0)"" onClick=""setHidden('tr','table_tr')"">关联借阅单</a></td>" & vbcrlf & "                       "
		jilu=0
		sqltext="select count(*) from O_LendBookmx where Ld_bkid="&ord&" "
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			jilu=rstxt(0)
		end if
		...
		if jilu>3 then
			Response.write "<a href=""javascript:void(0)"" onClick=""javascript:window.open('bookmx.asp?ord="
			Response.write ord
			Response.write "&lx=1','neww35win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')"">更多>>></a>"
			Response.write ord
		end if
		Response.write "</div></td>" & vbcrlf & "          </tr>" & vbcrlf & "           "
		sqltext="select top 3 * from O_LendBookmx where Ld_bkid="&ord&" "
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			do while not rstxt.eof
				...
				Response.write rstxt("Ld_time")
				Response.write "</div></td>" & vbcrlf & "                  <td colspan=""2""><div align=""left"">"
				Response.write FormatNumber(rstxt("Ld_num"),num1_dot,-1)
				Response.write "</div></td>" & vbcrlf & "                  <td colspan=""2""><div align=""left"">"
				Response.write "</div></td>" & vbcrlf & "                  <td colspan=""2""><a href=""javascript:void(0);"" onClick=""javascript:window.open('Detail_Lend.asp?ord="
				Response.write rstxt("id")
				Response.write "','neww36win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')""><div align=""right"" class=""red"">查看此借阅单详情..>>></div></A></td>" & vbcrlf & "                </tr>" & vbcrlf & "             "
				Response.write rstxt("id")
				rstxt.movenext
			loop
		else
		...
		rstxt.close
		set rstxt=nothing
		Response.write "" & vbcrlf & "              <tr class=""top"">" & vbcrlf & "                 <td colspan=""4"" height=""27""><a href=""javascript:void(0)"" onClick=""setHidden('tr','table_tr1')"">关联归还单</a></td>" & vbcrlf & "                      "
		jilu=0
		sqltext="select count(*) from O_RetBookmx where Ret_bkid in (select id from O_LendBookmx where Ld_bkid ="&ord&") "
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			jilu=rstxt(0)
		end if
		...
		if jilu>3 then
			Response.write "<a href=""javascript:void(0)"" onClick=""javascript:window.open('bookmx.asp?ord="
			Response.write ord
			Response.write "&lx=2','neww36win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')"">更多>>></a>"
			Response.write ord
		end if
		Response.write "</div></td>" & vbcrlf & "          </tr>" & vbcrlf & "             "
		sqltext="select top 3 * from O_RetBookmx where Ret_bkid in (select id from O_LendBookmx where Ld_bkid ="&ord&") "
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			do while not rstxt.eof
				Response.write "" & vbcrlf & "             <tr name=""table_tr1"" onMouseOver=""this.style.backgroundColor='efefef';"" onMouseOut=""this.style.backgroundColor='';"">" & vbcrlf & "                  <td height=""27"" colspan=""2""><div align=""left"">"
				Response.write rstxt("ret_time")
				Response.write "</div></td>" & vbcrlf & "                  <td colspan=""2""><div align=""left"">"
				Response.write FormatNumber(rstxt("ret_num"),num1_dot,-1)
				Response.write "</div></td>" & vbcrlf & "                  <td colspan=""2""><div align=""left"">"
				Response.write "</div></td>" & vbcrlf & "                  <td colspan=""2""><a href=""javascript:void(0);"" onClick=""javascript:window.open('Detail_Return.asp?ord="
				Response.write rstxt("Ret_fid")
				Response.write "','neww36win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')""><div align=""right"" class=""red"">查看此归还单详情..>>></div></A></td>" & vbcrlf & "                </tr>" & vbcrlf & "             "
				Response.write rstxt("Ret_fid")
				rstxt.movenext
			loop
		else
		...
		rstxt.close
		set rstxt=nothing
		Response.write "" & vbcrlf & "             <tr class=""top"">" & vbcrlf & "                  <td colspan=""4"" height=""27""><a href=""javascript:void(0)"" onClick=""setHidden('tr','table_tr2')"">关联盘点单</a></td>" & vbcrlf & "                      "
		jilu=0
		sqltext="select count(*) FROM O_ChkBook WHERE id IN(SELECT Chk_fid FROM O_ChkBookmx WHERE Chk_bkid="&ord&")"
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			jilu=rstxt(0)
		end if
		...
		if jilu>3 then
			Response.write "<a href=""javascript:void(0)"" onClick=""javascript:window.open('bookmx.asp?ord="
			Response.write ord
			Response.write "&lx=3','neww36win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')"">更多>>></a>"
			'Response.write ord
		end if
		Response.write "</div></td>" & vbcrlf & "          </tr>" & vbcrlf & "             "
		sqltext="select top 3 * FROM O_ChkBook WHERE id IN(SELECT Chk_fid FROM O_ChkBookmx WHERE Chk_bkid="&ord&")"
		set rstxt=conn.execute(sqltext)
		if not rstxt.eof then
			do while not rstxt.eof
				Response.write "" & vbcrlf & "             <tr name=""table_tr2"" onMouseOver=""this.style.backgroundColor='efefef';"" onMouseOut=""this.style.backgroundColor='';"">" & vbcrlf & "                  <td height=""27"" colspan=""2""><div align=""left"">"
				Response.write rstxt("chk_title")
				Response.write "</div></td>" & vbcrlf & "                  <td colspan=""2""><div align=""left"">"
				Response.write rstxt("chk_time")
				Response.write "</div></td>" & vbcrlf & "                  <td colspan=""2""><a href=""javascript:void(0);"" onClick=""javascript:window.open('Detail_Check.asp?ord="
				Response.write rstxt("id")
				Response.write "','neww36win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')""><div align=""right"" class=""red"">查看此盘点单详情..>>></div></A></td>" & vbcrlf & "                </tr>" & vbcrlf & "             "
				'Response.write rstxt("id")
				rstxt.movenext
			loop
		else
		...
		set rstxt=nothing
		if ZBRuntime.MC(27000) Then
			if open_6_1=3 or open_6_1=1 then
				Response.write "               " & vbcrlf & "               <tr class=""top"">" & vbcrlf & "                 <td colspan=""4"" height=""27""><a href=""javascript:void(0)"" onClick=""setHidden('tr','table_tr3')"">关联费用</a></td>" & vbcrlf & "                        "
				jilu=0
				sqltext="select count(*) from f_pay where id in (select fid from pay where book="&ord&") and ("&open_6_1&"=3 or ("&open_6_1&"=1 and charindex(','+cast(sorce2 as varchar(10))+',',','+'"&replace(intro_6_1," ","")&"'+',')>0)) and del=1"
				jilu=0
				set rstxt=conn.execute(sqltext)
				if not rstxt.eof then
					jilu=rstxt(0)
				...
				if jilu>3 then
					Response.write "<a href=""javascript:void(0)"" onClick=""javascript:window.open('bookmx.asp?ord="
					Response.write ord
					Response.write "&lx=4','neww35win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')"">更多>>></a>"
					Response.write ord
				end if
				Response.write "</div></td>" & vbcrlf & "          </tr>" & vbcrlf & "             "
				sqltext="select F.id, P.sort, F.sorce2 as cateid, P.fid, isnull(P.money1,0) money1, F.datejk, s1.sort1 as trade4, s2.sort1 as trade6 from pay P left join f_pay F on P.fid=F.id left join paytype s1 on s1.id=P.sort left join sortonehy s2 on s2.ord=s1.sort2 where P.book="& ord &" and ("&open_6_1&"=3 or ("&open_6_1&"=1 and charindex(','+cast(F.sorce2 as varchar(10))+',',','+'"&replace(intro_6_1," ","")&"'+',')>0)) and P.del=1 and P.complete in(3,0) order by P.date1 desc,P.ord desc"
				Response.write "</div></td>" & vbcrlf & "          </tr>" & vbcrlf & "             "
				set rstxt=conn.execute(sqltext)
				if not rstxt.eof then
					do while not rstxt.eof
						Response.write "" & vbcrlf & "             <tr name=""table_tr3"" onMouseOver=""this.style.backgroundColor='efefef';"" onMouseOut=""this.style.backgroundColor='';"">" & vbcrlf & "                  <td height=""27""><div align=""left"">"
						Response.write rstxt("datejk")
						Response.write "</div></td>" & vbcrlf & "                  <td colspan=""2""><div align=""center"">"
						Response.write rstxt("trade6")
						Response.write "→"
						Response.write rstxt("trade4")
						Response.write "</div></td>" & vbcrlf & "                  <td><div align=""right"">金额："
						Response.write Formatnumber(zbcdbl(rstxt("money1")),-1,-1)
						Response.write "</div></td>" & vbcrlf & "                  <td><div align=""right"">金额："
						Response.write "</div></td>" & vbcrlf & "                  <td colspan=""2"">" & vbcrlf & "                  "
						if (open_6_14=3 or CheckPurview(intro_6_14,trim(rstxt("cateid")))=True)then
							Response.write "" & vbcrlf & "                     <a href=""javascript:void(0);"" onClick=""javascript:window.open('../pay/paydetail.asp?ord="
							Response.write rstxt("id")
							Response.write "','neww36win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')"">" & vbcrlf & "                       "
							Response.write rstxt("id")
						end if
						Response.write "" & vbcrlf & "                     <div align=""right"" class=""red"">查看此费用详情..>>></div></A></td>" & vbcrlf & "           </tr>" & vbcrlf & "             "
						rstxt.movenext
					loop
				else
					Response.write "" & vbcrlf & "             <tr>" & vbcrlf & "                    <td colspan=""6"" height=""27"" align=""center"">暂无记录！</td>" & vbcrlf & "            </tr>     " & vbcrlf & "                "
		...
		Response.write "" & vbcrlf & "    </table>" & vbcrlf & " </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "         <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>"& vbcrlf & "              </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	else
