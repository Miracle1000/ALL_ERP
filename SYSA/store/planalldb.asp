...
'bigsystemtype = ".mozi"
	...
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=36 and sort2=1"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_36_1=0
		intro_36_1=0
	else
		open_36_1=rs1("qx_open")
		intro_36_1=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=36 and sort2=14"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_36_14=0
		intro_36_14=0
	else
		open_36_14=rs1("qx_open")
		intro_36_14=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=36 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_36_2=0
		intro_36_2=0
	else
		open_36_2=rs1("qx_open")
		intro_36_2=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=36 and sort2=3"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_36_3=0
		intro_36_3=0
	else
		open_36_3=rs1("qx_open")
		intro_36_3=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=36 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_36_8=0
		intro_36_8=0
	else
		open_36_8=rs1("qx_open")
		intro_36_8=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=36 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_36_13=0
		intro_36_13=0
	else
		open_36_13=rs1("qx_open")
		intro_36_13=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=36 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_36_16=0
		intro_36_16=0
	else
		open_36_16=rs1("qx_open")
		intro_36_16=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	...
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=31 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_31_16=0
		intro_31_16=0
		...
		intro_31_16=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=31 and sort2=17"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_31_17=0
		intro_31_17=0
	else
		open_31_17=rs1("qx_open")
		intro_31_17=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=32 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_32_16=0
		intro_32_16=0
		...
		intro_32_16=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=32 and sort2=17"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_32_17=0
		intro_32_17=0
	else
		open_32_17=rs1("qx_open")
		intro_32_17=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	if open_36_1=3 then
		list=""
	elseif open_36_1=1 then
		if intro_36_1 &""="" then intro_36_1 = "0"
		list="and cateid in ("&intro_36_1&")"
	else
		list="and cateid=0"
	end if
...
'Private Sub Class_Initialize
	...
	session("setdb_rk.asp")=""
	session("setdb_ck.asp")=""
	dim a,b
	a=request("a")
	B=request("B")
	C=request("C")
...
'if a=1 then
	elseif a=2 then
		Str_Result=Str_Result+"and   complete1=2"
'elseif a=2 then
	elseif a=3 then
		Str_Result=Str_Result+"and   complete1=3"
'elseif a=3 then
	elseif a=4 then
		Str_Result=Str_Result+"and   complete1=4"
'elseif a=4 then
	elseif a=5 then
		Str_Result=Str_Result+"and   complete1=5"
'elseif a=5 then
	elseif a=6 then
		Str_Result=Str_Result+"and   complete1=6"
'elseif a=6 then
	elseif a=7 then
	end if
	if C<>"" then
...
'if B="dbzt" then
		elseif B="dbbh" then
			Str_Result=Str_Result+"and  dbbh like '%"&C&"%'"
'elseif B="dbbh" then
		elseif B="chkg" then
			Str_Result=Str_Result+"and  cateout in (select ord from gate where name like '%"&C&"%')"
'elseif B="chkg" then
		elseif B="jhkg" then
			Str_Result=Str_Result+"and  catein in (select ord from gate where name like '%"&C&"%')"
'elseif B="jhkg" then
		end if
	end if
	if m1<>"" then
...
'if m2<>"" then
	...
	if link="yes" and uid<>"" then
		Str_Result=Str_Result+" and kg="& uid
'if link="yes" and uid<>"" then
	end if
	dim helper,remind
	...
	If remind <> "" Then
		...
		str_Result1 = " and ord in (" & helper.listSQL("ids") & ")"
	...
	elseif px=3 then
		px_Result="order by dbbh desc,ord desc"
	elseif px=4 then
		px_Result="order by dbbh asc,ord asc"
	elseif px=7 then
		px_Result="order by complete1 desc,ord desc"
	elseif px=8 then
		px_Result="order by complete1 asc,ord asc"
	elseif px=9 then
		px_Result="order by date7 desc ,ord desc"
	elseif px=10 then
		px_Result="order by date7,ord asc"
	elseif px=11 then
		px_Result="order by date3 desc,ord desc"
	elseif px=12 then
		px_Result="order by date3,ord asc"
	elseif px=13 then
		px_Result="order by kumove.datein desc,ord desc"
	elseif px=14 then
		px_Result="order by kumove.datein,ord asc"
	end if
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "    margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & ".IE5 .top_btns input.anybutton{height:18px;line-height:16px;margin-bottom:-0.5px}" & vbcrlf & "</style>" & vbcrlf & "" & vbcrlf & "</head>" & vbcrlf & "<body  "
	if open_36_8=0 then
	...
	Response.write " onMouseOver=""window.status='none';return true;"">" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "<tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "      <form method=""get"" action=""planalldb.asp"" id=""demo"" onSubmit=""return Validator.Validate(this,2)"" name=""date"">" & vbcrlf & "            <tr>" & vbcrlf & "      <td class=""place"">库间调拨单</td>" & vbcrlf & "      <td>&nbsp;<a href=""#"" onClick=""Myopen_px(User);return false;"" class=""sortRule"">排序规则<img src=""../images/i10.gif"" width=""9"" height=""5"" border=""0""></a></td>" & vbcrlf & "      <td align=""right""><font id=""kh"">" & vbcrlf & "        <select name=""select2""  onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"">" & vbcrlf & "          <option>-请选择-</option>" & vbcrlf & "          <option value=""page_count=10"" "
	...
	Response.write ">每页显示200条</option>" & vbcrlf & "        </select></font>&nbsp;" & vbcrlf & "                                        </td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table> " & vbcrlf & "         <table width=""100%"" border=""0"" cellpadding=""3"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td class='top_btns' background=""../images/112.gif""  height=""30"" align=""right"" style=""border-top:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;"">"
	'Response.write "selected"
	...
	Response.write ">审批未通过</option>" & vbcrlf & "                           <option value=""3"" "
	if a=3 then
		Response.write "selected"
	end if
	Response.write ">调拨完毕</option>" & vbcrlf & "                             <option value=""4"" "
	if a=4 then
		Response.write "selected"
	end if
	Response.write ">审批已通过</option>" & vbcrlf & "                           <option value=""5"" "
	if a=5 then
		Response.write "selected"
	end if
	Response.write ">已调出，在途中</option>" & vbcrlf & "                               <option value=""7"" "
	if a=7 then
		Response.write "selected"
	end if
	Response.write ">所有调拨单</option>" & vbcrlf & "        </select>" & vbcrlf & "        <select name=""B"">" & vbcrlf & "          <option value=""dbzt"" "
	if B="dbzt" then
		Response.write "selected"
	end if
	Response.write ">调拨主题</option>" & vbcrlf & "          <option value=""dbbh"""
	if B="dbbh" then
		Response.write "selected"
	end if
	Response.write ">调拨编号</option>" & vbcrlf & "                                   <option value=""chkg"""
	if B="chkg" then
		Response.write "selected"
	end if
	Response.write ">出货库管</option>" & vbcrlf & "                                   <option value=""jhkg"""
	if B="jhkg" then
		Response.write "selected"
	end if
	Response.write ">进货库管</option>" & vbcrlf & "        </select>" & vbcrlf & "        <input name=""C"" type=""text"" size=""10""  value="""
	Response.write C
	Response.write """/>" & vbcrlf & "        <input type=""submit"" name=""Submit422"" value=""检索""  class=""anybutton""/><span   id=s1>"
	if open_36_10=1 or open_36_10=3 then
		Response.write "" & vbcrlf & "        <input type=""button"" name=""Submitdel2"" value=""EXCEL导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({from:'form_with_page_action',page:'../out/xls_db.asp?a="
		Response.write a
		Response.write "&B="
		Response.write B
		Response.write "&C="
	...
	Response.write "</span></td>" & vbcrlf & "        </tr>" & vbcrlf & "             </form>" & vbcrlf & "      </table>" & vbcrlf & "   <table width=""100%"" border=""0"" cellpadding=""5"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "     <tr class=""top"">" & vbcrlf & "    <td align=""center""><div align=""center""><strong>选择</strong></div></td>" & vbcrlf & "      <td align=""center"" height=""24""><div align=""center""><strong>调拨编号</strong></div></td>" & vbcrlf & "       <td height=""27"" ><div align=""center"">调拨主题</div></td>" & vbcrlf & "    <td ><div align=""center"">调拨状态</div></td> " & vbcrlf & "     <td width=""11%"" ><div align=""center"">出货日期</div></td>" & vbcrlf & "    <td width=""11%""><div align=""center""><strong>进货日期</strong></div></td> " & vbcrlf & "   <td width=""9%"" ><div align=""center"">出货库管</div></td>" & vbcrlf & "     <td ><div align=""center"">进货库管</div></td>  " & vbcrlf & "    <td width=""16%"" ><div align=""center""><strong>操作</strong></div></td>" & vbcrlf & "   </tr>" & vbcrlf & ""
	dim n
	n=0
	set rs=server.CreateObject("adodb.recordset")
	sql="select *,CONVERT(VARCHAR(20),datein,120) datein,CONVERT(VARCHAR(20),dateout,120) dateout,(select count(1) from kuout where order1=kumove.ord and sort1=7 and del=1) as hasout from kumove WITH(NOLOCK) "&Str_Result&"  "&px_Result&""
	...
	if rs.RecordCount<=0 then
		...
		Response.write "" & vbcrlf & "      <form name=""form1"" method=""post"" action=""deleteall.asp?ord="
		...
		do until rs.eof
			...
			hasout = rs("hasout")
			candel = True
			If hasout>0 Then candel =False
			kg=rs("kg")
			if cateout<>"" then
				set rs7=server.CreateObject("adodb.recordset")
				sql7="select name from gate where ord="&cateout&""
			...
			if catein<>"" then
				set rs7=server.CreateObject("adodb.recordset")
				sql7="select name from gate where ord="&catein&""
				rs7.open sql7,conn,1,1
				if rs7.eof then
					cateinname=""
				else
			...
			Response.write "" & vbcrlf & "     <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td width=""6%"" align=""center""><span class=""red"">" & vbcrlf & "        "
			if (open_36_3=3 or CheckPurview(intro_36_3,trim(cateid))=True) And candel = True then
				Response.write "<input name=""selectid"" type=""checkbox"" id=""selectid"" value="""
				Response.write rs("ord")
				Response.write """>"
			end if
			Response.write "" & vbcrlf & "       </span></td> " & vbcrlf & "      <td width=""10%"" align=""center"" height=""24"">"
			Response.write rs("dbbh")
			Response.write "</td>" & vbcrlf & "      <td width=""21%"" height=""27"">&nbsp;"
			if open_36_14=3 or CheckPurview(intro_36_14,trim(cateid))=True Then
				Response.write "<a href=""#"" onclick=""javascript:window.open('contentdb.asp?ord="
			...
			Response.write "" & vbcrlf & "        </td>" & vbcrlf & "                <td width=""10%"">" & vbcrlf & "          <div align=""center"">"
			if complete1=1 then
				Response.write "待审批"
			elseif complete1=2 then
				Response.write "审批未通过"
			elseif complete1=4 then
				Response.write "审批已通过"
			elseif complete1=5 then
				Response.write "已调出，在途中"
			elseif complete1=3 then
				Response.write "调拨完毕"
			end if
			Response.write "</div></td>" & vbcrlf & "         <td><div align=""center"">"
			Response.write rs("dateout")
			Response.write "</div></td>" & vbcrlf & "           <td width=""10%""><div align=""center"">"
			Response.write rs("datein")
			Response.write "</div></td>" & vbcrlf & "           <td><div align=""center"">"
			Response.write cateidname
			Response.write "</div></td>" & vbcrlf & "         <td width=""8%""><div align=""center"">"
			Response.write cateinname
			...
			if open_36_14=3 or CheckPurview(intro_36_14,trim(cateid))=True then
				Response.write "" & vbcrlf & "                              <input type=""button"" name=""Submit3"" value=""详情""  onClick=""javascript:window.open('contentdb.asp?ord="
				Response.write pwurl(rs("ord"))
				Response.write "','newwin','width=' + 980 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=50,top=50')""  />"
				Response.write pwurl(rs("ord"))
			end if
			if complete1="1" and (open_36_16=3 or CheckPurview(intro_36_16,trim(cateid))=True) and kg=session("personzbintel2007") then
				Response.write " <input type=""button"" name=""Submit33"" value=""审批""  onClick=""javascript:if(true){hwndsp=window.open('setdb_sq.asp?top="
				Response.write pwurl(rs("ord"))
				Response.write "','newwindc','width=' + 1000 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=50');}else{hwndsp.focus();}"" />"
				Response.write pwurl(rs("ord"))
			end if
			if complete1=4 and  (open_32_17=3 or CheckPurview(intro_32_17,trim(cateid))=True) and cateout=session("personzbintel2007") then
				Response.write " <input type=""button"" name=""Submit3"" value=""调出""  onClick=""javascript:if(true){hwnddc=window.open('setdb_ck.asp?top="
				Response.write pwurl(rs("ord"))
				Response.write "','newwindc','width=' + 1000 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');}else{hwnddc.focus();}""/>"
				Response.write pwurl(rs("ord"))
			end if
			if complete1=5 and  (open_31_17=3 or CheckPurview(intro_31_17,trim(cateid))=True) and catein=session("personzbintel2007") then
				Response.write " <input type=""button"" name=""Submit3"" value=""调入""  onClick=""javascript:if(true){hwnddr=window.open('setdb_rk.asp?top="
				Response.write pwurl(rs("ord"))
				Response.write "','newwindc','width=' + 1000 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100');}else{hwnddr.focus();}""/>"
				Response.write pwurl(rs("ord"))
			end if
			if (open_36_3=3 or CheckPurview(intro_36_3,trim(cateid))=True) And candel=True then
				Response.write " <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='Delete.asp?ord="
				Response.write rs("ord")
				Response.write "&CurrPage="
				Response.write CurrPage
				Response.write "&a="
		...
		if open_36_3=1 or open_36_3=3 then
		...
		Response.write "" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <script language=javascript>" & vbcrlf & "var hwndsp=null,hwnddr=null,hwnddc=null;" & vbcrlf & "         " & vbcrlf & "function test()" & vbcrlf & "{" & vbcrlf & "  if(!confirm('确认删除吗？')) return false;" & vbcrlf & "}" & vbcrlf & " " &vbcrlf & "function mm(form) " & vbcrlf & "{" & vbcrlf & "     for (var i=0;i<form.elements.length;i++)" & vbcrlf & "        {" & vbcrlf & "               var e = form.elements[i]; " & vbcrlf & "              if (e.name != 'chkall') " & vbcrlf & "                e.checked = form.chkall.checked; " & vbcrlf & "       } " & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""38"" colspan=""3""><div align=""right""><p>&nbsp;" & vbcrlf & "      </p>" & vbcrlf & "    </div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</form>                    " & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	action1="库间调拨单"
	call close_list(1)
	Response.write "   " & vbcrlf & "  </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<script language=""javascript"">" & vbcrlf & "function Myopen_px(divID){" & vbcrlf & "      if(divID.style.display==""""){" & vbcrlf & "              divID.style.display=""none""" & vbcrlf & "        }else{" & vbcrlf & "          divID.style.display=""""" & vbcrlf & "        }" & vbcrlf & "       divID.style.left=300;" & vbcrlf & "   divID.style.top=0;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & ""
	if remind<>"" then
		Response.write "" & vbcrlf & "jQuery(function(){" & vbcrlf & "   BindCancelEvents({cfgId:"
		Response.write remind
		Response.write "});" & vbcrlf & "});" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "</script>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:100%; height:400;display:none;"">" & vbcrlf & "<table width=""150"" height=""300""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""139"">" & vbcrlf & "  <table width=""150"" height=""115"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=1')""><font color=""#2F496E"">按调拨主题排序(降)</font></a></td>" & vbcrlf & "</tr>" & vbcrlf & "                <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=2')""><font color=""#2F496E"">按调拨主题排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=3')""><font color=""#2F496E"">按调拨编号排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "             <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=4')""><font color=""#2F496E"">按调拨编号排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=7')""><font color=""#2F496E"">按调拨状态排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=8')""><font color=""#2F496E"">按调拨状态排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "       <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=9')""><font color=""#2F496E"">按添加日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "     <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=10')""><font color=""#2F496E"">按添加日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=11')""><font color=""#2F496E"">按出货日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                 <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=12')""><font color=""#2F496E"">按出货日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=13')""><font color=""#2F496E"">按进货日期排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf &"            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=14')""><font color=""#2F496E"">按进货日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>"& vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & "</body>" & vbcrlf & "</html>"
