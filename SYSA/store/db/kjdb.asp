...
'Public Function AddFormValue(name,  value)
		...
		sub page_load
			...
			Response.write "'></script>" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & "      function fMove(obj){" & vbcrlf & "            if(obj.offsetWidth<197){" & vbcrlf & "                        obj.style.width = 197;" & vbcrlf & "          }" & vbcrlf & "    }" & vbcrlf & "    //判断是不是辅助数量触发的格式" & vbcrlf & "    function checkDBNname(colname, InputDBName) {" & vbcrlf & "        if (colname == InputDBName && InputDBName == ""辅助数量"") return false;" & vbcrlf & "        return true;" & vbcrlf & "    }" & vbcrlf & "    window.ZtlrSetColValue = function (div, lvw, txtbox, v) {" & vbcrlf & "        if (txtbox&&txtbox.getAttribute(""cellindex"")==8){" & vbcrlf & "            for (var i = 0; i < div.hdataArray.length; i++) {" & vbcrlf & "                var row = div.hdataArray[i]" & vbcrlf & "                if (v > 0) {" & vbcrlf & "                    var AssistUnit = row[9];" & vbcrlf & "                    var Num = v;" & vbcrlf & "      var kuId = row[29];" & vbcrlf & "                    if (kuId && AssistUnit && Num) {" & vbcrlf & "                        ajax.regEvent(""GetAssistNum"");" & vbcrlf & "                        ajax.addParam(""Num"", Num);" & vbcrlf & "                        ajax.addParam(""kuId"", kuId);" & vbcrlf & "                        var r = ajax.send();" & vbcrlf & "                        if (Number(r) == 0) {" & vbcrlf & "                            row[10] = """"" & vbcrlf & "                        } else {" & vbcrlf & "                            row[10] = Number(r).toFixed("
			Response.write app.Info.FloatNumber
			Response.write ")" & vbcrlf & "                        }" & vbcrlf & "                    }" & vbcrlf & "                } else if (row[8] == 0) {" & vbcrlf & "                    row[10] = """";" & vbcrlf & "                }" & vbcrlf & "            }" & vbcrlf & "        }" & vbcrlf & "    }" & vbcrlf & ""& vbcrlf & "</script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "html{overflow:auto;padding:0;} " & vbcrlf & "td{padding:3px;}" & vbcrlf & "</style>" & vbcrlf & "<frameset cols='197,*' border=""10"" frameSpacing=""10"" frameborder=1 style2='border:4px solid white'>" & vbcrlf & "           <frame src='addpd.asp?__msgId=ckcptreelist&musthasnum=3' frameborder=0 bordercolor=""#fefeff"" style='min-width:197px' onresizex='return fMove(this)'></frame>" & vbcrlf & "           <frame src='?__msgId=addpdPage&"
			'Response.write app.Info.FloatNumber
		...
		Sub App_addpdPage
			...
			'Response.write app.headhtml
			Response.write "" & vbcrlf & "<body style='margin-top:0px;padding-top:0px;overflow:auto;'>" & vbcrlf & "  <script type=""text/javascript"">document.body.style.paddingTop=""0px"";</script>" & vbcrlf & "       <script language=javascript src='../../Manufacture/inc/bill.js?ver="
			'Response.write app.headhtml
			Response.write Application("sys.info.jsver")
			...
			Response.write Application("sys.info.jsver")
			Response.write Application("sys.info.jsver")
			Response.write "'></script><!-- office/.net样式菜单 -->" & vbcrlf & "       <div id='head' class=""resetHeadBgImg"" style='margin:0px;padding:0px;background:url(../images/m_mpbg.gif) repeat-x'>" & vbcrlf & "               <div class=""resetTransparent"" style='float:left;background:url(../../images/content_tab.png) no-repeat;width:277px;height:32px'>" & vbcrlf & "                  <div class=""resetTransparent resetTextColor333 billTitle"" style='margin-top:12px;margin-left:60px;font-weight:bold;font-size:14px;color:#444499;letter-spacing:3px;'>库间移货</div>" & vbcrlf & "                       "
			Response.write Application("sys.info.jsver")
			action1="库间精确移货"
			...
			Response.write top
			Response.write "' id='pdID'>" & vbcrlf & "  <table class=""resetBorderColor"" style='table-layout:fixed;border:1px solid #A7BBD7;border-top:0px;width:100%'>" & vbcrlf & "    <tr>" & vbcrlf & "            <td class='billfieldleft resetBorderColor' style='width:70px;border-left:1px solid #ccc'><pre style='display:inline' maxlength=40>  调拨主题： </pre></td>" & vbcrlf & "           <td class='billfieldright'>" & vbcrlf & "                     <table>" & vbcrlf & "                 <tr>" & vbcrlf & "                            <td><input type=text class=text style='height:17px' id='MT1' value='"
			Response.write tit
			Response.write "'></td>" & vbcrlf & "                               <td>&nbsp;<span class=c_red>*</span></td>" & vbcrlf & "                               <td  id='MT1_msg'></td>" & vbcrlf & "                 </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                </td>" & vbcrlf & "           <td class='billfieldleft'  style='width:70px'><pre style='display:inline' maxlength=40>  调拨编号： </pre></td>" & vbcrlf & "          <td class='billfieldright'>" & vbcrlf & "                     <table>" & vbcrlf & "                 <tr>" & vbcrlf & "                            <td><input type=text class=text style='height:17px' value="""
			Response.write pdno
			Response.write """  id='MT2'></td>" & vbcrlf & "                          <td>&nbsp;<span class=c_red>*</span></td>" & vbcrlf & "                               <td  id='MT2_msg'></td>" & vbcrlf & "                 </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                </td>" & vbcrlf & "           <td class='billfieldleft'  style='width:70px'><pre style='display:inline'>  调拨日期： </pre></td>" & vbcrlf & "            <td class='billfieldright'>" & vbcrlf & "                     <table class=textitemtable><tr><td>" & vbcrlf & "                     <input  id='MT3' class=text style= 'border-right:0px;height:19px' type=text readonly value='"
			Response.write pdno
			Response.write pddate
			Response.write "'></td><td><button class=InselButton   value='0' onclick='Bill.showDateDlg()' style='margin-top:0'><img class=""resetElementHidden"" src='../../images/datePicker.gif'><img class=""resetElementShow"" style=""display:none;"" width=""12"" height=""14"" src='../../skin/default/images/MoZihometop/content/datePicker.png'></button></td><td>&nbsp;<span class=c_red>*</span></td><td  id='MT3_msg'></td></tr></table>" & vbcrlf & "           </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td class='billfieldleft'><pre style='display:inline'>  调拨备注： </td>" & vbcrlf & "                <td class='billfieldright' colspan=5>" & vbcrlf & "                   <textarea name=""intro""  type=""text"" id='MT4' class='text' rows=""4"" onpropertychange=""this.style.posHeight=this.scrollHeight>64?this.scrollHeight:64;"" style=""width:80%;height:64px;"">"
			Response.write HTMLDecode(bz)
			Response.write "</textarea><span id=""MT4_msg""></span>" & vbcrlf & "           </td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "            <td class='billfieldleft'><pre style='display:inline'>  调拨明细： </td>" & vbcrlf & "                <td class='billfieldright' colspan=5>" & vbcrlf & "                   <div style='width:100%;overflow-y:hidden;overflow-x:auto'>" & vbcrlf & "                     "
			Response.write HTMLDecode(bz)
			...
			lvw.pagesize = 16
			lvw.canadd = false
			lvw.sql =   "exec erp_ck_khdb_list " & top
			...
			lvw.cols.items(9).resize = true
			lvw.cols.items(9).save = 1
			isOpenAss=false
			set rs = cn.execute("select isnull(nvalue,0) from home_usConfig where name='AssistUnitTactics' ")
			if not rs.eof then isOpenAss=(rs(0)=1)
			lvw.cols.items(10).resize = true
			lvw.cols.items(10).save = 1
			lvw.cols.items(10).edit = 0
			lvw.cols.items(10).htmlvisible = isOpenAss
			isFixAss=false
			set rs1 = cn.execute("select isnull(nvalue,0) from home_usConfig where name='ConversionUnitTactics' ")
			if not rs1.eof then isFixAss = (rs1(0)=1)
			lvw.cols.items(11).dtype = "number"
			lvw.cols.items(11).save = 1
			if isFixAss then lvw.cols.items(11).edit = 0
			lvw.cols.items(11).htmlvisible = isOpenAss
			assInx=4
			lvw.cols.items(8+assInx).htmlvisible=false
'assInx=4
			lvw.cols.items(8+assInx).resize = false
'assInx=4
			lvw.cols.items(8+assInx).save = 1
'assInx=4
			lvw.cols.items(9+assInx).edit = 0
'assInx=4
			lvw.cols.items(9+assInx).save = 0
'assInx=4
			lvw.cols.items(10+assInx).htmlvisible = false
'assInx=4
			lvw.cols.items(10+assInx).resize = false
'assInx=4
			lvw.cols.items(10+assInx).save = 1
'assInx=4
			lvw.cols.items(11+assInx).edit = 1
'assInx=4
			lvw.cols.items(11+assInx).save = 1
'assInx=4
			lvw.cols.items(11+assInx).selid = 22
'assInx=4
			If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
				lvw.cols.items(11+assInx).disztlr = 1
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			else
				lvw.cols.items(11+assInx).disztlr = 0
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			end if
			lvw.cols.items(12+assInx).edit = 0
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(12+assInx).save = 1
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(13+assInx).edit = 0
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(13+assInx).save = 1
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(14+assInx).edit = 0
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(14+assInx).save = 1
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(15+assInx).edit = 0
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(15+assInx).save = 1
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(16+assInx).htmlvisible =false
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(16+assInx).resize = false
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(16+assInx).save = 1
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(17+assInx).edit = 0
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(17+assInx).save = 0
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(18+assInx).edit = 0
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			lvw.cols.items(18+assInx).save = 1
'If cn.execute("select count(1) from setjm3 where ord=5430 and  num1=1").fields(0).value = 1 then
			...
			If Not rss.eof Then
				While Not rss.eof
					...
					Case 5:
					lvw.cols.items(9).edit = 1
					lvw.cols.items(9).save = 1
					lvw.cols.items(9).ywname = title
					dbnumName=title
					Case 6:
					If  set_open<>1 Then
						lvw.cols.items(19+assInx).htmlvisible = false
'If  set_open<>1 Then
						lvw.cols.items(19+assInx).resize = False
'If  set_open<>1 Then
						lvw.cols.items(19+assInx).disztlr=1
'If  set_open<>1 Then
					else
						lvw.cols.items(19+assInx).disztlr=0
'If  set_open<>1 Then
					end if
					lvw.cols.items(19+assInx).edit = 1
'If  set_open<>1 Then
					lvw.cols.items(19+assInx).save = 1
'If  set_open<>1 Then
					lvw.cols.items(19+assInx).ywname = title
'If  set_open<>1 Then
					Case 7:
					If  set_open<>1 Then
						lvw.cols.items(20+assInx).htmlvisible = false
'If  set_open<>1 Then
						lvw.cols.items(20+assInx).resize = False
'If  set_open<>1 Then
						lvw.cols.items(20+assInx).disztlr=1
'If  set_open<>1 Then
					else
						lvw.cols.items(20+assInx).disztlr=0
'If  set_open<>1 Then
					end if
					lvw.cols.items(20+assInx).edit = 1
'If  set_open<>1 Then
					lvw.cols.items(20+assInx).save = 1
'If  set_open<>1 Then
					lvw.cols.items(20+assInx).ywname = title
'If  set_open<>1 Then
					Case 8:
					If  set_open<>1 Then
						lvw.cols.items(21+assInx).htmlvisible = false
'If  set_open<>1 Then
						lvw.cols.items(21+assInx).resize = False
'If  set_open<>1 Then
						lvw.cols.items(21+assInx).disztlr=1
'If  set_open<>1 Then
					else
						lvw.cols.items(21+assInx).disztlr=0
'If  set_open<>1 Then
					end if
					lvw.cols.items(21+assInx).edit = 1
'If  set_open<>1 Then
					lvw.cols.items(21+assInx).save = 1
'If  set_open<>1 Then
					lvw.cols.items(21+assInx).ywname = title
'If  set_open<>1 Then
					Case 9:
					If  set_open<>1 Then
						lvw.cols.items(22+assInx).htmlvisible = false
'If  set_open<>1 Then
						lvw.cols.items(22+assInx).resize = False
'If  set_open<>1 Then
						lvw.cols.items(22+assInx).disztlr=1
'If  set_open<>1 Then
					else
						lvw.cols.items(22+assInx).disztlr=0
'If  set_open<>1 Then
					end if
					lvw.cols.items(22+assInx).edit = 1
'If  set_open<>1 Then
					lvw.cols.items(22+assInx).save = 1
'If  set_open<>1 Then
					lvw.cols.items(22+assInx).ywname = title
'If  set_open<>1 Then
					Case 10:
					If  set_open<>1 Then
						lvw.cols.items(23+assInx).htmlvisible = false
'If  set_open<>1 Then
						lvw.cols.items(23+assInx).resize = False
'If  set_open<>1 Then
						lvw.cols.items(23+assInx).disztlr=1
'If  set_open<>1 Then
					else
						lvw.cols.items(23+assInx).disztlr=0
'If  set_open<>1 Then
					end if
					lvw.cols.items(23+assInx).edit = 1
'If  set_open<>1 Then
					lvw.cols.items(23+assInx).save = 1
'If  set_open<>1 Then
					lvw.cols.items(23+assInx).ywname = title
'If  set_open<>1 Then
					Case 11 :
					If  set_open<>1 Then
						lvw.cols.items(24+assInx).htmlvisible = false
'If  set_open<>1 Then
						lvw.cols.items(24+assInx).resize = False
'If  set_open<>1 Then
						lvw.cols.items(24+assInx).disztlr=1
'If  set_open<>1 Then
					else
						lvw.cols.items(24+assInx).disztlr=0
'If  set_open<>1 Then
					end if
					lvw.cols.items(24+assInx).selid = 1062
'If  set_open<>1 Then
					lvw.cols.items(24+assInx).edit = 1
'If  set_open<>1 Then
					lvw.cols.items(24+assInx).save = 1
'If  set_open<>1 Then
					lvw.cols.items(24+assInx).ywname = title
'If  set_open<>1 Then
					Case 12 :
					If set_open<>1 Then
						lvw.cols.items(25+assInx).htmlvisible = false
'If set_open<>1 Then
						lvw.cols.items(25+assInx).resize = False
'If set_open<>1 Then
						lvw.cols.items(25+assInx).disztlr=1
'If set_open<>1 Then
					else
						lvw.cols.items(25+assInx).disztlr=0
'If set_open<>1 Then
					end if
					lvw.cols.items(25+assInx).selid = 1063
'If set_open<>1 Then
					lvw.cols.items(25+assInx).edit = 1
'If set_open<>1 Then
					lvw.cols.items(25+assInx).save = 1
'If set_open<>1 Then
					lvw.cols.items(25+assInx).ywname = title
'If set_open<>1 Then
					End Select
					rss.movenext
				wend
			...
			rss.close
			lvw.cols.items(26+assInx).htmlvisible = false
'rss.close
			lvw.cols.items(26+assInx).resize = false
'rss.close
			lvw.cols.items(26+assInx).edit = 0
'rss.close
			lvw.cols.items(26+assInx).save = 1
'rss.close
			lvw.cols.items(27+assInx).edit = 0
'rss.close
			lvw.cols.items(27+assInx).save = 0
'rss.close
			lvw.candr = not cn.execute("select 1 from [power] where sort1 = 36 and sort2 = 20 and ord = " & app.info.user & " and qx_open =1").eof
			lvw.formula = "if(〖"&dbnumName&"〗*1<0){【"&dbnumName&"】=(0)};if(〖辅助数量〗*1<0){【辅助数量】=(0)};if(〖现有库存〗-〖"&dbnumName&"〗< 0){【"&dbnumName&"】=(〖现有库存〗)}"
			Response.write lvw.innerHTML
			Response.write "<br>" & vbcrlf & "                 </div>" & vbcrlf & "          </td>" & vbcrlf & "   </tr>" & vbcrlf & "   </table>" & vbcrlf & "        <table style='table-layout:fixed;width:100%'>" & vbcrlf & "   <tr>" & vbcrlf & "            <td class=""resetTransparent"" style='background-image:url(../../images/tb_top_td_bg.gif);height:40px;line-height:40px;background-repeat:repeat-x'>" & vbcrlf & "             <div><div style='padding:3px;color:#666666'>（注意：当同一产品分多批次入同一仓库时，如无序列号等信息区分，调拨时根据产品，会匹配出<B>多行相同信息</b>， 若无法精确区分，建议使用【库间汇总移货】功能。）</div></div>" & vbcrlf & "                    <table align=center style='width:100%;text-align:center;'>" & vbcrlf & "                      <tr>" & vbcrlf & "                                <td>" & vbcrlf & "                            <button class=button onclick='savedb(1)'>确认调拨</button></td>" & vbcrlf & "                 </tr>" & vbcrlf & "                   </table>" & vbcrlf & "                </td>" & vbcrlf & "   </tr>" & vbcrlf & "   </table>" & vbcrlf & "        <script language=javascript src='../../Manufacture/inc/dateCalender.js?ver="
			Response.write Application("sys.info.jsver")
			Response.write "'></script><!-- 日期选择组件 -->" & vbcrlf & "    <script language=javascript src='../../inc/UrlEncode.js?ver="
			'Response.write Application("sys.info.jsver")
			Response.write Application("sys.info.jsver")
			Response.write "'></script>" & vbcrlf & "  <script language=javascript>" & vbcrlf & "            ListViewInit();" & vbcrlf & "         function savedb(){" & vbcrlf & "                      var $editor = jQuery('.ctllvwCurrInput');" & vbcrlf & "                       if ($editor.size()>0){" & vbcrlf & "                          if($editor.val().length>200){" & vbcrlf & "                                   $editor[0].select();" & vbcrlf & "                                    alert('字段长度不能超过200！');" & vbcrlf & "                                 return;" & vbcrlf & "                         }" & vbcrlf & "                       }" & vbcrlf & "" & vbcrlf & "                       //Task.1213.KILLER.2013.12.16 调拨保存提示顺序需要调整 ,输入无效仓库提示" & vbcrlf & "                        var dat = UrlEncode(lvw.GetSaveDetailData(document.getElementById('listview_pdlist'))); " & vbcrlf & "                        var rows = dat.split(""#or"");" & vbcrlf & "                      var str = '';" & vbcrlf & "                   var ii = 0;" & vbcrlf & "                     for (i=0;i<rows.length ;i++ )" & vbcrlf & "                   {" & vbcrlf & "                               rows[i] = rows[i].split(""#oc"");" & vbcrlf & "                if (rows[i][5 +"
			'Response.write Application("sys.info.jsver")
			Response.write  assInx
			Response.write "] == 0 || rows[i][5 +"
			'Response.write  assInx
			Response.write  assInx
			Response.write "] == 'invalid')" & vbcrlf & "                              {                               " & vbcrlf & "                                        if(ii>10) {str = str + '…………\r\n';break;}" & vbcrlf & "                                   ii = ii + 1;" & vbcrlf & "                                    str = str + '第'+(i+1)+'行，请选择正确的入库仓库。\r\n'" & vbcrlf & "                         }       " & vbcrlf & "                                if(rows[i][4]<= 0)" & vbcrlf & "                              {                                                         " & vbcrlf & "                                 str = str + '第'+(i+1)+'行，请输入正确的调拨数量。\r\n'" & vbcrlf & "                            }               " & vbcrlf & "                        }" & vbcrlf & "                       " & vbcrlf & "                        if(str.length > 0 )" & vbcrlf & "                     {" & vbcrlf & "                               alert(str);" & vbcrlf & "                             return false;" & vbcrlf & "                   }" & vbcrlf & "" & vbcrlf & "                       if (!window.confirm(""确定要调拨吗，该操作将立即生效？"")) { return false } "& vbcrlf &          "   if (!window.ajaxbaseurl) { window.ajaxbaseurl = ajax.url; }" & vbcrlf &             "ajax.url = window.ajaxbaseurl.split(""/SYSA/"")[0] + ""/SYSN/view/store/kumove/kjdb.save.ashx"";" & vbcrlf &                   " ajax.regEvent("""");" & vbcrlf &                        " for(var i=1;i<5;i++){" & vbcrlf & "                          if(i<4){document.getElementById(""MT"" + i + ""_msg"").innerHTML = """"}" & vbcrlf & "                            ajax.addParam(""MT"" + i,document.getElementById(""MT"" + i).value)" & vbcrlf & "                     }" & vbcrlf & "                       ajax.addParam(""dat"",dat);" & vbcrlf & "                 ajax.addParam(""ID"","
			'Response.write  assInx
			Response.write top
			Response.write ");" & vbcrlf & "                   ajax.exec();" & vbcrlf & "                    ajax.url = window.ajaxbaseurl;" & vbcrlf & "          }" & vbcrlf & "" & vbcrlf & "               window.top.TreeDataSelect = function(dat,dr)" & vbcrlf & "            {" & vbcrlf & "                       var dats = dat.join(""$"")" & vbcrlf & "                  ajax.regEvent(""addChild"");" & vbcrlf & "                        ajax.addParam(""datArray"",dats);" & vbcrlf & "                  ajax.addParam(""hasKuArray"",GetHasKuIdArray());" & vbcrlf & "                    ajax.addParam(""dr"",dr ? 1 : 0);" & vbcrlf & "                   ajax.send(getnewlist)" & vbcrlf & "                   ajax.showprocc();" & vbcrlf & "               }" & vbcrlf & "" & vbcrlf & "               window.lvwCellValue = function(v){" & vbcrlf & "                       v = v.split(lvw.sBoxSpr)" & vbcrlf & "                        if(v.length==2){" & vbcrlf & "                                return v[1].length>0 ? v[1] : v[0]" & vbcrlf & "                      }" & vbcrlf & "                       else{" & vbcrlf & "                           return v[0];" & vbcrlf & "                    }" & vbcrlf & "               }" & vbcrlf & "" & vbcrlf & "               window.isRepeat = function(div,cells){ //判断是否充分" & vbcrlf & "                        for(var i=0;i<div.hdataArray.length;i++){" & vbcrlf & "                               var row = div.hdataArray[i]" & vbcrlf & "                             var ku = row[row.length-1] //ku" & vbcrlf & "" & vbcrlf & "                         var ok1 = (cells[cells.length-1] == lvwCellValue(ku));" & vbcrlf & "                          if(ok1 == true){" & vbcrlf & "                                        return i;" & vbcrlf & "                              }" & vbcrlf & "                       }" & vbcrlf & "                       return -1;" & vbcrlf & "              }" & vbcrlf & "        function GetHasKuIdArray() {" & vbcrlf & "                   var r = """"" & vbcrlf & "                        var div = document.getElementById('listview_pdlist')" & vbcrlf & "                    for(var i=0;i<div.hdataArray.length;i++){" & vbcrlf & "                            var row = div.hdataArray[i]" & vbcrlf & "                var hsEdit = row.toString()" & vbcrlf & "                var choseKu = 0;" & vbcrlf & "                if (row[14]!="""") { choseKu = 1 }" & vbcrlf & "                r = r + "","" + row[row.length - 2 - choseKu].replace(lvw.sBoxSpr,"""") //增加动态列后，倒数第2列是库字段" & vbcrlf & "                        }" & vbcrlf & "                       return r" & vbcrlf & "                }" & vbcrlf & "" & vbcrlf & "               window.getnewlist = function(r){" & vbcrlf & "                        var rowIndex = 0" & vbcrlf & "                        var hsCount = 0 , addCount = 0" & vbcrlf & "                  var div = document.getElementById('listview_pdlist');" & vbcrlf & "                        var rows = r.split(""$="")" & vbcrlf & "                  for(var i = 0 ; i < rows.length ; i++){" & vbcrlf & "                         if(rows[i].length>1){" & vbcrlf & "                                   var cells = rows[i].split(""|-"")" & vbcrlf & "                                   cells.splice(cells.length-1,1)" & vbcrlf & "" & vbcrlf & "                                  //var rpt = isRepeat(div,cells)"& vbcrlf &                               "      //if(rpt>=0)" & vbcrlf &                             "        //{ "& vbcrlf &                                    "  //      hsCount = hsCount + 1" & vbcrlf &""& vbcrlf &                                  "  //}" & vbcrlf &                              "        //else{ "& vbcrlf &                                       "   addCount = addCount + 1 "& vbcrlf &                                          "div.hdataArray[div.hdataArray.length] = (""+%;$++%;$+"" + cells.join(""+%;$+"")).split(""+%;$""+"""") //lvw.addDataRow(div,cells);" & vbcrlf & "                                 //}" & vbcrlf & "                             }" & vbcrlf & "                       }" & vbcrlf & "                       div.PageStartIndex = div.hdataArray.length - div.getAttribute(""PageSize"") + 1" & vbcrlf & "                     div.PageStartIndex = div.PageStartIndex > 0 ? div.PageStartIndex : 1" & vbcrlf &" div.PageEndIndex = div.hdataArray.length "& vbcrlf &                     "    lvw.UpdateScrollBar(div);" & vbcrlf &                     "  lvw.Refresh(div)" & vbcrlf &                    "     if(hsCount > 0){" & vbcrlf &                              "   alert(""有"" + hsCount + ""条记录已经存在，没有重复添加。"")" & vbcrlf &                   "  } "& vbcrlf &            "    }" & vbcrlf &""& vbcrlf &              "  window.lvwoldfocus =lvw.editfocus" & vbcrlf & "               lvw_editfocus = function(CurrTd){" & vbcrlf & "                       if(!CurrTd){return false}" & vbcrlf & "                       var cellBody = CurrTd" & vbcrlf & "                   if (CurrTd.className.length==0){return false}" & vbcrlf & "" & vbcrlf & "                   if(CurrTd.className!=""full""){" & vbcrlf & "                             if(CurrTd.children.length==0){return false;}" & vbcrlf & "                                if(CurrTd.children[0].tagName!=""TABLE""){return false;}" & vbcrlf & "                            var cellBody = CurrTd.children[0].rows[0].cells[0];" & vbcrlf & "                     }" & vbcrlf & "                       var td = cellBody.parentElement.parentElement.parentElement.parentElement;" & vbcrlf & "                      if(td.cellIndex == 6){  // 表示是调拨数量编辑格子" & vbcrlf & "                              var tr = td.parentElement;" & vbcrlf & "                              var hdIndex = lvw.getDataRowIndexByTR(tr);" & vbcrlf & "                              //lvw.hdataArray[hdIndex]" & vbcrlf & "                               return false;" & vbcrlf & "                   }" & vbcrlf & "                       var tr = td.parentElement;" & vbcrlf & "                      var tb = tr.parentElement.parentElement;" & vbcrlf & "                     if(tb.currFocusInput){" & vbcrlf & "                          var oldtd = tb.currFocusInput.td;" & vbcrlf & "                               if(oldtd.cellIndex == 6){ //库存数量改变" & vbcrlf & "                                        var oldRow = oldtd.parentElement;" & vbcrlf & "                                       var hdIndex = lvw.getDataRowIndexByTR(oldRow);" & vbcrlf& "" & vbcrlf & "                               }" & vbcrlf & "                       }" & vbcrlf & "                       return window.lvwoldfocus(CurrTd);" & vbcrlf & "              }" & vbcrlf & "               window.formulCallBack = lvw.formulaApply" & vbcrlf & "                lvw.formulaApply = function(tb,tr){" & vbcrlf & "                     window.formulCallBack(tb,tr);" & vbcrlf & "                   var currKUID = tr.cells[tr.cells.length-2].innerText" & vbcrlf & "                     //alert(window.event.keyCode)" & vbcrlf & "                   //alert(currKUID)" & vbcrlf & "               }" & vbcrlf & "" & vbcrlf & "               function HideButton(){" & vbcrlf & "                  if(!document.getElementById(""listtoolbar_pdlist""))return;" & vbcrlf & "                 var buttons = document.getElementById(""listtoolbar_pdlist"").getElementsByTagName(""button"")" & vbcrlf & "                 for(var i = 0 ; i < buttons.length ; i ++){" & vbcrlf & "                             if(buttons[i].title==""导出表格(Excel)"" || buttons[i].title==""统计图示""){" & vbcrlf & "                                    buttons[i].style.display = ""none""" & vbcrlf & "                         }" & vbcrlf & "}" & vbcrlf & "               }" & vbcrlf & "               HideButton();" & vbcrlf & "" & vbcrlf & "           lvw.ontoolbarclick = function(key,c){" & vbcrlf & "                   " & vbcrlf & "        }" & vbcrlf & "" & vbcrlf & "        lvw.onformulaApply = function (div, input) {" & vbcrlf & "            if (window.InputDBName != ""申请数量"") {"& vbcrlf &                " return false" & vbcrlf &          "  }; "& vbcrlf &            " var rowIndex = input.tr.firstChild.innerText; "& vbcrlf &           "  var row = div.hdataArray[rowIndex - 1] "& vbcrlf &            " if (row[10] > 0) {" & vbcrlf &                 "var pord = row[3];" &vbcrlf & "                var unit = row[7];" & vbcrlf & "                var AssistUnit = row[11];" & vbcrlf & "                var Num = row[10];" & vbcrlf & "                var kuId = row[31];" & vbcrlf & "                if (pord && unit && AssistUnit && Num) {" & vbcrlf & "                   ajax.regEvent(""GetAssistNum"");" & vbcrlf & "                    ajax.addParam(""pord"", pord);" & vbcrlf & "                    ajax.addParam(""unit"", unit);" & vbcrlf & "                    ajax.addParam(""AssistUnit"", AssistUnit);" & vbcrlf & "                    ajax.addParam(""Num"", Num);"& vbcrlf & "                    ajax.addParam(""kuId"", kuId);" & vbcrlf & "                    var r = ajax.send();" & vbcrlf & "                    if (Number(r) == 0) {" & vbcrlf & "                        lvw.updateDataCell(input.tr.cells[12],"""");" & vbcrlf & "                        lvw.setCellValue(input.tr.cells[12],"""");" & vbcrlf & "                    } else {" & vbcrlf & "                        lvw.updateDataCell(input.tr.cells[12], Number(r).toFixed("
			Response.write app.Info.FloatNumber
			Response.write "));" & vbcrlf & "                        lvw.setCellValue(input.tr.cells[12], Number(r).toFixed("
			'Response.write app.Info.FloatNumber
			Response.write "));" & vbcrlf & "                    }" & vbcrlf & "                }" & vbcrlf & "            } else if (row[10]==0) {" & vbcrlf & "                lvw.setCellValue(input.tr.cells[12], """");" & vbcrlf & "            }" & vbcrlf & "            lvw.updateColSum(div, lvw.cellIndex(input.tr.cells[12]));" & vbcrlf & "            //div.hdataArray[rowIndex - 1][12] = r" & vbcrlf & "            //lvw.formulaApply(div.children[0], input.tr)" & vbcrlf & "        }" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "                jQuery(function(){" & vbcrlf & "                      var remark = document.getElementById(""MT4"");" & vbcrlf & "                      remark.posHeight=remark.scrollHeight>34?remark.scrollHeight:34;" & vbcrlf & "         });" & vbcrlf & "             //document.getElementById(""MT4"").fireEvent(""onpropertychange"")" & vbcrlf & "              $(document.getElementById(""MT4"")).trigger(""change"");" & vbcrlf & "    </script>" & vbcrlf & "</body>" & vbcrlf & ""
		end sub
		...
		sub App_Save
			app.alert "过程已迁移至：SYSN\view\store\kumove\kjdb.save.ashx，此页面已失效"
		end sub
		sub App_addChild
			isOpenAss=false
			set rs = cn.execute("select isnull(nvalue,0) from home_usConfig where name='AssistUnitTactics' ")
			...
			cn.execute("select IDENTITY(int,1,1) as d_sort, 10000 as cpID , 10000 as ckID,cast(null as int) as d_unit, cast(null as int) as d_attr1, cast(null as int) as d_attr2,cast(null as float) as d_num,"&_
			" cast(null as int) as d_rkid,cast(null as varchar(100)) as d_ph,cast(null as varchar(100)) as d_xlh,cast(null as varchar(100)) as d_scrq,cast(null as varchar(100)) as d_yxrq,cast(null as varchar(100)) as d_bz,cast(null as varchar(100)) as d_js,"&_
			" cast('' as ntext) as d_remark,cast(null as int) as d_AssistUnit, cast(null as float) as d_AssistNum,"&_
			" cast(null as varchar(50)) as zdy1,cast(null as varchar(50)) as zdy2,cast(null as varchar(50)) as zdy3,cast(null as varchar(50)) as zdy4,cast(null as int) as zdy5,cast(null as int) as zdy6 into #ttt;delete from #ttt;"&_
			" select 10000 as kuid into #ttt2;delete from #ttt2")
			set rs = server.CreateObject("adodb.recordset")
			dats = split(dat,"$")
			rs.open "select cpID,ckID,d_unit,d_attr1,d_attr2,d_num,d_rkid,d_ph,d_xlh,d_scrq,d_yxrq,d_bz,d_js,d_remark,d_AssistUnit,d_AssistNum,zdy1,zdy2,zdy3,zdy4,zdy5,zdy6 from #ttt" , cn , 1 ,3
...
'rs.fields(6).value = cell(6)
					rs.fields(8).value = replace(replace(cell(8),"#-x01","|"),"#-x02","$")
'rs.fields(6).value = cell(6)
					rs.fields(9).value = cell(9)
					rs.fields(10).value = cell(10)
					rs.fields(11).value = replace(replace(cell(11),"#-x01","|"),"#-x02","$")
'rs.fields(10).value = cell(10)
					rs.fields(12).value = cell(12)
					rs.fields(13).value = replace(replace(cell(13),"#-x01","|"),"#-x02","$")
'rs.fields(12).value = cell(12)
					if isOpenAss then
						if cell(14)&""<>"" then
							rs.fields(14).value = cell(14)
						end if
						if cell(15)&""<>"" then
							rs.fields(15).value = cell(15)
						end if
					end if
					On Error Resume Next
					m=0
					...
					do until rss.eof
						if rss("set_open")=1 then
							rs.fields(16+m).value = replace(replace(cell(12+assInx+n),"#-x01","|"),"#-x02","$")
'if rss("set_open")=1 then
							n=n+1
'if rss("set_open")=1 then
						end if
...
'if rss("set_open")=1 then
					...
					Loop
					rss.MoveFirst
				elseif ubound(cell)>1 then
					rs.fields(8).value = cell(2)
				end if
				rs.update
			next
			rss.Close
			...
			next
			rs.close
			sql =       "exec erp_ck_kjdb_list " & app.info.user & "," & dr
			set rs = cn.execute(sql)
			assInx=4
			Dim sValue
			if rs.State=1 then
...
'while rs.eof=false
						...
						If i=8 or (i=10 and not sValue&"" ="") Or i= rs.fields.count-1 Then
							sValue=rs.fields(i).value
							sValue = FormatNumber(sValue,app.Info.FloatNumber,-1,0,0)
'sValue=rs.fields(i).value
						ElseIf i+assInx=9 Then
							sValue=rs.fields(i).value
...
'sValue=rs.fields(i).value
		...
		sub App_ListDrConfig(drdat)
			...
			rs.close
			dim mFilePath
			mFilePath = "../../in/jqdb2.xls"
			if isOpenAss then
				mFilePath = "../../in/jqdb1.xls"
				if isOpenProductAttr then mFilePath = "../../in/jqdb3.xls"
			else
				if isOpenProductAttr then mFilePath = "../../in/jqdb4.xls"
			end if
			drdat.smpFilePath = mFilePath
			drdat.helpFilePath = "../../in/jqdb.doc"
			drdat.remark = "请参考示例excel文件，确保导入的文件格式符合要求。"
			drdat.autosave = true
			drdat.allowSize = 25*1024*1024
			drdat.modelCls = "调拨信息"
		...
		Sub app_GetAssistNum
			...
			kuId = request.form("kuId")
			set rs = cn.execute("select ku.AssistNum/ku.num3*"&Num&" from ku where id ='"&kuId&"'")
			if not rs.eof then resultNum=rs(0)
		...
		sub App_lvw_InExcel
			...
			while rs.eof = false
				...
				zdystr=zdystr&"+'|'+ convertchars(cells["&i+12+assInx&"])"
'zdyfields(i) = rs.fields("name").value
				i = i + 1
'zdyfields(i) = rs.fields("name").value
				rs.movenext
			...
			db  = uploader.dbname
			if not uploader.CheckFields("产品名称,产品编号,产品型号,产品单位,调拨数量,出库仓库,入库仓库,批号,序列号,生产日期,有效日期,包装,件数,备注"&zdys) then
				exit sub
			end if
...
'cn.execute "delete from " & db & " where  产品型号<>'#s_rkck_tok'" , n1
			cn.execute "insert into #k_fail (行号,失败原因) select up_index, '调拨数量不是数字' from " & db & " where isnumeric(isnull(调拨数量,'xx')) = 0 "
...
'cn.execute "delete from " & db & " where cast(调拨数量 as float) < 0" , n1
			...
			cn.execute "update " & db & " set 包装 = case isnull(包装,'') when '' then 0 else u.ord end, 产品型号='bzok' from sortonehy u where (u.gate2=82 and u.sort1 = 包装) or isnull(包装,'')='' "
			cn.execute "insert into #k_fail (行号,失败原因) select up_index, '包装错误' from " & db & " where 产品型号<>'bzok'"
			cn.execute "delete from " & db & "  where 产品型号<>'bzok'" , n
			cn.execute "insert into #k_all (内容,说明) values ('检测包装数据','" & app.iif(n > 0 ,"共<b style=""color:red"">" & (n) & "</b>条记录包装不正确。","") & "')"
			cn.execute "insert into #k_fail (行号,失败原因) select up_index, '生产日期不正确' from " & db & " where isdate(生产日期)=0 and isnull(生产日期,'')<>''"
			cn.execute "delete from " & db & "  where  isdate(生产日期)=0 and isnull(生产日期,'')<>''" , n
			cn.execute "insert into #k_fail (行号,失败原因) select up_index, '有效日期不正确' from " & db & " where isdate(有效日期)=0 and isnull(有效日期,'')<>''"
...
'cn.execute "delete from " & db & "  where  isdate(有效日期)=0 and isnull(有效日期,'')<>''" , n1
			...
			dim sql
			sql=sql & "insert into #k_fail (行号,失败原因)  select up_index , '库存不足' as x "&_
			" from " & db &_
			" where up_index not in ("&_
			"   select distinct e.up_index " & vbcrlf
			sql=sql & "from " & db & " e " & vbcrlf
			sql=sql & "inner join ku a on a.ord = e.产品名称 and e.出库仓库 = a.ck " & vbcrlf
			sql=sql & "                        and isnull(e.包装,'0')=isnull(a.bz,'0')" & vbcrlf
			sql=sql & "                        and cast(isnull(cast(e.件数 as varchar(25)),'1') as money) = cast(isnull(cast(a.js as varchar(25)),'1') as money)" & vbcrlf
			sql=sql & "                        and (isnull(e.有效日期,'')=isnull(a.dateyx,'') or (isdate(e.有效日期) =1 and isdate(a.dateyx) =1 and datediff(s,e.有效日期,a.dateyx)=0))" & vbcrlf
			sql=sql & "                        and (isnull(e.生产日期,'')=isnull(a.datesc,'') or (isdate(e.生产日期) =1 and isdate(a.datesc) =1 and datediff(s,e.生产日期,a.datesc)=0))" & vbcrlf
			sql=sql & "                        and (isnull(e.批号,'')=isnull(a.ph,''))" & vbcrlf
			sql=sql & "                        and (isnull(e.序列号,'')=isnull(a.xlh,'')) "& attrText3 & vbcrlf
			sql=sql & "inner join product b on b.del=1 and  e.产品名称 = b.ord " & vbcrlf
			sql=sql & "inner join sortck d on d.ord=e.出库仓库 " & vbcrlf
			sql=sql & "where isnull(a.num2,0) >= e.调拨数量 ) "
			cn.execute  sql, n
			cn.execute "delete  from " & db & "  where up_index  in (select 行号 from #k_fail where 失败原因='库存不足' or 失败原因='没有库存')" & vbcrlf & _
			"update #k_fail set 失败原因='库存不足(请确认包装、件数、有效日期、生产日期、批号、序列号是否匹配)' where 失败原因='库存不足'"
			cn.execute "insert into #k_all (内容,说明) values ('检测库存','" & app.iif(n > 0 ,"共<b style=""color:red"">" & (n) & "</b>条记录没有库存或库存不足。","") & "')"
			cn.execute "select x.up_index into #overlist "&_
			"from "&db&" x "&_
			"left join "&db&" y on cast(x.产品名称 as nvarchar(500)) = cast(y.产品名称 as nvarchar(500)) "&_
			"                       and isnull(cast(x.包装 as nvarchar(500)),'') = isnull(cast(y.包装 as nvarchar(500)),'') "&_
			"                       and isnull(cast(x.件数 as nvarchar(500)),'') = isnull(cast(y.件数 as nvarchar(500)),'') "&_
			"                       and isnull(cast(x.有效日期 as nvarchar(500)),'') = isnull(cast(y.有效日期 as nvarchar(500)),'') "&_
			"                       and isnull(cast(x.生产日期 as nvarchar(500)),'') = isnull(cast(y.生产日期 as nvarchar(500)),'') "&_
			"                       and isnull(cast(x.批号 as nvarchar(500)),'') = isnull(cast(y.批号 as nvarchar(500)),'') "&_
			"                       and isnull(cast(x.序列号 as nvarchar(500)),'') = isnull(cast(y.序列号 as nvarchar(500)),'') "&_
			...
			"where  y.up_index>0 "
			cn.execute "insert into #k_fail (行号,失败原因)  select up_index , '产品信息与出库仓库重复，无法精确匹配库存' as x from #overlist group by up_index "
			cn.execute "delete   from " & db & " where up_index in (select 行号 from  #k_fail where 失败原因='产品信息与出库仓库重复，无法精确匹配库存'  )",  n
			cn.execute "insert into #k_all (内容,说明) values ('产品信息与出库仓库重复','" & app.iif(n > 0 ,"共<b style=""color:red"">" & (n) & "</b>条记录产品信息与出库仓库重复。","") & "')"
...
'cn.execute "drop table #overlist "
			...
			set rs = cn.execute("select 产品名称,产品单位,"& showfields &"调拨数量,辅助单位,辅助数量,出库仓库,入库仓库,批号,序列号,生产日期,有效日期,包装,isnull(件数,'') as 件数,备注 "&zdys&" from " & db)
			while not rs.eof
				for i = 0 to rs.fields.count -1
'while not rs.eof
			...
			rs.close
			Response.write " </div>"
			Response.write "" & vbcrlf & "     <script language=javascript>" & vbcrlf & "            function convertchars(c){" & vbcrlf & "                       return c.replace(""|"",""#-x01"").replace(""$"",""#-x02"");" & vbcrlf & "             }" & vbcrlf & "               function cdata()" & vbcrlf & "                {" & vbcrlf & "                       var div =  window.parent.parent.lvwexceldrdiv;" & vbcrlf & "                  var lvw =  window.parent.parent.lvw;" & vbcrlf & "                    if(!div){alert(""无法找到相关联的列表"");return;}" & vbcrlf & "                   lvw.clear(div);" & vbcrlf & "                 var rows = document.getElementById(""data_"
			Response.write db
			Response.write """).innerHTML.split(""$~#"")" & vbcrlf & "                   var dat = new Array();" & vbcrlf & "                  for(var i=0; i< rows.length;i++){" & vbcrlf & "                               if(rows[i].length>0)" & vbcrlf & "                            {" & vbcrlf & "                                       var cells = rows[i].split(""^*#"")" & vbcrlf & "                                  dat[dat.length] = cells[0] + ""|"" + cells[3] + ""|"" + cells[1] + ""|"" + cells[2] + ""|"" + cells[4] + ""|"" +" & vbcrlf &                                                    "  convertchars(cells[5]) + ""|"" + convertchars(cells[6]) + ""|"" + cells[7] + ""|"" + cells[8] + ""|"" + convertchars(cells[9]) + ""|"" +" & vbcrlf &                                                   "  cells[10] + ""|"" + convertchars(cells[11])"
			'Response.write db
