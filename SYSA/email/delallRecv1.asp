...
'elseif G1=6 then
	...
	DelAllAttach("select Access_url from email_recv_Access  where del=1 and mailType=2 and email_ord in( select ord from email_recv_list where 1=1 "&Str_Result2&" "&str_sql_checkid&")")
	conn.Execute("delete  email_recv_Access  where  del=1 and mailType=2 and email_ord in( select ord from email_recv_list where 1=1 "&Str_Result2&" "&str_sql_checkid&")")
	conn.Execute("delete  email_recv_list where del=2 "&Str_Result2&" "&str_sql_checkid&"")
	action1="邮件删除全部清空"
	call close_list(2)
	Response.redirect "recvDelList.asp?page_count="&page_count&"&currPage="& currpage&"&A2="&A2&"&A1="&A1&"&person="&personid&"&company="&companyid&"&S1="&S1&"&S2="&S2&"&G1="&G1&"&G2="&G2&"&D="&D&"&q="&q&"&F1="&F1&"&F2="&F2&"&E="&E&"&F="&F&"&C1="&C1&"&C2="&C2&"&W1="&W1&"&W2="&W2&"&W3="&W3&"&P1="&P1&"&P2="&P2&"&J1="&J1&"&J2="&J2&"&ret="&m1&"&ret2="&m2&""
