...
'bigsystemtype = ".mozi"
	...
	rs.close
	Response.write "" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & " <td valign=""top""><div align=""right"">操作人员：</div></td><td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "<td><div align=""right"">产品系列：</div></td><td>"
	execute sdk.vbs("../manager/search_product.asp")
	Response.write "</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & " <td><div align=""right"">操作日期：</div></td><td>" & vbcrlf & "         &nbsp;自：<INPUT readonly=""true"" name=ret3 size=9  id=daysOfMonthPos1 onmouseup=""toggleDatePicker('daysOfMonth1','date.ret3')"" value="""
	Response.write m1
	Response.write """><DIV id=daysOfMonth1 style=""POSITION: absolute;z-index:10""></DIV>&nbsp;至：<INPUT name=ret4 readonly=""true"" size=9  id=daysOfMonth2Pos1 onmouseup=""toggleDatePicker('daysOfMonth21','date.ret4')"" value="""
	Response.write m1
	Response.write m2
	Response.write """>" & vbcrlf & " <DIV id=daysOfMonth21 style=""POSITION: absolute""></DIV>" & vbcrlf & " </td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "<td width=""10%"">&nbsp;</td>" & vbcrlf & "<td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
