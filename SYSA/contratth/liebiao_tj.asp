...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""1"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#CCC"" bordercolor=""#CCC"" id=""content"" style=""border-color:#CCC"">" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "          <td colspan=""2""><a class=""AfterQuickSearch"" href=""planall.asp?sp="
	Response.write request("sp")
	Response.write "&company="
	Response.write request("company")
	Response.write """><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a>     </td>" & vbcrlf & "           </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "         <td width=""10%"" class=""func""><div align=""right"">退货主题</div></td>" & vbcrlf & "                 <td width=""76%""><label><input name=""thmc"" type=""text"" id=""thmc""></label></td>" & vbcrlf & "         </tr>" & vbcrlf & "   <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "         <td width=""10%"" class=""func""><div align=""right"">退货编号</div></td>" & vbcrlf& "                  <td width=""76%""><label><input name=""thbh"" type=""text"" id=""thbh""></label></td>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "          <td width=""10%"" class=""func""><div align=""right"">关联客户</div></td> "& vbcrlf &             "   <td width=""76%""><label><input type=""text"" name=""khmc""></label></td>" & vbcrlf & "    </tr> "& vbcrlf &    "        <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff""> "& vbcrlf &     "     <td width=""10%"" class=""func""><div align=""right"">退货概要</div></td>" & vbcrlf & "           <td width=""76%""><label><input type=""text"" name=""intro""></label></td>" & vbcrlf & "           </tr>" & vbcrlf & "                        "
	set rs=conn.execute("select id,title,name,sort,gl from zdy where sort1=41 and set_open=1 and js=1 order by gate1 asc ")
	do until rs.eof
		Response.write "" & vbcrlf & "                      <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                       <td width=""10%"" class=""func""><div align=""right"">"
		Response.write rs("title")
		Response.write "</div></td>" & vbcrlf & "                    <td>" & vbcrlf & "                    "
		If rs("sort").value=2 Then
			...
			set rs1=conn.execute("select ord,sort1 from sortonehy where gate2='"&rs("gl")&"' order by gate1 desc")
			do until rs1.eof
				Response.write "<input type='checkbox' name='"& rs("name") &"' value='"& rs1("ord")& "' />"& rs1("sort1")& " "
				rs1.movenext
			loop
			rs1.close
		end if
	...
	loop
	rs.close
	Response.write "" & vbcrlf & "         <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "             <td width=""10%"" class=""func""><div align=""right"">产品名称</div></td>" & vbcrlf & "           <td><input name=""productname"" type=""text"" id=""productname""></td>" & vbcrlf & "       </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "         <td width=""10%"" class=""func""><div align=""right"">产品编号</div></td>" & vbcrlf & "                <td width=""76%""><label><input name=""cpbh"" type=""text"" id=""cpbh""></label></td> "& vbcrlf &     "   </tr>" & vbcrlf &    "      <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff""> "& vbcrlf &          "       <td width=""10%"" class=""func""><div align=""right"">产品型号</div></td> "& vbcrlf &    "        <td><input name=""cpxh"" type=""text"" id=""cpxh""></td>" & vbcrlf & "     </tr>" & vbcrlf & "          <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "         <td width=""10%"" class=""func""><div align=""right"">产品批号</div></td>" & vbcrlf & "                <td width=""76%""><label><input name=""cpph"" type=""text"" id=""cpph""></label></td> "& vbcrlf &   " </tr> "& vbcrlf &  "  <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf &      "    <td width=""10%"" class=""func""><div align=""right"">产品序列号</div></td>" & vbcrlf &            "   <td><input name=""cpxlh"" type=""text"" id=""cpxlh""></td> "& vbcrlf &   "    </tr>" & vbcrlf &      "  <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf &         " <td width=""10%"" class=""func""><div align=""right"">退货分类</div></td> "& vbcrlf &       "          <td width=""76%""><label> "& vbcrlf &     "       "
	set rs2=server.CreateObject("adodb.recordset")
	sql2="select * from sortonehy where gate2=35 order by gate1 desc"
	rs2.open sql2,conn,1,1
	do until rs2.eof
		Response.write "" & vbcrlf & "                      <input type=""checkbox"" name=""thfl"" value="""
	...
	rs2.close
	set rs2=nothing
	Response.write " " & vbcrlf & "               </label></td>" & vbcrlf & "    </tr>" & vbcrlf & "           <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "         <td width=""10%"" class=""func""><div align=""right"">退货状态</div></td>" & vbcrlf & "                <td width=""76%""><label>" & vbcrlf & "                             "
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select * from sortonehy where gate2=36 order by gate1 desc"
	rs7.open sql7,conn,1,1
	do until rs7.eof
		Response.write "" & vbcrlf & "                               <input type=""checkbox"" name=""thzt"" value="""
	...
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "               </label></td>" & vbcrlf & "    </tr>" & vbcrlf & ""
	if ZBRuntime.MC(17000) and ZBRuntime.MC(17002) then
		Response.write "" & vbcrlf & "        <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "         <td width=""10%"" class=""func""><div align=""right"">入库进展</div></td>" & vbcrlf & "                <td width=""76%""><input id=""rkjz1"" type=""checkbox"" name=""rkjz"" value=""1""><label for=""rkjz1"">未入库</label>&nbsp; <input id=""rkjz2"" type=""checkbox""  name=""rkjz"" value=""2""><label for=""rkjz2"">部分入库</label>&nbsp; <input type=""checkbox"" id=""rkjz3"" name=""rkjz"" value=""3""><label for=""rkjz3"">入库完毕</label>&nbsp; <input type=""checkbox"" id=""rkjz4"" name=""rkjz"" value=""4""><label for=""rkjz4"">无需入库</label>&nbsp;" & vbcrlf & "                 </td>" & vbcrlf & "    </tr>" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "             <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                <td width=""10%""><div align=""right"">添加人员</div></td>" & vbcrlf & "              <td>"
	if sort_zjjg="" or isnull(sort_zjjg) Then sort_zjjg=1
	set rs1=server.CreateObject("adodb.recordset")
	...
	SeaStr = ""
	If IsType = 1 Then
		If Len(dongjie)>0 And dongjie=1 Then SeaStr = SeaStr & " or del = 2 "
		If Len(huishouzhan)>0 And huishouzhan=1 Then SeaStr = SeaStr & " or del = 5 "
	end if
	ReDim d_at(54)
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	execute "On Error Resume Next : ExecuteGlobal Join(d_at, vbcrlf)"
	Response.write  CBaseUserTreeHtml("select ord,orgsid from gate where 1=1 "&str_w3&" and (del=1 "&SeaStr&")","orgsid", "W11","W22","W33",  "", w1, w2, Correct_W3)
	
	Response.write "</td>" & vbcrlf & "           </tr>" & vbcrlf & "                <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "                <td width=""10%""><div align=""right"">销售人员</div></td>" & vbcrlf & "              <td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "         <td width=""10%"" class=""func""><div align=""right"">关联地区</div></td>" & vbcrlf & "                <td width=""76%"">"
	execute sdk.vbs("../manager/search_area" &  Application("__saas__company")  & ".asp")
	Response.write "</td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "         <td width=""10%"" class=""func""><div align=""right"">关联行业</div></td>" & vbcrlf & "                <td width=""76%"">" & vbcrlf & "                  "
	set rs=server.CreateObject("adodb.recordset")
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "             <td width=""10%""><div align=""right"">生产日期</div></td>" & vbcrlf & "              <td>" & vbcrlf & "                   <INPUT name=duepaydate1 size=9  id=duepaydate1divPos onmouseup=toggleDatePicker(""duepaydate1div"",""date.duepaydate1"") value="""
	...
	Response.write """><DIV id=duepaydate2div style=""POSITION: absolute;z-index:10"" name =""duepaydate2div""></DIV>                           </td>" & vbcrlf & "     </tr>" & vbcrlf & "           <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "             <td width=""10%""><div align=""right"">有效日期</div></td>" & vbcrlf & "                 <td>" & vbcrlf & "           <INPUT name=paydate1 size=9  id=paydate1divPos onmouseup=toggleDatePicker(""paydate1div"",""date.paydate1"") value="""
	...
	Response.write """><DIV id=paydate2div style=""POSITION: absolute;z-index:10"" name =""paydate2div""></DIV></td>" & vbcrlf & "      </tr>" & vbcrlf & "           <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "             <td width=""10%""><div align=""right"">金额</div></td>" & vbcrlf & "            <td><input name=""duemoney1"" type=""text""  onblur=""yanZheng(this)"" id=""duemoney1"" value="""
	Response.write FormatNumber(0,num_dot_xs,-1,0,0)
	Response.write """ style=""width:73px"" onkeyup=""checkDot('duemoney1','"
	Response.write num_dot_xs
	Response.write "')"">" & vbcrlf & "" & vbcrlf & "                 -" & vbcrlf & "             <input name=""duemoney2"" type=""text"" id=""duemoney2"" onblur=""yanZheng(this)"" value="""
	Response.write num_dot_xs
	Response.write FormatNumber(999999999,num_dot_xs,-1,0,0)
	Response.write num_dot_xs
	Response.write """ style=""width:73px"" onkeyup=""checkDot('duemoney2','"
	Response.write num_dot_xs
	Response.write "')""></td>" & vbcrlf & "    </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td width=""10%"">&nbsp;</td>" & vbcrlf & "       <td width=""90%""><input type=""hidden"" name=""gjjs"" value=""1""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "       </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
