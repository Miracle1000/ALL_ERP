...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	End Select
	Response.write "" & vbcrlf & "<table width=""100%"" border=""1"" cellpadding=""6"" cellspacing=""1"" bordercolor=""#CCC"" bgcolor=""#CCC"" id=""content"" style=""border-color:#CCC"">" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "     <td colspan=""2"" align=""left""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=""" & vbcrlf & "                 document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';document.getElementById('ht1').value='';if(window.superSearch){superSearch(2);};return false;""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" style=""display:none"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "      <td rowspan=""2""><div align=""right"">人员选择：</div></td>" & vbcrlf & "    <td><div align=""left""><input name=""B"" type=""radio"" value=""1"" checked=""checked"" />领用人员" & vbcrlf & "          <input type=""radio"" name=""B"" value=""2"" />放弃人员" & vbcrlf & "             <input type=""radio"" name=""B"" value=""3"" />添加人员" & vbcrlf & "             <input type=""radio"" name=""B"" value=""4"" />添加人员和领用人员" & vbcrlf & "           <input type=""radio"" name=""B"" value=""5"" />添加人员和放弃人员" & vbcrlf & "        <input type=""radio"" name=""B"" value=""6"" />保护人员" & vbcrlf & "        <input type=""radio"" name=""B"" value=""7"" />未保护人员          <input type=""hidden"" name=""gjjs"" value=""7""></div>" & vbcrlf & "    </td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "        <td><div align=""left"">"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	dim i5
	i5=2
	set rs1=conn.execute("select ord,sort1 from sort4 order by gate1 desc")
	do until rs1.eof
		...
		Response.write ">"
		set rs2=conn.execute("select ord,sort2 from sort5  where sort1="&rs1("ord")&" order by gate2 desc")
		do until rs2.eof
	...
	Call print_search_scope(2,arrShow(22),arrName(22), "V1" ,"V2")
	...
	Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td width=""10%"">&nbsp;<input type=""hidden"" name=""H2"" value="""
	Response.write request("H2")
	Response.write """></td>" & vbcrlf & "<td width=""90%""><div align=""left""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2"">"
	If ZBRuntime.mc(201103) Then
		Response.write "&nbsp;&nbsp;<input type=""button"" value=""加入视图"" class=""anybutton"" name=""jrview"" onClick=""javascript:if(typeof(add_view)=='function'){add_view();}"">"
	end if
	Response.write "</div></td></tr></table>" & vbcrlf & "" & vbcrlf & ""
	conn.close
	set conn=nothing
