...
'If header.dbtype="hl" Then nbit = Info.hlNumber
		...
		public sub class_initialize
			...
			set rs_group_sum = server.CreateObject("")
...
'items = rpt.Settings.item(i)
	...
	Function RptPower(ByVal Index, ByVal powertype)
		If index <= 5 Then
			Select Case powertype
			Case "print" : RptPower = app.power.existsPower(1,7) : Exit function
			Case "excel" : RptPower = app.power.existsPower(1,10) : Exit function
			End select
		end if
		RptPower = true
	end function
	Function getKeyField(ByVal Index)
		If index <= 5 Then
			getKeyField = "ord"
		else
			getKeyField = "ord"
	...
	Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen('')=0 or sort in (-1))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen('')= 0 or cateid2 in (-1))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen('')=0 or cateid3 in (-1))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or jz in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen('')=0 or ly in (-1))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen('')=0 or zdy6 in (-1))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen('')=0 or zdy5 in (-1))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.charLen('')=0 or pym like '%' + '' + '%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.charLen('')=0 or khid like '%' + '' + '%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.charLen('')=0 or phone like '%' + '' + '%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.charLen('')=0 or address like '%' + '' + '%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.charLen('')=0 or url like '%' + '' + '%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.charLen('')=0 or zip like '%' + '' + '%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.charLen('')=0 or intro like '%' + '' + '%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen('')=0 or trade in (-1))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen('')=0 or jz in (-1))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or t1.date2 between NULL and NULL)", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or sort in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)= 0 or cateid2 in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or cateid3 in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or jz in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or ly in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or zdy6 in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or zdy5 in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or trade in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or sort1 in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)= 0 or cateid in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (dbo.CharLen(NULL)=0 or cateid2 in (NULL))", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (0=0 or pym like '%%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (0=0 or khid like '%%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (0=0 or phone like '%%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (0=0 or address like '%%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (0=0 or url like '%%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (0=0 or zip like '%%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (0=0 or intro like '%%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and (0=0 or name like '%%')", "and 1=1", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		sql = Replace(sql, "and 1=1" & vbcrlf & "and", "and", 1, -1, 1)
'Function ReportSqlHandle(ByVal sql)
		ReportSqlHandle = sql
	end function
	Function GetName(fname,fkey)
		Dim rs
		Set rs=cn.execute("select top 1 (case when isnull(name,'')='' then oldname else name end ) as fname,show from setfields where charindex(','+fieldname+',',',"&fkey&",')>0 order by gate1")
'Dim rs
		If rs.eof Then
			GetName=fname
		else
			GetName=rs("fname")
			If rs("show")<1 Then GetName=""
		end if
		rs.close
	end function
	function CreateSql(ByVal rs,  ByRef colname, ByRef rowname, ByRef grouptype, ByRef exitcols)
		Dim  basesql, colkey, coltype , rowkey, rowtype, colsort, colsortlist, colsortsql
		Dim coldata, rowdata, sql, basefrmid, colrs, rowrs, rs2, fname
		Dim colsql, rowsql , groupsql, colsor, tmp, i, ftype
		Dim colsql2, rowsql2
		Dim sql1, sql2, sql3, arr1, arr2
		Dim tbsql
		Dim wheresql
		Dim fieldsql
		Dim maxColCount : maxColCount = 10000
		baseSql = rs("basesql").value
		basefrmid = rs("basefromid").value
		colkey = rs("colkey").value
		coldata = rs("coldata").value
		colsort = rs("colsort").value
		rowkey = rs("rowkey").value
		rowdata = rs("rowdata").value
		baseSql = Trim(baseSql)
		If InStr(1,baseSql,"select",1)<>1 Or InStr(1,basesql," from ",1)=0 Then
			app.showerr "提示", "配置的SQL有误，不是一个有效的select ** from 语句。<br>SQL：" + baseSql
'If InStr(1,baseSql,"select",1)<>1 Or InStr(1,basesql," from ",1)=0 Then
			Exit function
		end if
		Dim fi : fi = instr(1, baseSql, " from ", 1)
		Dim s1 : s1 = Trim(Mid(Left(baseSql, fi), 7))
		Dim s2 : s2 = Split(Replace(Right(baseSql, Len(basesql)-fi-4)," where ", " where ", 1, -1, 1), "where")
'Dim s1 : s1 = Trim(Mid(Left(baseSql, fi), 7))
		tbsql = s2(0)
		If ubound(s2) > 0 Then
			wheresql = s2(1)
			For i = 2 To  ubound(s2)
				wheresql = wheresql & "where" & s2(i)
			next
			s2(1) = wheresql
			wheresql = convertSql(wheresql)
		end if
		s2 = Split(s1,"(")
		fieldsql = Replace(s2(1),")","")
		grouptype  = s2(0)
		Set colrs = cn.execute("select top 1 * from erp_sales_ReportFields where reportid=" & basefrmid & " and fkey='" & colkey & "'")
		If colrs.eof Then
			app.showerr "提示", "无法获取字段【" & colkey & "】的相关信息，请确认系统配置是否完整。 【Col=" & basefrmid & "】"
			Exit function
		end if
		colname = GetName(colrs("fname").value,colkey)
		tmp = colrs("sortconfig").value & ""
		ftype = LCase(colrs("ftype").value)
		If ftype = "sortonehy" Or ftype="zdy" Then
			If Len(tmp) = 0 Then
				If ftype="zdy" then
					Set rs2=cn.execute("select title from zdy where sort1=" & colrs("datassql").value & " and name='" & colrs("fkey").value & "' and set_open=1")
					If rs2.eof = False Then
						colname = rs2.fields(0).value
					end if
					rs2.close
				end if
				tmp = "按" & colname & "重要指数升序排列==order by gate1;按" & colname & "重要指数降序排列==order by gate1 desc;按" & colname & "名称升序排列==order by sort1;按" & colname & "名称降序排列==order by sort1 desc"
			end if
		end if
		If Len(tmp) > 0 Then
			colsortlist = Split(tmp,";")
			For i = 0 To ubound(colsortlist)
				tmp = Split(colsortlist(i) & "==","==")
				If tmp(0) = colsort Then
					colsortsql = tmp(1)
				end if
			next
		end if
		Set rowrs = cn.execute("select top 1 * from erp_sales_ReportFields where reportid=" & basefrmid & " and fkey='" & rowkey & "'")
		If rowrs.eof Then
			app.showerr "提示", "无法获取字段【" & rowkey & "】的相关信息，请确认系统配置是否完整。 【Row=" & basefrmid & "】"
			Exit function
		end if
		rowname = GetName(rowrs("fname").value,rowkey)
		Dim wdata
		sql2 = ""
		Dim showAther :  showAther = True
		Select Case colrs("ftype").value
		Case "zdy"
		sql = "select top " &  maxColCount & " sort1, ord from sortonehy a where del=1 and  gate2=(select top 1 gl from zdy where name='" & colkey & "' and sort1=" & colrs("datasSql").value & ") "
		If Len(coldata) > 0 Then
			sql = sql & " and ord in (" & coldata & ")"
		end if
		If Len(colsortsql) = 0 then
			sql = sql & " order by gate1 desc"
		else
			sql = sql & " " & colsortsql
		end if
		...
		While rs2.eof = False
			...
			colsql = colsql  & grouptype & "(case t1." & colkey & " when " & rs2("ord").value & " then (" & fieldsql & ") else 0 end) as [" &  Replace(rs2("sort1").value & "","@","&#64;") & "#X#" & rs2("ord").value  & "]"
			If Len(colsql2) > 0 Then colsql2 = colsql2 & ","
			colsql2 = colsql2  & grouptype & "(case t1." & colkey & " when " & rs2("ord").value & " then (" & fieldsql & ") else 0 end) as [" &  Replace(rs2("sort1").value & "","@","&#64;") & "]"
			If Len(sql2) > 0 Then
				sql2 = sql2 & ","
			end if
			sql2 = sql2 & rs2("ord").value
			rs2.movenext
		wend
		rs2.close
		Set rs2 = Nothing
		If Len(sql2) > 0 And Len(coldata) = 0  And showAther Then
			If Len(colsql) > 0 Then colsql = colsql & ","
			If Len(colsql2) > 0 Then colsql2 = colsql2 & ","
			colsql = colsql & grouptype & "(case when t1." & colkey & " in (" & sql2 & ") then 0 else (" & fieldsql & ") end) as [无#X#NULL]"
			colsql2 = colsql2 & grouptype & "(case when t1." & colkey & " in (" & sql2 & ") then 0 else (" & fieldsql & ") end) as [无]"
			exitcols = sql2
			sql2 = ""
		end if
		Case "sortonehy"
		sql = "select top  " &  maxColCount & " sort1, ord from sortonehy a where del=1 and gate2=" & colrs("datasSql").value
		If Len(coldata) > 0 Then
			sql = sql & " and ord in (" & coldata & ")"
		end if
		If Len(colsortsql) = 0 then
		...
		Case "gates"
		sql = "select top " &  maxColCount & " ord, name,(select top 1 t.gate1 from gate1 t where t.ord=sorce) as bmgate1, (select top 1 t.sort1 from gate1 t where t.ord=sorce) as bmname  from gate where del=1 "
		wdata = Split(coldata & "||||", "|")
		Set rs2 = cn.execute("exec erp_comm_getW3 '" & wdata(0) & "','" & wdata(1) & "','" & wdata(2) & "',1," & Info.user)
		While rs2.eof = False
			If Len(sql2) > 0 Then
				sql2 = sql2 & ","
			end if
			sql2 = sql2 & rs2(0).value
			rs2.movenext
		wend
		rs2.close
		If Len(sql2) = 0 Then
...
'If Len(colsortsql) = 0 then
		...
		While rs2.eof = False
			If Len(colsql) > 0 Then colsql = colsql & ","
			colsql = colsql & grouptype & "(case t1." & colkey & " when " & rs2("ord").value & " then (" & fieldsql & ") else 0 end) as [" & Replace(rs2("name").value & "","@","&#64;") & "#X#" & rs2("ord").value  & "]"
			If Len(colsql2) > 0 Then colsql2 = colsql2 & ","
			colsql2 = colsql2 & grouptype & "(case t1." & colkey & " when " & rs2("ord").value & " then (" & fieldsql & ") else 0 end) as [" & Replace(rs2("name").value & "","@","&#64;") & "]"
			rs2.movenext
		wend
		rs2.close
		Set rs2 = Nothing
		...
		Dim colkeys
		sql3 = ""
		colkeys = Split(colkey, ",")
		wdata = Split(coldata & "||||", "|")
		sql = " set nocount on;" & vbcrlf &_
		"  select cast(short_str as int) as w1 into #W1 from split('" & wdata(0) & "',',') a " & vbcrlf &_
		"  select cast(short_str as int) as w2, b.sort1 as w1 into #W2 from split('" & wdata(1) & "',',') a inner join gate2 b on a.short_str=b.ord" & vbcrlf &_
		"  delete #W1 where exists(select 1 from #W2 x where x.w1= [#w1].w1)" & vbcrlf &_
		"  insert into #w2(w1, w2)" & vbcrlf &_
		"  select a.w1, b.ord from #W1 a inner join gate2 b on a.w1 = b.sort1 " & vbcrlf &_
		"  union all" & vbcrlf &_
		"  select a.w1, 0 from #W1 a " & vbcrlf &_
		"  select top " & maxColCount & " cast((cast(b.ord as varchar(12)) + '.' +  CAST(isnull(c.ord,0) as varchar(12))) as numeric(20,10)) as k," & vbcrlf &_
		"  select a.w1, 0 from #W1 a " & vbcrlf &_
		"  b.sort1 + '_' + ISNULL(c.sort2,'无组别') as n" & vbcrlf &_
		"  select a.w1, 0 from #W1 a " & vbcrlf &_
		"  FROM #w2 a " & vbcrlf &_
		"  inner join gate1 b on a.w1 = b.ord " & vbcrlf &_
		"  left join gate2 c on c.ord = a.w2" & vbcrlf
		If Len(colsortsql) = 0 then
			sql = sql & " order by b.gate1 desc, b.ord, c.gate2 desc, c.ord;" & vbcrlf
		else
			sql = sql & " " & colsortsql & ";" & vbcrlf
		end if
		sql = sql & "      set nocount off;"
		Set rs2 = cn.execute(sql)
		While rs2.eof = False
			If Len(colsql) > 0 Then colsql = colsql & ","
			colsql = colsql & grouptype & "(case cast(cast(isnull(t1." & colkeys(0) & ",0) as varchar(12)) + '.' + cast(isnull(t1." & colkeys(1) & ",0) as varchar(12)) as numeric(20,10))  when " & rs2("k").value & " then (" & fieldsql & ") else 0 end) as [" & Replace(rs2("n").value & "","@","&#64;") & "#X#"& rs2("k").value  & "]"
			If Len(colsql2) > 0 Then colsql2 = colsql2 & ","
			colsql2 = colsql2 & grouptype & "(case cast(cast(isnull(t1." & colkeys(0) & ",0) as varchar(12)) + '.' + cast(isnull(t1." & colkeys(1) & ",0) as varchar(12)) as numeric(20,10))  when " & rs2("k").value & " then (" & fieldsql & ") else 0 end) as [" & Replace(rs2("n").value & "","@","&#64;") & "]"
			If Len(sql2) > 0 Then
				sql2 = sql2 & ","
			end if
			sql2 = sql2 & rs2("k").value & ""
			rs2.movenext
		wend
		rs2.close
		Set rs2 = Nothing
		If Len(sql2) > 0 And Len(coldata) < 2  And showAther Then
			If Len(colsql) > 0 Then colsql = colsql & ","
			If Len(colsql2) > 0 Then colsql2 = colsql2 & ","
			colsql = colsql & grouptype & "(case when cast(cast(isnull(t1." & colkeys(0) & ",0) as varchar(12)) + '.' + cast(isnull(t1." & colkeys(1) & ",0) as varchar(12)) as numeric(20,10)) in (" & sql2 & ") then 0 else (" & fieldsql & ") end) as [无#X#NULL]"
'If Len(colsql2) > 0 Then colsql2 = colsql2 & ","
			colsql2 = colsql2 & grouptype & "(case when cast(cast(isnull(t1." & colkeys(0) & ",0) as varchar(12)) + '.' + cast(isnull(t1." & colkeys(1) & ",0) as varchar(12)) as numeric(20,10)) in (" & sql2 & ") then 0 else (" & fieldsql & ") end) as [无]"
'If Len(colsql2) > 0 Then colsql2 = colsql2 & ","
			exitcols = sql2
			sql2 = ""
		end if
		If Len(sql2) > 0 Then
			wheresql = wheresql & " and cast(cast(isnull(t1." & colkeys(0) & ",0) as varchar(12)) + '.' + cast(isnull(t1." & colkeys(1) & ",0) as varchar(12)) as numeric(20,10)) in (" & sql2 &") "
'If Len(sql2) > 0 Then
		end if
		sql2  = ""
		Case "telcls"
		...
		sql = " set nocount on;" & vbcrlf &_
		"  select cast(short_str as int) as w1 into #W1 from split('" & wdata(0) & "',',') a " & vbcrlf &_
		"  select cast(short_str as int) as w2, b.sort1 as w1 into #W2 from split('" & wdata(1) & "',',') a inner join sort5 b on a.short_str=b.ord" & vbcrlf
		If Len(wdata(0)) = 0 And  Len(wdata(0)) = 0 Then
			sql = " set nocount on;" & vbcrlf &_
			"  select ord as w1 into #W1 from sort4 a " & vbcrlf &_
			"  select cast(short_str as int) as w2, b.sort1 as w1 into #W2 from split('" & wdata(1) & "',',') a inner join sort5 b on a.short_str=b.ord" & vbcrlf
		else
			sql = " set nocount on;" & vbcrlf &_
			"  select cast(short_str as int) as w1 into #W1 from split('" & wdata(0) & "',',') a " & vbcrlf &_
		...
		sql = sql & "delete #W1 where exists(select 1 from #W2 x where x.w1= [#w1].w1)" & vbcrlf &_
		"  insert into #w2(w1, w2)" & vbcrlf &_
		"  select a.w1, b.ord from #W1 a inner join  sort5 b on a.w1 = b.sort1 " & vbcrlf &_
		"  union all" & vbcrlf &_
		"  select a.w1, 0 from #W1 a " & vbcrlf &_
		"  select top " & maxColCount & "  (cast(b.ord as varchar(12)) + '.' +  CAST(isnull(c.ord,0) as varchar(12))) as k," & vbcrlf &_
		"  select a.w1, 0 from #W1 a " & vbcrlf &_
		"  b.sort1 + '_' + ISNULL(c.sort2,'无跟进程度') as n" & vbcrlf &_
		"  select a.w1, 0 from #W1 a " & vbcrlf &_
		"  FROM #w2 a " & vbcrlf &_
		"  inner join sort4 b on a.w1 = b.ord " & vbcrlf &_
		"  left join sort5 c on c.ord = a.w2" & vbcrlf
		If Len(colsortsql) = 0 then
			sql = sql & " order by b.gate1 desc, b.ord, c.gate2 desc, c.ord;" & vbcrlf
		else
			sql = sql & " " & colsortsql & ";" & vbcrlf
...
'If Len(sql2) > 0 Then
		...
		sql2  = ""
		Case Else
		sql2 = colrs("datasSql").value
		If InStr(1,sql2, "options", 1) = 1 Then
			sql2 = Right(sql2, Len(sql2)-8)
'If InStr(1,sql2, "options", 1) = 1 Then
			arr1 = Split(sql2, ";")
			sql2 = ""
			For i = 0 To ubound(arr1)
				...
				sql2 = sql2 & "select " & arr2(0) & " as value , '" & Replace(arr2(1),"'","''") & "' as name"
			next
		end if
		Set rs2 = cn.execute(Replace(sql2,"@sortsql",colsortsql))
		sql2  = ""
		While rs2.eof = False
			If Len(sql2) > 0 Then
				sql2 = sql2 & ","
			...
			If Len(colsql) > 0 Then colsql = colsql & ","
			colsql = colsql & grouptype & "(case t1." & colkey & " when " & rs2("value").value & " then (" & fieldsql & ") else 0 end) as [" & Replace(rs2("name").value & "","@","&#64;") & "#X#" & rs2("value").value  & "]"
			If Len(colsql2) > 0 Then colsql2 = colsql2 & ","
			colsql2 = colsql2 & grouptype & "(case t1." & colkey & " when " & rs2("value").value & " then (" & fieldsql & ") else 0 end) as [" & Replace(rs2("name").value & "","@","&#64;") & "]"
			sql2 = sql2 & rs2("value").value
			rs2.movenext
		wend
		rs2.close
		Set rs2 =  Nothing
		...
		End Select
		If Len(sql2) > 0 Then  wheresql = wheresql & " and t1." & colkey & " in (" & sql2 &") "
		Select Case rowrs("ftype")
		Case "zdy"
		fname = cn.execute("select top 1 title from zdy where name='" & rowkey & "' and sort1=" & rowrs("datasSql").value).fields(0).value
		rowsql = "isnull((select top 1 sort1 + '||'+ cast(t01.ord as varchar(12))  from sortonehy t01 where t01.ord= isnull(t1." + rowkey + ",0)),'空') as [" & fname & "]"
		groupsql = "group by isnull(t1." & rowkey & ",0)"
		rowsql2 = "isnull((select top 1 sort1 from sortonehy t01 where t01.ord= isnull(t1." + rowkey + ",0)),'空') as [" & fname & "]"
'groupsql = "group by isnull(t1." & rowkey & ",0)"
		Case "area"
		rowsql = "isnull((select top 1 menuname  + '||'+ cast(t01.id as varchar(12)) from menuarea t01 where t01.id= isnull(t1." + rowkey + ",0)),'空') as [" & rowrs("fname").value & "]"
		Case "area"
		groupsql = "group by isnull(t1." & rowkey & ",0)"
		rowsql2 = "isnull((select top 1 menuname from menuarea t01 where t01.id= isnull(t1." + rowkey + ",0)),'空') as [" & rowrs("fname").value & "]"
'groupsql = "group by isnull(t1." & rowkey & ",0)"
		Case "sortonehy"
		rowsql = "isnull((select top 1 sort1  + '||'+ cast(t01.ord as varchar(12)) from sortonehy t01 where t01.ord= isnull(t1." + rowkey + ",0)),'空') as [" & rowrs("fname").value & "]"
		Case "sortonehy"
		groupsql = "group by isnull(t1." & rowkey & ",0)"
		rowsql2 = "isnull((select top 1 sort1 from sortonehy t01 where t01.ord= isnull(t1." + rowkey + ",0)),'空') as [" & rowrs("fname").value & "]"
'groupsql = "group by isnull(t1." & rowkey & ",0)"
		Case "gates"
		rowsql = "(select top 1 name + '||' + cast(g.ord as varchar(12)) from gate g where g.ord=isnull(t1." & rowkey & ",0)) as [" & rowrs("fname").value & "],(select top 1 g1.sort1 + isnull('-' + g2.sort2,'') from gate g left join gate1 g1 on g.sorce=g1.ord left join gate2 g2 on g2.ord=g.sorce2 where g.ord=isnull(t1." & rowkey & ",0)) as [部门小组]"
		groupsql = "group by isnull(t1." & rowkey & ",0)"
		rowsql2 = "(select top 1 name from gate g where g.ord=isnull(t1." & rowkey & ",0)) as [" & rowrs("fname").value & "],(select top 1 g1.sort1 + isnull('-' + g2.sort2,'') from gate g left join gate1 g1 on g.sorce=g1.ord left join gate2 g2 on g2.ord=g.sorce2 where g.ord=isnull(t1." & rowkey & ",0)) as [部门小组]"
		Case "gategroup"
		Dim rowkeys
		rowkeys = Split(rowkey, ",")
		rowsql = "(select top 1 sort1 + '||' + cast(a.ord as varchar(12))  from gate1 a where a.ord=isnull(t1." + rowkeys(0) + ",0)) as 部门,(select top 1 sort2 + '||' + cast(a.ord as varchar(12)) from gate2 a where a.ord=isnull(t1." + rowkeys(1) + ",0)) as 小组"
'rowkeys = Split(rowkey, ",")
		groupsql = "group by isnull(t1." & rowkeys(0) & ",0), isnull(t1." & rowkeys(1) & ",0)"
		rowsql2 = "(select top 1 sort1 from gate1 a where a.ord=isnull(t1." + rowkeys(0) + ",0)) as 部门,(select top 1 sort2 from gate2 a where a.ord=isnull(t1." + rowkeys(1) + ",0)) as 小组"
'groupsql = "group by isnull(t1." & rowkeys(0) & ",0), isnull(t1." & rowkeys(1) & ",0)"
		Case "telcls"
		rowkeys = Split(rowkey, ",")
		rowsql = "(select top 1 sort1 + '||' + cast(a.ord as varchar(12)) from sort4 a where a.ord=t1." + rowkeys(0) + ") as 客户分类,(select top 1 sort2 + '||' + cast(a.ord as varchar(12)) from sort5 a where a.ord=t1." + rowkeys(1) + ") as 跟进程度"
'rowkeys = Split(rowkey, ",")
		groupsql = "group by t1." & rowkeys(0) & ",t1." & rowkeys(1)
		rowsql2 = "(select top 1 sort1 from sort4 a where a.ord=t1." + rowkeys(0) + ") as 客户分类,(select top 1 sort2 from sort5 a where a.ord=t1." + rowkeys(1) + ") as 跟进程度"
'groupsql = "group by t1." & rowkeys(0) & ",t1." & rowkeys(1)
		Case Else
		rowsql = rowrs("datasSql").value & ""
		rowsql =  Replace(rowsql, "@sortsql", "")
		If Len(rowsql) > 0 Then
			rowsql2 = rowsql
			rowsql = "isnull((select top 1 name + '||' + cast(a.value as varchar(12)) from (" & Replace(rowsql,"select ","select top 1000000 ",1,-1,1) & ") a where a.value=isnull(t1." &  rowkey & ",0)),'空') As [" & rowrs("fname").value & "]"
'rowsql2 = rowsql
			groupsql = "group by isnull(t1." & rowkey & ",0)"
			rowsql2 =  Replace(rowsql2,"select ","select top 1000000 ",1,-1,1)
'groupsql = "group by isnull(t1." & rowkey & ",0)"
			rowsql2 = "isnull((select top 1 name from (" & vbcrlf &  rowsql2 & vbcrlf & ") a where a.value=isnull(t1." &  rowkey & ",0)),'空') As [" & rowrs("fname").value & "]"
		else
			rowsql = "(t1." &  rowkey & " + '||' + t1." &  rowkey & ")  As [" & fname & "]"
			rowsql2 = "t1." &  rowkey & "  As [" & fname & "]"
			groupsql = "group by t1." & rowkey & ""
		end if
		End Select
		sql1 =  "select " & rowsql & "," & grouptype & "(" & fieldsql & ") as 行合计"
		If Len(colsql) > 0 Then
			sql1 = sql1 & ","
		end if
		sql1 = sql1 & colsql & vbcrlf & "--分割--" & vbcrlf & " from " & tbsql & " where " & Wheresql  & vbcrlf & "--分割--" & vbcrlf & groupsql
		sql1 = sql1 & ","
		sql2 =  "select " & colsql2 & " from " & tbsql & " where " & Wheresql
		sql3 =       "select top 10 " & rowsql2 & "," & grouptype & "(" & fieldsql & ") as 行合计 from " & tbsql & " where " & Wheresql & " " & groupsql & " order by 行合计 desc"
		CreateSql = sql1 &  Chr(1) & sql2 & Chr(1) & sql3
	end function
	Function convertSql(ByVal baseSql)
		Dim i, si, ei, skey, sql, rs
		Dim skeylen, rsql, dsql, psql
		sql = baseSql
		skey = "@ExistsPower{"
		skeylen = Len(skey)
		si = instr(1, baseSql,skey,1)
		While si > 0 And i < 100000
			ei = InStr(si +skeylen, basesql, "}", 1)
'While si > 0 And i < 100000
			If ei = 0 Then
				app.showerr "配置语句：【" & sql & "】存在语法错误，“动态函数@ExistsPower{”缺号闭合的括号。"
				Exit function
			end if
			rsql = mid(sql, si, ei-si+1)
			Exit function
			dsql = Split(Replace(Replace(rsql, skey, ""), "}" , ""), ",")
			If ubound(dsql) <> 2 Then
				app.showerr "配置语句：【" & sql & "】存在语法错误，“动态函数@ExistsPower需要3个参数。"
				Exit function
			end if
			psql =  "set nocount on;" & vbcrlf &_
			"if exists(select 1 from qxlblist where sort1=" & dsql(0) & " and sort2=" & dsql(1) & " and sort = 3)" & vbcrlf &_
			"begin" & vbcrlf &_
			"  select case qx_open when 3 then '' when 1 then qx_intro else '0' end from power where sort1=" & dsql(0) & " and sort2=" & dsql(1) & " and ord=" & Info.user & " and (qx_open=1 or qx_open=3)" & vbcrlf &_
			"end" & vbcrlf &_
			"else" & vbcrlf &_
			"begin" & vbcrlf &_
			"  select '' as r from power where sort1=" & dsql(0) & " and sort2=" & dsql(1) & " and ord=" & Info.user & " and qx_open=1" & vbcrlf &_
			"end" & vbcrlf &_
			"set nocount off"
			Set rs = cn.execute(psql)
			If rs.eof = False Then
				If rs.fields(0).value = "" Then
					psql = "1=1"
				else
					psql =dsql(2) & " in (" & Replace( rs.fields(0).value & ""," ","") & ")"
				end if
			else
				If dsql(1) = 19 Then
					psql = "1=1"
			...
			rs.close
			basesql =  Replace(baseSql, rsql, psql)
			i = i + 1
'basesql =  Replace(baseSql, rsql, psql)
			si = instr(1, baseSql,skey,1)
		wend
	...
	Sub onReportInit(rpt, state)
		rpt.beforeBtnsHTML = "<style>#lvwbody{width:auto!important}#lvw_pindex_mlistvw{margin-top:-1px!important}</style>"
'Sub onReportInit(rpt, state)
		Dim id : id = app.getInt("ID")
		Dim rs, sql, rowname, colname, grouptype
		Dim i, ii, cansearch, canadsearch, rs2, exitcols
		Dim basefromId
		app.AddDefaultScript
		If app.getint("view") = 1 Then
			sql = "select *,(select top 1 cast(basesql as varchar(8000)) from erp_sales_ReportItems_def d where d.id=basefromid) as baseSql from erp_sales_ReportItems where addcate=" & Info.User & " and del=7"
		else
			If id > 0 then
				sql = "select *,(select top 1 cast(basesql as varchar(8000)) from erp_sales_ReportItems_def d where d.id=basefromid) as baseSql from erp_sales_ReportItems where addcate=" & Info.User & " and ID=" & id
			else
				sql = "select *,id as basefromid from erp_sales_ReportItems_def where ID=" & Abs(id)
			end if
		end if
		Set rs = cn.execute(sql)
		If rs.eof = False Then
			rpt.title = rs("title").value & app.iif(app.getint("view")=1,"-预览版","")
'If rs.eof = False Then
			rpt.pagesize = rs("pagerowcount").value
			sql = Split( CreateSql(rs,colname, rowname, grouptype, exitcols) , Chr(1))
			rpt.sql = sql(0)
			cansearch = rs("cansearch").value
			canadsearch = rs("canadsearch").value
			basefromId = rs("basefromId").value
			rpt.canprint = rs("canprint").value And RptPower(id, "print")
			rpt.canexcel = rs("canexcel").value  And RptPower(id, "excel")
		else
			rs.close
			app.showerr "提示","对于的报表不存在，ID=【" & id & "】"
			Exit sub
		end if
		rs.close
		App("basefromId") = basefromId
		rpt.addgroup colname, sql(1), grouptype , "col", rpt.title
		rpt.addgroup rowname, sql(2), grouptype , "row", rpt.title
		Dim searchs, ftype, fname, fkey, datasSql
		If Len(cansearch) > 0 Then
			Set rs = cn.execute("select fname, ftype, fkey, datasSql from dbo.erp_sales_ReportFields where ReportId=" & basefromId & " and charindex('|'+ fkey + '|','|" & cansearch & "|')>0 order by searchsort")
'If Len(cansearch) > 0 Then
			While rs.eof = False
				ftype = rs("ftype").value
				fname = GetName(rs("fname").value,rs("fkey").value)
				fkey = rs("fkey").value
				datasSql = rs("datasSql").value
				Select Case LCase(ftype)
				Case "zdy"
				Set rs2 = cn.execute("select title, gl from zdy where name='" & fkey & "' and sort1=" & datasSql)
				If rs2.eof = False Then
					fname = rs2(0).value
					datasSql = rs2(1).value
				end if
				rs2.close
				If fkey = "zdy5" Or fkey = "zdy6" Then
					rpt.addfield fname & "：", "sortonehy", fkey, datasSql, "", ""
				else
					rpt.addfield fname & "：", "text", fkey, "", "", ""
				end if
				Case "sortonehy"
				rpt.addfield fname & "：", "sortonehy", fkey, datasSql, "", ""
				Case "gategroup"
				rpt.addfield fname & "：", "gategroup", fkey, "", "", ""
				Case "gategroup2"
				rpt.addfield fname & "：", "gategroup2", fkey, "", "", ""
				Case "gategroup3"
				rpt.addfield fname & "：", "gategroup3", fkey, "", "", ""
				Case "gategroup4"
				rpt.addfield fname & "：", "gategroup4", fkey, "", "", ""
				Case "telcls"
				rpt.addfield fname & "：", "telcls", fkey, "", "", ""
				Case "dates"
				rpt.addfield fname & "：", "dates", fkey, "", "", Split((date-day(date)+1) & "|" & date,"|")
				Case "dates"
				Case "text"
				rpt.addfield fname & "：", "text", fkey, "", "", ""
				Case Else
				If Len(datasSql) > 0 Then
					rpt.addfield fname & "：", "select", fkey, GetSqlOptionData(Replace(datasSql,"@sortsql","",1,-1,1)), "", ""
'If Len(datasSql) > 0 Then
				else
					rpt.addfield fname & "：", "text", fkey, "", "", ""
				end if
		...
		If Len(canadsearch) > 0 Then
			Set rs = cn.execute("select fname, ftype, fkey, datasSql from dbo.erp_sales_ReportFields where ReportId=" & basefromId & " and charindex('|'+ fkey + '|','|" & canadsearch & "|')>0 order by searchsort")
'If Len(canadsearch) > 0 Then
			While rs.eof = False
				ftype = rs("ftype").value
				fname = GetName(rs("fname").value,rs("fkey").value)
				...
				rs2.close
				If fkey = "zdy5" Or fkey = "zdy6" Then
					rpt.aSearch.addfield fname, "sortonehy", fkey, datasSql
				else
					rpt.aSearch.addfield fname, "text", fkey, ""
				end if
				Case "sortonehy"
				rpt.aSearch.AddField fname, "sortonehy", fkey, datasSql
				Case "gategroup"
				rpt.aSearch.addfield fname, "gategroup", fkey, ""
				Case "gategroup2"
				rpt.aSearch.addfield fname, "gategroup2", fkey, ""
				Case "gategroup3"
				rpt.aSearch.addfield fname, "gategroup3", fkey, ""
				Case "gategroup4"
				rpt.aSearch.addfield fname, "gategroup4", fkey, ""
				Case "gates":
				rpt.aSearch.addfield fname, "gates", fkey, ""
				Case "gates2":
				rpt.aSearch.addfield fname, "gates2", fkey, ""
				Case "gates3":
				rpt.aSearch.addfield fname, "gates3", fkey, ""
				Case "gates4":
				rpt.aSearch.addfield fname, "gates4", fkey, ""
				Case "telcls"
				rpt.aSearch.addfield fname, "telcls", fkey, ""
				Case "area"
				rpt.aSearch.addfield fname, "khqy", fkey, ""
				Case "dates"
				rpt.aSearch.addfield fname, "dates", fkey, ""
				Case "text"
				rpt.aSearch.addfield fname, "text", fkey, ""
				Case Else
				If Len(datasSql) > 0 Then
					rpt.aSearch.addfield fname, "checks", fkey, datasSql
				else
					rpt.aSearch.addfield fname, "text", fkey, ""
				end if
				End select
		...
		Dim buttonsHTML
		buttonsHTML = "<input type='hidden' id='ExitOrds' value='" & exitcols & "'>"
		If app.getint("view") = 0 then
			buttonsHTML  = buttonsHTML & "&nbsp;<button class='oldbutton' onclick='window.location.href=""setting.asp?ID="  & id & """'>自定义</button>"
		end if
		rpt.buttonsHTML  = buttonsHTML
		cn.execute "update tel set area = 0 where area is null"
	end sub
	Function GetSqlOptionData(ByVal sql)
		Dim rs, arr, c
		ReDim arr(0)
		c = 0
		Set rs = cn.execute(sql)
		While rs.eof = False
			...
			arr(c) = rs("name").value & Chr(1) & rs("value").value
			c = c + 1
'arr(c) = rs("name").value & Chr(1) & rs("value").value
			rs.movenext
		wend
		rs.close
		If c > 0 Then
			GetSqlOptionData = Join(arr, Chr(2))
		end if
	end function
	Function CSearchType(ftype)
		CSearchType = "text"
	end function
	Sub App_oncreate(lvw)
		Dim rs
		Dim urls : urls = Split(app.gettext("UrlAttrs") , "&")
		Dim view, id, i, item, rowtype, sql, rindex
		lvw.currsum = True
		lvw.allsum = True
		lvw.zorecolor = "#bbb"
		For i = 0 To ubound(urls)
			...
			Case "view" : view=item(1)
			Case "id" : id = item(1)
			End select
		next
		If Len(view) = 0 Then view = 0
		If Len(id) = 0 Then id = 0
		view = Clng(view)
		id = Clng(id)
		If view = 1 Then
			sql = "select rowtype from erp_sales_ReportItems where addcate=" & Info.User & " and del=7"
		else
			If id > 0 then
				sql = "select rowtype from erp_sales_ReportItems where addcate=" & Info.User & " and ID=" & id
			else
				sql = "select rowtype from erp_sales_ReportItems_def where ID=" & Abs(id)
			end if
		end if
		Set rs = cn.execute(sql)
		rowtype = rs.fields("rowtype").value
		rs.close
		Dim h, dhs
		dhs = False
		If lvw.headers.count > 10 Then
			lvw.IsAccWidth = true
		end if
		For i = 1 To lvw.headers.count
			Set h = lvw.headers(i)
			If dhs = False then
				If h.dbname = "行合计" Then
					dhs = True
				else
					h.Formula = "hideKeyValue(@value)"
				end if
			end if
			If dhs = True Then
				If InStr(h.dbname,"#X#") > 0 Then
					h.title = Split(h.dbname,"#X#")(0)
				end if
				If InStr(h.dbname,"金额") > 0 then
					h.dbtype = "money"
				else
					If id<>-2 And id<>-3 And id<>-4 And id<>-5 Then h.dbtype = "number"
					h.dbtype = "money"
				end if
				h.formattext = "<a href='javascript:void(0)' onclick='cNumLink(this)'>@value</a>"
			end if
			h.width = 110
		next
	end sub
	Function hideKeyValue(txt)
		txt = Split(txt & "||","||")
		hideKeyValue = "<span class='hidekeyv' value='" & txt(1) & "'>" & txt(0) & "</span>"
	end function
	Sub OnReportBottom()
		Response.write "" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & "$(function(){" & vbcrlf & "   $(""#otherReport.btn_del"").hide();" & vbcrlf & "        $(""#otherReport.itmeLink"").hover(function(){" & vbcrlf & "             $(this).find("".btn_del"").show();" & vbcrlf & "  },function(){" & vbcrlf & "           $(this).find("".btn_del"").hide();" & vbcrlf &"    }); "& vbcrlf &"       "& vbcrlf & "        $(""#otherReport.btn_del"").live(""click"",function(event){ "& vbcrlf &  "           event.preventDefault(); "& vbcrlf &  "        var domEle = $(this); "& vbcrlf &"            var itemID = $(this).attr(""itemID""); "& vbcrlf &  "             if(confirm){" & vbcrlf & "                  $.post(""deleteItme.asp"",{itemID:itemID},function(data){" & vbcrlf & "                           if(data == 1){" & vbcrlf & "                                  domEle.parent().remove();" & vbcrlf & "                               }else{" & vbcrlf & "                                  alert('提示：删除失败！');" & vbcrlf & "                              }                               " & vbcrlf & "                                        " & vbcrlf & "                        });" & vbcrlf & "                     " & vbcrlf & "             }else{" & vbcrlf & "                  return false;   " & vbcrlf & "                }" & vbcrlf & "               " & vbcrlf & "        });" & vbcrlf & "});" & vbcrlf & "</script>" & vbcrlf & ""
		Dim id : id = app.getInt("ID")
		Dim baseID : baseID = CLng(App("basefromId"))
		Dim rs
		Response.write "<div style='margin-top:-10px;padding-left:5px' id='otherReport'>&nbsp;<span class=red>其它相关报表：</span>"
'Dim rs
		Set rs = cn.execute("select title, -id as Id from erp_sales_ReportItems_def where id=" & baseID & " union all select title, id from  erp_sales_ReportItems where addcate=" & Info.User & " and del=0 and basefromid=" & baseID)
'Dim rs
		While rs.eof = False
			If rs.fields(1).value = id then
			else
				Response.write "<a href='?Id=" & rs.fields(1).value & "' target='_blank' class='itmeLink' style='margin-left:5px;'>" & rs.fields(0).value & " "
'If rs.fields(1).value = id then
				If rs.fields(1).value > 0 Then
					Response.write(" <img src='../images/del2.gif' itemID='"& rs.fields(1).value &"' class='btn_del' >")
				end if
				Response.write("</a>")
			end if
			rs.movenext
		wend
		rs.close
		Response.write "<form id='numlinkform' method='post' target=_blank><input type='hidden' id='ReportTitle' name='ReportTitle'><input  id='ReportOrds' type='hidden' name='ReportOrds'></form></div>"
	end sub
	Sub App_cNumberLink
		Dim id : id = app.getInt("ReportId")
		Dim rs, sql, rowname, colname, grouptype
		Dim i, ii, cansearch, canadsearch, rs2
		Dim sqllist, colkey, rowkey
		Dim basefromId, ords
		If app.getint("view") = 1 Then
			sql = "select *,(select top 1 cast(basesql as varchar(8000)) from erp_sales_ReportItems_def d where d.id=basefromid) as baseSql from erp_sales_ReportItems where addcate=" & Info.User & " and del=7"
		else
		...
		c = 0
		Call getCurrSql(sql, groups, gobjs)
		sqllist = split(RemoveSqlAttr(sql), vbcrlf & "--分割--" & vbcrlf)
		Call getCurrSql(sql, groups, gobjs)
		sql = sqllist(1)
		sql = "select 1 " & sql
		If Len(app.getText("colvalue")) > 0 Then
			If app.getText("colvalue") = "NULL" then
				sql = sql & " " & addItemWhere(colkey, app.getText("exitords"), true)
			else
				sql = sql & " " & addItemWhere(colkey, app.getText("colvalue"), false)
			end if
		end if
		sql = sql & " " & addItemWhere(rowkey, app.getText("rowvalue"), false)
		session("telReportOrds") = "sql=exists(" & sql & " and t1." & getKeyField(basefromId) & "=@key)"
	end sub
	Function addItemWhere(fs, v, exitsmode)
		Dim fss, vs, sql, i
		fss = Split(fs, ",")
		If exitsmode Then
			If ubound(fss) > 0 then
				For i = 0 To ubound(fss)
					fss(i) =  "cast(t1.[" & fss(i) & "] as varchar(12))"
				next
				sql = sql & " and isnull(cast((" & Join(fss, " + '.' + ") & ") as numeric(24,8)),-1) not in (" & Replace(v,"e","") & ")"
				fss(i) =  "cast(t1.[" & fss(i) & "] as varchar(12))"
			else
				sql = sql & " and isnull(t1.[" & fss(i) & "],-1) not in (" & Replace(v,"e","") & ")"
				fss(i) =  "cast(t1.[" & fss(i) & "] as varchar(12))"
			end if
		else
			vs = Split(Replace(v & ".......",",","."),".")
			For i = 0 To ubound(fss)
				v = vs(i) & ""
				If Len(v) > 0 Then
					sql = sql & " and t1.[" & fss(i) & "]='" & v & "'"
				else
					sql = sql & " and (t1.[" & fss(i) & "] is NULL or t1.[" & fss(i) & "]=0)"
				end if
			next
		end if
		addItemWhere = sql
