...
'c = Lcase(Mid(name, i, 1))
	...
	sort_jg=request.form("sort_jg")
	sort_jg_cg=request.form("sort_jg_cg")
	call setsort(41,sort4)
	call setsort(42,sort5)
	call setsort(43,sort6)
	call setsort(44,sort7)
	call setsort(10,sort10)
	call setsort(1202,sort_jg)
	call setsort(320173106,sort_jg_cg)
	conn.close
	set conn=nothing
	Response.write"<script language=javascript>alert('设置成功！');window.location='contract_cgjg.asp';</script>"
	call db_close : Response.end
