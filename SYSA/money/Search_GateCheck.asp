...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.clear
	action=saveRequestform("action")
	InputName=saveRequest("InputName")
	InputId=saveRequest("InputId")
	W3=SaveRequestUrl("W3")
	user_list=W3
	W1=request("W1")
	W2=request("W2")
	W3=request("W3")
	...
	if action="save" Then
		W1=saveRequestform("W1")
		W2=saveRequestform("W2")
		W3=saveRequestform("W3")
		IsAll=saveRequestform("IsAll")
		If IsAll="1" then
			W1=0
			W2=0
			W3=0
		...
		If W3<>"" then
			...
			Sql="select a.name from gate a  where a.ord in("&W3&") and a.del=1"
			Rs8.Open Sql,conn,1,1
			If Not Rs8.Eof Then
				Do While Not Rs8.Eof
					W3Name=W3Name&Rs8("name")&" "
					Rs8.MoveNext
				Loop
			end if
			Rs8.Close
		...
		Response.write "" & vbcrlf & "      <script language=""javascript"" type=""text/javascript"">" & vbcrlf & "               window.opener.GetUserVal("""
		Response.write InputId
		Response.write ""","""
		Response.write W3
		Response.write ""","""
		Response.write W3Name
		Response.write """);" & vbcrlf & "                winClose();" & vbcrlf & "             function winClose()" & vbcrlf & "             {" & vbcrlf & "                       try" & vbcrlf & "                     {" & vbcrlf & "                               window.opener=null;" & vbcrlf & "                             window.open('','_self');" & vbcrlf & "                                window.close();" & vbcrlf & "                 }catch(e)" & vbcrlf & "                       {}" & vbcrlf & "              }" & vbcrlf & "    </script>" & vbcrlf & "       "
	end if
...
'}" & vbcrlf & "    </script>" & vbcrlf & "       "
	...
	'Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "<script src= ""../Script/my_Search_GateCheck.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "//处理返回信息函数" & vbcrlf & "function GateCheckResponse(){" & vbcrlf & "      if(xmlHttpRequest.readyState == 4){" & vbcrlf & "             if(xmlHttpRequest.status == 200){" & vbcrlf & "                        var tempStr = xmlHttpRequest.responseText;" & vbcrlf & "                      if(tempStr.indexOf(""$$"")>0){" & vbcrlf & "                              window.opener.GetUserVal("""
	Response.write InputId
	Response.write """,tempStr.split(""$$"")[0].split(""|"")[0],tempStr.split(""$$"")[1].replace("" "",""""));" & vbcrlf & "                              if (!window.ActiveXObject && """
	Response.write InputId
	Response.write """ == ""gate_name_all"") { window.opener.gateall(); }" & vbcrlf & "                           winClose();" & vbcrlf & "                     }" & vbcrlf & "                       else{" & vbcrlf & "                           window.alert(""请选择销售人员"");" & vbcrlf & "                   }" & vbcrlf & "               }" & vbcrlf & "       }" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <form method=""post"" name=""demo""  action="""" id=""demo"" onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">人员选择</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "        <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""13%"" valign=""top""><div align=""right""><br>人员选择：</div></td>" & vbcrlf & "            <td width=""87%"">" & vbcrlf & "                        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "         <tr >" & vbcrlf & "                <td colspan=""4"">" & vbcrlf & "          "
	basesql="select ord, orgsid from gate where 1=1 "&str_w3&""
	Response.write CBaseUserTreeHtmlRadio(basesql,"", "","","W3",  "", "", "", share)
	Response.write " </td></tr>" & vbcrlf & "                     </table>" & vbcrlf & "                        </td>" & vbcrlf & "          </tr>" & vbcrlf & "  <tr>" & vbcrlf & "<td>&nbsp;</td>" & vbcrlf & "     <td align=""center"" class=""gray""><input type=""button"" name=""Submit42"" id=""GetVale"" value=""保存""  class=""page""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=""button"" name=""Submit42"" id=""w_close"" value=""取消""  onclick=""winClose()"" class=""page""/></td>" & vbcrlf & "     </tr>" & vbcrlf & "        </table></td>" & vbcrlf & "    </tr>" & vbcrlf & "  </form>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>"
