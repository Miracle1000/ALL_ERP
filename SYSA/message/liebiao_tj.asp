...
'bigsystemtype = ".mozi"
	...
	Response.write "" & vbcrlf & "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td colspan=""2""><a href=""###"" class=""AfterQuickSearch"" onClick=""document.getElementById('kh').disabled='';document.getElementById('kh').style.display='';document.getElementById('ht1').disabled='disabled';document.getElementById('ht1').style.display='none';""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a>           </td>" & vbcrlf & "           </tr>" & vbcrlf & "" & vbcrlf & "<tr><td><div align=""right"">短信状态选择：</div></td>" & vbcrlf & "<td onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & ""
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select * from errMessage where ord in (1,2,4,13,17,18,19,20,21)"
	rs7.open sql7,conn,1,1
	if not rs7.eof then
		do while not rs7.eof
			Response.write "" & vbcrlf & "  <input name=""A1"" type=""checkbox"" value="""
			Response.write rs7("errNum")
			Response.write """ />"
			Response.write rs7("errMgs")
			rs7.movenext
		loop
	end if
	rs7.close
	set rs7=nothing
	Response.write "" & vbcrlf & "" & vbcrlf & "      </td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff""><td><div align=""right"">发送人员选择：</div></td>" & vbcrlf & "  <td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & "</tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">发送号码：</div></td>" & vbcrlf & "         <td><select name=""S1"" >" & vbcrlf & "                          <option value=""1"">包含</option>" & vbcrlf & "                     <option value=""2"">不包含</option>" & vbcrlf & "                         <option value=""3"">等于</option>" & vbcrlf & "                           <option value=""4"">不等于</option>" & vbcrlf & "                         <option value=""5"">以..开始</option>" & vbcrlf & "                       <option value=""6"">以..结束</option>" & vbcrlf & "                       </select>" & vbcrlf & "                         <input name=""S2"" type=""text"" size=""15"" /></td>" & vbcrlf & "       </tr>" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">联系人：</div></td>" & vbcrlf & "        <td><select name=""G1"">" & vbcrlf & "           <option value=""1"">包含</option>" & vbcrlf & "           <option value=""2"">不包含</option>" & vbcrlf & "           <option value=""3"">等于</option>" & vbcrlf & "           <option value=""4"">不等于</option>" & vbcrlf & "           <option value=""5"">以..开始</option>" & vbcrlf & "           <option value=""6"">以..结束</option>" & vbcrlf & "         </select>" & vbcrlf & "               <input name=""G2"" type=""text"" size=""15"">"
	'"</td>" & vbcrlf & "  </tr>"& vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor=''"
	'ption value='3'>等于</option>""" & vbcrlf & "           <option value=""4"">不等于</option>" & vbcrlf & "           <option value=""5"">以..开始</option>" & vbcrlf & "           <option value=""6"">以..结束</option>" & vbcrlf & "         </select>" & vbcrlf & "             <input name=""C2"" type=""text"" size=""20""></td>" & vbcrlf & "  </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor"""
