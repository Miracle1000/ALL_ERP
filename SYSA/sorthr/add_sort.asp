...
'If Not rs.Eof Then
	...
	Cnid=SaveRequestUrlNum("cnid")
	OrderID=SaveRequestUrlNum("OrderID")
	TypeID=SaveRequestUrlNum("TypeID")
	tname = "hr_sort"
	If OrderID = 1021 Then
		tname = "hr_ret_type"
	end if
	...
	IF OrderID>0 Then
		set  Rs=conn.execute("select OrderName from M_OrderSettings where Id="& OrderID &"")
		If Not Rs.eof Then
			OrderName=Rs(0)
		else
			OrderName=""
	...
	title=""
	sortID=""
	If Action="edit" and cnid>0 and OrderId>0 Then
		Set Rs=server.CreateObject("adodb.recordset")
		SQL="select top 1 *  from " & tname & " Where cnid="&cnid&" and orderid="&OrderId&" and TypeID="& TypeID &" and del=0"
	...
	Class GetSort
		...
		Public Sub Initial()
			dim SortNum
			SortArr=""
			If IsNum(OrderID) Then
				If OrderID>0 Then
					If Cnid<>"0" and Cnid<>"" Then
						If Action="edit" Then
							SQLSort=" And Cnid<>"&Cnid&""
						end if
					else
						SQLSort=""
					end if
					SortNum=conn.execute("Select count(*) from " & tname & " where  OrderID="& OrderID &" and TypeID="& TypeID &" "&SQLSort&"  and Del=0")(0)
					SortArr="<script language=""javascript"" type=""text/javascript"">"&vbCrLf
					If SortNum>0 Then
						SortArr=SortArr&"var UserSortArr = new Array("& SortNum-1 &");"&vbCrLf
'If SortNum>0 Then
						Set Rs=server.CreateObject("adodb.recordset")
						Sql="Select * from " & tname & " where  OrderID="& OrderID &" and TypeID="& TypeID &" "&SQLSort&" and Del=0 order by px Desc"
						rs.open sql,conn,1,1
						If Not Rs.eof Then
							Dim i
							i=0
...
'End Class
	...
	Response.write "" & vbcrlf & "<script src= ""../Script/sr_add_sort.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & "" & vbcrlf & "<table width=""100%""  border=""0"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"">" & vbcrlf & "        <tr>" & vbcrlf & "          <td class=""resetElementHidden"" width=""5%"" height=""27""  background=""../images/contentbg.gIf""><div align=""center""><img src=""../images/contenttop.gIf""height=""27""> </div></td>" & vbcrlf & "          <td class=""resetUniqueTabtleTitle"" width=""95%""  background=""../images/contentbg.gIf""><strong><font color=""#1445A6"">单据"
	...
	Response.write PageTitle
	Response.write "设置</div></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr "
	If OrderID=1021 Then
		Response.write " style=""display:none"" "
	end if
	Response.write ">" & vbcrlf & "            <td width=""15%"" align=""right"" height=""33"">上级"
	Response.write PageTitle
	Response.write "：</td>" & vbcrlf & "            <td width=""85%"">" & vbcrlf & ""
	If CanChild Then
		Response.write "<p id=""SortP"">&nbsp;</P><input name=""sortid""   type=""hidden"" id=""sortid""  value="""& sortID &""">"&_
		...
		"<option value=0 selected=selected>根分类</option>"&_
		"</select>"
	end if
	Response.write "</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""15%"" align=""right"" height=""33"">"
	Response.write PageTitle
	Response.write "名称：</td>" & vbcrlf & "            <td width=""85%""><input name=""title"" type=""text"" id=""title"" value="""
	Response.write  title
	Response.write """ size=""20"" dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1至50个字之间"" ></td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""15%"" align=""right"" height=""33"">"
	Response.write PageTitle
	Response.write "排序：</td>" & vbcrlf & "            <td width=""85%""><input name=""px"" onfocus='this.select()' type=""text"" id=""px"" value="""
	Response.write  px
	Response.write """  onkeyup=""value=value.replace(/[^\d\.]/g,'')"" dataType=""Limit"" min=""1"" max=""9"" maxlength=""9"" msg=""必填""  size=""10"">" & vbcrlf & "              （排序框里只能输入数字，排序时将按照数字从大到小排序）</td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr>" & vbcrlf & "            <td height=""35"" bordercolorlight=""#000000"" bordercolordark=""#000000"" bordercolor=""#CCFFFF"" colspan=""2""><div align=""center"">" & vbcrlf & "                <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "                <input type=""button"" value=""重填"" class=""page"" name=""B2"" onclick=""document.getElementById('title').value=document.getElementById('title').defaultValue;document.getElementById('px').value=document.getElementById('px').defaultValue;"" />" & vbcrlf & "            </div></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </form>" & vbcrlf & "   </table></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "    <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "        <tr>" & vbcrlf & "          <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "        </tr>" & vbcrlf & "      </table></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</center>" & vbcrlf & "</div>" & vbcrlf & ""
	conn.Close
	Set conn = Nothing
