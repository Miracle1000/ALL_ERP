...
'bigsystemtype = ".mozi"
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "       <td><div align=""right"">产品名称：</div></td>" & vbcrlf & "                  <td><select name=""F1"">" & vbcrlf & "                      <option value=""1"">包含</option>" & vbcrlf & "                         <option value=""2"">不包含</option>" & vbcrlf & "                       <option value=""3"">等于</option>" & vbcrlf & "                           <option value=""4"">不等于</option>" & vbcrlf & "                         <option value=""5"">以..开始</option>" & vbcrlf & "                       <option value=""6"">以..结束</option>" & vbcrlf & "                       </select>" & vbcrlf & "                     <input name=""F2"" type=""text"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">拼音码：</div></td>" & vbcrlf & "                    <td><select name=""Z1"">" & vbcrlf & "                    <option value=""1"">包含</option>" & vbcrlf & "                         <option value=""2"">不包含</option>" & vbcrlf & "                         <option value=""3"">等于</option>" & vbcrlf & "                           <option value=""4"">不等于</option>" & vbcrlf & "                         <option value=""5"">以..开始</option>" & vbcrlf & "                       <option value=""6"">以..结束</option>" & vbcrlf & "                     </select>" & vbcrlf & "                     <input name=""Z2"" type=""text"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "     <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">产品编号：</div></td>" & vbcrlf & "         <td><select name=""G1"">" & vbcrlf & "           <option value=""1"">包含</option>" & vbcrlf & "           <option value=""2"">不包含</option>" & vbcrlf & "           <option value=""3"">等于</option>" & vbcrlf & "           <option value=""4"">不等于</option>" & vbcrlf & "           <option value=""5"">以..开始</option>" & vbcrlf & "           <option value=""6"">以..结束</option>" & vbcrlf & "         </select>" & vbcrlf & "        <input name=""G2"" type=""text"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "       <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "      <td><div align=""right"">产品型号：</div></td>" & vbcrlf & "      <td><select name=""P1"">" & vbcrlf & "           <option value=""1"">包含</option>" & vbcrlf & "           <option value=""2"">不包含</option>" & vbcrlf & "           <option value=""3"">等于</option>"& vbcrlf &        "    <option value=""4"">不等于</option> "& vbcrlf &          "  <option value=""5"">以..开始</option>" & vbcrlf &            "<option value=""6"">以..结束</option> "& vbcrlf &          "</select>" & vbcrlf &         " <input name=""P2"" type=""text"" size=""15""></td> "& vbcrlf &   "</tr>" & vbcrlf & "  "
	if ZBRuntime.MC(17000) then
		Response.write "" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">库存下限：</div></td>" & vbcrlf & "      <td><select name=""I1"">" & vbcrlf & "           <option value=""1"">大于</option>" & vbcrlf & "<option value=""2"">大于等于</option>" & vbcrlf & "           <option value=""3"">等于</option>" & vbcrlf & "           <option value=""4"">小于等于</option>" & vbcrlf & "                   <option value=""5"">小于</option>" & vbcrlf & "         </select>" & vbcrlf & "              <input name=""I2"" type=""text"" size=""15""onpropertychange=""formatData(this,'number');""></td>" & vbcrlf &          "   </tr> "& vbcrlf &          "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'""> "& vbcrlf &            "  <td><div align=""right"">库存上限：</div></td> "& vbcrlf &     "  <td><select name=""J1"">" & vbcrlf & "           <option value=""1"">大于</option>" & vbcrlf & "                  <option value=""2"">大于等于</option>" & vbcrlf & "           <option value=""3"">等于</option>" & vbcrlf & "           <option value=""4"">小于等于</option>" & vbcrlf & "                   <option value=""5"">小于</option>" & vbcrlf & "         </select>" & vbcrlf & "             <input name=""J2"" type=""text"" size=""15"" onpropertychange=""formatData(this,'number');""></td>" & vbcrlf & "         </tr>" & vbcrlf & "  "
	end if
	Response.write "" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "            <td><div align=""right"">产品说明：</div></td>" & vbcrlf & "      <td><select name=""T1"">" & vbcrlf & "           <option value=""1"">包含</option>" & vbcrlf & "  <option value=""2"">不包含</option>" & vbcrlf & "           <option value=""3"">等于</option>" & vbcrlf & "           <option value=""4"">不等于</option>" & vbcrlf & "           <option value=""5"">以..开始</option>" & vbcrlf & "           <option value=""6"">以..结束</option>" & vbcrlf & "         </select>" & vbcrlf & "         <input name=""T2"" type=""text"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "      <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">产品参数：</div></td>" & vbcrlf & "      <td><select name=""U1"">" & vbcrlf & "           <option value=""1"">包含</option>" & vbcrlf & "           <option value=""2"">不包含</option>" & vbcrlf & "           <option value=""3"">等于</option>" & vbcrlf & "           <option value=""4"">不等于</option>" & vbcrlf & "           <option value=""5"">以..开始</option>" & vbcrlf & "           <option value=""6"">以..结束</option>" & vbcrlf & "         </select>" & vbcrlf & "                <input name=""U2"" type=""text"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "      <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">产品备注：</div></td>" & vbcrlf & "      <td><select name=""E1"">" & vbcrlf & "           <option value=""1"">包含</option>" & vbcrlf & "           <option value=""2"">不包含</option>" & vbcrlf & "           <option value=""3"">等于</option>" & vbcrlf & " <option value=""4"">不等于</option>" & vbcrlf & "           <option value=""5"">以..开始</option>" & vbcrlf & "           <option value=""6"">以..结束</option>" & vbcrlf & "         </select>" & vbcrlf & "          <input name=""E2"" type=""text"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "</tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">主供应商：</div></td>" & vbcrlf & "      <td><select name=""GY1"">" & vbcrlf & "           <option value=""1"">包含</option>" & vbcrlf &"           <option value=""2"">不包含</option>" & vbcrlf & "           <option value=""3"">等于</option>" & vbcrlf & "           <option value=""4"">不等于</option>" & vbcrlf & "           <option value=""5"">以..开始</option>" & vbcrlf & "           <option value=""6"">以..结束</option>" & vbcrlf & "         </select>" & vbcrlf & "             <input name=""GY2"" type=""text"" size=""15""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  "
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title,name,sort,gl from zdy where sort1=21 and set_open=1 and js=1 and sort=2 order by gate1 asc "
	rs.open sql,conn,1,1
	if rs.eof then
	else
		do until rs.eof
	...
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "        <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">下限紧急程度：</div></td>" & vbcrlf & "          <td><select name=""N1"">" & vbcrlf & "           <option value=""1"">大于</option>" & vbcrlf &"            <option value=""2"">大于等于</option>" & vbcrlf & "           <option value=""3"">等于</option>" & vbcrlf & "           <option value=""4"">小于等于</option>" & vbcrlf & "                   <option value=""5"">小于</option>" & vbcrlf & "         </select>" & vbcrlf & "              <input name=""N2"" type=""text"" size=""14"" onpropertychange=""formatData(this,'number');"">%</td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">上限紧急程度：</div></td>" & vbcrlf & "          <td><select name=""N3"">" & vbcrlf &            "<option value=""1"">大于</option>" & vbcrlf &                 "  <option value=""2"">大于等于</option>" & vbcrlf &         "   <option value=""3"">等于</option> "& vbcrlf &         "   <option value=""4"">小于等于</option> "& vbcrlf &              "      <option value=""5"">小于</option> "& vbcrlf &       "   </select>" & vbcrlf & "             <input name=""N4"" type=""text"" size=""14"" onpropertychange=""formatData(this,'number');"">%</td>" & vbcrlf & "  </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td width=""10%"">&nbsp;</td>" & vbcrlf & "     <td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td>" & vbcrlf & "        </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	conn.close
	set conn=nothing
