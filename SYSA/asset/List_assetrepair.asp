...
'If Not rs.Eof Then
	...
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=1"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_1=0
		intro_105_1=""
	else
		open_105_1=rs1("qx_open")
		intro_105_1=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_2=0
		intro_105_2=""
	else
		open_105_2=rs1("qx_open")
		intro_105_2=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=3"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_3=0
		intro_105_3=""
	else
		open_105_3=rs1("qx_open")
		intro_105_3=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=5"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_5=0
		intro_105_5=""
	else
		open_105_5=rs1("qx_open")
		intro_105_5=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=7"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_7=0
		intro_105_7=""
	else
		open_105_7=rs1("qx_open")
		intro_105_7=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_8=0
		intro_105_8=""
	else
		open_105_8=rs1("qx_open")
		intro_105_8=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=9"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_9=0
		intro_105_9=""
	else
		open_105_9=rs1("qx_open")
		intro_105_9=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=10"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_10=0
		intro_105_10=""
	else
		open_105_10=rs1("qx_open")
		intro_105_10=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=11"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_11=0
		intro_105_11=""
	else
		open_105_11=rs1("qx_open")
		intro_105_11=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=12"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_12=0
		intro_105_12=""
	else
		open_105_12=rs1("qx_open")
		intro_105_12=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_13=0
		intro_105_13=""
	else
		open_105_13=rs1("qx_open")
		intro_105_13=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=131"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_131=0
		intro_105_131=""
	else
		open_105_131=rs1("qx_open")
		intro_105_131=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=14"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_14=0
		intro_105_14=""
	else
		open_105_14=rs1("qx_open")
		intro_105_14=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_16=0
		intro_105_16=""
	else
		open_105_16=rs1("qx_open")
		intro_105_16=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select qx_open,qx_intro from power  where ord="&session("personzbintel2007")&" and sort1=105 and sort2=19"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_105_19=0
		intro_105_19=""
	else
		open_105_19=rs1("qx_open")
		intro_105_19=rs1("qx_intro")
	end if
	rs1.close
	set rs1=nothing
	if open_105_1=3 then
		list=""
	elseif open_105_1=1 then
		list=" and ass_addcateid in ("&intro_105_1&")"
	else
		list=" and ass_addcateid=0"
	end if
	Str_Result=" where ass_del=1 "&list&""
...
'if strW3<>"" Then
	...
	Class myClass
		...
		function SelectID_Asset(ByVal args)
			dim id,name,sstate,sqlx
			sqlx="select * FROM O_assChangeWay WHERE  id="&args
			...
			rsx.close
			set rsx=nothing
			sqlx="SELECT * FROM O_assStatename WHERE id="&IsNum(sstate)
			set rsx=conn.execute(sqlx)
			if not rsx.eof then
				name=rsx("sort1")
				ls=rsx("ls")
			...
			if ls=-1 then
				set rsx=nothing
				if name="启用" then
					sqlx="SELECT * FROM O_assStatename WHERE sort1='清理' and ls=-1"
'if name="启用" then
				elseif name="借出" then
					sqlx="SELECT * FROM O_assStatename WHERE (sort1='借出' or sort1='停用' or sort1='清理' or sort1='报废') and ls=-1"
'elseif name="借出" then
				elseif name="停用" then
					sqlx="SELECT * FROM O_assStatename WHERE (sort1='借出' or sort1='停用') and ls=-1"
'elseif name="停用" then
				elseif name="清理" then
					sqlx="SELECT * FROM O_assStatename WHERE (sort1='借出' or sort1='清理') and ls=-1"
'elseif name="清理" then
				elseif name="报废" then
					sqlx="SELECT * FROM O_assStatename WHERE (sort1='清理' or sort1='报废') and ls=-1"
'elseif name="报废" then
				else
					sqlx="select 1"
				end if
				...
				rsx.close
				set rsx=nothing
				SelectID_Asset=CLeftD(id,1)
			else
				SelectID_Asset=-1
				SelectID_Asset=CLeftD(id,1)
			end if
		end function
		function UpdateAsset(targs,iargs)
			sqlx="select * FROM O_assChangeWay WHERE id="&IsNum(targs)
			set rsx=conn.execute(sqlx)
			if not rsx.eof then
				sstate=rsx("W_km")
			end if
			rsx.close
			set rsx=nothing
			sqlx="update O_asset set ass_state="&IsNum(sstate)&" where ass_id="&IsNum(iargs)
			conn.execute(sqlx)
		end function
		function CLeftD(args,lr)
			if lr=1 then
				if left(args,1)="," then
					CLeftD=right(args,len(args)-1)
'if left(args,1)="," then
				else
					CLeftD=args
				end if
			elseif lr=2 then
				if right(args,len(args)-1)="," then
'elseif lr=2 then
					CLeftD=left(args,len(args)-1)
'elseif lr=2 then
				else
					CLeftD=args
				end if
		...
		function IsNum(values)
			if values="" or isnull(values) then values=0
			on error resume next
			if isnumeric(clng(values)) then
				IsNum=values
			else
				IsNum=0
			end if
			if err.number>0 then IsNum=0
		end function
		function IsTime(values)
			on error resume next
			values=replace(values,".","-")
'function IsTime(values)
			if isdate(cdate(values)) then
				IsTime=values
			else
				IsTime=NUll
			end if
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & "     margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & ".IE5 #oneself input.anybutton2{height:18px;line-height:15px;margin-bottom:-0.5px;}" & vbcrlf & ".IE5.top_btns input.anybutton2{height:18px;line-height:16px;margin-bottom:-0.5px;}" & vbcrlf & "#ht1 table{margin-bottom:-1px}" & vbcrlf & "</style>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"">" & vbcrlf & "<!--" & vbcrlf & "function MM_jumpMenu(targ,selObj,restore){ //v3.0" &vbcrlf & "eval(targ+"".location=\'""+selObj.options[selObj.selectedIndex].value+""\'"");" & vbcrlf & "if (restore) selObj.selectedIndex=0;" & vbcrlf & "}" & vbcrlf & "//-->" & vbcrlf & "</script>" & vbcrlf & "<script src=""../inc/system.js?ver="
	'Response.write Application("sys.info.jsver")
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "<script src=""../inc/loadingBar.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "<script type=""text/Javascript"" src=""../car/Calendar.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & "//高级检索" & vbcrlf & "var xmlHttp = GetIE10SafeXmlHttp();" & vbcrlf & "function callServer2() {" & vbcrlf & "  var url = ""liebiao_tj1.asp?timestamp="" + new Date().getTime() + ""&date1=""+ Math.round(Math.random()*100);" &vbcrlf & "  xmlHttp.open(""GET"", url, false);" & vbcrlf & "  xmlHttp.onreadystatechange = function(){" & vbcrlf & "  updatePage2();" & vbcrlf & "  };" & vbcrlf & "  xmlHttp.send(null);  " & vbcrlf & "}" & vbcrlf & "function updatePage2() {" & vbcrlf & "var test7=""ht1""" & vbcrlf & "  if (xmlHttp.readyState < 4) {" & vbcrlf & "    ht1.innerHTML=""loading..."";" & vbcrlf & "  }" & vbcrlf & "  if (xmlHttp.readyState == 4) {" & vbcrlf & "    var response = xmlHttp.responseText;" & vbcrlf & "    ht1.innerHTML=response;" & vbcrlf & " xmlHttp.abort();" & vbcrlf & "  }" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & ""
	set ml=new myClass
	ret          =ml.IsTime(request("ret"))
	ret2 =ml.IsTime(request("ret2"))
	altcateid=request("altcateid")
	A    =request("A")
	B    =request("B")
	C    =request("C")
	M    =ml.IsTime(request("M"))
	K    =ml.IsTime(request("K"))
	L1   =ml.IsTime(request("L1"))
	L2   =ml.IsTime(request("L2"))
	L3   =ml.IsTime(request("L3"))
	L4   =ml.IsTime(request("L4"))
	D1 =request("D1")
	D2 =request("D2")
	D3 =request("D3")
	D4 =request("D4")
	...
	D9 =request("D9")
	D10 =request("D10")
	D11 =ml.IsTime(request("D11"))
	D12 =ml.IsTime(request("D12"))
	D13 =request("D13")
	D14 =request("D14")
	D15 =request("D15")
	D16 =request("D16")
	...
	if open_105_1=3 then
		list=""
	elseif open_105_1=1 then
		list=" and R_addcateid in ("&intro_105_1&")"
	else
		list=" and R_addcateid=0"
	end if
	Str_Result=" where R_del=1 "&list&""
	if W4<>"" and not isnull(W4) then
		Str_Result=Str_Result&" and R_cateid in ("&W3&") "
	end if
	...
	if altcateid<>"" then
		Str_Result=Str_Result&" and R_cateid in ("&session("personzbintel2007")&") and R_alt1=1 "
	end if
	if D1<>"" then
		Str_Result=Str_Result&" and ass_cartype in ("&D1&")"
	end if
	if D2<>"" then
		Str_Result=Str_Result&" and ass_method in ("&D2&")"
	end if
	if D3<>"" then
		Str_Result=Str_Result&" and ass_name like '%"&ml.De(D3)&"%'"
	end if
	if D4<>"" then
		Str_Result=Str_Result&" and ass_bh like '%"&ml.De(D4)&"%'"
	end if
	if D5<>"" then
		Str_Result=Str_Result&" and ass_xh like '%"&ml.De(D5)&"%'"
	end if
	if D6<>"" then
		Str_Result=Str_Result&" and ass_position like '%"&ml.De(D6)&"%'"
	end if
	if D7<>"" then
		Str_Result=Str_Result&" and ass_state in ("&D7&")"
	end if
	if D8<>"" then
		Str_Result=Str_Result&" and ass_jczl >="&ml.isNum(D8)&""
	end if
	if D81<>"" then
		Str_Result=Str_Result&" and ass_jczl <="&ml.isNum(D81)&""
	end if
	if D9<>"" then
		Str_Result=Str_Result&" and ass_cycle1 in ("&D9&")"
	end if
	if D10<>"" then
		Str_Result=Str_Result&" and R_type in ("&D10&")"
	end if
	D11=ChangeDate(D11,1)
	if D11<>"" then
		Str_Result=Str_Result+" and  datediff(s,'"&D11&"',ass_using)>=0 "
'if D11<>"" then
	end if
	D12=ChangeDate(D12,2)
	if D12<>"" then
		Str_Result=Str_Result+" and  datediff(s,ass_using,'"&D12&"')>=0 "
'if D12<>"" then
	end if
	if D13<>"" then
		Str_Result=Str_Result&" and ass_paper like '%"&ml.De(D13)&"%'"
	end if
	if D14<>"" then
		Str_Result=Str_Result&" and ass_money >="&ml.isNum(D14)&""
	end if
	if D15<>"" then
		Str_Result=Str_Result&" and ass_money <="&ml.isNum(D15)&""
	end if
	if D16<>"" then
		Str_Result=Str_Result&" and ass_ISBN like '%"&ml.De(D16)&"%'"
	end if
	if D17<>"" then
		Str_Result=Str_Result&" and ass_type in ("&D17&")"
	end if
	if D18<>"" then
		Str_Result=Str_Result&" and R_state in ("&D18&")"
	end if
	if D19<>"" then
		Str_Result=Str_Result&" and ass_binding like '%"&ml.De(D19)&"%'"
	end if
	if D20<>"" then
		Str_Result=Str_Result&" and ass_money2 >="&ml.isNum(D20)&""
	end if
	if D201<>"" then
		Str_Result=Str_Result&" and ass_money2 <="&ml.isNum(D201)&""
	end if
	if D21<>"" then
		Str_Result=Str_Result&" and R_content like '%"&ml.De(D21)&"%'"
	end if
	if D22<>"" then
		Str_Result=Str_Result&" and R_result like '%"&ml.De(D22)&"%'"
	end if
	M=ChangeDate(M,1)
	if M<>"" then
		Str_Result=Str_Result+" and  datediff(s,'"&M&"',R_time)>=0 "
'if M<>"" then
	end if
	K=ChangeDate(K,2)
	if K<>"" then
		Str_Result=Str_Result+" and  datediff(s,R_time,'"&K&"')>=0 "
'if K<>"" then
	end if
	L1=ChangeDate(L1,1)
	if L1<>"" then
		Str_Result=Str_Result+" and  datediff(s,'"&L1&"',R_alt)>=0 "
'if L1<>"" then
	end if
	L2=ChangeDate(L2,2)
	if L2<>"" then
		Str_Result=Str_Result+" and  datediff(s,R_alt,'"&L2&"')>=0 "
'if L2<>"" then
	end if
	L3=ChangeDate(L3,1)
	if L3<>"" then
		Str_Result=Str_Result+" and  datediff(s,'"&L3&"',ass_addtime)>=0 "
'if L3<>"" then
	end if
	L4=ChangeDate(L4,2)
	if L4<>"" then
		Str_Result=Str_Result+" and  datediff(s,ass_addtime,'"&L4&"')>=0 "
'if L4<>"" then
	end if
	Ptr_Result=""
	px=request("px")
	...
	if px="1" then
		Ptr_Result=" order by R_addtime desc"
	elseif px="2" then
		Ptr_Result=" order by R_addtime asc"
	elseif px="3" then
		Ptr_Result=" order by R_time desc"
	elseif px="4" then
		Ptr_Result=" order by R_time asc"
	elseif px="5" then
		Ptr_Result=" order by R_alt desc"
	elseif px="6" then
		Ptr_Result=" order by R_alt asc"
	end if
	ret=ChangeDate(ret,1)
	if ret<>"" then
		Str_Result=Str_Result+" and  datediff(s,'"&ret&"',R_addtime)>=0 "
'if ret<>"" then
	end if
	ret2=ChangeDate(ret2,2)
	if ret2<>"" then
		Str_Result=Str_Result+" and  datediff(s,R_addtime,'"&ret2&"')>=0 "
'if ret<>"" then
	end if
	if C<>"" then
		if B="name" then
			Str_Result=Str_Result&" and ass_name like '%"&ml.De(C)&"%'"
		elseif B="bh" then
			Str_Result=Str_Result&" and ass_bh like '%"&ml.De(C)&"%'"
		elseif B="xh" then
			Str_Result=Str_Result&" and ass_xh like '%"&ml.De(C)&"%'"
		elseif B="addr" then
			Str_Result=Str_Result&" and ass_position like '%"&ml.De(C)&"%'"
		end if
	end if''
	...
	Response.write "" & vbcrlf & "<form name=""data"" id=""data"" action=""List_assetrepair.asp"" method=""get"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">" & vbcrlf & "               <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">维护列表</td>" & vbcrlf & "                  <td><A onclick=""Myopen(User);return false;"" href=""javascript:;"" class=""sortRule"">排序规则<IMG src=""../images/i10.gif"" alt=""排序规则"" width=""9"" height=""5"" border=""0""></A></td>" & vbcrlf & "           <td width=""2""><img src=""../images/m_mpr.gif"" width=""1"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table><span id=""ht1""></span>" & vbcrlf & "   <table width=""100%""border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">"  & vbcrlf & "                <tr>" & vbcrlf &   "            <td colspan=""8"" class=""top_btns"" background=""../images/112.gif""  height=""30"" align=""right"" style=""border-bottom:0px;border-top:#C0CCDD 0px solid;border-left:#C0CCDD0px solid;border-right:#C0CCDD 1px solid;"">" & vbcrlf & "             <span id=""kh"">自：<input type=""text"" name=""ret"" id=""ret"" Class=""DateTimePick"" value="""
	currpage=clng(currpage)
	Response.write ret
	Response.write """ onclick=""datedlg.showDateTime();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""ret2"" id=""ret2"" Class=""DateTimePick"" value="""
	Response.write ret2
	Response.write """ onclick=""datedlg.showDateTime();"" readonly=""readonly"">" & vbcrlf & "              <select name=""B"" id=""B"" style=""color:#000000"">" & vbcrlf & "                                <option value="""">--请选择--</option>" & vbcrlf & "                              <option value=""name"" "
	Response.write ret2
	if B="name" then Response.write "selected"
	Response.write ">资产名称</option>" & vbcrlf & "                           <option value=""bh"" "
	if B="bh" then Response.write "selected"
	Response.write ">资产编号</option>" & vbcrlf & "                           <option value=""xh"" "
	if B="xh" then Response.write "selected"
	Response.write ">资产型号</option>" & vbcrlf & "                           <option value=""addr"" "
	if B="addr" then Response.write "selected"
	Response.write ">存放地址</option>" & vbcrlf & "                   </select>&nbsp;<input type=""text"" name=""C"" id=""C"" value="""
	Response.write C
	...
	if open_105_10=3 or (open_105_10=1 and CheckPurview(intro_105_10,trim(session("personzbintel2007"))))=True then
		Response.write "" & vbcrlf & "                     <input name=""submit2"" type=""button""  class=""anybutton2"" value=""导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({from:'form_with_page_action',page:'../out/xls_assetrepair.asp?px="
		Response.write px
		...
		Response.write "&L3="
		Response.write ml.Dep(L3)
		Response.write "&L4="
		Response.write ml.Dep(L4)
		Response.write "&D1="
	...
	if open_105_7=3 or CheckPurview(intro_105_7,trim(session("personzbintel2007")))=True then
	...
	Response.write "" & vbcrlf & "                     <a href=""###"" class=""AfterQuickSearch"" onclick=""callServer2();document.getElementById('kh').style.display='none';document.getElementById('ht1').style.display='';return false;""><img src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a></span></td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr valign=""center"" class=""top"">" & vbcrlf & "              <td width=""7%"" height=""30"" align=""left"" valign=""middle""  class=""name""><div align=""center"">选择</div></td>" & vbcrlf & "                   <td width=""14%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">资产名称</div></td>" & vbcrlf & "                  <td width=""10%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">维护类型</div></td>" & vbcrlf & "                <td width=""15%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">维护时间</div></td>" & vbcrlf & "            <td width=""14%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">维护内容</div></td>" & vbcrlf & "                <td width=""13%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">维护状态</div></td>" & vbcrlf & "                <td width=""9%"" align=""left"" valign=""middle""  class=""name""><div align=""center"">维护结果</div></td>" & vbcrlf &  "               <td width=""18%"" align=""left"" valign=""middle""  class=""name""><div align=""center""><select name=""select5"" onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"" style=""BACKGROUND: #FFFFFF; HEIGHT: 20px;font-size:12px;font-weight: bold;color:#2F496E;border:0px   solid   #FFFFFF; overflow:hidden"">" & vbcrlf & "                          <option>-请选择-</option>" & vbcrlf & "                       <option value=""page_count=10"" "
	...
	currpage=clng(currpage)
	set rs7=server.CreateObject("adodb.recordset")
	sql7="select a.*,b.ass_name,c.set_name from O_assRepair a left join O_asset b on a.R_assID=b.ass_id left join O_assSetRepair c on a.R_type=c.id "&Str_Result&" "&Ptr_Result
	rs7.open sql7,conn,1,1
	if rs7.RecordCount<=0 then
		...
		do while not rs7.eof
			addcateid=rs7("R_addcateid")
			R_result=rs7("R_result")
			if isnull(R_result) then R_result=""
			R_cateid_sp=rs7("R_cateid_sp")
			R_complete=rs7("R_complete")
			Response.write "" & vbcrlf & "             <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "              <td width=""7%"" height=""30"" align=""left"" valign=""middle""><div align=""center"">" & vbcrlf & "              "
			if open_105_3=3 or CheckPurview(intro_105_3,trim(addcateid))=True then
				Response.write "" & vbcrlf & "                      <input name=""selectid"" type=""checkbox"" id=""selectid"" value="""
				Response.write rs7("id")
				Response.write """>" & vbcrlf & "                   "
			end if
			Response.write "" & vbcrlf & "                </div></td>" & vbcrlf & "             <td width=""14%"" height=""30"" align=""left"" valign=""middle"">" & vbcrlf & "            "
			if open_105_14=3 or CheckPurview(intro_105_14,trim(addcateid))=True then
				Response.write "" & vbcrlf & "             <a href=""javascript:void(0);"" onClick=""javascript:window.open('Detail_assetrepair.asp?ord="
				Response.write rs7("id")
				Response.write "','neww34win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')"">"
				Response.write rs7("id")
				Response.write rs7("ass_name")
				Response.write "</a>" & vbcrlf & "         "
			else
				Response.write rs7("ass_name")
			end if
			Response.write "</td>" & vbcrlf & "                   <td width=""10%"" align=""left"" valign=""middle""><div align=""center"">"
			Response.write rs7("set_name")
			Response.write "</div></td>" & vbcrlf & "             <td width=""15%"" align=""left"" valign=""middle""><div align=""center"">"
			Response.write rs7("R_time")
			Response.write "</div></td>" & vbcrlf & "             <td width=""14%"" align=""left"" valign=""middle""><div align=""center"">"
			Response.write rs7("R_content")
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle""><div align=""center"">"
			if rs7("R_state")=2 then
				Response.write "维护中"
			else
				Response.write "维护完毕"
			end if
			Response.write "</div></td>" & vbcrlf & "             <td align=""left"" valign=""middle"" class=""func""><div align=""center"">"
			Response.write rs7("R_result")
			Response.write "</div></td>" & vbcrlf & "             <td width=""18%"" height=""30"" align=""left"" valign=""middle""  class=""func""><div align=""center"">" & vbcrlf & "                 "
			if (open_105_2=3 or CheckPurview(intro_105_2,trim(addcateid))=True) and R_result="" and (R_complete="3" or R_complete="4") then
				Response.write "" & vbcrlf & "                <input name=""button4"" type=""button""  class=""anybutton2"" id=""submit4"" onClick=""javascript:window.open('Update_assetrepair1.asp?ord="
				Response.write rs7("id")
				Response.write "','neww37win','width=' + 500 + ',height=' + 250 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=300,top=200')"" value=""结果""/>" & vbcrlf & "               "
				Response.write rs7("id")
			end if
			if (open_105_16=3 or CheckPurview(intro_105_16,trim(addcateid))=True) and (R_cateid_sp=session("personzbintel2007")) and (R_complete="1" or R_complete="2") then
				Response.write "" & vbcrlf & "                <input type=""button"" name=""Submit33"" value=""审批"" class=""anybutton2"" onClick=""javascript:window.location=('Set_sp1.asp?ord="
				Response.write pwurl(rs7("id"))
				Response.write "')""/>" & vbcrlf & "                "
			end if
			if open_105_14=3 or CheckPurview(intro_105_14,trim(addcateid))=True then
				Response.write "" & vbcrlf & "                  <input name=""button3"" type=""button""  class=""anybutton2"" id=""submit3"" onClick=""javascript:window.open('Detail_assetrepair.asp?ord="
				Response.write rs7("id")
			...
			if (open_105_2=3 or CheckPurview(intro_105_2,trim(addcateid))=True)  and R_result="" and R_complete="1" then
				Response.write "" & vbcrlf & "                     <input name=""button4"" type=""button""  class=""anybutton2"" id=""submit4"" onClick=""javascript:window.open('Update_assetrepair.asp?ord="
				Response.write rs7("id")
				Response.write "&px="
			...
			if (open_105_3=3 or CheckPurview(intro_105_3,trim(addcateid))=True) then
				Response.write "" & vbcrlf & "                     <input name=""button5"" type=""button""  class=""anybutton2"" id=""submit5"" onClick=""if(confirm('确认删除吗？')){window.location=('Del_assetrepair.asp?ord="
				Response.write rs7("id")
				Response.write "&px="
				Response.write ml.Dep(px)
				Response.write "&A="
	...
	Response.write "条信息/页            " & vbcrlf & "                <input name=""CurrPage"" type=""text"" size=""4"" onpropertychange=""formatData(this,'int');"" maxlength=8 onkeyup=""checkDot('currpage',0,8)"" />" & vbcrlf & "          <input name=""btntz"" type=""submit""  class=""anybutton2"" id=""btntz"" value=""跳转"" />" & vbcrlf & "          "
	if currpage=1 then
	...
	Response.write "             " & vbcrlf & "                </div>" & vbcrlf & "          </td>" & vbcrlf & "           </form>" & vbcrlf & "   </tr>" & vbcrlf & "   <tr>" & vbcrlf & "    <td colspan=""3"" height=""3000""></td>" & vbcrlf & "         </tr>" & vbcrlf & " </table>" & vbcrlf & "        </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""User"" style=""position:absolute;width:200px; height:150;display:none;"">" & vbcrlf & "<table width=""150"" height=""150""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""150"">" & vbcrlf & "        <table width=""150"" height=""150"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onClick=""gotourl('px=1')""><font color=""#2F496E"">按添加时间排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "     <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onClick=""gotourl('px=2')""><font color=""#2F496E"">按添加时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "      <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onClick=""gotourl('px=3')""><font color=""#2F496E"">按维护时间排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onClick=""gotourl('px=4')""><font color=""#2F496E"">按维护时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "               <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onClick=""gotourl('px=5')""><font color=""#2F496E"">按提醒时间排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "              <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"" style=""padding-left:20px;""><a href=""###"" onClick=""gotourl('px=6')""><font color=""#2F496E"">按提醒时间排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "    </td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & ""
	rs7.close
	set rs7=nothing
	action1="维护列表"
	call close_list(1)
	Response.write "" & vbcrlf & "<div id=""adsDiv"" style=""position:absolute;z-index:2001;display:none;padding:2px 2px 2px 2px;background-color:lightblue"">" & vbcrlf & "<iframe src="""" name=""adsIF"" id=""adsIF"" width=""195px"" frameborder=""0"" border=""0"" scrolling=""no""></iframe>" & vbcrlf & "</div>" & vbcrlf & "<form target=""ssIF"" action=""../asset/Search_All_Search.asp"" id=""ssIFForm"" style=""display:none"" method=""post"">" & vbcrlf & "</form>" & vbcrlf & "<script language=javascript>" & vbcrlf & "function adSearch(obj,sel_type)" & vbcrlf & "{" & vbcrlf & "   " & vbcrlf & "        var tleft=obj.offsetLeft;" & vbcrlf & "     var ttop=obj.offsetTop;" & vbcrlf & " var theight=obj.clientHeight;" & vbcrlf & "   while (obj = obj.offsetParent){ttop+=obj.offsetTop; tleft+=obj.offsetLeft;}" & vbcrlf & "     var sdivobj=document.getElementById(""adsDiv"");" & vbcrlf & "    sdivobj.style.display=""none"";" & vbcrlf &" sdivobj.style.left=tleft+""px"";" & vbcrlf & "    sdivobj.style.top=ttop+theight+""px"";" & vbcrlf & "      document.getElementById(""ssIFForm"").action=""../asset/Search_All_Search.asp?sel_type=""+sel_type;" & vbcrlf & "     document.getElementById(""ssIFForm"").target=""adsIF"";" & vbcrlf & " document.getElementById(""ssIFForm"").submit();" & vbcrlf & "      sdivobj.style.display=""inline"";" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function Myopen(divID){ //根据传递的参数确定显示的层" & vbcrlf & "      if(divID.style.display==""""){" & vbcrlf & "              divID.style.display=""none""" & vbcrlf & "        }else{" & vbcrlf & "          divID.style.display=""""" & vbcrlf & "  }" & vbcrlf & "       divID.style.left=300;" & vbcrlf & "   divID.style.top=10;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & "function testall()" & vbcrlf & "{" & vbcrlf & "if(!confirm('确认删除吗？'))" & vbcrlf & "{" & vbcrlf & "     window.location=""List_assetrepair.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
	...
	Response.write "&CurrPage="
	Response.write CurrPage
	Response.write """;" & vbcrlf & "}" & vbcrlf & "else" & vbcrlf & "{" & vbcrlf & "  document.getElementById('data').action=""Del_assetrepair.asp?px="
	Response.write px
	Response.write "&A="
	Response.write A
	Response.write "&B="
	...
	Response.write "&CurrPage="
	Response.write CurrPage
	Response.write """;" & vbcrlf & "        document.getElementById('data').submit();" & vbcrlf & "}" & vbcrlf & "}" & vbcrlf & "function testall1()" & vbcrlf & "{" & vbcrlf & " document.getElementById('data').action=""Add_lend.asp"";" & vbcrlf & "    document.getElementById('data').submit();" & vbcrlf & "}" & vbcrlf & "function testall2()" & vbcrlf & "{" & vbcrlf & "         document.getElementById('data').action=""Add_Check.asp"";" & vbcrlf & "   document.getElementById('data').submit();" & vbcrlf & "}" & vbcrlf & "function mm(form)" & vbcrlf & "{" & vbcrlf & "for (var i=0;i<form.elements.length;i++)" & vbcrlf & "///循环,form.elements.length得到表单里的控件个数" & vbcrlf & "{" & vbcrlf & "///把表单里的内容依付给e这个变量 " & vbcrlf & "var e = form.elements[i]; " & vbcrlf & "if (e.name != 'chkall') " & vbcrlf & "e.checked = form.chkall.checked; " & vbcrlf & "}" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
