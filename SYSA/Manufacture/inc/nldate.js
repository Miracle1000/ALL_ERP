  function nlClass(){
	  ...
	  obj.GetLunarDay = function(YearStr,MonthStr,DayStr)   
	  {   
	  ...
	  obj.getnlDay = function(YearStr,MonthStr,DayStr){
			var	sDObj=new   Date(parseInt(YearStr),parseInt(MonthStr)-1,parseInt(DayStr))   
			var lDObj=new   Lunar(sDObj)           //农历
			lDObj.smpDay =  cDay(lDObj.day) == "初一" ? cMonth(lDObj.month) : cDay(lDObj.day) 
			return lDObj;
	  }
	  return obj
  }
window.nlCls = new nlClass()