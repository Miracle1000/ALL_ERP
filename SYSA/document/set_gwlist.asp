...
'if ZBRuntime.MC(35000) = False  And ZBRuntime.MC(18100)=false Then
	...
	Sub Page_Load
		dim fromtype
		Dim id : id = app.base64.deurl(app.getText("id"))
		...
		Response.write app.DefTopBarHTML(app.virPath, "", "", "")
Response.write "" & vbcrlf & "" & vbcrlf & "<style type=""text/css"">" & vbcrlf & ".share-box {" & vbcrlf & "     padding:0 20px;" & vbcrlf & "}" & vbcrlf & ".share-tit {" & vbcrlf & "    color: #5b7cae;" & vbcrlf & " height: 30px;" & vbcrlf & "   line-height: 30px;      " & vbcrlf & "}" & vbcrlf & ".share-body {" & vbcrlf& "        margin-bottom: 20px;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & ".share-body table {" & vbcrlf & "        width: 100%;" & vbcrlf & "    border: 1px solid #E1E1DF;" & vbcrlf & "      border-collapse: collapse;" & vbcrlf & "      color: #5b7cae" & vbcrlf & "}" & vbcrlf & ".share-body table th {" & vbcrlf & "   background-color: #EFF6FF;    " & vbcrlf & "}" & vbcrlf & ".share-body table th,.share-body table th label{" & vbcrlf & "       font-weight: bold;" & vbcrlf & "      display: table-cell;" & vbcrlf & "}" & vbcrlf & ".share-body table th label input {" & vbcrlf & " vertical-align: middle;" & vbcrlf & " margin-right: 5px;" & vbcrlf & "}" & vbcrlf & ".share-body table th, .share-body table td {" & vbcrlf & "    padding: 3px;" & vbcrlf & "   border: 1px solid #E1E1DF;" & vbcrlf & "      text-align: left;" & vbcrlf & "       padding-left: 10px;" & vbcrlf & "     height: 24px;" & vbcrlf & "   line-height: 24px;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & ".share-chkbox {" & vbcrlf & "    display: block;" & vbcrlf & "}" & vbcrlf & "" & vbcrlf & ".share-footer {" & vbcrlf & " text-align: center;" & vbcrlf & "}" & vbcrlf & "body.defcomm{background-repeat:repeat-x;_overflow:visible;background-image:url("""")}" & vbcrlf & "" & vbcrlf & "#comm_itembarbg {display:none;background:""""}" & vbcrlf & "</style>" & vbcrlf & "" & vbcrlf & "<script type=""text/javascript"">" & vbcrlf & "$(function(){" & vbcrlf & "     // 处理全选" & vbcrlf & "     var $v = $(""#viewCheckAll"");" & vbcrlf & "      var $d = $(""#downCheckAll"");" & vbcrlf & "" & vbcrlf & "      $v.click(function(){" & vbcrlf & "                var ischk = $(this).attr(""checked"");              " & vbcrlf & "                var $box = $(""input[name=viewBox]"");" & vbcrlf & "              $box.each(function (index,ele) {" & vbcrlf & "                        if(ischk){" & vbcrlf & "                              $(this).attr(""checked"",""true"");" & vbcrlf & "                     }else{" & vbcrlf & "                          $(this).attr(""checked"","""");" & vbcrlf & "                        }" & vbcrlf & "               });" & vbcrlf & "     });" & vbcrlf & "" & vbcrlf & "     $d.click(function(){" & vbcrlf & "            var ischk = $(this).attr(""checked"");      " & vbcrlf & "                var $box = $(""input[name=downBox]"");" & vbcrlf & "              $box.each(function (index,ele) {" & vbcrlf & "                        if(ischk){" & vbcrlf & "                          $(this).attr(""checked"",""true"");" & vbcrlf & "                     }else{" & vbcrlf & "                          $(this).attr(""checked"","""");" & vbcrlf & "                 }" & vbcrlf & "               });" & vbcrlf & "     });" & vbcrlf & "" & vbcrlf & "     // 维护全选按钮状态" & vbcrlf & "     function selectAllStatus(){" & vbcrlf & "             $(""input[name=viewBox]"").each(function(index,ele){" & vbcrlf & "                  var isChk = $(this).attr(""checked"");" & vbcrlf & "                      if(!isChk){" & vbcrlf & "                             $v.attr(""checked"","""");" & vbcrlf & "                              return false;" & vbcrlf & "                   };" & vbcrlf & "                      $v.attr(""checked"",""true"");" & vbcrlf & "          });" & vbcrlf & "" & vbcrlf& "                $(""input[name=downBox]"").each(function(index,ele){" & vbcrlf & "                        var isChk = $(this).attr(""checked"");" & vbcrlf & "                      if(!isChk){" & vbcrlf & "                             $d.attr(""checked"","""");" & vbcrlf & "                              return false;" & vbcrlf & "                   };" & vbcrlf & "                      $d.attr(""checked"",""true"");" & vbcrlf & "          });" & vbcrlf & "    };" & vbcrlf & "      selectAllStatus();" & vbcrlf & "" & vbcrlf & "      $(""input[name=viewBox]"").click(function(){" & vbcrlf & "                selectAllStatus();" & vbcrlf & "      });" & vbcrlf & "     $(""input[name=downBox]"").click(function(){" & vbcrlf & "                selectAllStatus();" & vbcrlf & "      });" & vbcrlf &"" & vbcrlf &         "// 重置处理" & vbcrlf &      "window.resetbtn=function(){" & vbcrlf &              "$(""input[name=viewBox][flag=0]"").each(function(index,ele){" & vbcrlf &                         "$(this).attr(""checked"","");" & vbcrlf &          "});" & vbcrlf &              "$(""input[name=downBox][flag=0]"").each(function(index,ele){" & vbcrlf & "$(this).attr(""checked"","""");" & vbcrlf & "         });" & vbcrlf & "             $(""input[name=viewBox][flag=1]"").each(function(index,ele){" & vbcrlf & "                        $(this).attr(""checked"",""true"");" & vbcrlf & "             });" & vbcrlf & "             $(""input[name=downBox][flag=1]"").each(function(index,ele){" & vbcrlf & "                        $(this).attr(""checked"",""true"");" & vbcrlf & "          });" & vbcrlf & "             selectAllStatus();" & vbcrlf & "      }" & vbcrlf & "});" & vbcrlf & "</script>" & vbcrlf & "<div class=""share-box"">" & vbcrlf & "      <div style=""margin-top:5px;""><p style=""text-align:left; height:30px; ""><span class=""reseetTextColor"" style=""font-family:Arial;font-size:13px;font-weight:bold;font-style:normal;text-decoration:none;color:#5B7CAE;"">共享给以下岗位</span><span class=""reseetTextColor"" style=""font-family:Arial;font-size:13px;font-weight:normal;font-style:normal;text-decoration:none;color:#5B7CAE;"">（在需要共享的权限下的方框打勾）</span></p></div>" & vbcrlf & "       <form id=""demo"" name=""demo"" method=""post"" action=""?__msgid=dosave&id="
		Response.write app.base64.pwurl(id)
		Response.write "&fromtype="
		Response.write fromtype
		Response.write """>" & vbcrlf & "         <div class=""share-body"">" & vbcrlf & "                  <table>" & vbcrlf & "                         <thead>" & vbcrlf & "                                 <tr>" & vbcrlf & "                                            <th class=""resetGroupTableBg reseetTextColor"">岗位</th>" & vbcrlf & "                                           <th class=""resetGroupTableBg reseetTextColor""><label for=""viewCheckAll""><inputid=""viewCheckAll"" type=""checkbox"" title=""全选"">浏览</label></th>" & vbcrlf & "                                          <th class=""resetGroupTableBg reseetTextColor""><label for=""downCheckAll""><input id=""downCheckAll"" type=""checkbox"" title=""全选"">下载</label></th>" & vbcrlf & "                                   </tr>" & vbcrlf & "                           </thead>" & vbcrlf & "<tbody>" & vbcrlf & "                         "
		Dim rs,sql,pid,postView,postDown,curID,viewChecked,downChecked
		curID = app.base64.deurl(Request.QueryString("id"))
		Set rs = server.CreateObject("adodb.recordset")
		If fromtype&""<>"" Then
			sql =        "SELECT a.ord,a.sort1,(SELECT TOP 1 postView FROM DocSortsAndSharingRelation WHERE sortonehyId  = "& curID &" ) postView, " &_
			"(SELECT TOP 1 postDown FROM DocSortsAndSharingRelation WHERE sortonehyId  = "& curID &" ) postDown " &_
			"FROM sortonehy a " &_
			"WHERE a.gate2 = 1080 ORDER BY a.gate1 DESC "
		else
			sql =        "SELECT a.ord,a.sort1,(SELECT TOP 1 postView FROM document WHERE id = "& curID &" ) postView, " &_
			"(SELECT TOP 1 postDown FROM document WHERE id = "& curID &" ) postDown " &_
			"FROM sortonehy a " &_
			"WHERE a.gate2 = 1080 ORDER BY a.gate1 DESC "
		end if
		rs.Open sql,cn,1,1
		If Not rs.Eof Then
			Do While Not rs.Eof
				pid = rs("ord")
				postView = rs("postView")
				postDown = rs("postDown")
				If InStr(1,","& postView &",",","& pid &",",1) > 0 Then
					viewChecked = "checked"
				else
					viewChecked = ""
				end if
				If InStr(1,","& postDown &",",","& pid &",",1) > 0 Then
					downChecked = "checked"
					else
						downChecked = ""
						end if
						...
						Response.write "</td>" & vbcrlf & "                                         <td><label class=""share-chkbox"" for=""view_"
						Response.write rs("sort1")
						Response.write pid
						Response.write """><input type=""checkbox"" id=""view_"
						Response.write pid
						Response.write """ name=""viewBox"" "
						Response.write defView
						Response.write " value="""
						Response.write pid
						Response.write """ "
						Response.write viewChecked
						Response.write "></label></td>" & vbcrlf & "                                                <td><label class=""share-chkbox"" for=""down_"
						Response.write viewChecked
						Response.write pid
						Response.write """><input type=""checkbox"" id=""down_"
						Response.write pid
						Response.write """ name=""downBox"" "
						Response.write defDown
						Response.write " value="""
						Response.write pid
						Response.write """  "
						Response.write downChecked
						Response.write " ></label></td>" & vbcrlf & "                                       </tr>" & vbcrlf & "                           "
						rs.movenext
					Loop
				end if
				rs.close
				set rs = nothing
				Response.write "" & vbcrlf & "                             </tbody>" & vbcrlf & "                        </table>" & vbcrlf & "                </div>" & vbcrlf & "" & vbcrlf & "          <div class=""share-footer""> </div>" & vbcrlf & " </form>" & vbcrlf & "</div>" & vbcrlf & ""
'Loop
			end sub
			Sub app_dosave
				Dim viewBox,downBox,id,fromtype
				viewBox = app.getText("viewBox")
				downBox = app.getText("downBox")
					id = app.base64.deurl(app.getText("id"))
					fromtype=app.getText("fromtype")&""
					If viewBox <> "" Then viewBox = Replace(viewBox,", ",",")
					If downBox <> "" Then downBox = Replace(downBox,", ",",")
					if fromtype<>"" then
						cn.Execute("if exists( select 1 from DocSortsAndSharingRelation where sortonehyId = "& id &" ) begin UPDATE DocSortsAndSharingRelation SET postView = '"& viewBox &"', postDown = '"& downBox &"',share1='',share2='' WHERE sortonehyId = "& id &" end else begin  insert into DocSortsAndSharingRelation(sortonehyId,postView,postDown,updatetime)values ("& id &",'"& downBox &"','"& downBox &"',getdate()) end   ")
					else
						cn.Execute("UPDATE document SET postView = '"& viewBox &"', postDown = '"& downBox &"',share1='',share2='' WHERE id = "& id &" ")
					end if
					Response.write "<script>parent.window.opener.getSharePostList("& id &",1,'"& fromtype &"');parent.window.close();</script>"
					Response.end
				end sub
				Sub app_getPostList
					Dim rs,sql,id,postView,postDown,result ,stype ,share1 ,share2,fromtype
					id = Request("id")
					stype = request("stype")
					fromtype=request("fromtype")
					Set rs = server.CreateObject("adodb.recordset")
					if fromtype<>"" then
						sql = "SELECT postView,postDown,share1,share2 FROM DocSortsAndSharingRelation WHERE sortonehyid = "& id &" "
					else
						sql = "SELECT postView,postDown,share1,share2 FROM document WHERE id = "& id &" "
					end if
					rs.Open sql,cn,1,1
					If Not rs.Eof Then
						postView = rs("postView")
