...
'if hasNumStr(j)<>"" and hasNumStr(j)<>"0" then
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script src= ""../Script/Hs_correct.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""JavaScript""></script>" & vbcrlf & "<script language=""JavaScript"" type=""text/JavaScript"" src=""../inc/system.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script src= ""../Script/Hs_correct_1.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""JavaScript"" type=""text/JavaScript""></script>" & vbcrlf & "<script src= ""../Script/Hs_correct_2.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ ></script>" & vbcrlf & "<script src= ""../Script/Hs_correct_3.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=JavaScript1.2></SCRIPT>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & " margin-top: 0px;" & vbcrlf & "        background-color: #FFFFFF;" & vbcrlf & "      margin-left: 0px;" & vbcrlf & "       margin-right: 0px;" & vbcrlf & "      margin-bottom: 0px;" & vbcrlf& "}" & vbcrlf & ".salaryclass li{" & vbcrlf & "       border: 1px solid #C0CCDD;" & vbcrlf & "      line-height: 26px;" & vbcrlf & "      margin: 2px;" & vbcrlf & "    float: left;" & vbcrlf & "    width: 140px;" & vbcrlf & "   text-align: center;" & vbcrlf & "}" & vbcrlf & "-->" & vbcrlf & "</style>" & vbcrlf & "</head>"& vbcrlf & "<body  onunload=""window.opener.location.reload();"" > "& vbcrlf
	dim clo
	...
	set rs=server.CreateObject("adodb.recordset")
	sql="select *  from sortwages Where id="&CurrBookID&" "
	rs.open sql,conn,1,1
	if not rs.eof then
		salaryClass=rs("salaryClass").value
		sort1 = rs("sort1").value
		intro = rs("intro").value
		gate1 = rs("gate1").value
		deductible= rs("deductible").value
	end if
	rs.close
	set rs=nothing
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0""  cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"">" & vbcrlf & "<tr>" & vbcrlf & "<td width=""100%"" valign=""top"">" & vbcrlf & "   <table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""27"">" & vbcrlf & "       <tr>" & vbcrlf & "           <td width=""5%"" height=""27""  background=""../images/contentbg.gif""><div align=""center""><img src=""../images/contenttop.gif""height=""27""> </div></td>" & vbcrlf & "            <td width=""95%""  background=""../images/contentbg.gif""><strong><font color=""#1445A6"">设置工资项目</font></strong></td>" & vbcrlf & "      </tr>" & vbcrlf & "   </table>" & vbcrlf & "        <form method=""post"" action=""Updatecp.asp?ord="
	Response.write request("ord")
	Response.write """ id=""demo"" onsubmit="" return onsubm(this)"" name=""date"" style=""margin:0"">" & vbcrlf & "  <table width=""100%"" border=""0"" cellpadding=""3"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "              <tr class=""top""><td colspan=""2"">修改工资项目</td></tr>" & vbcrlf & "              <tr>" &vbcrlf & "                 <td width=""18%""><div align=""right"">工资项目：</div></td>" & vbcrlf & "                    <td width=""82%""><input type=""text"" name=""sort1"" value="
	Response.write sort1
	Response.write "   size=""30"" class=""text""  dataType=""Limit"" min=""1"" max=""50""  msg=""长度必须在1个至50个字之间""> <span class=""red"">*</span></td>" & vbcrlf & "              </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td><div align=""right"">类型：</div></td>" & vbcrlf & "                  <td>" & vbcrlf & "                            <input name=""may"" type=""radio"" onchange=""choose(this)"" onpropertychange=""choose(this)"" value=""1""  "
	if intro="1" then
		Response.write "checked"
	end if
	Response.write ">增项" & vbcrlf & "                         <input type=""radio""  onchange=""choose(this)"" onpropertychange=""choose(this)"" name=""may"" value=""-1"" "
	Response.write "checked"
	if intro="-1" then
		Response.write "checked"
		Response.write "checked"
	end if
	Response.write ">减项" & vbcrlf & "                         <input type=""radio""  onchange=""choose(this)"" onpropertychange=""choose(this)"" name=""may"" value=""0"" "
	if intro="0" then
		Response.write "checked"
	end if
	Response.write ">不操作" & vbcrlf & "                "
	if intro="-1" then
		Response.write ">不操作" & vbcrlf & "                "
		Response.write "" & vbcrlf & "                 <input type=""checkbox""   name=""may4"" id='may4' value=""1"" "
		if deductible="1" then
			Response.write "checked"
		end if
		Response.write "><span id=""span4"">参与应扣计算</span>" & vbcrlf & "                  "
	else
		Response.write "" & vbcrlf & "                 <input type=""checkbox""   name=""may4"" id='may4' style=""display:none"" value=""1""><span style=""display:none"" id=""span4"">参与应扣计算</span>" & vbcrlf & "                "
	end if
	Response.write "" & vbcrlf & "" & vbcrlf & "                      </td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td><div align=""right"">计算公式：</div></td>" & vbcrlf & "                      <td><input name=""salaryClass"" type=""text"" id=""salaryClass"" value="""
	Response.write salaryClass
	Response.write """ size=""60"" maxlength=""500"">只能包含参数及&nbsp;&nbsp;+&nbsp;&nbsp;-&nbsp;&nbsp;*&nbsp;&nbsp;/&nbsp;&nbsp;(&nbsp;&nbsp;)</td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td><div align=""right"">重要指数：</div></td>" & vbcrlf & "                      <td><select name=""gate1"" size=""1"">" & vbcrlf & "                  "
	For i=1 To 40
		...
		Response.write "</option>"
	next
	Response.write "" & vbcrlf & "                              </select>" & vbcrlf & "                       </td>" & vbcrlf & "           </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td colspan=""2"">" & vbcrlf & "                          <div class=""salaryclass""  id=""strlist"">" & vbcrlf & "                             "
	If ZBRuntime.MC(36000)=False or  ZBRuntime.MC(26002)=False Then gzSQL= " and flag<>'$jjcw'"
	If ZBRuntime.MC(18000)=False or  ZBRuntime.MC(26002)=False Then  gzSQL= gzSQL & " and flag<>'$jjgz'"
	...
	rsli.close
	set rsli=Nothing
	sql="select id from wages where salaryClass in (select id from hr_gongziClass where del=0 and charindex(',"&CurrBookID&",',','+cast(gongzi as nvarchar)+',')>0) and complete1=0"
	set rsli=Nothing
	...
	If disabled=0 Then
		Response.write "<tr>" & vbcrlf & "                         <td colspan=""2""><div align=""center"">" & vbcrlf & "                                <input type=""submit"" name=""Submit422"" value=""保存""  class=""page""/>" & vbcrlf & "                              <input type=""reset"" value=""重填"" class=""page"" name=""B2"" />" & vbcrlf & "                              </div></td>" & vbcrlf & "                     </tr>"
	end if
	Response.write "   " & vbcrlf & "  </table>" & vbcrlf & "        </form>" & vbcrlf & "</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr><td  class=""page""><table width=""100%"" border=""0"" align=""left"" ><tr><td height=""80"" >&nbsp;</td></tr></table></td></tr>" & vbcrlf & "</table>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf & ""
	action1="修改工资项目"
	call close_list(1)
%>
