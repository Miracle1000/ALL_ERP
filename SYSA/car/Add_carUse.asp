...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	sort1=request("sort")
	if sort1="" or isnull(sort1) then sort1=1
	if sort1=1 then
		typenames="申请"
	else
		typenames="派车"
	...
	if car_id="" or isnull(car_id) then
		numa=1
		car_id=0
	else
		numa=2
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<link href=""../car/style.css?ver="
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<script type=""text/Javascript"" src=""../yp/myJsClass.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script type=""text/Javascript"" src=""addtr.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<script language=""javascript"" type=""text/javascript"">" & vbcrlf & "a="
	Response.write numa
	Response.write ";" & vbcrlf & "" & vbcrlf & "function ask(){" & vbcrlf & "      document.getElementById('divsubmit').style.display='block';" & vbcrlf & "     if (document.getElementsByName('use_carid').length==0)  {" & vbcrlf & "               alert('请添加车辆使用明细');" & vbcrlf & "            document.getElementById('divsubmit').style.display='none';" & vbcrlf & "         return false;" & vbcrlf & "   }" & vbcrlf & "       var member=document.getElementsByName('member2');" & vbcrlf & "       if (member.length==0)   {" & vbcrlf & "               alert('请选择车辆使用人员');" & vbcrlf & "            document.getElementById('divsubmit').style.display='none';" & vbcrlf & "              return false;" & vbcrlf & " }       else    {" & vbcrlf & "               bx=false;" & vbcrlf & "               for(i=0 ;i<member.length;i++)           {" & vbcrlf & "                       if (member[i].checked==true)                    {" & vbcrlf & "                               bx=true;" & vbcrlf & "                                break;" & vbcrlf & "                  }" & vbcrlf & "               }" & vbcrlf & "               if (bx==false)          {" & vbcrlf & "                       alert('请选择车辆使用人员');" & vbcrlf &"                  document.getElementById('divsubmit').style.display='none';" & vbcrlf & "                      return false;" & vbcrlf & "           }" & vbcrlf & "       }" & vbcrlf & "       var carIdList=document.getElementsByName('use_carid');" & vbcrlf & "  var starTimeList=document.getElementsByName('use_startime');" & vbcrlf & "    var starEndList=document.getElementsByName('use_endtime');" & vbcrlf & "  qx=Validate(carIdList,starTimeList,starEndList);" & vbcrlf & "        if (parseInt(qx)!=0)    {" & vbcrlf & "               if (parseInt(qx)==1 || parseInt(qx)==2)         {" & vbcrlf & "                       alert('开始时间不能大于结束时间');" & vbcrlf & "              }else if(parseInt(qx)==3)       {" & vbcrlf & "                       alert('时间不能为空');" & vbcrlf & "               }else if(parseInt(qx)==4)       {" & vbcrlf & "                       alert('时间被占用');" & vbcrlf & "            }else if(parseInt(qx)==5)       {" & vbcrlf & "                       alert('时间被占用');" & vbcrlf & "            }" & vbcrlf & "               document.getElementById('divsubmit').style.display='none';" & vbcrlf & "              return false;" & vbcrlf & "}" & vbcrlf & "       var arrlist=document.getElementsByTagName(""input"");" & vbcrlf & "       for(i=0;i<arrlist.length;i++){" & vbcrlf & "          if (arrlist[i].type==""text"" || arrlist[i].type==""hidden"")   {" & vbcrlf & "                       if(arrlist[i].value.indexOf("", "")>=0 && (!arrlist[i].onpropertychange))   { " & vbcrlf & "arrlist[i].value=arrlist[i].value.replace(/,\s/g,""^#$6a""); "& vbcrlf & "                        }" & vbcrlf & "               }" & vbcrlf &        "}" & vbcrlf &   ""      & vbcrlf &         ""
	if sort1=1 then
		set rssp=conn.execute("select top 0 id from sp where gate2=20 order by gate1")
		if rssp.eof then
			spid=0
		else
			spid=rssp(0)
		...
		rssp.close
		set rssp=nothing
		Response.write "" & vbcrlf & "      var fromobj=document.getElementById(""demo"");" & vbcrlf & "      var jkm=document.getElementsByName(""member2"");" & vbcrlf & "    for(i=0;i<jkm.length;i++)" & vbcrlf & "       {" & vbcrlf & "               if(jkm[i].checked)" & vbcrlf & "              {" & vbcrlf & "                       cid=jkm[i].value;" & vbcrlf & "               }" & vbcrlf &"  }" & vbcrlf & "       for(var i=0;i<jkm.length;i++)" & vbcrlf & "   {" & vbcrlf & "               if(jkm[i].checked)" & vbcrlf & "              {" & vbcrlf & "                       cid=jkm[i].value;" & vbcrlf & "                       break;" & vbcrlf & "          }" & vbcrlf & "       }" & vbcrlf & "       check_SP(fromobj,20,"
		set rssp=nothing
		Response.write spid
		Response.write ",0,0,'"
		Response.write now
		...
		Response.write ",cid);" & vbcrlf & "        "
	else
		Response.write "" & vbcrlf & "      document.getElementById(""demo"").submit()" & vbcrlf & "  "
	end if
	Response.write "" & vbcrlf & "      return true;" & vbcrlf & "}" & vbcrlf & "</script>" & vbcrlf & "<script src= ""../Script/cr_Add_carUse.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "<style>" & vbcrlf & "       #ajaxdiv td{" & vbcrlf & "            border:1px solid #CCC;" & vbcrlf & "  }" & vbcrlf & "</style>" & vbcrlf & "</head>" & vbcrlf & "<body bgcolor=""#ebebeb"" onLoad=""car_img('"
	Response.write date
	Response.write "',1,'');"" scroll='yes'>" & vbcrlf & ""
	...
	rs7.close
	set rs7=nothing
	gateord=session("personzbintel2007")
	Response.write "" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">    " & vbcrlf & "       <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">" & vbcrlf & "                    "
	if request("sort")="1" then
		Response.write "申请添加"
	elseif request("sort")="2" then
		Response.write "派车添加"
	end if
	Response.write "</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right"">&nbsp;</td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "  <form action=""Save_carUse.asp?ord="
	Response.write ord
	Response.write "&sort1="
	Response.write sort1
	Response.write """ method=""POST"" name=""data""id=""demo"" onsubmit=""return false"">" & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">       " & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td colspan=""6"" height=""30"" style='padding-right:0;' >" & vbcrlf & "    " & vbcrlf & "                " & vbcrlf & "                <div  style='display:inline;float:left;'><img src=""../images/jiantou.gif""><a href=""javascript:void(0);"" onClick=""setHidden('tr','table_tr1');"">基本信息</a></div></div>" & vbcrlf & "               <div   style='display:inline;float:right;margin-right:5px;'>" & vbcrlf & "                <input type=""submit"" name=""Submit422"" value=""保存""  class=""page"" onclick=""return ask()""/>" & vbcrlf & "                 <input type=""reset"" value=""重填"" class=""page"" name=""B22"">" & vbcrlf & "               </div>" & vbcrlf & "                </td>" & vbcrlf & "        </tr>" & vbcrlf & "    <tr name=""table_tr1"">" & vbcrlf & "                     <td colspan=""6"">" & vbcrlf & "                  <div id=""ajaxdiv"" style=""width:100%;"" align=""center""><img src=""../images/smico/proc.gif""></div>" & vbcrlf & "                 </td>" & vbcrlf & "           </tr>" & vbcrlf & "           <!--自定义开始-->"
	'Response.write sort1
	set rs8=server.CreateObject("adodb.recordset")
	sql8="select * from zdy where sort1=804 and set_open=1 order by gate1 asc "
	...
	if rs8.eof then
		...
		Response.write("<tr name=""table_tr1"">")
		do until rs8.eof
			if clng(i_jm/3)=i_jm/3 and i_jm<>0 then
				Response.write("</tr><tr name=""table_tr1"">")
				j_jm=j_jm+1
				'Response.write("</tr><tr name=""table_tr1"">")
			end if
			Response.write "" & vbcrlf & "         <td width=""15%"" align=""right"">"
			Response.write rs8("title")
			Response.write "：</td>" & vbcrlf & "              <td width=""588"" "
			if i_jm=num1-1  then
				Response.write "：</td>" & vbcrlf & "              <td width=""588"" "
			...
			if rs8("sort")=2 then
				...
				Response.write """ type=""text"" size=""15"" datatype=""Limit"" max=""100"" msg=""长度不能超过50个字"">" & vbcrlf & "                "
			...
			elseif rs8("sort")=3 then
				...
				Response.write """ id="""
				Response.write rs8("name")
				Response.write """ value="""" Class=""DatePick""  onclick=""datedlg.show();"" readonly>" & vbcrlf & "                "
			end if
	...
	rs8.close
	set rs8=nothing
	Response.write "" & vbcrlf & "       <!--自定义结束-->" & vbcrlf & "             <!--<tr>" & vbcrlf & "                        <td height=""30"" align=""right"">发送短信：</td>" & vbcrlf & "                       <td colspan=""5"" height=""30"">                        " & vbcrlf & "                                <input type=""checkbox"" name=""SMS"" value=""1"">使用人员" & vbcrlf & "                  "
	'set rs8=nothing
	if sort1=1 then
		Response.write "" & vbcrlf & "                             <input type=""checkbox"" name=""SMS"" value=""2"">审批人员" & vbcrlf & "                  "
	end if
	Response.write "" & vbcrlf & "                             <input type=""checkbox"" name=""SMS"" value=""3"">司机" & vbcrlf & "                      </td>" & vbcrlf & "           </tr>-->" & vbcrlf & "                <tr class=""top"">" & vbcrlf & "                  <td colspan=""6"" height=""30""><div align=""left""><img src=""../images/jiantou.gif""><a href=""javascript:void(0);"" onClick=""setHidden('tr','table_tr4');"" id=""usePersonnel"">使用人员</a>&nbsp;<span id=""uname""></span></div></td>" & vbcrlf & "               </tr>" & vbcrlf & "           <tr name=""table_tr4"" id=""personnelList"">" & vbcrlf & "            <td colspan=""6"" class=""gray"">" & vbcrlf & "                       "
	set rs1=server.CreateObject("adodb.recordset")
	sql1="select sort1,qx_open,w1,w2,w3 from power2  where cateid="&session("personzbintel2007")&" and sort1=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_1_1=0
	else
	...
	defcateid = 0
	If conn.execute("select 1 from gate where ord=" & session("personzbintel2007") & " " & str_w3).eof = False Then
		defcateid = session("personzbintel2007")
	end if
	Response.write CBaseUserTreeHtmlRadioCE(basesql,"", "","","member2",  "", "", "", defcateid,"chkuname(node.text);")
	Response.write "" & vbcrlf & "                     <script>" & vbcrlf & "                                setTimeout(function(){" & vbcrlf & "                                  $(""#uname"").html($(""input[name=member2]"").attr(""text""));" & vbcrlf & "                              },400);" & vbcrlf & "                         setTimeout(function(){" & vbcrlf & "                                  $(""#uname"").html($(""input[name=member2]"").attr(""text""));" & vbcrlf & "                               },800);" & vbcrlf & "                         setTimeout(function(){" & vbcrlf & "                                  $(""#uname"").html($(""input[name=member2]"").attr(""text""));" & vbcrlf & "                              },2000);" & vbcrlf & "                                setTimeout(function(){" & vbcrlf & "                                  $(""#uname"").html($(""input[name=member2]"").attr(""text""));" & vbcrlf & "                              },4000);" & vbcrlf & "                        </script>" & vbcrlf & "               </td>" & vbcrlf & "      </tr>          " & vbcrlf & "        <tr class=""top"">" & vbcrlf & "            <td height=""30"" colspan=""6""><div align=""left""><img src=""../images/jiantou.gif""><a href=""javascript:void(0);"" onClick=""setHidden('tr','table_tr');"">车辆明细</a></div></td>" & vbcrlf & "          </tr>" & vbcrlf & "         <tr name=""table_tr"">" & vbcrlf & "        <td height=""30"" colspan=""6"">" & vbcrlf & "                    <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                              <tr>" & vbcrlf & "                    <td width=""80"">&nbsp;</td>" & vbcrlf & "                                        <td width=""80"">&nbsp;</td>" & vbcrlf & "                                        <td><div align=""center"">" & vbcrlf & "                                    <SELECT name=""usecatetype"" id=""usecatetype"" onChange=""batch('usecatetype');"">" & vbcrlf & "                        <OPTION selected value=""1"">公用</OPTION> "& vbcrlf &                         "<OPTION value=""2"">私用</OPTION>" & vbcrlf &                       "</SELECT>" & vbcrlf &                                         "</div></td>" & vbcrlf &                                      "<td><div align=""center"">" & vbcrlf &                                     "<input type=""text"" name=""alluse_pctime"" onchange=""setAll(this.value=""DateTimePick""  onclick=""datedlg.showDateTime();"" readonly>" & vbcrlf & "                                </div></td>" & vbcrlf & "                                 <td><div align=""center"">" & vbcrlf & "                                    <input type=""text"" name=""alluse_startime"" onchange=""setAll(this.value,'use_startime')"" Class=""DateTimePick""  onclick=""datedlg.showDateTime();"" readonly>" & vbcrlf & "                             </div></td>" & vbcrlf & "                                 <td><div align=""center"">" & vbcrlf & "                                     <input type=""text"" name=""alluse_endtime"" onchange=""setAll(this.value,'use_endtime')"" Class=""DateTimePick""  onclick=""datedlg.showDateTime();"" readonly>" & vbcrlf & " </div></td>" & vbcrlf & "                                 <td><div align=""center"">" & vbcrlf & "                                    <INPUT name=""usemdd"" id=""usemdd"" maxLength=""1000"" size='12' onpropertychange=""batch('usemdd');"">" & vbcrlf & "                                      </div></td>" & vbcrlf & "                                     <td><div align=""center"">" & vbcrlf & "                                    <INPUT name=""uselc"" id=""uselc"" size=""9"" maxLength=""1000"" onpropertychange=""batch('uselc');"">" & vbcrlf & "                                    </div></td>" & vbcrlf & "                                     <td><div align=""center"">" & vbcrlf & "                                    <INPUT name=""usething"" id=""usething"" size='12' maxLength=""1000"" onpropertychange=""batch('usething');"">" & vbcrlf & "                                        </div></td>" & vbcrlf & "                                   <td><div align=""center"">" & vbcrlf & "                                    <INPUT name=""usenote"" id=""usenotes"" size='12' maxLength=""500"" onpropertychange=""batch('usenotes');"">" & vbcrlf & "                                  </div></td>" & vbcrlf & "                             </tr>" & vbcrlf & "                           <tr>" & vbcrlf & "                                    <td width=""80""><div align=""center""><pre><strong>车牌号</strong></div></td>" & vbcrlf & "                                    <td width=""80""><div align=""center""><pre><strong>司机</strong></div></td>" & vbcrlf & "                                    <td width=""80""><div align=""center""><pre><strong>用车性质</strong></div></td>" & vbcrlf & "                                        <td width=""150""><div align=""center""><pre><strong>派车时间</strong></div></td>" & vbcrlf & "                                       <td width=""150""><div align=""center""><pre><strong>开始时间</strong></div></td>" & vbcrlf & "                                       <td width=""150""><div align=""center""><pre><strong>结束时间</strong></div></td>" & vbcrlf & "                                       <td><div align=""center""><pre><strong>目的地</strong></div></td>" & vbcrlf & "<td width=""80""><div align=""center""><pre><strong>里程</strong></div></td>" & vbcrlf & "                                    <td><div align=""center""><pre><strong>事由</strong></div></td>" & vbcrlf & "                                     <td><div align=""center""><pre><strong>备注</strong></div></td>" & vbcrlf & "                             </tr>" & vbcrlf & "                           <tbody id=""add_tr"">" & vbcrlf & "                           "
	if car_id<>0 then
		sql7="select car_code from O_carData where del=1 and car_id="&car_id
		set rs7=conn.execute(sql7)
		if not rs7.eof then
			Response.write "" & vbcrlf & "                                     <TR id=tr_"
			Response.write car_id
			Response.write "_1 name=""table_tr"">" & vbcrlf & "                                            <TD><DIV align=""left""><pre>"
			Response.write rs7("car_code")
			Response.write "<INPUT id=use_carid_"
			Response.write car_id
			Response.write " value="
			Response.write car_id
			Response.write " type=hidden name=use_carid>&nbsp;<A onclick=""del_TR('tr_"
			Response.write car_id
			Response.write "_1')"" href=""javascript:void(0)""><IMG src=""../images/del2.gif""></A>&nbsp;<SPAN id=""sortlist"">1</SPAN></DIV></TD>" & vbcrlf & "                                         <TD><DIV align=""center"">" & vbcrlf & "                                          <SELECT name=""use_driver"">                                        " & vbcrlf & "                                                        "
			sql8="select id, drivername from O_carDriver where id not in (SELECT b.use_driver FROM O_carUse a LEFT JOIN O_carUsemx b ON a.use_id=b.use_fid WHERE a.del=1 and a.use_complete=3 AND b.use_complete=1)"
			...
			if not rs8.eof then
				do while not rs8.eof
					...
					Response.write ">"
					Response.write rs8("drivername")
					Response.write "</OPTION>" & vbcrlf & "                                                    "
					rs8.movenext
				loop
			end if
			set rs8=nothing
			Response.write "" & vbcrlf & "                                             </SELECT></DIV></TD>" & vbcrlf & "                                            <TD><DIV align=""center"">" & vbcrlf & "                                          <SELECT name=""use_catetype"">" & vbcrlf & "                                              <OPTION selected value=""1"">公用</OPTION>" & vbcrlf & "                                          <OPTION value=""2"">私用</OPTION>" & vbcrlf & "                                           </SELECT></DIV></TD>" & vbcrlf & "                                            <TD><DIV align=""center""><input type=""text"" name=""use_pctime"" id=""use_pctime"""
			Response.write car_id
			Response.write """ Class=""DateTimePick""  onclick=""datedlg.showDateTime();"" readonly></DIV></TD>" & vbcrlf & "                                                <TD><DIV align=""center""><input type=""text"" name=""use_startime"" id=""use_startime"""
			Response.write car_id
			Response.write """ Class=""DateTimePick""  onclick=""datedlg.showDateTime();"" readonly></DIV></TD>" & vbcrlf & "                                                <TD><DIV align=""center""><input type=""text"" name=""use_endtime"" id=""use_endtime"""
			Response.write car_id
			Response.write """ Class=""DateTimePick""  onclick=""datedlg.showDateTime();"" readonly></DIV></TD>" & vbcrlf & "                                                <TD><DIV align=""center""><INPUT maxLength=""1000"" name=""use_mdd""></DIV></TD>" & vbcrlf & "                                            <TD><DIV align=""center""><INPUT maxLength=""1000"" size=""9"" name=""use_lc""></DIV></TD>" & vbcrlf & "                                              <TD><DIV align=""center""><INPUT maxLength=""1000"" name=""use_thing""></DIV></TD>" & vbcrlf & "                                               <TD><DIV align=""center""><INPUT maxLength=""500"" name=""use_notes""></DIV></TD>" & vbcrlf & "                                   </TR>" & vbcrlf & "                                   "
		end if
		rs7.close
		set rs7=nothing
	end if
	Response.write "" & vbcrlf & "                             </tbody>" & vbcrlf & "                        </table>" & vbcrlf & "                </td>" & vbcrlf & "     </tr>" & vbcrlf & "   " & vbcrlf & "        <tr>" & vbcrlf & "            <td width=""15%""><p align=""right"">"
	Response.write typenames
	Response.write "备注：</td>" & vbcrlf & "            <td colspan=""5"" class=""gray""><textarea name=""use_note"" style=""display:none"" cols=""1"" rows=""1""></textarea>" & vbcrlf & "          <IFRAME ID=""eWebEditor1"" SRC=""../edit/ewebeditor.asp?id=use_note&style=news"" FRAMEBORDER=""0"" SCROLLING=""no"" WIDTH=""100%"" HEIGHT=""300"" marginwidth=""1"" marginheight=""1"" name=""wfasdg""></IFRAME></td>" & vbcrlf & "        </tr> " & vbcrlf & "      <tr>" & vbcrlf & "        <td colspan=""6"" class=""gray"">" & vbcrlf & "                   <div align=""center"">" & vbcrlf & "                        <input type=""submit"" name=""Submit42"" value=""保存"" class=""page"" onclick=""return ask()""/>" & vbcrlf &                           "<input type=""reset"" value=""重填"" class=""page"" name=""B2"">" & vbcrlf &                "</div></td>" & vbcrlf &       "</tr>" & vbcrlf &     "</table></form>" & vbcrlf &       "</td>" & vbcrlf &   "</tr>" & vbcrlf & "</table>" & vbcrlf & "<div id=""divsubmit"" class=""submitdiv""><img src=""../images/smico/proc.gif""></div>" & vbcrlf & "<div id=""title"" class=""showdiv""><img src=""../images/smico/proc.gif""></div>" & vbcrlf & ""
	action1="车辆申请添加"
	call close_list(1)
	if sort1=1 then
		Response.write "<script src= ""../Script/ic_CommonSPClient.js?ver="
		Response.write Application("sys.info.jsver")
		Response.write """  language=""javascript""></script>" & vbcrlf & "<div id=""_sp_usr"" class=""easyui-dialog"" title=""请选择审批人"" style=""width:300px;height:200px;padding:5px;background:#fafafa;top:0px;"" closed=""true"" modal=""true"" closable=""false"">" & vbcrlf & "        <div id=""spdiv"" style=""display:none"">"& vbcrlf & "        <div region=""center"" border=""false"" style=""padding:5px; background:#fff;border:1px solid #ccc;width:97%;height:95px"">" & vbcrlf & "   <table width=""100%"" border=""1"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                    <tr class=""top"">" & vbcrlf & "                            <td colspan=""4"">此单据需要审批，请选择审批人：</td>" & vbcrlf & "                       </tr>" & vbcrlf & "                   <tr>" & vbcrlf & "                            <td width=""32%""><div align=""right"">审批人：</div></td>" & vbcrlf & "                              <td width=""68%"" colspan=""3"">" & vbcrlf & "                                        <div align=""left"">" & vbcrlf & "                                        <span class=""gray"">" & vbcrlf & "                                            <select name=""lead"" id=""spuser"" class=""gray"">" & vbcrlf & "                                         <option value="""">没有下级审批人，请核对</option>" & vbcrlf & "                                          </select><span id='_sp_errmsg' style='color:red;font-size:12px'></span>" & vbcrlf & "                                 </span>" & vbcrlf & "                                 </div>" & vbcrlf & "                          </td>" & vbcrlf& "     </tr>" & vbcrlf & "    </table>" & vbcrlf & "   </div>" & vbcrlf & "  <div region=""south"" id=""btnpannel"" border=""false"" style=""text-align:right;height:20px;padding-top:8px;padding-right:8px;"">" & vbcrlf & "              <a class=""easyui-linkbutton"" icon=""icon-ok"" href=""###"" id=""_sp_sbmit"">确定</a>" & vbcrlf & "              <a class=""easyui-linkbutton"" icon=""icon-cancel"" href=""###"" onClick=""$('#_sp_usr').window('close');if(document.getElementById('divsubmit')){document.getElementById('divsubmit').style.display='none';}"">取消</a>" & vbcrlf & "        </div>" & vbcrlf & "  </div>" & vbcrlf & "</div>" & vbcrlf & "<div id=""_spsb"" class=""easyui-dialog"" title=""提交中,请稍候..."" style=""width:200px;height:0px;padding:5px;background:#fafafa;top:0px;"" closed=""true"" closable=""false"" modal=""true"">" & vbcrlf & "     <div id=""cli"" style=""display:none"">正在处理中,请稍候...</div>" & vbcrlf & "</div>"
		'Response.write Application("sys.info.jsver")
