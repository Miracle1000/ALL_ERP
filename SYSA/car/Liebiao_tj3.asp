...
'Str_Result=" where del=1 and sort3=1   "&str_temp_where&""
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "        <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td colspan=""4""><a href=""###"" class=""AfterQuickSearch"" onClick=""document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';return false;""><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td>" & vbcrlf & "        </tr>" & vbcrlf & "           <tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td><div align=""right"">人员选择：</div></td>" & vbcrlf & "<td width=""57%"" colspan=""3"">"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td></tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td><div align=""right"">车辆险种：</div></td>" & vbcrlf & "      <td colspan=""3"">"
	set rs=server.CreateObject("adodb.recordset")
	sql="select * from O_carSet where setType=3 order by setsort desc"
	...
	rs.close
	set rs=nothing
	Response.write "</td>" & vbcrlf & "      </tr>" & vbcrlf & "         <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">车牌号：</div></td>" & vbcrlf & "        <td colspan=""3""><input name=""D2"" type=""text"" id=""D2"" size=""12"" /></td>" & vbcrlf & "  </tr>" & vbcrlf & "      <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">保险公司：</div></td>" & vbcrlf & "      <td colspan=""3""><input name=""D3"" type=""text"" id=""D3"" size=""20"" /></td>" & vbcrlf & "         </tr>" & vbcrlf & "           <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">联系电话：</div></td>" & vbcrlf & "      <td colspan=""3""><input name=""D4"" type=""text"" id=""D4"" size=""20"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "    <td><div align=""right"">保费：</div></td>" & vbcrlf & "    <td colspan=""3""><input name=""D5"" type=""text"" id=""D5"" size=""12""onpropertychange=""formatData(this,'money');"" onKeyUp=""checkDot('D5','"
	Response.write num_dot_xs
	Response.write "')""/>" & vbcrlf & "      -" & vbcrlf & "      <input name=""D6"" type=""text"" id=""D6"" size=""12"" onpropertychange=""formatData(this,'money');"" onKeyUp=""checkDot('D6','"
	'Response.write num_dot_xs
	Response.write num_dot_xs
	Response.write "')""/></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "        <td><div align=""right"">保险备注：</div></td>" & vbcrlf & "      <td colspan=""3""><input name=""D7"" type=""text"" id=""D7"" size=""30""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "          <td><div align=""right"">投保日期：</div></td>" & vbcrlf & "      <td colspan=""3"">&nbsp;自：<input type=""text"" name=""M"" id=""M"" Class=""DatePick"" onclick=""datedlg.show();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""K"" id=""K"" Class=""DatePick"" onclick=""datedlg.show();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "   <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "         <td><div align=""right"">结束日期：</div></td>" & vbcrlf & "      <td colspan=""3"">&nbsp;自：<input type=""text"" name=""L1"" id=""L1"" Class=""DatePick"" onclick=""datedlg.show();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""L2"" id=""L2""Class=""DatePick"" onclick=""datedlg.show();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "             <td><div align=""right"">添加日期：</div></td>" & vbcrlf & "      <td colspan=""3"">&nbsp;自：<input type=""text"" name=""D28"" id=""D28"" Class=""DatePick"" onclick=""datedlg.show();"" readonly=""readonly"">&nbsp;至：<input type=""text"" name=""D29"" id=""D29"" Class=""DatePick"" onclick=""datedlg.show();"" readonly=""readonly""></td>" & vbcrlf & "  </tr>" & vbcrlf & "    <tr onMouseOut=""this.style.backgroundColor=''"" onMouseOver=""this.style.backgroundColor='efefef'"">" & vbcrlf & "           <td width=""10%"">&nbsp;</td>" & vbcrlf & "       <td colspan=""3""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填""class=""page"" name=""B2""></td>" & vbcrlf &      "</tr>" & vbcrlf & "</table>" & vbcrlf
	conn.close
	set conn=nothing
