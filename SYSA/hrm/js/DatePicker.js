...
Calendar.prototype.style = function(){
	...
	strStyle += ".calendar {font-size:12px; margin:0;padding:0px;border:1px solid #CCC;background-color:#FFF;}";
	...
	strStyle += ".calendar .day li{font-weight:bold;} .calendar .date li{background-color:#ECF4FF;}";
	strStyle += ".calendar .month li{margin:10px 0px;float:left;width:16.67%;height:20px;line-height:20px;text-align:center;}";
	...
	strStyle += ".lastMonthDate, .nextMonthDate {color:#5B7CAE;font-size:11px}";
	...
	strStyle += ".calendarTitle{margin:20px 0;text-align:center;height:20px;line-height:20px;clear:both;width:100%;}";
	strStyle += ".calendarTitle .mark{text-decoration:none;color:#000;font-family:Tahoma;font-size:18px;font-weight:normal;}";
	strStyle += ".calendarBody{margin-top:20px;}"
	strStyle += ".today{ background-color:#ffffaa;border:1px solid #f60;padding:0 1px;}";
	strStyle += ".today a { color:#f30; }";
	strStyle += ".calendarBottom {text-align:center;height:20px;line-height:20px;clear:both;width:100%;padding:20px 0}";
	strStyle += ".calendarBottom li{float: none;height: 26px;line-height: 26px;"
		+ "text-align: center;display: inline-block;background: #EFEFEF;margin-left: 10px;"
		+ "padding: 0 10px;box-sizing: border-box;border-radius:3px}";
	strStyle += "</style>";
	return strStyle;
}
...
function Calendar(inputObj, dateFormatStyle, beginDate, endDate, lang, type) {   
  ...
  this.endDate = "2220-01-01".toDate();
...
Calendar.prototype.draw = function() {   
  ...
  lis += "<li id='PrevYear' class='mark' style='width:45%;' title='Previous Year'>&laquo;</li>";
  if("d" == this.type){
	...
	lis += "<li id='selectCurrent' style='width:45%;' title='Today'>" + Calendar.language.today[this.lang][0] +"</li>";
  	...
  	lis += "<li style='width:10%;'><span id='selectThisYear' class='selectThisYear'>" + this.date.getFullYear() + "</span>" + Calendar.language["title"][this.lang][0] + "</li>";
  	lis += "<li id='NextYear' class='mark' style='width:45%;' title='Next Year'>&raquo;</li></ul></div>";
  	lis += "<div class='calendarBody'>";
	...
	lis += "<li id='selectCurrent' title='Current Month'>" + Calendar.language.today[this.lang][1] +"</li>";
  }
  
  lis += "<li id='closeCalendar' title='Close'>" + Calendar.language.close[this.lang] +"</li>";
...
Calendar.prototype.selectThisYear = function(){
	...
	var selectStr = "<select style='font-size:10px;' onclick='window.event.cancelBubble=true' >";
...
Calendar.prototype.valueSelected = function(date){
	...
	HrformAction(date.format(this.dateFormatStyle));
}
...
Calendar.prototype.show = function () {
  ...
  this.panel.style.left = xy.x - 159 + 78 / 2+ "px";
...
document.write('<div id="calendarPanel" style="height:224px!important;position:absolute;visibility:hidden;z-index:9999;font-size:12px;">');
