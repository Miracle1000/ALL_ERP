...
'if isnull(values) then IsTime = null : exit function
	...
	Response.write Application("sys.info.jsver")
	Response.write """></script>" & vbcrlf & "<style type=""text/css"">" & vbcrlf & "<!--" & vbcrlf & "body {" & vbcrlf & " margin-top: 0px;" & vbcrlf & "}" & vbcrlf & "img{" & vbcrlf & "border:0}" & vbcrlf & ".style1 {color: #0066FF}" & vbcrlf & "#adddiv{" & vbcrlf & "width:1000px;" & vbcrlf & "height:300px;" & vbcrlf & "OVERFLOW:auto;" & vbcrlf & "SCROLLBAR-FACE-COLOR:#F0F4FD;SCROLLBAR-HIGHLIGHT-COLOR:#ffffff;SCROLLBAR-SHADOW-COLOR:#919192;SCROLLBAR-3DLIGHT-COLOR:#ffffff;SCROLLBAR-ARROW-COLOR:#919192;SCROLLBAR-TRACK-COLOR:#ffffff;SCROLLBAR-DARKSHADOW-COLOR:#ffffff;}" & vbcrlf & "-->" & vbcrlf & "</style>"& vbcrlf & "</head>" & vbcrlf & ""
	ord=request("ord")
	set ml=new myClass
	sql="select a.*,b.name from O_ChkBook a left join gate b on a.Chk_addcateid=b.ord where id="&ord
	set rs=conn.execute(sql)
	if not rs.eof then
		...
		rs7.close
		set rs7=nothing
		Response.write "" & vbcrlf & "<body bgcolor=""#ebebeb"">" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">      " & vbcrlf & "       <table width=""100%""border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf &      "     <tr> "& vbcrlf &      "       <td class=""place"">盘点详情</td> "& vbcrlf &    "         <td>&nbsp;</td> "& vbcrlf &        "     <td align=""right""><span id=""kh"">" & vbcrlf &  "              "
		if (open_103_2=3 or CheckPurview(intro_103_2,trim(addcateid))=True) then
			if rs("Chk_del")=2 then
				Response.write "" & vbcrlf & "                       <input name=""button4"" type=""button""  class=""anybutton2"" id=""submit4"" onClick=""javascript:window.location=('Update_Check1.asp?ord="
				Response.write rs("id")
				Response.write "')"" value=""盘点""/>" & vbcrlf & "                   "
			end if
			Response.write "" & vbcrlf & "                       <input name=""button4"" type=""button""  class=""anybutton2"" id=""submit4"" onClick=""javascript:window.open('Update_Check.asp?ord="
			Response.write rs("id")
		...
		if open_103_3=3 or CheckPurview(intro_103_3,trim(addcateid))=True then
			Response.write "" & vbcrlf & "                      <input name=""button5"" type=""button""  class=""anybutton2"" id=""submit5"" onClick=""if(confirm('确认删除吗？')){window.location=('Del_Check.asp?ord="
			Response.write rs("id")
			Response.write "&px="
			Response.write px
			Response.write "&A="
		...
		Response.write "</span>" & vbcrlf & "                      </td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>  " & vbcrlf & "      <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "      <tr class=""top"">" & vbcrlf & "        <td width=""15%"" height=""27"" ><div align=""left""><strong>基本信息</strong></div></td>" & vbcrlf & "        <td height=""27"" colspan=""5""></td>" & vbcrlf & "        </tr>" & vbcrlf & "            <tr>" & vbcrlf & "                    <td height=""30""><div align=""right"">盘点主题：</div></td>" & vbcrlf & "                 <td width=""18%"" class=""gray"">"
		Response.write rs("Chk_title")
		Response.write "</td>" & vbcrlf & "                    <td width=""16%""><div align=""right"">盘点时间：</div></td>" & vbcrlf & "                    <td width=""16%"" class=""gray"">"
		Response.write rs("Chk_time")
		Response.write "</td>" & vbcrlf & "                    <td width=""16%""><div align=""right"">盘点人员：</div></td>" & vbcrlf & "                    <td width=""19%"" class=""gray"">"
		Response.write rs("name")
		Response.write "</td>" & vbcrlf & "                </tr>" & vbcrlf & "           <tr>" & vbcrlf & "                    <td height=""30""><div align=""right"">添加时间：</div></td>" & vbcrlf & "                    <td width=""18%"" class=""gray"">"
		Response.write rs("Chk_addtime")
		Response.write "</td>" & vbcrlf & "                    <td width=""16%""><div align=""right"">添加人员：</div></td>" & vbcrlf & "                    <td colspan=""3"" class=""gray"">"
		Response.write addname
		Response.write "</td>" & vbcrlf & "            </tr>" & vbcrlf & "               <tr>" & vbcrlf & "                    <td height=""30""><div align=""right"">盘点备注：</div></td>" & vbcrlf & "                    <td colspan=""5"" class=""gray ewebeditorImg"">"
		Response.write rs("chk_note")
		Response.write "</td>" & vbcrlf & "                </tr>" & vbcrlf & "        <tr>" & vbcrlf & "                 <td colspan=""6"">" & vbcrlf & "                        <table border=""0"" width=""100%"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf & "                              <tr>" & vbcrlf & "                                    <td height=""27"" width=""15%"" align=""center""><pre><b>书名</b></td>" & vbcrlf & "                                      <td height=""27"" width=""12%"" align=""center""><pre><b>编号</b></td>" & vbcrlf & "                                      <td height=""27"" width=""12%"" align=""center""><pre><b>分类</b></td>" & vbcrlf & "                                      <td height=""27"" width=""12%"" align=""center""><pre><b>ISBN</b></td>" & vbcrlf & "                                        <td height=""27"" width=""8%"" align=""center""><pre><b>账面数量</b></td>" & vbcrlf & "                                   <td height=""27"" width=""8%"" align=""center""><pre><b>实际数量</b></td>" & vbcrlf & "                                   <td height=""27"" width=""8%"" align=""center""><pre><b>盈亏数量</b></td>" & vbcrlf & "                                   <td height=""27"" width=""286"" align=""center""><pre><b>备注</b></td>" & vbcrlf & "                            "
		sqls="select a.*,b.bk_name,b.bk_bh,b.bk_isbn,c.set_name from O_ChkBookmx a "&_
		"left join O_regbook b on a.Chk_bkid=b.id "&_
		"left join O_bookSet c on b.bk_type=c.id where Chk_fid="&rs("id")
		set rss=conn.execute(sqls)
		if not rss.eof then
			do while not rss.eof
				Response.write "" & vbcrlf & "                             </tr>" & vbcrlf & "                                   <td width=""15%"" height=""27""><div align=""center"">" & vbcrlf & "                                      "
				if open_103_14=3 or CheckPurview(intro_103_14,trim(addcateid))=True then
					...
					Response.write rss("chk_bkid")
					Response.write "','neww35win','width=' + 1000 + ',height=' + 600 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=200,top=200')"">" & vbcrlf & "                                       "
					Response.write rss("chk_bkid")
				end if
				Response.write rss("bk_name")
				Response.write "</a></div></td>" & vbcrlf & "                                      <td width=""12%"" height=""27""><div align=""center"">"
				Response.write rss("bk_bh")
				Response.write "</div></td>" & vbcrlf & "                                  <td width=""12%"" height=""27""><div align=""center"">"
				Response.write rss("set_name")
				Response.write "</div></td>" & vbcrlf & "                                  <td width=""12%"" height=""27""><div align=""center"">"
				Response.write rss("bk_isbn")
				Response.write "</div></td>" & vbcrlf & "                                  <td width=""8%"" height=""27""><div align=""center"">"
				Response.write FormatNumber(rss("chk_sjnum"),num1_dot,-1)
				Response.write "</div></td>" & vbcrlf & "                                  <td width=""8%"" height=""27""><div align=""center"">"
				Response.write FormatNumber(rss("chk_pdnum"),num1_dot,-1)
				Response.write "</div></td>" & vbcrlf & "                                  <td width=""8%"" height=""27""><div align=""center"">"
				Response.write FormatNumber(rss("chk_yknum"),num1_dot,-1)
				Response.write "</div></td>" & vbcrlf & "                                  <td height=""27""><div align=""center"">"
				Response.write rss("chk_note1")
				Response.write "</div></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                           "
				allnums1=ml.IsNum(allnums1)+rss("chk_sjnum")
				Response.write "</div></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                           "
				allnums2=ml.IsNum(allnums2)+rss("chk_pdnum")
				Response.write "</div></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                           "
				allnums3=ml.IsNum(allnums3)+rss("chk_yknum")
				Response.write "</div></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                           "
				rss.movenext
			loop
		else
			Response.write "</tr><td colspan='8'>暂无明细！</td></tr>"
		end if
		set rss=nothing
		Response.write "" & vbcrlf & "                             <tr>" & vbcrlf & "                                    " & vbcrlf & "                                        <td align=""right"" colspan=""4""><pre>合计：</td>" & vbcrlf & "                                <td width=""8%"" align=""center""><div id=""allnums1"">"
		Response.write FormatNumber(allnums1,num1_dot,-1)
		Response.write "</div></td>" & vbcrlf & "                            <td width=""8%"" align=""center""><div id=""allnums2"">"
		Response.write FormatNumber(allnums2,num1_dot,-1)
		Response.write "</div></td>" & vbcrlf & "                            <td width=""8%"" align=""center""><div id=""allnums3"">"
		Response.write FormatNumber(allnums3,num1_dot,-1)
		Response.write "</div></td>" & vbcrlf & "                                  <td align=""center""></td>" & vbcrlf & "                          </tr>" & vbcrlf & "                   </table>                 </td>" & vbcrlf & "          </tr>" & vbcrlf & "    </table>" & vbcrlf & "       </td>" & vbcrlf & "  </tr>" & vbcrlf & "  <tr>" & vbcrlf & "  <td class=""page"" height=""2000"">" & vbcrlf & " <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "             <tr>" & vbcrlf & "                    <td height=""30"" ><div align=""center""></div></td>" & vbcrlf & "            </tr>" & vbcrlf & "   </table>" & vbcrlf & "  </td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & ""
	else
