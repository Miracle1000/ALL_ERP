...
'bigsystemtype = ".mozi"
	...
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=1"
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=14"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_14=0
		intro_24_14=0
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=16"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_16=0
		intro_24_16=0
	else
		open_24_16=rs1("qx_open")
		intro_24_16=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=2"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_2=0
		intro_24_2=0
	else
		open_24_2=rs1("qx_open")
		intro_24_2=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=3"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_3=0
		intro_24_3=0
	else
		open_24_3=rs1("qx_open")
		intro_24_3=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=5"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_5=0
		intro_24_5=0
	else
		open_24_5=rs1("qx_open")
		intro_24_5=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=6"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_6=0
		intro_24_6=0
	else
		open_24_6=rs1("qx_open")
		intro_24_6=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=7"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_7=0
		intro_24_7=0
	else
		open_24_7=rs1("qx_open")
		intro_24_7=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=8"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_8=0
		intro_24_8=0
	else
		open_24_8=rs1("qx_open")
		intro_24_8=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=10"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_10=0
		intro_24_10=0
	else
		open_24_10=rs1("qx_open")
		intro_24_10=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=24 and sort2=17"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_17=0
		intro_24_17=0
	else
		open_24_17=rs1("qx_open")
		intro_24_17=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open from power  where ord="& curCate &" and sort1=24 and sort2=18"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_24_18=0
	else
		open_24_18=rs1("qx_open")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=4 and sort2=1"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_4_1=0
		intro_4_1=0
		...
		If intro_4_1&""="" Then intro_4_1="" Else intro_4_1 = Replace(intro_4_1&""," ","")
	end if
	rs1.close
	...
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=25 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_25_13=0
		intro_25_13=0
		...
		intro_25_13=rs1("qx_intro")
	end if
	rs1.close
	sql1="select qx_open,qx_intro from power  where ord="& curCate &" and sort1=22 and sort2=13"
	rs1.open sql1,conn,1,1
	if rs1.eof then
		open_22_13=0
		intro_22_13=0
...
'Private Sub Class_Initialize
	...
	if open_24_1=3 then
		list1=""
	elseif open_24_1=1 then
		list1="and a.cateid in ("&intro_24_1&")"
	else
		list1="and a.cateid=0"
	end if
	Str_Result="where a.del=1 "&list1&""
	noDel = Request("noDel")
	ksjs = request("ksjs")
	If Len(ksjs&"") > 0 Then
		C2 = request("C2")
		Select Case ksjs
		Case "xjzt" : Str_Result=Str_Result&" and  a.title like '%"&C2&"%' "
		Case "xjbh" : Str_Result=Str_Result&" and  a.xjid like '%"&C2&"%' "
		Case "xjstatus" : If C2<>7 Then Str_Result=Str_Result&" and a.status ="&C2&" "
		Case "zdy1" : Str_Result=Str_Result&" and  a.zdy1 like '%"&C2&"%' "
		Case "zdy2" : Str_Result=Str_Result&" and  a.zdy2 like '%"&C2&"%' "
		Case "zdy3" : Str_Result=Str_Result&" and  a.zdy3 like '%"&C2&"%' "
		Case "zdy4" : Str_Result=Str_Result&" and  a.zdy4 like '%"&C2&"%' "
		Case "zdy5" : Str_Result=Str_Result&" and  a.zdy5 ="&C2&" "
		Case "zdy6" : Str_Result=Str_Result&" and  a.zdy6 ="&C2&" "
		End Select
	else
		adSearch = request("adSearch")
		If adSearch&"" = "0" Then
			m1=request("ret") : m2=request("ret2")
			D=request("D") : B1=request("B1") : C1=request("C1")
			if m1<>"" Then Str_Result=Str_Result&" and a. date1>='"&m1&"'"
			if m2<>"" Then Str_Result=Str_Result&" and  a.date1<='"&m2&"'"
			If D&""<>"" Then Str_Result=Str_Result&" and  isnull(a.status,1) in  ("&D&")"
			if C1<>"" then
				Select Case B1
				Case "xjzt" : Str_Result=Str_Result&" and  a.title like '%"&C1&"%'"
				Case "xjbh" : Str_Result=Str_Result&" and  a.xjid like '%"&C1&"%'"
				Case "xjry" : Str_Result=Str_Result&" and  c.name like '%"&C1&"%'"
				Case "zdy1" : Str_Result=Str_Result&" and  a.zdy1 like '%"&C1&"%'"
				Case "zdy2" : Str_Result=Str_Result&" and  a.zdy2 like '%"&C1&"%'"
				Case "zdy3" : Str_Result=Str_Result&" and  a.zdy3 like '%"&C1&"%'"
				Case "zdy4" : Str_Result=Str_Result&" and  a.zdy4 like '%"&C1&"%'"
				Case "zdy5" : Str_Result=Str_Result&" and  a.zdy5 in(select ord from sortonehy where gate2=(select gl from zdy where sort1=24 and name='zdy5') and sort1 like '%"&C1&"%')"
				Case "zdy6" : Str_Result=Str_Result&" and  a.zdy6 in(select ord from sortonehy where gate2=(select gl from zdy where sort1=24 and name='zdy6') and sort1 like '%"&C1&"%')"
				End Select
			end if
		ElseIf adSearch&"" = "1" Then
			wtype=request("wtype") : W1=request("W1") : W2=request("W2") : W3=request("W3")
			xjzt = Request("xjzt") : ygzt = Request("ygzt") : cgzt = Request("cgzt")
			xjTitle=request("xjTitle") : xjbh = Request("xjbh") : remark = Request("remark")
			zdy1=request("zdy1") : zdy2=request("zdy2") : zdy3=request("zdy3") : zdy4=request("zdy4") : zdy5=request("zdy5") : zdy6=request("zdy6")
			cpTitle=request("cpTitle") : cpbh = Request("cpbh") : cptype1 = Request("cptype1")
			m1=request("ret") : m2=request("ret2") : m3=request("ret3") : m4=request("ret4")
			if request("W4")=1 then
				W3=W3
			else
				W3=getW3(W1,W2,W3)
			end if
			...
			if W4<>"" Then
				wtype = Replace(wtype&""," ","")
				If wtype&""="" Or wtype&""="," Then wtype="1"
				Str_Result=Str_Result&" and  ("
				If InStr(","& wtype &",",",1,")>0 Then Str_Result=Str_Result&" a.cateid in  ("&W3&")"
				If InStr(","& wtype &",",",2,")>0 Then
					If InStr(","& wtype &",",",1,")>0 Then Str_Result=Str_Result&" or "
					Str_Result=Str_Result&" a.cateid_dj in  ("&W3&")"
				end if
				Str_Result=Str_Result&" )"
			end if
			if xjTitle<>"" Then Str_Result=Str_Result&" and a.title like '%"&xjTitle&"%'"
			if xjbh<>"" Then Str_Result=Str_Result&" and a.xjid like '%"&xjbh&"%'"
			If xjzt&""<>"" Then Str_Result=Str_Result&" and  isnull(a.status,1) in  ("&xjzt&")"
			if ygzt&""<>"" Then Str_Result=Str_Result&" and  isnull(a.complete,(case isnull(a.caigou_yg,0) when 0 then (case when s.ygNum>0 then (case when s.ygNum>=s.xjNum then 1 else 2 end) else 0 end) else 3 end)) in ("&ygzt&")"
			if cgzt&""<>"" Then Str_Result=Str_Result&" and  (case when s.cgNum>0 then (case when s.cgNum>=s.xjNum then 1 else 2 end) else 0 end) in ("&cgzt&")"
			if zdy1<>"" Then Str_Result=Str_Result&" and  a.zdy1 like '%"&zdy1&"%'"
			if zdy2<>"" Then Str_Result=Str_Result&" and  a.zdy2 like '%"&zdy2&"%'"
			if zdy3<>"" Then Str_Result=Str_Result&" and  a.zdy3 like '%"&zdy3&"%'"
			if zdy4<>"" Then Str_Result=Str_Result&" and  a.zdy4 like '%"&zdy4&"%'"
			if zdy5<>"" Then Str_Result=Str_Result&" and  a.zdy5 in  ("&zdy5&")"
			if zdy6<>"" Then Str_Result=Str_Result&" and  a.zdy6 in  ("&zdy6&")"
			If remark <> "" Then Str_Result=Str_Result&" AND a.remark LIKE '%"&remark&"%'"
			If cpTitle&""<>"" Then Str_Result=Str_Result&" and  a.id in  (select xunjia from xunjialist where del=1 and ord in(select ord from product where title like '%"&cpTitle&"%'))"
			If cpbh&""<>"" Then Str_Result=Str_Result&" and  a.id in  (select xunjia from xunjialist where del=1 and ord in(select ord from product where order1 like '%"&cpbh&"%'))"
			If cptype1&""<>"" Then Str_Result=Str_Result&" and  a.id in  (select xunjia from xunjialist where del=1 and ord in(select ord from product where type1 like '%"&cptype1&"%'))"
			if m1<>"" Then Str_Result=Str_Result&" and  a.date1>='"&m1&"'"
			if m2<>"" Then Str_Result=Str_Result&" and  a.date1<='"&m2&" 23:59:59'"
			if m3<>"" Then Str_Result=Str_Result&" and  a.date7>='"&m3&"'"
			if m4<>"" Then Str_Result=Str_Result&" and  a.date7<='"&m4&" 23:59:59'"
		end if
	end if
	dim newstate
	...
	if newstate="1" then
		...
		sql9="select ord,intro,num1,tq1,fw1 from setjm2  where ord=54  and cateid="&session("personzbintel2007")&""
		rs9.open sql9,conn,1,1
		if rs9.eof then
		else
			if rs9("fw1")="0" then
				if openPower(24,1)=3 then
					Str_Result=Str_Result&""
				elseif openPower(24,1)=1 then
					Str_Result=Str_Result&" and a.cateid in ("&introPower(24,1)&")"
				else
					Str_Result=Str_Result&" and a.cateid=0"
				end if
			else
				Str_Result=Str_Result&" and a.cateid="&session("personzbintel2007")&""
			end if
		end if
		rs9.close
		set rs9=nothing
	...
	If request("remind") <> "" Then
		Set helper = CreateReminderHelper(conn,136,0)
		str_Result1 = " and a.id in (" & helper.listSQL("ids") & ")"
	end if
	...
	if px="" then px=1
	Select Case px
	Case 1 : px_Result=" order by a.date7 desc"
	Case 2 : px_Result=" order by a.date7 asc"
	Case 3 : px_Result=" order by a.title desc"
	Case 4 : px_Result=" order by a.title asc"
	Case 5 : px_Result=" order by a.xjid desc"
	Case 6 : px_Result=" order by a.xjid asc"
	Case 7 : px_Result=" order by isnull(a.status,1) desc"
	Case 8 : px_Result=" order by isnull(a.status,1) asc"
	Case 9 : px_Result=" order by complete desc"
	Case 10 : px_Result=" order by complete asc"
	Case 11 : px_Result=" order by a.date1 desc"
	Case 12 : px_Result=" order by a.date1 asc"
	End Select
	xjMoreyg = 0 : xjMorecg = 0
	Set rs = conn.execute("select isnull((select isnull(intro,0) intro from setopen where sort1=2016091806),0) xjMoreyg, isnull((select isnull(intro,0) intro from setopen where sort1=2016102801),0) xjMorecg")
	If rs.eof = False Then
		xjMoreyg = rs("xjMoreyg")
		xjMorecg = rs("xjMorecg")
	end if
	rs.close
	set rs = nothing
	currpage=Request("currpage")
	if isnull(currpage) Or isnumeric(currpage)=False then currpage = 1
	...
	Response.write Application("sys.info.jsver")
	Response.write """ rel=""stylesheet"" type=""text/css"">" & vbcrlf & "<style>" & vbcrlf & ".place{height:42px;}" & vbcrlf & ".xjListTable td, #content tr.top td{text-align:center}" & vbcrlf & "#ht1 #content{margin-bottom:-1px;}" & vbcrlf & ".ie5 input.anybutton.aa{margin-bottom:-0.5px;height:19px;line-height:16px;}" & vbcrlf & "#kh{height:50px !important;line-height:50px !important;}" & vbcrlf & "#kh td{" & vbcrlf & "       padding-right:0px!important;" & vbcrlf & "}" & vbcrlf & "#kh #demo{" & vbcrlf & " padding-right:16px!important;" & vbcrlf & "}" & vbcrlf & "</style>" & vbcrlf & "<script src= ""../Script/xa_event.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  type=""text/javascript""></script>" & vbcrlf & "</head>" & vbcrlf & "<body "
	if open_24_8=0 then
		Response.write " oncontextmenu=self.event.returnValue=false"
	end if
	Response.write " >" & vbcrlf & "<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""100%"" valign=""top"">  " & vbcrlf & "              <table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf& "                 <tr>" & vbcrlf & "        <td class=""place"">所有询价单</td>" & vbcrlf & "        <td>&nbsp;<a href=""javascript:void(0)"" onClick=""Myopen_px(User);return false;"" class=""sortRule"">排序规则<img src=""../images/i10.gif"" width=""9"" height=""5"" border=""0""></a></td>" & vbcrlf & "        <td align=""right"">" & vbcrlf & "          <select name=""select5""  onChange=""if(this.selectedIndex && this.selectedIndex!=0){gotourl(this.value);}"">" & vbcrlf & "            <option>-请选择-</option>" & vbcrlf & "            <option value=""page_count=10"" "
	Response.write " oncontextmenu=self.event.returnValue=false"
	...
	if open_24_10=1 or open_24_10=3 Then
		Response.write "<input type=""button"" name=""Submitdel2"" value=""EXCEL导出"" onClick=""if(confirm('确认导出为EXCEL文档？')){exportExcel({from:'form_with_page_action',page:'../out/xls_xj.asp?"
		Response.write sdk.ReturnURL("")
		Response.write "'})}"" class=""anybutton2""/>"
	end if
	if open_24_7=3 or (open_24_7=1 and  CheckPurview(intro_24_7,trim(cateid))=True) then
		Response.write "<input type=""button"" name=""Submit43"" value=""打印""  onClick=""javascript:window.print();""   class=""anybutton""/>" & vbcrlf & "          "
	end if
	Response.write "</td>" & vbcrlf & "        <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "      </table>" & vbcrlf & " <div id = ""kh"">" & vbcrlf & "           <table width=""100%"" border=""0"" cellpadding=""3"" style=""word-break:break-all;word-wrap:break-word;border-collapse:collapse;"">" & vbcrlf & "                       <tr>" & vbcrlf & "                            <td background=""../images/112.gif"" height=""30"" align=""right"" style=""border-top:#C0CCDD 1px solid;border-left:#C0CCDD 1px solid;border-right:#C0CCDD 1px solid;"">" & vbcrlf & "                                <form action=""event.asp"" method=""get"" id=""demo""  name=""date"" style=""margin:0;"">" & vbcrlf &                          "<input type=""hidden"" name=""adSearch"" id=""adSearch"" value=""0"">" & vbcrlf &                            "询价日期"
	...
	Response.write "" & vbcrlf & "                             <select name=""D"">" & vbcrlf & "                                 <option value="""">询价状态</option>" & vbcrlf & "                                        <option value=""0"" "
	If D&""="0" Then Response.write "selected"
	Response.write ">暂存</option>" & vbcrlf & "                                       <option value=""1"" "
	If D&""="1" Then Response.write "selected"
	Response.write ">询价中，待定价</option>" & vbcrlf & "                                     <option value=""2"" "
	If D&""="2" Then Response.write "selected"
	Response.write ">询价中，部分定价</option>" & vbcrlf & "                                   <option value=""3"" "
	If D&""="3" Then Response.write "selected"
	Response.write ">询价完毕</option>" & vbcrlf & "                                   <option value=""4"" "
	If D&""="4" Then Response.write "selected"
	Response.write ">已终止</option>" & vbcrlf & "                             </select>" & vbcrlf & "                               <select name=""B1"" style=""width:100px;"">" & vbcrlf & "                               <option value=""xjzt"" "
	if B1="xjzt" then
		Response.write "selected"
	end if
	Response.write ">询价主题</option>" & vbcrlf & "                             <option value=""xjbh"" "
	if B1="xjbh" then
		Response.write "selected"
	end if
	Response.write ">询价编号</option>" & vbcrlf & "                             <option value=""xjry"" "
	if B1="xjry" then
		Response.write "selected"
	end if
	Response.write ">询价人员</option>" & vbcrlf & "                             "
	Set rs = conn.execute("select title,name from zdy where sort1=24 and set_open=1 and js=1 order by gate1 asc ")
	While rs.eof = False
	...
	rs.close
	set rs = nothing
	Response.write "" & vbcrlf & "                             </select>" & vbcrlf & "                               <input name=""C1"" type=""text"" value="""
	Response.write C1
	Response.write """ style=""width:120px;""/>" & vbcrlf & "                            <input type=""submit"" name=""Submit422"" value=""检索""  class=""anybutton aa""/>" & vbcrlf & "                              <a href=""javascript:void(0)"" class=""AfterQuickSearch"" onclick=""search_lb();document.getElementById('kh').style.display='none';document.getElementById('ht1').style.display='';return false;""><img src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">高级检索</font></u></a>" & vbcrlf & "                               </form>" & vbcrlf & "                         </td>" & vbcrlf & "                   </tr>" & vbcrlf & "           </table></div>" & vbcrlf & "          <form action=""event.asp"" method=""get"" id=""demo2""  name=""xjFrom"" style=""margin:0"">" & vbcrlf &           "<span id=""ht1""></span><input type=""hidden"" name=""adSearch"" id=""adSearch"" value=""1"">" & vbcrlf &                "</form>" & vbcrlf & "<table width=""100%"" border=""0"" cellpadding=""5"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" class=""xjListTable"">" & vbcrlf & "    <tr class=""top"">" & vbcrlf & "    <td width=""5%"">选择</td>" & vbcrlf & "          <td width=""12%"" height=""26"">询价编号</td>" & vbcrlf & "   <td width=""16%"">询价主题</td>" & vbcrlf & "     <td width=""8%"">询价日期</td>" & vbcrlf & "      <td width=""8%"">询价状态</td>" & vbcrlf & "          <td width=""8%"">定价人员</td>" & vbcrlf & "      <td width=""8%"">询价人员</td>" & vbcrlf & ""
	if ZBRuntime.MC(4000) then
		Response.write "" & vbcrlf & "       <td width=""15%"">关联报价</td>" & vbcrlf & ""
	end if
	Response.write "" & vbcrlf & "       <td width=""15%"">操作</td>" & vbcrlf & "         </tr>" & vbcrlf & ""
	n=0 : hasPriceModel = ZBRuntime.MC(4000)
	set rs=server.CreateObject("adodb.recordset")
	sql = "select a.id,a.title,a.xjid, isnull(a.fromtype,0) fromtype, isnull(a.caigou_yg,0) caigou_yg, "& vbCrLf &_
	"                  isnull(a.complete,(case isnull(a.caigou_yg,0) when 0 then (case when s.ygNum>0 then (case when s.ygNum>=s.xjNum then 1 else 2 end) else 0 end) else 1 end)) complete, "& vbCrLf &_
	"                  (case when s.cgNum>0 then (case when s.cgNum>=s.xjNum then 1 else 2 end) else 0 end) complete2, "& vbCrLf &_
	"                  isnull(a.cateid,0) cateid,isnull(a.cateid_dj,0) cateid_dj,isnull(a.price,0) price, "& vbCrLf &_
	"                  a.date1,a.status, a.ystatus, "& vbCrLf &_
	"                  c.name cateName, d.name djname, isnull(b.title,'') bjTitle, isnull(b.cateid,0) cateid2  "& vbCrLf &_
	"          from xunjia a WITH(NOLOCK) "& vbCrLf &_
	"          left join price b WITH(NOLOCK) on a.price=b.ord  "& vbCrLf &_
	"                  and ("& open_4_1 &"=3 or ("& open_4_1 &"=1 and CHARINDEX(','+CAST(b.cateid as varchar(10))+',',',"& intro_4_1 &",')>0)) "& vbCrLf &_
	"          left join gate c WITH(NOLOCK) on c.ord=a.cateid "& vbCrLf &_
	"          left join gate d WITH(NOLOCK) on d.ord=a.cateid_dj "& vbCrLf &_
	"          left join ( "& vbCrLf &_
	"                  select a.xunjia,SUM(a.num1) xjNum,SUM(b.num1) ygNum,SUM(c.num1) cgNum "& vbCrLf &_
	"                  from ( "& vbCrLf &_
	"                          select id, xunjia, num1 from xunjialist where del=1 and toUse=1 "& vbCrLf &_
	"                          union all  "& vbCrLf &_
	"                          Select id, xunjia, num1 From xunjialist a  "& vbCrLf &_
	"                          left join ( "& vbCrLf &_
	"                                  select distinct pricelist from xunjialist where del=1 and toUse=2 "& vbCrLf &_
	"                          ) b on a.id=b.pricelist and a.del=1 "& vbCrLf &_
	"                                  and a.id not in(select pricelist from xunjialist where del=1 and toUse=1) "& vbCrLf &_
	"                          where a.Xunjiastatus=1 or b.pricelist>0 "& vbCrLf &_
	"                          union all "& vbCrLf &_
	"                          Select c.id, a.id xunjia, c.num1 from xunjia a WITH(NOLOCK) "& vbCrLf &_
	"                          inner join price b WITH(NOLOCK) on b.ord=a.price and a.del=1 and b.del=1 "& vbCrLf &_
	"                          inner join pricelist c WITH(NOLOCK) on c.del=3 and c.price=b.ord "& vbCrLf &_
	"                          left join ( "& vbCrLf &_
	"                                  select distinct pricelist from xunjialist where del=1 and isnull(toUse,0)=2 "& vbCrLf &_
	"                          ) d on c.id=d.pricelist and c.id not in(select pricelist from xunjialist where del=1 and toUse=1) "& vbCrLf &_
	"                          where c.xunjiastatus=1 or d.pricelist>0 "& vbCrLf &_
	"                  ) a "& vbCrLf &_
	"                  left join (  "& vbCrLf &_
	"                          select xunjialist,SUM(num1) num1 from caigoulist_yg WITH(NOLOCK) where del=1 group by xunjialist  "& vbCrLf &_
	"                  ) b  on b.xunjialist=a.id "& vbCrLf &_
	"                  left join (  "& vbCrLf &_
	"                          select xunjialist,SUM(num1) num1 from caigoulist WITH(NOLOCK) where del=1 group by xunjialist  "& vbCrLf &_
	"                  ) c on c.xunjialist=a.id "& vbCrLf &_
	"                  group by a.xunjia "& vbCrLf &_
	"          ) s on s.xunjia=a.id "& Str_Result & px_Result
	rs.open sql,conn,3,1
	if rs.RecordCount<=0 then
		Response.write "<table><tr><td align='center'>没有信息!</td></tr><tr><td height='500'></td></tr></table>"
	else
		...
		do until rs.eof
			xjord = rs("id") : xjTitle=rs("title") : xjbh = rs("xjid")
			xjord_pw = pwurl(xjord)
			complete=rs("complete") : complete2=rs("complete2") : status=rs("status") : ystatus=rs("ystatus")
			cateid=rs("cateid") : cateid_dj = rs("cateid_dj") : cateName = rs("cateName") : djname = rs("djname")
			price=rs("price") : xjdate = rs("date1") : bjTitle = rs("bjTitle") : cateid2 = rs("cateid2")
			fromtype = rs("fromtype") : caigou_yg = rs("caigou_yg")
			If caigou_yg&"" = "" Then caigou_yg = 0
			Select Case status
			Case 0 : trade5 = "暂存"
			Case 1 : trade5 = "询价中，待定价"
			Case 2 : trade5 = "询价中，部分定价"
			Case 3 : trade5 = "询价完毕"
			Case 4 : trade5 = "已终止"
			End Select
			Response.write "" & vbcrlf & "     <tr onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='efefef'"">" & vbcrlf & "     <td>" & vbcrlf & "    "
			if (((complete=0 And complete2=0) Or caigou_yg>0) And (open_24_3=3 or CheckPurview(intro_24_3,trim(cateid))=True)) Or (open_24_6=3 or CheckPurview(intro_24_6,trim(cateid))=True) Then
				Response.write "<input name=""selectid"" type=""checkbox"" value="""
				Response.write xjord
				Response.write """ "
				If ((complete=0 And complete2=0) Or caigou_yg>0) And (open_24_3=3 or CheckPurview(intro_24_3,trim(cateid))=True) Then Response.write "delAble='1'" Else Response.write "delAble='0'"
				If status<>4 And (open_24_6=3 or CheckPurview(intro_24_6,trim(cateid))=True) Then Response.write "zpAble='1'" Else Response.write "zpAble='0'"
				Response.write ">"
			end if
			Response.write "</td> " & vbcrlf & "               <td height=""27"" >"
			Response.write xjbh
			Response.write "</td>" & vbcrlf & "                <td style=""text-align:left""> "
			Response.write xjbh
			if open_24_14=3 or CheckPurview(intro_24_14,trim(cateid))=True then
				Response.write "<a href=""javascript:;"" onclick=""xjContet("
				Response.write "'"& xjord_pw &"',"& price
				Response.write ")"">"
			end if
			Response.write""& xjTitle &""
			Response.write "</a>" & vbcrlf & "         <span id=""tip_"
			Response.write xjord
			Response.write """ class=""red"">"
			If noDel&""<>"" Then
				If InStr(","& noDel &",",","& xjord &",")>0 Then Response.write "可以删除"
			end if
			Response.write "</span></td>" & vbcrlf & "   <td>"
			Response.write xjdate
			Response.write "</td>" & vbcrlf & "          <td>"
			Response.write trade5
			Response.write "</td>" & vbcrlf & "          <td>"
			Response.write djname
			Response.write "</td>" & vbcrlf & "          <td>"
			Response.write cateName
			Response.write "</td>" & vbcrlf & ""
			if hasPriceModel Then
				Response.write "" & vbcrlf & "       <td style=""text-align:left""> "
'if hasPriceModel Then
				if bjTitle&""<>"" then
					if open_4_14=3 Or (open_4_14=1 And  CheckPurview(intro_4_14,trim(cateid2))=True) Then
						Response.write "<a href=""javascript:;"" onclick=""bjContet('"
						Response.write pwurl(price)
						Response.write "')"">"
					end if
					Response.write bjTitle
					Response.write "</a>" & vbcrlf & "         "
				end if
				Response.write "" & vbcrlf & "             </td>" & vbcrlf & ""
			end if
			Response.write "" & vbcrlf & "       <td class=""func"">" & vbcrlf & "               <div>" & vbcrlf & "                   "
			if open_24_14=3 or CheckPurview(intro_24_14,trim(cateid))=True then
				Response.write "" & vbcrlf & "                             <input type=""button"" value=""详情""  onClick=""xjContet("
				Response.write "'"& xjord_pw &"',"& price
				Response.write ")""/>" & vbcrlf & "                      "
			end if
			If status = 0 And cateid&""=session("personzbintel2007")&"" Then
				If price>0 Then
					Response.write "" & vbcrlf & "                             <input type=""button"" value=""编辑""  onClick=""priceXjEditWin("
					Response.write "'"& pwurl(price) &"'"
					Response.write ")""/>" & vbcrlf & "                      "
				ElseIf fromtype = 2 Then
					Response.write "" & vbcrlf & "                             <input type=""button"" value=""编辑""  onClick=""ygXjEditWin("
					Response.write "'"& pwurl(caigou_yg) &"','"& xjord_pw &"'"
					Response.write ")""/>" & vbcrlf & "                      "
				else
					Response.write "" & vbcrlf & "                             <input type=""button"" value=""编辑""  onClick=""xjEditWin("
					Response.write "'"& xjord_pw &"'"
					Response.write ")""/>" & vbcrlf & "                      "
				end if
				If 1=0 Then
					if open_24_18=1 then
						Response.write "" & vbcrlf & "                             <input type=""button"" value=""终止""  onClick=""setXjStatus("
						Response.write xjord &",4"
						Response.write ")""/>" & vbcrlf & "                      "
					end if
				end if
			ElseIf status>0 And status<4 Then
				if (open_24_17=3 or CheckPurview(intro_24_17,trim(cateid))=True) And (status>0 And status<3) And cateid_dj&""=session("personzbintel2007")&"" then
					Response.write "" & vbcrlf & "                             <input type=""button"" value=""定价""  onClick=""mkPriceWin('"
					Response.write xjord_pw
					Response.write "')""/>" & vbcrlf & "                     "
				end if
				If 1=0 Then
					if (status=2 Or status=3) And (xjMoreyg&""="0" Or (xjMoreyg&""="1" And (complete&""="0" Or complete&""="2"))) and (open_25_13=3 or CheckPurview(intro_25_13,trim(cateid))=True) then
						Response.write "" & vbcrlf & "                             <input type=""button"" name=""Submit33"" value=""预购""  onClick=""addYGWin('"
						Response.write xjord_pw
						Response.write "')""/>" & vbcrlf & "                     "
					end if
					if (status=2 Or status=3) And (xjMorecg&""="0" Or (xjMorecg&""="1" And complete2&""<>"1")) and (open_22_13=3 or CheckPurview(intro_22_13,trim(cateid))=True) then
						Response.write "" & vbcrlf & "                             <input type=""button"" name=""Submit33"" value=""采购""  onClick=""addCGWin('"
						Response.write xjord_pw
						Response.write "')""/>" & vbcrlf & "                     "
					end if
					if open_24_18=1 then
			...
			ElseIf status=4 Then
				If 1=0 Then
					if open_24_18=1 then
						Response.write "" & vbcrlf & "                             <input type=""button"" value=""取消终止""  onClick=""setXjStatus("
						Response.write xjord &","& ystatus
						Response.write ")""/>" & vbcrlf & "                      "
					end if
				end if
			end if
			If status>0 Then
				if open_24_2=3 or CheckPurview(intro_24_2,trim(cateid))=True then
					Response.write "" & vbcrlf & "                             <input type=""button"" value=""修改""  onClick=""xjCorrectWin('"
					Response.write xjord_pw
					Response.write "')""/>" & vbcrlf & "                     "
				end if
			end if
			if ((complete=0 And complete2=0) Or caigou_yg>0) And (open_24_3=3 or CheckPurview(intro_24_3,trim(cateid))=True) then
				Response.write "" & vbcrlf & "                             <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='Delete.asp?"
				Response.write sdk.ReturnURL("ord=" & xjord &"")
				Response.write "'}""/>" & vbcrlf & "                     "
			end if
		...
		loop
		Response.write "     " & vbcrlf & "          </table>" & vbcrlf & "  </td>" & vbcrlf & "  </tr>" & vbcrlf & "          <tr>" & vbcrlf & "    <td  class=""page"">" & vbcrlf & "       <table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "  <tr>" & vbcrlf & "    <td width=""7%"" height=""30"">"
		If open_24_6>0 Or open_24_3>0 Then
			Response.write "<div>全选" & vbcrlf & "          <input name=""chkall"" type=""checkbox"" id=""chkall"" value=""all"" onclick=""mm()"" />" & vbcrlf & "    </div>"
		end if
		Response.write "</td>" & vbcrlf & "    <td width=""18%"" style=""text-align:left"">"
		if open_24_6=1 or open_24_6=3 then
			Response.write "      " & vbcrlf & "    <input type=""button"" class=""anybutton""  onClick=""batZP();"" value=""批量指派"">" & vbcrlf & "       "
		end if
		if open_24_3=1 or open_24_3=3 then
			Response.write "  " & vbcrlf & "   <input type=button  class=""anybutton""  value='批量删除'  style=""vertical-align:bottom;"" onClick=""batDel()"" >" & vbcrlf & "    "
'if open_24_3=1 or open_24_3=3 then
		end if
		Response.write "</td>" & vbcrlf & "    <td width=""75%""><div align=""right"">" & vbcrlf & "    "
		...
		Response.write "条信息/页&nbsp;&nbsp;" & vbcrlf & "     <input name=""currpage"" type=""text"" onkeyup=""value=value.replace(/[^\d]/g,'')""  size=""3"">" & vbcrlf & "     &nbsp;<input type=""button"" name=""Submit422"" value=""跳转"" onClick=""gotourl('currPage='+document.getElementById('currpage').value);"" class=""anybutton2""/>" & vbcrlf & ""
		if currpage=1 then
		...
		Response.write "" & vbcrlf & "</div></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr>" & vbcrlf & "<td height=""38"" colspan=""3""><div align=""right"">" & vbcrlf & "<table width=""98%""  border=""0"" cellspacing=""0"" cellpadding=""0"">" & vbcrlf & "  " & vbcrlf & "</table>" & vbcrlf & "</div></td>" & vbcrlf & "  </tr>" & vbcrlf & "</table>" & vbcrlf & ""
	end if
	rs.close
	set rs=nothing
	action1="询价列表"
	call close_list(1)
	Response.write "" & vbcrlf & "</td>" & vbcrlf & "</tr>" & vbcrlf & "</table>" & vbcrlf & "" & vbcrlf & "<div id=""User"" style=""position:absolute;width:150px; height:160;display:none;"">" & vbcrlf & "<table width=""150"" height=""180""  border=""0"" cellpadding=""-2"" cellspacing=""-2"">" & vbcrlf & "  <tr>" & vbcrlf & "    <td height=""139"">" & vbcrlf & "        <table width=""150"" height=""115"" bgcolor=""#ecf5ff"" border=""0"" >" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=3')""><font color=""#2F496E"">按询价主题排序(降)</font></a> </td>" & vbcrlf & "</tr>" & vbcrlf & "<tr valign=""middle"">" & vbcrlf & "<td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=4')""><font color=""#2F496E"">按询价主题排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                  <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=5')""><font color=""#2F496E"">按询价编号排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "   <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=6')""><font color=""#2F496E"">按询价编号排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "          <tr valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=11')""><font color=""#2F496E"">按询价日期排序(降)</font></a></td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=12')""><font color=""#2F496E"">按询价日期排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=7')""><font color=""#2F496E"">按询价状态排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "            <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=8')""><font color=""#2F496E"">按询价状态排序(升)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "           <tr  valign=""middle"">" & vbcrlf & "      <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=1')""><font color=""#2F496E"">按添加时间排序(降)</font></a> </td>" & vbcrlf & "          </tr>" & vbcrlf & "                   <tr  valign=""middle"">" & vbcrlf & "            <td height=""24"" colspan=""2"">&nbsp;&nbsp;<a href=""###"" onclick=""gotourl('px=2')""><font color=""#2F496E"">按添加时间排序(升)</font></a> </td>" & vbcrlf &           "</tr>" & vbcrlf &         "</table>" & vbcrlf &     "</td>" & vbcrlf &   "</tr>" & vbcrlf & "</table>" & vbcrlf & "</div>" & vbcrlf & "</body>" & vbcrlf & "</html>" & vbcrlf
