...
'if rs_kz_zdy("MustFillin") Or Len(KZ_LIMITID&"")>0  Then retStr = retStr & " min=""1"""
	...
	sorce_user=0
	sorce_user2=0
	set rs=conn.execute("select sorce,sorce2 from gate where ord="&session("personzbintel2007")&" ")
	If Not rs.eof Then
		sorce_user=rs("sorce")
	...
	If catesafe&""="" Then catesafe="0"
	Select Case catesafe
	Case "1" : Str_gate1=""
	Case "2" : Str_gate1="where ord="&sorce_user&" " : Str_gate11="where ord="&sorce_user&" "
	Case "3" : Str_gate1=" where ord="&sorce_user&"" : Str_gate2="and ord="&sorce_user2&" " : Str_gate11=" where ord="&sorce_user&"" : Str_gate21="and ord="&sorce_user2&" "
	Case Else
	...
	Response.write "" & vbcrlf & "<table width=""100%"" border=""1"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"" style='*margin-bottom:-1px;border-color:#CCC' bordercolor=""#CCCCCC"">" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td colspan=""2""><a href=""javascript:void(0)"" class=""AfterQuickSearch"" onClick=document.getElementById('kh').style.display='';document.getElementById('ht1').style.display='none';return false;><img class=""resetElementHidden"" src=""../images/icon_title.gif"" width=""18"" height=""7"" border=""0""><img class=""resetElementShowNoAlign"" src=""../skin/default/images/MoZihometop/leftNav/expand.png"" style=""display:none;"" width=""18"" height=""7"" border=""0""><u><font class=""advanSearch"">正常状态</font></u></a></td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "   <td><div align=""right"">领用情况：</div></td>" & vbcrlf & "      <td><input type=""checkbox"" name=""G"" value=""2"" />已领用" & vbcrlf & "                <input type=""checkbox"" name=""G"" value=""0"" />未领用" & vbcrlf & "            <input type=""checkbox"" name=""G"" value=""3"" />待审批 "& vbcrlf &"                <input type=""checkbox"" name=""G"" value=""1"" />全公开 "& vbcrlf &"     </td> "& vbcrlf &" </tr> "& vbcrlf &" <tr> "& vbcrlf &"   <td rowspan=""2""><div align=""right"">人员选择：</div></td>" & vbcrlf & "    <td onMouseOut=this.style.backgroundColor="" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "         <input name=""B"" type=""radio"" value=""1"" checked=""checked"" />领用人员" & vbcrlf & "             <input type=""radio"" name=""B"" value=""2"" />放弃人员" & vbcrlf & "             <input type=""radio"" name=""B"" value=""3"" />添加人员" & vbcrlf & "             <input type=""radio"" name=""B"" value=""4"" />添加人员和领用人员" & vbcrlf & "         <input type=""radio"" name=""B"" value=""5"" />添加人员和放弃人员" & vbcrlf & "   </td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "  <td>"
...
'd_at(44) = "               If nodes.items(i).orgstype = 0 Then" & vbCrLf
	...
	Response.write "</td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "   <td><div align=""right"">放弃原因：</div></td>" & vbcrlf & "      <td>" & vbcrlf & "            <input type=""checkbox"" name=""Abandon"" value=""1"" />领用未联系" & vbcrlf & "             <input type=""checkbox"" name=""Abandon"" value=""2"" />间隔未联系" & vbcrlf & "          <input type=""checkbox"" name=""Abandon"" value=""3"" />跟进未成功" & vbcrlf & "          <input type=""checkbox"" name=""Abandon"" value=""7"" />跟进超期收回" & vbcrlf & "                <input type=""checkbox"" name=""Abandon"" value=""8"" />领用超期收回" & vbcrlf & "               <input type=""checkbox"" name=""Abandon"" value=""4"" />保护过期" & vbcrlf & "            <input type=""checkbox"" name=""Abandon"" value=""5"" />主动放弃" & vbcrlf & "            <input type=""checkbox"" name=""Abandon"" value=""6"" />主管收回" & vbcrlf & "    </td>" & vbcrlf & "</tr>" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">"
	Response.write arrName(4)
	Response.write "：</div></td>" & vbcrlf & " <td>" & vbcrlf & "            "
	dim i5
	i5=1
	set rs1=conn.execute("select ord,sort1 from sort4  order by ord")
	do until rs1.eof
		...
		if CheckPurview(request("E"),trim(rs1("ord")))=True  Then Response.write " checked='checked' "
		Response.write ">"&rs1("sort1")&"<div id='u"&i5&"' "
		if CheckPurview(request("E"),trim(rs1("ord")))=True  Then
			Response.write " style='border:1px  dotted  #000000;' "
		else
			Response.write " style='border:1px  dotted  #000000;display:none;'"
		end if
		Response.write ">"
		set rs2=conn.execute("select ord,sort2 from sort5  where sort1="&rs1("ord")&" order by ord")
		do until rs2.eof
			Response.write "<span class='gray'><input name='F' type='checkbox' value='"&rs2("ord")&"' "
			if CheckPurview(request("F"),trim(rs2("ord")))=True  Then Response.write " checked='checked' "
	...
	Call print_search_scope(1,arrShow(6),arrName(6), 13 ,"A3")
	Call print_search_scope(1,arrShow(9),arrName(9), 14 ,"A1")
	set rss=conn.execute("select id,title,name,sort,gl from zdy where sort1=1 and set_open=1 and js=1 and sort=1 order by gate1 asc ")
	do until rss.eof
		Call print_search_scope(1,1,rss("title"), rss("gl") ,rss("name"))
		rss.movenext
	loop
	rss.close
	call Show_Search_Extended(1)
	...
	Call print_search_scope(1,arrShow(8),arrName(8), 11 ,"D")
	Call print_search_scope(2,arrShow(1),arrName(1), "F1" ,"F2")
	Call print_search_scope(2,arrShow(2),arrName(2), "S1" ,"S2")
	Call print_search_scope(2,arrShow(3),arrName(3), "Y1" ,"Y2")
	Call print_search_scope(2,arrShow(19),arrName(19), "G1" ,"G2")
	Call print_search_scope(2,arrShow(21),arrName(21), "P1" ,"P2")
	Call print_search_scope(2,arrShow(10),arrName(10), "I1" ,"I2")
	Call print_search_scope(2,arrShow(12),arrName(12), "J1" ,"J2")
	Call print_search_scope(2,arrShow(13),arrName(13), "K1" ,"K2")
	Call print_search_scope(2,arrShow(37),arrName(37), "T1" ,"T2")
	set rs=conn.execute("select id,title,name,sort,gl from zdy where sort1=1 and set_open=1 and js=1 and sort=2 order by gate1 asc ")
	do until rs.eof
		Call print_search_scope(2,1,rs("title"), rs("name")&"_1" ,rs("name")&"_2")
		rs.movenext
	loop
	rs.close
	Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "    <td><div align=""right"">放弃日期：</div></td>" & vbcrlf & "      <td>&nbsp;自：<INPUT name=""N1"" size=""9"" readonly id=""daysOfMonthPos"" onmouseup=toggleDatePicker(""daysOfMonth"",""date.N1"")><DIV id=daysOfMonth style=""POSITION: absolute;z-index:10""></DIV>&nbsp;&nbsp;至：<INPUT name=""N2"" size=""9"" readonly id=""daysOfMonth2Pos"" onmouseup=toggleDatePicker(""daysOfMonth2"",""date.N2"")><DIV id=daysOfMonth2 style=""POSITION: absolute""></DIV></td>" & vbcrlf & "</tr>" & vbcrlf & ""
	Call print_search_scope(3,1,"添加日期", "" ,"")
	Response.write "" & vbcrlf & "<tr onMouseOut=this.style.backgroundColor="""" onMouseOver=this.style.backgroundColor=""ecf5ff"">" & vbcrlf & "<td width=""10%"">&nbsp;</td>" & vbcrlf & "<td width=""90%""><input type=""submit"" name=""Submit45"" value=""检索""  class=""page""/>&nbsp;&nbsp;<input type=""reset"" value=""重填"" class=""page"" name=""B2""></td></tr></table>" & vbcrlf & ""
	conn.close
	set conn=nothing
