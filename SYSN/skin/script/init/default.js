...
$(function(){
	...
	$('#download').on('click',function(){
		if($('.scan').css('display')=='none'){
			...
			$('#QrCode').find('img').attr('src',window.PageInitParams[0].AppQrCodeLinks[0].Url)
		}else{
			$('.scan').css('display','none');
			$('#download').removeClass('down_click');
			$('#down_bg').css('background-position','center top');
	...
	//密码锁为空提醒
	$('#fa_p_password').click(function(){
		$(this).css('display','none');
		$('#jmgpwd').focus();
	})
	$('#jmgpwd').focus(function(){
		$(this).css('background-position','left bottom');
	})
	$('#jmgpwd').blur(function(){
		if($(this).val()==''){
...
window.createPage = function () {
    ...
    if (window.parent && window.parent != window) {
        ...
        if (purl.toLowerCase().indexOf("relogin.ashx") > 0) {
            parent.$ID("tishi").innerHTML = obj.Message;
	...
	html.push("<div class='main-tabs'><div class='tab-item active' id='account-login' onclick='window.CLoginType(this)' lgstatus=1><span class='login-icon account-icon'></span>账号登录</div><div class='tab-item' id='scan-login' onclick='window.CLoginType(this)' lgstatus=0><span class='login-icon scanf-icon'></span>扫码登录</div></div>")
	...
	html.push("<div class='mian_login_bottom' id='mb_cont'> <span>&copy;</span>"  + obj.CopyRight.replace("—","-").replace("0","<a href=\"" + obj.DBUpdateUrl + "\" target='setframe' id='updatelinker'>0</a>") + "&nbsp;&nbsp;&nbsp;" + (obj.CompanyFullName||"北京智邦国际软件技术有限公司"))
	var bahStr = "";
	...
	html.push("<img id='mainbg1' class='default-bg' src='../../../SYSN/skin/default/img/blue-bg.png'><img id='mainbg2' class='green-bg' src='../../../SYSN/skin/default/img/green-bg.png'><img id='mainbg3' class='purple-bg' src='../../../SYSN/skin/default/img/purple-bg.png'><img id='mainbg4' class='pink-bg' src='../../../SYSN/skin/default/img/pink-bg.png'><img id='mainbg5' class='black-bg' src='../../../SYSN/skin/default/img/black-bg.png'>")
...
function WriteDefaultPageHTML(){
	html.push("<div class='cont_btm'><div class='cont_center'  onClick='OpenLoginPage()'  title='点击进入全屏'></div></div>");
}
...
//				var obj = eval("(" + r + ")");
				...
				if (obj.result == 0 || window.SysConfig.IsDebugModel == true) {
					...
					$ID("tishi").innerHTML = obj.message;
					$ID("codes").click();
					$ID("xcode").value = "";
				}
			} catch (rx) {
...
function WriteLoginPageHTML() {
    ...
    html.push("<table style='margin:5px auto;width:300px;border-collapse:collapse;'><tr><td id='tishi' valign=middle>" + msg + "</td></tr></table>");
	...
	html.push("<input type='text' name='username' maxlength='50' " + (logintype == "relogin" ? " style='background-color:#f2f2f2' readonly onkeydown='return false;' " : " onkeydown='window.UserBoxFocus(1)' onmousedown='window.UserBoxFocus(1)' onfocus='this.style.borderColor=\"#84a6ee\";window.UserBoxFocus()' onblur='this.style.borderColor=\"\"'") + " id='username' autocomplete=\"off\" value='" + (obj.DefaultUser ? obj.DefaultUser : "请输入用户名") + "'  ><div id='user_iconbg'><div id='user_icon'></div></div>");
	html.push("<input type='password' id='password' name='password' maxlength='50' onfocus='this.style.borderColor=\"#84a6ee\"' onblur='this.style.borderColor=\"\"' autocomplete=\"off\" value='"+ (obj.DefaultPwd || "") +"' oncopy='return false' oncut='return false' onpaste='return false'><span id='fa_password'>请输入密码</span><div class='pass_iconbg'><div class='pass_icon'></div></div>");
	html.push("<div id='jmgou'></div>");
	html.push("<div class='code'><INPUT type='hidden' name='yz'><div class='verify_iconbg'><div class='verify_icon'></div></div> <input ");
	if (window.SysConfig.IsDebugModel == true) {
		html.push(" value='调式模式' style='background-color:#eee;'  readonly ");
	}
	html.push(" maxlength='4'  type='text' onfocus='this.style.borderColor=\"#84a6ee\"' onblur='this.style.borderColor=\"\"'  name='yzm' id='xcode' value='请输入验证码'>")
	...
	html.push("<div class='remem_infor'><div class='remem_dom'><INPUT type='checkbox' value='1' " + (obj.HasDefUserID ? "checked" : "") + " name='recUid' id='rem_name'><label for='rem_name' id='crem_name' onmouseover='_dp_msv(this,1)'  onmouseout='_dp_msv(this,0)'>记住用户名</label></div><div class='remem_dom'><INPUT type='checkbox' value='1' name='recPwd' " + (obj.HasDefPassWd ? "checked" : "") + " id='rem_password'><label for='rem_password' id='crem_pass' onmouseover='_dp_msv(this,1)'  onmouseout='_dp_msv(this,0)'>记住密码</label></div></div>");
	html.push("<div class='bottom_button'><input type='button' onclick='DoLogin()' name='Submit' onmouseover='_pg_mu(this,1)'  onmouseout='_pg_mu(this,0)' value='登  录' id='login'></div>");
	// <input  id='MACAddr' type='hidden' name='MACAddr' value='" + (obj.MacAddress||"") + "'><input onmouseover='_pg1_mu(this,1)'  onmouseout='_pg1_mu(this,0)'  type='reset' name='Submit2' value='重置' id='reset'> 取消了重置按钮
	html.push("</form>");
	var existsQrLink = obj.AppQrCodeLinks && obj.AppQrCodeLinks.length > 0;
	html.push("<div class='main-foot'> <div class='notice' style='" + (existsQrLink?"":"width:80px") + "'>");
	if (obj.Menus && obj.Menus.length > 0 && (window.location.href.indexOf("127.0.0.1") > 0 || window.location.href.indexOf("localhost") > 0)){
		obj.Menus.push({Url:  "javascript:document.getElementById(\"updatelinker\").click()", Title: "数据库升级"});
		html.push("<div class='settings' id='settings'><div class='set_bg' id='set_bg'><img class='arrow-down' src='../../../SYSN/skin/default/img/arrow-down.png' /></div></div>");
		html.push("<ul class='set_list' id='set_list'><img class='up-tag data-up-tag' src='../../../SYSN/skin/default/img/theme/dao-sanjiao.png'>");
	...
	//扫描用户名下载
	if (existsQrLink) {
		html.push("<div class=\"download\" id=\"download\"><div class=\"down_bg\" id=\"down_bg\"><img class='arrow-down' src='../../../SYSN/skin/default/img/arrow-down.png' /><img class='up-tag' src='../../../SYSN/skin/default/img/theme/dao-sanjiao.png'></div></div>")
		html.push("<div class=\"down_comm scan\" id=\"down_comm\">");
		html.push("<p class=\"down_comm_scan\" id=\"QrCode\"><img src=''></p>");
		html.push("<p class=\"down_comm_titl\">智邦国际客户端</p>");
...
window.WriteMobLoginSignHTML = function () {
	html.push("<div style='position:absolute;z-index:100;width:46px;height:46px;right:10px;bottom:10px;'>"
		+ "<img style='width:100%;height:100%;cursor:pointer' src='../../skin/default/img/qrcode.png' "
		...
		+ "<div style='position:absolute;z-index:100;color:#1383c7;line-height:28px;overflow:hidden;padding:0px;text-align:center;"
		+ "display:none;bottom:16px;right:52px;width:90px;height:28px;background:url(../../skin/default/img/lgtypepopbg.png);"
		+"font-size:11px;' id='lgpopsign'>"
		+ "扫码登录&nbsp;</div>");
	
	html.push("<div id='ScanfLoginDiv' style='display:none;position:absolute;width:100%;top:80px;bottom:3px;padding-top:56px;z-index:90;background-color:white;left:0px;'>");
	html.push("<table style='width:256px;border-collapse:collapse;margin:0 auto' align=center>");
	html.push("<tr><td style='padding-top:15px'>");

	html.push("<div style='width:220px;height:220px;border:0px solid #eee;margin:0 auto;overflow:hidden;background-position:10px 10px;background-repeat:no-repeat' id='loginQrCode'>");
	html.push("<div id='moblgtimeoutdiv' style='width:100%;height:100%;background:url(../../skin/default/img/transbg.png);overflow:hidden;display:none'>");
	html.push("<div style='text-align:center;margin-top:70px;width:100%'>"
					...
					+ "<button class='refreshCodeBtn' style='background-color:#0F83C6;width:120px;height:30px;font-family:微软雅黑, 黑体; font-size:16px; color:white;border:0px;cursor:pointer' onclick='window.MobLgRefresh()'>点击刷新</button></div>");
	html.push("</div>");
	html.push("</div>");
	html.push("</td></tr>");
	html.push("<tr><td class='theme-scanf' style='text-align:center;background: transparent url(../../skin/default/img/scanf.png) no-repeat 10px center;"
	...
	html.push("<button style='border:0px;height:2px;background-color:transparent;width:35px' onfocus='this.blur()'>&nbsp;</button>"
		+ "打开 <span style='color:#308CCB;font-size:16px;' class='theme-color'>智邦国际APP</span> 扫码登录</td></tr>");
	html.push("</table></div>");
}
...
window.CLoginType = function (r) {
	var sbox = $ID('lgstatusbox');
	var lgstatus = r.getAttribute("lgstatus") * 1;
	if (lgstatus == 0) {
		$ID('account-login').className = 'tab-item';
		$ID('scan-login').className = 'tab-item active';
		sbox.setAttribute("lgstatus", 1);
		sbox.src = "../../skin/default/img/pccode.png";
		$ID("ScanfLoginDiv").style.display = "block";
		$ID("lgpopsign").innerHTML = "&nbsp;密码登录";
		$("#moblgbottomtxt").removeClass("moblgbottom_scanfIco")
		$ID("moblgbottomtxt").innerHTML = "<div style='height:10px;overflow:hidden'></div>"
			...
			+ "打开 <span style='color:#308CCB;font-size:16px;' class='theme-color'>智邦国际APP</span> 扫码登录";
		$ID("moblgbottomtxt").style.backgroundImage = "url(../../skin/default/img/scanf.png)";
		$ID("loginQrCode").style.height = "220px";
		window.MobLoginQrCodeRefresh();
		window.MobTimerHwnd = window.setTimeout(window.MobLoginWatch, 1000);
	} else {
		$ID('account-login').className = 'tab-item active';
		$ID('scan-login').className = 'tab-item';
		sbox.setAttribute("lgstatus", 0);
		sbox.src = "../../skin/default/img/qrcode.png";
...
window.MobLoginWatchResult = function (r) {
	...
	if (r.indexOf("waitsure") >= 0) {
		...
		$("#moblgbottomtxt").addClass("moblgbottom_scanfIco")
		$ID("moblgbottomtxt").innerHTML = "<div style='color:#aaa;text-align:center;font-size:16px;'>扫描成功 !</div>"
							...
							+ "<span style='color:#308CCB;font-size:16px;' class='theme-color'>智邦国际APP</span> "
...
function CheckJMG() {
    ...
    var r =  app.ajax.send();
    switch(r){
    	case "0": $ID("tishi").innerHTML = ""; return true;
        case "1": $ID("tishi").innerHTML = "用户名密码错误或账号已被冻结！"; return false;
    	case "2": $ID("tishi").innerHTML = "请输入正确的账号密码！"; return false;
    	case "200":
    		if (app.getIEVer() > 11) {
    		...
    		htmls.push('<input id="jmgpwd" name="jmgpwd" type="password" class="login_1" oncopy="return false" oncut="return false" onpaste="return false"/>');
    		htmls.push('<input id="guid" name="guid" type="hidden" />');
    		htmls.push('<input id="miyao" name="miyao" type="hidden" />');
    		htmls.push('<span id="fa_p_password">请输入加密锁</span></span>');
    		$ID("jmgou").innerHTML = htmls.join("");
    		var NT120Client = $ID("NT120Client");
    		var inputjmg = $ID("inputjmg");
    		var tishi = $ID("tishi");
    		CheckData(NT120Client, inputjmg, tishi);
    		setTimeout(function () { $ID("jmgpwd").focus(); }, 100);
...
function CheckPWD(jmgpwd, NT120Client, guid, miyao, tishi) {
    try {
        if (jmgpwd.value != "") {
            ...
            if (rtn != 0) {
                tishi.innerHTML = "没有找到加密锁！";
                return false;
            }
            else {
                var result = NT120Client.NTLogin(jmgpwd.value);
                if (result != 0) {
                    tishi.innerHTML = "加密锁密码错误！";
                    return false;
                }
                else {
            ...
            tishi.innerHTML = "请输入加密锁密码！";
            return false;
        }
    }
    catch (e) {
        tishi.innerHTML = "加密锁组件加载失败！";
        return false;
    }
}
    ...
    try {
        if (jmgpwdold.value != "" && jmgpwdnew.value != "") {
            ...
            if (rtn != 0) {
                ...
                if (result != 0) {   tishi.innerHTML = "登录加密锁密码错误！";  return false; }
                else {
