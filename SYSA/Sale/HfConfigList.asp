...
'If Not rs.Eof Then
	...
	Response.write Application("sys.info.jsver")
	'Response.write Application("sys.info.jsver")
	Response.write """ type=""text/javascript"" language=""javascript""></script>" & vbcrlf & "<script src= ""../Script/Se_HfConfigList.js?ver="
	Response.write Application("sys.info.jsver")
	Response.write """  language=""javascript"" type=""text/javascript""></script>" & vbcrlf & "</head>" & vbcrlf & "<body>" & vbcrlf & "<table width=""100%""  border=""0"" align=""left"" cellpadding=""0"" cellspacing=""0"" bordercolor=""#E2E2E1"" bgcolor=""#FFFFFF"">" & vbcrlf & "  <form method=""post"" name=""demo""  action="""" id=""demo"" onsubmit=""return Validator.Validate(this,2)"">" & vbcrlf & "    <tr>" & vbcrlf & "      <td width=""100%"" valign=""top""><table width=""100%"" border=""0"" cellpadding=""0"" cellspacing=""0"" background=""../images/m_mpbg.gif"">" & vbcrlf & "          <tr>" & vbcrlf & "            <td class=""place"">回访流程列表</td>" & vbcrlf & "            <td>&nbsp;</td>" & vbcrlf & "            <td align=""right""><input type=""button"" class=""anybutton2"" name=""Submitdel22"" value=""添加回访流程""  onClick=""javascript:window.open('HfConfig.asp','newHrssTJ','width=' + 1100 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')""/></td>" & vbcrlf & "            <td width=""3""><img src=""../images/m_mpr.gif"" width=""3"" height=""32"" /></td>" & vbcrlf & "          </tr>" & vbcrlf & "        </table>" & vbcrlf & "        <table width=""100%"" border=""0"" cellpadding=""6"" cellspacing=""1"" bgcolor=""#C0CCDD"" id=""content"">" & vbcrlf &                                        " <tr class=""top"">" & vbcrlf &                                           "<td width=""6%""><div align=""center"">选择</div></td> "& vbcrlf &                                           "<td width=""25%""><div align=""center"">流程名称</div></td> "& vbcrlf &                                              "<td width=""15%""><div align=""center"">触发点</div></td>" & vbcrlf & "                                             <td width=""15%""><div align=""center"">添加时间</div></td>" & vbcrlf & "                                             <td width=""15%""><div align=""center"">添加人员</div></td>" & vbcrlf & "                                             <td width=""24%""><div align=""center"">操作</div></td>" & vbcrlf & "                                 </tr>" & vbcrlf & ""
	Set Rs=server.CreateObject("adodb.recordset")
	SQL="Select a.id,a.creator as creatorid, a.title, a.Indate, b.name as creator,a.del,c.title as sqltemple  from hf_config a left join gate b on a.creator=b.ord left join hf_ywlmSetings c on a.SQLTemplate=c.id where a.del=1 order by a.id desc"
	...
	If Not Rs.Eof Then
		...
		Do While Not Rs.Eof
			...
			Response.write "</div></td>" & vbcrlf & "                                           <td><div align=""center"">"
			Response.write Rs("sqltemple")
			Response.write "</div></td>" & vbcrlf & "                                           <td><div align=""center"">"
			Response.write Rs("Indate")
			Response.write "</div></td>" & vbcrlf & "                                           <td><div align=""center"">"
			Response.write Rs("creator")
			Response.write "</div></td>" & vbcrlf & "                                           <td class=""func""><div align=""center"">" & vbcrlf & "                                               <input type=""button"" name=""Submit3"" value=""详情""  onClick=""javascript:window.open('HfConfigCon.asp?ord="
			Response.write pwurl(rs("id"))
			Response.write "','newHrss','width=' + 900 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=100,top=100')""/>" & vbcrlf & "                                          <input type=""button"" name=""Submit3c"" value=""修改""  onClick=""javascript:window.open('HfConfig.asp?action=edit&ord="
			Response.write pwurl(rs("id"))
			'Response.write pwurl(rs("id"))
			Response.write "&CurrPage="
			Response.write CurrPage
			Response.write "','newHrss','width=' + 1100 + ',height=' + 500 + ',fullscreen =no,scrollbars=1,toolbar=0,resizable=1,left=150,top=150')""/>" & vbcrlf & "                                         <input type=""button"" name=""Submitdel"" value=""删除"" onClick=""if(confirm('确认删除？')){window.location.href='HfConfig.asp?action=del&ord="
			'Response.write CurrPage
			Response.write pwurl(rs("id"))
			Response.write "&CurrPage="
			Response.write CurrPage
	...
	rs.close
	Set Rs=Nothing
	Response.write "" & vbcrlf & "</table>" & vbcrlf & "    <tr>" & vbcrlf & "      <td  class=""page""><table width=""100%"" border=""0"" align=""left"" >" & vbcrlf & "          <tr>" & vbcrlf & "            <td width=""20%"" height=""250""  align=""left"" valign=""center"" >&nbsp<input type=""checkbox"" name=""Del_Batch"" id=""Del_Batch"">全选&nbsp;&nbsp;<input type=""button"" class=""anybutton2"" name=""Submitdel2"" value=""批量删除"" id=""Del_List"" /></td>" & vbcrlf & "            <td width=""97%""  align=""left"" valign=""center"" ><div align=""right""> <span class=""black"">共"
